...
public class LObjCharConsumerAttestTest<T> {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private LObjCharConsumer<Integer> function = (a1,a2) ->
            externalEffect.set(testValue);


    private LObjCharConsumer<Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjCharCons(functionThrowing)
         .doesAccept(100,'\u0100')
