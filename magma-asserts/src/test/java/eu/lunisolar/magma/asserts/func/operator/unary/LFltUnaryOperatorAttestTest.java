...
import eu.lunisolar.magma.func.operator.unary.LFltUnaryOperator;
...
public class LFltUnaryOperatorAttestTest {

    private float testValue = 100f;

    private LFltUnaryOperator function = a ->
            testValue;


    private LFltUnaryOperator functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestFltUnaryOp(functionThrowing)
         .doesApplyAsFlt(100f)
            .to(a -> a.must$(Be::equal$, 0f));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestFltUnaryOp(functionThrowing)
         .doesApplyAsFlt(100f).withException(a -> a
