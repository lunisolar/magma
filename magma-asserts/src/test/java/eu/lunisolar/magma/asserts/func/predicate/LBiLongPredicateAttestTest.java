...
public class LBiLongPredicateAttestTest {

    private boolean testValue = true;

    private LBiLongPredicate function = (a1,a2) ->
            testValue;


    private LBiLongPredicate functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiLongPred(functionThrowing)
         .doesTest(100L,100L)
            .to(a -> a.mustEx(Be::equalEx, false));
    }
