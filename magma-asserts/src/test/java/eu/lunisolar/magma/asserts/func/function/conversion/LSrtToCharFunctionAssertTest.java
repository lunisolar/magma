...
import eu.lunisolar.magma.func.function.conversion.LSrtToCharFunction;
...
public class LSrtToCharFunctionAssertTest {
    ...
    private LSrtToCharFunction function = a ->
            testValue;


    private LSrtToCharFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestSrtToCharFunc(functionThrowing)
         .doesApplyAsChar((short)100)
            .to( a -> a.isEqualTo(1));
    }
