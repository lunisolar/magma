...
public class LBiLongFunctionAttestTest<R> {

    private Integer testValue = 100;

    private LBiLongFunction<Integer> function = (a1,a2) ->
            testValue;


    private LBiLongFunction<Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiLongFunc(functionThrowing)
         .doesApply(100L,100L)
            .to(a -> a.mustEx(Be::equalEx, 0));
    }
