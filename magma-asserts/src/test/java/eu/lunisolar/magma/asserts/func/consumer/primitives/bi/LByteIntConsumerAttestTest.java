...
public class LByteIntConsumerAttestTest {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private LByteIntConsumer function = (a1,a2) ->
            externalEffect.set(testValue);


    private LByteIntConsumer functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestByteIntCons(functionThrowing)
         .doesAccept((byte)100,100)
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestByteIntCons(functionThrowing)
         .doesAccept((byte)100,100).withException(a -> a
