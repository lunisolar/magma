...
public class LBiFltPredicateAttestTest {

    private boolean testValue = true;

    private LBiFltPredicate function = (a1,a2) ->
            testValue;


    private LBiFltPredicate functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiFltPred(functionThrowing)
         .doesTest(100f,100f)
            .to(a -> a.must$(Be::equal$, false));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestBiFltPred(functionThrowing)
         .doesTest(100f,100f).withException(a -> a
