...
public class LOiToCharFunctionAttestTest<T> {

    private char testValue = '\u0100';

    private LOiToCharFunction<Integer> function = (a1,a2) ->
            testValue;


    private LOiToCharFunction<Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestOiToCharFunc(functionThrowing)
         .doesApplyAsChar(100,100)
            .to(a -> a.must$(Be::equal$, '\u0000'));
    }
