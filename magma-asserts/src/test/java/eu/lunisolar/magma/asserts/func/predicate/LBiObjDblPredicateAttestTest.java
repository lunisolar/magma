...
public class LBiObjDblPredicateAttestTest<T1,T2> {

    private boolean testValue = true;

    private LBiObjDblPredicate<Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LBiObjDblPredicate<Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiObjDblPred(functionThrowing)
         .doesTest(100,100,100d)
            .to(a -> a.must$(Be::equal$, false));
    }
