...
import eu.lunisolar.magma.func.function.conversion.LBoolToSrtFunction;
...
public class LBoolToSrtFunctionAttestTest {

    private short testValue = (short)100;

    private LBoolToSrtFunction function = a ->
            testValue;


    private LBoolToSrtFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBoolToSrtFunc(functionThrowing)
         .doesApplyAsSrt(true)
            .to(a -> a.must$(Be::equal$, (short)0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestBoolToSrtFunc(functionThrowing)
         .doesApplyAsSrt(true).withException(a -> a
