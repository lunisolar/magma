...
public class LTriPredicateAttestTest<T1,T2,T3> {

    private boolean testValue = true;

    private LTriPredicate<Integer,Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LTriPredicate<Integer,Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        FuncAttests.attestTriPred(function)
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestTriPred(functionThrowing)
         .doesTest(100,100,100)
            .to(a -> a.mustEx(Be::equalEx, false));
    }
