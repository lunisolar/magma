...
public class LBiCharPredicateAttestTest {

    private boolean testValue = true;

    private LBiCharPredicate function = (a1,a2) ->
            testValue;


    private LBiCharPredicate functionThrowing = (a1,a2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        FuncAttests.attestBiCharPred(function)
         .doesTest('\u0100','\u0100')
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiCharPred(functionThrowing)
         .doesTest('\u0100','\u0100')
            .to(a -> a.must$(Be::equal$, false));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestBiCharPred(functionThrowing)
         .doesTest('\u0100','\u0100').withException(a -> a
