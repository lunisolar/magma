...
public class LTieDblFunctionAssertTest<T> {
    ...
    private LTieDblFunction<Integer> function = (a1,a2,a3) ->
            testValue;


    private LTieDblFunction<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.attestTieDblFunc(function)
         .doesApplyAsInt(100,100,100d)
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestTieDblFunc(functionThrowing)
         .doesApplyAsInt(100,100,100d)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.attestTieDblFunc(functionThrowing)
         .doesApplyAsInt(100,100,100d).withException(a -> a
