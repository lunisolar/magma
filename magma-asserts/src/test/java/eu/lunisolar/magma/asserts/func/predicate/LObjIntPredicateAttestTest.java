...
public class LObjIntPredicateAttestTest<T> {

    private boolean testValue = true;

    private LObjIntPredicate<Integer> function = (a1,a2) ->
            testValue;


    private LObjIntPredicate<Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjIntPred(functionThrowing)
         .doesTest(100,100)
            .to(a -> a.mustEx(Be::equalEx, false));
    }
