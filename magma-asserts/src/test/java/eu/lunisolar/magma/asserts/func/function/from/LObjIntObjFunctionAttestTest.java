...
public class LObjIntObjFunctionAttestTest<T1,T2,R> {

    private Integer testValue = 100;

    private LObjIntObjFunction<Integer,Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LObjIntObjFunction<Integer,Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjIntObjFunc(functionThrowing)
         .doesApply(100,100,100)
            .to(a -> a.mustEx(Be::equalEx, 0));
    }
