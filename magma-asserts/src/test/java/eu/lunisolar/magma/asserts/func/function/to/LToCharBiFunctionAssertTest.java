...
public class LToCharBiFunctionAssertTest<T1,T2> {
    ...
    private LToCharBiFunction<Integer,Integer> function = (a1,a2) ->
            testValue;


    private LToCharBiFunction<Integer,Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertToCharBiFunc(function)
         .doesApplyAsChar(100,100)
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertToCharBiFunc(functionThrowing)
         .doesApplyAsChar(100,100)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertToCharBiFunc(functionThrowing)
         .doesApplyAsChar(100,100).withException(a -> a
