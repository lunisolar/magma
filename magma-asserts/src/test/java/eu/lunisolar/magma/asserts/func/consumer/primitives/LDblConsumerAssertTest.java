...
import eu.lunisolar.magma.func.consumer.primitives.LDblConsumer;
...
public class LDblConsumerAssertTest {
    ...
    private LDblConsumer function = a ->
            externalEffect.set(testValue);


    private LDblConsumer functionThrowing = a -> {
