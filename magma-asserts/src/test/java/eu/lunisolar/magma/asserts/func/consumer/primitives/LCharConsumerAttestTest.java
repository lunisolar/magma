...
import eu.lunisolar.magma.func.consumer.primitives.LCharConsumer;
...
public class LCharConsumerAttestTest {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private LCharConsumer function = a ->
            externalEffect.set(testValue);


    private LCharConsumer functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestCharCons(functionThrowing)
         .doesAccept('\u0100')
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestCharCons(functionThrowing)
         .doesAccept('\u0100').withException(a -> a
