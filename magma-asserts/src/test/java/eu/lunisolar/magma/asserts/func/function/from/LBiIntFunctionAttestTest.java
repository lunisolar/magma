...
public class LBiIntFunctionAttestTest<R> {

    private Integer testValue = 100;

    private LBiIntFunction<Integer> function = (a1,a2) ->
            testValue;


    private LBiIntFunction<Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiIntFunc(functionThrowing)
         .doesApply(100,100)
            .to(a -> a.must$(Be::equal$, 0));
    }
