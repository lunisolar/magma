...
import eu.lunisolar.magma.func.predicate.LFltPredicate;
...
public class LFltPredicateAttestTest {

    private boolean testValue = true;

    private LFltPredicate function = a ->
            testValue;


    private LFltPredicate functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestFltPred(functionThrowing)
         .doesTest(100f)
            .to(a -> a.must$(Be::equal$, false));
    }
