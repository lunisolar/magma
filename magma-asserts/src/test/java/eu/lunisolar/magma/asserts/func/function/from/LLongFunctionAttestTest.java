...
import eu.lunisolar.magma.func.function.from.LLongFunction;
...
public class LLongFunctionAttestTest<R> {

    private Integer testValue = 100;

    private LLongFunction<Integer> function = a ->
            testValue;


    private LLongFunction<Integer> functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestLongFunc(functionThrowing)
         .doesApply(100L)
            .to(a -> a.mustEx(Be::equalEx, 0));
    }
