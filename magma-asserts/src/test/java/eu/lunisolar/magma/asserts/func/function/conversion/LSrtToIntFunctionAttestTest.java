...
import eu.lunisolar.magma.func.function.conversion.LSrtToIntFunction;
...
public class LSrtToIntFunctionAttestTest {

    private int testValue = 100;

    private LSrtToIntFunction function = a ->
            testValue;


    private LSrtToIntFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestSrtToIntFunc(functionThrowing)
         .doesApplyAsInt((short)100)
            .to(a -> a.mustEx(Be::equalEx, 0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestSrtToIntFunc(functionThrowing)
         .doesApplyAsInt((short)100).withException(a -> a
