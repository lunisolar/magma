...
import eu.lunisolar.magma.func.function.conversion.LCharToSrtFunction;
...
public class LCharToSrtFunctionAttestTest {

    private short testValue = (short)100;

    private LCharToSrtFunction function = a ->
            testValue;


    private LCharToSrtFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestCharToSrtFunc(functionThrowing)
         .doesApplyAsSrt('\u0100')
            .to(a -> a.must$(Be::equal$, (short)0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestCharToSrtFunc(functionThrowing)
         .doesApplyAsSrt('\u0100').withException(a -> a
