...
public class LObjBiLongPredicateAssertTest<T> {
    ...
    private LObjBiLongPredicate<Integer> function = (a1,a2,a3) ->
            testValue;


    private LObjBiLongPredicate<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestObjBiLongPred(functionThrowing)
         .doesTest(100,100L,100L)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.attestObjBiLongPred(functionThrowing)
         .doesTest(100,100L,100L).withException(a -> a
