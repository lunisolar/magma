...
import eu.lunisolar.magma.func.function.conversion.LLongToCharFunction;
...
public class LLongToCharFunctionAttestTest {

    private char testValue = '\u0100';

    private LLongToCharFunction function = a ->
            testValue;


    private LLongToCharFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestLongToCharFunc(functionThrowing)
         .doesApplyAsChar(100L)
            .to(a -> a.must$(Be::equal$, '\u0000'));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestLongToCharFunc(functionThrowing)
         .doesApplyAsChar(100L).withException(a -> a
