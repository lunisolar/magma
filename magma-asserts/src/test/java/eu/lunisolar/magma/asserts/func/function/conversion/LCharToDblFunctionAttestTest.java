...
import eu.lunisolar.magma.func.function.conversion.LCharToDblFunction;
...
public class LCharToDblFunctionAttestTest {

    private double testValue = 100d;

    private LCharToDblFunction function = a ->
            testValue;


    private LCharToDblFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestCharToDblFunc(functionThrowing)
         .doesApplyAsDbl('\u0100')
            .to(a -> a.must$(Be::equal$, 0d));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestCharToDblFunc(functionThrowing)
         .doesApplyAsDbl('\u0100').withException(a -> a
