...
public class LObjIntObjPredicateAttestTest<T1,T2> {

    private boolean testValue = true;

    private LObjIntObjPredicate<Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LObjIntObjPredicate<Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        FuncAttests.attestObjIntObjPred(function)
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjIntObjPred(functionThrowing)
         .doesTest(100,100,100)
            .to(a -> a.must$(Be::equal$, false));
    }
