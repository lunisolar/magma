...
import eu.lunisolar.magma.func.function.conversion.LCharToByteFunction;
...
public class LCharToByteFunctionAttestTest {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestCharToByteFunc(functionThrowing)
         .doesApplyAsByte('\u0100')
            .to(a -> a.mustEx(Be::equalEx, (byte)0));
    }
