...
public class LBiObjSrtPredicateAttestTest<T1,T2> {

    private boolean testValue = true;

    private LBiObjSrtPredicate<Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LBiObjSrtPredicate<Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiObjSrtPred(functionThrowing)
         .doesTest(100,100,(short)100)
            .to(a -> a.must$(Be::equal$, false));
    }
