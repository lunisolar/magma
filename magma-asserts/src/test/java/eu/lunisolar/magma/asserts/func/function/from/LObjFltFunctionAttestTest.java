...
public class LObjFltFunctionAttestTest<T,R> {

    private Integer testValue = 100;

    private LObjFltFunction<Integer,Integer> function = (a1,a2) ->
            testValue;


    private LObjFltFunction<Integer,Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjFltFunc(functionThrowing)
         .doesApply(100,100f)
            .to(a -> a.must$(Be::equal$, 0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestObjFltFunc(functionThrowing)
         .doesApply(100,100f).withException(a -> a
