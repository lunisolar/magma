...
public class LTernaryOperatorAttestTest<T> {

    private Integer testValue = 100;

    private LTernaryOperator<Integer> function = (a1,a2,a3) ->
            testValue;


    private LTernaryOperator<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestTernaryOp(functionThrowing)
         .doesApply(100,100,100)
            .to(a -> a.must$(Be::equal$, 0));
    }
