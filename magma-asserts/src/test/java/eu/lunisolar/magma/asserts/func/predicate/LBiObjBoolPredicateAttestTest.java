...
public class LBiObjBoolPredicateAttestTest<T1,T2> {

    private boolean testValue = true;

    private LBiObjBoolPredicate<Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LBiObjBoolPredicate<Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiObjBoolPred(functionThrowing)
         .doesTest(100,100,true)
            .to(a -> a.must$(Be::equal$, false));
    }
