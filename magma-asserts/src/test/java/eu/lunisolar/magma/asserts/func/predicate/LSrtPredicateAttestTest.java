...
import eu.lunisolar.magma.func.predicate.LSrtPredicate;
...
public class LSrtPredicateAttestTest {

    private boolean testValue = true;

    private LSrtPredicate function = a ->
            testValue;


    private LSrtPredicate functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestSrtPred(functionThrowing)
         .doesTest((short)100)
            .to(a -> a.must$(Be::equal$, false));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestSrtPred(functionThrowing)
         .doesTest((short)100).withException(a -> a
