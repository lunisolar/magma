...
import eu.lunisolar.magma.func.supplier.LSrtSupplier;
...
public class LSrtSupplierAttestTest {
    ...
    private LSrtSupplier functionThrowing = () -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestSrtSup(functionThrowing)
         .doesGetAsSrt()
            .to(a -> a.must$(Be::equal$, (short)0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestSrtSup(functionThrowing)
         .doesGetAsSrt().withException(a -> a
