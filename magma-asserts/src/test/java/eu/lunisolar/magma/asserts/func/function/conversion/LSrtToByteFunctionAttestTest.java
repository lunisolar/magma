...
import eu.lunisolar.magma.func.function.conversion.LSrtToByteFunction;
...
public class LSrtToByteFunctionAttestTest {

    private byte testValue = (byte)100;

    private LSrtToByteFunction function = a ->
            testValue;


    private LSrtToByteFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestSrtToByteFunc(functionThrowing)
         .doesApplyAsByte((short)100)
            .to(a -> a.must$(Be::equal$, (byte)0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestSrtToByteFunc(functionThrowing)
         .doesApplyAsByte((short)100).withException(a -> a
