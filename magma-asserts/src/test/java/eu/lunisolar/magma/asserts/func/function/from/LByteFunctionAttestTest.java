...
public class LByteFunctionAttestTest<R> {

    private Integer testValue = 100;

    private LByteFunction<Integer> function = a ->
            testValue;


    private LByteFunction<Integer> functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestByteFunc(functionThrowing)
         .doesApply((byte)100)
            .to(a -> a.mustEx(Be::equalEx, 0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestByteFunc(functionThrowing)
         .doesApply((byte)100).withException(a -> a
