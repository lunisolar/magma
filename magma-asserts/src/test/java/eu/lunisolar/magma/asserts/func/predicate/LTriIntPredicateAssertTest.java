...
import eu.lunisolar.magma.func.predicate.LTriIntPredicate;
...
public class LTriIntPredicateAssertTest {
    ...
    private LTriIntPredicate function = (a1,a2,a3) ->
            testValue;


    private LTriIntPredicate functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestTriIntPred(functionThrowing)
         .doesTest(100,100,100)
            .to( a -> a.isEqualTo(1));
    }
