...
public class LToByteBiFunctionAssertTest<T1,T2> {
    ...
    private LToByteBiFunction<Integer,Integer> function = (a1,a2) ->
            testValue;


    private LToByteBiFunction<Integer,Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestToByteBiFunc(functionThrowing)
         .doesApplyAsByte(100,100)
            .to( a -> a.isEqualTo(1));
    }
