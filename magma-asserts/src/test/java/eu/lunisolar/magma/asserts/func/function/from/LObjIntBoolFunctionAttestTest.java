...
public class LObjIntBoolFunctionAttestTest<T,R> {

    private Integer testValue = 100;

    private LObjIntBoolFunction<Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LObjIntBoolFunction<Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjIntBoolFunc(functionThrowing)
         .doesApply(100,100,true)
            .to(a -> a.must$(Be::equal$, 0));
    }
