...
import eu.lunisolar.magma.func.operator.binary.LDblBinaryOperator;
...
public class LDblBinaryOperatorAttestTest {

    private double testValue = 100d;

    private LDblBinaryOperator function = (a1,a2) ->
            testValue;


    private LDblBinaryOperator functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestDblBinaryOp(functionThrowing)
         .doesApplyAsDbl(100d,100d)
            .to(a -> a.must$(Be::equal$, 0d));
    }
