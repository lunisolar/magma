...
import eu.lunisolar.magma.func.function.conversion.LIntToSrtFunction;
...
public class LIntToSrtFunctionAttestTest {

    private short testValue = (short)100;

    private LIntToSrtFunction function = a ->
            testValue;


    private LIntToSrtFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestIntToSrtFunc(functionThrowing)
         .doesApplyAsSrt(100)
            .to(a -> a.must$(Be::equal$, (short)0));
    }
