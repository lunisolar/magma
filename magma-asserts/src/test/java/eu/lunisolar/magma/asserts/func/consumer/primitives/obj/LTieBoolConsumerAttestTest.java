...
public class LTieBoolConsumerAttestTest<T> {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private LTieBoolConsumer<Integer> function = (a1,a2,a3) ->
            externalEffect.set(testValue);


    private LTieBoolConsumer<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestTieBoolCons(functionThrowing)
         .doesAccept(100,100,true)
