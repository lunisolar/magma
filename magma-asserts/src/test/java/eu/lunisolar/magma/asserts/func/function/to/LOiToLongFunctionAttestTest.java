...
public class LOiToLongFunctionAttestTest<T> {

    private long testValue = 100L;

    private LOiToLongFunction<Integer> function = (a1,a2) ->
            testValue;


    private LOiToLongFunction<Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestOiToLongFunc(functionThrowing)
         .doesApplyAsLong(100,100)
            .to(a -> a.must$(Be::equal$, 0L));
    }
