...
public class LTieFunctionAttestTest<T1,T2> {

    private int testValue = 100;

    private LTieFunction<Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LTieFunction<Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestTieFunc(functionThrowing)
         .doesApplyAsInt(100,100,100)
            .to(a -> a.must$(Be::equal$, 0));
    }
