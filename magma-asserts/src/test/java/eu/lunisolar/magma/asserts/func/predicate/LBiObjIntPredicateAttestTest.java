...
public class LBiObjIntPredicateAttestTest<T1,T2> {

    private boolean testValue = true;

    private LBiObjIntPredicate<Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LBiObjIntPredicate<Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiObjIntPred(functionThrowing)
         .doesTest(100,100,100)
            .to(a -> a.mustEx(Be::equalEx, false));
    }
