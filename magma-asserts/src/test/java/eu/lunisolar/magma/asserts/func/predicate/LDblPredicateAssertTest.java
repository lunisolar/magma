...
import eu.lunisolar.magma.func.predicate.LDblPredicate;
...
public class LDblPredicateAssertTest {
    ...
    private LDblPredicate function = a ->
            testValue;


    private LDblPredicate functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestDblPred(functionThrowing)
         .doesTest(100d)
            .to( a -> a.isEqualTo(1));
    }
