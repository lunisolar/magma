...
public class JreToLongBiFunctionAssertTest<T1,T2> {
    ...
    private ToLongBiFunction<Integer,Integer> function = (a1,a2) ->
            testValue;


    private ToLongBiFunction<Integer,Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestToLongBiFunc(functionThrowing)
         .doesApplyAsLong(100,100)
            .to( a -> a.isEqualTo(1));
    }
