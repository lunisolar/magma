...
import eu.lunisolar.magma.func.function.from.LTriCharFunction;
...
public class LTriCharFunctionAttestTest<R> {

    private Integer testValue = 100;

    private LTriCharFunction<Integer> function = (a1,a2,a3) ->
            testValue;


    private LTriCharFunction<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestTriCharFunc(functionThrowing)
         .doesApply('\u0100','\u0100','\u0100')
            .to(a -> a.mustEx(Be::equalEx, 0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestTriCharFunc(functionThrowing)
         .doesApply('\u0100','\u0100','\u0100').withException(a -> a
