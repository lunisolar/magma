...
import eu.lunisolar.magma.func.function.conversion.LFltToLongFunction;
...
public class LFltToLongFunctionAttestTest {

    private long testValue = 100L;

    private LFltToLongFunction function = a ->
            testValue;


    private LFltToLongFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestFltToLongFunc(functionThrowing)
         .doesApplyAsLong(100f)
            .to(a -> a.must$(Be::equal$, 0L));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestFltToLongFunc(functionThrowing)
         .doesApplyAsLong(100f).withException(a -> a
