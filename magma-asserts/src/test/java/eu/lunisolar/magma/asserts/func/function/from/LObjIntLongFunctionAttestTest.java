...
public class LObjIntLongFunctionAttestTest<T,R> {

    private Integer testValue = 100;

    private LObjIntLongFunction<Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LObjIntLongFunction<Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjIntLongFunc(functionThrowing)
         .doesApply(100,100,100L)
            .to(a -> a.mustEx(Be::equalEx, 0));
    }
