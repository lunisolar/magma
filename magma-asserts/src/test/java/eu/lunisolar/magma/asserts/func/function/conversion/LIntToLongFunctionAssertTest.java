...
import eu.lunisolar.magma.func.function.conversion.LIntToLongFunction;
...
public class LIntToLongFunctionAssertTest {
    ...
    private LIntToLongFunction function = a ->
            testValue;


    private LIntToLongFunction functionThrowing = a -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.attestIntToLongFunc(function)
         .doesApplyAsLong(100)
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestIntToLongFunc(functionThrowing)
         .doesApplyAsLong(100)
            .to( a -> a.isEqualTo(1));
    }
