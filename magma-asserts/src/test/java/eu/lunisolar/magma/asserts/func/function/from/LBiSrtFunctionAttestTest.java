...
public class LBiSrtFunctionAttestTest<R> {

    private Integer testValue = 100;

    private LBiSrtFunction<Integer> function = (a1,a2) ->
            testValue;


    private LBiSrtFunction<Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiSrtFunc(functionThrowing)
         .doesApply((short)100,(short)100)
            .to(a -> a.must$(Be::equal$, 0));
    }
