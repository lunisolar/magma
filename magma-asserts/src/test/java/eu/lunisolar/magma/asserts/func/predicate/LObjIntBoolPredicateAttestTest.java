...
public class LObjIntBoolPredicateAttestTest<T> {

    private boolean testValue = true;

    private LObjIntBoolPredicate<Integer> function = (a1,a2,a3) ->
            testValue;


    private LObjIntBoolPredicate<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjIntBoolPred(functionThrowing)
         .doesTest(100,100,true)
            .to(a -> a.must$(Be::equal$, false));
    }
