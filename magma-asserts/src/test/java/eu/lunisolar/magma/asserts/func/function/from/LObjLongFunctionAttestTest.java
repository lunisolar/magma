...
public class LObjLongFunctionAttestTest<T,R> {

    private Integer testValue = 100;

    private LObjLongFunction<Integer,Integer> function = (a1,a2) ->
            testValue;


    private LObjLongFunction<Integer,Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjLongFunc(functionThrowing)
         .doesApply(100,100L)
            .to(a -> a.must$(Be::equal$, 0));
    }
