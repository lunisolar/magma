...
import eu.lunisolar.magma.func.function.conversion.LBoolToDblFunction;
...
public class LBoolToDblFunctionAssertTest {
    ...
    private LBoolToDblFunction function = a ->
            testValue;


    private LBoolToDblFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertBoolToDblFunc(functionThrowing)
         .doesApplyAsDbl(true)
            .to( a -> a.isEqualTo(1));
    }
