...
public class LToFltBiFunctionAttestTest<T1,T2> {

    private float testValue = 100f;

    private LToFltBiFunction<Integer,Integer> function = (a1,a2) ->
            testValue;


    private LToFltBiFunction<Integer,Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestToFltBiFunc(functionThrowing)
         .doesApplyAsFlt(100,100)
            .to(a -> a.must$(Be::equal$, 0f));
    }
