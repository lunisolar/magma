...
public class LBiObjByteConsumerAttestTest<T1,T2> {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private LBiObjByteConsumer<Integer,Integer> function = (a1,a2,a3) ->
            externalEffect.set(testValue);


    private LBiObjByteConsumer<Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiObjByteCons(functionThrowing)
         .doesAccept(100,100,(byte)100)
