...
import eu.lunisolar.magma.func.function.to.LToSrtFunction;
...
public class LToSrtFunctionAttestTest<T> {

    private short testValue = (short)100;

    private LToSrtFunction<Integer> function = a ->
            testValue;


    private LToSrtFunction<Integer> functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestToSrtFunc(functionThrowing)
         .doesApplyAsSrt(100)
            .to(a -> a.must$(Be::equal$, (short)0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestToSrtFunc(functionThrowing)
         .doesApplyAsSrt(100).withException(a -> a
