...
import eu.lunisolar.magma.func.function.conversion.LFltToByteFunction;
...
public class LFltToByteFunctionAttestTest {

    private byte testValue = (byte)100;

    private LFltToByteFunction function = a ->
            testValue;


    private LFltToByteFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestFltToByteFunc(functionThrowing)
         .doesApplyAsByte(100f)
            .to(a -> a.must$(Be::equal$, (byte)0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestFltToByteFunc(functionThrowing)
         .doesApplyAsByte(100f).withException(a -> a
