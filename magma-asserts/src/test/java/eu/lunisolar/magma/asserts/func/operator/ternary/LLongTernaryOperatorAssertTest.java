...
import eu.lunisolar.magma.func.operator.ternary.LLongTernaryOperator;
...
public class LLongTernaryOperatorAssertTest {
    ...
    private LLongTernaryOperator function = (a1,a2,a3) ->
            testValue;


    private LLongTernaryOperator functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.attestLongTernaryOp(function)
         .doesApplyAsLong(100L,100L,100L)
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestLongTernaryOp(functionThrowing)
         .doesApplyAsLong(100L,100L,100L)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.attestLongTernaryOp(functionThrowing)
         .doesApplyAsLong(100L,100L,100L).withException(a -> a
