...
import eu.lunisolar.magma.func.supplier.LDblSupplier;
...
public class LDblSupplierAssertTest {
    ...
    private LDblSupplier functionThrowing = () -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestDblSup(functionThrowing)
         .doesGetAsDbl()
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.attestDblSup(functionThrowing)
         .doesGetAsDbl().withException(a -> a
