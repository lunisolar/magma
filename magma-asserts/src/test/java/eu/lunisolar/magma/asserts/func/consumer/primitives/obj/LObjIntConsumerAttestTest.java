...
public class LObjIntConsumerAttestTest<T> {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private LObjIntConsumer<Integer> function = (a1,a2) ->
            externalEffect.set(testValue);


    private LObjIntConsumer<Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjIntCons(functionThrowing)
         .doesAccept(100,100)
