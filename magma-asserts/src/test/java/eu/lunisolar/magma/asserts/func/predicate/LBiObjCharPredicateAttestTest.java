...
public class LBiObjCharPredicateAttestTest<T1,T2> {

    private boolean testValue = true;

    private LBiObjCharPredicate<Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LBiObjCharPredicate<Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiObjCharPred(functionThrowing)
         .doesTest(100,100,'\u0100')
            .to(a -> a.must$(Be::equal$, false));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestBiObjCharPred(functionThrowing)
         .doesTest(100,100,'\u0100').withException(a -> a
