...
import eu.lunisolar.magma.func.predicate.LTriBytePredicate;
...
public class LTriBytePredicateAttestTest {

    private boolean testValue = true;

    private LTriBytePredicate function = (a1,a2,a3) ->
            testValue;


    private LTriBytePredicate functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        FuncAttests.attestTriBytePred(function)
         .doesTest((byte)100,(byte)100,(byte)100)
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestTriBytePred(functionThrowing)
         .doesTest((byte)100,(byte)100,(byte)100)
            .to(a -> a.mustEx(Be::equalEx, false));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestTriBytePred(functionThrowing)
         .doesTest((byte)100,(byte)100,(byte)100).withException(a -> a
