...
public class LBiObjFltConsumerAttestTest<T1,T2> {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private LBiObjFltConsumer<Integer,Integer> function = (a1,a2,a3) ->
            externalEffect.set(testValue);


    private LBiObjFltConsumer<Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiObjFltCons(functionThrowing)
         .doesAccept(100,100,100f)
