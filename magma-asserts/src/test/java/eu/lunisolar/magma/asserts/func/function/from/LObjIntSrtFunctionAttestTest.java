...
public class LObjIntSrtFunctionAttestTest<T,R> {

    private Integer testValue = 100;

    private LObjIntSrtFunction<Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LObjIntSrtFunction<Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        FuncAttests.attestObjIntSrtFunc(function)
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjIntSrtFunc(functionThrowing)
         .doesApply(100,100,(short)100)
            .to(a -> a.mustEx(Be::equalEx, 0));
    }
