...
public class JreIntToDoubleFunctionAttestTest {

    private double testValue = 100d;

    private IntToDoubleFunction function = a ->
            testValue;


    private IntToDoubleFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestIntToDblFunc(functionThrowing)
         .doesApplyAsDbl(100)
            .to(a -> a.must$(Be::equal$, 0d));
    }
