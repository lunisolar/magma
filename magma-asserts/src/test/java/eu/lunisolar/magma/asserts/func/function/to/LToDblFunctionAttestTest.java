...
import eu.lunisolar.magma.func.function.to.LToDblFunction;
...
public class LToDblFunctionAttestTest<T> {

    private double testValue = 100d;

    private LToDblFunction<Integer> function = a ->
            testValue;


    private LToDblFunction<Integer> functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestToDblFunc(functionThrowing)
         .doesApplyAsDbl(100)
            .to(a -> a.mustEx(Be::equalEx, 0d));
    }
