...
import eu.lunisolar.magma.func.supplier.LByteSupplier;
...
public class LByteSupplierAssertTest {
    ...
    private LByteSupplier functionThrowing = () -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestByteSup(functionThrowing)
         .doesGetAsByte()
            .to( a -> a.isEqualTo(1));
    }
