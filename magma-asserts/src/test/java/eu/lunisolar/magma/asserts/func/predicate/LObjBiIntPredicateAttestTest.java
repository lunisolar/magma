...
public class LObjBiIntPredicateAttestTest<T> {

    private boolean testValue = true;

    private LObjBiIntPredicate<Integer> function = (a1,a2,a3) ->
            testValue;


    private LObjBiIntPredicate<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjBiIntPred(functionThrowing)
         .doesTest(100,100,100)
            .to(a -> a.must$(Be::equal$, false));
    }
