...
import eu.lunisolar.magma.func.predicate.LTriFltPredicate;
...
public class LTriFltPredicateAssertTest {
    ...
    private LTriFltPredicate function = (a1,a2,a3) ->
            testValue;


    private LTriFltPredicate functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestTriFltPred(functionThrowing)
         .doesTest(100f,100f,100f)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.attestTriFltPred(functionThrowing)
         .doesTest(100f,100f,100f).withException(a -> a
