...
public class LBiBoolConsumerAttestTest {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private LBiBoolConsumer function = (a1,a2) ->
            externalEffect.set(testValue);


    private LBiBoolConsumer functionThrowing = (a1,a2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        FuncAttests.attestBiBoolCons(function)
         .doesAccept(true,true)
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiBoolCons(functionThrowing)
         .doesAccept(true,true)
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestBiBoolCons(functionThrowing)
         .doesAccept(true,true).withException(a -> a
