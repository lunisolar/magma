...
public class LBiObjDblFunctionAttestTest<T1,T2,R> {

    private Integer testValue = 100;

    private LBiObjDblFunction<Integer,Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LBiObjDblFunction<Integer,Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiObjDblFunc(functionThrowing)
         .doesApply(100,100,100d)
            .to(a -> a.mustEx(Be::equalEx, 0));
    }
