...
public class LObjIntFltPredicateAttestTest<T> {

    private boolean testValue = true;

    private LObjIntFltPredicate<Integer> function = (a1,a2,a3) ->
            testValue;


    private LObjIntFltPredicate<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjIntFltPred(functionThrowing)
         .doesTest(100,100,100f)
            .to(a -> a.must$(Be::equal$, false));
    }
