...
public class LTieSrtFunctionAttestTest<T> {

    private int testValue = 100;

    private LTieSrtFunction<Integer> function = (a1,a2,a3) ->
            testValue;


    private LTieSrtFunction<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        FuncAttests.attestTieSrtFunc(function)
         .doesApplyAsInt(100,100,(short)100)
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestTieSrtFunc(functionThrowing)
         .doesApplyAsInt(100,100,(short)100)
            .to(a -> a.must$(Be::equal$, 0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestTieSrtFunc(functionThrowing)
         .doesApplyAsInt(100,100,(short)100).withException(a -> a
