...
public class LObjIntCharFunctionAttestTest<T,R> {

    private Integer testValue = 100;

    private LObjIntCharFunction<Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LObjIntCharFunction<Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjIntCharFunc(functionThrowing)
         .doesApply(100,100,'\u0100')
            .to(a -> a.mustEx(Be::equalEx, 0));
    }
