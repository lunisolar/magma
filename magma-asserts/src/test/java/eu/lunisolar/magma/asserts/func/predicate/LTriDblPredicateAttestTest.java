...
import eu.lunisolar.magma.func.predicate.LTriDblPredicate;
...
public class LTriDblPredicateAttestTest {

    private boolean testValue = true;

    private LTriDblPredicate function = (a1,a2,a3) ->
            testValue;


    private LTriDblPredicate functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestTriDblPred(functionThrowing)
         .doesTest(100d,100d,100d)
            .to(a -> a.must$(Be::equal$, false));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestTriDblPred(functionThrowing)
         .doesTest(100d,100d,100d).withException(a -> a
