...
public class LObjIntBytePredicateAttestTest<T> {

    private boolean testValue = true;

    private LObjIntBytePredicate<Integer> function = (a1,a2,a3) ->
            testValue;


    private LObjIntBytePredicate<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjIntBytePred(functionThrowing)
         .doesTest(100,100,(byte)100)
            .to(a -> a.must$(Be::equal$, false));
    }
