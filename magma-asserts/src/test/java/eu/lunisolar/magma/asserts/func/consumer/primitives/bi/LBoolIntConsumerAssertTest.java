...
public class LBoolIntConsumerAssertTest {
    ...
    private LBoolIntConsumer function = (a1,a2) ->
            externalEffect.set(testValue);


    private LBoolIntConsumer functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertBoolIntCons(functionThrowing)
         .doesAccept(true,100)
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertBoolIntCons(functionThrowing)
         .doesAccept(true,100).withException(a -> a
