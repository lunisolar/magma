...
public class LTieIntFunctionAttestTest<T> {

    private int testValue = 100;

    private LTieIntFunction<Integer> function = (a1,a2,a3) ->
            testValue;


    private LTieIntFunction<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestTieIntFunc(functionThrowing)
         .doesApplyAsInt(100,100,100)
            .to(a -> a.must$(Be::equal$, 0));
    }
