...
import eu.lunisolar.magma.func.function.conversion.LIntToByteFunction;
...
public class LIntToByteFunctionAssertTest {
    ...
    private LIntToByteFunction function = a ->
            testValue;


    private LIntToByteFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestIntToByteFunc(functionThrowing)
         .doesApplyAsByte(100)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.attestIntToByteFunc(functionThrowing)
         .doesApplyAsByte(100).withException(a -> a
