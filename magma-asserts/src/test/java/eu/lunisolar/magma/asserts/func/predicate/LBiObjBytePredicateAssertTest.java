...
public class LBiObjBytePredicateAssertTest<T1,T2> {
    ...
    private LBiObjBytePredicate<Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LBiObjBytePredicate<Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.attestBiObjBytePred(function)
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestBiObjBytePred(functionThrowing)
         .doesTest(100,100,(byte)100)
            .to( a -> a.isEqualTo(1));
    }
