...
import eu.lunisolar.magma.func.function.from.LCharFunction;
...
public class LCharFunctionAttestTest<R> {

    private Integer testValue = 100;

    private LCharFunction<Integer> function = a ->
            testValue;


    private LCharFunction<Integer> functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestCharFunc(functionThrowing)
         .doesApply('\u0100')
            .to(a -> a.must$(Be::equal$, 0));
    }
