...
public class LBiConsumerAttestTest<T1,T2> {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private LBiConsumer<Integer,Integer> function = (a1,a2) ->
            externalEffect.set(testValue);


    private LBiConsumer<Integer,Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiCons(functionThrowing)
         .doesAccept(100,100)
