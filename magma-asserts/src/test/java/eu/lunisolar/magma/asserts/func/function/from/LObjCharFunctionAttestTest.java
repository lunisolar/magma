...
public class LObjCharFunctionAttestTest<T,R> {

    private Integer testValue = 100;

    private LObjCharFunction<Integer,Integer> function = (a1,a2) ->
            testValue;


    private LObjCharFunction<Integer,Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        FuncAttests.attestObjCharFunc(function)
         .doesApply(100,'\u0100')
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjCharFunc(functionThrowing)
         .doesApply(100,'\u0100')
            .to(a -> a.mustEx(Be::equalEx, 0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestObjCharFunc(functionThrowing)
         .doesApply(100,'\u0100').withException(a -> a
