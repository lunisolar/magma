...
public class LObjBytePredicateAttestTest<T> {

    private boolean testValue = true;

    private LObjBytePredicate<Integer> function = (a1,a2) ->
            testValue;


    private LObjBytePredicate<Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjBytePred(functionThrowing)
         .doesTest(100,(byte)100)
            .to(a -> a.must$(Be::equal$, false));
    }
