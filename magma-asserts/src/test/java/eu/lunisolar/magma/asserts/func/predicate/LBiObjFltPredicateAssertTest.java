...
public class LBiObjFltPredicateAssertTest<T1,T2> {
    ...
    private LBiObjFltPredicate<Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LBiObjFltPredicate<Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestBiObjFltPred(functionThrowing)
         .doesTest(100,100,100f)
            .to( a -> a.isEqualTo(1));
    }
