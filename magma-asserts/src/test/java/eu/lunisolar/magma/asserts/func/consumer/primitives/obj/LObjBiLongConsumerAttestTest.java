...
public class LObjBiLongConsumerAttestTest<T> {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private LObjBiLongConsumer<Integer> function = (a1,a2,a3) ->
            externalEffect.set(testValue);


    private LObjBiLongConsumer<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjBiLongCons(functionThrowing)
         .doesAccept(100,100L,100L)
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestObjBiLongCons(functionThrowing)
         .doesAccept(100,100L,100L).withException(a -> a
