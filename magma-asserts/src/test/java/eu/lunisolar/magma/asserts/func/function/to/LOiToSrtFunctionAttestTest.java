...
public class LOiToSrtFunctionAttestTest<T> {

    private short testValue = (short)100;

    private LOiToSrtFunction<Integer> function = (a1,a2) ->
            testValue;


    private LOiToSrtFunction<Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestOiToSrtFunc(functionThrowing)
         .doesApplyAsSrt(100,100)
            .to(a -> a.must$(Be::equal$, (short)0));
    }
