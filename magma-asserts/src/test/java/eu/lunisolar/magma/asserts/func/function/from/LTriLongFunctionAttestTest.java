...
import eu.lunisolar.magma.func.function.from.LTriLongFunction;
...
public class LTriLongFunctionAttestTest<R> {

    private Integer testValue = 100;

    private LTriLongFunction<Integer> function = (a1,a2,a3) ->
            testValue;


    private LTriLongFunction<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestTriLongFunc(functionThrowing)
         .doesApply(100L,100L,100L)
            .to(a -> a.must$(Be::equal$, 0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestTriLongFunc(functionThrowing)
         .doesApply(100L,100L,100L).withException(a -> a
