...
import eu.lunisolar.magma.func.operator.ternary.LCharTernaryOperator;
...
public class LCharTernaryOperatorAttestTest {

    private char testValue = '\u0100';

    private LCharTernaryOperator function = (a1,a2,a3) ->
            testValue;


    private LCharTernaryOperator functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestCharTernaryOp(functionThrowing)
         .doesApplyAsChar('\u0100','\u0100','\u0100')
            .to(a -> a.must$(Be::equal$, '\u0000'));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestCharTernaryOp(functionThrowing)
         .doesApplyAsChar('\u0100','\u0100','\u0100').withException(a -> a
