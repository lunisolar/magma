...
public class LObjBiIntFunctionAttestTest<T,R> {

    private Integer testValue = 100;

    private LObjBiIntFunction<Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LObjBiIntFunction<Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjBiIntFunc(functionThrowing)
         .doesApply(100,100,100)
            .to(a -> a.mustEx(Be::equalEx, 0));
    }
