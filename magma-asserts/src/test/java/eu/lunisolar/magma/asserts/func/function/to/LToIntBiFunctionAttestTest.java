...
public class LToIntBiFunctionAttestTest<T1,T2> {

    private int testValue = 100;

    private LToIntBiFunction<Integer,Integer> function = (a1,a2) ->
            testValue;


    private LToIntBiFunction<Integer,Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestToIntBiFunc(functionThrowing)
         .doesApplyAsInt(100,100)
            .to(a -> a.must$(Be::equal$, 0));
    }
