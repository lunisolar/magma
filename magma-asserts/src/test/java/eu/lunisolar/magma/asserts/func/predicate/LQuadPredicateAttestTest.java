...
import eu.lunisolar.magma.func.predicate.LQuadPredicate;
...
public class LQuadPredicateAttestTest<T1,T2,T3,T4> {

    private boolean testValue = true;

    private LQuadPredicate<Integer,Integer,Integer,Integer> function = (a1,a2,a3,a4) ->
            testValue;


    private LQuadPredicate<Integer,Integer,Integer,Integer> functionThrowing = (a1,a2,a3,a4) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestQuadPred(functionThrowing)
         .doesTest(100,100,100,100)
            .to(a -> a.must$(Be::equal$, false));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestQuadPred(functionThrowing)
         .doesTest(100,100,100,100).withException(a -> a
