...
public class LToSrtBiFunctionAttestTest<T1,T2> {

    private short testValue = (short)100;

    private LToSrtBiFunction<Integer,Integer> function = (a1,a2) ->
            testValue;


    private LToSrtBiFunction<Integer,Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestToSrtBiFunc(functionThrowing)
         .doesApplyAsSrt(100,100)
            .to(a -> a.must$(Be::equal$, (short)0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestToSrtBiFunc(functionThrowing)
         .doesApplyAsSrt(100,100).withException(a -> a
