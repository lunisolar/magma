...
import eu.lunisolar.magma.func.function.conversion.LLongToDblFunction;
...
public class LLongToDblFunctionAttestTest {

    private double testValue = 100d;

    private LLongToDblFunction function = a ->
            testValue;


    private LLongToDblFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestLongToDblFunc(functionThrowing)
         .doesApplyAsDbl(100L)
            .to(a -> a.mustEx(Be::equalEx, 0d));
    }
