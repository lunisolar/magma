...
import eu.lunisolar.magma.func.consumer.primitives.tri.LTriCharConsumer;
...
public class LTriCharConsumerAttestTest {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private LTriCharConsumer function = (a1,a2,a3) ->
            externalEffect.set(testValue);


    private LTriCharConsumer functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestTriCharCons(functionThrowing)
         .doesAccept('\u0100','\u0100','\u0100')
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestTriCharCons(functionThrowing)
         .doesAccept('\u0100','\u0100','\u0100').withException(a -> a
