...
public class LTriConsumerAttestTest<T1,T2,T3> {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private LTriConsumer<Integer,Integer,Integer> function = (a1,a2,a3) ->
            externalEffect.set(testValue);


    private LTriConsumer<Integer,Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestTriCons(functionThrowing)
         .doesAccept(100,100,100)
