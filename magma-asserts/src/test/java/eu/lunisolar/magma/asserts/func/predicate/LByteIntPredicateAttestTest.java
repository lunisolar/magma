...
public class LByteIntPredicateAttestTest {

    private boolean testValue = true;

    private LByteIntPredicate function = (a1,a2) ->
            testValue;


    private LByteIntPredicate functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestByteIntPred(functionThrowing)
         .doesTest((byte)100,100)
            .to(a -> a.must$(Be::equal$, false));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestByteIntPred(functionThrowing)
         .doesTest((byte)100,100).withException(a -> a
