...
import eu.lunisolar.magma.func.function.to.LToCharFunction;
...
public class LToCharFunctionAssertTest<T> {
    ...
    private LToCharFunction<Integer> function = a ->
            testValue;


    private LToCharFunction<Integer> functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertToCharFunc(functionThrowing)
         .doesApplyAsChar(100)
            .to( a -> a.isEqualTo(1));
    }
