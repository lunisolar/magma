...
public class LTieCharConsumerAttestTest<T> {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private LTieCharConsumer<Integer> function = (a1,a2,a3) ->
            externalEffect.set(testValue);


    private LTieCharConsumer<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestTieCharCons(functionThrowing)
         .doesAccept(100,100,'\u0100')
