...
public class LObjIntByteFunctionAttestTest<T,R> {

    private Integer testValue = 100;

    private LObjIntByteFunction<Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LObjIntByteFunction<Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjIntByteFunc(functionThrowing)
         .doesApply(100,100,(byte)100)
            .to(a -> a.must$(Be::equal$, 0));
    }
