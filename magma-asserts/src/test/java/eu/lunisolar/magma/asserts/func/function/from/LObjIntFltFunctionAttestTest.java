...
public class LObjIntFltFunctionAttestTest<T,R> {

    private Integer testValue = 100;

    private LObjIntFltFunction<Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LObjIntFltFunction<Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjIntFltFunc(functionThrowing)
         .doesApply(100,100,100f)
            .to(a -> a.mustEx(Be::equalEx, 0));
    }
