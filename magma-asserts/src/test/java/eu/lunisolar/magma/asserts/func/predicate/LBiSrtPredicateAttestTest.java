...
public class LBiSrtPredicateAttestTest {

    private boolean testValue = true;

    private LBiSrtPredicate function = (a1,a2) ->
            testValue;


    private LBiSrtPredicate functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiSrtPred(functionThrowing)
         .doesTest((short)100,(short)100)
            .to(a -> a.must$(Be::equal$, false));
    }
