...
import eu.lunisolar.magma.func.function.conversion.LBoolToCharFunction;
...
public class LBoolToCharFunctionAttestTest {

    private char testValue = '\u0100';

    private LBoolToCharFunction function = a ->
            testValue;


    private LBoolToCharFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBoolToCharFunc(functionThrowing)
         .doesApplyAsChar(true)
            .to(a -> a.must$(Be::equal$, '\u0000'));
    }
