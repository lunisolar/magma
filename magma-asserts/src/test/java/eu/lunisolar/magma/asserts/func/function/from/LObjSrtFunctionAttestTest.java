...
public class LObjSrtFunctionAttestTest<T,R> {

    private Integer testValue = 100;

    private LObjSrtFunction<Integer,Integer> function = (a1,a2) ->
            testValue;


    private LObjSrtFunction<Integer,Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjSrtFunc(functionThrowing)
         .doesApply(100,(short)100)
            .to(a -> a.mustEx(Be::equalEx, 0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestObjSrtFunc(functionThrowing)
         .doesApply(100,(short)100).withException(a -> a
