...
import eu.lunisolar.magma.func.operator.unary.LCharUnaryOperator;
...
public class LCharUnaryOperatorAttestTest {

    private char testValue = '\u0100';

    private LCharUnaryOperator function = a ->
            testValue;


    private LCharUnaryOperator functionThrowing = a -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        FuncAttests.attestCharUnaryOp(function)
         .doesApplyAsChar('\u0100')
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestCharUnaryOp(functionThrowing)
         .doesApplyAsChar('\u0100')
            .to(a -> a.mustEx(Be::equalEx, '\u0000'));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestCharUnaryOp(functionThrowing)
         .doesApplyAsChar('\u0100').withException(a -> a
