...
public class LSrtIntPredicateAssertTest {
    ...
    private LSrtIntPredicate function = (a1,a2) ->
            testValue;


    private LSrtIntPredicate functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertSrtIntPred(functionThrowing)
         .doesTest((short)100,100)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertSrtIntPred(functionThrowing)
         .doesTest((short)100,100).withException(a -> a
