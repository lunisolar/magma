...
import eu.lunisolar.magma.func.function.conversion.LByteToLongFunction;
...
public class LByteToLongFunctionAttestTest {

    private long testValue = 100L;

    private LByteToLongFunction function = a ->
            testValue;


    private LByteToLongFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestByteToLongFunc(functionThrowing)
         .doesApplyAsLong((byte)100)
            .to(a -> a.must$(Be::equal$, 0L));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestByteToLongFunc(functionThrowing)
         .doesApplyAsLong((byte)100).withException(a -> a
