...
import eu.lunisolar.magma.func.function.conversion.LFltToDblFunction;
...
public class LFltToDblFunctionAssertTest {
    ...
    private LFltToDblFunction function = a ->
            testValue;


    private LFltToDblFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestFltToDblFunc(functionThrowing)
         .doesApplyAsDbl(100f)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.attestFltToDblFunc(functionThrowing)
         .doesApplyAsDbl(100f).withException(a -> a
