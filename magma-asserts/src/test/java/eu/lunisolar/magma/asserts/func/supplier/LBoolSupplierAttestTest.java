...
import eu.lunisolar.magma.func.supplier.LBoolSupplier;
...
public class LBoolSupplierAttestTest {
    ...
    private LBoolSupplier functionThrowing = () -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBoolSup(functionThrowing)
         .doesGetAsBool()
            .to(a -> a.mustEx(Be::equalEx, false));
    }
