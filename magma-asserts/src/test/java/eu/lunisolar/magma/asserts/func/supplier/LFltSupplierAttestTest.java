...
import eu.lunisolar.magma.func.supplier.LFltSupplier;
...
public class LFltSupplierAttestTest {
    ...
    private LFltSupplier functionThrowing = () -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestFltSup(functionThrowing)
         .doesGetAsFlt()
            .to(a -> a.must$(Be::equal$, 0f));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestFltSup(functionThrowing)
         .doesGetAsFlt().withException(a -> a
