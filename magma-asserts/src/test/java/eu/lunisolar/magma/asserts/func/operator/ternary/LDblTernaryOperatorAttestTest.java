...
import eu.lunisolar.magma.func.operator.ternary.LDblTernaryOperator;
...
public class LDblTernaryOperatorAttestTest {

    private double testValue = 100d;

    private LDblTernaryOperator function = (a1,a2,a3) ->
            testValue;


    private LDblTernaryOperator functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestDblTernaryOp(functionThrowing)
         .doesApplyAsDbl(100d,100d,100d)
            .to(a -> a.mustEx(Be::equalEx, 0d));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestDblTernaryOp(functionThrowing)
         .doesApplyAsDbl(100d,100d,100d).withException(a -> a
