...
import eu.lunisolar.magma.func.function.conversion.LSrtToFltFunction;
...
public class LSrtToFltFunctionAttestTest {

    private float testValue = 100f;

    private LSrtToFltFunction function = a ->
            testValue;


    private LSrtToFltFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestSrtToFltFunc(functionThrowing)
         .doesApplyAsFlt((short)100)
            .to(a -> a.mustEx(Be::equalEx, 0f));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestSrtToFltFunc(functionThrowing)
         .doesApplyAsFlt((short)100).withException(a -> a
