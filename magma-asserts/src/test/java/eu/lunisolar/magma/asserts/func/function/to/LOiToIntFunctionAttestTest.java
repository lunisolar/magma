...
public class LOiToIntFunctionAttestTest<T> {

    private int testValue = 100;

    private LOiToIntFunction<Integer> function = (a1,a2) ->
            testValue;


    private LOiToIntFunction<Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestOiToIntFunc(functionThrowing)
         .doesApplyAsInt(100,100)
            .to(a -> a.mustEx(Be::equalEx, 0));
    }
