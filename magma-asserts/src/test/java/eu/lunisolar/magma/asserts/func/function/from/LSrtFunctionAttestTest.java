...
public class LSrtFunctionAttestTest<R> {

    private Integer testValue = 100;

    private LSrtFunction<Integer> function = a ->
            testValue;


    private LSrtFunction<Integer> functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestSrtFunc(functionThrowing)
         .doesApply((short)100)
            .to(a -> a.must$(Be::equal$, 0));
    }
