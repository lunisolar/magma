...
import eu.lunisolar.magma.func.function.conversion.LDblToLongFunction;
...
public class LDblToLongFunctionAssertTest {
    ...
    private LDblToLongFunction function = a ->
            testValue;


    private LDblToLongFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestDblToLongFunc(functionThrowing)
         .doesApplyAsLong(100d)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.attestDblToLongFunc(functionThrowing)
         .doesApplyAsLong(100d).withException(a -> a
