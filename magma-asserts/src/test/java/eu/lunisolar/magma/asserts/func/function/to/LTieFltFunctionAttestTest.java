...
public class LTieFltFunctionAttestTest<T> {

    private int testValue = 100;

    private LTieFltFunction<Integer> function = (a1,a2,a3) ->
            testValue;


    private LTieFltFunction<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestTieFltFunc(functionThrowing)
         .doesApplyAsInt(100,100,100f)
            .to(a -> a.must$(Be::equal$, 0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestTieFltFunc(functionThrowing)
         .doesApplyAsInt(100,100,100f).withException(a -> a
