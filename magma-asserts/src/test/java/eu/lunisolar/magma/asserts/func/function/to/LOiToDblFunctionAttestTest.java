...
public class LOiToDblFunctionAttestTest<T> {

    private double testValue = 100d;

    private LOiToDblFunction<Integer> function = (a1,a2) ->
            testValue;


    private LOiToDblFunction<Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestOiToDblFunc(functionThrowing)
         .doesApplyAsDbl(100,100)
            .to(a -> a.must$(Be::equal$, 0d));
    }
