...
public class LLogicalTernaryOperatorAttestTest {

    private boolean testValue = true;

    private LLogicalTernaryOperator function = (a1,a2,a3) ->
            testValue;


    private LLogicalTernaryOperator functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestLogicalTernaryOp(functionThrowing)
         .doesApply(true,true,true)
            .to(a -> a.mustEx(Be::equalEx, false));
    }
