...
public class LToIntTriFunctionAttestTest<T1,T2,T3> {

    private int testValue = 100;

    private LToIntTriFunction<Integer,Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LToIntTriFunction<Integer,Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestToIntTriFunc(functionThrowing)
         .doesApplyAsInt(100,100,100)
            .to(a -> a.must$(Be::equal$, 0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestToIntTriFunc(functionThrowing)
         .doesApplyAsInt(100,100,100).withException(a -> a
