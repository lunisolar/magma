...
import eu.lunisolar.magma.func.function.conversion.LLongToIntFunction;
...
public class LLongToIntFunctionAttestTest {

    private int testValue = 100;

    private LLongToIntFunction function = a ->
            testValue;


    private LLongToIntFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestLongToIntFunc(functionThrowing)
         .doesApplyAsInt(100L)
            .to(a -> a.must$(Be::equal$, 0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestLongToIntFunc(functionThrowing)
         .doesApplyAsInt(100L).withException(a -> a
