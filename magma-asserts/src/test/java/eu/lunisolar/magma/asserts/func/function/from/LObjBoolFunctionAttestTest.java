...
public class LObjBoolFunctionAttestTest<T,R> {

    private Integer testValue = 100;

    private LObjBoolFunction<Integer,Integer> function = (a1,a2) ->
            testValue;


    private LObjBoolFunction<Integer,Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjBoolFunc(functionThrowing)
         .doesApply(100,true)
            .to(a -> a.must$(Be::equal$, 0));
    }
