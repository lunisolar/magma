...
import eu.lunisolar.magma.func.function.from.LTriSrtFunction;
...
public class LTriSrtFunctionAssertTest<R> {
    ...
    private LTriSrtFunction<Integer> function = (a1,a2,a3) ->
            testValue;


    private LTriSrtFunction<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.attestTriSrtFunc(function)
         .doesApply((short)100,(short)100,(short)100)
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestTriSrtFunc(functionThrowing)
         .doesApply((short)100,(short)100,(short)100)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.attestTriSrtFunc(functionThrowing)
         .doesApply((short)100,(short)100,(short)100).withException(a -> a
