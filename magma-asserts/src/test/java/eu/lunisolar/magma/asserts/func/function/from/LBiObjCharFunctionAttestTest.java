...
public class LBiObjCharFunctionAttestTest<T1,T2,R> {

    private Integer testValue = 100;

    private LBiObjCharFunction<Integer,Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LBiObjCharFunction<Integer,Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiObjCharFunc(functionThrowing)
         .doesApply(100,100,'\u0100')
            .to(a -> a.must$(Be::equal$, 0));
    }
