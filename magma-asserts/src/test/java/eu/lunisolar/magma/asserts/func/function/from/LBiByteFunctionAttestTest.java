...
public class LBiByteFunctionAttestTest<R> {

    private Integer testValue = 100;

    private LBiByteFunction<Integer> function = (a1,a2) ->
            testValue;


    private LBiByteFunction<Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiByteFunc(functionThrowing)
         .doesApply((byte)100,(byte)100)
            .to(a -> a.must$(Be::equal$, 0));
    }
