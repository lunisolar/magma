...
public class LLongUnaryOperatorAttestTest {

    private long testValue = 100L;

    private LLongUnaryOperator function = a ->
            testValue;


    private LLongUnaryOperator functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestLongUnaryOp(functionThrowing)
         .doesApplyAsLong(100L)
            .to(a -> a.mustEx(Be::equalEx, 0L));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestLongUnaryOp(functionThrowing)
         .doesApplyAsLong(100L).withException(a -> a
