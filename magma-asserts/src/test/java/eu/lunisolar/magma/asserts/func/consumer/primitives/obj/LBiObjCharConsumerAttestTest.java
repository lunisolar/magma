...
public class LBiObjCharConsumerAttestTest<T1,T2> {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private LBiObjCharConsumer<Integer,Integer> function = (a1,a2,a3) ->
            externalEffect.set(testValue);


    private LBiObjCharConsumer<Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiObjCharCons(functionThrowing)
         .doesAccept(100,100,'\u0100')
