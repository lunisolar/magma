...
import eu.lunisolar.magma.func.function.to.LToLongFunction;
...
public class LToLongFunctionAssertTest<T> {
    ...
    private LToLongFunction<Integer> function = a ->
            testValue;


    private LToLongFunction<Integer> functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestToLongFunc(functionThrowing)
         .doesApplyAsLong(100)
            .to( a -> a.isEqualTo(1));
    }
