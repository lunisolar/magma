...
import eu.lunisolar.magma.func.consumer.primitives.tri.LTriIntConsumer;
...
public class LTriIntConsumerAttestTest {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private LTriIntConsumer function = (a1,a2,a3) ->
            externalEffect.set(testValue);


    private LTriIntConsumer functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestTriIntCons(functionThrowing)
         .doesAccept(100,100,100)
