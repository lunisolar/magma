...
public class LBoolIntPredicateAssertTest {
    ...
    private LBoolIntPredicate function = (a1,a2) ->
            testValue;


    private LBoolIntPredicate functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestBoolIntPred(functionThrowing)
         .doesTest(true,100)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.attestBoolIntPred(functionThrowing)
         .doesTest(true,100).withException(a -> a
