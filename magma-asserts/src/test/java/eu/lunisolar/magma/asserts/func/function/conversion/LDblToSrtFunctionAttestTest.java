...
import eu.lunisolar.magma.func.function.conversion.LDblToSrtFunction;
...
public class LDblToSrtFunctionAttestTest {

    private short testValue = (short)100;

    private LDblToSrtFunction function = a ->
            testValue;


    private LDblToSrtFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestDblToSrtFunc(functionThrowing)
         .doesApplyAsSrt(100d)
            .to(a -> a.must$(Be::equal$, (short)0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestDblToSrtFunc(functionThrowing)
         .doesApplyAsSrt(100d).withException(a -> a
