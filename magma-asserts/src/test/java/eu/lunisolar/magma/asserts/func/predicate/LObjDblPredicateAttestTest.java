...
public class LObjDblPredicateAttestTest<T> {

    private boolean testValue = true;

    private LObjDblPredicate<Integer> function = (a1,a2) ->
            testValue;


    private LObjDblPredicate<Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjDblPred(functionThrowing)
         .doesTest(100,100d)
            .to(a -> a.mustEx(Be::equalEx, false));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestObjDblPred(functionThrowing)
         .doesTest(100,100d).withException(a -> a
