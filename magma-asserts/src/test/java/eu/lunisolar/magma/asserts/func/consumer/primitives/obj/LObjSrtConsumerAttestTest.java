...
public class LObjSrtConsumerAttestTest<T> {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private LObjSrtConsumer<Integer> function = (a1,a2) ->
            externalEffect.set(testValue);


    private LObjSrtConsumer<Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjSrtCons(functionThrowing)
         .doesAccept(100,(short)100)
