...
import eu.lunisolar.magma.func.function.conversion.LLongToFltFunction;
...
public class LLongToFltFunctionAssertTest {
    ...
    private LLongToFltFunction function = a ->
            testValue;


    private LLongToFltFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertLongToFltFunc(functionThrowing)
         .doesApplyAsFlt(100L)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertLongToFltFunc(functionThrowing)
         .doesApplyAsFlt(100L).withException(a -> a
