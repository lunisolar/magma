...
import eu.lunisolar.magma.func.predicate.LCharPredicate;
...
public class LCharPredicateAttestTest {

    private boolean testValue = true;

    private LCharPredicate function = a ->
            testValue;


    private LCharPredicate functionThrowing = a -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        FuncAttests.attestCharPred(function)
         .doesTest('\u0100')
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestCharPred(functionThrowing)
         .doesTest('\u0100')
            .to(a -> a.must$(Be::equal$, false));
    }
