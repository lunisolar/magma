...
import eu.lunisolar.magma.func.predicate.LQuintPredicate;
...
public class LQuintPredicateAttestTest<T1,T2,T3,T4,T5> {

    private boolean testValue = true;

    private LQuintPredicate<Integer,Integer,Integer,Integer,Integer> function = (a1,a2,a3,a4,a5) ->
            testValue;


    private LQuintPredicate<Integer,Integer,Integer,Integer,Integer> functionThrowing = (a1,a2,a3,a4,a5) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestQuintPred(functionThrowing)
         .doesTest(100,100,100,100,100)
            .to(a -> a.mustEx(Be::equalEx, false));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestQuintPred(functionThrowing)
         .doesTest(100,100,100,100,100).withException(a -> a
