...
public class LBiPredicateAssertTest<T1,T2> {
    ...
    private LBiPredicate<Integer,Integer> function = (a1,a2) ->
            testValue;


    private LBiPredicate<Integer,Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestBiPred(functionThrowing)
         .doesTest(100,100)
            .to( a -> a.isEqualTo(1));
    }
