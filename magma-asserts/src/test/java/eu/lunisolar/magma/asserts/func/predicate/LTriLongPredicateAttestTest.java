...
import eu.lunisolar.magma.func.predicate.LTriLongPredicate;
...
public class LTriLongPredicateAttestTest {

    private boolean testValue = true;

    private LTriLongPredicate function = (a1,a2,a3) ->
            testValue;


    private LTriLongPredicate functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestTriLongPred(functionThrowing)
         .doesTest(100L,100L,100L)
            .to(a -> a.must$(Be::equal$, false));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestTriLongPred(functionThrowing)
         .doesTest(100L,100L,100L).withException(a -> a
