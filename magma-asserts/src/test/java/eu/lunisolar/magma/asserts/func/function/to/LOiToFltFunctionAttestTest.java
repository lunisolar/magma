...
public class LOiToFltFunctionAttestTest<T> {

    private float testValue = 100f;

    private LOiToFltFunction<Integer> function = (a1,a2) ->
            testValue;


    private LOiToFltFunction<Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestOiToFltFunc(functionThrowing)
         .doesApplyAsFlt(100,100)
            .to(a -> a.must$(Be::equal$, 0f));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestOiToFltFunc(functionThrowing)
         .doesApplyAsFlt(100,100).withException(a -> a
