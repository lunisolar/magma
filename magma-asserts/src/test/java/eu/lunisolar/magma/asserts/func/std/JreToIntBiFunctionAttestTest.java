...
public class JreToIntBiFunctionAttestTest<T1,T2> {

    private int testValue = 100;

    private ToIntBiFunction<Integer,Integer> function = (a1,a2) ->
            testValue;


    private ToIntBiFunction<Integer,Integer> functionThrowing = (a1,a2) -> {
