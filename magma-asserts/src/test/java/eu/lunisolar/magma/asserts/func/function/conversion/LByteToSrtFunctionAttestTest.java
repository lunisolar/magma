...
import eu.lunisolar.magma.func.function.conversion.LByteToSrtFunction;
...
public class LByteToSrtFunctionAttestTest {

    private short testValue = (short)100;

    private LByteToSrtFunction function = a ->
            testValue;


    private LByteToSrtFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestByteToSrtFunc(functionThrowing)
         .doesApplyAsSrt((byte)100)
            .to(a -> a.must$(Be::equal$, (short)0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestByteToSrtFunc(functionThrowing)
         .doesApplyAsSrt((byte)100).withException(a -> a
