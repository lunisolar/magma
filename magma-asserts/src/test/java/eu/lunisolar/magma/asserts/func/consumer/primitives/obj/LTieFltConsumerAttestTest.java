...
public class LTieFltConsumerAttestTest<T> {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private LTieFltConsumer<Integer> function = (a1,a2,a3) ->
            externalEffect.set(testValue);


    private LTieFltConsumer<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestTieFltCons(functionThrowing)
         .doesAccept(100,100,100f)
