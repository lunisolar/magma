...
public class LObjBiLongFunctionAssertTest<T,R> {
    ...
    private LObjBiLongFunction<Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LObjBiLongFunction<Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestObjBiLongFunc(functionThrowing)
         .doesApply(100,100L,100L)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.attestObjBiLongFunc(functionThrowing)
         .doesApply(100,100L,100L).withException(a -> a
