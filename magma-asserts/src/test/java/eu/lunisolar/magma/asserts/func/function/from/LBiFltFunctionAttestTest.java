...
public class LBiFltFunctionAttestTest<R> {

    private Integer testValue = 100;

    private LBiFltFunction<Integer> function = (a1,a2) ->
            testValue;


    private LBiFltFunction<Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiFltFunc(functionThrowing)
         .doesApply(100f,100f)
            .to(a -> a.mustEx(Be::equalEx, 0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestBiFltFunc(functionThrowing)
         .doesApply(100f,100f).withException(a -> a
