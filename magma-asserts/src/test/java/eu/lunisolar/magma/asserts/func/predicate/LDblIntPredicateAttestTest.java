...
public class LDblIntPredicateAttestTest {

    private boolean testValue = true;

    private LDblIntPredicate function = (a1,a2) ->
            testValue;


    private LDblIntPredicate functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestDblIntPred(functionThrowing)
         .doesTest(100d,100)
            .to(a -> a.must$(Be::equal$, false));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestDblIntPred(functionThrowing)
         .doesTest(100d,100).withException(a -> a
