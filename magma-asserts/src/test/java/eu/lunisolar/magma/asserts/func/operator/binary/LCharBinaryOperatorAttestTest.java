...
import eu.lunisolar.magma.func.operator.binary.LCharBinaryOperator;
...
public class LCharBinaryOperatorAttestTest {

    private char testValue = '\u0100';

    private LCharBinaryOperator function = (a1,a2) ->
            testValue;


    private LCharBinaryOperator functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestCharBinaryOp(functionThrowing)
         .doesApplyAsChar('\u0100','\u0100')
            .to(a -> a.mustEx(Be::equalEx, '\u0000'));
    }
