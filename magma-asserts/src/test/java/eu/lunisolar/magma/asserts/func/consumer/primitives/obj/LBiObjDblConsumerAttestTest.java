...
public class LBiObjDblConsumerAttestTest<T1,T2> {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private LBiObjDblConsumer<Integer,Integer> function = (a1,a2,a3) ->
            externalEffect.set(testValue);


    private LBiObjDblConsumer<Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiObjDblCons(functionThrowing)
         .doesAccept(100,100,100d)
