...
import eu.lunisolar.magma.func.function.conversion.LLongToSrtFunction;
...
public class LLongToSrtFunctionAttestTest {

    private short testValue = (short)100;

    private LLongToSrtFunction function = a ->
            testValue;


    private LLongToSrtFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestLongToSrtFunc(functionThrowing)
         .doesApplyAsSrt(100L)
            .to(a -> a.must$(Be::equal$, (short)0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestLongToSrtFunc(functionThrowing)
         .doesApplyAsSrt(100L).withException(a -> a
