...
import eu.lunisolar.magma.func.operator.ternary.LByteTernaryOperator;
...
public class LByteTernaryOperatorAssertTest {
    ...
    private LByteTernaryOperator function = (a1,a2,a3) ->
            testValue;


    private LByteTernaryOperator functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.attestByteTernaryOp(function)
         .doesApplyAsByte((byte)100,(byte)100,(byte)100)
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestByteTernaryOp(functionThrowing)
         .doesApplyAsByte((byte)100,(byte)100,(byte)100)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.attestByteTernaryOp(functionThrowing)
         .doesApplyAsByte((byte)100,(byte)100,(byte)100).withException(a -> a
