...
import eu.lunisolar.magma.func.consumer.primitives.tri.LTriLongConsumer;
...
public class LTriLongConsumerAttestTest {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private LTriLongConsumer function = (a1,a2,a3) ->
            externalEffect.set(testValue);


    private LTriLongConsumer functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestTriLongCons(functionThrowing)
         .doesAccept(100L,100L,100L)
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestTriLongCons(functionThrowing)
         .doesAccept(100L,100L,100L).withException(a -> a
