...
public class LIntBinaryOperatorAttestTest {

    private int testValue = 100;

    private LIntBinaryOperator function = (a1,a2) ->
            testValue;


    private LIntBinaryOperator functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestIntBinaryOp(functionThrowing)
         .doesApplyAsInt(100,100)
            .to(a -> a.must$(Be::equal$, 0));
    }
