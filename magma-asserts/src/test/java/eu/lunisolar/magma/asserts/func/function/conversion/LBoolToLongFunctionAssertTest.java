...
import eu.lunisolar.magma.func.function.conversion.LBoolToLongFunction;
...
public class LBoolToLongFunctionAssertTest {
    ...
    private LBoolToLongFunction function = a ->
            testValue;


    private LBoolToLongFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestBoolToLongFunc(functionThrowing)
         .doesApplyAsLong(true)
            .to( a -> a.isEqualTo(1));
    }
