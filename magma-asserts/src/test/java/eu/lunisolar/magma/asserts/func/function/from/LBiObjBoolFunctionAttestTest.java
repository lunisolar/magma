...
public class LBiObjBoolFunctionAttestTest<T1,T2,R> {

    private Integer testValue = 100;

    private LBiObjBoolFunction<Integer,Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LBiObjBoolFunction<Integer,Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiObjBoolFunc(functionThrowing)
         .doesApply(100,100,true)
            .to(a -> a.must$(Be::equal$, 0));
    }
