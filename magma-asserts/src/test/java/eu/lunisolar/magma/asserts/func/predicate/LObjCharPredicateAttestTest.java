...
public class LObjCharPredicateAttestTest<T> {

    private boolean testValue = true;

    private LObjCharPredicate<Integer> function = (a1,a2) ->
            testValue;


    private LObjCharPredicate<Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjCharPred(functionThrowing)
         .doesTest(100,'\u0100')
            .to(a -> a.must$(Be::equal$, false));
    }
