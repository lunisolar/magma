...
import eu.lunisolar.magma.func.function.conversion.LByteToFltFunction;
...
public class LByteToFltFunctionAssertTest {
    ...
    private LByteToFltFunction function = a ->
            testValue;


    private LByteToFltFunction functionThrowing = a -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertByteToFltFunc(function)
         .doesApplyAsFlt((byte)100)
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertByteToFltFunc(functionThrowing)
         .doesApplyAsFlt((byte)100)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertByteToFltFunc(functionThrowing)
         .doesApplyAsFlt((byte)100).withException(a -> a
