...
public class LObjIntDblFunctionAttestTest<T,R> {

    private Integer testValue = 100;

    private LObjIntDblFunction<Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LObjIntDblFunction<Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjIntDblFunc(functionThrowing)
         .doesApply(100,100,100d)
            .to(a -> a.must$(Be::equal$, 0));
    }
