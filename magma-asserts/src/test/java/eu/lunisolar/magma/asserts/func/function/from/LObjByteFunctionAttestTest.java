...
public class LObjByteFunctionAttestTest<T,R> {

    private Integer testValue = 100;

    private LObjByteFunction<Integer,Integer> function = (a1,a2) ->
            testValue;


    private LObjByteFunction<Integer,Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjByteFunc(functionThrowing)
         .doesApply(100,(byte)100)
            .to(a -> a.must$(Be::equal$, 0));
    }
