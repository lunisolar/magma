...
import eu.lunisolar.magma.func.function.from.LTriByteFunction;
...
public class LTriByteFunctionAttestTest<R> {

    private Integer testValue = 100;

    private LTriByteFunction<Integer> function = (a1,a2,a3) ->
            testValue;


    private LTriByteFunction<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        FuncAttests.attestTriByteFunc(function)
         .doesApply((byte)100,(byte)100,(byte)100)
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestTriByteFunc(functionThrowing)
         .doesApply((byte)100,(byte)100,(byte)100)
            .to(a -> a.mustEx(Be::equalEx, 0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestTriByteFunc(functionThrowing)
         .doesApply((byte)100,(byte)100,(byte)100).withException(a -> a
