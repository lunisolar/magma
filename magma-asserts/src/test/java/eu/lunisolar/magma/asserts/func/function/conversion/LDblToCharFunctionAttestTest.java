...
import eu.lunisolar.magma.func.function.conversion.LDblToCharFunction;
...
public class LDblToCharFunctionAttestTest {

    private char testValue = '\u0100';

    private LDblToCharFunction function = a ->
            testValue;


    private LDblToCharFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestDblToCharFunc(functionThrowing)
         .doesApplyAsChar(100d)
            .to(a -> a.mustEx(Be::equalEx, '\u0000'));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestDblToCharFunc(functionThrowing)
         .doesApplyAsChar(100d).withException(a -> a
