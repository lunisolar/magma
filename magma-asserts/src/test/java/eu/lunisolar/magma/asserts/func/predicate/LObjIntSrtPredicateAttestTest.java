...
public class LObjIntSrtPredicateAttestTest<T> {

    private boolean testValue = true;

    private LObjIntSrtPredicate<Integer> function = (a1,a2,a3) ->
            testValue;


    private LObjIntSrtPredicate<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjIntSrtPred(functionThrowing)
         .doesTest(100,100,(short)100)
            .to(a -> a.mustEx(Be::equalEx, false));
    }
