...
public class JreObjDoubleConsumerAttestTest<T> {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private ObjDoubleConsumer<Integer> function = (a1,a2) ->
            externalEffect.set(testValue);


    private ObjDoubleConsumer<Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjDblCons(functionThrowing)
         .doesAccept(100,100d)
