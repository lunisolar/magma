...
import eu.lunisolar.magma.func.function.from.LTriIntFunction;
...
public class LTriIntFunctionAttestTest<R> {

    private Integer testValue = 100;

    private LTriIntFunction<Integer> function = (a1,a2,a3) ->
            testValue;


    private LTriIntFunction<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestTriIntFunc(functionThrowing)
         .doesApply(100,100,100)
            .to(a -> a.must$(Be::equal$, 0));
    }
