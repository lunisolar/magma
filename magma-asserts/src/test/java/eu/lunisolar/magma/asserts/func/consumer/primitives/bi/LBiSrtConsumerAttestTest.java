...
public class LBiSrtConsumerAttestTest {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private LBiSrtConsumer function = (a1,a2) ->
            externalEffect.set(testValue);


    private LBiSrtConsumer functionThrowing = (a1,a2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        FuncAttests.attestBiSrtCons(function)
         .doesAccept((short)100,(short)100)
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiSrtCons(functionThrowing)
         .doesAccept((short)100,(short)100)
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestBiSrtCons(functionThrowing)
         .doesAccept((short)100,(short)100).withException(a -> a
