...
public class LTieDblConsumerAttestTest<T> {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private LTieDblConsumer<Integer> function = (a1,a2,a3) ->
            externalEffect.set(testValue);


    private LTieDblConsumer<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestTieDblCons(functionThrowing)
         .doesAccept(100,100,100d)
