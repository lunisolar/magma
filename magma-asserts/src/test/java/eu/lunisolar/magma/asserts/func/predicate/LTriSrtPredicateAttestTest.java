...
import eu.lunisolar.magma.func.predicate.LTriSrtPredicate;
...
public class LTriSrtPredicateAttestTest {

    private boolean testValue = true;

    private LTriSrtPredicate function = (a1,a2,a3) ->
            testValue;


    private LTriSrtPredicate functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        FuncAttests.attestTriSrtPred(function)
         .doesTest((short)100,(short)100,(short)100)
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestTriSrtPred(functionThrowing)
         .doesTest((short)100,(short)100,(short)100)
            .to(a -> a.mustEx(Be::equalEx, false));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestTriSrtPred(functionThrowing)
         .doesTest((short)100,(short)100,(short)100).withException(a -> a
