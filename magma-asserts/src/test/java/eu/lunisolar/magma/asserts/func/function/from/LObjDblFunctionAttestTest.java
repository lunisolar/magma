...
public class LObjDblFunctionAttestTest<T,R> {

    private Integer testValue = 100;

    private LObjDblFunction<Integer,Integer> function = (a1,a2) ->
            testValue;


    private LObjDblFunction<Integer,Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjDblFunc(functionThrowing)
         .doesApply(100,100d)
            .to(a -> a.must$(Be::equal$, 0));
    }
