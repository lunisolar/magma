...
import eu.lunisolar.magma.func.consumer.primitives.tri.LTriFltConsumer;
...
public class LTriFltConsumerAttestTest {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private LTriFltConsumer function = (a1,a2,a3) ->
            externalEffect.set(testValue);


    private LTriFltConsumer functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestTriFltCons(functionThrowing)
         .doesAccept(100f,100f,100f)
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestTriFltCons(functionThrowing)
         .doesAccept(100f,100f,100f).withException(a -> a
