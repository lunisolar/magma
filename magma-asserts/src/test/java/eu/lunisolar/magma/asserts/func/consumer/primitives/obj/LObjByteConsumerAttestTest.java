...
public class LObjByteConsumerAttestTest<T> {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private LObjByteConsumer<Integer> function = (a1,a2) ->
            externalEffect.set(testValue);


    private LObjByteConsumer<Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjByteCons(functionThrowing)
         .doesAccept(100,(byte)100)
