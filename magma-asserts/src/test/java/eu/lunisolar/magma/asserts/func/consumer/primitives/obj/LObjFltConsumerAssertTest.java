...
public class LObjFltConsumerAssertTest<T> {
    ...
    private LObjFltConsumer<Integer> function = (a1,a2) ->
            externalEffect.set(testValue);


    private LObjFltConsumer<Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertObjFltCons(functionThrowing)
         .doesAccept(100,100f)
