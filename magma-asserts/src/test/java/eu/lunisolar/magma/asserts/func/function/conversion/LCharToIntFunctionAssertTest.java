...
import eu.lunisolar.magma.func.function.conversion.LCharToIntFunction;
...
public class LCharToIntFunctionAssertTest {
    ...
    private LCharToIntFunction function = a ->
            testValue;


    private LCharToIntFunction functionThrowing = a -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.attestCharToIntFunc(function)
         .doesApplyAsInt('\u0100')
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestCharToIntFunc(functionThrowing)
         .doesApplyAsInt('\u0100')
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.attestCharToIntFunc(functionThrowing)
         .doesApplyAsInt('\u0100').withException(a -> a
