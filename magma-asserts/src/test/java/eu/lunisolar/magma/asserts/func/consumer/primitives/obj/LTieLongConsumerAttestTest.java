...
public class LTieLongConsumerAttestTest<T> {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private LTieLongConsumer<Integer> function = (a1,a2,a3) ->
            externalEffect.set(testValue);


    private LTieLongConsumer<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestTieLongCons(functionThrowing)
         .doesAccept(100,100,100L)
