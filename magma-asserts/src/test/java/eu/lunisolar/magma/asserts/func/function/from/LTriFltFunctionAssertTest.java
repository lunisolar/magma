...
import eu.lunisolar.magma.func.function.from.LTriFltFunction;
...
public class LTriFltFunctionAssertTest<R> {
    ...
    private LTriFltFunction<Integer> function = (a1,a2,a3) ->
            testValue;


    private LTriFltFunction<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestTriFltFunc(functionThrowing)
         .doesApply(100f,100f,100f)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.attestTriFltFunc(functionThrowing)
         .doesApply(100f,100f,100f).withException(a -> a
