...
public class LObjLongPredicateAttestTest<T> {

    private boolean testValue = true;

    private LObjLongPredicate<Integer> function = (a1,a2) ->
            testValue;


    private LObjLongPredicate<Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestObjLongPred(functionThrowing)
         .doesTest(100,100L)
            .to(a -> a.must$(Be::equal$, false));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestObjLongPred(functionThrowing)
         .doesTest(100,100L).withException(a -> a
