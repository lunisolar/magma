...
import eu.lunisolar.magma.func.function.conversion.LDblToIntFunction;
...
public class LDblToIntFunctionAssertTest {
    ...
    private LDblToIntFunction function = a ->
            testValue;


    private LDblToIntFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestDblToIntFunc(functionThrowing)
         .doesApplyAsInt(100d)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.attestDblToIntFunc(functionThrowing)
         .doesApplyAsInt(100d).withException(a -> a
