...
public class LBiObjSrtFunctionAttestTest<T1,T2,R> {

    private Integer testValue = 100;

    private LBiObjSrtFunction<Integer,Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LBiObjSrtFunction<Integer,Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiObjSrtFunc(functionThrowing)
         .doesApply(100,100,(short)100)
            .to(a -> a.must$(Be::equal$, 0));
    }
