...
public class LOiToByteFunctionAssertTest<T> {
    ...
    private LOiToByteFunction<Integer> function = (a1,a2) ->
            testValue;


    private LOiToByteFunction<Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestOiToByteFunc(functionThrowing)
         .doesApplyAsByte(100,100)
            .to( a -> a.isEqualTo(1));
    }
