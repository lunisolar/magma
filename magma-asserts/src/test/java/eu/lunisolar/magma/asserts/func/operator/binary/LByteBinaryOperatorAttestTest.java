...
import eu.lunisolar.magma.func.operator.binary.LByteBinaryOperator;
...
public class LByteBinaryOperatorAttestTest {

    private byte testValue = (byte)100;

    private LByteBinaryOperator function = (a1,a2) ->
            testValue;


    private LByteBinaryOperator functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestByteBinaryOp(functionThrowing)
         .doesApplyAsByte((byte)100,(byte)100)
            .to(a -> a.must$(Be::equal$, (byte)0));
    }
