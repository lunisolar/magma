...
public class LIntTernaryOperatorAttestTest {

    private int testValue = 100;

    private LIntTernaryOperator function = (a1,a2,a3) ->
            testValue;


    private LIntTernaryOperator functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestIntTernaryOp(functionThrowing)
         .doesApplyAsInt(100,100,100)
            .to(a -> a.must$(Be::equal$, 0));
    }
