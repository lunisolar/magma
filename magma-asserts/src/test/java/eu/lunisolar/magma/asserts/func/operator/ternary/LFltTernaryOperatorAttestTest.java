...
import eu.lunisolar.magma.func.operator.ternary.LFltTernaryOperator;
...
public class LFltTernaryOperatorAttestTest {

    private float testValue = 100f;

    private LFltTernaryOperator function = (a1,a2,a3) ->
            testValue;


    private LFltTernaryOperator functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestFltTernaryOp(functionThrowing)
         .doesApplyAsFlt(100f,100f,100f)
            .to(a -> a.must$(Be::equal$, 0f));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestFltTernaryOp(functionThrowing)
         .doesApplyAsFlt(100f,100f,100f).withException(a -> a
