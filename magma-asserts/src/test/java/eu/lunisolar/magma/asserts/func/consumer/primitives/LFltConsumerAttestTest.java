...
import eu.lunisolar.magma.func.consumer.primitives.LFltConsumer;
...
public class LFltConsumerAttestTest {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private LFltConsumer function = a ->
            externalEffect.set(testValue);


    private LFltConsumer functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestFltCons(functionThrowing)
         .doesAccept(100f)
