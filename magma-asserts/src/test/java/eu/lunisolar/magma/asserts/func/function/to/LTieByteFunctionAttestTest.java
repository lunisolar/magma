...
public class LTieByteFunctionAttestTest<T> {

    private int testValue = 100;

    private LTieByteFunction<Integer> function = (a1,a2,a3) ->
            testValue;


    private LTieByteFunction<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        FuncAttests.attestTieByteFunc(function)
         .doesApplyAsInt(100,100,(byte)100)
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestTieByteFunc(functionThrowing)
         .doesApplyAsInt(100,100,(byte)100)
            .to(a -> a.mustEx(Be::equalEx, 0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestTieByteFunc(functionThrowing)
         .doesApplyAsInt(100,100,(byte)100).withException(a -> a
