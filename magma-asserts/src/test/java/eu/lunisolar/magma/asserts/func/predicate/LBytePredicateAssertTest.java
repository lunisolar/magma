...
import eu.lunisolar.magma.func.predicate.LBytePredicate;
...
public class LBytePredicateAssertTest {
    ...
    private LBytePredicate function = a ->
            testValue;


    private LBytePredicate functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestBytePred(functionThrowing)
         .doesTest((byte)100)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.attestBytePred(functionThrowing)
         .doesTest((byte)100).withException(a -> a
