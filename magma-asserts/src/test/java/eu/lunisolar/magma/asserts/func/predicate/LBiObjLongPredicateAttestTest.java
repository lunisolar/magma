...
public class LBiObjLongPredicateAttestTest<T1,T2> {

    private boolean testValue = true;

    private LBiObjLongPredicate<Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LBiObjLongPredicate<Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiObjLongPred(functionThrowing)
         .doesTest(100,100,100L)
            .to(a -> a.mustEx(Be::equalEx, false));
    }
