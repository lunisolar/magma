...
import eu.lunisolar.magma.func.consumer.primitives.LSrtConsumer;
...
public class LSrtConsumerAssertTest {
    ...
    private LSrtConsumer function = a ->
            externalEffect.set(testValue);


    private LSrtConsumer functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestSrtCons(functionThrowing)
         .doesAccept((short)100)
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.attestSrtCons(functionThrowing)
         .doesAccept((short)100).withException(a -> a
