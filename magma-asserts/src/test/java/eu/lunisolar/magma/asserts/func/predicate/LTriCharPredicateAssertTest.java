...
import eu.lunisolar.magma.func.predicate.LTriCharPredicate;
...
public class LTriCharPredicateAssertTest {
    ...
    private LTriCharPredicate function = (a1,a2,a3) ->
            testValue;


    private LTriCharPredicate functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestTriCharPred(functionThrowing)
         .doesTest('\u0100','\u0100','\u0100')
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.attestTriCharPred(functionThrowing)
         .doesTest('\u0100','\u0100','\u0100').withException(a -> a
