...
public class LBiCharFunctionAttestTest<R> {

    private Integer testValue = 100;

    private LBiCharFunction<Integer> function = (a1,a2) ->
            testValue;


    private LBiCharFunction<Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiCharFunc(functionThrowing)
         .doesApply('\u0100','\u0100')
            .to(a -> a.must$(Be::equal$, 0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestBiCharFunc(functionThrowing)
         .doesApply('\u0100','\u0100').withException(a -> a
