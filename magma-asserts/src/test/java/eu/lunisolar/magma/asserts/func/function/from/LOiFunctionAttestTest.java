...
public class LOiFunctionAttestTest<T,R> {

    private Integer testValue = 100;

    private LOiFunction<Integer,Integer> function = (a1,a2) ->
            testValue;


    private LOiFunction<Integer,Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestOiFunc(functionThrowing)
         .doesApply(100,100)
            .to(a -> a.mustEx(Be::equalEx, 0));
    }
