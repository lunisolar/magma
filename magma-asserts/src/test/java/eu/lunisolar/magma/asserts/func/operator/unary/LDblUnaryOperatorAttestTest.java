...
import eu.lunisolar.magma.func.operator.unary.LDblUnaryOperator;
...
public class LDblUnaryOperatorAttestTest {

    private double testValue = 100d;

    private LDblUnaryOperator function = a ->
            testValue;


    private LDblUnaryOperator functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestDblUnaryOp(functionThrowing)
         .doesApplyAsDbl(100d)
            .to(a -> a.mustEx(Be::equalEx, 0d));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestDblUnaryOp(functionThrowing)
         .doesApplyAsDbl(100d).withException(a -> a
