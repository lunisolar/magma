...
public class JreToDoubleBiFunctionAssertTest<T1,T2> {
    ...
    private ToDoubleBiFunction<Integer,Integer> function = (a1,a2) ->
            testValue;


    private ToDoubleBiFunction<Integer,Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestToDblBiFunc(functionThrowing)
         .doesApplyAsDbl(100,100)
            .to( a -> a.isEqualTo(1));
    }
