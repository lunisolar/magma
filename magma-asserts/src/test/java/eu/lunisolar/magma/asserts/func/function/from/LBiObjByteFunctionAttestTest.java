...
public class LBiObjByteFunctionAttestTest<T1,T2,R> {

    private Integer testValue = 100;

    private LBiObjByteFunction<Integer,Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LBiObjByteFunction<Integer,Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiObjByteFunc(functionThrowing)
         .doesApply(100,100,(byte)100)
            .to(a -> a.must$(Be::equal$, 0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestBiObjByteFunc(functionThrowing)
         .doesApply(100,100,(byte)100).withException(a -> a
