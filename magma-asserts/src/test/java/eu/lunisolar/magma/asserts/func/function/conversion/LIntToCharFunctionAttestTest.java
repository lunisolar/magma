...
import eu.lunisolar.magma.func.function.conversion.LIntToCharFunction;
...
public class LIntToCharFunctionAttestTest {

    private char testValue = '\u0100';

    private LIntToCharFunction function = a ->
            testValue;


    private LIntToCharFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestIntToCharFunc(functionThrowing)
         .doesApplyAsChar(100)
            .to(a -> a.mustEx(Be::equalEx, '\u0000'));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestIntToCharFunc(functionThrowing)
         .doesApplyAsChar(100).withException(a -> a
