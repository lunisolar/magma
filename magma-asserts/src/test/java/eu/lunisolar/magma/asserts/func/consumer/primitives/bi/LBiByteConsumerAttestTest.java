...
public class LBiByteConsumerAttestTest {

    private Integer testValue = 100;
    private AtomicReference<Object> externalEffect = new AtomicReference(null);

    private LBiByteConsumer function = (a1,a2) ->
            externalEffect.set(testValue);


    private LBiByteConsumer functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestBiByteCons(functionThrowing)
         .doesAccept((byte)100,(byte)100)
