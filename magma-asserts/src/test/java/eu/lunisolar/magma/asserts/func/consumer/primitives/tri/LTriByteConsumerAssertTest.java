...
import eu.lunisolar.magma.func.consumer.primitives.tri.LTriByteConsumer;
...
public class LTriByteConsumerAssertTest {
    ...
    private LTriByteConsumer function = (a1,a2,a3) ->
            externalEffect.set(testValue);


    private LTriByteConsumer functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertTriByteCons(function)
         .doesAccept((byte)100,(byte)100,(byte)100)
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertTriByteCons(functionThrowing)
         .doesAccept((byte)100,(byte)100,(byte)100)
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertTriByteCons(functionThrowing)
         .doesAccept((byte)100,(byte)100,(byte)100).withException(a -> a
