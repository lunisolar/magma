...
import eu.lunisolar.magma.func.function.conversion.LFltToSrtFunction;
...
public class LFltToSrtFunctionAttestTest {

    private short testValue = (short)100;

    private LFltToSrtFunction function = a ->
            testValue;


    private LFltToSrtFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestFltToSrtFunc(functionThrowing)
         .doesApplyAsSrt(100f)
            .to(a -> a.must$(Be::equal$, (short)0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestFltToSrtFunc(functionThrowing)
         .doesApplyAsSrt(100f).withException(a -> a
