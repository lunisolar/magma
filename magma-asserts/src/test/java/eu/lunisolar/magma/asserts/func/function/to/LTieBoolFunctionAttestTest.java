...
public class LTieBoolFunctionAttestTest<T> {

    private int testValue = 100;

    private LTieBoolFunction<Integer> function = (a1,a2,a3) ->
            testValue;


    private LTieBoolFunction<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        FuncAttests.attestTieBoolFunc(function)
         .doesApplyAsInt(100,100,true)
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        FuncAttests.attestTieBoolFunc(functionThrowing)
         .doesApplyAsInt(100,100,true)
            .to(a -> a.must$(Be::equal$, 0));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        FuncAttests.attestTieBoolFunc(functionThrowing)
         .doesApplyAsInt(100,100,true).withException(a -> a
