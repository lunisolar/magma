...
public class LTieCharFunctionAssertTest<T> {
    ...
    private LTieCharFunction<Integer> function = (a1,a2,a3) ->
            testValue;


    private LTieCharFunction<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.attestTieCharFunc(functionThrowing)
         .doesApplyAsInt(100,100,'\u0100')
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.attestTieCharFunc(functionThrowing)
         .doesApplyAsInt(100,100,'\u0100').withException(a -> a
