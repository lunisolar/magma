...
public interface LSrtToByteFunctionAssert<S extends LSrtToByteFunctionAssert<S, A, RS>, A extends LSrtToByteFunction, RS extends AbstractByteAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LSrtConsumer, A, RS, Byte> {
	...
	@Nonnull
	Evaluation<S, LSrtConsumer, A, RS, Byte> doesApplyAsByte(short a);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LSrtToByteFunction, RS extends AbstractByteAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LSrtToByteFunction, RS extends AbstractByteAssert<RS>> extends FullFunctionalAssert.Base<S, LSrtConsumer, A, RS, Byte> implements LSrtToByteFunctionAssert<S, A, RS> {
