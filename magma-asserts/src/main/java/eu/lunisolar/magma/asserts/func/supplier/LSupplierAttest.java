...
public final class LSupplierAttest<T> extends FunctionalAttest.Full<LSupplierAttest<T>, LSupplier<T>, LAction, Checks.Check<T>> {

	public LSupplierAttest(LSupplier<T> actual) {
		super(actual);
	}
	...
	@Nonnull
	public LSupplierAttest<T> doesReturn(T value) {
