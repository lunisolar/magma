...
public final class LFltFunctionAttest<R> extends FunctionalAttest.Full<LFltFunctionAttest<R>, LFltFunction<R>, LFltConsumer, Checks.Check<R>> {

	public LFltFunctionAttest(LFltFunction<R> actual) {
		super(actual);
	}
	...
	@Nonnull
	public Evaluation<LFltFunctionAttest<R>, LFltConsumer, R> doesApply(float a) {

		return new Evaluation<LFltFunctionAttest<R>, LFltConsumer, R>(this, () -> String.format("(%s)", a), (desc, pc) -> {
