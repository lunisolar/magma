...
public final class LSrtToLongFunctionAttest extends FunctionalAttest.Full<LSrtToLongFunctionAttest, LSrtToLongFunction, LSrtConsumer, Checks.CheckLong> {

	public LSrtToLongFunctionAttest(LSrtToLongFunction actual) {
		super(actual);
	}
	...
	@Nonnull
	public LongEvaluation<LSrtToLongFunctionAttest, LSrtConsumer> doesApplyAsLong(short a) {

		return new LongEvaluation<LSrtToLongFunctionAttest, LSrtConsumer>(this, () -> String.format("(%s)", a), (desc, pc) -> {
