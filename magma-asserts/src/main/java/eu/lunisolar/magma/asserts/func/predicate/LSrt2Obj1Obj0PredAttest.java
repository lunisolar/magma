...
public final class LSrt2Obj1Obj0PredAttest<T2, T1> extends FunctionalAttest.Full<LSrt2Obj1Obj0PredAttest<T2, T1>, LSrt2Obj1Obj0Pred<T2, T1>, LBiObjSrtConsumer.LSrt2Obj0Obj1Cons<T2, T1>, Checks.CheckBool> {

	public LSrt2Obj1Obj0PredAttest(LSrt2Obj1Obj0Pred<T2, T1> actual) {
		super(actual);
	}
	...
	@Nonnull
	public BoolEvaluation<LSrt2Obj1Obj0PredAttest<T2, T1>, LBiObjSrtConsumer.LSrt2Obj0Obj1Cons<T2, T1>> doesTest(short a3, T2 a2, T1 a1) {

		return new BoolEvaluation<LSrt2Obj1Obj0PredAttest<T2, T1>, LBiObjSrtConsumer.LSrt2Obj0Obj1Cons<T2, T1>>(this, () -> String.format("(%s,%s,%s)", a3, a2, a1), (desc, pc) -> {
			...
			var result = func.testSrt2Obj1Obj0(a3, a2, a1);
