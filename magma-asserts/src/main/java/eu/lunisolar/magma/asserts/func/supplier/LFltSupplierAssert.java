...
public interface LFltSupplierAssert<S extends LFltSupplierAssert<S, A, RS>, A extends LFltSupplier, RS extends AbstractFloatAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LAction, A, RS, Float> {
	...
	@Nonnull
	Evaluation<S, LAction, A, RS, Float> doesGetAsFlt();

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LFltSupplier, RS extends AbstractFloatAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LFltSupplier, RS extends AbstractFloatAssert<RS>> extends FullFunctionalAssert.Base<S, LAction, A, RS, Float> implements LFltSupplierAssert<S, A, RS> {
