...
public final class LBiObjBoolFunctionAttest<T1, T2, R> extends FunctionalAttest.Full<LBiObjBoolFunctionAttest<T1, T2, R>, LBiObjBoolFunction<T1, T2, R>, LBiObjBoolConsumer<T1, T2>, Checks.Check<R>> {

	public LBiObjBoolFunctionAttest(LBiObjBoolFunction<T1, T2, R> actual) {
		super(actual);
	}
	...
	@Nonnull
	public Evaluation<LBiObjBoolFunctionAttest<T1, T2, R>, LBiObjBoolConsumer<T1, T2>, R> doesApply(T1 a1, T2 a2, boolean a3) {

		return new Evaluation<LBiObjBoolFunctionAttest<T1, T2, R>, LBiObjBoolConsumer<T1, T2>, R>(this, () -> String.format("(%s,%s,%s)", a1, a2, a3), (desc, pc) -> {
