...
public final class LFltToSrtFunctionAttest extends FunctionalAttest.Full<LFltToSrtFunctionAttest, LFltToSrtFunction, LFltConsumer, Checks.CheckSrt> {

	public LFltToSrtFunctionAttest(LFltToSrtFunction actual) {
		super(actual);
	}

	public LFltToSrtFunctionAttest(LFltToSrtFunction actual, String name) {
		super(actual, name);
	}
