...
public final class LObjBoolFunctionAttest<T, R> extends FunctionalAttest.Full<LObjBoolFunctionAttest<T, R>, LObjBoolFunction<T, R>, LObjBoolConsumer<T>, Checks.Check<R>> {

	public LObjBoolFunctionAttest(LObjBoolFunction<T, R> actual) {
		super(actual);
	}
	...
	@Nonnull
	public Evaluation<LObjBoolFunctionAttest<T, R>, LObjBoolConsumer<T>, R> doesApply(T a1, boolean a2) {

		return new Evaluation<LObjBoolFunctionAttest<T, R>, LObjBoolConsumer<T>, R>(this, () -> String.format("(%s,%s)", a1, a2), (desc, pc) -> {
