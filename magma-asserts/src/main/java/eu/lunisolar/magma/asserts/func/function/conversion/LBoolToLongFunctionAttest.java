...
public final class LBoolToLongFunctionAttest extends FunctionalAttest.Full<LBoolToLongFunctionAttest, LBoolToLongFunction, LBoolConsumer, Checks.CheckLong> {

	public LBoolToLongFunctionAttest(LBoolToLongFunction actual) {
		super(actual);
	}
