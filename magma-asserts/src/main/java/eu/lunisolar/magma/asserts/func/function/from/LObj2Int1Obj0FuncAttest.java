...
public final class LObj2Int1Obj0FuncAttest<T2, T1, R> extends FunctionalAttest.Full<LObj2Int1Obj0FuncAttest<T2, T1, R>, LObj2Int1Obj0Func<T2, T1, R>, LTieConsumer<T2, T1>, Checks.Check<R>> {

	public LObj2Int1Obj0FuncAttest(LObj2Int1Obj0Func<T2, T1, R> actual) {
		super(actual);
	}

	public LObj2Int1Obj0FuncAttest(LObj2Int1Obj0Func<T2, T1, R> actual, String name) {
		super(actual, name);
	}
