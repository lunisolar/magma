...
public final class LFltTernaryOperatorAttest extends FunctionalAttest.Full<LFltTernaryOperatorAttest, LFltTernaryOperator, LTriFltConsumer, Checks.CheckFlt> {

	public LFltTernaryOperatorAttest(LFltTernaryOperator actual) {
		super(actual);
	}
