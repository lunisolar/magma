...
public final class LObjSrtPredicateAttest<T> extends FunctionalAttest.Full<LObjSrtPredicateAttest<T>, LObjSrtPredicate<T>, LObjSrtConsumer<T>, Checks.CheckBool> {

	public LObjSrtPredicateAttest(LObjSrtPredicate<T> actual) {
		super(actual);
	}
	...
	@Nonnull
	public BoolEvaluation<LObjSrtPredicateAttest<T>, LObjSrtConsumer<T>> doesTest(T a1, short a2) {

		return new BoolEvaluation<LObjSrtPredicateAttest<T>, LObjSrtConsumer<T>>(this, () -> String.format("(%s,%s)", a1, a2), (desc, pc) -> {
