...
public final class LBoolToCharFunctionAttest extends FunctionalAttest.Full<LBoolToCharFunctionAttest, LBoolToCharFunction, LBoolConsumer, Checks.CheckChar> {

	public LBoolToCharFunctionAttest(LBoolToCharFunction actual) {
		super(actual);
	}
