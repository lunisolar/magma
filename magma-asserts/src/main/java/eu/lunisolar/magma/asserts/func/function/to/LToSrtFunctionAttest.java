...
public final class LToSrtFunctionAttest<T> extends FunctionalAttest.Full<LToSrtFunctionAttest<T>, LToSrtFunction<T>, LConsumer<T>, Checks.CheckSrt> {

	public LToSrtFunctionAttest(LToSrtFunction<T> actual) {
		super(actual);
	}
	...
	@Nonnull
	public SrtEvaluation<LToSrtFunctionAttest<T>, LConsumer<T>> doesApplyAsSrt(T a) {

		return new SrtEvaluation<LToSrtFunctionAttest<T>, LConsumer<T>>(this, () -> String.format("(%s)", a), (desc, pc) -> {
