...
public final class LSrtIntObjFuncAttest<T, R> extends FunctionalAttest.Full<LSrtIntObjFuncAttest<T, R>, LSrtIntObjFunc<T, R>, LTieSrtConsumer.LSrtIntObjCons<T>, Checks.Check<R>> {

	public LSrtIntObjFuncAttest(LSrtIntObjFunc<T, R> actual) {
		super(actual);
	}

	public LSrtIntObjFuncAttest(LSrtIntObjFunc<T, R> actual, String name) {
		super(actual, name);
	}
