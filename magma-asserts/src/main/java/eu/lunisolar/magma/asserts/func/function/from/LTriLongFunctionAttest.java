...
public final class LTriLongFunctionAttest<R> extends FunctionalAttest.Full<LTriLongFunctionAttest<R>, LTriLongFunction<R>, LTriLongConsumer, Checks.Check<R>> {

	public LTriLongFunctionAttest(LTriLongFunction<R> actual) {
		super(actual);
	}

	public LTriLongFunctionAttest(LTriLongFunction<R> actual, String name) {
		super(actual, name);
	}
