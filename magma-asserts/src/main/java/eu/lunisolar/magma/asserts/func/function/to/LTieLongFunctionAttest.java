...
public final class LTieLongFunctionAttest<T> extends FunctionalAttest.Full<LTieLongFunctionAttest<T>, LTieLongFunction<T>, LTieLongConsumer<T>, Checks.CheckInt> {

	public LTieLongFunctionAttest(LTieLongFunction<T> actual) {
		super(actual);
	}
