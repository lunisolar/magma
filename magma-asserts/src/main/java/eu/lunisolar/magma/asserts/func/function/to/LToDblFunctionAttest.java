...
public final class LToDblFunctionAttest<T> extends FunctionalAttest.Full<LToDblFunctionAttest<T>, LToDblFunction<T>, LConsumer<T>, Checks.CheckDbl> {

	public LToDblFunctionAttest(LToDblFunction<T> actual) {
		super(actual);
	}
