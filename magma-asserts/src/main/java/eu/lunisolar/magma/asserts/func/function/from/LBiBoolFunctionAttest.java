...
public final class LBiBoolFunctionAttest<R> extends FunctionalAttest.Full<LBiBoolFunctionAttest<R>, LBiBoolFunction<R>, LBiBoolConsumer, Checks.Check<R>> {

	public LBiBoolFunctionAttest(LBiBoolFunction<R> actual) {
		super(actual);
	}
	...
	@Nonnull
	public Evaluation<LBiBoolFunctionAttest<R>, LBiBoolConsumer, R> doesApply(boolean a1, boolean a2) {

		return new Evaluation<LBiBoolFunctionAttest<R>, LBiBoolConsumer, R>(this, () -> String.format("(%s,%s)", a1, a2), (desc, pc) -> {
