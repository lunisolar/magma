...
public final class LByteObjFuncAttest<T, R> extends FunctionalAttest.Full<LByteObjFuncAttest<T, R>, LByteObjFunc<T, R>, LObjByteConsumer.LByteObjCons<T>, Checks.Check<R>> {

	public LByteObjFuncAttest(LByteObjFunc<T, R> actual) {
		super(actual);
	}

	public LByteObjFuncAttest(LByteObjFunc<T, R> actual, String name) {
		super(actual, name);
	}
	...
	@Nonnull
	public Evaluation<LByteObjFuncAttest<T, R>, LObjByteConsumer.LByteObjCons<T>, R> doesApply(byte a2, T a1) {

		return new Evaluation<LByteObjFuncAttest<T, R>, LObjByteConsumer.LByteObjCons<T>, R>(this, () -> String.format("(%s,%s)", a2, a1), (desc, pc) -> {
			...
			var result = func.applyByteObj(a2, a1);
