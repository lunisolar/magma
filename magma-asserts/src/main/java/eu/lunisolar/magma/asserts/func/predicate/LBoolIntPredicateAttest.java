...
public final class LBoolIntPredicateAttest extends FunctionalAttest.Full<LBoolIntPredicateAttest, LBoolIntPredicate, LBoolIntConsumer, Checks.CheckBool> {

	public LBoolIntPredicateAttest(LBoolIntPredicate actual) {
		super(actual);
	}
	...
	@Nonnull
	public BoolEvaluation<LBoolIntPredicateAttest, LBoolIntConsumer> doesTest(boolean a1, int a2) {

		return new BoolEvaluation<LBoolIntPredicateAttest, LBoolIntConsumer>(this, () -> String.format("(%s,%s)", a1, a2), (desc, pc) -> {
