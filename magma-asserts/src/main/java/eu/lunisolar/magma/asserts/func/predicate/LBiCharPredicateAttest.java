...
public final class LBiCharPredicateAttest extends FunctionalAttest.Full<LBiCharPredicateAttest, LBiCharPredicate, LBiCharConsumer, Checks.CheckBool> {

	public LBiCharPredicateAttest(LBiCharPredicate actual) {
		super(actual);
	}
	...
	@Nonnull
	public BoolEvaluation<LBiCharPredicateAttest, LBiCharConsumer> doesTest(char a1, char a2) {

		return new BoolEvaluation<LBiCharPredicateAttest, LBiCharConsumer>(this, () -> String.format("(%s,%s)", a1, a2), (desc, pc) -> {
