...
public final class LBiPredicateAttest<T1, T2> extends FunctionalAttest.Full<LBiPredicateAttest<T1, T2>, LBiPredicate<T1, T2>, LBiConsumer<T1, T2>, Checks.CheckBool> {

	public LBiPredicateAttest(LBiPredicate<T1, T2> actual) {
		super(actual);
	}
	...
	@Nonnull
	public BoolEvaluation<LBiPredicateAttest<T1, T2>, LBiConsumer<T1, T2>> doesTest(T1 a1, T2 a2) {

		return new BoolEvaluation<LBiPredicateAttest<T1, T2>, LBiConsumer<T1, T2>>(this, () -> String.format("(%s,%s)", a1, a2), (desc, pc) -> {
