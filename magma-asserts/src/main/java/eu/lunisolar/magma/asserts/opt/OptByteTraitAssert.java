...
public class OptByteTraitAssert extends AbstractObjectAssert<OptByteTraitAssert, OptByteTrait<?>> implements FluentTrait<OptByteTraitAssert>, MagmaAssert<OptByteTraitAssert, OptByteTrait<?>> {

	@Override
	public OptByteTrait<?> actual() {
		return super.actual;
	}

	public OptByteTraitAssert(OptByteTrait<?> actual) {
		super(actual, OptByteTraitAssert.class);
	}
	...
	public OptByteTraitAssert isNotVoid() {
		return isPresent();
	}
	...
	public OptByteTraitAssert isNotPresent() {
		return isVoid();
	}
	...
	public OptByteTraitAssert hasValue(byte expectedValue) {
		return contains(expectedValue);
	}

	public AbstractByteAssert<?> hasValueThat() {
		isPresent();
