...
public interface LIntSupplierAssert<S extends LIntSupplierAssert<S, A, RS>, A extends LIntSupplier, RS extends AbstractIntegerAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LAction, A, RS, Integer> {
	...
	final class The<A extends LIntSupplier, RS extends AbstractIntegerAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LIntSupplier, RS extends AbstractIntegerAssert<RS>> extends FullFunctionalAssert.Base<S, LAction, A, RS, Integer> implements LIntSupplierAssert<S, A, RS> {
