...
public final class LToIntTriFunctionAttest<T1, T2, T3> extends FunctionalAttest.Full<LToIntTriFunctionAttest<T1, T2, T3>, LToIntTriFunction<T1, T2, T3>, LTriConsumer<T1, T2, T3>, Checks.CheckInt> {

	public LToIntTriFunctionAttest(LToIntTriFunction<T1, T2, T3> actual) {
		super(actual);
	}
