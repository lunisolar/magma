...
public final class LBiFltFunctionAttest<R> extends FunctionalAttest.Full<LBiFltFunctionAttest<R>, LBiFltFunction<R>, LBiFltConsumer, Checks.Check<R>> {

	public LBiFltFunctionAttest(LBiFltFunction<R> actual) {
		super(actual);
	}

	public LBiFltFunctionAttest(LBiFltFunction<R> actual, String name) {
		super(actual, name);
	}
