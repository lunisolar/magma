...
public final class LCharObjIntToIntFuncAttest<T> extends FunctionalAttest.Full<LCharObjIntToIntFuncAttest<T>, LCharObjIntToIntFunc<T>, LTieCharConsumer.LCharObjIntCons<T>, Checks.CheckInt> {

	public LCharObjIntToIntFuncAttest(LCharObjIntToIntFunc<T> actual) {
		super(actual);
	}

	public LCharObjIntToIntFuncAttest(LCharObjIntToIntFunc<T> actual, String name) {
		super(actual, name);
	}
