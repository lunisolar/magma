...
public final class LObjDblConsumerAttest<T> extends FunctionalAttest.Simple<LObjDblConsumerAttest<T>, LObjDblConsumer<T>, LObjDblConsumer<T>> {

	public LObjDblConsumerAttest(LObjDblConsumer<T> actual) {
		super(actual);
	}

	public LObjDblConsumerAttest(LObjDblConsumer<T> actual, String name) {
		super(actual, name);
	}
