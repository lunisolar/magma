...
public final class LIntObjSrtPredAttest<T> extends FunctionalAttest.Full<LIntObjSrtPredAttest<T>, LIntObjSrtPred<T>, LTieSrtConsumer.LIntObjSrtCons<T>, Checks.CheckBool> {

	public LIntObjSrtPredAttest(LIntObjSrtPred<T> actual) {
		super(actual);
	}
	...
	@Nonnull
	public BoolEvaluation<LIntObjSrtPredAttest<T>, LTieSrtConsumer.LIntObjSrtCons<T>> doesTest(int a2, T a1, short a3) {

		return new BoolEvaluation<LIntObjSrtPredAttest<T>, LTieSrtConsumer.LIntObjSrtCons<T>>(this, () -> String.format("(%s,%s,%s)", a2, a1, a3), (desc, pc) -> {
			...
			var result = func.testIntObjSrt(a2, a1, a3);
