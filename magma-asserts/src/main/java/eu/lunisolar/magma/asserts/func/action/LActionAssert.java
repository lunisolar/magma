...
package eu.lunisolar.magma.asserts.func.action;
...
public interface LActionAssert<S extends LActionAssert<S, A>, A extends LAction> extends Assert<S, A>, FunctionalAssert.Simple<S, LAction, A> {
	...
	final class The<A extends LAction> extends Base<The<A>, A> {
	...
	class Base<S extends Base<S, A>, A extends LAction> extends FunctionalAssert.Simple.Base<S, LAction, A> implements LActionAssert<S, A> {
