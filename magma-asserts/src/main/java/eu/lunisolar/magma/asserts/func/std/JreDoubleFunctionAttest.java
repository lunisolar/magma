...
public final class JreDoubleFunctionAttest<R> extends FunctionalAttest.Full<JreDoubleFunctionAttest<R>, DoubleFunction<R>, LDblConsumer, Checks.Check<R>> {

	public JreDoubleFunctionAttest(DoubleFunction<R> actual) {
		super(actual);
	}
	...
	@Nonnull
	public Evaluation<JreDoubleFunctionAttest<R>, LDblConsumer, R> doesApply(double a) {

		return new Evaluation<JreDoubleFunctionAttest<R>, LDblConsumer, R>(this, () -> String.format("(%s)", a), (desc, pc) -> {
