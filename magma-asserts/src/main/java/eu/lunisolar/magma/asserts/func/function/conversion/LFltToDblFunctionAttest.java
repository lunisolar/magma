...
public final class LFltToDblFunctionAttest extends FunctionalAttest.Full<LFltToDblFunctionAttest, LFltToDblFunction, LFltConsumer, Checks.CheckDbl> {

	public LFltToDblFunctionAttest(LFltToDblFunction actual) {
		super(actual);
	}

	public LFltToDblFunctionAttest(LFltToDblFunction actual, String name) {
		super(actual, name);
	}
