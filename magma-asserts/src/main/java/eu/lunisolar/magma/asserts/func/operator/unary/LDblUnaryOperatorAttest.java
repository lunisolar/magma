...
public final class LDblUnaryOperatorAttest extends FunctionalAttest.Full<LDblUnaryOperatorAttest, LDblUnaryOperator, LDblConsumer, Checks.CheckDbl> {

	public LDblUnaryOperatorAttest(LDblUnaryOperator actual) {
		super(actual);
	}
	...
	@Nonnull
	public DblEvaluation<LDblUnaryOperatorAttest, LDblConsumer> doesApplyAsDbl(double a) {

		return new DblEvaluation<LDblUnaryOperatorAttest, LDblConsumer>(this, () -> String.format("(%s)", a), (desc, pc) -> {
