...
public final class LIntSrtConsAttest extends FunctionalAttest.Simple<LIntSrtConsAttest, LIntSrtCons, LSrtIntConsumer.LIntSrtCons> {

	public LIntSrtConsAttest(LIntSrtCons actual) {
		super(actual);
	}

	public LIntSrtConsAttest(LIntSrtCons actual, String name) {
		super(actual, name);
	}
