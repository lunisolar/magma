...
public interface LToIntBiFunctionAssert<S extends LToIntBiFunctionAssert<S, A, RS, T1, T2>, A extends LToIntBiFunction<T1, T2>, RS extends AbstractIntegerAssert<RS>, T1, T2>
	...
	final class The<A extends LToIntBiFunction<T1, T2>, RS extends AbstractIntegerAssert<RS>, T1, T2> extends Base<The<A, RS, T1, T2>, A, RS, T1, T2> {
	...
	class Base<S extends Base<S, A, RS, T1, T2>, A extends LToIntBiFunction<T1, T2>, RS extends AbstractIntegerAssert<RS>, T1, T2> extends FullFunctionalAssert.Base<S, LBiConsumer<T1, T2>, A, RS, Integer>
			implements
