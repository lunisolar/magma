...
public final class LIntFltObjConsAttest<T> extends FunctionalAttest.Simple<LIntFltObjConsAttest<T>, LIntFltObjCons<T>, LTieFltConsumer.LIntFltObjCons<T>> {

	public LIntFltObjConsAttest(LIntFltObjCons<T> actual) {
		super(actual);
	}

	public LIntFltObjConsAttest(LIntFltObjCons<T> actual, String name) {
		super(actual, name);
	}
