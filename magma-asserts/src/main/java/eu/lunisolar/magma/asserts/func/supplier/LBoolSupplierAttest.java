...
public final class LBoolSupplierAttest extends FunctionalAttest.Full<LBoolSupplierAttest, LBoolSupplier, LAction, Checks.CheckBool> {

	public LBoolSupplierAttest(LBoolSupplier actual) {
		super(actual);
	}
	...
	@Nonnull
	public LBoolSupplierAttest doesReturn(boolean value) {
