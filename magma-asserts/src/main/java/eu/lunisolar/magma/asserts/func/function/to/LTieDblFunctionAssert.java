...
public interface LTieDblFunctionAssert<S extends LTieDblFunctionAssert<S, A, RS, T>, A extends LTieDblFunction<T>, RS extends AbstractIntegerAssert<RS>, T> extends Assert<S, A>, FullFunctionalAssert<S, LTieDblConsumer<T>, A, RS, Integer> {
	...
	@Nonnull
	Evaluation<S, LTieDblConsumer<T>, A, RS, Integer> doesApplyAsInt(T a1, int a2, double a3);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LTieDblFunction<T>, RS extends AbstractIntegerAssert<RS>, T> extends Base<The<A, RS, T>, A, RS, T> {
	...
	class Base<S extends Base<S, A, RS, T>, A extends LTieDblFunction<T>, RS extends AbstractIntegerAssert<RS>, T> extends FullFunctionalAssert.Base<S, LTieDblConsumer<T>, A, RS, Integer> implements LTieDblFunctionAssert<S, A, RS, T> {
		...
		@Nonnull
		public Evaluation<S, LTieDblConsumer<T>, A, RS, Integer> doesApplyAsInt(T a1, int a2, double a3) {
