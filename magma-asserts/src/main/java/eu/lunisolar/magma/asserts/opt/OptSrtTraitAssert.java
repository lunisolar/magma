...
public class OptSrtTraitAssert extends AbstractObjectAssert<OptSrtTraitAssert, OptSrtTrait<?>> implements FluentTrait<OptSrtTraitAssert>, MagmaAssert<OptSrtTraitAssert, OptSrtTrait<?>> {
