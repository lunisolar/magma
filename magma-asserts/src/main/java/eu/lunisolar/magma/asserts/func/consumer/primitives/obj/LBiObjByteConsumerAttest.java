...
public final class LBiObjByteConsumerAttest<T1, T2> extends FunctionalAttest.Simple<LBiObjByteConsumerAttest<T1, T2>, LBiObjByteConsumer<T1, T2>, LBiObjByteConsumer<T1, T2>> {

	public LBiObjByteConsumerAttest(LBiObjByteConsumer<T1, T2> actual) {
		super(actual);
	}
	...
	@Nonnull
	public SemiEvaluation<LBiObjByteConsumerAttest<T1, T2>, LBiObjByteConsumer<T1, T2>, AssertionsCheck> doesAccept(T1 a1, T2 a2, byte a3) {

		return new SemiEvaluation<LBiObjByteConsumerAttest<T1, T2>, LBiObjByteConsumer<T1, T2>, AssertionsCheck>(this, () -> String.format("(%s,%s,%s)", a1, a2, a3), (desc, pc) -> {
