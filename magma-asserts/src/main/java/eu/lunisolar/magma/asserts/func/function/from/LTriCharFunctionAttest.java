...
public final class LTriCharFunctionAttest<R> extends FunctionalAttest.Full<LTriCharFunctionAttest<R>, LTriCharFunction<R>, LTriCharConsumer, Checks.Check<R>> {

	public LTriCharFunctionAttest(LTriCharFunction<R> actual) {
		super(actual);
	}
