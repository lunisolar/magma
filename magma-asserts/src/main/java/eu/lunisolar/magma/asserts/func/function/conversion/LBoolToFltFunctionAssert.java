...
public interface LBoolToFltFunctionAssert<S extends LBoolToFltFunctionAssert<S, A, RS>, A extends LBoolToFltFunction, RS extends AbstractFloatAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LBoolConsumer, A, RS, Float> {
	...
	@Nonnull
	Evaluation<S, LBoolConsumer, A, RS, Float> doesApplyAsFlt(boolean a);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LBoolToFltFunction, RS extends AbstractFloatAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LBoolToFltFunction, RS extends AbstractFloatAssert<RS>> extends FullFunctionalAssert.Base<S, LBoolConsumer, A, RS, Float> implements LBoolToFltFunctionAssert<S, A, RS> {
