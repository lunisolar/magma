...
public final class LCharBinaryOperatorAttest extends FunctionalAttest.Full<LCharBinaryOperatorAttest, LCharBinaryOperator, LBiCharConsumer, Checks.CheckChar> {

	public LCharBinaryOperatorAttest(LCharBinaryOperator actual) {
		super(actual);
	}
	...
	@Nonnull
	public CharEvaluation<LCharBinaryOperatorAttest, LBiCharConsumer> doesApplyAsChar(char a1, char a2) {

		return new CharEvaluation<LCharBinaryOperatorAttest, LBiCharConsumer>(this, () -> String.format("(%s,%s)", a1, a2), (desc, pc) -> {
