...
public final class LObjFltPredicateAttest<T> extends FunctionalAttest.Full<LObjFltPredicateAttest<T>, LObjFltPredicate<T>, LObjFltConsumer<T>, Checks.CheckBool> {

	public LObjFltPredicateAttest(LObjFltPredicate<T> actual) {
		super(actual);
	}

	public LObjFltPredicateAttest(LObjFltPredicate<T> actual, String name) {
		super(actual, name);
	}
