...
public interface LDblToSrtFunctionAssert<S extends LDblToSrtFunctionAssert<S, A, RS>, A extends LDblToSrtFunction, RS extends AbstractShortAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LDblConsumer, A, RS, Short> {
	...
	@Nonnull
	Evaluation<S, LDblConsumer, A, RS, Short> doesApplyAsSrt(double a);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LDblToSrtFunction, RS extends AbstractShortAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LDblToSrtFunction, RS extends AbstractShortAssert<RS>> extends FullFunctionalAssert.Base<S, LDblConsumer, A, RS, Short> implements LDblToSrtFunctionAssert<S, A, RS> {
