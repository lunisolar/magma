...
public interface LCharToFltFunctionAssert<S extends LCharToFltFunctionAssert<S, A, RS>, A extends LCharToFltFunction, RS extends AbstractFloatAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LCharConsumer, A, RS, Float> {
	...
	@Nonnull
	Evaluation<S, LCharConsumer, A, RS, Float> doesApplyAsFlt(char a);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LCharToFltFunction, RS extends AbstractFloatAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LCharToFltFunction, RS extends AbstractFloatAssert<RS>> extends FullFunctionalAssert.Base<S, LCharConsumer, A, RS, Float> implements LCharToFltFunctionAssert<S, A, RS> {
