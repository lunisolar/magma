...
public final class LByteSupplierAttest extends FunctionalAttest.Full<LByteSupplierAttest, LByteSupplier, LAction, Checks.CheckByte> {

	public LByteSupplierAttest(LByteSupplier actual) {
		super(actual);
	}
	...
	@Nonnull
	public LByteSupplierAttest doesReturn(byte value) {
