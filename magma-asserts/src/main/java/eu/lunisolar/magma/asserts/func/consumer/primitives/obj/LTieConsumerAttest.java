...
public final class LTieConsumerAttest<T1, T2> extends FunctionalAttest.Simple<LTieConsumerAttest<T1, T2>, LTieConsumer<T1, T2>, LTieConsumer<T1, T2>> {

	public LTieConsumerAttest(LTieConsumer<T1, T2> actual) {
		super(actual);
	}

	public LTieConsumerAttest(LTieConsumer<T1, T2> actual, String name) {
		super(actual, name);
	}
