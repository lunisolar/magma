...
public final class LBiCharFunctionAttest<R> extends FunctionalAttest.Full<LBiCharFunctionAttest<R>, LBiCharFunction<R>, LBiCharConsumer, Checks.Check<R>> {

	public LBiCharFunctionAttest(LBiCharFunction<R> actual) {
		super(actual);
	}
	...
	@Nonnull
	public Evaluation<LBiCharFunctionAttest<R>, LBiCharConsumer, R> doesApply(char a1, char a2) {

		return new Evaluation<LBiCharFunctionAttest<R>, LBiCharConsumer, R>(this, () -> String.format("(%s,%s)", a1, a2), (desc, pc) -> {
