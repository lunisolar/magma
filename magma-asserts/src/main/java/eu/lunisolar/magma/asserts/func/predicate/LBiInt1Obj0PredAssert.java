...
public interface LBiInt1Obj0PredAssert<S extends LBiInt1Obj0PredAssert<S, A, RS, T>, A extends LObjBiIntPredicate.LBiInt1Obj0Pred<T>, RS extends AbstractBooleanAssert<RS>, T>
		extends
			Assert<S, A>,
	...
	@Nonnull
	Evaluation<S, LTieIntConsumer.LInt1Int2Obj0Cons<T>, A, RS, Boolean> doesTest(int a3, int a2, T a1);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LObjBiIntPredicate.LBiInt1Obj0Pred<T>, RS extends AbstractBooleanAssert<RS>, T> extends Base<The<A, RS, T>, A, RS, T> {
	...
	class Base<S extends Base<S, A, RS, T>, A extends LObjBiIntPredicate.LBiInt1Obj0Pred<T>, RS extends AbstractBooleanAssert<RS>, T> extends FullFunctionalAssert.Base<S, LTieIntConsumer.LInt1Int2Obj0Cons<T>, A, RS, Boolean>
			implements
				LBiInt1Obj0PredAssert<S, A, RS, T> {
		...
		@Nonnull
		public Evaluation<S, LTieIntConsumer.LInt1Int2Obj0Cons<T>, A, RS, Boolean> doesTest(int a3, int a2, T a1) {
			...
			return evaluation(() -> String.format("(%s,%s,%s)", a3, a2, a1), pc -> {
				...
				return assertFactory.apply(actual.testBiInt1Obj0(a3, a2, a1));
			});
		}
