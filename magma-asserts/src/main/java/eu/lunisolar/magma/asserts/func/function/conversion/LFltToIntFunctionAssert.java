...
public interface LFltToIntFunctionAssert<S extends LFltToIntFunctionAssert<S, A, RS>, A extends LFltToIntFunction, RS extends AbstractIntegerAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LFltConsumer, A, RS, Integer> {
	...
	@Nonnull
	Evaluation<S, LFltConsumer, A, RS, Integer> doesApplyAsInt(float a);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LFltToIntFunction, RS extends AbstractIntegerAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LFltToIntFunction, RS extends AbstractIntegerAssert<RS>> extends FullFunctionalAssert.Base<S, LFltConsumer, A, RS, Integer> implements LFltToIntFunctionAssert<S, A, RS> {
