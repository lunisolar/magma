...
public final class LSrtToIntFunctionAttest extends FunctionalAttest.Full<LSrtToIntFunctionAttest, LSrtToIntFunction, LSrtConsumer, Checks.CheckInt> {

	public LSrtToIntFunctionAttest(LSrtToIntFunction actual) {
		super(actual);
	}

	public LSrtToIntFunctionAttest(LSrtToIntFunction actual, String name) {
		super(actual, name);
	}
