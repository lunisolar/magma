...
public final class LBoolToDblFunctionAttest extends FunctionalAttest.Full<LBoolToDblFunctionAttest, LBoolToDblFunction, LBoolConsumer, Checks.CheckDbl> {

	public LBoolToDblFunctionAttest(LBoolToDblFunction actual) {
		super(actual);
	}
	...
	@Nonnull
	public DblEvaluation<LBoolToDblFunctionAttest, LBoolConsumer> doesApplyAsDbl(boolean a) {

		return new DblEvaluation<LBoolToDblFunctionAttest, LBoolConsumer>(this, () -> String.format("(%s)", a), (desc, pc) -> {
