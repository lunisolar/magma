...
public final class LObjSrtIntToIntFuncAttest<T> extends FunctionalAttest.Full<LObjSrtIntToIntFuncAttest<T>, LObjSrtIntToIntFunc<T>, LTieSrtConsumer.LObjSrtIntCons<T>, Checks.CheckInt> {

	public LObjSrtIntToIntFuncAttest(LObjSrtIntToIntFunc<T> actual) {
		super(actual);
	}

	public LObjSrtIntToIntFuncAttest(LObjSrtIntToIntFunc<T> actual, String name) {
		super(actual, name);
	}
