...
public final class JreIntPredicateAttest extends FunctionalAttest.Full<JreIntPredicateAttest, IntPredicate, LIntConsumer, Checks.CheckBool> {

	public JreIntPredicateAttest(IntPredicate actual) {
		super(actual);
	}
