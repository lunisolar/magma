...
public interface LTriPredicateAssert<S extends LTriPredicateAssert<S, A, RS, T1, T2, T3>, A extends LTriPredicate<T1, T2, T3>, RS extends AbstractBooleanAssert<RS>, T1, T2, T3>
	...
	final class The<A extends LTriPredicate<T1, T2, T3>, RS extends AbstractBooleanAssert<RS>, T1, T2, T3> extends Base<The<A, RS, T1, T2, T3>, A, RS, T1, T2, T3> {
	...
	class Base<S extends Base<S, A, RS, T1, T2, T3>, A extends LTriPredicate<T1, T2, T3>, RS extends AbstractBooleanAssert<RS>, T1, T2, T3> extends FullFunctionalAssert.Base<S, LTriConsumer<T1, T2, T3>, A, RS, Boolean>
			implements
		...
		@Nonnull
		public Evaluation<S, LTriConsumer<T1, T2, T3>, A, RS, Boolean> doesTest(T1 a1, T2 a2, T3 a3) {
