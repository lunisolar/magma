...
public final class LIntTernaryOperatorAttest extends FunctionalAttest.Full<LIntTernaryOperatorAttest, LIntTernaryOperator, LTriIntConsumer, Checks.CheckInt> {

	public LIntTernaryOperatorAttest(LIntTernaryOperator actual) {
		super(actual);
	}
	...
	@Nonnull
	public IntEvaluation<LIntTernaryOperatorAttest, LTriIntConsumer> doesApplyAsInt(int a1, int a2, int a3) {

		return new IntEvaluation<LIntTernaryOperatorAttest, LTriIntConsumer>(this, () -> String.format("(%s,%s,%s)", a1, a2, a3), (desc, pc) -> {
