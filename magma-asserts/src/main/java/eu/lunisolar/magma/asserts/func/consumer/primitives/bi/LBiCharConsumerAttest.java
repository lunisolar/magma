...
public final class LBiCharConsumerAttest extends FunctionalAttest.Simple<LBiCharConsumerAttest, LBiCharConsumer, LBiCharConsumer> {

	public LBiCharConsumerAttest(LBiCharConsumer actual) {
		super(actual);
	}
