...
public final class LUnaryOperatorAttest<T> extends FunctionalAttest.Full<LUnaryOperatorAttest<T>, LUnaryOperator<T>, LConsumer<T>, Checks.Check<T>> {

	public LUnaryOperatorAttest(LUnaryOperator<T> actual) {
		super(actual);
	}
