...
public final class LByteToFltFunctionAttest extends FunctionalAttest.Full<LByteToFltFunctionAttest, LByteToFltFunction, LByteConsumer, Checks.CheckFlt> {

	public LByteToFltFunctionAttest(LByteToFltFunction actual) {
		super(actual);
	}
	...
	@Nonnull
	public FltEvaluation<LByteToFltFunctionAttest, LByteConsumer> doesApplyAsFlt(byte a) {

		return new FltEvaluation<LByteToFltFunctionAttest, LByteConsumer>(this, () -> String.format("(%s)", a), (desc, pc) -> {
