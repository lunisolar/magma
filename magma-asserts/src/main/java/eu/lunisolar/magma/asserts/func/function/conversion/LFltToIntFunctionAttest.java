...
public final class LFltToIntFunctionAttest extends FunctionalAttest.Full<LFltToIntFunctionAttest, LFltToIntFunction, LFltConsumer, Checks.CheckInt> {

	public LFltToIntFunctionAttest(LFltToIntFunction actual) {
		super(actual);
	}

	public LFltToIntFunctionAttest(LFltToIntFunction actual, String name) {
		super(actual, name);
	}
