...
public final class LTieBoolConsumerAttest<T> extends FunctionalAttest.Simple<LTieBoolConsumerAttest<T>, LTieBoolConsumer<T>, LTieBoolConsumer<T>> {

	public LTieBoolConsumerAttest(LTieBoolConsumer<T> actual) {
		super(actual);
	}
	...
	@Nonnull
	public SemiEvaluation<LTieBoolConsumerAttest<T>, LTieBoolConsumer<T>, AssertionsCheck> doesAccept(T a1, int a2, boolean a3) {

		return new SemiEvaluation<LTieBoolConsumerAttest<T>, LTieBoolConsumer<T>, AssertionsCheck>(this, () -> String.format("(%s,%s,%s)", a1, a2, a3), (desc, pc) -> {
