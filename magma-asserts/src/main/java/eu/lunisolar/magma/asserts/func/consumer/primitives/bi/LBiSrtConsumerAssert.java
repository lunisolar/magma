...
public interface LBiSrtConsumerAssert<S extends LBiSrtConsumerAssert<S, A>, A extends LBiSrtConsumer> extends Assert<S, A>, FunctionalAssert.Simple<S, LBiSrtConsumer, A> {
	...
	@Nonnull
	SemiEvaluation<S, LBiSrtConsumer, A> doesAccept(short a1, short a2);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LBiSrtConsumer> extends Base<The<A>, A> {
	...
	class Base<S extends Base<S, A>, A extends LBiSrtConsumer> extends FunctionalAssert.Simple.Base<S, LBiSrtConsumer, A> implements LBiSrtConsumerAssert<S, A> {
