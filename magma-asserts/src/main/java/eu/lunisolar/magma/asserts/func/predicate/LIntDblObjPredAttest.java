...
public final class LIntDblObjPredAttest<T> extends FunctionalAttest.Full<LIntDblObjPredAttest<T>, LIntDblObjPred<T>, LTieDblConsumer.LIntDblObjCons<T>, Checks.CheckBool> {

	public LIntDblObjPredAttest(LIntDblObjPred<T> actual) {
		super(actual);
	}

	public LIntDblObjPredAttest(LIntDblObjPred<T> actual, String name) {
		super(actual, name);
	}
