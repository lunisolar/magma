...
public final class LFltObjPredAttest<T> extends FunctionalAttest.Full<LFltObjPredAttest<T>, LFltObjPred<T>, LObjFltConsumer.LFltObjCons<T>, Checks.CheckBool> {

	public LFltObjPredAttest(LFltObjPred<T> actual) {
		super(actual);
	}
