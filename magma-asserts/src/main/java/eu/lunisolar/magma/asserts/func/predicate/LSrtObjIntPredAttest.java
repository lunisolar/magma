...
public final class LSrtObjIntPredAttest<T> extends FunctionalAttest.Full<LSrtObjIntPredAttest<T>, LSrtObjIntPred<T>, LTieSrtConsumer.LSrtObjIntCons<T>, Checks.CheckBool> {

	public LSrtObjIntPredAttest(LSrtObjIntPred<T> actual) {
		super(actual);
	}

	public LSrtObjIntPredAttest(LSrtObjIntPred<T> actual, String name) {
		super(actual, name);
	}
