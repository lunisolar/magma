...
public final class LDblToByteFunctionAttest extends FunctionalAttest.Full<LDblToByteFunctionAttest, LDblToByteFunction, LDblConsumer, Checks.CheckByte> {

	public LDblToByteFunctionAttest(LDblToByteFunction actual) {
		super(actual);
	}
	...
	@Nonnull
	public ByteEvaluation<LDblToByteFunctionAttest, LDblConsumer> doesApplyAsByte(double a) {

		return new ByteEvaluation<LDblToByteFunctionAttest, LDblConsumer>(this, () -> String.format("(%s)", a), (desc, pc) -> {
