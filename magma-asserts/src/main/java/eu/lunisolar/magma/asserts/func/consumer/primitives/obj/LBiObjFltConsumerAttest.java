...
public final class LBiObjFltConsumerAttest<T1, T2> extends FunctionalAttest.Simple<LBiObjFltConsumerAttest<T1, T2>, LBiObjFltConsumer<T1, T2>, LBiObjFltConsumer<T1, T2>> {

	public LBiObjFltConsumerAttest(LBiObjFltConsumer<T1, T2> actual) {
		super(actual);
	}

	public LBiObjFltConsumerAttest(LBiObjFltConsumer<T1, T2> actual, String name) {
		super(actual, name);
	}
