...
public final class LBiLongPredicateAttest extends FunctionalAttest.Full<LBiLongPredicateAttest, LBiLongPredicate, LBiLongConsumer, Checks.CheckBool> {

	public LBiLongPredicateAttest(LBiLongPredicate actual) {
		super(actual);
	}
	...
	@Nonnull
	public BoolEvaluation<LBiLongPredicateAttest, LBiLongConsumer> doesTest(long a1, long a2) {

		return new BoolEvaluation<LBiLongPredicateAttest, LBiLongConsumer>(this, () -> String.format("(%s,%s)", a1, a2), (desc, pc) -> {
