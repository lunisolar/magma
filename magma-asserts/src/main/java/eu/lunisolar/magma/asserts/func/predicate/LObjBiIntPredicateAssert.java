...
public interface LObjBiIntPredicateAssert<S extends LObjBiIntPredicateAssert<S, A, RS, T>, A extends LObjBiIntPredicate<T>, RS extends AbstractBooleanAssert<RS>, T> extends Assert<S, A>, FullFunctionalAssert<S, LTieIntConsumer<T>, A, RS, Boolean> {
	...
	@Nonnull
	Evaluation<S, LTieIntConsumer<T>, A, RS, Boolean> doesTest(T a1, int a2, int a3);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LObjBiIntPredicate<T>, RS extends AbstractBooleanAssert<RS>, T> extends Base<The<A, RS, T>, A, RS, T> {
	...
	class Base<S extends Base<S, A, RS, T>, A extends LObjBiIntPredicate<T>, RS extends AbstractBooleanAssert<RS>, T> extends FullFunctionalAssert.Base<S, LTieIntConsumer<T>, A, RS, Boolean> implements LObjBiIntPredicateAssert<S, A, RS, T> {
