...
public final class LOiToLongFunctionAttest<T> extends FunctionalAttest.Full<LOiToLongFunctionAttest<T>, LOiToLongFunction<T>, LObjIntConsumer<T>, Checks.CheckLong> {

	public LOiToLongFunctionAttest(LOiToLongFunction<T> actual) {
		super(actual);
	}
	...
	@Nonnull
	public LongEvaluation<LOiToLongFunctionAttest<T>, LObjIntConsumer<T>> doesApplyAsLong(T a1, int a2) {

		return new LongEvaluation<LOiToLongFunctionAttest<T>, LObjIntConsumer<T>>(this, () -> String.format("(%s,%s)", a1, a2), (desc, pc) -> {
