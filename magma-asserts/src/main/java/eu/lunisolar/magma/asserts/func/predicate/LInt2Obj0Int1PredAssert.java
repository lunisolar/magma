...
public interface LInt2Obj0Int1PredAssert<S extends LInt2Obj0Int1PredAssert<S, A, RS, T>, A extends LObjBiIntPredicate.LInt2Obj0Int1Pred<T>, RS extends AbstractBooleanAssert<RS>, T>
		extends
			Assert<S, A>,
	...
	@Nonnull
	Evaluation<S, LTieIntConsumer.LInt1Obj0Int2Cons<T>, A, RS, Boolean> doesTest(int a3, T a1, int a2);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LObjBiIntPredicate.LInt2Obj0Int1Pred<T>, RS extends AbstractBooleanAssert<RS>, T> extends Base<The<A, RS, T>, A, RS, T> {
	...
	class Base<S extends Base<S, A, RS, T>, A extends LObjBiIntPredicate.LInt2Obj0Int1Pred<T>, RS extends AbstractBooleanAssert<RS>, T> extends FullFunctionalAssert.Base<S, LTieIntConsumer.LInt1Obj0Int2Cons<T>, A, RS, Boolean>
			implements
				LInt2Obj0Int1PredAssert<S, A, RS, T> {
		...
		@Nonnull
		public Evaluation<S, LTieIntConsumer.LInt1Obj0Int2Cons<T>, A, RS, Boolean> doesTest(int a3, T a1, int a2) {
			...
			return evaluation(() -> String.format("(%s,%s,%s)", a3, a1, a2), pc -> {
				...
				return assertFactory.apply(actual.testInt2Obj0Int1(a3, a1, a2));
			});
		}
