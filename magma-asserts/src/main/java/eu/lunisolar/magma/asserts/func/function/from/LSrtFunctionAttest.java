...
public final class LSrtFunctionAttest<R> extends FunctionalAttest.Full<LSrtFunctionAttest<R>, LSrtFunction<R>, LSrtConsumer, Checks.Check<R>> {

	public LSrtFunctionAttest(LSrtFunction<R> actual) {
		super(actual);
	}
	...
	@Nonnull
	public Evaluation<LSrtFunctionAttest<R>, LSrtConsumer, R> doesApply(short a) {

		return new Evaluation<LSrtFunctionAttest<R>, LSrtConsumer, R>(this, () -> String.format("(%s)", a), (desc, pc) -> {
