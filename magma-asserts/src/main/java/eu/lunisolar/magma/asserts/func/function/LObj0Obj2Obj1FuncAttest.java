...
public final class LObj0Obj2Obj1FuncAttest<T1, T3, T2, R> extends FunctionalAttest.Full<LObj0Obj2Obj1FuncAttest<T1, T3, T2, R>, LObj0Obj2Obj1Func<T1, T3, T2, R>, LTriConsumer<T1, T3, T2>, Checks.Check<R>> {

	public LObj0Obj2Obj1FuncAttest(LObj0Obj2Obj1Func<T1, T3, T2, R> actual) {
		super(actual);
	}

	public LObj0Obj2Obj1FuncAttest(LObj0Obj2Obj1Func<T1, T3, T2, R> actual, String name) {
		super(actual, name);
	}
