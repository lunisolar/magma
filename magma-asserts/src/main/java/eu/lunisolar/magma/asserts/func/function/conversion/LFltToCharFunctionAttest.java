...
public final class LFltToCharFunctionAttest extends FunctionalAttest.Full<LFltToCharFunctionAttest, LFltToCharFunction, LFltConsumer, Checks.CheckChar> {

	public LFltToCharFunctionAttest(LFltToCharFunction actual) {
		super(actual);
	}
	...
	@Nonnull
	public CharEvaluation<LFltToCharFunctionAttest, LFltConsumer> doesApplyAsChar(float a) {

		return new CharEvaluation<LFltToCharFunctionAttest, LFltConsumer>(this, () -> String.format("(%s)", a), (desc, pc) -> {
