...
public final class JreConsumerAttest<T> extends FunctionalAttest.Simple<JreConsumerAttest<T>, Consumer<T>, LConsumer<T>> {

	public JreConsumerAttest(Consumer<T> actual) {
		super(actual);
	}
