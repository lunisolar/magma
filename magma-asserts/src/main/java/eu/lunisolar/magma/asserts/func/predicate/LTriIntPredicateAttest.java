...
public final class LTriIntPredicateAttest extends FunctionalAttest.Full<LTriIntPredicateAttest, LTriIntPredicate, LTriIntConsumer, Checks.CheckBool> {

	public LTriIntPredicateAttest(LTriIntPredicate actual) {
		super(actual);
	}

	public LTriIntPredicateAttest(LTriIntPredicate actual, String name) {
		super(actual, name);
	}
