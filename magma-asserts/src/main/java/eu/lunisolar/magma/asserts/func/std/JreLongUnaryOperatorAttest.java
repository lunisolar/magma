...
public final class JreLongUnaryOperatorAttest extends FunctionalAttest.Full<JreLongUnaryOperatorAttest, LongUnaryOperator, LLongConsumer, Checks.CheckLong> {

	public JreLongUnaryOperatorAttest(LongUnaryOperator actual) {
		super(actual);
	}
