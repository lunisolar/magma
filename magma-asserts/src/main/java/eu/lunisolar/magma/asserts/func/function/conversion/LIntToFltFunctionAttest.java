...
public final class LIntToFltFunctionAttest extends FunctionalAttest.Full<LIntToFltFunctionAttest, LIntToFltFunction, LIntConsumer, Checks.CheckFlt> {

	public LIntToFltFunctionAttest(LIntToFltFunction actual) {
		super(actual);
	}
