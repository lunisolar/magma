...
public final class LFunctionAttest<T, R> extends FunctionalAttest.Full<LFunctionAttest<T, R>, LFunction<T, R>, LConsumer<T>, Checks.Check<R>> {

	public LFunctionAttest(LFunction<T, R> actual) {
		super(actual);
	}
	...
	@Nonnull
	public Evaluation<LFunctionAttest<T, R>, LConsumer<T>, R> doesApply(T a) {

		return new Evaluation<LFunctionAttest<T, R>, LConsumer<T>, R>(this, () -> String.format("(%s)", a), (desc, pc) -> {
