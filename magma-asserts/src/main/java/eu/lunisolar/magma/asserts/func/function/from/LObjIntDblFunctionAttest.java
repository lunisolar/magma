...
public final class LObjIntDblFunctionAttest<T, R> extends FunctionalAttest.Full<LObjIntDblFunctionAttest<T, R>, LObjIntDblFunction<T, R>, LTieDblConsumer<T>, Checks.Check<R>> {

	public LObjIntDblFunctionAttest(LObjIntDblFunction<T, R> actual) {
		super(actual);
	}

	public LObjIntDblFunctionAttest(LObjIntDblFunction<T, R> actual, String name) {
		super(actual, name);
	}
