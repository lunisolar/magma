...
public interface LTieBoolConsumerAssert<S extends LTieBoolConsumerAssert<S, A, T>, A extends LTieBoolConsumer<T>, T> extends Assert<S, A>, FunctionalAssert.Simple<S, LTieBoolConsumer<T>, A> {
	...
	@Nonnull
	SemiEvaluation<S, LTieBoolConsumer<T>, A> doesAccept(T a1, int a2, boolean a3);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LTieBoolConsumer<T>, T> extends Base<The<A, T>, A, T> {
	...
	class Base<S extends Base<S, A, T>, A extends LTieBoolConsumer<T>, T> extends FunctionalAssert.Simple.Base<S, LTieBoolConsumer<T>, A> implements LTieBoolConsumerAssert<S, A, T> {
		...
		@Nonnull
		public SemiEvaluation<S, LTieBoolConsumer<T>, A> doesAccept(T a1, int a2, boolean a3) {
