...
public interface LSrtToIntFunctionAssert<S extends LSrtToIntFunctionAssert<S, A, RS>, A extends LSrtToIntFunction, RS extends AbstractIntegerAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LSrtConsumer, A, RS, Integer> {
	...
	@Nonnull
	Evaluation<S, LSrtConsumer, A, RS, Integer> doesApplyAsInt(short a);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LSrtToIntFunction, RS extends AbstractIntegerAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LSrtToIntFunction, RS extends AbstractIntegerAssert<RS>> extends FullFunctionalAssert.Base<S, LSrtConsumer, A, RS, Integer> implements LSrtToIntFunctionAssert<S, A, RS> {
