...
public final class LDblIntObjConsAttest<T> extends FunctionalAttest.Simple<LDblIntObjConsAttest<T>, LDblIntObjCons<T>, LTieDblConsumer.LDblIntObjCons<T>> {

	public LDblIntObjConsAttest(LDblIntObjCons<T> actual) {
		super(actual);
	}

	public LDblIntObjConsAttest(LDblIntObjCons<T> actual, String name) {
		super(actual, name);
	}
