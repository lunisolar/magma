...
public final class LSrtToByteFunctionAttest extends FunctionalAttest.Full<LSrtToByteFunctionAttest, LSrtToByteFunction, LSrtConsumer, Checks.CheckByte> {

	public LSrtToByteFunctionAttest(LSrtToByteFunction actual) {
		super(actual);
	}
	...
	@Nonnull
	public ByteEvaluation<LSrtToByteFunctionAttest, LSrtConsumer> doesApplyAsByte(short a) {

		return new ByteEvaluation<LSrtToByteFunctionAttest, LSrtConsumer>(this, () -> String.format("(%s)", a), (desc, pc) -> {
