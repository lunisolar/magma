...
public final class LBoolFunctionAttest<R> extends FunctionalAttest.Full<LBoolFunctionAttest<R>, LBoolFunction<R>, LBoolConsumer, Checks.Check<R>> {

	public LBoolFunctionAttest(LBoolFunction<R> actual) {
		super(actual);
	}
	...
	@Nonnull
	public Evaluation<LBoolFunctionAttest<R>, LBoolConsumer, R> doesApply(boolean a) {

		return new Evaluation<LBoolFunctionAttest<R>, LBoolConsumer, R>(this, () -> String.format("(%s)", a), (desc, pc) -> {
