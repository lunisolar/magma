...
public final class LLong1Long0ConsAttest extends FunctionalAttest.Simple<LLong1Long0ConsAttest, LLong1Long0Cons, LBiLongConsumer> {

	public LLong1Long0ConsAttest(LLong1Long0Cons actual) {
		super(actual);
	}
	...
	@Nonnull
	public SemiEvaluation<LLong1Long0ConsAttest, LBiLongConsumer, AssertionsCheck> doesAccept(long a2, long a1) {

		return new SemiEvaluation<LLong1Long0ConsAttest, LBiLongConsumer, AssertionsCheck>(this, () -> String.format("(%s,%s)", a2, a1), (desc, pc) -> {
