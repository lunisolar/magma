...
public final class LObjDblFunctionAttest<T, R> extends FunctionalAttest.Full<LObjDblFunctionAttest<T, R>, LObjDblFunction<T, R>, LObjDblConsumer<T>, Checks.Check<R>> {

	public LObjDblFunctionAttest(LObjDblFunction<T, R> actual) {
		super(actual);
	}
	...
	@Nonnull
	public Evaluation<LObjDblFunctionAttest<T, R>, LObjDblConsumer<T>, R> doesApply(T a1, double a2) {

		return new Evaluation<LObjDblFunctionAttest<T, R>, LObjDblConsumer<T>, R>(this, () -> String.format("(%s,%s)", a1, a2), (desc, pc) -> {
