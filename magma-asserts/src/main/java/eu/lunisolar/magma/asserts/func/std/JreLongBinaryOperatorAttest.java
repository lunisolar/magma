...
public final class JreLongBinaryOperatorAttest extends FunctionalAttest.Full<JreLongBinaryOperatorAttest, LongBinaryOperator, LBiLongConsumer, Checks.CheckLong> {

	public JreLongBinaryOperatorAttest(LongBinaryOperator actual) {
		super(actual);
	}
