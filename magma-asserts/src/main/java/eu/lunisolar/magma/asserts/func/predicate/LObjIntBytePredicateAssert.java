...
public interface LObjIntBytePredicateAssert<S extends LObjIntBytePredicateAssert<S, A, RS, T>, A extends LObjIntBytePredicate<T>, RS extends AbstractBooleanAssert<RS>, T> extends Assert<S, A>, FullFunctionalAssert<S, LTieByteConsumer<T>, A, RS, Boolean> {
	...
	@Nonnull
	Evaluation<S, LTieByteConsumer<T>, A, RS, Boolean> doesTest(T a1, int a2, byte a3);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LObjIntBytePredicate<T>, RS extends AbstractBooleanAssert<RS>, T> extends Base<The<A, RS, T>, A, RS, T> {
	...
	class Base<S extends Base<S, A, RS, T>, A extends LObjIntBytePredicate<T>, RS extends AbstractBooleanAssert<RS>, T> extends FullFunctionalAssert.Base<S, LTieByteConsumer<T>, A, RS, Boolean> implements LObjIntBytePredicateAssert<S, A, RS, T> {
		...
		@Nonnull
		public Evaluation<S, LTieByteConsumer<T>, A, RS, Boolean> doesTest(T a1, int a2, byte a3) {
