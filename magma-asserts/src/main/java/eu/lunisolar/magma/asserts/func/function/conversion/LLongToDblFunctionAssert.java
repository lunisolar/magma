...
public interface LLongToDblFunctionAssert<S extends LLongToDblFunctionAssert<S, A, RS>, A extends LLongToDblFunction, RS extends AbstractDoubleAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LLongConsumer, A, RS, Double> {
	...
	final class The<A extends LLongToDblFunction, RS extends AbstractDoubleAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LLongToDblFunction, RS extends AbstractDoubleAssert<RS>> extends FullFunctionalAssert.Base<S, LLongConsumer, A, RS, Double> implements LLongToDblFunctionAssert<S, A, RS> {
