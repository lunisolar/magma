...
public final class JreFunctionAttest<T, R> extends FunctionalAttest.Full<JreFunctionAttest<T, R>, Function<T, R>, LConsumer<T>, Checks.Check<R>> {

	public JreFunctionAttest(Function<T, R> actual) {
		super(actual);
	}
	...
	@Nonnull
	public Evaluation<JreFunctionAttest<T, R>, LConsumer<T>, R> doesApply(T a) {

		return new Evaluation<JreFunctionAttest<T, R>, LConsumer<T>, R>(this, () -> String.format("(%s)", a), (desc, pc) -> {
