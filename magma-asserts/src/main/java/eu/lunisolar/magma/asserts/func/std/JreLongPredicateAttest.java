...
public final class JreLongPredicateAttest extends FunctionalAttest.Full<JreLongPredicateAttest, LongPredicate, LLongConsumer, Checks.CheckBool> {

	public JreLongPredicateAttest(LongPredicate actual) {
		super(actual);
	}
	...
	@Nonnull
	public BoolEvaluation<JreLongPredicateAttest, LLongConsumer> doesTest(long a) {

		return new BoolEvaluation<JreLongPredicateAttest, LLongConsumer>(this, () -> String.format("(%s)", a), (desc, pc) -> {
