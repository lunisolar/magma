...
public interface LSrtToLongFunctionAssert<S extends LSrtToLongFunctionAssert<S, A, RS>, A extends LSrtToLongFunction, RS extends AbstractLongAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LSrtConsumer, A, RS, Long> {
	...
	@Nonnull
	Evaluation<S, LSrtConsumer, A, RS, Long> doesApplyAsLong(short a);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LSrtToLongFunction, RS extends AbstractLongAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LSrtToLongFunction, RS extends AbstractLongAssert<RS>> extends FullFunctionalAssert.Base<S, LSrtConsumer, A, RS, Long> implements LSrtToLongFunctionAssert<S, A, RS> {
