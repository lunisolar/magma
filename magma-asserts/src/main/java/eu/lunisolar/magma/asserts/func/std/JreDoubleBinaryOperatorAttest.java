...
public final class JreDoubleBinaryOperatorAttest extends FunctionalAttest.Full<JreDoubleBinaryOperatorAttest, DoubleBinaryOperator, LBiDblConsumer, Checks.CheckDbl> {

	public JreDoubleBinaryOperatorAttest(DoubleBinaryOperator actual) {
		super(actual);
	}
