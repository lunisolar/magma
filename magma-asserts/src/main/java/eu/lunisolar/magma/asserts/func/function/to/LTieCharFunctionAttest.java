...
public final class LTieCharFunctionAttest<T> extends FunctionalAttest.Full<LTieCharFunctionAttest<T>, LTieCharFunction<T>, LTieCharConsumer<T>, Checks.CheckInt> {

	public LTieCharFunctionAttest(LTieCharFunction<T> actual) {
		super(actual);
	}
	...
	@Nonnull
	public IntEvaluation<LTieCharFunctionAttest<T>, LTieCharConsumer<T>> doesApplyAsInt(T a1, int a2, char a3) {

		return new IntEvaluation<LTieCharFunctionAttest<T>, LTieCharConsumer<T>>(this, () -> String.format("(%s,%s,%s)", a1, a2, a3), (desc, pc) -> {
