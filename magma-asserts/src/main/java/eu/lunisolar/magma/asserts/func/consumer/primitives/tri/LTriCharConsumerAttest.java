...
public final class LTriCharConsumerAttest extends FunctionalAttest.Simple<LTriCharConsumerAttest, LTriCharConsumer, LTriCharConsumer> {

	public LTriCharConsumerAttest(LTriCharConsumer actual) {
		super(actual);
	}
