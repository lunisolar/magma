...
public final class LSrtConsumerAttest extends FunctionalAttest.Simple<LSrtConsumerAttest, LSrtConsumer, LSrtConsumer> {

	public LSrtConsumerAttest(LSrtConsumer actual) {
		super(actual);
	}

	public LSrtConsumerAttest(LSrtConsumer actual, String name) {
		super(actual, name);
	}
