...
public final class LObjLongIntPredAttest<T> extends FunctionalAttest.Full<LObjLongIntPredAttest<T>, LObjLongIntPred<T>, LTieLongConsumer.LObjLongIntCons<T>, Checks.CheckBool> {

	public LObjLongIntPredAttest(LObjLongIntPred<T> actual) {
		super(actual);
	}

	public LObjLongIntPredAttest(LObjLongIntPred<T> actual, String name) {
		super(actual, name);
	}
