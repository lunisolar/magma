...
/** Assert class for LByte1Byte0Pred. */
public interface LByte1Byte0PredAssert<S extends LByte1Byte0PredAssert<S, A, RS>, A extends LBiBytePredicate.LByte1Byte0Pred, RS extends AbstractBooleanAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LBiByteConsumer, A, RS, Boolean> {
	...
	@Nonnull
	Evaluation<S, LBiByteConsumer, A, RS, Boolean> doesTest(byte a2, byte a1);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LBiBytePredicate.LByte1Byte0Pred, RS extends AbstractBooleanAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LBiBytePredicate.LByte1Byte0Pred, RS extends AbstractBooleanAssert<RS>> extends FullFunctionalAssert.Base<S, LBiByteConsumer, A, RS, Boolean> implements LByte1Byte0PredAssert<S, A, RS> {
		...
		@Nonnull
		public Evaluation<S, LBiByteConsumer, A, RS, Boolean> doesTest(byte a2, byte a1) {

			return evaluation(() -> String.format("(%s,%s)", a2, a1), pc -> {
				if (pc != null) {
					pc.accept(a2, a1);
				}
				return assertFactory.apply(actual.testByte1Byte0(a2, a1));
			});
		}
