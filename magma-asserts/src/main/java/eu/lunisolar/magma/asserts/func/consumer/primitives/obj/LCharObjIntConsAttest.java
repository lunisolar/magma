...
public final class LCharObjIntConsAttest<T> extends FunctionalAttest.Simple<LCharObjIntConsAttest<T>, LCharObjIntCons<T>, LTieCharConsumer.LCharObjIntCons<T>> {

	public LCharObjIntConsAttest(LCharObjIntCons<T> actual) {
		super(actual);
	}

	public LCharObjIntConsAttest(LCharObjIntCons<T> actual, String name) {
		super(actual, name);
	}
	...
	public SemiEvaluation<LCharObjIntConsAttest<T>, LTieCharConsumer.LCharObjIntCons<T>, AssertionsCheck> doesAccept(char a3, T a1, int a2) {
		...
		return new SemiEvaluation<LCharObjIntConsAttest<T>, LTieCharConsumer.LCharObjIntCons<T>, AssertionsCheck>(this, () -> String.format("(%s,%s,%s)", a3, a1, a2), (desc, pc) -> {
			...
			func.acceptCharObjInt(a3, a1, a2);
			return null;
