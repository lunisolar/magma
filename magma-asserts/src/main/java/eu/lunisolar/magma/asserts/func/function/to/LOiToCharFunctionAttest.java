...
public final class LOiToCharFunctionAttest<T> extends FunctionalAttest.Full<LOiToCharFunctionAttest<T>, LOiToCharFunction<T>, LObjIntConsumer<T>, Checks.CheckChar> {

	public LOiToCharFunctionAttest(LOiToCharFunction<T> actual) {
		super(actual);
	}
