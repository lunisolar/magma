...
public final class LSrtIntObjConsAttest<T> extends FunctionalAttest.Simple<LSrtIntObjConsAttest<T>, LSrtIntObjCons<T>, LTieSrtConsumer.LSrtIntObjCons<T>> {

	public LSrtIntObjConsAttest(LSrtIntObjCons<T> actual) {
		super(actual);
	}

	public LSrtIntObjConsAttest(LSrtIntObjCons<T> actual, String name) {
		super(actual, name);
	}
