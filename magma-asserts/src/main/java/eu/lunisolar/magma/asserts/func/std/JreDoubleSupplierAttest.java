...
public final class JreDoubleSupplierAttest extends FunctionalAttest.Full<JreDoubleSupplierAttest, DoubleSupplier, LAction, Checks.CheckDbl> {

	public JreDoubleSupplierAttest(DoubleSupplier actual) {
		super(actual);
	}
	...
	@Nonnull
	public JreDoubleSupplierAttest doesReturn(double value) {
