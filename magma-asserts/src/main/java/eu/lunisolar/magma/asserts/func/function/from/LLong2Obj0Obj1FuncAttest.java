...
public final class LLong2Obj0Obj1FuncAttest<T1, T2, R> extends FunctionalAttest.Full<LLong2Obj0Obj1FuncAttest<T1, T2, R>, LLong2Obj0Obj1Func<T1, T2, R>, LBiObjLongConsumer.LLong2Obj0Obj1Cons<T1, T2>, Checks.Check<R>> {

	public LLong2Obj0Obj1FuncAttest(LLong2Obj0Obj1Func<T1, T2, R> actual) {
		super(actual);
	}

	public LLong2Obj0Obj1FuncAttest(LLong2Obj0Obj1Func<T1, T2, R> actual, String name) {
		super(actual, name);
	}
