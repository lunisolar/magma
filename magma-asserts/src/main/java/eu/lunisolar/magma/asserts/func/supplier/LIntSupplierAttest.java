...
public final class LIntSupplierAttest extends FunctionalAttest.Full<LIntSupplierAttest, LIntSupplier, LAction, Checks.CheckInt> {

	public LIntSupplierAttest(LIntSupplier actual) {
		super(actual);
	}
	...
	@Nonnull
	public IntEvaluation<LIntSupplierAttest, LAction> doesGetAsInt() {

		return new IntEvaluation<LIntSupplierAttest, LAction>(this, () -> String.format("()"), (desc, pc) -> {
	...
	@Nonnull
	public LIntSupplierAttest doesReturn(int value) {
