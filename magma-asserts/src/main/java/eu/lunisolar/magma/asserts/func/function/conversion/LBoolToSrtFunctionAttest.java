...
public final class LBoolToSrtFunctionAttest extends FunctionalAttest.Full<LBoolToSrtFunctionAttest, LBoolToSrtFunction, LBoolConsumer, Checks.CheckSrt> {

	public LBoolToSrtFunctionAttest(LBoolToSrtFunction actual) {
		super(actual);
	}
	...
	@Nonnull
	public SrtEvaluation<LBoolToSrtFunctionAttest, LBoolConsumer> doesApplyAsSrt(boolean a) {

		return new SrtEvaluation<LBoolToSrtFunctionAttest, LBoolConsumer>(this, () -> String.format("(%s)", a), (desc, pc) -> {
