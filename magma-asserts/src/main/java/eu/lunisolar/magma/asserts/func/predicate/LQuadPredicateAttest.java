...
public final class LQuadPredicateAttest<T1, T2, T3, T4> extends FunctionalAttest.Full<LQuadPredicateAttest<T1, T2, T3, T4>, LQuadPredicate<T1, T2, T3, T4>, LQuadConsumer<T1, T2, T3, T4>, Checks.CheckBool> {

	public LQuadPredicateAttest(LQuadPredicate<T1, T2, T3, T4> actual) {
		super(actual);
	}
