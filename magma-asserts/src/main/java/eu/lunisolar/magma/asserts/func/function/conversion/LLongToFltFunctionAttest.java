...
public final class LLongToFltFunctionAttest extends FunctionalAttest.Full<LLongToFltFunctionAttest, LLongToFltFunction, LLongConsumer, Checks.CheckFlt> {

	public LLongToFltFunctionAttest(LLongToFltFunction actual) {
		super(actual);
	}
	...
	@Nonnull
	public FltEvaluation<LLongToFltFunctionAttest, LLongConsumer> doesApplyAsFlt(long a) {

		return new FltEvaluation<LLongToFltFunctionAttest, LLongConsumer>(this, () -> String.format("(%s)", a), (desc, pc) -> {
