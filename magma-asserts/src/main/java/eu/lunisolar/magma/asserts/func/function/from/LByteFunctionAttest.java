...
public final class LByteFunctionAttest<R> extends FunctionalAttest.Full<LByteFunctionAttest<R>, LByteFunction<R>, LByteConsumer, Checks.Check<R>> {

	public LByteFunctionAttest(LByteFunction<R> actual) {
		super(actual);
	}
