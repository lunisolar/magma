...
public final class LLongIntConsumerAttest extends FunctionalAttest.Simple<LLongIntConsumerAttest, LLongIntConsumer, LLongIntConsumer> {

	public LLongIntConsumerAttest(LLongIntConsumer actual) {
		super(actual);
	}
	...
	@Nonnull
	public SemiEvaluation<LLongIntConsumerAttest, LLongIntConsumer, AssertionsCheck> doesAccept(long a1, int a2) {

		return new SemiEvaluation<LLongIntConsumerAttest, LLongIntConsumer, AssertionsCheck>(this, () -> String.format("(%s,%s)", a1, a2), (desc, pc) -> {
