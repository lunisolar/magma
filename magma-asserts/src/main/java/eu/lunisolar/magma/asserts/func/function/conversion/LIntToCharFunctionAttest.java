...
public final class LIntToCharFunctionAttest extends FunctionalAttest.Full<LIntToCharFunctionAttest, LIntToCharFunction, LIntConsumer, Checks.CheckChar> {

	public LIntToCharFunctionAttest(LIntToCharFunction actual) {
		super(actual);
	}

	public LIntToCharFunctionAttest(LIntToCharFunction actual, String name) {
		super(actual, name);
	}
