...
public final class LObj0Obj2Obj1ConsAttest<T1, T3, T2> extends FunctionalAttest.Simple<LObj0Obj2Obj1ConsAttest<T1, T3, T2>, LObj0Obj2Obj1Cons<T1, T3, T2>, LTriConsumer<T1, T3, T2>> {

	public LObj0Obj2Obj1ConsAttest(LObj0Obj2Obj1Cons<T1, T3, T2> actual) {
		super(actual);
	}

	public LObj0Obj2Obj1ConsAttest(LObj0Obj2Obj1Cons<T1, T3, T2> actual, String name) {
		super(actual, name);
	}
	...
	public SemiEvaluation<LObj0Obj2Obj1ConsAttest<T1, T3, T2>, LTriConsumer<T1, T3, T2>, AssertionsCheck> doesAccept(T1 a1, T3 a3, T2 a2) {
		...
		return new SemiEvaluation<LObj0Obj2Obj1ConsAttest<T1, T3, T2>, LTriConsumer<T1, T3, T2>, AssertionsCheck>(this, () -> String.format("(%s,%s,%s)", a1, a3, a2), (desc, pc) -> {
			...
			func.acceptObj0Obj2Obj1(a1, a3, a2);
			return null;
