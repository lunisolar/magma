...
public final class LLongObjFuncAttest<T, R> extends FunctionalAttest.Full<LLongObjFuncAttest<T, R>, LLongObjFunc<T, R>, LObjLongConsumer.LLongObjCons<T>, Checks.Check<R>> {

	public LLongObjFuncAttest(LLongObjFunc<T, R> actual) {
		super(actual);
	}

	public LLongObjFuncAttest(LLongObjFunc<T, R> actual, String name) {
		super(actual, name);
	}
	...
	@Nonnull
	public Evaluation<LLongObjFuncAttest<T, R>, LObjLongConsumer.LLongObjCons<T>, R> doesApply(long a2, T a1) {

		return new Evaluation<LLongObjFuncAttest<T, R>, LObjLongConsumer.LLongObjCons<T>, R>(this, () -> String.format("(%s,%s)", a2, a1), (desc, pc) -> {
			...
			var result = func.applyLongObj(a2, a1);
