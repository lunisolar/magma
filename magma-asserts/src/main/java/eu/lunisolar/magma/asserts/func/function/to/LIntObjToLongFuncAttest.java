...
public final class LIntObjToLongFuncAttest<T> extends FunctionalAttest.Full<LIntObjToLongFuncAttest<T>, LIntObjToLongFunc<T>, LObjIntConsumer.LIntObjCons<T>, Checks.CheckLong> {

	public LIntObjToLongFuncAttest(LIntObjToLongFunc<T> actual) {
		super(actual);
	}

	public LIntObjToLongFuncAttest(LIntObjToLongFunc<T> actual, String name) {
		super(actual, name);
	}
