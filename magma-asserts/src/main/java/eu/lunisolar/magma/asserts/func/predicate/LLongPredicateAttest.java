...
public final class LLongPredicateAttest extends FunctionalAttest.Full<LLongPredicateAttest, LLongPredicate, LLongConsumer, Checks.CheckBool> {

	public LLongPredicateAttest(LLongPredicate actual) {
		super(actual);
	}
	...
	@Nonnull
	public BoolEvaluation<LLongPredicateAttest, LLongConsumer> doesTest(long a) {

		return new BoolEvaluation<LLongPredicateAttest, LLongConsumer>(this, () -> String.format("(%s)", a), (desc, pc) -> {
