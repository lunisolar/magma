...
public final class LToCharBiFunctionAttest<T1, T2> extends FunctionalAttest.Full<LToCharBiFunctionAttest<T1, T2>, LToCharBiFunction<T1, T2>, LBiConsumer<T1, T2>, Checks.CheckChar> {

	public LToCharBiFunctionAttest(LToCharBiFunction<T1, T2> actual) {
		super(actual);
	}
