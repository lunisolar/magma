...
public final class LToLongFunctionAttest<T> extends FunctionalAttest.Full<LToLongFunctionAttest<T>, LToLongFunction<T>, LConsumer<T>, Checks.CheckLong> {

	public LToLongFunctionAttest(LToLongFunction<T> actual) {
		super(actual);
	}
