...
public final class JreDoubleUnaryOperatorAttest extends FunctionalAttest.Full<JreDoubleUnaryOperatorAttest, DoubleUnaryOperator, LDblConsumer, Checks.CheckDbl> {

	public JreDoubleUnaryOperatorAttest(DoubleUnaryOperator actual) {
		super(actual);
	}
	...
	@Nonnull
	public DblEvaluation<JreDoubleUnaryOperatorAttest, LDblConsumer> doesApplyAsDbl(double a) {

		return new DblEvaluation<JreDoubleUnaryOperatorAttest, LDblConsumer>(this, () -> String.format("(%s)", a), (desc, pc) -> {
