...
public final class LBoolToByteFunctionAttest extends FunctionalAttest.Full<LBoolToByteFunctionAttest, LBoolToByteFunction, LBoolConsumer, Checks.CheckByte> {

	public LBoolToByteFunctionAttest(LBoolToByteFunction actual) {
		super(actual);
	}
	...
	@Nonnull
	public ByteEvaluation<LBoolToByteFunctionAttest, LBoolConsumer> doesApplyAsByte(boolean a) {

		return new ByteEvaluation<LBoolToByteFunctionAttest, LBoolConsumer>(this, () -> String.format("(%s)", a), (desc, pc) -> {
