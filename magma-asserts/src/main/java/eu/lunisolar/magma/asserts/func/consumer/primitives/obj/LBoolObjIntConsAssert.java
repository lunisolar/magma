...
public interface LBoolObjIntConsAssert<S extends LBoolObjIntConsAssert<S, A, T>, A extends LTieBoolConsumer.LBoolObjIntCons<T>, T> extends Assert<S, A>, FunctionalAssert.Simple<S, LTieBoolConsumer.LBoolObjIntCons<T>, A> {
	...
	@Nonnull
	SemiEvaluation<S, LTieBoolConsumer.LBoolObjIntCons<T>, A> doesAccept(boolean a3, T a1, int a2);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LTieBoolConsumer.LBoolObjIntCons<T>, T> extends Base<The<A, T>, A, T> {
	...
	class Base<S extends Base<S, A, T>, A extends LTieBoolConsumer.LBoolObjIntCons<T>, T> extends FunctionalAssert.Simple.Base<S, LTieBoolConsumer.LBoolObjIntCons<T>, A> implements LBoolObjIntConsAssert<S, A, T> {
		...
		@Nonnull
		public SemiEvaluation<S, LTieBoolConsumer.LBoolObjIntCons<T>, A> doesAccept(boolean a3, T a1, int a2) {
			...
			return evaluation(() -> String.format("(%s,%s,%s)", a3, a1, a2), pc -> {
				...
				actual.acceptBoolObjInt(a3, a1, a2);
				return null;
			});
		}
