...
public final class LDblObjFuncAttest<T, R> extends FunctionalAttest.Full<LDblObjFuncAttest<T, R>, LDblObjFunc<T, R>, LObjDblConsumer.LDblObjCons<T>, Checks.Check<R>> {

	public LDblObjFuncAttest(LDblObjFunc<T, R> actual) {
		super(actual);
	}

	public LDblObjFuncAttest(LDblObjFunc<T, R> actual, String name) {
		super(actual, name);
	}
	...
	@Nonnull
	public Evaluation<LDblObjFuncAttest<T, R>, LObjDblConsumer.LDblObjCons<T>, R> doesApply(double a2, T a1) {

		return new Evaluation<LDblObjFuncAttest<T, R>, LObjDblConsumer.LDblObjCons<T>, R>(this, () -> String.format("(%s,%s)", a2, a1), (desc, pc) -> {
			...
			var result = func.applyDblObj(a2, a1);
