...
public final class LCharToDblFunctionAttest extends FunctionalAttest.Full<LCharToDblFunctionAttest, LCharToDblFunction, LCharConsumer, Checks.CheckDbl> {

	public LCharToDblFunctionAttest(LCharToDblFunction actual) {
		super(actual);
	}
	...
	@Nonnull
	public DblEvaluation<LCharToDblFunctionAttest, LCharConsumer> doesApplyAsDbl(char a) {

		return new DblEvaluation<LCharToDblFunctionAttest, LCharConsumer>(this, () -> String.format("(%s)", a), (desc, pc) -> {
