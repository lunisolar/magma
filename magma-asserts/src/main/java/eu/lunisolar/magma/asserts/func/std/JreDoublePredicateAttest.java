...
public final class JreDoublePredicateAttest extends FunctionalAttest.Full<JreDoublePredicateAttest, DoublePredicate, LDblConsumer, Checks.CheckBool> {

	public JreDoublePredicateAttest(DoublePredicate actual) {
		super(actual);
	}
	...
	@Nonnull
	public BoolEvaluation<JreDoublePredicateAttest, LDblConsumer> doesTest(double a) {

		return new BoolEvaluation<JreDoublePredicateAttest, LDblConsumer>(this, () -> String.format("(%s)", a), (desc, pc) -> {
