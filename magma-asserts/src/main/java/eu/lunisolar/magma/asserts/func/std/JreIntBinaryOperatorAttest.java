...
public final class JreIntBinaryOperatorAttest extends FunctionalAttest.Full<JreIntBinaryOperatorAttest, IntBinaryOperator, LBiIntConsumer, Checks.CheckInt> {

	public JreIntBinaryOperatorAttest(IntBinaryOperator actual) {
		super(actual);
	}
	...
	@Nonnull
	public IntEvaluation<JreIntBinaryOperatorAttest, LBiIntConsumer> doesApplyAsInt(int a1, int a2) {

		return new IntEvaluation<JreIntBinaryOperatorAttest, LBiIntConsumer>(this, () -> String.format("(%s,%s)", a1, a2), (desc, pc) -> {
