...
public final class LIntUnaryOperatorAttest extends FunctionalAttest.Full<LIntUnaryOperatorAttest, LIntUnaryOperator, LIntConsumer, Checks.CheckInt> {

	public LIntUnaryOperatorAttest(LIntUnaryOperator actual) {
		super(actual);
	}
