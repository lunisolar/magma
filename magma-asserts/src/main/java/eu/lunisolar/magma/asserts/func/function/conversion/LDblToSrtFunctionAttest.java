...
public final class LDblToSrtFunctionAttest extends FunctionalAttest.Full<LDblToSrtFunctionAttest, LDblToSrtFunction, LDblConsumer, Checks.CheckSrt> {

	public LDblToSrtFunctionAttest(LDblToSrtFunction actual) {
		super(actual);
	}
