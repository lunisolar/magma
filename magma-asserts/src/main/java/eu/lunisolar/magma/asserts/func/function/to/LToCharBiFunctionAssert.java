...
public interface LToCharBiFunctionAssert<S extends LToCharBiFunctionAssert<S, A, RS, T1, T2>, A extends LToCharBiFunction<T1, T2>, RS extends AbstractCharacterAssert<RS>, T1, T2>
	...
	final class The<A extends LToCharBiFunction<T1, T2>, RS extends AbstractCharacterAssert<RS>, T1, T2> extends Base<The<A, RS, T1, T2>, A, RS, T1, T2> {
	...
	class Base<S extends Base<S, A, RS, T1, T2>, A extends LToCharBiFunction<T1, T2>, RS extends AbstractCharacterAssert<RS>, T1, T2> extends FullFunctionalAssert.Base<S, LBiConsumer<T1, T2>, A, RS, Character>
			implements
		...
		@Nonnull
		public Evaluation<S, LBiConsumer<T1, T2>, A, RS, Character> doesApplyAsChar(T1 a1, T2 a2) {
