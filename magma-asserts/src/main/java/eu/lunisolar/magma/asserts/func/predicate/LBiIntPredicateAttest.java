...
public final class LBiIntPredicateAttest extends FunctionalAttest.Full<LBiIntPredicateAttest, LBiIntPredicate, LBiIntConsumer, Checks.CheckBool> {

	public LBiIntPredicateAttest(LBiIntPredicate actual) {
		super(actual);
	}
	...
	@Nonnull
	public BoolEvaluation<LBiIntPredicateAttest, LBiIntConsumer> doesTest(int a1, int a2) {

		return new BoolEvaluation<LBiIntPredicateAttest, LBiIntConsumer>(this, () -> String.format("(%s,%s)", a1, a2), (desc, pc) -> {
