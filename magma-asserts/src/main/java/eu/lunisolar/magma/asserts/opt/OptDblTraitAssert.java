...
public class OptDblTraitAssert extends AbstractObjectAssert<OptDblTraitAssert, OptDblTrait<?>> implements FluentTrait<OptDblTraitAssert>, Attest<OptDblTraitAssert, OptDblTrait<?>> {
	...
	public OptDblTraitAssert isPresent() {
		isNotNull();
		must(OptDblTrait::isPresent, "<%s> is expected to have value, but is void.");
		return this;
	}
	...
	public OptDblTraitAssert isVoid() {
		isNotNull();
		must(OptDblTrait::isVoid, "<%s> is expected to NOT have value, but it does.");
		return this;
	}
