...
public final class LObjLongPredicateAttest<T> extends FunctionalAttest.Full<LObjLongPredicateAttest<T>, LObjLongPredicate<T>, LObjLongConsumer<T>, Checks.CheckBool> {

	public LObjLongPredicateAttest(LObjLongPredicate<T> actual) {
		super(actual);
	}
	...
	@Nonnull
	public BoolEvaluation<LObjLongPredicateAttest<T>, LObjLongConsumer<T>> doesTest(T a1, long a2) {

		return new BoolEvaluation<LObjLongPredicateAttest<T>, LObjLongConsumer<T>>(this, () -> String.format("(%s,%s)", a1, a2), (desc, pc) -> {
