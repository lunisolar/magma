...
public final class LDblFunctionAttest<R> extends FunctionalAttest.Full<LDblFunctionAttest<R>, LDblFunction<R>, LDblConsumer, Checks.Check<R>> {

	public LDblFunctionAttest(LDblFunction<R> actual) {
		super(actual);
	}
	...
	@Nonnull
	public Evaluation<LDblFunctionAttest<R>, LDblConsumer, R> doesApply(double a) {

		return new Evaluation<LDblFunctionAttest<R>, LDblConsumer, R>(this, () -> String.format("(%s)", a), (desc, pc) -> {
