...
public final class LDblObjIntFuncAttest<T, R> extends FunctionalAttest.Full<LDblObjIntFuncAttest<T, R>, LDblObjIntFunc<T, R>, LTieDblConsumer.LDblObjIntCons<T>, Checks.Check<R>> {

	public LDblObjIntFuncAttest(LDblObjIntFunc<T, R> actual) {
		super(actual);
	}

	public LDblObjIntFuncAttest(LDblObjIntFunc<T, R> actual, String name) {
		super(actual, name);
	}
