...
public final class JreBiFunctionAttest<T1, T2, R> extends FunctionalAttest.Full<JreBiFunctionAttest<T1, T2, R>, BiFunction<T1, T2, R>, LBiConsumer<T1, T2>, Checks.Check<R>> {

	public JreBiFunctionAttest(BiFunction<T1, T2, R> actual) {
		super(actual);
	}
	...
	@Nonnull
	public Evaluation<JreBiFunctionAttest<T1, T2, R>, LBiConsumer<T1, T2>, R> doesApply(T1 a1, T2 a2) {

		return new Evaluation<JreBiFunctionAttest<T1, T2, R>, LBiConsumer<T1, T2>, R>(this, () -> String.format("(%s,%s)", a1, a2), (desc, pc) -> {
