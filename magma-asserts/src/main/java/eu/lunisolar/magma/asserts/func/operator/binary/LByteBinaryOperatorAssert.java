...
public interface LByteBinaryOperatorAssert<S extends LByteBinaryOperatorAssert<S, A, RS>, A extends LByteBinaryOperator, RS extends AbstractByteAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LBiByteConsumer, A, RS, Byte> {
	...
	@Nonnull
	Evaluation<S, LBiByteConsumer, A, RS, Byte> doesApplyAsByte(byte a1, byte a2);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LByteBinaryOperator, RS extends AbstractByteAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LByteBinaryOperator, RS extends AbstractByteAssert<RS>> extends FullFunctionalAssert.Base<S, LBiByteConsumer, A, RS, Byte> implements LByteBinaryOperatorAssert<S, A, RS> {
		...
		@Nonnull
		public Evaluation<S, LBiByteConsumer, A, RS, Byte> doesApplyAsByte(byte a1, byte a2) {
