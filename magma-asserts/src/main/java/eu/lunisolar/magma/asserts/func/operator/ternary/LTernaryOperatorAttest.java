...
public final class LTernaryOperatorAttest<T> extends FunctionalAttest.Full<LTernaryOperatorAttest<T>, LTernaryOperator<T>, LTriConsumer<T, T, T>, Checks.Check<T>> {

	public LTernaryOperatorAttest(LTernaryOperator<T> actual) {
		super(actual);
	}
