...
public final class LBiSrtFunctionAttest<R> extends FunctionalAttest.Full<LBiSrtFunctionAttest<R>, LBiSrtFunction<R>, LBiSrtConsumer, Checks.Check<R>> {

	public LBiSrtFunctionAttest(LBiSrtFunction<R> actual) {
		super(actual);
	}
