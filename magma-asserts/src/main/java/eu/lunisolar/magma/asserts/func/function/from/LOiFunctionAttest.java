...
public final class LOiFunctionAttest<T, R> extends FunctionalAttest.Full<LOiFunctionAttest<T, R>, LOiFunction<T, R>, LObjIntConsumer<T>, Checks.Check<R>> {

	public LOiFunctionAttest(LOiFunction<T, R> actual) {
		super(actual);
	}
	...
	@Nonnull
	public Evaluation<LOiFunctionAttest<T, R>, LObjIntConsumer<T>, R> doesApply(T a1, int a2) {

		return new Evaluation<LOiFunctionAttest<T, R>, LObjIntConsumer<T>, R>(this, () -> String.format("(%s,%s)", a1, a2), (desc, pc) -> {
