...
public final class JreLongToDoubleFunctionAttest extends FunctionalAttest.Full<JreLongToDoubleFunctionAttest, LongToDoubleFunction, LLongConsumer, Checks.CheckDbl> {

	public JreLongToDoubleFunctionAttest(LongToDoubleFunction actual) {
		super(actual);
	}
