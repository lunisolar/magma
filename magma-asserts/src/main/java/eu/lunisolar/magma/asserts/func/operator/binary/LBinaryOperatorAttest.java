...
public final class LBinaryOperatorAttest<T> extends FunctionalAttest.Full<LBinaryOperatorAttest<T>, LBinaryOperator<T>, LBiConsumer<T, T>, Checks.Check<T>> {

	public LBinaryOperatorAttest(LBinaryOperator<T> actual) {
		super(actual);
	}
