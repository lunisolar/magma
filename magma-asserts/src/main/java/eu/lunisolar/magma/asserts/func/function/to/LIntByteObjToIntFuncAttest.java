...
public final class LIntByteObjToIntFuncAttest<T> extends FunctionalAttest.Full<LIntByteObjToIntFuncAttest<T>, LIntByteObjToIntFunc<T>, LTieByteConsumer.LIntByteObjCons<T>, Checks.CheckInt> {

	public LIntByteObjToIntFuncAttest(LIntByteObjToIntFunc<T> actual) {
		super(actual);
	}
