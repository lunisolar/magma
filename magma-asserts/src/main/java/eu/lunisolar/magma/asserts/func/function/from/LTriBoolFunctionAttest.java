...
public final class LTriBoolFunctionAttest<R> extends FunctionalAttest.Full<LTriBoolFunctionAttest<R>, LTriBoolFunction<R>, LTriBoolConsumer, Checks.Check<R>> {

	public LTriBoolFunctionAttest(LTriBoolFunction<R> actual) {
		super(actual);
	}
