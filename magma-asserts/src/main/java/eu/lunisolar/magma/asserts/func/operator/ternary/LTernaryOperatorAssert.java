...
public interface LTernaryOperatorAssert<S extends LTernaryOperatorAssert<S, A, RS, T>, A extends LTernaryOperator<T>, RS extends Assert<RS, T>, T> extends Assert<S, A>, FullFunctionalAssert<S, LTriConsumer<T, T, T>, A, RS, T> {
	...
	final class The<A extends LTernaryOperator<T>, RS extends Assert<RS, T>, T> extends Base<The<A, RS, T>, A, RS, T> {
	...
	class Base<S extends Base<S, A, RS, T>, A extends LTernaryOperator<T>, RS extends Assert<RS, T>, T> extends FullFunctionalAssert.Base<S, LTriConsumer<T, T, T>, A, RS, T> implements LTernaryOperatorAssert<S, A, RS, T> {
		...
		@Nonnull
		public Evaluation<S, LTriConsumer<T, T, T>, A, RS, T> doesApply(T a1, T a2, T a3) {
