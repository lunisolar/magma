...
public interface LIntFltConsAssert<S extends LIntFltConsAssert<S, A>, A extends LFltIntConsumer.LIntFltCons> extends Assert<S, A>, FunctionalAssert.Simple<S, LFltIntConsumer.LIntFltCons, A> {
	...
	@Nonnull
	SemiEvaluation<S, LFltIntConsumer.LIntFltCons, A> doesAccept(int a2, float a1);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LFltIntConsumer.LIntFltCons> extends Base<The<A>, A> {
	...
	class Base<S extends Base<S, A>, A extends LFltIntConsumer.LIntFltCons> extends FunctionalAssert.Simple.Base<S, LFltIntConsumer.LIntFltCons, A> implements LIntFltConsAssert<S, A> {
		...
		@Nonnull
		public SemiEvaluation<S, LFltIntConsumer.LIntFltCons, A> doesAccept(int a2, float a1) {
