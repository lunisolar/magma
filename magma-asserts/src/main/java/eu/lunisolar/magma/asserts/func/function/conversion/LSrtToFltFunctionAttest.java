...
public final class LSrtToFltFunctionAttest extends FunctionalAttest.Full<LSrtToFltFunctionAttest, LSrtToFltFunction, LSrtConsumer, Checks.CheckFlt> {

	public LSrtToFltFunctionAttest(LSrtToFltFunction actual) {
		super(actual);
	}
	...
	@Nonnull
	public FltEvaluation<LSrtToFltFunctionAttest, LSrtConsumer> doesApplyAsFlt(short a) {

		return new FltEvaluation<LSrtToFltFunctionAttest, LSrtConsumer>(this, () -> String.format("(%s)", a), (desc, pc) -> {
