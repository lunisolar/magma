...
public final class LBool1Bool0ConsAttest extends FunctionalAttest.Simple<LBool1Bool0ConsAttest, LBool1Bool0Cons, LBiBoolConsumer> {

	public LBool1Bool0ConsAttest(LBool1Bool0Cons actual) {
		super(actual);
	}
