...
public interface LByteSupplierAssert<S extends LByteSupplierAssert<S, A, RS>, A extends LByteSupplier, RS extends AbstractByteAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LAction, A, RS, Byte> {
	...
	final class The<A extends LByteSupplier, RS extends AbstractByteAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LByteSupplier, RS extends AbstractByteAssert<RS>> extends FullFunctionalAssert.Base<S, LAction, A, RS, Byte> implements LByteSupplierAssert<S, A, RS> {
