...
public final class LBiLongConsumerAttest extends FunctionalAttest.Simple<LBiLongConsumerAttest, LBiLongConsumer, LBiLongConsumer> {

	public LBiLongConsumerAttest(LBiLongConsumer actual) {
		super(actual);
	}

	public LBiLongConsumerAttest(LBiLongConsumer actual, String name) {
		super(actual, name);
	}
