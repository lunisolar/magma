...
public final class LDblIntPredicateAttest extends FunctionalAttest.Full<LDblIntPredicateAttest, LDblIntPredicate, LDblIntConsumer, Checks.CheckBool> {

	public LDblIntPredicateAttest(LDblIntPredicate actual) {
		super(actual);
	}
	...
	@Nonnull
	public BoolEvaluation<LDblIntPredicateAttest, LDblIntConsumer> doesTest(double a1, int a2) {

		return new BoolEvaluation<LDblIntPredicateAttest, LDblIntConsumer>(this, () -> String.format("(%s,%s)", a1, a2), (desc, pc) -> {
