...
public final class JreLongConsumerAttest extends FunctionalAttest.Simple<JreLongConsumerAttest, LongConsumer, LLongConsumer> {

	public JreLongConsumerAttest(LongConsumer actual) {
		super(actual);
	}

	public JreLongConsumerAttest(LongConsumer actual, String name) {
		super(actual, name);
	}
