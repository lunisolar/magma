...
public interface JreObjIntConsumerAssert<S extends JreObjIntConsumerAssert<S, A, T>, A extends ObjIntConsumer<T>, T> extends Assert<S, A>, FunctionalAssert.Simple<S, LObjIntConsumer<T>, A> {
	...
	final class The<A extends ObjIntConsumer<T>, T> extends Base<The<A, T>, A, T> {
	...
	class Base<S extends Base<S, A, T>, A extends ObjIntConsumer<T>, T> extends FunctionalAssert.Simple.Base<S, LObjIntConsumer<T>, A> implements JreObjIntConsumerAssert<S, A, T> {
