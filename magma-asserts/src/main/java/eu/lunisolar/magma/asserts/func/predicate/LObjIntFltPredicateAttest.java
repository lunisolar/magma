...
public final class LObjIntFltPredicateAttest<T> extends FunctionalAttest.Full<LObjIntFltPredicateAttest<T>, LObjIntFltPredicate<T>, LTieFltConsumer<T>, Checks.CheckBool> {
	...
	public LObjIntFltPredicateAttest(LObjIntFltPredicate<T> actual) {
		super(actual);
	}

	public LObjIntFltPredicateAttest(LObjIntFltPredicate<T> actual, String name) {
		super(actual, name);
	}
	...
	@Nonnull
	public BoolEvaluation<LObjIntFltPredicateAttest<T>, LTieFltConsumer<T>> doesTest(T a1, int a2, float a3) {

		return new BoolEvaluation<LObjIntFltPredicateAttest<T>, LTieFltConsumer<T>>(this, () -> String.format("(%s,%s,%s)", a1, a2, a3), (desc, pc) -> {
