...
public final class LToCharFunctionAttest<T> extends FunctionalAttest.Full<LToCharFunctionAttest<T>, LToCharFunction<T>, LConsumer<T>, Checks.CheckChar> {

	public LToCharFunctionAttest(LToCharFunction<T> actual) {
		super(actual);
	}
