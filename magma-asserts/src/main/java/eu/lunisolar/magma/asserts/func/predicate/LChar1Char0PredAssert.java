...
import eu.lunisolar.magma.func.predicate.LBiCharPredicate.*;

/** Assert class for LChar1Char0Pred. */
public interface LChar1Char0PredAssert<S extends LChar1Char0PredAssert<S, A, RS>, A extends LBiCharPredicate.LChar1Char0Pred, RS extends AbstractBooleanAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LBiCharConsumer, A, RS, Boolean> {
	...
	@Nonnull
	Evaluation<S, LBiCharConsumer, A, RS, Boolean> doesTest(char a2, char a1);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LBiCharPredicate.LChar1Char0Pred, RS extends AbstractBooleanAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LBiCharPredicate.LChar1Char0Pred, RS extends AbstractBooleanAssert<RS>> extends FullFunctionalAssert.Base<S, LBiCharConsumer, A, RS, Boolean> implements LChar1Char0PredAssert<S, A, RS> {
		...
		@Nonnull
		public Evaluation<S, LBiCharConsumer, A, RS, Boolean> doesTest(char a2, char a1) {

			return evaluation(() -> String.format("(%s,%s)", a2, a1), pc -> {
				if (pc != null) {
					pc.accept(a2, a1);
				}
				return assertFactory.apply(actual.testChar1Char0(a2, a1));
			});
		}
