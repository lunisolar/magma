...
public final class LBiBytePredicateAttest extends FunctionalAttest.Full<LBiBytePredicateAttest, LBiBytePredicate, LBiByteConsumer, Checks.CheckBool> {

	public LBiBytePredicateAttest(LBiBytePredicate actual) {
		super(actual);
	}
