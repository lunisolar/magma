...
public final class LChar1Char0FuncAttest<R> extends FunctionalAttest.Full<LChar1Char0FuncAttest<R>, LChar1Char0Func<R>, LBiCharConsumer, Checks.Check<R>> {

	public LChar1Char0FuncAttest(LChar1Char0Func<R> actual) {
		super(actual);
	}
