...
public final class LTriByteConsumerAttest extends FunctionalAttest.Simple<LTriByteConsumerAttest, LTriByteConsumer, LTriByteConsumer> {

	public LTriByteConsumerAttest(LTriByteConsumer actual) {
		super(actual);
	}
