...
public final class JreLongToIntFunctionAttest extends FunctionalAttest.Full<JreLongToIntFunctionAttest, LongToIntFunction, LLongConsumer, Checks.CheckInt> {

	public JreLongToIntFunctionAttest(LongToIntFunction actual) {
		super(actual);
	}

	public JreLongToIntFunctionAttest(LongToIntFunction actual, String name) {
		super(actual, name);
	}
