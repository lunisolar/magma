...
public final class LIntToLongFunctionAttest extends FunctionalAttest.Full<LIntToLongFunctionAttest, LIntToLongFunction, LIntConsumer, Checks.CheckLong> {

	public LIntToLongFunctionAttest(LIntToLongFunction actual) {
		super(actual);
	}
	...
	@Nonnull
	public LongEvaluation<LIntToLongFunctionAttest, LIntConsumer> doesApplyAsLong(int a) {

		return new LongEvaluation<LIntToLongFunctionAttest, LIntConsumer>(this, () -> String.format("(%s)", a), (desc, pc) -> {
