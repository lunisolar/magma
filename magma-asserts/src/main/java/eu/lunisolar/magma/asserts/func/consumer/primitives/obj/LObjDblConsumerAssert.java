...
public interface LObjDblConsumerAssert<S extends LObjDblConsumerAssert<S, A, T>, A extends LObjDblConsumer<T>, T> extends Assert<S, A>, FunctionalAssert.Simple<S, LObjDblConsumer<T>, A> {
	...
	final class The<A extends LObjDblConsumer<T>, T> extends Base<The<A, T>, A, T> {
	...
	class Base<S extends Base<S, A, T>, A extends LObjDblConsumer<T>, T> extends FunctionalAssert.Simple.Base<S, LObjDblConsumer<T>, A> implements LObjDblConsumerAssert<S, A, T> {
