...
public final class LCharPredicateAttest extends FunctionalAttest.Full<LCharPredicateAttest, LCharPredicate, LCharConsumer, Checks.CheckBool> {

	public LCharPredicateAttest(LCharPredicate actual) {
		super(actual);
	}

	public LCharPredicateAttest(LCharPredicate actual, String name) {
		super(actual, name);
	}
