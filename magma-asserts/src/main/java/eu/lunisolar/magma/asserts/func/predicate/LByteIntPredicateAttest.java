...
public final class LByteIntPredicateAttest extends FunctionalAttest.Full<LByteIntPredicateAttest, LByteIntPredicate, LByteIntConsumer, Checks.CheckBool> {

	public LByteIntPredicateAttest(LByteIntPredicate actual) {
		super(actual);
	}

	public LByteIntPredicateAttest(LByteIntPredicate actual, String name) {
		super(actual, name);
	}
