...
public final class LToIntFunctionAttest<T> extends FunctionalAttest.Full<LToIntFunctionAttest<T>, LToIntFunction<T>, LConsumer<T>, Checks.CheckInt> {

	public LToIntFunctionAttest(LToIntFunction<T> actual) {
		super(actual);
	}
