...
public final class LObj1BiObj2ConsAttest<T2, T1, T3> extends FunctionalAttest.Simple<LObj1BiObj2ConsAttest<T2, T1, T3>, LObj1BiObj2Cons<T2, T1, T3>, LTriConsumer<T2, T1, T3>> {

	public LObj1BiObj2ConsAttest(LObj1BiObj2Cons<T2, T1, T3> actual) {
		super(actual);
	}
	...
	@Nonnull
	public SemiEvaluation<LObj1BiObj2ConsAttest<T2, T1, T3>, LTriConsumer<T2, T1, T3>, AssertionsCheck> doesAccept(T2 a2, T1 a1, T3 a3) {

		return new SemiEvaluation<LObj1BiObj2ConsAttest<T2, T1, T3>, LTriConsumer<T2, T1, T3>, AssertionsCheck>(this, () -> String.format("(%s,%s,%s)", a2, a1, a3), (desc, pc) -> {
			...
			func.acceptObj1BiObj2(a2, a1, a3);
			return null;
