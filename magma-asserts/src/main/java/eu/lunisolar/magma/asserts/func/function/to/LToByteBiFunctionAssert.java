...
public interface LToByteBiFunctionAssert<S extends LToByteBiFunctionAssert<S, A, RS, T1, T2>, A extends LToByteBiFunction<T1, T2>, RS extends AbstractByteAssert<RS>, T1, T2> extends Assert<S, A>, FullFunctionalAssert<S, LBiConsumer<T1, T2>, A, RS, Byte> {
	...
	@Nonnull
	Evaluation<S, LBiConsumer<T1, T2>, A, RS, Byte> doesApplyAsByte(T1 a1, T2 a2);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LToByteBiFunction<T1, T2>, RS extends AbstractByteAssert<RS>, T1, T2> extends Base<The<A, RS, T1, T2>, A, RS, T1, T2> {
	...
	class Base<S extends Base<S, A, RS, T1, T2>, A extends LToByteBiFunction<T1, T2>, RS extends AbstractByteAssert<RS>, T1, T2> extends FullFunctionalAssert.Base<S, LBiConsumer<T1, T2>, A, RS, Byte> implements LToByteBiFunctionAssert<S, A, RS, T1, T2> {
