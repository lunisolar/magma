...
public final class LByteToSrtFunctionAttest extends FunctionalAttest.Full<LByteToSrtFunctionAttest, LByteToSrtFunction, LByteConsumer, Checks.CheckSrt> {

	public LByteToSrtFunctionAttest(LByteToSrtFunction actual) {
		super(actual);
	}
	...
	@Nonnull
	public SrtEvaluation<LByteToSrtFunctionAttest, LByteConsumer> doesApplyAsSrt(byte a) {

		return new SrtEvaluation<LByteToSrtFunctionAttest, LByteConsumer>(this, () -> String.format("(%s)", a), (desc, pc) -> {
