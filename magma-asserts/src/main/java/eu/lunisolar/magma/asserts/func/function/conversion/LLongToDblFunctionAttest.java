...
public final class LLongToDblFunctionAttest extends FunctionalAttest.Full<LLongToDblFunctionAttest, LLongToDblFunction, LLongConsumer, Checks.CheckDbl> {

	public LLongToDblFunctionAttest(LLongToDblFunction actual) {
		super(actual);
	}
	...
	@Nonnull
	public DblEvaluation<LLongToDblFunctionAttest, LLongConsumer> doesApplyAsDbl(long a) {

		return new DblEvaluation<LLongToDblFunctionAttest, LLongConsumer>(this, () -> String.format("(%s)", a), (desc, pc) -> {
