...
public final class JreBiPredicateAttest<T1, T2> extends FunctionalAttest.Full<JreBiPredicateAttest<T1, T2>, BiPredicate<T1, T2>, LBiConsumer<T1, T2>, Checks.CheckBool> {

	public JreBiPredicateAttest(BiPredicate<T1, T2> actual) {
		super(actual);
	}
