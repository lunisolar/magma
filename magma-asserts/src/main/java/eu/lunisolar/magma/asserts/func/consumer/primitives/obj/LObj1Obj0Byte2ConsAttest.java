...
public final class LObj1Obj0Byte2ConsAttest<T2, T1> extends FunctionalAttest.Simple<LObj1Obj0Byte2ConsAttest<T2, T1>, LObj1Obj0Byte2Cons<T2, T1>, LBiObjByteConsumer<T2, T1>> {

	public LObj1Obj0Byte2ConsAttest(LObj1Obj0Byte2Cons<T2, T1> actual) {
		super(actual);
	}

	public LObj1Obj0Byte2ConsAttest(LObj1Obj0Byte2Cons<T2, T1> actual, String name) {
		super(actual, name);
	}
	...
	public SemiEvaluation<LObj1Obj0Byte2ConsAttest<T2, T1>, LBiObjByteConsumer<T2, T1>, AssertionsCheck> doesAccept(T2 a2, T1 a1, byte a3) {
		...
		return new SemiEvaluation<LObj1Obj0Byte2ConsAttest<T2, T1>, LBiObjByteConsumer<T2, T1>, AssertionsCheck>(this, () -> String.format("(%s,%s,%s)", a2, a1, a3), (desc, pc) -> {
			...
			func.acceptObj1Obj0Byte2(a2, a1, a3);
			return null;
