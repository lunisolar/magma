...
public interface LSrtIntPredicateAssert<S extends LSrtIntPredicateAssert<S, A, RS>, A extends LSrtIntPredicate, RS extends AbstractBooleanAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LSrtIntConsumer, A, RS, Boolean> {
	...
	@Nonnull
	Evaluation<S, LSrtIntConsumer, A, RS, Boolean> doesTest(short a1, int a2);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LSrtIntPredicate, RS extends AbstractBooleanAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LSrtIntPredicate, RS extends AbstractBooleanAssert<RS>> extends FullFunctionalAssert.Base<S, LSrtIntConsumer, A, RS, Boolean> implements LSrtIntPredicateAssert<S, A, RS> {
