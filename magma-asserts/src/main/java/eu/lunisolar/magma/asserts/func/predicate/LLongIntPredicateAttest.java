...
public final class LLongIntPredicateAttest extends FunctionalAttest.Full<LLongIntPredicateAttest, LLongIntPredicate, LLongIntConsumer, Checks.CheckBool> {

	public LLongIntPredicateAttest(LLongIntPredicate actual) {
		super(actual);
	}
	...
	@Nonnull
	public BoolEvaluation<LLongIntPredicateAttest, LLongIntConsumer> doesTest(long a1, int a2) {

		return new BoolEvaluation<LLongIntPredicateAttest, LLongIntConsumer>(this, () -> String.format("(%s,%s)", a1, a2), (desc, pc) -> {
