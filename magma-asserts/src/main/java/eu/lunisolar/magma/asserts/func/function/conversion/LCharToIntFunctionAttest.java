...
public final class LCharToIntFunctionAttest extends FunctionalAttest.Full<LCharToIntFunctionAttest, LCharToIntFunction, LCharConsumer, Checks.CheckInt> {

	public LCharToIntFunctionAttest(LCharToIntFunction actual) {
		super(actual);
	}
	...
	@Nonnull
	public IntEvaluation<LCharToIntFunctionAttest, LCharConsumer> doesApplyAsInt(char a) {

		return new IntEvaluation<LCharToIntFunctionAttest, LCharConsumer>(this, () -> String.format("(%s)", a), (desc, pc) -> {
