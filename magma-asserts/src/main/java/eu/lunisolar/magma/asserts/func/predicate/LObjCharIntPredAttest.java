...
public final class LObjCharIntPredAttest<T> extends FunctionalAttest.Full<LObjCharIntPredAttest<T>, LObjCharIntPred<T>, LTieCharConsumer.LObjCharIntCons<T>, Checks.CheckBool> {

	public LObjCharIntPredAttest(LObjCharIntPred<T> actual) {
		super(actual);
	}

	public LObjCharIntPredAttest(LObjCharIntPred<T> actual, String name) {
		super(actual, name);
	}
