...
public interface LBiSrtPredicateAssert<S extends LBiSrtPredicateAssert<S, A, RS>, A extends LBiSrtPredicate, RS extends AbstractBooleanAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LBiSrtConsumer, A, RS, Boolean> {
	...
	@Nonnull
	Evaluation<S, LBiSrtConsumer, A, RS, Boolean> doesTest(short a1, short a2);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LBiSrtPredicate, RS extends AbstractBooleanAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LBiSrtPredicate, RS extends AbstractBooleanAssert<RS>> extends FullFunctionalAssert.Base<S, LBiSrtConsumer, A, RS, Boolean> implements LBiSrtPredicateAssert<S, A, RS> {
		...
		@Nonnull
		public Evaluation<S, LBiSrtConsumer, A, RS, Boolean> doesTest(short a1, short a2) {
