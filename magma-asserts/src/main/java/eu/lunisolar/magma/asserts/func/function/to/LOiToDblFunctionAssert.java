...
public interface LOiToDblFunctionAssert<S extends LOiToDblFunctionAssert<S, A, RS, T>, A extends LOiToDblFunction<T>, RS extends AbstractDoubleAssert<RS>, T> extends Assert<S, A>, FullFunctionalAssert<S, LObjIntConsumer<T>, A, RS, Double> {
	...
	@Nonnull
	Evaluation<S, LObjIntConsumer<T>, A, RS, Double> doesApplyAsDbl(T a1, int a2);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LOiToDblFunction<T>, RS extends AbstractDoubleAssert<RS>, T> extends Base<The<A, RS, T>, A, RS, T> {
	...
	class Base<S extends Base<S, A, RS, T>, A extends LOiToDblFunction<T>, RS extends AbstractDoubleAssert<RS>, T> extends FullFunctionalAssert.Base<S, LObjIntConsumer<T>, A, RS, Double> implements LOiToDblFunctionAssert<S, A, RS, T> {
