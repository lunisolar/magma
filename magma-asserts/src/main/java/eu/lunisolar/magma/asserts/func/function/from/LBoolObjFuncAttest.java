...
public final class LBoolObjFuncAttest<T, R> extends FunctionalAttest.Full<LBoolObjFuncAttest<T, R>, LBoolObjFunc<T, R>, LObjBoolConsumer.LBoolObjCons<T>, Checks.Check<R>> {

	public LBoolObjFuncAttest(LBoolObjFunc<T, R> actual) {
		super(actual);
	}

	public LBoolObjFuncAttest(LBoolObjFunc<T, R> actual, String name) {
		super(actual, name);
	}
