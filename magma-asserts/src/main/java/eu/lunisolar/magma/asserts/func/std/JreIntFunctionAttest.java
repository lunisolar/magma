...
public final class JreIntFunctionAttest<R> extends FunctionalAttest.Full<JreIntFunctionAttest<R>, IntFunction<R>, LIntConsumer, Checks.Check<R>> {

	public JreIntFunctionAttest(IntFunction<R> actual) {
		super(actual);
	}

	public JreIntFunctionAttest(IntFunction<R> actual, String name) {
		super(actual, name);
	}
