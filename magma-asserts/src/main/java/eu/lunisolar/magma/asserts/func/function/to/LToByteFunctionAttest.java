...
public final class LToByteFunctionAttest<T> extends FunctionalAttest.Full<LToByteFunctionAttest<T>, LToByteFunction<T>, LConsumer<T>, Checks.CheckByte> {

	public LToByteFunctionAttest(LToByteFunction<T> actual) {
		super(actual);
	}
	...
	@Nonnull
	public ByteEvaluation<LToByteFunctionAttest<T>, LConsumer<T>> doesApplyAsByte(T a) {

		return new ByteEvaluation<LToByteFunctionAttest<T>, LConsumer<T>>(this, () -> String.format("(%s)", a), (desc, pc) -> {
