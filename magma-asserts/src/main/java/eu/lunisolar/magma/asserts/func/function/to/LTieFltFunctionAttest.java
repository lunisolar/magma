...
public final class LTieFltFunctionAttest<T> extends FunctionalAttest.Full<LTieFltFunctionAttest<T>, LTieFltFunction<T>, LTieFltConsumer<T>, Checks.CheckInt> {

	public LTieFltFunctionAttest(LTieFltFunction<T> actual) {
		super(actual);
	}
	...
	@Nonnull
	public IntEvaluation<LTieFltFunctionAttest<T>, LTieFltConsumer<T>> doesApplyAsInt(T a1, int a2, float a3) {

		return new IntEvaluation<LTieFltFunctionAttest<T>, LTieFltConsumer<T>>(this, () -> String.format("(%s,%s,%s)", a1, a2, a3), (desc, pc) -> {
