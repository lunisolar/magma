...
public final class LCharToSrtFunctionAttest extends FunctionalAttest.Full<LCharToSrtFunctionAttest, LCharToSrtFunction, LCharConsumer, Checks.CheckSrt> {

	public LCharToSrtFunctionAttest(LCharToSrtFunction actual) {
		super(actual);
	}

	public LCharToSrtFunctionAttest(LCharToSrtFunction actual, String name) {
		super(actual, name);
	}
