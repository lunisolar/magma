...
public final class LCharIntPredicateAttest extends FunctionalAttest.Full<LCharIntPredicateAttest, LCharIntPredicate, LCharIntConsumer, Checks.CheckBool> {

	public LCharIntPredicateAttest(LCharIntPredicate actual) {
		super(actual);
	}
	...
	@Nonnull
	public BoolEvaluation<LCharIntPredicateAttest, LCharIntConsumer> doesTest(char a1, int a2) {

		return new BoolEvaluation<LCharIntPredicateAttest, LCharIntConsumer>(this, () -> String.format("(%s,%s)", a1, a2), (desc, pc) -> {
