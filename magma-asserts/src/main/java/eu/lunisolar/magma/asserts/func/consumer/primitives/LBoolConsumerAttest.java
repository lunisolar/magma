...
public final class LBoolConsumerAttest extends FunctionalAttest.Simple<LBoolConsumerAttest, LBoolConsumer, LBoolConsumer> {

	public LBoolConsumerAttest(LBoolConsumer actual) {
		super(actual);
	}

	public LBoolConsumerAttest(LBoolConsumer actual, String name) {
		super(actual, name);
	}
