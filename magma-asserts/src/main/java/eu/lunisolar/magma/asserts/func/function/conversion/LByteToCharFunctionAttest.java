...
public final class LByteToCharFunctionAttest extends FunctionalAttest.Full<LByteToCharFunctionAttest, LByteToCharFunction, LByteConsumer, Checks.CheckChar> {

	public LByteToCharFunctionAttest(LByteToCharFunction actual) {
		super(actual);
	}
	...
	@Nonnull
	public CharEvaluation<LByteToCharFunctionAttest, LByteConsumer> doesApplyAsChar(byte a) {

		return new CharEvaluation<LByteToCharFunctionAttest, LByteConsumer>(this, () -> String.format("(%s)", a), (desc, pc) -> {
