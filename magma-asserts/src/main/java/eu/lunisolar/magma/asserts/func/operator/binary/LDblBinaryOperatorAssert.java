...
public interface LDblBinaryOperatorAssert<S extends LDblBinaryOperatorAssert<S, A, RS>, A extends LDblBinaryOperator, RS extends AbstractDoubleAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LBiDblConsumer, A, RS, Double> {
	...
	final class The<A extends LDblBinaryOperator, RS extends AbstractDoubleAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LDblBinaryOperator, RS extends AbstractDoubleAssert<RS>> extends FullFunctionalAssert.Base<S, LBiDblConsumer, A, RS, Double> implements LDblBinaryOperatorAssert<S, A, RS> {
