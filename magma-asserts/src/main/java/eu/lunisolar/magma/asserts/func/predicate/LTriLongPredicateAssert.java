...
/** Assert class for LTriLongPredicate. */
public interface LTriLongPredicateAssert<S extends LTriLongPredicateAssert<S, A, RS>, A extends LTriLongPredicate, RS extends AbstractBooleanAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LTriLongConsumer, A, RS, Boolean> {
	...
	@Nonnull
	Evaluation<S, LTriLongConsumer, A, RS, Boolean> doesTest(long a1, long a2, long a3);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LTriLongPredicate, RS extends AbstractBooleanAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LTriLongPredicate, RS extends AbstractBooleanAssert<RS>> extends FullFunctionalAssert.Base<S, LTriLongConsumer, A, RS, Boolean> implements LTriLongPredicateAssert<S, A, RS> {
		...
		@Nonnull
		public Evaluation<S, LTriLongConsumer, A, RS, Boolean> doesTest(long a1, long a2, long a3) {
