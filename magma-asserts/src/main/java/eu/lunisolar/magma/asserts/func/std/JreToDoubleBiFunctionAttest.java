...
public final class JreToDoubleBiFunctionAttest<T1, T2> extends FunctionalAttest.Full<JreToDoubleBiFunctionAttest<T1, T2>, ToDoubleBiFunction<T1, T2>, LBiConsumer<T1, T2>, Checks.CheckDbl> {

	public JreToDoubleBiFunctionAttest(ToDoubleBiFunction<T1, T2> actual) {
		super(actual);
	}
