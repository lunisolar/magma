...
public final class JrePredicateAttest<T> extends FunctionalAttest.Full<JrePredicateAttest<T>, Predicate<T>, LConsumer<T>, Checks.CheckBool> {

	public JrePredicateAttest(Predicate<T> actual) {
		super(actual);
	}
	...
	@Nonnull
	public BoolEvaluation<JrePredicateAttest<T>, LConsumer<T>> doesTest(T a) {

		return new BoolEvaluation<JrePredicateAttest<T>, LConsumer<T>>(this, () -> String.format("(%s)", a), (desc, pc) -> {
