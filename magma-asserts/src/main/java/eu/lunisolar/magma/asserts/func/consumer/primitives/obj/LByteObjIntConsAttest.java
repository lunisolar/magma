...
public final class LByteObjIntConsAttest<T> extends FunctionalAttest.Simple<LByteObjIntConsAttest<T>, LByteObjIntCons<T>, LTieByteConsumer.LByteObjIntCons<T>> {

	public LByteObjIntConsAttest(LByteObjIntCons<T> actual) {
		super(actual);
	}

	public LByteObjIntConsAttest(LByteObjIntCons<T> actual, String name) {
		super(actual, name);
	}
	...
	public SemiEvaluation<LByteObjIntConsAttest<T>, LTieByteConsumer.LByteObjIntCons<T>, AssertionsCheck> doesAccept(byte a3, T a1, int a2) {
		...
		return new SemiEvaluation<LByteObjIntConsAttest<T>, LTieByteConsumer.LByteObjIntCons<T>, AssertionsCheck>(this, () -> String.format("(%s,%s,%s)", a3, a1, a2), (desc, pc) -> {
			...
			func.acceptByteObjInt(a3, a1, a2);
			return null;
