...
public final class JreIntSupplierAttest extends FunctionalAttest.Full<JreIntSupplierAttest, IntSupplier, LAction, Checks.CheckInt> {

	public JreIntSupplierAttest(IntSupplier actual) {
		super(actual);
	}
	...
	@Nonnull
	public JreIntSupplierAttest doesReturn(int value) {
