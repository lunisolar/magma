...
public final class LIntBoolObjConsAttest<T> extends FunctionalAttest.Simple<LIntBoolObjConsAttest<T>, LIntBoolObjCons<T>, LTieBoolConsumer.LIntBoolObjCons<T>> {

	public LIntBoolObjConsAttest(LIntBoolObjCons<T> actual) {
		super(actual);
	}

	public LIntBoolObjConsAttest(LIntBoolObjCons<T> actual, String name) {
		super(actual, name);
	}
	...
	public SemiEvaluation<LIntBoolObjConsAttest<T>, LTieBoolConsumer.LIntBoolObjCons<T>, AssertionsCheck> doesAccept(int a2, boolean a3, T a1) {
		...
		return new SemiEvaluation<LIntBoolObjConsAttest<T>, LTieBoolConsumer.LIntBoolObjCons<T>, AssertionsCheck>(this, () -> String.format("(%s,%s,%s)", a2, a3, a1), (desc, pc) -> {
			...
			func.acceptIntBoolObj(a2, a3, a1);
			return null;
