...
public final class LIntToByteFunctionAttest extends FunctionalAttest.Full<LIntToByteFunctionAttest, LIntToByteFunction, LIntConsumer, Checks.CheckByte> {

	public LIntToByteFunctionAttest(LIntToByteFunction actual) {
		super(actual);
	}
	...
	@Nonnull
	public ByteEvaluation<LIntToByteFunctionAttest, LIntConsumer> doesApplyAsByte(int a) {

		return new ByteEvaluation<LIntToByteFunctionAttest, LIntConsumer>(this, () -> String.format("(%s)", a), (desc, pc) -> {
