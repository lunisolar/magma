...
public final class JreBooleanSupplierAttest extends FunctionalAttest.Full<JreBooleanSupplierAttest, BooleanSupplier, LAction, Checks.CheckBool> {

	public JreBooleanSupplierAttest(BooleanSupplier actual) {
		super(actual);
	}
	...
	@Nonnull
	public JreBooleanSupplierAttest doesReturn(boolean value) {
