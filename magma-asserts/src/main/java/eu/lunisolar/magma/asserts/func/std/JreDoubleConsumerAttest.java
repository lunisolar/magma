...
public final class JreDoubleConsumerAttest extends FunctionalAttest.Simple<JreDoubleConsumerAttest, DoubleConsumer, LDblConsumer> {

	public JreDoubleConsumerAttest(DoubleConsumer actual) {
		super(actual);
	}
