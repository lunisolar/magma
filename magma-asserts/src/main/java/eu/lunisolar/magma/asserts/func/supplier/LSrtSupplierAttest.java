...
public final class LSrtSupplierAttest extends FunctionalAttest.Full<LSrtSupplierAttest, LSrtSupplier, LAction, Checks.CheckSrt> {

	public LSrtSupplierAttest(LSrtSupplier actual) {
		super(actual);
	}
	...
	@Nonnull
	public SrtEvaluation<LSrtSupplierAttest, LAction> doesGetAsSrt() {

		return new SrtEvaluation<LSrtSupplierAttest, LAction>(this, () -> String.format("()"), (desc, pc) -> {
	...
	@Nonnull
	public LSrtSupplierAttest doesReturn(short value) {
