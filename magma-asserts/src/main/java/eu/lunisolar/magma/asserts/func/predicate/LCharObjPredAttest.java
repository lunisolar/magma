...
public final class LCharObjPredAttest<T> extends FunctionalAttest.Full<LCharObjPredAttest<T>, LCharObjPred<T>, LObjCharConsumer.LCharObjCons<T>, Checks.CheckBool> {

	public LCharObjPredAttest(LCharObjPred<T> actual) {
		super(actual);
	}

	public LCharObjPredAttest(LCharObjPred<T> actual, String name) {
		super(actual, name);
	}
