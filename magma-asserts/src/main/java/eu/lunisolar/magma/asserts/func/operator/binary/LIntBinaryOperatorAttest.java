...
public final class LIntBinaryOperatorAttest extends FunctionalAttest.Full<LIntBinaryOperatorAttest, LIntBinaryOperator, LBiIntConsumer, Checks.CheckInt> {

	public LIntBinaryOperatorAttest(LIntBinaryOperator actual) {
		super(actual);
	}
