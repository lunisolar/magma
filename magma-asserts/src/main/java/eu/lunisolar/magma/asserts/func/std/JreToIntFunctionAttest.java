...
public final class JreToIntFunctionAttest<T> extends FunctionalAttest.Full<JreToIntFunctionAttest<T>, ToIntFunction<T>, LConsumer<T>, Checks.CheckInt> {

	public JreToIntFunctionAttest(ToIntFunction<T> actual) {
		super(actual);
	}
