...
public final class LCharUnaryOperatorAttest extends FunctionalAttest.Full<LCharUnaryOperatorAttest, LCharUnaryOperator, LCharConsumer, Checks.CheckChar> {

	public LCharUnaryOperatorAttest(LCharUnaryOperator actual) {
		super(actual);
	}
	...
	@Nonnull
	public CharEvaluation<LCharUnaryOperatorAttest, LCharConsumer> doesApplyAsChar(char a) {

		return new CharEvaluation<LCharUnaryOperatorAttest, LCharConsumer>(this, () -> String.format("(%s)", a), (desc, pc) -> {
