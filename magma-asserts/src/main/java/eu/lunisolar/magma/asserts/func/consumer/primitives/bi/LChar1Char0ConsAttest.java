...
public final class LChar1Char0ConsAttest extends FunctionalAttest.Simple<LChar1Char0ConsAttest, LChar1Char0Cons, LBiCharConsumer> {

	public LChar1Char0ConsAttest(LChar1Char0Cons actual) {
		super(actual);
	}
