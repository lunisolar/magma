...
public final class LByteToLongFunctionAttest extends FunctionalAttest.Full<LByteToLongFunctionAttest, LByteToLongFunction, LByteConsumer, Checks.CheckLong> {

	public LByteToLongFunctionAttest(LByteToLongFunction actual) {
		super(actual);
	}
