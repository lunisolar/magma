...
public final class LTieDblFunctionAttest<T> extends FunctionalAttest.Full<LTieDblFunctionAttest<T>, LTieDblFunction<T>, LTieDblConsumer<T>, Checks.CheckInt> {

	public LTieDblFunctionAttest(LTieDblFunction<T> actual) {
		super(actual);
	}
	...
	@Nonnull
	public IntEvaluation<LTieDblFunctionAttest<T>, LTieDblConsumer<T>> doesApplyAsInt(T a1, int a2, double a3) {

		return new IntEvaluation<LTieDblFunctionAttest<T>, LTieDblConsumer<T>>(this, () -> String.format("(%s,%s,%s)", a1, a2, a3), (desc, pc) -> {
