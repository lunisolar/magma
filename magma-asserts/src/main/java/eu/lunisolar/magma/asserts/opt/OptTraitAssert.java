...
public class OptTraitAssert<T> extends AbstractObjectAssert<OptTraitAssert<T>, OptTrait<T, ?>> implements FluentTrait<OptTraitAssert<T>>, Attest<OptTraitAssert<T>, OptTrait<T, ?>> {
