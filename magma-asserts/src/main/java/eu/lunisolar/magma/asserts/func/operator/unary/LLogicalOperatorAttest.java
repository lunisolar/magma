...
public final class LLogicalOperatorAttest extends FunctionalAttest.Full<LLogicalOperatorAttest, LLogicalOperator, LBoolConsumer, Checks.CheckBool> {

	public LLogicalOperatorAttest(LLogicalOperator actual) {
		super(actual);
	}
