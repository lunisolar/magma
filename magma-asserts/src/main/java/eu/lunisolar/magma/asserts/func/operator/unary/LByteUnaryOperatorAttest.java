...
public final class LByteUnaryOperatorAttest extends FunctionalAttest.Full<LByteUnaryOperatorAttest, LByteUnaryOperator, LByteConsumer, Checks.CheckByte> {

	public LByteUnaryOperatorAttest(LByteUnaryOperator actual) {
		super(actual);
	}
