...
public final class LFltObjConsAttest<T> extends FunctionalAttest.Simple<LFltObjConsAttest<T>, LFltObjCons<T>, LObjFltConsumer.LFltObjCons<T>> {

	public LFltObjConsAttest(LFltObjCons<T> actual) {
		super(actual);
	}

	public LFltObjConsAttest(LFltObjCons<T> actual, String name) {
		super(actual, name);
	}
