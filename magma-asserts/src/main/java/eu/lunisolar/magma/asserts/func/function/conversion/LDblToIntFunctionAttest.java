...
public final class LDblToIntFunctionAttest extends FunctionalAttest.Full<LDblToIntFunctionAttest, LDblToIntFunction, LDblConsumer, Checks.CheckInt> {

	public LDblToIntFunctionAttest(LDblToIntFunction actual) {
		super(actual);
	}
	...
	@Nonnull
	public IntEvaluation<LDblToIntFunctionAttest, LDblConsumer> doesApplyAsInt(double a) {

		return new IntEvaluation<LDblToIntFunctionAttest, LDblConsumer>(this, () -> String.format("(%s)", a), (desc, pc) -> {
