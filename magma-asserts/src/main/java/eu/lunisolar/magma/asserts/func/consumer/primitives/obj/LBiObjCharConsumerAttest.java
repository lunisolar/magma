...
public final class LBiObjCharConsumerAttest<T1, T2> extends FunctionalAttest.Simple<LBiObjCharConsumerAttest<T1, T2>, LBiObjCharConsumer<T1, T2>, LBiObjCharConsumer<T1, T2>> {

	public LBiObjCharConsumerAttest(LBiObjCharConsumer<T1, T2> actual) {
		super(actual);
	}
	...
	@Nonnull
	public SemiEvaluation<LBiObjCharConsumerAttest<T1, T2>, LBiObjCharConsumer<T1, T2>, AssertionsCheck> doesAccept(T1 a1, T2 a2, char a3) {

		return new SemiEvaluation<LBiObjCharConsumerAttest<T1, T2>, LBiObjCharConsumer<T1, T2>, AssertionsCheck>(this, () -> String.format("(%s,%s,%s)", a1, a2, a3), (desc, pc) -> {
