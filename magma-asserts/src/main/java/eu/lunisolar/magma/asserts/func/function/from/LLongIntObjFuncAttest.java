...
public final class LLongIntObjFuncAttest<T, R> extends FunctionalAttest.Full<LLongIntObjFuncAttest<T, R>, LLongIntObjFunc<T, R>, LTieLongConsumer.LLongIntObjCons<T>, Checks.Check<R>> {

	public LLongIntObjFuncAttest(LLongIntObjFunc<T, R> actual) {
		super(actual);
	}

	public LLongIntObjFuncAttest(LLongIntObjFunc<T, R> actual, String name) {
		super(actual, name);
	}
