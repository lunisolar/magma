...
public final class JreToIntBiFunctionAttest<T1, T2> extends FunctionalAttest.Full<JreToIntBiFunctionAttest<T1, T2>, ToIntBiFunction<T1, T2>, LBiConsumer<T1, T2>, Checks.CheckInt> {

	public JreToIntBiFunctionAttest(ToIntBiFunction<T1, T2> actual) {
		super(actual);
	}
