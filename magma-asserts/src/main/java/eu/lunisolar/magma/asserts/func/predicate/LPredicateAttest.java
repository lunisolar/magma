...
public final class LPredicateAttest<T> extends FunctionalAttest.Full<LPredicateAttest<T>, LPredicate<T>, LConsumer<T>, Checks.CheckBool> {

	public LPredicateAttest(LPredicate<T> actual) {
		super(actual);
	}
