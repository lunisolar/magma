...
public final class LIntSrtPredAttest extends FunctionalAttest.Full<LIntSrtPredAttest, LIntSrtPred, LSrtIntConsumer.LIntSrtCons, Checks.CheckBool> {

	public LIntSrtPredAttest(LIntSrtPred actual) {
		super(actual);
	}

	public LIntSrtPredAttest(LIntSrtPred actual, String name) {
		super(actual, name);
	}
