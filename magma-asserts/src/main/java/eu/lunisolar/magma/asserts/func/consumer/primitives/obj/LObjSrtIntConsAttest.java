...
public final class LObjSrtIntConsAttest<T> extends FunctionalAttest.Simple<LObjSrtIntConsAttest<T>, LObjSrtIntCons<T>, LTieSrtConsumer.LObjSrtIntCons<T>> {

	public LObjSrtIntConsAttest(LObjSrtIntCons<T> actual) {
		super(actual);
	}

	public LObjSrtIntConsAttest(LObjSrtIntCons<T> actual, String name) {
		super(actual, name);
	}
