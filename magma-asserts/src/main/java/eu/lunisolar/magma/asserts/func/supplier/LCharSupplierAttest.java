...
public final class LCharSupplierAttest extends FunctionalAttest.Full<LCharSupplierAttest, LCharSupplier, LAction, Checks.CheckChar> {

	public LCharSupplierAttest(LCharSupplier actual) {
		super(actual);
	}
	...
	@Nonnull
	public LCharSupplierAttest doesReturn(char value) {
