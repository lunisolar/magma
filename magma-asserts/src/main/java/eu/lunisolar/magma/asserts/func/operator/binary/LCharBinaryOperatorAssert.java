...
public interface LCharBinaryOperatorAssert<S extends LCharBinaryOperatorAssert<S, A, RS>, A extends LCharBinaryOperator, RS extends AbstractCharacterAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LBiCharConsumer, A, RS, Character> {
	...
	final class The<A extends LCharBinaryOperator, RS extends AbstractCharacterAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LCharBinaryOperator, RS extends AbstractCharacterAssert<RS>> extends FullFunctionalAssert.Base<S, LBiCharConsumer, A, RS, Character> implements LCharBinaryOperatorAssert<S, A, RS> {
