...
public final class LSrtToDblFunctionAttest extends FunctionalAttest.Full<LSrtToDblFunctionAttest, LSrtToDblFunction, LSrtConsumer, Checks.CheckDbl> {

	public LSrtToDblFunctionAttest(LSrtToDblFunction actual) {
		super(actual);
	}
	...
	@Nonnull
	public DblEvaluation<LSrtToDblFunctionAttest, LSrtConsumer> doesApplyAsDbl(short a) {

		return new DblEvaluation<LSrtToDblFunctionAttest, LSrtConsumer>(this, () -> String.format("(%s)", a), (desc, pc) -> {
