...
public final class LByteTernaryOperatorAttest extends FunctionalAttest.Full<LByteTernaryOperatorAttest, LByteTernaryOperator, LTriByteConsumer, Checks.CheckByte> {

	public LByteTernaryOperatorAttest(LByteTernaryOperator actual) {
		super(actual);
	}
