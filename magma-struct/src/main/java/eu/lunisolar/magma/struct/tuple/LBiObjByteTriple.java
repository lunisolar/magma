...
public interface LBiObjByteTriple<T1, T2> extends LTuple<Object> {
	...
	static <T1, T2> int argHashCode(T1 first, T2 second, byte third) {
		final int prime = 31;
		int result = 1;
	...
	static <T1, T2> boolean argEquals(T1 first, T2 second, byte third, T1 firstOfOther, T2 secondOfOther, byte thirdOfOther) {
	 ...
	 */
	static <T1, T2> boolean argEquals(LBiObjByteTriple the, Object that) {
