...
public interface LBiObjIntTriple<T1, T2> extends LTuple<Object> {
	...
	static <T1, T2> int hashCode(T1 first, T2 second, int third) {
		final int prime = 31;
		int result = 1;
	...
	abstract class AbstractBiObjIntTriple<T1, T2> implements LBiObjIntTriple<T1, T2> {
		...
		public boolean equals(Object that) {
			return Null.equals(this, that, (one, two) -> {
				...
				// Intentionally all subclasses of LBiObjIntTriple are allowed.
		...
		@Override
		public int hashCode() {
			return LBiObjIntTriple.hashCode(first(), second(), third());
		}
