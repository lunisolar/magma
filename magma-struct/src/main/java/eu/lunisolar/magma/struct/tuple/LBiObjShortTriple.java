...
public interface LBiObjShortTriple<T1, T2> extends LTuple<Object> {
	...
	static <T1, T2> int hashCode(T1 first, T2 second, short third) {
		final int prime = 31;
		int result = 1;
	...
	abstract class AbstractBiObjShortTriple<T1, T2> implements LBiObjShortTriple<T1, T2> {
		...
		public boolean equals(Object that) {
			return Null.equals(this, that, (one, two) -> {
				...
				// Intentionally all subclasses of LBiObjShortTriple are allowed.
		...
		@Override
		public int hashCode() {
			return LBiObjShortTriple.hashCode(first(), second(), third());
		}
