...
public interface LBiObjLongTriple<T1, T2> extends LTuple<Object> {
	...
	static <T1, T2> int hashCode(T1 first, T2 second, long third) {
		final int prime = 31;
		int result = 1;
	...
	abstract class AbstractBiObjLongTriple<T1, T2> implements LBiObjLongTriple<T1, T2> {
		...
		public boolean equals(Object that) {
			return Null.equals(this, that, (one, two) -> {
				...
				// Intentionally all subclasses of LBiObjLongTriple are allowed.
		...
		@Override
		public int hashCode() {
			return LBiObjLongTriple.hashCode(first(), second(), third());
		}
