    ...
    public static Object[][] cases() {
        return new Object[][]{
                ...
                case_(v -> arg(v, "arg1").verbosity(ALL).must(Be::True, ">MyMsg<"), true, false, IllegalArgumentException.class,
                      "Argument [arg1=='false']: >MyMsg<"),
                case_(v -> arg(v, "arg1").verbosity(ALL).mustM1(Be::True, ">MyMsg< %s", "str"), true, false, IllegalArgumentException.class,
                      "Argument [arg1=='false']: >MyMsg< str"),
                case_(v -> arg(v, "arg1").verbosity(ALL).mustM2(Be::True, ">MyMsg< %s %d", "str", 34), true, false, IllegalArgumentException.class,
                      "Argument [arg1=='false']: >MyMsg< str 34"),
                case_(v -> arg(v, "arg1").verbosity(ALL).mustF(Be::True, __ -> ">" + __ + "<"), true, false, IllegalArgumentException.class,
                      ">false<"),
                case_(v -> arg(v, "arg1").verbosity(ALL).mustExM(Be::TrueEx, ">MyMsg<"), true, false, IllegalArgumentException.class,
                      "Argument [arg1=='false']: <false> must be true. - >MyMsg<"),
                case_(v -> arg(v, "arg1").verbosity(ALL).mustExM2(Be::TrueEx, ">MyMsg< %s %d", "str", 34), true, false, IllegalArgumentException.class,
                ...
                case_(v -> arg(v).mustF(P2::same, true, "x1", "x2", (__, a1, x1, x2) -> "" + __ + "," + a1 + "," + x2 + "," + x2), true, false,
