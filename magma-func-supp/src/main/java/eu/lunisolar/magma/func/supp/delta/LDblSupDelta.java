...
public class LDblSupDelta extends LDblSupMemento {

	protected final LDblBinaryOperator deltaFunction;

	protected LDblSupDelta(LDblSupplier function, LDblBinaryOperator deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LDblSupDelta(double initialValue, LDblSupplier function, LDblBinaryOperator deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static LDblSupDelta deltaOf(LDblSupplier function, LDblBinaryOperator deltaFunction) {
		return new LDblSupDelta(function, deltaFunction);
	}

	public static LDblSupDelta deltaOf(double initialValue, LDblSupplier function, LDblBinaryOperator deltaFunction) {
	...
	public static LDblSupDelta deltaOf(double initialValue, LDblSupplier function) {
		return deltaOf(initialValue, function, LDblSupDelta::mathDelta);
	}
	...
	public static boolean argEquals(LDblSupDelta the, Object that) {
		return Null.<LDblSupDelta> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LDblSupDelta other = (LDblSupDelta) two;
