...
public class LByteUnaryOpDeltaX<X extends Throwable> extends LByteUnaryOpMementoX<X> {

	protected final LByteBinaryOperatorX<X> deltaFunction;

	protected LByteUnaryOpDeltaX(LByteUnaryOperatorX<X> function, LByteBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LByteUnaryOpDeltaX(byte initialValue, LByteUnaryOperatorX<X> function, LByteBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LByteUnaryOpDeltaX<X> deltaOf(LByteUnaryOperatorX<X> function, LByteBinaryOperatorX<X> deltaFunction) {
		return new LByteUnaryOpDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LByteUnaryOpDeltaX<X> deltaOf(byte initialValue, LByteUnaryOperatorX<X> function, LByteBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LByteUnaryOpDeltaX the, Object that) {
		return Null.<LByteUnaryOpDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LByteUnaryOpDeltaX other = (LByteUnaryOpDeltaX) two;
