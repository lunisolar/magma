...
public interface FltValueTrait<SELF extends FltValueTrait<SELF>> extends Fluent<SELF>, aValue<aFloat>, LFltSingle {
	...
	default SELF valueFrom(@Nonnull OptFltTrait<?> trait) {
