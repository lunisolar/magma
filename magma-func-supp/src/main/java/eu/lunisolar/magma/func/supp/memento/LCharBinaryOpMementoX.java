...
public class LCharBinaryOpMementoX<X extends Throwable> implements LCharBinaryOperatorX<X> {

	protected char lastValue;

	protected LCharBinaryOperatorX<X> function;
	...
	public static boolean argEquals(LCharBinaryOpMementoX the, Object that) {
		return Null.<LCharBinaryOpMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LCharBinaryOpMementoX other = (LCharBinaryOpMementoX) two;
