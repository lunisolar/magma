...
public class LShortToCharFuncDeltaX<X extends Throwable> extends LShortToCharFuncMementoX<X> {

	protected final LCharBinaryOperatorX<X> deltaFunction;

	protected LShortToCharFuncDeltaX(LShortToCharFunctionX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LShortToCharFuncDeltaX(char initialValue, LShortToCharFunctionX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LShortToCharFuncDeltaX<X> deltaOf(LShortToCharFunctionX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
		return new LShortToCharFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LShortToCharFuncDeltaX<X> deltaOf(char initialValue, LShortToCharFunctionX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LShortToCharFuncDeltaX the, Object that) {
		return Null.<LShortToCharFuncDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LShortToCharFuncDeltaX other = (LShortToCharFuncDeltaX) two;
