...
public class LFloatToIntFuncMementoX<X extends Throwable> implements LFloatToIntFunctionX<X> {

	protected int lastValue;

	protected LFloatToIntFunctionX<X> function;
	...
	public static boolean argEquals(LFloatToIntFuncMementoX the, Object that) {
		return Null.<LFloatToIntFuncMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LFloatToIntFuncMementoX other = (LFloatToIntFuncMementoX) two;
