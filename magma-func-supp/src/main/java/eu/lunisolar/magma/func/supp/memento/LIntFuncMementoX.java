...
public class LIntFuncMementoX<R, X extends Throwable> implements LIntFunctionX<R, X> {

	protected R lastValue;

	protected LIntFunctionX<R, X> function;
	...
	public static boolean argEquals(LIntFuncMementoX the, Object that) {
		return Null.<LIntFuncMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LIntFuncMementoX other = (LIntFuncMementoX) two;
