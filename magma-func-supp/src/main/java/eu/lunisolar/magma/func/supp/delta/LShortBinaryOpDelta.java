...
public class LShortBinaryOpDelta extends LShortBinaryOpMemento {
	...
	public static boolean argEquals(LShortBinaryOpDelta the, Object that) {
		return Null.<LShortBinaryOpDelta> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LShortBinaryOpDelta other = (LShortBinaryOpDelta) two;
