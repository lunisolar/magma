 ...
 */
@NotThreadSafe
public final class LCharacter
		implements
			FluentTrait<LCharacter>,
			aValue<aChar>,
			CheckCharTrait<LCharacter>,
			FilterCharSingleTrait<LCharacter>,
	...
	public static LCharacter charValue(char value) {
		return new LCharacter(value);
	}
	...
	@Nonnull
	@Override
	public LCharacter value(char value) {
		this.value = value;
		return this;
	}
