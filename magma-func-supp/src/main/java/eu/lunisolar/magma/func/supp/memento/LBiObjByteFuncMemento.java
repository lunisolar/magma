...
public class LBiObjByteFuncMemento<T1, T2, R> implements LBiObjByteFunction<T1, T2, R> {
	 ...
	 */
	public static <T1, T2, R> LBiObjByteFuncMemento<T1, T2, R> hollowMementoOf(LBiObjByteFunction<T1, T2, R> supplier) {
	 ...
	 */
	public static <T1, T2, R> LBiObjByteFuncMemento<T1, T2, R> mementoOf(T1 a1, T2 a2, byte a3, LBiObjByteFunction<T1, T2, R> supplier) {
		return new LBiObjByteFuncMemento<T1, T2, R>(supplier.apply(a1, a2, a3), supplier);
	}
