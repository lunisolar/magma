...
public class LDoubleFuncMementoX<R, X extends Throwable> implements LDoubleFunctionX<R, X> {

	protected R lastValue;

	protected LDoubleFunctionX<R, X> function;
	...
	public static boolean argEquals(LDoubleFuncMementoX the, Object that) {
		return Null.<LDoubleFuncMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LDoubleFuncMementoX other = (LDoubleFuncMementoX) two;
