...
public class LDoubleToFloatFuncDeltaX<X extends Throwable> extends LDoubleToFloatFuncMementoX<X> {

	protected final LFloatBinaryOperatorX<X> deltaFunction;

	protected LDoubleToFloatFuncDeltaX(LDoubleToFloatFunctionX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LDoubleToFloatFuncDeltaX(float initialValue, LDoubleToFloatFunctionX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LDoubleToFloatFuncDeltaX<X> deltaOf(LDoubleToFloatFunctionX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
		return new LDoubleToFloatFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LDoubleToFloatFuncDeltaX<X> deltaOf(float initialValue, LDoubleToFloatFunctionX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LDoubleToFloatFuncDeltaX the, Object that) {
		return Null.<LDoubleToFloatFuncDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LDoubleToFloatFuncDeltaX other = (LDoubleToFloatFuncDeltaX) two;
