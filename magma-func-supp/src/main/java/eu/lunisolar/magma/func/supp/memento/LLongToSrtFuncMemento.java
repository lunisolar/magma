...
public class LLongToSrtFuncMemento implements LLongToSrtFunction {

	protected short lastValue;

	protected LLongToSrtFunction function;

	protected LLongToSrtFuncMemento(LLongToSrtFunction function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LLongToSrtFuncMemento(short initialValue, LLongToSrtFunction function) {
		this(function);
	...
	public static boolean argEquals(LLongToSrtFuncMemento the, Object that) {
		return Null.<LLongToSrtFuncMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LLongToSrtFuncMemento other = (LLongToSrtFuncMemento) two;
