...
public class LBiObjLongFuncDelta<T1, T2, R> extends LBiObjLongFuncMemento<T1, T2, R> {
	...
	public static <T1, T2, R> LBiObjLongFuncDelta<T1, T2, R> initializedDeltaOf(T1 a1, T2 a2, long a3, LBiObjLongFunction<T1, T2, R> function, LBinaryOperator<R> deltaFunction) {
