...
public class LSrtUnaryOpMemento implements LSrtUnaryOperator {

	protected short lastValue;

	protected LSrtUnaryOperator function;

	protected LSrtUnaryOpMemento(LSrtUnaryOperator function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LSrtUnaryOpMemento(short initialValue, LSrtUnaryOperator function) {
		this(function);
	...
	public static boolean argEquals(LSrtUnaryOpMemento the, Object that) {
		return Null.<LSrtUnaryOpMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LSrtUnaryOpMemento other = (LSrtUnaryOpMemento) two;
