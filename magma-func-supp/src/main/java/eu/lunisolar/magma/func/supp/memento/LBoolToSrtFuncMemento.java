...
public class LBoolToSrtFuncMemento implements LBoolToSrtFunction {

	protected short lastValue;

	protected LBoolToSrtFunction function;

	protected LBoolToSrtFuncMemento(LBoolToSrtFunction function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LBoolToSrtFuncMemento(short initialValue, LBoolToSrtFunction function) {
		this(function);
	...
	public static boolean argEquals(LBoolToSrtFuncMemento the, Object that) {
		return Null.<LBoolToSrtFuncMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LBoolToSrtFuncMemento other = (LBoolToSrtFuncMemento) two;
