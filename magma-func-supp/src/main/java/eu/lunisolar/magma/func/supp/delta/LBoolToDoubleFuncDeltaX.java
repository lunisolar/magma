...
public class LBoolToDoubleFuncDeltaX<X extends Throwable> extends LBoolToDoubleFuncMementoX<X> {

	protected final LDoubleBinaryOperatorX<X> deltaFunction;

	protected LBoolToDoubleFuncDeltaX(LBoolToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LBoolToDoubleFuncDeltaX(double initialValue, LBoolToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LBoolToDoubleFuncDeltaX<X> deltaOf(LBoolToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		return new LBoolToDoubleFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LBoolToDoubleFuncDeltaX<X> deltaOf(double initialValue, LBoolToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LBoolToDoubleFuncDeltaX the, Object that) {
		return Null.<LBoolToDoubleFuncDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LBoolToDoubleFuncDeltaX other = (LBoolToDoubleFuncDeltaX) two;
