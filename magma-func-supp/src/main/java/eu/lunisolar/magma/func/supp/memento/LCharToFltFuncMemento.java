...
public class LCharToFltFuncMemento implements LCharToFltFunction {

	protected float lastValue;

	protected LCharToFltFunction function;

	protected LCharToFltFuncMemento(LCharToFltFunction function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LCharToFltFuncMemento(float initialValue, LCharToFltFunction function) {
		this(function);
	...
	public static boolean argEquals(LCharToFltFuncMemento the, Object that) {
		return Null.<LCharToFltFuncMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LCharToFltFuncMemento other = (LCharToFltFuncMemento) two;
