...
public class LUnaryOpDelta<T> extends LUnaryOpMemento<T> {
	...
	public static <T> LUnaryOpDelta<T> deltaOf(LUnaryOperator<T> function, LBinaryOperator<T> deltaFunction) {
		return new LUnaryOpDelta<T>(function, deltaFunction);
	}

	public static <T> LUnaryOpDelta<T> deltaOf(T initialValue, LUnaryOperator<T> function, LBinaryOperator<T> deltaFunction) {
