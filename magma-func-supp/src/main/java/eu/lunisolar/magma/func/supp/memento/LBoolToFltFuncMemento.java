...
public class LBoolToFltFuncMemento implements LBoolToFltFunction {

	protected float lastValue;

	protected LBoolToFltFunction function;

	protected LBoolToFltFuncMemento(LBoolToFltFunction function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LBoolToFltFuncMemento(float initialValue, LBoolToFltFunction function) {
		this(function);
	...
	public static boolean argEquals(LBoolToFltFuncMemento the, Object that) {
		return Null.<LBoolToFltFuncMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LBoolToFltFuncMemento other = (LBoolToFltFuncMemento) two;
