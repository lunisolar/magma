...
public class LFltFuncMemento<R> implements LFltFunction<R> {

	protected R lastValue;

	protected LFltFunction<R> function;

	protected LFltFuncMemento(LFltFunction<R> function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LFltFuncMemento(R initialValue, LFltFunction<R> function) {
		this(function);
	...
	public static boolean argEquals(LFltFuncMemento the, Object that) {
		return Null.<LFltFuncMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LFltFuncMemento other = (LFltFuncMemento) two;
