...
public class LBoolToDblFuncDelta extends LBoolToDblFuncMemento {

	protected final LDblBinaryOperator deltaFunction;

	protected LBoolToDblFuncDelta(LBoolToDblFunction function, LDblBinaryOperator deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LBoolToDblFuncDelta(double initialValue, LBoolToDblFunction function, LDblBinaryOperator deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static LBoolToDblFuncDelta deltaOf(LBoolToDblFunction function, LDblBinaryOperator deltaFunction) {
		return new LBoolToDblFuncDelta(function, deltaFunction);
	}

	public static LBoolToDblFuncDelta deltaOf(double initialValue, LBoolToDblFunction function, LDblBinaryOperator deltaFunction) {
	...
	public static LBoolToDblFuncDelta deltaOf(double initialValue, LBoolToDblFunction function) {
		return deltaOf(initialValue, function, LBoolToDblFuncDelta::mathDelta);
	}
	...
	public static boolean argEquals(LBoolToDblFuncDelta the, Object that) {
		return Null.<LBoolToDblFuncDelta> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LBoolToDblFuncDelta other = (LBoolToDblFuncDelta) two;
	...
	@Override
	public double delta(boolean a) {
		return applyAsDbl(a);
	}

	@Override
	public double delta(boolean a, LDblBinaryOperator deltaFunction) {
