...
public class LIntUnaryOpDelta extends LIntUnaryOpMemento {

	protected final LIntBinaryOperator deltaFunction;

	protected LIntUnaryOpDelta(LIntUnaryOperator function, LIntBinaryOperator deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LIntUnaryOpDelta(int initialValue, LIntUnaryOperator function, LIntBinaryOperator deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static LIntUnaryOpDelta deltaOf(LIntUnaryOperator function, LIntBinaryOperator deltaFunction) {
		return new LIntUnaryOpDelta(function, deltaFunction);
	}

	public static LIntUnaryOpDelta deltaOf(int initialValue, LIntUnaryOperator function, LIntBinaryOperator deltaFunction) {
	...
	public static LIntUnaryOpDelta deltaOf(int initialValue, LIntUnaryOperator function) {
		return deltaOf(initialValue, function, LIntUnaryOpDelta::mathDelta);
	}
	...
	public static boolean argEquals(LIntUnaryOpDelta the, Object that) {
		return Null.<LIntUnaryOpDelta> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LIntUnaryOpDelta other = (LIntUnaryOpDelta) two;
	...
	@Override
	public int delta(int a, LIntBinaryOperator deltaFunction) {
