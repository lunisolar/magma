...
public class LLogicalOpDeltaX<X extends Throwable> extends LLogicalOpMementoX<X> {

	protected final LLogicalBinaryOperatorX<X> deltaFunction;

	protected LLogicalOpDeltaX(LLogicalOperatorX<X> function, LLogicalBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LLogicalOpDeltaX(boolean initialValue, LLogicalOperatorX<X> function, LLogicalBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LLogicalOpDeltaX<X> deltaOf(LLogicalOperatorX<X> function, LLogicalBinaryOperatorX<X> deltaFunction) {
		return new LLogicalOpDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LLogicalOpDeltaX<X> deltaOf(boolean initialValue, LLogicalOperatorX<X> function, LLogicalBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LLogicalOpDeltaX the, Object that) {
		return Null.<LLogicalOpDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LLogicalOpDeltaX other = (LLogicalOpDeltaX) two;
