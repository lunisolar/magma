...
public interface SrtValueTrait<SELF extends SrtValueTrait<SELF>> extends Fluent<SELF>, aValue<aShort>, LSrtSingle {
	...
	default SELF fromOpt(@Nonnull OptSrtTrait<?> trait) {
