...
public interface OptIntTrait<SELF extends OptIntTrait<SELF>> extends Fluent<SELF>, aValue<aInt>, CheckIntTrait<SELF>, FilterIntSingleTrait<SELF>, IsIntTrait<SELF>, DoIfIntTrait<SELF> {
	...
	default SELF perform(@Nonnull LIntUnaryOperator mapping) {
		Null.nonNullArg(mapping, "mapping");
	...
	default SELF performWith(int a1, @Nonnull LIntBinaryOperator mapping) {
		Null.nonNullArg(mapping, "mapping");
	...
	default SELF perform(@Nonnull LIntFunction<? extends OptIntTrait<? extends SELF>> mapping) {
		Null.nonNullArg(mapping, "mapping");
	...
	default SELF flatPerformWith(int a1, @Nonnull LBiIntFunction<? extends OptIntTrait<? extends SELF>> mapping) {
		Null.nonNullArg(mapping, "mapping");
