 ...
 */
public interface OptSrtTrait<SELF extends OptSrtTrait<SELF>> extends FluentTrait<SELF>, aValue<aShort>, CheckSrtTrait<SELF>, FilterSrtSingleTrait<SELF>, IsSrtTrait<SELF>, DoIfSrtTrait<SELF> {
