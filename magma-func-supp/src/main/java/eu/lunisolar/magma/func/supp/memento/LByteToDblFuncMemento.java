...
public class LByteToDblFuncMemento implements LByteToDblFunction {

	protected double lastValue;

	protected LByteToDblFunction function;

	protected LByteToDblFuncMemento(LByteToDblFunction function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LByteToDblFuncMemento(double initialValue, LByteToDblFunction function) {
		this(function);
	...
	public static boolean argEquals(LByteToDblFuncMemento the, Object that) {
		return Null.<LByteToDblFuncMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LByteToDblFuncMemento other = (LByteToDblFuncMemento) two;
