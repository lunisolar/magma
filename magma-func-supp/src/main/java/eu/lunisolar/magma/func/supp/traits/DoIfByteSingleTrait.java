 ...
 */
public interface DoIfByteSingleTrait<SELF extends DoIfByteSingleTrait<SELF>> extends LByteSingle, DoIfByteTrait<SELF>, IsByteTrait<SELF>, ByteValueTrait<SELF> {
