...
public class LCharToFloatFuncDeltaX<X extends Throwable> extends LCharToFloatFuncMementoX<X> {
	...
	protected LCharToFloatFuncDeltaX(LCharToFloatFunctionX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LCharToFloatFuncDeltaX(float initialValue, LCharToFloatFunctionX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LCharToFloatFuncDeltaX<X> deltaOf(LCharToFloatFunctionX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
		return new LCharToFloatFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LCharToFloatFuncDeltaX<X> deltaOf(float initialValue, LCharToFloatFunctionX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LCharToFloatFuncDeltaX the, Object that) {
		return Null.<LCharToFloatFuncDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LCharToFloatFuncDeltaX other = (LCharToFloatFuncDeltaX) two;
