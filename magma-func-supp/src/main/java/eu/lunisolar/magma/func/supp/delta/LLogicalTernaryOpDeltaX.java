...
public class LLogicalTernaryOpDeltaX<X extends Throwable> extends LLogicalTernaryOpMementoX<X> {

	protected final LLogicalBinaryOperatorX<X> deltaFunction;

	protected LLogicalTernaryOpDeltaX(LLogicalTernaryOperatorX<X> function, LLogicalBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LLogicalTernaryOpDeltaX(boolean initialValue, LLogicalTernaryOperatorX<X> function, LLogicalBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LLogicalTernaryOpDeltaX<X> deltaOf(LLogicalTernaryOperatorX<X> function, LLogicalBinaryOperatorX<X> deltaFunction) {
		return new LLogicalTernaryOpDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LLogicalTernaryOpDeltaX<X> deltaOf(boolean initialValue, LLogicalTernaryOperatorX<X> function, LLogicalBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LLogicalTernaryOpDeltaX the, Object that) {
		return Null.<LLogicalTernaryOpDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LLogicalTernaryOpDeltaX other = (LLogicalTernaryOpDeltaX) two;
