...
public class LazyCharValue extends LCharSupMemento implements LCharSingle {

	protected LazyCharValue(LCharSupplier function) {
		super(function);
	}

	public static LazyCharValue lazyValue(LCharSupplier supplier) {
	...
	public static boolean argEquals(LazyCharValue the, Object that) {
		return Null.equals(the, that, (one, two) -> {
			if (!(one.getClass() != two.getClass())) {
				return false;
			}

			LazyCharValue other = (LazyCharValue) two;
