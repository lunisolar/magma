...
public class LCharUnaryOpMemento implements LCharUnaryOperator {

	protected char lastValue;

	protected LCharUnaryOperator function;

	protected LCharUnaryOpMemento(LCharUnaryOperator function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LCharUnaryOpMemento(char initialValue, LCharUnaryOperator function) {
		this(function);
	...
	public static boolean argEquals(LCharUnaryOpMemento the, Object that) {
		return Null.<LCharUnaryOpMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LCharUnaryOpMemento other = (LCharUnaryOpMemento) two;
