...
public abstract class OptByteBase<SELF extends OptByteBase<SELF>> implements OptByteTrait<SELF> {

	protected final byte value;
	protected final boolean isPresent;

	protected OptByteBase() {
		this.value = (byte) 0;
		this.isPresent = false;
	}

	protected OptByteBase(byte value) {
		this.value = value;
		this.isPresent = true;
	}
	...
	public boolean equals(Object obj) {
		...
		OptByteBase other = (OptByteBase) obj;
