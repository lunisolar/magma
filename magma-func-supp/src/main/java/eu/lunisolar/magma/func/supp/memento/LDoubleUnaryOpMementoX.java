...
public class LDoubleUnaryOpMementoX<X extends Throwable> implements LDoubleUnaryOperatorX<X> {

	protected double lastValue;

	protected LDoubleUnaryOperatorX<X> function;
	...
	public static boolean argEquals(LDoubleUnaryOpMementoX the, Object that) {
		return Null.<LDoubleUnaryOpMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LDoubleUnaryOpMementoX other = (LDoubleUnaryOpMementoX) two;
