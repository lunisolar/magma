...
public class LDoubleToIntFuncMementoX<X extends Throwable> implements LDoubleToIntFunctionX<X> {

	protected int lastValue;

	protected LDoubleToIntFunctionX<X> function;
	...
	public static boolean argEquals(LDoubleToIntFuncMementoX the, Object that) {
		return Null.<LDoubleToIntFuncMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LDoubleToIntFuncMementoX other = (LDoubleToIntFuncMementoX) two;
