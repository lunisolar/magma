...
public class LBiObjShortFuncMementoX<T1, T2, R, X extends Throwable> implements LBiObjShortFunctionX<T1, T2, R, X> {

	protected R lastValue;

	protected LBiObjShortFunctionX<T1, T2, R, X> function;
	...
	public static boolean argEquals(LBiObjShortFuncMementoX the, Object that) {
		return Null.<LBiObjShortFuncMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LBiObjShortFuncMementoX other = (LBiObjShortFuncMementoX) two;
