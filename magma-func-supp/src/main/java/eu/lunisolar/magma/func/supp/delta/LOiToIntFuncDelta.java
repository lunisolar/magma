...
public class LOiToIntFuncDelta<T> extends LOiToIntFuncMemento<T> {

	protected final LIntBinaryOperator deltaFunction;

	protected LOiToIntFuncDelta(LOiToIntFunction<T> function, LIntBinaryOperator deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LOiToIntFuncDelta(int initialValue, LOiToIntFunction<T> function, LIntBinaryOperator deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <T> LOiToIntFuncDelta<T> deltaOf(LOiToIntFunction<T> function, LIntBinaryOperator deltaFunction) {
		return new LOiToIntFuncDelta<T>(function, deltaFunction);
	}

	public static <T> LOiToIntFuncDelta<T> deltaOf(int initialValue, LOiToIntFunction<T> function, LIntBinaryOperator deltaFunction) {
	...
	public static <T> LOiToIntFuncDelta<T> deltaOf(int initialValue, LOiToIntFunction<T> function) {
		return deltaOf(initialValue, function, LOiToIntFuncDelta::mathDelta);
	}
	...
	public static boolean argEquals(LOiToIntFuncDelta the, Object that) {
		return Null.<LOiToIntFuncDelta> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LOiToIntFuncDelta other = (LOiToIntFuncDelta) two;
	...
	@Override
	public int delta(T a1, int a2) {
		return applyAsInt(a1, a2);
	}

	@Override
	public int delta(T a1, int a2, LIntBinaryOperator deltaFunction) {
