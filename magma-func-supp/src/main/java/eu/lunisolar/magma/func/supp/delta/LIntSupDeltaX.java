...
public class LIntSupDeltaX<X extends Throwable> extends LIntSupMementoX<X> {
	...
	protected LIntSupDeltaX(LIntSupplierX<X> function, LIntBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LIntSupDeltaX(int initialValue, LIntSupplierX<X> function, LIntBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LIntSupDeltaX<X> deltaOf(LIntSupplierX<X> function, LIntBinaryOperatorX<X> deltaFunction) {
		return new LIntSupDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LIntSupDeltaX<X> deltaOf(int initialValue, LIntSupplierX<X> function, LIntBinaryOperatorX<X> deltaFunction) {
