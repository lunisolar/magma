...
public class LToDblFuncDelta<T> extends LToDblFuncMemento<T> {

	protected final LDblBinaryOperator deltaFunction;

	protected LToDblFuncDelta(LToDblFunction<T> function, LDblBinaryOperator deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LToDblFuncDelta(double initialValue, LToDblFunction<T> function, LDblBinaryOperator deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <T> LToDblFuncDelta<T> deltaOf(LToDblFunction<T> function, LDblBinaryOperator deltaFunction) {
		return new LToDblFuncDelta<T>(function, deltaFunction);
	}

	public static <T> LToDblFuncDelta<T> deltaOf(double initialValue, LToDblFunction<T> function, LDblBinaryOperator deltaFunction) {
	...
	public static <T> LToDblFuncDelta<T> deltaOf(double initialValue, LToDblFunction<T> function) {
		return deltaOf(initialValue, function, LToDblFuncDelta::mathDelta);
	}
	...
	public static boolean argEquals(LToDblFuncDelta the, Object that) {
		return Null.<LToDblFuncDelta> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LToDblFuncDelta other = (LToDblFuncDelta) two;
	...
	@Override
	public double delta(T a) {
		return applyAsDbl(a);
	}

	@Override
	public double delta(T a, LDblBinaryOperator deltaFunction) {
