...
public class LOiToByteFuncMemento<T> implements LOiToByteFunction<T> {

	protected byte lastValue;

	protected LOiToByteFunction<T> function;

	protected LOiToByteFuncMemento(LOiToByteFunction<T> function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LOiToByteFuncMemento(byte initialValue, LOiToByteFunction<T> function) {
		this(function);
	...
	public static boolean argEquals(LOiToByteFuncMemento the, Object that) {
		return Null.<LOiToByteFuncMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LOiToByteFuncMemento other = (LOiToByteFuncMemento) two;
