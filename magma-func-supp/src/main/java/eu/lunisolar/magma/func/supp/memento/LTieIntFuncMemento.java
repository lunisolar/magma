...
public class LTieIntFuncMemento<T> implements LTieIntFunction<T> {
	 ...
	 */
	public static <T> LTieIntFuncMemento<T> hollowMementoOf(LTieIntFunction<T> supplier) {
	 ...
	 */
	public static <T> LTieIntFuncMemento<T> mementoOf(T a1, int a2, int a3, LTieIntFunction<T> supplier) {
		return new LTieIntFuncMemento<T>(supplier.applyAsInt(a1, a2, a3), supplier);
	}
