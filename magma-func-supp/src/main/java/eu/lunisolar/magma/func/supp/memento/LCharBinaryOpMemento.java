...
public class LCharBinaryOpMemento implements LCharBinaryOperator {

	protected char lastValue;

	protected LCharBinaryOperator function;

	protected LCharBinaryOpMemento(LCharBinaryOperator function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LCharBinaryOpMemento(char initialValue, LCharBinaryOperator function) {
		this(function);
	...
	public static boolean argEquals(LCharBinaryOpMemento the, Object that) {
		return Null.<LCharBinaryOpMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LCharBinaryOpMemento other = (LCharBinaryOpMemento) two;
