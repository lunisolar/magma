...
public class LDblFuncMemento<R> implements LDblFunction<R> {

	protected R lastValue;

	protected LDblFunction<R> function;

	protected LDblFuncMemento(LDblFunction<R> function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LDblFuncMemento(R initialValue, LDblFunction<R> function) {
		this(function);
	...
	public static boolean argEquals(LDblFuncMemento the, Object that) {
		return Null.<LDblFuncMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LDblFuncMemento other = (LDblFuncMemento) two;
