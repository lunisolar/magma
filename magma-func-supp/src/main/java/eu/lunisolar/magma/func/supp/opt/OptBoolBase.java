...
public abstract class OptBoolBase<SELF extends OptBoolBase<SELF>> implements OptBoolTrait<SELF> {

	protected final boolean value;
	protected final boolean isPresent;

	protected OptBoolBase() {
		this.value = false;
		this.isPresent = false;
	}

	protected OptBoolBase(boolean value) {
		this.value = value;
		this.isPresent = true;
	}
	...
	public boolean equals(Object obj) {
		...
		OptBoolBase other = (OptBoolBase) obj;
