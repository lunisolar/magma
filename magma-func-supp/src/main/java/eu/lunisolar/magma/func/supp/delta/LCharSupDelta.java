...
public class LCharSupDelta extends LCharSupMemento {

	protected final LCharBinaryOperator deltaFunction;

	protected LCharSupDelta(LCharSupplier function, LCharBinaryOperator deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LCharSupDelta(char initialValue, LCharSupplier function, LCharBinaryOperator deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static LCharSupDelta deltaOf(LCharSupplier function, LCharBinaryOperator deltaFunction) {
		return new LCharSupDelta(function, deltaFunction);
	}

	public static LCharSupDelta deltaOf(char initialValue, LCharSupplier function, LCharBinaryOperator deltaFunction) {
	...
	public static LCharSupDelta deltaOf(char initialValue, LCharSupplier function) {
		return deltaOf(initialValue, function, LCharSupDelta::mathDelta);
	}
	...
	public static boolean argEquals(LCharSupDelta the, Object that) {
		return Null.<LCharSupDelta> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LCharSupDelta other = (LCharSupDelta) two;
