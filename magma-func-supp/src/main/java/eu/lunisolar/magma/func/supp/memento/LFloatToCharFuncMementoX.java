...
public class LFloatToCharFuncMementoX<X extends Throwable> implements LFloatToCharFunctionX<X> {

	protected char lastValue;

	protected LFloatToCharFunctionX<X> function;
	...
	public static boolean argEquals(LFloatToCharFuncMementoX the, Object that) {
		return Null.<LFloatToCharFuncMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LFloatToCharFuncMementoX other = (LFloatToCharFuncMementoX) two;
