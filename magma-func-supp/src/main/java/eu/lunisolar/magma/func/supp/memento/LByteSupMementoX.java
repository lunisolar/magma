...
public class LByteSupMementoX<X extends Throwable> implements LByteSupplierX<X> {

	protected byte lastValue;

	protected LByteSupplierX<X> function;
	...
	public static boolean argEquals(LByteSupMementoX the, Object that) {
		return Null.<LByteSupMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LByteSupMementoX other = (LByteSupMementoX) two;
