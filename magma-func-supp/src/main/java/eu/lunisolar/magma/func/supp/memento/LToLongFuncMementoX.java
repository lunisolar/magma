...
public class LToLongFuncMementoX<T, X extends Throwable> implements LToLongFunctionX<T, X> {

	protected long lastValue;

	protected LToLongFunctionX<T, X> function;
	...
	public static boolean argEquals(LToLongFuncMementoX the, Object that) {
		return Null.<LToLongFuncMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LToLongFuncMementoX other = (LToLongFuncMementoX) two;
