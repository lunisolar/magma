...
public class LazyShortValue extends LShortSupMemento implements LShortSingle {

	protected LazyShortValue(LShortSupplier function) {
		super(function);
	}

	public static LazyShortValue lazyValue(LShortSupplier supplier) {
	...
	public static boolean argEquals(LazyShortValue the, Object that) {
		return Null.equals(the, that, (one, two) -> {
			if (!(one.getClass() != two.getClass())) {
				return false;
			}

			LazyShortValue other = (LazyShortValue) two;
