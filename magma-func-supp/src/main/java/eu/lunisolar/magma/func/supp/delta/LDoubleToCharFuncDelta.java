...
public class LDoubleToCharFuncDelta extends LDoubleToCharFuncMemento {
	...
	public static boolean argEquals(LDoubleToCharFuncDelta the, Object that) {
		return Null.<LDoubleToCharFuncDelta> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LDoubleToCharFuncDelta other = (LDoubleToCharFuncDelta) two;
