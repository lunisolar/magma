...
public class LByteToFltFuncDelta extends LByteToFltFuncMemento {

	protected final LFltBinaryOperator deltaFunction;

	protected LByteToFltFuncDelta(LByteToFltFunction function, LFltBinaryOperator deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LByteToFltFuncDelta(float initialValue, LByteToFltFunction function, LFltBinaryOperator deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static LByteToFltFuncDelta deltaOf(LByteToFltFunction function, LFltBinaryOperator deltaFunction) {
		return new LByteToFltFuncDelta(function, deltaFunction);
	}

	public static LByteToFltFuncDelta deltaOf(float initialValue, LByteToFltFunction function, LFltBinaryOperator deltaFunction) {
	...
	public static LByteToFltFuncDelta deltaOf(float initialValue, LByteToFltFunction function) {
		return deltaOf(initialValue, function, LByteToFltFuncDelta::mathDelta);
	}
	...
	@Override
	public float applyAsFlt(byte a) {
		return deltaFunction.applyAsFlt(lastValue(), super.applyAsFlt(a));
	}

	// <editor-fold desc="object">

	public static boolean argEquals(LByteToFltFuncDelta the, Object that) {
		return Null.<LByteToFltFuncDelta> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LByteToFltFuncDelta other = (LByteToFltFuncDelta) two;
	...
	@Override
	public float delta(byte a) {
		return applyAsFlt(a);
	}

	@Override
	public float delta(byte a, LFltBinaryOperator deltaFunction) {
