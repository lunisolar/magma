...
public class LByteFuncDeltaX<R, X extends Throwable> extends LByteFuncMementoX<R, X> {
	...
	protected LByteFuncDeltaX(LByteFunctionX<R, X> function, LBinaryOperatorX<R, X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LByteFuncDeltaX(R initialValue, LByteFunctionX<R, X> function, LBinaryOperatorX<R, X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <R, X extends Throwable> LByteFuncDeltaX<R, X> deltaOf(LByteFunctionX<R, X> function, LBinaryOperatorX<R, X> deltaFunction) {
		return new LByteFuncDeltaX<R, X>(function, deltaFunction);
	}

	public static <R, X extends Throwable> LByteFuncDeltaX<R, X> deltaOf(R initialValue, LByteFunctionX<R, X> function, LBinaryOperatorX<R, X> deltaFunction) {
