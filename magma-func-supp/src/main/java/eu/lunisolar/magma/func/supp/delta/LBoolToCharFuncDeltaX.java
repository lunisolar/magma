...
public class LBoolToCharFuncDeltaX<X extends Throwable> extends LBoolToCharFuncMementoX<X> {
	...
	protected LBoolToCharFuncDeltaX(LBoolToCharFunctionX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LBoolToCharFuncDeltaX(char initialValue, LBoolToCharFunctionX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LBoolToCharFuncDeltaX<X> deltaOf(LBoolToCharFunctionX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
		return new LBoolToCharFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LBoolToCharFuncDeltaX<X> deltaOf(char initialValue, LBoolToCharFunctionX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
