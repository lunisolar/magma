...
public interface IsByteTrait<SELF extends IsByteTrait<SELF>> extends ByteValueTrait<SELF> {
	...
	/** Variant 'method(Is::equal, ...)' or 'method(Does::contain, ...)', etc.  */
	default <V> boolean is2Variant(@Nonnull LObjBytePredicate.LByteObjPred<? super V> predicate, V v) {
	...
	/** Variant 'method(Is::equal, ...)' or 'method(Does::contain, ...)', etc.  */
	default <V> boolean isNot2Variant(@Nonnull LObjBytePredicate.LByteObjPred<? super V> predicate, V v) {
