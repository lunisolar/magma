...
public class LIntToCharFuncDeltaX<X extends Throwable> extends LIntToCharFuncMementoX<X> {

	protected final LCharBinaryOperatorX<X> deltaFunction;

	protected LIntToCharFuncDeltaX(LIntToCharFunctionX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LIntToCharFuncDeltaX(char initialValue, LIntToCharFunctionX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LIntToCharFuncDeltaX<X> deltaOf(LIntToCharFunctionX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
		return new LIntToCharFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LIntToCharFuncDeltaX<X> deltaOf(char initialValue, LIntToCharFunctionX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LIntToCharFuncDeltaX the, Object that) {
		return Null.<LIntToCharFuncDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LIntToCharFuncDeltaX other = (LIntToCharFuncDeltaX) two;
