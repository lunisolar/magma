...
public class LFltToIntFuncDelta extends LFltToIntFuncMemento {

	protected final LIntBinaryOperator deltaFunction;

	protected LFltToIntFuncDelta(LFltToIntFunction function, LIntBinaryOperator deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LFltToIntFuncDelta(int initialValue, LFltToIntFunction function, LIntBinaryOperator deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static LFltToIntFuncDelta deltaOf(LFltToIntFunction function, LIntBinaryOperator deltaFunction) {
		return new LFltToIntFuncDelta(function, deltaFunction);
	}

	public static LFltToIntFuncDelta deltaOf(int initialValue, LFltToIntFunction function, LIntBinaryOperator deltaFunction) {
	...
	public static LFltToIntFuncDelta deltaOf(int initialValue, LFltToIntFunction function) {
		return deltaOf(initialValue, function, LFltToIntFuncDelta::mathDelta);
	}
	...
	@Override
	public int applyAsInt(float a) {
		return deltaFunction.applyAsInt(lastValue(), super.applyAsInt(a));
	}

	// <editor-fold desc="object">

	public static boolean argEquals(LFltToIntFuncDelta the, Object that) {
		return Null.<LFltToIntFuncDelta> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LFltToIntFuncDelta other = (LFltToIntFuncDelta) two;
