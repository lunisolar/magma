...
public class LFltToSrtFuncDelta extends LFltToSrtFuncMemento {

	protected final LSrtBinaryOperator deltaFunction;

	protected LFltToSrtFuncDelta(LFltToSrtFunction function, LSrtBinaryOperator deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LFltToSrtFuncDelta(short initialValue, LFltToSrtFunction function, LSrtBinaryOperator deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static LFltToSrtFuncDelta deltaOf(LFltToSrtFunction function, LSrtBinaryOperator deltaFunction) {
		return new LFltToSrtFuncDelta(function, deltaFunction);
	}

	public static LFltToSrtFuncDelta deltaOf(short initialValue, LFltToSrtFunction function, LSrtBinaryOperator deltaFunction) {
	...
	public static LFltToSrtFuncDelta deltaOf(short initialValue, LFltToSrtFunction function) {
		return deltaOf(initialValue, function, LFltToSrtFuncDelta::mathDelta);
	}
	...
	public static boolean argEquals(LFltToSrtFuncDelta the, Object that) {
		return Null.<LFltToSrtFuncDelta> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LFltToSrtFuncDelta other = (LFltToSrtFuncDelta) two;
