...
public class LBoolToByteFuncMemento implements LBoolToByteFunction {

	protected byte lastValue;

	protected LBoolToByteFunction function;

	protected LBoolToByteFuncMemento(LBoolToByteFunction function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LBoolToByteFuncMemento(byte initialValue, LBoolToByteFunction function) {
		this(function);
	...
	public static boolean argEquals(LBoolToByteFuncMemento the, Object that) {
		return Null.<LBoolToByteFuncMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LBoolToByteFuncMemento other = (LBoolToByteFuncMemento) two;
