...
public class LToByteFuncDeltaX<T, X extends Throwable> extends LToByteFuncMementoX<T, X> {

	protected final LByteBinaryOperatorX<X> deltaFunction;

	protected LToByteFuncDeltaX(LToByteFunctionX<T, X> function, LByteBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LToByteFuncDeltaX(byte initialValue, LToByteFunctionX<T, X> function, LByteBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <T, X extends Throwable> LToByteFuncDeltaX<T, X> deltaOf(LToByteFunctionX<T, X> function, LByteBinaryOperatorX<X> deltaFunction) {
		return new LToByteFuncDeltaX<T, X>(function, deltaFunction);
	}

	public static <T, X extends Throwable> LToByteFuncDeltaX<T, X> deltaOf(byte initialValue, LToByteFunctionX<T, X> function, LByteBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LToByteFuncDeltaX the, Object that) {
		return Null.<LToByteFuncDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LToByteFuncDeltaX other = (LToByteFuncDeltaX) two;
