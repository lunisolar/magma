...
public class LBoolToIntFuncMementoX<X extends Throwable> implements LBoolToIntFunctionX<X> {

	protected int lastValue;

	protected LBoolToIntFunctionX<X> function;
	...
	public static boolean argEquals(LBoolToIntFuncMementoX the, Object that) {
		return Null.<LBoolToIntFuncMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LBoolToIntFuncMementoX other = (LBoolToIntFuncMementoX) two;
