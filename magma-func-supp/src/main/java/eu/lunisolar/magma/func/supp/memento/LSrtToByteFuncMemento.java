...
public class LSrtToByteFuncMemento implements LSrtToByteFunction {

	protected byte lastValue;

	protected LSrtToByteFunction function;

	protected LSrtToByteFuncMemento(LSrtToByteFunction function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LSrtToByteFuncMemento(byte initialValue, LSrtToByteFunction function) {
		this(function);
	...
	public static boolean argEquals(LSrtToByteFuncMemento the, Object that) {
		return Null.<LSrtToByteFuncMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LSrtToByteFuncMemento other = (LSrtToByteFuncMemento) two;
