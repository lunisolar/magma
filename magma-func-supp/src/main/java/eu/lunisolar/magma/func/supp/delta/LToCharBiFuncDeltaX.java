...
public class LToCharBiFuncDeltaX<T1, T2, X extends Throwable> extends LToCharBiFuncMementoX<T1, T2, X> {
	...
	protected LToCharBiFuncDeltaX(LToCharBiFunctionX<T1, T2, X> function, LCharBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LToCharBiFuncDeltaX(char initialValue, LToCharBiFunctionX<T1, T2, X> function, LCharBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <T1, T2, X extends Throwable> LToCharBiFuncDeltaX<T1, T2, X> deltaOf(LToCharBiFunctionX<T1, T2, X> function, LCharBinaryOperatorX<X> deltaFunction) {
		return new LToCharBiFuncDeltaX<T1, T2, X>(function, deltaFunction);
	}

	public static <T1, T2, X extends Throwable> LToCharBiFuncDeltaX<T1, T2, X> deltaOf(char initialValue, LToCharBiFunctionX<T1, T2, X> function, LCharBinaryOperatorX<X> deltaFunction) {
