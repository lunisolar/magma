...
public class LazyByteValue extends LByteSupMemento implements LByteSingle {

	protected LazyByteValue(LByteSupplier function) {
		super(function);
	}

	public static LazyByteValue lazyValue(LByteSupplier supplier) {
	...
	public static boolean argEquals(LazyByteValue the, Object that) {
