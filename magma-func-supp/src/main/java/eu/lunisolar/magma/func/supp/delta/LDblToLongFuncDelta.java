...
public class LDblToLongFuncDelta extends LDblToLongFuncMemento {

	protected final LLongBinaryOperator deltaFunction;

	protected LDblToLongFuncDelta(LDblToLongFunction function, LLongBinaryOperator deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LDblToLongFuncDelta(long initialValue, LDblToLongFunction function, LLongBinaryOperator deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static LDblToLongFuncDelta deltaOf(LDblToLongFunction function, LLongBinaryOperator deltaFunction) {
		return new LDblToLongFuncDelta(function, deltaFunction);
	}

	public static LDblToLongFuncDelta deltaOf(long initialValue, LDblToLongFunction function, LLongBinaryOperator deltaFunction) {
	...
	public static LDblToLongFuncDelta deltaOf(long initialValue, LDblToLongFunction function) {
		return deltaOf(initialValue, function, LDblToLongFuncDelta::mathDelta);
	}
	...
	public static boolean argEquals(LDblToLongFuncDelta the, Object that) {
		return Null.<LDblToLongFuncDelta> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LDblToLongFuncDelta other = (LDblToLongFuncDelta) two;
	...
	@Override
	public long delta(double a) {
		return applyAsLong(a);
	}

	@Override
	public long delta(double a, LLongBinaryOperator deltaFunction) {
