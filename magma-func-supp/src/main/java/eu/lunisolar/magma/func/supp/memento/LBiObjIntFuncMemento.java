...
public class LBiObjIntFuncMemento<T1, T2, R> implements LBiObjIntFunction<T1, T2, R> {
	 ...
	 */
	public static <T1, T2, R> LBiObjIntFuncMemento<T1, T2, R> hollowMementoOf(LBiObjIntFunction<T1, T2, R> supplier) {
	 ...
	 */
	public static <T1, T2, R> LBiObjIntFuncMemento<T1, T2, R> mementoOf(T1 a1, T2 a2, int a3, LBiObjIntFunction<T1, T2, R> supplier) {
		return new LBiObjIntFuncMemento<T1, T2, R>(supplier.apply(a1, a2, a3), supplier);
	}

	@Override
	public R applyX(T1 a1, T2 a2, int a3) {
