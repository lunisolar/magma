...
public class LIntBinaryOpMemento implements LIntBinaryOperator {

	protected int lastValue;

	protected LIntBinaryOperator function;

	protected LIntBinaryOpMemento(LIntBinaryOperator function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LIntBinaryOpMemento(int initialValue, LIntBinaryOperator function) {
		this(function);
	...
	public static boolean argEquals(LIntBinaryOpMemento the, Object that) {
		return Null.<LIntBinaryOpMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LIntBinaryOpMemento other = (LIntBinaryOpMemento) two;
