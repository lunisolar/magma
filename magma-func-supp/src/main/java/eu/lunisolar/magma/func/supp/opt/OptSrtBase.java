...
public abstract class OptSrtBase<SELF extends OptSrtBase<SELF>> implements OptSrtTrait<SELF> {

	protected final short value;
	protected final boolean isPresent;

	protected OptSrtBase() {
		this.value = (short) 0;
		this.isPresent = false;
	}

	protected OptSrtBase(short value) {
		this.value = value;
		this.isPresent = true;
	}
	...
	public boolean equals(Object obj) {
		...
		OptSrtBase other = (OptSrtBase) obj;
