...
public class LToFltFuncDelta<T> extends LToFltFuncMemento<T> {

	protected final LFltBinaryOperator deltaFunction;

	protected LToFltFuncDelta(LToFltFunction<T> function, LFltBinaryOperator deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LToFltFuncDelta(float initialValue, LToFltFunction<T> function, LFltBinaryOperator deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <T> LToFltFuncDelta<T> deltaOf(LToFltFunction<T> function, LFltBinaryOperator deltaFunction) {
		return new LToFltFuncDelta<T>(function, deltaFunction);
	}

	public static <T> LToFltFuncDelta<T> deltaOf(float initialValue, LToFltFunction<T> function, LFltBinaryOperator deltaFunction) {
	...
	public static <T> LToFltFuncDelta<T> deltaOf(float initialValue, LToFltFunction<T> function) {
		return deltaOf(initialValue, function, LToFltFuncDelta::mathDelta);
	}
	...
	public static boolean argEquals(LToFltFuncDelta the, Object that) {
		return Null.<LToFltFuncDelta> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LToFltFuncDelta other = (LToFltFuncDelta) two;
	...
	@Override
	public float delta(T a) {
		return applyAsFlt(a);
	}

	@Override
	public float delta(T a, LFltBinaryOperator deltaFunction) {
