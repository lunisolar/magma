...
public interface AccessBiObjLongTriple<T1, T2> {
	...
	default void useWith(LBiObjLongConsumer.V1<T1, T2> accessFunction) {
		LBiObjLongTriple<T1, T2> tuple = accessBiObjLongTriple();
		accessFunction.doAcceptV1(tuple.first(), tuple.third(), tuple.second());
	}

	default void useWith(LBiObjLongConsumer.V2<T2, T1> accessFunction) {
		LBiObjLongTriple<T1, T2> tuple = accessBiObjLongTriple();
		accessFunction.doAcceptV2(tuple.second(), tuple.first(), tuple.third());
	}

	default void useWith(LBiObjLongConsumer.V3<T2, T1> accessFunction) {
		LBiObjLongTriple<T1, T2> tuple = accessBiObjLongTriple();
		accessFunction.doAcceptV3(tuple.second(), tuple.third(), tuple.first());
	}

	default void useWith(LBiObjLongConsumer.V4<T1, T2> accessFunction) {
		LBiObjLongTriple<T1, T2> tuple = accessBiObjLongTriple();
		accessFunction.doAcceptV4(tuple.third(), tuple.first(), tuple.second());
	}

	default void useWith(LBiObjLongConsumer.V5<T2, T1> accessFunction) {
		LBiObjLongTriple<T1, T2> tuple = accessBiObjLongTriple();
	...
	default <R> R useWith(LBiObjLongFunction.V1<T1, T2, R> accessFunction) {
		LBiObjLongTriple<T1, T2> tuple = accessBiObjLongTriple();
	...
	default <R> R useWith(LBiObjLongFunction.V2<T2, T1, R> accessFunction) {
		LBiObjLongTriple<T1, T2> tuple = accessBiObjLongTriple();
	...
	default <R> R useWith(LBiObjLongFunction.V3<T2, T1, R> accessFunction) {
		LBiObjLongTriple<T1, T2> tuple = accessBiObjLongTriple();
	...
	default <R> R useWith(LBiObjLongFunction.V4<T1, T2, R> accessFunction) {
		LBiObjLongTriple<T1, T2> tuple = accessBiObjLongTriple();
	...
	default <R> R useWith(LBiObjLongFunction.V5<T2, T1, R> accessFunction) {
		LBiObjLongTriple<T1, T2> tuple = accessBiObjLongTriple();
	...
	default boolean useWith(LBiObjLongPredicate.V1<T1, T2> accessFunction) {
		LBiObjLongTriple<T1, T2> tuple = accessBiObjLongTriple();
	...
	default boolean useWith(LBiObjLongPredicate.V2<T2, T1> accessFunction) {
		LBiObjLongTriple<T1, T2> tuple = accessBiObjLongTriple();
	...
	default boolean useWith(LBiObjLongPredicate.V3<T2, T1> accessFunction) {
		LBiObjLongTriple<T1, T2> tuple = accessBiObjLongTriple();
	...
	default boolean useWith(LBiObjLongPredicate.V4<T1, T2> accessFunction) {
		LBiObjLongTriple<T1, T2> tuple = accessBiObjLongTriple();
	...
	default boolean useWith(LBiObjLongPredicate.V5<T2, T1> accessFunction) {
		LBiObjLongTriple<T1, T2> tuple = accessBiObjLongTriple();
