...
public class LCharUnaryOpDeltaX<X extends Throwable> extends LCharUnaryOpMementoX<X> {
	...
	protected LCharUnaryOpDeltaX(LCharUnaryOperatorX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LCharUnaryOpDeltaX(char initialValue, LCharUnaryOperatorX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LCharUnaryOpDeltaX<X> deltaOf(LCharUnaryOperatorX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
		return new LCharUnaryOpDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LCharUnaryOpDeltaX<X> deltaOf(char initialValue, LCharUnaryOperatorX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
