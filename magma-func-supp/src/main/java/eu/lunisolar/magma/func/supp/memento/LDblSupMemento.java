...
public class LDblSupMemento implements LDblSupplier {

	protected double lastValue;

	protected LDblSupplier function;

	protected LDblSupMemento(LDblSupplier function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LDblSupMemento(double initialValue, LDblSupplier function) {
		this(function);
	...
	public static boolean argEquals(LDblSupMemento the, Object that) {
		return Null.<LDblSupMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LDblSupMemento other = (LDblSupMemento) two;
