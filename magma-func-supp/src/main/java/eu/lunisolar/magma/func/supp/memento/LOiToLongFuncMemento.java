...
public class LOiToLongFuncMemento<T> implements LOiToLongFunction<T> {

	protected long lastValue;

	protected LOiToLongFunction<T> function;

	protected LOiToLongFuncMemento(LOiToLongFunction<T> function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LOiToLongFuncMemento(long initialValue, LOiToLongFunction<T> function) {
		this(function);
	...
	public static boolean argEquals(LOiToLongFuncMemento the, Object that) {
		return Null.<LOiToLongFuncMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LOiToLongFuncMemento other = (LOiToLongFuncMemento) two;
