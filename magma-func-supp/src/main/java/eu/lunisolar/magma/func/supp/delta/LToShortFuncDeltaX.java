...
public class LToShortFuncDeltaX<T, X extends Throwable> extends LToShortFuncMementoX<T, X> {
	...
	protected LToShortFuncDeltaX(LToShortFunctionX<T, X> function, LShortBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LToShortFuncDeltaX(short initialValue, LToShortFunctionX<T, X> function, LShortBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <T, X extends Throwable> LToShortFuncDeltaX<T, X> deltaOf(LToShortFunctionX<T, X> function, LShortBinaryOperatorX<X> deltaFunction) {
		return new LToShortFuncDeltaX<T, X>(function, deltaFunction);
	}

	public static <T, X extends Throwable> LToShortFuncDeltaX<T, X> deltaOf(short initialValue, LToShortFunctionX<T, X> function, LShortBinaryOperatorX<X> deltaFunction) {
