...
public class LFloatToIntFuncDeltaX<X extends Throwable> extends LFloatToIntFuncMementoX<X> {

	protected final LIntBinaryOperatorX<X> deltaFunction;

	protected LFloatToIntFuncDeltaX(LFloatToIntFunctionX<X> function, LIntBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LFloatToIntFuncDeltaX(int initialValue, LFloatToIntFunctionX<X> function, LIntBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LFloatToIntFuncDeltaX<X> deltaOf(LFloatToIntFunctionX<X> function, LIntBinaryOperatorX<X> deltaFunction) {
		return new LFloatToIntFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LFloatToIntFuncDeltaX<X> deltaOf(int initialValue, LFloatToIntFunctionX<X> function, LIntBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LFloatToIntFuncDeltaX the, Object that) {
		return Null.<LFloatToIntFuncDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LFloatToIntFuncDeltaX other = (LFloatToIntFuncDeltaX) two;
