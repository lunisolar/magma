...
public class LSrtSupMemento implements LSrtSupplier {

	protected short lastValue;

	protected LSrtSupplier function;

	protected LSrtSupMemento(LSrtSupplier function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LSrtSupMemento(short initialValue, LSrtSupplier function) {
		this(function);
	...
	public static boolean argEquals(LSrtSupMemento the, Object that) {
		return Null.<LSrtSupMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LSrtSupMemento other = (LSrtSupMemento) two;
