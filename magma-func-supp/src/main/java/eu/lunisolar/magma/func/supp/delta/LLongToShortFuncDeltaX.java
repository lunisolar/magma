...
public class LLongToShortFuncDeltaX<X extends Throwable> extends LLongToShortFuncMementoX<X> {
	...
	protected LLongToShortFuncDeltaX(LLongToShortFunctionX<X> function, LShortBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LLongToShortFuncDeltaX(short initialValue, LLongToShortFunctionX<X> function, LShortBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LLongToShortFuncDeltaX<X> deltaOf(LLongToShortFunctionX<X> function, LShortBinaryOperatorX<X> deltaFunction) {
		return new LLongToShortFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LLongToShortFuncDeltaX<X> deltaOf(short initialValue, LLongToShortFunctionX<X> function, LShortBinaryOperatorX<X> deltaFunction) {
		return new LLongToShortFuncDeltaX<X>(initialValue, function, deltaFunction);
	}

	public static <X extends Throwable> LLongToShortFuncDeltaX<X> deltaOf(LLongToShortFunctionX<X> function) {
		return deltaOf(function, LLongToShortFuncDeltaX::mathDelta);
	}

	public static <X extends Throwable> LLongToShortFuncDeltaX<X> deltaOf(short initialValue, LLongToShortFunctionX<X> function) {
