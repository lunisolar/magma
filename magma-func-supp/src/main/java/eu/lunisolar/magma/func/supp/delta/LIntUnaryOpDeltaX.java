...
public class LIntUnaryOpDeltaX<X extends Throwable> extends LIntUnaryOpMementoX<X> {

	protected final LIntBinaryOperatorX<X> deltaFunction;

	protected LIntUnaryOpDeltaX(LIntUnaryOperatorX<X> function, LIntBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LIntUnaryOpDeltaX(int initialValue, LIntUnaryOperatorX<X> function, LIntBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LIntUnaryOpDeltaX<X> deltaOf(LIntUnaryOperatorX<X> function, LIntBinaryOperatorX<X> deltaFunction) {
		return new LIntUnaryOpDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LIntUnaryOpDeltaX<X> deltaOf(int initialValue, LIntUnaryOperatorX<X> function, LIntBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LIntUnaryOpDeltaX the, Object that) {
		return Null.<LIntUnaryOpDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LIntUnaryOpDeltaX other = (LIntUnaryOpDeltaX) two;
