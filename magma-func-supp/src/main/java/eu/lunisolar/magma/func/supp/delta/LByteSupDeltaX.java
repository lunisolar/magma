...
public class LByteSupDeltaX<X extends Throwable> extends LByteSupMementoX<X> {
	...
	protected LByteSupDeltaX(LByteSupplierX<X> function, LByteBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LByteSupDeltaX(byte initialValue, LByteSupplierX<X> function, LByteBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LByteSupDeltaX<X> deltaOf(LByteSupplierX<X> function, LByteBinaryOperatorX<X> deltaFunction) {
		return new LByteSupDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LByteSupDeltaX<X> deltaOf(byte initialValue, LByteSupplierX<X> function, LByteBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LByteSupDeltaX the, Object that) {
		return Null.<LByteSupDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LByteSupDeltaX other = (LByteSupDeltaX) two;
