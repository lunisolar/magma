...
public class LIntFuncMemento<R> implements LIntFunction<R> {

	protected R lastValue;

	protected LIntFunction<R> function;

	protected LIntFuncMemento(LIntFunction<R> function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LIntFuncMemento(R initialValue, LIntFunction<R> function) {
		this(function);
	...
	public static boolean argEquals(LIntFuncMemento the, Object that) {
		return Null.<LIntFuncMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LIntFuncMemento other = (LIntFuncMemento) two;
