...
public class LToLongBiFuncDeltaX<T1, T2, X extends Throwable> extends LToLongBiFuncMementoX<T1, T2, X> {
	...
	protected LToLongBiFuncDeltaX(LToLongBiFunctionX<T1, T2, X> function, LLongBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LToLongBiFuncDeltaX(long initialValue, LToLongBiFunctionX<T1, T2, X> function, LLongBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <T1, T2, X extends Throwable> LToLongBiFuncDeltaX<T1, T2, X> deltaOf(LToLongBiFunctionX<T1, T2, X> function, LLongBinaryOperatorX<X> deltaFunction) {
		return new LToLongBiFuncDeltaX<T1, T2, X>(function, deltaFunction);
	}

	public static <T1, T2, X extends Throwable> LToLongBiFuncDeltaX<T1, T2, X> deltaOf(long initialValue, LToLongBiFunctionX<T1, T2, X> function, LLongBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LToLongBiFuncDeltaX the, Object that) {
		return Null.<LToLongBiFuncDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LToLongBiFuncDeltaX other = (LToLongBiFuncDeltaX) two;
