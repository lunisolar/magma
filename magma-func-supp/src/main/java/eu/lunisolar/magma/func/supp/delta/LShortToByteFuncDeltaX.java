...
public class LShortToByteFuncDeltaX<X extends Throwable> extends LShortToByteFuncMementoX<X> {

	protected final LByteBinaryOperatorX<X> deltaFunction;

	protected LShortToByteFuncDeltaX(LShortToByteFunctionX<X> function, LByteBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LShortToByteFuncDeltaX(byte initialValue, LShortToByteFunctionX<X> function, LByteBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LShortToByteFuncDeltaX<X> deltaOf(LShortToByteFunctionX<X> function, LByteBinaryOperatorX<X> deltaFunction) {
		return new LShortToByteFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LShortToByteFuncDeltaX<X> deltaOf(byte initialValue, LShortToByteFunctionX<X> function, LByteBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LShortToByteFuncDeltaX the, Object that) {
		return Null.<LShortToByteFuncDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LShortToByteFuncDeltaX other = (LShortToByteFuncDeltaX) two;
