...
public class LToIntTriFuncMemento<T1, T2, T3> implements LToIntTriFunction<T1, T2, T3> {

	protected int lastValue;

	protected LToIntTriFunction<T1, T2, T3> function;

	protected LToIntTriFuncMemento(LToIntTriFunction<T1, T2, T3> function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LToIntTriFuncMemento(int initialValue, LToIntTriFunction<T1, T2, T3> function) {
		this(function);
	...
	public static boolean argEquals(LToIntTriFuncMemento the, Object that) {
		return Null.<LToIntTriFuncMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LToIntTriFuncMemento other = (LToIntTriFuncMemento) two;
