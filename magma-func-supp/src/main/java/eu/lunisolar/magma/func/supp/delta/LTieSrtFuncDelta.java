...
public class LTieSrtFuncDelta<T> extends LTieSrtFuncMemento<T> {

	protected final LIntBinaryOperator deltaFunction;

	protected LTieSrtFuncDelta(LTieSrtFunction<T> function, LIntBinaryOperator deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LTieSrtFuncDelta(int initialValue, LTieSrtFunction<T> function, LIntBinaryOperator deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <T> LTieSrtFuncDelta<T> deltaOf(LTieSrtFunction<T> function, LIntBinaryOperator deltaFunction) {
		return new LTieSrtFuncDelta<T>(function, deltaFunction);
	}

	public static <T> LTieSrtFuncDelta<T> deltaOf(int initialValue, LTieSrtFunction<T> function, LIntBinaryOperator deltaFunction) {
	...
	public static <T> LTieSrtFuncDelta<T> deltaOf(int initialValue, LTieSrtFunction<T> function) {
		return deltaOf(initialValue, function, LTieSrtFuncDelta::mathDelta);
	}
	...
	@Override
	public int applyAsInt(T a1, int a2, short a3) {
		return deltaFunction.applyAsInt(lastValue(), super.applyAsInt(a1, a2, a3));
	}

	// <editor-fold desc="object">

	public static boolean argEquals(LTieSrtFuncDelta the, Object that) {
		return Null.<LTieSrtFuncDelta> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LTieSrtFuncDelta other = (LTieSrtFuncDelta) two;
	...
	@Override
	public int delta(T a1, int a2, short a3) {
		return applyAsInt(a1, a2, a3);
	}

	@Override
	public int delta(T a1, int a2, short a3, LIntBinaryOperator deltaFunction) {
