...
public class LToLongFuncDeltaX<T, X extends Throwable> extends LToLongFuncMementoX<T, X> {

	protected final LLongBinaryOperatorX<X> deltaFunction;

	protected LToLongFuncDeltaX(LToLongFunctionX<T, X> function, LLongBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LToLongFuncDeltaX(long initialValue, LToLongFunctionX<T, X> function, LLongBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <T, X extends Throwable> LToLongFuncDeltaX<T, X> deltaOf(LToLongFunctionX<T, X> function, LLongBinaryOperatorX<X> deltaFunction) {
		return new LToLongFuncDeltaX<T, X>(function, deltaFunction);
	}

	public static <T, X extends Throwable> LToLongFuncDeltaX<T, X> deltaOf(long initialValue, LToLongFunctionX<T, X> function, LLongBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LToLongFuncDeltaX the, Object that) {
		return Null.<LToLongFuncDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LToLongFuncDeltaX other = (LToLongFuncDeltaX) two;
