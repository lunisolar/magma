...
public interface AccessObjIntObjTriple<T1, T2> {

	static <T1, T2> AccessObjIntObjTriple<T1, T2> wrap(AccessObjIntObjTriple<T1, T2> lambda) {
		return lambda;
	}
	 ...
	 */
	LObjIntObjTriple<T1, T2> accessObjIntObjTriple();

	/**
	 * After each access this method is called in order to potentially release the resources behind value (void).
	 */
	default void releaseObjIntObjTriple(LObjIntObjTriple<T1, T2> a) {
		// NOOP
	}

	default void useWith(LBiObjIntConsumer<T1, T2> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
	...
	default void useWith(LBiObjIntConsumer.LObjIntObj1Cons<T1, T2> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		accessFunction.doAcceptObjIntObj1(tuple.first(), tuple.second(), tuple.third());
	}

	default void useWith(LBiObjIntConsumer.LObj1Obj0IntCons<T2, T1> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		accessFunction.doAcceptObj1Obj0Int(tuple.third(), tuple.first(), tuple.second());
	}

	default void useWith(LBiObjIntConsumer.LObj1IntObj0Cons<T2, T1> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		accessFunction.doAcceptObj1IntObj0(tuple.third(), tuple.second(), tuple.first());
	}

	default void useWith(LBiObjIntConsumer.LIntObj0Obj1Cons<T1, T2> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		accessFunction.doAcceptIntObj0Obj1(tuple.second(), tuple.first(), tuple.third());
	}

	default void useWith(LBiObjIntConsumer.LIntObjObj0Cons<T2, T1> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		accessFunction.doAcceptIntObjObj0(tuple.second(), tuple.third(), tuple.first());
	}
	...
	default void useWith(LTieConsumer.LObjObj2IntCons<T1, T2> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		accessFunction.doAcceptObjObj2Int(tuple.first(), tuple.third(), tuple.second());
	}

	default void useWith(LTieConsumer.LIntBiObjCons<T1, T2> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		accessFunction.doAcceptIntBiObj(tuple.second(), tuple.first(), tuple.third());
	}

	default void useWith(LTieConsumer.LIntObj2Obj0Cons<T2, T1> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		accessFunction.doAcceptIntObj2Obj0(tuple.second(), tuple.third(), tuple.first());
	}

	default void useWith(LTieConsumer.LObj2Obj0IntCons<T2, T1> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		accessFunction.doAcceptObj2Obj0Int(tuple.third(), tuple.first(), tuple.second());
	}

	default void useWith(LTieConsumer.LObj2IntObj0Cons<T2, T1> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		accessFunction.doAcceptObj2IntObj0(tuple.third(), tuple.second(), tuple.first());
	}
	...
	default <R> R useWith(LBiObjIntFunction<T1, T2, R> accessFunction) {
		...
		releaseObjIntObjTriple(tuple);
		return retval;
	}

	default <R> R useWith(LBiObjIntFunction.LObjIntObj1Func<T1, T2, R> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		R retval = accessFunction.doApplyObjIntObj1(tuple.first(), tuple.second(), tuple.third());
		releaseObjIntObjTriple(tuple);
		return retval;
	}
	...
	default <R> R useWith(LBiObjIntFunction.LObj1Obj0IntFunc<T2, T1, R> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		R retval = accessFunction.doApplyObj1Obj0Int(tuple.third(), tuple.first(), tuple.second());
		releaseObjIntObjTriple(tuple);
		return retval;
	}
	...
	default <R> R useWith(LBiObjIntFunction.LObj1IntObj0Func<T2, T1, R> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		R retval = accessFunction.doApplyObj1IntObj0(tuple.third(), tuple.second(), tuple.first());
		releaseObjIntObjTriple(tuple);
		return retval;
	}
	...
	default <R> R useWith(LBiObjIntFunction.LIntObj0Obj1Func<T1, T2, R> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		R retval = accessFunction.doApplyIntObj0Obj1(tuple.second(), tuple.first(), tuple.third());
		releaseObjIntObjTriple(tuple);
		return retval;
	}
	...
	default <R> R useWith(LBiObjIntFunction.LIntObjObj0Func<T2, T1, R> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		R retval = accessFunction.doApplyIntObjObj0(tuple.second(), tuple.third(), tuple.first());
		releaseObjIntObjTriple(tuple);
		return retval;
	}
	...
	default <R> R useWith(LObjIntObjFunction.LObjObj2IntFunc<T1, T2, R> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		R retval = accessFunction.doApplyObjObj2Int(tuple.first(), tuple.third(), tuple.second());
		releaseObjIntObjTriple(tuple);
		return retval;
	}
	...
	default <R> R useWith(LObjIntObjFunction.LIntBiObjFunc<T1, T2, R> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		R retval = accessFunction.doApplyIntBiObj(tuple.second(), tuple.first(), tuple.third());
		releaseObjIntObjTriple(tuple);
		return retval;
	}
	...
	default <R> R useWith(LObjIntObjFunction.LIntObj2Obj0Func<T2, T1, R> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		R retval = accessFunction.doApplyIntObj2Obj0(tuple.second(), tuple.third(), tuple.first());
		releaseObjIntObjTriple(tuple);
		return retval;
	}
	...
	default <R> R useWith(LObjIntObjFunction.LObj2Obj0IntFunc<T2, T1, R> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		R retval = accessFunction.doApplyObj2Obj0Int(tuple.third(), tuple.first(), tuple.second());
		releaseObjIntObjTriple(tuple);
		return retval;
	}
	...
	default <R> R useWith(LObjIntObjFunction.LObj2IntObj0Func<T2, T1, R> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		R retval = accessFunction.doApplyObj2IntObj0(tuple.third(), tuple.second(), tuple.first());
		releaseObjIntObjTriple(tuple);
		return retval;
	}
	...
	default int useWith(LTieFunction.LObjObj2IntToIntFunc<T1, T2> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		int retval = accessFunction.doApplyAsIntObjObj2Int(tuple.first(), tuple.third(), tuple.second());
		releaseObjIntObjTriple(tuple);
		return retval;
	}
	...
	default int useWith(LTieFunction.LIntBiObjToIntFunc<T1, T2> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		int retval = accessFunction.doApplyAsIntIntBiObj(tuple.second(), tuple.first(), tuple.third());
		releaseObjIntObjTriple(tuple);
		return retval;
	}
	...
	default int useWith(LTieFunction.LIntObj2Obj0ToIntFunc<T2, T1> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		int retval = accessFunction.doApplyAsIntIntObj2Obj0(tuple.second(), tuple.third(), tuple.first());
		releaseObjIntObjTriple(tuple);
		return retval;
	}
	...
	default int useWith(LTieFunction.LObj2Obj0IntToIntFunc<T2, T1> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		int retval = accessFunction.doApplyAsIntObj2Obj0Int(tuple.third(), tuple.first(), tuple.second());
		releaseObjIntObjTriple(tuple);
		return retval;
	}
	...
	default int useWith(LTieFunction.LObj2IntObj0ToIntFunc<T2, T1> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		int retval = accessFunction.doApplyAsIntObj2IntObj0(tuple.third(), tuple.second(), tuple.first());
		releaseObjIntObjTriple(tuple);
		return retval;
	}
	...
	default boolean useWith(LBiObjIntPredicate.LObjIntObj1Pred<T1, T2> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		boolean retval = accessFunction.doTestObjIntObj1(tuple.first(), tuple.second(), tuple.third());
		releaseObjIntObjTriple(tuple);
		return retval;
	}
	...
	default boolean useWith(LBiObjIntPredicate.LObj1Obj0IntPred<T2, T1> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		boolean retval = accessFunction.doTestObj1Obj0Int(tuple.third(), tuple.first(), tuple.second());
		releaseObjIntObjTriple(tuple);
		return retval;
	}
	...
	default boolean useWith(LBiObjIntPredicate.LObj1IntObj0Pred<T2, T1> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		boolean retval = accessFunction.doTestObj1IntObj0(tuple.third(), tuple.second(), tuple.first());
		releaseObjIntObjTriple(tuple);
		return retval;
	}
	...
	default boolean useWith(LBiObjIntPredicate.LIntObj0Obj1Pred<T1, T2> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		boolean retval = accessFunction.doTestIntObj0Obj1(tuple.second(), tuple.first(), tuple.third());
		releaseObjIntObjTriple(tuple);
		return retval;
	}
	...
	default boolean useWith(LBiObjIntPredicate.LIntObjObj0Pred<T2, T1> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		boolean retval = accessFunction.doTestIntObjObj0(tuple.second(), tuple.third(), tuple.first());
		releaseObjIntObjTriple(tuple);
		return retval;
	}
	...
	default boolean useWith(LObjIntObjPredicate.LObjObj2IntPred<T1, T2> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		boolean retval = accessFunction.doTestObjObj2Int(tuple.first(), tuple.third(), tuple.second());
		releaseObjIntObjTriple(tuple);
		return retval;
	}
	...
	default boolean useWith(LObjIntObjPredicate.LIntBiObjPred<T1, T2> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		boolean retval = accessFunction.doTestIntBiObj(tuple.second(), tuple.first(), tuple.third());
		releaseObjIntObjTriple(tuple);
		return retval;
	}
	...
	default boolean useWith(LObjIntObjPredicate.LIntObj2Obj0Pred<T2, T1> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		boolean retval = accessFunction.doTestIntObj2Obj0(tuple.second(), tuple.third(), tuple.first());
		releaseObjIntObjTriple(tuple);
		return retval;
	}
	...
	default boolean useWith(LObjIntObjPredicate.LObj2Obj0IntPred<T2, T1> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		boolean retval = accessFunction.doTestObj2Obj0Int(tuple.third(), tuple.first(), tuple.second());
		releaseObjIntObjTriple(tuple);
		return retval;
	}
	...
	default boolean useWith(LObjIntObjPredicate.LObj2IntObj0Pred<T2, T1> accessFunction) {
		LObjIntObjTriple<T1, T2> tuple = accessObjIntObjTriple();
		boolean retval = accessFunction.doTestObj2IntObj0(tuple.third(), tuple.second(), tuple.first());
		releaseObjIntObjTriple(tuple);
		return retval;
	}
