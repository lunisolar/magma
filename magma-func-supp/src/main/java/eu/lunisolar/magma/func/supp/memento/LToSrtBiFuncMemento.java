...
public class LToSrtBiFuncMemento<T1, T2> implements LToSrtBiFunction<T1, T2> {

	protected short lastValue;

	protected LToSrtBiFunction<T1, T2> function;

	protected LToSrtBiFuncMemento(LToSrtBiFunction<T1, T2> function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LToSrtBiFuncMemento(short initialValue, LToSrtBiFunction<T1, T2> function) {
		this(function);
	...
	public static boolean argEquals(LToSrtBiFuncMemento the, Object that) {
		return Null.<LToSrtBiFuncMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LToSrtBiFuncMemento other = (LToSrtBiFuncMemento) two;
