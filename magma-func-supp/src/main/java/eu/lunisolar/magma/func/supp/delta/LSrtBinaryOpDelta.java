...
public class LSrtBinaryOpDelta extends LSrtBinaryOpMemento {

	protected final LSrtBinaryOperator deltaFunction;

	protected LSrtBinaryOpDelta(LSrtBinaryOperator function, LSrtBinaryOperator deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LSrtBinaryOpDelta(short initialValue, LSrtBinaryOperator function, LSrtBinaryOperator deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static LSrtBinaryOpDelta deltaOf(LSrtBinaryOperator function, LSrtBinaryOperator deltaFunction) {
		return new LSrtBinaryOpDelta(function, deltaFunction);
	}

	public static LSrtBinaryOpDelta deltaOf(short initialValue, LSrtBinaryOperator function, LSrtBinaryOperator deltaFunction) {
	...
	public static LSrtBinaryOpDelta deltaOf(short initialValue, LSrtBinaryOperator function) {
		return deltaOf(initialValue, function, LSrtBinaryOpDelta::mathDelta);
	}
	...
	public static boolean argEquals(LSrtBinaryOpDelta the, Object that) {
		return Null.<LSrtBinaryOpDelta> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LSrtBinaryOpDelta other = (LSrtBinaryOpDelta) two;
