...
public class LObjDoubleFuncMementoX<T, R, X extends Throwable> implements LObjDoubleFunctionX<T, R, X> {

	protected R lastValue;

	protected LObjDoubleFunctionX<T, R, X> function;
	...
	public static boolean argEquals(LObjDoubleFuncMementoX the, Object that) {
		return Null.<LObjDoubleFuncMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LObjDoubleFuncMementoX other = (LObjDoubleFuncMementoX) two;
