...
public class LazyBoolValue extends LBoolSupMemento implements LBoolSingle {

	protected LazyBoolValue(LBoolSupplier function) {
		super(function);
	}

	public static LazyBoolValue lazyValue(LBoolSupplier supplier) {
		return new LazyBoolValue(supplier);
	}
	...
	public static boolean argEquals(LazyBoolValue the, Object that) {
