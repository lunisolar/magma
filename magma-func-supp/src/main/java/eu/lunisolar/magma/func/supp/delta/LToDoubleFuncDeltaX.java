...
public class LToDoubleFuncDeltaX<T, X extends Throwable> extends LToDoubleFuncMementoX<T, X> {

	protected final LDoubleBinaryOperatorX<X> deltaFunction;

	protected LToDoubleFuncDeltaX(LToDoubleFunctionX<T, X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LToDoubleFuncDeltaX(double initialValue, LToDoubleFunctionX<T, X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <T, X extends Throwable> LToDoubleFuncDeltaX<T, X> deltaOf(LToDoubleFunctionX<T, X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		return new LToDoubleFuncDeltaX<T, X>(function, deltaFunction);
	}

	public static <T, X extends Throwable> LToDoubleFuncDeltaX<T, X> deltaOf(double initialValue, LToDoubleFunctionX<T, X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LToDoubleFuncDeltaX the, Object that) {
		return Null.<LToDoubleFuncDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LToDoubleFuncDeltaX other = (LToDoubleFuncDeltaX) two;
