...
public interface DoIfDblTrait<SELF extends DoIfDblTrait<SELF>> extends FluentTrait<SELF>, IsDblTrait<SELF> {
	...
	default <V> SELF doIf2Variant(V v, @Nonnull LObjDblPredicate.LDblObjPred<? super V> predicate, LConsumer<SELF> action) {
	...
	/** Variant with reverse predicate arguments order. */
	default <V> SELF doIf2Variant(@Nonnull LObjDblPredicate.LDblObjPred<? super V> predicate, V v, LConsumer<SELF> action) {
		return doIf2Variant(v, predicate, action);
	}

	default <V> SELF doIfNot2Variant(V v, @Nonnull LObjDblPredicate.LDblObjPred<? super V> predicate, LConsumer<SELF> action) {
	...
	/** Variant with reverse predicate arguments order. */
	default <V> SELF doIfNot2Variant(@Nonnull LObjDblPredicate.LDblObjPred<? super V> predicate, V v, LConsumer<SELF> action) {
