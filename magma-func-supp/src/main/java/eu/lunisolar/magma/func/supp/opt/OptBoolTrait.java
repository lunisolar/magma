...
public interface OptBoolTrait<SELF extends OptBoolTrait<SELF>> extends FluentTrait<SELF>, aValue<aBool>, CheckBoolTrait<SELF>, FilterBoolSingleTrait<SELF>, IsBoolTrait<SELF>, DoIfBoolSingleTrait<SELF>, UseBoolSingleTrait<SELF>, UniMapBoolTrait<SELF> {
	...
	default @Nonnull <K, R> Opt<R> mapToObjWith(K a1, @Nonnull LObjBoolFunction<? super K, ? extends R> mapping) {
		Null.nonNullArg(mapping, "mapping");
		return isPresent() ? (Opt.of(mapping.apply(a1, get()))) : Opt.empty();
	}

	default @Nonnull <K1, K2, R> Opt<R> mapToObjWith(K1 a1, K2 a2, @Nonnull LBiObjBoolFunction<? super K1, ? super K2, ? extends R> mapping) {
		Null.nonNullArg(mapping, "mapping");
	...
	default @Nonnull <K, R> Opt<R> flatMapToObjWith(K a1, @Nonnull LObjBoolFunction<? super K, ? extends ValueTrait<? extends R, ?>> mapping) {
		Null.nonNullArg(mapping, "mapping");
		return isPresent() ? Opt.from(mapping.apply(a1, get())) : Opt.empty();
	}

	default @Nonnull <K1, K2, R> Opt<R> flatMapToObjWith(K1 a1, K2 a2, @Nonnull LBiObjBoolFunction<? super K1, ? super K2, ? extends ValueTrait<? extends R, ?>> mapping) {
		Null.nonNullArg(mapping, "mapping");
	...
	default <K1> SELF ifPresentOrWith(K1 a1, @Nonnull LObjBoolConsumer<? super K1> action, @Nonnull LConsumer<K1> emptyAction) {
		Null.nonNullArg(action, "action");
		if (isPresent()) {
			action.accept(a1, get());
		} else {
	...
	default <K1, K2> SELF ifPresentOrWith(K1 a1, K2 a2, @Nonnull LBiObjBoolConsumer<? super K1, ? super K2> action, @Nonnull LBiConsumer<K1, K2> emptyAction) {
		Null.nonNullArg(action, "action");
		if (isPresent()) {
			action.accept(a1, a2, get());
		} else {
