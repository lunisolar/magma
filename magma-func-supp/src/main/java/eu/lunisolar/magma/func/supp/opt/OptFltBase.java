...
public abstract class OptFltBase<SELF extends OptFltBase<SELF>> implements OptFltTrait<SELF> {

	protected final float value;
	protected final boolean isPresent;

	protected OptFltBase() {
		this.value = 0f;
		this.isPresent = false;
	}

	protected OptFltBase(float value) {
		this.value = value;
		this.isPresent = true;
	}
	...
	public boolean equals(Object obj) {
		...
		OptFltBase other = (OptFltBase) obj;
