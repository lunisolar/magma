...
public class LByteUnaryOpMemento implements LByteUnaryOperator {

	protected byte lastValue;

	protected LByteUnaryOperator function;

	protected LByteUnaryOpMemento(LByteUnaryOperator function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LByteUnaryOpMemento(byte initialValue, LByteUnaryOperator function) {
		this(function);
	...
	public static boolean argEquals(LByteUnaryOpMemento the, Object that) {
		return Null.<LByteUnaryOpMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LByteUnaryOpMemento other = (LByteUnaryOpMemento) two;
