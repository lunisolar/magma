...
public class LLongUnaryOpDeltaX<X extends Throwable> extends LLongUnaryOpMementoX<X> {

	protected final LLongBinaryOperatorX<X> deltaFunction;

	protected LLongUnaryOpDeltaX(LLongUnaryOperatorX<X> function, LLongBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LLongUnaryOpDeltaX(long initialValue, LLongUnaryOperatorX<X> function, LLongBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LLongUnaryOpDeltaX<X> deltaOf(LLongUnaryOperatorX<X> function, LLongBinaryOperatorX<X> deltaFunction) {
		return new LLongUnaryOpDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LLongUnaryOpDeltaX<X> deltaOf(long initialValue, LLongUnaryOperatorX<X> function, LLongBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LLongUnaryOpDeltaX the, Object that) {
		return Null.<LLongUnaryOpDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LLongUnaryOpDeltaX other = (LLongUnaryOpDeltaX) two;
