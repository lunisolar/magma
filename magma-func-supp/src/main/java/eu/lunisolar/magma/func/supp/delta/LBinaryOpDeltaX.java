...
public class LBinaryOpDeltaX<T, X extends Throwable> extends LBinaryOpMementoX<T, X> {
	...
	protected LBinaryOpDeltaX(LBinaryOperatorX<T, X> function, LBinaryOperatorX<T, X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LBinaryOpDeltaX(T initialValue, LBinaryOperatorX<T, X> function, LBinaryOperatorX<T, X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <T, X extends Throwable> LBinaryOpDeltaX<T, X> deltaOf(LBinaryOperatorX<T, X> function, LBinaryOperatorX<T, X> deltaFunction) {
		return new LBinaryOpDeltaX<T, X>(function, deltaFunction);
	}

	public static <T, X extends Throwable> LBinaryOpDeltaX<T, X> deltaOf(T initialValue, LBinaryOperatorX<T, X> function, LBinaryOperatorX<T, X> deltaFunction) {
