...
public interface FilterLongTrait<SELF extends FilterLongTrait<SELF>> extends FluentTrait<SELF> {
	...
	default @Nonnull SELF filter(@Nonnull LBiLongPredicate predicate, long a2) {
	...
	/** Variant 'obj.filter(Is::equal, ...)' or 'opt.filter(Does::contain, ...)', etc.  */
	default @Nonnull SELF filter(@Nonnull LTriLongPredicate predicate, long a2, long a3) {
	...
	/** Variant 'obj.filter(Is::equal, ...)' or 'opt.filter(Does::contain, ...)', etc.  */
	default @Nonnull SELF filterInt(@Nonnull LLongIntPredicate predicate, int v) {
	...
	/** Variant 'obj.filter(Is::equal, ...)' or 'opt.filter(Does::contain, ...)', etc.  */
	default @Nonnull <V> SELF filter_(@Nonnull LObjLongPredicate.LLongObjPred<? super V> predicate, V v) {
	...
	/** Variant 'obj.filter(Is::equal, ...)' or 'opt.filter(Does::contain, ...)', etc.  */
	default @Nonnull <V1> SELF filterWithLong(@Nonnull LObjLongPredicate<? super V1> predicate, V1 with1) {
		return filterWithLong(with1, predicate);
	}
	...
	/** Variant 'obj.filter(Is::equal, ...)' or 'opt.filter(Does::contain, ...)', etc.  */
	default @Nonnull <V1, V2> SELF filterWith(@Nonnull LBiObjLongPredicate<? super V1, ? super V2> predicate, V1 with1, V2 with2) {
