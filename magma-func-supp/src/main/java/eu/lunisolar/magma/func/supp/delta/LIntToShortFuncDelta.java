...
public class LIntToShortFuncDelta extends LIntToShortFuncMemento {
	...
	public static boolean argEquals(LIntToShortFuncDelta the, Object that) {
		return Null.<LIntToShortFuncDelta> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LIntToShortFuncDelta other = (LIntToShortFuncDelta) two;
