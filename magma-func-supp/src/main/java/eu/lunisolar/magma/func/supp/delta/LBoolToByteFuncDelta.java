...
public class LBoolToByteFuncDelta extends LBoolToByteFuncMemento {

	protected final LByteBinaryOperator deltaFunction;

	protected LBoolToByteFuncDelta(LBoolToByteFunction function, LByteBinaryOperator deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LBoolToByteFuncDelta(byte initialValue, LBoolToByteFunction function, LByteBinaryOperator deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static LBoolToByteFuncDelta deltaOf(LBoolToByteFunction function, LByteBinaryOperator deltaFunction) {
		return new LBoolToByteFuncDelta(function, deltaFunction);
	}

	public static LBoolToByteFuncDelta deltaOf(byte initialValue, LBoolToByteFunction function, LByteBinaryOperator deltaFunction) {
	...
	public static LBoolToByteFuncDelta deltaOf(byte initialValue, LBoolToByteFunction function) {
		return deltaOf(initialValue, function, LBoolToByteFuncDelta::mathDelta);
	}
	...
	public static boolean argEquals(LBoolToByteFuncDelta the, Object that) {
		return Null.<LBoolToByteFuncDelta> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LBoolToByteFuncDelta other = (LBoolToByteFuncDelta) two;
