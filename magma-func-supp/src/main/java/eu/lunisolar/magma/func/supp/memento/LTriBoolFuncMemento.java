...
public class LTriBoolFuncMemento<R> implements LTriBoolFunction<R> {

	protected R lastValue;

	protected LTriBoolFunction<R> function;

	protected LTriBoolFuncMemento(LTriBoolFunction<R> function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LTriBoolFuncMemento(R initialValue, LTriBoolFunction<R> function) {
		this(function);
	...
	public static boolean argEquals(LTriBoolFuncMemento the, Object that) {
		return Null.<LTriBoolFuncMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LTriBoolFuncMemento other = (LTriBoolFuncMemento) two;
