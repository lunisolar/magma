...
public class LLongToFloatFuncDeltaX<X extends Throwable> extends LLongToFloatFuncMementoX<X> {

	protected final LFloatBinaryOperatorX<X> deltaFunction;

	protected LLongToFloatFuncDeltaX(LLongToFloatFunctionX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LLongToFloatFuncDeltaX(float initialValue, LLongToFloatFunctionX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LLongToFloatFuncDeltaX<X> deltaOf(LLongToFloatFunctionX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
		return new LLongToFloatFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LLongToFloatFuncDeltaX<X> deltaOf(float initialValue, LLongToFloatFunctionX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LLongToFloatFuncDeltaX the, Object that) {
		return Null.<LLongToFloatFuncDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LLongToFloatFuncDeltaX other = (LLongToFloatFuncDeltaX) two;
