...
public class LFloatToLongFuncDeltaX<X extends Throwable> extends LFloatToLongFuncMementoX<X> {
	...
	protected LFloatToLongFuncDeltaX(LFloatToLongFunctionX<X> function, LLongBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LFloatToLongFuncDeltaX(long initialValue, LFloatToLongFunctionX<X> function, LLongBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LFloatToLongFuncDeltaX<X> deltaOf(LFloatToLongFunctionX<X> function, LLongBinaryOperatorX<X> deltaFunction) {
		return new LFloatToLongFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LFloatToLongFuncDeltaX<X> deltaOf(long initialValue, LFloatToLongFunctionX<X> function, LLongBinaryOperatorX<X> deltaFunction) {
