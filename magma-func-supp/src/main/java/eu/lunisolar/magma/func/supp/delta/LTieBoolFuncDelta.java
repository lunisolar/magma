...
public class LTieBoolFuncDelta<T> extends LTieBoolFuncMemento<T> {

	protected final LIntBinaryOperator deltaFunction;

	protected LTieBoolFuncDelta(LTieBoolFunction<T> function, LIntBinaryOperator deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LTieBoolFuncDelta(int initialValue, LTieBoolFunction<T> function, LIntBinaryOperator deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <T> LTieBoolFuncDelta<T> deltaOf(LTieBoolFunction<T> function, LIntBinaryOperator deltaFunction) {
		return new LTieBoolFuncDelta<T>(function, deltaFunction);
	}

	public static <T> LTieBoolFuncDelta<T> deltaOf(int initialValue, LTieBoolFunction<T> function, LIntBinaryOperator deltaFunction) {
	...
	public static <T> LTieBoolFuncDelta<T> deltaOf(int initialValue, LTieBoolFunction<T> function) {
		return deltaOf(initialValue, function, LTieBoolFuncDelta::mathDelta);
	}
	...
	public static boolean argEquals(LTieBoolFuncDelta the, Object that) {
		return Null.<LTieBoolFuncDelta> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LTieBoolFuncDelta other = (LTieBoolFuncDelta) two;
	...
	@Override
	public int delta(T a1, int a2, boolean a3) {
		return applyAsInt(a1, a2, a3);
	}

	@Override
	public int delta(T a1, int a2, boolean a3, LIntBinaryOperator deltaFunction) {
