...
public class LFltToLongFuncMemento implements LFltToLongFunction {

	protected long lastValue;

	protected LFltToLongFunction function;

	protected LFltToLongFuncMemento(LFltToLongFunction function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LFltToLongFuncMemento(long initialValue, LFltToLongFunction function) {
		this(function);
	...
	public static boolean argEquals(LFltToLongFuncMemento the, Object that) {
		return Null.<LFltToLongFuncMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LFltToLongFuncMemento other = (LFltToLongFuncMemento) two;
