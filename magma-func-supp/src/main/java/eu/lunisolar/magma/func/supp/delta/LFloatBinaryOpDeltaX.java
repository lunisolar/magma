...
public class LFloatBinaryOpDeltaX<X extends Throwable> extends LFloatBinaryOpMementoX<X> {

	protected final LFloatBinaryOperatorX<X> deltaFunction;

	protected LFloatBinaryOpDeltaX(LFloatBinaryOperatorX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LFloatBinaryOpDeltaX(float initialValue, LFloatBinaryOperatorX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LFloatBinaryOpDeltaX<X> deltaOf(LFloatBinaryOperatorX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
		return new LFloatBinaryOpDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LFloatBinaryOpDeltaX<X> deltaOf(float initialValue, LFloatBinaryOperatorX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LFloatBinaryOpDeltaX the, Object that) {
		return Null.<LFloatBinaryOpDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LFloatBinaryOpDeltaX other = (LFloatBinaryOpDeltaX) two;
