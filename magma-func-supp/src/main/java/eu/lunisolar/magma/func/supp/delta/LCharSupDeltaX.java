...
public class LCharSupDeltaX<X extends Throwable> extends LCharSupMementoX<X> {

	protected final LCharBinaryOperatorX<X> deltaFunction;

	protected LCharSupDeltaX(LCharSupplierX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LCharSupDeltaX(char initialValue, LCharSupplierX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LCharSupDeltaX<X> deltaOf(LCharSupplierX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
		return new LCharSupDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LCharSupDeltaX<X> deltaOf(char initialValue, LCharSupplierX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LCharSupDeltaX the, Object that) {
		return Null.<LCharSupDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LCharSupDeltaX other = (LCharSupDeltaX) two;
