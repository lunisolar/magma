...
public class LFloatToDoubleFuncDeltaX<X extends Throwable> extends LFloatToDoubleFuncMementoX<X> {
	...
	protected LFloatToDoubleFuncDeltaX(LFloatToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LFloatToDoubleFuncDeltaX(double initialValue, LFloatToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LFloatToDoubleFuncDeltaX<X> deltaOf(LFloatToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		return new LFloatToDoubleFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LFloatToDoubleFuncDeltaX<X> deltaOf(double initialValue, LFloatToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
