...
public class LShortToLongFuncDeltaX<X extends Throwable> extends LShortToLongFuncMementoX<X> {
	...
	protected LShortToLongFuncDeltaX(LShortToLongFunctionX<X> function, LLongBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LShortToLongFuncDeltaX(long initialValue, LShortToLongFunctionX<X> function, LLongBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LShortToLongFuncDeltaX<X> deltaOf(LShortToLongFunctionX<X> function, LLongBinaryOperatorX<X> deltaFunction) {
		return new LShortToLongFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LShortToLongFuncDeltaX<X> deltaOf(long initialValue, LShortToLongFunctionX<X> function, LLongBinaryOperatorX<X> deltaFunction) {
