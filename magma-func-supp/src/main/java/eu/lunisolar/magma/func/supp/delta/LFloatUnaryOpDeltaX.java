...
public class LFloatUnaryOpDeltaX<X extends Throwable> extends LFloatUnaryOpMementoX<X> {
	...
	protected LFloatUnaryOpDeltaX(LFloatUnaryOperatorX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LFloatUnaryOpDeltaX(float initialValue, LFloatUnaryOperatorX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LFloatUnaryOpDeltaX<X> deltaOf(LFloatUnaryOperatorX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
		return new LFloatUnaryOpDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LFloatUnaryOpDeltaX<X> deltaOf(float initialValue, LFloatUnaryOperatorX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
