...
public class LIntToFloatFuncDelta extends LIntToFloatFuncMemento {
	...
	public static boolean argEquals(LIntToFloatFuncDelta the, Object that) {
		return Null.<LIntToFloatFuncDelta> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LIntToFloatFuncDelta other = (LIntToFloatFuncDelta) two;
