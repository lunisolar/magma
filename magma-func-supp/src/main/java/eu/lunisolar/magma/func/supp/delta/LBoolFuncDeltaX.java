...
public class LBoolFuncDeltaX<R, X extends Throwable> extends LBoolFuncMementoX<R, X> {
	...
	protected LBoolFuncDeltaX(LBoolFunctionX<R, X> function, LBinaryOperatorX<R, X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LBoolFuncDeltaX(R initialValue, LBoolFunctionX<R, X> function, LBinaryOperatorX<R, X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <R, X extends Throwable> LBoolFuncDeltaX<R, X> deltaOf(LBoolFunctionX<R, X> function, LBinaryOperatorX<R, X> deltaFunction) {
		return new LBoolFuncDeltaX<R, X>(function, deltaFunction);
	}

	public static <R, X extends Throwable> LBoolFuncDeltaX<R, X> deltaOf(R initialValue, LBoolFunctionX<R, X> function, LBinaryOperatorX<R, X> deltaFunction) {
