...
public class LByteToDoubleFuncDeltaX<X extends Throwable> extends LByteToDoubleFuncMementoX<X> {

	protected final LDoubleBinaryOperatorX<X> deltaFunction;

	protected LByteToDoubleFuncDeltaX(LByteToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LByteToDoubleFuncDeltaX(double initialValue, LByteToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LByteToDoubleFuncDeltaX<X> deltaOf(LByteToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		return new LByteToDoubleFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LByteToDoubleFuncDeltaX<X> deltaOf(double initialValue, LByteToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LByteToDoubleFuncDeltaX the, Object that) {
		return Null.<LByteToDoubleFuncDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LByteToDoubleFuncDeltaX other = (LByteToDoubleFuncDeltaX) two;
