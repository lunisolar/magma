...
public class LShortToFloatFuncMementoX<X extends Throwable> implements LShortToFloatFunctionX<X> {

	protected float lastValue;

	protected LShortToFloatFunctionX<X> function;
	...
	public static boolean argEquals(LShortToFloatFuncMementoX the, Object that) {
		return Null.<LShortToFloatFuncMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LShortToFloatFuncMementoX other = (LShortToFloatFuncMementoX) two;
