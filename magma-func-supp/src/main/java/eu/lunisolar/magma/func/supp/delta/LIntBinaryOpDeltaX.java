...
public class LIntBinaryOpDeltaX<X extends Throwable> extends LIntBinaryOpMementoX<X> {

	protected final LIntBinaryOperatorX<X> deltaFunction;

	protected LIntBinaryOpDeltaX(LIntBinaryOperatorX<X> function, LIntBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LIntBinaryOpDeltaX(int initialValue, LIntBinaryOperatorX<X> function, LIntBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LIntBinaryOpDeltaX<X> deltaOf(LIntBinaryOperatorX<X> function, LIntBinaryOperatorX<X> deltaFunction) {
		return new LIntBinaryOpDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LIntBinaryOpDeltaX<X> deltaOf(int initialValue, LIntBinaryOperatorX<X> function, LIntBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LIntBinaryOpDeltaX the, Object that) {
		return Null.<LIntBinaryOpDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LIntBinaryOpDeltaX other = (LIntBinaryOpDeltaX) two;
