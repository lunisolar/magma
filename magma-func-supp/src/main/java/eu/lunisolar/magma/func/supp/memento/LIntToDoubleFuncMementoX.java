...
public class LIntToDoubleFuncMementoX<X extends Throwable> implements LIntToDoubleFunctionX<X> {

	protected double lastValue;

	protected LIntToDoubleFunctionX<X> function;
	...
	public static boolean argEquals(LIntToDoubleFuncMementoX the, Object that) {
		return Null.<LIntToDoubleFuncMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LIntToDoubleFuncMementoX other = (LIntToDoubleFuncMementoX) two;
