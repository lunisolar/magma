...
public class LTriBoolFuncDelta<R> extends LTriBoolFuncMemento<R> {
	...
	public static <R> LTriBoolFuncDelta<R> deltaOf(LTriBoolFunction<R> function, LBinaryOperator<R> deltaFunction) {
		return new LTriBoolFuncDelta<R>(function, deltaFunction);
	}

	public static <R> LTriBoolFuncDelta<R> deltaOf(R initialValue, LTriBoolFunction<R> function, LBinaryOperator<R> deltaFunction) {
