...
public class LToDblBiFuncMemento<T1, T2> implements LToDblBiFunction<T1, T2> {

	protected double lastValue;

	protected LToDblBiFunction<T1, T2> function;

	protected LToDblBiFuncMemento(LToDblBiFunction<T1, T2> function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LToDblBiFuncMemento(double initialValue, LToDblBiFunction<T1, T2> function) {
		this(function);
	...
	public static boolean argEquals(LToDblBiFuncMemento the, Object that) {
		return Null.<LToDblBiFuncMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LToDblBiFuncMemento other = (LToDblBiFuncMemento) two;
