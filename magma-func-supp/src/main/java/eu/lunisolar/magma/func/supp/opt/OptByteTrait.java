...
public interface OptByteTrait<SELF extends OptByteTrait<SELF>> extends FluentTrait<SELF>, aValue<aByte>, CheckByteTrait<SELF>, FilterByteSingleTrait<SELF>, IsByteTrait<SELF>, DoIfByteSingleTrait<SELF>, UseByteSingleTrait<SELF>, UniMapByteTrait<SELF> {
	...
	default @Nonnull <K, R> Opt<R> mapToObjWith(K a1, @Nonnull LObjByteFunction<? super K, ? extends R> mapping) {
		Null.nonNullArg(mapping, "mapping");
		return isPresent() ? (Opt.of(mapping.apply(a1, get()))) : Opt.empty();
	}

	default @Nonnull <K1, K2, R> Opt<R> mapToObjWith(K1 a1, K2 a2, @Nonnull LBiObjByteFunction<? super K1, ? super K2, ? extends R> mapping) {
		Null.nonNullArg(mapping, "mapping");
	...
	default @Nonnull <K, R> Opt<R> flatMapToObjWith(K a1, @Nonnull LObjByteFunction<? super K, ? extends ValueTrait<? extends R, ?>> mapping) {
		Null.nonNullArg(mapping, "mapping");
		return isPresent() ? Opt.from(mapping.apply(a1, get())) : Opt.empty();
	}

	default @Nonnull <K1, K2, R> Opt<R> flatMapToObjWith(K1 a1, K2 a2, @Nonnull LBiObjByteFunction<? super K1, ? super K2, ? extends ValueTrait<? extends R, ?>> mapping) {
		Null.nonNullArg(mapping, "mapping");
