...
public class LShortToFloatFuncDeltaX<X extends Throwable> extends LShortToFloatFuncMementoX<X> {

	protected final LFloatBinaryOperatorX<X> deltaFunction;

	protected LShortToFloatFuncDeltaX(LShortToFloatFunctionX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LShortToFloatFuncDeltaX(float initialValue, LShortToFloatFunctionX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LShortToFloatFuncDeltaX<X> deltaOf(LShortToFloatFunctionX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
		return new LShortToFloatFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LShortToFloatFuncDeltaX<X> deltaOf(float initialValue, LShortToFloatFunctionX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LShortToFloatFuncDeltaX the, Object that) {
		return Null.<LShortToFloatFuncDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LShortToFloatFuncDeltaX other = (LShortToFloatFuncDeltaX) two;
