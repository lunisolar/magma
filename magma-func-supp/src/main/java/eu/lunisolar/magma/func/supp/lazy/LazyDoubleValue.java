...
public class LazyDoubleValue extends LDoubleSupMemento implements LDoubleSingle {

	protected LazyDoubleValue(LDoubleSupplier function) {
		super(function);
	}

	public static LazyDoubleValue lazyValue(LDoubleSupplier supplier) {
	...
	public static boolean argEquals(LazyDoubleValue the, Object that) {
