...
public class LTernaryOpDeltaX<T, X extends Throwable> extends LTernaryOpMementoX<T, X> {
	...
	protected LTernaryOpDeltaX(LTernaryOperatorX<T, X> function, LBinaryOperatorX<T, X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LTernaryOpDeltaX(T initialValue, LTernaryOperatorX<T, X> function, LBinaryOperatorX<T, X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <T, X extends Throwable> LTernaryOpDeltaX<T, X> deltaOf(LTernaryOperatorX<T, X> function, LBinaryOperatorX<T, X> deltaFunction) {
		return new LTernaryOpDeltaX<T, X>(function, deltaFunction);
	}

	public static <T, X extends Throwable> LTernaryOpDeltaX<T, X> deltaOf(T initialValue, LTernaryOperatorX<T, X> function, LBinaryOperatorX<T, X> deltaFunction) {
