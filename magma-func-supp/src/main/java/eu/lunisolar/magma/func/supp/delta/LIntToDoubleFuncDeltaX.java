...
public class LIntToDoubleFuncDeltaX<X extends Throwable> extends LIntToDoubleFuncMementoX<X> {

	protected final LDoubleBinaryOperatorX<X> deltaFunction;

	protected LIntToDoubleFuncDeltaX(LIntToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LIntToDoubleFuncDeltaX(double initialValue, LIntToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LIntToDoubleFuncDeltaX<X> deltaOf(LIntToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		return new LIntToDoubleFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LIntToDoubleFuncDeltaX<X> deltaOf(double initialValue, LIntToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LIntToDoubleFuncDeltaX the, Object that) {
		return Null.<LIntToDoubleFuncDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LIntToDoubleFuncDeltaX other = (LIntToDoubleFuncDeltaX) two;
