...
public class LCharUnaryOpDelta extends LCharUnaryOpMemento {

	protected final LCharBinaryOperator deltaFunction;

	protected LCharUnaryOpDelta(LCharUnaryOperator function, LCharBinaryOperator deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LCharUnaryOpDelta(char initialValue, LCharUnaryOperator function, LCharBinaryOperator deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static LCharUnaryOpDelta deltaOf(LCharUnaryOperator function, LCharBinaryOperator deltaFunction) {
		return new LCharUnaryOpDelta(function, deltaFunction);
	}

	public static LCharUnaryOpDelta deltaOf(char initialValue, LCharUnaryOperator function, LCharBinaryOperator deltaFunction) {
	...
	public static LCharUnaryOpDelta deltaOf(char initialValue, LCharUnaryOperator function) {
		return deltaOf(initialValue, function, LCharUnaryOpDelta::mathDelta);
	}
	...
	public static boolean argEquals(LCharUnaryOpDelta the, Object that) {
		return Null.<LCharUnaryOpDelta> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LCharUnaryOpDelta other = (LCharUnaryOpDelta) two;
