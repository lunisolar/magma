...
public class LDoubleSupDeltaX<X extends Throwable> extends LDoubleSupMementoX<X> {

	protected final LDoubleBinaryOperatorX<X> deltaFunction;

	protected LDoubleSupDeltaX(LDoubleSupplierX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LDoubleSupDeltaX(double initialValue, LDoubleSupplierX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LDoubleSupDeltaX<X> deltaOf(LDoubleSupplierX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		return new LDoubleSupDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LDoubleSupDeltaX<X> deltaOf(double initialValue, LDoubleSupplierX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LDoubleSupDeltaX the, Object that) {
		return Null.<LDoubleSupDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LDoubleSupDeltaX other = (LDoubleSupDeltaX) two;
