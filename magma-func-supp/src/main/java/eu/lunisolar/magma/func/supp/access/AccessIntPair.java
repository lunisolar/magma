...
public interface AccessIntPair {
	...
	default void useWith(LBiIntConsumer.V1 accessFunction) {
		LIntPair tuple = accessIntPair();
		accessFunction.doAcceptV1(tuple.first(), tuple.second());
	}

	default void useWithO1(LBiIntConsumer.V1 accessFunction) {
		LIntPair tuple = accessIntPair();
	...
	default <R> R useWith(LBiIntFunction.V1<R> accessFunction) {
		LIntPair tuple = accessIntPair();
	...
	default <R> R useWithO1(LBiIntFunction.V1<R> accessFunction) {
		LIntPair tuple = accessIntPair();
	...
	default boolean useWith(LBiIntPredicate.V1 accessFunction) {
		LIntPair tuple = accessIntPair();
	...
	default boolean useWithO1(LBiIntPredicate.V1 accessFunction) {
		LIntPair tuple = accessIntPair();
