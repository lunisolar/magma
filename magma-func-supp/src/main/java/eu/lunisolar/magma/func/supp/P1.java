...
public class P1 implements FluentSyntax {
	...
	public static <MP1> boolean match(@Nonnull String n, @Nonnull Pattern pattern, MP1 msgParamOnly) {
		Null.nonNullArg(n, "n");
	...
	public static <MP1> @Nullable String matchEx(@Nonnull String n, @Nonnull Pattern pattern, MP1 msgParamOnly) {
		Null.nonNullArg(n, "n");
		Null.nonNullArg(pattern, "pattern");
	...
	public static <MP1> boolean notMatch(@Nonnull String n, @Nonnull Pattern pattern, MP1 msgParamOnly) {
		Null.nonNullArg(n, "n");
		Null.nonNullArg(pattern, "pattern");
	...
	public static <MP1> @Nullable String notMatchEx(@Nonnull String n, @Nonnull Pattern pattern, MP1 msgParamOnly) {
		Null.nonNullArg(n, "n");
		Null.nonNullArg(pattern, "pattern");
	...
	/** Predicate: String <'%s'> must match pattern <'%s'>.*/
	public static <MP1> boolean match(@Nonnull String n, @Nonnull String pattern, MP1 msgParamOnly) {
		Null.nonNullArg(n, "n");
		Null.nonNullArg(pattern, "pattern");
		return Predicates.match(n, pattern);
	}
	...
	/** "Special" predicate: String <'%s'> must match pattern <'%s'>.*/
	public static <MP1> @Nullable String matchEx(@Nonnull String n, @Nonnull String pattern, MP1 msgParamOnly) {
		Null.nonNullArg(n, "n");
		Null.nonNullArg(pattern, "pattern");
		return Predicates.matchEx(n, pattern);
	}
	...
	/** Predicate: String <'%s'> must NOT match pattern <'%s'>.*/
	public static <MP1> boolean notMatch(@Nonnull String n, @Nonnull String pattern, MP1 msgParamOnly) {
		Null.nonNullArg(n, "n");
		Null.nonNullArg(pattern, "pattern");
		return Predicates.notMatch(n, pattern);
	}
	...
	/** "Special" predicate: String <'%s'> must NOT match pattern <'%s'>.*/
	public static <MP1> @Nullable String notMatchEx(@Nonnull String n, @Nonnull String pattern, MP1 msgParamOnly) {
		Null.nonNullArg(n, "n");
		Null.nonNullArg(pattern, "pattern");
		return Predicates.notMatchEx(n, pattern);
	}
	...
	public static <MP1> boolean suppressed(@Nonnull Throwable e, int expected, MP1 msgParamOnly) {
		Null.nonNullArg(e, "e");
		return Predicates.suppressed(e, expected);
	}

	/** "Special" predicate: Exception <%s> must have suppressed %d other exceptions (actual: %d).*/
	public static <MP1> @Nullable String suppressedEx(@Nonnull Throwable e, int expected, MP1 msgParamOnly) {
		Null.nonNullArg(e, "e");
	...
	/** Predicate: Exception <%s> must have suppressed %d other exceptions (actual: %d).*/
	public static <MP1> boolean suppressing(@Nonnull Throwable e, int expected, MP1 msgParamOnly) {
		Null.nonNullArg(e, "e");
		return Predicates.suppressing(e, expected);
	}

	/** "Special" predicate: Exception <%s> must have suppressed %d other exceptions (actual: %d).*/
	public static <MP1> @Nullable String suppressingEx(@Nonnull Throwable e, int expected, MP1 msgParamOnly) {
		Null.nonNullArg(e, "e");
	...
	public static <MP1> boolean msgMatch(@Nonnull Throwable e, @Nonnull Pattern pattern, MP1 msgParamOnly) {
		Null.nonNullArg(e, "e");
		Null.nonNullArg(pattern, "pattern");
	...
	public static <MP1> @Nullable String msgMatchEx(@Nonnull Throwable e, @Nonnull Pattern pattern, MP1 msgParamOnly) {
		Null.nonNullArg(e, "e");
		Null.nonNullArg(pattern, "pattern");
	...
	public static <MP1> boolean msgNotMatch(@Nonnull Throwable e, @Nonnull Pattern pattern, MP1 msgParamOnly) {
		Null.nonNullArg(e, "e");
		Null.nonNullArg(pattern, "pattern");
	...
	public static <MP1> @Nullable String msgNotMatchEx(@Nonnull Throwable e, @Nonnull Pattern pattern, MP1 msgParamOnly) {
		Null.nonNullArg(e, "e");
		Null.nonNullArg(pattern, "pattern");
	...
	/** Predicate: Exception <%s> must have message matching pattern <'%s'>.*/
	public static <MP1> boolean msgMatch(@Nonnull Throwable e, @Nonnull String pattern, MP1 msgParamOnly) {
		Null.nonNullArg(e, "e");
		Null.nonNullArg(pattern, "pattern");
		return Predicates.msgMatch(e, pattern);
	}
	...
	/** "Special" predicate: Exception <%s> must have message matching pattern <'%s'>.*/
	public static <MP1> @Nullable String msgMatchEx(@Nonnull Throwable e, @Nonnull String pattern, MP1 msgParamOnly) {
		Null.nonNullArg(e, "e");
		Null.nonNullArg(pattern, "pattern");
		return Predicates.msgMatchEx(e, pattern);
	}
	...
	/** Predicate: Exception <%s> must NOT have message matching pattern <'%s'>.*/
	public static <MP1> boolean msgNotMatch(@Nonnull Throwable e, @Nonnull String pattern, MP1 msgParamOnly) {
		Null.nonNullArg(e, "e");
		Null.nonNullArg(pattern, "pattern");
		return Predicates.msgNotMatch(e, pattern);
	}
	...
	/** "Special" predicate: Exception <%s> must NOT have message matching pattern <'%s'>.*/
	public static <MP1> @Nullable String msgNotMatchEx(@Nonnull Throwable e, @Nonnull String pattern, MP1 msgParamOnly) {
		Null.nonNullArg(e, "e");
		Null.nonNullArg(pattern, "pattern");
		return Predicates.msgNotMatchEx(e, pattern);
	}
	...
	public static <MP1> boolean singleEqual(@Nonnull LBoolSingle single, boolean expected, MP1 msgParamOnly) {
	...
	public static <MP1> @Nullable String singleEqualEx(@Nonnull LBoolSingle single, boolean expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleEqualEx(single, expected);
	}

	/** Predicate: LBoolSingle <%s> must NOT have value equal <%s>.*/
	public static <MP1> boolean singleNotEqual(@Nonnull LBoolSingle single, boolean expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleNotEqual(single, expected);
	}

	/** "Special" predicate: LBoolSingle <%s> must NOT have value equal <%s>.*/
	public static <MP1> @Nullable String singleNotEqualEx(@Nonnull LBoolSingle single, boolean expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleNotEqualEx(single, expected);
	}

	/** Predicate: LByteSingle <%s> must have value equal <%s>.*/
	public static <MP1> boolean singleEqual(@Nonnull LByteSingle single, byte expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleEqual(single, expected);
	}

	/** "Special" predicate: LByteSingle <%s> must have value equal <%s>.*/
	public static <MP1> @Nullable String singleEqualEx(@Nonnull LByteSingle single, byte expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleEqualEx(single, expected);
	}

	/** Predicate: LByteSingle <%s> must NOT have value equal <%s>.*/
	public static <MP1> boolean singleNotEqual(@Nonnull LByteSingle single, byte expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleNotEqual(single, expected);
	}

	/** "Special" predicate: LByteSingle <%s> must NOT have value equal <%s>.*/
	public static <MP1> @Nullable String singleNotEqualEx(@Nonnull LByteSingle single, byte expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleNotEqualEx(single, expected);
	}

	/** Predicate: LDblSingle <%s> must have value equal <%s>.*/
	public static <MP1> boolean singleEqual(@Nonnull LDblSingle single, double expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleEqual(single, expected);
	}

	/** "Special" predicate: LDblSingle <%s> must have value equal <%s>.*/
	public static <MP1> @Nullable String singleEqualEx(@Nonnull LDblSingle single, double expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleEqualEx(single, expected);
	}

	/** Predicate: LDblSingle <%s> must NOT have value equal <%s>.*/
	public static <MP1> boolean singleNotEqual(@Nonnull LDblSingle single, double expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleNotEqual(single, expected);
	}

	/** "Special" predicate: LDblSingle <%s> must NOT have value equal <%s>.*/
	public static <MP1> @Nullable String singleNotEqualEx(@Nonnull LDblSingle single, double expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleNotEqualEx(single, expected);
	}

	/** Predicate: LCharSingle <%s> must have value equal <%s>.*/
	public static <MP1> boolean singleEqual(@Nonnull LCharSingle single, char expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleEqual(single, expected);
	}

	/** "Special" predicate: LCharSingle <%s> must have value equal <%s>.*/
	public static <MP1> @Nullable String singleEqualEx(@Nonnull LCharSingle single, char expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleEqualEx(single, expected);
	}

	/** Predicate: LCharSingle <%s> must NOT have value equal <%s>.*/
	public static <MP1> boolean singleNotEqual(@Nonnull LCharSingle single, char expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleNotEqual(single, expected);
	}

	/** "Special" predicate: LCharSingle <%s> must NOT have value equal <%s>.*/
	public static <MP1> @Nullable String singleNotEqualEx(@Nonnull LCharSingle single, char expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleNotEqualEx(single, expected);
	}

	/** Predicate: LSrtSingle <%s> must have value equal <%s>.*/
	public static <MP1> boolean singleEqual(@Nonnull LSrtSingle single, short expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleEqual(single, expected);
	}

	/** "Special" predicate: LSrtSingle <%s> must have value equal <%s>.*/
	public static <MP1> @Nullable String singleEqualEx(@Nonnull LSrtSingle single, short expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleEqualEx(single, expected);
	}

	/** Predicate: LSrtSingle <%s> must NOT have value equal <%s>.*/
	public static <MP1> boolean singleNotEqual(@Nonnull LSrtSingle single, short expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleNotEqual(single, expected);
	}

	/** "Special" predicate: LSrtSingle <%s> must NOT have value equal <%s>.*/
	public static <MP1> @Nullable String singleNotEqualEx(@Nonnull LSrtSingle single, short expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleNotEqualEx(single, expected);
	}

	/** Predicate: LFltSingle <%s> must have value equal <%s>.*/
	public static <MP1> boolean singleEqual(@Nonnull LFltSingle single, float expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleEqual(single, expected);
	}

	/** "Special" predicate: LFltSingle <%s> must have value equal <%s>.*/
	public static <MP1> @Nullable String singleEqualEx(@Nonnull LFltSingle single, float expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleEqualEx(single, expected);
	}

	/** Predicate: LFltSingle <%s> must NOT have value equal <%s>.*/
	public static <MP1> boolean singleNotEqual(@Nonnull LFltSingle single, float expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleNotEqual(single, expected);
	}

	/** "Special" predicate: LFltSingle <%s> must NOT have value equal <%s>.*/
	public static <MP1> @Nullable String singleNotEqualEx(@Nonnull LFltSingle single, float expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleNotEqualEx(single, expected);
	}

	/** Predicate: LIntSingle <%s> must have value equal <%s>.*/
	public static <MP1> boolean singleEqual(@Nonnull LIntSingle single, int expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleEqual(single, expected);
	}

	/** "Special" predicate: LIntSingle <%s> must have value equal <%s>.*/
	public static <MP1> @Nullable String singleEqualEx(@Nonnull LIntSingle single, int expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleEqualEx(single, expected);
	}

	/** Predicate: LIntSingle <%s> must NOT have value equal <%s>.*/
	public static <MP1> boolean singleNotEqual(@Nonnull LIntSingle single, int expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleNotEqual(single, expected);
	}

	/** "Special" predicate: LIntSingle <%s> must NOT have value equal <%s>.*/
	public static <MP1> @Nullable String singleNotEqualEx(@Nonnull LIntSingle single, int expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleNotEqualEx(single, expected);
	}

	/** Predicate: LLongSingle <%s> must have value equal <%s>.*/
	public static <MP1> boolean singleEqual(@Nonnull LLongSingle single, long expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleEqual(single, expected);
	}

	/** "Special" predicate: LLongSingle <%s> must have value equal <%s>.*/
	public static <MP1> @Nullable String singleEqualEx(@Nonnull LLongSingle single, long expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleEqualEx(single, expected);
	}

	/** Predicate: LLongSingle <%s> must NOT have value equal <%s>.*/
	public static <MP1> boolean singleNotEqual(@Nonnull LLongSingle single, long expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleNotEqual(single, expected);
	}

	/** "Special" predicate: LLongSingle <%s> must NOT have value equal <%s>.*/
	public static <MP1> @Nullable String singleNotEqualEx(@Nonnull LLongSingle single, long expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleNotEqualEx(single, expected);
	}

	/** Predicate: LSingle<T> <%s> must have value equal <%s>.*/
	public static <T, MP1> boolean singleEqual(@Nonnull LSingle<T> single, T expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleEqual(single, expected);
	}

	/** "Special" predicate: LSingle<T> <%s> must have value equal <%s>.*/
	public static <T, MP1> @Nullable String singleEqualEx(@Nonnull LSingle<T> single, T expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleEqualEx(single, expected);
	}

	/** Predicate: LSingle<T> <%s> must NOT have value equal <%s>.*/
	public static <T, MP1> boolean singleNotEqual(@Nonnull LSingle<T> single, T expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleNotEqual(single, expected);
	}

	/** "Special" predicate: LSingle<T> <%s> must NOT have value equal <%s>.*/
	public static <T, MP1> @Nullable String singleNotEqualEx(@Nonnull LSingle<T> single, T expected, MP1 msgParamOnly) {
		Null.nonNullArg(single, "single");
		return Predicates.singleNotEqualEx(single, expected);
	}
	...
	public static <MP1> boolean valueEqual(@Nonnull LBoolean lValue, boolean expected, MP1 msgParamOnly) {
	...
	public static <MP1> @Nullable String valueEqualEx(@Nonnull LBoolean lValue, boolean expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueEqualEx(lValue, expected);
	}

	/** Predicate: LBoolean <%s> must NOT have value equal <%s>.*/
	public static <MP1> boolean valueNotEqual(@Nonnull LBoolean lValue, boolean expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueNotEqual(lValue, expected);
	}

	/** "Special" predicate: LBoolean <%s> must NOT have value equal <%s>.*/
	public static <MP1> @Nullable String valueNotEqualEx(@Nonnull LBoolean lValue, boolean expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueNotEqualEx(lValue, expected);
	}

	/** Predicate: LByte <%s> must have value equal <%s>.*/
	public static <MP1> boolean valueEqual(@Nonnull LByte lValue, byte expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueEqual(lValue, expected);
	}

	/** "Special" predicate: LByte <%s> must have value equal <%s>.*/
	public static <MP1> @Nullable String valueEqualEx(@Nonnull LByte lValue, byte expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueEqualEx(lValue, expected);
	}

	/** Predicate: LByte <%s> must NOT have value equal <%s>.*/
	public static <MP1> boolean valueNotEqual(@Nonnull LByte lValue, byte expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueNotEqual(lValue, expected);
	}

	/** "Special" predicate: LByte <%s> must NOT have value equal <%s>.*/
	public static <MP1> @Nullable String valueNotEqualEx(@Nonnull LByte lValue, byte expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueNotEqualEx(lValue, expected);
	}

	/** Predicate: LDouble <%s> must have value equal <%s>.*/
	public static <MP1> boolean valueEqual(@Nonnull LDouble lValue, double expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueEqual(lValue, expected);
	}

	/** "Special" predicate: LDouble <%s> must have value equal <%s>.*/
	public static <MP1> @Nullable String valueEqualEx(@Nonnull LDouble lValue, double expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueEqualEx(lValue, expected);
	}

	/** Predicate: LDouble <%s> must NOT have value equal <%s>.*/
	public static <MP1> boolean valueNotEqual(@Nonnull LDouble lValue, double expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueNotEqual(lValue, expected);
	}

	/** "Special" predicate: LDouble <%s> must NOT have value equal <%s>.*/
	public static <MP1> @Nullable String valueNotEqualEx(@Nonnull LDouble lValue, double expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueNotEqualEx(lValue, expected);
	}

	/** Predicate: LCharacter <%s> must have value equal <%s>.*/
	public static <MP1> boolean valueEqual(@Nonnull LCharacter lValue, char expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueEqual(lValue, expected);
	}

	/** "Special" predicate: LCharacter <%s> must have value equal <%s>.*/
	public static <MP1> @Nullable String valueEqualEx(@Nonnull LCharacter lValue, char expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueEqualEx(lValue, expected);
	}

	/** Predicate: LCharacter <%s> must NOT have value equal <%s>.*/
	public static <MP1> boolean valueNotEqual(@Nonnull LCharacter lValue, char expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueNotEqual(lValue, expected);
	}

	/** "Special" predicate: LCharacter <%s> must NOT have value equal <%s>.*/
	public static <MP1> @Nullable String valueNotEqualEx(@Nonnull LCharacter lValue, char expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueNotEqualEx(lValue, expected);
	}

	/** Predicate: LShort <%s> must have value equal <%s>.*/
	public static <MP1> boolean valueEqual(@Nonnull LShort lValue, short expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueEqual(lValue, expected);
	}

	/** "Special" predicate: LShort <%s> must have value equal <%s>.*/
	public static <MP1> @Nullable String valueEqualEx(@Nonnull LShort lValue, short expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueEqualEx(lValue, expected);
	}

	/** Predicate: LShort <%s> must NOT have value equal <%s>.*/
	public static <MP1> boolean valueNotEqual(@Nonnull LShort lValue, short expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueNotEqual(lValue, expected);
	}

	/** "Special" predicate: LShort <%s> must NOT have value equal <%s>.*/
	public static <MP1> @Nullable String valueNotEqualEx(@Nonnull LShort lValue, short expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueNotEqualEx(lValue, expected);
	}

	/** Predicate: LFloat <%s> must have value equal <%s>.*/
	public static <MP1> boolean valueEqual(@Nonnull LFloat lValue, float expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueEqual(lValue, expected);
	}

	/** "Special" predicate: LFloat <%s> must have value equal <%s>.*/
	public static <MP1> @Nullable String valueEqualEx(@Nonnull LFloat lValue, float expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueEqualEx(lValue, expected);
	}

	/** Predicate: LFloat <%s> must NOT have value equal <%s>.*/
	public static <MP1> boolean valueNotEqual(@Nonnull LFloat lValue, float expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueNotEqual(lValue, expected);
	}

	/** "Special" predicate: LFloat <%s> must NOT have value equal <%s>.*/
	public static <MP1> @Nullable String valueNotEqualEx(@Nonnull LFloat lValue, float expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueNotEqualEx(lValue, expected);
	}

	/** Predicate: LInteger <%s> must have value equal <%s>.*/
	public static <MP1> boolean valueEqual(@Nonnull LInteger lValue, int expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueEqual(lValue, expected);
	}

	/** "Special" predicate: LInteger <%s> must have value equal <%s>.*/
	public static <MP1> @Nullable String valueEqualEx(@Nonnull LInteger lValue, int expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueEqualEx(lValue, expected);
	}

	/** Predicate: LInteger <%s> must NOT have value equal <%s>.*/
	public static <MP1> boolean valueNotEqual(@Nonnull LInteger lValue, int expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueNotEqual(lValue, expected);
	}

	/** "Special" predicate: LInteger <%s> must NOT have value equal <%s>.*/
	public static <MP1> @Nullable String valueNotEqualEx(@Nonnull LInteger lValue, int expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueNotEqualEx(lValue, expected);
	}

	/** Predicate: LLong <%s> must have value equal <%s>.*/
	public static <MP1> boolean valueEqual(@Nonnull LLong lValue, long expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueEqual(lValue, expected);
	}

	/** "Special" predicate: LLong <%s> must have value equal <%s>.*/
	public static <MP1> @Nullable String valueEqualEx(@Nonnull LLong lValue, long expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueEqualEx(lValue, expected);
	}

	/** Predicate: LLong <%s> must NOT have value equal <%s>.*/
	public static <MP1> boolean valueNotEqual(@Nonnull LLong lValue, long expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueNotEqual(lValue, expected);
	}

	/** "Special" predicate: LLong <%s> must NOT have value equal <%s>.*/
	public static <MP1> @Nullable String valueNotEqualEx(@Nonnull LLong lValue, long expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueNotEqualEx(lValue, expected);
	}

	/** Predicate: LValue<T> <%s> must have value equal <%s>.*/
	public static <T, MP1> boolean valueEqual(@Nonnull LValue<T> lValue, T expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueEqual(lValue, expected);
	}

	/** "Special" predicate: LValue<T> <%s> must have value equal <%s>.*/
	public static <T, MP1> @Nullable String valueEqualEx(@Nonnull LValue<T> lValue, T expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueEqualEx(lValue, expected);
	}

	/** Predicate: LValue<T> <%s> must NOT have value equal <%s>.*/
	public static <T, MP1> boolean valueNotEqual(@Nonnull LValue<T> lValue, T expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueNotEqual(lValue, expected);
	}

	/** "Special" predicate: LValue<T> <%s> must NOT have value equal <%s>.*/
	public static <T, MP1> @Nullable String valueNotEqualEx(@Nonnull LValue<T> lValue, T expected, MP1 msgParamOnly) {
		Null.nonNullArg(lValue, "lValue");
		return Predicates.valueNotEqualEx(lValue, expected);
	}
