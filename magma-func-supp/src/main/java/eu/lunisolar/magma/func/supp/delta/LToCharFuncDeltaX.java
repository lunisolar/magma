...
public class LToCharFuncDeltaX<T, X extends Throwable> extends LToCharFuncMementoX<T, X> {

	protected final LCharBinaryOperatorX<X> deltaFunction;

	protected LToCharFuncDeltaX(LToCharFunctionX<T, X> function, LCharBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LToCharFuncDeltaX(char initialValue, LToCharFunctionX<T, X> function, LCharBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <T, X extends Throwable> LToCharFuncDeltaX<T, X> deltaOf(LToCharFunctionX<T, X> function, LCharBinaryOperatorX<X> deltaFunction) {
		return new LToCharFuncDeltaX<T, X>(function, deltaFunction);
	}

	public static <T, X extends Throwable> LToCharFuncDeltaX<T, X> deltaOf(char initialValue, LToCharFunctionX<T, X> function, LCharBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LToCharFuncDeltaX the, Object that) {
		return Null.<LToCharFuncDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LToCharFuncDeltaX other = (LToCharFuncDeltaX) two;
