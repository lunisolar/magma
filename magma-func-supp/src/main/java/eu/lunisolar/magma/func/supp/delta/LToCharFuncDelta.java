...
public class LToCharFuncDelta<T> extends LToCharFuncMemento<T> {

	protected final LCharBinaryOperator deltaFunction;

	protected LToCharFuncDelta(LToCharFunction<T> function, LCharBinaryOperator deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LToCharFuncDelta(char initialValue, LToCharFunction<T> function, LCharBinaryOperator deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <T> LToCharFuncDelta<T> deltaOf(LToCharFunction<T> function, LCharBinaryOperator deltaFunction) {
		return new LToCharFuncDelta<T>(function, deltaFunction);
	}

	public static <T> LToCharFuncDelta<T> deltaOf(char initialValue, LToCharFunction<T> function, LCharBinaryOperator deltaFunction) {
	...
	public static <T> LToCharFuncDelta<T> deltaOf(char initialValue, LToCharFunction<T> function) {
		return deltaOf(initialValue, function, LToCharFuncDelta::mathDelta);
	}
	...
	public static boolean argEquals(LToCharFuncDelta the, Object that) {
		return Null.<LToCharFuncDelta> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LToCharFuncDelta other = (LToCharFuncDelta) two;
