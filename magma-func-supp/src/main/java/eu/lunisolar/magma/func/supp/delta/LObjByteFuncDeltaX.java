...
public class LObjByteFuncDeltaX<T, R, X extends Throwable> extends LObjByteFuncMementoX<T, R, X> {
	...
	protected LObjByteFuncDeltaX(LObjByteFunctionX<T, R, X> function, LBinaryOperatorX<R, X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LObjByteFuncDeltaX(R initialValue, LObjByteFunctionX<T, R, X> function, LBinaryOperatorX<R, X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <T, R, X extends Throwable> LObjByteFuncDeltaX<T, R, X> deltaOf(LObjByteFunctionX<T, R, X> function, LBinaryOperatorX<R, X> deltaFunction) {
		return new LObjByteFuncDeltaX<T, R, X>(function, deltaFunction);
	}

	public static <T, R, X extends Throwable> LObjByteFuncDeltaX<T, R, X> deltaOf(R initialValue, LObjByteFunctionX<T, R, X> function, LBinaryOperatorX<R, X> deltaFunction) {
