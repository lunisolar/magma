...
public class LDoubleBinaryOpDeltaX<X extends Throwable> extends LDoubleBinaryOpMementoX<X> {
	...
	protected LDoubleBinaryOpDeltaX(LDoubleBinaryOperatorX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LDoubleBinaryOpDeltaX(double initialValue, LDoubleBinaryOperatorX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LDoubleBinaryOpDeltaX<X> deltaOf(LDoubleBinaryOperatorX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		return new LDoubleBinaryOpDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LDoubleBinaryOpDeltaX<X> deltaOf(double initialValue, LDoubleBinaryOperatorX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
