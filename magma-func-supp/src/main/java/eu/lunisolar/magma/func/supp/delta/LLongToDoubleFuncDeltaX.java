...
public class LLongToDoubleFuncDeltaX<X extends Throwable> extends LLongToDoubleFuncMementoX<X> {

	protected final LDoubleBinaryOperatorX<X> deltaFunction;

	protected LLongToDoubleFuncDeltaX(LLongToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LLongToDoubleFuncDeltaX(double initialValue, LLongToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LLongToDoubleFuncDeltaX<X> deltaOf(LLongToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		return new LLongToDoubleFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LLongToDoubleFuncDeltaX<X> deltaOf(double initialValue, LLongToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LLongToDoubleFuncDeltaX the, Object that) {
		return Null.<LLongToDoubleFuncDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LLongToDoubleFuncDeltaX other = (LLongToDoubleFuncDeltaX) two;
