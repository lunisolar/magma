...
public class LBiObjCharFuncDeltaX<T1, T2, R, X extends Throwable> extends LBiObjCharFuncMementoX<T1, T2, R, X> {
	...
	protected LBiObjCharFuncDeltaX(LBiObjCharFunctionX<T1, T2, R, X> function, LBinaryOperatorX<R, X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LBiObjCharFuncDeltaX(R initialValue, LBiObjCharFunctionX<T1, T2, R, X> function, LBinaryOperatorX<R, X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <T1, T2, R, X extends Throwable> LBiObjCharFuncDeltaX<T1, T2, R, X> deltaOf(LBiObjCharFunctionX<T1, T2, R, X> function, LBinaryOperatorX<R, X> deltaFunction) {
		return new LBiObjCharFuncDeltaX<T1, T2, R, X>(function, deltaFunction);
	}

	public static <T1, T2, R, X extends Throwable> LBiObjCharFuncDeltaX<T1, T2, R, X> deltaOf(R initialValue, LBiObjCharFunctionX<T1, T2, R, X> function, LBinaryOperatorX<R, X> deltaFunction) {
