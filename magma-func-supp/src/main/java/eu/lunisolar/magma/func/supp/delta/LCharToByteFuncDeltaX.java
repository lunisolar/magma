...
public class LCharToByteFuncDeltaX<X extends Throwable> extends LCharToByteFuncMementoX<X> {
	...
	protected LCharToByteFuncDeltaX(LCharToByteFunctionX<X> function, LByteBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LCharToByteFuncDeltaX(byte initialValue, LCharToByteFunctionX<X> function, LByteBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LCharToByteFuncDeltaX<X> deltaOf(LCharToByteFunctionX<X> function, LByteBinaryOperatorX<X> deltaFunction) {
		return new LCharToByteFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LCharToByteFuncDeltaX<X> deltaOf(byte initialValue, LCharToByteFunctionX<X> function, LByteBinaryOperatorX<X> deltaFunction) {
