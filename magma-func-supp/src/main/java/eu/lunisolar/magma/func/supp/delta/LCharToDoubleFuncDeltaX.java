...
public class LCharToDoubleFuncDeltaX<X extends Throwable> extends LCharToDoubleFuncMementoX<X> {
	...
	protected LCharToDoubleFuncDeltaX(LCharToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LCharToDoubleFuncDeltaX(double initialValue, LCharToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LCharToDoubleFuncDeltaX<X> deltaOf(LCharToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		return new LCharToDoubleFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LCharToDoubleFuncDeltaX<X> deltaOf(double initialValue, LCharToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
