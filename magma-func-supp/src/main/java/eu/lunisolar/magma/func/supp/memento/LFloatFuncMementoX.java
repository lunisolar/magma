...
public class LFloatFuncMementoX<R, X extends Throwable> implements LFloatFunctionX<R, X> {

	protected R lastValue;

	protected LFloatFunctionX<R, X> function;
	...
	public static boolean argEquals(LFloatFuncMementoX the, Object that) {
		return Null.<LFloatFuncMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LFloatFuncMementoX other = (LFloatFuncMementoX) two;
