...
public interface OptCharTrait<SELF extends OptCharTrait<SELF>> extends FluentTrait<SELF>, aValue<aChar>, CheckCharTrait<SELF>, FilterCharSingleTrait<SELF>, IsCharTrait<SELF>, DoIfCharSingleTrait<SELF>, UseCharSingleTrait<SELF> {
	...
	default @Nonnull <K> OptChar flatMap_(K a1, @Nonnull LObjCharFunction.LCharObjFunc<? super K, ? extends OptCharTrait<?>> mapping) {
		Null.nonNullArg(mapping, "mapping");
		return isPresent() ? OptChar.from(mapping.applyCharObj(get(), a1)) : OptChar.empty();
	}
	...
	default @Nonnull <K1, K2> OptChar flatMap_(K1 a1, K2 a2, @Nonnull LBiObjCharFunction.LChar2Obj0Obj1Func<? super K1, ? super K2, ? extends OptCharTrait<?>> mapping) {
		Null.nonNullArg(mapping, "mapping");
		return isPresent() ? OptChar.from(mapping.applyChar2Obj0Obj1(get(), a1, a2)) : OptChar.empty();
	}

	default @Nonnull <K1, K2> OptChar flatMapWith(K1 a1, K2 a2, @Nonnull LBiObjCharFunction<? super K1, ? super K2, ? extends OptCharTrait<?>> mapping) {
		Null.nonNullArg(mapping, "mapping");
	...
	default <K1> SELF ifPresent_(K1 a2, @Nonnull LObjCharConsumer.LCharObjCons<? super K1> action, @Nonnull LAction emptyAction) {
		Null.nonNullArg(action, "action");
		if (isPresent()) {
			action.acceptCharObj(get(), a2);
		} else {
	...
	default <K1, K2> SELF ifPresent_(K1 a2, K2 a3, @Nonnull LBiObjCharConsumer.LChar2Obj0Obj1Cons<? super K1, ? super K2> action, @Nonnull LAction emptyAction) {
		Null.nonNullArg(action, "action");
		if (isPresent()) {
			action.acceptChar2Obj0Obj1(get(), a2, a3);
		} else {
	...
	default SELF ifPresentWith(@Nonnull LCharConsumer action, @Nonnull LAction emptyAction) {
		Null.nonNullArg(action, "action");
		if (isPresent()) {
			action.accept(get());
		} else {
	...
	default <K1> SELF ifPresentWith(K1 a1, @Nonnull LObjCharConsumer<? super K1> action, @Nonnull LAction emptyAction) {
		Null.nonNullArg(action, "action");
		if (isPresent()) {
			action.accept(a1, get());
		} else {
	...
	default <K1, K2> SELF ifPresentWith(K1 a1, K2 a2, @Nonnull LBiObjCharConsumer<? super K1, ? super K2> action, @Nonnull LAction emptyAction) {
		Null.nonNullArg(action, "action");
		if (isPresent()) {
			action.accept(a1, a2, get());
		} else {
