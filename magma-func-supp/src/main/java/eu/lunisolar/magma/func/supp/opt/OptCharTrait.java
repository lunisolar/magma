 ...
 */
public interface OptCharTrait<SELF extends OptCharTrait<SELF>> extends Fluent<SELF>, aValue<aChar>, CheckCharTrait<SELF>, FilterCharTrait<SELF>, IsCharTrait<SELF> {
