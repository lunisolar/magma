...
public interface CheckBoolTrait<SELF extends CheckBoolTrait<SELF>> extends FailPoint<SELF>, aValue<aBool>, BoolValueTrait<SELF>, aCheck<aBool> {
	...
	/**   */
	default @Nonnull <V1, V2> SELF mustWithEx3(@Nonnull LBiObjBoolFunction<? super V1, ? super V2, ? extends String> specialPredicate, V1 with1, V2 with2, @Nonnull String message, @Nullable Object param1, @Nullable Object param2,
	...
	/**   */
	default @Nonnull <V1, V2> SELF mustWithEx3(V1 with1, V2 with2, @Nonnull LBiObjBoolFunction<? super V1, ? super V2, ? extends String> specialPredicate, @Nonnull String message, @Nullable Object param1, @Nullable Object param2,
			@Nullable Object param3) {
		Null.nonNullArg(specialPredicate, "specialPredicate");
		Null.nonNullArg(message, "message");
		@Nonnull
