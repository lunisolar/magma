...
public class LToByteBiFuncMementoX<T1, T2, X extends Throwable> implements LToByteBiFunctionX<T1, T2, X> {

	protected byte lastValue;

	protected LToByteBiFunctionX<T1, T2, X> function;
	...
	public static boolean argEquals(LToByteBiFuncMementoX the, Object that) {
		return Null.<LToByteBiFuncMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LToByteBiFuncMementoX other = (LToByteBiFuncMementoX) two;
