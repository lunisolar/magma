...
public final class P2 implements FluentSyntax {
	...
	public static <MP1, MP2> String same$(@Nullable Object n, @Nullable Object other, MP1 msgParamOnly1, MP2 msgParamOnly2) {
	...
	public static <MP1, MP2> String notSame$(@Nullable Object n, @Nullable Object other, MP1 msgParamOnly1, MP2 msgParamOnly2) {
	...
	public static <MP1, MP2> String Null$(@Nullable Object n, MP1 msgParamOnly1, MP2 msgParamOnly2) {
	...
	public static <MP1, MP2> String notNull$(@Nullable Object n, MP1 msgParamOnly1, MP2 msgParamOnly2) {
	...
	public static <MP1, MP2> String empty$(@Nonnull String n, MP1 msgParamOnly1, MP2 msgParamOnly2) {
		Null.nonNullArg(n, "n");
	...
	public static <MP1, MP2> String notEmpty$(@Nonnull String n, MP1 msgParamOnly1, MP2 msgParamOnly2) {
		Null.nonNullArg(n, "n");
	...
	public static <MP1, MP2> String blank$(@Nonnull String n, MP1 msgParamOnly1, MP2 msgParamOnly2) {
		Null.nonNullArg(n, "n");
	...
	public static <MP1, MP2> String notBlank$(@Nonnull String n, MP1 msgParamOnly1, MP2 msgParamOnly2) {
		Null.nonNullArg(n, "n");
	...
	public static <MP1, MP2> String nullOrEmpty$(@Nonnull String n, MP1 msgParamOnly1, MP2 msgParamOnly2) {
	...
	public static <MP1, MP2> String notNullNorEmpty$(@Nonnull String n, MP1 msgParamOnly1, MP2 msgParamOnly2) {
	...
	public static <MP1, MP2> String nullOrBlank$(@Nonnull String n, MP1 msgParamOnly1, MP2 msgParamOnly2) {
	...
	public static <MP1, MP2> String notNullNorBlank$(@Nonnull String n, MP1 msgParamOnly1, MP2 msgParamOnly2) {
	...
	public static <MP1, MP2> String instanceOf$(Object object, Class<?> clazz, MP1 msgParamOnly1, MP2 msgParamOnly2) {
		Null.nonNullArg(clazz, "clazz");
	...
	public static <MP1, MP2> String notInstanceOf$(Object object, Class<?> clazz, MP1 msgParamOnly1, MP2 msgParamOnly2) {
		Null.nonNullArg(clazz, "clazz");
	...
	public static <MP1, MP2> String assignableFrom$(Class<?> specialization, Class<?> clazz, MP1 msgParamOnly1, MP2 msgParamOnly2) {
		Null.nonNullArg(clazz, "clazz");
	...
	/** "Special" predicate: Class <%s> must ---NOT-- be specialization of <%s>. Available in {@link P}, {@link Is}, {@link Be}, {@link P1}, {@link P2}.*/
	public static <MP1, MP2> String notAssignableFrom$(Class<?> specialization, Class<?> clazz, MP1 msgParamOnly1, MP2 msgParamOnly2) {
		Null.nonNullArg(clazz, "clazz");
		return !(clazz.isAssignableFrom(specialization)) ? null : String.format("Class <%s> must ---NOT-- be specialization of <%s>.", specialization, clazz);
	}
