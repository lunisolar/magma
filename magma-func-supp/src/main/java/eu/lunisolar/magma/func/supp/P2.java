...
public class P2 implements FluentSyntax {
	...
	public static <MP1, MP2> boolean msgEqual(@Nonnull Throwable e, @Nonnull String text, MP1 msgParamOnly1, MP2 msgParamOnly2) {
		Null.nonNullArg(e, "e");
	...
	public static <MP1, MP2> @Nullable String msgEqual$(@Nonnull Throwable e, @Nonnull String text, MP1 msgParamOnly1, MP2 msgParamOnly2) {
		Null.nonNullArg(e, "e");
		Null.nonNullArg(text, "text");
		return Predicates.msgEqual$(e, text);
	}
	/** Predicate: Exception <%s> must NOT have message equal to <'%s>'..*/
	public static <MP1, MP2> boolean msgNotEqual(@Nonnull Throwable e, @Nonnull String text, MP1 msgParamOnly1, MP2 msgParamOnly2) {
		Null.nonNullArg(e, "e");
		Null.nonNullArg(text, "text");
	...
	public static <MP1, MP2> @Nullable String msgNotEqual$(@Nonnull Throwable e, @Nonnull String text, MP1 msgParamOnly1, MP2 msgParamOnly2) {
		Null.nonNullArg(e, "e");
		Null.nonNullArg(text, "text");
		return Predicates.msgNotEqual$(e, text);
	}
