...
public class P2 implements FluentSyntax {
	...
	public static <MP1, MP2> @Nullable String assignableFrom$(Class<?> clazz, Class<?> from, MP1 msgParamOnly1, MP2 msgParamOnly2) {
		Null.nonNullArg(from, "from");
		return Predicates.assignableFrom$(clazz, from);
	}
	...
	public static <MP1, MP2> @Nullable String notAssignableFrom$(Class<?> clazz, Class<?> from, MP1 msgParamOnly1, MP2 msgParamOnly2) {
		Null.nonNullArg(from, "from");
		return Predicates.notAssignableFrom$(clazz, from);
	}
	...
	public static <MP1, MP2> @Nullable String assignableTo$(Class<?> clazz, Class<?> from, MP1 msgParamOnly1, MP2 msgParamOnly2) {
		Null.nonNullArg(from, "from");
		return Predicates.assignableTo$(clazz, from);
	}
	...
	public static <MP1, MP2> @Nullable String notAssignableTo$(Class<?> clazz, Class<?> from, MP1 msgParamOnly1, MP2 msgParamOnly2) {
		Null.nonNullArg(from, "from");
		return Predicates.notAssignableTo$(clazz, from);
	}
	...
	public static <MP1, MP2> @Nullable String done$(@Nonnull Future<?> future, MP1 msgParamOnly1, MP2 msgParamOnly2) {
		Null.nonNullArg(future, "future");
		return Predicates.done$(future);
	}
	...
	public static <MP1, MP2> @Nullable String notDone$(@Nonnull Future<?> future, MP1 msgParamOnly1, MP2 msgParamOnly2) {
		Null.nonNullArg(future, "future");
		return Predicates.notDone$(future);
	}
	...
	public static <MP1, MP2> @Nullable String cancelled$(@Nonnull Future<?> future, MP1 msgParamOnly1, MP2 msgParamOnly2) {
		Null.nonNullArg(future, "future");
		return Predicates.cancelled$(future);
	}
	...
	public static <MP1, MP2> @Nullable String notCancelled$(@Nonnull Future<?> future, MP1 msgParamOnly1, MP2 msgParamOnly2) {
		Null.nonNullArg(future, "future");
		return Predicates.notCancelled$(future);
	}
	...
	/** "Special" predicate: <%s> must be cancelled. */
	public static <MP1, MP2> @Nullable String completedExceptionally$(@Nonnull CompletableFuture<?> future, MP1 msgParamOnly1, MP2 msgParamOnly2) {
		Null.nonNullArg(future, "future");
		return Predicates.completedExceptionally$(future);
	}
	/** Predicate: <%s> must NOT be cancelled..*/
	...
	/** "Special" predicate: <%s> must NOT be cancelled. */
	public static <MP1, MP2> @Nullable String notCompletedExceptionally$(@Nonnull CompletableFuture<?> future, MP1 msgParamOnly1, MP2 msgParamOnly2) {
		Null.nonNullArg(future, "future");
		return Predicates.notCompletedExceptionally$(future);
	}
	...
	public static <MP1, MP2> @Nullable String produce$(@Nonnull Future<?> future, Object expected, MP1 msgParamOnly1, MP2 msgParamOnly2) {
		Null.nonNullArg(future, "future");
		return Predicates.produce$(future, expected);
	}
	...
	public static <MP1, MP2> @Nullable String notProduce$(@Nonnull Future<?> future, Object expected, MP1 msgParamOnly1, MP2 msgParamOnly2) {
		Null.nonNullArg(future, "future");
		return Predicates.notProduce$(future, expected);
	}
