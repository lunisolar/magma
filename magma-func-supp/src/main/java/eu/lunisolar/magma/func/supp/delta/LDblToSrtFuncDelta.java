...
public class LDblToSrtFuncDelta extends LDblToSrtFuncMemento {

	protected final LSrtBinaryOperator deltaFunction;

	protected LDblToSrtFuncDelta(LDblToSrtFunction function, LSrtBinaryOperator deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LDblToSrtFuncDelta(short initialValue, LDblToSrtFunction function, LSrtBinaryOperator deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static LDblToSrtFuncDelta deltaOf(LDblToSrtFunction function, LSrtBinaryOperator deltaFunction) {
		return new LDblToSrtFuncDelta(function, deltaFunction);
	}

	public static LDblToSrtFuncDelta deltaOf(short initialValue, LDblToSrtFunction function, LSrtBinaryOperator deltaFunction) {
	...
	public static LDblToSrtFuncDelta deltaOf(short initialValue, LDblToSrtFunction function) {
		return deltaOf(initialValue, function, LDblToSrtFuncDelta::mathDelta);
	}
	...
	public static boolean argEquals(LDblToSrtFuncDelta the, Object that) {
		return Null.<LDblToSrtFuncDelta> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LDblToSrtFuncDelta other = (LDblToSrtFuncDelta) two;
