...
public class LCharSupMementoX<X extends Throwable> implements LCharSupplierX<X> {

	protected char lastValue;

	protected LCharSupplierX<X> function;
	...
	public static boolean argEquals(LCharSupMementoX the, Object that) {
		return Null.<LCharSupMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LCharSupMementoX other = (LCharSupMementoX) two;
