...
public class LBoolToShortFuncMementoX<X extends Throwable> implements LBoolToShortFunctionX<X> {

	protected short lastValue;

	protected LBoolToShortFunctionX<X> function;
	...
	public static boolean argEquals(LBoolToShortFuncMementoX the, Object that) {
		return Null.<LBoolToShortFuncMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LBoolToShortFuncMementoX other = (LBoolToShortFuncMementoX) two;
