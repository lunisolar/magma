...
public class LTieCharFuncMemento<T> implements LTieCharFunction<T> {

	protected int lastValue;

	protected LTieCharFunction<T> function;

	protected LTieCharFuncMemento(LTieCharFunction<T> function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LTieCharFuncMemento(int initialValue, LTieCharFunction<T> function) {
		this(function);
	...
	public static boolean argEquals(LTieCharFuncMemento the, Object that) {
		return Null.<LTieCharFuncMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LTieCharFuncMemento other = (LTieCharFuncMemento) two;
