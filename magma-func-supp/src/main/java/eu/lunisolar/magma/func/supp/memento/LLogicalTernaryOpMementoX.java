...
public class LLogicalTernaryOpMementoX<X extends Throwable> implements LLogicalTernaryOperatorX<X> {

	protected boolean lastValue;

	protected LLogicalTernaryOperatorX<X> function;
	...
	public static boolean argEquals(LLogicalTernaryOpMementoX the, Object that) {
		return Null.<LLogicalTernaryOpMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LLogicalTernaryOpMementoX other = (LLogicalTernaryOpMementoX) two;
