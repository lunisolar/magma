...
public class LDblToSrtFuncMemento implements LDblToSrtFunction {

	protected short lastValue;

	protected LDblToSrtFunction function;

	protected LDblToSrtFuncMemento(LDblToSrtFunction function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LDblToSrtFuncMemento(short initialValue, LDblToSrtFunction function) {
		this(function);
	...
	public static boolean argEquals(LDblToSrtFuncMemento the, Object that) {
		return Null.<LDblToSrtFuncMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LDblToSrtFuncMemento other = (LDblToSrtFuncMemento) two;
