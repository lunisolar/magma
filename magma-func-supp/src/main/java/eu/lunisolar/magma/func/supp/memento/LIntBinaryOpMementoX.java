...
public class LIntBinaryOpMementoX<X extends Throwable> implements LIntBinaryOperatorX<X> {

	protected int lastValue;

	protected LIntBinaryOperatorX<X> function;
	...
	public static boolean argEquals(LIntBinaryOpMementoX the, Object that) {
		return Null.<LIntBinaryOpMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LIntBinaryOpMementoX other = (LIntBinaryOpMementoX) two;
