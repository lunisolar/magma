...
public class LBoolToLongFuncDelta extends LBoolToLongFuncMemento {

	protected final LLongBinaryOperator deltaFunction;

	protected LBoolToLongFuncDelta(LBoolToLongFunction function, LLongBinaryOperator deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LBoolToLongFuncDelta(long initialValue, LBoolToLongFunction function, LLongBinaryOperator deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static LBoolToLongFuncDelta deltaOf(LBoolToLongFunction function, LLongBinaryOperator deltaFunction) {
		return new LBoolToLongFuncDelta(function, deltaFunction);
	}

	public static LBoolToLongFuncDelta deltaOf(long initialValue, LBoolToLongFunction function, LLongBinaryOperator deltaFunction) {
	...
	public static LBoolToLongFuncDelta deltaOf(long initialValue, LBoolToLongFunction function) {
		return deltaOf(initialValue, function, LBoolToLongFuncDelta::mathDelta);
	}
	...
	public static boolean argEquals(LBoolToLongFuncDelta the, Object that) {
		return Null.<LBoolToLongFuncDelta> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LBoolToLongFuncDelta other = (LBoolToLongFuncDelta) two;
	...
	@Override
	public long delta(boolean a) {
		return applyAsLong(a);
	}

	@Override
	public long delta(boolean a, LLongBinaryOperator deltaFunction) {
