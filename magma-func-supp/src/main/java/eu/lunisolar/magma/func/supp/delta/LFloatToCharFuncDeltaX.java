...
public class LFloatToCharFuncDeltaX<X extends Throwable> extends LFloatToCharFuncMementoX<X> {

	protected final LCharBinaryOperatorX<X> deltaFunction;

	protected LFloatToCharFuncDeltaX(LFloatToCharFunctionX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LFloatToCharFuncDeltaX(char initialValue, LFloatToCharFunctionX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LFloatToCharFuncDeltaX<X> deltaOf(LFloatToCharFunctionX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
		return new LFloatToCharFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LFloatToCharFuncDeltaX<X> deltaOf(char initialValue, LFloatToCharFunctionX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LFloatToCharFuncDeltaX the, Object that) {
		return Null.<LFloatToCharFuncDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LFloatToCharFuncDeltaX other = (LFloatToCharFuncDeltaX) two;
