...
public class LOiFuncMemento<T, R> implements LOiFunction<T, R> {
	 ...
	 */
	public static <T, R> LOiFuncMemento<T, R> hollowMementoOf(LOiFunction<T, R> supplier) {
	 ...
	 */
	public static <T, R> LOiFuncMemento<T, R> mementoOf(T a1, int a2, LOiFunction<T, R> supplier) {
		return new LOiFuncMemento<T, R>(supplier.apply(a1, a2), supplier);
	}
	...
	public static boolean argEquals(LOiFuncMemento the, Object that) {
		return Null.<LOiFuncMemento> equals(the, that, (one, two) -> {
