...
public class LIntToSrtFuncMemento implements LIntToSrtFunction {

	protected short lastValue;

	protected LIntToSrtFunction function;

	protected LIntToSrtFuncMemento(LIntToSrtFunction function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LIntToSrtFuncMemento(short initialValue, LIntToSrtFunction function) {
		this(function);
	...
	public static boolean argEquals(LIntToSrtFuncMemento the, Object that) {
		return Null.<LIntToSrtFuncMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LIntToSrtFuncMemento other = (LIntToSrtFuncMemento) two;
