...
public interface IntValueTrait<SELF extends IntValueTrait<SELF>> extends Fluent<SELF>, aValue<aInt>, LIntSingle {
	...
	default SELF valueFrom(@Nonnull OptIntTrait<?> trait) {
