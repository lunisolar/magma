...
public interface LongValueTrait<SELF extends LongValueTrait<SELF>> extends Fluent<SELF>, aValue<aLong>, LLongSingle {
	...
	default SELF valueFrom(@Nonnull OptLongTrait<?> trait) {
