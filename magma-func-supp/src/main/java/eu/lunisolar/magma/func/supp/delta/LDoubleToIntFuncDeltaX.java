...
public class LDoubleToIntFuncDeltaX<X extends Throwable> extends LDoubleToIntFuncMementoX<X> {

	protected final LIntBinaryOperatorX<X> deltaFunction;

	protected LDoubleToIntFuncDeltaX(LDoubleToIntFunctionX<X> function, LIntBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LDoubleToIntFuncDeltaX(int initialValue, LDoubleToIntFunctionX<X> function, LIntBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LDoubleToIntFuncDeltaX<X> deltaOf(LDoubleToIntFunctionX<X> function, LIntBinaryOperatorX<X> deltaFunction) {
		return new LDoubleToIntFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LDoubleToIntFuncDeltaX<X> deltaOf(int initialValue, LDoubleToIntFunctionX<X> function, LIntBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LDoubleToIntFuncDeltaX the, Object that) {
		return Null.<LDoubleToIntFuncDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LDoubleToIntFuncDeltaX other = (LDoubleToIntFuncDeltaX) two;
