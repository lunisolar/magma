...
public class LTriFuncDeltaX<T1, T2, T3, R, X extends Throwable> extends LTriFuncMementoX<T1, T2, T3, R, X> {
	...
	protected LTriFuncDeltaX(LTriFunctionX<T1, T2, T3, R, X> function, LBinaryOperatorX<R, X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LTriFuncDeltaX(R initialValue, LTriFunctionX<T1, T2, T3, R, X> function, LBinaryOperatorX<R, X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <T1, T2, T3, R, X extends Throwable> LTriFuncDeltaX<T1, T2, T3, R, X> deltaOf(LTriFunctionX<T1, T2, T3, R, X> function, LBinaryOperatorX<R, X> deltaFunction) {
		return new LTriFuncDeltaX<T1, T2, T3, R, X>(function, deltaFunction);
	}

	public static <T1, T2, T3, R, X extends Throwable> LTriFuncDeltaX<T1, T2, T3, R, X> deltaOf(R initialValue, LTriFunctionX<T1, T2, T3, R, X> function, LBinaryOperatorX<R, X> deltaFunction) {
