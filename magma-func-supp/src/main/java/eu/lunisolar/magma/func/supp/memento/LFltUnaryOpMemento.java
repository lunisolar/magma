...
public class LFltUnaryOpMemento implements LFltUnaryOperator {

	protected float lastValue;

	protected LFltUnaryOperator function;

	protected LFltUnaryOpMemento(LFltUnaryOperator function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LFltUnaryOpMemento(float initialValue, LFltUnaryOperator function) {
		this(function);
	...
	public static boolean argEquals(LFltUnaryOpMemento the, Object that) {
		return Null.<LFltUnaryOpMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LFltUnaryOpMemento other = (LFltUnaryOpMemento) two;
