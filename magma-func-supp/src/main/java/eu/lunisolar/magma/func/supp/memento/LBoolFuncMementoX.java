...
public class LBoolFuncMementoX<R, X extends Throwable> implements LBoolFunctionX<R, X> {

	protected R lastValue;

	protected LBoolFunctionX<R, X> function;
	...
	public static boolean argEquals(LBoolFuncMementoX the, Object that) {
		return Null.<LBoolFuncMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LBoolFuncMementoX other = (LBoolFuncMementoX) two;
