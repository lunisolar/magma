...
public class LFuncMementoX<T, R, X extends Throwable> implements LFunctionX<T, R, X> {

	protected R lastValue;

	protected LFunctionX<T, R, X> function;
	...
	public static boolean argEquals(LFuncMementoX the, Object that) {
		return Null.<LFuncMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LFuncMementoX other = (LFuncMementoX) two;
