...
public class LBoolToByteFuncDeltaX<X extends Throwable> extends LBoolToByteFuncMementoX<X> {

	protected final LByteBinaryOperatorX<X> deltaFunction;

	protected LBoolToByteFuncDeltaX(LBoolToByteFunctionX<X> function, LByteBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LBoolToByteFuncDeltaX(byte initialValue, LBoolToByteFunctionX<X> function, LByteBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LBoolToByteFuncDeltaX<X> deltaOf(LBoolToByteFunctionX<X> function, LByteBinaryOperatorX<X> deltaFunction) {
		return new LBoolToByteFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LBoolToByteFuncDeltaX<X> deltaOf(byte initialValue, LBoolToByteFunctionX<X> function, LByteBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LBoolToByteFuncDeltaX the, Object that) {
		return Null.<LBoolToByteFuncDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LBoolToByteFuncDeltaX other = (LBoolToByteFuncDeltaX) two;
