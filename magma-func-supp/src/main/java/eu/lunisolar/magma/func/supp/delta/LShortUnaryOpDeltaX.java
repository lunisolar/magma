...
public class LShortUnaryOpDeltaX<X extends Throwable> extends LShortUnaryOpMementoX<X> {

	protected final LShortBinaryOperatorX<X> deltaFunction;

	protected LShortUnaryOpDeltaX(LShortUnaryOperatorX<X> function, LShortBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LShortUnaryOpDeltaX(short initialValue, LShortUnaryOperatorX<X> function, LShortBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LShortUnaryOpDeltaX<X> deltaOf(LShortUnaryOperatorX<X> function, LShortBinaryOperatorX<X> deltaFunction) {
		return new LShortUnaryOpDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LShortUnaryOpDeltaX<X> deltaOf(short initialValue, LShortUnaryOperatorX<X> function, LShortBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LShortUnaryOpDeltaX the, Object that) {
		return Null.<LShortUnaryOpDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LShortUnaryOpDeltaX other = (LShortUnaryOpDeltaX) two;
