...
public interface AccessLong {
	...
	default void useWith(long a1, LBiLongConsumer.V1 accessFunction) {
		long tuple = accessLong();
	...
	default <T1, T2> void useWith(T1 a1, T2 a2, LBiObjLongConsumer.V1<T1, T2> accessFunction) {
		long tuple = accessLong();
		accessFunction.doAcceptV1(a1, tuple, a2);
	}

	default <T1, T2> void useWith(T1 a1, T2 a2, LBiObjLongConsumer.V4<T1, T2> accessFunction) {
		long tuple = accessLong();
	...
	default <T> void useWith(T a1, LObjLongConsumer.V1<T> accessFunction) {
		long tuple = accessLong();
		accessFunction.doAcceptV1(tuple, a1);
	}
	...
	default double useWith(LLongToDoubleFunction accessFunction) {
		long tuple = accessLong();
	...
	default float useWith(LLongToFloatFunction accessFunction) {
		long tuple = accessLong();
	...
	default short useWith(LLongToShortFunction accessFunction) {
		long tuple = accessLong();
	...
	default <R> R useWith(long a1, LBiLongFunction.V1<R> accessFunction) {
		long tuple = accessLong();
	...
	default <R, T1, T2> R useWith(T1 a1, T2 a2, LBiObjLongFunction.V1<T1, T2, R> accessFunction) {
		long tuple = accessLong();
	...
	default <R, T1, T2> R useWith(T1 a1, T2 a2, LBiObjLongFunction.V4<T1, T2, R> accessFunction) {
		long tuple = accessLong();
	...
	default <R, T> R useWith(T a1, LObjLongFunction.V1<T, R> accessFunction) {
		long tuple = accessLong();
		R retval = accessFunction.doApplyV1(tuple, a1);
		releaseLong(tuple);
		return retval;
	...
	default boolean useWith(long a1, LBiLongPredicate.V1 accessFunction) {
		long tuple = accessLong();
	...
	default <T1, T2> boolean useWith(T1 a1, T2 a2, LBiObjLongPredicate.V1<T1, T2> accessFunction) {
		long tuple = accessLong();
	...
	default <T1, T2> boolean useWith(T1 a1, T2 a2, LBiObjLongPredicate.V4<T1, T2> accessFunction) {
		long tuple = accessLong();
	...
	default <T> boolean useWith(T a1, LObjLongPredicate.V1<T> accessFunction) {
		long tuple = accessLong();
		boolean retval = accessFunction.doTestV1(tuple, a1);
		releaseLong(tuple);
		return retval;
