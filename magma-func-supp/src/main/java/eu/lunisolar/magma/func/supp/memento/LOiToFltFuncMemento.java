...
public class LOiToFltFuncMemento<T> implements LOiToFltFunction<T> {

	protected float lastValue;

	protected LOiToFltFunction<T> function;

	protected LOiToFltFuncMemento(LOiToFltFunction<T> function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LOiToFltFuncMemento(float initialValue, LOiToFltFunction<T> function) {
		this(function);
	...
	public static boolean argEquals(LOiToFltFuncMemento the, Object that) {
		return Null.<LOiToFltFuncMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LOiToFltFuncMemento other = (LOiToFltFuncMemento) two;
