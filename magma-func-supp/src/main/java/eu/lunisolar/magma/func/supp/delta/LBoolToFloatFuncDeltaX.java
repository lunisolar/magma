...
public class LBoolToFloatFuncDeltaX<X extends Throwable> extends LBoolToFloatFuncMementoX<X> {

	protected final LFloatBinaryOperatorX<X> deltaFunction;

	protected LBoolToFloatFuncDeltaX(LBoolToFloatFunctionX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LBoolToFloatFuncDeltaX(float initialValue, LBoolToFloatFunctionX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LBoolToFloatFuncDeltaX<X> deltaOf(LBoolToFloatFunctionX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
		return new LBoolToFloatFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LBoolToFloatFuncDeltaX<X> deltaOf(float initialValue, LBoolToFloatFunctionX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LBoolToFloatFuncDeltaX the, Object that) {
		return Null.<LBoolToFloatFuncDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LBoolToFloatFuncDeltaX other = (LBoolToFloatFuncDeltaX) two;
