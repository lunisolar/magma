...
public class LLongSupDeltaX<X extends Throwable> extends LLongSupMementoX<X> {

	protected final LLongBinaryOperatorX<X> deltaFunction;

	protected LLongSupDeltaX(LLongSupplierX<X> function, LLongBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LLongSupDeltaX(long initialValue, LLongSupplierX<X> function, LLongBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LLongSupDeltaX<X> deltaOf(LLongSupplierX<X> function, LLongBinaryOperatorX<X> deltaFunction) {
		return new LLongSupDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LLongSupDeltaX<X> deltaOf(long initialValue, LLongSupplierX<X> function, LLongBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LLongSupDeltaX the, Object that) {
		return Null.<LLongSupDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LLongSupDeltaX other = (LLongSupDeltaX) two;
