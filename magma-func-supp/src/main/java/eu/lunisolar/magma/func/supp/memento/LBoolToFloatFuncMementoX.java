...
public class LBoolToFloatFuncMementoX<X extends Throwable> implements LBoolToFloatFunctionX<X> {

	protected float lastValue;

	protected LBoolToFloatFunctionX<X> function;
	...
	public static boolean argEquals(LBoolToFloatFuncMementoX the, Object that) {
		return Null.<LBoolToFloatFuncMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LBoolToFloatFuncMementoX other = (LBoolToFloatFuncMementoX) two;
