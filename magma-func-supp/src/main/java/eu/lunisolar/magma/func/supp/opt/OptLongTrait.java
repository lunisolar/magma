...
public interface OptLongTrait<SELF extends OptLongTrait<SELF>> extends FluentTrait<SELF>, aValue<aLong>, CheckLongTrait<SELF>, FilterLongSingleTrait<SELF>, IsLongTrait<SELF>, DoIfLongSingleTrait<SELF>, UseLongSingleTrait<SELF> {
	...
	default @Nonnull <R, K> Opt<R> flatMapToObj_(K a1, @Nonnull LObjLongFunction.LLongObjFunc<? super K, ? extends OptTrait<? extends R, ?>> mapping) {
		Null.nonNullArg(mapping, "mapping");
		return isPresent() ? Opt.from(mapping.applyLongObj(get(), a1)) : Opt.empty();
	}

	default @Nonnull <R, K1, K2> Opt<R> flatMapToObj_(K1 a1, K2 a2, @Nonnull LBiObjLongFunction.LLong2Obj0Obj1Func<? super K1, ? super K2, ? extends OptTrait<? extends R, ?>> mapping) {
		Null.nonNullArg(mapping, "mapping");
	...
	default @Nonnull <R, K1, K2> Opt<R> flatMapToObjWith(K1 a1, K2 a2, @Nonnull LBiObjLongFunction<? super K1, ? super K2, ? extends OptTrait<? extends R, ?>> mapping) {
		Null.nonNullArg(mapping, "mapping");
