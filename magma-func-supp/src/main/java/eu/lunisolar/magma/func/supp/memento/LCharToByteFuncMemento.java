...
public class LCharToByteFuncMemento implements LCharToByteFunction {

	protected byte lastValue;

	protected LCharToByteFunction function;

	protected LCharToByteFuncMemento(LCharToByteFunction function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LCharToByteFuncMemento(byte initialValue, LCharToByteFunction function) {
		this(function);
	...
	public static boolean argEquals(LCharToByteFuncMemento the, Object that) {
		return Null.<LCharToByteFuncMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LCharToByteFuncMemento other = (LCharToByteFuncMemento) two;
