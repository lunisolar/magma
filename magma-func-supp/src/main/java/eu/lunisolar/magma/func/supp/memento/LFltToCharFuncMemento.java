...
public class LFltToCharFuncMemento implements LFltToCharFunction {

	protected char lastValue;

	protected LFltToCharFunction function;

	protected LFltToCharFuncMemento(LFltToCharFunction function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LFltToCharFuncMemento(char initialValue, LFltToCharFunction function) {
		this(function);
	...
	public static boolean argEquals(LFltToCharFuncMemento the, Object that) {
		return Null.<LFltToCharFuncMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LFltToCharFuncMemento other = (LFltToCharFuncMemento) two;
