...
public class LLongBinaryOpMementoX<X extends Throwable> implements LLongBinaryOperatorX<X> {

	protected long lastValue;

	protected LLongBinaryOperatorX<X> function;
	...
	public static boolean argEquals(LLongBinaryOpMementoX the, Object that) {
		return Null.<LLongBinaryOpMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LLongBinaryOpMementoX other = (LLongBinaryOpMementoX) two;
