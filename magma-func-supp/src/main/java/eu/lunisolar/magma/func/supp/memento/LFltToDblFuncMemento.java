...
public class LFltToDblFuncMemento implements LFltToDblFunction {

	protected double lastValue;

	protected LFltToDblFunction function;

	protected LFltToDblFuncMemento(LFltToDblFunction function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LFltToDblFuncMemento(double initialValue, LFltToDblFunction function) {
		this(function);
	...
	public static boolean argEquals(LFltToDblFuncMemento the, Object that) {
		return Null.<LFltToDblFuncMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LFltToDblFuncMemento other = (LFltToDblFuncMemento) two;
