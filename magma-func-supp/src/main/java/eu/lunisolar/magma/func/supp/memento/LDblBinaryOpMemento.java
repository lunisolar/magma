...
public class LDblBinaryOpMemento implements LDblBinaryOperator {

	protected double lastValue;

	protected LDblBinaryOperator function;

	protected LDblBinaryOpMemento(LDblBinaryOperator function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LDblBinaryOpMemento(double initialValue, LDblBinaryOperator function) {
		this(function);
	...
	public static boolean argEquals(LDblBinaryOpMemento the, Object that) {
		return Null.<LDblBinaryOpMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LDblBinaryOpMemento other = (LDblBinaryOpMemento) two;
