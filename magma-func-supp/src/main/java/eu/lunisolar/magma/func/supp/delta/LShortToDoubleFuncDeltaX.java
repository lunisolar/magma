...
public class LShortToDoubleFuncDeltaX<X extends Throwable> extends LShortToDoubleFuncMementoX<X> {

	protected final LDoubleBinaryOperatorX<X> deltaFunction;

	protected LShortToDoubleFuncDeltaX(LShortToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LShortToDoubleFuncDeltaX(double initialValue, LShortToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LShortToDoubleFuncDeltaX<X> deltaOf(LShortToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
		return new LShortToDoubleFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LShortToDoubleFuncDeltaX<X> deltaOf(double initialValue, LShortToDoubleFunctionX<X> function, LDoubleBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LShortToDoubleFuncDeltaX the, Object that) {
		return Null.<LShortToDoubleFuncDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LShortToDoubleFuncDeltaX other = (LShortToDoubleFuncDeltaX) two;
