...
public class LBoolSupMementoX<X extends Throwable> implements LBoolSupplierX<X> {

	protected boolean lastValue;

	protected LBoolSupplierX<X> function;
	...
	public static boolean argEquals(LBoolSupMementoX the, Object that) {
		return Null.<LBoolSupMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LBoolSupMementoX other = (LBoolSupMementoX) two;
