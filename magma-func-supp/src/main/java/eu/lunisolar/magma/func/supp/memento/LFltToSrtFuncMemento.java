...
public class LFltToSrtFuncMemento implements LFltToSrtFunction {

	protected short lastValue;

	protected LFltToSrtFunction function;

	protected LFltToSrtFuncMemento(LFltToSrtFunction function) {
		Null.nonNullArg(function, "function");
		this.function = function;
	}

	protected LFltToSrtFuncMemento(short initialValue, LFltToSrtFunction function) {
		this(function);
	...
	public static boolean argEquals(LFltToSrtFuncMemento the, Object that) {
		return Null.<LFltToSrtFuncMemento> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LFltToSrtFuncMemento other = (LFltToSrtFuncMemento) two;
