...
public class LIntToFloatFuncDeltaX<X extends Throwable> extends LIntToFloatFuncMementoX<X> {

	protected final LFloatBinaryOperatorX<X> deltaFunction;

	protected LIntToFloatFuncDeltaX(LIntToFloatFunctionX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LIntToFloatFuncDeltaX(float initialValue, LIntToFloatFunctionX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LIntToFloatFuncDeltaX<X> deltaOf(LIntToFloatFunctionX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
		return new LIntToFloatFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LIntToFloatFuncDeltaX<X> deltaOf(float initialValue, LIntToFloatFunctionX<X> function, LFloatBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LIntToFloatFuncDeltaX the, Object that) {
		return Null.<LIntToFloatFuncDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LIntToFloatFuncDeltaX other = (LIntToFloatFuncDeltaX) two;
