...
public class LBiByteFuncMementoX<R, X extends Throwable> implements LBiByteFunctionX<R, X> {

	protected R lastValue;

	protected LBiByteFunctionX<R, X> function;
	...
	public static boolean argEquals(LBiByteFuncMementoX the, Object that) {
		return Null.<LBiByteFuncMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LBiByteFuncMementoX other = (LBiByteFuncMementoX) two;
