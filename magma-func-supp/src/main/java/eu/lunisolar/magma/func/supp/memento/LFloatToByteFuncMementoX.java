...
public class LFloatToByteFuncMementoX<X extends Throwable> implements LFloatToByteFunctionX<X> {

	protected byte lastValue;

	protected LFloatToByteFunctionX<X> function;
	...
	public static boolean argEquals(LFloatToByteFuncMementoX the, Object that) {
		return Null.<LFloatToByteFuncMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LFloatToByteFuncMementoX other = (LFloatToByteFuncMementoX) two;
