...
public class LDblToIntFuncDelta extends LDblToIntFuncMemento {

	protected final LIntBinaryOperator deltaFunction;

	protected LDblToIntFuncDelta(LDblToIntFunction function, LIntBinaryOperator deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LDblToIntFuncDelta(int initialValue, LDblToIntFunction function, LIntBinaryOperator deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static LDblToIntFuncDelta deltaOf(LDblToIntFunction function, LIntBinaryOperator deltaFunction) {
		return new LDblToIntFuncDelta(function, deltaFunction);
	}

	public static LDblToIntFuncDelta deltaOf(int initialValue, LDblToIntFunction function, LIntBinaryOperator deltaFunction) {
	...
	public static LDblToIntFuncDelta deltaOf(int initialValue, LDblToIntFunction function) {
		return deltaOf(initialValue, function, LDblToIntFuncDelta::mathDelta);
	}
	...
	public static boolean argEquals(LDblToIntFuncDelta the, Object that) {
		return Null.<LDblToIntFuncDelta> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LDblToIntFuncDelta other = (LDblToIntFuncDelta) two;
