...
public class LIntToShortFuncDeltaX<X extends Throwable> extends LIntToShortFuncMementoX<X> {

	protected final LShortBinaryOperatorX<X> deltaFunction;

	protected LIntToShortFuncDeltaX(LIntToShortFunctionX<X> function, LShortBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LIntToShortFuncDeltaX(short initialValue, LIntToShortFunctionX<X> function, LShortBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LIntToShortFuncDeltaX<X> deltaOf(LIntToShortFunctionX<X> function, LShortBinaryOperatorX<X> deltaFunction) {
		return new LIntToShortFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LIntToShortFuncDeltaX<X> deltaOf(short initialValue, LIntToShortFunctionX<X> function, LShortBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LIntToShortFuncDeltaX the, Object that) {
		return Null.<LIntToShortFuncDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LIntToShortFuncDeltaX other = (LIntToShortFuncDeltaX) two;
