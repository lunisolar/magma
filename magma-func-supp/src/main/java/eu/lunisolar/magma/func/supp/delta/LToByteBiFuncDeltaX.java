...
public class LToByteBiFuncDeltaX<T1, T2, X extends Throwable> extends LToByteBiFuncMementoX<T1, T2, X> {
	...
	protected LToByteBiFuncDeltaX(LToByteBiFunctionX<T1, T2, X> function, LByteBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LToByteBiFuncDeltaX(byte initialValue, LToByteBiFunctionX<T1, T2, X> function, LByteBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <T1, T2, X extends Throwable> LToByteBiFuncDeltaX<T1, T2, X> deltaOf(LToByteBiFunctionX<T1, T2, X> function, LByteBinaryOperatorX<X> deltaFunction) {
		return new LToByteBiFuncDeltaX<T1, T2, X>(function, deltaFunction);
	}

	public static <T1, T2, X extends Throwable> LToByteBiFuncDeltaX<T1, T2, X> deltaOf(byte initialValue, LToByteBiFunctionX<T1, T2, X> function, LByteBinaryOperatorX<X> deltaFunction) {
