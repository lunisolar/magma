...
public class LLongToIntFuncDeltaX<X extends Throwable> extends LLongToIntFuncMementoX<X> {

	protected final LIntBinaryOperatorX<X> deltaFunction;

	protected LLongToIntFuncDeltaX(LLongToIntFunctionX<X> function, LIntBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LLongToIntFuncDeltaX(int initialValue, LLongToIntFunctionX<X> function, LIntBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LLongToIntFuncDeltaX<X> deltaOf(LLongToIntFunctionX<X> function, LIntBinaryOperatorX<X> deltaFunction) {
		return new LLongToIntFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LLongToIntFuncDeltaX<X> deltaOf(int initialValue, LLongToIntFunctionX<X> function, LIntBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LLongToIntFuncDeltaX the, Object that) {
		return Null.<LLongToIntFuncDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LLongToIntFuncDeltaX other = (LLongToIntFuncDeltaX) two;
