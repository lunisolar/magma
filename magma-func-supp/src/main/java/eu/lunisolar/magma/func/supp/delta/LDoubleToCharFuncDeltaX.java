...
public class LDoubleToCharFuncDeltaX<X extends Throwable> extends LDoubleToCharFuncMementoX<X> {

	protected final LCharBinaryOperatorX<X> deltaFunction;

	protected LDoubleToCharFuncDeltaX(LDoubleToCharFunctionX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LDoubleToCharFuncDeltaX(char initialValue, LDoubleToCharFunctionX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LDoubleToCharFuncDeltaX<X> deltaOf(LDoubleToCharFunctionX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
		return new LDoubleToCharFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LDoubleToCharFuncDeltaX<X> deltaOf(char initialValue, LDoubleToCharFunctionX<X> function, LCharBinaryOperatorX<X> deltaFunction) {
	...
	public static boolean argEquals(LDoubleToCharFuncDeltaX the, Object that) {
		return Null.<LDoubleToCharFuncDeltaX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LDoubleToCharFuncDeltaX other = (LDoubleToCharFuncDeltaX) two;
