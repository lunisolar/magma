...
public class LazyIntValue extends LIntSupMemento implements LIntSingle {

	protected LazyIntValue(LIntSupplier function) {
		super(function);
	}

	public static LazyIntValue lazyValue(LIntSupplier supplier) {
	...
	public static boolean argEquals(LazyIntValue the, Object that) {
