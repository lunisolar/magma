...
public class LIntToCharFuncMementoX<X extends Throwable> implements LIntToCharFunctionX<X> {

	protected char lastValue;

	protected LIntToCharFunctionX<X> function;
	...
	public static boolean argEquals(LIntToCharFuncMementoX the, Object that) {
		return Null.<LIntToCharFuncMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LIntToCharFuncMementoX other = (LIntToCharFuncMementoX) two;
