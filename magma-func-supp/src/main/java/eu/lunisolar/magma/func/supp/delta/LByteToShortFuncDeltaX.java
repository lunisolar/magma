...
public class LByteToShortFuncDeltaX<X extends Throwable> extends LByteToShortFuncMementoX<X> {
	...
	protected LByteToShortFuncDeltaX(LByteToShortFunctionX<X> function, LShortBinaryOperatorX<X> deltaFunction) {
		super(function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	protected LByteToShortFuncDeltaX(short initialValue, LByteToShortFunctionX<X> function, LShortBinaryOperatorX<X> deltaFunction) {
		super(initialValue, function);
		Null.nonNullArg(deltaFunction, "deltaFunction");
		this.deltaFunction = deltaFunction;
	}

	public static <X extends Throwable> LByteToShortFuncDeltaX<X> deltaOf(LByteToShortFunctionX<X> function, LShortBinaryOperatorX<X> deltaFunction) {
		return new LByteToShortFuncDeltaX<X>(function, deltaFunction);
	}

	public static <X extends Throwable> LByteToShortFuncDeltaX<X> deltaOf(short initialValue, LByteToShortFunctionX<X> function, LShortBinaryOperatorX<X> deltaFunction) {
