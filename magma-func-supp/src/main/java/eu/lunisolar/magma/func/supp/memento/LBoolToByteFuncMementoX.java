...
public class LBoolToByteFuncMementoX<X extends Throwable> implements LBoolToByteFunctionX<X> {

	protected byte lastValue;

	protected LBoolToByteFunctionX<X> function;
	...
	public static boolean argEquals(LBoolToByteFuncMementoX the, Object that) {
		return Null.<LBoolToByteFuncMementoX> equals(the, that, (one, two) -> {
			if (one.getClass() != two.getClass()) {
				return false;
			}

			LBoolToByteFuncMementoX other = (LBoolToByteFuncMementoX) two;
