...
public class LQuadFuncDeltaTest <T1,T2,T3,T4,R> {
    ...
    private LQuadFuncDelta<Integer,Integer,Integer,Integer,Integer> sut =  LQuadFuncDelta.<Integer,Integer,Integer,Integer,Integer>deltaOf(initialLastValue, (a1,a2,a3,a4) ->{
        functionCallCount++;
        return testValue;
