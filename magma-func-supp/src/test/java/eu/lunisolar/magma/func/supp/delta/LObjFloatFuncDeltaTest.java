...
public class LObjFloatFuncDeltaTest <T,R> {
    ...
    private LObjFloatFuncDelta<Integer,Integer> sut =  LObjFloatFuncDelta.<Integer,Integer>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
