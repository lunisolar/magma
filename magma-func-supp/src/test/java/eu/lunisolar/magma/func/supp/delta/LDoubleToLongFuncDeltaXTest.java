...
public class LDoubleToLongFuncDeltaXTest <X extends Throwable> {
    ...
    private LDoubleToLongFuncDeltaX<X> sut =  LDoubleToLongFuncDeltaX.<X>deltaOf(initialLastValue, a1 ->{
        functionCallCount++;
        return testValue;
    });
