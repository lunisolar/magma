...
public class LObjIntBoolFuncDeltaTest <T,R> {
    ...
    private LObjIntBoolFuncDelta<Integer,Integer> sut =  LObjIntBoolFuncDelta.<Integer,Integer>deltaOf(initialLastValue, (a1,a2,a3) ->{
        functionCallCount++;
        return testValue;
