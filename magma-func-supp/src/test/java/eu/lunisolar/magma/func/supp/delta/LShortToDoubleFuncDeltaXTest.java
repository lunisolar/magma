...
public class LShortToDoubleFuncDeltaXTest <X extends Throwable> {
    ...
    private LShortToDoubleFuncDeltaX<X> sut =  LShortToDoubleFuncDeltaX.<X>deltaOf(initialLastValue, a ->{
        functionCallCount++;
        return testValue;
    });
