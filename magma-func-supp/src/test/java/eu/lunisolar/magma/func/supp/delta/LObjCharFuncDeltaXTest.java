...
public class LObjCharFuncDeltaXTest <T,R,X extends Throwable> {
    ...
    private LObjCharFuncDeltaX<Integer,Integer,X> sut =  LObjCharFuncDeltaX.<Integer,Integer,X>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
