...
public class LObjIntFltFuncDeltaTest <T,R> {
    ...
    private LObjIntFltFuncDelta<Integer,Integer> sut =  LObjIntFltFuncDelta.<Integer,Integer>deltaOf(initialLastValue, (a1,a2,a3) ->{
        functionCallCount++;
        return testValue;
