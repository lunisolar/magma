...
public class LObjShortFuncDeltaXTest <T,R,X extends Throwable> {
    ...
    private LObjShortFuncDeltaX<Integer,Integer,X> sut =  LObjShortFuncDeltaX.<Integer,Integer,X>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
