...
public class LToByteBiFuncDeltaTest <T1,T2> {
    ...
    private LToByteBiFuncDelta<Integer,Integer> sut =  LToByteBiFuncDelta.<Integer,Integer>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
    });
