...
public class LObjShortFuncDeltaTest <T,R> {
    ...
    private LObjShortFuncDelta<Integer,Integer> sut =  LObjShortFuncDelta.<Integer,Integer>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
