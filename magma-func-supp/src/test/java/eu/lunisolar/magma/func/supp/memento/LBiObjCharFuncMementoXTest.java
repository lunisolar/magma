...
public class LBiObjCharFuncMementoXTest<T1,T2,R,X extends Throwable> {

    private int functionCallCount = 0;
    private R initialTestValue = (R)Integer.valueOf(1);
    private R testValue = initialTestValue;

    private LBiObjCharFuncMementoX<T1,T2,R,X> sut =  LBiObjCharFuncMementoX.<T1,T2,R,X>mementoOf( (a1,a2,a3) ->{
        functionCallCount++;
        return testValue;
    });
