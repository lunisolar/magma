...
public class LToDoubleBiFuncDeltaXTest <T1,T2,X extends Throwable> {
    ...
    private LToDoubleBiFuncDeltaX<Integer,Integer,X> sut =  LToDoubleBiFuncDeltaX.<Integer,Integer,X>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
    });
