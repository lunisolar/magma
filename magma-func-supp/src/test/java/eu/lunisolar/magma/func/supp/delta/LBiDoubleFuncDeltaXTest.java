...
public class LBiDoubleFuncDeltaXTest <R,X extends Throwable> {
    ...
    private LBiDoubleFuncDeltaX<Integer,X> sut =  LBiDoubleFuncDeltaX.<Integer,X>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
