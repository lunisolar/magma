...
public class LObjByteFuncDeltaXTest <T,R,X extends Throwable> {
    ...
    private LObjByteFuncDeltaX<Integer,Integer,X> sut =  LObjByteFuncDeltaX.<Integer,Integer,X>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
