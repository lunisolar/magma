...
public class LDoubleToFloatFuncDeltaXTest <X extends Throwable> {
    ...
    private LDoubleToFloatFuncDeltaX<X> sut =  LDoubleToFloatFuncDeltaX.<X>deltaOf(initialLastValue, a1 ->{
        functionCallCount++;
        return testValue;
    });
