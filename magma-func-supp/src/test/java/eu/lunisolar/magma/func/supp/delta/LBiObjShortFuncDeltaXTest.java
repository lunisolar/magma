...
public class LBiObjShortFuncDeltaXTest <T1,T2,R,X extends Throwable> {
    ...
    private LBiObjShortFuncDeltaX<Integer,Integer,Integer,X> sut =  LBiObjShortFuncDeltaX.<Integer,Integer,Integer,X>deltaOf(initialLastValue, (a1,a2,a3) ->{
        functionCallCount++;
        return testValue;
