...
public class LBiObjBoolFuncDeltaTest <T1,T2,R> {
    ...
    private LBiObjBoolFuncDelta<Integer,Integer,Integer> sut =  LBiObjBoolFuncDelta.<Integer,Integer,Integer>deltaOf(initialLastValue, (a1,a2,a3) ->{
        functionCallCount++;
        return testValue;
