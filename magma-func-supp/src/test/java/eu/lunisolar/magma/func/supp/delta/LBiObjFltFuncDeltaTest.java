...
public class LBiObjFltFuncDeltaTest <T1,T2,R> {
    ...
    private LBiObjFltFuncDelta<Integer,Integer,Integer> sut =  LBiObjFltFuncDelta.<Integer,Integer,Integer>deltaOf(initialLastValue, (a1,a2,a3) ->{
        functionCallCount++;
        return testValue;
