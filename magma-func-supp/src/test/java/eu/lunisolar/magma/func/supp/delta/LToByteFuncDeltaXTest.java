...
public class LToByteFuncDeltaXTest <T,X extends Throwable> {
    ...
    private LToByteFuncDeltaX<Integer,X> sut =  LToByteFuncDeltaX.<Integer,X>deltaOf(initialLastValue, a ->{
        functionCallCount++;
        return testValue;
    });
