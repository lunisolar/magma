...
public class LCharToDoubleFuncDeltaXTest<X extends Throwable> {
    ...
    private LCharToDoubleFuncDeltaX<X> sut =  LCharToDoubleFuncDeltaX.<X>deltaOf(initialLastValue, (a1) ->{
        functionCallCount++;
        return testValue;
    });
