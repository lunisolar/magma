...
public class LBiLongFuncDeltaXTest <R,X extends Throwable> {
    ...
    private LBiLongFuncDeltaX<Integer,X> sut =  LBiLongFuncDeltaX.<Integer,X>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
