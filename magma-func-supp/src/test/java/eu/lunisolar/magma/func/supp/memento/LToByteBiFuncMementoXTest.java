...
public class LToByteBiFuncMementoXTest <T1,T2,X extends Throwable> {

    private int functionCallCount = 0;
    private byte initialTestValue = (byte)1;
    private byte testValue = initialTestValue;

    private LToByteBiFuncMementoX<Integer,Integer,X> sut =  LToByteBiFuncMementoX.<Integer,Integer,X>mementoOf( (a1,a2) ->{
        functionCallCount++;
        return testValue;
    });
