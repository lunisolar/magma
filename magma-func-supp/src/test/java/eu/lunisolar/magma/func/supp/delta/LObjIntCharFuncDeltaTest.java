...
public class LObjIntCharFuncDeltaTest <T,R> {
    ...
    private LObjIntCharFuncDelta<Integer,Integer> sut =  LObjIntCharFuncDelta.<Integer,Integer>deltaOf(initialLastValue, (a1,a2,a3) ->{
        functionCallCount++;
        return testValue;
