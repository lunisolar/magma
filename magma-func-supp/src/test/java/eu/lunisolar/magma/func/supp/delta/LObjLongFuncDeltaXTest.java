...
public class LObjLongFuncDeltaXTest <T,R,X extends Throwable> {
    ...
    private LObjLongFuncDeltaX<Integer,Integer,X> sut =  LObjLongFuncDeltaX.<Integer,Integer,X>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
