...
public class LToCharBiFuncDeltaTest <T1,T2> {
    ...
    private LToCharBiFuncDelta<Integer,Integer> sut =  LToCharBiFuncDelta.<Integer,Integer>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
    });
