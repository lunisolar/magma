...
public class LTriFuncDeltaXTest<T1,T2,T3,R,X extends Throwable> {
    ...
    private LTriFuncDeltaX<T1,T2,T3,R,X> sut =  LTriFuncDeltaX.<T1,T2,T3,R,X>deltaOf(initialLastValue, (a1,a2,a3) ->{
        functionCallCount++;
        return testValue;
