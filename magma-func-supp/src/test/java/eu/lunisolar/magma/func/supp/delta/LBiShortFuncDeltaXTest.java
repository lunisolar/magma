...
public class LBiShortFuncDeltaXTest <R,X extends Throwable> {
    ...
    private LBiShortFuncDeltaX<Integer,X> sut =  LBiShortFuncDeltaX.<Integer,X>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
