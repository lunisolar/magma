...
public class LBoolToDoubleFuncDeltaXTest <X extends Throwable> {
    ...
    private LBoolToDoubleFuncDeltaX<X> sut =  LBoolToDoubleFuncDeltaX.<X>deltaOf(initialLastValue, a1 ->{
        functionCallCount++;
        return testValue;
    });
