...
public class LDoubleToShortFuncDeltaXTest<X extends Throwable> {
    ...
    private LDoubleToShortFuncDeltaX<X> sut =  LDoubleToShortFuncDeltaX.<X>deltaOf(initialLastValue, (a1) ->{
        functionCallCount++;
        return testValue;
    });
