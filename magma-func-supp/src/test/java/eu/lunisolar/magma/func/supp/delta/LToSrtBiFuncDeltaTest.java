...
public class LToSrtBiFuncDeltaTest <T1,T2> {
    ...
    private LToSrtBiFuncDelta<Integer,Integer> sut =  LToSrtBiFuncDelta.<Integer,Integer>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
    });
