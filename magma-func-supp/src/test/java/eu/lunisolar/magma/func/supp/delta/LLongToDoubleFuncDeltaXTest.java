...
public class LLongToDoubleFuncDeltaXTest<X extends Throwable> {
    ...
    private LLongToDoubleFuncDeltaX<X> sut =  LLongToDoubleFuncDeltaX.<X>deltaOf(initialLastValue, (a1) ->{
        functionCallCount++;
        return testValue;
    });
