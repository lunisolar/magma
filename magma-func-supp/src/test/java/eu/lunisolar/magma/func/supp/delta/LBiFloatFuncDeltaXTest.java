...
public class LBiFloatFuncDeltaXTest <R,X extends Throwable> {
    ...
    private LBiFloatFuncDeltaX<Integer,X> sut =  LBiFloatFuncDeltaX.<Integer,X>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
