...
public class LLogicalBinaryOpDeltaXTest<X extends Throwable> {
    ...
    private LLogicalBinaryOpDeltaX<X> sut =  LLogicalBinaryOpDeltaX.<X>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
    });
