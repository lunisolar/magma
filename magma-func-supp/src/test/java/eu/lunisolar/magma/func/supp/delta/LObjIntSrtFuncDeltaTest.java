...
public class LObjIntSrtFuncDeltaTest <T,R> {
    ...
    private LObjIntSrtFuncDelta<Integer,Integer> sut =  LObjIntSrtFuncDelta.<Integer,Integer>deltaOf(initialLastValue, (a1,a2,a3) ->{
        functionCallCount++;
        return testValue;
