...
public class LToIntTriFuncDeltaTest <T1,T2,T3> {
    ...
    private LToIntTriFuncDelta<Integer,Integer,Integer> sut =  LToIntTriFuncDelta.<Integer,Integer,Integer>deltaOf(initialLastValue, (a1,a2,a3) ->{
        functionCallCount++;
        return testValue;
    });
