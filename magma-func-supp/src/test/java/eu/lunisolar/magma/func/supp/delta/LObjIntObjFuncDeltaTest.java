...
public class LObjIntObjFuncDeltaTest <T1,T2,R> {
    ...
    private LObjIntObjFuncDelta<Integer,Integer,Integer> sut =  LObjIntObjFuncDelta.<Integer,Integer,Integer>deltaOf(initialLastValue, (a1,a2,a3) ->{
        functionCallCount++;
        return testValue;
