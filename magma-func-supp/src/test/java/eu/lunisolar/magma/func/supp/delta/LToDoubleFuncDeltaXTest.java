...
public class LToDoubleFuncDeltaXTest <T,X extends Throwable> {
    ...
    private LToDoubleFuncDeltaX<Integer,X> sut =  LToDoubleFuncDeltaX.<Integer,X>deltaOf(initialLastValue, a1 ->{
        functionCallCount++;
        return testValue;
    });
