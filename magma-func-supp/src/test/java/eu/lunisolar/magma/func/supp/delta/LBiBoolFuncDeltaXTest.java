...
public class LBiBoolFuncDeltaXTest <R,X extends Throwable> {
    ...
    private LBiBoolFuncDeltaX<Integer,X> sut =  LBiBoolFuncDeltaX.<Integer,X>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
