...
public class LTernaryOpDeltaXTest <T,X extends Throwable> {
    ...
    private LTernaryOpDeltaX<Integer,X> sut =  LTernaryOpDeltaX.<Integer,X>deltaOf(initialLastValue, (a1,a2,a3) ->{
        functionCallCount++;
        return testValue;
