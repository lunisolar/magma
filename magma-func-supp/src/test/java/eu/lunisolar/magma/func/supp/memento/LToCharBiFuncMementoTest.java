...
public class LToCharBiFuncMementoTest <T1,T2> {

    private int functionCallCount = 0;
    private char initialTestValue = '\u0001';
    private char testValue = initialTestValue;

    private LToCharBiFuncMemento<Integer,Integer> sut =  LToCharBiFuncMemento.<Integer,Integer>hollowMementoOf( (a1,a2) ->{
        functionCallCount++;
        return testValue;
    });
