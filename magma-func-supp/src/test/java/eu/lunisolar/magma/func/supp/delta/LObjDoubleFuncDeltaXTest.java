...
public class LObjDoubleFuncDeltaXTest <T,R,X extends Throwable> {
    ...
    private LObjDoubleFuncDeltaX<Integer,Integer,X> sut =  LObjDoubleFuncDeltaX.<Integer,Integer,X>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
