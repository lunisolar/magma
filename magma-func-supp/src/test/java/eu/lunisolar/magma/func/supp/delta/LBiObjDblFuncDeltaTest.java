...
public class LBiObjDblFuncDeltaTest <T1,T2,R> {
    ...
    private LBiObjDblFuncDelta<Integer,Integer,Integer> sut =  LBiObjDblFuncDelta.<Integer,Integer,Integer>deltaOf(initialLastValue, (a1,a2,a3) ->{
        functionCallCount++;
        return testValue;
