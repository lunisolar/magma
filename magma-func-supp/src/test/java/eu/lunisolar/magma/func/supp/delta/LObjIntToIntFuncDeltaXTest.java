...
public class LObjIntToIntFuncDeltaXTest <T,X extends Throwable> {
    ...
    private LObjIntToIntFuncDeltaX<Integer,X> sut =  LObjIntToIntFuncDeltaX.<Integer,X>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
    });
