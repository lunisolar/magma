...
public class LToIntBiFuncDeltaXTest <T1,T2,X extends Throwable> {
    ...
    private LToIntBiFuncDeltaX<Integer,Integer,X> sut =  LToIntBiFuncDeltaX.<Integer,Integer,X>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
    });
