...
public class LQuintFuncMementoTest <T1,T2,T3,T4,T5,R> {

    private int functionCallCount = 0;
    private Integer initialTestValue = 1;
    private Integer testValue = initialTestValue;

    private LQuintFuncMemento<Integer,Integer,Integer,Integer,Integer,Integer> sut =  LQuintFuncMemento.<Integer,Integer,Integer,Integer,Integer,Integer>hollowMementoOf( (a1,a2,a3,a4,a5) ->{
        functionCallCount++;
        return testValue;
    });
