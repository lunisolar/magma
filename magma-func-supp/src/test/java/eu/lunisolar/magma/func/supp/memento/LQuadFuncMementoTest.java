...
public class LQuadFuncMementoTest <T1,T2,T3,T4,R> {

    private int functionCallCount = 0;
    private Integer initialTestValue = 1;
    private Integer testValue = initialTestValue;

    private LQuadFuncMemento<Integer,Integer,Integer,Integer,Integer> sut =  LQuadFuncMemento.<Integer,Integer,Integer,Integer,Integer>hollowMementoOf( (a1,a2,a3,a4) ->{
        functionCallCount++;
        return testValue;
    });
