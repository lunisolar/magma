...
public class LToByteBiFuncDeltaXTest <T1,T2,X extends Throwable> {
    ...
    private LToByteBiFuncDeltaX<Integer,Integer,X> sut =  LToByteBiFuncDeltaX.<Integer,Integer,X>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
    });
