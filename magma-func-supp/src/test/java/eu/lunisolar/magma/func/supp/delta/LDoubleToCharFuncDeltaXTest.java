...
public class LDoubleToCharFuncDeltaXTest <X extends Throwable> {
    ...
    private LDoubleToCharFuncDeltaX<X> sut =  LDoubleToCharFuncDeltaX.<X>deltaOf(initialLastValue, a ->{
        functionCallCount++;
        return testValue;
    });
