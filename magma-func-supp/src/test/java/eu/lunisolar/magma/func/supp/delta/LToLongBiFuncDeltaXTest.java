...
public class LToLongBiFuncDeltaXTest <T1,T2,X extends Throwable> {
    ...
    private LToLongBiFuncDeltaX<Integer,Integer,X> sut =  LToLongBiFuncDeltaX.<Integer,Integer,X>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
    });
