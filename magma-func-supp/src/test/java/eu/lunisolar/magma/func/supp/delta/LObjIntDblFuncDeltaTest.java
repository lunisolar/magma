...
public class LObjIntDblFuncDeltaTest <T,R> {
    ...
    private LObjIntDblFuncDelta<Integer,Integer> sut =  LObjIntDblFuncDelta.<Integer,Integer>deltaOf(initialLastValue, (a1,a2,a3) ->{
        functionCallCount++;
        return testValue;
