...
public class LQuintFuncDeltaTest <T1,T2,T3,T4,T5,R> {
    ...
    private LQuintFuncDelta<Integer,Integer,Integer,Integer,Integer,Integer> sut =  LQuintFuncDelta.<Integer,Integer,Integer,Integer,Integer,Integer>deltaOf(initialLastValue, (a1,a2,a3,a4,a5) ->{
        functionCallCount++;
        return testValue;
