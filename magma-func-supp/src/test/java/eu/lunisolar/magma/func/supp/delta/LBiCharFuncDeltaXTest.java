...
public class LBiCharFuncDeltaXTest <R,X extends Throwable> {
    ...
    private LBiCharFuncDeltaX<Integer,X> sut =  LBiCharFuncDeltaX.<Integer,X>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
