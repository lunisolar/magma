...
public class LToDblBiFuncDeltaTest <T1,T2> {
    ...
    private LToDblBiFuncDelta<Integer,Integer> sut =  LToDblBiFuncDelta.<Integer,Integer>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
    });
