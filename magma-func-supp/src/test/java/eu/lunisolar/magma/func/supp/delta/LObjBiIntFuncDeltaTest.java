...
public class LObjBiIntFuncDeltaTest <T,R> {
    ...
    private LObjBiIntFuncDelta<Integer,Integer> sut =  LObjBiIntFuncDelta.<Integer,Integer>deltaOf(initialLastValue, (a1,a2,a3) ->{
        functionCallCount++;
        return testValue;
