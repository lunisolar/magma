...
public class LBiObjDoubleFuncDeltaTest<T1,T2,R> {
    ...
    private LBiObjDoubleFuncDelta<T1,T2,R> sut =  LBiObjDoubleFuncDelta.<T1,T2,R>deltaOf(initialLastValue, (a1,a2,a3) ->{
        functionCallCount++;
        return testValue;
