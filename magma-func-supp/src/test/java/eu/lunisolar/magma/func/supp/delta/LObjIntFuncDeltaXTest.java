...
public class LObjIntFuncDeltaXTest <T,R,X extends Throwable> {
    ...
    private LObjIntFuncDeltaX<Integer,Integer,X> sut =  LObjIntFuncDeltaX.<Integer,Integer,X>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
