...
public class LToShortBiFuncDeltaXTest <T1,T2,X extends Throwable> {
    ...
    private LToShortBiFuncDeltaX<Integer,Integer,X> sut =  LToShortBiFuncDeltaX.<Integer,Integer,X>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
    });
