...
public class LDoubleToByteFuncDeltaXTest <X extends Throwable> {
    ...
    private LDoubleToByteFuncDeltaX<X> sut =  LDoubleToByteFuncDeltaX.<X>deltaOf(initialLastValue, a ->{
        functionCallCount++;
        return testValue;
    });
