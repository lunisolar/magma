...
public class LBiObjSrtFuncDeltaTest <T1,T2,R> {
    ...
    private LBiObjSrtFuncDelta<Integer,Integer,Integer> sut =  LBiObjSrtFuncDelta.<Integer,Integer,Integer>deltaOf(initialLastValue, (a1,a2,a3) ->{
        functionCallCount++;
        return testValue;
