...
public class LObjIntByteFuncDeltaTest <T,R> {
    ...
    private LObjIntByteFuncDelta<Integer,Integer> sut =  LObjIntByteFuncDelta.<Integer,Integer>deltaOf(initialLastValue, (a1,a2,a3) ->{
        functionCallCount++;
        return testValue;
