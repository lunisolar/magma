...
public class LBiObjFloatFuncDeltaTest <T1,T2,R> {
    ...
    private LBiObjFloatFuncDelta<Integer,Integer,Integer> sut =  LBiObjFloatFuncDelta.<Integer,Integer,Integer>deltaOf(initialLastValue, (a1,a2,a3) ->{
        functionCallCount++;
        return testValue;
