...
public class LObjFloatFuncDeltaXTest <T,R,X extends Throwable> {
    ...
    private LObjFloatFuncDeltaX<Integer,Integer,X> sut =  LObjFloatFuncDeltaX.<Integer,Integer,X>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
