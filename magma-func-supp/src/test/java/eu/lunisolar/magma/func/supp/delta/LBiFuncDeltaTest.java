...
public class LBiFuncDeltaTest <T1,T2,R> {
    ...
    private LBiFuncDelta<Integer,Integer,Integer> sut =  LBiFuncDelta.<Integer,Integer,Integer>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
