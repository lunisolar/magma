...
public class LToFltBiFuncDeltaTest <T1,T2> {
    ...
    private LToFltBiFuncDelta<Integer,Integer> sut =  LToFltBiFuncDelta.<Integer,Integer>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
    });
