...
public class LObjIntLongFuncDeltaTest <T,R> {
    ...
    private LObjIntLongFuncDelta<Integer,Integer> sut =  LObjIntLongFuncDelta.<Integer,Integer>deltaOf(initialLastValue, (a1,a2,a3) ->{
        functionCallCount++;
        return testValue;
