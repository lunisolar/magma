...
public class LToDoubleBiFuncDeltaTest <T1,T2> {
    ...
    private LToDoubleBiFuncDelta<Integer,Integer> sut =  LToDoubleBiFuncDelta.<Integer,Integer>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
    });
