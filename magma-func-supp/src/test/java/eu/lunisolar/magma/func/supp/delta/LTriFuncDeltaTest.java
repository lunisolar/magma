...
public class LTriFuncDeltaTest <T1,T2,T3,R> {
    ...
    private LTriFuncDelta<Integer,Integer,Integer,Integer> sut =  LTriFuncDelta.<Integer,Integer,Integer,Integer>deltaOf(initialLastValue, (a1,a2,a3) ->{
        functionCallCount++;
        return testValue;
