...
public class LBiFuncMementoTest <T1,T2,R> {

    private int functionCallCount = 0;
    private Integer initialTestValue = 1;
    private Integer testValue = initialTestValue;

    private LBiFuncMemento<Integer,Integer,Integer> sut =  LBiFuncMemento.<Integer,Integer,Integer>hollowMementoOf( (a1,a2) ->{
        functionCallCount++;
        return testValue;
    });
