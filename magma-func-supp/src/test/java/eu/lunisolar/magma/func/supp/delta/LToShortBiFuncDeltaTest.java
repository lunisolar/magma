...
public class LToShortBiFuncDeltaTest <T1,T2> {
    ...
    private LToShortBiFuncDelta<Integer,Integer> sut =  LToShortBiFuncDelta.<Integer,Integer>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
    });
