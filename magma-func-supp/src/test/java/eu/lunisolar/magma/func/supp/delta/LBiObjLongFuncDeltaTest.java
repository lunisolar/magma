...
public class LBiObjLongFuncDeltaTest <T1,T2,R> {
    ...
    private LBiObjLongFuncDelta<Integer,Integer,Integer> sut =  LBiObjLongFuncDelta.<Integer,Integer,Integer>deltaOf(initialLastValue, (a1,a2,a3) ->{
        functionCallCount++;
        return testValue;
