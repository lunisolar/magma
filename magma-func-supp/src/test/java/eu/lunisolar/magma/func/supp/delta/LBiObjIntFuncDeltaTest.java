...
public class LBiObjIntFuncDeltaTest <T1,T2,R> {
    ...
    private LBiObjIntFuncDelta<Integer,Integer,Integer> sut =  LBiObjIntFuncDelta.<Integer,Integer,Integer>deltaOf(initialLastValue, (a1,a2,a3) ->{
        functionCallCount++;
        return testValue;
