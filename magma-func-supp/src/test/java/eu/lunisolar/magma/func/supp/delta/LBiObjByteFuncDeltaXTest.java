...
public class LBiObjByteFuncDeltaXTest <T1,T2,R,X extends Throwable> {
    ...
    private LBiObjByteFuncDeltaX<Integer,Integer,Integer,X> sut =  LBiObjByteFuncDeltaX.<Integer,Integer,Integer,X>deltaOf(initialLastValue, (a1,a2,a3) ->{
        functionCallCount++;
        return testValue;
