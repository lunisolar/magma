...
public class LToLongFuncDeltaXTest <T,X extends Throwable> {
    ...
    private LToLongFuncDeltaX<Integer,X> sut =  LToLongFuncDeltaX.<Integer,X>deltaOf(initialLastValue, a1 ->{
        functionCallCount++;
        return testValue;
    });
