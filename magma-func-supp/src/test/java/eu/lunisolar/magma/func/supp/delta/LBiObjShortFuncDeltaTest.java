...
public class LBiObjShortFuncDeltaTest <T1,T2,R> {
    ...
    private LBiObjShortFuncDelta<Integer,Integer,Integer> sut =  LBiObjShortFuncDelta.<Integer,Integer,Integer>deltaOf(initialLastValue, (a1,a2,a3) ->{
        functionCallCount++;
        return testValue;
