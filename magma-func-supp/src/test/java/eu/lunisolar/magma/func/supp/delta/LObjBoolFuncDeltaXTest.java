...
public class LObjBoolFuncDeltaXTest <T,R,X extends Throwable> {
    ...
    private LObjBoolFuncDeltaX<Integer,Integer,X> sut =  LObjBoolFuncDeltaX.<Integer,Integer,X>deltaOf(initialLastValue, (a1,a2) ->{
        functionCallCount++;
        return testValue;
