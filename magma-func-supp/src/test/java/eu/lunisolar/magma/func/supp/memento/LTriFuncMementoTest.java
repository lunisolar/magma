...
public class LTriFuncMementoTest <T1,T2,T3,R> {

    private int functionCallCount = 0;
    private Integer initialTestValue = 1;
    private Integer testValue = initialTestValue;

    private LTriFuncMemento<Integer,Integer,Integer,Integer> sut =  LTriFuncMemento.<Integer,Integer,Integer,Integer>hollowMementoOf( (a1,a2,a3) ->{
        functionCallCount++;
        return testValue;
    });
