...
public interface LToIntTriFunctionAssert<S extends LToIntTriFunctionAssert<S, A, RS, T1, T2, T3>, A extends LToIntTriFunction<T1, T2, T3>, RS extends AbstractIntegerAssert<RS>, T1, T2, T3>
		extends
			Assert<S, A>,
	...
	@Nonnull
	Evaluation<S, LTriConsumer<T1, T2, T3>, A, RS, Integer> doesApplyAsInt(T1 a1, T2 a2, T3 a3);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LToIntTriFunction<T1, T2, T3>, RS extends AbstractIntegerAssert<RS>, T1, T2, T3> extends Base<The<A, RS, T1, T2, T3>, A, RS, T1, T2, T3> {
	...
	class Base<S extends Base<S, A, RS, T1, T2, T3>, A extends LToIntTriFunction<T1, T2, T3>, RS extends AbstractIntegerAssert<RS>, T1, T2, T3> extends FullFunctionalAssert.Base<S, LTriConsumer<T1, T2, T3>, A, RS, Integer>
			implements
				LToIntTriFunctionAssert<S, A, RS, T1, T2, T3> {
