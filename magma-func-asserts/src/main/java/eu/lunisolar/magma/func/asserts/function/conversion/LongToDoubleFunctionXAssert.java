...
/** Assertions for LongToDoubleFunctionX. */
public interface LongToDoubleFunctionXAssert<S extends LongToDoubleFunctionXAssert<S, A, RS, X>, A extends LongToDoubleFunctionX<X>, RS extends AbstractDoubleAssert<RS>, X extends Exception>
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends LongToDoubleFunctionX<X>, RS extends AbstractDoubleAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Double, Exception>
			implements
