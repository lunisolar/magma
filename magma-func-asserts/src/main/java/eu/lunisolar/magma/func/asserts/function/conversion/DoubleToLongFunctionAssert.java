...
/** Assertions for DoubleToLongFunction. */
public interface DoubleToLongFunctionAssert<S extends DoubleToLongFunctionAssert<S, A, RS>, A extends DoubleToLongFunction, RS extends AbstractLongAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends DoubleToLongFunction, RS extends AbstractLongAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Long, Exception> implements DoubleToLongFunctionAssert<S, A, RS> {
