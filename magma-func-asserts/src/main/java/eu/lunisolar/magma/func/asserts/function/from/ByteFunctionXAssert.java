...
/** Assertions for ByteFunctionX. */
public interface ByteFunctionXAssert<S extends ByteFunctionXAssert<S, A, RS, R, X>, A extends ByteFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, R, X>, A extends ByteFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Exception> extends FunctionalAssert.Base<S, A, RS, R, Exception> implements ByteFunctionXAssert<S, A, RS, R, X> {
