...
public interface LIntToDblFunctionAssert<S extends LIntToDblFunctionAssert<S, A, RS>, A extends LIntToDblFunction, RS extends AbstractDoubleAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LIntConsumer, A, RS, Double> {
	...
	final class The<A extends LIntToDblFunction, RS extends AbstractDoubleAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LIntToDblFunction, RS extends AbstractDoubleAssert<RS>> extends FullFunctionalAssert.Base<S, LIntConsumer, A, RS, Double> implements LIntToDblFunctionAssert<S, A, RS> {
