...
public interface LTriBoolFunctionAssert<S extends LTriBoolFunctionAssert<S, A, RS, R>, A extends LTriBoolFunction<R>, RS extends Assert<RS, R>, R> extends Assert<S, A>, FullFunctionalAssert<S, LTriBoolConsumer, A, RS, R> {
	...
	final class The<A extends LTriBoolFunction<R>, RS extends Assert<RS, R>, R> extends Base<The<A, RS, R>, A, RS, R> {
	...
	class Base<S extends Base<S, A, RS, R>, A extends LTriBoolFunction<R>, RS extends Assert<RS, R>, R> extends FullFunctionalAssert.Base<S, LTriBoolConsumer, A, RS, R> implements LTriBoolFunctionAssert<S, A, RS, R> {
