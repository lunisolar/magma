...
public interface StdDoubleFunctionAssert<S extends StdDoubleFunctionAssert<S, A, RS, R>, A extends java.util.function.DoubleFunction<R>, RS extends Assert<RS, R>, R> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, R, Exception> {
	...
	public static class Base<S extends Base<S, A, RS, R>, A extends java.util.function.DoubleFunction<R>, RS extends Assert<RS, R>, R> extends FullFunctionalAssert.Base<S, A, RS, R, Exception> implements StdDoubleFunctionAssert<S, A, RS, R> {
