...
public interface ToIntFunctionAssert<S extends ToIntFunctionAssert<S, A, RS, T>, A extends java.util.function.ToIntFunction<T>, RS extends AbstractIntegerAssert<RS>, T>
	...
	public static class Base<S extends Base<S, A, RS, T>, A extends java.util.function.ToIntFunction<T>, RS extends AbstractIntegerAssert<RS>, T> extends FullFunctionalAssert.Base<S, LConsumerX<T, Exception>, A, RS, Integer, Exception>
			implements
				ToIntFunctionAssert<S, A, RS, T> {
