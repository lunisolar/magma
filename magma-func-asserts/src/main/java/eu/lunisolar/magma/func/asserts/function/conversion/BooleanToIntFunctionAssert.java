...
/** Assertions for BooleanToIntFunction. */
public interface BooleanToIntFunctionAssert<S extends BooleanToIntFunctionAssert<S, A, RS>, A extends BooleanToIntFunction, RS extends AbstractIntegerAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends BooleanToIntFunction, RS extends AbstractIntegerAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Integer, Exception> implements BooleanToIntFunctionAssert<S, A, RS> {
