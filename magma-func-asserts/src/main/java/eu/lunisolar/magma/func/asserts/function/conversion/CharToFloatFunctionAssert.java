...
/** Assertions for CharToFloatFunction. */
public interface CharToFloatFunctionAssert<S extends CharToFloatFunctionAssert<S, A, RS>, A extends CharToFloatFunction, RS extends AbstractFloatAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends CharToFloatFunction, RS extends AbstractFloatAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Float, Exception> implements CharToFloatFunctionAssert<S, A, RS> {
