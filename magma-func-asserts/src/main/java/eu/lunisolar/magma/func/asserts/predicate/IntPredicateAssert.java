...
/** Assertions for IntPredicate. */
public interface IntPredicateAssert<S extends IntPredicateAssert<S, A, RS>, A extends IntPredicate, RS extends AbstractBooleanAssert<RS>> extends Assert<S, A>, FunctionalAssert<S, A, RS, Boolean, Exception>, RecurringAsserts<S, A, RS, Boolean> {

	@Nonnull
	Evaluation<S, A, RS, Boolean, Exception> doesTest(int i);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	public final static class Impl<A extends IntPredicate, RS extends AbstractBooleanAssert<RS>> extends Base<Impl<A, RS>, A, RS> {
	...
	public static class Base<S extends Base<S, A, RS>, A extends IntPredicate, RS extends AbstractBooleanAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception> implements IntPredicateAssert<S, A, RS> {
