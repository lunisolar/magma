...
/** Assertions for BooleanToFloatFunction. */
public interface BooleanToFloatFunctionAssert<S extends BooleanToFloatFunctionAssert<S, A, RS>, A extends BooleanToFloatFunction, RS extends AbstractFloatAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends BooleanToFloatFunction, RS extends AbstractFloatAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Float, Exception> implements BooleanToFloatFunctionAssert<S, A, RS> {
