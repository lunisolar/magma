...
public interface LTriBoolFunctionXAssert<S extends LTriBoolFunctionXAssert<S, A, RS, R, X>, A extends LTriBoolFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Throwable>
	...
	public static class Base<S extends Base<S, A, RS, R, X>, A extends LTriBoolFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Throwable> extends FullFunctionalAssert.Base<S, LTriBoolConsumerX<Exception>, A, RS, R, Exception>
			implements
				LTriBoolFunctionXAssert<S, A, RS, R, X> {
