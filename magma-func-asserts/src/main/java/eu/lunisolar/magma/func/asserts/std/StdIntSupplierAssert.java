...
public interface StdIntSupplierAssert<S extends StdIntSupplierAssert<S, A, RS>, A extends java.util.function.IntSupplier, RS extends AbstractIntegerAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Integer, Exception> {
	...
	public static class Base<S extends Base<S, A, RS>, A extends java.util.function.IntSupplier, RS extends AbstractIntegerAssert<RS>> extends FullFunctionalAssert.Base<S, A, RS, Integer, Exception> implements StdIntSupplierAssert<S, A, RS> {
