...
public interface LLongToIntFunctionAssert<S extends LLongToIntFunctionAssert<S, A, RS>, A extends LLongToIntFunction, RS extends AbstractIntegerAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Integer, Exception> {
	...
	public static class Base<S extends Base<S, A, RS>, A extends LLongToIntFunction, RS extends AbstractIntegerAssert<RS>> extends FullFunctionalAssert.Base<S, A, RS, Integer, Exception> implements LLongToIntFunctionAssert<S, A, RS> {
