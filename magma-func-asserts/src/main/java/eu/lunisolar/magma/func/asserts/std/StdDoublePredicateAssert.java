...
/** Assertions for java.util.function.DoublePredicate. */
public interface StdDoublePredicateAssert<S extends StdDoublePredicateAssert<S, A, RS>, A extends java.util.function.DoublePredicate, RS extends AbstractBooleanAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends java.util.function.DoublePredicate, RS extends AbstractBooleanAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception> implements StdDoublePredicateAssert<S, A, RS> {
