...
public interface LBiIntPredicateAssert<S extends LBiIntPredicateAssert<S, A, RS>, A extends LBiIntPredicate, RS extends AbstractBooleanAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Boolean, Exception> {
	...
	public static class Base<S extends Base<S, A, RS>, A extends LBiIntPredicate, RS extends AbstractBooleanAssert<RS>> extends FullFunctionalAssert.Base<S, A, RS, Boolean, Exception> implements LBiIntPredicateAssert<S, A, RS> {
