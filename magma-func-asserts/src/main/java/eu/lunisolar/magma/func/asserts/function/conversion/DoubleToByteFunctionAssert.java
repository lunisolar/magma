...
/** Assertions for DoubleToByteFunction. */
public interface DoubleToByteFunctionAssert<S extends DoubleToByteFunctionAssert<S, A, RS>, A extends DoubleToByteFunction, RS extends AbstractByteAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends DoubleToByteFunction, RS extends AbstractByteAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Byte, Exception> implements DoubleToByteFunctionAssert<S, A, RS> {
