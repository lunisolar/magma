...
/** Assertions for ShortBiFunctionX. */
public interface ShortBiFunctionXAssert<S extends ShortBiFunctionXAssert<S, A, RS, R, X>, A extends ShortBiFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, R, X>, A extends ShortBiFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Exception> extends FunctionalAssert.Base<S, A, RS, R, Exception> implements ShortBiFunctionXAssert<S, A, RS, R, X> {
