...
public interface StdBiFunctionAssert<S extends StdBiFunctionAssert<S, A, RS, T1, T2, R>, A extends java.util.function.BiFunction<T1, T2, R>, RS extends Assert<RS, R>, T1, T2, R> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, R, Exception> {
