...
/** Assertions for DoubleToFloatFunction. */
public interface DoubleToFloatFunctionAssert<S extends DoubleToFloatFunctionAssert<S, A, RS>, A extends DoubleToFloatFunction, RS extends AbstractFloatAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends DoubleToFloatFunction, RS extends AbstractFloatAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Float, Exception> implements DoubleToFloatFunctionAssert<S, A, RS> {
