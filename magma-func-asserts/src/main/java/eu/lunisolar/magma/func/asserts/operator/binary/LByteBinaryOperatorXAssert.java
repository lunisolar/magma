...
public interface LByteBinaryOperatorXAssert<S extends LByteBinaryOperatorXAssert<S, A, RS, X>, A extends LByteBinaryOperatorX<X>, RS extends AbstractByteAssert<RS>, X extends Throwable>
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends LByteBinaryOperatorX<X>, RS extends AbstractByteAssert<RS>, X extends Throwable> extends FullFunctionalAssert.Base<S, A, RS, Byte, Exception>
			implements
