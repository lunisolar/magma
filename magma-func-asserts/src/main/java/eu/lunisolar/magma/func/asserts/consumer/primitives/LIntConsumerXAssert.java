...
public interface LIntConsumerXAssert<S extends LIntConsumerXAssert<S, A, X>, A extends LIntConsumerX<X>, X extends Throwable> extends Assert<S, A>, FunctionalAssert.Simple<S, LIntConsumerX<Exception>, A, Exception> {
	...
	public static class Base<S extends Base<S, A, X>, A extends LIntConsumerX<X>, X extends Throwable> extends FunctionalAssert.Simple.Base<S, LIntConsumerX<Exception>, A, Exception> implements LIntConsumerXAssert<S, A, X> {
