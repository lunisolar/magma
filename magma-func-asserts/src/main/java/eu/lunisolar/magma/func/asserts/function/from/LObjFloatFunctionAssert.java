...
public interface LObjFloatFunctionAssert<S extends LObjFloatFunctionAssert<S, A, RS, T, R>, A extends LObjFloatFunction<T, R>, RS extends Assert<RS, R>, T, R>
	...
	public static class Base<S extends Base<S, A, RS, T, R>, A extends LObjFloatFunction<T, R>, RS extends Assert<RS, R>, T, R> extends FullFunctionalAssert.Base<S, LObjFloatConsumerX<T, Exception>, A, RS, R, Exception>
			implements
				LObjFloatFunctionAssert<S, A, RS, T, R> {
