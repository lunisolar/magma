...
/** Assertions for java.util.function.DoubleUnaryOperator. */
public interface StdDoubleUnaryOperatorAssert<S extends StdDoubleUnaryOperatorAssert<S, A, RS>, A extends java.util.function.DoubleUnaryOperator, RS extends AbstractDoubleAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends java.util.function.DoubleUnaryOperator, RS extends AbstractDoubleAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Double, Exception> implements StdDoubleUnaryOperatorAssert<S, A, RS> {
