...
/** Assertions for IntToShortFunction. */
public interface IntToShortFunctionAssert<S extends IntToShortFunctionAssert<S, A, RS>, A extends IntToShortFunction, RS extends AbstractShortAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends IntToShortFunction, RS extends AbstractShortAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Short, Exception> implements IntToShortFunctionAssert<S, A, RS> {
