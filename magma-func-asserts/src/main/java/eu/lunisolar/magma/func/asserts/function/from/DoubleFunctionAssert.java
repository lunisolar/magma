...
/** Assertions for DoubleFunction. */
public interface DoubleFunctionAssert<S extends DoubleFunctionAssert<S, A, RS, R>, A extends DoubleFunction<R>, RS extends Assert<RS, R>, R> extends Assert<S, A>, FunctionalAssert<S, A, RS, R, Exception>, RecurringAsserts<S, A, RS, R> {
	...
	public static class Base<S extends Base<S, A, RS, R>, A extends DoubleFunction<R>, RS extends Assert<RS, R>, R> extends FunctionalAssert.Base<S, A, RS, R, Exception> implements DoubleFunctionAssert<S, A, RS, R> {
