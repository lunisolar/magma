...
public interface LFloatToCharFunctionAssert<S extends LFloatToCharFunctionAssert<S, A, RS>, A extends LFloatToCharFunction, RS extends AbstractCharacterAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Character, Exception> {
	...
	public static class Base<S extends Base<S, A, RS>, A extends LFloatToCharFunction, RS extends AbstractCharacterAssert<RS>> extends FullFunctionalAssert.Base<S, A, RS, Character, Exception> implements LFloatToCharFunctionAssert<S, A, RS> {
