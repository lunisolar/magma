...
/** Assertions for ShortToFloatFunction. */
public interface ShortToFloatFunctionAssert<S extends ShortToFloatFunctionAssert<S, A, RS>, A extends ShortToFloatFunction, RS extends AbstractFloatAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends ShortToFloatFunction, RS extends AbstractFloatAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Float, Exception> implements ShortToFloatFunctionAssert<S, A, RS> {
