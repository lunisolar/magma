...
/** Assertions for BiIntPredicateX. */
public interface BiIntPredicateXAssert<S extends BiIntPredicateXAssert<S, A, RS, X>, A extends BiIntPredicateX<X>, RS extends AbstractBooleanAssert<RS>, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends BiIntPredicateX<X>, RS extends AbstractBooleanAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception> implements BiIntPredicateXAssert<S, A, RS, X> {
