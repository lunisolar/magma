...
/** Assertions for ToLongBiFunctionX. */
public interface ToLongBiFunctionXAssert<S extends ToLongBiFunctionXAssert<S, A, RS, T1, T2, X>, A extends ToLongBiFunctionX<T1, T2, X>, RS extends AbstractLongAssert<RS>, T1, T2, X extends Exception>
	...
	public static class Base<S extends Base<S, A, RS, T1, T2, X>, A extends ToLongBiFunctionX<T1, T2, X>, RS extends AbstractLongAssert<RS>, T1, T2, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Long, Exception>
			implements
