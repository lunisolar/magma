...
public interface LToFloatBiFunctionXAssert<S extends LToFloatBiFunctionXAssert<S, A, RS, T1, T2, X>, A extends LToFloatBiFunctionX<T1, T2, X>, RS extends AbstractFloatAssert<RS>, T1, T2, X extends Throwable>
	...
	public static class Base<S extends Base<S, A, RS, T1, T2, X>, A extends LToFloatBiFunctionX<T1, T2, X>, RS extends AbstractFloatAssert<RS>, T1, T2, X extends Throwable> extends FullFunctionalAssert.Base<S, A, RS, Float, Exception>
			implements
