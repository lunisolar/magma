...
public interface LBiCharFunctionXAssert<S extends LBiCharFunctionXAssert<S, A, RS, R, X>, A extends LBiCharFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Throwable>
	...
	public static class Base<S extends Base<S, A, RS, R, X>, A extends LBiCharFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Throwable> extends FullFunctionalAssert.Base<S, LBiCharConsumerX<Exception>, A, RS, R, Exception>
			implements
				LBiCharFunctionXAssert<S, A, RS, R, X> {
