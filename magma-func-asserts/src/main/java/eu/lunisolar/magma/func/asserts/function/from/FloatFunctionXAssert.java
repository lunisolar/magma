...
/** Assertions for FloatFunctionX. */
public interface FloatFunctionXAssert<S extends FloatFunctionXAssert<S, A, RS, R, X>, A extends FloatFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, R, X>, A extends FloatFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Exception> extends FunctionalAssert.Base<S, A, RS, R, Exception> implements FloatFunctionXAssert<S, A, RS, R, X> {
