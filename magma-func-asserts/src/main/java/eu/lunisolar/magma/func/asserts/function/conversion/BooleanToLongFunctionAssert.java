...
/** Assertions for BooleanToLongFunction. */
public interface BooleanToLongFunctionAssert<S extends BooleanToLongFunctionAssert<S, A, RS>, A extends BooleanToLongFunction, RS extends AbstractLongAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends BooleanToLongFunction, RS extends AbstractLongAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Long, Exception> implements BooleanToLongFunctionAssert<S, A, RS> {
