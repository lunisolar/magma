...
public interface LFltObjPredAssert<S extends LFltObjPredAssert<S, A, RS, T>, A extends LObjFltPredicate.LFltObjPred<T>, RS extends AbstractBooleanAssert<RS>, T> extends Assert<S, A>, FullFunctionalAssert<S, LObjFltConsumer.LFltObjCons<T>, A, RS, Boolean> {
	...
	@Nonnull
	Evaluation<S, LObjFltConsumer.LFltObjCons<T>, A, RS, Boolean> doesTest(float a2, T a1);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LObjFltPredicate.LFltObjPred<T>, RS extends AbstractBooleanAssert<RS>, T> extends Base<The<A, RS, T>, A, RS, T> {
	...
	class Base<S extends Base<S, A, RS, T>, A extends LObjFltPredicate.LFltObjPred<T>, RS extends AbstractBooleanAssert<RS>, T> extends FullFunctionalAssert.Base<S, LObjFltConsumer.LFltObjCons<T>, A, RS, Boolean> implements LFltObjPredAssert<S, A, RS, T> {
		...
		@Nonnull
		public Evaluation<S, LObjFltConsumer.LFltObjCons<T>, A, RS, Boolean> doesTest(float a2, T a1) {
			...
			return evaluation(() -> String.format("(%s,%s)", a2, a1), pc -> {
				...
				return assertFactory.apply(actual.testFltObj(a2, a1));
			});
		}
