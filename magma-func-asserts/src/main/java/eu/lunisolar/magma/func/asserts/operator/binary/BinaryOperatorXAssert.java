...
/** Assertions for BinaryOperatorX. */
public interface BinaryOperatorXAssert<S extends BinaryOperatorXAssert<S, A, RS, T, X>, A extends BinaryOperatorX<T, X>, RS extends Assert<RS, T>, T, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, T, X>, A extends BinaryOperatorX<T, X>, RS extends Assert<RS, T>, T, X extends Exception> extends FunctionalAssert.Base<S, A, RS, T, Exception> implements BinaryOperatorXAssert<S, A, RS, T, X> {
