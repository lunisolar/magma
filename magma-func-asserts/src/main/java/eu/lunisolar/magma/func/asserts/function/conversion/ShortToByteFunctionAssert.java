...
/** Assertions for ShortToByteFunction. */
public interface ShortToByteFunctionAssert<S extends ShortToByteFunctionAssert<S, A, RS>, A extends ShortToByteFunction, RS extends AbstractByteAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends ShortToByteFunction, RS extends AbstractByteAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Byte, Exception> implements ShortToByteFunctionAssert<S, A, RS> {
