...
public interface LShortFunctionAssert<S extends LShortFunctionAssert<S, A, RS, R>, A extends LShortFunction<R>, RS extends Assert<RS, R>, R> extends Assert<S, A>, FullFunctionalAssert<S, LShortConsumerX<Exception>, A, RS, R, Exception> {
	...
	public static class Base<S extends Base<S, A, RS, R>, A extends LShortFunction<R>, RS extends Assert<RS, R>, R> extends FullFunctionalAssert.Base<S, LShortConsumerX<Exception>, A, RS, R, Exception> implements LShortFunctionAssert<S, A, RS, R> {
		...
		public Evaluation<S, LShortConsumerX<Exception>, A, RS, R, Exception> doesApply(short s) {
			...
			return evaluation((pc) -> {
				...
				return assertFactory.apply((R) actual.doApply(s));
			});
