...
/** Assertions for ToCharFunction. */
public interface ToCharFunctionAssert<S extends ToCharFunctionAssert<S, A, RS, T>, A extends ToCharFunction<T>, RS extends AbstractCharacterAssert<RS>, T>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, T>, A extends ToCharFunction<T>, RS extends AbstractCharacterAssert<RS>, T> extends FunctionalAssert.Base<S, A, RS, Character, Exception> implements ToCharFunctionAssert<S, A, RS, T> {
