...
public interface LTieByteFunctionAssert<S extends LTieByteFunctionAssert<S, A, RS, T>, A extends LTieByteFunction<T>, RS extends AbstractIntegerAssert<RS>, T> extends Assert<S, A>, FullFunctionalAssert<S, LTieByteConsumer<T>, A, RS, Integer> {
	...
	@Nonnull
	Evaluation<S, LTieByteConsumer<T>, A, RS, Integer> doesApplyAsInt(T a1, int a2, byte a3);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LTieByteFunction<T>, RS extends AbstractIntegerAssert<RS>, T> extends Base<The<A, RS, T>, A, RS, T> {
	...
	class Base<S extends Base<S, A, RS, T>, A extends LTieByteFunction<T>, RS extends AbstractIntegerAssert<RS>, T> extends FullFunctionalAssert.Base<S, LTieByteConsumer<T>, A, RS, Integer> implements LTieByteFunctionAssert<S, A, RS, T> {
