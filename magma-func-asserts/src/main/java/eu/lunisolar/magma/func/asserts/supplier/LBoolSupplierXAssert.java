...
public interface LBoolSupplierXAssert<S extends LBoolSupplierXAssert<S, A, RS, X>, A extends LBoolSupplierX<X>, RS extends AbstractBooleanAssert<RS>, X extends Throwable>
		extends
			Assert<S, A>,
	...
	public final static class The<A extends LBoolSupplierX<X>, RS extends AbstractBooleanAssert<RS>, X extends Throwable> extends Base<The<A, RS, X>, A, RS, X> {
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends LBoolSupplierX<X>, RS extends AbstractBooleanAssert<RS>, X extends Throwable> extends FullFunctionalAssert.Base<S, LActionX<Exception>, A, RS, Boolean, Exception>
			implements
				LBoolSupplierXAssert<S, A, RS, X> {
