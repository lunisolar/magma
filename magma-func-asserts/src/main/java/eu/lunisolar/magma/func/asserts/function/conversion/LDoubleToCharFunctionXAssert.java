...
public interface LDoubleToCharFunctionXAssert<S extends LDoubleToCharFunctionXAssert<S, A, RS, X>, A extends LDoubleToCharFunctionX<X>, RS extends AbstractCharacterAssert<RS>, X extends Throwable>
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends LDoubleToCharFunctionX<X>, RS extends AbstractCharacterAssert<RS>, X extends Throwable> extends FullFunctionalAssert.Base<S, A, RS, Character, Exception>
			implements
