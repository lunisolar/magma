...
/** Assertions for java.util.function.IntUnaryOperator. */
public interface StdIntUnaryOperatorAssert<S extends StdIntUnaryOperatorAssert<S, A, RS>, A extends java.util.function.IntUnaryOperator, RS extends AbstractIntegerAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends java.util.function.IntUnaryOperator, RS extends AbstractIntegerAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Integer, Exception> implements StdIntUnaryOperatorAssert<S, A, RS> {
