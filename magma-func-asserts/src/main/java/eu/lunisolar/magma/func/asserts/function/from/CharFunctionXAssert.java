...
/** Assertions for CharFunctionX. */
public interface CharFunctionXAssert<S extends CharFunctionXAssert<S, A, RS, R, X>, A extends CharFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, R, X>, A extends CharFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Exception> extends FunctionalAssert.Base<S, A, RS, R, Exception> implements CharFunctionXAssert<S, A, RS, R, X> {
