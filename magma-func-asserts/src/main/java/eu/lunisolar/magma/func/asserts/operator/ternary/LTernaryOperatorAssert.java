...
public interface LTernaryOperatorAssert<S extends LTernaryOperatorAssert<S, A, RS, T>, A extends LTernaryOperator<T>, RS extends Assert<RS, T>, T> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, T, Exception> {
	...
	public static class Base<S extends Base<S, A, RS, T>, A extends LTernaryOperator<T>, RS extends Assert<RS, T>, T> extends FullFunctionalAssert.Base<S, A, RS, T, Exception> implements LTernaryOperatorAssert<S, A, RS, T> {
