...
/** Assertions for IntToLongFunction. */
public interface IntToLongFunctionAssert<S extends IntToLongFunctionAssert<S, A, RS>, A extends IntToLongFunction, RS extends AbstractLongAssert<RS>> extends Assert<S, A>, FunctionalAssert<S, A, RS, Long, Exception>, RecurringAsserts<S, A, RS, Long> {

	@Nonnull
	Evaluation<S, A, RS, Long, Exception> doesApplyAsLong(int i);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	public final static class Impl<A extends IntToLongFunction, RS extends AbstractLongAssert<RS>> extends Base<Impl<A, RS>, A, RS> {
	...
	public static class Base<S extends Base<S, A, RS>, A extends IntToLongFunction, RS extends AbstractLongAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Long, Exception> implements IntToLongFunctionAssert<S, A, RS> {
