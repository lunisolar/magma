...
/** Assertions for LongBiFunctionX. */
public interface LongBiFunctionXAssert<S extends LongBiFunctionXAssert<S, A, RS, R, X>, A extends LongBiFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, R, X>, A extends LongBiFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Exception> extends FunctionalAssert.Base<S, A, RS, R, Exception> implements LongBiFunctionXAssert<S, A, RS, R, X> {
