...
/** Assertions for ToIntBiFunctionX. */
public interface ToIntBiFunctionXAssert<S extends ToIntBiFunctionXAssert<S, A, RS, T1, T2, X>, A extends ToIntBiFunctionX<T1, T2, X>, RS extends AbstractIntegerAssert<RS>, T1, T2, X extends Exception>
	...
	public static class Base<S extends Base<S, A, RS, T1, T2, X>, A extends ToIntBiFunctionX<T1, T2, X>, RS extends AbstractIntegerAssert<RS>, T1, T2, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Integer, Exception>
			implements
