...
public interface LByteSupplierAssert<S extends LByteSupplierAssert<S, A, RS>, A extends LByteSupplier, RS extends AbstractByteAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Byte, Exception> {
	...
	public static class Base<S extends Base<S, A, RS>, A extends LByteSupplier, RS extends AbstractByteAssert<RS>> extends FullFunctionalAssert.Base<S, A, RS, Byte, Exception> implements LByteSupplierAssert<S, A, RS> {
