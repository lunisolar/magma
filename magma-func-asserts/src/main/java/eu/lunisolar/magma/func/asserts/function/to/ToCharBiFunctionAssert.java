...
/** Assertions for ToCharBiFunction. */
public interface ToCharBiFunctionAssert<S extends ToCharBiFunctionAssert<S, A, RS, T1, T2>, A extends ToCharBiFunction<T1, T2>, RS extends AbstractCharacterAssert<RS>, T1, T2>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, T1, T2>, A extends ToCharBiFunction<T1, T2>, RS extends AbstractCharacterAssert<RS>, T1, T2> extends FunctionalAssert.Base<S, A, RS, Character, Exception>
			implements
