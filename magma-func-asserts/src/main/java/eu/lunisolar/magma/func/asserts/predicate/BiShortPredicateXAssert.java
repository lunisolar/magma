...
/** Assertions for BiShortPredicateX. */
public interface BiShortPredicateXAssert<S extends BiShortPredicateXAssert<S, A, RS, X>, A extends BiShortPredicateX<X>, RS extends AbstractBooleanAssert<RS>, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends BiShortPredicateX<X>, RS extends AbstractBooleanAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception>
			implements
