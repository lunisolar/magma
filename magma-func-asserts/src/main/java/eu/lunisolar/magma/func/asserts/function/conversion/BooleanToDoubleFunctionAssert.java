...
/** Assertions for BooleanToDoubleFunction. */
public interface BooleanToDoubleFunctionAssert<S extends BooleanToDoubleFunctionAssert<S, A, RS>, A extends BooleanToDoubleFunction, RS extends AbstractDoubleAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends BooleanToDoubleFunction, RS extends AbstractDoubleAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Double, Exception> implements BooleanToDoubleFunctionAssert<S, A, RS> {
