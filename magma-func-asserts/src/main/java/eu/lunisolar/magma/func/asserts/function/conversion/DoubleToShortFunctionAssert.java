...
/** Assertions for DoubleToShortFunction. */
public interface DoubleToShortFunctionAssert<S extends DoubleToShortFunctionAssert<S, A, RS>, A extends DoubleToShortFunction, RS extends AbstractShortAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends DoubleToShortFunction, RS extends AbstractShortAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Short, Exception> implements DoubleToShortFunctionAssert<S, A, RS> {
