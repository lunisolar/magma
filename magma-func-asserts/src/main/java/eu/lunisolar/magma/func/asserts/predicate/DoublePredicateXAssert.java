...
/** Assertions for DoublePredicateX. */
public interface DoublePredicateXAssert<S extends DoublePredicateXAssert<S, A, RS, X>, A extends DoublePredicateX<X>, RS extends AbstractBooleanAssert<RS>, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends DoublePredicateX<X>, RS extends AbstractBooleanAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception> implements DoublePredicateXAssert<S, A, RS, X> {
