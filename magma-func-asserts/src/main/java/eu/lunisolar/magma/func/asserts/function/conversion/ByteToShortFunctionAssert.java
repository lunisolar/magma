...
/** Assertions for ByteToShortFunction. */
public interface ByteToShortFunctionAssert<S extends ByteToShortFunctionAssert<S, A, RS>, A extends ByteToShortFunction, RS extends AbstractShortAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends ByteToShortFunction, RS extends AbstractShortAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Short, Exception> implements ByteToShortFunctionAssert<S, A, RS> {
