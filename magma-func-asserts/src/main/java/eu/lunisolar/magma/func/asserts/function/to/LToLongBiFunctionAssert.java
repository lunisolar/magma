...
public interface LToLongBiFunctionAssert<S extends LToLongBiFunctionAssert<S, A, RS, T1, T2>, A extends LToLongBiFunction<T1, T2>, RS extends AbstractLongAssert<RS>, T1, T2> extends Assert<S, A>, FullFunctionalAssert<S, LBiConsumer<T1, T2>, A, RS, Long> {
	...
	final class The<A extends LToLongBiFunction<T1, T2>, RS extends AbstractLongAssert<RS>, T1, T2> extends Base<The<A, RS, T1, T2>, A, RS, T1, T2> {
	...
	class Base<S extends Base<S, A, RS, T1, T2>, A extends LToLongBiFunction<T1, T2>, RS extends AbstractLongAssert<RS>, T1, T2> extends FullFunctionalAssert.Base<S, LBiConsumer<T1, T2>, A, RS, Long> implements LToLongBiFunctionAssert<S, A, RS, T1, T2> {
