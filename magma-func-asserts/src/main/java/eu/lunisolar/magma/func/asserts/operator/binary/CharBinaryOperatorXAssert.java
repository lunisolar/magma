...
/** Assertions for CharBinaryOperatorX. */
public interface CharBinaryOperatorXAssert<S extends CharBinaryOperatorXAssert<S, A, RS, X>, A extends CharBinaryOperatorX<X>, RS extends AbstractCharacterAssert<RS>, X extends Exception>
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends CharBinaryOperatorX<X>, RS extends AbstractCharacterAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Character, Exception>
			implements
