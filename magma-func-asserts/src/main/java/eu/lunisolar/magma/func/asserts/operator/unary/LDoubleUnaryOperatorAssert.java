...
/** Assert class for LDoubleUnaryOperator. */
public interface LDoubleUnaryOperatorAssert<S extends LDoubleUnaryOperatorAssert<S, A, RS>, A extends LDoubleUnaryOperator, RS extends AbstractDoubleAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends LDoubleUnaryOperator, RS extends AbstractDoubleAssert<RS>> extends FullFunctionalAssert.Base<S, LDoubleConsumerX<Exception>, A, RS, Double, Exception>
			implements
				LDoubleUnaryOperatorAssert<S, A, RS> {
