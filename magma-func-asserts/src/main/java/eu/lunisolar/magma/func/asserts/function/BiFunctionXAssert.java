...
/** Assertions for BiFunctionX. */
public interface BiFunctionXAssert<S extends BiFunctionXAssert<S, A, RS, T1, T2, R, X>, A extends BiFunctionX<T1, T2, R, X>, RS extends Assert<RS, R>, T1, T2, R, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, T1, T2, R, X>, A extends BiFunctionX<T1, T2, R, X>, RS extends Assert<RS, R>, T1, T2, R, X extends Exception> extends FunctionalAssert.Base<S, A, RS, R, Exception>
			implements
