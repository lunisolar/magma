...
public interface LongSupplierAssert<S extends LongSupplierAssert<S, A, RS>, A extends LongSupplier, RS extends AbstractLongAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LAction, A, RS, Long> {
	...
	class Base<S extends Base<S, A, RS>, A extends LongSupplier, RS extends AbstractLongAssert<RS>> extends FullFunctionalAssert.Base<S, LAction, A, RS, Long> implements LongSupplierAssert<S, A, RS> {
