...
/** Assertions for CharToByteFunction. */
public interface CharToByteFunctionAssert<S extends CharToByteFunctionAssert<S, A, RS>, A extends CharToByteFunction, RS extends AbstractByteAssert<RS>> extends Assert<S, A>, FunctionalAssert<S, A, RS, Byte, Exception>, RecurringAsserts<S, A, RS, Byte> {

	@Nonnull
	Evaluation<S, A, RS, Byte, Exception> doesApplyAsByte(char c);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	public final static class Impl<A extends CharToByteFunction, RS extends AbstractByteAssert<RS>> extends Base<Impl<A, RS>, A, RS> {
	...
	public static class Base<S extends Base<S, A, RS>, A extends CharToByteFunction, RS extends AbstractByteAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Byte, Exception> implements CharToByteFunctionAssert<S, A, RS> {
