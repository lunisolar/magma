...
/** Assertions for java.util.function.Predicate. */
public interface StdPredicateAssert<S extends StdPredicateAssert<S, A, RS, T>, A extends java.util.function.Predicate<T>, RS extends AbstractBooleanAssert<RS>, T>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, T>, A extends java.util.function.Predicate<T>, RS extends AbstractBooleanAssert<RS>, T> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception> implements StdPredicateAssert<S, A, RS, T> {
