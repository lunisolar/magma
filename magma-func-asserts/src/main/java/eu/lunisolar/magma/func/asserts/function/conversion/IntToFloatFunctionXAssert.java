...
/** Assertions for IntToFloatFunctionX. */
public interface IntToFloatFunctionXAssert<S extends IntToFloatFunctionXAssert<S, A, RS, X>, A extends IntToFloatFunctionX<X>, RS extends AbstractFloatAssert<RS>, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends IntToFloatFunctionX<X>, RS extends AbstractFloatAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Float, Exception>
			implements
