...
/** Assertions for FloatToByteFunction. */
public interface FloatToByteFunctionAssert<S extends FloatToByteFunctionAssert<S, A, RS>, A extends FloatToByteFunction, RS extends AbstractByteAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends FloatToByteFunction, RS extends AbstractByteAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Byte, Exception> implements FloatToByteFunctionAssert<S, A, RS> {
