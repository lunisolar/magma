...
/** Assertions for DoubleToIntFunctionX. */
public interface DoubleToIntFunctionXAssert<S extends DoubleToIntFunctionXAssert<S, A, RS, X>, A extends DoubleToIntFunctionX<X>, RS extends AbstractIntegerAssert<RS>, X extends Exception>
		extends
			Assert<S, A>,
	...
	@Nonnull
	Evaluation<S, A, RS, Integer, Exception> doesApplyAsInt(double d);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	public final static class Impl<A extends DoubleToIntFunctionX<X>, RS extends AbstractIntegerAssert<RS>, X extends Exception> extends Base<Impl<A, RS, X>, A, RS, X> {
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends DoubleToIntFunctionX<X>, RS extends AbstractIntegerAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Integer, Exception>
			implements
				DoubleToIntFunctionXAssert<S, A, RS, X> {
