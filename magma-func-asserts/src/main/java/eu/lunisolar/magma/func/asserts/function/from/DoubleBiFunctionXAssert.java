...
/** Assertions for DoubleBiFunctionX. */
public interface DoubleBiFunctionXAssert<S extends DoubleBiFunctionXAssert<S, A, RS, R, X>, A extends DoubleBiFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, R, X>, A extends DoubleBiFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Exception> extends FunctionalAssert.Base<S, A, RS, R, Exception> implements DoubleBiFunctionXAssert<S, A, RS, R, X> {
