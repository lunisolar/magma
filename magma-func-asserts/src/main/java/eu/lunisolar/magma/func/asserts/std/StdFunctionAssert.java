...
/** Assertions for java.util.function.Function. */
public interface StdFunctionAssert<S extends StdFunctionAssert<S, A, RS, T, R>, A extends java.util.function.Function<T, R>, RS extends Assert<RS, R>, T, R> extends Assert<S, A>, FunctionalAssert<S, A, RS, R, Exception>, RecurringAsserts<S, A, RS, R> {
	...
	public static class Base<S extends Base<S, A, RS, T, R>, A extends java.util.function.Function<T, R>, RS extends Assert<RS, R>, T, R> extends FunctionalAssert.Base<S, A, RS, R, Exception> implements StdFunctionAssert<S, A, RS, T, R> {
