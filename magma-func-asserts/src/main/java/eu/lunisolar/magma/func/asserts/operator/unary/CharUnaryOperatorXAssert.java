...
/** Assertions for CharUnaryOperatorX. */
public interface CharUnaryOperatorXAssert<S extends CharUnaryOperatorXAssert<S, A, RS, X>, A extends CharUnaryOperatorX<X>, RS extends AbstractCharacterAssert<RS>, X extends Exception>
		extends
			Assert<S, A>,
	...
	@Nonnull
	Evaluation<S, A, RS, Character, Exception> doesApplyAsChar(char c);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	public final static class Impl<A extends CharUnaryOperatorX<X>, RS extends AbstractCharacterAssert<RS>, X extends Exception> extends Base<Impl<A, RS, X>, A, RS, X> {
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends CharUnaryOperatorX<X>, RS extends AbstractCharacterAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Character, Exception>
			implements
				CharUnaryOperatorXAssert<S, A, RS, X> {
