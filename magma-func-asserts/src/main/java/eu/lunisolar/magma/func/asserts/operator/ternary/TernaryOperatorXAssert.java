...
/** Assertions for TernaryOperatorX. */
public interface TernaryOperatorXAssert<S extends TernaryOperatorXAssert<S, A, RS, T, X>, A extends TernaryOperatorX<T, X>, RS extends Assert<RS, T>, T, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, T, X>, A extends TernaryOperatorX<T, X>, RS extends Assert<RS, T>, T, X extends Exception> extends FunctionalAssert.Base<S, A, RS, T, Exception> implements TernaryOperatorXAssert<S, A, RS, T, X> {
