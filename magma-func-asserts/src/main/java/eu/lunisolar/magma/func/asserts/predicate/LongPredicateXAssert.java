...
/** Assertions for LongPredicateX. */
public interface LongPredicateXAssert<S extends LongPredicateXAssert<S, A, RS, X>, A extends LongPredicateX<X>, RS extends AbstractBooleanAssert<RS>, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends LongPredicateX<X>, RS extends AbstractBooleanAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception> implements LongPredicateXAssert<S, A, RS, X> {
