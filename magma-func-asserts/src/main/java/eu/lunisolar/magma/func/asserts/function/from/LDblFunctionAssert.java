...
public interface LDblFunctionAssert<S extends LDblFunctionAssert<S, A, RS, R>, A extends LDblFunction<R>, RS extends Assert<RS, R>, R> extends Assert<S, A>, FullFunctionalAssert<S, LDblConsumer, A, RS, R> {
	...
	final class The<A extends LDblFunction<R>, RS extends Assert<RS, R>, R> extends Base<The<A, RS, R>, A, RS, R> {
	...
	class Base<S extends Base<S, A, RS, R>, A extends LDblFunction<R>, RS extends Assert<RS, R>, R> extends FullFunctionalAssert.Base<S, LDblConsumer, A, RS, R> implements LDblFunctionAssert<S, A, RS, R> {
