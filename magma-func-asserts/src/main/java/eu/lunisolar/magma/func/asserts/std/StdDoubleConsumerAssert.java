...
public interface StdDoubleConsumerAssert<S extends StdDoubleConsumerAssert<S, A>, A extends java.util.function.DoubleConsumer> extends Assert<S, A>, FunctionalAssert.Simple<S, A, Exception> {
	...
	public static class Base<S extends Base<S, A>, A extends java.util.function.DoubleConsumer> extends FunctionalAssert.Simple.Base<S, A, Exception> implements StdDoubleConsumerAssert<S, A> {
