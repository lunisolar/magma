...
/** Assertions for ObjBooleanPredicate. */
public interface ObjBooleanPredicateAssert<S extends ObjBooleanPredicateAssert<S, A, RS, T>, A extends ObjBooleanPredicate<T>, RS extends AbstractBooleanAssert<RS>, T>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, T>, A extends ObjBooleanPredicate<T>, RS extends AbstractBooleanAssert<RS>, T> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception> implements ObjBooleanPredicateAssert<S, A, RS, T> {
