...
/** Assertions for CharToShortFunctionX. */
public interface CharToShortFunctionXAssert<S extends CharToShortFunctionXAssert<S, A, RS, X>, A extends CharToShortFunctionX<X>, RS extends AbstractShortAssert<RS>, X extends Exception>
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends CharToShortFunctionX<X>, RS extends AbstractShortAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Short, Exception>
			implements
