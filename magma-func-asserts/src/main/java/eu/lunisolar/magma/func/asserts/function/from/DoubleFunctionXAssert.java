...
/** Assertions for DoubleFunctionX. */
public interface DoubleFunctionXAssert<S extends DoubleFunctionXAssert<S, A, RS, R, X>, A extends DoubleFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, R, X>, A extends DoubleFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Exception> extends FunctionalAssert.Base<S, A, RS, R, Exception> implements DoubleFunctionXAssert<S, A, RS, R, X> {
