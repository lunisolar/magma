...
public interface LCharConsumerAssert<S extends LCharConsumerAssert<S, A>, A extends LCharConsumer> extends Assert<S, A>, FunctionalAssert.Simple<S, A, Exception> {
	...
	public static class Base<S extends Base<S, A>, A extends LCharConsumer> extends FunctionalAssert.Simple.Base<S, A, Exception> implements LCharConsumerAssert<S, A> {
