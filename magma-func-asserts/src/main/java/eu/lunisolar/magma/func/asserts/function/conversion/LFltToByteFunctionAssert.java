...
public interface LFltToByteFunctionAssert<S extends LFltToByteFunctionAssert<S, A, RS>, A extends LFltToByteFunction, RS extends AbstractByteAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LFltConsumer, A, RS, Byte> {
	...
	@Nonnull
	Evaluation<S, LFltConsumer, A, RS, Byte> doesApplyAsByte(float a);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LFltToByteFunction, RS extends AbstractByteAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LFltToByteFunction, RS extends AbstractByteAssert<RS>> extends FullFunctionalAssert.Base<S, LFltConsumer, A, RS, Byte> implements LFltToByteFunctionAssert<S, A, RS> {
