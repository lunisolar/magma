...
public interface FunctionAssert<S extends FunctionAssert<S, A, RS, T, R>, A extends Function<T, R>, RS extends Assert<RS, R>, T, R> extends Assert<S, A>, FunctionalAssert<S, A, RS, R, Exception>, RecurringAsserts<S, A, RS, R> {

	@Nonnull
	Evaluation<S, A, RS, R, Exception> doesApply(T t);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	public final static class Impl<A extends Function<T, R>, RS extends Assert<RS, R>, T, R> extends Base<Impl<A, RS, T, R>, A, RS, T, R> {
	...
	public static class Base<S extends Base<S, A, RS, T, R>, A extends Function<T, R>, RS extends Assert<RS, R>, T, R> extends FunctionalAssert.Base<S, A, RS, R, Exception> implements FunctionAssert<S, A, RS, T, R> {
