...
/** Assertions for DoubleToIntFunction. */
public interface DoubleToIntFunctionAssert<S extends DoubleToIntFunctionAssert<S, A, RS>, A extends DoubleToIntFunction, RS extends AbstractIntegerAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends DoubleToIntFunction, RS extends AbstractIntegerAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Integer, Exception> implements DoubleToIntFunctionAssert<S, A, RS> {
