...
/** Assertions for BytePredicateX. */
public interface BytePredicateXAssert<S extends BytePredicateXAssert<S, A, RS, X>, A extends BytePredicateX<X>, RS extends AbstractBooleanAssert<RS>, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends BytePredicateX<X>, RS extends AbstractBooleanAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception> implements BytePredicateXAssert<S, A, RS, X> {
