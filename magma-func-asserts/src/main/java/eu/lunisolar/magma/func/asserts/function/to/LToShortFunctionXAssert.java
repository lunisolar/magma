...
public interface LToShortFunctionXAssert<S extends LToShortFunctionXAssert<S, A, RS, T, X>, A extends LToShortFunctionX<T, X>, RS extends AbstractShortAssert<RS>, T, X extends Throwable>
		extends
			Assert<S, A>,
			FullFunctionalAssert<S, LConsumerX<T, X>, A, RS, Short> {

	@Nonnull
	Evaluation<S, LConsumerX<T, X>, A, RS, Short> doesApplyAsShort(T a1);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LToShortFunctionX<T, X>, RS extends AbstractShortAssert<RS>, T, X extends Throwable> extends Base<The<A, RS, T, X>, A, RS, T, X> {
	...
	class Base<S extends Base<S, A, RS, T, X>, A extends LToShortFunctionX<T, X>, RS extends AbstractShortAssert<RS>, T, X extends Throwable> extends FullFunctionalAssert.Base<S, LConsumerX<T, X>, A, RS, Short>
			implements
		...
		@Nonnull
		public Evaluation<S, LConsumerX<T, X>, A, RS, Short> doesApplyAsShort(T a1) {
