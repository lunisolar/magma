...
public interface ToLongFunctionAssert<S extends ToLongFunctionAssert<S, A, RS, T>, A extends java.util.function.ToLongFunction<T>, RS extends AbstractLongAssert<RS>, T> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Long, Exception> {
	...
	public static class Base<S extends Base<S, A, RS, T>, A extends java.util.function.ToLongFunction<T>, RS extends AbstractLongAssert<RS>, T> extends FullFunctionalAssert.Base<S, A, RS, Long, Exception> implements ToLongFunctionAssert<S, A, RS, T> {
