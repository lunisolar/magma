...
import eu.lunisolar.magma.func.function.from.LBiBoolFunction.*;

/** Assert class for LBool1Bool0Func. */
public interface LBool1Bool0FuncAssert<S extends LBool1Bool0FuncAssert<S, A, RS, R>, A extends LBiBoolFunction.LBool1Bool0Func<R>, RS extends Assert<RS, R>, R> extends Assert<S, A>, FullFunctionalAssert<S, LBiBoolConsumer, A, RS, R> {
	...
	@Nonnull
	Evaluation<S, LBiBoolConsumer, A, RS, R> doesApply(boolean a2, boolean a1);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LBiBoolFunction.LBool1Bool0Func<R>, RS extends Assert<RS, R>, R> extends Base<The<A, RS, R>, A, RS, R> {
	...
	class Base<S extends Base<S, A, RS, R>, A extends LBiBoolFunction.LBool1Bool0Func<R>, RS extends Assert<RS, R>, R> extends FullFunctionalAssert.Base<S, LBiBoolConsumer, A, RS, R> implements LBool1Bool0FuncAssert<S, A, RS, R> {
		...
		@Nonnull
		public Evaluation<S, LBiBoolConsumer, A, RS, R> doesApply(boolean a2, boolean a1) {

			return evaluation(() -> String.format("(%s,%s)", a2, a1), pc -> {
				if (pc != null) {
					pc.accept(a2, a1);
				}
				return assertFactory.apply(actual.applyBool1Bool0(a2, a1));
			});
		}
