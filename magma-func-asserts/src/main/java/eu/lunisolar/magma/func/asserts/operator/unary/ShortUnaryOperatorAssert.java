...
/** Assertions for ShortUnaryOperator. */
public interface ShortUnaryOperatorAssert<S extends ShortUnaryOperatorAssert<S, A, RS>, A extends ShortUnaryOperator, RS extends AbstractShortAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends ShortUnaryOperator, RS extends AbstractShortAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Short, Exception> implements ShortUnaryOperatorAssert<S, A, RS> {
