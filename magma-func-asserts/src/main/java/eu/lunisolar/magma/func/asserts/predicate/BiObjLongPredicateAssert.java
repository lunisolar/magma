...
/** Assertions for BiObjLongPredicate. */
public interface BiObjLongPredicateAssert<S extends BiObjLongPredicateAssert<S, A, RS, T1, T2>, A extends BiObjLongPredicate<T1, T2>, RS extends AbstractBooleanAssert<RS>, T1, T2>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, T1, T2>, A extends BiObjLongPredicate<T1, T2>, RS extends AbstractBooleanAssert<RS>, T1, T2> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception>
			implements
