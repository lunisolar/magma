...
/** Assert for ByteBinaryOperatorX. */
public interface ByteBinaryOperatorXAssert<S extends ByteBinaryOperatorXAssert<S, A, RS, X>, A extends ByteBinaryOperatorX<X>, RS extends AbstractByteAssert<RS>, X extends Exception> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Byte, Exception> {
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends ByteBinaryOperatorX<X>, RS extends AbstractByteAssert<RS>, X extends Exception> extends FullFunctionalAssert.Base<S, A, RS, Byte, Exception>
			implements
				ByteBinaryOperatorXAssert<S, A, RS, X> {
