...
public interface LBiObjLongPredicateAssert<S extends LBiObjLongPredicateAssert<S, A, RS, T1, T2>, A extends LBiObjLongPredicate<T1, T2>, RS extends AbstractBooleanAssert<RS>, T1, T2>
	...
	public static class Base<S extends Base<S, A, RS, T1, T2>, A extends LBiObjLongPredicate<T1, T2>, RS extends AbstractBooleanAssert<RS>, T1, T2> extends FullFunctionalAssert.Base<S, A, RS, Boolean, Exception>
			implements
