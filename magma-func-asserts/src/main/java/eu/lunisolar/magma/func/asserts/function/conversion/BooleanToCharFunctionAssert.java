...
/** Assertions for BooleanToCharFunction. */
public interface BooleanToCharFunctionAssert<S extends BooleanToCharFunctionAssert<S, A, RS>, A extends BooleanToCharFunction, RS extends AbstractCharacterAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends BooleanToCharFunction, RS extends AbstractCharacterAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Character, Exception> implements BooleanToCharFunctionAssert<S, A, RS> {
