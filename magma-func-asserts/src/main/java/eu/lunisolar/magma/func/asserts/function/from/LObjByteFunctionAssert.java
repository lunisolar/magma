...
public interface LObjByteFunctionAssert<S extends LObjByteFunctionAssert<S, A, RS, T, R>, A extends LObjByteFunction<T, R>, RS extends Assert<RS, R>, T, R> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, R, Exception> {
	...
	public static class Base<S extends Base<S, A, RS, T, R>, A extends LObjByteFunction<T, R>, RS extends Assert<RS, R>, T, R> extends FullFunctionalAssert.Base<S, A, RS, R, Exception> implements LObjByteFunctionAssert<S, A, RS, T, R> {
