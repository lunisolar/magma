...
/** Assertions for java.util.function.LongSupplier. */
public interface StdLongSupplierAssert<S extends StdLongSupplierAssert<S, A, RS>, A extends java.util.function.LongSupplier, RS extends AbstractLongAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends java.util.function.LongSupplier, RS extends AbstractLongAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Long, Exception> implements StdLongSupplierAssert<S, A, RS> {
