...
public interface StdLongSupplierAssert<S extends StdLongSupplierAssert<S, A, RS>, A extends java.util.function.LongSupplier, RS extends AbstractLongAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Long, Exception> {
	...
	public static class Base<S extends Base<S, A, RS>, A extends java.util.function.LongSupplier, RS extends AbstractLongAssert<RS>> extends FullFunctionalAssert.Base<S, A, RS, Long, Exception> implements StdLongSupplierAssert<S, A, RS> {
