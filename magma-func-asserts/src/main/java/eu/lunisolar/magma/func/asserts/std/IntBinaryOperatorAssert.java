...
public interface IntBinaryOperatorAssert<S extends IntBinaryOperatorAssert<S, A, RS>, A extends java.util.function.IntBinaryOperator, RS extends AbstractIntegerAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Integer, Exception> {
	...
	public static class Base<S extends Base<S, A, RS>, A extends java.util.function.IntBinaryOperator, RS extends AbstractIntegerAssert<RS>> extends FullFunctionalAssert.Base<S, A, RS, Integer, Exception> implements IntBinaryOperatorAssert<S, A, RS> {
