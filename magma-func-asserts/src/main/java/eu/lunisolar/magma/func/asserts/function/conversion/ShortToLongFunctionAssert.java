...
/** Assert for ShortToLongFunction. */
public interface ShortToLongFunctionAssert<S extends ShortToLongFunctionAssert<S, A, RS>, A extends ShortToLongFunction, RS extends AbstractLongAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Long, Exception> {
	...
	public static class Base<S extends Base<S, A, RS>, A extends ShortToLongFunction, RS extends AbstractLongAssert<RS>> extends FullFunctionalAssert.Base<S, A, RS, Long, Exception> implements ShortToLongFunctionAssert<S, A, RS> {
