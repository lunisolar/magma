...
public interface LToByteFunctionXAssert<S extends LToByteFunctionXAssert<S, A, RS, T, X>, A extends LToByteFunctionX<T, X>, RS extends AbstractByteAssert<RS>, T, X extends Throwable>
	...
	class Base<S extends Base<S, A, RS, T, X>, A extends LToByteFunctionX<T, X>, RS extends AbstractByteAssert<RS>, T, X extends Throwable> extends FullFunctionalAssert.Base<S, LConsumerX<T, X>, A, RS, Byte>
			implements
