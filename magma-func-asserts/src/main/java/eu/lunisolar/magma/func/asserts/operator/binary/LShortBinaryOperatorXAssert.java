...
public interface LShortBinaryOperatorXAssert<S extends LShortBinaryOperatorXAssert<S, A, RS, X>, A extends LShortBinaryOperatorX<X>, RS extends AbstractShortAssert<RS>, X extends Throwable>
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends LShortBinaryOperatorX<X>, RS extends AbstractShortAssert<RS>, X extends Throwable> extends FullFunctionalAssert.Base<S, A, RS, Short, Exception>
			implements
