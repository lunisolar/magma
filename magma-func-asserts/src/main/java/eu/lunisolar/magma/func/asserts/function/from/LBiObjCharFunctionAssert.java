...
public interface LBiObjCharFunctionAssert<S extends LBiObjCharFunctionAssert<S, A, RS, T1, T2, R>, A extends LBiObjCharFunction<T1, T2, R>, RS extends Assert<RS, R>, T1, T2, R>
		extends
			Assert<S, A>,
			FullFunctionalAssert<S, LBiObjCharConsumer<T1, T2>, A, RS, R> {
	...
	@Nonnull
	Evaluation<S, LBiObjCharConsumer<T1, T2>, A, RS, R> doesApply(T1 a1, T2 a2, char a3);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LBiObjCharFunction<T1, T2, R>, RS extends Assert<RS, R>, T1, T2, R> extends Base<The<A, RS, T1, T2, R>, A, RS, T1, T2, R> {
	...
	class Base<S extends Base<S, A, RS, T1, T2, R>, A extends LBiObjCharFunction<T1, T2, R>, RS extends Assert<RS, R>, T1, T2, R> extends FullFunctionalAssert.Base<S, LBiObjCharConsumer<T1, T2>, A, RS, R>
			implements
