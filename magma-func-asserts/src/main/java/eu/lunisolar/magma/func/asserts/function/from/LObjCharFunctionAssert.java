...
public interface LObjCharFunctionAssert<S extends LObjCharFunctionAssert<S, A, RS, T, R>, A extends LObjCharFunction<T, R>, RS extends Assert<RS, R>, T, R> extends Assert<S, A>, FullFunctionalAssert<S, LObjCharConsumer<T>, A, RS, R> {
	...
	final class The<A extends LObjCharFunction<T, R>, RS extends Assert<RS, R>, T, R> extends Base<The<A, RS, T, R>, A, RS, T, R> {
	...
	class Base<S extends Base<S, A, RS, T, R>, A extends LObjCharFunction<T, R>, RS extends Assert<RS, R>, T, R> extends FullFunctionalAssert.Base<S, LObjCharConsumer<T>, A, RS, R> implements LObjCharFunctionAssert<S, A, RS, T, R> {
		...
		@Nonnull
		public Evaluation<S, LObjCharConsumer<T>, A, RS, R> doesApply(T a1, char a2) {
