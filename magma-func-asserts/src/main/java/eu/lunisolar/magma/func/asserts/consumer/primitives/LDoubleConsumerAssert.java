...
public interface LDoubleConsumerAssert<S extends LDoubleConsumerAssert<S, A>, A extends LDoubleConsumer> extends Assert<S, A>, FunctionalAssert.Simple<S, A, Exception> {
	...
	public static class Base<S extends Base<S, A>, A extends LDoubleConsumer> extends FunctionalAssert.Simple.Base<S, A, Exception> implements LDoubleConsumerAssert<S, A> {
