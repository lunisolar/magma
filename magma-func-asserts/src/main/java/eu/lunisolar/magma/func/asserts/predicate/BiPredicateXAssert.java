...
public interface BiPredicateXAssert<S extends BiPredicateXAssert<S, A, RS, T1, T2, X>, A extends BiPredicateX<T1, T2, X>, RS extends AbstractBooleanAssert<RS>, T1, T2, X extends Exception>
	...
	public static class Base<S extends Base<S, A, RS, T1, T2, X>, A extends BiPredicateX<T1, T2, X>, RS extends AbstractBooleanAssert<RS>, T1, T2, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception>
			implements
