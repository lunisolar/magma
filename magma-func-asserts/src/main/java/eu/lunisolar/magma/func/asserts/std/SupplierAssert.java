...
public interface SupplierAssert<S extends SupplierAssert<S, A, RS, T>, A extends Supplier<T>, RS extends Assert<RS, T>, T> extends Assert<S, A>, FullFunctionalAssert<S, LAction, A, RS, T> {
	...
	class Base<S extends Base<S, A, RS, T>, A extends Supplier<T>, RS extends Assert<RS, T>, T> extends FullFunctionalAssert.Base<S, LAction, A, RS, T> implements SupplierAssert<S, A, RS, T> {
