...
public interface LFltFunctionAssert<S extends LFltFunctionAssert<S, A, RS, R>, A extends LFltFunction<R>, RS extends Assert<RS, R>, R> extends Assert<S, A>, FullFunctionalAssert<S, LFltConsumer, A, RS, R> {
	...
	@Nonnull
	Evaluation<S, LFltConsumer, A, RS, R> doesApply(float a);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LFltFunction<R>, RS extends Assert<RS, R>, R> extends Base<The<A, RS, R>, A, RS, R> {
	...
	class Base<S extends Base<S, A, RS, R>, A extends LFltFunction<R>, RS extends Assert<RS, R>, R> extends FullFunctionalAssert.Base<S, LFltConsumer, A, RS, R> implements LFltFunctionAssert<S, A, RS, R> {
