...
/** Assert for BooleanToFloatFunctionX. */
public interface BooleanToFloatFunctionXAssert<S extends BooleanToFloatFunctionXAssert<S, A, RS, X>, A extends BooleanToFloatFunctionX<X>, RS extends AbstractFloatAssert<RS>, X extends Exception>
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends BooleanToFloatFunctionX<X>, RS extends AbstractFloatAssert<RS>, X extends Exception> extends FullFunctionalAssert.Base<S, A, RS, Float, Exception>
			implements
