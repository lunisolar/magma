...
/** Assertions for BooleanToShortFunction. */
public interface BooleanToShortFunctionAssert<S extends BooleanToShortFunctionAssert<S, A, RS>, A extends BooleanToShortFunction, RS extends AbstractShortAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends BooleanToShortFunction, RS extends AbstractShortAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Short, Exception> implements BooleanToShortFunctionAssert<S, A, RS> {
