...
/** Assertions for ObjLongPredicate. */
public interface ObjLongPredicateAssert<S extends ObjLongPredicateAssert<S, A, RS, T>, A extends ObjLongPredicate<T>, RS extends AbstractBooleanAssert<RS>, T>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, T>, A extends ObjLongPredicate<T>, RS extends AbstractBooleanAssert<RS>, T> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception> implements ObjLongPredicateAssert<S, A, RS, T> {
