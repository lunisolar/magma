...
/** Assertions for IntBiFunctionX. */
public interface IntBiFunctionXAssert<S extends IntBiFunctionXAssert<S, A, RS, R, X>, A extends IntBiFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, R, X>, A extends IntBiFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Exception> extends FunctionalAssert.Base<S, A, RS, R, Exception> implements IntBiFunctionXAssert<S, A, RS, R, X> {
