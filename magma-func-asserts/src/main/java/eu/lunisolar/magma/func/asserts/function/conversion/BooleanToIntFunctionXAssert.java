...
/** Assertions for BooleanToIntFunctionX. */
public interface BooleanToIntFunctionXAssert<S extends BooleanToIntFunctionXAssert<S, A, RS, X>, A extends BooleanToIntFunctionX<X>, RS extends AbstractIntegerAssert<RS>, X extends Exception>
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends BooleanToIntFunctionX<X>, RS extends AbstractIntegerAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Integer, Exception>
			implements
