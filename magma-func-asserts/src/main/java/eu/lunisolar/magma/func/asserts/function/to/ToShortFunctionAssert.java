...
/** Assertions for ToShortFunction. */
public interface ToShortFunctionAssert<S extends ToShortFunctionAssert<S, A, RS, T>, A extends ToShortFunction<T>, RS extends AbstractShortAssert<RS>, T>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, T>, A extends ToShortFunction<T>, RS extends AbstractShortAssert<RS>, T> extends FunctionalAssert.Base<S, A, RS, Short, Exception> implements ToShortFunctionAssert<S, A, RS, T> {
