...
/** Assertions for IntToCharFunction. */
public interface IntToCharFunctionAssert<S extends IntToCharFunctionAssert<S, A, RS>, A extends IntToCharFunction, RS extends AbstractCharacterAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends IntToCharFunction, RS extends AbstractCharacterAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Character, Exception> implements IntToCharFunctionAssert<S, A, RS> {
