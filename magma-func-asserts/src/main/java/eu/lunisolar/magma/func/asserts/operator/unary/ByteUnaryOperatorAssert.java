...
/** Assert for ByteUnaryOperator. */
public interface ByteUnaryOperatorAssert<S extends ByteUnaryOperatorAssert<S, A, RS>, A extends ByteUnaryOperator, RS extends AbstractByteAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Byte, Exception> {
	...
	public static class Base<S extends Base<S, A, RS>, A extends ByteUnaryOperator, RS extends AbstractByteAssert<RS>> extends FullFunctionalAssert.Base<S, A, RS, Byte, Exception> implements ByteUnaryOperatorAssert<S, A, RS> {
