...
public interface StdDoubleBinaryOperatorAssert<S extends StdDoubleBinaryOperatorAssert<S, A, RS>, A extends java.util.function.DoubleBinaryOperator, RS extends AbstractDoubleAssert<RS>>
	...
	public static class Base<S extends Base<S, A, RS>, A extends java.util.function.DoubleBinaryOperator, RS extends AbstractDoubleAssert<RS>> extends FullFunctionalAssert.Base<S, A, RS, Double, Exception>
			implements
				StdDoubleBinaryOperatorAssert<S, A, RS> {
