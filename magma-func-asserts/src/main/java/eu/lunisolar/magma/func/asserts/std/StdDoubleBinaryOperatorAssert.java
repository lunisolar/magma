...
/** Assertions for java.util.function.DoubleBinaryOperator. */
public interface StdDoubleBinaryOperatorAssert<S extends StdDoubleBinaryOperatorAssert<S, A, RS>, A extends java.util.function.DoubleBinaryOperator, RS extends AbstractDoubleAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends java.util.function.DoubleBinaryOperator, RS extends AbstractDoubleAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Double, Exception> implements StdDoubleBinaryOperatorAssert<S, A, RS> {
