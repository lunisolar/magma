...
/** Assertions for java.util.function.LongToIntFunction. */
public interface StdLongToIntFunctionAssert<S extends StdLongToIntFunctionAssert<S, A, RS>, A extends java.util.function.LongToIntFunction, RS extends AbstractIntegerAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends java.util.function.LongToIntFunction, RS extends AbstractIntegerAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Integer, Exception> implements StdLongToIntFunctionAssert<S, A, RS> {
