...
/** Assertions for BinaryOperator. */
public interface BinaryOperatorAssert<S extends BinaryOperatorAssert<S, A, RS, T>, A extends BinaryOperator<T>, RS extends Assert<RS, T>, T> extends Assert<S, A>, FunctionalAssert<S, A, RS, T, Exception>, RecurringAsserts<S, A, RS, T> {

	@Nonnull
	Evaluation<S, A, RS, T, Exception> doesApply(T t1, T t2);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	public final static class Impl<A extends BinaryOperator<T>, RS extends Assert<RS, T>, T> extends Base<Impl<A, RS, T>, A, RS, T> {
	...
	public static class Base<S extends Base<S, A, RS, T>, A extends BinaryOperator<T>, RS extends Assert<RS, T>, T> extends FunctionalAssert.Base<S, A, RS, T, Exception> implements BinaryOperatorAssert<S, A, RS, T> {
