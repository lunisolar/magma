...
public interface LObjIntObjPredicateAssert<S extends LObjIntObjPredicateAssert<S, A, RS, T1, T2>, A extends LObjIntObjPredicate<T1, T2>, RS extends AbstractBooleanAssert<RS>, T1, T2>
		extends
			Assert<S, A>,
	...
	@Nonnull
	Evaluation<S, LTieConsumer<T1, T2>, A, RS, Boolean> doesTest(T1 a1, int a2, T2 a3);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LObjIntObjPredicate<T1, T2>, RS extends AbstractBooleanAssert<RS>, T1, T2> extends Base<The<A, RS, T1, T2>, A, RS, T1, T2> {
	...
	class Base<S extends Base<S, A, RS, T1, T2>, A extends LObjIntObjPredicate<T1, T2>, RS extends AbstractBooleanAssert<RS>, T1, T2> extends FullFunctionalAssert.Base<S, LTieConsumer<T1, T2>, A, RS, Boolean>
			implements
				LObjIntObjPredicateAssert<S, A, RS, T1, T2> {
