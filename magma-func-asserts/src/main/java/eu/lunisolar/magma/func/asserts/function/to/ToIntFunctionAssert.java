...
/** Assertions for ToIntFunction. */
public interface ToIntFunctionAssert<S extends ToIntFunctionAssert<S, A, RS, T>, A extends ToIntFunction<T>, RS extends AbstractIntegerAssert<RS>, T>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, T>, A extends ToIntFunction<T>, RS extends AbstractIntegerAssert<RS>, T> extends FunctionalAssert.Base<S, A, RS, Integer, Exception> implements ToIntFunctionAssert<S, A, RS, T> {
