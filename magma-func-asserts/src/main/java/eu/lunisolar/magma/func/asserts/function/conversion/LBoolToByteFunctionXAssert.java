...
public interface LBoolToByteFunctionXAssert<S extends LBoolToByteFunctionXAssert<S, A, RS, X>, A extends LBoolToByteFunctionX<X>, RS extends AbstractByteAssert<RS>, X extends Throwable>
	...
	class Base<S extends Base<S, A, RS, X>, A extends LBoolToByteFunctionX<X>, RS extends AbstractByteAssert<RS>, X extends Throwable> extends FullFunctionalAssert.Base<S, LBoolConsumerX<X>, A, RS, Byte> implements LBoolToByteFunctionXAssert<S, A, RS, X> {
