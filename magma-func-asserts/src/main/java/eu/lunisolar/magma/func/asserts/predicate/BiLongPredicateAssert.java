...
/** Assert for BiLongPredicate. */
public interface BiLongPredicateAssert<S extends BiLongPredicateAssert<S, A, RS>, A extends BiLongPredicate, RS extends AbstractBooleanAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Boolean, Exception> {
	...
	public static class Base<S extends Base<S, A, RS>, A extends BiLongPredicate, RS extends AbstractBooleanAssert<RS>> extends FullFunctionalAssert.Base<S, A, RS, Boolean, Exception> implements BiLongPredicateAssert<S, A, RS> {
