...
public interface LongPredicateAssert<S extends LongPredicateAssert<S, A, RS>, A extends LongPredicate, RS extends AbstractBooleanAssert<RS>> extends Assert<S, A>, FunctionalAssert<S, A, RS, Boolean, Exception>, RecurringAsserts<S, A, RS, Boolean> {

	@Nonnull
	Evaluation<S, A, RS, Boolean, Exception> doesTest(long l);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	public final static class Impl<A extends LongPredicate, RS extends AbstractBooleanAssert<RS>> extends Base<Impl<A, RS>, A, RS> {
	...
	public static class Base<S extends Base<S, A, RS>, A extends LongPredicate, RS extends AbstractBooleanAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception> implements LongPredicateAssert<S, A, RS> {
