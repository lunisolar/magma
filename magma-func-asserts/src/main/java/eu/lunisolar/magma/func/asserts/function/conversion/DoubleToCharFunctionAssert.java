...
/** Assertions for DoubleToCharFunction. */
public interface DoubleToCharFunctionAssert<S extends DoubleToCharFunctionAssert<S, A, RS>, A extends DoubleToCharFunction, RS extends AbstractCharacterAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends DoubleToCharFunction, RS extends AbstractCharacterAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Character, Exception> implements DoubleToCharFunctionAssert<S, A, RS> {
