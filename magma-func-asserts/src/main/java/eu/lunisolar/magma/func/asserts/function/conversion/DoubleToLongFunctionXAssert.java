...
/** Assertions for DoubleToLongFunctionX. */
public interface DoubleToLongFunctionXAssert<S extends DoubleToLongFunctionXAssert<S, A, RS, X>, A extends DoubleToLongFunctionX<X>, RS extends AbstractLongAssert<RS>, X extends Exception>
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends DoubleToLongFunctionX<X>, RS extends AbstractLongAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Long, Exception>
			implements
