...
/** Assertions for IntToByteFunction. */
public interface IntToByteFunctionAssert<S extends IntToByteFunctionAssert<S, A, RS>, A extends IntToByteFunction, RS extends AbstractByteAssert<RS>> extends Assert<S, A>, FunctionalAssert<S, A, RS, Byte, Exception>, RecurringAsserts<S, A, RS, Byte> {
	...
	public static class Base<S extends Base<S, A, RS>, A extends IntToByteFunction, RS extends AbstractByteAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Byte, Exception> implements IntToByteFunctionAssert<S, A, RS> {
