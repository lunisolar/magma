...
public interface LDblToLongFunctionAssert<S extends LDblToLongFunctionAssert<S, A, RS>, A extends LDblToLongFunction, RS extends AbstractLongAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LDblConsumer, A, RS, Long> {
	...
	final class The<A extends LDblToLongFunction, RS extends AbstractLongAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LDblToLongFunction, RS extends AbstractLongAssert<RS>> extends FullFunctionalAssert.Base<S, LDblConsumer, A, RS, Long> implements LDblToLongFunctionAssert<S, A, RS> {
