...
public interface LBoolSupplierAssert<S extends LBoolSupplierAssert<S, A, RS>, A extends LBoolSupplier, RS extends AbstractBooleanAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LAction, A, RS, Boolean> {
	...
	final class The<A extends LBoolSupplier, RS extends AbstractBooleanAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LBoolSupplier, RS extends AbstractBooleanAssert<RS>> extends FullFunctionalAssert.Base<S, LAction, A, RS, Boolean> implements LBoolSupplierAssert<S, A, RS> {
