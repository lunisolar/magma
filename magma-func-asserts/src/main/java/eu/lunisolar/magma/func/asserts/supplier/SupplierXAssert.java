...
/** Assert for SupplierX. */
public interface SupplierXAssert<S extends SupplierXAssert<S, A, RS, R, X>, A extends SupplierX<R, X>, RS extends Assert<RS, R>, R, X extends Exception> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, R, Exception> {
	...
	public static class Base<S extends Base<S, A, RS, R, X>, A extends SupplierX<R, X>, RS extends Assert<RS, R>, R, X extends Exception> extends FullFunctionalAssert.Base<S, A, RS, R, Exception> implements SupplierXAssert<S, A, RS, R, X> {
