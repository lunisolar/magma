...
/** Assertions for SupplierX. */
public interface SupplierXAssert<S extends SupplierXAssert<S, A, RS, R, X>, A extends SupplierX<R, X>, RS extends Assert<RS, R>, R, X extends Exception> extends Assert<S, A>, FunctionalAssert<S, A, RS, R, Exception>, RecurringAsserts<S, A, RS, R> {

	@Nonnull
	Evaluation<S, A, RS, R, Exception> doesGet();

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	public final static class Impl<A extends SupplierX<R, X>, RS extends Assert<RS, R>, R, X extends Exception> extends Base<Impl<A, RS, R, X>, A, RS, R, X> {
	...
	public static class Base<S extends Base<S, A, RS, R, X>, A extends SupplierX<R, X>, RS extends Assert<RS, R>, R, X extends Exception> extends FunctionalAssert.Base<S, A, RS, R, Exception> implements SupplierXAssert<S, A, RS, R, X> {
