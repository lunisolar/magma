...
/** Assert for FloatUnaryOperator. */
public interface FloatUnaryOperatorAssert<S extends FloatUnaryOperatorAssert<S, A, RS>, A extends FloatUnaryOperator, RS extends AbstractFloatAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Float, Exception> {
	...
	public static class Base<S extends Base<S, A, RS>, A extends FloatUnaryOperator, RS extends AbstractFloatAssert<RS>> extends FullFunctionalAssert.Base<S, A, RS, Float, Exception> implements FloatUnaryOperatorAssert<S, A, RS> {
