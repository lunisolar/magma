...
public interface LDblPredicateAssert<S extends LDblPredicateAssert<S, A, RS>, A extends LDblPredicate, RS extends AbstractBooleanAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LDblConsumer, A, RS, Boolean> {
	...
	final class The<A extends LDblPredicate, RS extends AbstractBooleanAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LDblPredicate, RS extends AbstractBooleanAssert<RS>> extends FullFunctionalAssert.Base<S, LDblConsumer, A, RS, Boolean> implements LDblPredicateAssert<S, A, RS> {
