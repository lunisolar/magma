...
public interface LBiBoolFunctionAssert<S extends LBiBoolFunctionAssert<S, A, RS, R>, A extends LBiBoolFunction<R>, RS extends Assert<RS, R>, R> extends Assert<S, A>, FullFunctionalAssert<S, LBiBoolConsumerX<Exception>, A, RS, R, Exception> {
	...
	public static class Base<S extends Base<S, A, RS, R>, A extends LBiBoolFunction<R>, RS extends Assert<RS, R>, R> extends FullFunctionalAssert.Base<S, LBiBoolConsumerX<Exception>, A, RS, R, Exception> implements LBiBoolFunctionAssert<S, A, RS, R> {
