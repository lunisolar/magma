...
/** Assertions for IntBinaryOperatorX. */
public interface IntBinaryOperatorXAssert<S extends IntBinaryOperatorXAssert<S, A, RS, X>, A extends IntBinaryOperatorX<X>, RS extends AbstractIntegerAssert<RS>, X extends Exception>
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends IntBinaryOperatorX<X>, RS extends AbstractIntegerAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Integer, Exception>
			implements
