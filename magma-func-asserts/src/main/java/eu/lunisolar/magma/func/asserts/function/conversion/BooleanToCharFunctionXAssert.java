...
/** Assertions for BooleanToCharFunctionX. */
public interface BooleanToCharFunctionXAssert<S extends BooleanToCharFunctionXAssert<S, A, RS, X>, A extends BooleanToCharFunctionX<X>, RS extends AbstractCharacterAssert<RS>, X extends Exception>
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends BooleanToCharFunctionX<X>, RS extends AbstractCharacterAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Character, Exception>
			implements
