...
/** Assertions for LongToIntFunction. */
public interface LongToIntFunctionAssert<S extends LongToIntFunctionAssert<S, A, RS>, A extends LongToIntFunction, RS extends AbstractIntegerAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends LongToIntFunction, RS extends AbstractIntegerAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Integer, Exception> implements LongToIntFunctionAssert<S, A, RS> {
