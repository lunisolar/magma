...
/** Assertions for IntToFloatFunction. */
public interface IntToFloatFunctionAssert<S extends IntToFloatFunctionAssert<S, A, RS>, A extends IntToFloatFunction, RS extends AbstractFloatAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends IntToFloatFunction, RS extends AbstractFloatAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Float, Exception> implements IntToFloatFunctionAssert<S, A, RS> {
