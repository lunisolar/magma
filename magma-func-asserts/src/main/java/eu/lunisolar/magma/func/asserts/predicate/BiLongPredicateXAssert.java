...
/** Assertions for BiLongPredicateX. */
public interface BiLongPredicateXAssert<S extends BiLongPredicateXAssert<S, A, RS, X>, A extends BiLongPredicateX<X>, RS extends AbstractBooleanAssert<RS>, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends BiLongPredicateX<X>, RS extends AbstractBooleanAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception> implements BiLongPredicateXAssert<S, A, RS, X> {
