...
/** Assertions for DoubleUnaryOperatorX. */
public interface DoubleUnaryOperatorXAssert<S extends DoubleUnaryOperatorXAssert<S, A, RS, X>, A extends DoubleUnaryOperatorX<X>, RS extends AbstractDoubleAssert<RS>, X extends Exception>
		extends
			Assert<S, A>,
	...
	public final static class Impl<A extends DoubleUnaryOperatorX<X>, RS extends AbstractDoubleAssert<RS>, X extends Exception> extends Base<Impl<A, RS, X>, A, RS, X> {
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends DoubleUnaryOperatorX<X>, RS extends AbstractDoubleAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Double, Exception>
			implements
				DoubleUnaryOperatorXAssert<S, A, RS, X> {
