...
/** Assertions for ToDoubleBiFunction. */
public interface ToDoubleBiFunctionAssert<S extends ToDoubleBiFunctionAssert<S, A, RS, T1, T2>, A extends ToDoubleBiFunction<T1, T2>, RS extends AbstractDoubleAssert<RS>, T1, T2>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, T1, T2>, A extends ToDoubleBiFunction<T1, T2>, RS extends AbstractDoubleAssert<RS>, T1, T2> extends FunctionalAssert.Base<S, A, RS, Double, Exception>
			implements
