...
public interface LDblConsumerAssert<S extends LDblConsumerAssert<S, A>, A extends LDblConsumer> extends Assert<S, A>, FunctionalAssert.Simple<S, LDblConsumer, A> {
	...
	final class The<A extends LDblConsumer> extends Base<The<A>, A> {
	...
	class Base<S extends Base<S, A>, A extends LDblConsumer> extends FunctionalAssert.Simple.Base<S, LDblConsumer, A> implements LDblConsumerAssert<S, A> {
