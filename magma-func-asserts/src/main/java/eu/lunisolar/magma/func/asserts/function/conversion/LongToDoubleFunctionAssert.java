...
/** Assertions for LongToDoubleFunction. */
public interface LongToDoubleFunctionAssert<S extends LongToDoubleFunctionAssert<S, A, RS>, A extends LongToDoubleFunction, RS extends AbstractDoubleAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends LongToDoubleFunction, RS extends AbstractDoubleAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Double, Exception> implements LongToDoubleFunctionAssert<S, A, RS> {
