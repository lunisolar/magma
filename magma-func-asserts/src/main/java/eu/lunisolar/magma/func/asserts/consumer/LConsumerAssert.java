...
public interface LConsumerAssert<S extends LConsumerAssert<S, A, T>, A extends LConsumer<T>, T> extends Assert<S, A>, FunctionalAssert.Simple<S, LConsumerX<T, Exception>, A, Exception> {
	...
	public static class Base<S extends Base<S, A, T>, A extends LConsumer<T>, T> extends FunctionalAssert.Simple.Base<S, LConsumerX<T, Exception>, A, Exception> implements LConsumerAssert<S, A, T> {
