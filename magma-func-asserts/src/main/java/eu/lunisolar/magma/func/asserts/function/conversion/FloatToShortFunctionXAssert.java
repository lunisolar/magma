...
/** Assertions for FloatToShortFunctionX. */
public interface FloatToShortFunctionXAssert<S extends FloatToShortFunctionXAssert<S, A, RS, X>, A extends FloatToShortFunctionX<X>, RS extends AbstractShortAssert<RS>, X extends Exception>
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends FloatToShortFunctionX<X>, RS extends AbstractShortAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Short, Exception>
			implements
