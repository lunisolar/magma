...
/** Assertions for java.util.function.LongToDoubleFunction. */
public interface StdLongToDoubleFunctionAssert<S extends StdLongToDoubleFunctionAssert<S, A, RS>, A extends java.util.function.LongToDoubleFunction, RS extends AbstractDoubleAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends java.util.function.LongToDoubleFunction, RS extends AbstractDoubleAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Double, Exception> implements StdLongToDoubleFunctionAssert<S, A, RS> {
