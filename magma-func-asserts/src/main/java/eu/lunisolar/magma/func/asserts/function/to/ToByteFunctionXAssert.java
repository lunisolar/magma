...
/** Assert for ToByteFunctionX. */
public interface ToByteFunctionXAssert<S extends ToByteFunctionXAssert<S, A, RS, T, X>, A extends ToByteFunctionX<T, X>, RS extends AbstractByteAssert<RS>, T, X extends Exception> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Byte, Exception> {
	...
	public static class Base<S extends Base<S, A, RS, T, X>, A extends ToByteFunctionX<T, X>, RS extends AbstractByteAssert<RS>, T, X extends Exception> extends FullFunctionalAssert.Base<S, A, RS, Byte, Exception>
			implements
