...
public interface LSrt2Obj1Obj0ConsAssert<S extends LSrt2Obj1Obj0ConsAssert<S, A, T2, T1>, A extends LBiObjSrtConsumer.LSrt2Obj1Obj0Cons<T2, T1>, T2, T1> extends Assert<S, A>, FunctionalAssert.Simple<S, LBiObjSrtConsumer.LSrt2Obj0Obj1Cons<T2, T1>, A> {
	...
	@Nonnull
	SemiEvaluation<S, LBiObjSrtConsumer.LSrt2Obj0Obj1Cons<T2, T1>, A> doesAccept(short a3, T2 a2, T1 a1);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LBiObjSrtConsumer.LSrt2Obj1Obj0Cons<T2, T1>, T2, T1> extends Base<The<A, T2, T1>, A, T2, T1> {
	...
	class Base<S extends Base<S, A, T2, T1>, A extends LBiObjSrtConsumer.LSrt2Obj1Obj0Cons<T2, T1>, T2, T1> extends FunctionalAssert.Simple.Base<S, LBiObjSrtConsumer.LSrt2Obj0Obj1Cons<T2, T1>, A> implements LSrt2Obj1Obj0ConsAssert<S, A, T2, T1> {
		...
		@Nonnull
		public SemiEvaluation<S, LBiObjSrtConsumer.LSrt2Obj0Obj1Cons<T2, T1>, A> doesAccept(short a3, T2 a2, T1 a1) {
			...
			return evaluation(() -> String.format("(%s,%s,%s)", a3, a2, a1), pc -> {
				...
				actual.acceptSrt2Obj1Obj0(a3, a2, a1);
				return null;
			});
		}
