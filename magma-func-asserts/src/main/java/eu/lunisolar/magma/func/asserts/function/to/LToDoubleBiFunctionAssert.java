...
public interface LToDoubleBiFunctionAssert<S extends LToDoubleBiFunctionAssert<S, A, RS, T1, T2>, A extends LToDoubleBiFunction<T1, T2>, RS extends AbstractDoubleAssert<RS>, T1, T2> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Double, Exception> {
	...
	public static class Base<S extends Base<S, A, RS, T1, T2>, A extends LToDoubleBiFunction<T1, T2>, RS extends AbstractDoubleAssert<RS>, T1, T2> extends FullFunctionalAssert.Base<S, A, RS, Double, Exception>
			implements
