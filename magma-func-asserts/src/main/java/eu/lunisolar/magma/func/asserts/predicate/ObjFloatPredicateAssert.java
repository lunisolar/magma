...
/** Assertions for ObjFloatPredicate. */
public interface ObjFloatPredicateAssert<S extends ObjFloatPredicateAssert<S, A, RS, T>, A extends ObjFloatPredicate<T>, RS extends AbstractBooleanAssert<RS>, T>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, T>, A extends ObjFloatPredicate<T>, RS extends AbstractBooleanAssert<RS>, T> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception> implements ObjFloatPredicateAssert<S, A, RS, T> {
