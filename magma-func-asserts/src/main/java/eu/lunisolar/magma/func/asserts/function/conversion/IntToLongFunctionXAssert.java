...
/** Assertions for IntToLongFunctionX. */
public interface IntToLongFunctionXAssert<S extends IntToLongFunctionXAssert<S, A, RS, X>, A extends IntToLongFunctionX<X>, RS extends AbstractLongAssert<RS>, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends IntToLongFunctionX<X>, RS extends AbstractLongAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Long, Exception> implements IntToLongFunctionXAssert<S, A, RS, X> {
