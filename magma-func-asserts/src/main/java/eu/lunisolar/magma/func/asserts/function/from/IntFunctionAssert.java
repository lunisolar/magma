...
/** Assertions for IntFunction. */
public interface IntFunctionAssert<S extends IntFunctionAssert<S, A, RS, R>, A extends IntFunction<R>, RS extends Assert<RS, R>, R> extends Assert<S, A>, FunctionalAssert<S, A, RS, R, Exception>, RecurringAsserts<S, A, RS, R> {

	@Nonnull
	Evaluation<S, A, RS, R, Exception> doesApply(int i);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	public final static class Impl<A extends IntFunction<R>, RS extends Assert<RS, R>, R> extends Base<Impl<A, RS, R>, A, RS, R> {
	...
	public static class Base<S extends Base<S, A, RS, R>, A extends IntFunction<R>, RS extends Assert<RS, R>, R> extends FunctionalAssert.Base<S, A, RS, R, Exception> implements IntFunctionAssert<S, A, RS, R> {
