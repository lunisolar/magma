...
public interface LActionAssert<S extends LActionAssert<S, A>, A extends LAction> extends Assert<S, A>, FunctionalAssert.Simple<S, LActionX<Exception>, A, Exception> {
	...
	public static class Base<S extends Base<S, A>, A extends LAction> extends FunctionalAssert.Simple.Base<S, LActionX<Exception>, A, Exception> implements LActionAssert<S, A> {
