...
/** Assert for LAction. */
public interface LActionAssert<S extends LActionAssert<S, A>, A extends LAction> extends Assert<S, A>, FunctionalAssert.Simple<S, A, Exception> {
	...
	public final static class Impl<A extends LAction> extends Base<Impl<A>, A> {
	...
	public static class Base<S extends Base<S, A>, A extends LAction> extends FunctionalAssert.Simple.Base<S, A, Exception> implements LActionAssert<S, A> {
