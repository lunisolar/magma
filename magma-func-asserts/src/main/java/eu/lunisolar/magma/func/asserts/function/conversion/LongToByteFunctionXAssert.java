...
/** Assertions for LongToByteFunctionX. */
public interface LongToByteFunctionXAssert<S extends LongToByteFunctionXAssert<S, A, RS, X>, A extends LongToByteFunctionX<X>, RS extends AbstractByteAssert<RS>, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends LongToByteFunctionX<X>, RS extends AbstractByteAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Byte, Exception> implements LongToByteFunctionXAssert<S, A, RS, X> {
