...
public interface StdDoubleSupplierAssert<S extends StdDoubleSupplierAssert<S, A, RS>, A extends java.util.function.DoubleSupplier, RS extends AbstractDoubleAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Double, Exception> {
	...
	public static class Base<S extends Base<S, A, RS>, A extends java.util.function.DoubleSupplier, RS extends AbstractDoubleAssert<RS>> extends FullFunctionalAssert.Base<S, A, RS, Double, Exception> implements StdDoubleSupplierAssert<S, A, RS> {
