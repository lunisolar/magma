...
/** Assertions for java.util.function.IntPredicate. */
public interface StdIntPredicateAssert<S extends StdIntPredicateAssert<S, A, RS>, A extends java.util.function.IntPredicate, RS extends AbstractBooleanAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends java.util.function.IntPredicate, RS extends AbstractBooleanAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception> implements StdIntPredicateAssert<S, A, RS> {
