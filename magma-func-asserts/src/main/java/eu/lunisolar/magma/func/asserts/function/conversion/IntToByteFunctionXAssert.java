...
/** Assertions for IntToByteFunctionX. */
public interface IntToByteFunctionXAssert<S extends IntToByteFunctionXAssert<S, A, RS, X>, A extends IntToByteFunctionX<X>, RS extends AbstractByteAssert<RS>, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends IntToByteFunctionX<X>, RS extends AbstractByteAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Byte, Exception> implements IntToByteFunctionXAssert<S, A, RS, X> {
