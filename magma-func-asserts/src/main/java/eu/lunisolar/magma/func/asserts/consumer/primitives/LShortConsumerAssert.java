...
public interface LShortConsumerAssert<S extends LShortConsumerAssert<S, A>, A extends LShortConsumer> extends Assert<S, A>, FunctionalAssert.Simple<S, A, Exception> {
	...
	public static class Base<S extends Base<S, A>, A extends LShortConsumer> extends FunctionalAssert.Simple.Base<S, A, Exception> implements LShortConsumerAssert<S, A> {
