...
/** Assertions for CharBiFunctionX. */
public interface CharBiFunctionXAssert<S extends CharBiFunctionXAssert<S, A, RS, R, X>, A extends CharBiFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, R, X>, A extends CharBiFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Exception> extends FunctionalAssert.Base<S, A, RS, R, Exception> implements CharBiFunctionXAssert<S, A, RS, R, X> {
