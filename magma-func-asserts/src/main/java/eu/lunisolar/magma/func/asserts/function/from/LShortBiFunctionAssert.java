...
public interface LShortBiFunctionAssert<S extends LShortBiFunctionAssert<S, A, RS, R>, A extends LShortBiFunction<R>, RS extends Assert<RS, R>, R> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, R, Exception> {
	...
	public static class Base<S extends Base<S, A, RS, R>, A extends LShortBiFunction<R>, RS extends Assert<RS, R>, R> extends FullFunctionalAssert.Base<S, A, RS, R, Exception> implements LShortBiFunctionAssert<S, A, RS, R> {
