...
/** Assertions for IntPredicateX. */
public interface IntPredicateXAssert<S extends IntPredicateXAssert<S, A, RS, X>, A extends IntPredicateX<X>, RS extends AbstractBooleanAssert<RS>, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends IntPredicateX<X>, RS extends AbstractBooleanAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception> implements IntPredicateXAssert<S, A, RS, X> {
