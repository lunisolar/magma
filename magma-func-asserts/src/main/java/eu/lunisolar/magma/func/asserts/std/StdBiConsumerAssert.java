...
public interface StdBiConsumerAssert<S extends StdBiConsumerAssert<S, A, T1, T2>, A extends java.util.function.BiConsumer<T1, T2>, T1, T2> extends Assert<S, A>, FunctionalAssert.Simple<S, A, Exception> {
	...
	public static class Base<S extends Base<S, A, T1, T2>, A extends java.util.function.BiConsumer<T1, T2>, T1, T2> extends FunctionalAssert.Simple.Base<S, A, Exception> implements StdBiConsumerAssert<S, A, T1, T2> {
