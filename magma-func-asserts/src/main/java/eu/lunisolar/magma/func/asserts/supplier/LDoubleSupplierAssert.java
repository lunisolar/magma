...
public interface LDoubleSupplierAssert<S extends LDoubleSupplierAssert<S, A, RS>, A extends LDoubleSupplier, RS extends AbstractDoubleAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Double, Exception> {
	...
	public static class Base<S extends Base<S, A, RS>, A extends LDoubleSupplier, RS extends AbstractDoubleAssert<RS>> extends FullFunctionalAssert.Base<S, A, RS, Double, Exception> implements LDoubleSupplierAssert<S, A, RS> {
