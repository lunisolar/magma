...
/** Assertions for ObjCharPredicate. */
public interface ObjCharPredicateAssert<S extends ObjCharPredicateAssert<S, A, RS, T>, A extends ObjCharPredicate<T>, RS extends AbstractBooleanAssert<RS>, T>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, T>, A extends ObjCharPredicate<T>, RS extends AbstractBooleanAssert<RS>, T> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception> implements ObjCharPredicateAssert<S, A, RS, T> {
