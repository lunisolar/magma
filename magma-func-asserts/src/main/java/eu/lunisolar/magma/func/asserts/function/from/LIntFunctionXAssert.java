...
public interface LIntFunctionXAssert<S extends LIntFunctionXAssert<S, A, RS, R, X>, A extends LIntFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Throwable> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, R, Exception> {
	...
	public static class Base<S extends Base<S, A, RS, R, X>, A extends LIntFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Throwable> extends FullFunctionalAssert.Base<S, A, RS, R, Exception> implements LIntFunctionXAssert<S, A, RS, R, X> {
