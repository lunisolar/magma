...
/** Assertions for CharToIntFunction. */
public interface CharToIntFunctionAssert<S extends CharToIntFunctionAssert<S, A, RS>, A extends CharToIntFunction, RS extends AbstractIntegerAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends CharToIntFunction, RS extends AbstractIntegerAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Integer, Exception> implements CharToIntFunctionAssert<S, A, RS> {
