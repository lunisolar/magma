...
/** Assertions for IntToDoubleFunction. */
public interface IntToDoubleFunctionAssert<S extends IntToDoubleFunctionAssert<S, A, RS>, A extends IntToDoubleFunction, RS extends AbstractDoubleAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends IntToDoubleFunction, RS extends AbstractDoubleAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Double, Exception> implements IntToDoubleFunctionAssert<S, A, RS> {
