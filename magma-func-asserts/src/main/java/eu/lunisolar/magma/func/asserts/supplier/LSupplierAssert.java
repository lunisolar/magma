...
public interface LSupplierAssert<S extends LSupplierAssert<S, A, RS, T>, A extends LSupplier<T>, RS extends Assert<RS, T>, T> extends Assert<S, A>, FullFunctionalAssert<S, LAction, A, RS, T> {
	...
	final class The<A extends LSupplier<T>, RS extends Assert<RS, T>, T> extends Base<The<A, RS, T>, A, RS, T> {
	...
	class Base<S extends Base<S, A, RS, T>, A extends LSupplier<T>, RS extends Assert<RS, T>, T> extends FullFunctionalAssert.Base<S, LAction, A, RS, T> implements LSupplierAssert<S, A, RS, T> {
