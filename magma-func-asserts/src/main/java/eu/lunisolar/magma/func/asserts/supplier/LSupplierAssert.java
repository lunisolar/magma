...
public interface LSupplierAssert<S extends LSupplierAssert<S, A, RS, R>, A extends LSupplier<R>, RS extends Assert<RS, R>, R> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, R, Exception> {
	...
	public static class Base<S extends Base<S, A, RS, R>, A extends LSupplier<R>, RS extends Assert<RS, R>, R> extends FullFunctionalAssert.Base<S, A, RS, R, Exception> implements LSupplierAssert<S, A, RS, R> {
