...
public interface LSupplierAssert<S extends LSupplierAssert<S, A, RS, R>, A extends LSupplier<R>, RS extends Assert<RS, R>, R> extends Assert<S, A>, FullFunctionalAssert<S, LActionX<Exception>, A, RS, R, Exception> {

	@Nonnull
	Evaluation<S, LActionX<Exception>, A, RS, R, Exception> doesGet();

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	public final static class Impl<A extends LSupplier<R>, RS extends Assert<RS, R>, R> extends Base<Impl<A, RS, R>, A, RS, R> {
	...
	public static class Base<S extends Base<S, A, RS, R>, A extends LSupplier<R>, RS extends Assert<RS, R>, R> extends FullFunctionalAssert.Base<S, LActionX<Exception>, A, RS, R, Exception> implements LSupplierAssert<S, A, RS, R> {
