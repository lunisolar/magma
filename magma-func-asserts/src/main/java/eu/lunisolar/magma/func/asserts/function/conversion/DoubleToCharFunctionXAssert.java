...
/** Assertions for DoubleToCharFunctionX. */
public interface DoubleToCharFunctionXAssert<S extends DoubleToCharFunctionXAssert<S, A, RS, X>, A extends DoubleToCharFunctionX<X>, RS extends AbstractCharacterAssert<RS>, X extends Exception>
		extends
			Assert<S, A>,
	...
	public final static class Impl<A extends DoubleToCharFunctionX<X>, RS extends AbstractCharacterAssert<RS>, X extends Exception> extends Base<Impl<A, RS, X>, A, RS, X> {
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends DoubleToCharFunctionX<X>, RS extends AbstractCharacterAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Character, Exception>
			implements
				DoubleToCharFunctionXAssert<S, A, RS, X> {
