...
/** Assertions for BooleanToByteFunction. */
public interface BooleanToByteFunctionAssert<S extends BooleanToByteFunctionAssert<S, A, RS>, A extends BooleanToByteFunction, RS extends AbstractByteAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends BooleanToByteFunction, RS extends AbstractByteAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Byte, Exception> implements BooleanToByteFunctionAssert<S, A, RS> {
