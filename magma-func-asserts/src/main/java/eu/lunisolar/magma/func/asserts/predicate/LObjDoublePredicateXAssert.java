...
public interface LObjDoublePredicateXAssert<S extends LObjDoublePredicateXAssert<S, A, RS, T, X>, A extends LObjDoublePredicateX<T, X>, RS extends AbstractBooleanAssert<RS>, T, X extends Throwable>
	...
	public static class Base<S extends Base<S, A, RS, T, X>, A extends LObjDoublePredicateX<T, X>, RS extends AbstractBooleanAssert<RS>, T, X extends Throwable>
			extends
				FullFunctionalAssert.Base<S, LObjDoubleConsumerX<T, Exception>, A, RS, Boolean, Exception> implements LObjDoublePredicateXAssert<S, A, RS, T, X> {
