...
/** Assertions for PredicateX. */
public interface PredicateXAssert<S extends PredicateXAssert<S, A, RS, T, X>, A extends PredicateX<T, X>, RS extends AbstractBooleanAssert<RS>, T, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, T, X>, A extends PredicateX<T, X>, RS extends AbstractBooleanAssert<RS>, T, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception> implements PredicateXAssert<S, A, RS, T, X> {
