...
public interface LCharToIntFunctionAssert<S extends LCharToIntFunctionAssert<S, A, RS>, A extends LCharToIntFunction, RS extends AbstractIntegerAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LCharConsumer, A, RS, Integer> {
	...
	@Nonnull
	Evaluation<S, LCharConsumer, A, RS, Integer> doesApplyAsInt(char a1);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LCharToIntFunction, RS extends AbstractIntegerAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LCharToIntFunction, RS extends AbstractIntegerAssert<RS>> extends FullFunctionalAssert.Base<S, LCharConsumer, A, RS, Integer> implements LCharToIntFunctionAssert<S, A, RS> {
		...
		@Nonnull
		public Evaluation<S, LCharConsumer, A, RS, Integer> doesApplyAsInt(char a1) {
