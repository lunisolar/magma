...
/** Assertions for BiObjDoubleFunction. */
public interface BiObjDoubleFunctionAssert<S extends BiObjDoubleFunctionAssert<S, A, RS, T1, T2, R>, A extends BiObjDoubleFunction<T1, T2, R>, RS extends Assert<RS, R>, T1, T2, R>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, T1, T2, R>, A extends BiObjDoubleFunction<T1, T2, R>, RS extends Assert<RS, R>, T1, T2, R> extends FunctionalAssert.Base<S, A, RS, R, Exception>
			implements
