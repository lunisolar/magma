...
/** Assertions for BooleanFunctionX. */
public interface BooleanFunctionXAssert<S extends BooleanFunctionXAssert<S, A, RS, R, X>, A extends BooleanFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, R, X>, A extends BooleanFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Exception> extends FunctionalAssert.Base<S, A, RS, R, Exception> implements BooleanFunctionXAssert<S, A, RS, R, X> {
