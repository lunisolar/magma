...
/** Assertions for ByteToCharFunction. */
public interface ByteToCharFunctionAssert<S extends ByteToCharFunctionAssert<S, A, RS>, A extends ByteToCharFunction, RS extends AbstractCharacterAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends ByteToCharFunction, RS extends AbstractCharacterAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Character, Exception> implements ByteToCharFunctionAssert<S, A, RS> {
