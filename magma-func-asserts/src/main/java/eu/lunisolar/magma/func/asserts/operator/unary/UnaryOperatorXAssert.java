...
/** Assertions for UnaryOperatorX. */
public interface UnaryOperatorXAssert<S extends UnaryOperatorXAssert<S, A, RS, T, X>, A extends UnaryOperatorX<T, X>, RS extends Assert<RS, T>, T, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, T, X>, A extends UnaryOperatorX<T, X>, RS extends Assert<RS, T>, T, X extends Exception> extends FunctionalAssert.Base<S, A, RS, T, Exception> implements UnaryOperatorXAssert<S, A, RS, T, X> {
