...
public interface LCharFunctionAssert<S extends LCharFunctionAssert<S, A, RS, R>, A extends LCharFunction<R>, RS extends Assert<RS, R>, R> extends Assert<S, A>, FullFunctionalAssert<S, LCharConsumerX<Exception>, A, RS, R, Exception> {
	...
	public static class Base<S extends Base<S, A, RS, R>, A extends LCharFunction<R>, RS extends Assert<RS, R>, R> extends FullFunctionalAssert.Base<S, LCharConsumerX<Exception>, A, RS, R, Exception> implements LCharFunctionAssert<S, A, RS, R> {
