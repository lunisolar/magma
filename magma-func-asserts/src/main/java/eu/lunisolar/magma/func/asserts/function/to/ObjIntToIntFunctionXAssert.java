...
/** Assertions for ObjIntToIntFunctionX. */
public interface ObjIntToIntFunctionXAssert<S extends ObjIntToIntFunctionXAssert<S, A, RS, T, X>, A extends ObjIntToIntFunctionX<T, X>, RS extends AbstractIntegerAssert<RS>, T, X extends Exception>
	...
	public static class Base<S extends Base<S, A, RS, T, X>, A extends ObjIntToIntFunctionX<T, X>, RS extends AbstractIntegerAssert<RS>, T, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Integer, Exception>
			implements
