...
/** Assertions for java.util.function.IntToLongFunction. */
public interface StdIntToLongFunctionAssert<S extends StdIntToLongFunctionAssert<S, A, RS>, A extends java.util.function.IntToLongFunction, RS extends AbstractLongAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends java.util.function.IntToLongFunction, RS extends AbstractLongAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Long, Exception> implements StdIntToLongFunctionAssert<S, A, RS> {
