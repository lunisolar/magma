...
public interface LLogicalTernaryOperatorXAssert<S extends LLogicalTernaryOperatorXAssert<S, A, RS, X>, A extends LLogicalTernaryOperatorX<X>, RS extends AbstractBooleanAssert<RS>, X extends Throwable>
	...
	public final static class Impl<A extends LLogicalTernaryOperatorX<X>, RS extends AbstractBooleanAssert<RS>, X extends Throwable> extends Base<Impl<A, RS, X>, A, RS, X> {
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends LLogicalTernaryOperatorX<X>, RS extends AbstractBooleanAssert<RS>, X extends Throwable> extends FullFunctionalAssert.Base<S, LBooleanTriConsumerX<Exception>, A, RS, Boolean, Exception>
			implements
