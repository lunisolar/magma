...
/** Assertions for ObjDoubleFunctionX. */
public interface ObjDoubleFunctionXAssert<S extends ObjDoubleFunctionXAssert<S, A, RS, T, R, X>, A extends ObjDoubleFunctionX<T, R, X>, RS extends Assert<RS, R>, T, R, X extends Exception>
	...
	public static class Base<S extends Base<S, A, RS, T, R, X>, A extends ObjDoubleFunctionX<T, R, X>, RS extends Assert<RS, R>, T, R, X extends Exception> extends FunctionalAssert.Base<S, A, RS, R, Exception>
			implements
