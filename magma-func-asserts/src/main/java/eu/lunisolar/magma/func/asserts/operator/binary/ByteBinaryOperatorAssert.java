...
/** Assertions for ByteBinaryOperator. */
public interface ByteBinaryOperatorAssert<S extends ByteBinaryOperatorAssert<S, A, RS>, A extends ByteBinaryOperator, RS extends AbstractByteAssert<RS>> extends Assert<S, A>, FunctionalAssert<S, A, RS, Byte, Exception>, RecurringAsserts<S, A, RS, Byte> {

	@Nonnull
	Evaluation<S, A, RS, Byte, Exception> doesApplyAsByte(byte b1, byte b2);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	public final static class Impl<A extends ByteBinaryOperator, RS extends AbstractByteAssert<RS>> extends Base<Impl<A, RS>, A, RS> {
	...
	public static class Base<S extends Base<S, A, RS>, A extends ByteBinaryOperator, RS extends AbstractByteAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Byte, Exception> implements ByteBinaryOperatorAssert<S, A, RS> {
