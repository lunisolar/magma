...
public interface LCharToDblFunctionAssert<S extends LCharToDblFunctionAssert<S, A, RS>, A extends LCharToDblFunction, RS extends AbstractDoubleAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LCharConsumer, A, RS, Double> {
	...
	@Nonnull
	Evaluation<S, LCharConsumer, A, RS, Double> doesApplyAsDbl(char a);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LCharToDblFunction, RS extends AbstractDoubleAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LCharToDblFunction, RS extends AbstractDoubleAssert<RS>> extends FullFunctionalAssert.Base<S, LCharConsumer, A, RS, Double> implements LCharToDblFunctionAssert<S, A, RS> {
