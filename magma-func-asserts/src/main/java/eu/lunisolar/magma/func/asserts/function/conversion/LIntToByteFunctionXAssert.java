...
public interface LIntToByteFunctionXAssert<S extends LIntToByteFunctionXAssert<S, A, RS, X>, A extends LIntToByteFunctionX<X>, RS extends AbstractByteAssert<RS>, X extends Throwable>
	...
	class Base<S extends Base<S, A, RS, X>, A extends LIntToByteFunctionX<X>, RS extends AbstractByteAssert<RS>, X extends Throwable> extends FullFunctionalAssert.Base<S, LIntConsumerX<X>, A, RS, Byte> implements LIntToByteFunctionXAssert<S, A, RS, X> {
