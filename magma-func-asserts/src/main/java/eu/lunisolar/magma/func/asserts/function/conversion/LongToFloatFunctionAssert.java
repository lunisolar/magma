...
/** Assertions for LongToFloatFunction. */
public interface LongToFloatFunctionAssert<S extends LongToFloatFunctionAssert<S, A, RS>, A extends LongToFloatFunction, RS extends AbstractFloatAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends LongToFloatFunction, RS extends AbstractFloatAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Float, Exception> implements LongToFloatFunctionAssert<S, A, RS> {
