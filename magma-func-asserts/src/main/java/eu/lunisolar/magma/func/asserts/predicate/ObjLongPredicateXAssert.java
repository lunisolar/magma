...
public interface ObjLongPredicateXAssert<S extends ObjLongPredicateXAssert<S, A, RS, T, X>, A extends ObjLongPredicateX<T, X>, RS extends AbstractBooleanAssert<RS>, T, X extends Exception>
	...
	public static class Base<S extends Base<S, A, RS, T, X>, A extends ObjLongPredicateX<T, X>, RS extends AbstractBooleanAssert<RS>, T, X extends Exception> extends FullFunctionalAssert.Base<S, A, RS, Boolean, Exception>
			implements
