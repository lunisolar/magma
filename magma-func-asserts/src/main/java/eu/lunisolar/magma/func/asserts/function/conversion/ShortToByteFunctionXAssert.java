...
/** Assertions for ShortToByteFunctionX. */
public interface ShortToByteFunctionXAssert<S extends ShortToByteFunctionXAssert<S, A, RS, X>, A extends ShortToByteFunctionX<X>, RS extends AbstractByteAssert<RS>, X extends Exception>
		extends
			Assert<S, A>,
	...
	public final static class Impl<A extends ShortToByteFunctionX<X>, RS extends AbstractByteAssert<RS>, X extends Exception> extends Base<Impl<A, RS, X>, A, RS, X> {
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends ShortToByteFunctionX<X>, RS extends AbstractByteAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Byte, Exception>
			implements
				ShortToByteFunctionXAssert<S, A, RS, X> {
