...
public interface LBooleanToIntFunctionXAssert<S extends LBooleanToIntFunctionXAssert<S, A, RS, X>, A extends LBooleanToIntFunctionX<X>, RS extends AbstractIntegerAssert<RS>, X extends Throwable>
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends LBooleanToIntFunctionX<X>, RS extends AbstractIntegerAssert<RS>, X extends Throwable> extends FullFunctionalAssert.Base<S, A, RS, Integer, Exception>
			implements
