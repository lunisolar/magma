...
public interface StdLongBinaryOperatorAssert<S extends StdLongBinaryOperatorAssert<S, A, RS>, A extends java.util.function.LongBinaryOperator, RS extends AbstractLongAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Long, Exception> {
	...
	public static class Base<S extends Base<S, A, RS>, A extends java.util.function.LongBinaryOperator, RS extends AbstractLongAssert<RS>> extends FullFunctionalAssert.Base<S, A, RS, Long, Exception> implements StdLongBinaryOperatorAssert<S, A, RS> {
