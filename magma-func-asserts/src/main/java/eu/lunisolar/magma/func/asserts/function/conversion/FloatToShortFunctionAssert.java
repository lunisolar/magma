...
/** Assertions for FloatToShortFunction. */
public interface FloatToShortFunctionAssert<S extends FloatToShortFunctionAssert<S, A, RS>, A extends FloatToShortFunction, RS extends AbstractShortAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends FloatToShortFunction, RS extends AbstractShortAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Short, Exception> implements FloatToShortFunctionAssert<S, A, RS> {
