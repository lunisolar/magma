...
public interface LTernaryOperatorXAssert<S extends LTernaryOperatorXAssert<S, A, RS, T, X>, A extends LTernaryOperatorX<T, X>, RS extends Assert<RS, T>, T, X extends Throwable>
	...
	public static class Base<S extends Base<S, A, RS, T, X>, A extends LTernaryOperatorX<T, X>, RS extends Assert<RS, T>, T, X extends Throwable> extends FullFunctionalAssert.Base<S, LTriConsumerX<T, T, T, Exception>, A, RS, T, Exception>
			implements
