...
/** Assertions for CharSupplierX. */
public interface CharSupplierXAssert<S extends CharSupplierXAssert<S, A, RS, X>, A extends CharSupplierX<X>, RS extends AbstractCharacterAssert<RS>, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends CharSupplierX<X>, RS extends AbstractCharacterAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Character, Exception> implements CharSupplierXAssert<S, A, RS, X> {
