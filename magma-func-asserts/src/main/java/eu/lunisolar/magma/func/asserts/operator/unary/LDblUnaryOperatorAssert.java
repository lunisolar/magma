...
public interface LDblUnaryOperatorAssert<S extends LDblUnaryOperatorAssert<S, A, RS>, A extends LDblUnaryOperator, RS extends AbstractDoubleAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LDblConsumer, A, RS, Double> {
	...
	final class The<A extends LDblUnaryOperator, RS extends AbstractDoubleAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LDblUnaryOperator, RS extends AbstractDoubleAssert<RS>> extends FullFunctionalAssert.Base<S, LDblConsumer, A, RS, Double> implements LDblUnaryOperatorAssert<S, A, RS> {
