...
/** Assertions for ObjCharPredicateX. */
public interface ObjCharPredicateXAssert<S extends ObjCharPredicateXAssert<S, A, RS, T, X>, A extends ObjCharPredicateX<T, X>, RS extends AbstractBooleanAssert<RS>, T, X extends Exception>
	...
	public static class Base<S extends Base<S, A, RS, T, X>, A extends ObjCharPredicateX<T, X>, RS extends AbstractBooleanAssert<RS>, T, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception>
			implements
