...
public interface LBiIntFunctionAssert<S extends LBiIntFunctionAssert<S, A, RS, R>, A extends LBiIntFunction<R>, RS extends Assert<RS, R>, R> extends Assert<S, A>, FullFunctionalAssert<S, LBiIntConsumer, A, RS, R> {
	...
	final class The<A extends LBiIntFunction<R>, RS extends Assert<RS, R>, R> extends Base<The<A, RS, R>, A, RS, R> {
	...
	class Base<S extends Base<S, A, RS, R>, A extends LBiIntFunction<R>, RS extends Assert<RS, R>, R> extends FullFunctionalAssert.Base<S, LBiIntConsumer, A, RS, R> implements LBiIntFunctionAssert<S, A, RS, R> {
		...
		@Nonnull
		public Evaluation<S, LBiIntConsumer, A, RS, R> doesApply(int a1, int a2) {
