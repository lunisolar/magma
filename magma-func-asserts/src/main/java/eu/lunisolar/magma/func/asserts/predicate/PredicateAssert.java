...
public interface PredicateAssert<S extends PredicateAssert<S, A, RS, T>, A extends Predicate<T>, RS extends AbstractBooleanAssert<RS>, T> extends Assert<S, A>, FunctionalAssert<S, A, RS, Boolean, Exception>, RecurringAsserts<S, A, RS, Boolean> {

	@Nonnull
	Evaluation<S, A, RS, Boolean, Exception> doesTest(T t);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	public final static class Impl<A extends Predicate<T>, RS extends AbstractBooleanAssert<RS>, T> extends Base<Impl<A, RS, T>, A, RS, T> {
	...
	public static class Base<S extends Base<S, A, RS, T>, A extends Predicate<T>, RS extends AbstractBooleanAssert<RS>, T> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception> implements PredicateAssert<S, A, RS, T> {
