...
/** Assertions for BooleanBinaryOperator. */
public interface BooleanBinaryOperatorAssert<S extends BooleanBinaryOperatorAssert<S, A, RS>, A extends BooleanBinaryOperator, RS extends AbstractBooleanAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends BooleanBinaryOperator, RS extends AbstractBooleanAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception> implements BooleanBinaryOperatorAssert<S, A, RS> {
