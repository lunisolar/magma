...
/** Assertions for FloatToIntFunction. */
public interface FloatToIntFunctionAssert<S extends FloatToIntFunctionAssert<S, A, RS>, A extends FloatToIntFunction, RS extends AbstractIntegerAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends FloatToIntFunction, RS extends AbstractIntegerAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Integer, Exception> implements FloatToIntFunctionAssert<S, A, RS> {
