...
public interface LSupplierXAssert<S extends LSupplierXAssert<S, A, RS, R, X>, A extends LSupplierX<R, X>, RS extends Assert<RS, R>, R, X extends Exception> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, R, Exception> {
	...
	public final static class Impl<A extends LSupplierX<R, X>, RS extends Assert<RS, R>, R, X extends Exception> extends Base<Impl<A, RS, R, X>, A, RS, R, X> {
	...
	public static class Base<S extends Base<S, A, RS, R, X>, A extends LSupplierX<R, X>, RS extends Assert<RS, R>, R, X extends Exception> extends FullFunctionalAssert.Base<S, A, RS, R, Exception> implements LSupplierXAssert<S, A, RS, R, X> {
