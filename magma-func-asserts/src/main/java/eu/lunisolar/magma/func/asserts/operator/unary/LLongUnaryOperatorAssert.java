...
public interface LLongUnaryOperatorAssert<S extends LLongUnaryOperatorAssert<S, A, RS>, A extends LLongUnaryOperator, RS extends AbstractLongAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LLongConsumer, A, RS, Long> {
	...
	final class The<A extends LLongUnaryOperator, RS extends AbstractLongAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LLongUnaryOperator, RS extends AbstractLongAssert<RS>> extends FullFunctionalAssert.Base<S, LLongConsumer, A, RS, Long> implements LLongUnaryOperatorAssert<S, A, RS> {
