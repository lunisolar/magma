...
public interface StdConsumerAssert<S extends StdConsumerAssert<S, A, T>, A extends java.util.function.Consumer<T>, T> extends Assert<S, A>, FunctionalAssert.Simple<S, A, Exception> {
	...
	public static class Base<S extends Base<S, A, T>, A extends java.util.function.Consumer<T>, T> extends FunctionalAssert.Simple.Base<S, A, Exception> implements StdConsumerAssert<S, A, T> {
