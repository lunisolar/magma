...
public interface BiPredicateAssert<S extends BiPredicateAssert<S, A, RS, T1, T2>, A extends java.util.function.BiPredicate<T1, T2>, RS extends AbstractBooleanAssert<RS>, T1, T2> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Boolean, Exception> {
	...
	public static class Base<S extends Base<S, A, RS, T1, T2>, A extends java.util.function.BiPredicate<T1, T2>, RS extends AbstractBooleanAssert<RS>, T1, T2> extends FullFunctionalAssert.Base<S, A, RS, Boolean, Exception>
			implements
				BiPredicateAssert<S, A, RS, T1, T2> {
