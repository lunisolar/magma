...
/** Assertions for java.util.function.LongUnaryOperator. */
public interface StdLongUnaryOperatorAssert<S extends StdLongUnaryOperatorAssert<S, A, RS>, A extends java.util.function.LongUnaryOperator, RS extends AbstractLongAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends java.util.function.LongUnaryOperator, RS extends AbstractLongAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Long, Exception> implements StdLongUnaryOperatorAssert<S, A, RS> {
