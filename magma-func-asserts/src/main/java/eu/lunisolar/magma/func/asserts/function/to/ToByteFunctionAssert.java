...
/** Assertions for ToByteFunction. */
public interface ToByteFunctionAssert<S extends ToByteFunctionAssert<S, A, RS, T>, A extends ToByteFunction<T>, RS extends AbstractByteAssert<RS>, T> extends Assert<S, A>, FunctionalAssert<S, A, RS, Byte, Exception>, RecurringAsserts<S, A, RS, Byte> {

	@Nonnull
	Evaluation<S, A, RS, Byte, Exception> doesApplyAsByte(T t);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	public final static class Impl<A extends ToByteFunction<T>, RS extends AbstractByteAssert<RS>, T> extends Base<Impl<A, RS, T>, A, RS, T> {
	...
	public static class Base<S extends Base<S, A, RS, T>, A extends ToByteFunction<T>, RS extends AbstractByteAssert<RS>, T> extends FunctionalAssert.Base<S, A, RS, Byte, Exception> implements ToByteFunctionAssert<S, A, RS, T> {
