...
public interface LDoublePredicateAssert<S extends LDoublePredicateAssert<S, A, RS>, A extends LDoublePredicate, RS extends AbstractBooleanAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Boolean, Exception> {
	...
	public static class Base<S extends Base<S, A, RS>, A extends LDoublePredicate, RS extends AbstractBooleanAssert<RS>> extends FullFunctionalAssert.Base<S, A, RS, Boolean, Exception> implements LDoublePredicateAssert<S, A, RS> {
