...
/** Assertions for FunctionX. */
public interface FunctionXAssert<S extends FunctionXAssert<S, A, RS, T, R, X>, A extends FunctionX<T, R, X>, RS extends Assert<RS, R>, T, R, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, T, R, X>, A extends FunctionX<T, R, X>, RS extends Assert<RS, R>, T, R, X extends Exception> extends FunctionalAssert.Base<S, A, RS, R, Exception> implements FunctionXAssert<S, A, RS, T, R, X> {
