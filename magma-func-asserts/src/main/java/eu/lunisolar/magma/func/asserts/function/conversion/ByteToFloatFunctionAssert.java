...
/** Assertions for ByteToFloatFunction. */
public interface ByteToFloatFunctionAssert<S extends ByteToFloatFunctionAssert<S, A, RS>, A extends ByteToFloatFunction, RS extends AbstractFloatAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends ByteToFloatFunction, RS extends AbstractFloatAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Float, Exception> implements ByteToFloatFunctionAssert<S, A, RS> {
