...
public interface LIntSupplierXAssert<S extends LIntSupplierXAssert<S, A, RS, X>, A extends LIntSupplierX<X>, RS extends AbstractIntegerAssert<RS>, X extends Exception> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Integer, Exception> {
	...
	public final static class Impl<A extends LIntSupplierX<X>, RS extends AbstractIntegerAssert<RS>, X extends Exception> extends Base<Impl<A, RS, X>, A, RS, X> {
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends LIntSupplierX<X>, RS extends AbstractIntegerAssert<RS>, X extends Exception> extends FullFunctionalAssert.Base<S, A, RS, Integer, Exception> implements LIntSupplierXAssert<S, A, RS, X> {
