...
/** Assertions for ObjBytePredicate. */
public interface ObjBytePredicateAssert<S extends ObjBytePredicateAssert<S, A, RS, T>, A extends ObjBytePredicate<T>, RS extends AbstractBooleanAssert<RS>, T>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, T>, A extends ObjBytePredicate<T>, RS extends AbstractBooleanAssert<RS>, T> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception> implements ObjBytePredicateAssert<S, A, RS, T> {
