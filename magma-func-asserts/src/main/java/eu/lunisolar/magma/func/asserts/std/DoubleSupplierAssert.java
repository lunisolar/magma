...
public interface DoubleSupplierAssert<S extends DoubleSupplierAssert<S, A, RS>, A extends DoubleSupplier, RS extends AbstractDoubleAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LAction, A, RS, Double> {
	...
	class Base<S extends Base<S, A, RS>, A extends DoubleSupplier, RS extends AbstractDoubleAssert<RS>> extends FullFunctionalAssert.Base<S, LAction, A, RS, Double> implements DoubleSupplierAssert<S, A, RS> {
