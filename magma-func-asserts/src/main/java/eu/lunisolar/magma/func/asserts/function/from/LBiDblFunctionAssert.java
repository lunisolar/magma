...
public interface LBiDblFunctionAssert<S extends LBiDblFunctionAssert<S, A, RS, R>, A extends LBiDblFunction<R>, RS extends Assert<RS, R>, R> extends Assert<S, A>, FullFunctionalAssert<S, LBiDblConsumer, A, RS, R> {
	...
	@Nonnull
	Evaluation<S, LBiDblConsumer, A, RS, R> doesApply(double a1, double a2);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LBiDblFunction<R>, RS extends Assert<RS, R>, R> extends Base<The<A, RS, R>, A, RS, R> {
	...
	class Base<S extends Base<S, A, RS, R>, A extends LBiDblFunction<R>, RS extends Assert<RS, R>, R> extends FullFunctionalAssert.Base<S, LBiDblConsumer, A, RS, R> implements LBiDblFunctionAssert<S, A, RS, R> {
		...
		@Nonnull
		public Evaluation<S, LBiDblConsumer, A, RS, R> doesApply(double a1, double a2) {
