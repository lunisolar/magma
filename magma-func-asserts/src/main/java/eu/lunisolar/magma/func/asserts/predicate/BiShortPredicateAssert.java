...
/** Assertions for BiShortPredicate. */
public interface BiShortPredicateAssert<S extends BiShortPredicateAssert<S, A, RS>, A extends BiShortPredicate, RS extends AbstractBooleanAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends BiShortPredicate, RS extends AbstractBooleanAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception> implements BiShortPredicateAssert<S, A, RS> {
