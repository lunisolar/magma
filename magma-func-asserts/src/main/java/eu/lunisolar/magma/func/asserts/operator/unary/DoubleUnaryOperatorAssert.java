...
/** Assertions for DoubleUnaryOperator. */
public interface DoubleUnaryOperatorAssert<S extends DoubleUnaryOperatorAssert<S, A, RS>, A extends DoubleUnaryOperator, RS extends AbstractDoubleAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends DoubleUnaryOperator, RS extends AbstractDoubleAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Double, Exception> implements DoubleUnaryOperatorAssert<S, A, RS> {
