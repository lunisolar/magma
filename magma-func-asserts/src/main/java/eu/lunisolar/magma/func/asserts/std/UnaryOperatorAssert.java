...
public interface UnaryOperatorAssert<S extends UnaryOperatorAssert<S, A, RS, T>, A extends java.util.function.UnaryOperator<T>, RS extends Assert<RS, T>, T> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, T, Exception> {
	...
	public static class Base<S extends Base<S, A, RS, T>, A extends java.util.function.UnaryOperator<T>, RS extends Assert<RS, T>, T> extends FullFunctionalAssert.Base<S, A, RS, T, Exception> implements UnaryOperatorAssert<S, A, RS, T> {
