...
/** Assertions for CharToShortFunction. */
public interface CharToShortFunctionAssert<S extends CharToShortFunctionAssert<S, A, RS>, A extends CharToShortFunction, RS extends AbstractShortAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends CharToShortFunction, RS extends AbstractShortAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Short, Exception> implements CharToShortFunctionAssert<S, A, RS> {
