...
public interface LByteFunctionAssert<S extends LByteFunctionAssert<S, A, RS, R>, A extends LByteFunction<R>, RS extends Assert<RS, R>, R> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, R, Exception> {
	...
	public static class Base<S extends Base<S, A, RS, R>, A extends LByteFunction<R>, RS extends Assert<RS, R>, R> extends FullFunctionalAssert.Base<S, A, RS, R, Exception> implements LByteFunctionAssert<S, A, RS, R> {
