...
/** Assertions for ToFloatBiFunction. */
public interface ToFloatBiFunctionAssert<S extends ToFloatBiFunctionAssert<S, A, RS, T1, T2>, A extends ToFloatBiFunction<T1, T2>, RS extends AbstractFloatAssert<RS>, T1, T2>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, T1, T2>, A extends ToFloatBiFunction<T1, T2>, RS extends AbstractFloatAssert<RS>, T1, T2> extends FunctionalAssert.Base<S, A, RS, Float, Exception> implements ToFloatBiFunctionAssert<S, A, RS, T1, T2> {
