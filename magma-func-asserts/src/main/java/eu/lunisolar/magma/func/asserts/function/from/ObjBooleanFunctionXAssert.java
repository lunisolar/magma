...
/** Assertions for ObjBooleanFunctionX. */
public interface ObjBooleanFunctionXAssert<S extends ObjBooleanFunctionXAssert<S, A, RS, T, R, X>, A extends ObjBooleanFunctionX<T, R, X>, RS extends Assert<RS, R>, T, R, X extends Exception>
	...
	public static class Base<S extends Base<S, A, RS, T, R, X>, A extends ObjBooleanFunctionX<T, R, X>, RS extends Assert<RS, R>, T, R, X extends Exception> extends FunctionalAssert.Base<S, A, RS, R, Exception>
			implements
