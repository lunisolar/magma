...
public interface LShortSupplierXAssert<S extends LShortSupplierXAssert<S, A, RS, X>, A extends LShortSupplierX<X>, RS extends AbstractShortAssert<RS>, X extends Throwable>
		extends
			Assert<S, A>,
			FullFunctionalAssert<S, LActionX<Exception>, A, RS, Short, Exception> {
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends LShortSupplierX<X>, RS extends AbstractShortAssert<RS>, X extends Throwable> extends FullFunctionalAssert.Base<S, LActionX<Exception>, A, RS, Short, Exception>
			implements
				LShortSupplierXAssert<S, A, RS, X> {
