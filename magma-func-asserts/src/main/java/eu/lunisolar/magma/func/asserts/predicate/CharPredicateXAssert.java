...
/** Assertions for CharPredicateX. */
public interface CharPredicateXAssert<S extends CharPredicateXAssert<S, A, RS, X>, A extends CharPredicateX<X>, RS extends AbstractBooleanAssert<RS>, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends CharPredicateX<X>, RS extends AbstractBooleanAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception> implements CharPredicateXAssert<S, A, RS, X> {
