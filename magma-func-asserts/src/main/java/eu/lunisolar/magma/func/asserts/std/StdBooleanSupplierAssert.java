...
public interface StdBooleanSupplierAssert<S extends StdBooleanSupplierAssert<S, A, RS>, A extends java.util.function.BooleanSupplier, RS extends AbstractBooleanAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Boolean, Exception> {
	...
	public static class Base<S extends Base<S, A, RS>, A extends java.util.function.BooleanSupplier, RS extends AbstractBooleanAssert<RS>> extends FullFunctionalAssert.Base<S, A, RS, Boolean, Exception> implements StdBooleanSupplierAssert<S, A, RS> {
