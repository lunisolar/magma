...
/** Assert for LBooleanToIntFunction. */
public interface LBooleanToIntFunctionAssert<S extends LBooleanToIntFunctionAssert<S, A, RS>, A extends LBooleanToIntFunction, RS extends AbstractIntegerAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Integer, Exception> {
	...
	public static class Base<S extends Base<S, A, RS>, A extends LBooleanToIntFunction, RS extends AbstractIntegerAssert<RS>> extends FullFunctionalAssert.Base<S, A, RS, Integer, Exception> implements LBooleanToIntFunctionAssert<S, A, RS> {
