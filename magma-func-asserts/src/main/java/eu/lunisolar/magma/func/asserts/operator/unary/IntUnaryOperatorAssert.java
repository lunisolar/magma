...
/** Assertions for IntUnaryOperator. */
public interface IntUnaryOperatorAssert<S extends IntUnaryOperatorAssert<S, A, RS>, A extends IntUnaryOperator, RS extends AbstractIntegerAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends IntUnaryOperator, RS extends AbstractIntegerAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Integer, Exception> implements IntUnaryOperatorAssert<S, A, RS> {
