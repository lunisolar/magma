...
public interface LShortPredicateXAssert<S extends LShortPredicateXAssert<S, A, RS, X>, A extends LShortPredicateX<X>, RS extends AbstractBooleanAssert<RS>, X extends Throwable> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Boolean, Exception> {
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends LShortPredicateX<X>, RS extends AbstractBooleanAssert<RS>, X extends Throwable> extends FullFunctionalAssert.Base<S, A, RS, Boolean, Exception>
			implements
