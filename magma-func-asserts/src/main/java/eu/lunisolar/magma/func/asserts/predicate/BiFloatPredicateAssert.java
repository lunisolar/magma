...
/** Assertions for BiFloatPredicate. */
public interface BiFloatPredicateAssert<S extends BiFloatPredicateAssert<S, A, RS>, A extends BiFloatPredicate, RS extends AbstractBooleanAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends BiFloatPredicate, RS extends AbstractBooleanAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception> implements BiFloatPredicateAssert<S, A, RS> {
