...
/** Assertions for ToLongFunction. */
public interface ToLongFunctionAssert<S extends ToLongFunctionAssert<S, A, RS, T>, A extends ToLongFunction<T>, RS extends AbstractLongAssert<RS>, T> extends Assert<S, A>, FunctionalAssert<S, A, RS, Long, Exception>, RecurringAsserts<S, A, RS, Long> {

	@Nonnull
	Evaluation<S, A, RS, Long, Exception> doesApplyAsLong(T t);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	public final static class Impl<A extends ToLongFunction<T>, RS extends AbstractLongAssert<RS>, T> extends Base<Impl<A, RS, T>, A, RS, T> {
	...
	public static class Base<S extends Base<S, A, RS, T>, A extends ToLongFunction<T>, RS extends AbstractLongAssert<RS>, T> extends FunctionalAssert.Base<S, A, RS, Long, Exception> implements ToLongFunctionAssert<S, A, RS, T> {
