...
public interface LLongBinaryOperatorAssert<S extends LLongBinaryOperatorAssert<S, A, RS>, A extends LLongBinaryOperator, RS extends AbstractLongAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LBiLongConsumer, A, RS, Long> {
	...
	final class The<A extends LLongBinaryOperator, RS extends AbstractLongAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LLongBinaryOperator, RS extends AbstractLongAssert<RS>> extends FullFunctionalAssert.Base<S, LBiLongConsumer, A, RS, Long> implements LLongBinaryOperatorAssert<S, A, RS> {
