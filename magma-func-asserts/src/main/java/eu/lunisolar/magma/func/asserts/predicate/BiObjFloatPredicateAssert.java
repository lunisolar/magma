...
/** Assertions for BiObjFloatPredicate. */
public interface BiObjFloatPredicateAssert<S extends BiObjFloatPredicateAssert<S, A, RS, T1, T2>, A extends BiObjFloatPredicate<T1, T2>, RS extends AbstractBooleanAssert<RS>, T1, T2>
	...
	public static class Base<S extends Base<S, A, RS, T1, T2>, A extends BiObjFloatPredicate<T1, T2>, RS extends AbstractBooleanAssert<RS>, T1, T2> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception>
			implements
