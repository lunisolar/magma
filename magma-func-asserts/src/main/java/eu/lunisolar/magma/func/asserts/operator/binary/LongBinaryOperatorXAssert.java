...
/** Assert for LongBinaryOperatorX. */
public interface LongBinaryOperatorXAssert<S extends LongBinaryOperatorXAssert<S, A, RS, X>, A extends LongBinaryOperatorX<X>, RS extends AbstractLongAssert<RS>, X extends Exception> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Long, Exception> {
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends LongBinaryOperatorX<X>, RS extends AbstractLongAssert<RS>, X extends Exception> extends FullFunctionalAssert.Base<S, A, RS, Long, Exception>
			implements
				LongBinaryOperatorXAssert<S, A, RS, X> {
