...
public interface LIntBinaryOperatorAssert<S extends LIntBinaryOperatorAssert<S, A, RS>, A extends LIntBinaryOperator, RS extends AbstractIntegerAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LBiIntConsumer, A, RS, Integer> {
	...
	final class The<A extends LIntBinaryOperator, RS extends AbstractIntegerAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LIntBinaryOperator, RS extends AbstractIntegerAssert<RS>> extends FullFunctionalAssert.Base<S, LBiIntConsumer, A, RS, Integer> implements LIntBinaryOperatorAssert<S, A, RS> {
