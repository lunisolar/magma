...
/** Assertions for BooleanToByteFunctionX. */
public interface BooleanToByteFunctionXAssert<S extends BooleanToByteFunctionXAssert<S, A, RS, X>, A extends BooleanToByteFunctionX<X>, RS extends AbstractByteAssert<RS>, X extends Exception>
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends BooleanToByteFunctionX<X>, RS extends AbstractByteAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Byte, Exception>
			implements
