...
/** Assert for LongSupplierX. */
public interface LongSupplierXAssert<S extends LongSupplierXAssert<S, A, RS, X>, A extends LongSupplierX<X>, RS extends AbstractLongAssert<RS>, X extends Exception> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Long, Exception> {
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends LongSupplierX<X>, RS extends AbstractLongAssert<RS>, X extends Exception> extends FullFunctionalAssert.Base<S, A, RS, Long, Exception> implements LongSupplierXAssert<S, A, RS, X> {
