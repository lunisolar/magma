...
public interface LBiShortPredicateXAssert<S extends LBiShortPredicateXAssert<S, A, RS, X>, A extends LBiShortPredicateX<X>, RS extends AbstractBooleanAssert<RS>, X extends Throwable>
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends LBiShortPredicateX<X>, RS extends AbstractBooleanAssert<RS>, X extends Throwable> extends FullFunctionalAssert.Base<S, LBiShortConsumerX<Exception>, A, RS, Boolean, Exception>
			implements
