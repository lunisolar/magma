...
/** Assertions for BiPredicate. */
public interface BiPredicateAssert<S extends BiPredicateAssert<S, A, RS, T1, T2>, A extends BiPredicate<T1, T2>, RS extends AbstractBooleanAssert<RS>, T1, T2>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, T1, T2>, A extends BiPredicate<T1, T2>, RS extends AbstractBooleanAssert<RS>, T1, T2> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception> implements BiPredicateAssert<S, A, RS, T1, T2> {
