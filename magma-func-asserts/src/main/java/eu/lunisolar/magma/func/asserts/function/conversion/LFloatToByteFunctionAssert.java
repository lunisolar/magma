...
public interface LFloatToByteFunctionAssert<S extends LFloatToByteFunctionAssert<S, A, RS>, A extends LFloatToByteFunction, RS extends AbstractByteAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Byte, Exception> {
	...
	public static class Base<S extends Base<S, A, RS>, A extends LFloatToByteFunction, RS extends AbstractByteAssert<RS>> extends FullFunctionalAssert.Base<S, A, RS, Byte, Exception> implements LFloatToByteFunctionAssert<S, A, RS> {
