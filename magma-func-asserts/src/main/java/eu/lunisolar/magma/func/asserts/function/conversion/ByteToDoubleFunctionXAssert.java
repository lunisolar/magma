...
/** Assert for ByteToDoubleFunctionX. */
public interface ByteToDoubleFunctionXAssert<S extends ByteToDoubleFunctionXAssert<S, A, RS, X>, A extends ByteToDoubleFunctionX<X>, RS extends AbstractDoubleAssert<RS>, X extends Exception>
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends ByteToDoubleFunctionX<X>, RS extends AbstractDoubleAssert<RS>, X extends Exception> extends FullFunctionalAssert.Base<S, A, RS, Double, Exception>
			implements
