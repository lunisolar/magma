...
/** Assertions for BooleanBiFunctionX. */
public interface BooleanBiFunctionXAssert<S extends BooleanBiFunctionXAssert<S, A, RS, R, X>, A extends BooleanBiFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, R, X>, A extends BooleanBiFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Exception> extends FunctionalAssert.Base<S, A, RS, R, Exception> implements BooleanBiFunctionXAssert<S, A, RS, R, X> {
