...
public interface LBiLongPredicateAssert<S extends LBiLongPredicateAssert<S, A, RS>, A extends LBiLongPredicate, RS extends AbstractBooleanAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Boolean, Exception> {
	...
	public static class Base<S extends Base<S, A, RS>, A extends LBiLongPredicate, RS extends AbstractBooleanAssert<RS>> extends FullFunctionalAssert.Base<S, A, RS, Boolean, Exception> implements LBiLongPredicateAssert<S, A, RS> {
