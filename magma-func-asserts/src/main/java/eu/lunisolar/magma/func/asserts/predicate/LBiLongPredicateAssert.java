...
public interface LBiLongPredicateAssert<S extends LBiLongPredicateAssert<S, A, RS>, A extends LBiLongPredicate, RS extends AbstractBooleanAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LBiLongConsumer, A, RS, Boolean> {
	...
	final class The<A extends LBiLongPredicate, RS extends AbstractBooleanAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LBiLongPredicate, RS extends AbstractBooleanAssert<RS>> extends FullFunctionalAssert.Base<S, LBiLongConsumer, A, RS, Boolean> implements LBiLongPredicateAssert<S, A, RS> {
		...
		@Nonnull
		public Evaluation<S, LBiLongConsumer, A, RS, Boolean> doesTest(long a1, long a2) {
