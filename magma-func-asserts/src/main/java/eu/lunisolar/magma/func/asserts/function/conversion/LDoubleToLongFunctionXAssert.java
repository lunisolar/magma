...
public interface LDoubleToLongFunctionXAssert<S extends LDoubleToLongFunctionXAssert<S, A, RS, X>, A extends LDoubleToLongFunctionX<X>, RS extends AbstractLongAssert<RS>, X extends Exception>
		extends
			Assert<S, A>,
	...
	public final static class Impl<A extends LDoubleToLongFunctionX<X>, RS extends AbstractLongAssert<RS>, X extends Exception> extends Base<Impl<A, RS, X>, A, RS, X> {
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends LDoubleToLongFunctionX<X>, RS extends AbstractLongAssert<RS>, X extends Exception> extends FullFunctionalAssert.Base<S, A, RS, Long, Exception>
			implements
