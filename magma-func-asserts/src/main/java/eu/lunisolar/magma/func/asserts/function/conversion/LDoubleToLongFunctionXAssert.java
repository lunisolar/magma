...
public interface LDoubleToLongFunctionXAssert<S extends LDoubleToLongFunctionXAssert<S, A, RS, X>, A extends LDoubleToLongFunctionX<X>, RS extends AbstractLongAssert<RS>, X extends Throwable>
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends LDoubleToLongFunctionX<X>, RS extends AbstractLongAssert<RS>, X extends Throwable> extends FullFunctionalAssert.Base<S, A, RS, Long, Exception>
			implements
