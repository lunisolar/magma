...
public interface LDoubleToLongFunctionXAssert<S extends LDoubleToLongFunctionXAssert<S, A, RS, X>, A extends LDoubleToLongFunctionX<X>, RS extends AbstractLongAssert<RS>, X extends Throwable>
		extends
			Assert<S, A>,
			FullFunctionalAssert<S, LDoubleConsumerX<X>, A, RS, Long> {

	@Nonnull
	Evaluation<S, LDoubleConsumerX<X>, A, RS, Long> doesApplyAsLong(double a1);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LDoubleToLongFunctionX<X>, RS extends AbstractLongAssert<RS>, X extends Throwable> extends Base<The<A, RS, X>, A, RS, X> {
	...
	class Base<S extends Base<S, A, RS, X>, A extends LDoubleToLongFunctionX<X>, RS extends AbstractLongAssert<RS>, X extends Throwable> extends FullFunctionalAssert.Base<S, LDoubleConsumerX<X>, A, RS, Long>
			implements
		...
		@Nonnull
		public Evaluation<S, LDoubleConsumerX<X>, A, RS, Long> doesApplyAsLong(double a1) {
