...
/** Assertions for java.util.function.IntToDoubleFunction. */
public interface StdIntToDoubleFunctionAssert<S extends StdIntToDoubleFunctionAssert<S, A, RS>, A extends java.util.function.IntToDoubleFunction, RS extends AbstractDoubleAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends java.util.function.IntToDoubleFunction, RS extends AbstractDoubleAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Double, Exception> implements StdIntToDoubleFunctionAssert<S, A, RS> {
