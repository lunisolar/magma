...
/** Assertions for ObjCharFunctionX. */
public interface ObjCharFunctionXAssert<S extends ObjCharFunctionXAssert<S, A, RS, T, R, X>, A extends ObjCharFunctionX<T, R, X>, RS extends Assert<RS, R>, T, R, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, T, R, X>, A extends ObjCharFunctionX<T, R, X>, RS extends Assert<RS, R>, T, R, X extends Exception> extends FunctionalAssert.Base<S, A, RS, R, Exception>
			implements
