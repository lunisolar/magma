...
/** Assertions for ByteToIntFunction. */
public interface ByteToIntFunctionAssert<S extends ByteToIntFunctionAssert<S, A, RS>, A extends ByteToIntFunction, RS extends AbstractIntegerAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends ByteToIntFunction, RS extends AbstractIntegerAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Integer, Exception> implements ByteToIntFunctionAssert<S, A, RS> {
