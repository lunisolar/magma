...
public interface LongUnaryOperatorAssert<S extends LongUnaryOperatorAssert<S, A, RS>, A extends java.util.function.LongUnaryOperator, RS extends AbstractLongAssert<RS>>
	...
	public static class Base<S extends Base<S, A, RS>, A extends java.util.function.LongUnaryOperator, RS extends AbstractLongAssert<RS>> extends FullFunctionalAssert.Base<S, LLongConsumerX<Exception>, A, RS, Long, Exception>
			implements
				LongUnaryOperatorAssert<S, A, RS> {
