...
/** Assertions for java.util.function.BinaryOperator. */
public interface StdBinaryOperatorAssert<S extends StdBinaryOperatorAssert<S, A, RS, T>, A extends java.util.function.BinaryOperator<T>, RS extends Assert<RS, T>, T>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, T>, A extends java.util.function.BinaryOperator<T>, RS extends Assert<RS, T>, T> extends FunctionalAssert.Base<S, A, RS, T, Exception> implements StdBinaryOperatorAssert<S, A, RS, T> {
