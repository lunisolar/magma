...
/** Assertions for ToDoubleFunction. */
public interface ToDoubleFunctionAssert<S extends ToDoubleFunctionAssert<S, A, RS, T>, A extends ToDoubleFunction<T>, RS extends AbstractDoubleAssert<RS>, T>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, T>, A extends ToDoubleFunction<T>, RS extends AbstractDoubleAssert<RS>, T> extends FunctionalAssert.Base<S, A, RS, Double, Exception> implements ToDoubleFunctionAssert<S, A, RS, T> {
