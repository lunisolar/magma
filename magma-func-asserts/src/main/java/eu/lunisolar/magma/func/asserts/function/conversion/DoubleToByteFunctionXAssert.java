...
/** Assertions for DoubleToByteFunctionX. */
public interface DoubleToByteFunctionXAssert<S extends DoubleToByteFunctionXAssert<S, A, RS, X>, A extends DoubleToByteFunctionX<X>, RS extends AbstractByteAssert<RS>, X extends Exception>
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends DoubleToByteFunctionX<X>, RS extends AbstractByteAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Byte, Exception>
			implements
