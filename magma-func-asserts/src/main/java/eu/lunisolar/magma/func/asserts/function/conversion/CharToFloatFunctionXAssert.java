...
/** Assertions for CharToFloatFunctionX. */
public interface CharToFloatFunctionXAssert<S extends CharToFloatFunctionXAssert<S, A, RS, X>, A extends CharToFloatFunctionX<X>, RS extends AbstractFloatAssert<RS>, X extends Exception>
		extends
			Assert<S, A>,
	...
	@Nonnull
	Evaluation<S, A, RS, Float, Exception> doesApplyAsFloat(char c);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	public final static class Impl<A extends CharToFloatFunctionX<X>, RS extends AbstractFloatAssert<RS>, X extends Exception> extends Base<Impl<A, RS, X>, A, RS, X> {
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends CharToFloatFunctionX<X>, RS extends AbstractFloatAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Float, Exception>
			implements
				CharToFloatFunctionXAssert<S, A, RS, X> {
