...
public interface LFltToLongFunctionAssert<S extends LFltToLongFunctionAssert<S, A, RS>, A extends LFltToLongFunction, RS extends AbstractLongAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LFltConsumer, A, RS, Long> {
	...
	@Nonnull
	Evaluation<S, LFltConsumer, A, RS, Long> doesApplyAsLong(float a);

	/** Convenience implementation - if you want instantiate not to extend (uses one less generic parameter). */
	final class The<A extends LFltToLongFunction, RS extends AbstractLongAssert<RS>> extends Base<The<A, RS>, A, RS> {
	...
	class Base<S extends Base<S, A, RS>, A extends LFltToLongFunction, RS extends AbstractLongAssert<RS>> extends FullFunctionalAssert.Base<S, LFltConsumer, A, RS, Long> implements LFltToLongFunctionAssert<S, A, RS> {
