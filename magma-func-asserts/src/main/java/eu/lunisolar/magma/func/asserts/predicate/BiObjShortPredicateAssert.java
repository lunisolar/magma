...
/** Assertions for BiObjShortPredicate. */
public interface BiObjShortPredicateAssert<S extends BiObjShortPredicateAssert<S, A, RS, T1, T2>, A extends BiObjShortPredicate<T1, T2>, RS extends AbstractBooleanAssert<RS>, T1, T2>
	...
	public static class Base<S extends Base<S, A, RS, T1, T2>, A extends BiObjShortPredicate<T1, T2>, RS extends AbstractBooleanAssert<RS>, T1, T2> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception>
			implements
