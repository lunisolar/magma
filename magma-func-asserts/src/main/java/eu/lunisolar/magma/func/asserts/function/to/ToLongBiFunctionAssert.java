...
/** Assertions for ToLongBiFunction. */
public interface ToLongBiFunctionAssert<S extends ToLongBiFunctionAssert<S, A, RS, T1, T2>, A extends ToLongBiFunction<T1, T2>, RS extends AbstractLongAssert<RS>, T1, T2>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, T1, T2>, A extends ToLongBiFunction<T1, T2>, RS extends AbstractLongAssert<RS>, T1, T2> extends FunctionalAssert.Base<S, A, RS, Long, Exception> implements ToLongBiFunctionAssert<S, A, RS, T1, T2> {
