...
/** Assertions for IntFunctionX. */
public interface IntFunctionXAssert<S extends IntFunctionXAssert<S, A, RS, R, X>, A extends IntFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, R, X>, A extends IntFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Exception> extends FunctionalAssert.Base<S, A, RS, R, Exception> implements IntFunctionXAssert<S, A, RS, R, X> {
