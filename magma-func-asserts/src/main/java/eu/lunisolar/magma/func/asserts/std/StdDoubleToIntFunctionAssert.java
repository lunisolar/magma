...
/** Assertions for java.util.function.DoubleToIntFunction. */
public interface StdDoubleToIntFunctionAssert<S extends StdDoubleToIntFunctionAssert<S, A, RS>, A extends java.util.function.DoubleToIntFunction, RS extends AbstractIntegerAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends java.util.function.DoubleToIntFunction, RS extends AbstractIntegerAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Integer, Exception> implements StdDoubleToIntFunctionAssert<S, A, RS> {
