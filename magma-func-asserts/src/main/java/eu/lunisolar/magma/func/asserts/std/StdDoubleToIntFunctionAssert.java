...
public interface StdDoubleToIntFunctionAssert<S extends StdDoubleToIntFunctionAssert<S, A, RS>, A extends java.util.function.DoubleToIntFunction, RS extends AbstractIntegerAssert<RS>>
	...
	public static class Base<S extends Base<S, A, RS>, A extends java.util.function.DoubleToIntFunction, RS extends AbstractIntegerAssert<RS>> extends FullFunctionalAssert.Base<S, A, RS, Integer, Exception>
			implements
				StdDoubleToIntFunctionAssert<S, A, RS> {
