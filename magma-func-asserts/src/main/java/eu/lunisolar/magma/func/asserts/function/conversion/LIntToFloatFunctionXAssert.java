...
public interface LIntToFloatFunctionXAssert<S extends LIntToFloatFunctionXAssert<S, A, RS, X>, A extends LIntToFloatFunctionX<X>, RS extends AbstractFloatAssert<RS>, X extends Throwable>
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends LIntToFloatFunctionX<X>, RS extends AbstractFloatAssert<RS>, X extends Throwable> extends FullFunctionalAssert.Base<S, A, RS, Float, Exception>
			implements
