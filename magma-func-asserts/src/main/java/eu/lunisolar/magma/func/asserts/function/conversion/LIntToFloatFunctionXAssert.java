...
public interface LIntToFloatFunctionXAssert<S extends LIntToFloatFunctionXAssert<S, A, RS, X>, A extends LIntToFloatFunctionX<X>, RS extends AbstractFloatAssert<RS>, X extends Exception>
		extends
			Assert<S, A>,
	...
	public final static class Impl<A extends LIntToFloatFunctionX<X>, RS extends AbstractFloatAssert<RS>, X extends Exception> extends Base<Impl<A, RS, X>, A, RS, X> {
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends LIntToFloatFunctionX<X>, RS extends AbstractFloatAssert<RS>, X extends Exception> extends FullFunctionalAssert.Base<S, A, RS, Float, Exception>
			implements
