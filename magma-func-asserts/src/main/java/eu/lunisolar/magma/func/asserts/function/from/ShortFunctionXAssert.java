...
/** Assertions for ShortFunctionX. */
public interface ShortFunctionXAssert<S extends ShortFunctionXAssert<S, A, RS, R, X>, A extends ShortFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, R, X>, A extends ShortFunctionX<R, X>, RS extends Assert<RS, R>, R, X extends Exception> extends FunctionalAssert.Base<S, A, RS, R, Exception> implements ShortFunctionXAssert<S, A, RS, R, X> {
