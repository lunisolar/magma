...
/** Assertions for IntBinaryOperator. */
public interface IntBinaryOperatorAssert<S extends IntBinaryOperatorAssert<S, A, RS>, A extends IntBinaryOperator, RS extends AbstractIntegerAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends IntBinaryOperator, RS extends AbstractIntegerAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Integer, Exception> implements IntBinaryOperatorAssert<S, A, RS> {
