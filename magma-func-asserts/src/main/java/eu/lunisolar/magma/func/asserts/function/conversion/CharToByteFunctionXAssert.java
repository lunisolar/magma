...
/** Assertions for CharToByteFunctionX. */
public interface CharToByteFunctionXAssert<S extends CharToByteFunctionXAssert<S, A, RS, X>, A extends CharToByteFunctionX<X>, RS extends AbstractByteAssert<RS>, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends CharToByteFunctionX<X>, RS extends AbstractByteAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Byte, Exception> implements CharToByteFunctionXAssert<S, A, RS, X> {
