...
/** Assertions for java.util.function.Supplier. */
public interface StdSupplierAssert<S extends StdSupplierAssert<S, A, RS, R>, A extends java.util.function.Supplier<R>, RS extends Assert<RS, R>, R> extends Assert<S, A>, FunctionalAssert<S, A, RS, R, Exception>, RecurringAsserts<S, A, RS, R> {
	...
	public static class Base<S extends Base<S, A, RS, R>, A extends java.util.function.Supplier<R>, RS extends Assert<RS, R>, R> extends FunctionalAssert.Base<S, A, RS, R, Exception> implements StdSupplierAssert<S, A, RS, R> {
