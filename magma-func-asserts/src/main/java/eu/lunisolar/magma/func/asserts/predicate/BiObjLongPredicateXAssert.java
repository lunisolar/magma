...
/** Assertions for BiObjLongPredicateX. */
public interface BiObjLongPredicateXAssert<S extends BiObjLongPredicateXAssert<S, A, RS, T1, T2, X>, A extends BiObjLongPredicateX<T1, T2, X>, RS extends AbstractBooleanAssert<RS>, T1, T2, X extends Exception>
	...
	public static class Base<S extends Base<S, A, RS, T1, T2, X>, A extends BiObjLongPredicateX<T1, T2, X>, RS extends AbstractBooleanAssert<RS>, T1, T2, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception>
			implements
