...
/** Assertions for BiObjIntFunctionX. */
public interface BiObjIntFunctionXAssert<S extends BiObjIntFunctionXAssert<S, A, RS, T1, T2, R, X>, A extends BiObjIntFunctionX<T1, T2, R, X>, RS extends Assert<RS, R>, T1, T2, R, X extends Exception>
	...
	public static class Base<S extends Base<S, A, RS, T1, T2, R, X>, A extends BiObjIntFunctionX<T1, T2, R, X>, RS extends Assert<RS, R>, T1, T2, R, X extends Exception> extends FunctionalAssert.Base<S, A, RS, R, Exception>
			implements
