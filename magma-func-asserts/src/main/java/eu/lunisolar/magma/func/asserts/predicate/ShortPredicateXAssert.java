...
/** Assertions for ShortPredicateX. */
public interface ShortPredicateXAssert<S extends ShortPredicateXAssert<S, A, RS, X>, A extends ShortPredicateX<X>, RS extends AbstractBooleanAssert<RS>, X extends Exception>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends ShortPredicateX<X>, RS extends AbstractBooleanAssert<RS>, X extends Exception> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception> implements ShortPredicateXAssert<S, A, RS, X> {
