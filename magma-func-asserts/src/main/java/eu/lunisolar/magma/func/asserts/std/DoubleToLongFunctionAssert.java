...
public interface DoubleToLongFunctionAssert<S extends DoubleToLongFunctionAssert<S, A, RS>, A extends DoubleToLongFunction, RS extends AbstractLongAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, LDoubleConsumer, A, RS, Long> {
	...
	class Base<S extends Base<S, A, RS>, A extends DoubleToLongFunction, RS extends AbstractLongAssert<RS>> extends FullFunctionalAssert.Base<S, LDoubleConsumer, A, RS, Long> implements DoubleToLongFunctionAssert<S, A, RS> {
