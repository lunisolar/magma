...
/** Assertions for ObjDoublePredicate. */
public interface ObjDoublePredicateAssert<S extends ObjDoublePredicateAssert<S, A, RS, T>, A extends ObjDoublePredicate<T>, RS extends AbstractBooleanAssert<RS>, T>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS, T>, A extends ObjDoublePredicate<T>, RS extends AbstractBooleanAssert<RS>, T> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception> implements ObjDoublePredicateAssert<S, A, RS, T> {
