...
/** Assert for FloatBiFunction. */
public interface FloatBiFunctionAssert<S extends FloatBiFunctionAssert<S, A, RS, R>, A extends FloatBiFunction<R>, RS extends Assert<RS, R>, R> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, R, Exception> {
	...
	public static class Base<S extends Base<S, A, RS, R>, A extends FloatBiFunction<R>, RS extends Assert<RS, R>, R> extends FullFunctionalAssert.Base<S, A, RS, R, Exception> implements FloatBiFunctionAssert<S, A, RS, R> {
