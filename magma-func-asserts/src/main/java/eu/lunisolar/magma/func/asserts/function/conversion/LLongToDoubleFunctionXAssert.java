...
public interface LLongToDoubleFunctionXAssert<S extends LLongToDoubleFunctionXAssert<S, A, RS, X>, A extends LLongToDoubleFunctionX<X>, RS extends AbstractDoubleAssert<RS>, X extends Exception>
		extends
			Assert<S, A>,
	...
	public final static class Impl<A extends LLongToDoubleFunctionX<X>, RS extends AbstractDoubleAssert<RS>, X extends Exception> extends Base<Impl<A, RS, X>, A, RS, X> {
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends LLongToDoubleFunctionX<X>, RS extends AbstractDoubleAssert<RS>, X extends Exception> extends FullFunctionalAssert.Base<S, A, RS, Double, Exception>
			implements
