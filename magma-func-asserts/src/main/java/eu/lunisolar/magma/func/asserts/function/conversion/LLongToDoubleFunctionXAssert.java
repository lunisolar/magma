...
public interface LLongToDoubleFunctionXAssert<S extends LLongToDoubleFunctionXAssert<S, A, RS, X>, A extends LLongToDoubleFunctionX<X>, RS extends AbstractDoubleAssert<RS>, X extends Throwable>
	...
	public final static class The<A extends LLongToDoubleFunctionX<X>, RS extends AbstractDoubleAssert<RS>, X extends Throwable> extends Base<The<A, RS, X>, A, RS, X> {
	...
	public static class Base<S extends Base<S, A, RS, X>, A extends LLongToDoubleFunctionX<X>, RS extends AbstractDoubleAssert<RS>, X extends Throwable> extends FullFunctionalAssert.Base<S, LLongConsumerX<Exception>, A, RS, Double, Exception>
			implements
