...
/** Assertions for java.util.function.LongPredicate. */
public interface StdLongPredicateAssert<S extends StdLongPredicateAssert<S, A, RS>, A extends java.util.function.LongPredicate, RS extends AbstractBooleanAssert<RS>>
		extends
			Assert<S, A>,
	...
	public static class Base<S extends Base<S, A, RS>, A extends java.util.function.LongPredicate, RS extends AbstractBooleanAssert<RS>> extends FunctionalAssert.Base<S, A, RS, Boolean, Exception> implements StdLongPredicateAssert<S, A, RS> {
