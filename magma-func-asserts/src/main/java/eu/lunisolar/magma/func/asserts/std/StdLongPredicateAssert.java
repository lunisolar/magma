...
public interface StdLongPredicateAssert<S extends StdLongPredicateAssert<S, A, RS>, A extends java.util.function.LongPredicate, RS extends AbstractBooleanAssert<RS>> extends Assert<S, A>, FullFunctionalAssert<S, A, RS, Boolean, Exception> {
	...
	public static class Base<S extends Base<S, A, RS>, A extends java.util.function.LongPredicate, RS extends AbstractBooleanAssert<RS>> extends FullFunctionalAssert.Base<S, A, RS, Boolean, Exception> implements StdLongPredicateAssert<S, A, RS> {
