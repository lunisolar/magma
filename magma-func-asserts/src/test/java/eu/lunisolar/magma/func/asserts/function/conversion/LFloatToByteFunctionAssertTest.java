...
public class LFloatToByteFunctionAssertTest<X extends Throwable> {
    ...
    private LFloatToByteFunction function = LFloatToByteFunction.l(a1 ->
            testValue
    );

    private LFloatToByteFunction functionThrowing = LFloatToByteFunction.l(a1 -> {
