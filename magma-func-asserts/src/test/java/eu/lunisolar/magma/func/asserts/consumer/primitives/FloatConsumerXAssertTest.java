...
public class FloatConsumerXAssertTest<X extends ParseException> {
    ...
    private FloatConsumerX<X> function = FloatConsumerX.lX((f) -> {
            externalEffect.set(testValue);
    });

    private FloatConsumerX<X> functionThrowing = FloatConsumerX.lX((f) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept((float)80).withException(a -> a
