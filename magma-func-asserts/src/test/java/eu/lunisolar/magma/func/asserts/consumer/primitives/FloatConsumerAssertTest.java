...
public class FloatConsumerAssertTest<X extends ParseException> {
    ...
    private FloatConsumer function = FloatConsumer.l((f) -> {
            externalEffect.set(testValue);
    });

    private FloatConsumer functionThrowing = FloatConsumer.l((f) -> {
