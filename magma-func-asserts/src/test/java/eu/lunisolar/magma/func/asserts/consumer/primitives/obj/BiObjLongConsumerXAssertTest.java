...
public class BiObjLongConsumerXAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjLongConsumerX<Integer ,Integer ,X> function = BiObjLongConsumerX.lX((t1,t2, l) -> {
            externalEffect.set(testValue);
    });

    private BiObjLongConsumerX<Integer ,Integer ,X> functionThrowing = BiObjLongConsumerX.lX((t1,t2, l) -> {
