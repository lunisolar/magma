...
public class BooleanToByteFunctionAssertTest<X extends ParseException> {
    ...
    private BooleanToByteFunction function = BooleanToByteFunction.l((b) -> {
            return testValue;
    });

    private BooleanToByteFunction functionThrowing = BooleanToByteFunction.l((b) -> {
