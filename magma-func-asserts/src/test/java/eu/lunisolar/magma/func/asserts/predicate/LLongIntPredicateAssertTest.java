...
public class LLongIntPredicateAssertTest {
    ...
    private LLongIntPredicate function = (a1,a2) ->
            testValue;


    private LLongIntPredicate functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertLongIntPred(functionThrowing)
         .doesTest(100L,100)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertLongIntPred(functionThrowing)
         .doesTest(100L,100).withException(a -> a
