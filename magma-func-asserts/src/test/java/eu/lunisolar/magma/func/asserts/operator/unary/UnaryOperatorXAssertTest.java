...
public class UnaryOperatorXAssertTest<T,X extends ParseException> {
    ...
    private UnaryOperatorX<Integer ,X> function = UnaryOperatorX.lX((t) -> {
            return (Integer ) testValue;
    });

    private UnaryOperatorX<Integer ,X> functionThrowing = UnaryOperatorX.lX((t) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80)).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80)).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80)).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80)).withException(a -> a
