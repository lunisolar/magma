...
public class BiObjDoubleFunctionXAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private BiObjDoubleFunctionX<Integer ,Integer ,Integer ,X> function = BiObjDoubleFunctionX.lX((t1,t2, d) -> {
            return (Integer ) testValue;
    });

    private BiObjDoubleFunctionX<Integer ,Integer ,Integer ,X> functionThrowing = BiObjDoubleFunctionX.lX((t1,t2, d) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(double)82).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(double)82).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(double)82).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(double)82).withException(a -> a
