...
public class LObjDoubleFunctionAssertTest<T,R,X extends Throwable> {
    ...
    private LObjDoubleFunction<Integer ,Integer > function = LObjDoubleFunction.l((a1,a2) ->
            (Integer ) testValue
    );

    private LObjDoubleFunction<Integer ,Integer > functionThrowing = LObjDoubleFunction.l((a1,a2) -> {
