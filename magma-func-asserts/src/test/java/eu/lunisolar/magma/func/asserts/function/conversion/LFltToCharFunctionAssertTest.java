...
import eu.lunisolar.magma.func.function.conversion.LFltToCharFunction;
...
public class LFltToCharFunctionAssertTest {
    ...
    private LFltToCharFunction function = a ->
            testValue;


    private LFltToCharFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertFltToCharFunc(functionThrowing)
         .doesApplyAsChar(100f)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertFltToCharFunc(functionThrowing)
         .doesApplyAsChar(100f).withException(a -> a
