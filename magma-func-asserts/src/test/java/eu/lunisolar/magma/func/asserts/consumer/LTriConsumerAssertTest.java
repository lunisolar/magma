...
public class LTriConsumerAssertTest<T1,T2,T3,X extends ParseException> {
    ...
    private LTriConsumer<Integer,Integer,Integer> function = (Integer a1,Integer a2,Integer a3) ->
            externalEffect.set(testValue);


    private LTriConsumer<Integer,Integer,Integer> functionThrowing = (Integer a1,Integer a2,Integer a3) -> {
