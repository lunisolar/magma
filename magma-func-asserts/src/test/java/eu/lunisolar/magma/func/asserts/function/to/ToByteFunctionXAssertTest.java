...
public class ToByteFunctionXAssertTest<T,X extends ParseException> {
    ...
    private ToByteFunctionX<Integer ,X> function = ToByteFunctionX.lX((t) -> {
            return testValue;
    });

    private ToByteFunctionX<Integer ,X> functionThrowing = ToByteFunctionX.lX((t) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsByte((Integer )Integer.valueOf(80)).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsByte((Integer )Integer.valueOf(80)).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsByte((Integer )Integer.valueOf(80)).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsByte((Integer )Integer.valueOf(80)).withException(a -> a
