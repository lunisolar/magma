...
public class BooleanFunctionAssertTest<R,X extends ParseException> {
    ...
    private BooleanFunction<Integer > function = BooleanFunction.l((b) -> {
            return (Integer ) testValue;
    });

    private BooleanFunction<Integer > functionThrowing = BooleanFunction.l((b) -> {
