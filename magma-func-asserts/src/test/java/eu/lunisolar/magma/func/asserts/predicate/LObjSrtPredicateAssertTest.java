...
public class LObjSrtPredicateAssertTest<T> {
    ...
    private LObjSrtPredicate<Integer> function = (a1,a2) ->
            testValue;


    private LObjSrtPredicate<Integer> functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertObjSrtPred(functionThrowing)
         .doesTest(100,(short)100)
            .to( a -> a.isEqualTo(1));
    }
