...
public class LongToByteFunctionAssertTest<X extends ParseException> {
    ...
    private LongToByteFunction function = LongToByteFunction.l((l) -> {
            return testValue;
    });

    private LongToByteFunction functionThrowing = LongToByteFunction.l((l) -> {
