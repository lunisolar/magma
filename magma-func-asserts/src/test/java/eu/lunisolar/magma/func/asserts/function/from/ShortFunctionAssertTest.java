...
public class ShortFunctionAssertTest<R,X extends ParseException> {
    ...
    private ShortFunction<Integer > function = ShortFunction.l((s) -> {
            return (Integer ) testValue;
    });

    private ShortFunction<Integer > functionThrowing = ShortFunction.l((s) -> {
