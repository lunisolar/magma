...
public class FloatPredicateAssertTest<X extends ParseException> {
    ...
    private FloatPredicate function = FloatPredicate.l((f) -> {
            return testValue;
    });

    private FloatPredicate functionThrowing = FloatPredicate.l((f) -> {
