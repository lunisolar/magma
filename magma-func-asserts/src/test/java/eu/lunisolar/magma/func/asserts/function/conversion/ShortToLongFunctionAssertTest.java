...
public class ShortToLongFunctionAssertTest<X extends ParseException> {
    ...
    private ShortToLongFunction function = ShortToLongFunction.l((s) -> {
            return testValue;
    });

    private ShortToLongFunction functionThrowing = ShortToLongFunction.l((s) -> {
