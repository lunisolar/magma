...
public class BiPredicateXAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiPredicateX<Integer ,Integer ,X> function = BiPredicateX.lX((t1,t2) -> {
            return testValue;
    });

    private BiPredicateX<Integer ,Integer ,X> functionThrowing = BiPredicateX.lX((t1,t2) -> {
