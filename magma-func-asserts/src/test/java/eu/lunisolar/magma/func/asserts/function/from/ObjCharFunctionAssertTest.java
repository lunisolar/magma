...
public class ObjCharFunctionAssertTest<T,R,X extends ParseException> {
    ...
    private ObjCharFunction<Integer ,Integer > function = ObjCharFunction.l((t, c) -> {
            return (Integer ) testValue;
    });

    private ObjCharFunction<Integer ,Integer > functionThrowing = ObjCharFunction.l((t, c) -> {
