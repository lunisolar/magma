...
public class BiConsumerXAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiConsumerX<Integer ,Integer ,X> function = BiConsumerX.lX((t1,t2) -> {
            externalEffect.set(testValue);
    });

    private BiConsumerX<Integer ,Integer ,X> functionThrowing = BiConsumerX.lX((t1,t2) -> {
