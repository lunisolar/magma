...
public class BooleanBiFunctionXAssertTest<R,X extends ParseException> {
    ...
    private BooleanBiFunctionX<Integer ,X> function = BooleanBiFunctionX.lX((b1,b2) -> {
            return (Integer ) testValue;
    });

    private BooleanBiFunctionX<Integer ,X> functionThrowing = BooleanBiFunctionX.lX((b1,b2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply(true,true).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply(true,true).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply(true,true).to( a -> a.isEqualTo(1));
