...
public class IntBiConsumerAssertTest<X extends ParseException> {
    ...
    private IntBiConsumer function = IntBiConsumer.l((i1,i2) -> {
            externalEffect.set(testValue);
    });

    private IntBiConsumer functionThrowing = IntBiConsumer.l((i1,i2) -> {
