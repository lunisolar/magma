...
public class ToFloatBiFunctionAssertTest<T1,T2,X extends ParseException> {
    ...
    private ToFloatBiFunction<Integer ,Integer > function = ToFloatBiFunction.l((t1,t2) -> {
            return testValue;
    });

    private ToFloatBiFunction<Integer ,Integer > functionThrowing = ToFloatBiFunction.l((t1,t2) -> {
