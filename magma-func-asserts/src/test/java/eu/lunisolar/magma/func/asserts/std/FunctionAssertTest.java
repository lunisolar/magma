...
public class FunctionAssertTest<T,R,X extends Throwable> {
    ...
    private java.util.function.Function<Integer ,Integer > function = (a1 ->
            (Integer ) testValue
    );

    private java.util.function.Function<Integer ,Integer > functionThrowing = (a1 -> {
