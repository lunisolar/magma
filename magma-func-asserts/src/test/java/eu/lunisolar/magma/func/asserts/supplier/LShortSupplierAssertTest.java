...
import eu.lunisolar.magma.func.supplier.LShortSupplier;
...
public class LShortSupplierAssertTest<X extends ParseException> {
    ...
    private LShortSupplier function = () ->
            testValue;


    private LShortSupplier functionThrowing = () -> {
