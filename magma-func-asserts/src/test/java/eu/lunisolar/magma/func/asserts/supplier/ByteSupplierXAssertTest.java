...
public class ByteSupplierXAssertTest<X extends ParseException> {
    ...
    private ByteSupplierX<X> function = ByteSupplierX.lX(() -> {
            return testValue;
    });

    private ByteSupplierX<X> functionThrowing = ByteSupplierX.lX(() -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesGetAsByte().to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesGetAsByte().to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesGetAsByte().to( a -> a.isEqualTo(1));
