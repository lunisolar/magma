...
public class BooleanBiConsumerXAssertTest<X extends ParseException> {
    ...
    private BooleanBiConsumerX<X> function = BooleanBiConsumerX.lX((b1,b2) -> {
            externalEffect.set(testValue);
    });

    private BooleanBiConsumerX<X> functionThrowing = BooleanBiConsumerX.lX((b1,b2) -> {
