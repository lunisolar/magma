...
public class ObjFloatPredicateXAssertTest<T,X extends ParseException> {
    ...
    private ObjFloatPredicateX<Integer ,X> function = ObjFloatPredicateX.lX((t, f) -> {
            return testValue;
    });

    private ObjFloatPredicateX<Integer ,X> functionThrowing = ObjFloatPredicateX.lX((t, f) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(float)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(float)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(float)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(float)81).withException(a -> a
