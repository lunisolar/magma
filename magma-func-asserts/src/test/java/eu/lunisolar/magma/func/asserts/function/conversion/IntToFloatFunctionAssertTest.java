...
public class IntToFloatFunctionAssertTest<X extends ParseException> {
    ...
    private IntToFloatFunction function = IntToFloatFunction.l((i) -> {
            return testValue;
    });

    private IntToFloatFunction functionThrowing = IntToFloatFunction.l((i) -> {
