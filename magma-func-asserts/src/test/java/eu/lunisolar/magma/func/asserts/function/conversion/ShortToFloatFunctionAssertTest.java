...
public class ShortToFloatFunctionAssertTest<X extends ParseException> {
    ...
    private ShortToFloatFunction function = ShortToFloatFunction.l((s) -> {
            return testValue;
    });

    private ShortToFloatFunction functionThrowing = ShortToFloatFunction.l((s) -> {
