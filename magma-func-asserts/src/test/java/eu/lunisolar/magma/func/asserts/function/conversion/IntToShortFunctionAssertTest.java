...
public class IntToShortFunctionAssertTest<X extends ParseException> {
    ...
    private IntToShortFunction function = IntToShortFunction.l((i) -> {
            return testValue;
    });

    private IntToShortFunction functionThrowing = IntToShortFunction.l((i) -> {
