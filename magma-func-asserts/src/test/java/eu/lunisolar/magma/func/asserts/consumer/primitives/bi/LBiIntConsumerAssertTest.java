...
public class LBiIntConsumerAssertTest<X extends Throwable> {
    ...
    private LBiIntConsumer function = LBiIntConsumer.l((a1,a2) ->
            externalEffect.set(testValue)
    );

    private LBiIntConsumer functionThrowing = LBiIntConsumer.l((a1,a2) -> {
