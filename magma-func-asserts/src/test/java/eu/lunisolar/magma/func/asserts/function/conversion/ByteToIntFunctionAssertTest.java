...
public class ByteToIntFunctionAssertTest<X extends ParseException> {
    ...
    private ByteToIntFunction function = ByteToIntFunction.l((b) -> {
            return testValue;
    });

    private ByteToIntFunction functionThrowing = ByteToIntFunction.l((b) -> {
