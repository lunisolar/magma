...
public class LObjLongPredicateAssertTest<T,X extends Throwable> {
    ...
    private LObjLongPredicate<Integer > function = LObjLongPredicate.l((a1,a2) ->
            testValue
    );

    private LObjLongPredicate<Integer > functionThrowing = LObjLongPredicate.l((a1,a2) -> {
