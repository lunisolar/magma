...
public class ObjCharPredicateAssertTest<T,X extends ParseException> {
    ...
    private ObjCharPredicate<Integer > function = ObjCharPredicate.l((t, c) -> {
            return testValue;
    });

    private ObjCharPredicate<Integer > functionThrowing = ObjCharPredicate.l((t, c) -> {
