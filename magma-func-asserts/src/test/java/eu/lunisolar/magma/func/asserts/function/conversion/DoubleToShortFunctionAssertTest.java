...
public class DoubleToShortFunctionAssertTest<X extends ParseException> {
    ...
    private DoubleToShortFunction function = DoubleToShortFunction.l((d) -> {
            return testValue;
    });

    private DoubleToShortFunction functionThrowing = DoubleToShortFunction.l((d) -> {
