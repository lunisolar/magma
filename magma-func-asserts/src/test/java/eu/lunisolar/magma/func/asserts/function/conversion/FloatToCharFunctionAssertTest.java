...
public class FloatToCharFunctionAssertTest<X extends ParseException> {
    ...
    private FloatToCharFunction function = FloatToCharFunction.l((f) -> {
            return testValue;
    });

    private FloatToCharFunction functionThrowing = FloatToCharFunction.l((f) -> {
