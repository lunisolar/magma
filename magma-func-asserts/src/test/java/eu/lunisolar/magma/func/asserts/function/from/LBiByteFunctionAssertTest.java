...
public class LBiByteFunctionAssertTest<R,X extends ParseException> {
    ...
    private LBiByteFunction<Integer> function = (byte a1,byte a2) ->
            testValue;


    private LBiByteFunction<Integer> functionThrowing = (byte a1,byte a2) -> {
