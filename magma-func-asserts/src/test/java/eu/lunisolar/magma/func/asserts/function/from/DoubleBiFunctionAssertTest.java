...
public class DoubleBiFunctionAssertTest<R,X extends ParseException> {
    ...
    private DoubleBiFunction<Integer > function = DoubleBiFunction.l((d1,d2) -> {
            return (Integer ) testValue;
    });

    private DoubleBiFunction<Integer > functionThrowing = DoubleBiFunction.l((d1,d2) -> {
