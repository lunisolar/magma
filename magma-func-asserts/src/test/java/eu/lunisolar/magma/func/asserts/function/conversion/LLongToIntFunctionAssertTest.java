...
public class LLongToIntFunctionAssertTest<X extends Throwable> {
    ...
    private LLongToIntFunction function = LLongToIntFunction.l(a1 ->
            testValue
    );

    private LLongToIntFunction functionThrowing = LLongToIntFunction.l(a1 -> {
