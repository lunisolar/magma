...
public class LLongToIntFunctionAssertTest<X extends ParseException> {
    ...
    private LLongToIntFunction function = a1 ->
            testValue;


    private LLongToIntFunction functionThrowing = a1 -> {
