...
public class BiFunctionAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private BiFunction<Integer ,Integer ,Integer > function = BiFunction.l((t1,t2) -> {
            return (Integer ) testValue;
    });

    private BiFunction<Integer ,Integer ,Integer > functionThrowing = BiFunction.l((t1,t2) -> {
