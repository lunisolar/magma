...
public class BooleanBiConsumerAssertTest<X extends ParseException> {
    ...
    private BooleanBiConsumer function = BooleanBiConsumer.l((b1,b2) -> {
            externalEffect.set(testValue);
    });

    private BooleanBiConsumer functionThrowing = BooleanBiConsumer.l((b1,b2) -> {
