...
public class LBiObjLongPredicateAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjLongPredicate<Integer,Integer> function = (Integer a1,Integer a2,long a3) ->
            testValue;


    private LBiObjLongPredicate<Integer,Integer> functionThrowing = (Integer a1,Integer a2,long a3) -> {
