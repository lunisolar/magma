...
public class LLogicalBinaryOperatorAssertTest<X extends Throwable> {
    ...
    private LLogicalBinaryOperator function = LLogicalBinaryOperator.l((b1,b2) ->
            testValue
    );

    private LLogicalBinaryOperator functionThrowing = LLogicalBinaryOperator.l((b1,b2) -> {
