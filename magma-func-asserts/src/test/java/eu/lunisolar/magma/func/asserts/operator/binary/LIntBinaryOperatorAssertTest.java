...
public class LIntBinaryOperatorAssertTest<X extends Throwable> {
    ...
    private LIntBinaryOperator function = LIntBinaryOperator.l((a1,a2) ->
            testValue
    );

    private LIntBinaryOperator functionThrowing = LIntBinaryOperator.l((a1,a2) -> {
