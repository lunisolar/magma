...
public class LIntBinaryOperatorAssertTest<X extends ParseException> {
    ...
    private LIntBinaryOperator function = (int a1,int a2) ->
            testValue;


    private LIntBinaryOperator functionThrowing = (int a1,int a2) -> {
