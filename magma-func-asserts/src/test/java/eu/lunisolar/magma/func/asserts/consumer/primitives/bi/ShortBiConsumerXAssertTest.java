...
public class ShortBiConsumerXAssertTest<X extends ParseException> {
    ...
    private ShortBiConsumerX<X> function = ShortBiConsumerX.lX((s1,s2) -> {
            externalEffect.set(testValue);
    });

    private ShortBiConsumerX<X> functionThrowing = ShortBiConsumerX.lX((s1,s2) -> {
