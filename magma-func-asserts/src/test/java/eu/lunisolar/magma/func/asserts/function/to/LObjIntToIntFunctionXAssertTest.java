...
public class LObjIntToIntFunctionXAssertTest<T,X extends Throwable> {
    ...
    private LObjIntToIntFunctionX<Integer ,X> function = LObjIntToIntFunctionX.lX((a1,a2) ->
            testValue
    );

    private LObjIntToIntFunctionX<Integer ,X> functionThrowing = LObjIntToIntFunctionX.lX((a1,a2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsInt((Integer )Integer.valueOf(80),(int)81)
