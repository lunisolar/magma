...
public class IntSupplierAssertTest<X extends ParseException> {
    ...
    private IntSupplier function = IntSupplier.l(() -> {
            return testValue;
    });

    private IntSupplier functionThrowing = IntSupplier.l(() -> {
