...
public class ObjBooleanConsumerAssertTest<T,X extends ParseException> {
    ...
    private ObjBooleanConsumer<Integer > function = ObjBooleanConsumer.l((t, b) -> {
            externalEffect.set(testValue);
    });

    private ObjBooleanConsumer<Integer > functionThrowing = ObjBooleanConsumer.l((t, b) -> {
