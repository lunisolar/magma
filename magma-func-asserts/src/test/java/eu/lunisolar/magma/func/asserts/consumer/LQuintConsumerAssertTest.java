...
import eu.lunisolar.magma.func.consumer.LQuintConsumer;
...
public class LQuintConsumerAssertTest<T1,T2,T3,T4,T5> {
    ...
    private LQuintConsumer<Integer,Integer,Integer,Integer,Integer> function = (a1,a2,a3,a4,a5) ->
            externalEffect.set(testValue);


    private LQuintConsumer<Integer,Integer,Integer,Integer,Integer> functionThrowing = (a1,a2,a3,a4,a5) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertQuintCons(function)
         .doesAccept(100,100,100,100,100)
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertQuintCons(functionThrowing)
         .doesAccept(100,100,100,100,100)
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertQuintCons(functionThrowing)
         .doesAccept(100,100,100,100,100).withException(a -> a
