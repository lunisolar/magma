...
public class ToLongFunctionAssertTest<T,X extends Throwable> {
    ...
    private java.util.function.ToLongFunction<Integer > function = (a1 ->
            testValue
    );

    private java.util.function.ToLongFunction<Integer > functionThrowing = (a1 -> {
