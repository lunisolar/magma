...
public class LObjByteFunctionXAssertTest<T,R,X extends Throwable> {
    ...
    private LObjByteFunctionX<Integer ,Integer ,X> function = LObjByteFunctionX.lX((a1,a2) ->
            (Integer ) testValue
    );

    private LObjByteFunctionX<Integer ,Integer ,X> functionThrowing = LObjByteFunctionX.lX((a1,a2) -> {
