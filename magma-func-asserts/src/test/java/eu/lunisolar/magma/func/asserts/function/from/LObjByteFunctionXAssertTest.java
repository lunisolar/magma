...
import eu.lunisolar.magma.func.function.from.LObjByteFunctionX;
...
public class LObjByteFunctionXAssertTest<T,R,X extends ParseException> {
    ...
    private LObjByteFunctionX<Integer,Integer,X> function = (Integer a1,byte a2) ->
            testValue;


    private LObjByteFunctionX<Integer,Integer,X> functionThrowing = (Integer a1,byte a2) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply(100,(byte)100).withException(a -> a
