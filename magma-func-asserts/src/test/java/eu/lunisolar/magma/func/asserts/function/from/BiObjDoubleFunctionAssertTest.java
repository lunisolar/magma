...
public class BiObjDoubleFunctionAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private BiObjDoubleFunction<Integer ,Integer ,Integer > function = BiObjDoubleFunction.l((t1,t2, d) -> {
            return (Integer ) testValue;
    });

    private BiObjDoubleFunction<Integer ,Integer ,Integer > functionThrowing = BiObjDoubleFunction.l((t1,t2, d) -> {
