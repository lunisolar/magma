...
public class FunctionXAssertTest<T,R,X extends ParseException> {
    ...
    private FunctionX<Integer ,Integer ,X> function = FunctionX.lX((t) -> {
            return (Integer ) testValue;
    });

    private FunctionX<Integer ,Integer ,X> functionThrowing = FunctionX.lX((t) -> {
