...
public class LBoolFunctionXAssertTest<R,X extends Throwable> {
    ...
    private LBoolFunctionX<Integer ,X> function = LBoolFunctionX.lX(a1 ->
            (Integer ) testValue
    );

    private LBoolFunctionX<Integer ,X> functionThrowing = LBoolFunctionX.lX(a1 -> {
