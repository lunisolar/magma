...
import eu.lunisolar.magma.func.function.from.LBoolFunctionX;
...
public class LBoolFunctionXAssertTest<R,X extends ParseException> {
    ...
    private LBoolFunctionX<Integer,X> function = a1 ->
            testValue;


    private LBoolFunctionX<Integer,X> functionThrowing = a1 -> {
