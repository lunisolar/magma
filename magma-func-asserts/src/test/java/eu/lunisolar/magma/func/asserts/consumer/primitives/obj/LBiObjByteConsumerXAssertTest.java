...
public class LBiObjByteConsumerXAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjByteConsumerX<Integer ,Integer ,X> function = LBiObjByteConsumerX.lX((a1,a2,a3) ->
            externalEffect.set(testValue)
    );

    private LBiObjByteConsumerX<Integer ,Integer ,X> functionThrowing = LBiObjByteConsumerX.lX((a1,a2,a3) -> {
