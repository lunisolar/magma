...
import eu.lunisolar.magma.func.function.from.LBiLongFunctionX;
...
public class LBiLongFunctionXAssertTest<R,X extends ParseException> {
    ...
    private LBiLongFunctionX<Integer,X> function = (long a1,long a2) ->
            testValue;


    private LBiLongFunctionX<Integer,X> functionThrowing = (long a1,long a2) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply(100L,100L).withException(a -> a
