...
public class ObjCharConsumerXAssertTest<T,X extends ParseException> {
    ...
    private ObjCharConsumerX<Integer ,X> function = ObjCharConsumerX.lX((t, c) -> {
            externalEffect.set(testValue);
    });

    private ObjCharConsumerX<Integer ,X> functionThrowing = ObjCharConsumerX.lX((t, c) -> {
