...
public class FloatBinaryOperatorXAssertTest<X extends ParseException> {
    ...
    private FloatBinaryOperatorX<X> function = FloatBinaryOperatorX.lX((f1,f2) -> {
            return testValue;
    });

    private FloatBinaryOperatorX<X> functionThrowing = FloatBinaryOperatorX.lX((f1,f2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsFloat((float)80,(float)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsFloat((float)80,(float)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsFloat((float)80,(float)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsFloat((float)80,(float)81).withException(a -> a
