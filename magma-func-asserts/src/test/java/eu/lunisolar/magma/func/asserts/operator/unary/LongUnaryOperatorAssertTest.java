...
public class LongUnaryOperatorAssertTest<X extends ParseException> {
    ...
    private LongUnaryOperator function = LongUnaryOperator.l((l) -> {
            return testValue;
    });

    private LongUnaryOperator functionThrowing = LongUnaryOperator.l((l) -> {
