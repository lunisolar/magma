...
public class LObjBoolPredicateAssertTest<T,X extends Throwable> {
    ...
    private LObjBoolPredicate<Integer > function = LObjBoolPredicate.l((a1,a2) ->
            testValue
    );

    private LObjBoolPredicate<Integer > functionThrowing = LObjBoolPredicate.l((a1,a2) -> {
