...
import eu.lunisolar.magma.func.function.LQuadFunction;
...
public class LQuadFunctionAssertTest<T1,T2,T3,T4,R> {
    ...
    private LQuadFunction<Integer,Integer,Integer,Integer,Integer> function = (a1,a2,a3,a4) ->
            testValue;


    private LQuadFunction<Integer,Integer,Integer,Integer,Integer> functionThrowing = (a1,a2,a3,a4) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertQuadFunc(functionThrowing)
         .doesApply(100,100,100,100)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertQuadFunc(functionThrowing)
         .doesApply(100,100,100,100).withException(a -> a
