...
public class LFunctionXAssertTest<T,R,X extends Throwable> {
    ...
    private LFunctionX<Integer ,Integer ,X> function = LFunctionX.lX(a1 ->
            (Integer ) testValue
    );

    private LFunctionX<Integer ,Integer ,X> functionThrowing = LFunctionX.lX(a1 -> {
