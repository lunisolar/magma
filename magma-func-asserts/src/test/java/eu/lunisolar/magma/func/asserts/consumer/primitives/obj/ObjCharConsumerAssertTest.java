...
public class ObjCharConsumerAssertTest<T,X extends ParseException> {
    ...
    private ObjCharConsumer<Integer > function = ObjCharConsumer.l((t, c) -> {
            externalEffect.set(testValue);
    });

    private ObjCharConsumer<Integer > functionThrowing = ObjCharConsumer.l((t, c) -> {
