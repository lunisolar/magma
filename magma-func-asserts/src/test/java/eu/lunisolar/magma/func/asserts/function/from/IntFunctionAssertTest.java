...
public class IntFunctionAssertTest<R,X extends ParseException> {
    ...
    private IntFunction<Integer > function = IntFunction.l((i) -> {
            return (Integer ) testValue;
    });

    private IntFunction<Integer > functionThrowing = IntFunction.l((i) -> {
