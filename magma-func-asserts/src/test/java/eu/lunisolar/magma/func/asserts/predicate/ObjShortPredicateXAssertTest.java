...
public class ObjShortPredicateXAssertTest<T,X extends ParseException> {
    ...
    private ObjShortPredicateX<Integer ,X> function = ObjShortPredicateX.lX((t, s) -> {
            return testValue;
    });

    private ObjShortPredicateX<Integer ,X> functionThrowing = ObjShortPredicateX.lX((t, s) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(short)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(short)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(short)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(short)81).withException(a -> a
