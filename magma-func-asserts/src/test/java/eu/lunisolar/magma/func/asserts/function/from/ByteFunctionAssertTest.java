...
public class ByteFunctionAssertTest<R,X extends ParseException> {
    ...
    private ByteFunction<Integer > function = ByteFunction.l((b) -> {
            return (Integer ) testValue;
    });

    private ByteFunction<Integer > functionThrowing = ByteFunction.l((b) -> {
