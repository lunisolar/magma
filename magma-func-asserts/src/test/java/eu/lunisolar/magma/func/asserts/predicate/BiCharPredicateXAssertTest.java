...
public class BiCharPredicateXAssertTest<X extends ParseException> {
    ...
    private BiCharPredicateX<X> function = BiCharPredicateX.lX((c1,c2) -> {
            return testValue;
    });

    private BiCharPredicateX<X> functionThrowing = BiCharPredicateX.lX((c1,c2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((char)80,(char)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((char)80,(char)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((char)80,(char)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((char)80,(char)81).withException(a -> a
