...
public class BiLongPredicateXAssertTest<X extends ParseException> {
    ...
    private BiLongPredicateX<X> function = BiLongPredicateX.lX((l1,l2) -> {
            return testValue;
    });

    private BiLongPredicateX<X> functionThrowing = BiLongPredicateX.lX((l1,l2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((long)80,(long)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((long)80,(long)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((long)80,(long)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((long)80,(long)81).withException(a -> a
