...
public class FloatToShortFunctionXAssertTest<X extends ParseException> {
    ...
    private FloatToShortFunctionX<X> function = FloatToShortFunctionX.lX((f) -> {
            return testValue;
    });

    private FloatToShortFunctionX<X> functionThrowing = FloatToShortFunctionX.lX((f) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsShort((float)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsShort((float)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort((float)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort((float)80).withException(a -> a
