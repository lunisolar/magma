...
public class ToDoubleBiFunctionAssertTest<T1,T2,X extends ParseException> {
    ...
    private ToDoubleBiFunction<Integer ,Integer > function = ToDoubleBiFunction.l((t1,t2) -> {
            return testValue;
    });

    private ToDoubleBiFunction<Integer ,Integer > functionThrowing = ToDoubleBiFunction.l((t1,t2) -> {
