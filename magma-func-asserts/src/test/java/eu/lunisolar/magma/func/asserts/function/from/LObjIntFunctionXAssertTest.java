...
public class LObjIntFunctionXAssertTest<T,R,X extends Throwable> {
    ...
    private LObjIntFunctionX<Integer ,Integer ,X> function = LObjIntFunctionX.lX((a1,a2) ->
            (Integer ) testValue
    );

    private LObjIntFunctionX<Integer ,Integer ,X> functionThrowing = LObjIntFunctionX.lX((a1,a2) -> {
