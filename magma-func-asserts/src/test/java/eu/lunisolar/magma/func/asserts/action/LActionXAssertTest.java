...
import eu.lunisolar.magma.func.action.LActionX;
...
public class LActionXAssertTest<X extends ParseException> {
    ...
    private LActionX<X> function = () ->
            externalEffect.set(testValue);


    private LActionX<X> functionThrowing = () -> {
