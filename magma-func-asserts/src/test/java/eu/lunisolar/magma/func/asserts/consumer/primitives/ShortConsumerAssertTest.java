...
public class ShortConsumerAssertTest<X extends ParseException> {
    ...
    private ShortConsumer function = ShortConsumer.l((s) -> {
            externalEffect.set(testValue);
    });

    private ShortConsumer functionThrowing = ShortConsumer.l((s) -> {
