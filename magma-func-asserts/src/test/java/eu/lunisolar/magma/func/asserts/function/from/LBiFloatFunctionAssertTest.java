...
import eu.lunisolar.magma.func.function.from.LBiFloatFunction;
...
public class LBiFloatFunctionAssertTest<R,X extends ParseException> {
    ...
    private LBiFloatFunction<Integer> function = (float a1,float a2) ->
            testValue;


    private LBiFloatFunction<Integer> functionThrowing = (float a1,float a2) -> {
