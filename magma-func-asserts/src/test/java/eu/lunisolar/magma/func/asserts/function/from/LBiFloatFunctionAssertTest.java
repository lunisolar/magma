...
public class LBiFloatFunctionAssertTest<R,X extends Throwable> {
    ...
    private LBiFloatFunction<Integer > function = LBiFloatFunction.l((a1,a2) ->
            (Integer ) testValue
    );

    private LBiFloatFunction<Integer > functionThrowing = LBiFloatFunction.l((a1,a2) -> {
