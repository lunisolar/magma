...
public class BooleanTernaryOperatorXAssertTest<X extends ParseException> {
    ...
    private BooleanTernaryOperatorX<X> function = BooleanTernaryOperatorX.lX((b1,b2,b3) -> {
            return testValue;
    });

    private BooleanTernaryOperatorX<X> functionThrowing = BooleanTernaryOperatorX.lX((b1,b2,b3) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply(true,true,true).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply(true,true,true).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply(true,true,true).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply(true,true,true).withException(a -> a
