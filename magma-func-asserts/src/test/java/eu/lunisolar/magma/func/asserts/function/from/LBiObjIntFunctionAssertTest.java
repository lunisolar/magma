...
public class LBiObjIntFunctionAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private LBiObjIntFunction<Integer,Integer,Integer> function = (Integer a1,Integer a2,int a3) ->
            testValue;


    private LBiObjIntFunction<Integer,Integer,Integer> functionThrowing = (Integer a1,Integer a2,int a3) -> {
