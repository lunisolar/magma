...
public class LBiObjIntFunctionAssertTest<T1,T2,R,X extends Throwable> {
    ...
    private LBiObjIntFunction<Integer ,Integer ,Integer > function = LBiObjIntFunction.l((a1,a2,a3) ->
            (Integer ) testValue
    );

    private LBiObjIntFunction<Integer ,Integer ,Integer > functionThrowing = LBiObjIntFunction.l((a1,a2,a3) -> {
