...
public class LBiObjIntFunctionAssertTest<T1,T2,R> {
    ...
    private LBiObjIntFunction<Integer,Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LBiObjIntFunction<Integer,Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertBiObjIntFunc(functionThrowing)
         .doesApply(100,100,100)
            .to( a -> a.isEqualTo(1));
    }
