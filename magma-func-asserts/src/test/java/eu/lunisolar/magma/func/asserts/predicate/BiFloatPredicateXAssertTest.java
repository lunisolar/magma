...
public class BiFloatPredicateXAssertTest<X extends ParseException> {
    ...
    private BiFloatPredicateX<X> function = BiFloatPredicateX.lX((f1,f2) -> {
            return testValue;
    });

    private BiFloatPredicateX<X> functionThrowing = BiFloatPredicateX.lX((f1,f2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((float)80,(float)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((float)80,(float)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((float)80,(float)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((float)80,(float)81).withException(a -> a
