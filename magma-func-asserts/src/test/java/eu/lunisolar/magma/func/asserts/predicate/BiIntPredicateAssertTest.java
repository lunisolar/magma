...
public class BiIntPredicateAssertTest<X extends ParseException> {
    ...
    private BiIntPredicate function = BiIntPredicate.l((i1,i2) -> {
            return testValue;
    });

    private BiIntPredicate functionThrowing = BiIntPredicate.l((i1,i2) -> {
