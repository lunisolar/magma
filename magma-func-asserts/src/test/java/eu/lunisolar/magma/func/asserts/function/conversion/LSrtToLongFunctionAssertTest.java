...
import eu.lunisolar.magma.func.function.conversion.LSrtToLongFunction;
...
public class LSrtToLongFunctionAssertTest {
    ...
    private LSrtToLongFunction function = a ->
            testValue;


    private LSrtToLongFunction functionThrowing = a -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertSrtToLongFunc(function)
         .doesApplyAsLong((short)100)
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertSrtToLongFunc(functionThrowing)
         .doesApplyAsLong((short)100)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertSrtToLongFunc(functionThrowing)
         .doesApplyAsLong((short)100).withException(a -> a
