...
public class FloatFunctionAssertTest<R,X extends ParseException> {
    ...
    private FloatFunction<Integer > function = FloatFunction.l((f) -> {
            return (Integer ) testValue;
    });

    private FloatFunction<Integer > functionThrowing = FloatFunction.l((f) -> {
