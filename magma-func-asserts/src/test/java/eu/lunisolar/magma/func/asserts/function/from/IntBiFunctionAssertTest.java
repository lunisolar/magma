...
public class IntBiFunctionAssertTest<R,X extends ParseException> {
    ...
    private IntBiFunction<Integer > function = IntBiFunction.l((i1,i2) -> {
            return (Integer ) testValue;
    });

    private IntBiFunction<Integer > functionThrowing = IntBiFunction.l((i1,i2) -> {
