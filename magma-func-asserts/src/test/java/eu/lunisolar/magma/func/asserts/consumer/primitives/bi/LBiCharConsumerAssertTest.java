...
public class LBiCharConsumerAssertTest<X extends ParseException> {
    ...
    private LBiCharConsumer function = (char a1,char a2) ->
            externalEffect.set(testValue);


    private LBiCharConsumer functionThrowing = (char a1,char a2) -> {
