...
public class BiDoublePredicateXAssertTest<X extends ParseException> {
    ...
    private BiDoublePredicateX<X> function = BiDoublePredicateX.lX((d1,d2) -> {
            return testValue;
    });

    private BiDoublePredicateX<X> functionThrowing = BiDoublePredicateX.lX((d1,d2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((double)80,(double)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((double)80,(double)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((double)80,(double)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((double)80,(double)81).withException(a -> a
