...
public class ObjBytePredicateXAssertTest<T,X extends ParseException> {
    ...
    private ObjBytePredicateX<Integer ,X> function = ObjBytePredicateX.lX((t, b) -> {
            return testValue;
    });

    private ObjBytePredicateX<Integer ,X> functionThrowing = ObjBytePredicateX.lX((t, b) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(byte)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(byte)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(byte)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(byte)81).withException(a -> a
