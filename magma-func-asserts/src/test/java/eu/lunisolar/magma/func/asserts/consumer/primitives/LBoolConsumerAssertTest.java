...
import eu.lunisolar.magma.func.consumer.primitives.LBoolConsumer;
...
public class LBoolConsumerAssertTest {
    ...
    private LBoolConsumer function = a ->
            externalEffect.set(testValue);


    private LBoolConsumer functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertBoolCons(functionThrowing)
         .doesAccept(true)
