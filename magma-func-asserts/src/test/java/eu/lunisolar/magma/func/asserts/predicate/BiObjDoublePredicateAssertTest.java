...
public class BiObjDoublePredicateAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjDoublePredicate<Integer ,Integer > function = BiObjDoublePredicate.l((t1,t2, d) -> {
            return testValue;
    });

    private BiObjDoublePredicate<Integer ,Integer > functionThrowing = BiObjDoublePredicate.l((t1,t2, d) -> {
