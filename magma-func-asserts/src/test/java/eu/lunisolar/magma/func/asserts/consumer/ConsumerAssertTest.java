...
public class ConsumerAssertTest<T,X extends ParseException> {
    ...
    private Consumer<Integer > function = Consumer.l((t) -> {
            externalEffect.set(testValue);
    });

    private Consumer<Integer > functionThrowing = Consumer.l((t) -> {
