...
public class ByteUnaryOperatorXAssertTest<X extends ParseException> {
    ...
    private ByteUnaryOperatorX<X> function = ByteUnaryOperatorX.lX((b) -> {
            return testValue;
    });

    private ByteUnaryOperatorX<X> functionThrowing = ByteUnaryOperatorX.lX((b) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsByte((byte)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsByte((byte)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsByte((byte)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsByte((byte)80).withException(a -> a
