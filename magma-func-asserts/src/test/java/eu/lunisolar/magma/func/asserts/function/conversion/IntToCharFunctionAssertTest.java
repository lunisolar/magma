...
public class IntToCharFunctionAssertTest<X extends ParseException> {
    ...
    private IntToCharFunction function = IntToCharFunction.l((i) -> {
            return testValue;
    });

    private IntToCharFunction functionThrowing = IntToCharFunction.l((i) -> {
