...
public class DoubleConsumerAssertTest<X extends Throwable> {
    ...
    private java.util.function.DoubleConsumer function = (a1 ->
            externalEffect.set(testValue)
    );

    private java.util.function.DoubleConsumer functionThrowing = (a1 -> {
