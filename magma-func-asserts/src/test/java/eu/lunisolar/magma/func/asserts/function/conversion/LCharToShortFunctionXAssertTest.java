...
import eu.lunisolar.magma.func.function.conversion.LCharToShortFunctionX;
...
public class LCharToShortFunctionXAssertTest<X extends ParseException> {
    ...
    private LCharToShortFunctionX<X> function = a1 ->
            testValue;


    private LCharToShortFunctionX<X> functionThrowing = a1 -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort('\u0100').withException(a -> a
