...
public class LCharToShortFunctionXAssertTest<X extends Throwable> {
    ...
    private LCharToShortFunctionX<X> function = LCharToShortFunctionX.lX(a1 ->
            testValue
    );

    private LCharToShortFunctionX<X> functionThrowing = LCharToShortFunctionX.lX(a1 -> {
