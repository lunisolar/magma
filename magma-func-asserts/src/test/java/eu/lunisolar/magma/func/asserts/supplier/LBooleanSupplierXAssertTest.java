...
public class LBooleanSupplierXAssertTest<X extends ParseException> {
    ...
    private LBooleanSupplierX<X> function = LBooleanSupplierX.lX(() -> {
            return testValue;
    });

    private LBooleanSupplierX<X> functionThrowing = LBooleanSupplierX.lX(() -> {
