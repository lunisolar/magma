...
public class LObjBytePredicateAssertTest<T,X extends Throwable> {
    ...
    private LObjBytePredicate<Integer > function = LObjBytePredicate.l((a1,a2) ->
            testValue
    );

    private LObjBytePredicate<Integer > functionThrowing = LObjBytePredicate.l((a1,a2) -> {
