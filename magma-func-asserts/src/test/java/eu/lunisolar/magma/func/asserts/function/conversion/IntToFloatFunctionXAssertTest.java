...
public class IntToFloatFunctionXAssertTest<X extends ParseException> {
    ...
    private IntToFloatFunctionX<X> function = IntToFloatFunctionX.lX((i) -> {
            return testValue;
    });

    private IntToFloatFunctionX<X> functionThrowing = IntToFloatFunctionX.lX((i) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsFloat((int)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsFloat((int)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsFloat((int)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsFloat((int)80).withException(a -> a
