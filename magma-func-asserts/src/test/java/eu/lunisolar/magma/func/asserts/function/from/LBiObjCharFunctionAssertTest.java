...
public class LBiObjCharFunctionAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private LBiObjCharFunction<Integer,Integer,Integer> function = (Integer a1,Integer a2,char a3) ->
            testValue;


    private LBiObjCharFunction<Integer,Integer,Integer> functionThrowing = (Integer a1,Integer a2,char a3) -> {
