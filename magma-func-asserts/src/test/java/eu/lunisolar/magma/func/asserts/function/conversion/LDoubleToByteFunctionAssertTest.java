...
import eu.lunisolar.magma.func.function.conversion.LDoubleToByteFunction;
...
public class LDoubleToByteFunctionAssertTest<X extends ParseException> {
    ...
    private LDoubleToByteFunction function = a1 ->
            testValue;


    private LDoubleToByteFunction functionThrowing = a1 -> {
