...
public class LDoubleToByteFunctionAssertTest<X extends Throwable> {
    ...
    private LDoubleToByteFunction function = LDoubleToByteFunction.l(a1 ->
            testValue
    );

    private LDoubleToByteFunction functionThrowing = LDoubleToByteFunction.l(a1 -> {
