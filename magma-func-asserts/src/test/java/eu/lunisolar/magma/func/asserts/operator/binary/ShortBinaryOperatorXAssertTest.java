...
public class ShortBinaryOperatorXAssertTest<X extends ParseException> {
    ...
    private ShortBinaryOperatorX<X> function = ShortBinaryOperatorX.lX((s1,s2) -> {
            return testValue;
    });

    private ShortBinaryOperatorX<X> functionThrowing = ShortBinaryOperatorX.lX((s1,s2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsShort((short)80,(short)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsShort((short)80,(short)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort((short)80,(short)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort((short)80,(short)81).withException(a -> a
