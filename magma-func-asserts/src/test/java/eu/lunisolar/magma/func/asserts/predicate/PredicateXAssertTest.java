...
public class PredicateXAssertTest<T,X extends ParseException> {
    ...
    private PredicateX<Integer ,X> function = PredicateX.lX((t) -> {
            return testValue;
    });

    private PredicateX<Integer ,X> functionThrowing = PredicateX.lX((t) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80)).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80)).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80)).to( a -> a.isEqualTo(1));
