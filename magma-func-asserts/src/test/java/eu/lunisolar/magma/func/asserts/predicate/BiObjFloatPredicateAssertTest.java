...
public class BiObjFloatPredicateAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjFloatPredicate<Integer ,Integer > function = BiObjFloatPredicate.l((t1,t2, f) -> {
            return testValue;
    });

    private BiObjFloatPredicate<Integer ,Integer > functionThrowing = BiObjFloatPredicate.l((t1,t2, f) -> {
