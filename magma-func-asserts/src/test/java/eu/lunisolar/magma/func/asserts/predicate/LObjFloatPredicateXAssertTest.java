...
public class LObjFloatPredicateXAssertTest<T,X extends Throwable> {
    ...
    private LObjFloatPredicateX<Integer ,X> function = LObjFloatPredicateX.lX((a1,a2) ->
            testValue
    );

    private LObjFloatPredicateX<Integer ,X> functionThrowing = LObjFloatPredicateX.lX((a1,a2) -> {
