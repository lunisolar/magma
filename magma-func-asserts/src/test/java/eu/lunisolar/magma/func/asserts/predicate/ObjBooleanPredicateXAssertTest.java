...
public class ObjBooleanPredicateXAssertTest<T,X extends ParseException> {
    ...
    private ObjBooleanPredicateX<Integer ,X> function = ObjBooleanPredicateX.lX((t, b) -> {
            return testValue;
    });

    private ObjBooleanPredicateX<Integer ,X> functionThrowing = ObjBooleanPredicateX.lX((t, b) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),true).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),true).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),true).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),true).withException(a -> a
