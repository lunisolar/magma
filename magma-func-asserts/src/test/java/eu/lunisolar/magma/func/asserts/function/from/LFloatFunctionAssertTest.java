...
public class LFloatFunctionAssertTest<R,X extends Throwable> {
    ...
    private LFloatFunction<Integer > function = LFloatFunction.l(a1 ->
            (Integer ) testValue
    );

    private LFloatFunction<Integer > functionThrowing = LFloatFunction.l(a1 -> {
