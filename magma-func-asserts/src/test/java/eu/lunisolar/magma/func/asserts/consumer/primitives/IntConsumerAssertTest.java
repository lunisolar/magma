...
public class IntConsumerAssertTest<X extends ParseException> {
    ...
    private IntConsumer function = IntConsumer.l((i) -> {
            externalEffect.set(testValue);
    });

    private IntConsumer functionThrowing = IntConsumer.l((i) -> {
