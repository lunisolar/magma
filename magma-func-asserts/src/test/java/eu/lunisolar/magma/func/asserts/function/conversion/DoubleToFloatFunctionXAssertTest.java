...
public class DoubleToFloatFunctionXAssertTest<X extends ParseException> {
    ...
    private DoubleToFloatFunctionX<X> function = DoubleToFloatFunctionX.lX((d) -> {
            return testValue;
    });

    private DoubleToFloatFunctionX<X> functionThrowing = DoubleToFloatFunctionX.lX((d) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsFloat((double)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsFloat((double)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsFloat((double)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsFloat((double)80).withException(a -> a
