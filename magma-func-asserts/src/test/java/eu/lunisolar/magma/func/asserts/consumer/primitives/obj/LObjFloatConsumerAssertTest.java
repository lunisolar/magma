...
import eu.lunisolar.magma.func.consumer.primitives.obj.LObjFloatConsumer;
...
public class LObjFloatConsumerAssertTest<T,X extends ParseException> {
    ...
    private LObjFloatConsumer<Integer> function = (Integer a1,float a2) ->
            externalEffect.set(testValue);


    private LObjFloatConsumer<Integer> functionThrowing = (Integer a1,float a2) -> {
