...
public class BiDoublePredicateAssertTest<X extends ParseException> {
    ...
    private BiDoublePredicate function = BiDoublePredicate.l((d1,d2) -> {
            return testValue;
    });

    private BiDoublePredicate functionThrowing = BiDoublePredicate.l((d1,d2) -> {
