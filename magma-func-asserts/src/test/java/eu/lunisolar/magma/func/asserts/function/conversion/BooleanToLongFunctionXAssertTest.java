...
public class BooleanToLongFunctionXAssertTest<X extends ParseException> {
    ...
    private BooleanToLongFunctionX<X> function = BooleanToLongFunctionX.lX((b) -> {
            return testValue;
    });

    private BooleanToLongFunctionX<X> functionThrowing = BooleanToLongFunctionX.lX((b) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsLong(true).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsLong(true).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsLong(true).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsLong(true).withException(a -> a
