...
import eu.lunisolar.magma.func.operator.binary.LFloatBinaryOperatorX;
...
public class LFloatBinaryOperatorXAssertTest<X extends ParseException> {
    ...
    private LFloatBinaryOperatorX<X> function = (float a1,float a2) ->
            testValue;


    private LFloatBinaryOperatorX<X> functionThrowing = (float a1,float a2) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsFloat(100f,100f).withException(a -> a
