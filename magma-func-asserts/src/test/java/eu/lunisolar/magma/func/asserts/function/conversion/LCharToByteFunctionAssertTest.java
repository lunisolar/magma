...
public class LCharToByteFunctionAssertTest<X extends Throwable> {
    ...
    private LCharToByteFunction function = LCharToByteFunction.l(a1 ->
            testValue
    );

    private LCharToByteFunction functionThrowing = LCharToByteFunction.l(a1 -> {
