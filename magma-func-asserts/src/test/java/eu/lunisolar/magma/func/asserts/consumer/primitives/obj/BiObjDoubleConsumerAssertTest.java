...
public class BiObjDoubleConsumerAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjDoubleConsumer<Integer ,Integer > function = BiObjDoubleConsumer.l((t1,t2, d) -> {
            externalEffect.set(testValue);
    });

    private BiObjDoubleConsumer<Integer ,Integer > functionThrowing = BiObjDoubleConsumer.l((t1,t2, d) -> {
