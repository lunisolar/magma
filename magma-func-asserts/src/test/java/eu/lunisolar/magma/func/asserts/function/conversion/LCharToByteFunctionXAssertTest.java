...
public class LCharToByteFunctionXAssertTest<X extends Throwable> {
    ...
    private LCharToByteFunctionX<X> function = LCharToByteFunctionX.lX(a1 ->
            testValue
    );

    private LCharToByteFunctionX<X> functionThrowing = LCharToByteFunctionX.lX(a1 -> {
