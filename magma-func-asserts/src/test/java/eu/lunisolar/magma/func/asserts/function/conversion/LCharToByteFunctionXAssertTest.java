...
import eu.lunisolar.magma.func.function.conversion.LCharToByteFunctionX;
...
public class LCharToByteFunctionXAssertTest<X extends ParseException> {
    ...
    private LCharToByteFunctionX<X> function = a1 ->
            testValue;


    private LCharToByteFunctionX<X> functionThrowing = a1 -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsByte('\u0100').withException(a -> a
