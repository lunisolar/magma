...
public class BiObjIntPredicateAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjIntPredicate<Integer ,Integer > function = BiObjIntPredicate.l((t1,t2, i) -> {
            return testValue;
    });

    private BiObjIntPredicate<Integer ,Integer > functionThrowing = BiObjIntPredicate.l((t1,t2, i) -> {
