...
public class StdBooleanSupplierAssertTest<X extends ParseException> {
    ...
    private java.util.function.BooleanSupplier function = (() -> {
            return testValue;
    });

    private java.util.function.BooleanSupplier functionThrowing = (() -> {
