...
public class LBiObjBoolConsumerAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjBoolConsumer<Integer,Integer> function = (Integer a1,Integer a2,boolean a3) ->
            externalEffect.set(testValue);


    private LBiObjBoolConsumer<Integer,Integer> functionThrowing = (Integer a1,Integer a2,boolean a3) -> {
