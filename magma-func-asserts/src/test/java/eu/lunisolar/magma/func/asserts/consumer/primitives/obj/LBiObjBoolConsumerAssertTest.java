...
public class LBiObjBoolConsumerAssertTest<T1,T2> {
    ...
    private LBiObjBoolConsumer<Integer,Integer> function = (a1,a2,a3) ->
            externalEffect.set(testValue);


    private LBiObjBoolConsumer<Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertBiObjBoolCons(functionThrowing)
         .doesAccept(100,100,true)
