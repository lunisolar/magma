...
import eu.lunisolar.magma.func.function.conversion.LLongToIntFunctionX;
...
public class LLongToIntFunctionXAssertTest<X extends ParseException> {
    ...
    private LLongToIntFunctionX<X> function = a1 ->
            testValue;


    private LLongToIntFunctionX<X> functionThrowing = a1 -> {
