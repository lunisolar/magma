...
public class LLongToShortFunctionAssertTest<X extends Throwable> {
    ...
    private LLongToShortFunction function = LLongToShortFunction.l(a1 ->
            testValue
    );

    private LLongToShortFunction functionThrowing = LLongToShortFunction.l(a1 -> {
