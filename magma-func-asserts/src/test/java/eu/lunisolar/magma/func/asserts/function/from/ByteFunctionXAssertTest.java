...
public class ByteFunctionXAssertTest<R,X extends ParseException> {
    ...
    private ByteFunctionX<Integer ,X> function = ByteFunctionX.lX((b) -> {
            return (Integer ) testValue;
    });

    private ByteFunctionX<Integer ,X> functionThrowing = ByteFunctionX.lX((b) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((byte)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((byte)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((byte)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((byte)80).withException(a -> a
