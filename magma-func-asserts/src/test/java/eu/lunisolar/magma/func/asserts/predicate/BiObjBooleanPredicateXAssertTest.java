...
public class BiObjBooleanPredicateXAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjBooleanPredicateX<Integer ,Integer ,X> function = BiObjBooleanPredicateX.lX((t1,t2, b) -> {
            return testValue;
    });

    private BiObjBooleanPredicateX<Integer ,Integer ,X> functionThrowing = BiObjBooleanPredicateX.lX((t1,t2, b) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),true).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),true).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),true).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),true).withException(a -> a
