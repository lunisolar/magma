...
public class BiObjFloatConsumerAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjFloatConsumer<Integer ,Integer > function = BiObjFloatConsumer.l((t1,t2, f) -> {
            externalEffect.set(testValue);
    });

    private BiObjFloatConsumer<Integer ,Integer > functionThrowing = BiObjFloatConsumer.l((t1,t2, f) -> {
