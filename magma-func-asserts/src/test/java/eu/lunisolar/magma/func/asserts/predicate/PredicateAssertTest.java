...
public class PredicateAssertTest<T,X extends ParseException> {
    ...
    private Predicate<Integer > function = Predicate.l((t) -> {
            return testValue;
    });

    private Predicate<Integer > functionThrowing = Predicate.l((t) -> {
