...
public class LTernaryOperatorAssertTest<T,X extends ParseException> {
    ...
    private LTernaryOperator<Integer> function = (Integer a1,Integer a2,Integer a3) ->
            testValue;


    private LTernaryOperator<Integer> functionThrowing = (Integer a1,Integer a2,Integer a3) -> {
