...
public class StdLongToIntFunctionAssertTest<X extends ParseException> {
    ...
    private java.util.function.LongToIntFunction function = ((l) -> {
            return testValue;
    });

    private java.util.function.LongToIntFunction functionThrowing = ((l) -> {
