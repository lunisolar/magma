...
public class BooleanBinaryOperatorAssertTest<X extends ParseException> {
    ...
    private BooleanBinaryOperator function = BooleanBinaryOperator.l((b1,b2) -> {
            return testValue;
    });

    private BooleanBinaryOperator functionThrowing = BooleanBinaryOperator.l((b1,b2) -> {
