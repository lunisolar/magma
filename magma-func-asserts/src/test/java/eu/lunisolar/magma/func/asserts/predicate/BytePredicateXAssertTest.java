...
public class BytePredicateXAssertTest<X extends ParseException> {
    ...
    private BytePredicateX<X> function = BytePredicateX.lX((b) -> {
            return testValue;
    });

    private BytePredicateX<X> functionThrowing = BytePredicateX.lX((b) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((byte)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((byte)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((byte)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((byte)80).withException(a -> a
