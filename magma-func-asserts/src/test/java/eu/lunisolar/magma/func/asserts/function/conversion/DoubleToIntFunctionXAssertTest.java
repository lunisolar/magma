...
public class DoubleToIntFunctionXAssertTest<X extends ParseException> {
    ...
    private DoubleToIntFunctionX<X> function = DoubleToIntFunctionX.lX((d) -> {
            return testValue;
    });

    private DoubleToIntFunctionX<X> functionThrowing = DoubleToIntFunctionX.lX((d) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsInt((double)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsInt((double)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsInt((double)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsInt((double)80).withException(a -> a
