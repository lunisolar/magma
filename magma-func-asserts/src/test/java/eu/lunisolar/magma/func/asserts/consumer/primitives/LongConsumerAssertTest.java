...
public class LongConsumerAssertTest<X extends ParseException> {
    ...
    private LongConsumer function = LongConsumer.l((l) -> {
            externalEffect.set(testValue);
    });

    private LongConsumer functionThrowing = LongConsumer.l((l) -> {
