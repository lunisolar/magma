...
import eu.lunisolar.magma.func.function.conversion.LShortToLongFunctionX;
...
public class LShortToLongFunctionXAssertTest<X extends ParseException> {
    ...
    private LShortToLongFunctionX<X> function = a1 ->
            testValue;


    private LShortToLongFunctionX<X> functionThrowing = a1 -> {
