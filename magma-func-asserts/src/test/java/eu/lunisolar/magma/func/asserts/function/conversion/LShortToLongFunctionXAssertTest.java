...
public class LShortToLongFunctionXAssertTest<X extends Throwable> {
    ...
    private LShortToLongFunctionX<X> function = LShortToLongFunctionX.lX(a1 ->
            testValue
    );

    private LShortToLongFunctionX<X> functionThrowing = LShortToLongFunctionX.lX(a1 -> {
