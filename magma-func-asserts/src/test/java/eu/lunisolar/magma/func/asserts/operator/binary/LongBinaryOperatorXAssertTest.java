...
public class LongBinaryOperatorXAssertTest<X extends ParseException> {
    ...
    private LongBinaryOperatorX<X> function = LongBinaryOperatorX.lX((l1,l2) -> {
            return testValue;
    });

    private LongBinaryOperatorX<X> functionThrowing = LongBinaryOperatorX.lX((l1,l2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsLong((long)80,(long)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsLong((long)80,(long)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsLong((long)80,(long)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsLong((long)80,(long)81).withException(a -> a
