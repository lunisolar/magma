...
public class LCharPredicateAssertTest<X extends Throwable> {
    ...
    private LCharPredicate function = LCharPredicate.l(a1 ->
            testValue
    );

    private LCharPredicate functionThrowing = LCharPredicate.l(a1 -> {
