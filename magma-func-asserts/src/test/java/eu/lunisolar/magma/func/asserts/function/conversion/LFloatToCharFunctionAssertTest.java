...
import eu.lunisolar.magma.func.function.conversion.LFloatToCharFunction;
...
public class LFloatToCharFunctionAssertTest<X extends ParseException> {
    ...
    private LFloatToCharFunction function = a1 ->
            testValue;


    private LFloatToCharFunction functionThrowing = a1 -> {
