...
public class LFloatToCharFunctionAssertTest<X extends Throwable> {
    ...
    private LFloatToCharFunction function = LFloatToCharFunction.l(a1 ->
            testValue
    );

    private LFloatToCharFunction functionThrowing = LFloatToCharFunction.l(a1 -> {
