...
public class FloatToIntFunctionXAssertTest<X extends ParseException> {
    ...
    private FloatToIntFunctionX<X> function = FloatToIntFunctionX.lX((f) -> {
            return testValue;
    });

    private FloatToIntFunctionX<X> functionThrowing = FloatToIntFunctionX.lX((f) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsInt((float)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsInt((float)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsInt((float)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsInt((float)80).withException(a -> a
