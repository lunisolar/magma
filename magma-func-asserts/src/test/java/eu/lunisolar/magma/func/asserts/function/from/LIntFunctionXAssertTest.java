...
public class LIntFunctionXAssertTest<R,X extends Throwable> {
    ...
    private LIntFunctionX<Integer ,X> function = LIntFunctionX.lX(a1 ->
            (Integer ) testValue
    );

    private LIntFunctionX<Integer ,X> functionThrowing = LIntFunctionX.lX(a1 -> {
