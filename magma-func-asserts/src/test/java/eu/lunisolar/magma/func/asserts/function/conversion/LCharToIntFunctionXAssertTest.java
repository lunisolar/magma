...
public class LCharToIntFunctionXAssertTest<X extends Throwable> {
    ...
    private LCharToIntFunctionX<X> function = LCharToIntFunctionX.lX(a1 ->
            testValue
    );

    private LCharToIntFunctionX<X> functionThrowing = LCharToIntFunctionX.lX(a1 -> {
