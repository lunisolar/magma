...
public class LongToShortFunctionXAssertTest<X extends ParseException> {
    ...
    private LongToShortFunctionX<X> function = LongToShortFunctionX.lX((l) -> {
            return testValue;
    });

    private LongToShortFunctionX<X> functionThrowing = LongToShortFunctionX.lX((l) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsShort((long)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsShort((long)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort((long)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort((long)80).withException(a -> a
