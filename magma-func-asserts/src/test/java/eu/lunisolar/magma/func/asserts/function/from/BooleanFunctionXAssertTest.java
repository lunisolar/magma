...
public class BooleanFunctionXAssertTest<R,X extends ParseException> {
    ...
    private BooleanFunctionX<Integer ,X> function = BooleanFunctionX.lX((b) -> {
            return (Integer ) testValue;
    });

    private BooleanFunctionX<Integer ,X> functionThrowing = BooleanFunctionX.lX((b) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply(true).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply(true).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply(true).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply(true).withException(a -> a
