...
public class BiBytePredicateXAssertTest<X extends ParseException> {
    ...
    private BiBytePredicateX<X> function = BiBytePredicateX.lX((b1,b2) -> {
            return testValue;
    });

    private BiBytePredicateX<X> functionThrowing = BiBytePredicateX.lX((b1,b2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((byte)80,(byte)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((byte)80,(byte)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((byte)80,(byte)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((byte)80,(byte)81).withException(a -> a
