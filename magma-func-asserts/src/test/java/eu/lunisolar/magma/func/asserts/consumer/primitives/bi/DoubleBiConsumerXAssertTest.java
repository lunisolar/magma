...
public class DoubleBiConsumerXAssertTest<X extends ParseException> {
    ...
    private DoubleBiConsumerX<X> function = DoubleBiConsumerX.lX((d1,d2) -> {
            externalEffect.set(testValue);
    });

    private DoubleBiConsumerX<X> functionThrowing = DoubleBiConsumerX.lX((d1,d2) -> {
