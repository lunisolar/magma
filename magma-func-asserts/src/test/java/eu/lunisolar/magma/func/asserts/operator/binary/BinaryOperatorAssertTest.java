...
public class BinaryOperatorAssertTest<T,X extends ParseException> {
    ...
    private BinaryOperator<Integer > function = BinaryOperator.l((t1,t2) -> {
            return (Integer ) testValue;
    });

    private BinaryOperator<Integer > functionThrowing = BinaryOperator.l((t1,t2) -> {
