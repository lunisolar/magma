...
public class ShortBiFunctionAssertTest<R,X extends ParseException> {
    ...
    private ShortBiFunction<Integer > function = ShortBiFunction.l((s1,s2) -> {
            return (Integer ) testValue;
    });

    private ShortBiFunction<Integer > functionThrowing = ShortBiFunction.l((s1,s2) -> {
