...
public class LIntToDoubleFunctionAssertTest<X extends Throwable> {
    ...
    private LIntToDoubleFunction function = LIntToDoubleFunction.l(a1 ->
            testValue
    );

    private LIntToDoubleFunction functionThrowing = LIntToDoubleFunction.l(a1 -> {
