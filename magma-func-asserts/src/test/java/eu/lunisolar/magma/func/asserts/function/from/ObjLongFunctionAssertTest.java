...
public class ObjLongFunctionAssertTest<T,R,X extends ParseException> {
    ...
    private ObjLongFunction<Integer ,Integer > function = ObjLongFunction.l((t, l) -> {
            return (Integer ) testValue;
    });

    private ObjLongFunction<Integer ,Integer > functionThrowing = ObjLongFunction.l((t, l) -> {
