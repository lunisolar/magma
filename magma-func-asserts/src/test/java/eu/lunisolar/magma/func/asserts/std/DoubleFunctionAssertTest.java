...
public class DoubleFunctionAssertTest<R,X extends Throwable> {
    ...
    private java.util.function.DoubleFunction<Integer > function = (a1 ->
            (Integer ) testValue
    );

    private java.util.function.DoubleFunction<Integer > functionThrowing = (a1 -> {
