...
public class IntBiConsumerXAssertTest<X extends ParseException> {
    ...
    private IntBiConsumerX<X> function = IntBiConsumerX.lX((i1,i2) -> {
            externalEffect.set(testValue);
    });

    private IntBiConsumerX<X> functionThrowing = IntBiConsumerX.lX((i1,i2) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept((int)80,(int)81).withException(a -> a
