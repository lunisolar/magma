...
public class LObjIntFunctionAssertTest<T,R,X extends Throwable> {
    ...
    private LObjIntFunction<Integer ,Integer > function = LObjIntFunction.l((a1,a2) ->
            (Integer ) testValue
    );

    private LObjIntFunction<Integer ,Integer > functionThrowing = LObjIntFunction.l((a1,a2) -> {
