...
public class LBiDblPredicateAssertTest {
    ...
    private LBiDblPredicate function = (a1,a2) ->
            testValue;


    private LBiDblPredicate functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertBiDblPred(functionThrowing)
         .doesTest(100d,100d)
            .to( a -> a.isEqualTo(1));
    }
