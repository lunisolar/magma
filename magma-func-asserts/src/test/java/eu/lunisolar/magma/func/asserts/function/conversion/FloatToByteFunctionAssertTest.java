...
public class FloatToByteFunctionAssertTest<X extends ParseException> {
    ...
    private FloatToByteFunction function = FloatToByteFunction.l((f) -> {
            return testValue;
    });

    private FloatToByteFunction functionThrowing = FloatToByteFunction.l((f) -> {
