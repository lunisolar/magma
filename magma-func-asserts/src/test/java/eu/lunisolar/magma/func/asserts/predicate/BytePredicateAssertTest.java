...
public class BytePredicateAssertTest<X extends ParseException> {
    ...
    private BytePredicate function = BytePredicate.l((b) -> {
            return testValue;
    });

    private BytePredicate functionThrowing = BytePredicate.l((b) -> {
