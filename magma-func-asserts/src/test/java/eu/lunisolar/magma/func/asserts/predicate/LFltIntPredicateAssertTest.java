...
public class LFltIntPredicateAssertTest {
    ...
    private LFltIntPredicate function = (a1,a2) ->
            testValue;


    private LFltIntPredicate functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertFltIntPred(functionThrowing)
         .doesTest(100f,100)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertFltIntPred(functionThrowing)
         .doesTest(100f,100).withException(a -> a
