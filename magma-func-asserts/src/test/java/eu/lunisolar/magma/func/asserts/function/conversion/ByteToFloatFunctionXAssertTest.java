...
public class ByteToFloatFunctionXAssertTest<X extends ParseException> {
    ...
    private ByteToFloatFunctionX<X> function = ByteToFloatFunctionX.lX((b) -> {
            return testValue;
    });

    private ByteToFloatFunctionX<X> functionThrowing = ByteToFloatFunctionX.lX((b) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsFloat((byte)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsFloat((byte)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsFloat((byte)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsFloat((byte)80).withException(a -> a
