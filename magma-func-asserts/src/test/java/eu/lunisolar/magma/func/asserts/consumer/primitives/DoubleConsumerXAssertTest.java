...
public class DoubleConsumerXAssertTest<X extends ParseException> {
    ...
    private DoubleConsumerX<X> function = DoubleConsumerX.lX((d) -> {
            externalEffect.set(testValue);
    });

    private DoubleConsumerX<X> functionThrowing = DoubleConsumerX.lX((d) -> {
