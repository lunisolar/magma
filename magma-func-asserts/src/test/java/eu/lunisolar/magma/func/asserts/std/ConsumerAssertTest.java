...
public class ConsumerAssertTest<T,X extends Throwable> {
    ...
    private java.util.function.Consumer<Integer > function = (a1 ->
            externalEffect.set(testValue)
    );

    private java.util.function.Consumer<Integer > functionThrowing = (a1 -> {
