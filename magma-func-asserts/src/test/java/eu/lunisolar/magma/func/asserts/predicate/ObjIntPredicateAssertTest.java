...
public class ObjIntPredicateAssertTest<T,X extends ParseException> {
    ...
    private ObjIntPredicate<Integer > function = ObjIntPredicate.l((t, i) -> {
            return testValue;
    });

    private ObjIntPredicate<Integer > functionThrowing = ObjIntPredicate.l((t, i) -> {
