...
public class LBiObjShortPredicateAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjShortPredicate<Integer ,Integer > function = LBiObjShortPredicate.l((a1,a2,a3) ->
            testValue
    );

    private LBiObjShortPredicate<Integer ,Integer > functionThrowing = LBiObjShortPredicate.l((a1,a2,a3) -> {
