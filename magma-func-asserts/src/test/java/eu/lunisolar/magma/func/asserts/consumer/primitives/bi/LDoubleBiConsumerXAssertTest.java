...
public class LDoubleBiConsumerXAssertTest<X extends ParseException> {
    ...
    private LDoubleBiConsumerX<X> function = LDoubleBiConsumerX.lX((d1,d2) -> {
            externalEffect.set(testValue);
    });

    private LDoubleBiConsumerX<X> functionThrowing = LDoubleBiConsumerX.lX((d1,d2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesAccept((double)80,(double)81)
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept((double)80,(double)81).withException(a -> a
