...
public class ShortBiConsumerAssertTest<X extends ParseException> {
    ...
    private ShortBiConsumer function = ShortBiConsumer.l((s1,s2) -> {
            externalEffect.set(testValue);
    });

    private ShortBiConsumer functionThrowing = ShortBiConsumer.l((s1,s2) -> {
