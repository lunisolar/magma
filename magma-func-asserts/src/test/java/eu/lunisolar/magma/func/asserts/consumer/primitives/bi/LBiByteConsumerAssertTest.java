...
public class LBiByteConsumerAssertTest<X extends Throwable> {
    ...
    private LBiByteConsumer function = LBiByteConsumer.l((a1,a2) ->
            externalEffect.set(testValue)
    );

    private LBiByteConsumer functionThrowing = LBiByteConsumer.l((a1,a2) -> {
