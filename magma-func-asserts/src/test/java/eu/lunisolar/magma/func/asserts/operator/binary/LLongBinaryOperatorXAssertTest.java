...
public class LLongBinaryOperatorXAssertTest<X extends Throwable> {
    ...
    private LLongBinaryOperatorX<X> function = LLongBinaryOperatorX.lX((a1,a2) ->
            testValue
    );

    private LLongBinaryOperatorX<X> functionThrowing = LLongBinaryOperatorX.lX((a1,a2) -> {
