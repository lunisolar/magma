...
import eu.lunisolar.magma.func.operator.binary.LLongBinaryOperatorX;
...
public class LLongBinaryOperatorXAssertTest<X extends ParseException> {
    ...
    private LLongBinaryOperatorX<X> function = (long a1,long a2) ->
            testValue;


    private LLongBinaryOperatorX<X> functionThrowing = (long a1,long a2) -> {
