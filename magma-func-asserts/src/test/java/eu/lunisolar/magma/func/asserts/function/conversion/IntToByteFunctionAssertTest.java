...
public class IntToByteFunctionAssertTest<X extends ParseException> {
    ...
    private IntToByteFunction function = IntToByteFunction.l((i) -> {
            return testValue;
    });

    private IntToByteFunction functionThrowing = IntToByteFunction.l((i) -> {
