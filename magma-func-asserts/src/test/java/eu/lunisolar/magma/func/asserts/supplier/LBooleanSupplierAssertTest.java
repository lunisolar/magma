...
public class LBooleanSupplierAssertTest<X extends ParseException> {
    ...
    private LBooleanSupplier function = LBooleanSupplier.l(() -> {
            return testValue;
    });

    private LBooleanSupplier functionThrowing = LBooleanSupplier.l(() -> {
