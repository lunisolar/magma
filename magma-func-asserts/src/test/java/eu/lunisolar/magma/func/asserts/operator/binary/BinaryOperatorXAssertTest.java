...
public class BinaryOperatorXAssertTest<T,X extends ParseException> {
    ...
    private BinaryOperatorX<Integer ,X> function = BinaryOperatorX.lX((t1,t2) -> {
            return (Integer ) testValue;
    });

    private BinaryOperatorX<Integer ,X> functionThrowing = BinaryOperatorX.lX((t1,t2) -> {
