...
import eu.lunisolar.magma.func.predicate.LBiFloatPredicateX;
...
public class LBiFloatPredicateXAssertTest<X extends ParseException> {
    ...
    private LBiFloatPredicateX<X> function = (float a1,float a2) ->
            testValue;


    private LBiFloatPredicateX<X> functionThrowing = (float a1,float a2) -> {
