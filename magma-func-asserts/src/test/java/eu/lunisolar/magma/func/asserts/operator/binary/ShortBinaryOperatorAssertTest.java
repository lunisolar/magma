...
public class ShortBinaryOperatorAssertTest<X extends ParseException> {
    ...
    private ShortBinaryOperator function = ShortBinaryOperator.l((s1,s2) -> {
            return testValue;
    });

    private ShortBinaryOperator functionThrowing = ShortBinaryOperator.l((s1,s2) -> {
