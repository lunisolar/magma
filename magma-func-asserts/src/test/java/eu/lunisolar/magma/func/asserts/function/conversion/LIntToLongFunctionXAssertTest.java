...
import eu.lunisolar.magma.func.function.conversion.LIntToLongFunctionX;
...
public class LIntToLongFunctionXAssertTest<X extends ParseException> {
    ...
    private LIntToLongFunctionX<X> function = a1 ->
            testValue;


    private LIntToLongFunctionX<X> functionThrowing = a1 -> {
