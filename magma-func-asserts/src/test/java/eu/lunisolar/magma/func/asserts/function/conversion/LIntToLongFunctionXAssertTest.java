...
public class LIntToLongFunctionXAssertTest<X extends Throwable> {
    ...
    private LIntToLongFunctionX<X> function = LIntToLongFunctionX.lX(a1 ->
            testValue
    );

    private LIntToLongFunctionX<X> functionThrowing = LIntToLongFunctionX.lX(a1 -> {
