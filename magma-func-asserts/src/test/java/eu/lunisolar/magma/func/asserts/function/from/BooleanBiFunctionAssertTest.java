...
public class BooleanBiFunctionAssertTest<R,X extends ParseException> {
    ...
    private BooleanBiFunction<Integer > function = BooleanBiFunction.l((b1,b2) -> {
            return (Integer ) testValue;
    });

    private BooleanBiFunction<Integer > functionThrowing = BooleanBiFunction.l((b1,b2) -> {
