...
public class LByteToFloatFunctionAssertTest<X extends Throwable> {
    ...
    private LByteToFloatFunction function = LByteToFloatFunction.l(a1 ->
            testValue
    );

    private LByteToFloatFunction functionThrowing = LByteToFloatFunction.l(a1 -> {
