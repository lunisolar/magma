...
import eu.lunisolar.magma.func.function.conversion.LByteToFloatFunction;
...
public class LByteToFloatFunctionAssertTest<X extends ParseException> {
    ...
    private LByteToFloatFunction function = a1 ->
            testValue;


    private LByteToFloatFunction functionThrowing = a1 -> {
