...
public class TernaryOperatorXAssertTest<T,X extends ParseException> {

    private T testValue = (T)Integer.valueOf(100);


    @SuppressWarnings("unchecked") public static final FunctionalAssertions<ObjectAssert> A = new FunctionalAssertions() {
    };

    private TernaryOperatorX<Integer ,X> function = TernaryOperatorX.lX((t1,t2,t3) -> {
            return (Integer ) testValue;
    });

    private TernaryOperatorX<Integer ,X> functionThrowing = TernaryOperatorX.lX((t1,t2,t3) -> {
