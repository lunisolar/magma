...
public class ObjDoubleConsumerXAssertTest<T,X extends ParseException> {
    ...
    private ObjDoubleConsumerX<Integer ,X> function = ObjDoubleConsumerX.lX((t, d) -> {
            externalEffect.set(testValue);
    });

    private ObjDoubleConsumerX<Integer ,X> functionThrowing = ObjDoubleConsumerX.lX((t, d) -> {
