...
public class LBiObjFloatFunctionAssertTest<T1,T2,R,X extends Throwable> {
    ...
    private LBiObjFloatFunction<Integer ,Integer ,Integer > function = LBiObjFloatFunction.l((a1,a2,a3) ->
            (Integer ) testValue
    );

    private LBiObjFloatFunction<Integer ,Integer ,Integer > functionThrowing = LBiObjFloatFunction.l((a1,a2,a3) -> {
