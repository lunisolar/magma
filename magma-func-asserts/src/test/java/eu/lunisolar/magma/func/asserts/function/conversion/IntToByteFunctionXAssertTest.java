...
public class IntToByteFunctionXAssertTest<X extends ParseException> {
    ...
    private IntToByteFunctionX<X> function = IntToByteFunctionX.lX((i) -> {
            return testValue;
    });

    private IntToByteFunctionX<X> functionThrowing = IntToByteFunctionX.lX((i) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsByte((int)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsByte((int)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsByte((int)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsByte((int)80).withException(a -> a
