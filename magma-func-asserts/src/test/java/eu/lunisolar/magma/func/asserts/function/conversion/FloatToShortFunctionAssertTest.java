...
public class FloatToShortFunctionAssertTest<X extends ParseException> {
    ...
    private FloatToShortFunction function = FloatToShortFunction.l((f) -> {
            return testValue;
    });

    private FloatToShortFunction functionThrowing = FloatToShortFunction.l((f) -> {
