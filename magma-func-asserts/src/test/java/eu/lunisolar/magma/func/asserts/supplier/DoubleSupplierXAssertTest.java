...
public class DoubleSupplierXAssertTest<X extends ParseException> {
    ...
    private DoubleSupplierX<X> function = DoubleSupplierX.lX(() -> {
            return testValue;
    });

    private DoubleSupplierX<X> functionThrowing = DoubleSupplierX.lX(() -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesGetAsDouble().to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesGetAsDouble().to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesGetAsDouble().to( a -> a.isEqualTo(1));
