...
import eu.lunisolar.magma.func.function.from.LObjLongFunctionX;
...
public class LObjLongFunctionXAssertTest<T,R,X extends ParseException> {
    ...
    private LObjLongFunctionX<Integer,Integer,X> function = (Integer a1,long a2) ->
            testValue;


    private LObjLongFunctionX<Integer,Integer,X> functionThrowing = (Integer a1,long a2) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply(100,100L).withException(a -> a
