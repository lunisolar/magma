...
public class LObjLongFunctionXAssertTest<T,R,X extends Throwable> {
    ...
    private LObjLongFunctionX<Integer ,Integer ,X> function = LObjLongFunctionX.lX((a1,a2) ->
            (Integer ) testValue
    );

    private LObjLongFunctionX<Integer ,Integer ,X> functionThrowing = LObjLongFunctionX.lX((a1,a2) -> {
