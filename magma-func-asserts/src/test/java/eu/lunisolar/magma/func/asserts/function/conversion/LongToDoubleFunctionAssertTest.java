...
public class LongToDoubleFunctionAssertTest<X extends ParseException> {
    ...
    private LongToDoubleFunction function = LongToDoubleFunction.l((l) -> {
            return testValue;
    });

    private LongToDoubleFunction functionThrowing = LongToDoubleFunction.l((l) -> {
