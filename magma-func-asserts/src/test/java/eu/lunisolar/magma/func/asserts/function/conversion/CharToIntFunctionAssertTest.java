...
public class CharToIntFunctionAssertTest<X extends ParseException> {
    ...
    private CharToIntFunction function = CharToIntFunction.l((c) -> {
            return testValue;
    });

    private CharToIntFunction functionThrowing = CharToIntFunction.l((c) -> {
