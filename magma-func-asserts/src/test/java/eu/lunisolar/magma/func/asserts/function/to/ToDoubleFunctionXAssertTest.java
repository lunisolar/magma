...
public class ToDoubleFunctionXAssertTest<T,X extends ParseException> {
    ...
    private ToDoubleFunctionX<Integer ,X> function = ToDoubleFunctionX.lX((t) -> {
            return testValue;
    });

    private ToDoubleFunctionX<Integer ,X> functionThrowing = ToDoubleFunctionX.lX((t) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsDouble((Integer )Integer.valueOf(80)).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsDouble((Integer )Integer.valueOf(80)).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsDouble((Integer )Integer.valueOf(80)).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsDouble((Integer )Integer.valueOf(80)).withException(a -> a
