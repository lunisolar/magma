...
public class ToByteFunctionAssertTest<T,X extends ParseException> {
    ...
    private ToByteFunction<Integer > function = ToByteFunction.l((t) -> {
            return testValue;
    });

    private ToByteFunction<Integer > functionThrowing = ToByteFunction.l((t) -> {
