...
public class StdIntSupplierAssertTest<X extends ParseException> {
    ...
    private java.util.function.IntSupplier function = (() -> {
            return testValue;
    });

    private java.util.function.IntSupplier functionThrowing = (() -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesGetAsInt().to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesGetAsInt().to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesGetAsInt().to( a -> a.isEqualTo(1));
