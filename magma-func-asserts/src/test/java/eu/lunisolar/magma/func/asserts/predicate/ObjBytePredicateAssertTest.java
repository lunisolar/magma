...
public class ObjBytePredicateAssertTest<T,X extends ParseException> {
    ...
    private ObjBytePredicate<Integer > function = ObjBytePredicate.l((t, b) -> {
            return testValue;
    });

    private ObjBytePredicate<Integer > functionThrowing = ObjBytePredicate.l((t, b) -> {
