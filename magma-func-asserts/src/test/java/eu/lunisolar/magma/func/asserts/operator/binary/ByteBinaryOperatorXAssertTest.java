...
public class ByteBinaryOperatorXAssertTest<X extends ParseException> {
    ...
    private ByteBinaryOperatorX<X> function = ByteBinaryOperatorX.lX((b1,b2) -> {
            return testValue;
    });

    private ByteBinaryOperatorX<X> functionThrowing = ByteBinaryOperatorX.lX((b1,b2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsByte((byte)80,(byte)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsByte((byte)80,(byte)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsByte((byte)80,(byte)81).to( a -> a.isEqualTo(1));
