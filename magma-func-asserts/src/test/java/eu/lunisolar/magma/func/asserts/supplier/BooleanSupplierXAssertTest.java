...
public class BooleanSupplierXAssertTest<X extends ParseException> {
    ...
    private BooleanSupplierX<X> function = BooleanSupplierX.lX(() -> {
            return testValue;
    });

    private BooleanSupplierX<X> functionThrowing = BooleanSupplierX.lX(() -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesGetAsBoolean().to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesGetAsBoolean().to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesGetAsBoolean().to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesGetAsBoolean().withException(a -> a
