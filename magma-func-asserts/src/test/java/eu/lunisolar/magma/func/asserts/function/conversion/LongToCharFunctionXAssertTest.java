...
public class LongToCharFunctionXAssertTest<X extends ParseException> {
    ...
    private LongToCharFunctionX<X> function = LongToCharFunctionX.lX((l) -> {
            return testValue;
    });

    private LongToCharFunctionX<X> functionThrowing = LongToCharFunctionX.lX((l) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsChar((long)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsChar((long)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsChar((long)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsChar((long)80).withException(a -> a
