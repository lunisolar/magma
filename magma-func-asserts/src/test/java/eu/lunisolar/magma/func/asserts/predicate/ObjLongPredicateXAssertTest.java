...
public class ObjLongPredicateXAssertTest<T,X extends ParseException> {
    ...
    private ObjLongPredicateX<Integer ,X> function = ObjLongPredicateX.lX((t, l) -> {
            return testValue;
    });

    private ObjLongPredicateX<Integer ,X> functionThrowing = ObjLongPredicateX.lX((t, l) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(long)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(long)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(long)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(long)81).withException(a -> a
