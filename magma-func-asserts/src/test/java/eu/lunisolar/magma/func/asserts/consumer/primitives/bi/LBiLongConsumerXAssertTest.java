...
import eu.lunisolar.magma.func.consumer.primitives.bi.LBiLongConsumerX;
...
public class LBiLongConsumerXAssertTest<X extends ParseException> {
    ...
    private LBiLongConsumerX<X> function = (long a1,long a2) ->
            externalEffect.set(testValue);


    private LBiLongConsumerX<X> functionThrowing = (long a1,long a2) -> {
