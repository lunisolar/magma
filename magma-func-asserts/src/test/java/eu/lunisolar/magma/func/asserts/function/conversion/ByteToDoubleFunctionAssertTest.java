...
public class ByteToDoubleFunctionAssertTest<X extends ParseException> {
    ...
    private ByteToDoubleFunction function = ByteToDoubleFunction.l((b) -> {
            return testValue;
    });

    private ByteToDoubleFunction functionThrowing = ByteToDoubleFunction.l((b) -> {
