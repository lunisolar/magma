...
import eu.lunisolar.magma.func.consumer.primitives.LShortConsumerX;
...
public class LShortConsumerXAssertTest<X extends ParseException> {
    ...
    private LShortConsumerX<X> function = a1 ->
            externalEffect.set(testValue);


    private LShortConsumerX<X> functionThrowing = a1 -> {
