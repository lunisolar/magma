...
public class ToIntBiFunctionAssertTest<T1,T2,X extends ParseException> {
    ...
    private ToIntBiFunction<Integer ,Integer > function = ToIntBiFunction.l((t1,t2) -> {
            return testValue;
    });

    private ToIntBiFunction<Integer ,Integer > functionThrowing = ToIntBiFunction.l((t1,t2) -> {
