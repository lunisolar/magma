...
public class ObjDoublePredicateXAssertTest<T,X extends ParseException> {
    ...
    private ObjDoublePredicateX<Integer ,X> function = ObjDoublePredicateX.lX((t, d) -> {
            return testValue;
    });

    private ObjDoublePredicateX<Integer ,X> functionThrowing = ObjDoublePredicateX.lX((t, d) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(double)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(double)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(double)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(double)81).withException(a -> a
