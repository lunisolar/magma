...
public class ShortBiFunctionXAssertTest<R,X extends ParseException> {
    ...
    private ShortBiFunctionX<Integer ,X> function = ShortBiFunctionX.lX((s1,s2) -> {
            return (Integer ) testValue;
    });

    private ShortBiFunctionX<Integer ,X> functionThrowing = ShortBiFunctionX.lX((s1,s2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((short)80,(short)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((short)80,(short)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((short)80,(short)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((short)80,(short)81).withException(a -> a
