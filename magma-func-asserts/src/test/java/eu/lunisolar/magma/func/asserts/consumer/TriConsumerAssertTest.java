...
public class TriConsumerAssertTest<T1,T2,T3,X extends ParseException> {
    ...
    private TriConsumer<Integer ,Integer ,Integer > function = TriConsumer.l((t1,t2,t3) -> {
            externalEffect.set(testValue);
    });

    private TriConsumer<Integer ,Integer ,Integer > functionThrowing = TriConsumer.l((t1,t2,t3) -> {
