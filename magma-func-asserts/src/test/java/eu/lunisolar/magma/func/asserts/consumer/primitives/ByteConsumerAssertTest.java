...
public class ByteConsumerAssertTest<X extends ParseException> {
    ...
    private ByteConsumer function = ByteConsumer.l((b) -> {
            externalEffect.set(testValue);
    });

    private ByteConsumer functionThrowing = ByteConsumer.l((b) -> {
