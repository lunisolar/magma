...
public class ToShortFunctionAssertTest<T,X extends ParseException> {
    ...
    private ToShortFunction<Integer > function = ToShortFunction.l((t) -> {
            return testValue;
    });

    private ToShortFunction<Integer > functionThrowing = ToShortFunction.l((t) -> {
