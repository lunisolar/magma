...
public class BiObjFloatPredicateXAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjFloatPredicateX<Integer ,Integer ,X> function = BiObjFloatPredicateX.lX((t1,t2, f) -> {
            return testValue;
    });

    private BiObjFloatPredicateX<Integer ,Integer ,X> functionThrowing = BiObjFloatPredicateX.lX((t1,t2, f) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(float)82).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(float)82).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(float)82).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(float)82).withException(a -> a
