...
public class BooleanToCharFunctionXAssertTest<X extends ParseException> {
    ...
    private BooleanToCharFunctionX<X> function = BooleanToCharFunctionX.lX((b) -> {
            return testValue;
    });

    private BooleanToCharFunctionX<X> functionThrowing = BooleanToCharFunctionX.lX((b) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsChar(true).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsChar(true).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsChar(true).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsChar(true).withException(a -> a
