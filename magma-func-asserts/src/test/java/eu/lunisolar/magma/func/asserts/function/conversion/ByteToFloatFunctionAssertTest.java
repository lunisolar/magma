...
public class ByteToFloatFunctionAssertTest<X extends ParseException> {
    ...
    private ByteToFloatFunction function = ByteToFloatFunction.l((b) -> {
            return testValue;
    });

    private ByteToFloatFunction functionThrowing = ByteToFloatFunction.l((b) -> {
