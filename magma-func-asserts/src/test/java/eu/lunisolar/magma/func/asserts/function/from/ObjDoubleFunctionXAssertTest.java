...
public class ObjDoubleFunctionXAssertTest<T,R,X extends ParseException> {
    ...
    private ObjDoubleFunctionX<Integer ,Integer ,X> function = ObjDoubleFunctionX.lX((t, d) -> {
            return (Integer ) testValue;
    });

    private ObjDoubleFunctionX<Integer ,Integer ,X> functionThrowing = ObjDoubleFunctionX.lX((t, d) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(double)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(double)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(double)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(double)81).withException(a -> a
