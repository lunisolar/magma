...
public class ObjFloatPredicateAssertTest<T,X extends ParseException> {
    ...
    private ObjFloatPredicate<Integer > function = ObjFloatPredicate.l((t, f) -> {
            return testValue;
    });

    private ObjFloatPredicate<Integer > functionThrowing = ObjFloatPredicate.l((t, f) -> {
