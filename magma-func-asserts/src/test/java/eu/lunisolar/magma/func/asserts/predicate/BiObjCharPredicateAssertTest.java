...
public class BiObjCharPredicateAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjCharPredicate<Integer ,Integer > function = BiObjCharPredicate.l((t1,t2, c) -> {
            return testValue;
    });

    private BiObjCharPredicate<Integer ,Integer > functionThrowing = BiObjCharPredicate.l((t1,t2, c) -> {
