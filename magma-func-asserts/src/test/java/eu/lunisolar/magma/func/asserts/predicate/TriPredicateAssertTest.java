...
public class TriPredicateAssertTest<T1,T2,T3,X extends ParseException> {
    ...
    private TriPredicate<Integer ,Integer ,Integer > function = TriPredicate.l((t1,t2,t3) -> {
            return testValue;
    });

    private TriPredicate<Integer ,Integer ,Integer > functionThrowing = TriPredicate.l((t1,t2,t3) -> {
