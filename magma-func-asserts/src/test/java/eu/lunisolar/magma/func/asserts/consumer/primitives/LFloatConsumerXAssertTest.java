...
import eu.lunisolar.magma.func.consumer.primitives.LFloatConsumerX;
...
public class LFloatConsumerXAssertTest<X extends ParseException> {
    ...
    private LFloatConsumerX<X> function = a1 ->
            externalEffect.set(testValue);


    private LFloatConsumerX<X> functionThrowing = a1 -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept(100f).withException(a -> a
