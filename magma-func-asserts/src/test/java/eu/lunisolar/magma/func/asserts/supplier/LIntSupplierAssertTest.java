...
public class LIntSupplierAssertTest<X extends ParseException> {
    ...
    private LIntSupplier function = LIntSupplier.l(() -> {
            return testValue;
    });

    private LIntSupplier functionThrowing = LIntSupplier.l(() -> {
