...
public class LToByteBiFunctionAssertTest<T1,T2,X extends Throwable> {
    ...
    private LToByteBiFunction<Integer ,Integer > function = LToByteBiFunction.l((a1,a2) ->
            testValue
    );

    private LToByteBiFunction<Integer ,Integer > functionThrowing = LToByteBiFunction.l((a1,a2) -> {
