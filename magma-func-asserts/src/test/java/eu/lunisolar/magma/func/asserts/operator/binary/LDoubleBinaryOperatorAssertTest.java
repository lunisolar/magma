...
import eu.lunisolar.magma.func.operator.binary.LDoubleBinaryOperator;
...
public class LDoubleBinaryOperatorAssertTest<X extends ParseException> {
    ...
    private LDoubleBinaryOperator function = (double a1,double a2) ->
            testValue;


    private LDoubleBinaryOperator functionThrowing = (double a1,double a2) -> {
