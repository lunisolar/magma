...
public class LDoubleBinaryOperatorAssertTest<X extends Throwable> {
    ...
    private LDoubleBinaryOperator function = LDoubleBinaryOperator.l((a1,a2) ->
            testValue
    );

    private LDoubleBinaryOperator functionThrowing = LDoubleBinaryOperator.l((a1,a2) -> {
