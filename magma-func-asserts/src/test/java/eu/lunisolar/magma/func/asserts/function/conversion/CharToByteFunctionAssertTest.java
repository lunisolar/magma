...
public class CharToByteFunctionAssertTest<X extends ParseException> {
    ...
    private CharToByteFunction function = CharToByteFunction.l((c) -> {
            return testValue;
    });

    private CharToByteFunction functionThrowing = CharToByteFunction.l((c) -> {
