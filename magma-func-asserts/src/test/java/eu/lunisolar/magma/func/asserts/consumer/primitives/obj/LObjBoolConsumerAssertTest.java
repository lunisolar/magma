...
public class LObjBoolConsumerAssertTest<T,X extends Throwable> {
    ...
    private LObjBoolConsumer<Integer > function = LObjBoolConsumer.l((a1,a2) ->
            externalEffect.set(testValue)
    );

    private LObjBoolConsumer<Integer > functionThrowing = LObjBoolConsumer.l((a1,a2) -> {
