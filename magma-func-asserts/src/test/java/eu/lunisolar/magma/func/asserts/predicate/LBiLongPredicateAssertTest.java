...
public class LBiLongPredicateAssertTest<X extends ParseException> {
    ...
    private LBiLongPredicate function = (long a1,long a2) ->
            testValue;


    private LBiLongPredicate functionThrowing = (long a1,long a2) -> {
