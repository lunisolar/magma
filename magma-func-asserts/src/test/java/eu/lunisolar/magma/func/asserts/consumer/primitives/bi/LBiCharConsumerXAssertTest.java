...
public class LBiCharConsumerXAssertTest<X extends Throwable> {
    ...
    private LBiCharConsumerX<X> function = LBiCharConsumerX.lX((c1,c2) ->
            externalEffect.set(testValue)
    );

    private LBiCharConsumerX<X> functionThrowing = LBiCharConsumerX.lX((c1,c2) -> {
