...
import eu.lunisolar.magma.func.consumer.primitives.bi.LBiCharConsumerX;
...
public class LBiCharConsumerXAssertTest<X extends ParseException> {
    ...
    private LBiCharConsumerX<X> function = (char a1,char a2) ->
            externalEffect.set(testValue);


    private LBiCharConsumerX<X> functionThrowing = (char a1,char a2) -> {
