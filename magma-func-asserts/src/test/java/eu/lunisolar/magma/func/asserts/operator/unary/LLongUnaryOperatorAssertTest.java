...
public class LLongUnaryOperatorAssertTest<X extends Throwable> {
    ...
    private LLongUnaryOperator function = LLongUnaryOperator.l(a1 ->
            testValue
    );

    private LLongUnaryOperator functionThrowing = LLongUnaryOperator.l(a1 -> {
