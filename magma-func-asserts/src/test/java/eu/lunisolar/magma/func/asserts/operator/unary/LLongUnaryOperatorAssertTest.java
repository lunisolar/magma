...
public class LLongUnaryOperatorAssertTest<X extends ParseException> {
    ...
    private LLongUnaryOperator function = LLongUnaryOperator.l((l) -> {
            return testValue;
    });

    private LLongUnaryOperator functionThrowing = LLongUnaryOperator.l((l) -> {
