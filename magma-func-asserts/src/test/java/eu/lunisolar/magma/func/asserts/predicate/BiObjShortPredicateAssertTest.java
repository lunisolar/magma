...
public class BiObjShortPredicateAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjShortPredicate<Integer ,Integer > function = BiObjShortPredicate.l((t1,t2, s) -> {
            return testValue;
    });

    private BiObjShortPredicate<Integer ,Integer > functionThrowing = BiObjShortPredicate.l((t1,t2, s) -> {
