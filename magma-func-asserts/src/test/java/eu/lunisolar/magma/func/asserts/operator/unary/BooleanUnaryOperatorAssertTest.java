...
public class BooleanUnaryOperatorAssertTest<X extends ParseException> {
    ...
    private BooleanUnaryOperator function = BooleanUnaryOperator.l((b) -> {
            return testValue;
    });

    private BooleanUnaryOperator functionThrowing = BooleanUnaryOperator.l((b) -> {
