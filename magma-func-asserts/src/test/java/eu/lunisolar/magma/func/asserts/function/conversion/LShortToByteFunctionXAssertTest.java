...
import eu.lunisolar.magma.func.function.conversion.LShortToByteFunctionX;
...
public class LShortToByteFunctionXAssertTest<X extends ParseException> {
    ...
    private LShortToByteFunctionX<X> function = a1 ->
            testValue;


    private LShortToByteFunctionX<X> functionThrowing = a1 -> {
