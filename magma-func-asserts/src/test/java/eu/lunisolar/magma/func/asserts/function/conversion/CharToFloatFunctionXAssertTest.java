...
public class CharToFloatFunctionXAssertTest<X extends ParseException> {
    ...
    private CharToFloatFunctionX<X> function = CharToFloatFunctionX.lX((c) -> {
            return testValue;
    });

    private CharToFloatFunctionX<X> functionThrowing = CharToFloatFunctionX.lX((c) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsFloat((char)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsFloat((char)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsFloat((char)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsFloat((char)80).withException(a -> a
