...
public class DoubleUnaryOperatorAssertTest<X extends ParseException> {
    ...
    private DoubleUnaryOperator function = DoubleUnaryOperator.l((d) -> {
            return testValue;
    });

    private DoubleUnaryOperator functionThrowing = DoubleUnaryOperator.l((d) -> {
