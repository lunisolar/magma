...
public class StdIntBinaryOperatorAssertTest<X extends ParseException> {
    ...
    private java.util.function.IntBinaryOperator function = ((i1,i2) -> {
            return testValue;
    });

    private java.util.function.IntBinaryOperator functionThrowing = ((i1,i2) -> {
