...
public class ShortToIntFunctionAssertTest<X extends ParseException> {
    ...
    private ShortToIntFunction function = ShortToIntFunction.l((s) -> {
            return testValue;
    });

    private ShortToIntFunction functionThrowing = ShortToIntFunction.l((s) -> {
