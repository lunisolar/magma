...
public class DoubleToIntFunctionAssertTest<X extends Throwable> {
    ...
    private java.util.function.DoubleToIntFunction function = (a1 ->
            testValue
    );

    private java.util.function.DoubleToIntFunction functionThrowing = (a1 -> {
