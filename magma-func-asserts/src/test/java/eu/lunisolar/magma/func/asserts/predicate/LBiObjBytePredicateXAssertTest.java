...
import eu.lunisolar.magma.func.predicate.LBiObjBytePredicateX;
...
public class LBiObjBytePredicateXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjBytePredicateX<Integer,Integer,X> function = (Integer a1,Integer a2,byte a3) ->
            testValue;


    private LBiObjBytePredicateX<Integer,Integer,X> functionThrowing = (Integer a1,Integer a2,byte a3) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest(100,100,(byte)100).withException(a -> a
