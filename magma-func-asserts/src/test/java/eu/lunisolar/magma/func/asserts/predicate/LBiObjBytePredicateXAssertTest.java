...
public class LBiObjBytePredicateXAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjBytePredicateX<Integer ,Integer ,X> function = LBiObjBytePredicateX.lX((a1,a2,a3) ->
            testValue
    );

    private LBiObjBytePredicateX<Integer ,Integer ,X> functionThrowing = LBiObjBytePredicateX.lX((a1,a2,a3) -> {
