...
public class StdIntToDoubleFunctionAssertTest<X extends ParseException> {
    ...
    private java.util.function.IntToDoubleFunction function = ((i) -> {
            return testValue;
    });

    private java.util.function.IntToDoubleFunction functionThrowing = ((i) -> {
