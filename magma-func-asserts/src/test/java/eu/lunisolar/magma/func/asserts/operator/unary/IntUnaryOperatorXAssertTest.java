...
public class IntUnaryOperatorXAssertTest<X extends ParseException> {
    ...
    private IntUnaryOperatorX<X> function = IntUnaryOperatorX.lX((i) -> {
            return testValue;
    });

    private IntUnaryOperatorX<X> functionThrowing = IntUnaryOperatorX.lX((i) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsInt((int)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsInt((int)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsInt((int)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsInt((int)80).withException(a -> a
