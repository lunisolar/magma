...
public class LCharUnaryOperatorAssertTest<X extends ParseException> {
    ...
    private LCharUnaryOperator function = a1 ->
            testValue;


    private LCharUnaryOperator functionThrowing = a1 -> {
