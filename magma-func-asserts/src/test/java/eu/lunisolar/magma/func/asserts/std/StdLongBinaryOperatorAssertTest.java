...
public class StdLongBinaryOperatorAssertTest<X extends ParseException> {
    ...
    private java.util.function.LongBinaryOperator function = ((l1,l2) -> {
            return testValue;
    });

    private java.util.function.LongBinaryOperator functionThrowing = ((l1,l2) -> {
