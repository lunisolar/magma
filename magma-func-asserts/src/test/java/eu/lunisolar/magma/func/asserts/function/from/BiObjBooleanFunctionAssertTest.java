...
public class BiObjBooleanFunctionAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private BiObjBooleanFunction<Integer ,Integer ,Integer > function = BiObjBooleanFunction.l((t1,t2, b) -> {
            return (Integer ) testValue;
    });

    private BiObjBooleanFunction<Integer ,Integer ,Integer > functionThrowing = BiObjBooleanFunction.l((t1,t2, b) -> {
