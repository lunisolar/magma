...
import eu.lunisolar.magma.func.operator.binary.LFltBinaryOperator;
...
public class LFltBinaryOperatorAssertTest {
    ...
    private LFltBinaryOperator function = (a1,a2) ->
            testValue;


    private LFltBinaryOperator functionThrowing = (a1,a2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertFltBinaryOp(function)
         .doesApplyAsFlt(100f,100f)
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertFltBinaryOp(functionThrowing)
         .doesApplyAsFlt(100f,100f)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertFltBinaryOp(functionThrowing)
         .doesApplyAsFlt(100f,100f).withException(a -> a
