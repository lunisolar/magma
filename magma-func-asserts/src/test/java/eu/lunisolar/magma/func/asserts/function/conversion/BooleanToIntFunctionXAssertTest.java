...
public class BooleanToIntFunctionXAssertTest<X extends ParseException> {
    ...
    private BooleanToIntFunctionX<X> function = BooleanToIntFunctionX.lX((b) -> {
            return testValue;
    });

    private BooleanToIntFunctionX<X> functionThrowing = BooleanToIntFunctionX.lX((b) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsInt(true).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsInt(true).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsInt(true).to( a -> a.isEqualTo(1));
