...
public class LongSupplierAssertTest<X extends ParseException> {
    ...
    private LongSupplier function = LongSupplier.l(() -> {
            return testValue;
    });

    private LongSupplier functionThrowing = LongSupplier.l(() -> {
