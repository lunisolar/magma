...
public class FloatBiFunctionXAssertTest<R,X extends ParseException> {
    ...
    private FloatBiFunctionX<Integer ,X> function = FloatBiFunctionX.lX((f1,f2) -> {
            return (Integer ) testValue;
    });

    private FloatBiFunctionX<Integer ,X> functionThrowing = FloatBiFunctionX.lX((f1,f2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((float)80,(float)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((float)80,(float)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((float)80,(float)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((float)80,(float)81).withException(a -> a
