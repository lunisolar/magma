...
public class ObjShortConsumerAssertTest<T,X extends ParseException> {
    ...
    private ObjShortConsumer<Integer > function = ObjShortConsumer.l((t, s) -> {
            externalEffect.set(testValue);
    });

    private ObjShortConsumer<Integer > functionThrowing = ObjShortConsumer.l((t, s) -> {
