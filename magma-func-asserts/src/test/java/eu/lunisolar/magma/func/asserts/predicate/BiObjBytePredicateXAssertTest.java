...
public class BiObjBytePredicateXAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjBytePredicateX<Integer ,Integer ,X> function = BiObjBytePredicateX.lX((t1,t2, b) -> {
            return testValue;
    });

    private BiObjBytePredicateX<Integer ,Integer ,X> functionThrowing = BiObjBytePredicateX.lX((t1,t2, b) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(byte)82).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(byte)82).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(byte)82).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(byte)82).withException(a -> a
