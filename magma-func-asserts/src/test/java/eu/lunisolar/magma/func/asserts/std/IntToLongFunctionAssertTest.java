...
public class IntToLongFunctionAssertTest<X extends Throwable> {
    ...
    private java.util.function.IntToLongFunction function = (a1 ->
            testValue
    );

    private java.util.function.IntToLongFunction functionThrowing = (a1 -> {
