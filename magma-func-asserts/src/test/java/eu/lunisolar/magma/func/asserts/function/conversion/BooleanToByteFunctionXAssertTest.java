...
public class BooleanToByteFunctionXAssertTest<X extends ParseException> {
    ...
    private BooleanToByteFunctionX<X> function = BooleanToByteFunctionX.lX((b) -> {
            return testValue;
    });

    private BooleanToByteFunctionX<X> functionThrowing = BooleanToByteFunctionX.lX((b) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsByte(true).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsByte(true).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsByte(true).to( a -> a.isEqualTo(1));
