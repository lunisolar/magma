...
public class LUnaryOperatorAssertTest<T,X extends Throwable> {
    ...
    private LUnaryOperator<Integer > function = LUnaryOperator.l(a1 ->
            (Integer ) testValue
    );

    private LUnaryOperator<Integer > functionThrowing = LUnaryOperator.l(a1 -> {
