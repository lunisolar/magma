...
public class LLongToFloatFunctionAssertTest<X extends Throwable> {
    ...
    private LLongToFloatFunction function = LLongToFloatFunction.l(a1 ->
            testValue
    );

    private LLongToFloatFunction functionThrowing = LLongToFloatFunction.l(a1 -> {
