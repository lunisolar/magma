...
import eu.lunisolar.magma.func.function.conversion.LBoolToFloatFunction;
...
public class LBoolToFloatFunctionAssertTest<X extends ParseException> {
    ...
    private LBoolToFloatFunction function = a1 ->
            testValue;


    private LBoolToFloatFunction functionThrowing = a1 -> {
