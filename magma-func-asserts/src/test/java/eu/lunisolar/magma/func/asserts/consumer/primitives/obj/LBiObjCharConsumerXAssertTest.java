...
public class LBiObjCharConsumerXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjCharConsumerX<Integer ,Integer ,X> function = LBiObjCharConsumerX.lX((t1,t2, c) -> {
            externalEffect.set(testValue);
    });

    private LBiObjCharConsumerX<Integer ,Integer ,X> functionThrowing = LBiObjCharConsumerX.lX((t1,t2, c) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesAccept((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(char)82)
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(char)82).withException(a -> a
