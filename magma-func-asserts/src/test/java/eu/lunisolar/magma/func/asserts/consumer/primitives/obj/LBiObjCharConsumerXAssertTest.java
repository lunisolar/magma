...
public class LBiObjCharConsumerXAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjCharConsumerX<Integer ,Integer ,X> function = LBiObjCharConsumerX.lX((a1,a2,a3) ->
            externalEffect.set(testValue)
    );

    private LBiObjCharConsumerX<Integer ,Integer ,X> functionThrowing = LBiObjCharConsumerX.lX((a1,a2,a3) -> {
