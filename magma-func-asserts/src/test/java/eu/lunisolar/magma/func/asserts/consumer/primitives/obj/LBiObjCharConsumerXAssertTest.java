...
import eu.lunisolar.magma.func.consumer.primitives.obj.LBiObjCharConsumerX;
...
public class LBiObjCharConsumerXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjCharConsumerX<Integer,Integer,X> function = (Integer a1,Integer a2,char a3) ->
            externalEffect.set(testValue);


    private LBiObjCharConsumerX<Integer,Integer,X> functionThrowing = (Integer a1,Integer a2,char a3) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept(100,100,'\u0100').withException(a -> a
