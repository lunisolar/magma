...
public class LBiBytePredicateAssertTest<X extends Throwable> {
    ...
    private LBiBytePredicate function = LBiBytePredicate.l((a1,a2) ->
            testValue
    );

    private LBiBytePredicate functionThrowing = LBiBytePredicate.l((a1,a2) -> {
