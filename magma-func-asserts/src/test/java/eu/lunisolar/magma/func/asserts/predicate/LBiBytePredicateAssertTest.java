...
public class LBiBytePredicateAssertTest<X extends ParseException> {
    ...
    private LBiBytePredicate function = LBiBytePredicate.l((b1,b2) -> {
            return testValue;
    });

    private LBiBytePredicate functionThrowing = LBiBytePredicate.l((b1,b2) -> {
