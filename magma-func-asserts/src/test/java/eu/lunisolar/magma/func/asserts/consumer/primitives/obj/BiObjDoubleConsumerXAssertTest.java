...
public class BiObjDoubleConsumerXAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjDoubleConsumerX<Integer ,Integer ,X> function = BiObjDoubleConsumerX.lX((t1,t2, d) -> {
            externalEffect.set(testValue);
    });

    private BiObjDoubleConsumerX<Integer ,Integer ,X> functionThrowing = BiObjDoubleConsumerX.lX((t1,t2, d) -> {
