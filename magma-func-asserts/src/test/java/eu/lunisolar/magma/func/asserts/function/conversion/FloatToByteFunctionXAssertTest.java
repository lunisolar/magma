...
public class FloatToByteFunctionXAssertTest<X extends ParseException> {
    ...
    private FloatToByteFunctionX<X> function = FloatToByteFunctionX.lX((f) -> {
            return testValue;
    });

    private FloatToByteFunctionX<X> functionThrowing = FloatToByteFunctionX.lX((f) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsByte((float)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsByte((float)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsByte((float)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsByte((float)80).withException(a -> a
