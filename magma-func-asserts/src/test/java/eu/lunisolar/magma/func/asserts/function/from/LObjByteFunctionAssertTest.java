...
public class LObjByteFunctionAssertTest<T,R,X extends Throwable> {
    ...
    private LObjByteFunction<Integer ,Integer > function = LObjByteFunction.l((a1,a2) ->
            (Integer ) testValue
    );

    private LObjByteFunction<Integer ,Integer > functionThrowing = LObjByteFunction.l((a1,a2) -> {
