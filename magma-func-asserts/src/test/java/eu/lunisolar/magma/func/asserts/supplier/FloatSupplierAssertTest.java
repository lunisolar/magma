...
public class FloatSupplierAssertTest<X extends ParseException> {
    ...
    private FloatSupplier function = FloatSupplier.l(() -> {
            return testValue;
    });

    private FloatSupplier functionThrowing = FloatSupplier.l(() -> {
