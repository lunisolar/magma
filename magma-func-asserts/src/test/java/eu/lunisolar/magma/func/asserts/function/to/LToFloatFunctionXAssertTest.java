...
public class LToFloatFunctionXAssertTest<T,X extends Throwable> {
    ...
    private LToFloatFunctionX<Integer ,X> function = LToFloatFunctionX.lX(a1 ->
            testValue
    );

    private LToFloatFunctionX<Integer ,X> functionThrowing = LToFloatFunctionX.lX(a1 -> {
