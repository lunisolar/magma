...
import eu.lunisolar.magma.func.function.to.LToFloatFunctionX;
...
public class LToFloatFunctionXAssertTest<T,X extends ParseException> {
    ...
    private LToFloatFunctionX<Integer,X> function = a1 ->
            testValue;


    private LToFloatFunctionX<Integer,X> functionThrowing = a1 -> {
