...
public class LFloatToDoubleFunctionAssertTest<X extends Throwable> {
    ...
    private LFloatToDoubleFunction function = LFloatToDoubleFunction.l(a1 ->
            testValue
    );

    private LFloatToDoubleFunction functionThrowing = LFloatToDoubleFunction.l(a1 -> {
