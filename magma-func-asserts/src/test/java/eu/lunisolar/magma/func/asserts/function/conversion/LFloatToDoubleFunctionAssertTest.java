...
import eu.lunisolar.magma.func.function.conversion.LFloatToDoubleFunction;
...
public class LFloatToDoubleFunctionAssertTest<X extends ParseException> {
    ...
    private LFloatToDoubleFunction function = a1 ->
            testValue;


    private LFloatToDoubleFunction functionThrowing = a1 -> {
