...
public class ObjFloatConsumerAssertTest<T,X extends ParseException> {
    ...
    private ObjFloatConsumer<Integer > function = ObjFloatConsumer.l((t, f) -> {
            externalEffect.set(testValue);
    });

    private ObjFloatConsumer<Integer > functionThrowing = ObjFloatConsumer.l((t, f) -> {
