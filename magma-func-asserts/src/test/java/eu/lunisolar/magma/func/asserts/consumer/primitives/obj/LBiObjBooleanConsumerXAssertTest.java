...
public class LBiObjBooleanConsumerXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjBooleanConsumerX<Integer ,Integer ,X> function = LBiObjBooleanConsumerX.lX((t1,t2, b) -> {
            externalEffect.set(testValue);
    });

    private LBiObjBooleanConsumerX<Integer ,Integer ,X> functionThrowing = LBiObjBooleanConsumerX.lX((t1,t2, b) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesAccept((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),true)
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),true).withException(a -> a
