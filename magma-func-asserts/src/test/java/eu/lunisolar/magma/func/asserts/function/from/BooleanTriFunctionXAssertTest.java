...
public class BooleanTriFunctionXAssertTest<R,X extends ParseException> {
    ...
    private BooleanTriFunctionX<Integer ,X> function = BooleanTriFunctionX.lX((b1,b2,b3) -> {
            return (Integer ) testValue;
    });

    private BooleanTriFunctionX<Integer ,X> functionThrowing = BooleanTriFunctionX.lX((b1,b2,b3) -> {
