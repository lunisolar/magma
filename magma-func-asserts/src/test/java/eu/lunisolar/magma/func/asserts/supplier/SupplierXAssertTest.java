...
public class SupplierXAssertTest<R,X extends ParseException> {
    ...
    private SupplierX<Integer ,X> function = SupplierX.lX(() -> {
            return (Integer ) testValue;
    });

    private SupplierX<Integer ,X> functionThrowing = SupplierX.lX(() -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesGet().to(a -> a.isEqualTo(testValue));
