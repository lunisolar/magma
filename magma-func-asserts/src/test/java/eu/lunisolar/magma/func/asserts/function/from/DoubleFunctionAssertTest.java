...
public class DoubleFunctionAssertTest<R,X extends ParseException> {
    ...
    private DoubleFunction<Integer > function = DoubleFunction.l((d) -> {
            return (Integer ) testValue;
    });

    private DoubleFunction<Integer > functionThrowing = DoubleFunction.l((d) -> {
