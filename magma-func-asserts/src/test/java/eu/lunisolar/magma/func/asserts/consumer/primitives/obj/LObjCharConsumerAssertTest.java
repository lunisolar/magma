...
public class LObjCharConsumerAssertTest<T,X extends Throwable> {
    ...
    private LObjCharConsumer<Integer > function = LObjCharConsumer.l((a1,a2) ->
            externalEffect.set(testValue)
    );

    private LObjCharConsumer<Integer > functionThrowing = LObjCharConsumer.l((a1,a2) -> {
