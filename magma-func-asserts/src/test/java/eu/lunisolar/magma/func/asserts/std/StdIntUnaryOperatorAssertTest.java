...
public class StdIntUnaryOperatorAssertTest<X extends ParseException> {
    ...
    private java.util.function.IntUnaryOperator function = ((i) -> {
            return testValue;
    });

    private java.util.function.IntUnaryOperator functionThrowing = ((i) -> {
