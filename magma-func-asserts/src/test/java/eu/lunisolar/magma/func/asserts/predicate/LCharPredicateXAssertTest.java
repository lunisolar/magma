...
public class LCharPredicateXAssertTest<X extends Throwable> {
    ...
    private LCharPredicateX<X> function = LCharPredicateX.lX(a1 ->
            testValue
    );

    private LCharPredicateX<X> functionThrowing = LCharPredicateX.lX(a1 -> {
