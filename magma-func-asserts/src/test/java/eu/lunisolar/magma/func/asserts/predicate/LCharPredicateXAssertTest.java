...
import eu.lunisolar.magma.func.predicate.LCharPredicateX;
...
public class LCharPredicateXAssertTest<X extends ParseException> {
    ...
    private LCharPredicateX<X> function = a1 ->
            testValue;


    private LCharPredicateX<X> functionThrowing = a1 -> {
