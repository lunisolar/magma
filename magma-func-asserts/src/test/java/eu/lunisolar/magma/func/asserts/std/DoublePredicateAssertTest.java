...
public class DoublePredicateAssertTest<X extends Throwable> {
    ...
    private java.util.function.DoublePredicate function = (a1 ->
            testValue
    );

    private java.util.function.DoublePredicate functionThrowing = (a1 -> {
