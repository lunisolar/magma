...
public class LByteToDoubleFunctionXAssertTest<X extends Throwable> {
    ...
    private LByteToDoubleFunctionX<X> function = LByteToDoubleFunctionX.lX(a1 ->
            testValue
    );

    private LByteToDoubleFunctionX<X> functionThrowing = LByteToDoubleFunctionX.lX(a1 -> {
