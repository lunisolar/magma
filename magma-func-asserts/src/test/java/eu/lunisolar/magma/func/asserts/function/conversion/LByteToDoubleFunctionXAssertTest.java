...
import eu.lunisolar.magma.func.function.conversion.LByteToDoubleFunctionX;
...
public class LByteToDoubleFunctionXAssertTest<X extends ParseException> {
    ...
    private LByteToDoubleFunctionX<X> function = a1 ->
            testValue;


    private LByteToDoubleFunctionX<X> functionThrowing = a1 -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsDouble((byte)100).withException(a -> a
