...
public class LLongConsumerXAssertTest<X extends Throwable> {
    ...
    private LLongConsumerX<X> function = LLongConsumerX.lX(a1 ->
            externalEffect.set(testValue)
    );

    private LLongConsumerX<X> functionThrowing = LLongConsumerX.lX(a1 -> {
