...
public class ToDoubleFunctionAssertTest<T,X extends Throwable> {
    ...
    private java.util.function.ToDoubleFunction<Integer > function = (a1 ->
            testValue
    );

    private java.util.function.ToDoubleFunction<Integer > functionThrowing = (a1 -> {
