...
import eu.lunisolar.magma.func.function.from.LDoubleFunctionX;
...
public class LDoubleFunctionXAssertTest<R,X extends ParseException> {
    ...
    private LDoubleFunctionX<Integer,X> function = a1 ->
            testValue;


    private LDoubleFunctionX<Integer,X> functionThrowing = a1 -> {
