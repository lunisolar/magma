...
public class LDoubleFunctionXAssertTest<R,X extends Throwable> {
    ...
    private LDoubleFunctionX<Integer ,X> function = LDoubleFunctionX.lX(a1 ->
            (Integer ) testValue
    );

    private LDoubleFunctionX<Integer ,X> functionThrowing = LDoubleFunctionX.lX(a1 -> {
