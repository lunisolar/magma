...
public class ToLongBiFunctionXAssertTest<T1,T2,X extends ParseException> {
    ...
    private ToLongBiFunctionX<Integer ,Integer ,X> function = ToLongBiFunctionX.lX((t1,t2) -> {
            return testValue;
    });

    private ToLongBiFunctionX<Integer ,Integer ,X> functionThrowing = ToLongBiFunctionX.lX((t1,t2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsLong((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81)).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsLong((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81)).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsLong((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81)).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsLong((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81)).withException(a -> a
