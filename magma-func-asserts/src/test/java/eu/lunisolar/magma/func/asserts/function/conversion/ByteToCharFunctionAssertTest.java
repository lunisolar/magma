...
public class ByteToCharFunctionAssertTest<X extends ParseException> {
    ...
    private ByteToCharFunction function = ByteToCharFunction.l((b) -> {
            return testValue;
    });

    private ByteToCharFunction functionThrowing = ByteToCharFunction.l((b) -> {
