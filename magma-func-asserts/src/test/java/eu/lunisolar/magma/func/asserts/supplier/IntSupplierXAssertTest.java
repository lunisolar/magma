...
public class IntSupplierXAssertTest<X extends ParseException> {
    ...
    private IntSupplierX<X> function = IntSupplierX.lX(() -> {
            return testValue;
    });

    private IntSupplierX<X> functionThrowing = IntSupplierX.lX(() -> {
