...
public class BooleanTriFunctionAssertTest<R,X extends ParseException> {
    ...
    private BooleanTriFunction<Integer > function = BooleanTriFunction.l((b1,b2,b3) -> {
            return (Integer ) testValue;
    });

    private BooleanTriFunction<Integer > functionThrowing = BooleanTriFunction.l((b1,b2,b3) -> {
