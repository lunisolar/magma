...
public class BooleanTernaryOperatorAssertTest<X extends ParseException> {
    ...
    private BooleanTernaryOperator functionThrowing = BooleanTernaryOperator.l((b1,b2,b3) -> {
