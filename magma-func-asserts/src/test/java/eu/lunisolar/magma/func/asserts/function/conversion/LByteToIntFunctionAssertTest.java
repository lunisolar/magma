...
public class LByteToIntFunctionAssertTest<X extends ParseException> {
    ...
    private LByteToIntFunction function = LByteToIntFunction.l((b) -> {
            return testValue;
    });

    private LByteToIntFunction functionThrowing = LByteToIntFunction.l((b) -> {
