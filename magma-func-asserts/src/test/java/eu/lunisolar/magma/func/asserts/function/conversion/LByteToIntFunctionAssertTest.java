...
public class LByteToIntFunctionAssertTest<X extends Throwable> {
    ...
    private LByteToIntFunction function = LByteToIntFunction.l(a1 ->
            testValue
    );

    private LByteToIntFunction functionThrowing = LByteToIntFunction.l(a1 -> {
