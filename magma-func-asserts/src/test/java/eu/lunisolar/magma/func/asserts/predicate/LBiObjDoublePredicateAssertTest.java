...
public class LBiObjDoublePredicateAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjDoublePredicate<Integer ,Integer > function = LBiObjDoublePredicate.l((a1,a2,a3) ->
            testValue
    );

    private LBiObjDoublePredicate<Integer ,Integer > functionThrowing = LBiObjDoublePredicate.l((a1,a2,a3) -> {
