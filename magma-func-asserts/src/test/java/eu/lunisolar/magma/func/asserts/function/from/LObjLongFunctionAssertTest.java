...
public class LObjLongFunctionAssertTest<T,R,X extends Throwable> {
    ...
    private LObjLongFunction<Integer ,Integer > function = LObjLongFunction.l((a1,a2) ->
            (Integer ) testValue
    );

    private LObjLongFunction<Integer ,Integer > functionThrowing = LObjLongFunction.l((a1,a2) -> {
