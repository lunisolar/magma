...
public class BooleanUnaryOperatorXAssertTest<X extends ParseException> {
    ...
    private BooleanUnaryOperatorX<X> function = BooleanUnaryOperatorX.lX((b) -> {
            return testValue;
    });

    private BooleanUnaryOperatorX<X> functionThrowing = BooleanUnaryOperatorX.lX((b) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsBoolean(true).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsBoolean(true).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsBoolean(true).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsBoolean(true).withException(a -> a
