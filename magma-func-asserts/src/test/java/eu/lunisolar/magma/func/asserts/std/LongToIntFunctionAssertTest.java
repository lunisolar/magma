...
public class LongToIntFunctionAssertTest<X extends Throwable> {
    ...
    private java.util.function.LongToIntFunction function = (a1 ->
            testValue
    );

    private java.util.function.LongToIntFunction functionThrowing = (a1 -> {
