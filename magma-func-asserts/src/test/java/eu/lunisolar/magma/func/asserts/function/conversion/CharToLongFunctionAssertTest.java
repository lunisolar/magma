...
public class CharToLongFunctionAssertTest<X extends ParseException> {
    ...
    private CharToLongFunction function = CharToLongFunction.l((c) -> {
            return testValue;
    });

    private CharToLongFunction functionThrowing = CharToLongFunction.l((c) -> {
