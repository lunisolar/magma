...
public class ObjByteConsumerXAssertTest<T,X extends ParseException> {
    ...
    private ObjByteConsumerX<Integer ,X> function = ObjByteConsumerX.lX((t, b) -> {
            externalEffect.set(testValue);
    });

    private ObjByteConsumerX<Integer ,X> functionThrowing = ObjByteConsumerX.lX((t, b) -> {
