...
public class ObjFloatConsumerXAssertTest<T,X extends ParseException> {
    ...
    private ObjFloatConsumerX<Integer ,X> function = ObjFloatConsumerX.lX((t, f) -> {
            externalEffect.set(testValue);
    });

    private ObjFloatConsumerX<Integer ,X> functionThrowing = ObjFloatConsumerX.lX((t, f) -> {
