...
public class LToLongFunctionAssertTest<T,X extends Throwable> {
    ...
    private LToLongFunction<Integer > function = LToLongFunction.l(a1 ->
            testValue
    );

    private LToLongFunction<Integer > functionThrowing = LToLongFunction.l(a1 -> {
