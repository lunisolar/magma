...
public class LToLongFunctionAssertTest<T,X extends ParseException> {
    ...
    private LToLongFunction<Integer > function = LToLongFunction.l((t) -> {
            return testValue;
    });

    private LToLongFunction<Integer > functionThrowing = LToLongFunction.l((t) -> {
