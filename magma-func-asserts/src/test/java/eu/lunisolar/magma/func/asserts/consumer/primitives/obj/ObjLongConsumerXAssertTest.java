...
public class ObjLongConsumerXAssertTest<T,X extends ParseException> {
    ...
    private ObjLongConsumerX<Integer ,X> function = ObjLongConsumerX.lX((t, l) -> {
            externalEffect.set(testValue);
    });

    private ObjLongConsumerX<Integer ,X> functionThrowing = ObjLongConsumerX.lX((t, l) -> {
