...
public class LCharUnaryOperatorXAssertTest<X extends Throwable> {
    ...
    private LCharUnaryOperatorX<X> function = LCharUnaryOperatorX.lX(a1 ->
            testValue
    );

    private LCharUnaryOperatorX<X> functionThrowing = LCharUnaryOperatorX.lX(a1 -> {
