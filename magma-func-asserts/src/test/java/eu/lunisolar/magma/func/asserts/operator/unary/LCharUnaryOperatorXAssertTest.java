...
import eu.lunisolar.magma.func.operator.unary.LCharUnaryOperatorX;
...
public class LCharUnaryOperatorXAssertTest<X extends ParseException> {
    ...
    private LCharUnaryOperatorX<X> function = a1 ->
            testValue;


    private LCharUnaryOperatorX<X> functionThrowing = a1 -> {
