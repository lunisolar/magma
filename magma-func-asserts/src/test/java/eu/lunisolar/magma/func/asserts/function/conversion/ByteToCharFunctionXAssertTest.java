...
public class ByteToCharFunctionXAssertTest<X extends ParseException> {
    ...
    private ByteToCharFunctionX<X> function = ByteToCharFunctionX.lX((b) -> {
            return testValue;
    });

    private ByteToCharFunctionX<X> functionThrowing = ByteToCharFunctionX.lX((b) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsChar((byte)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsChar((byte)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsChar((byte)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsChar((byte)80).withException(a -> a
