...
public class LObjCharFunctionAssertTest<T,R,X extends Throwable> {
    ...
    private LObjCharFunction<Integer ,Integer > function = LObjCharFunction.l((a1,a2) ->
            (Integer ) testValue
    );

    private LObjCharFunction<Integer ,Integer > functionThrowing = LObjCharFunction.l((a1,a2) -> {
