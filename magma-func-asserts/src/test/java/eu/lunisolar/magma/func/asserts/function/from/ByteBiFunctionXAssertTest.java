...
public class ByteBiFunctionXAssertTest<R,X extends ParseException> {
    ...
    private ByteBiFunctionX<Integer ,X> function = ByteBiFunctionX.lX((b1,b2) -> {
            return (Integer ) testValue;
    });

    private ByteBiFunctionX<Integer ,X> functionThrowing = ByteBiFunctionX.lX((b1,b2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((byte)80,(byte)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((byte)80,(byte)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((byte)80,(byte)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((byte)80,(byte)81).withException(a -> a
