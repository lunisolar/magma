...
public class LongFunctionXAssertTest<R,X extends ParseException> {
    ...
    private LongFunctionX<Integer ,X> function = LongFunctionX.lX((l) -> {
            return (Integer ) testValue;
    });

    private LongFunctionX<Integer ,X> functionThrowing = LongFunctionX.lX((l) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((long)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((long)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((long)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((long)80).withException(a -> a
