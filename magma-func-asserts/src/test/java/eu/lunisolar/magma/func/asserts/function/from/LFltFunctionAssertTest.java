...
import eu.lunisolar.magma.func.function.from.LFltFunction;
...
public class LFltFunctionAssertTest<R> {
    ...
    private LFltFunction<Integer> function = a ->
            testValue;


    private LFltFunction<Integer> functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertFltFunc(functionThrowing)
         .doesApply(100f)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertFltFunc(functionThrowing)
         .doesApply(100f).withException(a -> a
