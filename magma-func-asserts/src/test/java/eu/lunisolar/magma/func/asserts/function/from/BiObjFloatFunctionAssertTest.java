...
public class BiObjFloatFunctionAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private BiObjFloatFunction<Integer ,Integer ,Integer > function = BiObjFloatFunction.l((t1,t2, f) -> {
            return (Integer ) testValue;
    });

    private BiObjFloatFunction<Integer ,Integer ,Integer > functionThrowing = BiObjFloatFunction.l((t1,t2, f) -> {
