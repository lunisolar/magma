...
public class LObjDoublePredicateXAssertTest<T,X extends Throwable> {
    ...
    private LObjDoublePredicateX<Integer ,X> function = LObjDoublePredicateX.lX((a1,a2) ->
            testValue
    );

    private LObjDoublePredicateX<Integer ,X> functionThrowing = LObjDoublePredicateX.lX((a1,a2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(double)81)
