...
import eu.lunisolar.magma.func.supplier.LDoubleSupplier;
...
public class LDoubleSupplierAssertTest<X extends ParseException> {
    ...
    private LDoubleSupplier function = () ->
            testValue;


    private LDoubleSupplier functionThrowing = () -> {
