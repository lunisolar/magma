...
public class LDoublePredicateAssertTest<X extends Throwable> {
    ...
    private LDoublePredicate function = LDoublePredicate.l(a1 ->
            testValue
    );

    private LDoublePredicate functionThrowing = LDoublePredicate.l(a1 -> {
