...
import eu.lunisolar.magma.func.predicate.LDoublePredicate;
...
public class LDoublePredicateAssertTest<X extends ParseException> {
    ...
    private LDoublePredicate function = a1 ->
            testValue;


    private LDoublePredicate functionThrowing = a1 -> {
