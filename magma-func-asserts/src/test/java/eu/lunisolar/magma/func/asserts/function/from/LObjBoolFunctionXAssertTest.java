...
public class LObjBoolFunctionXAssertTest<T,R,X extends Throwable> {
    ...
    private LObjBoolFunctionX<Integer ,Integer ,X> function = LObjBoolFunctionX.lX((t, b) ->
            (Integer ) testValue
    );

    private LObjBoolFunctionX<Integer ,Integer ,X> functionThrowing = LObjBoolFunctionX.lX((t, b) -> {
