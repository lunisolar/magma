...
public class LObjBoolFunctionXAssertTest<T,R,X extends Throwable> {
    ...
    private LObjBoolFunctionX<Integer ,Integer ,X> function = LObjBoolFunctionX.lX((a1,a2) ->
            (Integer ) testValue
    );

    private LObjBoolFunctionX<Integer ,Integer ,X> functionThrowing = LObjBoolFunctionX.lX((a1,a2) -> {
