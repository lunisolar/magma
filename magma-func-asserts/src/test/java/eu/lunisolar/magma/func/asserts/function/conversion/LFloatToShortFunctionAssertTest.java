...
import eu.lunisolar.magma.func.function.conversion.LFloatToShortFunction;
...
public class LFloatToShortFunctionAssertTest<X extends ParseException> {
    ...
    private LFloatToShortFunction function = a1 ->
            testValue;


    private LFloatToShortFunction functionThrowing = a1 -> {
