...
public class LFloatToShortFunctionAssertTest<X extends Throwable> {
    ...
    private LFloatToShortFunction function = LFloatToShortFunction.l(a1 ->
            testValue
    );

    private LFloatToShortFunction functionThrowing = LFloatToShortFunction.l(a1 -> {
