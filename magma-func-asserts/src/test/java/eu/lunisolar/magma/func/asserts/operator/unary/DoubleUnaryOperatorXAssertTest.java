...
public class DoubleUnaryOperatorXAssertTest<X extends ParseException> {
    ...
    private DoubleUnaryOperatorX<X> function = DoubleUnaryOperatorX.lX((d) -> {
            return testValue;
    });

    private DoubleUnaryOperatorX<X> functionThrowing = DoubleUnaryOperatorX.lX((d) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsDouble((double)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsDouble((double)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsDouble((double)80).to( a -> a.isEqualTo(1));
