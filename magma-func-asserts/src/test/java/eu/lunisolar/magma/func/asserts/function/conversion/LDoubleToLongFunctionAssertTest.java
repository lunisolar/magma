...
import eu.lunisolar.magma.func.function.conversion.LDoubleToLongFunction;
...
public class LDoubleToLongFunctionAssertTest<X extends ParseException> {
    ...
    private LDoubleToLongFunction function = a1 ->
            testValue;


    private LDoubleToLongFunction functionThrowing = a1 -> {
