...
public class LDoubleToLongFunctionAssertTest<X extends Throwable> {
    ...
    private LDoubleToLongFunction function = LDoubleToLongFunction.l(a1 ->
            testValue
    );

    private LDoubleToLongFunction functionThrowing = LDoubleToLongFunction.l(a1 -> {
