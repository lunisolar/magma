...
public class ShortUnaryOperatorAssertTest<X extends ParseException> {
    ...
    private ShortUnaryOperator function = ShortUnaryOperator.l((s) -> {
            return testValue;
    });

    private ShortUnaryOperator functionThrowing = ShortUnaryOperator.l((s) -> {
