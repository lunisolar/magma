...
public class LBiObjDoubleFunctionXAssertTest<T1,T2,R,X extends Throwable> {
    ...
    private LBiObjDoubleFunctionX<Integer ,Integer ,Integer ,X> function = LBiObjDoubleFunctionX.lX((a1,a2,a3) ->
            (Integer ) testValue
    );

    private LBiObjDoubleFunctionX<Integer ,Integer ,Integer ,X> functionThrowing = LBiObjDoubleFunctionX.lX((a1,a2,a3) -> {
