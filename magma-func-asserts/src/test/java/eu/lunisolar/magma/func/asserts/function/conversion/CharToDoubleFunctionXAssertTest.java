...
public class CharToDoubleFunctionXAssertTest<X extends ParseException> {
    ...
    private CharToDoubleFunctionX<X> function = CharToDoubleFunctionX.lX((c) -> {
            return testValue;
    });

    private CharToDoubleFunctionX<X> functionThrowing = CharToDoubleFunctionX.lX((c) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsDouble((char)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsDouble((char)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsDouble((char)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsDouble((char)80).withException(a -> a
