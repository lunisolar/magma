...
public class IntToDoubleFunctionAssertTest<X extends ParseException> {
    ...
    private IntToDoubleFunction function = IntToDoubleFunction.l((i) -> {
            return testValue;
    });

    private IntToDoubleFunction functionThrowing = IntToDoubleFunction.l((i) -> {
