...
public class LTriBooleanConsumerAssertTest<X extends Throwable> {
    ...
    private LTriBooleanConsumer function = LTriBooleanConsumer.l((b1,b2,b3) ->
            externalEffect.set(testValue)
    );

    private LTriBooleanConsumer functionThrowing = LTriBooleanConsumer.l((b1,b2,b3) -> {
