...
public class LTriBoolConsumerAssertTest<X extends Throwable> {
    ...
    private LTriBoolConsumer function = LTriBoolConsumer.l((b1,b2,b3) ->
            externalEffect.set(testValue)
    );

    private LTriBoolConsumer functionThrowing = LTriBoolConsumer.l((b1,b2,b3) -> {
