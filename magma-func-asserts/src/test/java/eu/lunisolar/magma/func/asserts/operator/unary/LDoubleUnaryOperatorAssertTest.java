...
public class LDoubleUnaryOperatorAssertTest<X extends Throwable> {
    ...
    private LDoubleUnaryOperator function = LDoubleUnaryOperator.l(a1 ->
            testValue
    );

    private LDoubleUnaryOperator functionThrowing = LDoubleUnaryOperator.l(a1 -> {
