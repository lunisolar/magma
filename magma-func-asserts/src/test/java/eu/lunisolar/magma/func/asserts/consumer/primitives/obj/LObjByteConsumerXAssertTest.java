...
public class LObjByteConsumerXAssertTest<T,X extends Throwable> {
    ...
    private LObjByteConsumerX<Integer ,X> function = LObjByteConsumerX.lX((a1,a2) ->
            externalEffect.set(testValue)
    );

    private LObjByteConsumerX<Integer ,X> functionThrowing = LObjByteConsumerX.lX((a1,a2) -> {
