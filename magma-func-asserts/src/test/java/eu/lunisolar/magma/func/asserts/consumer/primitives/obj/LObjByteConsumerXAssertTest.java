...
import eu.lunisolar.magma.func.consumer.primitives.obj.LObjByteConsumerX;
...
public class LObjByteConsumerXAssertTest<T,X extends ParseException> {
    ...
    private LObjByteConsumerX<Integer,X> function = (Integer a1,byte a2) ->
            externalEffect.set(testValue);


    private LObjByteConsumerX<Integer,X> functionThrowing = (Integer a1,byte a2) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept(100,(byte)100).withException(a -> a
