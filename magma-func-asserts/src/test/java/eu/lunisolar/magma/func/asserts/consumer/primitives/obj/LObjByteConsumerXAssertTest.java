...
public class LObjByteConsumerXAssertTest<T,X extends ParseException> {
    ...
    private LObjByteConsumerX<Integer ,X> function = LObjByteConsumerX.lX((t, b) -> {
            externalEffect.set(testValue);
    });

    private LObjByteConsumerX<Integer ,X> functionThrowing = LObjByteConsumerX.lX((t, b) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesAccept((Integer )Integer.valueOf(80),(byte)81)
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept((Integer )Integer.valueOf(80),(byte)81).withException(a -> a
