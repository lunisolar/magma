...
import eu.lunisolar.magma.func.function.from.LObjFloatFunction;
...
public class LObjFloatFunctionAssertTest<T,R,X extends ParseException> {
    ...
    private LObjFloatFunction<Integer,Integer> function = (Integer a1,float a2) ->
            testValue;


    private LObjFloatFunction<Integer,Integer> functionThrowing = (Integer a1,float a2) -> {
