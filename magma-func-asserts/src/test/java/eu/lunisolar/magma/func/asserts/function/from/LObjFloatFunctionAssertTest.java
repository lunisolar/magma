...
public class LObjFloatFunctionAssertTest<T,R,X extends Throwable> {
    ...
    private LObjFloatFunction<Integer ,Integer > function = LObjFloatFunction.l((a1,a2) ->
            (Integer ) testValue
    );

    private LObjFloatFunction<Integer ,Integer > functionThrowing = LObjFloatFunction.l((a1,a2) -> {
