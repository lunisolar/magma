...
public class LBiObjLongFunctionAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private LBiObjLongFunction<Integer,Integer,Integer> function = (Integer a1,Integer a2,long a3) ->
            testValue;


    private LBiObjLongFunction<Integer,Integer,Integer> functionThrowing = (Integer a1,Integer a2,long a3) -> {
