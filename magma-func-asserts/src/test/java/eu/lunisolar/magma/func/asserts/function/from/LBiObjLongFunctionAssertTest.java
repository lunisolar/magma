...
public class LBiObjLongFunctionAssertTest<T1,T2,R> {
    ...
    private LBiObjLongFunction<Integer,Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LBiObjLongFunction<Integer,Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertBiObjLongFunc(functionThrowing)
         .doesApply(100,100,100L)
            .to( a -> a.isEqualTo(1));
    }
