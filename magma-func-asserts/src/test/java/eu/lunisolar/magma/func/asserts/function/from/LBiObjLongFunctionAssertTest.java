...
public class LBiObjLongFunctionAssertTest<T1,T2,R,X extends Throwable> {
    ...
    private LBiObjLongFunction<Integer ,Integer ,Integer > function = LBiObjLongFunction.l((a1,a2,a3) ->
            (Integer ) testValue
    );

    private LBiObjLongFunction<Integer ,Integer ,Integer > functionThrowing = LBiObjLongFunction.l((a1,a2,a3) -> {
