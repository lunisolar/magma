...
import eu.lunisolar.magma.func.predicate.LBiObjIntPredicateX;
...
public class LBiObjIntPredicateXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjIntPredicateX<Integer,Integer,X> function = (Integer a1,Integer a2,int a3) ->
            testValue;


    private LBiObjIntPredicateX<Integer,Integer,X> functionThrowing = (Integer a1,Integer a2,int a3) -> {
