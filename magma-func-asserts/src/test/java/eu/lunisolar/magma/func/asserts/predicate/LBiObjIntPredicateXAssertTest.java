...
public class LBiObjIntPredicateXAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjIntPredicateX<Integer ,Integer ,X> function = LBiObjIntPredicateX.lX((a1,a2,a3) ->
            testValue
    );

    private LBiObjIntPredicateX<Integer ,Integer ,X> functionThrowing = LBiObjIntPredicateX.lX((a1,a2,a3) -> {
