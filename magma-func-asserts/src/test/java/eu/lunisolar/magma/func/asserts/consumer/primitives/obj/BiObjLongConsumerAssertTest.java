...
public class BiObjLongConsumerAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjLongConsumer<Integer ,Integer > function = BiObjLongConsumer.l((t1,t2, l) -> {
            externalEffect.set(testValue);
    });

    private BiObjLongConsumer<Integer ,Integer > functionThrowing = BiObjLongConsumer.l((t1,t2, l) -> {
