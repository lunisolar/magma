...
public class LTriBooleanFunctionXAssertTest<R,X extends Throwable> {
    ...
    private LTriBooleanFunctionX<Integer ,X> function = LTriBooleanFunctionX.lX((b1,b2,b3) ->
            (Integer ) testValue
    );

    private LTriBooleanFunctionX<Integer ,X> functionThrowing = LTriBooleanFunctionX.lX((b1,b2,b3) -> {
