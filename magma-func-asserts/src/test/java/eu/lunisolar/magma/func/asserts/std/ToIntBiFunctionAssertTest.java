...
public class ToIntBiFunctionAssertTest<T1,T2> {
    ...
    private ToIntBiFunction<Integer,Integer> function = (Integer a1,Integer a2) ->
            testValue;


    private ToIntBiFunction<Integer,Integer> functionThrowing = (Integer a1,Integer a2) -> {
