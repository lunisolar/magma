...
public class ToIntBiFunctionAssertTest<T1,T2,X extends Throwable> {
    ...
    private java.util.function.ToIntBiFunction<Integer ,Integer > function = ((a1,a2) ->
            testValue
    );

    private java.util.function.ToIntBiFunction<Integer ,Integer > functionThrowing = ((a1,a2) -> {
