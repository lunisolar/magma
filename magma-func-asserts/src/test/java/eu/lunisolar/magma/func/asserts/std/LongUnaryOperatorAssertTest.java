...
public class LongUnaryOperatorAssertTest<X extends Throwable> {
    ...
    private java.util.function.LongUnaryOperator function = (a1 ->
            testValue
    );

    private java.util.function.LongUnaryOperator functionThrowing = (a1 -> {
