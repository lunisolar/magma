...
import eu.lunisolar.magma.func.function.conversion.LShortToIntFunctionX;
...
public class LShortToIntFunctionXAssertTest<X extends ParseException> {
    ...
    private LShortToIntFunctionX<X> function = a1 ->
            testValue;


    private LShortToIntFunctionX<X> functionThrowing = a1 -> {
