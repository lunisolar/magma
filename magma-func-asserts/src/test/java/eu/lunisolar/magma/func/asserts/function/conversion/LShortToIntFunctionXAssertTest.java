...
public class LShortToIntFunctionXAssertTest<X extends Throwable> {
    ...
    private LShortToIntFunctionX<X> function = LShortToIntFunctionX.lX(a1 ->
            testValue
    );

    private LShortToIntFunctionX<X> functionThrowing = LShortToIntFunctionX.lX(a1 -> {
