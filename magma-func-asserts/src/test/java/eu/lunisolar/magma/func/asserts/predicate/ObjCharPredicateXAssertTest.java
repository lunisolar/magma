...
public class ObjCharPredicateXAssertTest<T,X extends ParseException> {
    ...
    private ObjCharPredicateX<Integer ,X> function = ObjCharPredicateX.lX((t, c) -> {
            return testValue;
    });

    private ObjCharPredicateX<Integer ,X> functionThrowing = ObjCharPredicateX.lX((t, c) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(char)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(char)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(char)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(char)81).withException(a -> a
