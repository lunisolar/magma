...
import eu.lunisolar.magma.func.function.conversion.LByteToShortFunctionX;
...
public class LByteToShortFunctionXAssertTest<X extends ParseException> {
    ...
    private LByteToShortFunctionX<X> function = a1 ->
            testValue;


    private LByteToShortFunctionX<X> functionThrowing = a1 -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort((byte)100).withException(a -> a
