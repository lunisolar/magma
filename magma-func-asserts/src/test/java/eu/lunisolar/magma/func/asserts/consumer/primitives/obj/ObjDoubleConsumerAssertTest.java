...
public class ObjDoubleConsumerAssertTest<T,X extends ParseException> {
    ...
    private ObjDoubleConsumer<Integer > function = ObjDoubleConsumer.l((t, d) -> {
            externalEffect.set(testValue);
    });

    private ObjDoubleConsumer<Integer > functionThrowing = ObjDoubleConsumer.l((t, d) -> {
