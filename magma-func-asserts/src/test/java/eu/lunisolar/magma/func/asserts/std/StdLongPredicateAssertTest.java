...
public class StdLongPredicateAssertTest<X extends ParseException> {
    ...
    private java.util.function.LongPredicate function = ((l) -> {
            return testValue;
    });

    private java.util.function.LongPredicate functionThrowing = ((l) -> {
