...
public class ShortToDoubleFunctionXAssertTest<X extends ParseException> {
    ...
    private ShortToDoubleFunctionX<X> function = ShortToDoubleFunctionX.lX((s) -> {
            return testValue;
    });

    private ShortToDoubleFunctionX<X> functionThrowing = ShortToDoubleFunctionX.lX((s) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsDouble((short)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsDouble((short)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsDouble((short)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsDouble((short)80).withException(a -> a
