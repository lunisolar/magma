...
public class ShortToByteFunctionAssertTest<X extends ParseException> {
    ...
    private ShortToByteFunction function = ShortToByteFunction.l((s) -> {
            return testValue;
    });

    private ShortToByteFunction functionThrowing = ShortToByteFunction.l((s) -> {
