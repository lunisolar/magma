...
import eu.lunisolar.magma.func.function.conversion.LCharToFloatFunction;
...
public class LCharToFloatFunctionAssertTest<X extends ParseException> {
    ...
    private LCharToFloatFunction function = a1 ->
            testValue;


    private LCharToFloatFunction functionThrowing = a1 -> {
