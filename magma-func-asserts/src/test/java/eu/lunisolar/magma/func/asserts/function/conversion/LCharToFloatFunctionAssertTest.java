...
public class LCharToFloatFunctionAssertTest<X extends Throwable> {
    ...
    private LCharToFloatFunction function = LCharToFloatFunction.l(a1 ->
            testValue
    );

    private LCharToFloatFunction functionThrowing = LCharToFloatFunction.l(a1 -> {
