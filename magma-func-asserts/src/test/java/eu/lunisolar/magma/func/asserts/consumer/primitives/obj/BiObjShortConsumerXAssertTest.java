...
public class BiObjShortConsumerXAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjShortConsumerX<Integer ,Integer ,X> function = BiObjShortConsumerX.lX((t1,t2, s) -> {
            externalEffect.set(testValue);
    });

    private BiObjShortConsumerX<Integer ,Integer ,X> functionThrowing = BiObjShortConsumerX.lX((t1,t2, s) -> {
