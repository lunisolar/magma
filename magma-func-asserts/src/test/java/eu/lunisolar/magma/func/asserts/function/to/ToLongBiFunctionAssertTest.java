...
public class ToLongBiFunctionAssertTest<T1,T2,X extends ParseException> {
    ...
    private ToLongBiFunction<Integer ,Integer > function = ToLongBiFunction.l((t1,t2) -> {
            return testValue;
    });

    private ToLongBiFunction<Integer ,Integer > functionThrowing = ToLongBiFunction.l((t1,t2) -> {
