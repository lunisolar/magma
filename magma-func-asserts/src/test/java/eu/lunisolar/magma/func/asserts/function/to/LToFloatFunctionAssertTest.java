...
import eu.lunisolar.magma.func.function.to.LToFloatFunction;
...
public class LToFloatFunctionAssertTest<T,X extends ParseException> {
    ...
    private LToFloatFunction<Integer> function = a1 ->
            testValue;


    private LToFloatFunction<Integer> functionThrowing = a1 -> {
