...
public class LToFloatFunctionAssertTest<T,X extends ParseException> {
    ...
    private LToFloatFunction<Integer > function = LToFloatFunction.l((t) -> {
            return testValue;
    });

    private LToFloatFunction<Integer > functionThrowing = LToFloatFunction.l((t) -> {
