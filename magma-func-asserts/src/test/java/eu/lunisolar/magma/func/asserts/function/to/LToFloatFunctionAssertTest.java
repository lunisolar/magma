...
public class LToFloatFunctionAssertTest<T,X extends Throwable> {
    ...
    private LToFloatFunction<Integer > function = LToFloatFunction.l(a1 ->
            testValue
    );

    private LToFloatFunction<Integer > functionThrowing = LToFloatFunction.l(a1 -> {
