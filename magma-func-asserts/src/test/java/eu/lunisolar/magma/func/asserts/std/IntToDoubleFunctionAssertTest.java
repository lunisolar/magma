...
public class IntToDoubleFunctionAssertTest<X extends Throwable> {
    ...
    private java.util.function.IntToDoubleFunction function = (a1 ->
            testValue
    );

    private java.util.function.IntToDoubleFunction functionThrowing = (a1 -> {
