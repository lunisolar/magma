...
public class ObjBooleanFunctionAssertTest<T,R,X extends ParseException> {
    ...
    private ObjBooleanFunction<Integer ,Integer > function = ObjBooleanFunction.l((t, b) -> {
            return (Integer ) testValue;
    });

    private ObjBooleanFunction<Integer ,Integer > functionThrowing = ObjBooleanFunction.l((t, b) -> {
