...
public class ByteBiConsumerXAssertTest<X extends ParseException> {
    ...
    private ByteBiConsumerX<X> function = ByteBiConsumerX.lX((b1,b2) -> {
            externalEffect.set(testValue);
    });

    private ByteBiConsumerX<X> functionThrowing = ByteBiConsumerX.lX((b1,b2) -> {
