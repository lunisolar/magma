...
public class BiObjBooleanPredicateAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjBooleanPredicate<Integer ,Integer > function = BiObjBooleanPredicate.l((t1,t2, b) -> {
            return testValue;
    });

    private BiObjBooleanPredicate<Integer ,Integer > functionThrowing = BiObjBooleanPredicate.l((t1,t2, b) -> {
