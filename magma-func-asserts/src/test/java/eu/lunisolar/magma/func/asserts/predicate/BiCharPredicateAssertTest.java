...
public class BiCharPredicateAssertTest<X extends ParseException> {
    ...
    private BiCharPredicate function = BiCharPredicate.l((c1,c2) -> {
            return testValue;
    });

    private BiCharPredicate functionThrowing = BiCharPredicate.l((c1,c2) -> {
