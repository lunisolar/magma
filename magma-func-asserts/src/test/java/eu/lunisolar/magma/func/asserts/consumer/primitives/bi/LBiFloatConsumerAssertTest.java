...
public class LBiFloatConsumerAssertTest<X extends Throwable> {
    ...
    private LBiFloatConsumer function = LBiFloatConsumer.l((a1,a2) ->
            externalEffect.set(testValue)
    );

    private LBiFloatConsumer functionThrowing = LBiFloatConsumer.l((a1,a2) -> {
