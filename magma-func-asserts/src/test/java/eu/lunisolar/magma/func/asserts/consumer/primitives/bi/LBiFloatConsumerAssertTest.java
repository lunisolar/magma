...
import eu.lunisolar.magma.func.consumer.primitives.bi.LBiFloatConsumer;
...
public class LBiFloatConsumerAssertTest<X extends ParseException> {
    ...
    private LBiFloatConsumer function = (float a1,float a2) ->
            externalEffect.set(testValue);


    private LBiFloatConsumer functionThrowing = (float a1,float a2) -> {
