...
public class FloatToLongFunctionAssertTest<X extends ParseException> {
    ...
    private FloatToLongFunction function = FloatToLongFunction.l((f) -> {
            return testValue;
    });

    private FloatToLongFunction functionThrowing = FloatToLongFunction.l((f) -> {
