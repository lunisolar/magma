...
import eu.lunisolar.magma.func.consumer.primitives.LShortConsumer;
...
public class LShortConsumerAssertTest<X extends ParseException> {
    ...
    private LShortConsumer function = a1 ->
            externalEffect.set(testValue);


    private LShortConsumer functionThrowing = a1 -> {
