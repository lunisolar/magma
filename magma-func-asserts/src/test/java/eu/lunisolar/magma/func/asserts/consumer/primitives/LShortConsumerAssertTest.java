...
public class LShortConsumerAssertTest<X extends Throwable> {
    ...
    private LShortConsumer function = LShortConsumer.l(a1 ->
            externalEffect.set(testValue)
    );

    private LShortConsumer functionThrowing = LShortConsumer.l(a1 -> {
