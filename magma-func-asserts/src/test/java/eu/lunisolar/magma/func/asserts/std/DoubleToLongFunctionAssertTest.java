...
public class DoubleToLongFunctionAssertTest<X extends Throwable> {
    ...
    private java.util.function.DoubleToLongFunction function = (a1 ->
            testValue
    );

    private java.util.function.DoubleToLongFunction functionThrowing = (a1 -> {
