...
public class LDoubleBinaryOperatorXAssertTest<X extends Throwable> {
    ...
    private LDoubleBinaryOperatorX<X> function = LDoubleBinaryOperatorX.lX((a1,a2) ->
            testValue
    );

    private LDoubleBinaryOperatorX<X> functionThrowing = LDoubleBinaryOperatorX.lX((a1,a2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsDouble((double)80,(double)81)
