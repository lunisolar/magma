...
import eu.lunisolar.magma.func.operator.binary.LDoubleBinaryOperatorX;
...
public class LDoubleBinaryOperatorXAssertTest<X extends ParseException> {
    ...
    private LDoubleBinaryOperatorX<X> function = (double a1,double a2) ->
            testValue;


    private LDoubleBinaryOperatorX<X> functionThrowing = (double a1,double a2) -> {
