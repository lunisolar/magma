...
public class LBiObjDoubleFunctionAssertTest<T1,T2,R,X extends Throwable> {
    ...
    private LBiObjDoubleFunction<Integer ,Integer ,Integer > function = LBiObjDoubleFunction.l((a1,a2,a3) ->
            (Integer ) testValue
    );

    private LBiObjDoubleFunction<Integer ,Integer ,Integer > functionThrowing = LBiObjDoubleFunction.l((a1,a2,a3) -> {
