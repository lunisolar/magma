...
import eu.lunisolar.magma.func.function.from.LBiObjDoubleFunction;
...
public class LBiObjDoubleFunctionAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private LBiObjDoubleFunction<Integer,Integer,Integer> function = (Integer a1,Integer a2,double a3) ->
            testValue;


    private LBiObjDoubleFunction<Integer,Integer,Integer> functionThrowing = (Integer a1,Integer a2,double a3) -> {
