...
public class LObjIntToIntFunctionAssertTest<T,X extends Throwable> {
    ...
    private LObjIntToIntFunction<Integer > function = LObjIntToIntFunction.l((a1,a2) ->
            testValue
    );

    private LObjIntToIntFunction<Integer > functionThrowing = LObjIntToIntFunction.l((a1,a2) -> {
