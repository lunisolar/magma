...
import eu.lunisolar.magma.func.function.to.LObjIntToIntFunction;
...
public class LObjIntToIntFunctionAssertTest<T,X extends ParseException> {
    ...
    private LObjIntToIntFunction<Integer> function = (Integer a1,int a2) ->
            testValue;


    private LObjIntToIntFunction<Integer> functionThrowing = (Integer a1,int a2) -> {
