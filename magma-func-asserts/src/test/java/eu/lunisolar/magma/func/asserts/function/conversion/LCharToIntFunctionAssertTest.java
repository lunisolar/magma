...
public class LCharToIntFunctionAssertTest<X extends ParseException> {
    ...
    private LCharToIntFunction function = a1 ->
            testValue;


    private LCharToIntFunction functionThrowing = a1 -> {
