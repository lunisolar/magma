...
public class LCharToIntFunctionAssertTest<X extends Throwable> {
    ...
    private LCharToIntFunction function = LCharToIntFunction.l(a1 ->
            testValue
    );

    private LCharToIntFunction functionThrowing = LCharToIntFunction.l(a1 -> {
