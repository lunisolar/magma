...
public class LIntToCharFunctionXAssertTest<X extends Throwable> {
    ...
    private LIntToCharFunctionX<X> function = LIntToCharFunctionX.lX(a1 ->
            testValue
    );

    private LIntToCharFunctionX<X> functionThrowing = LIntToCharFunctionX.lX(a1 -> {
