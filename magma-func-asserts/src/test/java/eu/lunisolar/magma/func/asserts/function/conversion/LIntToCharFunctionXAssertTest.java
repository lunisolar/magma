...
import eu.lunisolar.magma.func.function.conversion.LIntToCharFunctionX;
...
public class LIntToCharFunctionXAssertTest<X extends ParseException> {
    ...
    private LIntToCharFunctionX<X> function = a1 ->
            testValue;


    private LIntToCharFunctionX<X> functionThrowing = a1 -> {
