...
public class CharToDoubleFunctionAssertTest<X extends ParseException> {
    ...
    private CharToDoubleFunction function = CharToDoubleFunction.l((c) -> {
            return testValue;
    });

    private CharToDoubleFunction functionThrowing = CharToDoubleFunction.l((c) -> {
