...
public class LObjIntDblPredicateAssertTest<T> {
    ...
    private LObjIntDblPredicate<Integer> function = (a1,a2,a3) ->
            testValue;


    private LObjIntDblPredicate<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertObjIntDblPred(functionThrowing)
         .doesTest(100,100,100d)
            .to( a -> a.isEqualTo(1));
    }
