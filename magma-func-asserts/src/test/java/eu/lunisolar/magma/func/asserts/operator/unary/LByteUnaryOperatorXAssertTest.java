...
public class LByteUnaryOperatorXAssertTest<X extends Throwable> {
    ...
    private LByteUnaryOperatorX<X> function = LByteUnaryOperatorX.lX(a1 ->
            testValue
    );

    private LByteUnaryOperatorX<X> functionThrowing = LByteUnaryOperatorX.lX(a1 -> {
