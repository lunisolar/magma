...
import eu.lunisolar.magma.func.operator.unary.LByteUnaryOperatorX;
...
public class LByteUnaryOperatorXAssertTest<X extends ParseException> {
    ...
    private LByteUnaryOperatorX<X> function = a1 ->
            testValue;


    private LByteUnaryOperatorX<X> functionThrowing = a1 -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsByte((byte)100).withException(a -> a
