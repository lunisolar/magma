...
public class LIntToCharFunctionAssertTest<X extends ParseException> {
    ...
    private LIntToCharFunction function = a1 ->
            testValue;


    private LIntToCharFunction functionThrowing = a1 -> {
