...
public class LIntToCharFunctionAssertTest<X extends Throwable> {
    ...
    private LIntToCharFunction function = LIntToCharFunction.l(a1 ->
            testValue
    );

    private LIntToCharFunction functionThrowing = LIntToCharFunction.l(a1 -> {
