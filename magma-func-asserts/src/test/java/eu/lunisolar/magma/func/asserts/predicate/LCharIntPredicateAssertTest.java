...
public class LCharIntPredicateAssertTest {
    ...
    private LCharIntPredicate function = (a1,a2) ->
            testValue;


    private LCharIntPredicate functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertCharIntPred(functionThrowing)
         .doesTest('\u0100',100)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertCharIntPred(functionThrowing)
         .doesTest('\u0100',100).withException(a -> a
