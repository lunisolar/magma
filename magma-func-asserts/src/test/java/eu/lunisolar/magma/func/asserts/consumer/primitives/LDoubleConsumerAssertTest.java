...
public class LDoubleConsumerAssertTest<X extends Throwable> {
    ...
    private LDoubleConsumer function = LDoubleConsumer.l(a1 ->
            externalEffect.set(testValue)
    );

    private LDoubleConsumer functionThrowing = LDoubleConsumer.l(a1 -> {
