...
import eu.lunisolar.magma.func.consumer.primitives.LDoubleConsumer;
...
public class LDoubleConsumerAssertTest<X extends ParseException> {
    ...
    private LDoubleConsumer function = a1 ->
            externalEffect.set(testValue);


    private LDoubleConsumer functionThrowing = a1 -> {
