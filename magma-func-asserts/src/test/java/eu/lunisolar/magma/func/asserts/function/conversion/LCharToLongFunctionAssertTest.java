...
import eu.lunisolar.magma.func.function.conversion.LCharToLongFunction;
...
public class LCharToLongFunctionAssertTest {
    ...
    private LCharToLongFunction function = a ->
            testValue;


    private LCharToLongFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertCharToLongFunc(functionThrowing)
         .doesApplyAsLong('\u0100')
            .to( a -> a.isEqualTo(1));
    }
