...
public class LCharToLongFunctionAssertTest<X extends Throwable> {
    ...
    private LCharToLongFunction function = LCharToLongFunction.l(a1 ->
            testValue
    );

    private LCharToLongFunction functionThrowing = LCharToLongFunction.l(a1 -> {
