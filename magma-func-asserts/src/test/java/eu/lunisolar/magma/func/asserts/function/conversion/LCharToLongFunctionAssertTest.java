...
public class LCharToLongFunctionAssertTest<X extends ParseException> {
    ...
    private LCharToLongFunction function = LCharToLongFunction.l((c) -> {
            return testValue;
    });

    private LCharToLongFunction functionThrowing = LCharToLongFunction.l((c) -> {
