...
public class ObjBooleanPredicateAssertTest<T,X extends ParseException> {
    ...
    private ObjBooleanPredicate<Integer > function = ObjBooleanPredicate.l((t, b) -> {
            return testValue;
    });

    private ObjBooleanPredicate<Integer > functionThrowing = ObjBooleanPredicate.l((t, b) -> {
