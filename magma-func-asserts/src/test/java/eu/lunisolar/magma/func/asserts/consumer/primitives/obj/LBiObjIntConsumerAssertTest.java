...
public class LBiObjIntConsumerAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjIntConsumer<Integer ,Integer > function = LBiObjIntConsumer.l((a1,a2,a3) ->
            externalEffect.set(testValue)
    );

    private LBiObjIntConsumer<Integer ,Integer > functionThrowing = LBiObjIntConsumer.l((a1,a2,a3) -> {
