...
public class LDoubleToFloatFunctionAssertTest<X extends Throwable> {
    ...
    private LDoubleToFloatFunction function = LDoubleToFloatFunction.l(a1 ->
            testValue
    );

    private LDoubleToFloatFunction functionThrowing = LDoubleToFloatFunction.l(a1 -> {
