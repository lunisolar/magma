...
public class LongToIntFunctionAssertTest<X extends ParseException> {
    ...
    private LongToIntFunction function = LongToIntFunction.l((l) -> {
            return testValue;
    });

    private LongToIntFunction functionThrowing = LongToIntFunction.l((l) -> {
