...
public class ObjShortPredicateAssertTest<T,X extends ParseException> {
    ...
    private ObjShortPredicate<Integer > function = ObjShortPredicate.l((t, s) -> {
            return testValue;
    });

    private ObjShortPredicate<Integer > functionThrowing = ObjShortPredicate.l((t, s) -> {
