...
public class LTernaryOperatorXAssertTest<T,X extends Throwable> {
    ...
    private LTernaryOperatorX<Integer ,X> function = LTernaryOperatorX.lX((a1,a2,a3) ->
            (Integer ) testValue
    );

    private LTernaryOperatorX<Integer ,X> functionThrowing = LTernaryOperatorX.lX((a1,a2,a3) -> {
