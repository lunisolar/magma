...
public class LBiLongConsumerAssertTest<X extends ParseException> {
    ...
    private LBiLongConsumer function = (long a1,long a2) ->
            externalEffect.set(testValue);


    private LBiLongConsumer functionThrowing = (long a1,long a2) -> {
