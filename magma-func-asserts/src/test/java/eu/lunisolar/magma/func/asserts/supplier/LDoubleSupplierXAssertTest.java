...
import eu.lunisolar.magma.func.supplier.LDoubleSupplierX;
...
public class LDoubleSupplierXAssertTest<X extends ParseException> {
    ...
    private LDoubleSupplierX<X> function = () ->
            testValue;


    private LDoubleSupplierX<X> functionThrowing = () -> {
