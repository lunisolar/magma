...
public class FloatUnaryOperatorXAssertTest<X extends ParseException> {
    ...
    private FloatUnaryOperatorX<X> function = FloatUnaryOperatorX.lX((f) -> {
            return testValue;
    });

    private FloatUnaryOperatorX<X> functionThrowing = FloatUnaryOperatorX.lX((f) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsFloat((float)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsFloat((float)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsFloat((float)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsFloat((float)80).withException(a -> a
