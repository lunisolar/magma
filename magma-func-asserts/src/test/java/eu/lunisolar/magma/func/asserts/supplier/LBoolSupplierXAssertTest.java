...
public class LBoolSupplierXAssertTest<X extends Throwable> {
    ...
    private LBoolSupplierX<X> function = LBoolSupplierX.lX(() ->
            testValue
    );

    private LBoolSupplierX<X> functionThrowing = LBoolSupplierX.lX(() -> {
