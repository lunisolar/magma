...
import eu.lunisolar.magma.func.supplier.LBoolSupplierX;
...
public class LBoolSupplierXAssertTest<X extends ParseException> {
    ...
    private LBoolSupplierX<X> function = () ->
            testValue;


    private LBoolSupplierX<X> functionThrowing = () -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesGetAsBool().withException(a -> a
