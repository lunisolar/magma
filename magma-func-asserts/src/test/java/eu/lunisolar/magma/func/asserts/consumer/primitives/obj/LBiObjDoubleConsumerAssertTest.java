...
public class LBiObjDoubleConsumerAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjDoubleConsumer<Integer ,Integer > function = LBiObjDoubleConsumer.l((a1,a2,a3) ->
            externalEffect.set(testValue)
    );

    private LBiObjDoubleConsumer<Integer ,Integer > functionThrowing = LBiObjDoubleConsumer.l((a1,a2,a3) -> {
