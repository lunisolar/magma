...
import eu.lunisolar.magma.func.consumer.primitives.obj.LBiObjDoubleConsumer;
...
public class LBiObjDoubleConsumerAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjDoubleConsumer<Integer,Integer> function = (Integer a1,Integer a2,double a3) ->
            externalEffect.set(testValue);


    private LBiObjDoubleConsumer<Integer,Integer> functionThrowing = (Integer a1,Integer a2,double a3) -> {
