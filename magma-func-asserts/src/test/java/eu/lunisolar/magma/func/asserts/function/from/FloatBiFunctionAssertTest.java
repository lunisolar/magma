...
public class FloatBiFunctionAssertTest<R,X extends ParseException> {
    ...
    private FloatBiFunction<Integer > function = FloatBiFunction.l((f1,f2) -> {
            return (Integer ) testValue;
    });

    private FloatBiFunction<Integer > functionThrowing = FloatBiFunction.l((f1,f2) -> {
