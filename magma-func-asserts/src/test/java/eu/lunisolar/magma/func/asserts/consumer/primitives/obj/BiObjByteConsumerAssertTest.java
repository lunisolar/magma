...
public class BiObjByteConsumerAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjByteConsumer<Integer ,Integer > function = BiObjByteConsumer.l((t1,t2, b) -> {
            externalEffect.set(testValue);
    });

    private BiObjByteConsumer<Integer ,Integer > functionThrowing = BiObjByteConsumer.l((t1,t2, b) -> {
