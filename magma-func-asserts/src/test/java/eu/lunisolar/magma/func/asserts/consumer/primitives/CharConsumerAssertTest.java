...
public class CharConsumerAssertTest<X extends ParseException> {
    ...
    private CharConsumer function = CharConsumer.l((c) -> {
            externalEffect.set(testValue);
    });

    private CharConsumer functionThrowing = CharConsumer.l((c) -> {
