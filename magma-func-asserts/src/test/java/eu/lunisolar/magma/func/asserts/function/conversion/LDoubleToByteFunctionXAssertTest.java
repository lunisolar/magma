...
public class LDoubleToByteFunctionXAssertTest<X extends Throwable> {
    ...
    private LDoubleToByteFunctionX<X> function = LDoubleToByteFunctionX.lX(a1 ->
            testValue
    );

    private LDoubleToByteFunctionX<X> functionThrowing = LDoubleToByteFunctionX.lX(a1 -> {
