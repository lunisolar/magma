...
import eu.lunisolar.magma.func.function.conversion.LDoubleToByteFunctionX;
...
public class LDoubleToByteFunctionXAssertTest<X extends ParseException> {
    ...
    private LDoubleToByteFunctionX<X> function = a1 ->
            testValue;


    private LDoubleToByteFunctionX<X> functionThrowing = a1 -> {
