...
public class StdIntFunctionAssertTest<R,X extends ParseException> {
    ...
    private java.util.function.IntFunction<Integer > function = ((i) -> {
            return (Integer ) testValue;
    });

    private java.util.function.IntFunction<Integer > functionThrowing = ((i) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((int)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((int)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((int)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((int)80).withException(a -> a
