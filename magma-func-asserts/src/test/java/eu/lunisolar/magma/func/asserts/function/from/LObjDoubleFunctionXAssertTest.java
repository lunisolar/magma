...
import eu.lunisolar.magma.func.function.from.LObjDoubleFunctionX;
...
public class LObjDoubleFunctionXAssertTest<T,R,X extends ParseException> {
    ...
    private LObjDoubleFunctionX<Integer,Integer,X> function = (Integer a1,double a2) ->
            testValue;


    private LObjDoubleFunctionX<Integer,Integer,X> functionThrowing = (Integer a1,double a2) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply(100,100d).withException(a -> a
