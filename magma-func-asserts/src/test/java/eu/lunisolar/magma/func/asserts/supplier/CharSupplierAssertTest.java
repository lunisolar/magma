...
public class CharSupplierAssertTest<X extends ParseException> {
    ...
    private CharSupplier function = CharSupplier.l(() -> {
            return testValue;
    });

    private CharSupplier functionThrowing = CharSupplier.l(() -> {
