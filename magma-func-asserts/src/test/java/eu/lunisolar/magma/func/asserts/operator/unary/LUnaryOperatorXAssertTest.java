...
public class LUnaryOperatorXAssertTest<T,X extends Throwable> {
    ...
    private LUnaryOperatorX<Integer ,X> function = LUnaryOperatorX.lX(a1 ->
            (Integer ) testValue
    );

    private LUnaryOperatorX<Integer ,X> functionThrowing = LUnaryOperatorX.lX(a1 -> {
