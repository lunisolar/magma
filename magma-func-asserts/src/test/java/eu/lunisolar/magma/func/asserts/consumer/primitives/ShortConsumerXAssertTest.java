...
public class ShortConsumerXAssertTest<X extends ParseException> {
    ...
    private ShortConsumerX<X> function = ShortConsumerX.lX((s) -> {
            externalEffect.set(testValue);
    });

    private ShortConsumerX<X> functionThrowing = ShortConsumerX.lX((s) -> {
