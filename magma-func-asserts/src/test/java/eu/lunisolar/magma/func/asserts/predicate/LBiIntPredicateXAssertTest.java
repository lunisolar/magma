...
import eu.lunisolar.magma.func.predicate.LBiIntPredicateX;
...
public class LBiIntPredicateXAssertTest<X extends ParseException> {
    ...
    private LBiIntPredicateX<X> function = (int a1,int a2) ->
            testValue;


    private LBiIntPredicateX<X> functionThrowing = (int a1,int a2) -> {
