...
public class LBiIntPredicateXAssertTest<X extends Throwable> {
    ...
    private LBiIntPredicateX<X> function = LBiIntPredicateX.lX((a1,a2) ->
            testValue
    );

    private LBiIntPredicateX<X> functionThrowing = LBiIntPredicateX.lX((a1,a2) -> {
