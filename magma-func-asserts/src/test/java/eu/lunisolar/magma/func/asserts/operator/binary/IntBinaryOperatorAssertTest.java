...
public class IntBinaryOperatorAssertTest<X extends ParseException> {
    ...
    private IntBinaryOperator function = IntBinaryOperator.l((i1,i2) -> {
            return testValue;
    });

    private IntBinaryOperator functionThrowing = IntBinaryOperator.l((i1,i2) -> {
