...
public class LLogicalBinaryOperatorXAssertTest<X extends Throwable> {
    ...
    private LLogicalBinaryOperatorX<X> function = LLogicalBinaryOperatorX.lX((b1,b2) ->
            testValue
    );

    private LLogicalBinaryOperatorX<X> functionThrowing = LLogicalBinaryOperatorX.lX((b1,b2) -> {
