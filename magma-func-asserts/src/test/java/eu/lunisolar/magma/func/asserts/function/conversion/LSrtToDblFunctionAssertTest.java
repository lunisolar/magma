...
import eu.lunisolar.magma.func.function.conversion.LSrtToDblFunction;
...
public class LSrtToDblFunctionAssertTest {
    ...
    private LSrtToDblFunction function = a ->
            testValue;


    private LSrtToDblFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertSrtToDblFunc(functionThrowing)
         .doesApplyAsDbl((short)100)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertSrtToDblFunc(functionThrowing)
         .doesApplyAsDbl((short)100).withException(a -> a
