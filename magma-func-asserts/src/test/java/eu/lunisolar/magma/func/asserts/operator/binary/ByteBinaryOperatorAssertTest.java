...
public class ByteBinaryOperatorAssertTest<X extends ParseException> {
    ...
    private ByteBinaryOperator function = ByteBinaryOperator.l((b1,b2) -> {
            return testValue;
    });

    private ByteBinaryOperator functionThrowing = ByteBinaryOperator.l((b1,b2) -> {
