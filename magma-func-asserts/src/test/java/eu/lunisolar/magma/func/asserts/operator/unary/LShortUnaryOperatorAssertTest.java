...
import eu.lunisolar.magma.func.operator.unary.LShortUnaryOperator;
...
public class LShortUnaryOperatorAssertTest<X extends ParseException> {
    ...
    private LShortUnaryOperator function = a1 ->
            testValue;


    private LShortUnaryOperator functionThrowing = a1 -> {
