...
public class LShortUnaryOperatorAssertTest<X extends Throwable> {
    ...
    private LShortUnaryOperator function = LShortUnaryOperator.l(a1 ->
            testValue
    );

    private LShortUnaryOperator functionThrowing = LShortUnaryOperator.l(a1 -> {
