...
public class FloatToDoubleFunctionXAssertTest<X extends ParseException> {
    ...
    private FloatToDoubleFunctionX<X> function = FloatToDoubleFunctionX.lX((f) -> {
            return testValue;
    });

    private FloatToDoubleFunctionX<X> functionThrowing = FloatToDoubleFunctionX.lX((f) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsDouble((float)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsDouble((float)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsDouble((float)80).to( a -> a.isEqualTo(1));
