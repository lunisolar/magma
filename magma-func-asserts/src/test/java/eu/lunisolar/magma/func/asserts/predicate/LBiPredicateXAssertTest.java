...
import eu.lunisolar.magma.func.predicate.LBiPredicateX;
...
public class LBiPredicateXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiPredicateX<Integer,Integer,X> function = (Integer a1,Integer a2) ->
            testValue;


    private LBiPredicateX<Integer,Integer,X> functionThrowing = (Integer a1,Integer a2) -> {
