...
public class LBiPredicateXAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiPredicateX<Integer ,Integer ,X> function = LBiPredicateX.lX((a1,a2) ->
            testValue
    );

    private LBiPredicateX<Integer ,Integer ,X> functionThrowing = LBiPredicateX.lX((a1,a2) -> {
