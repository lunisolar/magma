...
public class LShortPredicateXAssertTest<X extends Throwable> {
    ...
    private LShortPredicateX<X> function = LShortPredicateX.lX(a1 ->
            testValue
    );

    private LShortPredicateX<X> functionThrowing = LShortPredicateX.lX(a1 -> {
