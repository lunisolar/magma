...
import eu.lunisolar.magma.func.predicate.LShortPredicateX;
...
public class LShortPredicateXAssertTest<X extends ParseException> {
    ...
    private LShortPredicateX<X> function = a1 ->
            testValue;


    private LShortPredicateX<X> functionThrowing = a1 -> {
