...
public class LByteSupplierAssertTest<X extends ParseException> {
    ...
    private LByteSupplier function = LByteSupplier.l(() -> {
            return testValue;
    });

    private LByteSupplier functionThrowing = LByteSupplier.l(() -> {
