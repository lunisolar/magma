...
public class LObjDoublePredicateAssertTest<T,X extends Throwable> {
    ...
    private LObjDoublePredicate<Integer > function = LObjDoublePredicate.l((a1,a2) ->
            testValue
    );

    private LObjDoublePredicate<Integer > functionThrowing = LObjDoublePredicate.l((a1,a2) -> {
