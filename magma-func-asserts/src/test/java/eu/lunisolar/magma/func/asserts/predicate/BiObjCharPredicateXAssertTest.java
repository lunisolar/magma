...
public class BiObjCharPredicateXAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjCharPredicateX<Integer ,Integer ,X> function = BiObjCharPredicateX.lX((t1,t2, c) -> {
            return testValue;
    });

    private BiObjCharPredicateX<Integer ,Integer ,X> functionThrowing = BiObjCharPredicateX.lX((t1,t2, c) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(char)82).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(char)82).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(char)82).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(char)82).withException(a -> a
