...
public class LObjIntCharPredicateAssertTest<T> {
    ...
    private LObjIntCharPredicate<Integer> function = (a1,a2,a3) ->
            testValue;


    private LObjIntCharPredicate<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertObjIntCharPred(functionThrowing)
         .doesTest(100,100,'\u0100')
            .to( a -> a.isEqualTo(1));
    }
