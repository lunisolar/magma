...
public class ToLongFunctionXAssertTest<T,X extends ParseException> {
    ...
    private ToLongFunctionX<Integer ,X> function = ToLongFunctionX.lX((t) -> {
            return testValue;
    });

    private ToLongFunctionX<Integer ,X> functionThrowing = ToLongFunctionX.lX((t) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsLong((Integer )Integer.valueOf(80)).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsLong((Integer )Integer.valueOf(80)).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsLong((Integer )Integer.valueOf(80)).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsLong((Integer )Integer.valueOf(80)).withException(a -> a
