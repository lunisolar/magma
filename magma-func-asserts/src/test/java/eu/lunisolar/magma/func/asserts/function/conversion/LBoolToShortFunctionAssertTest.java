...
import eu.lunisolar.magma.func.function.conversion.LBoolToShortFunction;
...
public class LBoolToShortFunctionAssertTest<X extends ParseException> {
    ...
    private LBoolToShortFunction function = a1 ->
            testValue;


    private LBoolToShortFunction functionThrowing = a1 -> {
