...
public class LBoolToShortFunctionAssertTest<X extends Throwable> {
    ...
    private LBoolToShortFunction function = LBoolToShortFunction.l(a1 ->
            testValue
    );

    private LBoolToShortFunction functionThrowing = LBoolToShortFunction.l(a1 -> {
