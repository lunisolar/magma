...
public class LongSupplierXAssertTest<X extends ParseException> {
    ...
    private LongSupplierX<X> function = LongSupplierX.lX(() -> {
            return testValue;
    });

    private LongSupplierX<X> functionThrowing = LongSupplierX.lX(() -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesGetAsLong().to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesGetAsLong().to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesGetAsLong().to( a -> a.isEqualTo(1));
