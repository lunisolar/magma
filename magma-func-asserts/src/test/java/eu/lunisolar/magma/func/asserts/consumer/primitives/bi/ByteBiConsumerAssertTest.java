...
public class ByteBiConsumerAssertTest<X extends ParseException> {
    ...
    private ByteBiConsumer function = ByteBiConsumer.l((b1,b2) -> {
            externalEffect.set(testValue);
    });

    private ByteBiConsumer functionThrowing = ByteBiConsumer.l((b1,b2) -> {
