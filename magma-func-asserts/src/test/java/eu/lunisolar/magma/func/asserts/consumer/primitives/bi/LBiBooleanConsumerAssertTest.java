...
public class LBiBooleanConsumerAssertTest<X extends Throwable> {
    ...
    private LBiBooleanConsumer function = LBiBooleanConsumer.l((b1,b2) ->
            externalEffect.set(testValue)
    );

    private LBiBooleanConsumer functionThrowing = LBiBooleanConsumer.l((b1,b2) -> {
