...
public class ByteSupplierAssertTest<X extends ParseException> {
    ...
    private ByteSupplier function = ByteSupplier.l(() -> {
            return testValue;
    });

    private ByteSupplier functionThrowing = ByteSupplier.l(() -> {
