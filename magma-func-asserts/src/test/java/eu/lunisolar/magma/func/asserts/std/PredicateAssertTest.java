...
public class PredicateAssertTest<T,X extends Throwable> {
    ...
    private java.util.function.Predicate<Integer > function = (a1 ->
            testValue
    );

    private java.util.function.Predicate<Integer > functionThrowing = (a1 -> {
