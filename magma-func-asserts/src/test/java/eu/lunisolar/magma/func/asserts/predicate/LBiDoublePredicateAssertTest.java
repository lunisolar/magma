...
import eu.lunisolar.magma.func.predicate.LBiDoublePredicate;
...
public class LBiDoublePredicateAssertTest<X extends ParseException> {
    ...
    private LBiDoublePredicate function = (double a1,double a2) ->
            testValue;


    private LBiDoublePredicate functionThrowing = (double a1,double a2) -> {
