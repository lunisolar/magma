...
public class ToIntFunctionAssertTest<T,X extends ParseException> {
    ...
    private ToIntFunction<Integer > function = ToIntFunction.l((t) -> {
            return testValue;
    });

    private ToIntFunction<Integer > functionThrowing = ToIntFunction.l((t) -> {
