...
public class FloatToLongFunctionXAssertTest<X extends ParseException> {
    ...
    private FloatToLongFunctionX<X> function = FloatToLongFunctionX.lX((f) -> {
            return testValue;
    });

    private FloatToLongFunctionX<X> functionThrowing = FloatToLongFunctionX.lX((f) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsLong((float)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsLong((float)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsLong((float)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsLong((float)80).withException(a -> a
