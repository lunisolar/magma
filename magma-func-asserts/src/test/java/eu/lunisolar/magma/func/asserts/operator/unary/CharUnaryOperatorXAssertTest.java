...
public class CharUnaryOperatorXAssertTest<X extends ParseException> {
    ...
    private CharUnaryOperatorX<X> function = CharUnaryOperatorX.lX((c) -> {
            return testValue;
    });

    private CharUnaryOperatorX<X> functionThrowing = CharUnaryOperatorX.lX((c) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsChar((char)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsChar((char)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsChar((char)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsChar((char)80).withException(a -> a
