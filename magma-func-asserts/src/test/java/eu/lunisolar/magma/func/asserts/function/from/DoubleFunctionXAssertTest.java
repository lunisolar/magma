...
public class DoubleFunctionXAssertTest<R,X extends ParseException> {
    ...
    private DoubleFunctionX<Integer ,X> function = DoubleFunctionX.lX((d) -> {
            return (Integer ) testValue;
    });

    private DoubleFunctionX<Integer ,X> functionThrowing = DoubleFunctionX.lX((d) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((double)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((double)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((double)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((double)80).withException(a -> a
