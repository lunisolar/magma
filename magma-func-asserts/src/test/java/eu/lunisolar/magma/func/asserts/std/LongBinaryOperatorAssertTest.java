...
public class LongBinaryOperatorAssertTest<X extends Throwable> {
    ...
    private java.util.function.LongBinaryOperator function = ((a1,a2) ->
            testValue
    );

    private java.util.function.LongBinaryOperator functionThrowing = ((a1,a2) -> {
