...
public class LongBinaryOperatorAssertTest {
    ...
    private LongBinaryOperator function = (long a1,long a2) ->
            testValue;


    private LongBinaryOperator functionThrowing = (long a1,long a2) -> {
