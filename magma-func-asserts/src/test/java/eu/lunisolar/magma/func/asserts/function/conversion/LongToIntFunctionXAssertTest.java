...
public class LongToIntFunctionXAssertTest<X extends ParseException> {
    ...
    private LongToIntFunctionX<X> function = LongToIntFunctionX.lX((l) -> {
            return testValue;
    });

    private LongToIntFunctionX<X> functionThrowing = LongToIntFunctionX.lX((l) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsInt((long)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsInt((long)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsInt((long)80).to( a -> a.isEqualTo(1));
