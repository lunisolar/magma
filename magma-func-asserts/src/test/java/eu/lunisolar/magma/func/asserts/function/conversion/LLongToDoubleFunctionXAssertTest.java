...
import eu.lunisolar.magma.func.function.conversion.LLongToDoubleFunctionX;
...
public class LLongToDoubleFunctionXAssertTest<X extends ParseException> {
    ...
    private LLongToDoubleFunctionX<X> function = a1 ->
            testValue;


    private LLongToDoubleFunctionX<X> functionThrowing = a1 -> {
