...
public class LLongToDoubleFunctionXAssertTest<X extends Throwable> {
    ...
    private LLongToDoubleFunctionX<X> function = LLongToDoubleFunctionX.lX(a1 ->
            testValue
    );

    private LLongToDoubleFunctionX<X> functionThrowing = LLongToDoubleFunctionX.lX(a1 -> {
