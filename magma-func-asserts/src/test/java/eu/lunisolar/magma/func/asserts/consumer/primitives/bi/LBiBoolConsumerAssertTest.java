...
public class LBiBoolConsumerAssertTest<X extends Throwable> {
    ...
    private LBiBoolConsumer function = LBiBoolConsumer.l((a1,a2) ->
            externalEffect.set(testValue)
    );

    private LBiBoolConsumer functionThrowing = LBiBoolConsumer.l((a1,a2) -> {
