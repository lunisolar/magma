...
public class ObjIntPredicateXAssertTest<T,X extends ParseException> {
    ...
    private ObjIntPredicateX<Integer ,X> function = ObjIntPredicateX.lX((t, i) -> {
            return testValue;
    });

    private ObjIntPredicateX<Integer ,X> functionThrowing = ObjIntPredicateX.lX((t, i) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(int)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(int)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(int)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(int)81).withException(a -> a
