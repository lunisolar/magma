...
public class LBiObjLongFunctionXAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private LBiObjLongFunctionX<Integer,Integer,Integer,X> function = (a1,a2,a3) ->
            testValue;


    private LBiObjLongFunctionX<Integer,Integer,Integer,X> functionThrowing = (a1,a2,a3) -> {
