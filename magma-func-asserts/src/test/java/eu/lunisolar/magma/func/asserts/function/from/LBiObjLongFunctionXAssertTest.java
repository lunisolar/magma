...
public class LBiObjLongFunctionXAssertTest<T1,T2,R,X extends Throwable> {
    ...
    private LBiObjLongFunctionX<Integer ,Integer ,Integer ,X> function = LBiObjLongFunctionX.lX((a1,a2,a3) ->
            (Integer ) testValue
    );

    private LBiObjLongFunctionX<Integer ,Integer ,Integer ,X> functionThrowing = LBiObjLongFunctionX.lX((a1,a2,a3) -> {
