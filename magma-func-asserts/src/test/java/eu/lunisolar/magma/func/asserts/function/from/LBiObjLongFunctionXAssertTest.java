...
import eu.lunisolar.magma.func.function.from.LBiObjLongFunctionX;
...
public class LBiObjLongFunctionXAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private LBiObjLongFunctionX<Integer,Integer,Integer,X> function = (Integer a1,Integer a2,long a3) ->
            testValue;


    private LBiObjLongFunctionX<Integer,Integer,Integer,X> functionThrowing = (Integer a1,Integer a2,long a3) -> {
