...
public class FloatToDoubleFunctionAssertTest<X extends ParseException> {
    ...
    private FloatToDoubleFunction function = FloatToDoubleFunction.l((f) -> {
            return testValue;
    });

    private FloatToDoubleFunction functionThrowing = FloatToDoubleFunction.l((f) -> {
