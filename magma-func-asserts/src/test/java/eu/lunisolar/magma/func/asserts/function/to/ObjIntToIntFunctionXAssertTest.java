...
public class ObjIntToIntFunctionXAssertTest<T,X extends ParseException> {
    ...
    private ObjIntToIntFunctionX<Integer ,X> function = ObjIntToIntFunctionX.lX((t, i) -> {
            return testValue;
    });

    private ObjIntToIntFunctionX<Integer ,X> functionThrowing = ObjIntToIntFunctionX.lX((t, i) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsInt((Integer )Integer.valueOf(80),(int)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsInt((Integer )Integer.valueOf(80),(int)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsInt((Integer )Integer.valueOf(80),(int)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsInt((Integer )Integer.valueOf(80),(int)81).withException(a -> a
