...
public class IntConsumerXAssertTest<X extends ParseException> {
    ...
    private IntConsumerX<X> function = IntConsumerX.lX((i) -> {
            externalEffect.set(testValue);
    });

    private IntConsumerX<X> functionThrowing = IntConsumerX.lX((i) -> {
