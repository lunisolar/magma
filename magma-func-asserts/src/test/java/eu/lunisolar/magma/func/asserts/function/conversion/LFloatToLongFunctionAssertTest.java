...
public class LFloatToLongFunctionAssertTest<X extends Throwable> {
    ...
    private LFloatToLongFunction function = LFloatToLongFunction.l(a1 ->
            testValue
    );

    private LFloatToLongFunction functionThrowing = LFloatToLongFunction.l(a1 -> {
