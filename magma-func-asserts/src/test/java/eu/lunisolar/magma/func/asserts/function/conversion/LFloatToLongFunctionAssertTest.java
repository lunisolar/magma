...
import eu.lunisolar.magma.func.function.conversion.LFloatToLongFunction;
...
public class LFloatToLongFunctionAssertTest<X extends ParseException> {
    ...
    private LFloatToLongFunction function = a1 ->
            testValue;


    private LFloatToLongFunction functionThrowing = a1 -> {
