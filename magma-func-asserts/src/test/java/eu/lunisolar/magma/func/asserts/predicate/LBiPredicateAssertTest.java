...
public class LBiPredicateAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiPredicate<Integer ,Integer > function = LBiPredicate.l((a1,a2) ->
            testValue
    );

    private LBiPredicate<Integer ,Integer > functionThrowing = LBiPredicate.l((a1,a2) -> {
