...
public class LCharToDoubleFunctionXAssertTest<X extends Throwable> {
    ...
    private LCharToDoubleFunctionX<X> function = LCharToDoubleFunctionX.lX(a1 ->
            testValue
    );

    private LCharToDoubleFunctionX<X> functionThrowing = LCharToDoubleFunctionX.lX(a1 -> {
