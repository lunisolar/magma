...
import eu.lunisolar.magma.func.function.conversion.LCharToDoubleFunctionX;
...
public class LCharToDoubleFunctionXAssertTest<X extends ParseException> {
    ...
    private LCharToDoubleFunctionX<X> function = a1 ->
            testValue;


    private LCharToDoubleFunctionX<X> functionThrowing = a1 -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsDouble('\u0100').withException(a -> a
