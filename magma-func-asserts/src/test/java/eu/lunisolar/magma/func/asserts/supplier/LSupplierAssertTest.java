...
public class LSupplierAssertTest<R,X extends ParseException> {
    ...
    private LSupplier<Integer > function = LSupplier.l(() -> {
            return (Integer ) testValue;
    });

    private LSupplier<Integer > functionThrowing = LSupplier.l(() -> {
