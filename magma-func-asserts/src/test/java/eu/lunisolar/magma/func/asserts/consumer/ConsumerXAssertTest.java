...
public class ConsumerXAssertTest<T,X extends ParseException> {
    ...
    private ConsumerX<Integer ,X> function = ConsumerX.lX((t) -> {
            externalEffect.set(testValue);
    });

    private ConsumerX<Integer ,X> functionThrowing = ConsumerX.lX((t) -> {
