...
public class LTriBooleanFunctionAssertTest<R,X extends Throwable> {
    ...
    private LTriBooleanFunction<Integer > function = LTriBooleanFunction.l((b1,b2,b3) ->
            (Integer ) testValue
    );

    private LTriBooleanFunction<Integer > functionThrowing = LTriBooleanFunction.l((b1,b2,b3) -> {
