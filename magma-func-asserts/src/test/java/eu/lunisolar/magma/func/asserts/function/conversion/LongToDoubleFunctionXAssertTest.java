...
public class LongToDoubleFunctionXAssertTest<X extends ParseException> {
    ...
    private LongToDoubleFunctionX<X> function = LongToDoubleFunctionX.lX((l) -> {
            return testValue;
    });

    private LongToDoubleFunctionX<X> functionThrowing = LongToDoubleFunctionX.lX((l) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsDouble((long)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsDouble((long)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsDouble((long)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsDouble((long)80).withException(a -> a
