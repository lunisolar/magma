...
public class LIntConsumerXAssertTest<X extends Throwable> {
    ...
    private LIntConsumerX<X> function = LIntConsumerX.lX(a1 ->
            externalEffect.set(testValue)
    );

    private LIntConsumerX<X> functionThrowing = LIntConsumerX.lX(a1 -> {
