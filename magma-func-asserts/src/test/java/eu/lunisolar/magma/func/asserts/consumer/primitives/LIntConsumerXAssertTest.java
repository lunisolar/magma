...
import eu.lunisolar.magma.func.consumer.primitives.LIntConsumerX;
...
public class LIntConsumerXAssertTest<X extends ParseException> {
    ...
    private LIntConsumerX<X> function = a1 ->
            externalEffect.set(testValue);


    private LIntConsumerX<X> functionThrowing = a1 -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept(100).withException(a -> a
