...
import eu.lunisolar.magma.func.function.to.LToShortFunctionX;
...
public class LToShortFunctionXAssertTest<T,X extends ParseException> {
    ...
    private LToShortFunctionX<Integer,X> function = a1 ->
            testValue;


    private LToShortFunctionX<Integer,X> functionThrowing = a1 -> {
