...
public class LToShortFunctionXAssertTest<T,X extends Throwable> {
    ...
    private LToShortFunctionX<Integer ,X> function = LToShortFunctionX.lX(a1 ->
            testValue
    );

    private LToShortFunctionX<Integer ,X> functionThrowing = LToShortFunctionX.lX(a1 -> {
