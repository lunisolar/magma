...
public class LFloatToShortFunctionXAssertTest<X extends Throwable> {
    ...
    private LFloatToShortFunctionX<X> function = LFloatToShortFunctionX.lX(a1 ->
            testValue
    );

    private LFloatToShortFunctionX<X> functionThrowing = LFloatToShortFunctionX.lX(a1 -> {
