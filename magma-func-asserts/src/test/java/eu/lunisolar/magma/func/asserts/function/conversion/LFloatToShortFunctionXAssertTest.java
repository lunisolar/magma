...
import eu.lunisolar.magma.func.function.conversion.LFloatToShortFunctionX;
...
public class LFloatToShortFunctionXAssertTest<X extends ParseException> {
    ...
    private LFloatToShortFunctionX<X> function = a1 ->
            testValue;


    private LFloatToShortFunctionX<X> functionThrowing = a1 -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort(100f).withException(a -> a
