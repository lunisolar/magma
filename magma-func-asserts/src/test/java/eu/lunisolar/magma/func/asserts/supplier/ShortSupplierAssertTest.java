...
public class ShortSupplierAssertTest<X extends ParseException> {
    ...
    private ShortSupplier function = ShortSupplier.l(() -> {
            return testValue;
    });

    private ShortSupplier functionThrowing = ShortSupplier.l(() -> {
