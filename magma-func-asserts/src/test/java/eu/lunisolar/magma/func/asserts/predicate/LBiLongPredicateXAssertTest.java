...
public class LBiLongPredicateXAssertTest<X extends ParseException> {
    ...
    private LBiLongPredicateX<X> function = LBiLongPredicateX.lX((l1,l2) -> {
            return testValue;
    });

    private LBiLongPredicateX<X> functionThrowing = LBiLongPredicateX.lX((l1,l2) -> {
