...
import eu.lunisolar.magma.func.predicate.LBiLongPredicateX;
...
public class LBiLongPredicateXAssertTest<X extends ParseException> {
    ...
    private LBiLongPredicateX<X> function = (long a1,long a2) ->
            testValue;


    private LBiLongPredicateX<X> functionThrowing = (long a1,long a2) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest(100L,100L).withException(a -> a
