...
public class LDoubleToShortFunctionAssertTest<X extends Throwable> {
    ...
    private LDoubleToShortFunction function = LDoubleToShortFunction.l(a1 ->
            testValue
    );

    private LDoubleToShortFunction functionThrowing = LDoubleToShortFunction.l(a1 -> {
