...
import eu.lunisolar.magma.func.function.conversion.LDoubleToShortFunction;
...
public class LDoubleToShortFunctionAssertTest<X extends ParseException> {
    ...
    private LDoubleToShortFunction function = a1 ->
            testValue;


    private LDoubleToShortFunction functionThrowing = a1 -> {
