...
public class LLongToCharFunctionAssertTest<X extends ParseException> {
    ...
    private LLongToCharFunction function = a1 ->
            testValue;


    private LLongToCharFunction functionThrowing = a1 -> {
