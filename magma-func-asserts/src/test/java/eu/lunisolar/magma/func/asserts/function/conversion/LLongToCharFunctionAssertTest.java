...
public class LLongToCharFunctionAssertTest<X extends Throwable> {
    ...
    private LLongToCharFunction function = LLongToCharFunction.l(a1 ->
            testValue
    );

    private LLongToCharFunction functionThrowing = LLongToCharFunction.l(a1 -> {
