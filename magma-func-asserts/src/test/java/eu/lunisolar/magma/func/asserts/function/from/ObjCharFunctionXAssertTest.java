...
public class ObjCharFunctionXAssertTest<T,R,X extends ParseException> {
    ...
    private ObjCharFunctionX<Integer ,Integer ,X> function = ObjCharFunctionX.lX((t, c) -> {
            return (Integer ) testValue;
    });

    private ObjCharFunctionX<Integer ,Integer ,X> functionThrowing = ObjCharFunctionX.lX((t, c) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(char)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(char)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(char)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(char)81).withException(a -> a
