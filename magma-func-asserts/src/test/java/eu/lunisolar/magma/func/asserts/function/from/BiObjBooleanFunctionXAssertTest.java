...
public class BiObjBooleanFunctionXAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private BiObjBooleanFunctionX<Integer ,Integer ,Integer ,X> function = BiObjBooleanFunctionX.lX((t1,t2, b) -> {
            return (Integer ) testValue;
    });

    private BiObjBooleanFunctionX<Integer ,Integer ,Integer ,X> functionThrowing = BiObjBooleanFunctionX.lX((t1,t2, b) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),true).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),true).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),true).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),true).withException(a -> a
