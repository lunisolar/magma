...
public class ShortToCharFunctionXAssertTest<X extends ParseException> {
    ...
    private ShortToCharFunctionX<X> function = ShortToCharFunctionX.lX((s) -> {
            return testValue;
    });

    private ShortToCharFunctionX<X> functionThrowing = ShortToCharFunctionX.lX((s) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsChar((short)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsChar((short)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsChar((short)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsChar((short)80).withException(a -> a
