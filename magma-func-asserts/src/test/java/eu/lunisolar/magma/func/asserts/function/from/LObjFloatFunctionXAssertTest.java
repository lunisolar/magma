...
public class LObjFloatFunctionXAssertTest<T,R,X extends Throwable> {
    ...
    private LObjFloatFunctionX<Integer ,Integer ,X> function = LObjFloatFunctionX.lX((a1,a2) ->
            (Integer ) testValue
    );

    private LObjFloatFunctionX<Integer ,Integer ,X> functionThrowing = LObjFloatFunctionX.lX((a1,a2) -> {
