...
import eu.lunisolar.magma.func.function.from.LObjFloatFunctionX;
...
public class LObjFloatFunctionXAssertTest<T,R,X extends ParseException> {
    ...
    private LObjFloatFunctionX<Integer,Integer,X> function = (Integer a1,float a2) ->
            testValue;


    private LObjFloatFunctionX<Integer,Integer,X> functionThrowing = (Integer a1,float a2) -> {
