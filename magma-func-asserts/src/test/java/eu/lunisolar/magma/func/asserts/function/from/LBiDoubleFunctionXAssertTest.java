...
public class LBiDoubleFunctionXAssertTest<R,X extends Throwable> {
    ...
    private LBiDoubleFunctionX<Integer ,X> function = LBiDoubleFunctionX.lX((d1,d2) ->
            (Integer ) testValue
    );

    private LBiDoubleFunctionX<Integer ,X> functionThrowing = LBiDoubleFunctionX.lX((d1,d2) -> {
