...
public class LBiDoubleFunctionXAssertTest<R,X extends Throwable> {
    ...
    private LBiDoubleFunctionX<Integer ,X> function = LBiDoubleFunctionX.lX((a1,a2) ->
            (Integer ) testValue
    );

    private LBiDoubleFunctionX<Integer ,X> functionThrowing = LBiDoubleFunctionX.lX((a1,a2) -> {
