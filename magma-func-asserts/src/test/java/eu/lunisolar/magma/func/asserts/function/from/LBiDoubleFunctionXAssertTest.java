...
import eu.lunisolar.magma.func.function.from.LBiDoubleFunctionX;
...
public class LBiDoubleFunctionXAssertTest<R,X extends ParseException> {
    ...
    private LBiDoubleFunctionX<Integer,X> function = (double a1,double a2) ->
            testValue;


    private LBiDoubleFunctionX<Integer,X> functionThrowing = (double a1,double a2) -> {
