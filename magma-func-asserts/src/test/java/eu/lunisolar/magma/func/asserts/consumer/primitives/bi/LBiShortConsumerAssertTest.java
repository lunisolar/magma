...
public class LBiShortConsumerAssertTest<X extends Throwable> {
    ...
    private LBiShortConsumer function = LBiShortConsumer.l((s1,s2) ->
            externalEffect.set(testValue)
    );

    private LBiShortConsumer functionThrowing = LBiShortConsumer.l((s1,s2) -> {
