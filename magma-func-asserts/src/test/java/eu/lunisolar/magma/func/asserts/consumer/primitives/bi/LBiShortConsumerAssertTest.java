...
import eu.lunisolar.magma.func.consumer.primitives.bi.LBiShortConsumer;
...
public class LBiShortConsumerAssertTest<X extends ParseException> {
    ...
    private LBiShortConsumer function = (short a1,short a2) ->
            externalEffect.set(testValue);


    private LBiShortConsumer functionThrowing = (short a1,short a2) -> {
