...
public class ObjIntToIntFunctionAssertTest<T,X extends ParseException> {
    ...
    private ObjIntToIntFunction<Integer > function = ObjIntToIntFunction.l((t, i) -> {
            return testValue;
    });

    private ObjIntToIntFunction<Integer > functionThrowing = ObjIntToIntFunction.l((t, i) -> {
