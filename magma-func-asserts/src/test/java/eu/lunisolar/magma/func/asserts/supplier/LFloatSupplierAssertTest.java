...
import eu.lunisolar.magma.func.supplier.LFloatSupplier;
...
public class LFloatSupplierAssertTest<X extends ParseException> {
    ...
    private LFloatSupplier function = () ->
            testValue;


    private LFloatSupplier functionThrowing = () -> {
