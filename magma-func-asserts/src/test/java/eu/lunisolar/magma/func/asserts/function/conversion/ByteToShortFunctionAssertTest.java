...
public class ByteToShortFunctionAssertTest<X extends ParseException> {
    ...
    private ByteToShortFunction function = ByteToShortFunction.l((b) -> {
            return testValue;
    });

    private ByteToShortFunction functionThrowing = ByteToShortFunction.l((b) -> {
