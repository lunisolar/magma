...
public class CharBiConsumerAssertTest<X extends ParseException> {
    ...
    private CharBiConsumer function = CharBiConsumer.l((c1,c2) -> {
            externalEffect.set(testValue);
    });

    private CharBiConsumer functionThrowing = CharBiConsumer.l((c1,c2) -> {
