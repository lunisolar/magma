...
public class LLongBinaryOperatorAssertTest<X extends ParseException> {
    ...
    private LLongBinaryOperator function = (long a1,long a2) ->
            testValue;


    private LLongBinaryOperator functionThrowing = (long a1,long a2) -> {
