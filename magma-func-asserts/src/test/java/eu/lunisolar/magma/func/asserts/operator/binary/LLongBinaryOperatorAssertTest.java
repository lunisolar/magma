...
import eu.lunisolar.magma.func.operator.binary.LLongBinaryOperator;
...
public class LLongBinaryOperatorAssertTest {
    ...
    private LLongBinaryOperator function = (a1,a2) ->
            testValue;


    private LLongBinaryOperator functionThrowing = (a1,a2) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertLongBinaryOp(functionThrowing)
         .doesApplyAsLong(100L,100L)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertLongBinaryOp(functionThrowing)
         .doesApplyAsLong(100L,100L).withException(a -> a
