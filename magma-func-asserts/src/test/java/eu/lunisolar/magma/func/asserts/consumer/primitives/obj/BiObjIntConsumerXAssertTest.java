...
public class BiObjIntConsumerXAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjIntConsumerX<Integer ,Integer ,X> function = BiObjIntConsumerX.lX((t1,t2, i) -> {
            externalEffect.set(testValue);
    });

    private BiObjIntConsumerX<Integer ,Integer ,X> functionThrowing = BiObjIntConsumerX.lX((t1,t2, i) -> {
