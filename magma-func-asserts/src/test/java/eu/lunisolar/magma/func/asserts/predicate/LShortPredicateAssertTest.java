...
public class LShortPredicateAssertTest<X extends Throwable> {
    ...
    private LShortPredicate function = LShortPredicate.l(a1 ->
            testValue
    );

    private LShortPredicate functionThrowing = LShortPredicate.l(a1 -> {
