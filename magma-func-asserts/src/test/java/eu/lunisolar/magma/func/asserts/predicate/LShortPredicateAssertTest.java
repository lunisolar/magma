...
public class LShortPredicateAssertTest<X extends ParseException> {
    ...
    private LShortPredicate function = LShortPredicate.l((s) -> {
            return testValue;
    });

    private LShortPredicate functionThrowing = LShortPredicate.l((s) -> {
