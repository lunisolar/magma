...
public class BiIntPredicateXAssertTest<X extends ParseException> {
    ...
    private BiIntPredicateX<X> function = BiIntPredicateX.lX((i1,i2) -> {
            return testValue;
    });

    private BiIntPredicateX<X> functionThrowing = BiIntPredicateX.lX((i1,i2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((int)80,(int)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((int)80,(int)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((int)80,(int)81).to( a -> a.isEqualTo(1));
