...
public class BooleanToDoubleFunctionAssertTest<X extends ParseException> {
    ...
    private BooleanToDoubleFunction function = BooleanToDoubleFunction.l((b) -> {
            return testValue;
    });

    private BooleanToDoubleFunction functionThrowing = BooleanToDoubleFunction.l((b) -> {
