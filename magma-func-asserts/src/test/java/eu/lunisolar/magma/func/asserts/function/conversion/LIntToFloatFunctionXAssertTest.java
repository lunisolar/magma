...
import eu.lunisolar.magma.func.function.conversion.LIntToFloatFunctionX;
...
public class LIntToFloatFunctionXAssertTest<X extends ParseException> {
    ...
    private LIntToFloatFunctionX<X> function = a1 ->
            testValue;


    private LIntToFloatFunctionX<X> functionThrowing = a1 -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsFloat(100).withException(a -> a
