...
import eu.lunisolar.magma.func.consumer.primitives.bi.LBiByteConsumerX;
...
public class LBiByteConsumerXAssertTest<X extends ParseException> {
    ...
    private LBiByteConsumerX<X> function = (byte a1,byte a2) ->
            externalEffect.set(testValue);


    private LBiByteConsumerX<X> functionThrowing = (byte a1,byte a2) -> {
