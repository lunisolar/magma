...
public class LBiByteConsumerXAssertTest<X extends Throwable> {
    ...
    private LBiByteConsumerX<X> function = LBiByteConsumerX.lX((a1,a2) ->
            externalEffect.set(testValue)
    );

    private LBiByteConsumerX<X> functionThrowing = LBiByteConsumerX.lX((a1,a2) -> {
