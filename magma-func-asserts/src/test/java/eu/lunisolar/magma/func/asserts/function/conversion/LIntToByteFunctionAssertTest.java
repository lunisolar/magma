...
public class LIntToByteFunctionAssertTest<X extends Throwable> {
    ...
    private LIntToByteFunction function = LIntToByteFunction.l(a1 ->
            testValue
    );

    private LIntToByteFunction functionThrowing = LIntToByteFunction.l(a1 -> {
