...
public class LIntToByteFunctionAssertTest<X extends ParseException> {
    ...
    private LIntToByteFunction function = a1 ->
            testValue;


    private LIntToByteFunction functionThrowing = a1 -> {
