...
import eu.lunisolar.magma.func.function.from.LBiIntFunctionX;
...
public class LBiIntFunctionXAssertTest<R,X extends ParseException> {
    ...
    private LBiIntFunctionX<Integer,X> function = (int a1,int a2) ->
            testValue;


    private LBiIntFunctionX<Integer,X> functionThrowing = (int a1,int a2) -> {
