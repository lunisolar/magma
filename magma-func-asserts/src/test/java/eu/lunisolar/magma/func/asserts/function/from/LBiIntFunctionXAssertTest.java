...
public class LBiIntFunctionXAssertTest<R,X extends Throwable> {
    ...
    private LBiIntFunctionX<Integer ,X> function = LBiIntFunctionX.lX((i1,i2) ->
            (Integer ) testValue
    );

    private LBiIntFunctionX<Integer ,X> functionThrowing = LBiIntFunctionX.lX((i1,i2) -> {
