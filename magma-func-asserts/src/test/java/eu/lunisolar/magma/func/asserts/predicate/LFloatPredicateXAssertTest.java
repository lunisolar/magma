...
public class LFloatPredicateXAssertTest<X extends Throwable> {
    ...
    private LFloatPredicateX<X> function = LFloatPredicateX.lX(a1 ->
            testValue
    );

    private LFloatPredicateX<X> functionThrowing = LFloatPredicateX.lX(a1 -> {
