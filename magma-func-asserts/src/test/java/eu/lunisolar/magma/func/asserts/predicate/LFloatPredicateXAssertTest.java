...
import eu.lunisolar.magma.func.predicate.LFloatPredicateX;
...
public class LFloatPredicateXAssertTest<X extends ParseException> {
    ...
    private LFloatPredicateX<X> function = a1 ->
            testValue;


    private LFloatPredicateX<X> functionThrowing = a1 -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest(100f).withException(a -> a
