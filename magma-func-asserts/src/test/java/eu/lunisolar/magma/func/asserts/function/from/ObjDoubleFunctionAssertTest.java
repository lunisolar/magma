...
public class ObjDoubleFunctionAssertTest<T,R,X extends ParseException> {
    ...
    private ObjDoubleFunction<Integer ,Integer > function = ObjDoubleFunction.l((t, d) -> {
            return (Integer ) testValue;
    });

    private ObjDoubleFunction<Integer ,Integer > functionThrowing = ObjDoubleFunction.l((t, d) -> {
