...
public class LByteToLongFunctionXAssertTest<X extends Throwable> {
    ...
    private LByteToLongFunctionX<X> function = LByteToLongFunctionX.lX(a1 ->
            testValue
    );

    private LByteToLongFunctionX<X> functionThrowing = LByteToLongFunctionX.lX(a1 -> {
