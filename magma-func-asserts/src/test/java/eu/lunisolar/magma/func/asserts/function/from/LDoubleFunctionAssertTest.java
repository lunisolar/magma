...
import eu.lunisolar.magma.func.function.from.LDoubleFunction;
...
public class LDoubleFunctionAssertTest<R,X extends ParseException> {
    ...
    private LDoubleFunction<Integer> function = a1 ->
            testValue;


    private LDoubleFunction<Integer> functionThrowing = a1 -> {
