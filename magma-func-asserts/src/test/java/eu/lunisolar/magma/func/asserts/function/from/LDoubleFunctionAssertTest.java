...
public class LDoubleFunctionAssertTest<R,X extends Throwable> {
    ...
    private LDoubleFunction<Integer > function = LDoubleFunction.l(a1 ->
            (Integer ) testValue
    );

    private LDoubleFunction<Integer > functionThrowing = LDoubleFunction.l(a1 -> {
