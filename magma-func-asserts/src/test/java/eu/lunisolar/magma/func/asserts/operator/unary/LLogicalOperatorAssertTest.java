...
public class LLogicalOperatorAssertTest<X extends Throwable> {
    ...
    private LLogicalOperator function = LLogicalOperator.l(a1 ->
            testValue
    );

    private LLogicalOperator functionThrowing = LLogicalOperator.l(a1 -> {
