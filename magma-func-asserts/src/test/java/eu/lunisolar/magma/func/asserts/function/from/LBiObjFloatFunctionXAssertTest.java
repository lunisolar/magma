...
public class LBiObjFloatFunctionXAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private LBiObjFloatFunctionX<Integer,Integer,Integer,X> function = (a1,a2,a3) ->
            testValue;


    private LBiObjFloatFunctionX<Integer,Integer,Integer,X> functionThrowing = (a1,a2,a3) -> {
