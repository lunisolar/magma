...
public class LBiObjFloatFunctionXAssertTest<T1,T2,R,X extends Throwable> {
    ...
    private LBiObjFloatFunctionX<Integer ,Integer ,Integer ,X> function = LBiObjFloatFunctionX.lX((a1,a2,a3) ->
            (Integer ) testValue
    );

    private LBiObjFloatFunctionX<Integer ,Integer ,Integer ,X> functionThrowing = LBiObjFloatFunctionX.lX((a1,a2,a3) -> {
