...
import eu.lunisolar.magma.func.function.from.LBiObjFloatFunctionX;
...
public class LBiObjFloatFunctionXAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private LBiObjFloatFunctionX<Integer,Integer,Integer,X> function = (Integer a1,Integer a2,float a3) ->
            testValue;


    private LBiObjFloatFunctionX<Integer,Integer,Integer,X> functionThrowing = (Integer a1,Integer a2,float a3) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply(100,100,100f).withException(a -> a
