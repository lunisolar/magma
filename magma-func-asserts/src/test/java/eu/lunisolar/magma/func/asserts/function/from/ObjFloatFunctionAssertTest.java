...
public class ObjFloatFunctionAssertTest<T,R,X extends ParseException> {
    ...
    private ObjFloatFunction<Integer ,Integer > function = ObjFloatFunction.l((t, f) -> {
            return (Integer ) testValue;
    });

    private ObjFloatFunction<Integer ,Integer > functionThrowing = ObjFloatFunction.l((t, f) -> {
