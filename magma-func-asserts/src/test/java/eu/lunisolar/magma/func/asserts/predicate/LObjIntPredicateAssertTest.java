...
public class LObjIntPredicateAssertTest<T,X extends ParseException> {
    ...
    private LObjIntPredicate<Integer> function = (Integer a1,int a2) ->
            testValue;


    private LObjIntPredicate<Integer> functionThrowing = (Integer a1,int a2) -> {
