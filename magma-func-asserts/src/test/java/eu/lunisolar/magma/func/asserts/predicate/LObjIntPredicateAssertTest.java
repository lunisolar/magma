...
public class LObjIntPredicateAssertTest<T,X extends Throwable> {
    ...
    private LObjIntPredicate<Integer > function = LObjIntPredicate.l((a1,a2) ->
            testValue
    );

    private LObjIntPredicate<Integer > functionThrowing = LObjIntPredicate.l((a1,a2) -> {
