...
public class LObjBytePredicateXAssertTest<T,X extends Throwable> {
    ...
    private LObjBytePredicateX<Integer ,X> function = LObjBytePredicateX.lX((a1,a2) ->
            testValue
    );

    private LObjBytePredicateX<Integer ,X> functionThrowing = LObjBytePredicateX.lX((a1,a2) -> {
