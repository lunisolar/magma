...
public class LCharConsumerAssertTest<X extends Throwable> {
    ...
    private LCharConsumer function = LCharConsumer.l(a1 ->
            externalEffect.set(testValue)
    );

    private LCharConsumer functionThrowing = LCharConsumer.l(a1 -> {
