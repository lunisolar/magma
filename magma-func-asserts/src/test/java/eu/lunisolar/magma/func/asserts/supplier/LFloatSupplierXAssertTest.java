...
import eu.lunisolar.magma.func.supplier.LFloatSupplierX;
...
public class LFloatSupplierXAssertTest<X extends ParseException> {
    ...
    private LFloatSupplierX<X> function = () ->
            testValue;


    private LFloatSupplierX<X> functionThrowing = () -> {
