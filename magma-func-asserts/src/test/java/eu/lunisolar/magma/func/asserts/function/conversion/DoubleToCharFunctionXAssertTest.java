...
public class DoubleToCharFunctionXAssertTest<X extends ParseException> {
    ...
    private DoubleToCharFunctionX<X> function = DoubleToCharFunctionX.lX((d) -> {
            return testValue;
    });

    private DoubleToCharFunctionX<X> functionThrowing = DoubleToCharFunctionX.lX((d) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsChar((double)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsChar((double)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsChar((double)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsChar((double)80).withException(a -> a
