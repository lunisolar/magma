...
public class LIntToByteFunctionXAssertTest<X extends Throwable> {
    ...
    private LIntToByteFunctionX<X> function = LIntToByteFunctionX.lX(a1 ->
            testValue
    );

    private LIntToByteFunctionX<X> functionThrowing = LIntToByteFunctionX.lX(a1 -> {
