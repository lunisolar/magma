...
public class LDoublePredicateXAssertTest<X extends ParseException> {
    ...
    private LDoublePredicateX<X> function = LDoublePredicateX.lX((d) -> {
            return testValue;
    });

    private LDoublePredicateX<X> functionThrowing = LDoublePredicateX.lX((d) -> {
