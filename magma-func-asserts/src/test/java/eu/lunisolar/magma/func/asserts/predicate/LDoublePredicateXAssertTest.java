...
public class LDoublePredicateXAssertTest<X extends Throwable> {
    ...
    private LDoublePredicateX<X> function = LDoublePredicateX.lX(a1 ->
            testValue
    );

    private LDoublePredicateX<X> functionThrowing = LDoublePredicateX.lX(a1 -> {
