...
public class BiObjCharConsumerXAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjCharConsumerX<Integer ,Integer ,X> function = BiObjCharConsumerX.lX((t1,t2, c) -> {
            externalEffect.set(testValue);
    });

    private BiObjCharConsumerX<Integer ,Integer ,X> functionThrowing = BiObjCharConsumerX.lX((t1,t2, c) -> {
