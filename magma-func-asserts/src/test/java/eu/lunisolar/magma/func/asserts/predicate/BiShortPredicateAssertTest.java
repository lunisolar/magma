...
public class BiShortPredicateAssertTest<X extends ParseException> {
    ...
    private BiShortPredicate function = BiShortPredicate.l((s1,s2) -> {
            return testValue;
    });

    private BiShortPredicate functionThrowing = BiShortPredicate.l((s1,s2) -> {
