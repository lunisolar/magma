...
public class LObjIntConsumerAssertTest<T,X extends Throwable> {
    ...
    private LObjIntConsumer<Integer > function = LObjIntConsumer.l((a1,a2) ->
            externalEffect.set(testValue)
    );

    private LObjIntConsumer<Integer > functionThrowing = LObjIntConsumer.l((a1,a2) -> {
