...
public class LPredicateXAssertTest<T,X extends Throwable> {
    ...
    private LPredicateX<Integer ,X> function = LPredicateX.lX(a1 ->
            testValue
    );

    private LPredicateX<Integer ,X> functionThrowing = LPredicateX.lX(a1 -> {
