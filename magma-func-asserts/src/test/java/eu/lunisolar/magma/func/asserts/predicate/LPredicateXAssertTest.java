...
public class LPredicateXAssertTest<T,X extends ParseException> {
    ...
    private LPredicateX<Integer ,X> function = LPredicateX.lX((t) -> {
            return testValue;
    });

    private LPredicateX<Integer ,X> functionThrowing = LPredicateX.lX((t) -> {
