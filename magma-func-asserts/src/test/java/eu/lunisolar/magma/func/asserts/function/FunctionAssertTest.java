...
public class FunctionAssertTest<T,R,X extends ParseException> {
    ...
    private Function<Integer ,Integer > function = Function.l((t) -> {
            return (Integer ) testValue;
    });

    private Function<Integer ,Integer > functionThrowing = Function.l((t) -> {
