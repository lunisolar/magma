...
public class DoubleToByteFunctionAssertTest<X extends ParseException> {
    ...
    private DoubleToByteFunction function = DoubleToByteFunction.l((d) -> {
            return testValue;
    });

    private DoubleToByteFunction functionThrowing = DoubleToByteFunction.l((d) -> {
