...
public class LShortToByteFunctionAssertTest<X extends Throwable> {
    ...
    private LShortToByteFunction function = LShortToByteFunction.l(a1 ->
            testValue
    );

    private LShortToByteFunction functionThrowing = LShortToByteFunction.l(a1 -> {
