...
import eu.lunisolar.magma.func.function.conversion.LShortToByteFunction;
...
public class LShortToByteFunctionAssertTest<X extends ParseException> {
    ...
    private LShortToByteFunction function = a1 ->
            testValue;


    private LShortToByteFunction functionThrowing = a1 -> {
