...
public class UnaryOperatorAssertTest<T,X extends Throwable> {
    ...
    private java.util.function.UnaryOperator<Integer > function = (a1 ->
            (Integer ) testValue
    );

    private java.util.function.UnaryOperator<Integer > functionThrowing = (a1 -> {
