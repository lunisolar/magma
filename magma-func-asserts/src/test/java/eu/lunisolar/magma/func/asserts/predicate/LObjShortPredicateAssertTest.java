...
import eu.lunisolar.magma.func.predicate.LObjShortPredicate;
...
public class LObjShortPredicateAssertTest<T,X extends ParseException> {
    ...
    private LObjShortPredicate<Integer> function = (Integer a1,short a2) ->
            testValue;


    private LObjShortPredicate<Integer> functionThrowing = (Integer a1,short a2) -> {
