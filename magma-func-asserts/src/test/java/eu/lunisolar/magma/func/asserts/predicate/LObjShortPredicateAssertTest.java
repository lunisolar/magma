...
public class LObjShortPredicateAssertTest<T,X extends Throwable> {
    ...
    private LObjShortPredicate<Integer > function = LObjShortPredicate.l((a1,a2) ->
            testValue
    );

    private LObjShortPredicate<Integer > functionThrowing = LObjShortPredicate.l((a1,a2) -> {
