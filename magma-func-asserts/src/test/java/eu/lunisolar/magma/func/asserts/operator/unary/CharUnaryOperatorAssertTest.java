...
public class CharUnaryOperatorAssertTest<X extends ParseException> {
    ...
    private CharUnaryOperator function = CharUnaryOperator.l((c) -> {
            return testValue;
    });

    private CharUnaryOperator functionThrowing = CharUnaryOperator.l((c) -> {
