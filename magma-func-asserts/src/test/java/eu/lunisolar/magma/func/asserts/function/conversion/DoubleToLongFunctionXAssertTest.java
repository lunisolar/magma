...
public class DoubleToLongFunctionXAssertTest<X extends ParseException> {
    ...
    private DoubleToLongFunctionX<X> function = DoubleToLongFunctionX.lX((d) -> {
            return testValue;
    });

    private DoubleToLongFunctionX<X> functionThrowing = DoubleToLongFunctionX.lX((d) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsLong((double)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsLong((double)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsLong((double)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsLong((double)80).withException(a -> a
