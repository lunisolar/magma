...
public class LongPredicateAssertTest<X extends Throwable> {
    ...
    private java.util.function.LongPredicate function = (a1 ->
            testValue
    );

    private java.util.function.LongPredicate functionThrowing = (a1 -> {
