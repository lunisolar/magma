...
import eu.lunisolar.magma.func.function.conversion.LByteToIntFunctionX;
...
public class LByteToIntFunctionXAssertTest<X extends ParseException> {
    ...
    private LByteToIntFunctionX<X> function = a1 ->
            testValue;


    private LByteToIntFunctionX<X> functionThrowing = a1 -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsInt((byte)100).withException(a -> a
