...
public class LByteToIntFunctionXAssertTest<X extends Throwable> {
    ...
    private LByteToIntFunctionX<X> function = LByteToIntFunctionX.lX(a1 ->
            testValue
    );

    private LByteToIntFunctionX<X> functionThrowing = LByteToIntFunctionX.lX(a1 -> {
