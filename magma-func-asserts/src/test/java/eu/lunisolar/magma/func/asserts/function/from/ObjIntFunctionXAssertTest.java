...
public class ObjIntFunctionXAssertTest<T,R,X extends ParseException> {
    ...
    private ObjIntFunctionX<Integer ,Integer ,X> function = ObjIntFunctionX.lX((t, i) -> {
            return (Integer ) testValue;
    });

    private ObjIntFunctionX<Integer ,Integer ,X> functionThrowing = ObjIntFunctionX.lX((t, i) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(int)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(int)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(int)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(int)81).withException(a -> a
