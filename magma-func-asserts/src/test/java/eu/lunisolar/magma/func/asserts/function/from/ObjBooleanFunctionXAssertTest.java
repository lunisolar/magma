...
public class ObjBooleanFunctionXAssertTest<T,R,X extends ParseException> {
    ...
    private ObjBooleanFunctionX<Integer ,Integer ,X> function = ObjBooleanFunctionX.lX((t, b) -> {
            return (Integer ) testValue;
    });

    private ObjBooleanFunctionX<Integer ,Integer ,X> functionThrowing = ObjBooleanFunctionX.lX((t, b) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),true).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),true).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),true).to( a -> a.isEqualTo(1));
