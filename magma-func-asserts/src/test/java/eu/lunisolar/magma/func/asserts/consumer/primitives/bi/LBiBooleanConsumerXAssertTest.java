...
public class LBiBooleanConsumerXAssertTest<X extends Throwable> {
    ...
    private LBiBooleanConsumerX<X> function = LBiBooleanConsumerX.lX((b1,b2) ->
            externalEffect.set(testValue)
    );

    private LBiBooleanConsumerX<X> functionThrowing = LBiBooleanConsumerX.lX((b1,b2) -> {
