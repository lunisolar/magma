...
public class LBiObjCharConsumerAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjCharConsumer<Integer,Integer> function = (Integer a1,Integer a2,char a3) ->
            externalEffect.set(testValue);


    private LBiObjCharConsumer<Integer,Integer> functionThrowing = (Integer a1,Integer a2,char a3) -> {
