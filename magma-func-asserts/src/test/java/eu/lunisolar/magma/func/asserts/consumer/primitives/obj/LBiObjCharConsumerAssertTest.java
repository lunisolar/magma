...
public class LBiObjCharConsumerAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjCharConsumer<Integer ,Integer > function = LBiObjCharConsumer.l((a1,a2,a3) ->
            externalEffect.set(testValue)
    );

    private LBiObjCharConsumer<Integer ,Integer > functionThrowing = LBiObjCharConsumer.l((a1,a2,a3) -> {
