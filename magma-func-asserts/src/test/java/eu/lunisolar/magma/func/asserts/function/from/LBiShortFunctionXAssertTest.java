...
import eu.lunisolar.magma.func.function.from.LBiShortFunctionX;
...
public class LBiShortFunctionXAssertTest<R,X extends ParseException> {
    ...
    private LBiShortFunctionX<Integer,X> function = (short a1,short a2) ->
            testValue;


    private LBiShortFunctionX<Integer,X> functionThrowing = (short a1,short a2) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((short)100,(short)100).withException(a -> a
