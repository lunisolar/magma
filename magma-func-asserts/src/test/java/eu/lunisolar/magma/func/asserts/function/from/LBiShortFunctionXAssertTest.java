...
public class LBiShortFunctionXAssertTest<R,X extends Throwable> {
    ...
    private LBiShortFunctionX<Integer ,X> function = LBiShortFunctionX.lX((a1,a2) ->
            (Integer ) testValue
    );

    private LBiShortFunctionX<Integer ,X> functionThrowing = LBiShortFunctionX.lX((a1,a2) -> {
