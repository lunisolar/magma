...
public class LBiShortFunctionXAssertTest<R,X extends Throwable> {
    ...
    private LBiShortFunctionX<Integer ,X> function = LBiShortFunctionX.lX((s1,s2) ->
            (Integer ) testValue
    );

    private LBiShortFunctionX<Integer ,X> functionThrowing = LBiShortFunctionX.lX((s1,s2) -> {
