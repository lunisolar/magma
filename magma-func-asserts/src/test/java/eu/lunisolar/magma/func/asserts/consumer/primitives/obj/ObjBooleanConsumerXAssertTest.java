...
public class ObjBooleanConsumerXAssertTest<T,X extends ParseException> {
    ...
    private ObjBooleanConsumerX<Integer ,X> function = ObjBooleanConsumerX.lX((t, b) -> {
            externalEffect.set(testValue);
    });

    private ObjBooleanConsumerX<Integer ,X> functionThrowing = ObjBooleanConsumerX.lX((t, b) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesAccept((Integer )Integer.valueOf(80),true)
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept((Integer )Integer.valueOf(80),true).withException(a -> a
