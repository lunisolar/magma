...
import eu.lunisolar.magma.func.consumer.primitives.LCharConsumerX;
...
public class LCharConsumerXAssertTest<X extends ParseException> {
    ...
    private LCharConsumerX<X> function = a1 ->
            externalEffect.set(testValue);


    private LCharConsumerX<X> functionThrowing = a1 -> {
