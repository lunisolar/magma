...
public class LCharConsumerXAssertTest<X extends Throwable> {
    ...
    private LCharConsumerX<X> function = LCharConsumerX.lX(a1 ->
            externalEffect.set(testValue)
    );

    private LCharConsumerX<X> functionThrowing = LCharConsumerX.lX(a1 -> {
