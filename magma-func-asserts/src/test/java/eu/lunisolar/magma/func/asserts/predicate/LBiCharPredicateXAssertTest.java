...
public class LBiCharPredicateXAssertTest<X extends ParseException> {
    ...
    private LBiCharPredicateX<X> function = LBiCharPredicateX.lX((c1,c2) -> {
            return testValue;
    });

    private LBiCharPredicateX<X> functionThrowing = LBiCharPredicateX.lX((c1,c2) -> {
