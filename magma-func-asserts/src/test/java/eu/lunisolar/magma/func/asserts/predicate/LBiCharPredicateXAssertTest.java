...
import eu.lunisolar.magma.func.predicate.LBiCharPredicateX;
...
public class LBiCharPredicateXAssertTest<X extends ParseException> {
    ...
    private LBiCharPredicateX<X> function = (char a1,char a2) ->
            testValue;


    private LBiCharPredicateX<X> functionThrowing = (char a1,char a2) -> {
