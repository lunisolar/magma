...
public class BooleanToLongFunctionAssertTest<X extends ParseException> {
    ...
    private BooleanToLongFunction function = BooleanToLongFunction.l((b) -> {
            return testValue;
    });

    private BooleanToLongFunction functionThrowing = BooleanToLongFunction.l((b) -> {
