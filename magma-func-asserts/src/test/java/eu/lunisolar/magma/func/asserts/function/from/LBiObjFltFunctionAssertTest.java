...
public class LBiObjFltFunctionAssertTest<T1,T2,R> {
    ...
    private LBiObjFltFunction<Integer,Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LBiObjFltFunction<Integer,Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertBiObjFltFunc(functionThrowing)
         .doesApply(100,100,100f)
            .to( a -> a.isEqualTo(1));
    }
