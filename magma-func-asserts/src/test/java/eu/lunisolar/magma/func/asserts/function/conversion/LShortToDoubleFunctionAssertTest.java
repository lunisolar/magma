...
public class LShortToDoubleFunctionAssertTest<X extends Throwable> {
    ...
    private LShortToDoubleFunction function = LShortToDoubleFunction.l(a1 ->
            testValue
    );

    private LShortToDoubleFunction functionThrowing = LShortToDoubleFunction.l(a1 -> {
