...
public class FloatBiConsumerXAssertTest<X extends ParseException> {
    ...
    private FloatBiConsumerX<X> function = FloatBiConsumerX.lX((f1,f2) -> {
            externalEffect.set(testValue);
    });

    private FloatBiConsumerX<X> functionThrowing = FloatBiConsumerX.lX((f1,f2) -> {
