...
public class CharPredicateAssertTest<X extends ParseException> {
    ...
    private CharPredicate function = CharPredicate.l((c) -> {
            return testValue;
    });

    private CharPredicate functionThrowing = CharPredicate.l((c) -> {
