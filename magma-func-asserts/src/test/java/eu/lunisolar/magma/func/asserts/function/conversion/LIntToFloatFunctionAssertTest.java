...
public class LIntToFloatFunctionAssertTest<X extends Throwable> {
    ...
    private LIntToFloatFunction function = LIntToFloatFunction.l(a1 ->
            testValue
    );

    private LIntToFloatFunction functionThrowing = LIntToFloatFunction.l(a1 -> {
