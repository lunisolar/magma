...
public class LIntToFloatFunctionAssertTest<X extends ParseException> {
    ...
    private LIntToFloatFunction function = LIntToFloatFunction.l((i) -> {
            return testValue;
    });

    private LIntToFloatFunction functionThrowing = LIntToFloatFunction.l((i) -> {
