...
import eu.lunisolar.magma.func.supplier.LShortSupplierX;
...
public class LShortSupplierXAssertTest<X extends ParseException> {
    ...
    private LShortSupplierX<X> function = () ->
            testValue;


    private LShortSupplierX<X> functionThrowing = () -> {
