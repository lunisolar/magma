...
public class LObjIntConsumerXAssertTest<T,X extends ParseException> {
    ...
    private LObjIntConsumerX<Integer ,X> function = LObjIntConsumerX.lX((t, i) -> {
            externalEffect.set(testValue);
    });

    private LObjIntConsumerX<Integer ,X> functionThrowing = LObjIntConsumerX.lX((t, i) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesAccept((Integer )Integer.valueOf(80),(int)81)
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept((Integer )Integer.valueOf(80),(int)81).withException(a -> a
