...
import eu.lunisolar.magma.func.consumer.primitives.obj.LObjIntConsumerX;
...
public class LObjIntConsumerXAssertTest<T,X extends ParseException> {
    ...
    private LObjIntConsumerX<Integer,X> function = (Integer a1,int a2) ->
            externalEffect.set(testValue);


    private LObjIntConsumerX<Integer,X> functionThrowing = (Integer a1,int a2) -> {
