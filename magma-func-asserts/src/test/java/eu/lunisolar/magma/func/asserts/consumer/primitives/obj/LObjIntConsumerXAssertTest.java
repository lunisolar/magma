...
public class LObjIntConsumerXAssertTest<T,X extends Throwable> {
    ...
    private LObjIntConsumerX<Integer ,X> function = LObjIntConsumerX.lX((a1,a2) ->
            externalEffect.set(testValue)
    );

    private LObjIntConsumerX<Integer ,X> functionThrowing = LObjIntConsumerX.lX((a1,a2) -> {
