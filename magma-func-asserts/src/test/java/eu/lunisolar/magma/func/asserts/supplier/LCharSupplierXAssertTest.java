...
import eu.lunisolar.magma.func.supplier.LCharSupplierX;
...
public class LCharSupplierXAssertTest<X extends ParseException> {
    ...
    private LCharSupplierX<X> function = () ->
            testValue;


    private LCharSupplierX<X> functionThrowing = () -> {
