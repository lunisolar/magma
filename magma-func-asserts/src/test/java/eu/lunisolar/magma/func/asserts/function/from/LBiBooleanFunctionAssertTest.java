...
public class LBiBooleanFunctionAssertTest<R,X extends Throwable> {
    ...
    private LBiBooleanFunction<Integer > function = LBiBooleanFunction.l((b1,b2) ->
            (Integer ) testValue
    );

    private LBiBooleanFunction<Integer > functionThrowing = LBiBooleanFunction.l((b1,b2) -> {
