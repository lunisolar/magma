...
public class LIntFunctionAssertTest<R,X extends Throwable> {
    ...
    private LIntFunction<Integer > function = LIntFunction.l(a1 ->
            (Integer ) testValue
    );

    private LIntFunction<Integer > functionThrowing = LIntFunction.l(a1 -> {
