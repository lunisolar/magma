...
public class LObjCharPredicateAssertTest<T,X extends Throwable> {
    ...
    private LObjCharPredicate<Integer > function = LObjCharPredicate.l((a1,a2) ->
            testValue
    );

    private LObjCharPredicate<Integer > functionThrowing = LObjCharPredicate.l((a1,a2) -> {
