...
public class CharBiConsumerXAssertTest<X extends ParseException> {
    ...
    private CharBiConsumerX<X> function = CharBiConsumerX.lX((c1,c2) -> {
            externalEffect.set(testValue);
    });

    private CharBiConsumerX<X> functionThrowing = CharBiConsumerX.lX((c1,c2) -> {
