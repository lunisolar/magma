...
public class StdLongUnaryOperatorAssertTest<X extends ParseException> {
    ...
    private java.util.function.LongUnaryOperator function = ((l) -> {
            return testValue;
    });

    private java.util.function.LongUnaryOperator functionThrowing = ((l) -> {
