...
public class LPredicateAssertTest<T,X extends Throwable> {
    ...
    private LPredicate<Integer > function = LPredicate.l(a1 ->
            testValue
    );

    private LPredicate<Integer > functionThrowing = LPredicate.l(a1 -> {
