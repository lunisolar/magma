...
public class ObjShortConsumerXAssertTest<T,X extends ParseException> {
    ...
    private ObjShortConsumerX<Integer ,X> function = ObjShortConsumerX.lX((t, s) -> {
            externalEffect.set(testValue);
    });

    private ObjShortConsumerX<Integer ,X> functionThrowing = ObjShortConsumerX.lX((t, s) -> {
