...
public class LBoolToCharFunctionAssertTest<X extends ParseException> {
    ...
    private LBoolToCharFunction function = a1 ->
            testValue;


    private LBoolToCharFunction functionThrowing = a1 -> {
