...
public class LBoolToCharFunctionAssertTest<X extends Throwable> {
    ...
    private LBoolToCharFunction function = LBoolToCharFunction.l(a1 ->
            testValue
    );

    private LBoolToCharFunction functionThrowing = LBoolToCharFunction.l(a1 -> {
