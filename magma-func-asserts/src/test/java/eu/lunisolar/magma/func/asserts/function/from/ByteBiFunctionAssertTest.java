...
public class ByteBiFunctionAssertTest<R,X extends ParseException> {
    ...
    private ByteBiFunction<Integer > function = ByteBiFunction.l((b1,b2) -> {
            return (Integer ) testValue;
    });

    private ByteBiFunction<Integer > functionThrowing = ByteBiFunction.l((b1,b2) -> {
