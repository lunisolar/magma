...
public class LBiCharPredicateAssertTest<X extends ParseException> {
    ...
    private LBiCharPredicate function = (char a1,char a2) ->
            testValue;


    private LBiCharPredicate functionThrowing = (char a1,char a2) -> {
