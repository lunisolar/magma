...
public class LDoubleToCharFunctionXAssertTest<X extends Throwable> {
    ...
    private LDoubleToCharFunctionX<X> function = LDoubleToCharFunctionX.lX(a1 ->
            testValue
    );

    private LDoubleToCharFunctionX<X> functionThrowing = LDoubleToCharFunctionX.lX(a1 -> {
