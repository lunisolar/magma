...
import eu.lunisolar.magma.func.function.conversion.LDoubleToCharFunctionX;
...
public class LDoubleToCharFunctionXAssertTest<X extends ParseException> {
    ...
    private LDoubleToCharFunctionX<X> function = a1 ->
            testValue;


    private LDoubleToCharFunctionX<X> functionThrowing = a1 -> {
