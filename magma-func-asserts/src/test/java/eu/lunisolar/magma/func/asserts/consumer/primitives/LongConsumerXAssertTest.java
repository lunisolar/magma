...
public class LongConsumerXAssertTest<X extends ParseException> {
    ...
    private LongConsumerX<X> function = LongConsumerX.lX((l) -> {
            externalEffect.set(testValue);
    });

    private LongConsumerX<X> functionThrowing = LongConsumerX.lX((l) -> {
