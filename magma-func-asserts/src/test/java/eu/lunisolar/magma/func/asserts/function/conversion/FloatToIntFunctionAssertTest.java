...
public class FloatToIntFunctionAssertTest<X extends ParseException> {
    ...
    private FloatToIntFunction function = FloatToIntFunction.l((f) -> {
            return testValue;
    });

    private FloatToIntFunction functionThrowing = FloatToIntFunction.l((f) -> {
