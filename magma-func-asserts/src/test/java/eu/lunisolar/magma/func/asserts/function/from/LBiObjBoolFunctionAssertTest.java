...
public class LBiObjBoolFunctionAssertTest<T1,T2,R,X extends Throwable> {
    ...
    private LBiObjBoolFunction<Integer ,Integer ,Integer > function = LBiObjBoolFunction.l((a1,a2,a3) ->
            (Integer ) testValue
    );

    private LBiObjBoolFunction<Integer ,Integer ,Integer > functionThrowing = LBiObjBoolFunction.l((a1,a2,a3) -> {
