...
public class LBiObjBoolFunctionAssertTest<T1,T2,R,X extends Throwable> {
    ...
    private LBiObjBoolFunction<Integer ,Integer ,Integer > function = LBiObjBoolFunction.l((t1,t2, b) ->
            (Integer ) testValue
    );

    private LBiObjBoolFunction<Integer ,Integer ,Integer > functionThrowing = LBiObjBoolFunction.l((t1,t2, b) -> {
