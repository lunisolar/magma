...
public class LBiObjBoolFunctionAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private LBiObjBoolFunction<Integer,Integer,Integer> function = (Integer a1,Integer a2,boolean a3) ->
            testValue;


    private LBiObjBoolFunction<Integer,Integer,Integer> functionThrowing = (Integer a1,Integer a2,boolean a3) -> {
