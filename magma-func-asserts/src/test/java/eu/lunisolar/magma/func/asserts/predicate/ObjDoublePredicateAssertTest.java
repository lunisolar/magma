...
public class ObjDoublePredicateAssertTest<T,X extends ParseException> {
    ...
    private ObjDoublePredicate<Integer > function = ObjDoublePredicate.l((t, d) -> {
            return testValue;
    });

    private ObjDoublePredicate<Integer > functionThrowing = ObjDoublePredicate.l((t, d) -> {
