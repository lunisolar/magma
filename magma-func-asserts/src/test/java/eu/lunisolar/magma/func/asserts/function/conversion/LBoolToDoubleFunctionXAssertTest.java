...
import eu.lunisolar.magma.func.function.conversion.LBoolToDoubleFunctionX;
...
public class LBoolToDoubleFunctionXAssertTest<X extends ParseException> {
    ...
    private LBoolToDoubleFunctionX<X> function = a1 ->
            testValue;


    private LBoolToDoubleFunctionX<X> functionThrowing = a1 -> {
