...
public class LBoolToDoubleFunctionXAssertTest<X extends Throwable> {
    ...
    private LBoolToDoubleFunctionX<X> function = LBoolToDoubleFunctionX.lX(a1 ->
            testValue
    );

    private LBoolToDoubleFunctionX<X> functionThrowing = LBoolToDoubleFunctionX.lX(a1 -> {
