...
public class LByteToCharFunctionAssertTest<X extends ParseException> {
    ...
    private LByteToCharFunction function = a1 ->
            testValue;


    private LByteToCharFunction functionThrowing = a1 -> {
