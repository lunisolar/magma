...
import eu.lunisolar.magma.func.function.conversion.LByteToCharFunction;
...
public class LByteToCharFunctionAssertTest {
    ...
    private LByteToCharFunction function = a ->
            testValue;


    private LByteToCharFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertByteToCharFunc(functionThrowing)
         .doesApplyAsChar((byte)100)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertByteToCharFunc(functionThrowing)
         .doesApplyAsChar((byte)100).withException(a -> a
