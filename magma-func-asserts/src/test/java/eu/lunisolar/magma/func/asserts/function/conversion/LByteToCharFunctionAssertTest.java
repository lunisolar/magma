...
public class LByteToCharFunctionAssertTest<X extends Throwable> {
    ...
    private LByteToCharFunction function = LByteToCharFunction.l(a1 ->
            testValue
    );

    private LByteToCharFunction functionThrowing = LByteToCharFunction.l(a1 -> {
