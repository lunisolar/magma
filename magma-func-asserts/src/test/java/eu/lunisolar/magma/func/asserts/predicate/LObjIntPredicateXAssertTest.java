...
public class LObjIntPredicateXAssertTest<T,X extends Throwable> {
    ...
    private LObjIntPredicateX<Integer ,X> function = LObjIntPredicateX.lX((a1,a2) ->
            testValue
    );

    private LObjIntPredicateX<Integer ,X> functionThrowing = LObjIntPredicateX.lX((a1,a2) -> {
