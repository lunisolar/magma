...
import eu.lunisolar.magma.func.predicate.LObjIntPredicateX;
...
public class LObjIntPredicateXAssertTest<T,X extends ParseException> {
    ...
    private LObjIntPredicateX<Integer,X> function = (Integer a1,int a2) ->
            testValue;


    private LObjIntPredicateX<Integer,X> functionThrowing = (Integer a1,int a2) -> {
