...
public class ObjByteConsumerAssertTest<T,X extends ParseException> {
    ...
    private ObjByteConsumer<Integer > function = ObjByteConsumer.l((t, b) -> {
            externalEffect.set(testValue);
    });

    private ObjByteConsumer<Integer > functionThrowing = ObjByteConsumer.l((t, b) -> {
