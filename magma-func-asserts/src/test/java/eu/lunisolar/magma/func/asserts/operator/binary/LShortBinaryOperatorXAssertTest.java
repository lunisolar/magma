...
public class LShortBinaryOperatorXAssertTest<X extends Throwable> {
    ...
    private LShortBinaryOperatorX<X> function = LShortBinaryOperatorX.lX((a1,a2) ->
            testValue
    );

    private LShortBinaryOperatorX<X> functionThrowing = LShortBinaryOperatorX.lX((a1,a2) -> {
