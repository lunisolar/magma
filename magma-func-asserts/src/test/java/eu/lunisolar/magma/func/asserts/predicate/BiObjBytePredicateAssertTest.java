...
public class BiObjBytePredicateAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjBytePredicate<Integer ,Integer > function = BiObjBytePredicate.l((t1,t2, b) -> {
            return testValue;
    });

    private BiObjBytePredicate<Integer ,Integer > functionThrowing = BiObjBytePredicate.l((t1,t2, b) -> {
