...
public class LongPredicateAssertTest<X extends ParseException> {
    ...
    private LongPredicate function = LongPredicate.l((l) -> {
            return testValue;
    });

    private LongPredicate functionThrowing = LongPredicate.l((l) -> {
