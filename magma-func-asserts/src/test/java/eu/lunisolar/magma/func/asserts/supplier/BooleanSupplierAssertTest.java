...
public class BooleanSupplierAssertTest<X extends ParseException> {
    ...
    private BooleanSupplier function = BooleanSupplier.l(() -> {
            return testValue;
    });

    private BooleanSupplier functionThrowing = BooleanSupplier.l(() -> {
