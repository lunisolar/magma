...
public class LBiIntPredicateAssertTest<X extends Throwable> {
    ...
    private LBiIntPredicate function = LBiIntPredicate.l((a1,a2) ->
            testValue
    );

    private LBiIntPredicate functionThrowing = LBiIntPredicate.l((a1,a2) -> {
