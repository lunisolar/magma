...
public class LToCharFunctionAssertTest<T,X extends ParseException> {
    ...
    private LToCharFunction<Integer > function = LToCharFunction.l((t) -> {
            return testValue;
    });

    private LToCharFunction<Integer > functionThrowing = LToCharFunction.l((t) -> {
