...
public class LToCharFunctionAssertTest<T,X extends Throwable> {
    ...
    private LToCharFunction<Integer > function = LToCharFunction.l(a1 ->
            testValue
    );

    private LToCharFunction<Integer > functionThrowing = LToCharFunction.l(a1 -> {
