...
public class LFloatUnaryOperatorAssertTest<X extends Throwable> {
    ...
    private LFloatUnaryOperator function = LFloatUnaryOperator.l(a1 ->
            testValue
    );

    private LFloatUnaryOperator functionThrowing = LFloatUnaryOperator.l(a1 -> {
