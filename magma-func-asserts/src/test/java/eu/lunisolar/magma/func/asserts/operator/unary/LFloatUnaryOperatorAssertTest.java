...
import eu.lunisolar.magma.func.operator.unary.LFloatUnaryOperator;
...
public class LFloatUnaryOperatorAssertTest<X extends ParseException> {
    ...
    private LFloatUnaryOperator function = a1 ->
            testValue;


    private LFloatUnaryOperator functionThrowing = a1 -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsFloat(100f).withException(a -> a
