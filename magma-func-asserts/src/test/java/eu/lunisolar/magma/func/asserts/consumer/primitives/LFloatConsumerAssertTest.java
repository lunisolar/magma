...
import eu.lunisolar.magma.func.consumer.primitives.LFloatConsumer;
...
public class LFloatConsumerAssertTest<X extends ParseException> {
    ...
    private LFloatConsumer function = a1 ->
            externalEffect.set(testValue);


    private LFloatConsumer functionThrowing = a1 -> {
