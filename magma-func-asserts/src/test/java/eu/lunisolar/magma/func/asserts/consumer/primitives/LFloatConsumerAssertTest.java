...
public class LFloatConsumerAssertTest<X extends Throwable> {
    ...
    private LFloatConsumer function = LFloatConsumer.l(a1 ->
            externalEffect.set(testValue)
    );

    private LFloatConsumer functionThrowing = LFloatConsumer.l(a1 -> {
