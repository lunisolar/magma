...
public class LongBiFunctionXAssertTest<R,X extends ParseException> {
    ...
    private LongBiFunctionX<Integer ,X> function = LongBiFunctionX.lX((l1,l2) -> {
            return (Integer ) testValue;
    });

    private LongBiFunctionX<Integer ,X> functionThrowing = LongBiFunctionX.lX((l1,l2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((long)80,(long)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((long)80,(long)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((long)80,(long)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((long)80,(long)81).withException(a -> a
