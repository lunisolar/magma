...
public class ToLongBiFunctionAssertTest<T1,T2> {
    ...
    private ToLongBiFunction<Integer,Integer> function = (Integer a1,Integer a2) ->
            testValue;


    private ToLongBiFunction<Integer,Integer> functionThrowing = (Integer a1,Integer a2) -> {
