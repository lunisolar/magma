...
public class LBiObjBoolConsumerXAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjBoolConsumerX<Integer ,Integer ,X> function = LBiObjBoolConsumerX.lX((a1,a2,a3) ->
            externalEffect.set(testValue)
    );

    private LBiObjBoolConsumerX<Integer ,Integer ,X> functionThrowing = LBiObjBoolConsumerX.lX((a1,a2,a3) -> {
