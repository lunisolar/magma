...
public class LBiObjBoolConsumerXAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjBoolConsumerX<Integer ,Integer ,X> function = LBiObjBoolConsumerX.lX((t1,t2, b) ->
            externalEffect.set(testValue)
    );

    private LBiObjBoolConsumerX<Integer ,Integer ,X> functionThrowing = LBiObjBoolConsumerX.lX((t1,t2, b) -> {
