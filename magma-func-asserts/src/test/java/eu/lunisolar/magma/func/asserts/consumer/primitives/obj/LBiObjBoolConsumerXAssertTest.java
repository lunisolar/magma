...
import eu.lunisolar.magma.func.consumer.primitives.obj.LBiObjBoolConsumerX;
...
public class LBiObjBoolConsumerXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjBoolConsumerX<Integer,Integer,X> function = (Integer a1,Integer a2,boolean a3) ->
            externalEffect.set(testValue);


    private LBiObjBoolConsumerX<Integer,Integer,X> functionThrowing = (Integer a1,Integer a2,boolean a3) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept(100,100,true).withException(a -> a
