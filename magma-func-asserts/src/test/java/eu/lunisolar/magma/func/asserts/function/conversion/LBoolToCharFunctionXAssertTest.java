...
public class LBoolToCharFunctionXAssertTest<X extends Throwable> {
    ...
    private LBoolToCharFunctionX<X> function = LBoolToCharFunctionX.lX(a1 ->
            testValue
    );

    private LBoolToCharFunctionX<X> functionThrowing = LBoolToCharFunctionX.lX(a1 -> {
