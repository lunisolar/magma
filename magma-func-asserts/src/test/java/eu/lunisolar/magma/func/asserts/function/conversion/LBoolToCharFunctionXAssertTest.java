...
import eu.lunisolar.magma.func.function.conversion.LBoolToCharFunctionX;
...
public class LBoolToCharFunctionXAssertTest<X extends ParseException> {
    ...
    private LBoolToCharFunctionX<X> function = a1 ->
            testValue;


    private LBoolToCharFunctionX<X> functionThrowing = a1 -> {
