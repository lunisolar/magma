...
public class LongBinaryOperatorAssertTest<X extends ParseException> {
    ...
    private LongBinaryOperator function = LongBinaryOperator.l((l1,l2) -> {
            return testValue;
    });

    private LongBinaryOperator functionThrowing = LongBinaryOperator.l((l1,l2) -> {
