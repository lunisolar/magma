...
public class BiBytePredicateAssertTest<X extends ParseException> {
    ...
    private BiBytePredicate function = BiBytePredicate.l((b1,b2) -> {
            return testValue;
    });

    private BiBytePredicate functionThrowing = BiBytePredicate.l((b1,b2) -> {
