...
public class DoubleSupplierAssertTest<X extends ParseException> {
    ...
    private DoubleSupplier function = DoubleSupplier.l(() -> {
            return testValue;
    });

    private DoubleSupplier functionThrowing = DoubleSupplier.l(() -> {
