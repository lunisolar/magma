...
public class BiLongPredicateAssertTest<X extends ParseException> {
    ...
    private BiLongPredicate function = BiLongPredicate.l((l1,l2) -> {
            return testValue;
    });

    private BiLongPredicate functionThrowing = BiLongPredicate.l((l1,l2) -> {
