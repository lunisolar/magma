...
public class DoubleConsumerAssertTest<X extends ParseException> {
    ...
    private DoubleConsumer function = DoubleConsumer.l((d) -> {
            externalEffect.set(testValue);
    });

    private DoubleConsumer functionThrowing = DoubleConsumer.l((d) -> {
