...
public class LFloatFunctionXAssertTest<R,X extends Throwable> {
    ...
    private LFloatFunctionX<Integer ,X> function = LFloatFunctionX.lX(a1 ->
            (Integer ) testValue
    );

    private LFloatFunctionX<Integer ,X> functionThrowing = LFloatFunctionX.lX(a1 -> {
