...
import eu.lunisolar.magma.func.function.from.LFloatFunctionX;
...
public class LFloatFunctionXAssertTest<R,X extends ParseException> {
    ...
    private LFloatFunctionX<Integer,X> function = a1 ->
            testValue;


    private LFloatFunctionX<Integer,X> functionThrowing = a1 -> {
