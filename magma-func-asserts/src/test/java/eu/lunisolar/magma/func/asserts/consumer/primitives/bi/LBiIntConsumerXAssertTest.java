...
import eu.lunisolar.magma.func.consumer.primitives.bi.LBiIntConsumerX;
...
public class LBiIntConsumerXAssertTest<X extends ParseException> {
    ...
    private LBiIntConsumerX<X> function = (int a1,int a2) ->
            externalEffect.set(testValue);


    private LBiIntConsumerX<X> functionThrowing = (int a1,int a2) -> {
