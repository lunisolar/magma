...
public class LBiIntConsumerXAssertTest<X extends Throwable> {
    ...
    private LBiIntConsumerX<X> function = LBiIntConsumerX.lX((a1,a2) ->
            externalEffect.set(testValue)
    );

    private LBiIntConsumerX<X> functionThrowing = LBiIntConsumerX.lX((a1,a2) -> {
