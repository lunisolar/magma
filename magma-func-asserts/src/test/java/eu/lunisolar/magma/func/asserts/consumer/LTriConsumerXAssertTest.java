...
public class LTriConsumerXAssertTest<T1,T2,T3,X extends Throwable> {
    ...
    private LTriConsumerX<Integer ,Integer ,Integer ,X> function = LTriConsumerX.lX((a1,a2,a3) ->
            externalEffect.set(testValue)
    );

    private LTriConsumerX<Integer ,Integer ,Integer ,X> functionThrowing = LTriConsumerX.lX((a1,a2,a3) -> {
