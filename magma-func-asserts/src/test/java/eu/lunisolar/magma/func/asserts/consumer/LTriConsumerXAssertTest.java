...
public class LTriConsumerXAssertTest<T1,T2,T3,X extends ParseException> {
    ...
    private LTriConsumerX<Integer ,Integer ,Integer ,X> function = LTriConsumerX.lX((t1,t2,t3) -> {
            externalEffect.set(testValue);
    });

    private LTriConsumerX<Integer ,Integer ,Integer ,X> functionThrowing = LTriConsumerX.lX((t1,t2,t3) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesAccept((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(Integer )Integer.valueOf(82))
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(Integer )Integer.valueOf(82)).withException(a -> a
