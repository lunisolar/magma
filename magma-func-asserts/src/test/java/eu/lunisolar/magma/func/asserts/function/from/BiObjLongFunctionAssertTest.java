...
public class BiObjLongFunctionAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private BiObjLongFunction<Integer ,Integer ,Integer > function = BiObjLongFunction.l((t1,t2, l) -> {
            return (Integer ) testValue;
    });

    private BiObjLongFunction<Integer ,Integer ,Integer > functionThrowing = BiObjLongFunction.l((t1,t2, l) -> {
