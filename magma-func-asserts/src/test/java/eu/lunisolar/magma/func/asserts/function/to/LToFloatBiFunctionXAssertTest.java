...
public class LToFloatBiFunctionXAssertTest<T1,T2,X extends Throwable> {
    ...
    private LToFloatBiFunctionX<Integer ,Integer ,X> function = LToFloatBiFunctionX.lX((a1,a2) ->
            testValue
    );

    private LToFloatBiFunctionX<Integer ,Integer ,X> functionThrowing = LToFloatBiFunctionX.lX((a1,a2) -> {
