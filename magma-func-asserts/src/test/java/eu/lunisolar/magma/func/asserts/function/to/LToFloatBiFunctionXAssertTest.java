...
import eu.lunisolar.magma.func.function.to.LToFloatBiFunctionX;
...
public class LToFloatBiFunctionXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LToFloatBiFunctionX<Integer,Integer,X> function = (Integer a1,Integer a2) ->
            testValue;


    private LToFloatBiFunctionX<Integer,Integer,X> functionThrowing = (Integer a1,Integer a2) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsFloat(100,100).withException(a -> a
