...
public class LongConsumerAssertTest<X extends Throwable> {
    ...
    private java.util.function.LongConsumer function = (a1 ->
            externalEffect.set(testValue)
    );

    private java.util.function.LongConsumer functionThrowing = (a1 -> {
