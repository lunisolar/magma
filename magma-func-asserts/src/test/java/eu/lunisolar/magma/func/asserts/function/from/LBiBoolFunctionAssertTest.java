...
public class LBiBoolFunctionAssertTest<R,X extends Throwable> {
    ...
    private LBiBoolFunction<Integer > function = LBiBoolFunction.l((b1,b2) ->
            (Integer ) testValue
    );

    private LBiBoolFunction<Integer > functionThrowing = LBiBoolFunction.l((b1,b2) -> {
