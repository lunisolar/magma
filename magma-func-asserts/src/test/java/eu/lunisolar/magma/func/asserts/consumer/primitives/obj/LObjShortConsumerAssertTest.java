...
import eu.lunisolar.magma.func.consumer.primitives.obj.LObjShortConsumer;
...
public class LObjShortConsumerAssertTest<T,X extends ParseException> {
    ...
    private LObjShortConsumer<Integer> function = (Integer a1,short a2) ->
            externalEffect.set(testValue);


    private LObjShortConsumer<Integer> functionThrowing = (Integer a1,short a2) -> {
