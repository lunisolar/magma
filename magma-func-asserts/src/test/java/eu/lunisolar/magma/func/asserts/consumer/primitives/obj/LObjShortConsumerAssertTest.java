...
public class LObjShortConsumerAssertTest<T,X extends Throwable> {
    ...
    private LObjShortConsumer<Integer > function = LObjShortConsumer.l((a1,a2) ->
            externalEffect.set(testValue)
    );

    private LObjShortConsumer<Integer > functionThrowing = LObjShortConsumer.l((a1,a2) -> {
