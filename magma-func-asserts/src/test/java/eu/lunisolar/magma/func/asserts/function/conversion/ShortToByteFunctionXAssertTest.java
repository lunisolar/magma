...
public class ShortToByteFunctionXAssertTest<X extends ParseException> {
    ...
    private ShortToByteFunctionX<X> function = ShortToByteFunctionX.lX((s) -> {
            return testValue;
    });

    private ShortToByteFunctionX<X> functionThrowing = ShortToByteFunctionX.lX((s) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsByte((short)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsByte((short)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsByte((short)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsByte((short)80).withException(a -> a
