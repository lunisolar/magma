...
public class CharBinaryOperatorAssertTest<X extends ParseException> {
    ...
    private CharBinaryOperator function = CharBinaryOperator.l((c1,c2) -> {
            return testValue;
    });

    private CharBinaryOperator functionThrowing = CharBinaryOperator.l((c1,c2) -> {
