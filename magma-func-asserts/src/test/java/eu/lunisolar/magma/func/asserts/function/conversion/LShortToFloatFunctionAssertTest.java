...
public class LShortToFloatFunctionAssertTest<X extends Throwable> {
    ...
    private LShortToFloatFunction function = LShortToFloatFunction.l(a1 ->
            testValue
    );

    private LShortToFloatFunction functionThrowing = LShortToFloatFunction.l(a1 -> {
