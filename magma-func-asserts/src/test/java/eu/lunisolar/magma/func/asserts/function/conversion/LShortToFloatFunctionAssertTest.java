...
import eu.lunisolar.magma.func.function.conversion.LShortToFloatFunction;
...
public class LShortToFloatFunctionAssertTest<X extends ParseException> {
    ...
    private LShortToFloatFunction function = a1 ->
            testValue;


    private LShortToFloatFunction functionThrowing = a1 -> {
