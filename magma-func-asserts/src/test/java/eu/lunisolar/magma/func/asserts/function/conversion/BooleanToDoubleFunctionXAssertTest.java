...
public class BooleanToDoubleFunctionXAssertTest<X extends ParseException> {
    ...
    private BooleanToDoubleFunctionX<X> function = BooleanToDoubleFunctionX.lX((b) -> {
            return testValue;
    });

    private BooleanToDoubleFunctionX<X> functionThrowing = BooleanToDoubleFunctionX.lX((b) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsDouble(true).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsDouble(true).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsDouble(true).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsDouble(true).withException(a -> a
