...
import eu.lunisolar.magma.func.predicate.LBiDoublePredicateX;
...
public class LBiDoublePredicateXAssertTest<X extends ParseException> {
    ...
    private LBiDoublePredicateX<X> function = (double a1,double a2) ->
            testValue;


    private LBiDoublePredicateX<X> functionThrowing = (double a1,double a2) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest(100d,100d).withException(a -> a
