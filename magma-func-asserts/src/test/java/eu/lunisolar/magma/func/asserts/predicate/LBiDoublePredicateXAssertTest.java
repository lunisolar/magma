...
public class LBiDoublePredicateXAssertTest<X extends Throwable> {
    ...
    private LBiDoublePredicateX<X> function = LBiDoublePredicateX.lX((a1,a2) ->
            testValue
    );

    private LBiDoublePredicateX<X> functionThrowing = LBiDoublePredicateX.lX((a1,a2) -> {
