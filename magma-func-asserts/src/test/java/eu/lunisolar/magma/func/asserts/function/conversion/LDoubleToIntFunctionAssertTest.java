...
import eu.lunisolar.magma.func.function.conversion.LDoubleToIntFunction;
...
public class LDoubleToIntFunctionAssertTest<X extends ParseException> {
    ...
    private LDoubleToIntFunction function = a1 ->
            testValue;


    private LDoubleToIntFunction functionThrowing = a1 -> {
