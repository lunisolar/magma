...
public class LDoubleToIntFunctionAssertTest<X extends Throwable> {
    ...
    private LDoubleToIntFunction function = LDoubleToIntFunction.l(a1 ->
            testValue
    );

    private LDoubleToIntFunction functionThrowing = LDoubleToIntFunction.l(a1 -> {
