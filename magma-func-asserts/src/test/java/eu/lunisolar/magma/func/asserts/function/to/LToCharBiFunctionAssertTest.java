...
public class LToCharBiFunctionAssertTest<T1,T2,X extends Throwable> {
    ...
    private LToCharBiFunction<Integer ,Integer > function = LToCharBiFunction.l((a1,a2) ->
            testValue
    );

    private LToCharBiFunction<Integer ,Integer > functionThrowing = LToCharBiFunction.l((a1,a2) -> {
