...
public class LToCharBiFunctionAssertTest<T1,T2,X extends ParseException> {
    ...
    private LToCharBiFunction<Integer,Integer> function = (Integer a1,Integer a2) ->
            testValue;


    private LToCharBiFunction<Integer,Integer> functionThrowing = (Integer a1,Integer a2) -> {
