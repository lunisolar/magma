...
public class LToCharBiFunctionAssertTest<T1,T2,X extends ParseException> {
    ...
    private LToCharBiFunction<Integer ,Integer > function = LToCharBiFunction.l((t1,t2) -> {
            return testValue;
    });

    private LToCharBiFunction<Integer ,Integer > functionThrowing = LToCharBiFunction.l((t1,t2) -> {
