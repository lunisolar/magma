...
import eu.lunisolar.magma.func.function.conversion.LFloatToByteFunctionX;
...
public class LFloatToByteFunctionXAssertTest<X extends ParseException> {
    ...
    private LFloatToByteFunctionX<X> function = a1 ->
            testValue;


    private LFloatToByteFunctionX<X> functionThrowing = a1 -> {
