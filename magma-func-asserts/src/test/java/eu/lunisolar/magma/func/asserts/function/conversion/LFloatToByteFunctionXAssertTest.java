...
public class LFloatToByteFunctionXAssertTest<X extends Throwable> {
    ...
    private LFloatToByteFunctionX<X> function = LFloatToByteFunctionX.lX(a1 ->
            testValue
    );

    private LFloatToByteFunctionX<X> functionThrowing = LFloatToByteFunctionX.lX(a1 -> {
