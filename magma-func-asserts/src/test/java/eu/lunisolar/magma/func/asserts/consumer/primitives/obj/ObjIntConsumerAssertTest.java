...
public class ObjIntConsumerAssertTest<T,X extends ParseException> {
    ...
    private ObjIntConsumer<Integer > function = ObjIntConsumer.l((t, i) -> {
            externalEffect.set(testValue);
    });

    private ObjIntConsumer<Integer > functionThrowing = ObjIntConsumer.l((t, i) -> {
