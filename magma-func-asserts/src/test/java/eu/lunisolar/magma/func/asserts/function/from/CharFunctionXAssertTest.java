...
public class CharFunctionXAssertTest<R,X extends ParseException> {
    ...
    private CharFunctionX<Integer ,X> function = CharFunctionX.lX((c) -> {
            return (Integer ) testValue;
    });

    private CharFunctionX<Integer ,X> functionThrowing = CharFunctionX.lX((c) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((char)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((char)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((char)80).to( a -> a.isEqualTo(1));
