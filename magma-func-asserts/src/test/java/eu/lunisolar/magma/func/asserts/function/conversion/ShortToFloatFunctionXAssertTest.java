...
public class ShortToFloatFunctionXAssertTest<X extends ParseException> {
    ...
    private ShortToFloatFunctionX<X> function = ShortToFloatFunctionX.lX((s) -> {
            return testValue;
    });

    private ShortToFloatFunctionX<X> functionThrowing = ShortToFloatFunctionX.lX((s) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsFloat((short)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsFloat((short)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsFloat((short)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsFloat((short)80).withException(a -> a
