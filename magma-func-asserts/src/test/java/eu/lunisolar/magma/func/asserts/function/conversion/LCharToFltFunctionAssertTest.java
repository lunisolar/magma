...
import eu.lunisolar.magma.func.function.conversion.LCharToFltFunction;
...
public class LCharToFltFunctionAssertTest {
    ...
    private LCharToFltFunction function = a ->
            testValue;


    private LCharToFltFunction functionThrowing = a -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertCharToFltFunc(functionThrowing)
         .doesApplyAsFlt('\u0100')
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertCharToFltFunc(functionThrowing)
         .doesApplyAsFlt('\u0100').withException(a -> a
