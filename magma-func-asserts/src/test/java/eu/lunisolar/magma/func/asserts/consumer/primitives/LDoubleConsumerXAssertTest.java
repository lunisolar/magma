...
import eu.lunisolar.magma.func.consumer.primitives.LDoubleConsumerX;
...
public class LDoubleConsumerXAssertTest<X extends ParseException> {
    ...
    private LDoubleConsumerX<X> function = a1 ->
            externalEffect.set(testValue);


    private LDoubleConsumerX<X> functionThrowing = a1 -> {
