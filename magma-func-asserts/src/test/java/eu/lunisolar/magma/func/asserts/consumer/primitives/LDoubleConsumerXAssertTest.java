...
public class LDoubleConsumerXAssertTest<X extends Throwable> {
    ...
    private LDoubleConsumerX<X> function = LDoubleConsumerX.lX(a1 ->
            externalEffect.set(testValue)
    );

    private LDoubleConsumerX<X> functionThrowing = LDoubleConsumerX.lX(a1 -> {
