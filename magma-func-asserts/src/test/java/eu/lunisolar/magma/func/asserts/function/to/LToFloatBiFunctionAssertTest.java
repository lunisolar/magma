...
import eu.lunisolar.magma.func.function.to.LToFloatBiFunction;
...
public class LToFloatBiFunctionAssertTest<T1,T2,X extends ParseException> {
    ...
    private LToFloatBiFunction<Integer,Integer> function = (Integer a1,Integer a2) ->
            testValue;


    private LToFloatBiFunction<Integer,Integer> functionThrowing = (Integer a1,Integer a2) -> {
