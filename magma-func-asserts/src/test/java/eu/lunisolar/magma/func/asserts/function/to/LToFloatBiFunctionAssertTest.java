...
public class LToFloatBiFunctionAssertTest<T1,T2,X extends Throwable> {
    ...
    private LToFloatBiFunction<Integer ,Integer > function = LToFloatBiFunction.l((a1,a2) ->
            testValue
    );

    private LToFloatBiFunction<Integer ,Integer > functionThrowing = LToFloatBiFunction.l((a1,a2) -> {
