...
public class LBiFloatPredicateAssertTest<X extends Throwable> {
    ...
    private LBiFloatPredicate function = LBiFloatPredicate.l((a1,a2) ->
            testValue
    );

    private LBiFloatPredicate functionThrowing = LBiFloatPredicate.l((a1,a2) -> {
