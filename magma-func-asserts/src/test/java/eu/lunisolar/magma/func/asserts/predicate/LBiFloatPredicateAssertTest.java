...
import eu.lunisolar.magma.func.predicate.LBiFloatPredicate;
...
public class LBiFloatPredicateAssertTest<X extends ParseException> {
    ...
    private LBiFloatPredicate function = (float a1,float a2) ->
            testValue;


    private LBiFloatPredicate functionThrowing = (float a1,float a2) -> {
