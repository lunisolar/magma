...
import eu.lunisolar.magma.func.consumer.primitives.obj.LBiObjShortConsumer;
...
public class LBiObjShortConsumerAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjShortConsumer<Integer,Integer> function = (Integer a1,Integer a2,short a3) ->
            externalEffect.set(testValue);


    private LBiObjShortConsumer<Integer,Integer> functionThrowing = (Integer a1,Integer a2,short a3) -> {
