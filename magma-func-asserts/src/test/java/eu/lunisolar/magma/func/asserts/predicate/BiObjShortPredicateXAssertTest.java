...
public class BiObjShortPredicateXAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjShortPredicateX<Integer ,Integer ,X> function = BiObjShortPredicateX.lX((t1,t2, s) -> {
            return testValue;
    });

    private BiObjShortPredicateX<Integer ,Integer ,X> functionThrowing = BiObjShortPredicateX.lX((t1,t2, s) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(short)82).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(short)82).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(short)82).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(short)82).withException(a -> a
