...
public class LLongToFloatFunctionXAssertTest<X extends Throwable> {
    ...
    private LLongToFloatFunctionX<X> function = LLongToFloatFunctionX.lX(a1 ->
            testValue
    );

    private LLongToFloatFunctionX<X> functionThrowing = LLongToFloatFunctionX.lX(a1 -> {
