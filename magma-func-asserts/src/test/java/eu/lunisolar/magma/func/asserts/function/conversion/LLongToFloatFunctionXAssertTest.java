...
import eu.lunisolar.magma.func.function.conversion.LLongToFloatFunctionX;
...
public class LLongToFloatFunctionXAssertTest<X extends ParseException> {
    ...
    private LLongToFloatFunctionX<X> function = a1 ->
            testValue;


    private LLongToFloatFunctionX<X> functionThrowing = a1 -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsFloat(100L).withException(a -> a
