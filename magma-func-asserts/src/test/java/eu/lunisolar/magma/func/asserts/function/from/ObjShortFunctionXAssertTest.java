...
public class ObjShortFunctionXAssertTest<T,R,X extends ParseException> {
    ...
    private ObjShortFunctionX<Integer ,Integer ,X> function = ObjShortFunctionX.lX((t, s) -> {
            return (Integer ) testValue;
    });

    private ObjShortFunctionX<Integer ,Integer ,X> functionThrowing = ObjShortFunctionX.lX((t, s) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(short)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(short)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(short)81).to( a -> a.isEqualTo(1));
