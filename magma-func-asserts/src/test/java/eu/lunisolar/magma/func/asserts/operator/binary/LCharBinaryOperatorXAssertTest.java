...
import eu.lunisolar.magma.func.operator.binary.LCharBinaryOperatorX;
...
public class LCharBinaryOperatorXAssertTest<X extends ParseException> {
    ...
    private LCharBinaryOperatorX<X> function = (char a1,char a2) ->
            testValue;


    private LCharBinaryOperatorX<X> functionThrowing = (char a1,char a2) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsChar('\u0100','\u0100').withException(a -> a
