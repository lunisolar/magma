...
import eu.lunisolar.magma.func.function.to.LToShortBiFunction;
...
public class LToShortBiFunctionAssertTest<T1,T2,X extends ParseException> {
    ...
    private LToShortBiFunction<Integer,Integer> function = (Integer a1,Integer a2) ->
            testValue;


    private LToShortBiFunction<Integer,Integer> functionThrowing = (Integer a1,Integer a2) -> {
