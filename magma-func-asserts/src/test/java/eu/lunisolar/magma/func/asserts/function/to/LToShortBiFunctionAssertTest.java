...
public class LToShortBiFunctionAssertTest<T1,T2,X extends Throwable> {
    ...
    private LToShortBiFunction<Integer ,Integer > function = LToShortBiFunction.l((a1,a2) ->
            testValue
    );

    private LToShortBiFunction<Integer ,Integer > functionThrowing = LToShortBiFunction.l((a1,a2) -> {
