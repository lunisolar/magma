...
public class LLongUnaryOperatorXAssertTest<X extends Throwable> {
    ...
    private LLongUnaryOperatorX<X> function = LLongUnaryOperatorX.lX(a1 ->
            testValue
    );

    private LLongUnaryOperatorX<X> functionThrowing = LLongUnaryOperatorX.lX(a1 -> {
