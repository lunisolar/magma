...
public class LongBiConsumerXAssertTest<X extends ParseException> {
    ...
    private LongBiConsumerX<X> function = LongBiConsumerX.lX((l1,l2) -> {
            externalEffect.set(testValue);
    });

    private LongBiConsumerX<X> functionThrowing = LongBiConsumerX.lX((l1,l2) -> {
