...
public class BiObjByteFunctionXAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private BiObjByteFunctionX<Integer ,Integer ,Integer ,X> function = BiObjByteFunctionX.lX((t1,t2, i) -> {
            return (Integer ) testValue;
    });

    private BiObjByteFunctionX<Integer ,Integer ,Integer ,X> functionThrowing = BiObjByteFunctionX.lX((t1,t2, i) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(byte)82).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(byte)82).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(byte)82).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(byte)82).withException(a -> a
