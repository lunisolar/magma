...
public class CharToFloatFunctionAssertTest<X extends ParseException> {
    ...
    private CharToFloatFunction function = CharToFloatFunction.l((c) -> {
            return testValue;
    });

    private CharToFloatFunction functionThrowing = CharToFloatFunction.l((c) -> {
