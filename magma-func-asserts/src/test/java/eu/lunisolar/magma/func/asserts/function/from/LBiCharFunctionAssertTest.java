...
public class LBiCharFunctionAssertTest<R,X extends ParseException> {
    ...
    private LBiCharFunction<Integer> function = (char a1,char a2) ->
            testValue;


    private LBiCharFunction<Integer> functionThrowing = (char a1,char a2) -> {
