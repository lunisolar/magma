...
public class LBiCharFunctionAssertTest<R,X extends Throwable> {
    ...
    private LBiCharFunction<Integer > function = LBiCharFunction.l((c1,c2) ->
            (Integer ) testValue
    );

    private LBiCharFunction<Integer > functionThrowing = LBiCharFunction.l((c1,c2) -> {
