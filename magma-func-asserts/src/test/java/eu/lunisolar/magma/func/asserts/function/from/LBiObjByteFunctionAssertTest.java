...
public class LBiObjByteFunctionAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private LBiObjByteFunction<Integer,Integer,Integer> function = (Integer a1,Integer a2,byte a3) ->
            testValue;


    private LBiObjByteFunction<Integer,Integer,Integer> functionThrowing = (Integer a1,Integer a2,byte a3) -> {
