...
public class LBiObjByteFunctionAssertTest<T1,T2,R,X extends Throwable> {
    ...
    private LBiObjByteFunction<Integer ,Integer ,Integer > function = LBiObjByteFunction.l((a1,a2,a3) ->
            (Integer ) testValue
    );

    private LBiObjByteFunction<Integer ,Integer ,Integer > functionThrowing = LBiObjByteFunction.l((a1,a2,a3) -> {
