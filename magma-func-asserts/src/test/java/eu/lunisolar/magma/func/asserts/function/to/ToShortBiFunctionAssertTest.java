...
public class ToShortBiFunctionAssertTest<T1,T2,X extends ParseException> {
    ...
    private ToShortBiFunction<Integer ,Integer > function = ToShortBiFunction.l((t1,t2) -> {
            return testValue;
    });

    private ToShortBiFunction<Integer ,Integer > functionThrowing = ToShortBiFunction.l((t1,t2) -> {
