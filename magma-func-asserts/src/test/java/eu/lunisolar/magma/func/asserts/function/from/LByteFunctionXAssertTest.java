...
public class LByteFunctionXAssertTest<R,X extends Throwable> {
    ...
    private LByteFunctionX<Integer ,X> function = LByteFunctionX.lX(a1 ->
            (Integer ) testValue
    );

    private LByteFunctionX<Integer ,X> functionThrowing = LByteFunctionX.lX(a1 -> {
