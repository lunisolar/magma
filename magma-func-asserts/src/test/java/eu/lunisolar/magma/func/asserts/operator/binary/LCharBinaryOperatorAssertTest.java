...
public class LCharBinaryOperatorAssertTest<X extends ParseException> {
    ...
    private LCharBinaryOperator function = (char a1,char a2) ->
            testValue;


    private LCharBinaryOperator functionThrowing = (char a1,char a2) -> {
