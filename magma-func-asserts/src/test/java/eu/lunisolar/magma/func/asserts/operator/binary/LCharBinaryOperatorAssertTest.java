...
public class LCharBinaryOperatorAssertTest<X extends Throwable> {
    ...
    private LCharBinaryOperator function = LCharBinaryOperator.l((a1,a2) ->
            testValue
    );

    private LCharBinaryOperator functionThrowing = LCharBinaryOperator.l((a1,a2) -> {
