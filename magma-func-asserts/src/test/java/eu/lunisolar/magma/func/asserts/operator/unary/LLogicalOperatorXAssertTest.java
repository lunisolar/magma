...
public class LLogicalOperatorXAssertTest<X extends Throwable> {
    ...
    private LLogicalOperatorX<X> function = LLogicalOperatorX.lX(a1 ->
            testValue
    );

    private LLogicalOperatorX<X> functionThrowing = LLogicalOperatorX.lX(a1 -> {
