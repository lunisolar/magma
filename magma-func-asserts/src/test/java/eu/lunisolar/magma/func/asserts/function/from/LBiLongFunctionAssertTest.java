...
public class LBiLongFunctionAssertTest<R,X extends ParseException> {
    ...
    private LBiLongFunction<Integer> function = (long a1,long a2) ->
            testValue;


    private LBiLongFunction<Integer> functionThrowing = (long a1,long a2) -> {
