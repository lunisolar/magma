...
public class LBiLongFunctionAssertTest<R,X extends Throwable> {
    ...
    private LBiLongFunction<Integer > function = LBiLongFunction.l((l1,l2) ->
            (Integer ) testValue
    );

    private LBiLongFunction<Integer > functionThrowing = LBiLongFunction.l((l1,l2) -> {
