...
public class TernaryOperatorAssertTest<T,X extends ParseException> {
    ...
    private TernaryOperator<Integer > function = TernaryOperator.l((t1,t2,t3) -> {
            return (Integer ) testValue;
    });

    private TernaryOperator<Integer > functionThrowing = TernaryOperator.l((t1,t2,t3) -> {
