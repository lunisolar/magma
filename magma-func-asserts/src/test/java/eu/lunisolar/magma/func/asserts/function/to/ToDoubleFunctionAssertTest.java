...
public class ToDoubleFunctionAssertTest<T,X extends ParseException> {
    ...
    private ToDoubleFunction<Integer > function = ToDoubleFunction.l((t) -> {
            return testValue;
    });

    private ToDoubleFunction<Integer > functionThrowing = ToDoubleFunction.l((t) -> {
