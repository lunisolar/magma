...
import eu.lunisolar.magma.func.predicate.LObjCharPredicateX;
...
public class LObjCharPredicateXAssertTest<T,X extends ParseException> {
    ...
    private LObjCharPredicateX<Integer,X> function = (Integer a1,char a2) ->
            testValue;


    private LObjCharPredicateX<Integer,X> functionThrowing = (Integer a1,char a2) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest(100,'\u0100').withException(a -> a
