...
public class LObjCharPredicateXAssertTest<T,X extends Throwable> {
    ...
    private LObjCharPredicateX<Integer ,X> function = LObjCharPredicateX.lX((a1,a2) ->
            testValue
    );

    private LObjCharPredicateX<Integer ,X> functionThrowing = LObjCharPredicateX.lX((a1,a2) -> {
