...
public class BiObjShortConsumerAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjShortConsumer<Integer ,Integer > function = BiObjShortConsumer.l((t1,t2, s) -> {
            externalEffect.set(testValue);
    });

    private BiObjShortConsumer<Integer ,Integer > functionThrowing = BiObjShortConsumer.l((t1,t2, s) -> {
