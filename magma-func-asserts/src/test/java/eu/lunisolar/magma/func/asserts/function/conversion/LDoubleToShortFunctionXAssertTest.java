...
import eu.lunisolar.magma.func.function.conversion.LDoubleToShortFunctionX;
...
public class LDoubleToShortFunctionXAssertTest<X extends ParseException> {
    ...
    private LDoubleToShortFunctionX<X> function = a1 ->
            testValue;


    private LDoubleToShortFunctionX<X> functionThrowing = a1 -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort(100d).withException(a -> a
