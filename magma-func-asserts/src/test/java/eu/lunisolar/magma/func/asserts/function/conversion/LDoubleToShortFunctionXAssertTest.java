...
public class LDoubleToShortFunctionXAssertTest<X extends Throwable> {
    ...
    private LDoubleToShortFunctionX<X> function = LDoubleToShortFunctionX.lX(a1 ->
            testValue
    );

    private LDoubleToShortFunctionX<X> functionThrowing = LDoubleToShortFunctionX.lX(a1 -> {
