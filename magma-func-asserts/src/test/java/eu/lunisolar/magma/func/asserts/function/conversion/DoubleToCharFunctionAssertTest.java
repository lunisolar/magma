...
public class DoubleToCharFunctionAssertTest<X extends ParseException> {
    ...
    private DoubleToCharFunction function = DoubleToCharFunction.l((d) -> {
            return testValue;
    });

    private DoubleToCharFunction functionThrowing = DoubleToCharFunction.l((d) -> {
