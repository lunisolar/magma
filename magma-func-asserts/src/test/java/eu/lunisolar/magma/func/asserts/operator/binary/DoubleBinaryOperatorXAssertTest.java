...
public class DoubleBinaryOperatorXAssertTest<X extends ParseException> {
    ...
    private DoubleBinaryOperatorX<X> function = DoubleBinaryOperatorX.lX((d1,d2) -> {
            return testValue;
    });

    private DoubleBinaryOperatorX<X> functionThrowing = DoubleBinaryOperatorX.lX((d1,d2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsDouble((double)80,(double)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsDouble((double)80,(double)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsDouble((double)80,(double)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsDouble((double)80,(double)81).withException(a -> a
