...
public class DoubleToIntFunctionAssertTest<X extends ParseException> {
    ...
    private DoubleToIntFunction function = DoubleToIntFunction.l((d) -> {
            return testValue;
    });

    private DoubleToIntFunction functionThrowing = DoubleToIntFunction.l((d) -> {
