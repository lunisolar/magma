...
import eu.lunisolar.magma.func.supplier.LLongSupplierX;
...
public class LLongSupplierXAssertTest<X extends ParseException> {
    ...
    private LLongSupplierX<X> function = () ->
            testValue;


    private LLongSupplierX<X> functionThrowing = () -> {
