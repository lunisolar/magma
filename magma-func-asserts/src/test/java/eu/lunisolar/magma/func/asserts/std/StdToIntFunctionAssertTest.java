...
public class StdToIntFunctionAssertTest<T,X extends ParseException> {
    ...
    private java.util.function.ToIntFunction<Integer > function = ((t) -> {
            return testValue;
    });

    private java.util.function.ToIntFunction<Integer > functionThrowing = ((t) -> {
