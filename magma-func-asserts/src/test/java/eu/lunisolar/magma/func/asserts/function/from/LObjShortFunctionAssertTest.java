...
public class LObjShortFunctionAssertTest<T,R,X extends Throwable> {
    ...
    private LObjShortFunction<Integer ,Integer > function = LObjShortFunction.l((a1,a2) ->
            (Integer ) testValue
    );

    private LObjShortFunction<Integer ,Integer > functionThrowing = LObjShortFunction.l((a1,a2) -> {
