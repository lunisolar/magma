...
public class IntFunctionXAssertTest<R,X extends ParseException> {
    ...
    private IntFunctionX<Integer ,X> function = IntFunctionX.lX((i) -> {
            return (Integer ) testValue;
    });

    private IntFunctionX<Integer ,X> functionThrowing = IntFunctionX.lX((i) -> {
