...
public class IntPredicateXAssertTest<X extends ParseException> {
    ...
    private IntPredicateX<X> function = IntPredicateX.lX((i) -> {
            return testValue;
    });

    private IntPredicateX<X> functionThrowing = IntPredicateX.lX((i) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((int)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((int)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((int)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((int)80).withException(a -> a
