...
public class ToDoubleBiFunctionXAssertTest<T1,T2,X extends ParseException> {
    ...
    private ToDoubleBiFunctionX<Integer ,Integer ,X> function = ToDoubleBiFunctionX.lX((t1,t2) -> {
            return testValue;
    });

    private ToDoubleBiFunctionX<Integer ,Integer ,X> functionThrowing = ToDoubleBiFunctionX.lX((t1,t2) -> {
