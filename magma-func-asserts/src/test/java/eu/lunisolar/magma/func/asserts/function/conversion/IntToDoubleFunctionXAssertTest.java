...
public class IntToDoubleFunctionXAssertTest<X extends ParseException> {
    ...
    private IntToDoubleFunctionX<X> function = IntToDoubleFunctionX.lX((i) -> {
            return testValue;
    });

    private IntToDoubleFunctionX<X> functionThrowing = IntToDoubleFunctionX.lX((i) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsDouble((int)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsDouble((int)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsDouble((int)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsDouble((int)80).withException(a -> a
