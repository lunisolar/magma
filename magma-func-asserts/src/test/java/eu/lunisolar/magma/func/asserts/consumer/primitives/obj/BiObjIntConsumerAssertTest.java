...
public class BiObjIntConsumerAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjIntConsumer<Integer ,Integer > function = BiObjIntConsumer.l((t1,t2, i) -> {
            externalEffect.set(testValue);
    });

    private BiObjIntConsumer<Integer ,Integer > functionThrowing = BiObjIntConsumer.l((t1,t2, i) -> {
