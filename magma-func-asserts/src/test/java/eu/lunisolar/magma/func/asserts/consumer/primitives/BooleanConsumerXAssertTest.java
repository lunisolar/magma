...
public class BooleanConsumerXAssertTest<X extends ParseException> {
    ...
    private BooleanConsumerX<X> function = BooleanConsumerX.lX((b) -> {
            externalEffect.set(testValue);
    });

    private BooleanConsumerX<X> functionThrowing = BooleanConsumerX.lX((b) -> {
