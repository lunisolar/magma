...
public class BooleanToShortFunctionXAssertTest<X extends ParseException> {
    ...
    private BooleanToShortFunctionX<X> function = BooleanToShortFunctionX.lX((b) -> {
            return testValue;
    });

    private BooleanToShortFunctionX<X> functionThrowing = BooleanToShortFunctionX.lX((b) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsShort(true).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsShort(true).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort(true).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort(true).withException(a -> a
