...
public class DoubleBinaryOperatorAssertTest<X extends ParseException> {
    ...
    private DoubleBinaryOperator function = DoubleBinaryOperator.l((d1,d2) -> {
            return testValue;
    });

    private DoubleBinaryOperator functionThrowing = DoubleBinaryOperator.l((d1,d2) -> {
