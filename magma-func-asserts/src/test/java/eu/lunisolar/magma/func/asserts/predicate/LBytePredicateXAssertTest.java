...
import eu.lunisolar.magma.func.predicate.LBytePredicateX;
...
public class LBytePredicateXAssertTest<X extends ParseException> {
    ...
    private LBytePredicateX<X> function = a1 ->
            testValue;


    private LBytePredicateX<X> functionThrowing = a1 -> {
