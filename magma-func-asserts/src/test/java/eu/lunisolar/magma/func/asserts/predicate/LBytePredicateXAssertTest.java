...
public class LBytePredicateXAssertTest<X extends Throwable> {
    ...
    private LBytePredicateX<X> function = LBytePredicateX.lX(a1 ->
            testValue
    );

    private LBytePredicateX<X> functionThrowing = LBytePredicateX.lX(a1 -> {
