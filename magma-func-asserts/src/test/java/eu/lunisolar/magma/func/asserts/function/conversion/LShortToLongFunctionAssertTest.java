...
public class LShortToLongFunctionAssertTest<X extends Throwable> {
    ...
    private LShortToLongFunction function = LShortToLongFunction.l(a1 ->
            testValue
    );

    private LShortToLongFunction functionThrowing = LShortToLongFunction.l(a1 -> {
