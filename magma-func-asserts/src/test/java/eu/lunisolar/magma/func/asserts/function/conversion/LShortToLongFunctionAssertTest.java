...
import eu.lunisolar.magma.func.function.conversion.LShortToLongFunction;
...
public class LShortToLongFunctionAssertTest<X extends ParseException> {
    ...
    private LShortToLongFunction function = a1 ->
            testValue;


    private LShortToLongFunction functionThrowing = a1 -> {
