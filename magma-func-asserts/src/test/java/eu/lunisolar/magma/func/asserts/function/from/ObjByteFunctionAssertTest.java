...
public class ObjByteFunctionAssertTest<T,R,X extends ParseException> {
    ...
    private ObjByteFunction<Integer ,Integer > function = ObjByteFunction.l((t, i) -> {
            return (Integer ) testValue;
    });

    private ObjByteFunction<Integer ,Integer > functionThrowing = ObjByteFunction.l((t, i) -> {
