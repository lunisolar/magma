...
import eu.lunisolar.magma.func.function.to.LToDoubleFunction;
...
public class LToDoubleFunctionAssertTest<T,X extends ParseException> {
    ...
    private LToDoubleFunction<Integer> function = a1 ->
            testValue;


    private LToDoubleFunction<Integer> functionThrowing = a1 -> {
