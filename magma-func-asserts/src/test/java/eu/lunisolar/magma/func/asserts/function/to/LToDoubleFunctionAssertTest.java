...
public class LToDoubleFunctionAssertTest<T,X extends Throwable> {
    ...
    private LToDoubleFunction<Integer > function = LToDoubleFunction.l(a1 ->
            testValue
    );

    private LToDoubleFunction<Integer > functionThrowing = LToDoubleFunction.l(a1 -> {
