...
public class LBiFunctionXAssertTest<T1,T2,R,X extends Throwable> {
    ...
    private LBiFunctionX<Integer ,Integer ,Integer ,X> function = LBiFunctionX.lX((a1,a2) ->
            (Integer ) testValue
    );

    private LBiFunctionX<Integer ,Integer ,Integer ,X> functionThrowing = LBiFunctionX.lX((a1,a2) -> {
