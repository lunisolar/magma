...
public class ShortToCharFunctionAssertTest<X extends ParseException> {
    ...
    private ShortToCharFunction function = ShortToCharFunction.l((s) -> {
            return testValue;
    });

    private ShortToCharFunction functionThrowing = ShortToCharFunction.l((s) -> {
