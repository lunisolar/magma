...
public class LByteToShortFunctionAssertTest<X extends Throwable> {
    ...
    private LByteToShortFunction function = LByteToShortFunction.l(a1 ->
            testValue
    );

    private LByteToShortFunction functionThrowing = LByteToShortFunction.l(a1 -> {
