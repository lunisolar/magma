...
import eu.lunisolar.magma.func.function.conversion.LByteToShortFunction;
...
public class LByteToShortFunctionAssertTest<X extends ParseException> {
    ...
    private LByteToShortFunction function = a1 ->
            testValue;


    private LByteToShortFunction functionThrowing = a1 -> {
