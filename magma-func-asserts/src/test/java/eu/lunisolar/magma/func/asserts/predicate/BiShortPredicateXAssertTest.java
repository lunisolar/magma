...
public class BiShortPredicateXAssertTest<X extends ParseException> {
    ...
    private BiShortPredicateX<X> function = BiShortPredicateX.lX((s1,s2) -> {
            return testValue;
    });

    private BiShortPredicateX<X> functionThrowing = BiShortPredicateX.lX((s1,s2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((short)80,(short)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((short)80,(short)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((short)80,(short)81).to( a -> a.isEqualTo(1));
