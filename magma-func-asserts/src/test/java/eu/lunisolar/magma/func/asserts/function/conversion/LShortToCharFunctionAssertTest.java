...
import eu.lunisolar.magma.func.function.conversion.LShortToCharFunction;
...
public class LShortToCharFunctionAssertTest<X extends ParseException> {
    ...
    private LShortToCharFunction function = a1 ->
            testValue;


    private LShortToCharFunction functionThrowing = a1 -> {
