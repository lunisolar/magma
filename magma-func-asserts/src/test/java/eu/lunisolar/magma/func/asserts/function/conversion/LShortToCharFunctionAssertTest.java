...
public class LShortToCharFunctionAssertTest<X extends Throwable> {
    ...
    private LShortToCharFunction function = LShortToCharFunction.l(a1 ->
            testValue
    );

    private LShortToCharFunction functionThrowing = LShortToCharFunction.l(a1 -> {
