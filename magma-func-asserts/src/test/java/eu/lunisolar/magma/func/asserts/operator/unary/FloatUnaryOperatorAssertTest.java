...
public class FloatUnaryOperatorAssertTest<X extends ParseException> {
    ...
    private FloatUnaryOperator function = FloatUnaryOperator.l((f) -> {
            return testValue;
    });

    private FloatUnaryOperator functionThrowing = FloatUnaryOperator.l((f) -> {
