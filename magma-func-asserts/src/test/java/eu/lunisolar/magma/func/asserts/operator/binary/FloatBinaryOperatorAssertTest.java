...
public class FloatBinaryOperatorAssertTest<X extends ParseException> {
    ...
    private FloatBinaryOperator function = FloatBinaryOperator.l((f1,f2) -> {
            return testValue;
    });

    private FloatBinaryOperator functionThrowing = FloatBinaryOperator.l((f1,f2) -> {
