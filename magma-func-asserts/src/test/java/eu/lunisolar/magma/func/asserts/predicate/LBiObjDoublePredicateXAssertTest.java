...
import eu.lunisolar.magma.func.predicate.LBiObjDoublePredicateX;
...
public class LBiObjDoublePredicateXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjDoublePredicateX<Integer,Integer,X> function = (Integer a1,Integer a2,double a3) ->
            testValue;


    private LBiObjDoublePredicateX<Integer,Integer,X> functionThrowing = (Integer a1,Integer a2,double a3) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest(100,100,100d).withException(a -> a
