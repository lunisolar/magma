...
public class LBiObjDoublePredicateXAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjDoublePredicateX<Integer ,Integer ,X> function = LBiObjDoublePredicateX.lX((a1,a2,a3) ->
            testValue
    );

    private LBiObjDoublePredicateX<Integer ,Integer ,X> functionThrowing = LBiObjDoublePredicateX.lX((a1,a2,a3) -> {
