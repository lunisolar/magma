...
public class LObjDoubleConsumerAssertTest<T,X extends Throwable> {
    ...
    private LObjDoubleConsumer<Integer > function = LObjDoubleConsumer.l((a1,a2) ->
            externalEffect.set(testValue)
    );

    private LObjDoubleConsumer<Integer > functionThrowing = LObjDoubleConsumer.l((a1,a2) -> {
