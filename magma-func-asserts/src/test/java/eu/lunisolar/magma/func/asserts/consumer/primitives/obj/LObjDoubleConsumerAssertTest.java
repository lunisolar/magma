...
import eu.lunisolar.magma.func.consumer.primitives.obj.LObjDoubleConsumer;
...
public class LObjDoubleConsumerAssertTest<T,X extends ParseException> {
    ...
    private LObjDoubleConsumer<Integer> function = (Integer a1,double a2) ->
            externalEffect.set(testValue);


    private LObjDoubleConsumer<Integer> functionThrowing = (Integer a1,double a2) -> {
