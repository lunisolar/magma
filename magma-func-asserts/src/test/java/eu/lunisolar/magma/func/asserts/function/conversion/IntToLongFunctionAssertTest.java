...
public class IntToLongFunctionAssertTest<X extends ParseException> {
    ...
    private IntToLongFunction function = IntToLongFunction.l((i) -> {
            return testValue;
    });

    private IntToLongFunction functionThrowing = IntToLongFunction.l((i) -> {
