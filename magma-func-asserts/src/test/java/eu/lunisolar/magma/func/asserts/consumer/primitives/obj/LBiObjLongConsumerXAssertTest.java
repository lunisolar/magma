...
import eu.lunisolar.magma.func.consumer.primitives.obj.LBiObjLongConsumerX;
...
public class LBiObjLongConsumerXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjLongConsumerX<Integer,Integer,X> function = (Integer a1,Integer a2,long a3) ->
            externalEffect.set(testValue);


    private LBiObjLongConsumerX<Integer,Integer,X> functionThrowing = (Integer a1,Integer a2,long a3) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept(100,100,100L).withException(a -> a
