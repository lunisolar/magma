...
public class LBiObjLongConsumerXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjLongConsumerX<Integer ,Integer ,X> function = LBiObjLongConsumerX.lX((t1,t2, l) -> {
            externalEffect.set(testValue);
    });

    private LBiObjLongConsumerX<Integer ,Integer ,X> functionThrowing = LBiObjLongConsumerX.lX((t1,t2, l) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesAccept((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(long)82)
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(long)82).withException(a -> a
