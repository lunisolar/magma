...
public class LBiObjLongConsumerXAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjLongConsumerX<Integer ,Integer ,X> function = LBiObjLongConsumerX.lX((a1,a2,a3) ->
            externalEffect.set(testValue)
    );

    private LBiObjLongConsumerX<Integer ,Integer ,X> functionThrowing = LBiObjLongConsumerX.lX((a1,a2,a3) -> {
