...
public class ObjLongFunctionXAssertTest<T,R,X extends ParseException> {
    ...
    private ObjLongFunctionX<Integer ,Integer ,X> function = ObjLongFunctionX.lX((t, l) -> {
            return (Integer ) testValue;
    });

    private ObjLongFunctionX<Integer ,Integer ,X> functionThrowing = ObjLongFunctionX.lX((t, l) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(long)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(long)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(long)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(long)81).withException(a -> a
