...
public class ToCharFunctionAssertTest<T,X extends ParseException> {
    ...
    private ToCharFunction<Integer > function = ToCharFunction.l((t) -> {
            return testValue;
    });

    private ToCharFunction<Integer > functionThrowing = ToCharFunction.l((t) -> {
