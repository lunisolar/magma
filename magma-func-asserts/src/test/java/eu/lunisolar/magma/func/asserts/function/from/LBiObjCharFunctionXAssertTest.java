...
public class LBiObjCharFunctionXAssertTest<T1,T2,R,X extends Throwable> {
    ...
    private LBiObjCharFunctionX<Integer ,Integer ,Integer ,X> function = LBiObjCharFunctionX.lX((a1,a2,a3) ->
            (Integer ) testValue
    );

    private LBiObjCharFunctionX<Integer ,Integer ,Integer ,X> functionThrowing = LBiObjCharFunctionX.lX((a1,a2,a3) -> {
