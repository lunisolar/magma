...
import eu.lunisolar.magma.func.function.from.LBiObjCharFunctionX;
...
public class LBiObjCharFunctionXAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private LBiObjCharFunctionX<Integer,Integer,Integer,X> function = (Integer a1,Integer a2,char a3) ->
            testValue;


    private LBiObjCharFunctionX<Integer,Integer,Integer,X> functionThrowing = (Integer a1,Integer a2,char a3) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply(100,100,'\u0100').withException(a -> a
