...
public class LBiObjBytePredicateAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjBytePredicate<Integer ,Integer > function = LBiObjBytePredicate.l((a1,a2,a3) ->
            testValue
    );

    private LBiObjBytePredicate<Integer ,Integer > functionThrowing = LBiObjBytePredicate.l((a1,a2,a3) -> {
