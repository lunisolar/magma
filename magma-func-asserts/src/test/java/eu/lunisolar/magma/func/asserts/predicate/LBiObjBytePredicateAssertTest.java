...
public class LBiObjBytePredicateAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjBytePredicate<Integer,Integer> function = (Integer a1,Integer a2,byte a3) ->
            testValue;


    private LBiObjBytePredicate<Integer,Integer> functionThrowing = (Integer a1,Integer a2,byte a3) -> {
