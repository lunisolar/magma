...
public class ObjLongPredicateAssertTest<T,X extends ParseException> {
    ...
    private ObjLongPredicate<Integer > function = ObjLongPredicate.l((t, l) -> {
            return testValue;
    });

    private ObjLongPredicate<Integer > functionThrowing = ObjLongPredicate.l((t, l) -> {
