...
public class LTriPredicateAssertTest<T1,T2,T3,X extends Throwable> {
    ...
    private LTriPredicate<Integer ,Integer ,Integer > function = LTriPredicate.l((a1,a2,a3) ->
            testValue
    );

    private LTriPredicate<Integer ,Integer ,Integer > functionThrowing = LTriPredicate.l((a1,a2,a3) -> {
