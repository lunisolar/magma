...
import eu.lunisolar.magma.func.function.conversion.LIntToDoubleFunctionX;
...
public class LIntToDoubleFunctionXAssertTest<X extends ParseException> {
    ...
    private LIntToDoubleFunctionX<X> function = a1 ->
            testValue;


    private LIntToDoubleFunctionX<X> functionThrowing = a1 -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsDouble(100).withException(a -> a
