...
public class LIntToDoubleFunctionXAssertTest<X extends Throwable> {
    ...
    private LIntToDoubleFunctionX<X> function = LIntToDoubleFunctionX.lX(a1 ->
            testValue
    );

    private LIntToDoubleFunctionX<X> functionThrowing = LIntToDoubleFunctionX.lX(a1 -> {
