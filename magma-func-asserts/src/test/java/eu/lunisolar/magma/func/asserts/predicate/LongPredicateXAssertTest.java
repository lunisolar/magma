...
public class LongPredicateXAssertTest<X extends ParseException> {
    ...
    private LongPredicateX<X> function = LongPredicateX.lX((l) -> {
            return testValue;
    });

    private LongPredicateX<X> functionThrowing = LongPredicateX.lX((l) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((long)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((long)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((long)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((long)80).withException(a -> a
