...
public class BooleanToShortFunctionAssertTest<X extends ParseException> {
    ...
    private BooleanToShortFunction function = BooleanToShortFunction.l((b) -> {
            return testValue;
    });

    private BooleanToShortFunction functionThrowing = BooleanToShortFunction.l((b) -> {
