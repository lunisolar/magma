...
public class LBiObjLongPredicateXAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjLongPredicateX<Integer ,Integer ,X> function = LBiObjLongPredicateX.lX((a1,a2,a3) ->
            testValue
    );

    private LBiObjLongPredicateX<Integer ,Integer ,X> functionThrowing = LBiObjLongPredicateX.lX((a1,a2,a3) -> {
