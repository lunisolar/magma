...
import eu.lunisolar.magma.func.predicate.LBiObjLongPredicateX;
...
public class LBiObjLongPredicateXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjLongPredicateX<Integer,Integer,X> function = (Integer a1,Integer a2,long a3) ->
            testValue;


    private LBiObjLongPredicateX<Integer,Integer,X> functionThrowing = (Integer a1,Integer a2,long a3) -> {
