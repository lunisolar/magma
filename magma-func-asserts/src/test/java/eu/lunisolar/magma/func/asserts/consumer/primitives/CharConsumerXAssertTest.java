...
public class CharConsumerXAssertTest<X extends ParseException> {
    ...
    private CharConsumerX<X> function = CharConsumerX.lX((c) -> {
            externalEffect.set(testValue);
    });

    private CharConsumerX<X> functionThrowing = CharConsumerX.lX((c) -> {
