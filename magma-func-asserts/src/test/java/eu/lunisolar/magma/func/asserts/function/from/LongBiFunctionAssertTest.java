...
public class LongBiFunctionAssertTest<R,X extends ParseException> {
    ...
    private LongBiFunction<Integer > function = LongBiFunction.l((l1,l2) -> {
            return (Integer ) testValue;
    });

    private LongBiFunction<Integer > functionThrowing = LongBiFunction.l((l1,l2) -> {
