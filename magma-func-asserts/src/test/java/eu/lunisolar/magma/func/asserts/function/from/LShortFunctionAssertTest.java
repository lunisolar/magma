...
public class LShortFunctionAssertTest<R,X extends Throwable> {
    ...
    private LShortFunction<Integer > function = LShortFunction.l(a1 ->
            (Integer ) testValue
    );

    private LShortFunction<Integer > functionThrowing = LShortFunction.l(a1 -> {
