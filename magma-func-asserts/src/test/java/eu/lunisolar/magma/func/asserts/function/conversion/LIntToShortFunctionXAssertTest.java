...
public class LIntToShortFunctionXAssertTest<X extends Throwable> {
    ...
    private LIntToShortFunctionX<X> function = LIntToShortFunctionX.lX(a1 ->
            testValue
    );

    private LIntToShortFunctionX<X> functionThrowing = LIntToShortFunctionX.lX(a1 -> {
