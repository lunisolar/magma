...
import eu.lunisolar.magma.func.function.conversion.LIntToShortFunctionX;
...
public class LIntToShortFunctionXAssertTest<X extends ParseException> {
    ...
    private LIntToShortFunctionX<X> function = a1 ->
            testValue;


    private LIntToShortFunctionX<X> functionThrowing = a1 -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort(100).withException(a -> a
