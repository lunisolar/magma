...
public class ObjIntConsumerXAssertTest<T,X extends ParseException> {
    ...
    private ObjIntConsumerX<Integer ,X> function = ObjIntConsumerX.lX((t, i) -> {
            externalEffect.set(testValue);
    });

    private ObjIntConsumerX<Integer ,X> functionThrowing = ObjIntConsumerX.lX((t, i) -> {
