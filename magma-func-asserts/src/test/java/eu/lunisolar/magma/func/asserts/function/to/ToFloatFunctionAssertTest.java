...
public class ToFloatFunctionAssertTest<T,X extends ParseException> {
    ...
    private ToFloatFunction<Integer > function = ToFloatFunction.l((t) -> {
            return testValue;
    });

    private ToFloatFunction<Integer > functionThrowing = ToFloatFunction.l((t) -> {
