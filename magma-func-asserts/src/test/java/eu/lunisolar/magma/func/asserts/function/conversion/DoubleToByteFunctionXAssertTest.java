...
public class DoubleToByteFunctionXAssertTest<X extends ParseException> {
    ...
    private DoubleToByteFunctionX<X> function = DoubleToByteFunctionX.lX((d) -> {
            return testValue;
    });

    private DoubleToByteFunctionX<X> functionThrowing = DoubleToByteFunctionX.lX((d) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsByte((double)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsByte((double)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsByte((double)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsByte((double)80).withException(a -> a
