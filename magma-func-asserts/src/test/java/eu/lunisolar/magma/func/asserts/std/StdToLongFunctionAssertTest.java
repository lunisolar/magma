...
public class StdToLongFunctionAssertTest<T,X extends ParseException> {
    ...
    private java.util.function.ToLongFunction<Integer > function = ((t) -> {
            return testValue;
    });

    private java.util.function.ToLongFunction<Integer > functionThrowing = ((t) -> {
