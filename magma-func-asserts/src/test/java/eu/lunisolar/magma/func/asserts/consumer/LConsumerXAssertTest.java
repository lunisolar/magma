...
public class LConsumerXAssertTest<T,X extends Throwable> {
    ...
    private LConsumerX<Integer ,X> function = LConsumerX.lX(a1 ->
            externalEffect.set(testValue)
    );

    private LConsumerX<Integer ,X> functionThrowing = LConsumerX.lX(a1 -> {
