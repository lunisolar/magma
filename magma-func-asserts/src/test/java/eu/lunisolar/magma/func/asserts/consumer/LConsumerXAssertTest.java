...
public class LConsumerXAssertTest<T,X extends ParseException> {
    ...
    private LConsumerX<Integer ,X> function = LConsumerX.lX((t) -> {
            externalEffect.set(testValue);
    });

    private LConsumerX<Integer ,X> functionThrowing = LConsumerX.lX((t) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesAccept((Integer )Integer.valueOf(80))
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept((Integer )Integer.valueOf(80)).withException(a -> a
