...
public class CharToShortFunctionAssertTest<X extends ParseException> {
    ...
    private CharToShortFunction function = CharToShortFunction.l((c) -> {
            return testValue;
    });

    private CharToShortFunction functionThrowing = CharToShortFunction.l((c) -> {
