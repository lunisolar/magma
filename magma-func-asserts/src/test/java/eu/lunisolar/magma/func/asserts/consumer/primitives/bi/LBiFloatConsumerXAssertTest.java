...
import eu.lunisolar.magma.func.consumer.primitives.bi.LBiFloatConsumerX;
...
public class LBiFloatConsumerXAssertTest<X extends ParseException> {
    ...
    private LBiFloatConsumerX<X> function = (float a1,float a2) ->
            externalEffect.set(testValue);


    private LBiFloatConsumerX<X> functionThrowing = (float a1,float a2) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept(100f,100f).withException(a -> a
