...
public class LBiFloatConsumerXAssertTest<X extends Throwable> {
    ...
    private LBiFloatConsumerX<X> function = LBiFloatConsumerX.lX((a1,a2) ->
            externalEffect.set(testValue)
    );

    private LBiFloatConsumerX<X> functionThrowing = LBiFloatConsumerX.lX((a1,a2) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept((float)80,(float)81).withException(a -> a
