...
public class BiObjShortFunctionXAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private BiObjShortFunctionX<Integer ,Integer ,Integer ,X> function = BiObjShortFunctionX.lX((t1,t2, s) -> {
            return (Integer ) testValue;
    });

    private BiObjShortFunctionX<Integer ,Integer ,Integer ,X> functionThrowing = BiObjShortFunctionX.lX((t1,t2, s) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(short)82).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(short)82).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(short)82).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(short)82).withException(a -> a
