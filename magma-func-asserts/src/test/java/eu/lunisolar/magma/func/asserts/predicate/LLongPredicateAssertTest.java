...
public class LLongPredicateAssertTest<X extends ParseException> {
    ...
    private LLongPredicate function = LLongPredicate.l((l) -> {
            return testValue;
    });

    private LLongPredicate functionThrowing = LLongPredicate.l((l) -> {
