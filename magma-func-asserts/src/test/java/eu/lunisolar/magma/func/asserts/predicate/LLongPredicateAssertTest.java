...
public class LLongPredicateAssertTest<X extends Throwable> {
    ...
    private LLongPredicate function = LLongPredicate.l(a1 ->
            testValue
    );

    private LLongPredicate functionThrowing = LLongPredicate.l(a1 -> {
