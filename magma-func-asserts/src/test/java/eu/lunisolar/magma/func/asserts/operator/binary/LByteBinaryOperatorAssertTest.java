...
public class LByteBinaryOperatorAssertTest<X extends ParseException> {
    ...
    private LByteBinaryOperator function = (byte a1,byte a2) ->
            testValue;


    private LByteBinaryOperator functionThrowing = (byte a1,byte a2) -> {
