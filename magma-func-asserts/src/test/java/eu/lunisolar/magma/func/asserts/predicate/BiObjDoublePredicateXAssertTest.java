...
public class BiObjDoublePredicateXAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjDoublePredicateX<Integer ,Integer ,X> function = BiObjDoublePredicateX.lX((t1,t2, d) -> {
            return testValue;
    });

    private BiObjDoublePredicateX<Integer ,Integer ,X> functionThrowing = BiObjDoublePredicateX.lX((t1,t2, d) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(double)82).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(double)82).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(double)82).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(double)82).withException(a -> a
