...
public class ShortPredicateAssertTest<X extends ParseException> {
    ...
    private ShortPredicate function = ShortPredicate.l((s) -> {
            return testValue;
    });

    private ShortPredicate functionThrowing = ShortPredicate.l((s) -> {
