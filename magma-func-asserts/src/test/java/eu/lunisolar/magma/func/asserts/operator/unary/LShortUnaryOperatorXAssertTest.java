...
import eu.lunisolar.magma.func.operator.unary.LShortUnaryOperatorX;
...
public class LShortUnaryOperatorXAssertTest<X extends ParseException> {
    ...
    private LShortUnaryOperatorX<X> function = a1 ->
            testValue;


    private LShortUnaryOperatorX<X> functionThrowing = a1 -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort((short)100).withException(a -> a
