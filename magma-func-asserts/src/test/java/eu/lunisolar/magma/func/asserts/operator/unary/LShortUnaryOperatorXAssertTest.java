...
public class LShortUnaryOperatorXAssertTest<X extends Throwable> {
    ...
    private LShortUnaryOperatorX<X> function = LShortUnaryOperatorX.lX(a1 ->
            testValue
    );

    private LShortUnaryOperatorX<X> functionThrowing = LShortUnaryOperatorX.lX(a1 -> {
