...
public class LToDoubleBiFunctionAssertTest<T1,T2,X extends Throwable> {
    ...
    private LToDoubleBiFunction<Integer ,Integer > function = LToDoubleBiFunction.l((a1,a2) ->
            testValue
    );

    private LToDoubleBiFunction<Integer ,Integer > functionThrowing = LToDoubleBiFunction.l((a1,a2) -> {
