...
import eu.lunisolar.magma.func.function.to.LToDoubleBiFunction;
...
public class LToDoubleBiFunctionAssertTest<T1,T2,X extends ParseException> {
    ...
    private LToDoubleBiFunction<Integer,Integer> function = (Integer a1,Integer a2) ->
            testValue;


    private LToDoubleBiFunction<Integer,Integer> functionThrowing = (Integer a1,Integer a2) -> {
