...
public class LToDoubleBiFunctionAssertTest<T1,T2,X extends ParseException> {
    ...
    private LToDoubleBiFunction<Integer ,Integer > function = LToDoubleBiFunction.l((t1,t2) -> {
            return testValue;
    });

    private LToDoubleBiFunction<Integer ,Integer > functionThrowing = LToDoubleBiFunction.l((t1,t2) -> {
