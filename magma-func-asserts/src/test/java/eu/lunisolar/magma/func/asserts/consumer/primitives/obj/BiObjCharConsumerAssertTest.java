...
public class BiObjCharConsumerAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjCharConsumer<Integer ,Integer > function = BiObjCharConsumer.l((t1,t2, c) -> {
            externalEffect.set(testValue);
    });

    private BiObjCharConsumer<Integer ,Integer > functionThrowing = BiObjCharConsumer.l((t1,t2, c) -> {
