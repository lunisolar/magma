...
public class DoubleBiConsumerAssertTest<X extends ParseException> {
    ...
    private DoubleBiConsumer function = DoubleBiConsumer.l((d1,d2) -> {
            externalEffect.set(testValue);
    });

    private DoubleBiConsumer functionThrowing = DoubleBiConsumer.l((d1,d2) -> {
