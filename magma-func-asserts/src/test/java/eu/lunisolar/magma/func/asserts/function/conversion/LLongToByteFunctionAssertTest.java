...
public class LLongToByteFunctionAssertTest<X extends ParseException> {
    ...
    private LLongToByteFunction function = a1 ->
            testValue;


    private LLongToByteFunction functionThrowing = a1 -> {
