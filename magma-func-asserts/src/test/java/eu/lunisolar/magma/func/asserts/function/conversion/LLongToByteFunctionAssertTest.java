...
public class LLongToByteFunctionAssertTest<X extends Throwable> {
    ...
    private LLongToByteFunction function = LLongToByteFunction.l(a1 ->
            testValue
    );

    private LLongToByteFunction functionThrowing = LLongToByteFunction.l(a1 -> {
