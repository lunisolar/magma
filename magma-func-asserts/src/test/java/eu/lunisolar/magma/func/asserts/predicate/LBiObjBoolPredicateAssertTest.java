...
public class LBiObjBoolPredicateAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjBoolPredicate<Integer ,Integer > function = LBiObjBoolPredicate.l((a1,a2,a3) ->
            testValue
    );

    private LBiObjBoolPredicate<Integer ,Integer > functionThrowing = LBiObjBoolPredicate.l((a1,a2,a3) -> {
