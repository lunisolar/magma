...
public class LBiObjBoolPredicateAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjBoolPredicate<Integer,Integer> function = (Integer a1,Integer a2,boolean a3) ->
            testValue;


    private LBiObjBoolPredicate<Integer,Integer> functionThrowing = (Integer a1,Integer a2,boolean a3) -> {
