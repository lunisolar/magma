...
public class LBiObjBoolPredicateAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjBoolPredicate<Integer ,Integer > function = LBiObjBoolPredicate.l((t1,t2, b) ->
            testValue
    );

    private LBiObjBoolPredicate<Integer ,Integer > functionThrowing = LBiObjBoolPredicate.l((t1,t2, b) -> {
