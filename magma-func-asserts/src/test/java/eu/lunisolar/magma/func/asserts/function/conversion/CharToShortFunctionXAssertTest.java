...
public class CharToShortFunctionXAssertTest<X extends ParseException> {
    ...
    private CharToShortFunctionX<X> function = CharToShortFunctionX.lX((c) -> {
            return testValue;
    });

    private CharToShortFunctionX<X> functionThrowing = CharToShortFunctionX.lX((c) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsShort((char)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsShort((char)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort((char)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort((char)80).withException(a -> a
