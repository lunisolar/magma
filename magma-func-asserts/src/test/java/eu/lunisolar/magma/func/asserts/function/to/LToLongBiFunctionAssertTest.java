...
public class LToLongBiFunctionAssertTest<T1,T2,X extends Throwable> {
    ...
    private LToLongBiFunction<Integer ,Integer > function = LToLongBiFunction.l((a1,a2) ->
            testValue
    );

    private LToLongBiFunction<Integer ,Integer > functionThrowing = LToLongBiFunction.l((a1,a2) -> {
