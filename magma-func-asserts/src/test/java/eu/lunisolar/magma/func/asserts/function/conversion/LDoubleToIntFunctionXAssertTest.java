...
public class LDoubleToIntFunctionXAssertTest<X extends Throwable> {
    ...
    private LDoubleToIntFunctionX<X> function = LDoubleToIntFunctionX.lX(a1 ->
            testValue
    );

    private LDoubleToIntFunctionX<X> functionThrowing = LDoubleToIntFunctionX.lX(a1 -> {
