...
import eu.lunisolar.magma.func.function.conversion.LDoubleToIntFunctionX;
...
public class LDoubleToIntFunctionXAssertTest<X extends ParseException> {
    ...
    private LDoubleToIntFunctionX<X> function = a1 ->
            testValue;


    private LDoubleToIntFunctionX<X> functionThrowing = a1 -> {
