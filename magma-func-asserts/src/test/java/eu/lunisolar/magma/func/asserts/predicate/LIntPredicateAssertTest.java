...
public class LIntPredicateAssertTest<X extends ParseException> {
    ...
    private LIntPredicate function = LIntPredicate.l((i) -> {
            return testValue;
    });

    private LIntPredicate functionThrowing = LIntPredicate.l((i) -> {
