...
public class LIntPredicateAssertTest<X extends Throwable> {
    ...
    private LIntPredicate function = LIntPredicate.l(a1 ->
            testValue
    );

    private LIntPredicate functionThrowing = LIntPredicate.l(a1 -> {
