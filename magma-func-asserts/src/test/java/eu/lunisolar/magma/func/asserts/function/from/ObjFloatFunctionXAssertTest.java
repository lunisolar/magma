...
public class ObjFloatFunctionXAssertTest<T,R,X extends ParseException> {
    ...
    private ObjFloatFunctionX<Integer ,Integer ,X> function = ObjFloatFunctionX.lX((t, f) -> {
            return (Integer ) testValue;
    });

    private ObjFloatFunctionX<Integer ,Integer ,X> functionThrowing = ObjFloatFunctionX.lX((t, f) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(float)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(float)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(float)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(float)81).withException(a -> a
