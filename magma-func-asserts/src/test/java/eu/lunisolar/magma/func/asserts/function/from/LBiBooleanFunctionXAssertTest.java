...
public class LBiBooleanFunctionXAssertTest<R,X extends Throwable> {
    ...
    private LBiBooleanFunctionX<Integer ,X> function = LBiBooleanFunctionX.lX((b1,b2) ->
            (Integer ) testValue
    );

    private LBiBooleanFunctionX<Integer ,X> functionThrowing = LBiBooleanFunctionX.lX((b1,b2) -> {
