...
import eu.lunisolar.magma.func.predicate.LBiObjFloatPredicateX;
...
public class LBiObjFloatPredicateXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjFloatPredicateX<Integer,Integer,X> function = (Integer a1,Integer a2,float a3) ->
            testValue;


    private LBiObjFloatPredicateX<Integer,Integer,X> functionThrowing = (Integer a1,Integer a2,float a3) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest(100,100,100f).withException(a -> a
