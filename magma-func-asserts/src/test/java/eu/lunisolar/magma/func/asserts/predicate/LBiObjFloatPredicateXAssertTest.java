...
public class LBiObjFloatPredicateXAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjFloatPredicateX<Integer ,Integer ,X> function = LBiObjFloatPredicateX.lX((a1,a2,a3) ->
            testValue
    );

    private LBiObjFloatPredicateX<Integer ,Integer ,X> functionThrowing = LBiObjFloatPredicateX.lX((a1,a2,a3) -> {
