...
public class LShortToCharFunctionXAssertTest<X extends Throwable> {
    ...
    private LShortToCharFunctionX<X> function = LShortToCharFunctionX.lX(a1 ->
            testValue
    );

    private LShortToCharFunctionX<X> functionThrowing = LShortToCharFunctionX.lX(a1 -> {
