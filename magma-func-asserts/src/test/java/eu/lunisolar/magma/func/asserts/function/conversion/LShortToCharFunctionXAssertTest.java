...
import eu.lunisolar.magma.func.function.conversion.LShortToCharFunctionX;
...
public class LShortToCharFunctionXAssertTest<X extends ParseException> {
    ...
    private LShortToCharFunctionX<X> function = a1 ->
            testValue;


    private LShortToCharFunctionX<X> functionThrowing = a1 -> {
