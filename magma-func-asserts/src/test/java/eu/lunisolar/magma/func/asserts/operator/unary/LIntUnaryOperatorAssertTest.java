...
public class LIntUnaryOperatorAssertTest<X extends Throwable> {
    ...
    private LIntUnaryOperator function = LIntUnaryOperator.l(a1 ->
            testValue
    );

    private LIntUnaryOperator functionThrowing = LIntUnaryOperator.l(a1 -> {
