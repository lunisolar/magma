...
public class LIntUnaryOperatorAssertTest<X extends ParseException> {
    ...
    private LIntUnaryOperator function = LIntUnaryOperator.l((i) -> {
            return testValue;
    });

    private LIntUnaryOperator functionThrowing = LIntUnaryOperator.l((i) -> {
