...
public class LBiObjBoolPredicateXAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjBoolPredicateX<Integer ,Integer ,X> function = LBiObjBoolPredicateX.lX((a1,a2,a3) ->
            testValue
    );

    private LBiObjBoolPredicateX<Integer ,Integer ,X> functionThrowing = LBiObjBoolPredicateX.lX((a1,a2,a3) -> {
