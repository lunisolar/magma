...
public class LBiObjBoolPredicateXAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjBoolPredicateX<Integer ,Integer ,X> function = LBiObjBoolPredicateX.lX((t1,t2, b) ->
            testValue
    );

    private LBiObjBoolPredicateX<Integer ,Integer ,X> functionThrowing = LBiObjBoolPredicateX.lX((t1,t2, b) -> {
