...
import eu.lunisolar.magma.func.predicate.LBiObjBoolPredicateX;
...
public class LBiObjBoolPredicateXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjBoolPredicateX<Integer,Integer,X> function = (Integer a1,Integer a2,boolean a3) ->
            testValue;


    private LBiObjBoolPredicateX<Integer,Integer,X> functionThrowing = (Integer a1,Integer a2,boolean a3) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest(100,100,true).withException(a -> a
