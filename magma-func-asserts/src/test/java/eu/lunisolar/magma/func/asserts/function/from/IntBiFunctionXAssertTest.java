...
public class IntBiFunctionXAssertTest<R,X extends ParseException> {
    ...
    private IntBiFunctionX<Integer ,X> function = IntBiFunctionX.lX((i1,i2) -> {
            return (Integer ) testValue;
    });

    private IntBiFunctionX<Integer ,X> functionThrowing = IntBiFunctionX.lX((i1,i2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((int)80,(int)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((int)80,(int)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((int)80,(int)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((int)80,(int)81).withException(a -> a
