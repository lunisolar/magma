...
public class BiPredicateAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiPredicate<Integer ,Integer > function = BiPredicate.l((t1,t2) -> {
            return testValue;
    });

    private BiPredicate<Integer ,Integer > functionThrowing = BiPredicate.l((t1,t2) -> {
