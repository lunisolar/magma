...
public class ToCharBiFunctionAssertTest<T1,T2,X extends ParseException> {
    ...
    private ToCharBiFunction<Integer ,Integer > function = ToCharBiFunction.l((t1,t2) -> {
            return testValue;
    });

    private ToCharBiFunction<Integer ,Integer > functionThrowing = ToCharBiFunction.l((t1,t2) -> {
