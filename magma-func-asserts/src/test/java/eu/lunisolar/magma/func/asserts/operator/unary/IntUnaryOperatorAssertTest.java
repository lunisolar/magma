...
public class IntUnaryOperatorAssertTest<X extends ParseException> {
    ...
    private IntUnaryOperator function = IntUnaryOperator.l((i) -> {
            return testValue;
    });

    private IntUnaryOperator functionThrowing = IntUnaryOperator.l((i) -> {
