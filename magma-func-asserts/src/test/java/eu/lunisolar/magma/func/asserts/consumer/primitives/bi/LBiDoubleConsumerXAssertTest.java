...
public class LBiDoubleConsumerXAssertTest<X extends Throwable> {
    ...
    private LBiDoubleConsumerX<X> function = LBiDoubleConsumerX.lX((d1,d2) ->
            externalEffect.set(testValue)
    );

    private LBiDoubleConsumerX<X> functionThrowing = LBiDoubleConsumerX.lX((d1,d2) -> {
