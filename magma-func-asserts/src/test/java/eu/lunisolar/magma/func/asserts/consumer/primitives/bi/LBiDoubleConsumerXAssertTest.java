...
import eu.lunisolar.magma.func.consumer.primitives.bi.LBiDoubleConsumerX;
...
public class LBiDoubleConsumerXAssertTest<X extends ParseException> {
    ...
    private LBiDoubleConsumerX<X> function = (double a1,double a2) ->
            externalEffect.set(testValue);


    private LBiDoubleConsumerX<X> functionThrowing = (double a1,double a2) -> {
