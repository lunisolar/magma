...
public class ByteUnaryOperatorAssertTest<X extends ParseException> {
    ...
    private ByteUnaryOperator function = ByteUnaryOperator.l((b) -> {
            return testValue;
    });

    private ByteUnaryOperator functionThrowing = ByteUnaryOperator.l((b) -> {
