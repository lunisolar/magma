...
public class ToLongFunctionAssertTest<T,X extends ParseException> {
    ...
    private ToLongFunction<Integer > function = ToLongFunction.l((t) -> {
            return testValue;
    });

    private ToLongFunction<Integer > functionThrowing = ToLongFunction.l((t) -> {
