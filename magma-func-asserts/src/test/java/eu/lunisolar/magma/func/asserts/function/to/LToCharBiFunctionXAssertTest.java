...
import eu.lunisolar.magma.func.function.to.LToCharBiFunctionX;
...
public class LToCharBiFunctionXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LToCharBiFunctionX<Integer,Integer,X> function = (Integer a1,Integer a2) ->
            testValue;


    private LToCharBiFunctionX<Integer,Integer,X> functionThrowing = (Integer a1,Integer a2) -> {
