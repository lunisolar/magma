...
public class LToCharBiFunctionXAssertTest<T1,T2,X extends Throwable> {
    ...
    private LToCharBiFunctionX<Integer ,Integer ,X> function = LToCharBiFunctionX.lX((a1,a2) ->
            testValue
    );

    private LToCharBiFunctionX<Integer ,Integer ,X> functionThrowing = LToCharBiFunctionX.lX((a1,a2) -> {
