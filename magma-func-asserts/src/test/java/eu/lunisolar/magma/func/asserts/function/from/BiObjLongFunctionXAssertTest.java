...
public class BiObjLongFunctionXAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private BiObjLongFunctionX<Integer ,Integer ,Integer ,X> function = BiObjLongFunctionX.lX((t1,t2, l) -> {
            return (Integer ) testValue;
    });

    private BiObjLongFunctionX<Integer ,Integer ,Integer ,X> functionThrowing = BiObjLongFunctionX.lX((t1,t2, l) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(long)82).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(long)82).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(long)82).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(long)82).withException(a -> a
