...
import eu.lunisolar.magma.func.consumer.primitives.obj.LBiObjFloatConsumer;
...
public class LBiObjFloatConsumerAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjFloatConsumer<Integer,Integer> function = (Integer a1,Integer a2,float a3) ->
            externalEffect.set(testValue);


    private LBiObjFloatConsumer<Integer,Integer> functionThrowing = (Integer a1,Integer a2,float a3) -> {
