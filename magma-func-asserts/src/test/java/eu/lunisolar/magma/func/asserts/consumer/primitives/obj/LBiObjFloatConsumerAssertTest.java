...
public class LBiObjFloatConsumerAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjFloatConsumer<Integer ,Integer > function = LBiObjFloatConsumer.l((a1,a2,a3) ->
            externalEffect.set(testValue)
    );

    private LBiObjFloatConsumer<Integer ,Integer > functionThrowing = LBiObjFloatConsumer.l((a1,a2,a3) -> {
