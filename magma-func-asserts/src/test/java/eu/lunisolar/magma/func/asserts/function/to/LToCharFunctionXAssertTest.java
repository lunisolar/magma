...
import eu.lunisolar.magma.func.function.to.LToCharFunctionX;
...
public class LToCharFunctionXAssertTest<T,X extends ParseException> {
    ...
    private LToCharFunctionX<Integer,X> function = a1 ->
            testValue;


    private LToCharFunctionX<Integer,X> functionThrowing = a1 -> {
