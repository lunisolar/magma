...
public class LToCharFunctionXAssertTest<T,X extends Throwable> {
    ...
    private LToCharFunctionX<Integer ,X> function = LToCharFunctionX.lX(a1 ->
            testValue
    );

    private LToCharFunctionX<Integer ,X> functionThrowing = LToCharFunctionX.lX(a1 -> {
