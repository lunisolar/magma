...
public class LBoolToIntFunctionAssertTest<X extends ParseException> {
    ...
    private LBoolToIntFunction function = a1 ->
            testValue;


    private LBoolToIntFunction functionThrowing = a1 -> {
