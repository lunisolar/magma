...
public class LBoolToIntFunctionAssertTest<X extends Throwable> {
    ...
    private LBoolToIntFunction function = LBoolToIntFunction.l(a1 ->
            testValue
    );

    private LBoolToIntFunction functionThrowing = LBoolToIntFunction.l(a1 -> {
