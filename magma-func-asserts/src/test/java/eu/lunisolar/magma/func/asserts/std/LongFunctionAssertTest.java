...
public class LongFunctionAssertTest<R,X extends Throwable> {
    ...
    private java.util.function.LongFunction<Integer > function = (a1 ->
            (Integer ) testValue
    );

    private java.util.function.LongFunction<Integer > functionThrowing = (a1 -> {
