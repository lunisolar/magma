...
public class ByteConsumerXAssertTest<X extends ParseException> {
    ...
    private ByteConsumerX<X> function = ByteConsumerX.lX((b) -> {
            externalEffect.set(testValue);
    });

    private ByteConsumerX<X> functionThrowing = ByteConsumerX.lX((b) -> {
