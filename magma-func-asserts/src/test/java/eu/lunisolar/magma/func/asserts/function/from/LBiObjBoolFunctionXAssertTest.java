...
import eu.lunisolar.magma.func.function.from.LBiObjBoolFunctionX;
...
public class LBiObjBoolFunctionXAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private LBiObjBoolFunctionX<Integer,Integer,Integer,X> function = (Integer a1,Integer a2,boolean a3) ->
            testValue;


    private LBiObjBoolFunctionX<Integer,Integer,Integer,X> functionThrowing = (Integer a1,Integer a2,boolean a3) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply(100,100,true).withException(a -> a
