...
import eu.lunisolar.magma.func.function.from.LBiShortFunction;
...
public class LBiShortFunctionAssertTest<R,X extends ParseException> {
    ...
    private LBiShortFunction<Integer> function = (short a1,short a2) ->
            testValue;


    private LBiShortFunction<Integer> functionThrowing = (short a1,short a2) -> {
