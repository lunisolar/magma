...
public class LBiShortFunctionAssertTest<R,X extends Throwable> {
    ...
    private LBiShortFunction<Integer > function = LBiShortFunction.l((a1,a2) ->
            (Integer ) testValue
    );

    private LBiShortFunction<Integer > functionThrowing = LBiShortFunction.l((a1,a2) -> {
