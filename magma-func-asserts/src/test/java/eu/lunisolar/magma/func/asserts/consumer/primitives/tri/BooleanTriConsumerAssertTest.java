...
public class BooleanTriConsumerAssertTest<X extends ParseException> {
    ...
    private BooleanTriConsumer function = BooleanTriConsumer.l((b1,b2,b3) -> {
            externalEffect.set(testValue);
    });

    private BooleanTriConsumer functionThrowing = BooleanTriConsumer.l((b1,b2,b3) -> {
