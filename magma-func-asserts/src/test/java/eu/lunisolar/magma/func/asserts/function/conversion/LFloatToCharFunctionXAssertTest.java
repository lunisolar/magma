...
import eu.lunisolar.magma.func.function.conversion.LFloatToCharFunctionX;
...
public class LFloatToCharFunctionXAssertTest<X extends ParseException> {
    ...
    private LFloatToCharFunctionX<X> function = a1 ->
            testValue;


    private LFloatToCharFunctionX<X> functionThrowing = a1 -> {
