...
public class LFloatToCharFunctionXAssertTest<X extends Throwable> {
    ...
    private LFloatToCharFunctionX<X> function = LFloatToCharFunctionX.lX(a1 ->
            testValue
    );

    private LFloatToCharFunctionX<X> functionThrowing = LFloatToCharFunctionX.lX(a1 -> {
