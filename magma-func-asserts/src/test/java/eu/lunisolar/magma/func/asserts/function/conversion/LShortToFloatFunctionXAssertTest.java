...
public class LShortToFloatFunctionXAssertTest<X extends Throwable> {
    ...
    private LShortToFloatFunctionX<X> function = LShortToFloatFunctionX.lX(a1 ->
            testValue
    );

    private LShortToFloatFunctionX<X> functionThrowing = LShortToFloatFunctionX.lX(a1 -> {
