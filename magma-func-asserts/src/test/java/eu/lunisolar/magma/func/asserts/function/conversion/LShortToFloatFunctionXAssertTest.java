...
import eu.lunisolar.magma.func.function.conversion.LShortToFloatFunctionX;
...
public class LShortToFloatFunctionXAssertTest<X extends ParseException> {
    ...
    private LShortToFloatFunctionX<X> function = a1 ->
            testValue;


    private LShortToFloatFunctionX<X> functionThrowing = a1 -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsFloat((short)100).withException(a -> a
