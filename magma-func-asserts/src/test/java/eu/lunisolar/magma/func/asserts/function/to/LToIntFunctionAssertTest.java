...
public class LToIntFunctionAssertTest<T,X extends Throwable> {
    ...
    private LToIntFunction<Integer > function = LToIntFunction.l(a1 ->
            testValue
    );

    private LToIntFunction<Integer > functionThrowing = LToIntFunction.l(a1 -> {
