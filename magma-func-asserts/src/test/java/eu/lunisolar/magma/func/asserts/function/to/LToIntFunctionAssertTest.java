...
public class LToIntFunctionAssertTest<T,X extends ParseException> {
    ...
    private LToIntFunction<Integer > function = LToIntFunction.l((t) -> {
            return testValue;
    });

    private LToIntFunction<Integer > functionThrowing = LToIntFunction.l((t) -> {
