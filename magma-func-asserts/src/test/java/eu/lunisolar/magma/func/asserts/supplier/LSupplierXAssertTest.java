...
public class LSupplierXAssertTest<R,X extends ParseException> {
    ...
    private LSupplierX<Integer ,X> function = LSupplierX.lX(() -> {
            return (Integer ) testValue;
    });

    private LSupplierX<Integer ,X> functionThrowing = LSupplierX.lX(() -> {
