...
public class DoublePredicateAssertTest<X extends ParseException> {
    ...
    private DoublePredicate function = DoublePredicate.l((d) -> {
            return testValue;
    });

    private DoublePredicate functionThrowing = DoublePredicate.l((d) -> {
