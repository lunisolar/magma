...
public class LFloatToIntFunctionXAssertTest<X extends Throwable> {
    ...
    private LFloatToIntFunctionX<X> function = LFloatToIntFunctionX.lX(a1 ->
            testValue
    );

    private LFloatToIntFunctionX<X> functionThrowing = LFloatToIntFunctionX.lX(a1 -> {
