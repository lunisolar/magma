...
import eu.lunisolar.magma.func.function.conversion.LFloatToIntFunctionX;
...
public class LFloatToIntFunctionXAssertTest<X extends ParseException> {
    ...
    private LFloatToIntFunctionX<X> function = a1 ->
            testValue;


    private LFloatToIntFunctionX<X> functionThrowing = a1 -> {
