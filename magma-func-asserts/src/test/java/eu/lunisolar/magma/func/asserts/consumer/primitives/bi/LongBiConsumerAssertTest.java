...
public class LongBiConsumerAssertTest<X extends ParseException> {
    ...
    private LongBiConsumer function = LongBiConsumer.l((l1,l2) -> {
            externalEffect.set(testValue);
    });

    private LongBiConsumer functionThrowing = LongBiConsumer.l((l1,l2) -> {
