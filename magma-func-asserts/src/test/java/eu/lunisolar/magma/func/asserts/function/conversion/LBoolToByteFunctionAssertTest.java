...
public class LBoolToByteFunctionAssertTest<X extends Throwable> {
    ...
    private LBoolToByteFunction function = LBoolToByteFunction.l(a1 ->
            testValue
    );

    private LBoolToByteFunction functionThrowing = LBoolToByteFunction.l(a1 -> {
