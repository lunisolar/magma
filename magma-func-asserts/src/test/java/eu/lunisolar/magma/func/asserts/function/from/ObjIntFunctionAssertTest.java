...
public class ObjIntFunctionAssertTest<T,R,X extends ParseException> {
    ...
    private ObjIntFunction<Integer ,Integer > function = ObjIntFunction.l((t, i) -> {
            return (Integer ) testValue;
    });

    private ObjIntFunction<Integer ,Integer > functionThrowing = ObjIntFunction.l((t, i) -> {
