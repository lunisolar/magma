...
public class CharBinaryOperatorXAssertTest<X extends ParseException> {
    ...
    private CharBinaryOperatorX<X> function = CharBinaryOperatorX.lX((c1,c2) -> {
            return testValue;
    });

    private CharBinaryOperatorX<X> functionThrowing = CharBinaryOperatorX.lX((c1,c2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsChar((char)80,(char)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsChar((char)80,(char)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsChar((char)80,(char)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsChar((char)80,(char)81).withException(a -> a
