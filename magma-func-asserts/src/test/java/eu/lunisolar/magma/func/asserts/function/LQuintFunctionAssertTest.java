...
import eu.lunisolar.magma.func.function.LQuintFunction;
...
public class LQuintFunctionAssertTest<T1,T2,T3,T4,T5,R> {
    ...
    private LQuintFunction<Integer,Integer,Integer,Integer,Integer,Integer> function = (a1,a2,a3,a4,a5) ->
            testValue;


    private LQuintFunction<Integer,Integer,Integer,Integer,Integer,Integer> functionThrowing = (a1,a2,a3,a4,a5) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertQuintFunc(function)
         .doesApply(100,100,100,100,100)
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertQuintFunc(functionThrowing)
         .doesApply(100,100,100,100,100)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertQuintFunc(functionThrowing)
         .doesApply(100,100,100,100,100).withException(a -> a
