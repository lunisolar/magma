...
public class LLongFunctionXAssertTest<R,X extends Throwable> {
    ...
    private LLongFunctionX<Integer ,X> function = LLongFunctionX.lX(a1 ->
            (Integer ) testValue
    );

    private LLongFunctionX<Integer ,X> functionThrowing = LLongFunctionX.lX(a1 -> {
