...
import eu.lunisolar.magma.func.function.from.LLongFunctionX;
...
public class LLongFunctionXAssertTest<R,X extends ParseException> {
    ...
    private LLongFunctionX<Integer,X> function = a1 ->
            testValue;


    private LLongFunctionX<Integer,X> functionThrowing = a1 -> {
