...
import eu.lunisolar.magma.func.function.to.LToDoubleFunctionX;
...
public class LToDoubleFunctionXAssertTest<T,X extends ParseException> {
    ...
    private LToDoubleFunctionX<Integer,X> function = a1 ->
            testValue;


    private LToDoubleFunctionX<Integer,X> functionThrowing = a1 -> {
