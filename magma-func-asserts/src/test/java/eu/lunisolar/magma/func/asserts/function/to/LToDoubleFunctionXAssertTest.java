...
public class LToDoubleFunctionXAssertTest<T,X extends Throwable> {
    ...
    private LToDoubleFunctionX<Integer ,X> function = LToDoubleFunctionX.lX(a1 ->
            testValue
    );

    private LToDoubleFunctionX<Integer ,X> functionThrowing = LToDoubleFunctionX.lX(a1 -> {
