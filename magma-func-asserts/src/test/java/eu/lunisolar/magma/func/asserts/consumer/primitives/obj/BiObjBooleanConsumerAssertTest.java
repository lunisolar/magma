...
public class BiObjBooleanConsumerAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjBooleanConsumer<Integer ,Integer > function = BiObjBooleanConsumer.l((t1,t2, b) -> {
            externalEffect.set(testValue);
    });

    private BiObjBooleanConsumer<Integer ,Integer > functionThrowing = BiObjBooleanConsumer.l((t1,t2, b) -> {
