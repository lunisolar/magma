...
public class LTriBooleanConsumerXAssertTest<X extends Throwable> {
    ...
    private LTriBooleanConsumerX<X> function = LTriBooleanConsumerX.lX((b1,b2,b3) ->
            externalEffect.set(testValue)
    );

    private LTriBooleanConsumerX<X> functionThrowing = LTriBooleanConsumerX.lX((b1,b2,b3) -> {
