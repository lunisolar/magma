...
public class LBiObjLongConsumerAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjLongConsumer<Integer ,Integer > function = LBiObjLongConsumer.l((a1,a2,a3) ->
            externalEffect.set(testValue)
    );

    private LBiObjLongConsumer<Integer ,Integer > functionThrowing = LBiObjLongConsumer.l((a1,a2,a3) -> {
