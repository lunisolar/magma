...
public class LIntConsumerAssertTest<X extends Throwable> {
    ...
    private LIntConsumer function = LIntConsumer.l(a1 ->
            externalEffect.set(testValue)
    );

    private LIntConsumer functionThrowing = LIntConsumer.l(a1 -> {
