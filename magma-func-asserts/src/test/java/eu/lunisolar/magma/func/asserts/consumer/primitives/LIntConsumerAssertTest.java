...
public class LIntConsumerAssertTest<X extends ParseException> {
    ...
    private LIntConsumer function = LIntConsumer.l((i) -> {
            externalEffect.set(testValue);
    });

    private LIntConsumer functionThrowing = LIntConsumer.l((i) -> {
