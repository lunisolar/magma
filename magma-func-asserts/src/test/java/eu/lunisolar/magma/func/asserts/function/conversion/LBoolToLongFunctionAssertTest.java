...
public class LBoolToLongFunctionAssertTest<X extends ParseException> {
    ...
    private LBoolToLongFunction function = a1 ->
            testValue;


    private LBoolToLongFunction functionThrowing = a1 -> {
