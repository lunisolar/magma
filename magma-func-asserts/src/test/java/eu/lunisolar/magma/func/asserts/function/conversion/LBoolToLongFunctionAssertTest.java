...
public class LBoolToLongFunctionAssertTest<X extends Throwable> {
    ...
    private LBoolToLongFunction function = LBoolToLongFunction.l(a1 ->
            testValue
    );

    private LBoolToLongFunction functionThrowing = LBoolToLongFunction.l(a1 -> {
