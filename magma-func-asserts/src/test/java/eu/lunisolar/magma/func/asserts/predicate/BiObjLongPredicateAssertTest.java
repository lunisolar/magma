...
public class BiObjLongPredicateAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjLongPredicate<Integer ,Integer > function = BiObjLongPredicate.l((t1,t2, l) -> {
            return testValue;
    });

    private BiObjLongPredicate<Integer ,Integer > functionThrowing = BiObjLongPredicate.l((t1,t2, l) -> {
