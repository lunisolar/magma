...
public class BiFunctionXAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private BiFunctionX<Integer ,Integer ,Integer ,X> function = BiFunctionX.lX((t1,t2) -> {
            return (Integer ) testValue;
    });

    private BiFunctionX<Integer ,Integer ,Integer ,X> functionThrowing = BiFunctionX.lX((t1,t2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81)).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81)).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81)).to( a -> a.isEqualTo(1));
