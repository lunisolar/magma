...
public class LBiFloatFunctionXAssertTest<R,X extends Throwable> {
    ...
    private LBiFloatFunctionX<Integer ,X> function = LBiFloatFunctionX.lX((a1,a2) ->
            (Integer ) testValue
    );

    private LBiFloatFunctionX<Integer ,X> functionThrowing = LBiFloatFunctionX.lX((a1,a2) -> {
