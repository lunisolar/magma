...
import eu.lunisolar.magma.func.function.from.LBiFloatFunctionX;
...
public class LBiFloatFunctionXAssertTest<R,X extends ParseException> {
    ...
    private LBiFloatFunctionX<Integer,X> function = (float a1,float a2) ->
            testValue;


    private LBiFloatFunctionX<Integer,X> functionThrowing = (float a1,float a2) -> {
