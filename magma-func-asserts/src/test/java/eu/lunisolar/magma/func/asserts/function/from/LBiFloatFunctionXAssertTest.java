...
public class LBiFloatFunctionXAssertTest<R,X extends Throwable> {
    ...
    private LBiFloatFunctionX<Integer ,X> function = LBiFloatFunctionX.lX((f1,f2) ->
            (Integer ) testValue
    );

    private LBiFloatFunctionX<Integer ,X> functionThrowing = LBiFloatFunctionX.lX((f1,f2) -> {
