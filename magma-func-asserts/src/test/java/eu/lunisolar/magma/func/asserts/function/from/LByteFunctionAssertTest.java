...
public class LByteFunctionAssertTest<R,X extends Throwable> {
    ...
    private LByteFunction<Integer > function = LByteFunction.l(a1 ->
            (Integer ) testValue
    );

    private LByteFunction<Integer > functionThrowing = LByteFunction.l(a1 -> {
