...
public class LTriFunctionAssertTest<T1,T2,T3,R,X extends Throwable> {
    ...
    private LTriFunction<Integer ,Integer ,Integer ,Integer > function = LTriFunction.l((a1,a2,a3) ->
            (Integer ) testValue
    );

    private LTriFunction<Integer ,Integer ,Integer ,Integer > functionThrowing = LTriFunction.l((a1,a2,a3) -> {
