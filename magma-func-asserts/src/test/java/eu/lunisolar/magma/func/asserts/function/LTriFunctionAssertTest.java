...
public class LTriFunctionAssertTest<T1,T2,T3,R,X extends ParseException> {
    ...
    private LTriFunction<Integer,Integer,Integer,Integer> function = (Integer a1,Integer a2,Integer a3) ->
            testValue;


    private LTriFunction<Integer,Integer,Integer,Integer> functionThrowing = (Integer a1,Integer a2,Integer a3) -> {
