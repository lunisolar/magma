...
public class LTriFunctionAssertTest<T1,T2,T3,R> {
    ...
    private LTriFunction<Integer,Integer,Integer,Integer> function = (a1,a2,a3) ->
            testValue;


    private LTriFunction<Integer,Integer,Integer,Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertTriFunc(functionThrowing)
         .doesApply(100,100,100)
            .to( a -> a.isEqualTo(1));
    }
