...
public class BiObjFloatConsumerXAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjFloatConsumerX<Integer ,Integer ,X> function = BiObjFloatConsumerX.lX((t1,t2, f) -> {
            externalEffect.set(testValue);
    });

    private BiObjFloatConsumerX<Integer ,Integer ,X> functionThrowing = BiObjFloatConsumerX.lX((t1,t2, f) -> {
