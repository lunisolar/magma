...
import eu.lunisolar.magma.func.function.from.LObjShortFunctionX;
...
public class LObjShortFunctionXAssertTest<T,R,X extends ParseException> {
    ...
    private LObjShortFunctionX<Integer,Integer,X> function = (Integer a1,short a2) ->
            testValue;


    private LObjShortFunctionX<Integer,Integer,X> functionThrowing = (Integer a1,short a2) -> {
