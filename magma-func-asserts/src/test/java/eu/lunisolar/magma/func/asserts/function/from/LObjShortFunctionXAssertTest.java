...
public class LObjShortFunctionXAssertTest<T,R,X extends Throwable> {
    ...
    private LObjShortFunctionX<Integer ,Integer ,X> function = LObjShortFunctionX.lX((a1,a2) ->
            (Integer ) testValue
    );

    private LObjShortFunctionX<Integer ,Integer ,X> functionThrowing = LObjShortFunctionX.lX((a1,a2) -> {
