...
public class DoubleToShortFunctionXAssertTest<X extends ParseException> {
    ...
    private DoubleToShortFunctionX<X> function = DoubleToShortFunctionX.lX((d) -> {
            return testValue;
    });

    private DoubleToShortFunctionX<X> functionThrowing = DoubleToShortFunctionX.lX((d) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsShort((double)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsShort((double)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort((double)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort((double)80).withException(a -> a
