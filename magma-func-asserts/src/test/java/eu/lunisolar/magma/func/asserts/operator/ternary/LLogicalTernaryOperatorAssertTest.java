...
public class LLogicalTernaryOperatorAssertTest<X extends Throwable> {
    ...
    private LLogicalTernaryOperator function = LLogicalTernaryOperator.l((a1,a2,a3) ->
            testValue
    );

    private LLogicalTernaryOperator functionThrowing = LLogicalTernaryOperator.l((a1,a2,a3) -> {
