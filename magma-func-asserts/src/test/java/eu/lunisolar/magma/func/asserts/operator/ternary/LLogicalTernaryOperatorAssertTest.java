...
public class LLogicalTernaryOperatorAssertTest<X extends Throwable> {
    ...
    private LLogicalTernaryOperator function = LLogicalTernaryOperator.l((b1,b2,b3) ->
            testValue
    );

    private LLogicalTernaryOperator functionThrowing = LLogicalTernaryOperator.l((b1,b2,b3) -> {
