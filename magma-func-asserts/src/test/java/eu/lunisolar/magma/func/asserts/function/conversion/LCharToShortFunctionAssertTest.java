...
public class LCharToShortFunctionAssertTest<X extends Throwable> {
    ...
    private LCharToShortFunction function = LCharToShortFunction.l(a1 ->
            testValue
    );

    private LCharToShortFunction functionThrowing = LCharToShortFunction.l(a1 -> {
