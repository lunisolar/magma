...
import eu.lunisolar.magma.func.function.conversion.LCharToShortFunction;
...
public class LCharToShortFunctionAssertTest<X extends ParseException> {
    ...
    private LCharToShortFunction function = a1 ->
            testValue;


    private LCharToShortFunction functionThrowing = a1 -> {
