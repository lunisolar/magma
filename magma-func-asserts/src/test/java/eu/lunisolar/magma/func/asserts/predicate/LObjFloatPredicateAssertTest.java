...
public class LObjFloatPredicateAssertTest<T,X extends Throwable> {
    ...
    private LObjFloatPredicate<Integer > function = LObjFloatPredicate.l((a1,a2) ->
            testValue
    );

    private LObjFloatPredicate<Integer > functionThrowing = LObjFloatPredicate.l((a1,a2) -> {
