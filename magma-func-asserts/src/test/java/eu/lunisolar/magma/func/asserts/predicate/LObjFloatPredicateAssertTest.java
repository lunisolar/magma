...
import eu.lunisolar.magma.func.predicate.LObjFloatPredicate;
...
public class LObjFloatPredicateAssertTest<T,X extends ParseException> {
    ...
    private LObjFloatPredicate<Integer> function = (Integer a1,float a2) ->
            testValue;


    private LObjFloatPredicate<Integer> functionThrowing = (Integer a1,float a2) -> {
