...
public class LFloatUnaryOperatorXAssertTest<X extends Throwable> {
    ...
    private LFloatUnaryOperatorX<X> function = LFloatUnaryOperatorX.lX(a1 ->
            testValue
    );

    private LFloatUnaryOperatorX<X> functionThrowing = LFloatUnaryOperatorX.lX(a1 -> {
