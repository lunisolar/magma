...
public class LongToDoubleFunctionAssertTest<X extends Throwable> {
    ...
    private java.util.function.LongToDoubleFunction function = (a1 ->
            testValue
    );

    private java.util.function.LongToDoubleFunction functionThrowing = (a1 -> {
