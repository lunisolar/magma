...
public class IntBinaryOperatorXAssertTest<X extends ParseException> {
    ...
    private IntBinaryOperatorX<X> function = IntBinaryOperatorX.lX((i1,i2) -> {
            return testValue;
    });

    private IntBinaryOperatorX<X> functionThrowing = IntBinaryOperatorX.lX((i1,i2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsInt((int)80,(int)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsInt((int)80,(int)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsInt((int)80,(int)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsInt((int)80,(int)81).withException(a -> a
