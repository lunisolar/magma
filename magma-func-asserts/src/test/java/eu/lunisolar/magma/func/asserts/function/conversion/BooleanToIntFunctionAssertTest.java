...
public class BooleanToIntFunctionAssertTest<X extends ParseException> {
    ...
    private BooleanToIntFunction function = BooleanToIntFunction.l((b) -> {
            return testValue;
    });

    private BooleanToIntFunction functionThrowing = BooleanToIntFunction.l((b) -> {
