...
public class LBiObjShortPredicateXAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjShortPredicateX<Integer ,Integer ,X> function = LBiObjShortPredicateX.lX((a1,a2,a3) ->
            testValue
    );

    private LBiObjShortPredicateX<Integer ,Integer ,X> functionThrowing = LBiObjShortPredicateX.lX((a1,a2,a3) -> {
