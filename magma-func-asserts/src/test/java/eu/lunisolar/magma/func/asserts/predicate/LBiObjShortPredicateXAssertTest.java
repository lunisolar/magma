...
import eu.lunisolar.magma.func.predicate.LBiObjShortPredicateX;
...
public class LBiObjShortPredicateXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjShortPredicateX<Integer,Integer,X> function = (Integer a1,Integer a2,short a3) ->
            testValue;


    private LBiObjShortPredicateX<Integer,Integer,X> functionThrowing = (Integer a1,Integer a2,short a3) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest(100,100,(short)100).withException(a -> a
