...
public class DoubleBiFunctionXAssertTest<R,X extends ParseException> {
    ...
    private DoubleBiFunctionX<Integer ,X> function = DoubleBiFunctionX.lX((d1,d2) -> {
            return (Integer ) testValue;
    });

    private DoubleBiFunctionX<Integer ,X> functionThrowing = DoubleBiFunctionX.lX((d1,d2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((double)80,(double)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((double)80,(double)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((double)80,(double)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((double)80,(double)81).withException(a -> a
