...
public class ToIntFunctionXAssertTest<T,X extends ParseException> {
    ...
    private ToIntFunctionX<Integer ,X> function = ToIntFunctionX.lX((t) -> {
            return testValue;
    });

    private ToIntFunctionX<Integer ,X> functionThrowing = ToIntFunctionX.lX((t) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsInt((Integer )Integer.valueOf(80)).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsInt((Integer )Integer.valueOf(80)).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsInt((Integer )Integer.valueOf(80)).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsInt((Integer )Integer.valueOf(80)).withException(a -> a
