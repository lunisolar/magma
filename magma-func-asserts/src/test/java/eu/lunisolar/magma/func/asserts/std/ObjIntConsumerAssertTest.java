...
public class ObjIntConsumerAssertTest<T> {
    ...
    private ObjIntConsumer<Integer> function = (Integer a1,int a2) ->
            externalEffect.set(testValue);


    private ObjIntConsumer<Integer> functionThrowing = (Integer a1,int a2) -> {
