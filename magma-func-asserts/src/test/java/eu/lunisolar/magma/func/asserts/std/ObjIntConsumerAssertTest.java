...
public class ObjIntConsumerAssertTest<T,X extends Throwable> {
    ...
    private java.util.function.ObjIntConsumer<Integer > function = ((a1,a2) ->
            externalEffect.set(testValue)
    );

    private java.util.function.ObjIntConsumer<Integer > functionThrowing = ((a1,a2) -> {
