...
public class LBiObjCharPredicateXAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjCharPredicateX<Integer ,Integer ,X> function = LBiObjCharPredicateX.lX((a1,a2,a3) ->
            testValue
    );

    private LBiObjCharPredicateX<Integer ,Integer ,X> functionThrowing = LBiObjCharPredicateX.lX((a1,a2,a3) -> {
