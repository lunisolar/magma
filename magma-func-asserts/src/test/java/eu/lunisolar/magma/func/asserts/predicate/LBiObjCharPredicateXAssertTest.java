...
import eu.lunisolar.magma.func.predicate.LBiObjCharPredicateX;
...
public class LBiObjCharPredicateXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjCharPredicateX<Integer,Integer,X> function = (Integer a1,Integer a2,char a3) ->
            testValue;


    private LBiObjCharPredicateX<Integer,Integer,X> functionThrowing = (Integer a1,Integer a2,char a3) -> {
