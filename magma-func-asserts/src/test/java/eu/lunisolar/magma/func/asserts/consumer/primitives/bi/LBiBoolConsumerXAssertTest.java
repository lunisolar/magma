...
import eu.lunisolar.magma.func.consumer.primitives.bi.LBiBoolConsumerX;
...
public class LBiBoolConsumerXAssertTest<X extends ParseException> {
    ...
    private LBiBoolConsumerX<X> function = (boolean a1,boolean a2) ->
            externalEffect.set(testValue);


    private LBiBoolConsumerX<X> functionThrowing = (boolean a1,boolean a2) -> {
