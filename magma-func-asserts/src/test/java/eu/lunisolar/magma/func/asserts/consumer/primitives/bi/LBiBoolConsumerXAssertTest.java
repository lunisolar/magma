...
public class LBiBoolConsumerXAssertTest<X extends Throwable> {
    ...
    private LBiBoolConsumerX<X> function = LBiBoolConsumerX.lX((a1,a2) ->
            externalEffect.set(testValue)
    );

    private LBiBoolConsumerX<X> functionThrowing = LBiBoolConsumerX.lX((a1,a2) -> {
