...
public class CharToByteFunctionXAssertTest<X extends ParseException> {
    ...
    private CharToByteFunctionX<X> function = CharToByteFunctionX.lX((c) -> {
            return testValue;
    });

    private CharToByteFunctionX<X> functionThrowing = CharToByteFunctionX.lX((c) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsByte((char)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsByte((char)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsByte((char)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsByte((char)80).withException(a -> a
