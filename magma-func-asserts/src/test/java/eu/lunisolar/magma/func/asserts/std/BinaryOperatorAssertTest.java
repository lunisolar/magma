...
public class BinaryOperatorAssertTest<T,X extends Throwable> {
    ...
    private java.util.function.BinaryOperator<Integer > function = ((a1,a2) ->
            (Integer ) testValue
    );

    private java.util.function.BinaryOperator<Integer > functionThrowing = ((a1,a2) -> {
