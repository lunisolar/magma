...
import eu.lunisolar.magma.func.function.from.LBiObjShortFunction;
...
public class LBiObjShortFunctionAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private LBiObjShortFunction<Integer,Integer,Integer> function = (Integer a1,Integer a2,short a3) ->
            testValue;


    private LBiObjShortFunction<Integer,Integer,Integer> functionThrowing = (Integer a1,Integer a2,short a3) -> {
