...
public class LBiObjShortFunctionAssertTest<T1,T2,R,X extends Throwable> {
    ...
    private LBiObjShortFunction<Integer ,Integer ,Integer > function = LBiObjShortFunction.l((a1,a2,a3) ->
            (Integer ) testValue
    );

    private LBiObjShortFunction<Integer ,Integer ,Integer > functionThrowing = LBiObjShortFunction.l((a1,a2,a3) -> {
