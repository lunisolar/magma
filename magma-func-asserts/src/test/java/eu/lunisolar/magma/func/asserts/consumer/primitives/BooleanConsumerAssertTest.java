...
public class BooleanConsumerAssertTest<X extends ParseException> {
    ...
    private BooleanConsumer function = BooleanConsumer.l((b) -> {
            externalEffect.set(testValue);
    });

    private BooleanConsumer functionThrowing = BooleanConsumer.l((b) -> {
