...
import eu.lunisolar.magma.func.consumer.primitives.LBoolConsumerX;
...
public class LBoolConsumerXAssertTest<X extends ParseException> {
    ...
    private LBoolConsumerX<X> function = a1 ->
            externalEffect.set(testValue);


    private LBoolConsumerX<X> functionThrowing = a1 -> {
