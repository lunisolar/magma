...
public class LObjByteConsumerAssertTest<T,X extends Throwable> {
    ...
    private LObjByteConsumer<Integer > function = LObjByteConsumer.l((a1,a2) ->
            externalEffect.set(testValue)
    );

    private LObjByteConsumer<Integer > functionThrowing = LObjByteConsumer.l((a1,a2) -> {
