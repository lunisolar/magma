...
public class ByteToLongFunctionAssertTest<X extends ParseException> {
    ...
    private ByteToLongFunction function = ByteToLongFunction.l((b) -> {
            return testValue;
    });

    private ByteToLongFunction functionThrowing = ByteToLongFunction.l((b) -> {
