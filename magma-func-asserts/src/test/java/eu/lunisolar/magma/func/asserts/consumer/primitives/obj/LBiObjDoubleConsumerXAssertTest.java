...
public class LBiObjDoubleConsumerXAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjDoubleConsumerX<Integer ,Integer ,X> function = LBiObjDoubleConsumerX.lX((a1,a2,a3) ->
            externalEffect.set(testValue)
    );

    private LBiObjDoubleConsumerX<Integer ,Integer ,X> functionThrowing = LBiObjDoubleConsumerX.lX((a1,a2,a3) -> {
