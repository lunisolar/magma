...
import eu.lunisolar.magma.func.consumer.primitives.obj.LBiObjDoubleConsumerX;
...
public class LBiObjDoubleConsumerXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjDoubleConsumerX<Integer,Integer,X> function = (Integer a1,Integer a2,double a3) ->
            externalEffect.set(testValue);


    private LBiObjDoubleConsumerX<Integer,Integer,X> functionThrowing = (Integer a1,Integer a2,double a3) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept(100,100,100d).withException(a -> a
