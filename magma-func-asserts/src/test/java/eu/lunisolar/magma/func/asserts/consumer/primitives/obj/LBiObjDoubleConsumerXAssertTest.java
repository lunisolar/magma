...
public class LBiObjDoubleConsumerXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjDoubleConsumerX<Integer ,Integer ,X> function = LBiObjDoubleConsumerX.lX((t1,t2, d) -> {
            externalEffect.set(testValue);
    });

    private LBiObjDoubleConsumerX<Integer ,Integer ,X> functionThrowing = LBiObjDoubleConsumerX.lX((t1,t2, d) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesAccept((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(double)82)
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(double)82).withException(a -> a
