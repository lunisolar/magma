...
public class IntFunctionAssertTest<R,X extends Throwable> {
    ...
    private java.util.function.IntFunction<Integer > function = (a1 ->
            (Integer ) testValue
    );

    private java.util.function.IntFunction<Integer > functionThrowing = (a1 -> {
