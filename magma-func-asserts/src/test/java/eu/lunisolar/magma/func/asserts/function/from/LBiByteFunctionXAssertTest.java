...
import eu.lunisolar.magma.func.function.from.LBiByteFunctionX;
...
public class LBiByteFunctionXAssertTest<R,X extends ParseException> {
    ...
    private LBiByteFunctionX<Integer,X> function = (byte a1,byte a2) ->
            testValue;


    private LBiByteFunctionX<Integer,X> functionThrowing = (byte a1,byte a2) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((byte)100,(byte)100).withException(a -> a
