...
public class LBiByteFunctionXAssertTest<R,X extends Throwable> {
    ...
    private LBiByteFunctionX<Integer ,X> function = LBiByteFunctionX.lX((b1,b2) ->
            (Integer ) testValue
    );

    private LBiByteFunctionX<Integer ,X> functionThrowing = LBiByteFunctionX.lX((b1,b2) -> {
