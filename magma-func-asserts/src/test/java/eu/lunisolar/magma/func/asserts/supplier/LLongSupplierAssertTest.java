...
public class LLongSupplierAssertTest<X extends ParseException> {
    ...
    private LLongSupplier function = LLongSupplier.l(() -> {
            return testValue;
    });

    private LLongSupplier functionThrowing = LLongSupplier.l(() -> {
