...
public class BiObjByteFunctionAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private BiObjByteFunction<Integer ,Integer ,Integer > function = BiObjByteFunction.l((t1,t2, i) -> {
            return (Integer ) testValue;
    });

    private BiObjByteFunction<Integer ,Integer ,Integer > functionThrowing = BiObjByteFunction.l((t1,t2, i) -> {
