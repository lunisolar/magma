...
public class LTriFunctionXAssertTest<T1,T2,T3,R,X extends Throwable> {
    ...
    private LTriFunctionX<Integer ,Integer ,Integer ,Integer ,X> function = LTriFunctionX.lX((a1,a2,a3) ->
            (Integer ) testValue
    );

    private LTriFunctionX<Integer ,Integer ,Integer ,Integer ,X> functionThrowing = LTriFunctionX.lX((a1,a2,a3) -> {
