...
public class LBoolFunctionAssertTest<R,X extends Throwable> {
    ...
    private LBoolFunction<Integer > function = LBoolFunction.l(a1 ->
            (Integer ) testValue
    );

    private LBoolFunction<Integer > functionThrowing = LBoolFunction.l(a1 -> {
