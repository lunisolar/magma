...
public class ToShortFunctionXAssertTest<T,X extends ParseException> {
    ...
    private ToShortFunctionX<Integer ,X> function = ToShortFunctionX.lX((t) -> {
            return testValue;
    });

    private ToShortFunctionX<Integer ,X> functionThrowing = ToShortFunctionX.lX((t) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsShort((Integer )Integer.valueOf(80)).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsShort((Integer )Integer.valueOf(80)).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort((Integer )Integer.valueOf(80)).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort((Integer )Integer.valueOf(80)).withException(a -> a
