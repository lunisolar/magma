...
public class ObjByteFunctionXAssertTest<T,R,X extends ParseException> {
    ...
    private ObjByteFunctionX<Integer ,Integer ,X> function = ObjByteFunctionX.lX((t, i) -> {
            return (Integer ) testValue;
    });

    private ObjByteFunctionX<Integer ,Integer ,X> functionThrowing = ObjByteFunctionX.lX((t, i) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(byte)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(byte)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(byte)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(byte)81).withException(a -> a
