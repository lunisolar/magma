...
public class LBoolToByteFunctionXAssertTest<X extends Throwable> {
    ...
    private LBoolToByteFunctionX<X> function = LBoolToByteFunctionX.lX(a1 ->
            testValue
    );

    private LBoolToByteFunctionX<X> functionThrowing = LBoolToByteFunctionX.lX(a1 -> {
