...
import eu.lunisolar.magma.func.function.conversion.LBoolToByteFunctionX;
...
public class LBoolToByteFunctionXAssertTest<X extends ParseException> {
    ...
    private LBoolToByteFunctionX<X> function = a1 ->
            testValue;


    private LBoolToByteFunctionX<X> functionThrowing = a1 -> {
