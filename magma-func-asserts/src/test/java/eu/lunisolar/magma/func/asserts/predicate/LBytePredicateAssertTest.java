...
public class LBytePredicateAssertTest<X extends Throwable> {
    ...
    private LBytePredicate function = LBytePredicate.l(a1 ->
            testValue
    );

    private LBytePredicate functionThrowing = LBytePredicate.l(a1 -> {
