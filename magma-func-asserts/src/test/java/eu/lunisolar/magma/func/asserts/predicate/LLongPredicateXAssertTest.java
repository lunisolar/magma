...
import eu.lunisolar.magma.func.predicate.LLongPredicateX;
...
public class LLongPredicateXAssertTest<X extends ParseException> {
    ...
    private LLongPredicateX<X> function = a1 ->
            testValue;


    private LLongPredicateX<X> functionThrowing = a1 -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest(100L).withException(a -> a
