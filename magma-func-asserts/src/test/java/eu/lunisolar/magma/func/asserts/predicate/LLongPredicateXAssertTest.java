...
public class LLongPredicateXAssertTest<X extends Throwable> {
    ...
    private LLongPredicateX<X> function = LLongPredicateX.lX(a1 ->
            testValue
    );

    private LLongPredicateX<X> functionThrowing = LLongPredicateX.lX(a1 -> {
