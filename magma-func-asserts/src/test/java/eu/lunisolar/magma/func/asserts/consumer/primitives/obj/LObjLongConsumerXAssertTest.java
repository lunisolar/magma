...
public class LObjLongConsumerXAssertTest<T,X extends Throwable> {
    ...
    private LObjLongConsumerX<Integer ,X> function = LObjLongConsumerX.lX((a1,a2) ->
            externalEffect.set(testValue)
    );

    private LObjLongConsumerX<Integer ,X> functionThrowing = LObjLongConsumerX.lX((a1,a2) -> {
