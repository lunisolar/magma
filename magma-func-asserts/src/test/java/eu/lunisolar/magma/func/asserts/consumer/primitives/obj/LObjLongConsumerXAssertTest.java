...
import eu.lunisolar.magma.func.consumer.primitives.obj.LObjLongConsumerX;
...
public class LObjLongConsumerXAssertTest<T,X extends ParseException> {
    ...
    private LObjLongConsumerX<Integer,X> function = (Integer a1,long a2) ->
            externalEffect.set(testValue);


    private LObjLongConsumerX<Integer,X> functionThrowing = (Integer a1,long a2) -> {
