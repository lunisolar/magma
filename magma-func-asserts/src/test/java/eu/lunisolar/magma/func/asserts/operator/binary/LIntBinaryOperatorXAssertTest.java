...
public class LIntBinaryOperatorXAssertTest<X extends Throwable> {
    ...
    private LIntBinaryOperatorX<X> function = LIntBinaryOperatorX.lX((a1,a2) ->
            testValue
    );

    private LIntBinaryOperatorX<X> functionThrowing = LIntBinaryOperatorX.lX((a1,a2) -> {
