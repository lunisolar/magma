...
import eu.lunisolar.magma.func.operator.unary.LDoubleUnaryOperatorX;
...
public class LDoubleUnaryOperatorXAssertTest<X extends ParseException> {
    ...
    private LDoubleUnaryOperatorX<X> function = a1 ->
            testValue;


    private LDoubleUnaryOperatorX<X> functionThrowing = a1 -> {
