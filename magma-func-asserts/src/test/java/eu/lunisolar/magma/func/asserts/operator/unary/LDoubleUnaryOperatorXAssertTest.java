...
public class LDoubleUnaryOperatorXAssertTest<X extends Throwable> {
    ...
    private LDoubleUnaryOperatorX<X> function = LDoubleUnaryOperatorX.lX(a1 ->
            testValue
    );

    private LDoubleUnaryOperatorX<X> functionThrowing = LDoubleUnaryOperatorX.lX(a1 -> {
