...
public class LBiObjIntPredicateAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjIntPredicate<Integer,Integer> function = (Integer a1,Integer a2,int a3) ->
            testValue;


    private LBiObjIntPredicate<Integer,Integer> functionThrowing = (Integer a1,Integer a2,int a3) -> {
