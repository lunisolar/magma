...
public class LBiObjIntPredicateAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjIntPredicate<Integer ,Integer > function = LBiObjIntPredicate.l((a1,a2,a3) ->
            testValue
    );

    private LBiObjIntPredicate<Integer ,Integer > functionThrowing = LBiObjIntPredicate.l((a1,a2,a3) -> {
