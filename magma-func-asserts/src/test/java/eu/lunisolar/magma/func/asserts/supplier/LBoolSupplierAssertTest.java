...
public class LBoolSupplierAssertTest<X extends Throwable> {
    ...
    private LBoolSupplier function = LBoolSupplier.l(() ->
            testValue
    );

    private LBoolSupplier functionThrowing = LBoolSupplier.l(() -> {
