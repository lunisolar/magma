...
public class LBiObjByteFunctionXAssertTest<T1,T2,R,X extends Throwable> {
    ...
    private LBiObjByteFunctionX<Integer ,Integer ,Integer ,X> function = LBiObjByteFunctionX.lX((a1,a2,a3) ->
            (Integer ) testValue
    );

    private LBiObjByteFunctionX<Integer ,Integer ,Integer ,X> functionThrowing = LBiObjByteFunctionX.lX((a1,a2,a3) -> {
