...
import eu.lunisolar.magma.func.function.from.LBiObjByteFunctionX;
...
public class LBiObjByteFunctionXAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private LBiObjByteFunctionX<Integer,Integer,Integer,X> function = (Integer a1,Integer a2,byte a3) ->
            testValue;


    private LBiObjByteFunctionX<Integer,Integer,Integer,X> functionThrowing = (Integer a1,Integer a2,byte a3) -> {
