...
public class LDoubleToLongFunctionXAssertTest<X extends Throwable> {
    ...
    private LDoubleToLongFunctionX<X> function = LDoubleToLongFunctionX.lX(a1 ->
            testValue
    );

    private LDoubleToLongFunctionX<X> functionThrowing = LDoubleToLongFunctionX.lX(a1 -> {
