...
import eu.lunisolar.magma.func.function.conversion.LDoubleToLongFunctionX;
...
public class LDoubleToLongFunctionXAssertTest<X extends ParseException> {
    ...
    private LDoubleToLongFunctionX<X> function = a1 ->
            testValue;


    private LDoubleToLongFunctionX<X> functionThrowing = a1 -> {
