...
public class LIntToLongFunctionAssertTest<X extends Throwable> {
    ...
    private LIntToLongFunction function = LIntToLongFunction.l(a1 ->
            testValue
    );

    private LIntToLongFunction functionThrowing = LIntToLongFunction.l(a1 -> {
