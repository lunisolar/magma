...
public class LIntToLongFunctionAssertTest<X extends ParseException> {
    ...
    private LIntToLongFunction function = LIntToLongFunction.l((i) -> {
            return testValue;
    });

    private LIntToLongFunction functionThrowing = LIntToLongFunction.l((i) -> {
