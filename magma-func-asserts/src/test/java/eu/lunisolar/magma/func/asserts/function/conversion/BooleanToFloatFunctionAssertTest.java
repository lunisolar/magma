...
public class BooleanToFloatFunctionAssertTest<X extends ParseException> {
    ...
    private BooleanToFloatFunction function = BooleanToFloatFunction.l((b) -> {
            return testValue;
    });

    private BooleanToFloatFunction functionThrowing = BooleanToFloatFunction.l((b) -> {
