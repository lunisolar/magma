...
public class DoubleToFloatFunctionAssertTest<X extends ParseException> {
    ...
    private DoubleToFloatFunction function = DoubleToFloatFunction.l((d) -> {
            return testValue;
    });

    private DoubleToFloatFunction functionThrowing = DoubleToFloatFunction.l((d) -> {
