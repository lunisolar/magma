...
public class ShortFunctionXAssertTest<R,X extends ParseException> {
    ...
    private ShortFunctionX<Integer ,X> function = ShortFunctionX.lX((s) -> {
            return (Integer ) testValue;
    });

    private ShortFunctionX<Integer ,X> functionThrowing = ShortFunctionX.lX((s) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((short)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((short)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((short)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((short)80).withException(a -> a
