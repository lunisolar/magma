...
public class LBiBytePredicateXAssertTest<X extends Throwable> {
    ...
    private LBiBytePredicateX<X> function = LBiBytePredicateX.lX((a1,a2) ->
            testValue
    );

    private LBiBytePredicateX<X> functionThrowing = LBiBytePredicateX.lX((a1,a2) -> {
