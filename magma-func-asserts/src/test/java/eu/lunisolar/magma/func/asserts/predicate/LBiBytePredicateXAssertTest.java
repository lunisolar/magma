...
public class LBiBytePredicateXAssertTest<X extends ParseException> {
    ...
    private LBiBytePredicateX<X> function = LBiBytePredicateX.lX((b1,b2) -> {
            return testValue;
    });

    private LBiBytePredicateX<X> functionThrowing = LBiBytePredicateX.lX((b1,b2) -> {
