...
import eu.lunisolar.magma.func.predicate.LBiBytePredicateX;
...
public class LBiBytePredicateXAssertTest<X extends ParseException> {
    ...
    private LBiBytePredicateX<X> function = (byte a1,byte a2) ->
            testValue;


    private LBiBytePredicateX<X> functionThrowing = (byte a1,byte a2) -> {
