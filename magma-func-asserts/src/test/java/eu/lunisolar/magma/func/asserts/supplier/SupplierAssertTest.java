...
public class SupplierAssertTest<R,X extends ParseException> {
    ...
    private Supplier<Integer > function = Supplier.l(() -> {
            return (Integer ) testValue;
    });

    private Supplier<Integer > functionThrowing = Supplier.l(() -> {
