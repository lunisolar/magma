...
public class LLongConsumerAssertTest<X extends ParseException> {
    ...
    private LLongConsumer function = LLongConsumer.l((l) -> {
            externalEffect.set(testValue);
    });

    private LLongConsumer functionThrowing = LLongConsumer.l((l) -> {
