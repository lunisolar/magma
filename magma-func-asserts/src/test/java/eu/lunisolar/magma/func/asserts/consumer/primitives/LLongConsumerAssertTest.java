...
public class LLongConsumerAssertTest<X extends Throwable> {
    ...
    private LLongConsumer function = LLongConsumer.l(a1 ->
            externalEffect.set(testValue)
    );

    private LLongConsumer functionThrowing = LLongConsumer.l(a1 -> {
