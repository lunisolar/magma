...
public class ShortToDoubleFunctionAssertTest<X extends ParseException> {
    ...
    private ShortToDoubleFunction function = ShortToDoubleFunction.l((s) -> {
            return testValue;
    });

    private ShortToDoubleFunction functionThrowing = ShortToDoubleFunction.l((s) -> {
