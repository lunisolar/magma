...
public class ToIntFunctionAssertTest<T,X extends Throwable> {
    ...
    private java.util.function.ToIntFunction<Integer > function = (a1 ->
            testValue
    );

    private java.util.function.ToIntFunction<Integer > functionThrowing = (a1 -> {
