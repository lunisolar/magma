...
import eu.lunisolar.magma.func.predicate.LObjShortPredicateX;
...
public class LObjShortPredicateXAssertTest<T,X extends ParseException> {
    ...
    private LObjShortPredicateX<Integer,X> function = (Integer a1,short a2) ->
            testValue;


    private LObjShortPredicateX<Integer,X> functionThrowing = (Integer a1,short a2) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest(100,(short)100).withException(a -> a
