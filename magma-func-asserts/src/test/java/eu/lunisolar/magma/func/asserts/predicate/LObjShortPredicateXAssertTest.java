...
public class LObjShortPredicateXAssertTest<T,X extends Throwable> {
    ...
    private LObjShortPredicateX<Integer ,X> function = LObjShortPredicateX.lX((a1,a2) ->
            testValue
    );

    private LObjShortPredicateX<Integer ,X> functionThrowing = LObjShortPredicateX.lX((a1,a2) -> {
