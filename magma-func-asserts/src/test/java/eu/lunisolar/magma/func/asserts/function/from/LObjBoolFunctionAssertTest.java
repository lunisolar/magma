...
public class LObjBoolFunctionAssertTest<T,R,X extends Throwable> {
    ...
    private LObjBoolFunction<Integer ,Integer > function = LObjBoolFunction.l((t, b) ->
            (Integer ) testValue
    );

    private LObjBoolFunction<Integer ,Integer > functionThrowing = LObjBoolFunction.l((t, b) -> {
