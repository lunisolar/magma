...
public class BooleanToCharFunctionAssertTest<X extends ParseException> {
    ...
    private BooleanToCharFunction function = BooleanToCharFunction.l((b) -> {
            return testValue;
    });

    private BooleanToCharFunction functionThrowing = BooleanToCharFunction.l((b) -> {
