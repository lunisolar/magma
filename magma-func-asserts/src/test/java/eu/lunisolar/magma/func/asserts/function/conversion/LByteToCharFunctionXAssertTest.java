...
import eu.lunisolar.magma.func.function.conversion.LByteToCharFunctionX;
...
public class LByteToCharFunctionXAssertTest<X extends ParseException> {
    ...
    private LByteToCharFunctionX<X> function = a1 ->
            testValue;


    private LByteToCharFunctionX<X> functionThrowing = a1 -> {
