...
public class LByteToCharFunctionXAssertTest<X extends Throwable> {
    ...
    private LByteToCharFunctionX<X> function = LByteToCharFunctionX.lX(a1 ->
            testValue
    );

    private LByteToCharFunctionX<X> functionThrowing = LByteToCharFunctionX.lX(a1 -> {
