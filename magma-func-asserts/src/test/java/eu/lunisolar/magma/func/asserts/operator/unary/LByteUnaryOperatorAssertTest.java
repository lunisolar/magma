...
import eu.lunisolar.magma.func.operator.unary.LByteUnaryOperator;
...
public class LByteUnaryOperatorAssertTest {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertByteUnaryOp(functionThrowing)
         .doesApplyAsByte((byte)100)
            .to( a -> a.isEqualTo(1));
    }
