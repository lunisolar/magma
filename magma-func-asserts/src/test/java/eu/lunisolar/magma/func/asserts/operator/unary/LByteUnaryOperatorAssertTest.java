...
public class LByteUnaryOperatorAssertTest<X extends ParseException> {
    ...
    private LByteUnaryOperator function = LByteUnaryOperator.l((b) -> {
            return testValue;
    });

    private LByteUnaryOperator functionThrowing = LByteUnaryOperator.l((b) -> {
