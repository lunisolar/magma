...
public class LByteUnaryOperatorAssertTest<X extends Throwable> {
    ...
    private LByteUnaryOperator function = LByteUnaryOperator.l(a1 ->
            testValue
    );

    private LByteUnaryOperator functionThrowing = LByteUnaryOperator.l(a1 -> {
