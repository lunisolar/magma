...
public class FloatFunctionXAssertTest<R,X extends ParseException> {
    ...
    private FloatFunctionX<Integer ,X> function = FloatFunctionX.lX((f) -> {
            return (Integer ) testValue;
    });

    private FloatFunctionX<Integer ,X> functionThrowing = FloatFunctionX.lX((f) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((float)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((float)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((float)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((float)80).withException(a -> a
