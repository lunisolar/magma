...
public class BiObjFloatFunctionXAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private BiObjFloatFunctionX<Integer ,Integer ,Integer ,X> function = BiObjFloatFunctionX.lX((t1,t2, f) -> {
            return (Integer ) testValue;
    });

    private BiObjFloatFunctionX<Integer ,Integer ,Integer ,X> functionThrowing = BiObjFloatFunctionX.lX((t1,t2, f) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(float)82).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(float)82).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(float)82).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(float)82).withException(a -> a
