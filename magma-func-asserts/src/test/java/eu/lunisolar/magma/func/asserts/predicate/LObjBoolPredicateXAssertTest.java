...
import eu.lunisolar.magma.func.predicate.LObjBoolPredicateX;
...
public class LObjBoolPredicateXAssertTest<T,X extends ParseException> {
    ...
    private LObjBoolPredicateX<Integer,X> function = (Integer a1,boolean a2) ->
            testValue;


    private LObjBoolPredicateX<Integer,X> functionThrowing = (Integer a1,boolean a2) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest(100,true).withException(a -> a
