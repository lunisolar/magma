...
public class LObjBoolPredicateXAssertTest<T,X extends Throwable> {
    ...
    private LObjBoolPredicateX<Integer ,X> function = LObjBoolPredicateX.lX((t, b) ->
            testValue
    );

    private LObjBoolPredicateX<Integer ,X> functionThrowing = LObjBoolPredicateX.lX((t, b) -> {
