...
public class LObjBoolPredicateXAssertTest<T,X extends Throwable> {
    ...
    private LObjBoolPredicateX<Integer ,X> function = LObjBoolPredicateX.lX((a1,a2) ->
            testValue
    );

    private LObjBoolPredicateX<Integer ,X> functionThrowing = LObjBoolPredicateX.lX((a1,a2) -> {
