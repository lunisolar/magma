...
public class LToLongBiFunctionXAssertTest<T1,T2,X extends Throwable> {
    ...
    private LToLongBiFunctionX<Integer ,Integer ,X> function = LToLongBiFunctionX.lX((a1,a2) ->
            testValue
    );

    private LToLongBiFunctionX<Integer ,Integer ,X> functionThrowing = LToLongBiFunctionX.lX((a1,a2) -> {
