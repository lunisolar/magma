...
import eu.lunisolar.magma.func.function.to.LToLongBiFunctionX;
...
public class LToLongBiFunctionXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LToLongBiFunctionX<Integer,Integer,X> function = (Integer a1,Integer a2) ->
            testValue;


    private LToLongBiFunctionX<Integer,Integer,X> functionThrowing = (Integer a1,Integer a2) -> {
