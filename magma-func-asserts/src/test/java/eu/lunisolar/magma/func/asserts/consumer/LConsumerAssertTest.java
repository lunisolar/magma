...
public class LConsumerAssertTest<T,X extends Throwable> {
    ...
    private LConsumer<Integer > function = LConsumer.l(a1 ->
            externalEffect.set(testValue)
    );

    private LConsumer<Integer > functionThrowing = LConsumer.l(a1 -> {
