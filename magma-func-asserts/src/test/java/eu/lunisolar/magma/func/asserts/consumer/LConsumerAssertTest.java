...
public class LConsumerAssertTest<T,X extends ParseException> {
    ...
    private LConsumer<Integer > function = LConsumer.l((t) -> {
            externalEffect.set(testValue);
    });

    private LConsumer<Integer > functionThrowing = LConsumer.l((t) -> {
