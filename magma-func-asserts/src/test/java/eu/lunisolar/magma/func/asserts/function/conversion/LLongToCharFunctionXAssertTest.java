...
public class LLongToCharFunctionXAssertTest<X extends Throwable> {
    ...
    private LLongToCharFunctionX<X> function = LLongToCharFunctionX.lX(a1 ->
            testValue
    );

    private LLongToCharFunctionX<X> functionThrowing = LLongToCharFunctionX.lX(a1 -> {
