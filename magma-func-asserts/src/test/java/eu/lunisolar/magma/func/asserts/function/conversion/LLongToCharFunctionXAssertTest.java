...
import eu.lunisolar.magma.func.function.conversion.LLongToCharFunctionX;
...
public class LLongToCharFunctionXAssertTest<X extends ParseException> {
    ...
    private LLongToCharFunctionX<X> function = a1 ->
            testValue;


    private LLongToCharFunctionX<X> functionThrowing = a1 -> {
