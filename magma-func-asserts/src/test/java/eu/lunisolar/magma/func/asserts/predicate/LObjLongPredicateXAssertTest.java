...
public class LObjLongPredicateXAssertTest<T,X extends Throwable> {
    ...
    private LObjLongPredicateX<Integer ,X> function = LObjLongPredicateX.lX((a1,a2) ->
            testValue
    );

    private LObjLongPredicateX<Integer ,X> functionThrowing = LObjLongPredicateX.lX((a1,a2) -> {
