...
import eu.lunisolar.magma.func.function.conversion.LDoubleToCharFunction;
...
public class LDoubleToCharFunctionAssertTest<X extends ParseException> {
    ...
    private LDoubleToCharFunction function = a1 ->
            testValue;


    private LDoubleToCharFunction functionThrowing = a1 -> {
