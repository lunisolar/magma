...
public class LDoubleToCharFunctionAssertTest<X extends Throwable> {
    ...
    private LDoubleToCharFunction function = LDoubleToCharFunction.l(a1 ->
            testValue
    );

    private LDoubleToCharFunction functionThrowing = LDoubleToCharFunction.l(a1 -> {
