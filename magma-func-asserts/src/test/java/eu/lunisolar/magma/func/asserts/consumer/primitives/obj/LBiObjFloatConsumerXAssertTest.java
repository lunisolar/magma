...
import eu.lunisolar.magma.func.consumer.primitives.obj.LBiObjFloatConsumerX;
...
public class LBiObjFloatConsumerXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjFloatConsumerX<Integer,Integer,X> function = (Integer a1,Integer a2,float a3) ->
            externalEffect.set(testValue);


    private LBiObjFloatConsumerX<Integer,Integer,X> functionThrowing = (Integer a1,Integer a2,float a3) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept(100,100,100f).withException(a -> a
