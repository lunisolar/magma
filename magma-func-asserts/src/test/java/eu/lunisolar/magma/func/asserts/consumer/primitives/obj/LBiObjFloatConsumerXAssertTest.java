...
public class LBiObjFloatConsumerXAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjFloatConsumerX<Integer ,Integer ,X> function = LBiObjFloatConsumerX.lX((a1,a2,a3) ->
            externalEffect.set(testValue)
    );

    private LBiObjFloatConsumerX<Integer ,Integer ,X> functionThrowing = LBiObjFloatConsumerX.lX((a1,a2,a3) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesAccept((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(float)82)
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(float)82).withException(a -> a
