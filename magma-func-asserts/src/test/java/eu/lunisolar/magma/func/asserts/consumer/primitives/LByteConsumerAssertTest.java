...
public class LByteConsumerAssertTest<X extends ParseException> {
    ...
    private LByteConsumer function = LByteConsumer.l((b) -> {
            externalEffect.set(testValue);
    });

    private LByteConsumer functionThrowing = LByteConsumer.l((b) -> {
