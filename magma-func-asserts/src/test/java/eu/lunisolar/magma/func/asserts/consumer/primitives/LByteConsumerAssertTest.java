...
public class LByteConsumerAssertTest<X extends Throwable> {
    ...
    private LByteConsumer function = LByteConsumer.l(a1 ->
            externalEffect.set(testValue)
    );

    private LByteConsumer functionThrowing = LByteConsumer.l(a1 -> {
