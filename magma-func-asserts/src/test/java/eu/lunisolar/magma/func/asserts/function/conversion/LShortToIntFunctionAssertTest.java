...
public class LShortToIntFunctionAssertTest<X extends Throwable> {
    ...
    private LShortToIntFunction function = LShortToIntFunction.l(a1 ->
            testValue
    );

    private LShortToIntFunction functionThrowing = LShortToIntFunction.l(a1 -> {
