...
public class BiObjCharFunctionAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private BiObjCharFunction<Integer ,Integer ,Integer > function = BiObjCharFunction.l((t1,t2, c) -> {
            return (Integer ) testValue;
    });

    private BiObjCharFunction<Integer ,Integer ,Integer > functionThrowing = BiObjCharFunction.l((t1,t2, c) -> {
