...
import eu.lunisolar.magma.func.function.from.LShortFunctionX;
...
public class LShortFunctionXAssertTest<R,X extends ParseException> {
    ...
    private LShortFunctionX<Integer,X> function = a1 ->
            testValue;


    private LShortFunctionX<Integer,X> functionThrowing = a1 -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((short)100).withException(a -> a
