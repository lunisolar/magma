...
public class LShortFunctionXAssertTest<R,X extends Throwable> {
    ...
    private LShortFunctionX<Integer ,X> function = LShortFunctionX.lX(a1 ->
            (Integer ) testValue
    );

    private LShortFunctionX<Integer ,X> functionThrowing = LShortFunctionX.lX(a1 -> {
