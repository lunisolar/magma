...
public class FloatBiConsumerAssertTest<X extends ParseException> {
    ...
    private FloatBiConsumer function = FloatBiConsumer.l((f1,f2) -> {
            externalEffect.set(testValue);
    });

    private FloatBiConsumer functionThrowing = FloatBiConsumer.l((f1,f2) -> {
