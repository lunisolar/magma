...
public class LObjCharConsumerXAssertTest<T,X extends Throwable> {
    ...
    private LObjCharConsumerX<Integer ,X> function = LObjCharConsumerX.lX((a1,a2) ->
            externalEffect.set(testValue)
    );

    private LObjCharConsumerX<Integer ,X> functionThrowing = LObjCharConsumerX.lX((a1,a2) -> {
