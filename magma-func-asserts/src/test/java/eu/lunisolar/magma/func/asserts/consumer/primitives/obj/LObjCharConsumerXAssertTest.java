...
public class LObjCharConsumerXAssertTest<T,X extends ParseException> {
    ...
    private LObjCharConsumerX<Integer ,X> function = LObjCharConsumerX.lX((t, c) -> {
            externalEffect.set(testValue);
    });

    private LObjCharConsumerX<Integer ,X> functionThrowing = LObjCharConsumerX.lX((t, c) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesAccept((Integer )Integer.valueOf(80),(char)81)
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept((Integer )Integer.valueOf(80),(char)81).withException(a -> a
