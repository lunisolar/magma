...
import eu.lunisolar.magma.func.consumer.primitives.obj.LObjCharConsumerX;
...
public class LObjCharConsumerXAssertTest<T,X extends ParseException> {
    ...
    private LObjCharConsumerX<Integer,X> function = (Integer a1,char a2) ->
            externalEffect.set(testValue);


    private LObjCharConsumerX<Integer,X> functionThrowing = (Integer a1,char a2) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept(100,'\u0100').withException(a -> a
