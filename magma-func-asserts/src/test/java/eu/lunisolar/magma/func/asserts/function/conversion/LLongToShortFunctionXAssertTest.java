...
public class LLongToShortFunctionXAssertTest<X extends Throwable> {
    ...
    private LLongToShortFunctionX<X> function = LLongToShortFunctionX.lX(a1 ->
            testValue
    );

    private LLongToShortFunctionX<X> functionThrowing = LLongToShortFunctionX.lX(a1 -> {
