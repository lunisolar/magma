...
import eu.lunisolar.magma.func.function.conversion.LLongToShortFunctionX;
...
public class LLongToShortFunctionXAssertTest<X extends ParseException> {
    ...
    private LLongToShortFunctionX<X> function = a1 ->
            testValue;


    private LLongToShortFunctionX<X> functionThrowing = a1 -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort(100L).withException(a -> a
