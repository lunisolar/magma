...
public class ToByteBiFunctionAssertTest<T1,T2,X extends ParseException> {
    ...
    private ToByteBiFunction<Integer ,Integer > function = ToByteBiFunction.l((t1,t2) -> {
            return testValue;
    });

    private ToByteBiFunction<Integer ,Integer > functionThrowing = ToByteBiFunction.l((t1,t2) -> {
