...
public class LToLongFunctionXAssertTest<T,X extends Throwable> {
    ...
    private LToLongFunctionX<Integer ,X> function = LToLongFunctionX.lX(a1 ->
            testValue
    );

    private LToLongFunctionX<Integer ,X> functionThrowing = LToLongFunctionX.lX(a1 -> {
