...
import eu.lunisolar.magma.func.function.to.LToLongFunctionX;
...
public class LToLongFunctionXAssertTest<T,X extends ParseException> {
    ...
    private LToLongFunctionX<Integer,X> function = a1 ->
            testValue;


    private LToLongFunctionX<Integer,X> functionThrowing = a1 -> {
