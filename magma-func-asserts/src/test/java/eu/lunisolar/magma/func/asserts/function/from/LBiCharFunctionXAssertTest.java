...
public class LBiCharFunctionXAssertTest<R,X extends Throwable> {
    ...
    private LBiCharFunctionX<Integer ,X> function = LBiCharFunctionX.lX((a1,a2) ->
            (Integer ) testValue
    );

    private LBiCharFunctionX<Integer ,X> functionThrowing = LBiCharFunctionX.lX((a1,a2) -> {
