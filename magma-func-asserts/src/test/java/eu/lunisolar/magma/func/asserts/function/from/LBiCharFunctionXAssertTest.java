...
import eu.lunisolar.magma.func.function.from.LBiCharFunctionX;
...
public class LBiCharFunctionXAssertTest<R,X extends ParseException> {
    ...
    private LBiCharFunctionX<Integer,X> function = (char a1,char a2) ->
            testValue;


    private LBiCharFunctionX<Integer,X> functionThrowing = (char a1,char a2) -> {
