...
import eu.lunisolar.magma.func.function.conversion.LCharToDoubleFunction;
...
public class LCharToDoubleFunctionAssertTest<X extends ParseException> {
    ...
    private LCharToDoubleFunction function = a1 ->
            testValue;


    private LCharToDoubleFunction functionThrowing = a1 -> {
