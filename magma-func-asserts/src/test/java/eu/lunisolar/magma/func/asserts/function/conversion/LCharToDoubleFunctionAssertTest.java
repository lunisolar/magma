...
public class LCharToDoubleFunctionAssertTest<X extends Throwable> {
    ...
    private LCharToDoubleFunction function = LCharToDoubleFunction.l(a1 ->
            testValue
    );

    private LCharToDoubleFunction functionThrowing = LCharToDoubleFunction.l(a1 -> {
