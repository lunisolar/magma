...
public class LongToShortFunctionAssertTest<X extends ParseException> {
    ...
    private LongToShortFunction function = LongToShortFunction.l((l) -> {
            return testValue;
    });

    private LongToShortFunction functionThrowing = LongToShortFunction.l((l) -> {
