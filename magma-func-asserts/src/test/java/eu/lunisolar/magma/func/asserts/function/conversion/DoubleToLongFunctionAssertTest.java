...
public class DoubleToLongFunctionAssertTest<X extends ParseException> {
    ...
    private DoubleToLongFunction function = DoubleToLongFunction.l((d) -> {
            return testValue;
    });

    private DoubleToLongFunction functionThrowing = DoubleToLongFunction.l((d) -> {
