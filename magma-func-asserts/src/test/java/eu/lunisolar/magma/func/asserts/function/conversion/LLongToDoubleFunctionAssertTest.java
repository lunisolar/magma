...
public class LLongToDoubleFunctionAssertTest<X extends Throwable> {
    ...
    private LLongToDoubleFunction function = LLongToDoubleFunction.l(a1 ->
            testValue
    );

    private LLongToDoubleFunction functionThrowing = LLongToDoubleFunction.l(a1 -> {
