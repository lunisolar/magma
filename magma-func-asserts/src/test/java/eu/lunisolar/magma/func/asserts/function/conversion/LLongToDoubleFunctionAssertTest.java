...
import eu.lunisolar.magma.func.function.conversion.LLongToDoubleFunction;
...
public class LLongToDoubleFunctionAssertTest<X extends ParseException> {
    ...
    private LLongToDoubleFunction function = a1 ->
            testValue;


    private LLongToDoubleFunction functionThrowing = a1 -> {
