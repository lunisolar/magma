...
public class BiObjLongPredicateXAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjLongPredicateX<Integer ,Integer ,X> function = BiObjLongPredicateX.lX((t1,t2, l) -> {
            return testValue;
    });

    private BiObjLongPredicateX<Integer ,Integer ,X> functionThrowing = BiObjLongPredicateX.lX((t1,t2, l) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(long)82).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(long)82).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(long)82).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesTest((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(long)82).withException(a -> a
