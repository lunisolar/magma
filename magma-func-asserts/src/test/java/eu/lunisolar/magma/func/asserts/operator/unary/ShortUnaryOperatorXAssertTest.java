...
public class ShortUnaryOperatorXAssertTest<X extends ParseException> {
    ...
    private ShortUnaryOperatorX<X> function = ShortUnaryOperatorX.lX((s) -> {
            return testValue;
    });

    private ShortUnaryOperatorX<X> functionThrowing = ShortUnaryOperatorX.lX((s) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsShort((short)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsShort((short)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort((short)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort((short)80).withException(a -> a
