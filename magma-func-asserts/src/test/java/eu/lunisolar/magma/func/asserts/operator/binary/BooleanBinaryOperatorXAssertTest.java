...
public class BooleanBinaryOperatorXAssertTest<X extends ParseException> {
    ...
    private BooleanBinaryOperatorX<X> function = BooleanBinaryOperatorX.lX((b1,b2) -> {
            return testValue;
    });

    private BooleanBinaryOperatorX<X> functionThrowing = BooleanBinaryOperatorX.lX((b1,b2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsBoolean(true,true).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsBoolean(true,true).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsBoolean(true,true).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsBoolean(true,true).withException(a -> a
