...
public class LongToCharFunctionAssertTest<X extends ParseException> {
    ...
    private LongToCharFunction function = LongToCharFunction.l((l) -> {
            return testValue;
    });

    private LongToCharFunction functionThrowing = LongToCharFunction.l((l) -> {
