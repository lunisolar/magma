...
public class LByteConsumerXAssertTest<X extends Throwable> {
    ...
    private LByteConsumerX<X> function = LByteConsumerX.lX(a1 ->
            externalEffect.set(testValue)
    );

    private LByteConsumerX<X> functionThrowing = LByteConsumerX.lX(a1 -> {
