...
public class LFloatToLongFunctionXAssertTest<X extends Throwable> {
    ...
    private LFloatToLongFunctionX<X> function = LFloatToLongFunctionX.lX(a1 ->
            testValue
    );

    private LFloatToLongFunctionX<X> functionThrowing = LFloatToLongFunctionX.lX(a1 -> {
