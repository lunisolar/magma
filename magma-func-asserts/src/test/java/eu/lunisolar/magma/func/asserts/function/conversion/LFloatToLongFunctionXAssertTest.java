...
import eu.lunisolar.magma.func.function.conversion.LFloatToLongFunctionX;
...
public class LFloatToLongFunctionXAssertTest<X extends ParseException> {
    ...
    private LFloatToLongFunctionX<X> function = a1 ->
            testValue;


    private LFloatToLongFunctionX<X> functionThrowing = a1 -> {
