...
public class BiObjIntFunctionAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private BiObjIntFunction<Integer ,Integer ,Integer > function = BiObjIntFunction.l((t1,t2, i) -> {
            return (Integer ) testValue;
    });

    private BiObjIntFunction<Integer ,Integer ,Integer > functionThrowing = BiObjIntFunction.l((t1,t2, i) -> {
