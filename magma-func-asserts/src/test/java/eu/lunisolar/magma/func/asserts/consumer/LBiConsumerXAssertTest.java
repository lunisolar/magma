...
import eu.lunisolar.magma.func.consumer.LBiConsumerX;
...
public class LBiConsumerXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiConsumerX<Integer,Integer,X> function = (Integer a1,Integer a2) ->
            externalEffect.set(testValue);


    private LBiConsumerX<Integer,Integer,X> functionThrowing = (Integer a1,Integer a2) -> {
