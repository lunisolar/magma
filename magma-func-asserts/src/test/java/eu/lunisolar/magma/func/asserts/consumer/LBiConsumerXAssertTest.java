...
public class LBiConsumerXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiConsumerX<Integer ,Integer ,X> function = LBiConsumerX.lX((t1,t2) -> {
            externalEffect.set(testValue);
    });

    private LBiConsumerX<Integer ,Integer ,X> functionThrowing = LBiConsumerX.lX((t1,t2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesAccept((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81))
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81)).withException(a -> a
