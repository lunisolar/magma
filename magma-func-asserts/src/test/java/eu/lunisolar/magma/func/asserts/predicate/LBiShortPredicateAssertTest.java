...
import eu.lunisolar.magma.func.predicate.LBiShortPredicate;
...
public class LBiShortPredicateAssertTest<X extends ParseException> {
    ...
    private LBiShortPredicate function = (short a1,short a2) ->
            testValue;


    private LBiShortPredicate functionThrowing = (short a1,short a2) -> {
