...
public class LBiShortPredicateAssertTest<X extends Throwable> {
    ...
    private LBiShortPredicate function = LBiShortPredicate.l((a1,a2) ->
            testValue
    );

    private LBiShortPredicate functionThrowing = LBiShortPredicate.l((a1,a2) -> {
