...
import eu.lunisolar.magma.func.consumer.primitives.obj.LBiObjShortConsumerX;
...
public class LBiObjShortConsumerXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjShortConsumerX<Integer,Integer,X> function = (Integer a1,Integer a2,short a3) ->
            externalEffect.set(testValue);


    private LBiObjShortConsumerX<Integer,Integer,X> functionThrowing = (Integer a1,Integer a2,short a3) -> {
