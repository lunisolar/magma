...
public class LBiObjShortConsumerXAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjShortConsumerX<Integer ,Integer ,X> function = LBiObjShortConsumerX.lX((a1,a2,a3) ->
            externalEffect.set(testValue)
    );

    private LBiObjShortConsumerX<Integer ,Integer ,X> functionThrowing = LBiObjShortConsumerX.lX((a1,a2,a3) -> {
