...
public class LBiObjShortConsumerXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjShortConsumerX<Integer ,Integer ,X> function = LBiObjShortConsumerX.lX((t1,t2, s) -> {
            externalEffect.set(testValue);
    });

    private LBiObjShortConsumerX<Integer ,Integer ,X> functionThrowing = LBiObjShortConsumerX.lX((t1,t2, s) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesAccept((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(short)82)
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(short)82).withException(a -> a
