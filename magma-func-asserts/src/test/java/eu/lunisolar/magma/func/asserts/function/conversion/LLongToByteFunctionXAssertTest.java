...
public class LLongToByteFunctionXAssertTest<X extends Throwable> {
    ...
    private LLongToByteFunctionX<X> function = LLongToByteFunctionX.lX(a1 ->
            testValue
    );

    private LLongToByteFunctionX<X> functionThrowing = LLongToByteFunctionX.lX(a1 -> {
