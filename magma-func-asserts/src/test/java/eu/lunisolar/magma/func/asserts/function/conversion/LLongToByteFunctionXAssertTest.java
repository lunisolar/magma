...
import eu.lunisolar.magma.func.function.conversion.LLongToByteFunctionX;
...
public class LLongToByteFunctionXAssertTest<X extends ParseException> {
    ...
    private LLongToByteFunctionX<X> function = a1 ->
            testValue;


    private LLongToByteFunctionX<X> functionThrowing = a1 -> {
