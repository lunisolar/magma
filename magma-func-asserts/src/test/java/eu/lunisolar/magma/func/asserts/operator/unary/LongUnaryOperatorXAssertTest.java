...
public class LongUnaryOperatorXAssertTest<X extends ParseException> {
    ...
    private LongUnaryOperatorX<X> function = LongUnaryOperatorX.lX((l) -> {
            return testValue;
    });

    private LongUnaryOperatorX<X> functionThrowing = LongUnaryOperatorX.lX((l) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsLong((long)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsLong((long)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsLong((long)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsLong((long)80).withException(a -> a
