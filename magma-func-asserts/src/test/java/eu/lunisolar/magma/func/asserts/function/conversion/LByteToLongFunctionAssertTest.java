...
public class LByteToLongFunctionAssertTest<X extends ParseException> {
    ...
    private LByteToLongFunction function = a1 ->
            testValue;


    private LByteToLongFunction functionThrowing = a1 -> {
