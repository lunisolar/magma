...
public class LByteToLongFunctionAssertTest<X extends Throwable> {
    ...
    private LByteToLongFunction function = LByteToLongFunction.l(a1 ->
            testValue
    );

    private LByteToLongFunction functionThrowing = LByteToLongFunction.l(a1 -> {
