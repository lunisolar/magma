...
public class BooleanToFloatFunctionXAssertTest<X extends ParseException> {
    ...
    private BooleanToFloatFunctionX<X> function = BooleanToFloatFunctionX.lX((b) -> {
            return testValue;
    });

    private BooleanToFloatFunctionX<X> functionThrowing = BooleanToFloatFunctionX.lX((b) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsFloat(true).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsFloat(true).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsFloat(true).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsFloat(true).withException(a -> a
