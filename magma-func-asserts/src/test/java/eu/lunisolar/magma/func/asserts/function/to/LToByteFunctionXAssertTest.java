...
public class LToByteFunctionXAssertTest<T,X extends Throwable> {
    ...
    private LToByteFunctionX<Integer ,X> function = LToByteFunctionX.lX(a1 ->
            testValue
    );

    private LToByteFunctionX<Integer ,X> functionThrowing = LToByteFunctionX.lX(a1 -> {
