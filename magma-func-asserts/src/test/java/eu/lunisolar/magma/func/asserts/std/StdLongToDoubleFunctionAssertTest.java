...
public class StdLongToDoubleFunctionAssertTest<X extends ParseException> {
    ...
    private java.util.function.LongToDoubleFunction function = ((l) -> {
            return testValue;
    });

    private java.util.function.LongToDoubleFunction functionThrowing = ((l) -> {
