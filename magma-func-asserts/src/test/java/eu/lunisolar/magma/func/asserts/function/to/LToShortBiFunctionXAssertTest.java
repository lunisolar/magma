...
public class LToShortBiFunctionXAssertTest<T1,T2,X extends Throwable> {
    ...
    private LToShortBiFunctionX<Integer ,Integer ,X> function = LToShortBiFunctionX.lX((a1,a2) ->
            testValue
    );

    private LToShortBiFunctionX<Integer ,Integer ,X> functionThrowing = LToShortBiFunctionX.lX((a1,a2) -> {
