...
import eu.lunisolar.magma.func.function.to.LToShortBiFunctionX;
...
public class LToShortBiFunctionXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LToShortBiFunctionX<Integer,Integer,X> function = (Integer a1,Integer a2) ->
            testValue;


    private LToShortBiFunctionX<Integer,Integer,X> functionThrowing = (Integer a1,Integer a2) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort(100,100).withException(a -> a
