...
public class LongToFloatFunctionAssertTest<X extends ParseException> {
    ...
    private LongToFloatFunction function = LongToFloatFunction.l((l) -> {
            return testValue;
    });

    private LongToFloatFunction functionThrowing = LongToFloatFunction.l((l) -> {
