...
public class LFloatPredicateAssertTest<X extends Throwable> {
    ...
    private LFloatPredicate function = LFloatPredicate.l(a1 ->
            testValue
    );

    private LFloatPredicate functionThrowing = LFloatPredicate.l(a1 -> {
