...
import eu.lunisolar.magma.func.predicate.LFloatPredicate;
...
public class LFloatPredicateAssertTest<X extends ParseException> {
    ...
    private LFloatPredicate function = a1 ->
            testValue;


    private LFloatPredicate functionThrowing = a1 -> {
