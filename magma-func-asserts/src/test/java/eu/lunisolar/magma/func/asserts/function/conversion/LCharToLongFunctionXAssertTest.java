...
public class LCharToLongFunctionXAssertTest<X extends Throwable> {
    ...
    private LCharToLongFunctionX<X> function = LCharToLongFunctionX.lX(a1 ->
            testValue
    );

    private LCharToLongFunctionX<X> functionThrowing = LCharToLongFunctionX.lX(a1 -> {
