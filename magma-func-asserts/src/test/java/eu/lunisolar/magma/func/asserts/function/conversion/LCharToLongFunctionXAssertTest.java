...
import eu.lunisolar.magma.func.function.conversion.LCharToLongFunctionX;
...
public class LCharToLongFunctionXAssertTest<X extends ParseException> {
    ...
    private LCharToLongFunctionX<X> function = a1 ->
            testValue;


    private LCharToLongFunctionX<X> functionThrowing = a1 -> {
