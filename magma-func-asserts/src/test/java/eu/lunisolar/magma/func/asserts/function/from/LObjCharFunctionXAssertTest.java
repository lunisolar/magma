...
public class LObjCharFunctionXAssertTest<T,R,X extends Throwable> {
    ...
    private LObjCharFunctionX<Integer ,Integer ,X> function = LObjCharFunctionX.lX((a1,a2) ->
            (Integer ) testValue
    );

    private LObjCharFunctionX<Integer ,Integer ,X> functionThrowing = LObjCharFunctionX.lX((a1,a2) -> {
