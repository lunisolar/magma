...
import eu.lunisolar.magma.func.function.from.LObjCharFunctionX;
...
public class LObjCharFunctionXAssertTest<T,R,X extends ParseException> {
    ...
    private LObjCharFunctionX<Integer,Integer,X> function = (Integer a1,char a2) ->
            testValue;


    private LObjCharFunctionX<Integer,Integer,X> functionThrowing = (Integer a1,char a2) -> {
