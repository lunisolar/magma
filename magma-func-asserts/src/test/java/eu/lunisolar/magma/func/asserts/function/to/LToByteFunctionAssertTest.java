...
public class LToByteFunctionAssertTest<T,X extends ParseException> {
    ...
    private LToByteFunction<Integer > function = LToByteFunction.l((t) -> {
            return testValue;
    });

    private LToByteFunction<Integer > functionThrowing = LToByteFunction.l((t) -> {
