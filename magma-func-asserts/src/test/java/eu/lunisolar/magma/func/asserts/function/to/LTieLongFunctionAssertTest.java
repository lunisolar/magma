...
public class LTieLongFunctionAssertTest<T> {
    ...
    private LTieLongFunction<Integer> function = (a1,a2,a3) ->
            testValue;


    private LTieLongFunction<Integer> functionThrowing = (a1,a2,a3) -> {
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertTieLongFunc(functionThrowing)
         .doesApplyAsInt(100,100,100L)
            .to( a -> a.isEqualTo(1));
    }
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertTieLongFunc(functionThrowing)
         .doesApplyAsInt(100,100,100L).withException(a -> a
