...
public class IntPredicateAssertTest<X extends Throwable> {
    ...
    private java.util.function.IntPredicate function = (a1 ->
            testValue
    );

    private java.util.function.IntPredicate functionThrowing = (a1 -> {
