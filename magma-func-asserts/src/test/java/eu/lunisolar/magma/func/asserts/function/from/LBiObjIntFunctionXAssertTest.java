...
public class LBiObjIntFunctionXAssertTest<T1,T2,R,X extends Throwable> {
    ...
    private LBiObjIntFunctionX<Integer ,Integer ,Integer ,X> function = LBiObjIntFunctionX.lX((a1,a2,a3) ->
            (Integer ) testValue
    );

    private LBiObjIntFunctionX<Integer ,Integer ,Integer ,X> functionThrowing = LBiObjIntFunctionX.lX((a1,a2,a3) -> {
