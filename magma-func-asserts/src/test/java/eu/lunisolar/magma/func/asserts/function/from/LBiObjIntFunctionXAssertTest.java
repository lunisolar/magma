...
import eu.lunisolar.magma.func.function.from.LBiObjIntFunctionX;
...
public class LBiObjIntFunctionXAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private LBiObjIntFunctionX<Integer,Integer,Integer,X> function = (Integer a1,Integer a2,int a3) ->
            testValue;


    private LBiObjIntFunctionX<Integer,Integer,Integer,X> functionThrowing = (Integer a1,Integer a2,int a3) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply(100,100,100).withException(a -> a
