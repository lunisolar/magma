...
import eu.lunisolar.magma.func.function.conversion.LFloatToDoubleFunctionX;
...
public class LFloatToDoubleFunctionXAssertTest<X extends ParseException> {
    ...
    private LFloatToDoubleFunctionX<X> function = a1 ->
            testValue;


    private LFloatToDoubleFunctionX<X> functionThrowing = a1 -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsDouble(100f).withException(a -> a
