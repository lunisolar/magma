...
public class LFloatToDoubleFunctionXAssertTest<X extends Throwable> {
    ...
    private LFloatToDoubleFunctionX<X> function = LFloatToDoubleFunctionX.lX(a1 ->
            testValue
    );

    private LFloatToDoubleFunctionX<X> functionThrowing = LFloatToDoubleFunctionX.lX(a1 -> {
