...
public class LFloatToIntFunctionAssertTest<X extends ParseException> {
    ...
    private LFloatToIntFunction function = LFloatToIntFunction.l((f) -> {
            return testValue;
    });

    private LFloatToIntFunction functionThrowing = LFloatToIntFunction.l((f) -> {
