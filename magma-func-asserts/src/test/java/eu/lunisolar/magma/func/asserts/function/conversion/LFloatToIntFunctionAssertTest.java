...
public class LFloatToIntFunctionAssertTest<X extends Throwable> {
    ...
    private LFloatToIntFunction function = LFloatToIntFunction.l(a1 ->
            testValue
    );

    private LFloatToIntFunction functionThrowing = LFloatToIntFunction.l(a1 -> {
