...
import eu.lunisolar.magma.func.function.conversion.LFloatToIntFunction;
...
public class LFloatToIntFunctionAssertTest<X extends ParseException> {
    ...
    private LFloatToIntFunction function = a1 ->
            testValue;


    private LFloatToIntFunction functionThrowing = a1 -> {
