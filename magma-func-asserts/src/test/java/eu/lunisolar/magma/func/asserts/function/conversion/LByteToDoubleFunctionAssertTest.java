...
public class LByteToDoubleFunctionAssertTest<X extends Throwable> {
    ...
    private LByteToDoubleFunction function = LByteToDoubleFunction.l(a1 ->
            testValue
    );

    private LByteToDoubleFunction functionThrowing = LByteToDoubleFunction.l(a1 -> {
