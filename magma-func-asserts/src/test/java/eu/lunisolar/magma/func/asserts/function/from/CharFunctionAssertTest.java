...
public class CharFunctionAssertTest<R,X extends ParseException> {
    ...
    private CharFunction<Integer > function = CharFunction.l((c) -> {
            return (Integer ) testValue;
    });

    private CharFunction<Integer > functionThrowing = CharFunction.l((c) -> {
