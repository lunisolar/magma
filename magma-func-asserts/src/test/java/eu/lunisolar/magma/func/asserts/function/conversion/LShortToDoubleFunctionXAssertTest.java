...
public class LShortToDoubleFunctionXAssertTest<X extends Throwable> {
    ...
    private LShortToDoubleFunctionX<X> function = LShortToDoubleFunctionX.lX(a1 ->
            testValue
    );

    private LShortToDoubleFunctionX<X> functionThrowing = LShortToDoubleFunctionX.lX(a1 -> {
