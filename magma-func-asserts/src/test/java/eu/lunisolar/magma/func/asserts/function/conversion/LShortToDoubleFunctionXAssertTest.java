...
import eu.lunisolar.magma.func.function.conversion.LShortToDoubleFunctionX;
...
public class LShortToDoubleFunctionXAssertTest<X extends ParseException> {
    ...
    private LShortToDoubleFunctionX<X> function = a1 ->
            testValue;


    private LShortToDoubleFunctionX<X> functionThrowing = a1 -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsDouble((short)100).withException(a -> a
