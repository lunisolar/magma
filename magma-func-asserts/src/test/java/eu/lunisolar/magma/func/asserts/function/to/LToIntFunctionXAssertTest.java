...
import eu.lunisolar.magma.func.function.to.LToIntFunctionX;
...
public class LToIntFunctionXAssertTest<T,X extends ParseException> {
    ...
    private LToIntFunctionX<Integer,X> function = a1 ->
            testValue;


    private LToIntFunctionX<Integer,X> functionThrowing = a1 -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsInt(100).withException(a -> a
