...
public class LToIntFunctionXAssertTest<T,X extends Throwable> {
    ...
    private LToIntFunctionX<Integer ,X> function = LToIntFunctionX.lX(a1 ->
            testValue
    );

    private LToIntFunctionX<Integer ,X> functionThrowing = LToIntFunctionX.lX(a1 -> {
