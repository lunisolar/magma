...
import eu.lunisolar.magma.func.consumer.primitives.obj.LObjShortConsumerX;
...
public class LObjShortConsumerXAssertTest<T,X extends ParseException> {
    ...
    private LObjShortConsumerX<Integer,X> function = (Integer a1,short a2) ->
            externalEffect.set(testValue);


    private LObjShortConsumerX<Integer,X> functionThrowing = (Integer a1,short a2) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept(100,(short)100).withException(a -> a
