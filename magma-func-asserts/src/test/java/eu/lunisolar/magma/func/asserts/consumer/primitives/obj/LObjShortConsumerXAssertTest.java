...
public class LObjShortConsumerXAssertTest<T,X extends ParseException> {
    ...
    private LObjShortConsumerX<Integer ,X> function = LObjShortConsumerX.lX((t, s) -> {
            externalEffect.set(testValue);
    });

    private LObjShortConsumerX<Integer ,X> functionThrowing = LObjShortConsumerX.lX((t, s) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesAccept((Integer )Integer.valueOf(80),(short)81)
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept((Integer )Integer.valueOf(80),(short)81).withException(a -> a
