...
public class LObjShortConsumerXAssertTest<T,X extends Throwable> {
    ...
    private LObjShortConsumerX<Integer ,X> function = LObjShortConsumerX.lX((a1,a2) ->
            externalEffect.set(testValue)
    );

    private LObjShortConsumerX<Integer ,X> functionThrowing = LObjShortConsumerX.lX((a1,a2) -> {
