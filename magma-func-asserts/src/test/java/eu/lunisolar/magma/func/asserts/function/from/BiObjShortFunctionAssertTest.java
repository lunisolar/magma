...
public class BiObjShortFunctionAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private BiObjShortFunction<Integer ,Integer ,Integer > function = BiObjShortFunction.l((t1,t2, s) -> {
            return (Integer ) testValue;
    });

    private BiObjShortFunction<Integer ,Integer ,Integer > functionThrowing = BiObjShortFunction.l((t1,t2, s) -> {
