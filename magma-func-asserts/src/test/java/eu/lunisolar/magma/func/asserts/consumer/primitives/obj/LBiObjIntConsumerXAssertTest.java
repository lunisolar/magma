...
import eu.lunisolar.magma.func.consumer.primitives.obj.LBiObjIntConsumerX;
...
public class LBiObjIntConsumerXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjIntConsumerX<Integer,Integer,X> function = (Integer a1,Integer a2,int a3) ->
            externalEffect.set(testValue);


    private LBiObjIntConsumerX<Integer,Integer,X> functionThrowing = (Integer a1,Integer a2,int a3) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept(100,100,100).withException(a -> a
