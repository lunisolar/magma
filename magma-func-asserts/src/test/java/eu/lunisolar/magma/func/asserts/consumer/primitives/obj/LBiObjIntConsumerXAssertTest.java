...
public class LBiObjIntConsumerXAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjIntConsumerX<Integer ,Integer ,X> function = LBiObjIntConsumerX.lX((a1,a2,a3) ->
            externalEffect.set(testValue)
    );

    private LBiObjIntConsumerX<Integer ,Integer ,X> functionThrowing = LBiObjIntConsumerX.lX((a1,a2,a3) -> {
