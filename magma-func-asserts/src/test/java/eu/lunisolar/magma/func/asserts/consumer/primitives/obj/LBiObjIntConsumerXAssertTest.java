...
public class LBiObjIntConsumerXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjIntConsumerX<Integer ,Integer ,X> function = LBiObjIntConsumerX.lX((t1,t2, i) -> {
            externalEffect.set(testValue);
    });

    private LBiObjIntConsumerX<Integer ,Integer ,X> functionThrowing = LBiObjIntConsumerX.lX((t1,t2, i) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesAccept((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(int)82)
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesAccept((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(int)82).withException(a -> a
