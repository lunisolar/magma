...
public class LToShortFunctionAssertTest<T,X extends ParseException> {
    ...
    private LToShortFunction<Integer > function = LToShortFunction.l((t) -> {
            return testValue;
    });

    private LToShortFunction<Integer > functionThrowing = LToShortFunction.l((t) -> {
