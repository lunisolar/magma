...
import eu.lunisolar.magma.func.function.to.LToShortFunction;
...
public class LToShortFunctionAssertTest<T,X extends ParseException> {
    ...
    private LToShortFunction<Integer> function = a1 ->
            testValue;


    private LToShortFunction<Integer> functionThrowing = a1 -> {
