...
public class LToShortFunctionAssertTest<T,X extends Throwable> {
    ...
    private LToShortFunction<Integer > function = LToShortFunction.l(a1 ->
            testValue
    );

    private LToShortFunction<Integer > functionThrowing = LToShortFunction.l(a1 -> {
