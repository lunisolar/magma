...
public class BiFloatPredicateAssertTest<X extends ParseException> {
    ...
    private BiFloatPredicate function = BiFloatPredicate.l((f1,f2) -> {
            return testValue;
    });

    private BiFloatPredicate functionThrowing = BiFloatPredicate.l((f1,f2) -> {
