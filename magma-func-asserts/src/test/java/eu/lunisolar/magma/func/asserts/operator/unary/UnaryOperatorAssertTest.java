...
public class UnaryOperatorAssertTest<T,X extends ParseException> {
    ...
    private UnaryOperator<Integer > function = UnaryOperator.l((t) -> {
            return (Integer ) testValue;
    });

    private UnaryOperator<Integer > functionThrowing = UnaryOperator.l((t) -> {
