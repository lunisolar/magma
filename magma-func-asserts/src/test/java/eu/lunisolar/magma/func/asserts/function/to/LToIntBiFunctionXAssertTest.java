...
public class LToIntBiFunctionXAssertTest<T1,T2,X extends Throwable> {
    ...
    private LToIntBiFunctionX<Integer ,Integer ,X> function = LToIntBiFunctionX.lX((a1,a2) ->
            testValue
    );

    private LToIntBiFunctionX<Integer ,Integer ,X> functionThrowing = LToIntBiFunctionX.lX((a1,a2) -> {
