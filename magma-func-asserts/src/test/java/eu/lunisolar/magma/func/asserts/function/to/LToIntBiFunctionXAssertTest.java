...
import eu.lunisolar.magma.func.function.to.LToIntBiFunctionX;
...
public class LToIntBiFunctionXAssertTest<T1,T2,X extends ParseException> {
    ...
    private LToIntBiFunctionX<Integer,Integer,X> function = (Integer a1,Integer a2) ->
            testValue;


    private LToIntBiFunctionX<Integer,Integer,X> functionThrowing = (Integer a1,Integer a2) -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsInt(100,100).withException(a -> a
