...
import eu.lunisolar.magma.func.function.conversion.LCharToFloatFunctionX;
...
public class LCharToFloatFunctionXAssertTest<X extends ParseException> {
    ...
    private LCharToFloatFunctionX<X> function = a1 ->
            testValue;


    private LCharToFloatFunctionX<X> functionThrowing = a1 -> {
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsFloat('\u0100').withException(a -> a
