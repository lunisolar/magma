...
public class LCharToFloatFunctionXAssertTest<X extends Throwable> {
    ...
    private LCharToFloatFunctionX<X> function = LCharToFloatFunctionX.lX(a1 ->
            testValue
    );

    private LCharToFloatFunctionX<X> functionThrowing = LCharToFloatFunctionX.lX(a1 -> {
