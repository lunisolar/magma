...
public class CharBiFunctionAssertTest<R,X extends ParseException> {
    ...
    private CharBiFunction<Integer > function = CharBiFunction.l((c1,c2) -> {
            return (Integer ) testValue;
    });

    private CharBiFunction<Integer > functionThrowing = CharBiFunction.l((c1,c2) -> {
