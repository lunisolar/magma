...
public class LIntUnaryOperatorXAssertTest<X extends ParseException> {
    ...
    private LIntUnaryOperatorX<X> function = LIntUnaryOperatorX.lX((i) -> {
            return testValue;
    });

    private LIntUnaryOperatorX<X> functionThrowing = LIntUnaryOperatorX.lX((i) -> {
