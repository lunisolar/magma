...
public class LIntUnaryOperatorXAssertTest<X extends Throwable> {
    ...
    private LIntUnaryOperatorX<X> function = LIntUnaryOperatorX.lX(a1 ->
            testValue
    );

    private LIntUnaryOperatorX<X> functionThrowing = LIntUnaryOperatorX.lX(a1 -> {
