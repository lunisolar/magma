...
import eu.lunisolar.magma.func.operator.unary.LIntUnaryOperatorX;
...
public class LIntUnaryOperatorXAssertTest<X extends ParseException> {
    ...
    private LIntUnaryOperatorX<X> function = a1 ->
            testValue;


    private LIntUnaryOperatorX<X> functionThrowing = a1 -> {
