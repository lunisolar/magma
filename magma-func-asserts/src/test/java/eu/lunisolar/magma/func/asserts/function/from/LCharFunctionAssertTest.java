...
public class LCharFunctionAssertTest<R,X extends Throwable> {
    ...
    private LCharFunction<Integer > function = LCharFunction.l(a1 ->
            (Integer ) testValue
    );

    private LCharFunction<Integer > functionThrowing = LCharFunction.l(a1 -> {
