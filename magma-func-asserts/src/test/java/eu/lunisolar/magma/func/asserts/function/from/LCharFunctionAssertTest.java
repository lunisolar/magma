...
public class LCharFunctionAssertTest<R,X extends ParseException> {
    ...
    private LCharFunction<Integer> function = a1 ->
            testValue;


    private LCharFunction<Integer> functionThrowing = a1 -> {
