...
public class BiObjByteConsumerXAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjByteConsumerX<Integer ,Integer ,X> function = BiObjByteConsumerX.lX((t1,t2, b) -> {
            externalEffect.set(testValue);
    });

    private BiObjByteConsumerX<Integer ,Integer ,X> functionThrowing = BiObjByteConsumerX.lX((t1,t2, b) -> {
