...
public class BiObjCharFunctionXAssertTest<T1,T2,R,X extends ParseException> {
    ...
    private BiObjCharFunctionX<Integer ,Integer ,Integer ,X> function = BiObjCharFunctionX.lX((t1,t2, c) -> {
            return (Integer ) testValue;
    });

    private BiObjCharFunctionX<Integer ,Integer ,Integer ,X> functionThrowing = BiObjCharFunctionX.lX((t1,t2, c) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(char)82).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(char)82).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(char)82).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(char)82).withException(a -> a
