...
import eu.lunisolar.magma.func.predicate.LBiObjFloatPredicate;
...
public class LBiObjFloatPredicateAssertTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjFloatPredicate<Integer,Integer> function = (Integer a1,Integer a2,float a3) ->
            testValue;


    private LBiObjFloatPredicate<Integer,Integer> functionThrowing = (Integer a1,Integer a2,float a3) -> {
