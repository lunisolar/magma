...
public class LBiObjFloatPredicateAssertTest<T1,T2,X extends Throwable> {
    ...
    private LBiObjFloatPredicate<Integer ,Integer > function = LBiObjFloatPredicate.l((a1,a2,a3) ->
            testValue
    );

    private LBiObjFloatPredicate<Integer ,Integer > functionThrowing = LBiObjFloatPredicate.l((a1,a2,a3) -> {
