...
public class LIntPredicateXAssertTest<X extends ParseException> {
    ...
    private LIntPredicateX<X> function = LIntPredicateX.lX((i) -> {
            return testValue;
    });

    private LIntPredicateX<X> functionThrowing = LIntPredicateX.lX((i) -> {
