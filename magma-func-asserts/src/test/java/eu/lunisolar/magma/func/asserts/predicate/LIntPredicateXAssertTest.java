...
public class LIntPredicateXAssertTest<X extends Throwable> {
    ...
    private LIntPredicateX<X> function = LIntPredicateX.lX(a1 ->
            testValue
    );

    private LIntPredicateX<X> functionThrowing = LIntPredicateX.lX(a1 -> {
