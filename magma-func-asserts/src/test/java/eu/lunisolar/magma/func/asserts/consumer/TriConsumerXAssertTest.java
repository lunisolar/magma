...
public class TriConsumerXAssertTest<T1,T2,T3,X extends ParseException> {
    ...
    private TriConsumerX<Integer ,Integer ,Integer ,X> function = TriConsumerX.lX((t1,t2,t3) -> {
            externalEffect.set(testValue);
    });

    private TriConsumerX<Integer ,Integer ,Integer ,X> functionThrowing = TriConsumerX.lX((t1,t2,t3) -> {
