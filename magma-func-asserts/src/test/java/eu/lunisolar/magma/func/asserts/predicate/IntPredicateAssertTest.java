...
public class IntPredicateAssertTest<X extends ParseException> {
    ...
    private IntPredicate function = IntPredicate.l((i) -> {
            return testValue;
    });

    private IntPredicate functionThrowing = IntPredicate.l((i) -> {
