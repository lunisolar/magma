...
import eu.lunisolar.magma.func.supplier.LIntSupplierX;
...
public class LIntSupplierXAssertTest<X extends ParseException> {
    ...
    private LIntSupplierX<X> function = () ->
            testValue;


    private LIntSupplierX<X> functionThrowing = () -> {
