...
public class LShortBinaryOperatorAssertTest<X extends Throwable> {
    ...
    private LShortBinaryOperator function = LShortBinaryOperator.l((a1,a2) ->
            testValue
    );

    private LShortBinaryOperator functionThrowing = LShortBinaryOperator.l((a1,a2) -> {
