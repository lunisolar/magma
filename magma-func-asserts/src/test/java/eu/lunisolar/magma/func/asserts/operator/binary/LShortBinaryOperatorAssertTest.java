...
import eu.lunisolar.magma.func.operator.binary.LShortBinaryOperator;
...
public class LShortBinaryOperatorAssertTest<X extends ParseException> {
    ...
    private LShortBinaryOperator function = (short a1,short a2) ->
            testValue;


    private LShortBinaryOperator functionThrowing = (short a1,short a2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsShort((short)100,(short)100)
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort((short)100,(short)100).withException(a -> a
