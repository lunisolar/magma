...
public class IntToShortFunctionXAssertTest<X extends ParseException> {
    ...
    private IntToShortFunctionX<X> function = IntToShortFunctionX.lX((i) -> {
            return testValue;
    });

    private IntToShortFunctionX<X> functionThrowing = IntToShortFunctionX.lX((i) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsShort((int)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsShort((int)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort((int)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsShort((int)80).withException(a -> a
