...
public class CharBiFunctionXAssertTest<R,X extends ParseException> {
    ...
    private CharBiFunctionX<Integer ,X> function = CharBiFunctionX.lX((c1,c2) -> {
            return (Integer ) testValue;
    });

    private CharBiFunctionX<Integer ,X> functionThrowing = CharBiFunctionX.lX((c1,c2) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((char)80,(char)81).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApply((char)80,(char)81).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((char)80,(char)81).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApply((char)80,(char)81).withException(a -> a
