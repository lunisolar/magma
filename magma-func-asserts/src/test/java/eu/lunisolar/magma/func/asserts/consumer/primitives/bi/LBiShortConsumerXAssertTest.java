...
import eu.lunisolar.magma.func.consumer.primitives.bi.LBiShortConsumerX;
...
public class LBiShortConsumerXAssertTest<X extends ParseException> {
    ...
    private LBiShortConsumerX<X> function = (short a1,short a2) ->
            externalEffect.set(testValue);


    private LBiShortConsumerX<X> functionThrowing = (short a1,short a2) -> {
