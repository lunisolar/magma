...
public class LongFunctionAssertTest<R,X extends ParseException> {
    ...
    private LongFunction<Integer > function = LongFunction.l((l) -> {
            return (Integer ) testValue;
    });

    private LongFunction<Integer > functionThrowing = LongFunction.l((l) -> {
