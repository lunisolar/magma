...
public class ByteToIntFunctionXAssertTest<X extends ParseException> {
    ...
    private ByteToIntFunctionX<X> function = ByteToIntFunctionX.lX((b) -> {
            return testValue;
    });

    private ByteToIntFunctionX<X> functionThrowing = ByteToIntFunctionX.lX((b) -> {
    ...
    public void testAssertPositive() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsInt((byte)80).to(a -> a.isEqualTo(testValue));
    ...
    public void testAssertNegative() throws ParseException {
        ...
        A.assertThat(function)
         .doesApplyAsInt((byte)80).to( a -> a.isEqualTo(2));
    ...
    public void testAssertThrowsUnexpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsInt((byte)80).to( a -> a.isEqualTo(1));
    ...
    public void testAssertThrowsExpected() throws ParseException {
        ...
        A.assertThat(functionThrowing)
         .doesApplyAsInt((byte)80).withException(a -> a
