...
public class BiObjBooleanConsumerXAssertTest<T1,T2,X extends ParseException> {
    ...
    private BiObjBooleanConsumerX<Integer ,Integer ,X> function = BiObjBooleanConsumerX.lX((t1,t2, b) -> {
            externalEffect.set(testValue);
    });

    private BiObjBooleanConsumerX<Integer ,Integer ,X> functionThrowing = BiObjBooleanConsumerX.lX((t1,t2, b) -> {
