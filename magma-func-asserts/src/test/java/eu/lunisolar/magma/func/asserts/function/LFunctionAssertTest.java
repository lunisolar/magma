...
public class LFunctionAssertTest<T,R,X extends Throwable> {
    ...
    private LFunction<Integer ,Integer > function = LFunction.l(a1 ->
            (Integer ) testValue
    );

    private LFunction<Integer ,Integer > functionThrowing = LFunction.l(a1 -> {
