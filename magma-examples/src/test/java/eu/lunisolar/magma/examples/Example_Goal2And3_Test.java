...
/**
 * By Example - More primitive types and combinations.
 * ==========================
 *
 * #### Abstract
 *
...
public class Example_Goal2And3_Test {
     ...
     *
     * Then second dimension to the problem arises when you need something like this: FloatToIntFunction, IntToFloatFunction, ObjFloatFunction, BiFloatPredicate.
     *
    ...
    public void problemToSolve2() {
        ...
        long result = integerList.stream().filter(Example_Goal2And3_Test::myMethodToReference).count();
