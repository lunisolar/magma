...
public class BooleanToDoubleFunctionXTest<X extends ParseException> {
    ...
    private BooleanToDoubleFunctionX<X> sut = new BooleanToDoubleFunctionX(){
        public  double applyAsDouble(boolean b) throws ParseException {
            return testValue;
        }
    };

    private BooleanToDoubleFunction opposite = new BooleanToDoubleFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BooleanToDoubleFunctionX: double applyAsDouble(boolean b) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(BooleanToDoubleFunctionX.lX((boolean b) -> testValue ))
            .isInstanceOf(BooleanToDoubleFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(BooleanToDoubleFunctionX.wrapX(opposite))
            .isInstanceOf(BooleanToDoubleFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        BooleanToDoubleFunctionX<X> wrapped = BooleanToDoubleFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromBoolean() throws ParseException {
        ...
        BooleanToDoubleFunctionX<X> sutO = (boolean b) -> {
        ...
        //when
        BooleanToDoubleFunctionX<X> function = sutO.fromBoolean(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        BooleanToDoubleFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BooleanToDoubleFunctionX: double applyAsDouble(boolean b) throws X");
    }
