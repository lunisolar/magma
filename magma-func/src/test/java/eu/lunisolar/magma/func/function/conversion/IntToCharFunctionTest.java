...
public class IntToCharFunctionTest<X extends ParseException> {
    ...
    private IntToCharFunction sut = new IntToCharFunction(){
        public  char applyAsChar(int i)  {
            return testValue;
        }
    };

    private IntToCharFunctionX<X> opposite = new IntToCharFunctionX(){
        public  char applyAsChar(int i) throws ParseException {
            return testValue;
        }
    };
    ...
    public void testTheResult() throws ParseException {
        assertThat(sut.applyAsChar((int)100))
            .isEqualTo(testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("IntToCharFunction: char applyAsChar(int i)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(IntToCharFunction.l((int i) -> testValue ))
            .isInstanceOf(IntToCharFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(IntToCharFunction.wrap(opposite))
            .isInstanceOf(IntToCharFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        // given
        IntToCharFunctionX<X> sutThrowing = IntToCharFunctionX.lX((int i) -> {
            throw new UnsupportedOperationException(ORIGINAL_MESSAGE);
        });

        // when
        IntToCharFunction wrapped = IntToCharFunction.wrap(sutThrowing);

        // then
        try {
            wrapped.applyAsChar((int)100);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        IntToCharFunctionX<ParseException> sutThrowing = IntToCharFunctionX.lX((int i) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        IntToCharFunction sutThrowing = IntToCharFunction.l((int i) -> {
            throw new UnsupportedOperationException();
        });

        // when
        IntToCharFunction wrapped = IntToCharFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromInt() throws ParseException {
        ...
        //when
        IntToCharFunction function = sutO.fromInt(before1);
        function.applyAsChar((int)80);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(IntToCharFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(IntToCharFunctionX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().applyAsChar((int)100);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        IntToCharFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("IntToCharFunction: char applyAsChar(int i)");
    }
