...
public class LLongToSrtFunctionTest {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.applyAsSrt(100L), testValue);
    }
    ...
    public void testNonNullApplyAsSrt() throws Throwable {
            Assert.assertEquals(sut.nonNullApplyAsSrt(100L), testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LLongToSrtFunction: short applyAsSrt(long a)");
    }

    @Test
    public void testLongToSrtFuncMethod() throws Throwable {
        Assert.assertTrue(LLongToSrtFunction.longToSrtFunc(a -> testValue ) instanceof LLongToSrtFunction);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LLongToSrtFunction: short applyAsSrt(long a)"));
