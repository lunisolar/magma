...
public class LBooleanFunctionXTest<R,X extends ParseException> {
    ...
    private LBooleanFunctionX<R,ParseException> sutAlwaysThrowing = LBooleanFunctionX.lX((boolean b) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBooleanFunctionX<R,RuntimeException> sutAlwaysThrowingUnckeck = LBooleanFunctionX.lX((boolean b) -> {
    ...
    public void testLXMethod() throws ParseException {
        assertThat(LBooleanFunctionX.lX((boolean b) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LBooleanFunctionX<R,X> wrapped = LBooleanFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromBoolean() throws ParseException {
        ...
        LBooleanFunctionX<Integer ,X> sutO = (boolean b) -> {
...
//
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LBooleanFunctionX<R,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
