...
public class LongBinaryOperatorTest<X extends ParseException> {
    ...
    private LongBinaryOperator sut = new LongBinaryOperator(){
        public  long applyAsLong(long l1,long l2)  {
            return testValue;
        }
    };

    private LongBinaryOperatorX<X> opposite = new LongBinaryOperatorX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LongBinaryOperator: long applyAsLong(long l1,long l2)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LongBinaryOperator.l((long l1,long l2) -> testValue ))
            .isInstanceOf(LongBinaryOperator.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(LongBinaryOperator.wrap(opposite))
            .isInstanceOf(LongBinaryOperator.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(LongBinaryOperator.wrapStd(jre))
            .isInstanceOf(LongBinaryOperator.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        LongBinaryOperator wrapped = LongBinaryOperator.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LongBinaryOperatorX<ParseException> sutThrowing = LongBinaryOperatorX.lX((long l1,long l2) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LongBinaryOperator sutThrowing = LongBinaryOperator.l((long l1,long l2) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LongBinaryOperator wrapped = LongBinaryOperator.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testMin() throws ParseException {
        ...
        //when
        LongBinaryOperator min = LongBinaryOperator.min();
    ...
    public void testMax() throws ParseException {
        ...
        //when
        LongBinaryOperator max = LongBinaryOperator.max();
    ...
    public void testfromLong() throws ParseException {
        ...
        LongBinaryOperator sutO = (long l1,long l2) -> {
        ...
        //when
        LongBinaryOperator function = sutO.fromLong(before1,before2);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LongBinaryOperator wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LongBinaryOperator: long applyAsLong(long l1,long l2)");
    }
