...
public class LBoolToIntFunctionXTest<X extends ParseException> {
    ...
    private LBoolToIntFunctionX<ParseException> sutAlwaysThrowing = LBoolToIntFunctionX.lX(b -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBoolToIntFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LBoolToIntFunctionX.lX(b -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBoolToIntFunctionX: int doApplyAsInt(boolean b) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LBoolToIntFunctionX.lX(b -> testValue ))
...
@Test
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBoolToIntFunctionX: int doApplyAsInt(boolean b) throws X");
    }
