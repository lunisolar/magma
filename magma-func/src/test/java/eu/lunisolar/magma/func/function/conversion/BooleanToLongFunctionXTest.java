...
public class BooleanToLongFunctionXTest<X extends ParseException> {
    ...
    private BooleanToLongFunctionX<X> sut = new BooleanToLongFunctionX(){
        public  long applyAsLong(boolean b) throws ParseException {
            return testValue;
        }
    };

    private BooleanToLongFunction opposite = new BooleanToLongFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BooleanToLongFunctionX: long applyAsLong(boolean b) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(BooleanToLongFunctionX.lX((boolean b) -> testValue ))
            .isInstanceOf(BooleanToLongFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(BooleanToLongFunctionX.wrapX(opposite))
            .isInstanceOf(BooleanToLongFunctionX.class);
    }
    ...
    public void testfromBoolean() throws ParseException {
        ...
        BooleanToLongFunctionX<X> sutO = (boolean b) -> {
        ...
        //when
        BooleanToLongFunctionX<X> function = sutO.fromBoolean(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(BooleanToLongFunction.class);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        BooleanToLongFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BooleanToLongFunctionX: long applyAsLong(boolean b) throws X");
    }
