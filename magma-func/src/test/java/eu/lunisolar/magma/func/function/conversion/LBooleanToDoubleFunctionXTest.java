...
public class LBooleanToDoubleFunctionXTest<X extends ParseException> {
    ...
    private LBooleanToDoubleFunctionX<X> sut = new LBooleanToDoubleFunctionX(){
        public  double doApplyAsDouble(boolean b) throws ParseException {
            return testValue;
        }
    };

    private LBooleanToDoubleFunction opposite = new LBooleanToDoubleFunction(){
    ...
    private LBooleanToDoubleFunctionX<ParseException> sutAlwaysThrowing = LBooleanToDoubleFunctionX.lX(b -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBooleanToDoubleFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LBooleanToDoubleFunctionX.lX(b -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBooleanToDoubleFunctionX: double doApplyAsDouble(boolean b) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LBooleanToDoubleFunctionX.lX(b -> testValue ))
            .isInstanceOf(LBooleanToDoubleFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws X {
        assertThat(LBooleanToDoubleFunctionX.wrapX(opposite))
            .isInstanceOf(LBooleanToDoubleFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // when
        LBooleanToDoubleFunctionX<X> wrapped = sutThrowing.handleBoolToDoubleFuncX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBooleanToDoubleFunctionX<X> wrapped = sutThrowing.handleBoolToDoubleFuncX(h -> Function4U.doNothing());
    ...
    public void testboolToDoubleFuncComposeBoolean() throws X {
        ...
        LBooleanToDoubleFunctionX<X> sutO = b -> {
        ...
        //when
        LBooleanToDoubleFunctionX<X> function = sutO.boolToDoubleFuncComposeBoolean(before1);
    ...
    public void testboolToDoubleFuncCompose() throws X {
        ...
        //when
        LToDoubleFunctionX<Integer ,X> function = sutO.boolToDoubleFuncCompose(before1);
    ...
    public void testHandleBoolToDoubleFunc() throws X {
        ...
        // when
        LBooleanToDoubleFunctionX<X> wrapped = sutThrowing.handleBoolToDoubleFuncX(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBooleanToDoubleFunctionX: double doApplyAsDouble(boolean b) throws X");
    }
