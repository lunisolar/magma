...
public class LBooleanSupplierXTest<X extends ParseException> {
    ...
    private LBooleanSupplierX<X> sut = new LBooleanSupplierX(){
        public  boolean getAsBoolean() throws ParseException {
            return testValue;
        }
    };

    private LBooleanSupplier opposite = new LBooleanSupplier(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBooleanSupplierX: boolean getAsBoolean() throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(LBooleanSupplierX.lX(() -> testValue ))
            .isInstanceOf(LBooleanSupplierX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(LBooleanSupplierX.wrapX(opposite))
            .isInstanceOf(LBooleanSupplierX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LBooleanSupplierX<X> wrapped = LBooleanSupplierX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LBooleanSupplierX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBooleanSupplierX: boolean getAsBoolean() throws X");
    }
