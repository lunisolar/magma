...
public class LBooleanToShortFunctionTest<X extends ParseException> {
    ...
    private LBooleanToShortFunction sut = new LBooleanToShortFunction(){
        public  short applyAsShort(boolean b)  {
            return testValue;
        }
    };

    private LBooleanToShortFunctionX<X> opposite = new LBooleanToShortFunctionX(){
        public  short applyAsShort(boolean b) throws ParseException {
            return testValue;
        }
    };
    ...
    public void testTheResult() throws ParseException {
        assertThat(sut.applyAsShort(true))
            .isEqualTo(testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBooleanToShortFunction: short applyAsShort(boolean b)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LBooleanToShortFunction.l((boolean b) -> testValue ))
            .isInstanceOf(LBooleanToShortFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(LBooleanToShortFunction.wrap(opposite))
            .isInstanceOf(LBooleanToShortFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        LBooleanToShortFunction wrapped = LBooleanToShortFunction.wrap(sutThrowing);

        // then
        try {
            wrapped.applyAsShort(true);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LBooleanToShortFunctionX<ParseException> sutThrowing = LBooleanToShortFunctionX.lX((boolean b) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LBooleanToShortFunction sutThrowing = LBooleanToShortFunction.l((boolean b) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LBooleanToShortFunction wrapped = LBooleanToShortFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromBoolean() throws ParseException {
        ...
        LBooleanToShortFunction sutO = (boolean b) -> {
        ...
        //when
        LBooleanToShortFunction function = sutO.fromBoolean(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LBooleanToShortFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LBooleanToShortFunctionX.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LBooleanToShortFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBooleanToShortFunction: short applyAsShort(boolean b)");
    }
