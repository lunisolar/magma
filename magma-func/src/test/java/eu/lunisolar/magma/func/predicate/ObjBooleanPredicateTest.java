...
public class ObjBooleanPredicateTest<T,X extends ParseException> {
    ...
    private ObjBooleanPredicate<T> sut = new ObjBooleanPredicate(){
        public  boolean test(Object t, boolean b)  {
            return testValue;
        }
    };

    private ObjBooleanPredicateX<T,X> opposite = new ObjBooleanPredicateX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ObjBooleanPredicate: boolean test(T t, boolean b)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(ObjBooleanPredicate.l((Object t, boolean b) -> testValue ))
            .isInstanceOf(ObjBooleanPredicate.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(ObjBooleanPredicate.wrap(opposite))
            .isInstanceOf(ObjBooleanPredicate.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        ObjBooleanPredicate<T> wrapped = ObjBooleanPredicate.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        ObjBooleanPredicateX<T,ParseException> sutThrowing = ObjBooleanPredicateX.lX((T t, boolean b) -> {
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws ParseException {
        ...
        //given
        ObjBooleanPredicate<T> fun1 = ObjBooleanPredicate.l((T t, boolean b) -> f1Result);
        ObjBooleanPredicate<T> fun2 = ObjBooleanPredicate.l((T t, boolean b) -> f2Result);

        //when
        ObjBooleanPredicate<T> andFunction = fun1.and(fun2);
        ObjBooleanPredicate<T> orFunction = fun1.or(fun2);
        ObjBooleanPredicate<T> xorFunction = fun1.xor(fun2);
    ...
    public void isEqual() throws ParseException  {
        //when
        ObjBooleanPredicate<T> equals = ObjBooleanPredicate.isEqual((T)Integer.valueOf(100),true);
    ...
    public void testfromBoolean() throws ParseException {
        ...
        ObjBooleanPredicate<Integer > sutO = (Integer t, boolean b) -> {
        ...
        //when
        ObjBooleanPredicate<Integer > function = sutO.fromBoolean(before1,before2);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ObjBooleanPredicate<T> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ObjBooleanPredicate: boolean test(T t, boolean b)");
    }
