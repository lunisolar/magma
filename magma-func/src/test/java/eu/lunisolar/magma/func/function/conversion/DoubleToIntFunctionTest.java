...
public class DoubleToIntFunctionTest<X extends ParseException> {
    ...
    private DoubleToIntFunction sut = new DoubleToIntFunction(){
        public  int applyAsInt(double d)  {
            return testValue;
        }
    };

    private DoubleToIntFunctionX<X> opposite = new DoubleToIntFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("DoubleToIntFunction: int applyAsInt(double d)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(DoubleToIntFunction.l((double d) -> testValue ))
            .isInstanceOf(DoubleToIntFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(DoubleToIntFunction.wrap(opposite))
            .isInstanceOf(DoubleToIntFunction.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(DoubleToIntFunction.wrapStd(jre))
            .isInstanceOf(DoubleToIntFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        DoubleToIntFunction wrapped = DoubleToIntFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        DoubleToIntFunctionX<ParseException> sutThrowing = DoubleToIntFunctionX.lX((double d) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        DoubleToIntFunction sutThrowing = DoubleToIntFunction.l((double d) -> {
            throw new UnsupportedOperationException();
        });

        // when
        DoubleToIntFunction wrapped = DoubleToIntFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromDouble() throws ParseException {
        ...
        DoubleToIntFunction sutO = (double d) -> {
        ...
        //when
        DoubleToIntFunction function = sutO.fromDouble(before1);
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().applyAsInt((double)100);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        DoubleToIntFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("DoubleToIntFunction: int applyAsInt(double d)");
    }
