...
public class FunctionTest<T,R,X extends ParseException> {
    ...
    private Function<T,R> sut = new Function(){
        public @Nullable Object  apply(Object t)  {
            return testValue;
        }
    };

    private FunctionX<T,R,X> opposite = new FunctionX(){
        public @Nullable Object  apply(Object t) throws ParseException {
            return testValue;
        }
    };

    private Function<T,R> sutNull = new Function(){
        public @Nullable Object  apply(Object t)  {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (Function: R apply(T t)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("Function: R apply(T t)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(Function.l((Object t) -> testValue ))
            .isInstanceOf(Function.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(Function.wrap(opposite))
            .isInstanceOf(Function.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(Function.wrapStd(jre))
            .isInstanceOf(Function.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        Function<T,R> wrapped = Function.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        FunctionX<T,R,ParseException> sutThrowing = FunctionX.lX((T t) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        Function<T,R> sutThrowing = Function.l((T t) -> {
            throw new UnsupportedOperationException();
        });

        // when
        Function<T,R> wrapped = Function.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfrom() throws ParseException {
        ...
        Function<Integer ,Integer > sutO = (Integer t) -> {
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        Consumer<Integer > function = sutO.then(thenFunction);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        Function<T,R> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
