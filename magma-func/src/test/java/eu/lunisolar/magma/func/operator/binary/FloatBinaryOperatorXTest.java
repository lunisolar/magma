...
public class FloatBinaryOperatorXTest<X extends ParseException> {
    ...
    private FloatBinaryOperatorX<X> sut = new FloatBinaryOperatorX(){
        public  float applyAsFloat(float f1,float f2) throws ParseException {
            return testValue;
        }
    };

    private FloatBinaryOperator opposite = new FloatBinaryOperator(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("FloatBinaryOperatorX: float applyAsFloat(float f1,float f2) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(FloatBinaryOperatorX.lX((float f1,float f2) -> testValue ))
            .isInstanceOf(FloatBinaryOperatorX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(FloatBinaryOperatorX.wrapX(opposite))
            .isInstanceOf(FloatBinaryOperatorX.class);
    }
    ...
    public void testMin() throws ParseException {
        ...
        //when
        FloatBinaryOperatorX<X> min = FloatBinaryOperatorX.min();
    ...
    public void testMax() throws ParseException {
        ...
        //when
        FloatBinaryOperatorX<X> max = FloatBinaryOperatorX.max();
    ...
    public void testfromFloat() throws ParseException {
        ...
        FloatBinaryOperatorX<X> sutO = (float f1,float f2) -> {
        ...
        //when
        FloatBinaryOperatorX<X> function = sutO.fromFloat(before1,before2);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        FloatBinaryOperatorX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("FloatBinaryOperatorX: float applyAsFloat(float f1,float f2) throws X");
    }
