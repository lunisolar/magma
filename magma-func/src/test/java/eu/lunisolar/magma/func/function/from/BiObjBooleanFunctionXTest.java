...
public class BiObjBooleanFunctionXTest<T1,T2,R,X extends ParseException> {
    ...
    private BiObjBooleanFunctionX<T1,T2,R,X> sut = new BiObjBooleanFunctionX(){
        public @Nullable Object  apply(Object t1,Object t2, boolean b) throws ParseException {
            return testValue;
        }
    };

    private BiObjBooleanFunction<T1,T2,R> opposite = new BiObjBooleanFunction(){
        public @Nullable Object  apply(Object t1,Object t2, boolean b)  {
            return testValue;
        }
    };

    private BiObjBooleanFunctionX<T1,T2,R,X> sutNull = new BiObjBooleanFunctionX(){
        public @Nullable Object  apply(Object t1,Object t2, boolean b) throws ParseException {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (BiObjBooleanFunctionX: R apply(T1 t1,T2 t2, boolean b) throws X).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BiObjBooleanFunctionX: R apply(T1 t1,T2 t2, boolean b) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(BiObjBooleanFunctionX.lX((Object t1,Object t2, boolean b) -> testValue ))
            .isInstanceOf(BiObjBooleanFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(BiObjBooleanFunctionX.wrapX(opposite))
            .isInstanceOf(BiObjBooleanFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        BiObjBooleanFunctionX<T1,T2,R,X> wrapped = BiObjBooleanFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromBoolean() throws ParseException {
        ...
        BiObjBooleanFunctionX<Integer ,Integer ,Integer ,X> sutO = (Integer t1,Integer t2, boolean b) -> {
        ...
        //when
        BiObjBooleanFunctionX<Integer ,Integer ,Integer ,X> function = sutO.fromBoolean(before1,before2,before3);
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        BiObjBooleanConsumerX<Integer ,Integer ,X> function = sutO.then(thenFunction);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        BiObjBooleanFunctionX<T1,T2,R,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BiObjBooleanFunctionX: R apply(T1 t1,T2 t2, boolean b) throws X");
    }
