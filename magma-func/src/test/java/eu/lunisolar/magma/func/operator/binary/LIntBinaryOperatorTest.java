...
public class LIntBinaryOperatorTest<X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LIntBinaryOperator: int applyAsInt(int i1,int i2)");
    }
    ...
    public void testWrapStdMethod() throws ParseException {
        assertThat(LIntBinaryOperator.wrapStd(jre))
            .isInstanceOf(LIntBinaryOperator.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LIntBinaryOperator wrapped = LIntBinaryOperator.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LIntBinaryOperator wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LIntBinaryOperator: int applyAsInt(int i1,int i2)");
    }
