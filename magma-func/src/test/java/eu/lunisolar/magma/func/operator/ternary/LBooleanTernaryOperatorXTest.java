...
public class LBooleanTernaryOperatorXTest<X extends ParseException> {
    ...
    private LBooleanTernaryOperatorX<ParseException> sutAlwaysThrowing = LBooleanTernaryOperatorX.lX((boolean b1,boolean b2,boolean b3) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBooleanTernaryOperatorX<RuntimeException> sutAlwaysThrowingUnckeck = LBooleanTernaryOperatorX.lX((boolean b1,boolean b2,boolean b3) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // when
        LBooleanTernaryOperatorX<X> wrapped = sutThrowing.handleX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBooleanTernaryOperatorX<X> wrapped = sutThrowing.handleX(h -> Function4U.doNothing());
    ...
    public void testHandle() throws X {
        ...
        // when
        LBooleanTernaryOperatorX<X> wrapped = sutThrowing.handleX(h -> {
