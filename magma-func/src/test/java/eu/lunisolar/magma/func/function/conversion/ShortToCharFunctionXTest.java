...
public class ShortToCharFunctionXTest<X extends ParseException> {
    ...
    private ShortToCharFunctionX<X> sut = new ShortToCharFunctionX(){
        public  char applyAsChar(short s) throws ParseException {
            return testValue;
        }
    };

    private ShortToCharFunction opposite = new ShortToCharFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ShortToCharFunctionX: char applyAsChar(short s) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(ShortToCharFunctionX.lX((short s) -> testValue ))
            .isInstanceOf(ShortToCharFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(ShortToCharFunctionX.wrapX(opposite))
            .isInstanceOf(ShortToCharFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        ShortToCharFunctionX<X> wrapped = ShortToCharFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromShort() throws ParseException {
        ...
        ShortToCharFunctionX<X> sutO = (short s) -> {
        ...
        //when
        ShortToCharFunctionX<X> function = sutO.fromShort(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        ShortToCharFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ShortToCharFunctionX: char applyAsChar(short s) throws X");
    }
