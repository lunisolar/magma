...
public class LongUnaryOperatorTest<X extends ParseException> {
    ...
    private LongUnaryOperator sut = new LongUnaryOperator(){
        public  long applyAsLong(long l)  {
            return testValue;
        }
    };

    private LongUnaryOperatorX<X> opposite = new LongUnaryOperatorX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LongUnaryOperator: long applyAsLong(long l)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LongUnaryOperator.l((long l) -> testValue ))
            .isInstanceOf(LongUnaryOperator.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(LongUnaryOperator.wrap(opposite))
            .isInstanceOf(LongUnaryOperator.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(LongUnaryOperator.wrapStd(jre))
            .isInstanceOf(LongUnaryOperator.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        LongUnaryOperator wrapped = LongUnaryOperator.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LongUnaryOperatorX<ParseException> sutThrowing = LongUnaryOperatorX.lX((long l) -> {
    ...
    public void testfromLong() throws ParseException {
        ...
        //when
        LongUnaryOperator function = sutO.fromLong(before1);
    ...
    public void identity() throws ParseException {
        LongUnaryOperator identityFunction = LongUnaryOperator.identity();
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LongUnaryOperator wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LongUnaryOperator: long applyAsLong(long l)");
    }
