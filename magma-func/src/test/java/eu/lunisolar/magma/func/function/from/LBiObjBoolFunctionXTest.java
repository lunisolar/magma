...
public class LBiObjBoolFunctionXTest<T1,T2,R,X extends ParseException> {
    ...
    private LBiObjBoolFunctionX<Integer,Integer,Integer,X> sut = new LBiObjBoolFunctionX<Integer,Integer,Integer,X>(){
        public @Nullable Integer doApply(Integer a1,Integer a2,boolean a3)  throws X {
            return testValue;
        }
    };

    private LBiObjBoolFunction<Integer,Integer,Integer> opposite = new LBiObjBoolFunction<Integer,Integer,Integer>(){
        public @Nullable Integer doApply(Integer a1,Integer a2,boolean a3)  {
            return testValue;
        }
    };

    private LBiObjBoolFunctionX<Integer,Integer,Integer,X> sutNull = new LBiObjBoolFunctionX<Integer,Integer,Integer,X>(){
        public @Nullable Integer doApply(Integer a1,Integer a2,boolean a3)  throws X {
            return null;
        }
    };
    ...
    private LBiObjBoolFunctionX<Integer,Integer,Integer,ParseException> sutAlwaysThrowing = LBiObjBoolFunctionX.lX((a1,a2,a3) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiObjBoolFunctionX<Integer,Integer,Integer,RuntimeException> sutAlwaysThrowingUnchecked = LBiObjBoolFunctionX.lX((a1,a2,a3) -> {
    ...
    public void testNestingDoApplyChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoApply(100,100,true);
    ...
    public void testShovingDoApplyChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoApply(100,100,true);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testLXMethod() throws X {
        assertThat(LBiObjBoolFunctionX.lX((a1,a2,a3) -> testValue ))
    ...
    public void testHandlingDoApplyMethodWrapsTheException() throws X {
        ...
        // when
        LBiObjBoolFunctionX<Integer,Integer,Integer,RuntimeException> wrapped = sutThrowing.handleBiObjBoolFuncX(handler -> handler
    ...
    @Test
    public void testHandleBiObjBoolFuncXMethodDoNotWrapsOtherExceptionIf() throws X {
        ...
        // when
        LBiObjBoolFunctionX<Integer,Integer,Integer,X> wrapped = sutThrowing.handleBiObjBoolFuncX(handler -> handler
                .wrapIf(UnsupportedOperationException.class::isInstance,IllegalArgumentException::new,  EXCEPTION_WAS_WRAPPED)
...
@Test
    public void testHandleBiObjBoolFuncXMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleBiObjBoolFuncXMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBiObjBoolFunctionX<Integer,Integer,Integer,X> wrapped = sutThrowing.handleBiObjBoolFuncX(h -> Function4U.doNothing());
    ...
    public void testBiObjBoolFuncComposeBool() throws X {
        ...
        //when
        LBiObjBoolFunctionX<Integer,Integer,Integer,X> function = sutO.biObjBoolFuncComposeBool(before1,before2,before3);
    ...
    public void testThen0() throws X  {
        ...
        //given (+ some assertions)
        LBiObjBoolFunctionX<Integer,Integer,Integer,X> sutO = (a1,a2,a3) -> {
                mainFunctionCalled.set(true);
    ...
    public void testHandleBiObjBoolFunc() throws X {
        ...
        // when
        LBiObjBoolFunctionX<Integer,Integer,Integer,X> wrapped = sutThrowing.handleBiObjBoolFuncX(h -> {
    ...
    public void compilerSubstituteVariantV1() {
        LBiObjBoolFunctionX lambda = LBiObjBoolFunctionX./*<T1,T2,R,X>*/lX1(this::variantV1);
    ...
    public void compilerSubstituteVariantV2() {
        LBiObjBoolFunctionX lambda = LBiObjBoolFunctionX./*<T1,T2,R,X>*/lX2(this::variantV2);
    ...
    public void compilerSubstituteVariantV3() {
        LBiObjBoolFunctionX lambda = LBiObjBoolFunctionX./*<T1,T2,R,X>*/lX3(this::variantV3);
    ...
    public void compilerSubstituteVariantV4() {
        LBiObjBoolFunctionX lambda = LBiObjBoolFunctionX./*<T1,T2,R,X>*/lX4(this::variantV4);
    ...
    public void compilerSubstituteVariantV5() {
        LBiObjBoolFunctionX lambda = LBiObjBoolFunctionX./*<T1,T2,R,X>*/lX5(this::variantV5);
    ...
    @Test void safeCompiles() {
        LBiObjBoolFunctionX r1 = LBiObjBoolFunctionX.safe(sut); //NOSONAR
    }
    ...
    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LBiObjBoolFunctionX<Integer,Integer,Integer,X>,Y> supplier = ()->sut;
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LBiObjBoolFunctionX<Integer,Integer,Integer,X>,Y> r1 = LBiObjBoolFunctionX.safeSupplier(()->sut);  //NOSONAR
    }
