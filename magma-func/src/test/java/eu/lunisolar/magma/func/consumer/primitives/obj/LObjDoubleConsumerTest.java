...
@Test
    ...
    @Test  void safeSupplierCompiles() {
        LSupplier<LObjDoubleConsumer<T>> r1 = LObjDoubleConsumer.safeSupplier(()->sut);  //NOSONAR
        Supplier<LObjDoubleConsumer<T>> r2 = LObjDoubleConsumer.safeSupplier(()->sut); //NOSONAR
    }
