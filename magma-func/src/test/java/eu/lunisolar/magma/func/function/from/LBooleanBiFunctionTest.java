...
public class LBooleanBiFunctionTest<R,X extends ParseException> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LBooleanBiFunction<R> wrapped = LBooleanBiFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
...
//
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LBooleanBiFunction<R> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
