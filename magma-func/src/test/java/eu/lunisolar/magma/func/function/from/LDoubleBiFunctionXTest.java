...
public class LDoubleBiFunctionXTest<R,X extends ParseException> {
    ...
    private LDoubleBiFunctionX<R,ParseException> sutAlwaysThrowing = LDoubleBiFunctionX.lX((double d1,double d2) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LDoubleBiFunctionX<R,RuntimeException> sutAlwaysThrowingUnckeck = LDoubleBiFunctionX.lX((double d1,double d2) -> {
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNullDoApply() method cannot be null (LDoubleBiFunctionX: R doApply(double d1,double d2) throws X).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LDoubleBiFunctionX: R doApply(double d1,double d2) throws X");
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // when
        LDoubleBiFunctionX<R,X> wrapped = sutThrowing.handleDBiFuncX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LDoubleBiFunctionX<R,X> wrapped = sutThrowing.handleDBiFuncX(h -> Function4U.doNothing());
    ...
    public void testdBiFuncFromDouble() throws X {
        ...
        //when
        LDoubleBiFunctionX<Integer ,X> function = sutO.dBiFuncFromDouble(before1,before2);
    ...
    public void testdBiFuncFrom() throws X {
        ...
        //when
        LBiFunctionX<Integer ,Integer ,Integer ,X> function = sutO.dBiFuncFrom(before1,before2);
    ...
    public void testHandleDBiFunc() throws X {
        ...
        // when
        LDoubleBiFunctionX<R,X> wrapped = sutThrowing.handleDBiFuncX(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LDoubleBiFunctionX: R doApply(double d1,double d2) throws X");
    }
