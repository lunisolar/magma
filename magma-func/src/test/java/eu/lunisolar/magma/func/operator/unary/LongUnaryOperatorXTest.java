...
public class LongUnaryOperatorXTest<X extends ParseException> {
    ...
    private LongUnaryOperatorX<X> sut = new LongUnaryOperatorX(){
        public  long applyAsLong(long l) throws ParseException {
            return testValue;
        }
    };

    private LongUnaryOperator opposite = new LongUnaryOperator(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LongUnaryOperatorX: long applyAsLong(long l) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(LongUnaryOperatorX.lX((long l) -> testValue ))
            .isInstanceOf(LongUnaryOperatorX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(LongUnaryOperatorX.wrapX(opposite))
            .isInstanceOf(LongUnaryOperatorX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LongUnaryOperatorX<X> sutThrowing = LongUnaryOperatorX.lX((long l) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LongUnaryOperatorX<X> wrapped = LongUnaryOperatorX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromLong() throws ParseException {
        ...
        LongUnaryOperatorX<X> sutO = (long l) -> {
        ...
        //when
        LongUnaryOperatorX<X> function = sutO.fromLong(before1);
    ...
    public void identity() throws ParseException {
        LongUnaryOperatorX<X> identityFunction = LongUnaryOperatorX.identity();
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LongUnaryOperator.class);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LongUnaryOperatorX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LongUnaryOperatorX: long applyAsLong(long l) throws X");
    }
