...
public class LByteToFloatFunctionXTest<X extends ParseException> {
    ...
    public void testLXMethod() throws ParseException {
        assertThat(LByteToFloatFunctionX.lX((byte b) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LByteToFloatFunctionX<X> wrapped = LByteToFloatFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        LByteToFloatFunctionX<X> sutO = (byte b) -> {
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LByteToFloatFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
