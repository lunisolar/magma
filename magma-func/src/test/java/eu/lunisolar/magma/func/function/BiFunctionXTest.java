...
public class BiFunctionXTest<T1,T2,R,X extends ParseException> {
    ...
    private BiFunctionX<T1,T2,R,X> sut = new BiFunctionX(){
        public @Nullable Object  apply(Object t1,Object t2) throws ParseException {
            return testValue;
        }
    };

    private BiFunction<T1,T2,R> opposite = new BiFunction(){
        public @Nullable Object  apply(Object t1,Object t2)  {
            return testValue;
        }
    };

    private BiFunctionX<T1,T2,R,X> sutNull = new BiFunctionX(){
        public @Nullable Object  apply(Object t1,Object t2) throws ParseException {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (BiFunctionX: R apply(T1 t1,T2 t2) throws X).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BiFunctionX: R apply(T1 t1,T2 t2) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(BiFunctionX.lX((Object t1,Object t2) -> testValue ))
            .isInstanceOf(BiFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(BiFunctionX.wrapX(opposite))
            .isInstanceOf(BiFunctionX.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(BiFunctionX.wrapStd(jre))
            .isInstanceOf(BiFunctionX.class);
    }
    ...
    public void testfrom() throws ParseException {
        ...
        BiFunctionX<Integer ,Integer ,Integer ,X> sutO = (Integer t1,Integer t2) -> {
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        BiConsumerX<Integer ,Integer ,X> function = sutO.then(thenFunction);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        BiFunctionX<T1,T2,R,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BiFunctionX: R apply(T1 t1,T2 t2) throws X");
    }
