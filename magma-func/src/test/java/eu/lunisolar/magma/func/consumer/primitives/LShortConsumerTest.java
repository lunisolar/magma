...
public class LShortConsumerTest<X extends ParseException> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LShortSingle,LTuple.Void,RuntimeException> theCall = sut;
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LShortConsumer: void doAccept(short a1)");
    }
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LShortConsumerX<ParseException> sutThrowing = LShortConsumerX.lX(a1 -> {
...
@Test
    ...
    public void testshortConsComposeShort() throws X {
        ...
        //when
        LShortConsumer function = sutO.shortConsComposeShort(before1);
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LShortConsumer: void doAccept(short a1)");
    }
    ...
    @Test void safeCompiles() {
        LShortConsumer r1 = LShortConsumer.safe(sut);
        LShortConsumerX r2 = LShortConsumer.safe(sut);
    }
    ...
    @Test  void safeSupplierCompiles() {
        LSupplier<LShortConsumer> r1 = LShortConsumer.safeSupplier(()->sut);
    }
