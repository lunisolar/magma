...
public class ToIntBiFunctionXTest<T1,T2,X extends ParseException> {
    ...
    private ToIntBiFunctionX<T1,T2,X> sut = new ToIntBiFunctionX(){
        public  int applyAsInt(Object t1,Object t2) throws ParseException {
            return testValue;
        }
    };

    private ToIntBiFunction<T1,T2> opposite = new ToIntBiFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ToIntBiFunctionX: int applyAsInt(T1 t1,T2 t2) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(ToIntBiFunctionX.lX((Object t1,Object t2) -> testValue ))
            .isInstanceOf(ToIntBiFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(ToIntBiFunctionX.wrapX(opposite))
            .isInstanceOf(ToIntBiFunctionX.class);
    }
    ...
    public void testfrom() throws ParseException {
        ...
        ToIntBiFunctionX<Integer ,Integer ,X> sutO = (Integer t1,Integer t2) -> {
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        ToIntBiFunctionX<T1,T2,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ToIntBiFunctionX: int applyAsInt(T1 t1,T2 t2) throws X");
    }
