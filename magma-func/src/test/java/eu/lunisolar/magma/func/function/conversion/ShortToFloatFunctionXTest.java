...
public class ShortToFloatFunctionXTest<X extends ParseException> {
    ...
    private ShortToFloatFunctionX<X> sut = new ShortToFloatFunctionX(){
        public  float applyAsFloat(short s) throws ParseException {
            return testValue;
        }
    };

    private ShortToFloatFunction opposite = new ShortToFloatFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ShortToFloatFunctionX: float applyAsFloat(short s) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(ShortToFloatFunctionX.lX((short s) -> testValue ))
            .isInstanceOf(ShortToFloatFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(ShortToFloatFunctionX.wrapX(opposite))
            .isInstanceOf(ShortToFloatFunctionX.class);
    }
    ...
    public void testfromShort() throws ParseException {
        ...
        ShortToFloatFunctionX<X> sutO = (short s) -> {
        ...
        //when
        ShortToFloatFunctionX<X> function = sutO.fromShort(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        ShortToFloatFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ShortToFloatFunctionX: float applyAsFloat(short s) throws X");
    }
