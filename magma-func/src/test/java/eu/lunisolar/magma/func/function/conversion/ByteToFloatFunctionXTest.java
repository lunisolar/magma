...
public class ByteToFloatFunctionXTest<X extends ParseException> {
    ...
    private ByteToFloatFunctionX<X> sut = new ByteToFloatFunctionX(){
        public  float applyAsFloat(byte b) throws ParseException {
            return testValue;
        }
    };

    private ByteToFloatFunction opposite = new ByteToFloatFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ByteToFloatFunctionX: float applyAsFloat(byte b) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(ByteToFloatFunctionX.lX((byte b) -> testValue ))
            .isInstanceOf(ByteToFloatFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(ByteToFloatFunctionX.wrapX(opposite))
            .isInstanceOf(ByteToFloatFunctionX.class);
    }
    ...
    public void testfromByte() throws ParseException {
        ...
        ByteToFloatFunctionX<X> sutO = (byte b) -> {
        ...
        //when
        ByteToFloatFunctionX<X> function = sutO.fromByte(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        ByteToFloatFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ByteToFloatFunctionX: float applyAsFloat(byte b) throws X");
    }
