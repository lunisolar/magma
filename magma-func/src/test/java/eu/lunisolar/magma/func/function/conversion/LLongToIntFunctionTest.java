...
public class LLongToIntFunctionTest<X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LLongToIntFunction: int applyAsInt(long l)");
    }
    ...
    public void testWrapStdMethod() throws ParseException {
        assertThat(LLongToIntFunction.wrapStd(jre))
            .isInstanceOf(LLongToIntFunction.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LLongToIntFunction wrapped = LLongToIntFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LLongToIntFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LLongToIntFunctionX.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LLongToIntFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LLongToIntFunction: int applyAsInt(long l)");
    }
