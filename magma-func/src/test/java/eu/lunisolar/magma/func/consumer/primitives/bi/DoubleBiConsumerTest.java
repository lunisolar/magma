...
public class DoubleBiConsumerTest<X extends ParseException> {
    ...
    private DoubleBiConsumer sut = new DoubleBiConsumer(){
        public  void accept(double d1,double d2)  {
            Function4U.doNothing();
        }
    };

    private DoubleBiConsumerX<X> opposite = new DoubleBiConsumerX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("DoubleBiConsumer: void accept(double d1,double d2)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(DoubleBiConsumer.l((double d1,double d2) -> Function4U.doNothing() ))
            .isInstanceOf(DoubleBiConsumer.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(DoubleBiConsumer.wrap(opposite))
            .isInstanceOf(DoubleBiConsumer.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        DoubleBiConsumer wrapped = DoubleBiConsumer.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        DoubleBiConsumerX<ParseException> sutThrowing = DoubleBiConsumerX.lX((double d1,double d2) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        DoubleBiConsumer wrapped = DoubleBiConsumer.wrapException(sutThrowing, UnsupportedOperationException.class, t -> {
    ...
    public void testfromDouble() throws ParseException {
        ...
        DoubleBiConsumer sutO = (double d1,double d2) -> {
        ...
        //when
        DoubleBiConsumer function = sutO.fromDouble(before1,before2);
    ...
    public void testAndThen() throws ParseException {
        ...
        DoubleBiConsumer thenFunction = (double d1,double d2) -> {
        ...
        //when
        DoubleBiConsumer function = sutO.andThen(thenFunction);
        function.accept((double)80,(double)81);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        DoubleBiConsumer wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("DoubleBiConsumer: void accept(double d1,double d2)");
    }
