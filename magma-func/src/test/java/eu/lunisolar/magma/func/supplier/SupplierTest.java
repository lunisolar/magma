...
public class SupplierTest<R,X extends ParseException> {
    ...
    private Supplier<R> sut = new Supplier(){
        public @Nullable Object  get()  {
            return testValue;
        }
    };

    private SupplierX<R,X> opposite = new SupplierX(){
        public @Nullable Object  get() throws ParseException {
            return testValue;
        }
    };

    private Supplier<R> sutNull = new Supplier(){
        public @Nullable Object  get()  {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (Supplier: R get()).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("Supplier: R get()");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(Supplier.l(() -> testValue ))
            .isInstanceOf(Supplier.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(Supplier.wrap(opposite))
            .isInstanceOf(Supplier.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(Supplier.wrapStd(jre))
            .isInstanceOf(Supplier.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        Supplier<R> wrapped = Supplier.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        SupplierX<R,ParseException> sutThrowing = SupplierX.lX(() -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        Supplier<R> sutThrowing = Supplier.l(() -> {
            throw new UnsupportedOperationException();
        });

        // when
        Supplier<R> wrapped = Supplier.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        Action function = sutO.then(thenFunction);
        function.execute();
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        Supplier<R> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
