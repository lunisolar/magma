...
public class BooleanSupplierTest<X extends ParseException> {
    ...
    private BooleanSupplier sut = new BooleanSupplier(){
        public  boolean getAsBoolean()  {
            return testValue;
        }
    };

    private BooleanSupplierX<X> opposite = new BooleanSupplierX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BooleanSupplier: boolean getAsBoolean()");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(BooleanSupplier.l(() -> testValue ))
            .isInstanceOf(BooleanSupplier.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(BooleanSupplier.wrap(opposite))
            .isInstanceOf(BooleanSupplier.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(BooleanSupplier.wrapStd(jre))
            .isInstanceOf(BooleanSupplier.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        BooleanSupplier wrapped = BooleanSupplier.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        BooleanSupplierX<ParseException> sutThrowing = BooleanSupplierX.lX(() -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        BooleanSupplier sutThrowing = BooleanSupplier.l(() -> {
            throw new UnsupportedOperationException();
        });

        // when
        BooleanSupplier wrapped = BooleanSupplier.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        BooleanSupplier wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BooleanSupplier: boolean getAsBoolean()");
    }
