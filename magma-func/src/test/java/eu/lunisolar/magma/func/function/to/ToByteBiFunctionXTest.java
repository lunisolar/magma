...
public class ToByteBiFunctionXTest<T1,T2,X extends ParseException> {
    ...
    private ToByteBiFunctionX<T1,T2,X> sut = new ToByteBiFunctionX(){
        public  byte applyAsByte(Object t1,Object t2) throws ParseException {
            return testValue;
        }
    };

    private ToByteBiFunction<T1,T2> opposite = new ToByteBiFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ToByteBiFunctionX: byte applyAsByte(T1 t1,T2 t2) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(ToByteBiFunctionX.lX((Object t1,Object t2) -> testValue ))
            .isInstanceOf(ToByteBiFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(ToByteBiFunctionX.wrapX(opposite))
            .isInstanceOf(ToByteBiFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        ToByteBiFunctionX<T1,T2,X> wrapped = ToByteBiFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfrom() throws ParseException {
        ...
        ToByteBiFunctionX<Integer ,Integer ,X> sutO = (Integer t1,Integer t2) -> {
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        ToByteBiFunctionX<T1,T2,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ToByteBiFunctionX: byte applyAsByte(T1 t1,T2 t2) throws X");
    }
