...
public class LTieLongFunctionTest<T> {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.applyAsInt(100,100,100L), testValue);
    }
    ...
    public void testNonNullApplyAsInt() throws Throwable {
            Assert.assertEquals(sut.nonNullApplyAsInt(100,100,100L), testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LTieLongFunction: int applyAsInt(T a1,int a2,long a3)");
    }

    @Test
    public void testTieLongFuncMethod() throws Throwable {
        Assert.assertTrue(LTieLongFunction.tieLongFunc((a1,a2,a3) -> testValue ) instanceof LTieLongFunction);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LTieLongFunction: int applyAsInt(T a1,int a2,long a3)"));
    ...
    public void compilerSubstituteVariantLObjLongIntToIntFunc() {
        ...
        Assert.assertTrue(lambda instanceof LTieLongFunction.LObjLongIntToIntFunc);
    }
    ...
    public void compilerSubstituteVariantLIntObjLongToIntFunc() {
        ...
        Assert.assertTrue(lambda instanceof LTieLongFunction.LIntObjLongToIntFunc);
    }
    ...
    public void compilerSubstituteVariantLIntLongObjToIntFunc() {
        ...
        Assert.assertTrue(lambda instanceof LTieLongFunction.LIntLongObjToIntFunc);
    }
    ...
    public void compilerSubstituteVariantLLongObjIntToIntFunc() {
        ...
        Assert.assertTrue(lambda instanceof LTieLongFunction.LLongObjIntToIntFunc);
    }
    ...
    public void compilerSubstituteVariantLLongIntObjToIntFunc() {
        ...
        Assert.assertTrue(lambda instanceof LTieLongFunction.LLongIntObjToIntFunc);
    }
