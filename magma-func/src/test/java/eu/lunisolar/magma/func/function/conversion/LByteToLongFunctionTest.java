...
public class LByteToLongFunctionTest<X extends ParseException> {
    ...
    private LByteToLongFunctionX<X> opposite = new LByteToLongFunctionX<X>(){
    ...
    private LByteToLongFunctionX<RuntimeException> sutAlwaysThrowingUnchecked = LByteToLongFunction.l(a -> {
    ...
    public void testLMethod() throws X {
        assertThat(LByteToLongFunction.l(a -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LByteToLongFunctionX<ParseException> sutThrowing = LByteToLongFunctionX.lX(a -> {
    ...
    public void testHandlingDoApplyAsLongMethodWrapsTheException() throws X {
        ...
        // given
        LByteToLongFunction sutThrowing = LByteToLongFunction.l(a -> {
    ...
    @Test
    public void testHandleByteToLongFuncMethodDoNotWrapsOtherExceptionIf() throws X {
...
@Test
    public void testHandleByteToLongFuncMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleByteToLongFuncMishandlingExceptionIsAllowed() throws X {
    ...
    @Test void safeCompiles() {
        LByteToLongFunction r1 = LByteToLongFunction.safe(sut); //NOSONAR
        LByteToLongFunctionX r2 = LByteToLongFunction.safe(sut); //NOSONAR
    }

    @Test void safePropagates() {
        Object result = LByteToLongFunction.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LByteToLongFunction.safe(null);
        assertThat(result).isSameAs(LByteToLongFunction.l(LByteToLongFunction.safe()));
    }

    @Test  void safeSupplierPropagates() {
        LSupplier<LByteToLongFunction> supplier = ()->sut;
        Object result = LByteToLongFunction.safeSupplier(supplier);
        assertThat(result).isSameAs(supplier);
    }

    @Test  void safeSupplierProtectsAgainstNpe() {
        Object result = LByteToLongFunction.safeSupplier(null);
        assertThat(result).isSameAs(LByteToLongFunction.safeSupplier());
    }

    @Test  void safeSupplierCompiles() {
        LSupplier<LByteToLongFunction> r1 = LByteToLongFunction.safeSupplier(()->sut);  //NOSONAR
    }
