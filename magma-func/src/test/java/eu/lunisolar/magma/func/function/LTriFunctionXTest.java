...
public class LTriFunctionXTest<T1,T2,T3,R,X extends ParseException> {
    ...
    private LTriFunctionX<T1,T2,T3,R,ParseException> sutAlwaysThrowing = LTriFunctionX.lX((T1 a1,T2 a2,T3 a3) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LTriFunctionX<T1,T2,T3,R,RuntimeException> sutAlwaysThrowingUnckeck = LTriFunctionX.lX((T1 a1,T2 a2,T3 a3) -> {
    ...
    public void testLXMethod() throws X {
        assertThat(LTriFunctionX.lX((Object a1,Object a2,Object a3) -> testValue ))
...
@Test
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LTriFunctionX<T1,T2,T3,R,X>,Y> r1 = LTriFunctionX.safeSupplier(()->sut);  //NOSONAR
    }
