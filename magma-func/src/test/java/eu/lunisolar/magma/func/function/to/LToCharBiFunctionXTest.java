...
public class LToCharBiFunctionXTest<T1,T2,X extends ParseException> {
    ...
    private LToCharBiFunctionX<T1,T2,ParseException> sutAlwaysThrowing = LToCharBiFunctionX.lX((T1 a1,T2 a2) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LToCharBiFunctionX<T1,T2,RuntimeException> sutAlwaysThrowingUnckeck = LToCharBiFunctionX.lX((T1 a1,T2 a2) -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LPair<T1,T2>,Character,X> theCall = sut;
    ...
    public void testLXMethod() throws X {
        assertThat(LToCharBiFunctionX.lX((Object a1,Object a2) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // when
        LToCharBiFunctionX<T1,T2,X> wrapped = sutThrowing.handleToCharBiFuncX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LToCharBiFunctionX<T1,T2,X> wrapped = sutThrowing.handleToCharBiFuncX(h -> Function4U.doNothing());
    ...
    public void testtoCharBiFuncCompose() throws X {
        ...
        LToCharBiFunctionX<Integer ,Integer ,X> sutO = (Integer a1,Integer a2) -> {
    ...
    public void testHandleToCharBiFunc() throws X {
        ...
        // when
        LToCharBiFunctionX<T1,T2,X> wrapped = sutThrowing.handleToCharBiFuncX(h -> {
    ...
    public void compilerSubstituteVariant1() {
        LToCharBiFunctionX lambda = LToCharBiFunctionX./*<T1,T2,X>*/lX1(this::variant1);
    ...
    @Test void safeCompiles() {
        LToCharBiFunctionX r1 = LToCharBiFunctionX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LToCharBiFunctionX<T1,T2,X>,Y> supplier = ()->sut;
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LToCharBiFunctionX<T1,T2,X>,Y> r1 = LToCharBiFunctionX.safeSupplier(()->sut);
    }
