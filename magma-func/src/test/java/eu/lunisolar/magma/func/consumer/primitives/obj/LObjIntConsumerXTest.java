...
public class LObjIntConsumerXTest<T,X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LObjIntConsumerX: void doAccept(T t, int i) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(LObjIntConsumerX.lX((Object t, int i) -> Function4U.doNothing() ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LObjIntConsumerX<T,X> wrapped = LObjIntConsumerX.wrapException(sutThrowing, UnsupportedOperationException.class, t -> {
    ...
    public void testfromInt() throws ParseException {
        ...
        LObjIntConsumerX<Integer ,X> sutO = (Integer t, int i) -> {
        ...
        //when
        LObjIntConsumerX<Integer ,X> function = sutO.fromInt(before1,before2);
    ...
    public void testAndThen() throws ParseException {
        ...
        LObjIntConsumerX<Integer ,X> thenFunction = (Integer t, int i) -> {
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LObjIntConsumerX<T,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LObjIntConsumerX: void doAccept(T t, int i) throws X");
    }
