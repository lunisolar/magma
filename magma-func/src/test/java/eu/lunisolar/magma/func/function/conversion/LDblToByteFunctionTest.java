...
public class LDblToByteFunctionTest {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.applyAsByte(100d), testValue);
    }
    ...
    public void testNonNullApplyAsByte() throws Throwable {
            Assert.assertEquals(sut.nonNullApplyAsByte(100d), testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LDblToByteFunction: byte applyAsByte(double a)");
    }

    @Test
    public void testDblToByteFuncMethod() throws Throwable {
        Assert.assertTrue(LDblToByteFunction.dblToByteFunc(a -> testValue ) instanceof LDblToByteFunction);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LDblToByteFunction: byte applyAsByte(double a)"));
