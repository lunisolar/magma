...
public class LIntToFloatFunctionXTest<X extends ParseException> {
    ...
    private LIntToFloatFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LIntToFloatFunctionX.lX(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LIntSingle,Float,X> theCall = sut;
...
@Test
    ...
    @Test void safeCompiles() {
        LIntToFloatFunctionX r1 = LIntToFloatFunctionX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LIntToFloatFunctionX<X>,Y> r1 = LIntToFloatFunctionX.safeSupplier(()->sut);
    }
