...
public class LShortToLongFunctionXTest<X extends ParseException> {
    ...
    private LShortToLongFunctionX<X> sut = new LShortToLongFunctionX<X>(){
    ...
    private LShortToLongFunctionX<ParseException> sutAlwaysThrowing = LShortToLongFunctionX.lX(a1 -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LShortToLongFunctionX<RuntimeException> sutAlwaysThrowingUnchecked = LShortToLongFunctionX.lX(a1 -> {
    ...
    public void testNestingDoApplyAsLongChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoApplyAsLong((short)100);
    ...
    public void testShovingDoApplyAsLongChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoApplyAsLong((short)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LShortToLongFunctionX: long doApplyAsLong(short a1) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LShortToLongFunctionX.lX(a1 -> testValue ))
    ...
    public void testHandlingDoApplyAsLongMethodWrapsTheException() throws X {
        ...
        // when
        LShortToLongFunctionX<RuntimeException> wrapped = sutThrowing.handleShortToLongFuncX(handler -> handler
    ...
    @Test
    public void testHandleShortToLongFuncXMethodDoNotWrapsOtherExceptionIf() throws X {
        ...
        // when
        LShortToLongFunctionX<X> wrapped = sutThrowing.handleShortToLongFuncX(handler -> handler
                .wrapIf(UnsupportedOperationException.class::isInstance,IllegalArgumentException::new,  EXCEPTION_WAS_WRAPPED)
...
@Test
    public void testHandleShortToLongFuncXMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleShortToLongFuncXMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LShortToLongFunctionX<X> wrapped = sutThrowing.handleShortToLongFuncX(h -> Function4U.doNothing());
    ...
    public void testShortToLongFuncComposeShort() throws X {
        ...
        LShortToLongFunctionX<X> sutO = a1 -> {
        ...
        //when
        LShortToLongFunctionX<X> function = sutO.shortToLongFuncComposeShort(before1);
    ...
    public void testShortToLongFuncCompose() throws X {
        ...
        //when
        LToLongFunctionX<Integer,X> function = sutO.shortToLongFuncCompose(before1);
    ...
    public void testHandleShortToLongFunc() throws X {
        ...
        // when
        LShortToLongFunctionX<X> wrapped = sutThrowing.handleShortToLongFuncX(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LShortToLongFunctionX: long doApplyAsLong(short a1) throws X");
    }
    ...
    @Test void safeCompiles() {
        LShortToLongFunctionX r1 = LShortToLongFunctionX.safe(sut); //NOSONAR
    }

    @Test void safePropagates() {
        Object result = LShortToLongFunctionX.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LShortToLongFunctionX.safe(null);
        assertThat(result).isSameAs(LShortToLongFunctionX.lX(LShortToLongFunctionX.safe()));
    }

    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LShortToLongFunctionX<X>,Y> supplier = ()->sut;
        Object result = LShortToLongFunctionX.safeSupplier(supplier);
        assertThat(result).isSameAs(supplier);
    }

    @Test <Y extends Throwable> void safeSupplierProtectsAgainstNpe() {
        Object result = LShortToLongFunctionX.safeSupplier(null);
        assertThat(result).isSameAs(LShortToLongFunctionX.safeSupplier());
    }

    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LShortToLongFunctionX<X>,Y> r1 = LShortToLongFunctionX.safeSupplier(()->sut);  //NOSONAR
    }
