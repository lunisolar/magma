...
public class LIntToShortFunctionTest<X extends ParseException> {
    ...
    public void testLMethod() throws ParseException {
        assertThat(LIntToShortFunction.l((int i) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LIntToShortFunctionX<ParseException> sutThrowing = LIntToShortFunctionX.lX((int i) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LIntToShortFunction sutThrowing = LIntToShortFunction.l((int i) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LIntToShortFunction wrapped = LIntToShortFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromInt() throws ParseException {
        ...
        LIntToShortFunction sutO = (int i) -> {
        ...
        //when
        LIntToShortFunction function = sutO.fromInt(before1);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LIntToShortFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
