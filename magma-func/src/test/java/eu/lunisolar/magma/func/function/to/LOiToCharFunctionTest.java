...
public class LOiToCharFunctionTest<T> {
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LOiToCharFunction: char applyAsChar(T a1,int a2)");
    }

    @Test
    public void testOiToCharFuncMethod() throws Throwable {
        Assert.assertTrue(LOiToCharFunction.oiToCharFunc((a1,a2) -> testValue ) instanceof LOiToCharFunction);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LOiToCharFunction: char applyAsChar(T a1,int a2)"));
