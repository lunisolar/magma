...
public class LongBiFunctionTest<R,X extends ParseException> {
    ...
    private LongBiFunction<R> sut = new LongBiFunction(){
        public @Nullable Object  apply(long l1,long l2)  {
            return testValue;
        }
    };

    private LongBiFunctionX<R,X> opposite = new LongBiFunctionX(){
        public @Nullable Object  apply(long l1,long l2) throws ParseException {
            return testValue;
        }
    };

    private LongBiFunction<R> sutNull = new LongBiFunction(){
        public @Nullable Object  apply(long l1,long l2)  {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (LongBiFunction: R apply(long l1,long l2)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LongBiFunction: R apply(long l1,long l2)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LongBiFunction.l((long l1,long l2) -> testValue ))
            .isInstanceOf(LongBiFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(LongBiFunction.wrap(opposite))
            .isInstanceOf(LongBiFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        LongBiFunction<R> wrapped = LongBiFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LongBiFunctionX<R,ParseException> sutThrowing = LongBiFunctionX.lX((long l1,long l2) -> {
    ...
    public void testfromLong() throws ParseException {
        ...
        LongBiFunction<Integer > sutO = (long l1,long l2) -> {
        ...
        //when
        LongBiFunction<Integer > function = sutO.fromLong(before1,before2);
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        LongBiConsumer function = sutO.then(thenFunction);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LongBiFunction<R> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LongBiFunction: R apply(long l1,long l2)");
    }
