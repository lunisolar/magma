...
public class BooleanFunctionTest<R,X extends ParseException> {
    ...
    private BooleanFunction<R> sut = new BooleanFunction(){
        public @Nullable Object  apply(boolean b)  {
            return testValue;
        }
    };

    private BooleanFunctionX<R,X> opposite = new BooleanFunctionX(){
        public @Nullable Object  apply(boolean b) throws ParseException {
            return testValue;
        }
    };

    private BooleanFunction<R> sutNull = new BooleanFunction(){
        public @Nullable Object  apply(boolean b)  {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (BooleanFunction: R apply(boolean b)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BooleanFunction: R apply(boolean b)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(BooleanFunction.l((boolean b) -> testValue ))
            .isInstanceOf(BooleanFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(BooleanFunction.wrap(opposite))
            .isInstanceOf(BooleanFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        BooleanFunction<R> wrapped = BooleanFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        BooleanFunctionX<R,ParseException> sutThrowing = BooleanFunctionX.lX((boolean b) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        BooleanFunction<R> sutThrowing = BooleanFunction.l((boolean b) -> {
            throw new UnsupportedOperationException();
        });

        // when
        BooleanFunction<R> wrapped = BooleanFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromBoolean() throws ParseException {
        ...
        BooleanFunction<Integer > sutO = (boolean b) -> {
        ...
        //when
        BooleanFunction<Integer > function = sutO.fromBoolean(before1);
        function.apply(true);
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        BooleanConsumer function = sutO.then(thenFunction);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(BooleanFunction.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        BooleanFunction<R> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BooleanFunction: R apply(boolean b)");
    }
