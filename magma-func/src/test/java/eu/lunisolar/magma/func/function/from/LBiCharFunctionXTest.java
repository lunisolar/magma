...
public class LBiCharFunctionXTest<R,X extends ParseException> {
    ...
    private LBiCharFunctionX<R,ParseException> sutAlwaysThrowing = LBiCharFunctionX.lX((char c1,char c2) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiCharFunctionX<R,RuntimeException> sutAlwaysThrowingUnckeck = LBiCharFunctionX.lX((char c1,char c2) -> {
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNullDoApply() method cannot be null (LBiCharFunctionX: R doApply(char c1,char c2) throws X).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBiCharFunctionX: R doApply(char c1,char c2) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LBiCharFunctionX.lX((char c1,char c2) -> testValue ))
...
@Test
    ...
    public void testbiCharFuncComposeChar() throws X {
        ...
        LBiCharFunctionX<Integer ,X> sutO = (char c1,char c2) -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBiCharFunctionX: R doApply(char c1,char c2) throws X");
    }
