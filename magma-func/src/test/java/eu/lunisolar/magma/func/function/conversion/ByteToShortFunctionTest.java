...
public class ByteToShortFunctionTest<X extends ParseException> {
    ...
    private ByteToShortFunction sut = new ByteToShortFunction(){
        public  short applyAsShort(byte b)  {
            return testValue;
        }
    };

    private ByteToShortFunctionX<X> opposite = new ByteToShortFunctionX(){
        public  short applyAsShort(byte b) throws ParseException {
            return testValue;
        }
    };
    ...
    public void testTheResult() throws ParseException {
        assertThat(sut.applyAsShort((byte)100))
            .isEqualTo(testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ByteToShortFunction: short applyAsShort(byte b)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(ByteToShortFunction.l((byte b) -> testValue ))
            .isInstanceOf(ByteToShortFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(ByteToShortFunction.wrap(opposite))
            .isInstanceOf(ByteToShortFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        // given
        ByteToShortFunctionX<X> sutThrowing = ByteToShortFunctionX.lX((byte b) -> {
            throw new UnsupportedOperationException(ORIGINAL_MESSAGE);
        });

        // when
        ByteToShortFunction wrapped = ByteToShortFunction.wrap(sutThrowing);

        // then
        try {
            wrapped.applyAsShort((byte)100);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        ByteToShortFunctionX<ParseException> sutThrowing = ByteToShortFunctionX.lX((byte b) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        ByteToShortFunction sutThrowing = ByteToShortFunction.l((byte b) -> {
            throw new UnsupportedOperationException();
        });

        // when
        ByteToShortFunction wrapped = ByteToShortFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        ByteToShortFunction sutO = (byte b) -> {
        ...
        //when
        ByteToShortFunction function = sutO.fromByte(before1);
        function.applyAsShort((byte)80);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(ByteToShortFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(ByteToShortFunctionX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().applyAsShort((byte)100);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ByteToShortFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ByteToShortFunction: short applyAsShort(byte b)");
    }
