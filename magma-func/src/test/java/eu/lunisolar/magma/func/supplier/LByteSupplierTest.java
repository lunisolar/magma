...
public class LByteSupplierTest {
    ...
    @Test
    public void testNestingGetAsByteUnchecked() throws Throwable {
    ...
    @Test
    public void testShovingGetAsByteUnchecked() throws Throwable {
    ...
    @Test  void safeSupplierCompiles() {
        LSupplier<LByteSupplier> r1 = LByteSupplier.safeSupplier(()->sut);  //NOSONAR
    }
