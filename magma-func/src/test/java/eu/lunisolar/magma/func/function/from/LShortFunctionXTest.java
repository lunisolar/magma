...
public class LShortFunctionXTest<R,X extends ParseException> {
    ...
    private LShortFunctionX<R,ParseException> sutAlwaysThrowing = LShortFunctionX.lX(s -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LShortFunctionX<R,RuntimeException> sutAlwaysThrowingUnckeck = LShortFunctionX.lX(s -> {
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNullDoApply() method cannot be null (LShortFunctionX: R doApply(short s) throws X).\\E")
    ...
    public void testLXMethod() throws X {
        assertThat(LShortFunctionX.lX(s -> testValue ))
...
@Test
    ...
    public void testshortFuncComposeShort() throws X {
        ...
        LShortFunctionX<Integer ,X> sutO = s -> {
