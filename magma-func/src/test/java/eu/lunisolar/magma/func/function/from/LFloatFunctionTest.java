...
public class LFloatFunctionTest<R,X extends ParseException> {
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (LFloatFunction: R apply(float f)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LFloatFunction: R apply(float f)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LFloatFunction.l((float f) -> testValue ))
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        // given
        LFloatFunctionX<R,X> sutThrowing = LFloatFunctionX.lX((float f) -> {
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LFloatFunctionX<R,ParseException> sutThrowing = LFloatFunctionX.lX((float f) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LFloatFunction<R> sutThrowing = LFloatFunction.l((float f) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LFloatFunction<R> wrapped = LFloatFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromFloat() throws ParseException {
        ...
        LFloatFunction<Integer > sutO = (float f) -> {
        ...
        //when
        LFloatFunction<Integer > function = sutO.fromFloat(before1);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LFloatFunction<R> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LFloatFunction: R apply(float f)");
    }
