...
public class ByteToLongFunctionXTest<X extends ParseException> {
    ...
    private ByteToLongFunctionX<X> sut = new ByteToLongFunctionX(){
        public  long applyAsLong(byte b) throws ParseException {
            return testValue;
        }
    };

    private ByteToLongFunction opposite = new ByteToLongFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ByteToLongFunctionX: long applyAsLong(byte b) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(ByteToLongFunctionX.lX((byte b) -> testValue ))
            .isInstanceOf(ByteToLongFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(ByteToLongFunctionX.wrapX(opposite))
            .isInstanceOf(ByteToLongFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        ByteToLongFunctionX<X> wrapped = ByteToLongFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });

        // then
        try {
            wrapped.applyAsLong((byte)100);
    ...
    public void testfromByte() throws ParseException {
        ...
        ByteToLongFunctionX<X> sutO = (byte b) -> {
        ...
        //when
        ByteToLongFunctionX<X> function = sutO.fromByte(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(ByteToLongFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(ByteToLongFunctionX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().applyAsLong((byte)100);
    }
