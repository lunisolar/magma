...
public class LSrtFunctionTest<R> {
    ...
    private LSrtFunction<Integer> sutAlwaysThrowing = LSrtFunction.srtFunc(a -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LSrtFunction<Integer> sutAlwaysThrowingUnchecked = LSrtFunction.srtFunc(a -> {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.apply((short)100), testValue);
    }
    ...
    public void testNonNullApply() throws Throwable {
            Assert.assertSame(sut.nonNullApply((short)100), testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LSrtFunction: R apply(short a)");
    }

    @Test
    public void testSrtFuncMethod() throws Throwable {
        Assert.assertTrue(LSrtFunction.srtFunc(a -> testValue ) instanceof LSrtFunction);
    ...
    @Test
    public void testSrtFuncCompose() throws Throwable {
    ...
    public void testShove() {
        ...
        // given
        LSrtFunction<Integer> sutThrowing = LSrtFunction.srtFunc(a -> {
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LSrtFunction: R apply(short a)"));
