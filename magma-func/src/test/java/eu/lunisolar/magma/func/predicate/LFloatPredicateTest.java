...
public class LFloatPredicateTest<X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LFloatPredicate: boolean doTest(float f)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LFloatPredicate.l((float f) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LFloatPredicateX<ParseException> sutThrowing = LFloatPredicateX.lX((float f) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LFloatPredicate sutThrowing = LFloatPredicate.l((float f) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LFloatPredicate wrapped = LFloatPredicate.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws ParseException {
        ...
        //given
        LFloatPredicate fun1 = LFloatPredicate.l((float f) -> f1Result);
        LFloatPredicate fun2 = LFloatPredicate.l((float f) -> f2Result);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LFloatPredicate wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LFloatPredicate: boolean doTest(float f)");
    }
