...
public class LByteBiConsumerXTest<X extends ParseException> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LByteBiConsumerX<X> wrapped = LByteBiConsumerX.wrapException(sutThrowing, UnsupportedOperationException.class, t -> {
...
//
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LByteBiConsumerX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
