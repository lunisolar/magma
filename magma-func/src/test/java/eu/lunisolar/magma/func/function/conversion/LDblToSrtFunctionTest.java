...
public class LDblToSrtFunctionTest {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.applyAsSrt(100d), testValue);
    }
    ...
    public void testNonNullApplyAsSrt() throws Throwable {
            Assert.assertEquals(sut.nonNullApplyAsSrt(100d), testValue);
    }
    ...
    public void testNestingApplyAsSrtUnchecked() throws Throwable {
        ...
        // then
        try {
            sutAlwaysThrowingUnchecked.nestingApplyAsSrt(100d);
    ...
    public void testShovingApplyAsSrtUnchecked() throws Throwable {
        ...
        // then
        try {
            sutAlwaysThrowingUnchecked.shovingApplyAsSrt(100d);
            Assert.fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            Assert.assertEquals(e.getClass(), IndexOutOfBoundsException.class);
            Assert.assertNull(e.getCause());
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LDblToSrtFunction: short applyAsSrt(double a)");
    }

    @Test
    public void testDblToSrtFuncMethod() throws Throwable {
        Assert.assertTrue(LDblToSrtFunction.dblToSrtFunc(a -> testValue ) instanceof LDblToSrtFunction);
    ...
    public void testCompose() throws Throwable {
        ...
        //when
        LDblToSrtFunction function = sutO.compose(before);
        function.applyAsSrt(80d);
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingApplyAsSrt(100d);
    }
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LDblToSrtFunction: short applyAsSrt(double a)"));
