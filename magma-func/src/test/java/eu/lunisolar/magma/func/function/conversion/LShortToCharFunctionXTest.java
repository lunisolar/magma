...
public class LShortToCharFunctionXTest<X extends ParseException> {
    ...
    private LShortToCharFunctionX<ParseException> sutAlwaysThrowing = LShortToCharFunctionX.lX((short s) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LShortToCharFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LShortToCharFunctionX.lX((short s) -> {
    ...
    @Test
    public void testNestingDoApplyAsChar_checked() throws ParseException {
    ...
    @Test
    public void testShovingDoApplyAsChar_checked() throws ParseException {
    ...
    public void testLXMethod() throws ParseException {
        assertThat(LShortToCharFunctionX.lX((short s) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LShortToCharFunctionX<X> sutThrowing = LShortToCharFunctionX.lX((short s) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LShortToCharFunctionX<X> wrapped = LShortToCharFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromShort() throws ParseException {
        ...
        LShortToCharFunctionX<X> sutO = (short s) -> {
        ...
        //when
        LShortToCharFunctionX<X> function = sutO.fromShort(before1);
...
//
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().doApplyAsChar((short)100);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LShortToCharFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
