...
public class LFltToByteFunctionTest {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.applyAsByte(100f), testValue);
    }
    ...
    public void testNonNullApplyAsByte() throws Throwable {
            Assert.assertEquals(sut.nonNullApplyAsByte(100f), testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LFltToByteFunction: byte applyAsByte(float a)");
    }

    @Test
    public void testFltToByteFuncMethod() throws Throwable {
        Assert.assertTrue(LFltToByteFunction.fltToByteFunc(a -> testValue ) instanceof LFltToByteFunction);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LFltToByteFunction: byte applyAsByte(float a)"));
