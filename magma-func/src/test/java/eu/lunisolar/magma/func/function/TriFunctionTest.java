...
public class TriFunctionTest<T1,T2,T3,R,X extends ParseException> {
    ...
    private TriFunction<T1,T2,T3,R> sut = new TriFunction(){
        public @Nullable Object  apply(Object t1,Object t2,Object t3)  {
            return testValue;
        }
    };

    private TriFunctionX<T1,T2,T3,R,X> opposite = new TriFunctionX(){
        public @Nullable Object  apply(Object t1,Object t2,Object t3) throws ParseException {
            return testValue;
        }
    };

    private TriFunction<T1,T2,T3,R> sutNull = new TriFunction(){
        public @Nullable Object  apply(Object t1,Object t2,Object t3)  {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (TriFunction: R apply(T1 t1,T2 t2,T3 t3)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("TriFunction: R apply(T1 t1,T2 t2,T3 t3)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(TriFunction.l((Object t1,Object t2,Object t3) -> testValue ))
            .isInstanceOf(TriFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(TriFunction.wrap(opposite))
            .isInstanceOf(TriFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        TriFunction<T1,T2,T3,R> wrapped = TriFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        TriFunctionX<T1,T2,T3,R,ParseException> sutThrowing = TriFunctionX.lX((T1 t1,T2 t2,T3 t3) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        TriFunction<T1,T2,T3,R> sutThrowing = TriFunction.l((T1 t1,T2 t2,T3 t3) -> {
            throw new UnsupportedOperationException();
        });

        // when
        TriFunction<T1,T2,T3,R> wrapped = TriFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfrom() throws ParseException {
        ...
        TriFunction<Integer ,Integer ,Integer ,Integer > sutO = (Integer t1,Integer t2,Integer t3) -> {
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        TriConsumer<Integer ,Integer ,Integer > function = sutO.then(thenFunction);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(TriFunction.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        TriFunction<T1,T2,T3,R> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
