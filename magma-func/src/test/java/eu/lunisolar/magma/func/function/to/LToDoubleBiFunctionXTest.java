...
public class LToDoubleBiFunctionXTest<T1,T2,X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LToDoubleBiFunctionX: double applyAsDouble(T1 t1,T2 t2) throws X");
    }
    ...
    public void testWrapStdMethod() throws ParseException {
        assertThat(LToDoubleBiFunctionX.wrapStd(jre))
            .isInstanceOf(LToDoubleBiFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LToDoubleBiFunctionX<T1,T2,X> wrapped = LToDoubleBiFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LToDoubleBiFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LToDoubleBiFunctionX.class);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LToDoubleBiFunctionX<T1,T2,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LToDoubleBiFunctionX: double applyAsDouble(T1 t1,T2 t2) throws X");
    }
