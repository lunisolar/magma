...
public class LSupplierXTest<R,X extends ParseException> {
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (LSupplierX: R get() throws X).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LSupplierX: R get() throws X");
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LSupplierX<R,X> wrapped = LSupplierX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        LActionX<X> function = sutO.then(thenFunction);
        function.execute();
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LSupplierX<R,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LSupplierX: R get() throws X");
    }
