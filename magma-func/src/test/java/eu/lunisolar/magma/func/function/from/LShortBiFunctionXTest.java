...
public class LShortBiFunctionXTest<R,X extends ParseException> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LShortBiFunctionX<R,X> wrapped = LShortBiFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromShort() throws ParseException {
        ...
        //when
        LShortBiFunctionX<Integer ,X> function = sutO.fromShort(before1,before2);
...
//
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LShortBiFunctionX<R,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
