...
public class LByteToDoubleFunctionXTest<X extends ParseException> {
    ...
    private LByteToDoubleFunctionX<ParseException> sutAlwaysThrowing = LByteToDoubleFunctionX.lX((byte b) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LByteToDoubleFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LByteToDoubleFunctionX.lX((byte b) -> {
    ...
    public void testLXMethod() throws ParseException {
        assertThat(LByteToDoubleFunctionX.lX((byte b) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LByteToDoubleFunctionX<X> sutThrowing = LByteToDoubleFunctionX.lX((byte b) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LByteToDoubleFunctionX<X> wrapped = LByteToDoubleFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        LByteToDoubleFunctionX<X> sutO = (byte b) -> {
        ...
        //when
        LByteToDoubleFunctionX<X> function = sutO.fromByte(before1);
...
//
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().doApplyAsDouble((byte)100);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LByteToDoubleFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
