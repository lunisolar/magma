...
public class LByteToDoubleFunctionXTest<X extends ParseException> {
    ...
    private LByteToDoubleFunctionX<X> sut = new LByteToDoubleFunctionX(){
        public  double doApplyAsDouble(byte b) throws ParseException {
            return testValue;
        }
    };
    ...
    private LByteToDoubleFunctionX<ParseException> sutAlwaysThrowing = LByteToDoubleFunctionX.lX(b -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LByteToDoubleFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LByteToDoubleFunctionX.lX(b -> {
    ...
    public void testNestingDoApplyAsDoubleUnckeck() throws X {
        ...
        // then
        try {
            sutAlwaysThrowingUnckeck.nestingDoApplyAsDouble((byte)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testShovingDoApplyAsDoubleUnckeck() throws X {
        ...
        // then
        try {
            sutAlwaysThrowingUnckeck.shovingDoApplyAsDouble((byte)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
                    .isExactlyInstanceOf(IndexOutOfBoundsException.class)
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LByteToDoubleFunctionX: double doApplyAsDouble(byte b) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LByteToDoubleFunctionX.lX(b -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LByteToDoubleFunctionX<X> sutThrowing = LByteToDoubleFunctionX.lX(b -> {
            throw new UnsupportedOperationException();
        });

        // when
        LByteToDoubleFunctionX<X> wrapped = sutThrowing.handleBToDFuncX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LByteToDoubleFunctionX<X> wrapped = sutThrowing.handleBToDFuncX(h -> Function4U.doNothing());
    ...
    @Test
    public void testbToDFuncFromByte() throws X {

        final ThreadLocal<Boolean> mainFunctionCalled = ThreadLocal.withInitial(()-> false);
        final AtomicInteger beforeCalls = new AtomicInteger(0);

        //given (+ some assertions)
        LByteToDoubleFunctionX<X> sutO = b -> {
        ...
        //when
        LByteToDoubleFunctionX<X> function = sutO.bToDFuncFromByte(before1);
    ...
    @Test
    public void testbToDFuncFrom() throws X {
        ...
        //when
        LToDoubleFunctionX<Integer ,X> function = sutO.bToDFuncFrom(before1);
    ...
    public void testNesting() {
        assertThat(sut.nestingBToDFunc())
            .isInstanceOf(LByteToDoubleFunction.class);
    }

    @Test
    public void testShoving() {
        assertThat(sut.shovingBToDFunc())
            .isInstanceOf(LByteToDoubleFunction.class);
    }

    @Test
    public void testNestingX() {
        assertThat(sut.nestingBToDFuncX())
            .isInstanceOf(LByteToDoubleFunctionX.class);
    }

    @Test
    public void testShovingX() {
        assertThat(sut.shovingBToDFuncX())
            .isInstanceOf(LByteToDoubleFunctionX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingBToDFunc().doApplyAsDouble((byte)100);
    }

    @Test
    public void testHandleBToDFunc() throws X {
        ...
        // when
        LByteToDoubleFunctionX<X> wrapped = sutThrowing.handleBToDFuncX(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LByteToDoubleFunctionX: double doApplyAsDouble(byte b) throws X");
    }
