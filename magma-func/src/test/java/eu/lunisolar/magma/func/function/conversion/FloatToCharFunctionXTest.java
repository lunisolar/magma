...
public class FloatToCharFunctionXTest<X extends ParseException> {
    ...
    private FloatToCharFunctionX<X> sut = new FloatToCharFunctionX(){
        public  char applyAsChar(float f) throws ParseException {
            return testValue;
        }
    };

    private FloatToCharFunction opposite = new FloatToCharFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("FloatToCharFunctionX: char applyAsChar(float f) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(FloatToCharFunctionX.lX((float f) -> testValue ))
            .isInstanceOf(FloatToCharFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(FloatToCharFunctionX.wrapX(opposite))
            .isInstanceOf(FloatToCharFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        FloatToCharFunctionX<X> wrapped = FloatToCharFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromFloat() throws ParseException {
        ...
        FloatToCharFunctionX<X> sutO = (float f) -> {
        ...
        //when
        FloatToCharFunctionX<X> function = sutO.fromFloat(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        FloatToCharFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("FloatToCharFunctionX: char applyAsChar(float f) throws X");
    }
