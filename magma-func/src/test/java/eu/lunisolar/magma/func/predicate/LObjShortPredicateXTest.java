...
public class LObjShortPredicateXTest<T,X extends ParseException> {
    ...
    private LObjShortPredicateX<Integer,X> sut = new LObjShortPredicateX<Integer,X>(){
        public  boolean doTest(Integer a1,short a2)  throws X {
            return testValue;
        }
    };

    private LObjShortPredicate<Integer> opposite = new LObjShortPredicate<Integer>(){
    ...
    private LObjShortPredicateX<Integer,ParseException> sutAlwaysThrowing = LObjShortPredicateX.lX((a1,a2) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LObjShortPredicateX<Integer,RuntimeException> sutAlwaysThrowingUnchecked = LObjShortPredicateX.lX((a1,a2) -> {
    ...
    public void testNestingDoTestChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoTest(100,(short)100);
    ...
    public void testShovingDoTestChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoTest(100,(short)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testLXMethod() throws X {
        assertThat(LObjShortPredicateX.lX((a1,a2) -> testValue ))
    ...
    public void testHandlingDoTestMethodWrapsTheException() throws X {
        ...
        // when
        LObjShortPredicateX<Integer,RuntimeException> wrapped = sutThrowing.handleObjShortPredX(handler -> handler
    ...
    @Test
    public void testHandleObjShortPredXMethodDoNotWrapsOtherExceptionIf() throws X {
        ...
        // when
        LObjShortPredicateX<Integer,X> wrapped = sutThrowing.handleObjShortPredX(handler -> handler
                .wrapIf(UnsupportedOperationException.class::isInstance,IllegalArgumentException::new,  EXCEPTION_WAS_WRAPPED)
...
@Test
    public void testHandleObjShortPredXMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleObjShortPredXMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LObjShortPredicateX<Integer,X> wrapped = sutThrowing.handleObjShortPredX(h -> Function4U.doNothing());
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws X {
        ...
        //given
        LObjShortPredicateX<Integer,X> fun1 = LObjShortPredicateX.lX((a1,a2) -> f1Result);
        LObjShortPredicateX<Integer,X> fun2 = LObjShortPredicateX.lX((a1,a2) -> f2Result);

        //when
        LObjShortPredicateX<Integer,X> andFunction = fun1.and(fun2);
        LObjShortPredicateX<Integer,X> orFunction = fun1.or(fun2);
        LObjShortPredicateX<Integer,X> xorFunction = fun1.xor(fun2);
    ...
    public void testIsEqual() throws X  {
        //when
        LObjShortPredicateX<Integer,X> equals = LObjShortPredicateX.isEqual(1,(short)1);
    ...
    public void testObjShortPredComposeShort() throws X {
        ...
        LObjShortPredicateX<Integer,X> sutO = (a1,a2) -> {
    ...
    public void testBoolToObjShortFunc0() throws X  {
        ...
        //when
        LObjShortFunctionX<Integer,Integer,X> function = sutO.boolToObjShortFunc(thenFunction);
    ...
    public void testHandleObjShortPred() throws X {
        ...
        // when
        LObjShortPredicateX<Integer,X> wrapped = sutThrowing.handleObjShortPredX(h -> {
    ...
    public void compilerSubstituteVariantV1() {
        LObjShortPredicateX lambda = LObjShortPredicateX./*<T,X>*/lX1(this::variantV1);
    ...
    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LObjShortPredicateX<Integer,X>,Y> supplier = ()->sut;
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LObjShortPredicateX<Integer,X>,Y> r1 = LObjShortPredicateX.safeSupplier(()->sut);  //NOSONAR
    }
