...
public class LBooleanToIntFunctionTest<X extends ParseException> {
    ...
    public void testLMethod() throws ParseException {
        assertThat(LBooleanToIntFunction.l((boolean b) -> testValue ))
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        // given
        LBooleanToIntFunctionX<X> sutThrowing = LBooleanToIntFunctionX.lX((boolean b) -> {
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LBooleanToIntFunctionX<ParseException> sutThrowing = LBooleanToIntFunctionX.lX((boolean b) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LBooleanToIntFunction sutThrowing = LBooleanToIntFunction.l((boolean b) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LBooleanToIntFunction wrapped = LBooleanToIntFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromBoolean() throws ParseException {
        ...
        LBooleanToIntFunction sutO = (boolean b) -> {
        ...
        //when
        LBooleanToIntFunction function = sutO.fromBoolean(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LBooleanToIntFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LBooleanToIntFunctionX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().doApplyAsInt(true);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LBooleanToIntFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
