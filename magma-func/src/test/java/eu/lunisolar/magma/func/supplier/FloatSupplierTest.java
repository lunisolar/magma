...
public class FloatSupplierTest<X extends ParseException> {
    ...
    private FloatSupplier sut = new FloatSupplier(){
        public  float getAsFloat()  {
            return testValue;
        }
    };

    private FloatSupplierX<X> opposite = new FloatSupplierX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("FloatSupplier: float getAsFloat()");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(FloatSupplier.l(() -> testValue ))
            .isInstanceOf(FloatSupplier.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(FloatSupplier.wrap(opposite))
            .isInstanceOf(FloatSupplier.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        FloatSupplier wrapped = FloatSupplier.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        FloatSupplierX<ParseException> sutThrowing = FloatSupplierX.lX(() -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        FloatSupplier sutThrowing = FloatSupplier.l(() -> {
            throw new UnsupportedOperationException();
        });

        // when
        FloatSupplier wrapped = FloatSupplier.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        FloatSupplier wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("FloatSupplier: float getAsFloat()");
    }
