...
public class LCharToDblFunctionTest {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.applyAsDbl('\u0100'), testValue);
    }
    ...
    public void testNonNullApplyAsDbl() throws Throwable {
            Assert.assertEquals(sut.nonNullApplyAsDbl('\u0100'), testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LCharToDblFunction: double applyAsDbl(char a)");
    }

    @Test
    public void testCharToDblFuncMethod() throws Throwable {
        Assert.assertTrue(LCharToDblFunction.charToDblFunc(a -> testValue ) instanceof LCharToDblFunction);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LCharToDblFunction: double applyAsDbl(char a)"));
