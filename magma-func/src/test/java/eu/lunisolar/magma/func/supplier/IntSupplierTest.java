...
public class IntSupplierTest<X extends ParseException> {
    ...
    private IntSupplier sut = new IntSupplier(){
        public  int getAsInt()  {
            return testValue;
        }
    };

    private IntSupplierX<X> opposite = new IntSupplierX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("IntSupplier: int getAsInt()");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(IntSupplier.l(() -> testValue ))
            .isInstanceOf(IntSupplier.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(IntSupplier.wrap(opposite))
            .isInstanceOf(IntSupplier.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        IntSupplier wrapped = IntSupplier.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        IntSupplierX<ParseException> sutThrowing = IntSupplierX.lX(() -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        IntSupplier sutThrowing = IntSupplier.l(() -> {
            throw new UnsupportedOperationException();
        });

        // when
        IntSupplier wrapped = IntSupplier.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        IntSupplier wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("IntSupplier: int getAsInt()");
    }
