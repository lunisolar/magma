...
public class LTieIntFunctionTest<T> {
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LTieIntFunction: int applyAsInt(T a1,int a2,int a3)");
    }

    @Test
    public void testTieIntFuncMethod() throws Throwable {
        Assert.assertTrue(LTieIntFunction.tieIntFunc((a1,a2,a3) -> testValue ) instanceof LTieIntFunction);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LTieIntFunction: int applyAsInt(T a1,int a2,int a3)"));
    ...
    public void compilerSubstituteVariantLObj0Int2Int1ToIntFunc() {
        ...
        Assert.assertTrue(lambda instanceof LTieIntFunction.LObj0Int2Int1ToIntFunc);
    }
    ...
    public void compilerSubstituteVariantLInt1Obj0Int2ToIntFunc() {
        ...
        Assert.assertTrue(lambda instanceof LTieIntFunction.LInt1Obj0Int2ToIntFunc);
    }
    ...
    public void compilerSubstituteVariantLInt1Int2Obj0ToIntFunc() {
        ...
        Assert.assertTrue(lambda instanceof LTieIntFunction.LInt1Int2Obj0ToIntFunc);
    }
    ...
    public void compilerSubstituteVariantLInt2Obj0Int1ToIntFunc() {
        ...
        Assert.assertTrue(lambda instanceof LTieIntFunction.LInt2Obj0Int1ToIntFunc);
    }
    ...
    public void compilerSubstituteVariantLBiInt1Obj0ToIntFunc() {
        ...
        Assert.assertTrue(lambda instanceof LTieIntFunction.LBiInt1Obj0ToIntFunc);
    }
