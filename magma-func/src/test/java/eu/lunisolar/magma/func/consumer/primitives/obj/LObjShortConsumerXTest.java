...
public class LObjShortConsumerXTest<T,X extends ParseException> {
    ...
    private LObjShortConsumerX<T,ParseException> sutAlwaysThrowing = LObjShortConsumerX.lX((T a1,short a2) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LObjShortConsumerX<T,RuntimeException> sutAlwaysThrowingUnckeck = LObjShortConsumerX.lX((T a1,short a2) -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LObjShortPair<T>,LTuple.Void,X> theCall = sut;
    ...
    public void testLXMethod() throws X {
        assertThat(LObjShortConsumerX.lX((Object a1,short a2) -> Function4U.doNothing() ))
...
@Test
    ...
    public void testAndThen() throws X {
        ...
        LObjShortConsumerX<Integer ,X> thenFunction = (Integer a1,short a2) -> {
    ...
    public void compilerSubstituteVariant1() {
        LObjShortConsumerX lambda = LObjShortConsumerX./*<T,X>*/lX1(this::variant1);
    ...
    @Test void safeCompiles() {
        LObjShortConsumerX r1 = LObjShortConsumerX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LObjShortConsumerX<T,X>,Y> supplier = ()->sut;
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LObjShortConsumerX<T,X>,Y> r1 = LObjShortConsumerX.safeSupplier(()->sut);
    }
