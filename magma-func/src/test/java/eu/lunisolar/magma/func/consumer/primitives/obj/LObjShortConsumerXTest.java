...
public class LObjShortConsumerXTest<T,X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LObjShortConsumerX: void accept(T t, short s) throws X");
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LObjShortConsumerX<T,X> wrapped = LObjShortConsumerX.wrapException(sutThrowing, UnsupportedOperationException.class, t -> {
    ...
    public void testfromShort() throws ParseException {
        ...
        //when
        LObjShortConsumerX<Integer ,X> function = sutO.fromShort(before1,before2);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LObjShortConsumer.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LObjShortConsumerX.class);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LObjShortConsumerX<T,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LObjShortConsumerX: void accept(T t, short s) throws X");
    }
