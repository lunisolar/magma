...
public class ObjLongPredicateXTest<T,X extends ParseException> {
    ...
    private ObjLongPredicateX<T,X> sut = new ObjLongPredicateX(){
        public  boolean test(Object t, long l) throws ParseException {
            return testValue;
        }
    };

    private ObjLongPredicate<T> opposite = new ObjLongPredicate(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ObjLongPredicateX: boolean test(T t, long l) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(ObjLongPredicateX.lX((Object t, long l) -> testValue ))
            .isInstanceOf(ObjLongPredicateX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(ObjLongPredicateX.wrapX(opposite))
            .isInstanceOf(ObjLongPredicateX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        ObjLongPredicateX<T,X> wrapped = ObjLongPredicateX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws ParseException {
        ...
        //given
        ObjLongPredicateX<T,X> fun1 = ObjLongPredicateX.lX((T t, long l) -> f1Result);
        ObjLongPredicateX<T,X> fun2 = ObjLongPredicateX.lX((T t, long l) -> f2Result);

        //when
        ObjLongPredicateX<T,X> andFunction = fun1.and(fun2);
        ObjLongPredicateX<T,X> orFunction = fun1.or(fun2);
        ObjLongPredicateX<T,X> xorFunction = fun1.xor(fun2);
    ...
    public void isEqual() throws ParseException  {
        //when
        ObjLongPredicateX<T,X> equals = ObjLongPredicateX.isEqual((T)Integer.valueOf(100),(long)100);
    ...
    public void testfromLong() throws ParseException {
        ...
        ObjLongPredicateX<Integer ,X> sutO = (Integer t, long l) -> {
        ...
        //when
        ObjLongPredicateX<Integer ,X> function = sutO.fromLong(before1,before2);
    ...
    public void testThen0() throws ParseException  {
        ...
        //when
        ObjLongFunctionX<Integer ,Integer ,X> function = sutO.then(thenFunction);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        ObjLongPredicateX<T,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ObjLongPredicateX: boolean test(T t, long l) throws X");
    }
