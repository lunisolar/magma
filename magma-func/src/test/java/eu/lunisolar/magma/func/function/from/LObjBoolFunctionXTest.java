...
public class LObjBoolFunctionXTest<T,R,X extends ParseException> {
    ...
    private LObjBoolFunctionX<T,R,X> sut = new LObjBoolFunctionX(){
        public @Nullable Object  doApply(Object t, boolean b) throws ParseException {
            return testValue;
        }
    };

    private LObjBoolFunction<T,R> opposite = new LObjBoolFunction(){
        public @Nullable Object  doApply(Object t, boolean b)  {
            return testValue;
        }
    };

    private LObjBoolFunctionX<T,R,X> sutNull = new LObjBoolFunctionX(){
        public @Nullable Object  doApply(Object t, boolean b) throws ParseException {
            return null;
        }
    };
    ...
    private LObjBoolFunctionX<T,R,ParseException> sutAlwaysThrowing = LObjBoolFunctionX.lX((T t, boolean b) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LObjBoolFunctionX<T,R,RuntimeException> sutAlwaysThrowingUnckeck = LObjBoolFunctionX.lX((T t, boolean b) -> {
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNullDoApply() method cannot be null (LObjBoolFunctionX: R doApply(T t, boolean b) throws X).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LObjBoolFunctionX: R doApply(T t, boolean b) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LObjBoolFunctionX.lX((Object t, boolean b) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LObjBoolFunctionX<T,R,X> sutThrowing = LObjBoolFunctionX.lX((T t, boolean b) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LObjBoolFunctionX<T,R,X> wrapped = sutThrowing.handleObjBoolFuncX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LObjBoolFunctionX<T,R,X> wrapped = sutThrowing.handleObjBoolFuncX(h -> Function4U.doNothing());
    ...
    public void testobjBoolFuncComposeBoolean() throws X {
        ...
        LObjBoolFunctionX<Integer ,Integer ,X> sutO = (Integer t, boolean b) -> {
        ...
        //when
        LObjBoolFunctionX<Integer ,Integer ,X> function = sutO.objBoolFuncComposeBoolean(before1,before2);
    ...
    public void testHandleObjBoolFunc() throws X {
        ...
        // when
        LObjBoolFunctionX<T,R,X> wrapped = sutThrowing.handleObjBoolFuncX(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LObjBoolFunctionX: R doApply(T t, boolean b) throws X");
    }
