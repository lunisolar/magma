...
public class LObjBoolFunctionXTest<T,R,X extends ParseException> {
    ...
    private LObjBoolFunctionX<T,R,ParseException> sutAlwaysThrowing = LObjBoolFunctionX.lX((T a1,boolean a2) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LObjBoolFunctionX<T,R,RuntimeException> sutAlwaysThrowingUnckeck = LObjBoolFunctionX.lX((T a1,boolean a2) -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LObjBoolPair<T>,R,X> theCall = sut;
    ...
    public void testLXMethod() throws X {
        assertThat(LObjBoolFunctionX.lX((Object a1,boolean a2) -> testValue ))
...
@Test
    ...
    public void testobjBoolFuncComposeBoolean() throws X {
        ...
        LObjBoolFunctionX<Integer ,Integer ,X> sutO = (Integer a1,boolean a2) -> {
    ...
    public void compilerSubstituteVariant1() {
        LObjBoolFunctionX lambda = LObjBoolFunctionX./*<T,R,X>*/lX1(this::variant1);
    ...
    @Test void safeCompiles() {
        LObjBoolFunctionX r1 = LObjBoolFunctionX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LObjBoolFunctionX<T,R,X>,Y> supplier = ()->sut;
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LObjBoolFunctionX<T,R,X>,Y> r1 = LObjBoolFunctionX.safeSupplier(()->sut);
    }
