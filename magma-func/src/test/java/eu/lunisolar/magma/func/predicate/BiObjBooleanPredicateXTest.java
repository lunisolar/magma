...
public class BiObjBooleanPredicateXTest<T1,T2,X extends ParseException> {
    ...
    private BiObjBooleanPredicateX<T1,T2,X> sut = new BiObjBooleanPredicateX(){
        public  boolean test(Object t1,Object t2, boolean b) throws ParseException {
            return testValue;
        }
    };

    private BiObjBooleanPredicate<T1,T2> opposite = new BiObjBooleanPredicate(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BiObjBooleanPredicateX: boolean test(T1 t1,T2 t2, boolean b) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(BiObjBooleanPredicateX.lX((Object t1,Object t2, boolean b) -> testValue ))
            .isInstanceOf(BiObjBooleanPredicateX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(BiObjBooleanPredicateX.wrapX(opposite))
            .isInstanceOf(BiObjBooleanPredicateX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        BiObjBooleanPredicateX<T1,T2,X> wrapped = BiObjBooleanPredicateX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws ParseException {
        ...
        //given
        BiObjBooleanPredicateX<T1,T2,X> fun1 = BiObjBooleanPredicateX.lX((T1 t1,T2 t2, boolean b) -> f1Result);
        BiObjBooleanPredicateX<T1,T2,X> fun2 = BiObjBooleanPredicateX.lX((T1 t1,T2 t2, boolean b) -> f2Result);

        //when
        BiObjBooleanPredicateX<T1,T2,X> andFunction = fun1.and(fun2);
        BiObjBooleanPredicateX<T1,T2,X> orFunction = fun1.or(fun2);
        BiObjBooleanPredicateX<T1,T2,X> xorFunction = fun1.xor(fun2);
    ...
    public void isEqual() throws ParseException  {
        //when
        BiObjBooleanPredicateX<T1,T2,X> equals = BiObjBooleanPredicateX.isEqual((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),true);
    ...
    public void testfromBoolean() throws ParseException {
        ...
        BiObjBooleanPredicateX<Integer ,Integer ,X> sutO = (Integer t1,Integer t2, boolean b) -> {
        ...
        //when
        BiObjBooleanPredicateX<Integer ,Integer ,X> function = sutO.fromBoolean(before1,before2,before3);
    ...
    public void testThen0() throws ParseException  {
        ...
        //when
        BiObjBooleanFunctionX<Integer ,Integer ,Integer ,X> function = sutO.then(thenFunction);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        BiObjBooleanPredicateX<T1,T2,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BiObjBooleanPredicateX: boolean test(T1 t1,T2 t2, boolean b) throws X");
    }
