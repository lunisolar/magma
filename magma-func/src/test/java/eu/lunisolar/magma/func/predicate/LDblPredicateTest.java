...
public class LDblPredicateTest {
    ...
    private LDblPredicate sut = new LDblPredicate(){
        public  boolean doTestX(double a)  {
            return testValue;
        }
    };
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LDblPredicate: boolean doTest(double a)");
    }

    @Test
    public void testDblPredMethod() throws Throwable {
        assertThat(LDblPredicate.dblPred(a -> testValue ))
            .isInstanceOf(LDblPredicate.class);
    }


    @Test
    public void testWrapStdMethod() throws Throwable {
        assertThat(LDblPredicate.wrap(jre))
            .isInstanceOf(LDblPredicate.class);
    }
    ...
    @Test
    public void testDblPredComposeDbl() throws Throwable {
        ...
        //when
        LDblPredicate function = sutO.dblPredComposeDbl(before);
        function.doTest(80d);
    ...
    @Test
    public void testDblPredCompose() throws Throwable {
        ...
        //when
        LPredicate<Integer> function = sutO.dblPredCompose(before);
        function.doTest(80);
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingDblPred().doTest(100d);
    }
    ...
    public void testToString() throws Throwable {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LDblPredicate: boolean doTest(double a)");
    }
    ...
    @Test void safeCompiles() {
        LDblPredicate r1 = LDblPredicate.safe(sut); //NOSONAR
        DoublePredicate r3 = LDblPredicate.safe(sut); //NOSONAR
    }

    @Test void safePropagates() {
        Object result = LDblPredicate.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LDblPredicate.safe(null);
        assertThat(result).isSameAs(LDblPredicate.dblPred(LDblPredicate.safe()));
    }

    @Test  void safeSupplierPropagates() {
        LSupplier<LDblPredicate> supplier = ()->sut;
        Object result = LDblPredicate.safeSupplier(supplier);
        assertThat(result).isSameAs(supplier);
    }

    @Test  void safeSupplierProtectsAgainstNpe() {
        Object result = LDblPredicate.safeSupplier(null);
        assertThat(result).isSameAs(LDblPredicate.safeSupplier());
    }

    @Test  void safeSupplierCompiles() {
        LSupplier<LDblPredicate> r1 = LDblPredicate.safeSupplier(()->sut);  //NOSONAR
        Supplier<LDblPredicate> r2 = LDblPredicate.safeSupplier(()->sut); //NOSONAR
    }
