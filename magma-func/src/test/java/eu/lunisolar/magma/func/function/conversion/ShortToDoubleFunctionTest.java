...
public class ShortToDoubleFunctionTest<X extends ParseException> {
    ...
    private ShortToDoubleFunction sut = new ShortToDoubleFunction(){
        public  double applyAsDouble(short s)  {
            return testValue;
        }
    };

    private ShortToDoubleFunctionX<X> opposite = new ShortToDoubleFunctionX(){
        public  double applyAsDouble(short s) throws ParseException {
            return testValue;
        }
    };
    ...
    public void testTheResult() throws ParseException {
        assertThat(sut.applyAsDouble((short)100))
            .isEqualTo(testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ShortToDoubleFunction: double applyAsDouble(short s)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(ShortToDoubleFunction.l((short s) -> testValue ))
            .isInstanceOf(ShortToDoubleFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(ShortToDoubleFunction.wrap(opposite))
            .isInstanceOf(ShortToDoubleFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        // given
        ShortToDoubleFunctionX<X> sutThrowing = ShortToDoubleFunctionX.lX((short s) -> {
            throw new UnsupportedOperationException(ORIGINAL_MESSAGE);
        });

        // when
        ShortToDoubleFunction wrapped = ShortToDoubleFunction.wrap(sutThrowing);

        // then
        try {
            wrapped.applyAsDouble((short)100);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        ShortToDoubleFunctionX<ParseException> sutThrowing = ShortToDoubleFunctionX.lX((short s) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        ShortToDoubleFunction sutThrowing = ShortToDoubleFunction.l((short s) -> {
            throw new UnsupportedOperationException();
        });

        // when
        ShortToDoubleFunction wrapped = ShortToDoubleFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromShort() throws ParseException {
        ...
        ShortToDoubleFunction sutO = (short s) -> {
        ...
        //when
        ShortToDoubleFunction function = sutO.fromShort(before1);
        function.applyAsDouble((short)80);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(ShortToDoubleFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(ShortToDoubleFunctionX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().applyAsDouble((short)100);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ShortToDoubleFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ShortToDoubleFunction: double applyAsDouble(short s)");
    }
