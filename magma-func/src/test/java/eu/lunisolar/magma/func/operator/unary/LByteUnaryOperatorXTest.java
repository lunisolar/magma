...
public class LByteUnaryOperatorXTest<X extends ParseException> {
    ...
    private LByteUnaryOperatorX<X> sut = new LByteUnaryOperatorX(){
        public  byte doApplyAsByte(byte a1) throws ParseException {
            return testValue;
        }
    };
    ...
    private LByteUnaryOperatorX<RuntimeException> sutAlwaysThrowingUnckeck = LByteUnaryOperatorX.lX(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LByteSingle,Byte,X> theCall = sut;
    ...
    public void testNestingDoApplyAsByteUnckeck() throws X {
        ...
        // then
        try {
            sutAlwaysThrowingUnckeck.nestingDoApplyAsByte((byte)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testShovingDoApplyAsByteUnckeck() throws X {
        ...
        // then
        try {
            sutAlwaysThrowingUnckeck.shovingDoApplyAsByte((byte)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
                    .isExactlyInstanceOf(IndexOutOfBoundsException.class)
...
@Test
    ...
    public void identity() throws X {
        ...
        assertThat(identityFunction.doApplyAsByte((byte)80)).isEqualTo((byte)80);
    }
    ...
    @Test void safeCompiles() {
        LByteUnaryOperatorX r1 = LByteUnaryOperatorX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LByteUnaryOperatorX<X>,Y> r1 = LByteUnaryOperatorX.safeSupplier(()->sut);
    }
