...
public class LByteUnaryOperatorXTest<X extends ParseException> {
    ...
    private LByteUnaryOperatorX<X> sut = new LByteUnaryOperatorX(){
        public  byte doApplyAsByte(byte b) throws ParseException {
            return testValue;
        }
    };
    ...
    private LByteUnaryOperatorX<ParseException> sutAlwaysThrowing = LByteUnaryOperatorX.lX((byte b) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LByteUnaryOperatorX<RuntimeException> sutAlwaysThrowingUnckeck = LByteUnaryOperatorX.lX((byte b) -> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LByteUnaryOperatorX: byte doApplyAsByte(byte b) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(LByteUnaryOperatorX.lX((byte b) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LByteUnaryOperatorX<X> sutThrowing = LByteUnaryOperatorX.lX((byte b) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LByteUnaryOperatorX<X> wrapped = LByteUnaryOperatorX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        LByteUnaryOperatorX<X> sutO = (byte b) -> {
        ...
        //when
        LByteUnaryOperatorX<X> function = sutO.fromByte(before1);
...
//
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().doApplyAsByte((byte)100);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LByteUnaryOperatorX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LByteUnaryOperatorX: byte doApplyAsByte(byte b) throws X");
    }
