...
public class LByteUnaryOperatorXTest<X extends ParseException> {
    ...
    private LByteUnaryOperatorX<X> sut = new LByteUnaryOperatorX<X>(){
        public  byte doApplyAsByte(byte a1)  throws X {
            return testValue;
        }
    };

    private LByteUnaryOperator opposite = new LByteUnaryOperator(){
    ...
    private LByteUnaryOperatorX<ParseException> sutAlwaysThrowing = LByteUnaryOperatorX.lX(a1 -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LByteUnaryOperatorX<RuntimeException> sutAlwaysThrowingUnchecked = LByteUnaryOperatorX.lX(a1 -> {
    ...
    public void testNestingDoApplyAsByteChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoApplyAsByte((byte)100);
    ...
    public void testShovingDoApplyAsByteChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoApplyAsByte((byte)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LByteUnaryOperatorX: byte doApplyAsByte(byte a1) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LByteUnaryOperatorX.lX(a1 -> testValue ))
            .isInstanceOf(LByteUnaryOperatorX.class);
    }

    @Test
    public void testWrapXMethod() throws X {
        assertThat(LByteUnaryOperatorX.wrapX(opposite))
            .isInstanceOf(LByteUnaryOperatorX.class);
    }
    ...
    public void testHandlingDoApplyAsByteMethodWrapsTheException() throws X {
        ...
        // given
        LByteUnaryOperatorX<X> sutThrowing = LByteUnaryOperatorX.lX(a1 -> {
            throw new UnsupportedOperationException();
        });

        // when
        LByteUnaryOperatorX<RuntimeException> wrapped = sutThrowing.handleByteUnaryOpX(handler -> handler
    ...
    @Test
    public void testHandleByteUnaryOpXMethodDoNotWrapsOtherExceptionIf() throws X {
        ...
        // when
        LByteUnaryOperatorX<X> wrapped = sutThrowing.handleByteUnaryOpX(handler -> handler
                .wrapIf(UnsupportedOperationException.class::isInstance,IllegalArgumentException::new,  EXCEPTION_WAS_WRAPPED)
...
@Test
    public void testHandleByteUnaryOpXMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleByteUnaryOpXMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LByteUnaryOperatorX<X> wrapped = sutThrowing.handleByteUnaryOpX(h -> Function4U.doNothing());
    ...
    public void testByteUnaryOpComposeByte() throws X {
        ...
        //when
        LByteUnaryOperatorX<X> function = sutO.byteUnaryOpComposeByte(before1);
    ...
    public void testByteUnaryOpCompose() throws X {
        ...
        //when
        LToByteFunctionX<Integer,X> function = sutO.byteUnaryOpCompose(before1);
    ...
    public void identity() throws X {
        LByteUnaryOperatorX<X> identityFunction = LByteUnaryOperatorX.identity();
    ...
    public void testHandleByteUnaryOp() throws X {
        ...
        // when
        LByteUnaryOperatorX<X> wrapped = sutThrowing.handleByteUnaryOpX(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LByteUnaryOperatorX: byte doApplyAsByte(byte a1) throws X");
    }
    ...
    @Test void safeCompiles() {
        LByteUnaryOperatorX r1 = LByteUnaryOperatorX.safe(sut); //NOSONAR
    }

    @Test void safePropagates() {
        Object result = LByteUnaryOperatorX.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LByteUnaryOperatorX.safe(null);
        assertThat(result).isSameAs(LByteUnaryOperatorX.lX(LByteUnaryOperatorX.safe()));
    }

    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LByteUnaryOperatorX<X>,Y> supplier = ()->sut;
        Object result = LByteUnaryOperatorX.safeSupplier(supplier);
        assertThat(result).isSameAs(supplier);
    }

    @Test <Y extends Throwable> void safeSupplierProtectsAgainstNpe() {
        Object result = LByteUnaryOperatorX.safeSupplier(null);
        assertThat(result).isSameAs(LByteUnaryOperatorX.safeSupplier());
    }

    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LByteUnaryOperatorX<X>,Y> r1 = LByteUnaryOperatorX.safeSupplier(()->sut);  //NOSONAR
    }
