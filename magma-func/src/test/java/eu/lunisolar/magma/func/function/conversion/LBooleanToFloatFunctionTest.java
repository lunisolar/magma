...
public class LBooleanToFloatFunctionTest<X extends ParseException> {
    ...
    private LBooleanToFloatFunction sutAlwaysThrowingUnckeck = LBooleanToFloatFunction.l(b -> {
    ...
    public void testLMethod() throws X {
        assertThat(LBooleanToFloatFunction.l(b -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LBooleanToFloatFunctionX<ParseException> sutThrowing = LBooleanToFloatFunctionX.lX(b -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // when
        LBooleanToFloatFunction wrapped = sutThrowing.handle(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBooleanToFloatFunction wrapped = sutThrowing.handle(h -> Function4U.doNothing());
    ...
    public void testfromBoolean() throws X {
        ...
        LBooleanToFloatFunction sutO = b -> {
    ...
    public void testHandle() throws X {
        ...
        // when
        LBooleanToFloatFunction wrapped = sutThrowing.handle(h -> {
