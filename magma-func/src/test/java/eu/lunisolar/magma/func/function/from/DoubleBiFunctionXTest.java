...
public class DoubleBiFunctionXTest<R,X extends ParseException> {
    ...
    private DoubleBiFunctionX<R,X> sut = new DoubleBiFunctionX(){
        public @Nullable Object  apply(double d1,double d2) throws ParseException {
            return testValue;
        }
    };

    private DoubleBiFunction<R> opposite = new DoubleBiFunction(){
        public @Nullable Object  apply(double d1,double d2)  {
            return testValue;
        }
    };

    private DoubleBiFunctionX<R,X> sutNull = new DoubleBiFunctionX(){
        public @Nullable Object  apply(double d1,double d2) throws ParseException {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (DoubleBiFunctionX: R apply(double d1,double d2) throws X).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("DoubleBiFunctionX: R apply(double d1,double d2) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(DoubleBiFunctionX.lX((double d1,double d2) -> testValue ))
            .isInstanceOf(DoubleBiFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(DoubleBiFunctionX.wrapX(opposite))
            .isInstanceOf(DoubleBiFunctionX.class);
    }
    ...
    public void testfromDouble() throws ParseException {
        ...
        DoubleBiFunctionX<Integer ,X> sutO = (double d1,double d2) -> {
        ...
        //when
        DoubleBiFunctionX<Integer ,X> function = sutO.fromDouble(before1,before2);
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        DoubleBiConsumerX<X> function = sutO.then(thenFunction);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        DoubleBiFunctionX<R,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("DoubleBiFunctionX: R apply(double d1,double d2) throws X");
    }
