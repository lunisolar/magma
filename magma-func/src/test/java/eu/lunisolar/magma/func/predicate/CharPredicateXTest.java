...
public class CharPredicateXTest<X extends ParseException> {
    ...
    private CharPredicateX<X> sut = new CharPredicateX(){
        public  boolean test(char c) throws ParseException {
            return testValue;
        }
    };

    private CharPredicate opposite = new CharPredicate(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("CharPredicateX: boolean test(char c) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(CharPredicateX.lX((char c) -> testValue ))
            .isInstanceOf(CharPredicateX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(CharPredicateX.wrapX(opposite))
            .isInstanceOf(CharPredicateX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        CharPredicateX<X> wrapped = CharPredicateX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws ParseException {
        ...
        //given
        CharPredicateX<X> fun1 = CharPredicateX.lX((char c) -> f1Result);
        CharPredicateX<X> fun2 = CharPredicateX.lX((char c) -> f2Result);

        //when
        CharPredicateX<X> andFunction = fun1.and(fun2);
        CharPredicateX<X> orFunction = fun1.or(fun2);
        CharPredicateX<X> xorFunction = fun1.xor(fun2);
    ...
    public void isEqual() throws ParseException  {
        //when
        CharPredicateX<X> equals = CharPredicateX.isEqual((char)100);
    ...
    public void testfromChar() throws ParseException {
        ...
        //when
        CharPredicateX<X> function = sutO.fromChar(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        CharPredicateX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("CharPredicateX: boolean test(char c) throws X");
    }
