...
public class LFloatConsumerXTest<X extends ParseException> {
    ...
    private LFloatConsumerX<ParseException> sutAlwaysThrowing = LFloatConsumerX.lX((float f) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LFloatConsumerX<RuntimeException> sutAlwaysThrowingUnckeck = LFloatConsumerX.lX((float f) -> {
    ...
    public void testLXMethod() throws ParseException {
        assertThat(LFloatConsumerX.lX((float f) -> Function4U.doNothing() ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LFloatConsumerX<X> wrapped = LFloatConsumerX.wrapException(sutThrowing, UnsupportedOperationException.class, t -> {
    ...
    public void testfromFloat() throws ParseException {
        ...
        LFloatConsumerX<X> sutO = (float f) -> {
...
//
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LFloatConsumerX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
