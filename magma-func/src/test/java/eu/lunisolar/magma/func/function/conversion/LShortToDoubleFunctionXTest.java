...
public class LShortToDoubleFunctionXTest<X extends ParseException> {
    ...
    private LShortToDoubleFunctionX<X> sut = new LShortToDoubleFunctionX<X>(){
    ...
    private LShortToDoubleFunctionX<ParseException> sutAlwaysThrowing = LShortToDoubleFunctionX.lX(a -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LShortToDoubleFunctionX<RuntimeException> sutAlwaysThrowingUnchecked = LShortToDoubleFunctionX.lX(a -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LShortToDoubleFunctionX: double doApplyAsDouble(short a) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LShortToDoubleFunctionX.lX(a -> testValue ))
    ...
    public void testHandlingDoApplyAsDoubleMethodWrapsTheException() throws X {
        ...
        // given
        LShortToDoubleFunctionX<X> sutThrowing = LShortToDoubleFunctionX.lX(a -> {
            throw new UnsupportedOperationException();
        });

        // when
        LShortToDoubleFunctionX<RuntimeException> wrapped = sutThrowing.handleShortToDoubleFuncX(handler -> handler
    ...
    @Test
    public void testHandleShortToDoubleFuncXMethodDoNotWrapsOtherExceptionIf() throws X {
        ...
        // when
        LShortToDoubleFunctionX<X> wrapped = sutThrowing.handleShortToDoubleFuncX(handler -> handler
                .wrapIf(UnsupportedOperationException.class::isInstance,IllegalArgumentException::new,  EXCEPTION_WAS_WRAPPED)
...
@Test
    public void testHandleShortToDoubleFuncXMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleShortToDoubleFuncXMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LShortToDoubleFunctionX<X> wrapped = sutThrowing.handleShortToDoubleFuncX(h -> Function4U.doNothing());
    ...
    public void testShortToDoubleFuncComposeShort() throws X {
        ...
        LShortToDoubleFunctionX<X> sutO = a -> {
        ...
        //when
        LShortToDoubleFunctionX<X> function = sutO.shortToDoubleFuncComposeShort(before);
    ...
    public void testShortToDoubleFuncCompose() throws X {
        ...
        //when
        LToDoubleFunctionX<Integer,X> function = sutO.shortToDoubleFuncCompose(before);
    ...
    public void testHandleShortToDoubleFunc() throws X {
        ...
        // when
        LShortToDoubleFunctionX<X> wrapped = sutThrowing.handleShortToDoubleFuncX(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LShortToDoubleFunctionX: double doApplyAsDouble(short a) throws X");
    }
    ...
    @Test void safeCompiles() {
        LShortToDoubleFunctionX r1 = LShortToDoubleFunctionX.safe(sut); //NOSONAR
    }

    @Test void safePropagates() {
        Object result = LShortToDoubleFunctionX.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LShortToDoubleFunctionX.safe(null);
        assertThat(result).isSameAs(LShortToDoubleFunctionX.lX(LShortToDoubleFunctionX.safe()));
    }

    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LShortToDoubleFunctionX<X>,Y> supplier = ()->sut;
        Object result = LShortToDoubleFunctionX.safeSupplier(supplier);
        assertThat(result).isSameAs(supplier);
    }

    @Test <Y extends Throwable> void safeSupplierProtectsAgainstNpe() {
        Object result = LShortToDoubleFunctionX.safeSupplier(null);
        assertThat(result).isSameAs(LShortToDoubleFunctionX.safeSupplier());
    }

    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LShortToDoubleFunctionX<X>,Y> r1 = LShortToDoubleFunctionX.safeSupplier(()->sut);  //NOSONAR
    }
