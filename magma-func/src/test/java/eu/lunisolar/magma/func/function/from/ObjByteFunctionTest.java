...
public class ObjByteFunctionTest<T,R,X extends ParseException> {
    ...
    private ObjByteFunction<T,R> sut = new ObjByteFunction(){
        public @Nullable Object  apply(Object t, byte i)  {
            return testValue;
        }
    };

    private ObjByteFunctionX<T,R,X> opposite = new ObjByteFunctionX(){
        public @Nullable Object  apply(Object t, byte i) throws ParseException {
            return testValue;
        }
    };

    private ObjByteFunction<T,R> sutNull = new ObjByteFunction(){
        public @Nullable Object  apply(Object t, byte i)  {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (ObjByteFunction: R apply(T t, byte i)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ObjByteFunction: R apply(T t, byte i)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(ObjByteFunction.l((Object t, byte i) -> testValue ))
            .isInstanceOf(ObjByteFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(ObjByteFunction.wrap(opposite))
            .isInstanceOf(ObjByteFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        ObjByteFunction<T,R> wrapped = ObjByteFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        ObjByteFunctionX<T,R,ParseException> sutThrowing = ObjByteFunctionX.lX((T t, byte i) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        ObjByteFunction<T,R> sutThrowing = ObjByteFunction.l((T t, byte i) -> {
            throw new UnsupportedOperationException();
        });

        // when
        ObjByteFunction<T,R> wrapped = ObjByteFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        ObjByteFunction<Integer ,Integer > sutO = (Integer t, byte i) -> {
        ...
        //when
        ObjByteFunction<Integer ,Integer > function = sutO.fromByte(before1,before2);
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        ObjByteConsumer<Integer > function = sutO.then(thenFunction);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ObjByteFunction<T,R> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ObjByteFunction: R apply(T t, byte i)");
    }
