...
public class ToByteFunctionTest<T,X extends ParseException> {
    ...
    private ToByteFunction<T> sut = new ToByteFunction(){
        public  byte applyAsByte(Object t)  {
            return testValue;
        }
    };

    private ToByteFunctionX<T,X> opposite = new ToByteFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ToByteFunction: byte applyAsByte(T t)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(ToByteFunction.l((Object t) -> testValue ))
            .isInstanceOf(ToByteFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(ToByteFunction.wrap(opposite))
            .isInstanceOf(ToByteFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        ToByteFunction<T> wrapped = ToByteFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        ToByteFunctionX<T,ParseException> sutThrowing = ToByteFunctionX.lX((T t) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        ToByteFunction<T> sutThrowing = ToByteFunction.l((T t) -> {
            throw new UnsupportedOperationException();
        });

        // when
        ToByteFunction<T> wrapped = ToByteFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfrom() throws ParseException {
        ...
        ToByteFunction<Integer > sutO = (Integer t) -> {
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ToByteFunction<T> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ToByteFunction: byte applyAsByte(T t)");
    }
