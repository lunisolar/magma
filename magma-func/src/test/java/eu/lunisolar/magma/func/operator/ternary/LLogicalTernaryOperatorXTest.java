...
public class LLogicalTernaryOperatorXTest<X extends ParseException> {
    ...
    private LLogicalTernaryOperatorX<X> sut = new LLogicalTernaryOperatorX<X>(){
    ...
    private LLogicalTernaryOperatorX<ParseException> sutAlwaysThrowing = LLogicalTernaryOperatorX.lX((a1,a2,a3) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LLogicalTernaryOperatorX<RuntimeException> sutAlwaysThrowingUnchecked = LLogicalTernaryOperatorX.lX((a1,a2,a3) -> {
    ...
    public void testLXMethod() throws X {
        assertThat(LLogicalTernaryOperatorX.lX((a1,a2,a3) -> testValue ))
    ...
    public void testHandlingDoApplyMethodWrapsTheException() throws X {
        ...
        // when
        LLogicalTernaryOperatorX<RuntimeException> wrapped = sutThrowing.handleLogicalTernaryOpX(handler -> handler
    ...
    @Test
    public void testHandleLogicalTernaryOpXMethodDoNotWrapsOtherExceptionIf() throws X {
...
@Test
    public void testHandleLogicalTernaryOpXMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleLogicalTernaryOpXMishandlingExceptionIsAllowed() throws X {
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws X {
        ...
        //given
        LLogicalTernaryOperatorX<X> fun1 = LLogicalTernaryOperatorX.lX((a1,a2,a3) -> f1Result);
        LLogicalTernaryOperatorX<X> fun2 = LLogicalTernaryOperatorX.lX((a1,a2,a3) -> f2Result);
    ...
    public void testLogicalTernaryOpComposeBool() throws X {
        ...
        //when
        LLogicalTernaryOperatorX<X> function = sutO.logicalTernaryOpComposeBool(before1,before2,before3);
    ...
    public void testThen0() throws X  {
        ...
        //given (+ some assertions)
        LLogicalTernaryOperatorX<X> sutO = (a1,a2,a3) -> {
                mainFunctionCalled.set(true);
                assertThat(a1).isEqualTo(true);
                assertThat(a2).isEqualTo(true);
                assertThat(a3).isEqualTo(true);
    ...
    @Test void safeCompiles() {
        LLogicalTernaryOperatorX r1 = LLogicalTernaryOperatorX.safe(sut); //NOSONAR
    }
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LLogicalTernaryOperatorX<X>,Y> r1 = LLogicalTernaryOperatorX.safeSupplier(()->sut);  //NOSONAR
    }
