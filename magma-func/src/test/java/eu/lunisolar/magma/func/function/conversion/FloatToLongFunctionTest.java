...
public class FloatToLongFunctionTest<X extends ParseException> {
    ...
    private FloatToLongFunction sut = new FloatToLongFunction(){
        public  long applyAsLong(float f)  {
            return testValue;
        }
    };

    private FloatToLongFunctionX<X> opposite = new FloatToLongFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("FloatToLongFunction: long applyAsLong(float f)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(FloatToLongFunction.l((float f) -> testValue ))
            .isInstanceOf(FloatToLongFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(FloatToLongFunction.wrap(opposite))
            .isInstanceOf(FloatToLongFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        FloatToLongFunction wrapped = FloatToLongFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        FloatToLongFunctionX<ParseException> sutThrowing = FloatToLongFunctionX.lX((float f) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        FloatToLongFunction sutThrowing = FloatToLongFunction.l((float f) -> {
            throw new UnsupportedOperationException();
        });

        // when
        FloatToLongFunction wrapped = FloatToLongFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromFloat() throws ParseException {
        ...
        FloatToLongFunction sutO = (float f) -> {
        ...
        //when
        FloatToLongFunction function = sutO.fromFloat(before1);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        FloatToLongFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("FloatToLongFunction: long applyAsLong(float f)");
    }
