...
public class LObjBoolConsumerTest<T> {
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LObjBoolConsumer: void accept(T a1,boolean a2)");
    }

    @Test
    public void testObjBoolConsMethod() throws Throwable {
        Assert.assertTrue(LObjBoolConsumer.objBoolCons(LObjBoolConsumer::doNothing) instanceof LObjBoolConsumer);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LObjBoolConsumer: void accept(T a1,boolean a2)"));
