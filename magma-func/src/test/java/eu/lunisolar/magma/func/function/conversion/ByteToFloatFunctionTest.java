...
public class ByteToFloatFunctionTest<X extends ParseException> {
    ...
    private ByteToFloatFunction sut = new ByteToFloatFunction(){
        public  float applyAsFloat(byte b)  {
            return testValue;
        }
    };

    private ByteToFloatFunctionX<X> opposite = new ByteToFloatFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ByteToFloatFunction: float applyAsFloat(byte b)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(ByteToFloatFunction.l((byte b) -> testValue ))
            .isInstanceOf(ByteToFloatFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(ByteToFloatFunction.wrap(opposite))
            .isInstanceOf(ByteToFloatFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        ByteToFloatFunction wrapped = ByteToFloatFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        ByteToFloatFunctionX<ParseException> sutThrowing = ByteToFloatFunctionX.lX((byte b) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        ByteToFloatFunction sutThrowing = ByteToFloatFunction.l((byte b) -> {
            throw new UnsupportedOperationException();
        });

        // when
        ByteToFloatFunction wrapped = ByteToFloatFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        ByteToFloatFunction sutO = (byte b) -> {
        ...
        //when
        ByteToFloatFunction function = sutO.fromByte(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(ByteToFloatFunction.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ByteToFloatFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ByteToFloatFunction: float applyAsFloat(byte b)");
    }
