...
public class IntToLongFunctionXTest<X extends ParseException> {
    ...
    private IntToLongFunctionX<X> sut = new IntToLongFunctionX(){
        public  long applyAsLong(int i) throws ParseException {
            return testValue;
        }
    };

    private IntToLongFunction opposite = new IntToLongFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("IntToLongFunctionX: long applyAsLong(int i) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(IntToLongFunctionX.lX((int i) -> testValue ))
            .isInstanceOf(IntToLongFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(IntToLongFunctionX.wrapX(opposite))
            .isInstanceOf(IntToLongFunctionX.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(IntToLongFunctionX.wrapStd(jre))
            .isInstanceOf(IntToLongFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        IntToLongFunctionX<X> wrapped = IntToLongFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromInt() throws ParseException {
        ...
        IntToLongFunctionX<X> sutO = (int i) -> {
        ...
        //when
        IntToLongFunctionX<X> function = sutO.fromInt(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        IntToLongFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("IntToLongFunctionX: long applyAsLong(int i) throws X");
    }
