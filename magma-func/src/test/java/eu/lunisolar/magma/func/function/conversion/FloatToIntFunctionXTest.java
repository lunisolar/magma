...
public class FloatToIntFunctionXTest<X extends ParseException> {
    ...
    private FloatToIntFunctionX<X> sut = new FloatToIntFunctionX(){
        public  int applyAsInt(float f) throws ParseException {
            return testValue;
        }
    };

    private FloatToIntFunction opposite = new FloatToIntFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("FloatToIntFunctionX: int applyAsInt(float f) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(FloatToIntFunctionX.lX((float f) -> testValue ))
            .isInstanceOf(FloatToIntFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(FloatToIntFunctionX.wrapX(opposite))
            .isInstanceOf(FloatToIntFunctionX.class);
    }
    ...
    public void testfromFloat() throws ParseException {
        ...
        FloatToIntFunctionX<X> sutO = (float f) -> {
        ...
        //when
        FloatToIntFunctionX<X> function = sutO.fromFloat(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        FloatToIntFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("FloatToIntFunctionX: int applyAsInt(float f) throws X");
    }
