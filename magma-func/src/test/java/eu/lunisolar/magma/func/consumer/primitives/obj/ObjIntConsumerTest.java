...
public class ObjIntConsumerTest<T,X extends ParseException> {
    ...
    private ObjIntConsumer<T> sut = new ObjIntConsumer(){
        public  void accept(Object t, int i)  {
            Function4U.doNothing();
        }
    };

    private ObjIntConsumerX<T,X> opposite = new ObjIntConsumerX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ObjIntConsumer: void accept(T t, int i)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(ObjIntConsumer.l((Object t, int i) -> Function4U.doNothing() ))
            .isInstanceOf(ObjIntConsumer.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(ObjIntConsumer.wrap(opposite))
            .isInstanceOf(ObjIntConsumer.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(ObjIntConsumer.wrapStd(jre))
            .isInstanceOf(ObjIntConsumer.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        ObjIntConsumer<T> wrapped = ObjIntConsumer.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        ObjIntConsumerX<T,ParseException> sutThrowing = ObjIntConsumerX.lX((T t, int i) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        ObjIntConsumer<T> wrapped = ObjIntConsumer.wrapException(sutThrowing, UnsupportedOperationException.class, t -> {
    ...
    public void testfromInt() throws ParseException {
        ...
        ObjIntConsumer<Integer > sutO = (Integer t, int i) -> {
        ...
        //when
        ObjIntConsumer<Integer > function = sutO.fromInt(before1,before2);
    ...
    public void testAndThen() throws ParseException {
        ...
        ObjIntConsumer<Integer > thenFunction = (Integer t, int i) -> {
        ...
        //when
        ObjIntConsumer<Integer > function = sutO.andThen(thenFunction);
        function.accept((Integer )Integer.valueOf(80),(int)81);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ObjIntConsumer<T> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ObjIntConsumer: void accept(T t, int i)");
    }
