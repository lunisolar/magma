...
public class BooleanToFloatFunctionXTest<X extends ParseException> {
    ...
    private BooleanToFloatFunctionX<X> sut = new BooleanToFloatFunctionX(){
        public  float applyAsFloat(boolean b) throws ParseException {
            return testValue;
        }
    };

    private BooleanToFloatFunction opposite = new BooleanToFloatFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BooleanToFloatFunctionX: float applyAsFloat(boolean b) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(BooleanToFloatFunctionX.lX((boolean b) -> testValue ))
            .isInstanceOf(BooleanToFloatFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(BooleanToFloatFunctionX.wrapX(opposite))
            .isInstanceOf(BooleanToFloatFunctionX.class);
    }
    ...
    public void testfromBoolean() throws ParseException {
        ...
        BooleanToFloatFunctionX<X> sutO = (boolean b) -> {
        ...
        //when
        BooleanToFloatFunctionX<X> function = sutO.fromBoolean(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        BooleanToFloatFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BooleanToFloatFunctionX: float applyAsFloat(boolean b) throws X");
    }
