...
public class DoubleToShortFunctionXTest<X extends ParseException> {
    ...
    private DoubleToShortFunctionX<X> sut = new DoubleToShortFunctionX(){
        public  short applyAsShort(double d) throws ParseException {
            return testValue;
        }
    };

    private DoubleToShortFunction opposite = new DoubleToShortFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("DoubleToShortFunctionX: short applyAsShort(double d) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(DoubleToShortFunctionX.lX((double d) -> testValue ))
            .isInstanceOf(DoubleToShortFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(DoubleToShortFunctionX.wrapX(opposite))
            .isInstanceOf(DoubleToShortFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        DoubleToShortFunctionX<X> wrapped = DoubleToShortFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromDouble() throws ParseException {
        ...
        DoubleToShortFunctionX<X> sutO = (double d) -> {
        ...
        //when
        DoubleToShortFunctionX<X> function = sutO.fromDouble(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        DoubleToShortFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("DoubleToShortFunctionX: short applyAsShort(double d) throws X");
    }
