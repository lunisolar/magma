...
public class ShortToByteFunctionXTest<X extends ParseException> {
    ...
    private ShortToByteFunctionX<X> sut = new ShortToByteFunctionX(){
        public  byte applyAsByte(short s) throws ParseException {
            return testValue;
        }
    };

    private ShortToByteFunction opposite = new ShortToByteFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ShortToByteFunctionX: byte applyAsByte(short s) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(ShortToByteFunctionX.lX((short s) -> testValue ))
            .isInstanceOf(ShortToByteFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(ShortToByteFunctionX.wrapX(opposite))
            .isInstanceOf(ShortToByteFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        ShortToByteFunctionX<X> wrapped = ShortToByteFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromShort() throws ParseException {
        ...
        ShortToByteFunctionX<X> sutO = (short s) -> {
        ...
        //when
        ShortToByteFunctionX<X> function = sutO.fromShort(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        ShortToByteFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ShortToByteFunctionX: byte applyAsByte(short s) throws X");
    }
