...
public class LBiObjCharFunctionXTest<T1,T2,R,X extends ParseException> {
    ...
    private LBiObjCharFunctionX<Integer,Integer,Integer,X> sut = new LBiObjCharFunctionX<Integer,Integer,Integer,X>(){
        public @Nullable Integer doApply(Integer a1,Integer a2,char a3)  throws X {
            return testValue;
        }
    };

    private LBiObjCharFunction<Integer,Integer,Integer> opposite = new LBiObjCharFunction<Integer,Integer,Integer>(){
        public @Nullable Integer doApply(Integer a1,Integer a2,char a3)  {
            return testValue;
        }
    };

    private LBiObjCharFunctionX<Integer,Integer,Integer,X> sutNull = new LBiObjCharFunctionX<Integer,Integer,Integer,X>(){
        public @Nullable Integer doApply(Integer a1,Integer a2,char a3)  throws X {
            return null;
        }
    };
    ...
    private LBiObjCharFunctionX<Integer,Integer,Integer,ParseException> sutAlwaysThrowing = LBiObjCharFunctionX.lX((a1,a2,a3) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiObjCharFunctionX<Integer,Integer,Integer,RuntimeException> sutAlwaysThrowingUnchecked = LBiObjCharFunctionX.lX((a1,a2,a3) -> {
    ...
    public void testNestingDoApplyChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoApply(100,100,'\u0100');
    ...
    public void testShovingDoApplyChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoApply(100,100,'\u0100');
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testLXMethod() throws X {
        assertThat(LBiObjCharFunctionX.lX((a1,a2,a3) -> testValue ))
    ...
    public void testHandlingDoApplyMethodWrapsTheException() throws X {
        ...
        // when
        LBiObjCharFunctionX<Integer,Integer,Integer,RuntimeException> wrapped = sutThrowing.handleBiObjCharFuncX(handler -> handler
    ...
    @Test
    public void testHandleBiObjCharFuncXMethodDoNotWrapsOtherExceptionIf() throws X {
        ...
        // when
        LBiObjCharFunctionX<Integer,Integer,Integer,X> wrapped = sutThrowing.handleBiObjCharFuncX(handler -> handler
                .wrapIf(UnsupportedOperationException.class::isInstance,IllegalArgumentException::new,  EXCEPTION_WAS_WRAPPED)
...
@Test
    public void testHandleBiObjCharFuncXMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleBiObjCharFuncXMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBiObjCharFunctionX<Integer,Integer,Integer,X> wrapped = sutThrowing.handleBiObjCharFuncX(h -> Function4U.doNothing());
    ...
    public void testThen0() throws X  {
        ...
        //given (+ some assertions)
        LBiObjCharFunctionX<Integer,Integer,Integer,X> sutO = (a1,a2,a3) -> {
                mainFunctionCalled.set(true);
    ...
    public void testHandleBiObjCharFunc() throws X {
        ...
        // when
        LBiObjCharFunctionX<Integer,Integer,Integer,X> wrapped = sutThrowing.handleBiObjCharFuncX(h -> {
    ...
    public void compilerSubstituteVariantV1() {
        LBiObjCharFunctionX lambda = LBiObjCharFunctionX./*<T1,T2,R,X>*/lX1(this::variantV1);
    ...
    public void compilerSubstituteVariantV2() {
        LBiObjCharFunctionX lambda = LBiObjCharFunctionX./*<T1,T2,R,X>*/lX2(this::variantV2);
    ...
    public void compilerSubstituteVariantV3() {
        LBiObjCharFunctionX lambda = LBiObjCharFunctionX./*<T1,T2,R,X>*/lX3(this::variantV3);
    ...
    public void compilerSubstituteVariantV4() {
        LBiObjCharFunctionX lambda = LBiObjCharFunctionX./*<T1,T2,R,X>*/lX4(this::variantV4);
    ...
    public void compilerSubstituteVariantV5() {
        LBiObjCharFunctionX lambda = LBiObjCharFunctionX./*<T1,T2,R,X>*/lX5(this::variantV5);
    ...
    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LBiObjCharFunctionX<Integer,Integer,Integer,X>,Y> supplier = ()->sut;
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LBiObjCharFunctionX<Integer,Integer,Integer,X>,Y> r1 = LBiObjCharFunctionX.safeSupplier(()->sut);  //NOSONAR
    }
