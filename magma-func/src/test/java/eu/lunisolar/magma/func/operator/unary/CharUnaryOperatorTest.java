...
public class CharUnaryOperatorTest<X extends ParseException> {
    ...
    private CharUnaryOperator sut = new CharUnaryOperator(){
        public  char applyAsChar(char c)  {
            return testValue;
        }
    };

    private CharUnaryOperatorX<X> opposite = new CharUnaryOperatorX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("CharUnaryOperator: char applyAsChar(char c)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(CharUnaryOperator.l((char c) -> testValue ))
            .isInstanceOf(CharUnaryOperator.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(CharUnaryOperator.wrap(opposite))
            .isInstanceOf(CharUnaryOperator.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        CharUnaryOperator wrapped = CharUnaryOperator.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        CharUnaryOperatorX<ParseException> sutThrowing = CharUnaryOperatorX.lX((char c) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        CharUnaryOperator sutThrowing = CharUnaryOperator.l((char c) -> {
            throw new UnsupportedOperationException();
        });

        // when
        CharUnaryOperator wrapped = CharUnaryOperator.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromChar() throws ParseException {
        ...
        //when
        CharUnaryOperator function = sutO.fromChar(before1);
    ...
    public void testfrom() throws ParseException {
        ...
        //when
        ToCharFunction<Integer > function = sutO.from(before1);
    ...
    public void identity() throws ParseException {
        CharUnaryOperator identityFunction = CharUnaryOperator.identity();
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        CharUnaryOperator wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("CharUnaryOperator: char applyAsChar(char c)");
    }
