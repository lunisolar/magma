...
public class LBoolToByteFunctionXTest<X extends ParseException> {
    ...
    private LBoolToByteFunctionX<ParseException> sutAlwaysThrowing = LBoolToByteFunctionX.lX(b -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBoolToByteFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LBoolToByteFunctionX.lX(b -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBoolToByteFunctionX: byte doApplyAsByte(boolean b) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LBoolToByteFunctionX.lX(b -> testValue ))
...
@Test
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBoolToByteFunctionX: byte doApplyAsByte(boolean b) throws X");
    }
