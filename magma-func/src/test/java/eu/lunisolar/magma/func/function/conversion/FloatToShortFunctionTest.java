...
public class FloatToShortFunctionTest<X extends ParseException> {
    ...
    private FloatToShortFunction sut = new FloatToShortFunction(){
        public  short applyAsShort(float f)  {
            return testValue;
        }
    };

    private FloatToShortFunctionX<X> opposite = new FloatToShortFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("FloatToShortFunction: short applyAsShort(float f)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(FloatToShortFunction.l((float f) -> testValue ))
            .isInstanceOf(FloatToShortFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(FloatToShortFunction.wrap(opposite))
            .isInstanceOf(FloatToShortFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        // given
        FloatToShortFunctionX<X> sutThrowing = FloatToShortFunctionX.lX((float f) -> {
            throw new UnsupportedOperationException(ORIGINAL_MESSAGE);
        });

        // when
        FloatToShortFunction wrapped = FloatToShortFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        FloatToShortFunctionX<ParseException> sutThrowing = FloatToShortFunctionX.lX((float f) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        FloatToShortFunction sutThrowing = FloatToShortFunction.l((float f) -> {
            throw new UnsupportedOperationException();
        });

        // when
        FloatToShortFunction wrapped = FloatToShortFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromFloat() throws ParseException {
        ...
        FloatToShortFunction sutO = (float f) -> {
        ...
        //when
        FloatToShortFunction function = sutO.fromFloat(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(FloatToShortFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(FloatToShortFunctionX.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        FloatToShortFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("FloatToShortFunction: short applyAsShort(float f)");
    }
