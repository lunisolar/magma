...
public class LBiPredicateTest<T1,T2,X extends ParseException> {
    ...
    private LBiPredicate<T1,T2> sutAlwaysThrowingUnckeck = LBiPredicate.l((T1 t1,T2 t2) -> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBiPredicate: boolean doTest(T1 t1,T2 t2)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LBiPredicate.l((Object t1,Object t2) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LBiPredicateX<T1,T2,ParseException> sutThrowing = LBiPredicateX.lX((T1 t1,T2 t2) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LBiPredicate<T1,T2> sutThrowing = LBiPredicate.l((T1 t1,T2 t2) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LBiPredicate<T1,T2> wrapped = LBiPredicate.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws ParseException {
        ...
        //given
        LBiPredicate<T1,T2> fun1 = LBiPredicate.l((T1 t1,T2 t2) -> f1Result);
        LBiPredicate<T1,T2> fun2 = LBiPredicate.l((T1 t1,T2 t2) -> f2Result);
    ...
    public void testfrom() throws ParseException {
        ...
        LBiPredicate<Integer ,Integer > sutO = (Integer t1,Integer t2) -> {
...
//
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LBiPredicate<T1,T2> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBiPredicate: boolean doTest(T1 t1,T2 t2)");
    }
