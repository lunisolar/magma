...
public class LToCharBiFunctionTest<T1,T2,X extends ParseException> {
    ...
    private LToCharBiFunction<T1,T2> sutAlwaysThrowingUnckeck = LToCharBiFunction.l((T1 t1,T2 t2) -> {
    ...
    public void testLMethod() throws X {
        assertThat(LToCharBiFunction.l((Object t1,Object t2) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LToCharBiFunctionX<T1,T2,ParseException> sutThrowing = LToCharBiFunctionX.lX((T1 t1,T2 t2) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LToCharBiFunction<T1,T2> sutThrowing = LToCharBiFunction.l((T1 t1,T2 t2) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LToCharBiFunction<T1,T2> wrapped = sutThrowing.handleToCBiFunc(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LToCharBiFunction<T1,T2> wrapped = sutThrowing.handleToCBiFunc(h -> Function4U.doNothing());
    ...
    public void testtoCBiFuncFrom() throws X {
        ...
        LToCharBiFunction<Integer ,Integer > sutO = (Integer t1,Integer t2) -> {
        ...
        //when
        LToCharBiFunction<Integer ,Integer > function = sutO.toCBiFuncFrom(before1,before2);
    ...
    public void testHandleToCBiFunc() throws X {
        ...
        // when
        LToCharBiFunction<T1,T2> wrapped = sutThrowing.handleToCBiFunc(h -> {
