...
public class LBiObjIntConsumerTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjIntConsumer<T1,T2> sutAlwaysThrowingUnckeck = LBiObjIntConsumer.l((T1 a1,T2 a2,int a3) -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LBiObjIntTriple<T1,T2>,LTuple.Void,RuntimeException> theCall = sut;
    ...
    public void testLMethod() throws X {
        assertThat(LBiObjIntConsumer.l((Object a1,Object a2,int a3) -> Function4U.doNothing() ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LBiObjIntConsumerX<T1,T2,ParseException> sutThrowing = LBiObjIntConsumerX.lX((T1 a1,T2 a2,int a3) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LBiObjIntConsumer<T1,T2> sutThrowing = LBiObjIntConsumer.l((T1 a1,T2 a2,int a3) -> {
...
@Test
    ...
    public void testAndThen() throws X {
        ...
        LBiObjIntConsumer<Integer ,Integer > thenFunction = (Integer a1,Integer a2,int a3) -> {
    ...
    public void compilerSubstituteVariant1() {
        LBiObjIntConsumer lambda = LBiObjIntConsumer./*<T1,T2>*/l1(this::variant1);
    ...
    public void compilerSubstituteVariant2() {
        LBiObjIntConsumer lambda = LBiObjIntConsumer./*<T1,T2>*/l2(this::variant2);
    ...
    public void compilerSubstituteVariant3() {
        LBiObjIntConsumer lambda = LBiObjIntConsumer./*<T1,T2>*/l3(this::variant3);
    ...
    public void compilerSubstituteVariant4() {
        LBiObjIntConsumer lambda = LBiObjIntConsumer./*<T1,T2>*/l4(this::variant4);
    ...
    public void compilerSubstituteVariant5() {
        LBiObjIntConsumer lambda = LBiObjIntConsumer./*<T1,T2>*/l5(this::variant5);
    ...
    @Test void safeCompiles() {
        LBiObjIntConsumer r1 = LBiObjIntConsumer.safe(sut);
        LBiObjIntConsumerX r2 = LBiObjIntConsumer.safe(sut);
    }
    ...
    @Test  void safeSupplierPropagates() {
        LSupplier<LBiObjIntConsumer<T1,T2>> supplier = ()->sut;
    ...
    @Test  void safeSupplierCompiles() {
        LSupplier<LBiObjIntConsumer<T1,T2>> r1 = LBiObjIntConsumer.safeSupplier(()->sut);
    }
