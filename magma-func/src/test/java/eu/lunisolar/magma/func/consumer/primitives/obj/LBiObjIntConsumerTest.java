...
public class LBiObjIntConsumerTest<T1,T2> {
    ...
    private LBiObjIntConsumer<Integer,Integer> sut = new LBiObjIntConsumer<Integer,Integer>(){
        public  void acceptX(Integer a1,Integer a2,int a3)  {
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LBiObjIntConsumer: void accept(T1 a1,T2 a2,int a3)");
    }

    @Test
    public void testBiObjIntConsMethod() throws Throwable {
        Assert.assertTrue(LBiObjIntConsumer.biObjIntCons(LBiObjIntConsumer::doNothing) instanceof LBiObjIntConsumer);
    ...
    public void testCompose() throws Throwable {
        ...
        //when
        LBiObjIntConsumer<Integer,Integer> function = sutO.compose(before1,before2,before3);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LBiObjIntConsumer: void accept(T1 a1,T2 a2,int a3)"));
