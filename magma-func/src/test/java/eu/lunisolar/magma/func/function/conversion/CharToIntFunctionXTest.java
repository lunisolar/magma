...
public class CharToIntFunctionXTest<X extends ParseException> {
    ...
    private CharToIntFunctionX<X> sut = new CharToIntFunctionX(){
        public  int applyAsInt(char c) throws ParseException {
            return testValue;
        }
    };

    private CharToIntFunction opposite = new CharToIntFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("CharToIntFunctionX: int applyAsInt(char c) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(CharToIntFunctionX.lX((char c) -> testValue ))
            .isInstanceOf(CharToIntFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(CharToIntFunctionX.wrapX(opposite))
            .isInstanceOf(CharToIntFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        CharToIntFunctionX<X> wrapped = CharToIntFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromChar() throws ParseException {
        ...
        CharToIntFunctionX<X> sutO = (char c) -> {
        ...
        //when
        CharToIntFunctionX<X> function = sutO.fromChar(before1);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        CharToIntFunctionX<X> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("CharToIntFunctionX: int applyAsInt(char c) throws X");
    }
