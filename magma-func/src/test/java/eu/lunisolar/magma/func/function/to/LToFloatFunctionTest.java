...
public class LToFloatFunctionTest<T,X extends ParseException> {
    ...
    private LToFloatFunction<T> sut = new LToFloatFunction(){
        public  float applyAsFloat(Object t)  {
            return testValue;
        }
    };

    private LToFloatFunctionX<T,X> opposite = new LToFloatFunctionX(){
        public  float applyAsFloat(Object t) throws ParseException {
            return testValue;
        }
    };
    ...
    public void testTheResult() throws ParseException {
        assertThat(sut.applyAsFloat((T)Integer.valueOf(100)))
            .isEqualTo(testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LToFloatFunction: float applyAsFloat(T t)");
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // then
        try {
            wrapped.applyAsFloat((T)Integer.valueOf(100));
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LToFloatFunction: float applyAsFloat(T t)");
    }
