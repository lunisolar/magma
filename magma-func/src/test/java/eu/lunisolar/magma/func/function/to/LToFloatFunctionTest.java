...
public class LToFloatFunctionTest<T,X extends ParseException> {
    ...
    private LToFloatFunction<T> sutAlwaysThrowingUnckeck = LToFloatFunction.l((T t) -> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LToFloatFunction: float doApplyAsFloat(T t)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LToFloatFunction.l((Object t) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LToFloatFunctionX<T,ParseException> sutThrowing = LToFloatFunctionX.lX((T t) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LToFloatFunction<T> sutThrowing = LToFloatFunction.l((T t) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LToFloatFunction<T> wrapped = LToFloatFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfrom() throws ParseException {
        ...
        LToFloatFunction<Integer > sutO = (Integer t) -> {
...
//
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LToFloatFunction<T> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LToFloatFunction: float doApplyAsFloat(T t)");
    }
