...
public class DoubleFunctionTest<R,X extends ParseException> {
    ...
    private DoubleFunction<R> sut = new DoubleFunction(){
        public @Nullable Object  apply(double d)  {
            return testValue;
        }
    };

    private DoubleFunctionX<R,X> opposite = new DoubleFunctionX(){
        public @Nullable Object  apply(double d) throws ParseException {
            return testValue;
        }
    };

    private DoubleFunction<R> sutNull = new DoubleFunction(){
        public @Nullable Object  apply(double d)  {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (DoubleFunction: R apply(double d)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("DoubleFunction: R apply(double d)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(DoubleFunction.l((double d) -> testValue ))
            .isInstanceOf(DoubleFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(DoubleFunction.wrap(opposite))
            .isInstanceOf(DoubleFunction.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(DoubleFunction.wrapStd(jre))
            .isInstanceOf(DoubleFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        DoubleFunction<R> wrapped = DoubleFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        DoubleFunctionX<R,ParseException> sutThrowing = DoubleFunctionX.lX((double d) -> {
    ...
    public void testfromDouble() throws ParseException {
        ...
        DoubleFunction<Integer > sutO = (double d) -> {
        ...
        //when
        DoubleFunction<Integer > function = sutO.fromDouble(before1);
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        DoubleConsumer function = sutO.then(thenFunction);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        DoubleFunction<R> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("DoubleFunction: R apply(double d)");
    }
