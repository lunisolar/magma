...
public class DoubleToByteFunctionXTest<X extends ParseException> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        DoubleToByteFunctionX<X> wrapped = DoubleToByteFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, t -> {
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        DoubleToByteFunctionX<X> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
