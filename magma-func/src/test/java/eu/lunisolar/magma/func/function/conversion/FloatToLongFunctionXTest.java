...
public class FloatToLongFunctionXTest<X extends ParseException> {
    ...
    private FloatToLongFunctionX<X> sut = new FloatToLongFunctionX(){
        public  long applyAsLong(float f) throws ParseException {
            return testValue;
        }
    };

    private FloatToLongFunction opposite = new FloatToLongFunction(){
    ...
    public void testTheResult() throws ParseException {
        assertThat(sut.applyAsLong((float)100))
            .isEqualTo(testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("FloatToLongFunctionX: long applyAsLong(float f) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(FloatToLongFunctionX.lX((float f) -> testValue ))
            .isInstanceOf(FloatToLongFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(FloatToLongFunctionX.wrapX(opposite))
            .isInstanceOf(FloatToLongFunctionX.class);
    }
    ...
    public void testfromFloat() throws ParseException {
        ...
        FloatToLongFunctionX<X> sutO = (float f) -> {
        ...
        //when
        FloatToLongFunctionX<X> function = sutO.fromFloat(before1);
        function.applyAsLong((float)80);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(FloatToLongFunction.class);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        FloatToLongFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("FloatToLongFunctionX: long applyAsLong(float f) throws X");
    }
