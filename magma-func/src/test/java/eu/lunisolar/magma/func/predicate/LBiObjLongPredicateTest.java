...
public class LBiObjLongPredicateTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjLongPredicate<T1,T2> sutAlwaysThrowingUnckeck = LBiObjLongPredicate.l((T1 a1,T2 a2,long a3) -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LBiObjLongTriple<T1,T2>,Boolean,RuntimeException> theCall = sut;
    ...
    public void testLMethod() throws X {
        assertThat(LBiObjLongPredicate.l((Object a1,Object a2,long a3) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LBiObjLongPredicateX<T1,T2,ParseException> sutThrowing = LBiObjLongPredicateX.lX((T1 a1,T2 a2,long a3) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LBiObjLongPredicate<T1,T2> sutThrowing = LBiObjLongPredicate.l((T1 a1,T2 a2,long a3) -> {
...
@Test
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws X {
        ...
        //given
        LBiObjLongPredicate<T1,T2> fun1 = LBiObjLongPredicate.l((T1 a1,T2 a2,long a3) -> f1Result);
        LBiObjLongPredicate<T1,T2> fun2 = LBiObjLongPredicate.l((T1 a1,T2 a2,long a3) -> f2Result);
    ...
    public void testbiObjLongPredComposeLong() throws X {
        ...
        LBiObjLongPredicate<Integer ,Integer > sutO = (Integer a1,Integer a2,long a3) -> {
    ...
    public void compilerSubstituteVariant1() {
        LBiObjLongPredicate lambda = LBiObjLongPredicate./*<T1,T2>*/l1(this::variant1);
    ...
    public void compilerSubstituteVariant2() {
        LBiObjLongPredicate lambda = LBiObjLongPredicate./*<T1,T2>*/l2(this::variant2);
    ...
    public void compilerSubstituteVariant3() {
        LBiObjLongPredicate lambda = LBiObjLongPredicate./*<T1,T2>*/l3(this::variant3);
    ...
    public void compilerSubstituteVariant4() {
        LBiObjLongPredicate lambda = LBiObjLongPredicate./*<T1,T2>*/l4(this::variant4);
    ...
    public void compilerSubstituteVariant5() {
        LBiObjLongPredicate lambda = LBiObjLongPredicate./*<T1,T2>*/l5(this::variant5);
    ...
    @Test void safeCompiles() {
        LBiObjLongPredicate r1 = LBiObjLongPredicate.safe(sut);
        LBiObjLongPredicateX r2 = LBiObjLongPredicate.safe(sut);
    }
    ...
    @Test  void safeSupplierPropagates() {
        LSupplier<LBiObjLongPredicate<T1,T2>> supplier = ()->sut;
    ...
    @Test  void safeSupplierCompiles() {
        LSupplier<LBiObjLongPredicate<T1,T2>> r1 = LBiObjLongPredicate.safeSupplier(()->sut);
    }
