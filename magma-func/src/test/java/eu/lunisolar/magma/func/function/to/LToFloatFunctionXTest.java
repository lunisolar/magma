...
public class LToFloatFunctionXTest<T,X extends ParseException> {
    ...
    private LToFloatFunctionX<T,X> sut = new LToFloatFunctionX(){
        public  float doApplyAsFloat(Object t) throws ParseException {
            return testValue;
        }
    };

    private LToFloatFunction<T> opposite = new LToFloatFunction(){
        public  float doApplyAsFloat(Object t)  {
            return testValue;
        }
    };
    ...
    private LToFloatFunctionX<T,ParseException> sutAlwaysThrowing = LToFloatFunctionX.lX((T t) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LToFloatFunctionX<T,RuntimeException> sutAlwaysThrowingUnckeck = LToFloatFunctionX.lX((T t) -> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LToFloatFunctionX: float doApplyAsFloat(T t) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(LToFloatFunctionX.lX((Object t) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LToFloatFunctionX<T,X> sutThrowing = LToFloatFunctionX.lX((T t) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LToFloatFunctionX<T,X> wrapped = LToFloatFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfrom() throws ParseException {
        ...
        LToFloatFunctionX<Integer ,X> sutO = (Integer t) -> {
...
//
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().doApplyAsFloat((T)Integer.valueOf(100));
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LToFloatFunctionX<T,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LToFloatFunctionX: float doApplyAsFloat(T t) throws X");
    }
