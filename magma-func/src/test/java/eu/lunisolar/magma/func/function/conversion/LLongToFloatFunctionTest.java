...
public class LLongToFloatFunctionTest<X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LLongToFloatFunction: float applyAsFloat(long l)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LLongToFloatFunction.l((long l) -> testValue ))
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        // given
        LLongToFloatFunctionX<X> sutThrowing = LLongToFloatFunctionX.lX((long l) -> {
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LLongToFloatFunctionX<ParseException> sutThrowing = LLongToFloatFunctionX.lX((long l) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LLongToFloatFunction sutThrowing = LLongToFloatFunction.l((long l) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LLongToFloatFunction wrapped = LLongToFloatFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromLong() throws ParseException {
        ...
        LLongToFloatFunction sutO = (long l) -> {
        ...
        //when
        LLongToFloatFunction function = sutO.fromLong(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LLongToFloatFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LLongToFloatFunctionX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().applyAsFloat((long)100);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LLongToFloatFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LLongToFloatFunction: float applyAsFloat(long l)");
    }
