...
public class LLongToFloatFunctionTest<X extends ParseException> {
    ...
    private LLongToFloatFunction sutAlwaysThrowingUnckeck = LLongToFloatFunction.l((long l) -> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LLongToFloatFunction: float doApplyAsFloat(long l)");
    }
...
//
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().doApplyAsFloat((long)100);
    }
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LLongToFloatFunction: float doApplyAsFloat(long l)");
    }
