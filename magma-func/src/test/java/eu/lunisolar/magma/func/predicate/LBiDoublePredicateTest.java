...
public class LBiDoublePredicateTest<X extends ParseException> {
    ...
    private LBiDoublePredicateX<X> opposite = new LBiDoublePredicateX<X>(){
    ...
    private LBiDoublePredicateX<RuntimeException> sutAlwaysThrowingUnchecked = LBiDoublePredicate.l((a1,a2) -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBiDoublePredicate: boolean doTest(double a1,double a2)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LBiDoublePredicate.l((a1,a2) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LBiDoublePredicateX<ParseException> sutThrowing = LBiDoublePredicateX.lX((a1,a2) -> {
    ...
    public void testHandlingDoTestMethodWrapsTheException() throws X {
        ...
        // given
        LBiDoublePredicate sutThrowing = LBiDoublePredicate.l((a1,a2) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LBiDoublePredicate wrapped = sutThrowing.handleBiDoublePred(handler -> handler
    ...
    @Test
    public void testHandleBiDoublePredMethodDoNotWrapsOtherExceptionIf() throws X {
...
@Test
    public void testHandleBiDoublePredMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleBiDoublePredMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBiDoublePredicate wrapped = sutThrowing.handleBiDoublePred(h -> Function4U.doNothing());
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws X {
        ...
        //given
        LBiDoublePredicate fun1 = LBiDoublePredicate.l((a1,a2) -> f1Result);
        LBiDoublePredicate fun2 = LBiDoublePredicate.l((a1,a2) -> f2Result);
    ...
    public void testIsEqual() throws X  {
        //when
        LBiDoublePredicate equals = LBiDoublePredicate.isEqual(1d,1d);
    ...
    public void testBiDoublePredComposeDouble() throws X {
        ...
        //when
        LBiDoublePredicate function = sutO.biDoublePredComposeDouble(before1,before2);
    ...
    public void testBiDoublePredCompose() throws X {
        ...
        //when
        LBiPredicate<Integer,Integer> function = sutO.biDoublePredCompose(before1,before2);
    ...
    @Test
    public void testBoolToBiDoubleFunction0() throws X  {
        ...
        //when
        LBiDoubleFunction<Integer> function = sutO.boolToBiDoubleFunction(thenFunction);
    ...
    public void testHandleBiDoublePred() throws X {
        ...
        // when
        LBiDoublePredicate wrapped = sutThrowing.handleBiDoublePred(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBiDoublePredicate: boolean doTest(double a1,double a2)");
    }
    ...
    public void compilerSubstituteVariantV1() {
        LBiDoublePredicate lambda = LBiDoublePredicate./**/l1(this::variantV1);

        assertThat(lambda).isInstanceOf(LBiDoublePredicate.V1.class);
    }
    ...
    @Test void safeCompiles() {
        LBiDoublePredicate r1 = LBiDoublePredicate.safe(sut); //NOSONAR
        LBiDoublePredicateX r2 = LBiDoublePredicate.safe(sut); //NOSONAR
    }

    @Test void safePropagates() {
        Object result = LBiDoublePredicate.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LBiDoublePredicate.safe(null);
        assertThat(result).isSameAs(LBiDoublePredicate.l(LBiDoublePredicate.safe()));
    }

    @Test  void safeSupplierPropagates() {
        LSupplier<LBiDoublePredicate> supplier = ()->sut;
        Object result = LBiDoublePredicate.safeSupplier(supplier);
        assertThat(result).isSameAs(supplier);
    }

    @Test  void safeSupplierProtectsAgainstNpe() {
        Object result = LBiDoublePredicate.safeSupplier(null);
        assertThat(result).isSameAs(LBiDoublePredicate.safeSupplier());
    }

    @Test  void safeSupplierCompiles() {
        LSupplier<LBiDoublePredicate> r1 = LBiDoublePredicate.safeSupplier(()->sut);  //NOSONAR
    }
