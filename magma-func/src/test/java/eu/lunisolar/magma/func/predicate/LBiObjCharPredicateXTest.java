...
public class LBiObjCharPredicateXTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjCharPredicateX<Integer,Integer,X> sut = new LBiObjCharPredicateX<Integer,Integer,X>(){
        public  boolean doTest(Integer a1,Integer a2,char a3)  throws X {
            return testValue;
        }
    };

    private LBiObjCharPredicate<Integer,Integer> opposite = new LBiObjCharPredicate<Integer,Integer>(){
    ...
    private LBiObjCharPredicateX<Integer,Integer,ParseException> sutAlwaysThrowing = LBiObjCharPredicateX.lX((a1,a2,a3) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiObjCharPredicateX<Integer,Integer,RuntimeException> sutAlwaysThrowingUnchecked = LBiObjCharPredicateX.lX((a1,a2,a3) -> {
    ...
    public void testNestingDoTestChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoTest(100,100,'\u0100');
    ...
    public void testShovingDoTestChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoTest(100,100,'\u0100');
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testLXMethod() throws X {
        assertThat(LBiObjCharPredicateX.lX((a1,a2,a3) -> testValue ))
    ...
    public void testHandlingDoTestMethodWrapsTheException() throws X {
        ...
        // when
        LBiObjCharPredicateX<Integer,Integer,RuntimeException> wrapped = sutThrowing.handleBiObjCharPredX(handler -> handler
    ...
    @Test
    public void testHandleBiObjCharPredXMethodDoNotWrapsOtherExceptionIf() throws X {
        ...
        // when
        LBiObjCharPredicateX<Integer,Integer,X> wrapped = sutThrowing.handleBiObjCharPredX(handler -> handler
                .wrapIf(UnsupportedOperationException.class::isInstance,IllegalArgumentException::new,  EXCEPTION_WAS_WRAPPED)
...
@Test
    public void testHandleBiObjCharPredXMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleBiObjCharPredXMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBiObjCharPredicateX<Integer,Integer,X> wrapped = sutThrowing.handleBiObjCharPredX(h -> Function4U.doNothing());
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws X {
        ...
        //given
        LBiObjCharPredicateX<Integer,Integer,X> fun1 = LBiObjCharPredicateX.lX((a1,a2,a3) -> f1Result);
        LBiObjCharPredicateX<Integer,Integer,X> fun2 = LBiObjCharPredicateX.lX((a1,a2,a3) -> f2Result);

        //when
        LBiObjCharPredicateX<Integer,Integer,X> andFunction = fun1.and(fun2);
        LBiObjCharPredicateX<Integer,Integer,X> orFunction = fun1.or(fun2);
        LBiObjCharPredicateX<Integer,Integer,X> xorFunction = fun1.xor(fun2);
    ...
    public void testIsEqual() throws X  {
        //when
        LBiObjCharPredicateX<Integer,Integer,X> equals = LBiObjCharPredicateX.isEqual(1,1,'\u0001');
    ...
    public void testBiObjCharPredComposeChar() throws X {
        ...
        LBiObjCharPredicateX<Integer,Integer,X> sutO = (a1,a2,a3) -> {
    ...
    public void testBoolToBiObjCharFunc0() throws X  {
        ...
        //when
        LBiObjCharFunctionX<Integer,Integer,Integer,X> function = sutO.boolToBiObjCharFunc(thenFunction);
    ...
    public void testHandleBiObjCharPred() throws X {
        ...
        // when
        LBiObjCharPredicateX<Integer,Integer,X> wrapped = sutThrowing.handleBiObjCharPredX(h -> {
    ...
    public void compilerSubstituteVariantV1() {
        LBiObjCharPredicateX lambda = LBiObjCharPredicateX./*<T1,T2,X>*/lX1(this::variantV1);
    ...
    public void compilerSubstituteVariantV2() {
        LBiObjCharPredicateX lambda = LBiObjCharPredicateX./*<T1,T2,X>*/lX2(this::variantV2);
    ...
    public void compilerSubstituteVariantV3() {
        LBiObjCharPredicateX lambda = LBiObjCharPredicateX./*<T1,T2,X>*/lX3(this::variantV3);
    ...
    public void compilerSubstituteVariantV4() {
        LBiObjCharPredicateX lambda = LBiObjCharPredicateX./*<T1,T2,X>*/lX4(this::variantV4);
    ...
    public void compilerSubstituteVariantV5() {
        LBiObjCharPredicateX lambda = LBiObjCharPredicateX./*<T1,T2,X>*/lX5(this::variantV5);
    ...
    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LBiObjCharPredicateX<Integer,Integer,X>,Y> supplier = ()->sut;
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LBiObjCharPredicateX<Integer,Integer,X>,Y> r1 = LBiObjCharPredicateX.safeSupplier(()->sut);  //NOSONAR
    }
