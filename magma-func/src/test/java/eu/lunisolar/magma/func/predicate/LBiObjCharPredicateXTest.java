...
public class LBiObjCharPredicateXTest<T1,T2,X extends ParseException> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LBiObjCharTriple<T1,T2>,Boolean,X> theCall = sut;
...
@Test
    ...
    @Test void safeCompiles() {
        LBiObjCharPredicateX r1 = LBiObjCharPredicateX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LBiObjCharPredicateX<T1,T2,X>,Y> r1 = LBiObjCharPredicateX.safeSupplier(()->sut);
    }
