...
public class LFltToDblFunctionTest {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.applyAsDbl(100f), testValue);
    }
    ...
    public void testNonNullApplyAsDbl() throws Throwable {
            Assert.assertEquals(sut.nonNullApplyAsDbl(100f), testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LFltToDblFunction: double applyAsDbl(float a)");
    }

    @Test
    public void testFltToDblFuncMethod() throws Throwable {
        Assert.assertTrue(LFltToDblFunction.fltToDblFunc(a -> testValue ) instanceof LFltToDblFunction);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LFltToDblFunction: double applyAsDbl(float a)"));
