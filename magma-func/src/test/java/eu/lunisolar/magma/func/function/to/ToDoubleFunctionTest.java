...
public class ToDoubleFunctionTest<T,X extends ParseException> {
    ...
    private ToDoubleFunction<T> sut = new ToDoubleFunction(){
        public  double applyAsDouble(Object t)  {
            return testValue;
        }
    };

    private ToDoubleFunctionX<T,X> opposite = new ToDoubleFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ToDoubleFunction: double applyAsDouble(T t)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(ToDoubleFunction.l((Object t) -> testValue ))
            .isInstanceOf(ToDoubleFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(ToDoubleFunction.wrap(opposite))
            .isInstanceOf(ToDoubleFunction.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(ToDoubleFunction.wrapStd(jre))
            .isInstanceOf(ToDoubleFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        // given
        ToDoubleFunctionX<T,X> sutThrowing = ToDoubleFunctionX.lX((T t) -> {
            throw new UnsupportedOperationException(ORIGINAL_MESSAGE);
        });

        // when
        ToDoubleFunction<T> wrapped = ToDoubleFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        ToDoubleFunctionX<T,ParseException> sutThrowing = ToDoubleFunctionX.lX((T t) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        ToDoubleFunction<T> sutThrowing = ToDoubleFunction.l((T t) -> {
            throw new UnsupportedOperationException();
        });

        // when
        ToDoubleFunction<T> wrapped = ToDoubleFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfrom() throws ParseException {
        ...
        ToDoubleFunction<Integer > sutO = (Integer t) -> {
    ...
    @Test
    public void testStd() {
        assertThat(sut.std()).isInstanceOf(java.util.function.ToDoubleFunction.class);
    }

    @Test
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(ToDoubleFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(ToDoubleFunctionX.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ToDoubleFunction<T> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ToDoubleFunction: double applyAsDouble(T t)");
    }
