...
public class LTriFltPredicateTest {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.test(100f,100f,100f), testValue);
    }
    ...
    public void testNonNullTest() throws Throwable {
            Assert.assertEquals(sut.nonNullTest(100f,100f,100f), testValue);
    }
    ...
    public void testApplyAsBooleanShouldNotModifyValue() throws Throwable {
        Assert.assertEquals(sut.doApplyAsBoolean(100f,100f,100f), testValue);
    }


    @Test
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LTriFltPredicate: boolean test(float a1,float a2,float a3)");
    }

    @Test
    public void testTriFltPredMethod() throws Throwable {
        Assert.assertTrue(LTriFltPredicate.triFltPred((a1,a2,a3) -> testValue ) instanceof LTriFltPredicate);
    ...
    public void testnegate() throws Throwable {
        Assert.assertEquals(sut.negate().test(100f,100f,100f), !testValue);
    }
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws Throwable {
        ...
        //then
        Assert.assertEquals(andFunction.test(100f,100f,100f), andResult);

        Assert.assertEquals(orFunction.test(100f,100f,100f), orResult);

        Assert.assertEquals(xorFunction.test(100f,100f,100f), xorResult);
    }
    ...
    public void testIsEqual() throws Throwable  {
        ...
        //then
        Assert.assertTrue(equals.test(1f,1f,1f));

        Assert.assertFalse(equals.test(0f,0f,0f));
    }
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LTriFltPredicate: boolean test(float a1,float a2,float a3)"));
