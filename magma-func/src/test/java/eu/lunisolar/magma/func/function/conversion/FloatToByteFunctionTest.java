...
public class FloatToByteFunctionTest<X extends ParseException> {
    ...
    private FloatToByteFunction sut = new FloatToByteFunction(){
        public  byte applyAsByte(float f)  {
            return testValue;
        }
    };

    private FloatToByteFunctionX<X> opposite = new FloatToByteFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("FloatToByteFunction: byte applyAsByte(float f)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(FloatToByteFunction.l((float f) -> testValue ))
            .isInstanceOf(FloatToByteFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(FloatToByteFunction.wrap(opposite))
            .isInstanceOf(FloatToByteFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        // given
        FloatToByteFunctionX<X> sutThrowing = FloatToByteFunctionX.lX((float f) -> {
            throw new UnsupportedOperationException(ORIGINAL_MESSAGE);
        });

        // when
        FloatToByteFunction wrapped = FloatToByteFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        FloatToByteFunctionX<ParseException> sutThrowing = FloatToByteFunctionX.lX((float f) -> {
    ...
    public void testfromFloat() throws ParseException {
        ...
        FloatToByteFunction sutO = (float f) -> {
        ...
        //when
        FloatToByteFunction function = sutO.fromFloat(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(FloatToByteFunction.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        FloatToByteFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("FloatToByteFunction: byte applyAsByte(float f)");
    }
