...
public class LFloatToByteFunctionTest<X extends ParseException> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LFloatToByteFunction wrapped = LFloatToByteFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
...
//
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LFloatToByteFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
