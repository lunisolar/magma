...
public class LToDoubleFunctionTest<T,X extends ParseException> {
    ...
    public void testLMethod() throws ParseException {
        assertThat(LToDoubleFunction.l((Object t) -> testValue ))
    ...
    public void testWrapStdMethod() throws ParseException {
        assertThat(LToDoubleFunction.wrapStd(jre))
            .isInstanceOf(LToDoubleFunction.class);
    }
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LToDoubleFunctionX<T,ParseException> sutThrowing = LToDoubleFunctionX.lX((T t) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LToDoubleFunction<T> sutThrowing = LToDoubleFunction.l((T t) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LToDoubleFunction<T> wrapped = LToDoubleFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfrom() throws ParseException {
        ...
        LToDoubleFunction<Integer > sutO = (Integer t) -> {
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LToDoubleFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LToDoubleFunctionX.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LToDoubleFunction<T> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
