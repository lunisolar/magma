...
public class LObjIntFunctionTest<T,R,X extends ParseException> {
    ...
    private LObjIntFunction<T,R> sutAlwaysThrowingUnckeck = LObjIntFunction.l((T a1,int a2) -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LObjIntPair<T>,R,RuntimeException> theCall = sut;
    ...
    public void testLMethod() throws X {
        assertThat(LObjIntFunction.l((Object a1,int a2) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LObjIntFunctionX<T,R,ParseException> sutThrowing = LObjIntFunctionX.lX((T a1,int a2) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LObjIntFunction<T,R> sutThrowing = LObjIntFunction.l((T a1,int a2) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LObjIntFunction<T,R> wrapped = sutThrowing.handleObjIntFunc(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LObjIntFunction<T,R> wrapped = sutThrowing.handleObjIntFunc(h -> Function4U.doNothing());
    ...
    public void testHandleObjIntFunc() throws X {
        ...
        // when
        LObjIntFunction<T,R> wrapped = sutThrowing.handleObjIntFunc(h -> {
    ...
    public void compilerSubstituteVariant1() {
        LObjIntFunction lambda = LObjIntFunction./*<T,R>*/l1(this::variant1);
    ...
    @Test void safeCompiles() {
        LObjIntFunction r1 = LObjIntFunction.safe(sut);
        LObjIntFunctionX r2 = LObjIntFunction.safe(sut);
    }
    ...
    @Test  void safeSupplierPropagates() {
        LSupplier<LObjIntFunction<T,R>> supplier = ()->sut;
    ...
    @Test  void safeSupplierCompiles() {
        LSupplier<LObjIntFunction<T,R>> r1 = LObjIntFunction.safeSupplier(()->sut);
    }
