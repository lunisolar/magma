...
public class LLongToByteFunctionTest<X extends ParseException> {
    ...
    private LLongToByteFunction sutAlwaysThrowingUnckeck = LLongToByteFunction.l(a1 -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LLongToByteFunction: byte doApplyAsByte(long a1)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LLongToByteFunction.l(a1 -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LLongToByteFunctionX<ParseException> sutThrowing = LLongToByteFunctionX.lX(a1 -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LLongToByteFunction sutThrowing = LLongToByteFunction.l(a1 -> {
            throw new UnsupportedOperationException();
        });

        // when
        LLongToByteFunction wrapped = sutThrowing.handleLongToByteFunc(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LLongToByteFunction wrapped = sutThrowing.handleLongToByteFunc(h -> Function4U.doNothing());
    ...
    public void testlongToByteFuncComposeLong() throws X {
        ...
        //when
        LLongToByteFunction function = sutO.longToByteFuncComposeLong(before1);
    ...
    public void testlongToByteFuncCompose() throws X {
        ...
        //when
        LToByteFunction<Integer > function = sutO.longToByteFuncCompose(before1);
    ...
    public void testHandleLongToByteFunc() throws X {
        ...
        // when
        LLongToByteFunction wrapped = sutThrowing.handleLongToByteFunc(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LLongToByteFunction: byte doApplyAsByte(long a1)");
    }
    ...
    @Test void safeProtectsAgainstNpe() {
        ...
        assertThat(result).isSameAs(LLongToByteFunction.l(LLongToByteFunction.safe()));
    }
