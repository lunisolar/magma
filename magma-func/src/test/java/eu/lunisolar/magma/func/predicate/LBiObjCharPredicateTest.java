...
public class LBiObjCharPredicateTest<T1,T2,X extends ParseException> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LBiObjCharPredicate<T1,T2> wrapped = LBiObjCharPredicate.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromChar() throws ParseException {
        ...
        //when
        LBiObjCharPredicate<Integer ,Integer > function = sutO.fromChar(before1,before2,before3);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LBiObjCharPredicate.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LBiObjCharPredicateX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().doTest((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),(char)100);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LBiObjCharPredicate<T1,T2> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
