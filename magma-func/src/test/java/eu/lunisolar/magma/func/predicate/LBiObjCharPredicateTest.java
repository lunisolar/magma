...
public class LBiObjCharPredicateTest<T1,T2> {
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBiObjCharPredicate: boolean test(T1 a1,T2 a2,char a3)");
    }
    ...
    public void testToString() throws Throwable {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBiObjCharPredicate: boolean test(T1 a1,T2 a2,char a3)");
    }
    ...
    public void compilerSubstituteVariantLObj0Char2Obj1Pred() {
        ...
        assertThat(lambda).isInstanceOf(LBiObjCharPredicate.LObj0Char2Obj1Pred.class);
    }
    ...
    public void compilerSubstituteVariantLObj1Obj0Char2Pred() {
        ...
        assertThat(lambda).isInstanceOf(LBiObjCharPredicate.LObj1Obj0Char2Pred.class);
    }
    ...
    public void compilerSubstituteVariantLObj1Char2Obj0Pred() {
        ...
        assertThat(lambda).isInstanceOf(LBiObjCharPredicate.LObj1Char2Obj0Pred.class);
    }
    ...
    public void compilerSubstituteVariantLChar2Obj0Obj1Pred() {
        ...
        assertThat(lambda).isInstanceOf(LBiObjCharPredicate.LChar2Obj0Obj1Pred.class);
    }
    ...
    public void compilerSubstituteVariantLChar2Obj1Obj0Pred() {
        ...
        assertThat(lambda).isInstanceOf(LBiObjCharPredicate.LChar2Obj1Obj0Pred.class);
    }
