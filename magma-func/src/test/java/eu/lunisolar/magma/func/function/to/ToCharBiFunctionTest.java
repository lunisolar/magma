...
public class ToCharBiFunctionTest<T1,T2,X extends ParseException> {
    ...
    private ToCharBiFunction<T1,T2> sut = new ToCharBiFunction(){
        public  char applyAsChar(Object t1,Object t2)  {
            return testValue;
        }
    };

    private ToCharBiFunctionX<T1,T2,X> opposite = new ToCharBiFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ToCharBiFunction: char applyAsChar(T1 t1,T2 t2)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(ToCharBiFunction.l((Object t1,Object t2) -> testValue ))
            .isInstanceOf(ToCharBiFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(ToCharBiFunction.wrap(opposite))
            .isInstanceOf(ToCharBiFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        ToCharBiFunction<T1,T2> wrapped = ToCharBiFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        ToCharBiFunctionX<T1,T2,ParseException> sutThrowing = ToCharBiFunctionX.lX((T1 t1,T2 t2) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        ToCharBiFunction<T1,T2> sutThrowing = ToCharBiFunction.l((T1 t1,T2 t2) -> {
            throw new UnsupportedOperationException();
        });

        // when
        ToCharBiFunction<T1,T2> wrapped = ToCharBiFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfrom() throws ParseException {
        ...
        ToCharBiFunction<Integer ,Integer > sutO = (Integer t1,Integer t2) -> {
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ToCharBiFunction<T1,T2> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ToCharBiFunction: char applyAsChar(T1 t1,T2 t2)");
    }
