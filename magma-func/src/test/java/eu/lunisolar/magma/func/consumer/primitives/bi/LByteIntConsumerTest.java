...
public class LByteIntConsumerTest {
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LByteIntConsumer: void accept(byte a1,int a2)");
    }

    @Test
    public void testByteIntConsMethod() throws Throwable {
        Assert.assertTrue(LByteIntConsumer.byteIntCons(LByteIntConsumer::doNothing) instanceof LByteIntConsumer);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LByteIntConsumer: void accept(byte a1,int a2)"));
    ...
    public void compilerSubstituteVariantLIntByteCons() {
        ...
        Assert.assertTrue(lambda instanceof LByteIntConsumer.LIntByteCons);
    }
