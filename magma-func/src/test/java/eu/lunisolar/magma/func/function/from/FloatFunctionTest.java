...
public class FloatFunctionTest<R,X extends ParseException> {
    ...
    private FloatFunction<R> sut = new FloatFunction(){
        public @Nullable Object  apply(float f)  {
            return testValue;
        }
    };

    private FloatFunctionX<R,X> opposite = new FloatFunctionX(){
        public @Nullable Object  apply(float f) throws ParseException {
            return testValue;
        }
    };

    private FloatFunction<R> sutNull = new FloatFunction(){
        public @Nullable Object  apply(float f)  {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (FloatFunction: R apply(float f)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("FloatFunction: R apply(float f)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(FloatFunction.l((float f) -> testValue ))
            .isInstanceOf(FloatFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(FloatFunction.wrap(opposite))
            .isInstanceOf(FloatFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        FloatFunction<R> wrapped = FloatFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        FloatFunctionX<R,ParseException> sutThrowing = FloatFunctionX.lX((float f) -> {
    ...
    public void testfromFloat() throws ParseException {
        ...
        FloatFunction<Integer > sutO = (float f) -> {
        ...
        //when
        FloatFunction<Integer > function = sutO.fromFloat(before1);
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        FloatConsumer function = sutO.then(thenFunction);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        FloatFunction<R> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("FloatFunction: R apply(float f)");
    }
