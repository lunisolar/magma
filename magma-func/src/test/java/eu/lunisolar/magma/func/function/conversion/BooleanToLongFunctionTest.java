...
public class BooleanToLongFunctionTest<X extends ParseException> {
    ...
    private BooleanToLongFunction sut = new BooleanToLongFunction(){
        public  long applyAsLong(boolean b)  {
            return testValue;
        }
    };

    private BooleanToLongFunctionX<X> opposite = new BooleanToLongFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BooleanToLongFunction: long applyAsLong(boolean b)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(BooleanToLongFunction.l((boolean b) -> testValue ))
            .isInstanceOf(BooleanToLongFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(BooleanToLongFunction.wrap(opposite))
            .isInstanceOf(BooleanToLongFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        BooleanToLongFunction wrapped = BooleanToLongFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        BooleanToLongFunctionX<ParseException> sutThrowing = BooleanToLongFunctionX.lX((boolean b) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        BooleanToLongFunction sutThrowing = BooleanToLongFunction.l((boolean b) -> {
            throw new UnsupportedOperationException();
        });

        // when
        BooleanToLongFunction wrapped = BooleanToLongFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromBoolean() throws ParseException {
        ...
        BooleanToLongFunction sutO = (boolean b) -> {
        ...
        //when
        BooleanToLongFunction function = sutO.fromBoolean(before1);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        BooleanToLongFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BooleanToLongFunction: long applyAsLong(boolean b)");
    }
