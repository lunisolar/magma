...
public class LLongSupplierTest<X extends ParseException> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LLongSupplier wrapped = LLongSupplier.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
...
//
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LLongSupplier wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
