...
public class ObjDoubleFunctionTest<T,R,X extends ParseException> {
    ...
    private ObjDoubleFunction<T,R> sut = new ObjDoubleFunction(){
        public @Nullable Object  apply(Object t, double d)  {
            return testValue;
        }
    };

    private ObjDoubleFunctionX<T,R,X> opposite = new ObjDoubleFunctionX(){
        public @Nullable Object  apply(Object t, double d) throws ParseException {
            return testValue;
        }
    };

    private ObjDoubleFunction<T,R> sutNull = new ObjDoubleFunction(){
        public @Nullable Object  apply(Object t, double d)  {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (ObjDoubleFunction: R apply(T t, double d)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ObjDoubleFunction: R apply(T t, double d)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(ObjDoubleFunction.l((Object t, double d) -> testValue ))
            .isInstanceOf(ObjDoubleFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(ObjDoubleFunction.wrap(opposite))
            .isInstanceOf(ObjDoubleFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        ObjDoubleFunction<T,R> wrapped = ObjDoubleFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        ObjDoubleFunctionX<T,R,ParseException> sutThrowing = ObjDoubleFunctionX.lX((T t, double d) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        ObjDoubleFunction<T,R> sutThrowing = ObjDoubleFunction.l((T t, double d) -> {
            throw new UnsupportedOperationException();
        });

        // when
        ObjDoubleFunction<T,R> wrapped = ObjDoubleFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromDouble() throws ParseException {
        ...
        ObjDoubleFunction<Integer ,Integer > sutO = (Integer t, double d) -> {
        ...
        //when
        ObjDoubleFunction<Integer ,Integer > function = sutO.fromDouble(before1,before2);
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        ObjDoubleConsumer<Integer > function = sutO.then(thenFunction);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ObjDoubleFunction<T,R> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ObjDoubleFunction: R apply(T t, double d)");
    }
