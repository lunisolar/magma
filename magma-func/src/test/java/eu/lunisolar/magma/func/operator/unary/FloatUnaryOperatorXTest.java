...
public class FloatUnaryOperatorXTest<X extends ParseException> {
    ...
    private FloatUnaryOperatorX<X> sut = new FloatUnaryOperatorX(){
        public  float applyAsFloat(float f) throws ParseException {
            return testValue;
        }
    };

    private FloatUnaryOperator opposite = new FloatUnaryOperator(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("FloatUnaryOperatorX: float applyAsFloat(float f) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(FloatUnaryOperatorX.lX((float f) -> testValue ))
            .isInstanceOf(FloatUnaryOperatorX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(FloatUnaryOperatorX.wrapX(opposite))
            .isInstanceOf(FloatUnaryOperatorX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        FloatUnaryOperatorX<X> sutThrowing = FloatUnaryOperatorX.lX((float f) -> {
            throw new UnsupportedOperationException();
        });

        // when
        FloatUnaryOperatorX<X> wrapped = FloatUnaryOperatorX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromFloat() throws ParseException {
        ...
        FloatUnaryOperatorX<X> sutO = (float f) -> {
        ...
        //when
        FloatUnaryOperatorX<X> function = sutO.fromFloat(before1);
    ...
    public void identity() throws ParseException {
        FloatUnaryOperatorX<X> identityFunction = FloatUnaryOperatorX.identity();
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(FloatUnaryOperator.class);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        FloatUnaryOperatorX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("FloatUnaryOperatorX: float applyAsFloat(float f) throws X");
    }
