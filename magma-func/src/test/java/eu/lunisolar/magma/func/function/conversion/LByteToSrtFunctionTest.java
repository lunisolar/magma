...
public class LByteToSrtFunctionTest {
    ...
    private LByteToSrtFunction sut = new LByteToSrtFunction(){
    ...
    private LByteToSrtFunction sutAlwaysThrowing = LByteToSrtFunction.byteToSrtFunc(a -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LByteToSrtFunction sutAlwaysThrowingUnchecked = LByteToSrtFunction.byteToSrtFunc(a -> {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.applyAsSrt((byte)100), testValue);
    }
    ...
    public void testNonNullApplyAsSrt() throws Throwable {
            Assert.assertEquals(sut.nonNullApplyAsSrt((byte)100), testValue);
    }
    ...
    public void testNestingApplyAsSrtUnchecked() throws Throwable {
        ...
        // then
        try {
            sutAlwaysThrowingUnchecked.nestingApplyAsSrt((byte)100);
    ...
    public void testShovingApplyAsSrtUnchecked() throws Throwable {
        ...
        // then
        try {
            sutAlwaysThrowingUnchecked.shovingApplyAsSrt((byte)100);
            Assert.fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            Assert.assertEquals(e.getClass(), IndexOutOfBoundsException.class);
            Assert.assertNull(e.getCause());
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LByteToSrtFunction: short applyAsSrt(byte a)");
    }

    @Test
    public void testByteToSrtFuncMethod() throws Throwable {
        Assert.assertTrue(LByteToSrtFunction.byteToSrtFunc(a -> testValue ) instanceof LByteToSrtFunction);
    ...
    public void testCompose() throws Throwable {
        ...
        //when
        LByteToSrtFunction function = sutO.compose(before);
        function.applyAsSrt((byte)80);
    ...
    @Test
    public void testByteToSrtFuncCompose() throws Throwable {
        ...
        //when
        LToSrtFunction<Integer> function = sutO.byteToSrtFuncCompose(before);
    ...
    public void testShove() {
        ...
        // given
        LByteToSrtFunction sutThrowing = LByteToSrtFunction.byteToSrtFunc(a -> {
            throw new UnsupportedOperationException();
        });

        // when
        sutThrowing.shovingApplyAsSrt((byte)100);
    }
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LByteToSrtFunction: short applyAsSrt(byte a)"));
