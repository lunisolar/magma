...
public class ShortToCharFunctionTest<X extends ParseException> {
    ...
    private ShortToCharFunction sut = new ShortToCharFunction(){
        public  char applyAsChar(short s)  {
            return testValue;
        }
    };

    private ShortToCharFunctionX<X> opposite = new ShortToCharFunctionX(){
        public  char applyAsChar(short s) throws ParseException {
            return testValue;
        }
    };
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ShortToCharFunction: char applyAsChar(short s)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(ShortToCharFunction.l((short s) -> testValue ))
            .isInstanceOf(ShortToCharFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(ShortToCharFunction.wrap(opposite))
            .isInstanceOf(ShortToCharFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        // given
        ShortToCharFunctionX<X> sutThrowing = ShortToCharFunctionX.lX((short s) -> {
            throw new UnsupportedOperationException(ORIGINAL_MESSAGE);
        });

        // when
        ShortToCharFunction wrapped = ShortToCharFunction.wrap(sutThrowing);

        // then
        try {
            wrapped.applyAsChar((short)100);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        ShortToCharFunctionX<ParseException> sutThrowing = ShortToCharFunctionX.lX((short s) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        ShortToCharFunction sutThrowing = ShortToCharFunction.l((short s) -> {
            throw new UnsupportedOperationException();
        });

        // when
        ShortToCharFunction wrapped = ShortToCharFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromShort() throws ParseException {
        ...
        ShortToCharFunction sutO = (short s) -> {
        ...
        //when
        ShortToCharFunction function = sutO.fromShort(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(ShortToCharFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(ShortToCharFunctionX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().applyAsChar((short)100);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ShortToCharFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ShortToCharFunction: char applyAsChar(short s)");
    }
