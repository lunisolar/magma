...
public class LShortToIntFunctionXTest<X extends ParseException> {
    ...
    private LShortToIntFunctionX<X> sut = new LShortToIntFunctionX<X>(){
        public  int doApplyAsInt(short a)  throws X {
            return testValue;
        }
    };

    private LShortToIntFunction opposite = new LShortToIntFunction(){
    ...
    private LShortToIntFunctionX<ParseException> sutAlwaysThrowing = LShortToIntFunctionX.lX(a -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LShortToIntFunctionX<RuntimeException> sutAlwaysThrowingUnchecked = LShortToIntFunctionX.lX(a -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LShortToIntFunctionX: int doApplyAsInt(short a) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LShortToIntFunctionX.lX(a -> testValue ))
            .isInstanceOf(LShortToIntFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws X {
        assertThat(LShortToIntFunctionX.wrapX(opposite))
            .isInstanceOf(LShortToIntFunctionX.class);
    }
    ...
    public void testHandlingDoApplyAsIntMethodWrapsTheException() throws X {
        ...
        // given
        LShortToIntFunctionX<X> sutThrowing = LShortToIntFunctionX.lX(a -> {
            throw new UnsupportedOperationException();
        });

        // when
        LShortToIntFunctionX<RuntimeException> wrapped = sutThrowing.handleShortToIntFuncX(handler -> handler
    ...
    @Test
    public void testHandleShortToIntFuncXMethodDoNotWrapsOtherExceptionIf() throws X {
        ...
        // when
        LShortToIntFunctionX<X> wrapped = sutThrowing.handleShortToIntFuncX(handler -> handler
                .wrapIf(UnsupportedOperationException.class::isInstance,IllegalArgumentException::new,  EXCEPTION_WAS_WRAPPED)
...
@Test
    public void testHandleShortToIntFuncXMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleShortToIntFuncXMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LShortToIntFunctionX<X> wrapped = sutThrowing.handleShortToIntFuncX(h -> Function4U.doNothing());
    ...
    public void testShortToIntFuncComposeShort() throws X {
        ...
        //when
        LShortToIntFunctionX<X> function = sutO.shortToIntFuncComposeShort(before);
    ...
    public void testShortToIntFuncCompose() throws X {
        ...
        //when
        LToIntFunctionX<Integer,X> function = sutO.shortToIntFuncCompose(before);
    ...
    public void testHandleShortToIntFunc() throws X {
        ...
        // when
        LShortToIntFunctionX<X> wrapped = sutThrowing.handleShortToIntFuncX(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LShortToIntFunctionX: int doApplyAsInt(short a) throws X");
    }
    ...
    @Test void safeCompiles() {
        LShortToIntFunctionX r1 = LShortToIntFunctionX.safe(sut); //NOSONAR
    }

    @Test void safePropagates() {
        Object result = LShortToIntFunctionX.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LShortToIntFunctionX.safe(null);
        assertThat(result).isSameAs(LShortToIntFunctionX.lX(LShortToIntFunctionX.safe()));
    }

    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LShortToIntFunctionX<X>,Y> supplier = ()->sut;
        Object result = LShortToIntFunctionX.safeSupplier(supplier);
        assertThat(result).isSameAs(supplier);
    }

    @Test <Y extends Throwable> void safeSupplierProtectsAgainstNpe() {
        Object result = LShortToIntFunctionX.safeSupplier(null);
        assertThat(result).isSameAs(LShortToIntFunctionX.safeSupplier());
    }

    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LShortToIntFunctionX<X>,Y> r1 = LShortToIntFunctionX.safeSupplier(()->sut);  //NOSONAR
    }
