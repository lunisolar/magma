...
public class LBiDoubleConsumerTest<X extends ParseException> {
    ...
    private LBiDoubleConsumer sutAlwaysThrowingUnckeck = LBiDoubleConsumer.l((double d1,double d2) -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBiDoubleConsumer: void doAccept(double d1,double d2)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LBiDoubleConsumer.l((double d1,double d2) -> Function4U.doNothing() ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LBiDoubleConsumerX<ParseException> sutThrowing = LBiDoubleConsumerX.lX((double d1,double d2) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LBiDoubleConsumer sutThrowing = LBiDoubleConsumer.l((double d1,double d2) -> {
...
@Test
    ...
    public void testbiDoubleConsComposeDouble() throws X {
        ...
        LBiDoubleConsumer sutO = (double d1,double d2) -> {
    ...
    public void testAndThen() throws X {
        ...
        LBiDoubleConsumer thenFunction = (double d1,double d2) -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBiDoubleConsumer: void doAccept(double d1,double d2)");
    }
