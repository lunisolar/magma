...
public class LDoubleFunctionTest<R,X extends ParseException> {
    ...
    private LDoubleFunction<R> sut = new LDoubleFunction(){
        public @Nullable Object  doApply(double a1)  {
            return testValue;
        }
    };

    private LDoubleFunctionX<R,X> opposite = new LDoubleFunctionX(){
        public @Nullable Object  doApply(double a1) throws ParseException {
            return testValue;
        }
    };
    ...
    private DoubleFunction jre = a1 -> testValue;



    private LDoubleFunction<R> sutAlwaysThrowingUnckeck = LDoubleFunction.l(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LDoubleSingle,R,RuntimeException> theCall = sut;
    ...
    public void testNestingDoApplyUnckeck() throws X {
        ...
        // then
        try {
            sutAlwaysThrowingUnckeck.nestingDoApply((double)100);
    ...
    public void testShovingDoApplyUnckeck() throws X {
        ...
        // then
        try {
            sutAlwaysThrowingUnckeck.shovingDoApply((double)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
                    .isExactlyInstanceOf(IndexOutOfBoundsException.class)
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNullDoApply() method cannot be null (LDoubleFunction: R doApply(double a1)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LDoubleFunction: R doApply(double a1)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LDoubleFunction.l(a1 -> testValue ))
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws X {
        // given
        LDoubleFunctionX<R,X> sutThrowing = LDoubleFunctionX.lX(a1 -> {
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LDoubleFunctionX<R,ParseException> sutThrowing = LDoubleFunctionX.lX(a1 -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LDoubleFunction<R> sutThrowing = LDoubleFunction.l(a1 -> {
            throw new UnsupportedOperationException();
        });

        // when
        LDoubleFunction<R> wrapped = sutThrowing.handleDoubleFunc(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LDoubleFunction<R> wrapped = sutThrowing.handleDoubleFunc(h -> Function4U.doNothing());
    ...
    public void testdoubleFuncComposeDouble() throws X {
        ...
        LDoubleFunction<Integer > sutO = a1 -> {
        ...
        //when
        LDoubleFunction<Integer > function = sutO.doubleFuncComposeDouble(before1);
        function.doApply((double)80);
    ...
    public void testdoubleFuncCompose() throws X {
        ...
        //when
        LFunction<Integer ,Integer > function = sutO.doubleFuncCompose(before1);
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingDoubleFunc().doApply((double)100);
    }
    ...
    public void testHandleDoubleFunc() throws X {
        ...
        // when
        LDoubleFunction<R> wrapped = sutThrowing.handleDoubleFunc(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LDoubleFunction: R doApply(double a1)");
    }
    ...
    @Test void safeCompiles() {
        LDoubleFunction r1 = LDoubleFunction.safe(sut);
        LDoubleFunctionX r2 = LDoubleFunction.safe(sut);
        DoubleFunction r3 = LDoubleFunction.safe(sut);
    }
    ...
    @Test  void safeSupplierPropagates() {
        LSupplier<LDoubleFunction<R>> supplier = ()->sut;
    ...
    @Test  void safeSupplierCompiles() {
        LSupplier<LDoubleFunction<R>> r1 = LDoubleFunction.safeSupplier(()->sut);
        Supplier<LDoubleFunction<R>> r2 = LDoubleFunction.safeSupplier(()->sut);
    }
