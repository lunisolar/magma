...
public class LBiLongFunctionXTest<R,X extends ParseException> {
    ...
    private LBiLongFunctionX<Integer,X> sut = new LBiLongFunctionX<Integer,X>(){
        public @Nullable Integer doApply(long a1,long a2)  throws X {
            return testValue;
        }
    };

    private LBiLongFunction<Integer> opposite = new LBiLongFunction<Integer>(){
        public @Nullable Integer doApply(long a1,long a2)  {
            return testValue;
        }
    };

    private LBiLongFunctionX<Integer,X> sutNull = new LBiLongFunctionX<Integer,X>(){
        public @Nullable Integer doApply(long a1,long a2)  throws X {
            return null;
        }
    };
    ...
    private LBiLongFunctionX<Integer,ParseException> sutAlwaysThrowing = LBiLongFunctionX.lX((a1,a2) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiLongFunctionX<Integer,RuntimeException> sutAlwaysThrowingUnchecked = LBiLongFunctionX.lX((a1,a2) -> {
    ...
    public void testNestingDoApplyChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoApply(100L,100L);
    ...
    public void testShovingDoApplyChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoApply(100L,100L);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testLXMethod() throws X {
        assertThat(LBiLongFunctionX.lX((a1,a2) -> testValue ))
    ...
    public void testHandlingDoApplyMethodWrapsTheException() throws X {
        ...
        // when
        LBiLongFunctionX<Integer,RuntimeException> wrapped = sutThrowing.handleBiLongFuncX(handler -> handler
    ...
    @Test
    public void testHandleBiLongFuncXMethodDoNotWrapsOtherExceptionIf() throws X {
        ...
        // when
        LBiLongFunctionX<Integer,X> wrapped = sutThrowing.handleBiLongFuncX(handler -> handler
                .wrapIf(UnsupportedOperationException.class::isInstance,IllegalArgumentException::new,  EXCEPTION_WAS_WRAPPED)
...
@Test
    public void testHandleBiLongFuncXMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleBiLongFuncXMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBiLongFunctionX<Integer,X> wrapped = sutThrowing.handleBiLongFuncX(h -> Function4U.doNothing());
    ...
    public void testHandleBiLongFunc() throws X {
        ...
        // when
        LBiLongFunctionX<Integer,X> wrapped = sutThrowing.handleBiLongFuncX(h -> {
    ...
    public void compilerSubstituteVariantV1() {
        LBiLongFunctionX lambda = LBiLongFunctionX./*<R,X>*/lX1(this::variantV1);
    ...
    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LBiLongFunctionX<Integer,X>,Y> supplier = ()->sut;
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LBiLongFunctionX<Integer,X>,Y> r1 = LBiLongFunctionX.safeSupplier(()->sut);  //NOSONAR
    }
