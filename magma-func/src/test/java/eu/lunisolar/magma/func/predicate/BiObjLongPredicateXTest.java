...
public class BiObjLongPredicateXTest<T1,T2,X extends ParseException> {
    ...
    private BiObjLongPredicateX<T1,T2,X> sut = new BiObjLongPredicateX(){
        public  boolean test(Object t1,Object t2, long l) throws ParseException {
            return testValue;
        }
    };

    private BiObjLongPredicate<T1,T2> opposite = new BiObjLongPredicate(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BiObjLongPredicateX: boolean test(T1 t1,T2 t2, long l) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(BiObjLongPredicateX.lX((Object t1,Object t2, long l) -> testValue ))
            .isInstanceOf(BiObjLongPredicateX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(BiObjLongPredicateX.wrapX(opposite))
            .isInstanceOf(BiObjLongPredicateX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        BiObjLongPredicateX<T1,T2,X> wrapped = BiObjLongPredicateX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws ParseException {
        ...
        //given
        BiObjLongPredicateX<T1,T2,X> fun1 = BiObjLongPredicateX.lX((T1 t1,T2 t2, long l) -> f1Result);
        BiObjLongPredicateX<T1,T2,X> fun2 = BiObjLongPredicateX.lX((T1 t1,T2 t2, long l) -> f2Result);

        //when
        BiObjLongPredicateX<T1,T2,X> andFunction = fun1.and(fun2);
        BiObjLongPredicateX<T1,T2,X> orFunction = fun1.or(fun2);
        BiObjLongPredicateX<T1,T2,X> xorFunction = fun1.xor(fun2);
    ...
    public void isEqual() throws ParseException  {
        //when
        BiObjLongPredicateX<T1,T2,X> equals = BiObjLongPredicateX.isEqual((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),(long)100);
    ...
    public void testfromLong() throws ParseException {
        ...
        BiObjLongPredicateX<Integer ,Integer ,X> sutO = (Integer t1,Integer t2, long l) -> {
        ...
        //when
        BiObjLongPredicateX<Integer ,Integer ,X> function = sutO.fromLong(before1,before2,before3);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        BiObjLongPredicateX<T1,T2,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BiObjLongPredicateX: boolean test(T1 t1,T2 t2, long l) throws X");
    }
