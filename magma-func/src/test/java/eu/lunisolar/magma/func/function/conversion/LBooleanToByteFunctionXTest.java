...
public class LBooleanToByteFunctionXTest<X extends ParseException> {
    ...
    private LBooleanToByteFunctionX<ParseException> sutAlwaysThrowing = LBooleanToByteFunctionX.lX((boolean b) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBooleanToByteFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LBooleanToByteFunctionX.lX((boolean b) -> {
    ...
    public void testLXMethod() throws ParseException {
        assertThat(LBooleanToByteFunctionX.lX((boolean b) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LBooleanToByteFunctionX<X> wrapped = LBooleanToByteFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromBoolean() throws ParseException {
        ...
        LBooleanToByteFunctionX<X> sutO = (boolean b) -> {
...
//
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LBooleanToByteFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
