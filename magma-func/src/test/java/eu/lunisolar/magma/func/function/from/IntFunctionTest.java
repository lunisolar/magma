...
public class IntFunctionTest<R,X extends ParseException> {
    ...
    private IntFunction<R> sut = new IntFunction(){
        public @Nullable Object  apply(int i)  {
            return testValue;
        }
    };

    private IntFunctionX<R,X> opposite = new IntFunctionX(){
        public @Nullable Object  apply(int i) throws ParseException {
            return testValue;
        }
    };

    private IntFunction<R> sutNull = new IntFunction(){
        public @Nullable Object  apply(int i)  {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (IntFunction: R apply(int i)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("IntFunction: R apply(int i)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(IntFunction.l((int i) -> testValue ))
            .isInstanceOf(IntFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(IntFunction.wrap(opposite))
            .isInstanceOf(IntFunction.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(IntFunction.wrapStd(jre))
            .isInstanceOf(IntFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        IntFunction<R> wrapped = IntFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        IntFunctionX<R,ParseException> sutThrowing = IntFunctionX.lX((int i) -> {
    ...
    public void testfromInt() throws ParseException {
        ...
        IntFunction<Integer > sutO = (int i) -> {
        ...
        //when
        IntFunction<Integer > function = sutO.fromInt(before1);
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        IntConsumer function = sutO.then(thenFunction);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        IntFunction<R> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("IntFunction: R apply(int i)");
    }
