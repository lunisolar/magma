...
public class LSrtToLongFunctionTest {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.applyAsLong((short)100), testValue);
    }
    ...
    public void testNonNullApplyAsLong() throws Throwable {
            Assert.assertEquals(sut.nonNullApplyAsLong((short)100), testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LSrtToLongFunction: long applyAsLong(short a)");
    }

    @Test
    public void testSrtToLongFuncMethod() throws Throwable {
        Assert.assertTrue(LSrtToLongFunction.srtToLongFunc(a -> testValue ) instanceof LSrtToLongFunction);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LSrtToLongFunction: long applyAsLong(short a)"));
