...
public class LObjFloatFunctionXTest<T,R,X extends ParseException> {
    ...
    private LObjFloatFunctionX<T,R,ParseException> sutAlwaysThrowing = LObjFloatFunctionX.lX((T a1,float a2) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LObjFloatFunctionX<T,R,RuntimeException> sutAlwaysThrowingUnckeck = LObjFloatFunctionX.lX((T a1,float a2) -> {
    ...
    public void testLXMethod() throws X {
        assertThat(LObjFloatFunctionX.lX((Object a1,float a2) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // when
        LObjFloatFunctionX<T,R,X> wrapped = sutThrowing.handleObjFloatFuncX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LObjFloatFunctionX<T,R,X> wrapped = sutThrowing.handleObjFloatFuncX(h -> Function4U.doNothing());
    ...
    public void testHandleObjFloatFunc() throws X {
        ...
        // when
        LObjFloatFunctionX<T,R,X> wrapped = sutThrowing.handleObjFloatFuncX(h -> {
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LObjFloatFunctionX<T,R,X>,Y> r1 = LObjFloatFunctionX.safeSupplier(()->sut);  //NOSONAR
    }
