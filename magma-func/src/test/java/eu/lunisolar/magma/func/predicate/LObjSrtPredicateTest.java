...
public class LObjSrtPredicateTest<T> {
    ...
    private LObjSrtPredicate<Integer> sut = new LObjSrtPredicate<Integer>(){
        public  boolean doTestX(Integer a1,short a2)  {
            return testValue;
        }
    };
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LObjSrtPredicate: boolean doTest(T a1,short a2)");
    }
    ...
    @Test
    public void testObjSrtPredComposeSrt() throws Throwable {
        ...
        //when
        LObjSrtPredicate<Integer> function = sutO.objSrtPredComposeSrt(before1,before2);
    ...
    public void testNesting() {
        assertThat(sut.nestingObjSrtPred())
            .isSameAs(sut)
            .isInstanceOf(LObjSrtPredicate.class);
    }
    ...
    public void testShoving() {
        assertThat(sut.shovingObjSrtPred())
            .isSameAs(sut)
            .isInstanceOf(LObjSrtPredicate.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingObjSrtPred().doTest(100,(short)100);
    }
    ...
    public void testToString() throws Throwable {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LObjSrtPredicate: boolean doTest(T a1,short a2)");
    }
