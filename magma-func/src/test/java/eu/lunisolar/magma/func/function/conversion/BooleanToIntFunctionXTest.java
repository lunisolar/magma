...
public class BooleanToIntFunctionXTest<X extends ParseException> {
    ...
    private BooleanToIntFunctionX<X> sut = new BooleanToIntFunctionX(){
        public  int applyAsInt(boolean b) throws ParseException {
            return testValue;
        }
    };

    private BooleanToIntFunction opposite = new BooleanToIntFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BooleanToIntFunctionX: int applyAsInt(boolean b) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(BooleanToIntFunctionX.lX((boolean b) -> testValue ))
            .isInstanceOf(BooleanToIntFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(BooleanToIntFunctionX.wrapX(opposite))
            .isInstanceOf(BooleanToIntFunctionX.class);
    }
    ...
    public void testfromBoolean() throws ParseException {
        ...
        BooleanToIntFunctionX<X> sutO = (boolean b) -> {
        ...
        //when
        BooleanToIntFunctionX<X> function = sutO.fromBoolean(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        BooleanToIntFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BooleanToIntFunctionX: int applyAsInt(boolean b) throws X");
    }
