...
public class LBiObjShortFunctionTest<T1,T2,R,X extends ParseException> {
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (LBiObjShortFunction: R doApply(T1 t1,T2 t2, short s)).\\E")
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LBiObjShortFunction<T1,T2,R> wrapped = LBiObjShortFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromShort() throws ParseException {
        ...
        //when
        LBiObjShortFunction<Integer ,Integer ,Integer > function = sutO.fromShort(before1,before2,before3);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LBiObjShortFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LBiObjShortFunctionX.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LBiObjShortFunction<T1,T2,R> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
