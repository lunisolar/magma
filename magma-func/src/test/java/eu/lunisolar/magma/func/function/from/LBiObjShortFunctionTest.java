...
public class LBiObjShortFunctionTest<T1,T2,R,X extends ParseException> {
    ...
    private LBiObjShortFunction<T1,T2,R> sutAlwaysThrowingUnckeck = LBiObjShortFunction.l((T1 t1,T2 t2, short s) -> {
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNullDoApply() method cannot be null (LBiObjShortFunction: R doApply(T1 t1,T2 t2, short s)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBiObjShortFunction: R doApply(T1 t1,T2 t2, short s)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LBiObjShortFunction.l((Object t1,Object t2, short s) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LBiObjShortFunctionX<T1,T2,R,ParseException> sutThrowing = LBiObjShortFunctionX.lX((T1 t1,T2 t2, short s) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LBiObjShortFunction<T1,T2,R> sutThrowing = LBiObjShortFunction.l((T1 t1,T2 t2, short s) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LBiObjShortFunction<T1,T2,R> wrapped = sutThrowing.handleBiObjSFunc(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBiObjShortFunction<T1,T2,R> wrapped = sutThrowing.handleBiObjSFunc(h -> Function4U.doNothing());
    ...
    public void testbiObjSFuncFromShort() throws X {
        ...
        LBiObjShortFunction<Integer ,Integer ,Integer > sutO = (Integer t1,Integer t2, short s) -> {
        ...
        //when
        LBiObjShortFunction<Integer ,Integer ,Integer > function = sutO.biObjSFuncFromShort(before1,before2,before3);
    ...
    public void testbiObjSFuncFrom() throws X {
        ...
        //when
        LTriFunction<Integer ,Integer ,Integer ,Integer > function = sutO.biObjSFuncFrom(before1,before2,before3);
    ...
    public void testHandleBiObjSFunc() throws X {
        ...
        // when
        LBiObjShortFunction<T1,T2,R> wrapped = sutThrowing.handleBiObjSFunc(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBiObjShortFunction: R doApply(T1 t1,T2 t2, short s)");
    }
