...
public class LCharToByteFunctionXTest<X extends ParseException> {
    ...
    private LCharToByteFunctionX<X> sut = new LCharToByteFunctionX(){
        public  byte doApplyAsByte(char a1) throws ParseException {
            return testValue;
        }
    };
    ...
    private LCharToByteFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LCharToByteFunctionX.lX(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LCharSingle,Byte,X> theCall = sut;
...
@Test
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingCharToByteFunc().doApplyAsByte((char)100);
    }
    ...
    @Test void safeCompiles() {
        LCharToByteFunctionX r1 = LCharToByteFunctionX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LCharToByteFunctionX<X>,Y> r1 = LCharToByteFunctionX.safeSupplier(()->sut);
    }
