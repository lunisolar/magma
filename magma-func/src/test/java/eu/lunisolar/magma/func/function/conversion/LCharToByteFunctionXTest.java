...
public class LCharToByteFunctionXTest<X extends ParseException> {
    ...
    private LCharToByteFunctionX<X> sut = new LCharToByteFunctionX<X>(){
    ...
    private LCharToByteFunctionX<ParseException> sutAlwaysThrowing = LCharToByteFunctionX.lX(a1 -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LCharToByteFunctionX<RuntimeException> sutAlwaysThrowingUnchecked = LCharToByteFunctionX.lX(a1 -> {
    ...
    public void testNonNullDoApplyAsByte() throws X {
        assertThat(sut.nonNullDoApplyAsByte('\u0100'))
            .isEqualTo(testValue);
    }
    ...
    public void testNestingDoApplyAsByteChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoApplyAsByte('\u0100');
    ...
    public void testNestingDoApplyAsByteUnchecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowingUnchecked.nestingDoApplyAsByte('\u0100');
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testShovingDoApplyAsByteChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoApplyAsByte('\u0100');
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testShovingDoApplyAsByteUnchecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowingUnchecked.shovingDoApplyAsByte('\u0100');
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
                    .isExactlyInstanceOf(IndexOutOfBoundsException.class)
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LCharToByteFunctionX: byte doApplyAsByte(char a1) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LCharToByteFunctionX.lX(a1 -> testValue ))
    ...
    public void testHandlingDoApplyAsByteMethodWrapsTheException() throws X {
        ...
        // when
        LCharToByteFunctionX<RuntimeException> wrapped = sutThrowing.handleCharToByteFuncX(handler -> handler
            .wrapIf(UnsupportedOperationException.class::isInstance,IllegalArgumentException::new,  EXCEPTION_WAS_WRAPPED));

        // then
        try {
            wrapped.doApplyAsByte('\u0100');
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    @Test
    public void testHandleCharToByteFuncXMethodDoNotWrapsOtherExceptionIf() throws X {
        ...
        // when
        LCharToByteFunctionX<X> wrapped = sutThrowing.handleCharToByteFuncX(handler -> handler
                .wrapIf(UnsupportedOperationException.class::isInstance,IllegalArgumentException::new,  EXCEPTION_WAS_WRAPPED)
...
@Test
    public void testHandleCharToByteFuncXMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleCharToByteFuncXMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LCharToByteFunctionX<X> wrapped = sutThrowing.handleCharToByteFuncX(h -> Function4U.doNothing());
    ...
    @Test
    public void testCharToByteFuncComposeChar() throws X {

        final ThreadLocal<Boolean> mainFunctionCalled = ThreadLocal.withInitial(()-> false);
        final AtomicInteger beforeCalls = new AtomicInteger(0);

        //given (+ some assertions)
        LCharToByteFunctionX<X> sutO = a1 -> {
        ...
        //when
        LCharToByteFunctionX<X> function = sutO.charToByteFuncComposeChar(before1);
    ...
    @Test
    public void testCharToByteFuncCompose() throws X {
        ...
        //when
        LToByteFunctionX<Integer,X> function = sutO.charToByteFuncCompose(before1);
    ...
    public void testNesting() {
        assertThat(sut.nestingCharToByteFunc())
            .isInstanceOf(LCharToByteFunction.class);
    }

    @Test
    public void testShoving() {
        assertThat(sut.shovingCharToByteFunc())
            .isInstanceOf(LCharToByteFunction.class);
    }

    @Test
    public void testNestingX() {
        assertThat(sut.nestingCharToByteFuncX())
            .isInstanceOf(LCharToByteFunctionX.class);
    }

    @Test
    public void testShovingX() {
        assertThat(sut.shovingCharToByteFuncX())
            .isInstanceOf(LCharToByteFunctionX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingCharToByteFunc().doApplyAsByte('\u0100');
    }
    ...
    public void testHandleCharToByteFunc() throws X {
        ...
        // when
        LCharToByteFunctionX<X> wrapped = sutThrowing.handleCharToByteFuncX(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LCharToByteFunctionX: byte doApplyAsByte(char a1) throws X");
    }
    ...
    @Test void safeCompiles() {
        LCharToByteFunctionX r1 = LCharToByteFunctionX.safe(sut); //NOSONAR
    }

    @Test void safePropagates() {
        Object result = LCharToByteFunctionX.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LCharToByteFunctionX.safe(null);
        assertThat(result).isSameAs(LCharToByteFunctionX.lX(LCharToByteFunctionX.safe()));
    }

    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LCharToByteFunctionX<X>,Y> supplier = ()->sut;
        Object result = LCharToByteFunctionX.safeSupplier(supplier);
        assertThat(result).isSameAs(supplier);
    }

    @Test <Y extends Throwable> void safeSupplierProtectsAgainstNpe() {
        Object result = LCharToByteFunctionX.safeSupplier(null);
        assertThat(result).isSameAs(LCharToByteFunctionX.safeSupplier());
    }

    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LCharToByteFunctionX<X>,Y> r1 = LCharToByteFunctionX.safeSupplier(()->sut);  //NOSONAR
    }
