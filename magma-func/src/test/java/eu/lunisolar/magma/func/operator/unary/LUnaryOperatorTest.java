...
public class LUnaryOperatorTest<T,X extends ParseException> {
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (LUnaryOperator: T apply(T t)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LUnaryOperator: T apply(T t)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LUnaryOperator.l((Object t) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LUnaryOperatorX<T,ParseException> sutThrowing = LUnaryOperatorX.lX((T t) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LUnaryOperator<T> sutThrowing = LUnaryOperator.l((T t) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LUnaryOperator<T> wrapped = LUnaryOperator.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testThen0() throws ParseException  {
        ...
        LUnaryOperator<Integer > sutO = (Integer t) -> {
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LUnaryOperator<T> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LUnaryOperator: T apply(T t)");
    }
