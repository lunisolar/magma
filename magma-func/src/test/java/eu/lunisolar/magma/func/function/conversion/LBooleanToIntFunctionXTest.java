...
public class LBooleanToIntFunctionXTest<X extends ParseException> {
    ...
    private LBooleanToIntFunctionX<X> sut = new LBooleanToIntFunctionX(){
        public  int doApplyAsInt(boolean b) throws ParseException {
            return testValue;
        }
    };

    private LBooleanToIntFunction opposite = new LBooleanToIntFunction(){
    ...
    private LBooleanToIntFunctionX<ParseException> sutAlwaysThrowing = LBooleanToIntFunctionX.lX(b -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBooleanToIntFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LBooleanToIntFunctionX.lX(b -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBooleanToIntFunctionX: int doApplyAsInt(boolean b) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LBooleanToIntFunctionX.lX(b -> testValue ))
            .isInstanceOf(LBooleanToIntFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws X {
        assertThat(LBooleanToIntFunctionX.wrapX(opposite))
            .isInstanceOf(LBooleanToIntFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // when
        LBooleanToIntFunctionX<X> wrapped = sutThrowing.handleBoolToIFuncX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBooleanToIntFunctionX<X> wrapped = sutThrowing.handleBoolToIFuncX(h -> Function4U.doNothing());
    ...
    public void testboolToIFuncFromBoolean() throws X {
        ...
        LBooleanToIntFunctionX<X> sutO = b -> {
        ...
        //when
        LBooleanToIntFunctionX<X> function = sutO.boolToIFuncFromBoolean(before1);
    ...
    public void testboolToIFuncFrom() throws X {
        ...
        //when
        LToIntFunctionX<Integer ,X> function = sutO.boolToIFuncFrom(before1);
    ...
    public void testHandleBoolToIFunc() throws X {
        ...
        // when
        LBooleanToIntFunctionX<X> wrapped = sutThrowing.handleBoolToIFuncX(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBooleanToIntFunctionX: int doApplyAsInt(boolean b) throws X");
    }
