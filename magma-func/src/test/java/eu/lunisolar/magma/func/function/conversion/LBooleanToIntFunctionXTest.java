...
public class LBooleanToIntFunctionXTest<X extends ParseException> {
    ...
    private LBooleanToIntFunctionX<ParseException> sutAlwaysThrowing = LBooleanToIntFunctionX.lX((boolean b) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBooleanToIntFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LBooleanToIntFunctionX.lX((boolean b) -> {
    ...
    public void testLXMethod() throws ParseException {
        assertThat(LBooleanToIntFunctionX.lX((boolean b) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LBooleanToIntFunctionX<X> wrapped = LBooleanToIntFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromBoolean() throws ParseException {
        ...
        LBooleanToIntFunctionX<X> sutO = (boolean b) -> {
        ...
        //when
        LBooleanToIntFunctionX<X> function = sutO.fromBoolean(before1);
...
//
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LBooleanToIntFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
