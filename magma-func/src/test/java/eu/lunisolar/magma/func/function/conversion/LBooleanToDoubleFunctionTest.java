...
public class LBooleanToDoubleFunctionTest<X extends ParseException> {
    ...
    private LBooleanToDoubleFunction sut = new LBooleanToDoubleFunction(){
        public  double doApplyAsDouble(boolean b)  {
            return testValue;
        }
    };

    private LBooleanToDoubleFunctionX<X> opposite = new LBooleanToDoubleFunctionX(){
        public  double doApplyAsDouble(boolean b) throws ParseException {
            return testValue;
        }
    };
    ...
    private LBooleanToDoubleFunction sutAlwaysThrowingUnckeck = LBooleanToDoubleFunction.l(b -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBooleanToDoubleFunction: double doApplyAsDouble(boolean b)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LBooleanToDoubleFunction.l(b -> testValue ))
            .isInstanceOf(LBooleanToDoubleFunction.class);
    }

    @Test
    public void testWrapMethod() throws X {
        assertThat(LBooleanToDoubleFunction.wrap(opposite))
            .isInstanceOf(LBooleanToDoubleFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws X {
        ...
        // when
        LBooleanToDoubleFunction wrapped = LBooleanToDoubleFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LBooleanToDoubleFunctionX<ParseException> sutThrowing = LBooleanToDoubleFunctionX.lX(b -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LBooleanToDoubleFunction sutThrowing = LBooleanToDoubleFunction.l(b -> {
            throw new UnsupportedOperationException();
        });

        // when
        LBooleanToDoubleFunction wrapped = sutThrowing.handleBoolToDoubleFunc(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBooleanToDoubleFunction wrapped = sutThrowing.handleBoolToDoubleFunc(h -> Function4U.doNothing());
    ...
    public void testboolToDoubleFuncComposeBoolean() throws X {
        ...
        LBooleanToDoubleFunction sutO = b -> {
        ...
        //when
        LBooleanToDoubleFunction function = sutO.boolToDoubleFuncComposeBoolean(before1);
    ...
    public void testHandleBoolToDoubleFunc() throws X {
        ...
        // when
        LBooleanToDoubleFunction wrapped = sutThrowing.handleBoolToDoubleFunc(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBooleanToDoubleFunction: double doApplyAsDouble(boolean b)");
    }
