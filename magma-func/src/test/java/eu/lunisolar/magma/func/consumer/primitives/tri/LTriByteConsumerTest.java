...
public class LTriByteConsumerTest {
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LTriByteConsumer: void accept(byte a1,byte a2,byte a3)");
    }

    @Test
    public void testTriByteConsMethod() throws Throwable {
        Assert.assertTrue(LTriByteConsumer.triByteCons(LTriByteConsumer::doNothing) instanceof LTriByteConsumer);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LTriByteConsumer: void accept(byte a1,byte a2,byte a3)"));
