...
public class LBiObjSrtFunctionTest<T1,T2,R> {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.apply(100,100,(short)100), testValue);
    }
    ...
    public void testNonNullApply() throws Throwable {
            Assert.assertSame(sut.nonNullApply(100,100,(short)100), testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LBiObjSrtFunction: R apply(T1 a1,T2 a2,short a3)");
    }

    @Test
    public void testBiObjSrtFuncMethod() throws Throwable {
        Assert.assertTrue(LBiObjSrtFunction.biObjSrtFunc((a1,a2,a3) -> testValue ) instanceof LBiObjSrtFunction);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LBiObjSrtFunction: R apply(T1 a1,T2 a2,short a3)"));
    ...
    public void compilerSubstituteVariantLObj0Srt2Obj1Func() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjSrtFunction.LObj0Srt2Obj1Func);
    }
    ...
    public void compilerSubstituteVariantLObj1Obj0Srt2Func() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjSrtFunction.LObj1Obj0Srt2Func);
    }
    ...
    public void compilerSubstituteVariantLObj1Srt2Obj0Func() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjSrtFunction.LObj1Srt2Obj0Func);
    }
    ...
    public void compilerSubstituteVariantLSrt2Obj0Obj1Func() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjSrtFunction.LSrt2Obj0Obj1Func);
    }
    ...
    public void compilerSubstituteVariantLSrt2Obj1Obj0Func() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjSrtFunction.LSrt2Obj1Obj0Func);
    }
