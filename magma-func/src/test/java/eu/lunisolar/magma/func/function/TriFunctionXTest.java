...
public class TriFunctionXTest<T1,T2,T3,R,X extends ParseException> {
    ...
    private TriFunctionX<T1,T2,T3,R,X> sut = new TriFunctionX(){
        public @Nullable Object  apply(Object t1,Object t2,Object t3) throws ParseException {
            return testValue;
        }
    };

    private TriFunction<T1,T2,T3,R> opposite = new TriFunction(){
        public @Nullable Object  apply(Object t1,Object t2,Object t3)  {
            return testValue;
        }
    };

    private TriFunctionX<T1,T2,T3,R,X> sutNull = new TriFunctionX(){
        public @Nullable Object  apply(Object t1,Object t2,Object t3) throws ParseException {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (TriFunctionX: R apply(T1 t1,T2 t2,T3 t3) throws X).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("TriFunctionX: R apply(T1 t1,T2 t2,T3 t3) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(TriFunctionX.lX((Object t1,Object t2,Object t3) -> testValue ))
            .isInstanceOf(TriFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(TriFunctionX.wrapX(opposite))
            .isInstanceOf(TriFunctionX.class);
    }
    ...
    public void testfrom() throws ParseException {
        ...
        TriFunctionX<Integer ,Integer ,Integer ,Integer ,X> sutO = (Integer t1,Integer t2,Integer t3) -> {
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        TriConsumerX<Integer ,Integer ,Integer ,X> function = sutO.then(thenFunction);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        TriFunctionX<T1,T2,T3,R,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("TriFunctionX: R apply(T1 t1,T2 t2,T3 t3) throws X");
    }
