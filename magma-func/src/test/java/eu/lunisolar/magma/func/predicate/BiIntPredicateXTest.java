...
public class BiIntPredicateXTest<X extends ParseException> {
    ...
    private BiIntPredicateX<X> sut = new BiIntPredicateX(){
        public  boolean test(int i1,int i2) throws ParseException {
            return testValue;
        }
    };

    private BiIntPredicate opposite = new BiIntPredicate(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BiIntPredicateX: boolean test(int i1,int i2) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(BiIntPredicateX.lX((int i1,int i2) -> testValue ))
            .isInstanceOf(BiIntPredicateX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(BiIntPredicateX.wrapX(opposite))
            .isInstanceOf(BiIntPredicateX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        BiIntPredicateX<X> wrapped = BiIntPredicateX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws ParseException {
        ...
        //given
        BiIntPredicateX<X> fun1 = BiIntPredicateX.lX((int i1,int i2) -> f1Result);
        BiIntPredicateX<X> fun2 = BiIntPredicateX.lX((int i1,int i2) -> f2Result);

        //when
        BiIntPredicateX<X> andFunction = fun1.and(fun2);
        BiIntPredicateX<X> orFunction = fun1.or(fun2);
        BiIntPredicateX<X> xorFunction = fun1.xor(fun2);
    ...
    public void isEqual() throws ParseException  {
        //when
        BiIntPredicateX<X> equals = BiIntPredicateX.isEqual((int)100,(int)100);
    ...
    public void testfromInt() throws ParseException {
        ...
        BiIntPredicateX<X> sutO = (int i1,int i2) -> {
        ...
        //when
        BiIntPredicateX<X> function = sutO.fromInt(before1,before2);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        BiIntPredicateX<X> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BiIntPredicateX: boolean test(int i1,int i2) throws X");
    }
