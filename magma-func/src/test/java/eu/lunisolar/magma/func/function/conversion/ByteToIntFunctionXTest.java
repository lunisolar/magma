...
public class ByteToIntFunctionXTest<X extends ParseException> {
    ...
    private ByteToIntFunctionX<X> sut = new ByteToIntFunctionX(){
        public  int applyAsInt(byte b) throws ParseException {
            return testValue;
        }
    };

    private ByteToIntFunction opposite = new ByteToIntFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ByteToIntFunctionX: int applyAsInt(byte b) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(ByteToIntFunctionX.lX((byte b) -> testValue ))
            .isInstanceOf(ByteToIntFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(ByteToIntFunctionX.wrapX(opposite))
            .isInstanceOf(ByteToIntFunctionX.class);
    }
    ...
    public void testfromByte() throws ParseException {
        ...
        ByteToIntFunctionX<X> sutO = (byte b) -> {
        ...
        //when
        ByteToIntFunctionX<X> function = sutO.fromByte(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        ByteToIntFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ByteToIntFunctionX: int applyAsInt(byte b) throws X");
    }
