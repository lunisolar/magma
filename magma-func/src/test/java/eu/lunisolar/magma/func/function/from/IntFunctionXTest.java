...
public class IntFunctionXTest<R,X extends ParseException> {
    ...
    private IntFunctionX<R,X> sut = new IntFunctionX(){
        public @Nullable Object  apply(int i) throws ParseException {
            return testValue;
        }
    };

    private IntFunction<R> opposite = new IntFunction(){
        public @Nullable Object  apply(int i)  {
            return testValue;
        }
    };

    private IntFunctionX<R,X> sutNull = new IntFunctionX(){
        public @Nullable Object  apply(int i) throws ParseException {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (IntFunctionX: R apply(int i) throws X).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("IntFunctionX: R apply(int i) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(IntFunctionX.lX((int i) -> testValue ))
            .isInstanceOf(IntFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(IntFunctionX.wrapX(opposite))
            .isInstanceOf(IntFunctionX.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(IntFunctionX.wrapStd(jre))
            .isInstanceOf(IntFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        IntFunctionX<R,X> sutThrowing = IntFunctionX.lX((int i) -> {
            throw new UnsupportedOperationException();
        });

        // when
        IntFunctionX<R,X> wrapped = IntFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromInt() throws ParseException {
        ...
        IntFunctionX<Integer ,X> sutO = (int i) -> {
        ...
        //when
        IntFunctionX<Integer ,X> function = sutO.fromInt(before1);
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        IntConsumerX<X> function = sutO.then(thenFunction);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(IntFunction.class);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        IntFunctionX<R,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("IntFunctionX: R apply(int i) throws X");
    }
