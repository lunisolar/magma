...
public class CharFunctionTest<R,X extends ParseException> {
    ...
    private CharFunction<R> sut = new CharFunction(){
        public @Nullable Object  apply(char c)  {
            return testValue;
        }
    };

    private CharFunctionX<R,X> opposite = new CharFunctionX(){
        public @Nullable Object  apply(char c) throws ParseException {
            return testValue;
        }
    };

    private CharFunction<R> sutNull = new CharFunction(){
        public @Nullable Object  apply(char c)  {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (CharFunction: R apply(char c)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("CharFunction: R apply(char c)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(CharFunction.l((char c) -> testValue ))
            .isInstanceOf(CharFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(CharFunction.wrap(opposite))
            .isInstanceOf(CharFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        CharFunction<R> wrapped = CharFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        CharFunctionX<R,ParseException> sutThrowing = CharFunctionX.lX((char c) -> {
    ...
    public void testfromChar() throws ParseException {
        ...
        CharFunction<Integer > sutO = (char c) -> {
        ...
        //when
        CharFunction<Integer > function = sutO.fromChar(before1);
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        CharConsumer function = sutO.then(thenFunction);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        CharFunction<R> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("CharFunction: R apply(char c)");
    }
