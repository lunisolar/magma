...
public class LObjIntSrtPredicateTest<T> {
    ...
    private LObjIntSrtPredicate<Integer> sut = new LObjIntSrtPredicate<Integer>(){
        public  boolean testX(Integer a1,int a2,short a3)  {
            return testValue;
        }
    };
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LObjIntSrtPredicate: boolean test(T a1,int a2,short a3)");
    }

    @Test
    public void testObjIntSrtPredMethod() throws Throwable {
        Assert.assertTrue(LObjIntSrtPredicate.objIntSrtPred((a1,a2,a3) -> testValue ) instanceof LObjIntSrtPredicate);
    ...
    public void testCompose() throws Throwable {
        ...
        //when
        LObjIntSrtPredicate<Integer> function = sutO.compose(before1,before2,before3);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LObjIntSrtPredicate: boolean test(T a1,int a2,short a3)"));
    ...
    public void compilerSubstituteVariantLObjSrtIntPred() {
        ...
        Assert.assertTrue(lambda instanceof LObjIntSrtPredicate.LObjSrtIntPred);
    }
    ...
    public void compilerSubstituteVariantLIntObjSrtPred() {
        ...
        Assert.assertTrue(lambda instanceof LObjIntSrtPredicate.LIntObjSrtPred);
    }
    ...
    public void compilerSubstituteVariantLIntSrtObjPred() {
        ...
        Assert.assertTrue(lambda instanceof LObjIntSrtPredicate.LIntSrtObjPred);
    }
    ...
    public void compilerSubstituteVariantLSrtObjIntPred() {
        ...
        Assert.assertTrue(lambda instanceof LObjIntSrtPredicate.LSrtObjIntPred);
    }
    ...
    public void compilerSubstituteVariantLSrtIntObjPred() {
        ...
        Assert.assertTrue(lambda instanceof LObjIntSrtPredicate.LSrtIntObjPred);
    }
