...
public class LToIntBiFunctionTest<T1,T2> {
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LToIntBiFunction: int applyAsInt(T1 a1,T2 a2)");
    }

    @Test
    public void testToIntBiFuncMethod() throws Throwable {
        Assert.assertTrue(LToIntBiFunction.toIntBiFunc((a1,a2) -> testValue ) instanceof LToIntBiFunction);
    ...
    public void testWrapStdMethod() throws Throwable {
        Assert.assertTrue(LToIntBiFunction.wrap(jre) instanceof LToIntBiFunction);
    }
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LToIntBiFunction: int applyAsInt(T1 a1,T2 a2)"));
