...
public class LObjBooleanPredicateTest<T,X extends ParseException> {
    ...
    private LObjBooleanPredicate<T> sutAlwaysThrowingUnckeck = LObjBooleanPredicate.l((T t, boolean b) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // when
        LObjBooleanPredicate<T> wrapped = sutThrowing.handleObjBoolPred(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LObjBooleanPredicate<T> wrapped = sutThrowing.handleObjBoolPred(h -> Function4U.doNothing());
    ...
    public void testobjBoolPredFromBoolean() throws X {
        ...
        //when
        LObjBooleanPredicate<Integer > function = sutO.objBoolPredFromBoolean(before1,before2);
    ...
    public void testobjBoolPredFrom() throws X {
        ...
        //when
        LBiPredicate<Integer ,Integer > function = sutO.objBoolPredFrom(before1,before2);
    ...
    public void testThen0() throws X  {
        ...
        //when
        LObjBooleanFunction<Integer ,Integer > function = sutO.boolToObjBooleanFunction(thenFunction);
    ...
    public void testHandleObjBoolPred() throws X {
        ...
        // when
        LObjBooleanPredicate<T> wrapped = sutThrowing.handleObjBoolPred(h -> {
