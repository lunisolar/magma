...
public class LIntToShortFunctionXTest<X extends ParseException> {
    ...
    private LIntToShortFunctionX<ParseException> sutAlwaysThrowing = LIntToShortFunctionX.lX((int i) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LIntToShortFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LIntToShortFunctionX.lX((int i) -> {
    ...
    public void testLXMethod() throws X {
        assertThat(LIntToShortFunctionX.lX((int i) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LIntToShortFunctionX<X> sutThrowing = LIntToShortFunctionX.lX((int i) -> {
...
@Test
    ...
    public void testfromInt() throws X {
        ...
        LIntToShortFunctionX<X> sutO = (int i) -> {
