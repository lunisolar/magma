...
public class LIntToShortFunctionXTest<X extends ParseException> {
    ...
    private LIntToShortFunctionX<X> sut = new LIntToShortFunctionX<X>(){
        public  short doApplyAsShort(int a)  throws X {
            return testValue;
        }
    };

    private LIntToShortFunction opposite = new LIntToShortFunction(){
    ...
    private LIntToShortFunctionX<ParseException> sutAlwaysThrowing = LIntToShortFunctionX.lX(a -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LIntToShortFunctionX<RuntimeException> sutAlwaysThrowingUnchecked = LIntToShortFunctionX.lX(a -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LIntToShortFunctionX: short doApplyAsShort(int a) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LIntToShortFunctionX.lX(a -> testValue ))
            .isInstanceOf(LIntToShortFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws X {
        assertThat(LIntToShortFunctionX.wrapX(opposite))
            .isInstanceOf(LIntToShortFunctionX.class);
    }
    ...
    public void testHandlingDoApplyAsShortMethodWrapsTheException() throws X {
        ...
        // given
        LIntToShortFunctionX<X> sutThrowing = LIntToShortFunctionX.lX(a -> {
            throw new UnsupportedOperationException();
        });

        // when
        LIntToShortFunctionX<RuntimeException> wrapped = sutThrowing.handleIntToShortFuncX(handler -> handler
    ...
    @Test
    public void testHandleIntToShortFuncXMethodDoNotWrapsOtherExceptionIf() throws X {
        ...
        // when
        LIntToShortFunctionX<X> wrapped = sutThrowing.handleIntToShortFuncX(handler -> handler
                .wrapIf(UnsupportedOperationException.class::isInstance,IllegalArgumentException::new,  EXCEPTION_WAS_WRAPPED)
...
@Test
    public void testHandleIntToShortFuncXMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleIntToShortFuncXMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LIntToShortFunctionX<X> wrapped = sutThrowing.handleIntToShortFuncX(h -> Function4U.doNothing());
    ...
    public void testIntToShortFuncComposeInt() throws X {
        ...
        //when
        LIntToShortFunctionX<X> function = sutO.intToShortFuncComposeInt(before);
    ...
    public void testIntToShortFuncCompose() throws X {
        ...
        //when
        LToShortFunctionX<Integer,X> function = sutO.intToShortFuncCompose(before);
        function.doApplyAsShort(80);
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingIntToShortFunc().doApplyAsShort(100);
    }
    ...
    public void testHandleIntToShortFunc() throws X {
        ...
        // when
        LIntToShortFunctionX<X> wrapped = sutThrowing.handleIntToShortFuncX(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LIntToShortFunctionX: short doApplyAsShort(int a) throws X");
    }
    ...
    @Test void safeCompiles() {
        LIntToShortFunctionX r1 = LIntToShortFunctionX.safe(sut); //NOSONAR
    }

    @Test void safePropagates() {
        Object result = LIntToShortFunctionX.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LIntToShortFunctionX.safe(null);
        assertThat(result).isSameAs(LIntToShortFunctionX.lX(LIntToShortFunctionX.safe()));
    }

    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LIntToShortFunctionX<X>,Y> supplier = ()->sut;
        Object result = LIntToShortFunctionX.safeSupplier(supplier);
        assertThat(result).isSameAs(supplier);
    }

    @Test <Y extends Throwable> void safeSupplierProtectsAgainstNpe() {
        Object result = LIntToShortFunctionX.safeSupplier(null);
        assertThat(result).isSameAs(LIntToShortFunctionX.safeSupplier());
    }

    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LIntToShortFunctionX<X>,Y> r1 = LIntToShortFunctionX.safeSupplier(()->sut);  //NOSONAR
    }
