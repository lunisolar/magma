...
public class LBiObjIntFunctionXTest<T1,T2,R,X extends ParseException> {
    ...
    private LBiObjIntFunctionX<T1,T2,R,ParseException> sutAlwaysThrowing = LBiObjIntFunctionX.lX((T1 a1,T2 a2,int a3) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiObjIntFunctionX<T1,T2,R,RuntimeException> sutAlwaysThrowingUnckeck = LBiObjIntFunctionX.lX((T1 a1,T2 a2,int a3) -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LBiObjIntTriple<T1,T2>,R,X> theCall = sut;
    ...
    public void testLXMethod() throws X {
        assertThat(LBiObjIntFunctionX.lX((Object a1,Object a2,int a3) -> testValue ))
...
@Test
    ...
    private R variant1(T1 a1,int a3,T2 a2) {
        return (R)Integer.valueOf(100);
    }

    @Test
    public void compilerSubstituteVariant1() {
        LBiObjIntFunctionX lambda = LBiObjIntFunctionX./*<T1,T2,R,X>*/lX1(this::variant1);

        assertThat(lambda).isInstanceOf(LBiObjIntFunctionX.V1.class);
    }


    private R variant2(T2 a2,T1 a1,int a3) {
        return (R)Integer.valueOf(100);
    }

    @Test
    public void compilerSubstituteVariant2() {
        LBiObjIntFunctionX lambda = LBiObjIntFunctionX./*<T1,T2,R,X>*/lX2(this::variant2);

        assertThat(lambda).isInstanceOf(LBiObjIntFunctionX.V2.class);
    }


    private R variant3(T2 a2,int a3,T1 a1) {
        return (R)Integer.valueOf(100);
    }

    @Test
    public void compilerSubstituteVariant3() {
        LBiObjIntFunctionX lambda = LBiObjIntFunctionX./*<T1,T2,R,X>*/lX3(this::variant3);

        assertThat(lambda).isInstanceOf(LBiObjIntFunctionX.V3.class);
    }


    private R variant4(int a3,T1 a1,T2 a2) {
        return (R)Integer.valueOf(100);
    }

    @Test
    public void compilerSubstituteVariant4() {
        LBiObjIntFunctionX lambda = LBiObjIntFunctionX./*<T1,T2,R,X>*/lX4(this::variant4);

        assertThat(lambda).isInstanceOf(LBiObjIntFunctionX.V4.class);
    }


    private R variant5(int a3,T2 a2,T1 a1) {
        return (R)Integer.valueOf(100);
    }

    @Test
    public void compilerSubstituteVariant5() {
        LBiObjIntFunctionX lambda = LBiObjIntFunctionX./*<T1,T2,R,X>*/lX5(this::variant5);
    ...
    @Test void safeCompiles() {
        LBiObjIntFunctionX r1 = LBiObjIntFunctionX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LBiObjIntFunctionX<T1,T2,R,X>,Y> supplier = ()->sut;
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LBiObjIntFunctionX<T1,T2,R,X>,Y> r1 = LBiObjIntFunctionX.safeSupplier(()->sut);
    }
