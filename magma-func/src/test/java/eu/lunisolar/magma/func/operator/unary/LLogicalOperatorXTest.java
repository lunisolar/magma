...
public class LLogicalOperatorXTest<X extends ParseException> {
    ...
    private LLogicalOperatorX<ParseException> sutAlwaysThrowing = LLogicalOperatorX.lX(b -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LLogicalOperatorX<RuntimeException> sutAlwaysThrowingUnckeck = LLogicalOperatorX.lX(b -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LLogicalOperatorX: boolean doApply(boolean b) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LLogicalOperatorX.lX(b -> testValue ))
...
@Test
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws X {
        ...
        //given
        LLogicalOperatorX<X> fun1 = LLogicalOperatorX.lX(b -> f1Result);
        LLogicalOperatorX<X> fun2 = LLogicalOperatorX.lX(b -> f2Result);
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LLogicalOperatorX: boolean doApply(boolean b) throws X");
    }
