...
public class DoubleToShortFunctionTest<X extends ParseException> {
    ...
    private DoubleToShortFunction sut = new DoubleToShortFunction(){
        public  short applyAsShort(double d)  {
            return testValue;
        }
    };

    private DoubleToShortFunctionX<X> opposite = new DoubleToShortFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("DoubleToShortFunction: short applyAsShort(double d)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(DoubleToShortFunction.l((double d) -> testValue ))
            .isInstanceOf(DoubleToShortFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(DoubleToShortFunction.wrap(opposite))
            .isInstanceOf(DoubleToShortFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        // given
        DoubleToShortFunctionX<X> sutThrowing = DoubleToShortFunctionX.lX((double d) -> {
            throw new UnsupportedOperationException(ORIGINAL_MESSAGE);
        });

        // when
        DoubleToShortFunction wrapped = DoubleToShortFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        DoubleToShortFunctionX<ParseException> sutThrowing = DoubleToShortFunctionX.lX((double d) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        DoubleToShortFunction sutThrowing = DoubleToShortFunction.l((double d) -> {
            throw new UnsupportedOperationException();
        });

        // when
        DoubleToShortFunction wrapped = DoubleToShortFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromDouble() throws ParseException {
        ...
        DoubleToShortFunction sutO = (double d) -> {
        ...
        //when
        DoubleToShortFunction function = sutO.fromDouble(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(DoubleToShortFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(DoubleToShortFunctionX.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        DoubleToShortFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("DoubleToShortFunction: short applyAsShort(double d)");
    }
