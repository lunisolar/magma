...
public class ShortPredicateXTest<X extends ParseException> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        ShortPredicateX<X> wrapped = ShortPredicateX.wrapException(sutThrowing, UnsupportedOperationException.class, t -> {
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ShortPredicateX<X> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
