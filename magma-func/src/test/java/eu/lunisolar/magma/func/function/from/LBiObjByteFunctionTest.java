...
public class LBiObjByteFunctionTest<T1,T2,R,X extends ParseException> {
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (LBiObjByteFunction: R apply(T1 t1,T2 t2, byte i)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBiObjByteFunction: R apply(T1 t1,T2 t2, byte i)");
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LBiObjByteFunction<T1,T2,R> wrapped = LBiObjByteFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        //when
        LBiObjByteFunction<Integer ,Integer ,Integer > function = sutO.fromByte(before1,before2,before3);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LBiObjByteFunction<T1,T2,R> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBiObjByteFunction: R apply(T1 t1,T2 t2, byte i)");
    }
