...
public class LBiObjByteFunctionTest<T1,T2,R> {
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LBiObjByteFunction: R apply(T1 a1,T2 a2,byte a3)");
    }

    @Test
    public void testBiObjByteFuncMethod() throws Throwable {
        Assert.assertTrue(LBiObjByteFunction.biObjByteFunc((a1,a2,a3) -> testValue ) instanceof LBiObjByteFunction);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LBiObjByteFunction: R apply(T1 a1,T2 a2,byte a3)"));
    ...
    public void compilerSubstituteVariantLObj0Byte2Obj1Func() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjByteFunction.LObj0Byte2Obj1Func);
    }
    ...
    public void compilerSubstituteVariantLObj1Obj0Byte2Func() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjByteFunction.LObj1Obj0Byte2Func);
    }
    ...
    public void compilerSubstituteVariantLObj1Byte2Obj0Func() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjByteFunction.LObj1Byte2Obj0Func);
    }
    ...
    public void compilerSubstituteVariantLByte2Obj0Obj1Func() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjByteFunction.LByte2Obj0Obj1Func);
    }
    ...
    public void compilerSubstituteVariantLByte2Obj1Obj0Func() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjByteFunction.LByte2Obj1Obj0Func);
    }
