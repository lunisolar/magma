...
public class IntToFloatFunctionTest<X extends ParseException> {
    ...
    private IntToFloatFunction sut = new IntToFloatFunction(){
        public  float applyAsFloat(int i)  {
            return testValue;
        }
    };

    private IntToFloatFunctionX<X> opposite = new IntToFloatFunctionX(){
        public  float applyAsFloat(int i) throws ParseException {
            return testValue;
        }
    };
    ...
    public void testTheResult() throws ParseException {
        assertThat(sut.applyAsFloat((int)100))
            .isEqualTo(testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("IntToFloatFunction: float applyAsFloat(int i)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(IntToFloatFunction.l((int i) -> testValue ))
            .isInstanceOf(IntToFloatFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(IntToFloatFunction.wrap(opposite))
            .isInstanceOf(IntToFloatFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        // given
        IntToFloatFunctionX<X> sutThrowing = IntToFloatFunctionX.lX((int i) -> {
            throw new UnsupportedOperationException(ORIGINAL_MESSAGE);
        });

        // when
        IntToFloatFunction wrapped = IntToFloatFunction.wrap(sutThrowing);

        // then
        try {
            wrapped.applyAsFloat((int)100);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        IntToFloatFunctionX<ParseException> sutThrowing = IntToFloatFunctionX.lX((int i) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        IntToFloatFunction sutThrowing = IntToFloatFunction.l((int i) -> {
            throw new UnsupportedOperationException();
        });

        // when
        IntToFloatFunction wrapped = IntToFloatFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromInt() throws ParseException {
        ...
        //when
        IntToFloatFunction function = sutO.fromInt(before1);
        function.applyAsFloat((int)80);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(IntToFloatFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(IntToFloatFunctionX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().applyAsFloat((int)100);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        IntToFloatFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("IntToFloatFunction: float applyAsFloat(int i)");
    }
