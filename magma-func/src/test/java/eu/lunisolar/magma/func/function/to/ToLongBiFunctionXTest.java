...
public class ToLongBiFunctionXTest<T1,T2,X extends ParseException> {
    ...
    private ToLongBiFunctionX<T1,T2,X> sut = new ToLongBiFunctionX(){
        public  long applyAsLong(Object t1,Object t2) throws ParseException {
            return testValue;
        }
    };

    private ToLongBiFunction<T1,T2> opposite = new ToLongBiFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ToLongBiFunctionX: long applyAsLong(T1 t1,T2 t2) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(ToLongBiFunctionX.lX((Object t1,Object t2) -> testValue ))
            .isInstanceOf(ToLongBiFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(ToLongBiFunctionX.wrapX(opposite))
            .isInstanceOf(ToLongBiFunctionX.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(ToLongBiFunctionX.wrapStd(jre))
            .isInstanceOf(ToLongBiFunctionX.class);
    }
    ...
    public void testfrom() throws ParseException {
        ...
        ToLongBiFunctionX<Integer ,Integer ,X> sutO = (Integer t1,Integer t2) -> {
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        ToLongBiFunctionX<T1,T2,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ToLongBiFunctionX: long applyAsLong(T1 t1,T2 t2) throws X");
    }
