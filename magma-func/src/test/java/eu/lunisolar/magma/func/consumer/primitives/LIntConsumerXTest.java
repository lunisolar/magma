...
public class LIntConsumerXTest<X extends ParseException> {
    ...
    private LIntConsumerX<X> sut = new LIntConsumerX<X>(){
    ...
    private LIntConsumerX<ParseException> sutAlwaysThrowing = LIntConsumerX.lX(a -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LIntConsumerX<RuntimeException> sutAlwaysThrowingUnchecked = LIntConsumerX.lX(a -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LIntConsumerX: void doAccept(int a) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LIntConsumerX.lX(Function4U::doNothing))
    ...
    public void testHandlingDoAcceptMethodWrapsTheException() throws X {
        ...
        // when
        LIntConsumerX<RuntimeException> wrapped = sutThrowing.handleIntConsX(handler -> handler
    ...
    @Test
    public void testHandleIntConsXMethodDoNotWrapsOtherExceptionIf() throws X {
...
@Test
    public void testHandleIntConsXMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleIntConsXMishandlingExceptionIsAllowed() throws X {
    ...
    public void testIntConsComposeInt() throws X {
        ...
        //when
        LIntConsumerX<X> function = sutO.intConsComposeInt(before);
    ...
    public void testIntConsCompose() throws X {
        ...
        //when
        LConsumerX<Integer,X> function = sutO.intConsCompose(before);
        function.doAccept(80);
    ...
    public void testAndThen() throws X {
        ...
        LIntConsumerX<X> thenFunction = a -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LIntConsumerX: void doAccept(int a) throws X");
    }
    ...
    @Test void safeCompiles() {
        LIntConsumerX r1 = LIntConsumerX.safe(sut); //NOSONAR
        IntConsumer r3 = LIntConsumerX.safe(sut); //NOSONAR
    }

    @Test void safePropagates() {
        Object result = LIntConsumerX.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LIntConsumerX.safe(null);
        assertThat(result).isSameAs(LIntConsumerX.lX(LIntConsumerX.safe()));
    }

    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LIntConsumerX<X>,Y> supplier = ()->sut;
        Object result = LIntConsumerX.safeSupplier(supplier);
        assertThat(result).isSameAs(supplier);
    }

    @Test <Y extends Throwable> void safeSupplierProtectsAgainstNpe() {
        Object result = LIntConsumerX.safeSupplier(null);
        assertThat(result).isSameAs(LIntConsumerX.safeSupplier());
    }

    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LIntConsumerX<X>,Y> r1 = LIntConsumerX.safeSupplier(()->sut);  //NOSONAR
        Supplier<LIntConsumerX<X>> r2 = LIntConsumerX.safeSupplier(()->sut); //NOSONAR
    }
