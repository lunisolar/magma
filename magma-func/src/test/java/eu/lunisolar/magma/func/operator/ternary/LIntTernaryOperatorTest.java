...
public class LIntTernaryOperatorTest {
    ...
    private LIntTernaryOperator sut = new LIntTernaryOperator(){
        public  int applyAsIntX(int a1,int a2,int a3)  {
            return testValue;
        }
    };
    ...
    private LIntTernaryOperator sutAlwaysThrowing = LIntTernaryOperator.intTernaryOp((a1,a2,a3) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LIntTernaryOperator sutAlwaysThrowingUnchecked = LIntTernaryOperator.intTernaryOp((a1,a2,a3) -> {
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LIntTernaryOperator: int applyAsInt(int a1,int a2,int a3)");
    }

    @Test
    public void testIntTernaryOpMethod() throws Throwable {
        Assert.assertTrue(LIntTernaryOperator.intTernaryOp((a1,a2,a3) -> testValue ) instanceof LIntTernaryOperator);
    ...
    public void testCompose() throws Throwable {
        ...
        //when
        LIntTernaryOperator function = sutO.compose(before1,before2,before3);
    ...
    @Test
    public void testIntTernaryOpCompose() throws Throwable {
        ...
        //when
        LToIntTriFunction<Integer,Integer,Integer> function = sutO.intTernaryOpCompose(before1,before2,before3);
        function.applyAsInt(80,81,82);
    ...
    public void testShove() {
        ...
        // given
        LIntTernaryOperator sutThrowing = LIntTernaryOperator.intTernaryOp((a1,a2,a3) -> {
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LIntTernaryOperator: int applyAsInt(int a1,int a2,int a3)"));
