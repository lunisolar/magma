...
public class CharToLongFunctionXTest<X extends ParseException> {
    ...
    private CharToLongFunctionX<X> sut = new CharToLongFunctionX(){
        public  long applyAsLong(char c) throws ParseException {
            return testValue;
        }
    };

    private CharToLongFunction opposite = new CharToLongFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("CharToLongFunctionX: long applyAsLong(char c) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(CharToLongFunctionX.lX((char c) -> testValue ))
            .isInstanceOf(CharToLongFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(CharToLongFunctionX.wrapX(opposite))
            .isInstanceOf(CharToLongFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        CharToLongFunctionX<X> wrapped = CharToLongFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromChar() throws ParseException {
        ...
        CharToLongFunctionX<X> sutO = (char c) -> {
        ...
        //when
        CharToLongFunctionX<X> function = sutO.fromChar(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        CharToLongFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("CharToLongFunctionX: long applyAsLong(char c) throws X");
    }
