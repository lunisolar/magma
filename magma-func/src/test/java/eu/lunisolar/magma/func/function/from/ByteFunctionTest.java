...
public class ByteFunctionTest<R,X extends ParseException> {
    ...
    private ByteFunction<R> sut = new ByteFunction(){
        public @Nullable Object  apply(byte b)  {
            return testValue;
        }
    };

    private ByteFunctionX<R,X> opposite = new ByteFunctionX(){
        public @Nullable Object  apply(byte b) throws ParseException {
            return testValue;
        }
    };

    private ByteFunction<R> sutNull = new ByteFunction(){
        public @Nullable Object  apply(byte b)  {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (ByteFunction: R apply(byte b)).\\E")
    public void testNonNullCapturesNull() throws ParseException {
        sutNull.nonNull((byte)100);
    }
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ByteFunction: R apply(byte b)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(ByteFunction.l((byte b) -> testValue ))
            .isInstanceOf(ByteFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(ByteFunction.wrap(opposite))
            .isInstanceOf(ByteFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        // given
        ByteFunctionX<R,X> sutThrowing = ByteFunctionX.lX((byte b) -> {
            throw new UnsupportedOperationException(ORIGINAL_MESSAGE);
        });

        // when
        ByteFunction<R> wrapped = ByteFunction.wrap(sutThrowing);

        // then
        try {
            wrapped.apply((byte)100);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        ByteFunctionX<R,ParseException> sutThrowing = ByteFunctionX.lX((byte b) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        ByteFunction<R> sutThrowing = ByteFunction.l((byte b) -> {
            throw new UnsupportedOperationException();
        });

        // when
        ByteFunction<R> wrapped = ByteFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        ByteFunction<Integer > sutO = (byte b) -> {
        ...
        //when
        ByteFunction<Integer > function = sutO.fromByte(before1);
        function.apply((byte)80);
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        ByteConsumer function = sutO.then(thenFunction);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(ByteFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(ByteFunctionX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().apply((byte)100);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ByteFunction<R> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ByteFunction: R apply(byte b)");
    }
