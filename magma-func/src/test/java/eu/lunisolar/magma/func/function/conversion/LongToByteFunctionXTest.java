...
public class LongToByteFunctionXTest<X extends ParseException> {
    ...
    private LongToByteFunctionX<X> sut = new LongToByteFunctionX(){
        public  byte applyAsByte(long l) throws ParseException {
            return testValue;
        }
    };

    private LongToByteFunction opposite = new LongToByteFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LongToByteFunctionX: byte applyAsByte(long l) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(LongToByteFunctionX.lX((long l) -> testValue ))
            .isInstanceOf(LongToByteFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(LongToByteFunctionX.wrapX(opposite))
            .isInstanceOf(LongToByteFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LongToByteFunctionX<X> wrapped = LongToByteFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromLong() throws ParseException {
        ...
        LongToByteFunctionX<X> sutO = (long l) -> {
        ...
        //when
        LongToByteFunctionX<X> function = sutO.fromLong(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LongToByteFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LongToByteFunctionX: byte applyAsByte(long l) throws X");
    }
