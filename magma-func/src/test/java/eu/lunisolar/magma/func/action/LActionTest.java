...
public class LActionTest<X extends ParseException> {
    ...
    public void testWrapStdMethod() throws ParseException {
        assertThat(LAction.wrapStd(jre))
            .isInstanceOf(LAction.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LAction wrapped = LAction.wrapException(sutThrowing, UnsupportedOperationException.class, t -> {
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LAction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
