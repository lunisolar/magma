...
public class ByteUnaryOperatorTest<X extends ParseException> {
    ...
    private ByteUnaryOperator sut = new ByteUnaryOperator(){
        public  byte applyAsByte(byte b)  {
            return testValue;
        }
    };

    private ByteUnaryOperatorX<X> opposite = new ByteUnaryOperatorX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ByteUnaryOperator: byte applyAsByte(byte b)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(ByteUnaryOperator.l((byte b) -> testValue ))
            .isInstanceOf(ByteUnaryOperator.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(ByteUnaryOperator.wrap(opposite))
            .isInstanceOf(ByteUnaryOperator.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        ByteUnaryOperator wrapped = ByteUnaryOperator.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        ByteUnaryOperatorX<ParseException> sutThrowing = ByteUnaryOperatorX.lX((byte b) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        ByteUnaryOperator sutThrowing = ByteUnaryOperator.l((byte b) -> {
            throw new UnsupportedOperationException();
        });

        // when
        ByteUnaryOperator wrapped = ByteUnaryOperator.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        //when
        ByteUnaryOperator function = sutO.fromByte(before1);
    ...
    public void identity() throws ParseException {
        ByteUnaryOperator identityFunction = ByteUnaryOperator.identity();
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ByteUnaryOperator wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ByteUnaryOperator: byte applyAsByte(byte b)");
    }
