...
public class CharToFloatFunctionTest<X extends ParseException> {
    ...
    private CharToFloatFunction sut = new CharToFloatFunction(){
        public  float applyAsFloat(char c)  {
            return testValue;
        }
    };

    private CharToFloatFunctionX<X> opposite = new CharToFloatFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("CharToFloatFunction: float applyAsFloat(char c)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(CharToFloatFunction.l((char c) -> testValue ))
            .isInstanceOf(CharToFloatFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(CharToFloatFunction.wrap(opposite))
            .isInstanceOf(CharToFloatFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        CharToFloatFunction wrapped = CharToFloatFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        CharToFloatFunctionX<ParseException> sutThrowing = CharToFloatFunctionX.lX((char c) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        CharToFloatFunction sutThrowing = CharToFloatFunction.l((char c) -> {
            throw new UnsupportedOperationException();
        });

        // when
        CharToFloatFunction wrapped = CharToFloatFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromChar() throws ParseException {
        ...
        CharToFloatFunction sutO = (char c) -> {
        ...
        //when
        CharToFloatFunction function = sutO.fromChar(before1);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        CharToFloatFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("CharToFloatFunction: float applyAsFloat(char c)");
    }
