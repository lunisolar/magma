...
public class LOiFunctionTest<T,R> {
    ...
    private LOiFunction<Integer,Integer> sutAlwaysThrowing = LOiFunction.oiFunc((a1,a2) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LOiFunction<Integer,Integer> sutAlwaysThrowingUnchecked = LOiFunction.oiFunc((a1,a2) -> {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.apply(100,100), testValue);
    }
    ...
    public void testNonNullApply() throws Throwable {
            Assert.assertSame(sut.nonNullApply(100,100), testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LOiFunction: R apply(T a1,int a2)");
    }

    @Test
    public void testOiFuncMethod() throws Throwable {
        Assert.assertTrue(LOiFunction.oiFunc((a1,a2) -> testValue ) instanceof LOiFunction);
    ...
    public void testCompose() throws Throwable {
        ...
        LOiFunction<Integer,Integer> sutO = (a1,a2) -> {
    ...
    @Test
    public void testOiFuncCompose() throws Throwable {
    ...
    public void testShove() {
        ...
        // given
        LOiFunction<Integer,Integer> sutThrowing = LOiFunction.oiFunc((a1,a2) -> {
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LOiFunction: R apply(T a1,int a2)"));
