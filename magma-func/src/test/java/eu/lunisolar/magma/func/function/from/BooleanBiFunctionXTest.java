...
public class BooleanBiFunctionXTest<R,X extends ParseException> {
    ...
    private BooleanBiFunctionX<R,X> sut = new BooleanBiFunctionX(){
        public @Nullable Object  apply(boolean b1,boolean b2) throws ParseException {
            return testValue;
        }
    };

    private BooleanBiFunction<R> opposite = new BooleanBiFunction(){
        public @Nullable Object  apply(boolean b1,boolean b2)  {
            return testValue;
        }
    };

    private BooleanBiFunctionX<R,X> sutNull = new BooleanBiFunctionX(){
        public @Nullable Object  apply(boolean b1,boolean b2) throws ParseException {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (BooleanBiFunctionX: R apply(boolean b1,boolean b2) throws X).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BooleanBiFunctionX: R apply(boolean b1,boolean b2) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(BooleanBiFunctionX.lX((boolean b1,boolean b2) -> testValue ))
            .isInstanceOf(BooleanBiFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(BooleanBiFunctionX.wrapX(opposite))
            .isInstanceOf(BooleanBiFunctionX.class);
    }
    ...
    public void testfromBoolean() throws ParseException {
        ...
        BooleanBiFunctionX<Integer ,X> sutO = (boolean b1,boolean b2) -> {
        ...
        //when
        BooleanBiFunctionX<Integer ,X> function = sutO.fromBoolean(before1,before2);
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        BooleanBiConsumerX<X> function = sutO.then(thenFunction);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        BooleanBiFunctionX<R,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BooleanBiFunctionX: R apply(boolean b1,boolean b2) throws X");
    }
