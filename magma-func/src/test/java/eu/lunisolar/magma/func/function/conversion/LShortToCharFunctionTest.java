...
public class LShortToCharFunctionTest<X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LShortToCharFunction: char applyAsChar(short s)");
    }
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LShortToCharFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LShortToCharFunctionX.class);
    }
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LShortToCharFunction: char applyAsChar(short s)");
    }
