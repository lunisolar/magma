...
public class LBiFunctionTest<T1,T2,R,X extends ParseException> {
    ...
    private LBiFunction<T1,T2,R> sutAlwaysThrowingUnckeck = LBiFunction.l((T1 a1,T2 a2) -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LPair<T1,T2>,R,RuntimeException> theCall = sut;
    ...
    public void testLMethod() throws X {
        assertThat(LBiFunction.l((Object a1,Object a2) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LBiFunctionX<T1,T2,R,ParseException> sutThrowing = LBiFunctionX.lX((T1 a1,T2 a2) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LBiFunction<T1,T2,R> sutThrowing = LBiFunction.l((T1 a1,T2 a2) -> {
...
@Test
    ...
    public void compilerSubstituteVariant1() {
        LBiFunction lambda = LBiFunction./*<T1,T2,R>*/l1(this::variant1);
    ...
    @Test void safeCompiles() {
        LBiFunction r1 = LBiFunction.safe(sut);
        LBiFunctionX r2 = LBiFunction.safe(sut);
        BiFunction r3 = LBiFunction.safe(sut);
    }
    ...
    @Test  void safeSupplierPropagates() {
        LSupplier<LBiFunction<T1,T2,R>> supplier = ()->sut;
    ...
    @Test  void safeSupplierCompiles() {
        LSupplier<LBiFunction<T1,T2,R>> r1 = LBiFunction.safeSupplier(()->sut);
        Supplier<LBiFunction<T1,T2,R>> r2 = LBiFunction.safeSupplier(()->sut);
    }
