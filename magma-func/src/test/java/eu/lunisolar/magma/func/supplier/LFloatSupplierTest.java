...
public class LFloatSupplierTest<X extends ParseException> {
    ...
    private LFloatSupplier sut = new LFloatSupplier(){
        public  float doGetAsFloat()  {
            return testValue;
        }
    };

    private LFloatSupplierX<X> opposite = new LFloatSupplierX<X>(){
    ...
    private LFloatSupplierX<RuntimeException> sutAlwaysThrowingUnchecked = LFloatSupplier.l(() -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LFloatSupplier: float doGetAsFloat()");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LFloatSupplier.l(() -> testValue ))
            .isInstanceOf(LFloatSupplier.class);
    }

    @Test
    public void testWrapMethod() throws X {
        assertThat(LFloatSupplier.wrap(opposite))
            .isInstanceOf(LFloatSupplier.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws X {
        ...
        // when
        LFloatSupplier wrapped = LFloatSupplier.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LFloatSupplierX<ParseException> sutThrowing = LFloatSupplierX.lX(() -> {
    ...
    @Test
    public void testHandleFloatSupMethodDoNotWrapsOtherExceptionIf() throws X {
...
@Test
    public void testHandleFloatSupMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleFloatSupMishandlingExceptionIsAllowed() throws X {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LFloatSupplier: float doGetAsFloat()");
    }
    ...
    @Test void safePropagates() {
        Object result = LFloatSupplier.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LFloatSupplier.safe(null);
        assertThat(result).isSameAs(LFloatSupplier.l(LFloatSupplier.safe()));
    }

    @Test  void safeSupplierPropagates() {
        LSupplier<LFloatSupplier> supplier = ()->sut;
        Object result = LFloatSupplier.safeSupplier(supplier);
        assertThat(result).isSameAs(supplier);
    }

    @Test  void safeSupplierProtectsAgainstNpe() {
        Object result = LFloatSupplier.safeSupplier(null);
        assertThat(result).isSameAs(LFloatSupplier.safeSupplier());
    }
