...
public class LShortPredicateXTest<X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LShortPredicateX: boolean test(short s) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(LShortPredicateX.lX((short s) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LShortPredicateX<X> wrapped = LShortPredicateX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws ParseException {
        ...
        //given
        LShortPredicateX<X> fun1 = LShortPredicateX.lX((short s) -> f1Result);
        LShortPredicateX<X> fun2 = LShortPredicateX.lX((short s) -> f2Result);
    ...
    public void testfromShort() throws ParseException {
        ...
        LShortPredicateX<X> sutO = (short s) -> {
        ...
        //when
        LShortPredicateX<X> function = sutO.fromShort(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LShortPredicate.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LShortPredicateX.class);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LShortPredicateX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LShortPredicateX: boolean test(short s) throws X");
    }
