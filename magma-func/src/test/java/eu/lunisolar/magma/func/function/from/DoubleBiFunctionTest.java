...
public class DoubleBiFunctionTest<R,X extends ParseException> {
    ...
    private DoubleBiFunction<R> sut = new DoubleBiFunction(){
        public @Nullable Object  apply(double d1,double d2)  {
            return testValue;
        }
    };

    private DoubleBiFunctionX<R,X> opposite = new DoubleBiFunctionX(){
        public @Nullable Object  apply(double d1,double d2) throws ParseException {
            return testValue;
        }
    };

    private DoubleBiFunction<R> sutNull = new DoubleBiFunction(){
        public @Nullable Object  apply(double d1,double d2)  {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (DoubleBiFunction: R apply(double d1,double d2)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("DoubleBiFunction: R apply(double d1,double d2)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(DoubleBiFunction.l((double d1,double d2) -> testValue ))
            .isInstanceOf(DoubleBiFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(DoubleBiFunction.wrap(opposite))
            .isInstanceOf(DoubleBiFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        DoubleBiFunction<R> wrapped = DoubleBiFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        DoubleBiFunctionX<R,ParseException> sutThrowing = DoubleBiFunctionX.lX((double d1,double d2) -> {
    ...
    public void testfromDouble() throws ParseException {
        ...
        DoubleBiFunction<Integer > sutO = (double d1,double d2) -> {
        ...
        //when
        DoubleBiFunction<Integer > function = sutO.fromDouble(before1,before2);
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        DoubleBiConsumer function = sutO.then(thenFunction);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(DoubleBiFunction.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        DoubleBiFunction<R> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("DoubleBiFunction: R apply(double d1,double d2)");
    }
