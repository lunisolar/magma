...
public class ToCharFunctionXTest<T,X extends ParseException> {
    ...
    private ToCharFunctionX<T,X> sut = new ToCharFunctionX(){
        public  char applyAsChar(Object t) throws ParseException {
            return testValue;
        }
    };

    private ToCharFunction<T> opposite = new ToCharFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ToCharFunctionX: char applyAsChar(T t) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(ToCharFunctionX.lX((Object t) -> testValue ))
            .isInstanceOf(ToCharFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(ToCharFunctionX.wrapX(opposite))
            .isInstanceOf(ToCharFunctionX.class);
    }
    ...
    public void testfrom() throws ParseException {
        ...
        ToCharFunctionX<Integer ,X> sutO = (Integer t) -> {
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        ToCharFunctionX<T,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ToCharFunctionX: char applyAsChar(T t) throws X");
    }
