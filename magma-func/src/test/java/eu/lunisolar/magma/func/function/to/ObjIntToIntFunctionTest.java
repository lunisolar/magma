...
public class ObjIntToIntFunctionTest<T,X extends ParseException> {
    ...
    private ObjIntToIntFunction<T> sut = new ObjIntToIntFunction(){
        public  int applyAsInt(Object t, int i)  {
            return testValue;
        }
    };

    private ObjIntToIntFunctionX<T,X> opposite = new ObjIntToIntFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ObjIntToIntFunction: int applyAsInt(T t, int i)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(ObjIntToIntFunction.l((Object t, int i) -> testValue ))
            .isInstanceOf(ObjIntToIntFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(ObjIntToIntFunction.wrap(opposite))
            .isInstanceOf(ObjIntToIntFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        ObjIntToIntFunction<T> wrapped = ObjIntToIntFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        ObjIntToIntFunctionX<T,ParseException> sutThrowing = ObjIntToIntFunctionX.lX((T t, int i) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        ObjIntToIntFunction<T> sutThrowing = ObjIntToIntFunction.l((T t, int i) -> {
            throw new UnsupportedOperationException();
        });

        // when
        ObjIntToIntFunction<T> wrapped = ObjIntToIntFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromInt() throws ParseException {
        ...
        ObjIntToIntFunction<Integer > sutO = (Integer t, int i) -> {
        ...
        //when
        ObjIntToIntFunction<Integer > function = sutO.fromInt(before1,before2);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ObjIntToIntFunction<T> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ObjIntToIntFunction: int applyAsInt(T t, int i)");
    }
