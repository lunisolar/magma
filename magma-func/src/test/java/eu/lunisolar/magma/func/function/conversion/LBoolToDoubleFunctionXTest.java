...
public class LBoolToDoubleFunctionXTest<X extends ParseException> {
    ...
    private LBoolToDoubleFunctionX<ParseException> sutAlwaysThrowing = LBoolToDoubleFunctionX.lX(b -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBoolToDoubleFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LBoolToDoubleFunctionX.lX(b -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBoolToDoubleFunctionX: double doApplyAsDouble(boolean b) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LBoolToDoubleFunctionX.lX(b -> testValue ))
...
@Test
    ...
    public void testboolToDoubleFuncComposeBoolean() throws X {
        ...
        LBoolToDoubleFunctionX<X> sutO = b -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBoolToDoubleFunctionX: double doApplyAsDouble(boolean b) throws X");
    }
