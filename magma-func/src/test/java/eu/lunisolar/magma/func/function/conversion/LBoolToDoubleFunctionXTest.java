...
public class LBoolToDoubleFunctionXTest<X extends ParseException> {
    ...
    private LBoolToDoubleFunctionX<X> sut = new LBoolToDoubleFunctionX(){
    ...
    private LBoolToDoubleFunctionX<ParseException> sutAlwaysThrowing = LBoolToDoubleFunctionX.lX(a1 -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBoolToDoubleFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LBoolToDoubleFunctionX.lX(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LBoolSingle,Double,X> theCall = sut;
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBoolToDoubleFunctionX: double doApplyAsDouble(boolean a1) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LBoolToDoubleFunctionX.lX(a1 -> testValue ))
...
@Test
    ...
    public void testboolToDoubleFuncComposeBoolean() throws X {
        ...
        LBoolToDoubleFunctionX<X> sutO = a1 -> {
        ...
        //when
        LBoolToDoubleFunctionX<X> function = sutO.boolToDoubleFuncComposeBoolean(before1);
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBoolToDoubleFunctionX: double doApplyAsDouble(boolean a1) throws X");
    }
