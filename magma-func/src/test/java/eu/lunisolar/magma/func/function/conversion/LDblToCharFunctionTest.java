...
public class LDblToCharFunctionTest {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.applyAsChar(100d), testValue);
    }
    ...
    public void testNonNullApplyAsChar() throws Throwable {
            Assert.assertEquals(sut.nonNullApplyAsChar(100d), testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LDblToCharFunction: char applyAsChar(double a)");
    }

    @Test
    public void testDblToCharFuncMethod() throws Throwable {
        Assert.assertTrue(LDblToCharFunction.dblToCharFunc(a -> testValue ) instanceof LDblToCharFunction);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LDblToCharFunction: char applyAsChar(double a)"));
