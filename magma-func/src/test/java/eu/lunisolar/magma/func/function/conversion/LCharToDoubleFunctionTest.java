...
public class LCharToDoubleFunctionTest<X extends ParseException> {
    ...
    private LCharToDoubleFunction sutAlwaysThrowingUnckeck = LCharToDoubleFunction.l((char c) -> {
    ...
    public void testLMethod() throws ParseException {
        assertThat(LCharToDoubleFunction.l((char c) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LCharToDoubleFunctionX<ParseException> sutThrowing = LCharToDoubleFunctionX.lX((char c) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LCharToDoubleFunction sutThrowing = LCharToDoubleFunction.l((char c) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LCharToDoubleFunction wrapped = LCharToDoubleFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromChar() throws ParseException {
        ...
        LCharToDoubleFunction sutO = (char c) -> {
        ...
        //when
        LCharToDoubleFunction function = sutO.fromChar(before1);
...
//
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LCharToDoubleFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
