...
public class LCharToDoubleFunctionTest<X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LCharToDoubleFunction: double applyAsDouble(char c)");
    }
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LCharToDoubleFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LCharToDoubleFunctionX.class);
    }
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LCharToDoubleFunction: double applyAsDouble(char c)");
    }
