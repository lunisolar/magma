...
public class ToIntFunctionXTest<T,X extends ParseException> {
    ...
    private ToIntFunctionX<T,X> sut = new ToIntFunctionX(){
        public  int applyAsInt(Object t) throws ParseException {
            return testValue;
        }
    };

    private ToIntFunction<T> opposite = new ToIntFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ToIntFunctionX: int applyAsInt(T t) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(ToIntFunctionX.lX((Object t) -> testValue ))
            .isInstanceOf(ToIntFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(ToIntFunctionX.wrapX(opposite))
            .isInstanceOf(ToIntFunctionX.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(ToIntFunctionX.wrapStd(jre))
            .isInstanceOf(ToIntFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        ToIntFunctionX<T,X> wrapped = ToIntFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfrom() throws ParseException {
        ...
        ToIntFunctionX<Integer ,X> sutO = (Integer t) -> {
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        ToIntFunctionX<T,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ToIntFunctionX: int applyAsInt(T t) throws X");
    }
