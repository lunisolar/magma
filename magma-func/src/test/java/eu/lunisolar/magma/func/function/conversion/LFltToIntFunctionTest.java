...
public class LFltToIntFunctionTest {
    ...
    private LFltToIntFunction sut = new LFltToIntFunction(){
    ...
    private LFltToIntFunction sutAlwaysThrowing = LFltToIntFunction.fltToIntFunc(a -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LFltToIntFunction sutAlwaysThrowingUnchecked = LFltToIntFunction.fltToIntFunc(a -> {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.applyAsInt(100f), testValue);
    }
    ...
    public void testNonNullApplyAsInt() throws Throwable {
            Assert.assertEquals(sut.nonNullApplyAsInt(100f), testValue);
    }
    ...
    public void testNestingApplyAsIntUnchecked() throws Throwable {
        ...
        // then
        try {
            sutAlwaysThrowingUnchecked.nestingApplyAsInt(100f);
    ...
    public void testShovingApplyAsIntUnchecked() throws Throwable {
        ...
        // then
        try {
            sutAlwaysThrowingUnchecked.shovingApplyAsInt(100f);
            Assert.fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            Assert.assertEquals(e.getClass(), IndexOutOfBoundsException.class);
            Assert.assertNull(e.getCause());
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LFltToIntFunction: int applyAsInt(float a)");
    }

    @Test
    public void testFltToIntFuncMethod() throws Throwable {
        Assert.assertTrue(LFltToIntFunction.fltToIntFunc(a -> testValue ) instanceof LFltToIntFunction);
    ...
    public void testCompose() throws Throwable {
        ...
        //when
        LFltToIntFunction function = sutO.compose(before);
        function.applyAsInt(80f);
    ...
    public void testShove() {
        ...
        // given
        LFltToIntFunction sutThrowing = LFltToIntFunction.fltToIntFunc(a -> {
            throw new UnsupportedOperationException();
        });

        // when
        sutThrowing.shovingApplyAsInt(100f);
    }
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LFltToIntFunction: int applyAsInt(float a)"));
