...
public class LByteToShortFunctionTest<X extends ParseException> {
    ...
    private LByteToShortFunctionX<X> opposite = new LByteToShortFunctionX(){
        public  short doApplyAsShort(byte a1) throws ParseException {
            return testValue;
        }
    };
    ...
    private LByteToShortFunction sutAlwaysThrowingUnckeck = LByteToShortFunction.l(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LByteSingle,Short,RuntimeException> theCall = sut;
...
@Test
    ...
    @Test void safeCompiles() {
        LByteToShortFunction r1 = LByteToShortFunction.safe(sut);
        LByteToShortFunctionX r2 = LByteToShortFunction.safe(sut);
    }
    ...
    @Test  void safeSupplierCompiles() {
        LSupplier<LByteToShortFunction> r1 = LByteToShortFunction.safeSupplier(()->sut);
    }
