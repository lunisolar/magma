...
public class LongToShortFunctionTest<X extends ParseException> {
    ...
    private LongToShortFunction sut = new LongToShortFunction(){
        public  short applyAsShort(long l)  {
            return testValue;
        }
    };

    private LongToShortFunctionX<X> opposite = new LongToShortFunctionX(){
        public  short applyAsShort(long l) throws ParseException {
            return testValue;
        }
    };
    ...
    public void testTheResult() throws ParseException {
        assertThat(sut.applyAsShort((long)100))
            .isEqualTo(testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LongToShortFunction: short applyAsShort(long l)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LongToShortFunction.l((long l) -> testValue ))
            .isInstanceOf(LongToShortFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(LongToShortFunction.wrap(opposite))
            .isInstanceOf(LongToShortFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        // given
        LongToShortFunctionX<X> sutThrowing = LongToShortFunctionX.lX((long l) -> {
            throw new UnsupportedOperationException(ORIGINAL_MESSAGE);
        });

        // when
        LongToShortFunction wrapped = LongToShortFunction.wrap(sutThrowing);

        // then
        try {
            wrapped.applyAsShort((long)100);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LongToShortFunctionX<ParseException> sutThrowing = LongToShortFunctionX.lX((long l) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LongToShortFunction sutThrowing = LongToShortFunction.l((long l) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LongToShortFunction wrapped = LongToShortFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromLong() throws ParseException {
        ...
        LongToShortFunction sutO = (long l) -> {
        ...
        //when
        LongToShortFunction function = sutO.fromLong(before1);
        function.applyAsShort((long)80);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LongToShortFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LongToShortFunctionX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().applyAsShort((long)100);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LongToShortFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LongToShortFunction: short applyAsShort(long l)");
    }
