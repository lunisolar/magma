...
public class LongToIntFunctionTest<X extends ParseException> {
    ...
    private LongToIntFunction sut = new LongToIntFunction(){
        public  int applyAsInt(long l)  {
            return testValue;
        }
    };

    private LongToIntFunctionX<X> opposite = new LongToIntFunctionX(){
        public  int applyAsInt(long l) throws ParseException {
            return testValue;
        }
    };
    ...
    public void testTheResult() throws ParseException {
        assertThat(sut.applyAsInt((long)100))
            .isEqualTo(testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LongToIntFunction: int applyAsInt(long l)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LongToIntFunction.l((long l) -> testValue ))
            .isInstanceOf(LongToIntFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(LongToIntFunction.wrap(opposite))
            .isInstanceOf(LongToIntFunction.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(LongToIntFunction.wrapStd(jre))
            .isInstanceOf(LongToIntFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        // given
        LongToIntFunctionX<X> sutThrowing = LongToIntFunctionX.lX((long l) -> {
            throw new UnsupportedOperationException(ORIGINAL_MESSAGE);
        });

        // when
        LongToIntFunction wrapped = LongToIntFunction.wrap(sutThrowing);

        // then
        try {
            wrapped.applyAsInt((long)100);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LongToIntFunctionX<ParseException> sutThrowing = LongToIntFunctionX.lX((long l) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LongToIntFunction sutThrowing = LongToIntFunction.l((long l) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LongToIntFunction wrapped = LongToIntFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromLong() throws ParseException {
        ...
        //when
        LongToIntFunction function = sutO.fromLong(before1);
        function.applyAsInt((long)80);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LongToIntFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LongToIntFunctionX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().applyAsInt((long)100);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LongToIntFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LongToIntFunction: int applyAsInt(long l)");
    }
