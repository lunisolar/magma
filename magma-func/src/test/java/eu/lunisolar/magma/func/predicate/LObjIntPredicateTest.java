...
public class LObjIntPredicateTest<T,X extends ParseException> {
    ...
    private LObjIntPredicate<T> sutAlwaysThrowingUnckeck = LObjIntPredicate.l((T a1,int a2) -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LObjIntPair<T>,Boolean,RuntimeException> theCall = sut;
    ...
    public void testLMethod() throws X {
        assertThat(LObjIntPredicate.l((Object a1,int a2) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LObjIntPredicateX<T,ParseException> sutThrowing = LObjIntPredicateX.lX((T a1,int a2) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LObjIntPredicate<T> sutThrowing = LObjIntPredicate.l((T a1,int a2) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LObjIntPredicate<T> wrapped = sutThrowing.handleObjIntPred(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LObjIntPredicate<T> wrapped = sutThrowing.handleObjIntPred(h -> Function4U.doNothing());
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws X {
        ...
        //given
        LObjIntPredicate<T> fun1 = LObjIntPredicate.l((T a1,int a2) -> f1Result);
        LObjIntPredicate<T> fun2 = LObjIntPredicate.l((T a1,int a2) -> f2Result);
    ...
    public void testHandleObjIntPred() throws X {
        ...
        // when
        LObjIntPredicate<T> wrapped = sutThrowing.handleObjIntPred(h -> {
    ...
    public void compilerSubstituteVariant1() {
        LObjIntPredicate lambda = LObjIntPredicate./*<T>*/l1(this::variant1);
    ...
    @Test void safeCompiles() {
        LObjIntPredicate r1 = LObjIntPredicate.safe(sut);
        LObjIntPredicateX r2 = LObjIntPredicate.safe(sut);
    }
    ...
    @Test  void safeSupplierPropagates() {
        LSupplier<LObjIntPredicate<T>> supplier = ()->sut;
    ...
    @Test  void safeSupplierCompiles() {
        LSupplier<LObjIntPredicate<T>> r1 = LObjIntPredicate.safeSupplier(()->sut);
    }
