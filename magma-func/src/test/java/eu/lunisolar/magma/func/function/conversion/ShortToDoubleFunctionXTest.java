...
public class ShortToDoubleFunctionXTest<X extends ParseException> {
    ...
    private ShortToDoubleFunctionX<X> sut = new ShortToDoubleFunctionX(){
        public  double applyAsDouble(short s) throws ParseException {
            return testValue;
        }
    };

    private ShortToDoubleFunction opposite = new ShortToDoubleFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ShortToDoubleFunctionX: double applyAsDouble(short s) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(ShortToDoubleFunctionX.lX((short s) -> testValue ))
            .isInstanceOf(ShortToDoubleFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(ShortToDoubleFunctionX.wrapX(opposite))
            .isInstanceOf(ShortToDoubleFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        ShortToDoubleFunctionX<X> wrapped = ShortToDoubleFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromShort() throws ParseException {
        ...
        ShortToDoubleFunctionX<X> sutO = (short s) -> {
        ...
        //when
        ShortToDoubleFunctionX<X> function = sutO.fromShort(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        ShortToDoubleFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ShortToDoubleFunctionX: double applyAsDouble(short s) throws X");
    }
