...
public class CharToShortFunctionTest<X extends ParseException> {
    ...
    private CharToShortFunction sut = new CharToShortFunction(){
        public  short applyAsShort(char c)  {
            return testValue;
        }
    };

    private CharToShortFunctionX<X> opposite = new CharToShortFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("CharToShortFunction: short applyAsShort(char c)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(CharToShortFunction.l((char c) -> testValue ))
            .isInstanceOf(CharToShortFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(CharToShortFunction.wrap(opposite))
            .isInstanceOf(CharToShortFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        CharToShortFunction wrapped = CharToShortFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        CharToShortFunctionX<ParseException> sutThrowing = CharToShortFunctionX.lX((char c) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        CharToShortFunction sutThrowing = CharToShortFunction.l((char c) -> {
            throw new UnsupportedOperationException();
        });

        // when
        CharToShortFunction wrapped = CharToShortFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromChar() throws ParseException {
        ...
        CharToShortFunction sutO = (char c) -> {
        ...
        //when
        CharToShortFunction function = sutO.fromChar(before1);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        CharToShortFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("CharToShortFunction: short applyAsShort(char c)");
    }
