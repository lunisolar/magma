...
public class ShortFunctionTest<R,X extends ParseException> {
    ...
    private ShortFunction<R> sut = new ShortFunction(){
        public @Nullable Object  apply(short s)  {
            return testValue;
        }
    };

    private ShortFunctionX<R,X> opposite = new ShortFunctionX(){
        public @Nullable Object  apply(short s) throws ParseException {
            return testValue;
        }
    };

    private ShortFunction<R> sutNull = new ShortFunction(){
        public @Nullable Object  apply(short s)  {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (ShortFunction: R apply(short s)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ShortFunction: R apply(short s)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(ShortFunction.l((short s) -> testValue ))
            .isInstanceOf(ShortFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(ShortFunction.wrap(opposite))
            .isInstanceOf(ShortFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        ShortFunction<R> wrapped = ShortFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        ShortFunctionX<R,ParseException> sutThrowing = ShortFunctionX.lX((short s) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        ShortFunction<R> sutThrowing = ShortFunction.l((short s) -> {
            throw new UnsupportedOperationException();
        });

        // when
        ShortFunction<R> wrapped = ShortFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromShort() throws ParseException {
        ...
        ShortFunction<Integer > sutO = (short s) -> {
        ...
        //when
        ShortFunction<Integer > function = sutO.fromShort(before1);
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        ShortConsumer function = sutO.then(thenFunction);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(ShortFunction.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ShortFunction<R> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ShortFunction: R apply(short s)");
    }
