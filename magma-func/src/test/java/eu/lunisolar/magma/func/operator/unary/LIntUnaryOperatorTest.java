...
public class LIntUnaryOperatorTest<X extends ParseException> {
    ...
    public void testLMethod() throws ParseException {
        assertThat(LIntUnaryOperator.l((int i) -> testValue ))
    ...
    public void testWrapStdMethod() throws ParseException {
        assertThat(LIntUnaryOperator.wrapStd(jre))
            .isInstanceOf(LIntUnaryOperator.class);
    }
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LIntUnaryOperatorX<ParseException> sutThrowing = LIntUnaryOperatorX.lX((int i) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LIntUnaryOperator sutThrowing = LIntUnaryOperator.l((int i) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LIntUnaryOperator wrapped = LIntUnaryOperator.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromInt() throws ParseException {
        ...
        //when
        LIntUnaryOperator function = sutO.fromInt(before1);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LIntUnaryOperator wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
