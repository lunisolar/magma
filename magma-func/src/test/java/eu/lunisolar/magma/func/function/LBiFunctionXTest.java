...
public class LBiFunctionXTest<T1,T2,R,X extends ParseException> {
    ...
    private LBiFunctionX<T1,T2,R,ParseException> sutAlwaysThrowing = LBiFunctionX.lX((T1 t1,T2 t2) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiFunctionX<T1,T2,R,RuntimeException> sutAlwaysThrowingUnckeck = LBiFunctionX.lX((T1 t1,T2 t2) -> {
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNullDoApply() method cannot be null (LBiFunctionX: R doApply(T1 t1,T2 t2) throws X).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBiFunctionX: R doApply(T1 t1,T2 t2) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LBiFunctionX.lX((Object t1,Object t2) -> testValue ))
...
@Test
    ...
    public void testbiFuncFrom() throws X {
        ...
        LBiFunctionX<Integer ,Integer ,Integer ,X> sutO = (Integer t1,Integer t2) -> {
        ...
        //when
        LBiFunctionX<Integer ,Integer ,Integer ,X> function = sutO.biFuncFrom(before1,before2);
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBiFunctionX: R doApply(T1 t1,T2 t2) throws X");
    }
