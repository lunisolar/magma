...
public class LBiFunctionXTest<T1,T2,R,X extends ParseException> {
    ...
    private LBiFunctionX<T1,T2,R,X> sut = new LBiFunctionX(){
        public @Nullable Object  doApply(Object a1,Object a2) throws ParseException {
            return testValue;
        }
    };

    private LBiFunction<T1,T2,R> opposite = new LBiFunction(){
        public @Nullable Object  doApply(Object a1,Object a2)  {
            return testValue;
        }
    };

    private LBiFunctionX<T1,T2,R,X> sutNull = new LBiFunctionX(){
        public @Nullable Object  doApply(Object a1,Object a2) throws ParseException {
            return null;
        }
    };
    ...
    private BiFunction jre = (Object a1,Object a2) -> testValue;


    private LBiFunctionX<T1,T2,R,ParseException> sutAlwaysThrowing = LBiFunctionX.lX((T1 a1,T2 a2) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiFunctionX<T1,T2,R,RuntimeException> sutAlwaysThrowingUnckeck = LBiFunctionX.lX((T1 a1,T2 a2) -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LPair<T1,T2>,R,X> theCall = sut;
    ...
    public void testNestingDoApplyChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoApply((T1)Integer.valueOf(100),(T2)Integer.valueOf(100));
    ...
    public void testShovingDoApplyChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoApply((T1)Integer.valueOf(100),(T2)Integer.valueOf(100));
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testLXMethod() throws X {
        assertThat(LBiFunctionX.lX((Object a1,Object a2) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LBiFunctionX<T1,T2,R,X> sutThrowing = LBiFunctionX.lX((T1 a1,T2 a2) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LBiFunctionX<T1,T2,R,X> wrapped = sutThrowing.handleBiFuncX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBiFunctionX<T1,T2,R,X> wrapped = sutThrowing.handleBiFuncX(h -> Function4U.doNothing());
    ...
    public void testbiFuncCompose() throws X {
        ...
        LBiFunctionX<Integer ,Integer ,Integer ,X> sutO = (Integer a1,Integer a2) -> {
    ...
    public void testHandleBiFunc() throws X {
        ...
        // when
        LBiFunctionX<T1,T2,R,X> wrapped = sutThrowing.handleBiFuncX(h -> {
    ...
    private R variant1(T2 a2,T1 a1) {
        return (R)Integer.valueOf(100);
    }

    @Test
    public void compilerSubstituteVariant1() {
        LBiFunctionX lambda = LBiFunctionX./*<T1,T2,R,X>*/lX1(this::variant1);
    ...
    @Test void safeCompiles() {
        LBiFunctionX r1 = LBiFunctionX.safe(sut);
        BiFunction r3 = LBiFunctionX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LBiFunctionX<T1,T2,R,X>,Y> supplier = ()->sut;
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LBiFunctionX<T1,T2,R,X>,Y> r1 = LBiFunctionX.safeSupplier(()->sut);
        Supplier<LBiFunctionX<T1,T2,R,X>> r2 = LBiFunctionX.safeSupplier(()->sut);
    }
