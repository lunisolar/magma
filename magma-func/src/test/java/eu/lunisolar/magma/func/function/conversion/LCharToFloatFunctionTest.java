...
public class LCharToFloatFunctionTest<X extends ParseException> {
    ...
    private LCharToFloatFunction sutAlwaysThrowingUnckeck = LCharToFloatFunction.l((char c) -> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LCharToFloatFunction: float doApplyAsFloat(char c)");
    }
...
//
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LCharToFloatFunction: float doApplyAsFloat(char c)");
    }
