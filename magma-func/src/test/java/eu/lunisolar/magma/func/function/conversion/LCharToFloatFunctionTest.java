...
public class LCharToFloatFunctionTest<X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LCharToFloatFunction: float applyAsFloat(char c)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LCharToFloatFunction.l((char c) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LCharToFloatFunctionX<ParseException> sutThrowing = LCharToFloatFunctionX.lX((char c) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LCharToFloatFunction sutThrowing = LCharToFloatFunction.l((char c) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LCharToFloatFunction wrapped = LCharToFloatFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromChar() throws ParseException {
        ...
        LCharToFloatFunction sutO = (char c) -> {
        ...
        //when
        LCharToFloatFunction function = sutO.fromChar(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LCharToFloatFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LCharToFloatFunctionX.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LCharToFloatFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LCharToFloatFunction: float applyAsFloat(char c)");
    }
