...
public class LTieBoolFunctionTest<T> {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.applyAsInt(100,100,true), testValue);
    }
    ...
    public void testNonNullApplyAsInt() throws Throwable {
            Assert.assertEquals(sut.nonNullApplyAsInt(100,100,true), testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LTieBoolFunction: int applyAsInt(T a1,int a2,boolean a3)");
    }

    @Test
    public void testTieBoolFuncMethod() throws Throwable {
        Assert.assertTrue(LTieBoolFunction.tieBoolFunc((a1,a2,a3) -> testValue ) instanceof LTieBoolFunction);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LTieBoolFunction: int applyAsInt(T a1,int a2,boolean a3)"));
    ...
    public void compilerSubstituteVariantLObjBoolIntToIntFunc() {
        ...
        Assert.assertTrue(lambda instanceof LTieBoolFunction.LObjBoolIntToIntFunc);
    }
    ...
    public void compilerSubstituteVariantLIntObjBoolToIntFunc() {
        ...
        Assert.assertTrue(lambda instanceof LTieBoolFunction.LIntObjBoolToIntFunc);
    }
    ...
    public void compilerSubstituteVariantLIntBoolObjToIntFunc() {
        ...
        Assert.assertTrue(lambda instanceof LTieBoolFunction.LIntBoolObjToIntFunc);
    }
    ...
    public void compilerSubstituteVariantLBoolObjIntToIntFunc() {
        ...
        Assert.assertTrue(lambda instanceof LTieBoolFunction.LBoolObjIntToIntFunc);
    }
    ...
    public void compilerSubstituteVariantLBoolIntObjToIntFunc() {
        ...
        Assert.assertTrue(lambda instanceof LTieBoolFunction.LBoolIntObjToIntFunc);
    }
