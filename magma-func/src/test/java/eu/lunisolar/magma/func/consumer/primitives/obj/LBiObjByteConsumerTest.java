...
public class LBiObjByteConsumerTest<T1,T2,X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBiObjByteConsumer: void accept(T1 t1,T2 t2, byte b)");
    }
    ...
    public void testfromByte() throws ParseException {
        ...
        //when
        LBiObjByteConsumer<Integer ,Integer > function = sutO.fromByte(before1,before2,before3);
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBiObjByteConsumer: void accept(T1 t1,T2 t2, byte b)");
    }
