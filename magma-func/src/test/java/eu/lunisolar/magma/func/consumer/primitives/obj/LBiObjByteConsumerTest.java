...
public class LBiObjByteConsumerTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjByteConsumer<T1,T2> sutAlwaysThrowingUnckeck = LBiObjByteConsumer.l((T1 a1,T2 a2,byte a3) -> {
    ...
    public void testLMethod() throws X {
        assertThat(LBiObjByteConsumer.l((Object a1,Object a2,byte a3) -> Function4U.doNothing() ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LBiObjByteConsumerX<T1,T2,ParseException> sutThrowing = LBiObjByteConsumerX.lX((T1 a1,T2 a2,byte a3) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LBiObjByteConsumer<T1,T2> sutThrowing = LBiObjByteConsumer.l((T1 a1,T2 a2,byte a3) -> {
...
@Test
    ...
    public void testbiObjByteConsComposeByte() throws X {
        ...
        LBiObjByteConsumer<Integer ,Integer > sutO = (Integer a1,Integer a2,byte a3) -> {
    ...
    public void testAndThen() throws X {
        ...
        LBiObjByteConsumer<Integer ,Integer > thenFunction = (Integer a1,Integer a2,byte a3) -> {
    ...
    private void variant1(T1 a1,byte a3,T2 a2) {
    }

    @Test
    public void compilerSubstituteVariant1() {
        LBiObjByteConsumer lambda = LBiObjByteConsumer./*<T1,T2>*/l1(this::variant1);

        assertThat(lambda).isInstanceOf(LBiObjByteConsumer.V1.class);
    }


    private void variant2(T2 a2,T1 a1,byte a3) {
    }

    @Test
    public void compilerSubstituteVariant2() {
        LBiObjByteConsumer lambda = LBiObjByteConsumer./*<T1,T2>*/l2(this::variant2);

        assertThat(lambda).isInstanceOf(LBiObjByteConsumer.V2.class);
    }


    private void variant3(T2 a2,byte a3,T1 a1) {
    }

    @Test
    public void compilerSubstituteVariant3() {
        LBiObjByteConsumer lambda = LBiObjByteConsumer./*<T1,T2>*/l3(this::variant3);

        assertThat(lambda).isInstanceOf(LBiObjByteConsumer.V3.class);
    }


    private void variant4(byte a3,T1 a1,T2 a2) {
    }

    @Test
    public void compilerSubstituteVariant4() {
        LBiObjByteConsumer lambda = LBiObjByteConsumer./*<T1,T2>*/l4(this::variant4);

        assertThat(lambda).isInstanceOf(LBiObjByteConsumer.V4.class);
    }


    private void variant5(byte a3,T2 a2,T1 a1) {
    }

    @Test
    public void compilerSubstituteVariant5() {
        LBiObjByteConsumer lambda = LBiObjByteConsumer./*<T1,T2>*/l5(this::variant5);
    ...
    @Test  void safeSupplierPropagates() {
        LSupplier<LBiObjByteConsumer<T1,T2>> supplier = ()->sut;
