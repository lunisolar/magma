...
public class FloatToShortFunctionXTest<X extends ParseException> {
    ...
    private FloatToShortFunctionX<X> sut = new FloatToShortFunctionX(){
        public  short applyAsShort(float f) throws ParseException {
            return testValue;
        }
    };

    private FloatToShortFunction opposite = new FloatToShortFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("FloatToShortFunctionX: short applyAsShort(float f) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(FloatToShortFunctionX.lX((float f) -> testValue ))
            .isInstanceOf(FloatToShortFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(FloatToShortFunctionX.wrapX(opposite))
            .isInstanceOf(FloatToShortFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        FloatToShortFunctionX<X> wrapped = FloatToShortFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromFloat() throws ParseException {
        ...
        FloatToShortFunctionX<X> sutO = (float f) -> {
        ...
        //when
        FloatToShortFunctionX<X> function = sutO.fromFloat(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        FloatToShortFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("FloatToShortFunctionX: short applyAsShort(float f) throws X");
    }
