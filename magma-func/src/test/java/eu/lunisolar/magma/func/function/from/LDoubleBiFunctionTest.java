...
public class LDoubleBiFunctionTest<R,X extends ParseException> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LDoubleBiFunction<R> wrapped = LDoubleBiFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromDouble() throws ParseException {
        ...
        //when
        LDoubleBiFunction<Integer > function = sutO.fromDouble(before1,before2);
...
//
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().doApply((double)100,(double)100);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LDoubleBiFunction<R> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
