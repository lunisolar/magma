...
public class ToFloatFunctionTest<T,X extends ParseException> {
    ...
    private ToFloatFunction<T> sut = new ToFloatFunction(){
        public  float applyAsFloat(Object t)  {
            return testValue;
        }
    };

    private ToFloatFunctionX<T,X> opposite = new ToFloatFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ToFloatFunction: float applyAsFloat(T t)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(ToFloatFunction.l((Object t) -> testValue ))
            .isInstanceOf(ToFloatFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(ToFloatFunction.wrap(opposite))
            .isInstanceOf(ToFloatFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        ToFloatFunction<T> wrapped = ToFloatFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        ToFloatFunctionX<T,ParseException> sutThrowing = ToFloatFunctionX.lX((T t) -> {
    ...
    public void testfrom() throws ParseException {
        ...
        ToFloatFunction<Integer > sutO = (Integer t) -> {
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ToFloatFunction<T> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ToFloatFunction: float applyAsFloat(T t)");
    }
