...
public class LBiObjDoublePredicateXTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjDoublePredicateX<T1,T2,ParseException> sutAlwaysThrowing = LBiObjDoublePredicateX.lX((T1 t1,T2 t2, double d) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiObjDoublePredicateX<T1,T2,RuntimeException> sutAlwaysThrowingUnckeck = LBiObjDoublePredicateX.lX((T1 t1,T2 t2, double d) -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBiObjDoublePredicateX: boolean doTest(T1 t1,T2 t2, double d) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LBiObjDoublePredicateX.lX((Object t1,Object t2, double d) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // when
        LBiObjDoublePredicateX<T1,T2,X> wrapped = sutThrowing.handleBiObjDPredX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBiObjDoublePredicateX<T1,T2,X> wrapped = sutThrowing.handleBiObjDPredX(h -> Function4U.doNothing());
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws X {
        ...
        //given
        LBiObjDoublePredicateX<T1,T2,X> fun1 = LBiObjDoublePredicateX.lX((T1 t1,T2 t2, double d) -> f1Result);
        LBiObjDoublePredicateX<T1,T2,X> fun2 = LBiObjDoublePredicateX.lX((T1 t1,T2 t2, double d) -> f2Result);
    ...
    public void testbiObjDPredFromDouble() throws X {
        ...
        LBiObjDoublePredicateX<Integer ,Integer ,X> sutO = (Integer t1,Integer t2, double d) -> {
        ...
        //when
        LBiObjDoublePredicateX<Integer ,Integer ,X> function = sutO.biObjDPredFromDouble(before1,before2,before3);
    ...
    public void testbiObjDPredFrom() throws X {
        ...
        //when
        LTriPredicateX<Integer ,Integer ,Integer ,X> function = sutO.biObjDPredFrom(before1,before2,before3);
    ...
    public void testHandleBiObjDPred() throws X {
        ...
        // when
        LBiObjDoublePredicateX<T1,T2,X> wrapped = sutThrowing.handleBiObjDPredX(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBiObjDoublePredicateX: boolean doTest(T1 t1,T2 t2, double d) throws X");
    }
