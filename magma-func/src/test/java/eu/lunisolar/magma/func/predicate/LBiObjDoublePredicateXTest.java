...
public class LBiObjDoublePredicateXTest<T1,T2,X extends ParseException> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LBiObjDoublePredicateX<T1,T2,X> wrapped = LBiObjDoublePredicateX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromDouble() throws ParseException {
        ...
        //when
        LBiObjDoublePredicateX<Integer ,Integer ,X> function = sutO.fromDouble(before1,before2,before3);
...
//
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().doTest((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),(double)100);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LBiObjDoublePredicateX<T1,T2,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
