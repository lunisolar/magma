...
public class LByteIntPredicateTest {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.test((byte)100,100), testValue);
    }
    ...
    public void testNonNullTest() throws Throwable {
            Assert.assertEquals(sut.nonNullTest((byte)100,100), testValue);
    }
    ...
    public void testApplyAsBooleanShouldNotModifyValue() throws Throwable {
        Assert.assertEquals(sut.doApplyAsBoolean((byte)100,100), testValue);
    }


    @Test
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LByteIntPredicate: boolean test(byte a1,int a2)");
    }

    @Test
    public void testByteIntPredMethod() throws Throwable {
        Assert.assertTrue(LByteIntPredicate.byteIntPred((a1,a2) -> testValue ) instanceof LByteIntPredicate);
    ...
    public void testnegate() throws Throwable {
        Assert.assertEquals(sut.negate().test((byte)100,100), !testValue);
    }
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws Throwable {
        ...
        //then
        Assert.assertEquals(andFunction.test((byte)100,100), andResult);

        Assert.assertEquals(orFunction.test((byte)100,100), orResult);

        Assert.assertEquals(xorFunction.test((byte)100,100), xorResult);
    }
    ...
    public void testIsEqual() throws Throwable  {
        ...
        //then
        Assert.assertTrue(equals.test((byte)1,1));

        Assert.assertFalse(equals.test((byte)0,0));
    }
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LByteIntPredicate: boolean test(byte a1,int a2)"));
    ...
    public void compilerSubstituteVariantLIntBytePred() {
        ...
        Assert.assertTrue(lambda instanceof LByteIntPredicate.LIntBytePred);
    }
