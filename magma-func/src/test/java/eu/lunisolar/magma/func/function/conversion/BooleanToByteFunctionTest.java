...
public class BooleanToByteFunctionTest<X extends ParseException> {
    ...
    private BooleanToByteFunction sut = new BooleanToByteFunction(){
        public  byte applyAsByte(boolean b)  {
            return testValue;
        }
    };

    private BooleanToByteFunctionX<X> opposite = new BooleanToByteFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BooleanToByteFunction: byte applyAsByte(boolean b)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(BooleanToByteFunction.l((boolean b) -> testValue ))
            .isInstanceOf(BooleanToByteFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(BooleanToByteFunction.wrap(opposite))
            .isInstanceOf(BooleanToByteFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        BooleanToByteFunction wrapped = BooleanToByteFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        BooleanToByteFunctionX<ParseException> sutThrowing = BooleanToByteFunctionX.lX((boolean b) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        BooleanToByteFunction sutThrowing = BooleanToByteFunction.l((boolean b) -> {
            throw new UnsupportedOperationException();
        });

        // when
        BooleanToByteFunction wrapped = BooleanToByteFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromBoolean() throws ParseException {
        ...
        BooleanToByteFunction sutO = (boolean b) -> {
        ...
        //when
        BooleanToByteFunction function = sutO.fromBoolean(before1);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        BooleanToByteFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BooleanToByteFunction: byte applyAsByte(boolean b)");
    }
