...
public class LBiObjDblConsumerTest<T1,T2> {
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LBiObjDblConsumer: void accept(T1 a1,T2 a2,double a3)");
    }

    @Test
    public void testBiObjDblConsMethod() throws Throwable {
        Assert.assertTrue(LBiObjDblConsumer.biObjDblCons(LBiObjDblConsumer::doNothing) instanceof LBiObjDblConsumer);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LBiObjDblConsumer: void accept(T1 a1,T2 a2,double a3)"));
    ...
    public void compilerSubstituteVariantLObj0Dbl2Obj1Cons() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjDblConsumer.LObj0Dbl2Obj1Cons);
    }
    ...
    public void compilerSubstituteVariantLObj1Obj0Dbl2Cons() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjDblConsumer.LObj1Obj0Dbl2Cons);
    }
    ...
    public void compilerSubstituteVariantLObj1Dbl2Obj0Cons() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjDblConsumer.LObj1Dbl2Obj0Cons);
    }
    ...
    public void compilerSubstituteVariantLDbl2Obj0Obj1Cons() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjDblConsumer.LDbl2Obj0Obj1Cons);
    }
    ...
    public void compilerSubstituteVariantLDbl2Obj1Obj0Cons() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjDblConsumer.LDbl2Obj1Obj0Cons);
    }
