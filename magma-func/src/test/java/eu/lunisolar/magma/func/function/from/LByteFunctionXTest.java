...
public class LByteFunctionXTest<R,X extends ParseException> {
    ...
    private LByteFunctionX<R,ParseException> sutAlwaysThrowing = LByteFunctionX.lX((byte b) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LByteFunctionX<R,RuntimeException> sutAlwaysThrowingUnckeck = LByteFunctionX.lX((byte b) -> {
