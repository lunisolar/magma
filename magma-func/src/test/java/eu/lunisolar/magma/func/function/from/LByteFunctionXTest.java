...
public class LByteFunctionXTest<R,X extends ParseException> {
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (LByteFunctionX: R apply(byte b) throws X).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LByteFunctionX: R apply(byte b) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(LByteFunctionX.lX((byte b) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LByteFunctionX<R,X> wrapped = LByteFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        LByteFunctionX<Integer ,X> sutO = (byte b) -> {
        ...
        //when
        LByteFunctionX<Integer ,X> function = sutO.fromByte(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LByteFunctionX<R,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LByteFunctionX: R apply(byte b) throws X");
    }
