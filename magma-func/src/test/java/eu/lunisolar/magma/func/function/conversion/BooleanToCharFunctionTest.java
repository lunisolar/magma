...
public class BooleanToCharFunctionTest<X extends ParseException> {
    ...
    private BooleanToCharFunction sut = new BooleanToCharFunction(){
        public  char applyAsChar(boolean b)  {
            return testValue;
        }
    };

    private BooleanToCharFunctionX<X> opposite = new BooleanToCharFunctionX(){
        public  char applyAsChar(boolean b) throws ParseException {
            return testValue;
        }
    };
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BooleanToCharFunction: char applyAsChar(boolean b)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(BooleanToCharFunction.l((boolean b) -> testValue ))
            .isInstanceOf(BooleanToCharFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(BooleanToCharFunction.wrap(opposite))
            .isInstanceOf(BooleanToCharFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        BooleanToCharFunction wrapped = BooleanToCharFunction.wrap(sutThrowing);

        // then
        try {
            wrapped.applyAsChar(true);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        BooleanToCharFunctionX<ParseException> sutThrowing = BooleanToCharFunctionX.lX((boolean b) -> {
    ...
    public void testfromBoolean() throws ParseException {
        ...
        BooleanToCharFunction sutO = (boolean b) -> {
        ...
        //when
        BooleanToCharFunction function = sutO.fromBoolean(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(BooleanToCharFunction.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        BooleanToCharFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BooleanToCharFunction: char applyAsChar(boolean b)");
    }
