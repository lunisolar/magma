...
public class CharToDoubleFunctionXTest<X extends ParseException> {
    ...
    private CharToDoubleFunctionX<X> sut = new CharToDoubleFunctionX(){
        public  double applyAsDouble(char c) throws ParseException {
            return testValue;
        }
    };

    private CharToDoubleFunction opposite = new CharToDoubleFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("CharToDoubleFunctionX: double applyAsDouble(char c) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(CharToDoubleFunctionX.lX((char c) -> testValue ))
            .isInstanceOf(CharToDoubleFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(CharToDoubleFunctionX.wrapX(opposite))
            .isInstanceOf(CharToDoubleFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        CharToDoubleFunctionX<X> wrapped = CharToDoubleFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromChar() throws ParseException {
        ...
        CharToDoubleFunctionX<X> sutO = (char c) -> {
        ...
        //when
        CharToDoubleFunctionX<X> function = sutO.fromChar(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        CharToDoubleFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("CharToDoubleFunctionX: double applyAsDouble(char c) throws X");
    }
