...
public class LBoolConsumerXTest<X extends ParseException> {
    ...
    private LBoolConsumerX<X> sut = new LBoolConsumerX(){
    ...
    private LBoolConsumerX<RuntimeException> sutAlwaysThrowingUnckeck = LBoolConsumerX.lX(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LBoolSingle,LTuple.Void,X> theCall = sut;
    ...
    public void testLXMethod() throws X {
        assertThat(LBoolConsumerX.lX(a1 -> Function4U.doNothing() ))
            .isInstanceOf(LBoolConsumerX.class);
    }

    @Test
    public void testWrapXMethod() throws X {
        assertThat(LBoolConsumerX.wrapX(opposite))
            .isInstanceOf(LBoolConsumerX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // when
        LBoolConsumerX<X> wrapped = sutThrowing.handleBoolConsX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBoolConsumerX<X> wrapped = sutThrowing.handleBoolConsX(h -> Function4U.doNothing());
    ...
    public void testboolConsComposeBoolean() throws X {
        ...
        //when
        LBoolConsumerX<X> function = sutO.boolConsComposeBoolean(before1);
    ...
    public void testAndThen() throws X {
        ...
        LBoolConsumerX<X> thenFunction = (boolean a1) -> {
                thenFunctionCalled.set(true);
                assertThat(a1).isEqualTo(true);
        };

        //when
        LBoolConsumerX<X> function = sutO.andThen(thenFunction);
        function.doAccept(true);
    ...
    public void testHandleBoolCons() throws X {
        ...
        // when
        LBoolConsumerX<X> wrapped = sutThrowing.handleBoolConsX(h -> {
    ...
    @Test void safeCompiles() {
        LBoolConsumerX r1 = LBoolConsumerX.safe(sut);
    }

    @Test void safePropagates() {
        Object result = LBoolConsumerX.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LBoolConsumerX.safe(null);
        assertThat(result).isSameAs(LBoolConsumerX.lX(LBoolConsumerX.safe()));
    }

    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LBoolConsumerX<X>,Y> supplier = ()->sut;
        Object result = LBoolConsumerX.safeSupplier(supplier);
        assertThat(result).isSameAs(supplier);
    }

    @Test <Y extends Throwable> void safeSupplierProtectsAgainstNpe() {
        Object result = LBoolConsumerX.safeSupplier(null);
        assertThat(result).isSameAs(LBoolConsumerX.safeSupplier());
    }

    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LBoolConsumerX<X>,Y> r1 = LBoolConsumerX.safeSupplier(()->sut);
    }
