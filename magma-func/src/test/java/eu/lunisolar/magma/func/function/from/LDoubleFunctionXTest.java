...
public class LDoubleFunctionXTest<R,X extends ParseException> {
    ...
    private LDoubleFunctionX<R,X> sut = new LDoubleFunctionX(){
        public @Nullable Object  doApply(double d) throws ParseException {
            return testValue;
        }
    };

    private LDoubleFunction<R> opposite = new LDoubleFunction(){
        public @Nullable Object  doApply(double d)  {
            return testValue;
        }
    };

    private LDoubleFunctionX<R,X> sutNull = new LDoubleFunctionX(){
        public @Nullable Object  doApply(double d) throws ParseException {
            return null;
        }
    };
    ...
    private java.util.function.DoubleFunction jre = d -> testValue;


    private LDoubleFunctionX<R,ParseException> sutAlwaysThrowing = LDoubleFunctionX.lX(d -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LDoubleFunctionX<R,RuntimeException> sutAlwaysThrowingUnckeck = LDoubleFunctionX.lX(d -> {
    ...
    public void testNestingDoApplyChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoApply((double)100);
    ...
    public void testShovingDoApplyChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoApply((double)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testLXMethod() throws X {
        assertThat(LDoubleFunctionX.lX(d -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LDoubleFunctionX<R,X> sutThrowing = LDoubleFunctionX.lX(d -> {
            throw new UnsupportedOperationException();
        });

        // when
        LDoubleFunctionX<R,X> wrapped = sutThrowing.handleDFuncX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LDoubleFunctionX<R,X> wrapped = sutThrowing.handleDFuncX(h -> Function4U.doNothing());
    ...
    @Test
    public void testdFuncFromDouble() throws X {

        final ThreadLocal<Boolean> mainFunctionCalled = ThreadLocal.withInitial(()-> false);
        final AtomicInteger beforeCalls = new AtomicInteger(0);

        //given (+ some assertions)
        LDoubleFunctionX<Integer ,X> sutO = d -> {
        ...
        //when
        LDoubleFunctionX<Integer ,X> function = sutO.dFuncFromDouble(before1);
    ...
    @Test
    public void testdFuncFrom() throws X {
        ...
        //when
        LFunctionX<Integer ,Integer ,X> function = sutO.dFuncFrom(before1);
    ...
    public void testNesting() {
        assertThat(sut.nestingDFunc())
            .isInstanceOf(LDoubleFunction.class);
    }

    @Test
    public void testShoving() {
        assertThat(sut.shovingDFunc())
            .isInstanceOf(LDoubleFunction.class);
    }

    @Test
    public void testNestingX() {
        assertThat(sut.nestingDFuncX())
            .isInstanceOf(LDoubleFunctionX.class);
    }

    @Test
    public void testShovingX() {
        assertThat(sut.shovingDFuncX())
            .isInstanceOf(LDoubleFunctionX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingDFunc().doApply((double)100);
    }

    @Test
    public void testHandleDFunc() throws X {
        ...
        // when
        LDoubleFunctionX<R,X> wrapped = sutThrowing.handleDFuncX(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LDoubleFunctionX: R doApply(double d) throws X");
    }
