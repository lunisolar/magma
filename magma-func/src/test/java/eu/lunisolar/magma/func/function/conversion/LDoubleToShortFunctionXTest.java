...
public class LDoubleToShortFunctionXTest<X extends ParseException> {
    ...
    private LDoubleToShortFunctionX<X> sut = new LDoubleToShortFunctionX(){
    ...
    private LDoubleToShortFunctionX<ParseException> sutAlwaysThrowing = LDoubleToShortFunctionX.lX(d -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LDoubleToShortFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LDoubleToShortFunctionX.lX(d -> {
    ...
    public void testNestingDoApplyAsShortChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoApplyAsShort((double)100);
    ...
    public void testShovingDoApplyAsShortChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoApplyAsShort((double)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LDoubleToShortFunctionX: short doApplyAsShort(double d) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LDoubleToShortFunctionX.lX(d -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LDoubleToShortFunctionX<X> sutThrowing = LDoubleToShortFunctionX.lX(d -> {
            throw new UnsupportedOperationException();
        });

        // when
        LDoubleToShortFunctionX<X> wrapped = sutThrowing.handleDToSFuncX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LDoubleToShortFunctionX<X> wrapped = sutThrowing.handleDToSFuncX(h -> Function4U.doNothing());
    ...
    public void testdToSFuncFromDouble() throws X {
        ...
        LDoubleToShortFunctionX<X> sutO = d -> {
        ...
        //when
        LDoubleToShortFunctionX<X> function = sutO.dToSFuncFromDouble(before1);
    ...
    public void testdToSFuncFrom() throws X {
        ...
        //when
        LToShortFunctionX<Integer ,X> function = sutO.dToSFuncFrom(before1);
    ...
    public void testHandleDToSFunc() throws X {
        ...
        // when
        LDoubleToShortFunctionX<X> wrapped = sutThrowing.handleDToSFuncX(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LDoubleToShortFunctionX: short doApplyAsShort(double d) throws X");
    }
