...
public class ToLongFunctionXTest<T,X extends ParseException> {
    ...
    private ToLongFunctionX<T,X> sut = new ToLongFunctionX(){
        public  long applyAsLong(Object t) throws ParseException {
            return testValue;
        }
    };

    private ToLongFunction<T> opposite = new ToLongFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ToLongFunctionX: long applyAsLong(T t) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(ToLongFunctionX.lX((Object t) -> testValue ))
            .isInstanceOf(ToLongFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(ToLongFunctionX.wrapX(opposite))
            .isInstanceOf(ToLongFunctionX.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(ToLongFunctionX.wrapStd(jre))
            .isInstanceOf(ToLongFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        ToLongFunctionX<T,X> wrapped = ToLongFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfrom() throws ParseException {
        ...
        ToLongFunctionX<Integer ,X> sutO = (Integer t) -> {
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        ToLongFunctionX<T,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ToLongFunctionX: long applyAsLong(T t) throws X");
    }
