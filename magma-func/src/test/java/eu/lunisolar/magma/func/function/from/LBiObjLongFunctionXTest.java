...
public class LBiObjLongFunctionXTest<T1,T2,R,X extends ParseException> {
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (LBiObjLongFunctionX: R apply(T1 t1,T2 t2, long l) throws X).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBiObjLongFunctionX: R apply(T1 t1,T2 t2, long l) throws X");
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LBiObjLongFunctionX<T1,T2,R,X> wrapped = LBiObjLongFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LBiObjLongFunctionX<T1,T2,R,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBiObjLongFunctionX: R apply(T1 t1,T2 t2, long l) throws X");
    }
