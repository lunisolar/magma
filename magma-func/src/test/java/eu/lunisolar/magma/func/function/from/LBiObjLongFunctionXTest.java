...
public class LBiObjLongFunctionXTest<T1,T2,R,X extends ParseException> {
    ...
    private LBiObjLongFunctionX<T1,T2,R,X> sut = new LBiObjLongFunctionX(){
        public @Nullable Object  doApply(Object a1,Object a2,long a3) throws ParseException {
            return testValue;
        }
    };

    private LBiObjLongFunction<T1,T2,R> opposite = new LBiObjLongFunction(){
        public @Nullable Object  doApply(Object a1,Object a2,long a3)  {
            return testValue;
        }
    };
    ...
    private LBiObjLongFunctionX<T1,T2,R,ParseException> sutAlwaysThrowing = LBiObjLongFunctionX.lX((T1 a1,T2 a2,long a3) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiObjLongFunctionX<T1,T2,R,RuntimeException> sutAlwaysThrowingUnckeck = LBiObjLongFunctionX.lX((T1 a1,T2 a2,long a3) -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LBiObjLongTriple<T1,T2>,R,X> theCall = sut;
    ...
    public void testLXMethod() throws X {
        assertThat(LBiObjLongFunctionX.lX((Object a1,Object a2,long a3) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LBiObjLongFunctionX<T1,T2,R,X> sutThrowing = LBiObjLongFunctionX.lX((T1 a1,T2 a2,long a3) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LBiObjLongFunctionX<T1,T2,R,X> wrapped = sutThrowing.handleBiObjLongFuncX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBiObjLongFunctionX<T1,T2,R,X> wrapped = sutThrowing.handleBiObjLongFuncX(h -> Function4U.doNothing());
    ...
    public void testbiObjLongFuncComposeLong() throws X {
        ...
        LBiObjLongFunctionX<Integer ,Integer ,Integer ,X> sutO = (Integer a1,Integer a2,long a3) -> {
    ...
    public void testHandleBiObjLongFunc() throws X {
        ...
        // when
        LBiObjLongFunctionX<T1,T2,R,X> wrapped = sutThrowing.handleBiObjLongFuncX(h -> {
    ...
    public void compilerSubstituteVariant1() {
        LBiObjLongFunctionX lambda = LBiObjLongFunctionX./*<T1,T2,R,X>*/lX1(this::variant1);
    ...
    public void compilerSubstituteVariant2() {
        LBiObjLongFunctionX lambda = LBiObjLongFunctionX./*<T1,T2,R,X>*/lX2(this::variant2);
    ...
    public void compilerSubstituteVariant3() {
        LBiObjLongFunctionX lambda = LBiObjLongFunctionX./*<T1,T2,R,X>*/lX3(this::variant3);
    ...
    public void compilerSubstituteVariant4() {
        LBiObjLongFunctionX lambda = LBiObjLongFunctionX./*<T1,T2,R,X>*/lX4(this::variant4);
    ...
    public void compilerSubstituteVariant5() {
        LBiObjLongFunctionX lambda = LBiObjLongFunctionX./*<T1,T2,R,X>*/lX5(this::variant5);
    ...
    @Test void safeCompiles() {
        LBiObjLongFunctionX r1 = LBiObjLongFunctionX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LBiObjLongFunctionX<T1,T2,R,X>,Y> supplier = ()->sut;
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LBiObjLongFunctionX<T1,T2,R,X>,Y> r1 = LBiObjLongFunctionX.safeSupplier(()->sut);
    }
