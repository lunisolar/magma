...
public class LBiObjLongFunctionXTest<T1,T2,R,X extends ParseException> {
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (LBiObjLongFunctionX: R doApply(T1 t1,T2 t2, long l) throws X).\\E")
