...
public class LBoolToLongFunctionXTest<X extends ParseException> {
    ...
    private LBoolToLongFunctionX<X> sut = new LBoolToLongFunctionX(){
    ...
    private LBoolToLongFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LBoolToLongFunctionX.lX(a1 -> {
...
@Test
    ...
    public void testboolToLongFuncComposeBoolean() throws X {
        ...
        //when
        LBoolToLongFunctionX<X> function = sutO.boolToLongFuncComposeBoolean(before1);
