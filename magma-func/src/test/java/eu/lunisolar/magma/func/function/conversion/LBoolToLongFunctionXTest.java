...
public class LBoolToLongFunctionXTest<X extends ParseException> {
    ...
    private LBoolToLongFunctionX<X> sut = new LBoolToLongFunctionX<X>(){
        public  long doApplyAsLong(boolean a)  throws X {
            return testValue;
        }
    };

    private LBoolToLongFunction opposite = new LBoolToLongFunction(){
    ...
    private LBoolToLongFunctionX<ParseException> sutAlwaysThrowing = LBoolToLongFunctionX.lX(a -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBoolToLongFunctionX<RuntimeException> sutAlwaysThrowingUnchecked = LBoolToLongFunctionX.lX(a -> {
    ...
    public void testNestingDoApplyAsLongUnchecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowingUnchecked.nestingDoApplyAsLong(true);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testShovingDoApplyAsLongUnchecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowingUnchecked.shovingDoApplyAsLong(true);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
                    .isExactlyInstanceOf(IndexOutOfBoundsException.class)
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBoolToLongFunctionX: long doApplyAsLong(boolean a) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LBoolToLongFunctionX.lX(a -> testValue ))
            .isInstanceOf(LBoolToLongFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws X {
        assertThat(LBoolToLongFunctionX.wrapX(opposite))
            .isInstanceOf(LBoolToLongFunctionX.class);
    }
    ...
    public void testHandlingDoApplyAsLongMethodWrapsTheException() throws X {
        ...
        // given
        LBoolToLongFunctionX<X> sutThrowing = LBoolToLongFunctionX.lX(a -> {
            throw new UnsupportedOperationException();
        });

        // when
        LBoolToLongFunctionX<RuntimeException> wrapped = sutThrowing.handleBoolToLongFuncX(handler -> handler
    ...
    @Test
    public void testHandleBoolToLongFuncXMethodDoNotWrapsOtherExceptionIf() throws X {
        ...
        // when
        LBoolToLongFunctionX<X> wrapped = sutThrowing.handleBoolToLongFuncX(handler -> handler
                .wrapIf(UnsupportedOperationException.class::isInstance,IllegalArgumentException::new,  EXCEPTION_WAS_WRAPPED)
...
@Test
    public void testHandleBoolToLongFuncXMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleBoolToLongFuncXMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBoolToLongFunctionX<X> wrapped = sutThrowing.handleBoolToLongFuncX(h -> Function4U.doNothing());
    ...
    @Test
    public void testBoolToLongFuncComposeBool() throws X {

        final ThreadLocal<Boolean> mainFunctionCalled = ThreadLocal.withInitial(()-> false);
        final AtomicInteger beforeCalls = new AtomicInteger(0);

        //given (+ some assertions)
        LBoolToLongFunctionX<X> sutO = a -> {
        ...
        //when
        LBoolToLongFunctionX<X> function = sutO.boolToLongFuncComposeBool(before);
    ...
    public void testBoolToLongFuncCompose() throws X {
        ...
        //when
        LToLongFunctionX<Integer,X> function = sutO.boolToLongFuncCompose(before);
    ...
    public void testHandleBoolToLongFunc() throws X {
        ...
        // when
        LBoolToLongFunctionX<X> wrapped = sutThrowing.handleBoolToLongFuncX(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBoolToLongFunctionX: long doApplyAsLong(boolean a) throws X");
    }
    ...
    @Test void safePropagates() {
        Object result = LBoolToLongFunctionX.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LBoolToLongFunctionX.safe(null);
        assertThat(result).isSameAs(LBoolToLongFunctionX.lX(LBoolToLongFunctionX.safe()));
    }

    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LBoolToLongFunctionX<X>,Y> supplier = ()->sut;
        Object result = LBoolToLongFunctionX.safeSupplier(supplier);
        assertThat(result).isSameAs(supplier);
    }

    @Test <Y extends Throwable> void safeSupplierProtectsAgainstNpe() {
        Object result = LBoolToLongFunctionX.safeSupplier(null);
        assertThat(result).isSameAs(LBoolToLongFunctionX.safeSupplier());
    }
