...
public class ShortToFloatFunctionTest<X extends ParseException> {
    ...
    private ShortToFloatFunction sut = new ShortToFloatFunction(){
        public  float applyAsFloat(short s)  {
            return testValue;
        }
    };

    private ShortToFloatFunctionX<X> opposite = new ShortToFloatFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ShortToFloatFunction: float applyAsFloat(short s)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(ShortToFloatFunction.l((short s) -> testValue ))
            .isInstanceOf(ShortToFloatFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(ShortToFloatFunction.wrap(opposite))
            .isInstanceOf(ShortToFloatFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        ShortToFloatFunction wrapped = ShortToFloatFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        ShortToFloatFunctionX<ParseException> sutThrowing = ShortToFloatFunctionX.lX((short s) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        ShortToFloatFunction sutThrowing = ShortToFloatFunction.l((short s) -> {
            throw new UnsupportedOperationException();
        });

        // when
        ShortToFloatFunction wrapped = ShortToFloatFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromShort() throws ParseException {
        ...
        ShortToFloatFunction sutO = (short s) -> {
        ...
        //when
        ShortToFloatFunction function = sutO.fromShort(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(ShortToFloatFunction.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ShortToFloatFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ShortToFloatFunction: float applyAsFloat(short s)");
    }
