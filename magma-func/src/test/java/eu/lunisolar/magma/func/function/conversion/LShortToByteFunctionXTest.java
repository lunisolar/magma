...
public class LShortToByteFunctionXTest<X extends ParseException> {
    ...
    private LShortToByteFunctionX<X> sut = new LShortToByteFunctionX(){
        public  byte doApplyAsByte(short a1) throws ParseException {
            return testValue;
        }
    };
    ...
    private LShortToByteFunctionX<ParseException> sutAlwaysThrowing = LShortToByteFunctionX.lX(a1 -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LShortToByteFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LShortToByteFunctionX.lX(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LShortSingle,Byte,X> theCall = sut;
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LShortToByteFunctionX: byte doApplyAsByte(short a1) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LShortToByteFunctionX.lX(a1 -> testValue ))
...
@Test
    ...
    public void testshortToByteFuncComposeShort() throws X {
        ...
        LShortToByteFunctionX<X> sutO = a1 -> {
        ...
        //when
        LShortToByteFunctionX<X> function = sutO.shortToByteFuncComposeShort(before1);
    ...
    public void testshortToByteFuncCompose() throws X {
        ...
        //when
        LToByteFunctionX<Integer ,X> function = sutO.shortToByteFuncCompose(before1);
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LShortToByteFunctionX: byte doApplyAsByte(short a1) throws X");
    }
    ...
    @Test void safeCompiles() {
        LShortToByteFunctionX r1 = LShortToByteFunctionX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LShortToByteFunctionX<X>,Y> r1 = LShortToByteFunctionX.safeSupplier(()->sut);
    }
