...
public class LFloatToDoubleFunctionTest<X extends ParseException> {
    ...
    private LFloatToDoubleFunction sutAlwaysThrowingUnckeck = LFloatToDoubleFunction.l((float f) -> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LFloatToDoubleFunction: double doApplyAsDouble(float f)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LFloatToDoubleFunction.l((float f) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LFloatToDoubleFunctionX<ParseException> sutThrowing = LFloatToDoubleFunctionX.lX((float f) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LFloatToDoubleFunction sutThrowing = LFloatToDoubleFunction.l((float f) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LFloatToDoubleFunction wrapped = LFloatToDoubleFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromFloat() throws ParseException {
        ...
        LFloatToDoubleFunction sutO = (float f) -> {
        ...
        //when
        LFloatToDoubleFunction function = sutO.fromFloat(before1);
...
//
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LFloatToDoubleFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LFloatToDoubleFunction: double doApplyAsDouble(float f)");
    }
