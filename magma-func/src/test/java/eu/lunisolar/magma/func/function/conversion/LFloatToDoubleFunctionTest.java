...
public class LFloatToDoubleFunctionTest<X extends ParseException> {
    ...
    private LFloatToDoubleFunction sutAlwaysThrowingUnckeck = LFloatToDoubleFunction.l(f -> {
    ...
    public void testLMethod() throws X {
        assertThat(LFloatToDoubleFunction.l(f -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LFloatToDoubleFunctionX<ParseException> sutThrowing = LFloatToDoubleFunctionX.lX(f -> {
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LFloatToDoubleFunction wrapped = sutThrowing.handle(h -> Function4U.doNothing());
