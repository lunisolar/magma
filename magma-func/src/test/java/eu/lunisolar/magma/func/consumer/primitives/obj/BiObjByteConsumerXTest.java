...
public class BiObjByteConsumerXTest<T1,T2,X extends ParseException> {
    ...
    private BiObjByteConsumerX<T1,T2,X> sut = new BiObjByteConsumerX(){
        public  void accept(Object t1,Object t2, byte b) throws ParseException {
            Function4U.doNothing();
        }
    };

    private BiObjByteConsumer<T1,T2> opposite = new BiObjByteConsumer(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BiObjByteConsumerX: void accept(T1 t1,T2 t2, byte b) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(BiObjByteConsumerX.lX((Object t1,Object t2, byte b) -> Function4U.doNothing() ))
            .isInstanceOf(BiObjByteConsumerX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(BiObjByteConsumerX.wrapX(opposite))
            .isInstanceOf(BiObjByteConsumerX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        BiObjByteConsumerX<T1,T2,X> wrapped = BiObjByteConsumerX.wrapException(sutThrowing, UnsupportedOperationException.class, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        BiObjByteConsumerX<Integer ,Integer ,X> sutO = (Integer t1,Integer t2, byte b) -> {
        ...
        //when
        BiObjByteConsumerX<Integer ,Integer ,X> function = sutO.fromByte(before1,before2,before3);
    ...
    public void testAndThen() throws ParseException {
        ...
        BiObjByteConsumerX<Integer ,Integer ,X> thenFunction = (Integer t1,Integer t2, byte b) -> {
        ...
        //when
        BiObjByteConsumerX<Integer ,Integer ,X> function = sutO.andThen(thenFunction);
        function.accept((Integer )Integer.valueOf(80),(Integer )Integer.valueOf(81),(byte)82);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        BiObjByteConsumerX<T1,T2,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BiObjByteConsumerX: void accept(T1 t1,T2 t2, byte b) throws X");
    }
