...
public class LongBiFunctionXTest<R,X extends ParseException> {
    ...
    private LongBiFunctionX<R,X> sut = new LongBiFunctionX(){
        public @Nullable Object  apply(long l1,long l2) throws ParseException {
            return testValue;
        }
    };

    private LongBiFunction<R> opposite = new LongBiFunction(){
        public @Nullable Object  apply(long l1,long l2)  {
            return testValue;
        }
    };

    private LongBiFunctionX<R,X> sutNull = new LongBiFunctionX(){
        public @Nullable Object  apply(long l1,long l2) throws ParseException {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (LongBiFunctionX: R apply(long l1,long l2) throws X).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LongBiFunctionX: R apply(long l1,long l2) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(LongBiFunctionX.lX((long l1,long l2) -> testValue ))
            .isInstanceOf(LongBiFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(LongBiFunctionX.wrapX(opposite))
            .isInstanceOf(LongBiFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LongBiFunctionX<R,X> sutThrowing = LongBiFunctionX.lX((long l1,long l2) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LongBiFunctionX<R,X> wrapped = LongBiFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromLong() throws ParseException {
        ...
        LongBiFunctionX<Integer ,X> sutO = (long l1,long l2) -> {
        ...
        //when
        LongBiFunctionX<Integer ,X> function = sutO.fromLong(before1,before2);
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        LongBiConsumerX<X> function = sutO.then(thenFunction);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LongBiFunction.class);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LongBiFunctionX<R,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LongBiFunctionX: R apply(long l1,long l2) throws X");
    }
