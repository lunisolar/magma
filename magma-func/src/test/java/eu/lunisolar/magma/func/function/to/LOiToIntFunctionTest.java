...
public class LOiToIntFunctionTest<T> {
    ...
    private LOiToIntFunction<Integer> sut = new LOiToIntFunction<Integer>(){
        public  int doApplyAsIntX(Integer a1,int a2)  {
            return testValue;
        }
    };
    ...
    private LOiToIntFunction<Integer> sutAlwaysThrowing = LOiToIntFunction.oiToIntFunc((a1,a2) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LOiToIntFunction<Integer> sutAlwaysThrowingUnchecked = LOiToIntFunction.oiToIntFunc((a1,a2) -> {
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LOiToIntFunction: int doApplyAsInt(T a1,int a2)");
    }

    @Test
    public void testOiToIntFuncMethod() throws Throwable {
        assertThat(LOiToIntFunction.oiToIntFunc((a1,a2) -> testValue ))
            .isInstanceOf(LOiToIntFunction.class);
    }
    ...
    @Test
    public void testOiToIntFuncComposeInt() throws Throwable {

        final ThreadLocal<Boolean> mainFunctionCalled = ThreadLocal.withInitial(()-> false);
        final AtomicInteger beforeCalls = new AtomicInteger(0);

        //given (+ some assertions)
        LOiToIntFunction<Integer> sutO = (a1,a2) -> {
        ...
        //when
        LOiToIntFunction<Integer> function = sutO.oiToIntFuncComposeInt(before1,before2);
    ...
    @Test
    public void testOiToIntFuncCompose() throws Throwable {
        ...
        //when
        LToIntBiFunction<Integer,Integer> function = sutO.oiToIntFuncCompose(before1,before2);
        function.doApplyAsInt(80,81);
    ...
    public void testNesting() {
        assertThat(sut.nestingOiToIntFunc())
            .isSameAs(sut)
            .isInstanceOf(LOiToIntFunction.class);
    }
    ...
    public void testShoving() {
        assertThat(sut.shovingOiToIntFunc())
            .isSameAs(sut)
            .isInstanceOf(LOiToIntFunction.class);
    }
    ...
    public void testShove() {
        ...
        // given
        LOiToIntFunction<Integer> sutThrowing = LOiToIntFunction.oiToIntFunc((a1,a2) -> {
            throw new UnsupportedOperationException();
        });

        // when
        sutThrowing.shovingOiToIntFunc().doApplyAsInt(100,100);
    }
    ...
    public void testToString() throws Throwable {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LOiToIntFunction: int doApplyAsInt(T a1,int a2)");
    }
    ...
    private int variantLIntObjToIntFunc(int a2,Integer a1) {
        return 100;
    }

    @Test
    public void compilerSubstituteVariantLIntObjToIntFunc() {
        LOiToIntFunction lambda = LOiToIntFunction./*<T>*/intObjToIntFunc(this::variantLIntObjToIntFunc);

        assertThat(lambda).isInstanceOf(LOiToIntFunction.LIntObjToIntFunc.class);
    }
