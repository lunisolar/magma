...
public class LOiToIntFunctionTest<T> {
    ...
    private LOiToIntFunction<Integer> sut = new LOiToIntFunction<Integer>(){
        public  int applyAsIntX(Integer a1,int a2)  {
            return testValue;
        }
    };
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LOiToIntFunction: int applyAsInt(T a1,int a2)");
    }

    @Test
    public void testOiToIntFuncMethod() throws Throwable {
        Assert.assertTrue(LOiToIntFunction.oiToIntFunc((a1,a2) -> testValue ) instanceof LOiToIntFunction);
    ...
    public void testCompose() throws Throwable {
        ...
        //when
        LOiToIntFunction<Integer> function = sutO.compose(before1,before2);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LOiToIntFunction: int applyAsInt(T a1,int a2)"));
    ...
    public void compilerSubstituteVariantLIntObjToIntFunc() {
        ...
        Assert.assertTrue(lambda instanceof LOiToIntFunction.LIntObjToIntFunc);
    }
