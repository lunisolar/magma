...
public class LTriPredicateXTest<T1,T2,T3,X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LTriPredicateX: boolean test(T1 t1,T2 t2,T3 t3) throws X");
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LTriPredicateX<T1,T2,T3,X> wrapped = LTriPredicateX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LTriPredicate.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LTriPredicateX.class);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LTriPredicateX<T1,T2,T3,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LTriPredicateX: boolean test(T1 t1,T2 t2,T3 t3) throws X");
    }
