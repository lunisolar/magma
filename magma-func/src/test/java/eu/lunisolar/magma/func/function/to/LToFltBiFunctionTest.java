...
public class LToFltBiFunctionTest<T1,T2> {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.applyAsFlt(100,100), testValue);
    }
    ...
    public void testNonNullApplyAsFlt() throws Throwable {
            Assert.assertEquals(sut.nonNullApplyAsFlt(100,100), testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LToFltBiFunction: float applyAsFlt(T1 a1,T2 a2)");
    }

    @Test
    public void testToFltBiFuncMethod() throws Throwable {
        Assert.assertTrue(LToFltBiFunction.toFltBiFunc((a1,a2) -> testValue ) instanceof LToFltBiFunction);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LToFltBiFunction: float applyAsFlt(T1 a1,T2 a2)"));
    ...
    public void compilerSubstituteVariantLToFltObj1Obj0Func() {
        ...
        Assert.assertTrue(lambda instanceof LToFltBiFunction.LToFltObj1Obj0Func);
    }
