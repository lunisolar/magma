...
public class LIntFunctionTest<R,X extends ParseException> {
    ...
    private LIntFunction<R> sut = new LIntFunction(){
        public @Nullable Object  doApply(int i)  {
            return testValue;
        }
    };

    private LIntFunctionX<R,X> opposite = new LIntFunctionX(){
        public @Nullable Object  doApply(int i) throws ParseException {
            return testValue;
        }
    };

    private LIntFunction<R> sutNull = new LIntFunction(){
        public @Nullable Object  doApply(int i)  {
            return null;
        }
    };
    ...
    private java.util.function.IntFunction jre = i -> testValue;



    private LIntFunction<R> sutAlwaysThrowingUnckeck = LIntFunction.l(i -> {
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNullDoApply() method cannot be null (LIntFunction: R doApply(int i)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LIntFunction: R doApply(int i)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LIntFunction.l(i -> testValue ))
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws X {
        // given
        LIntFunctionX<R,X> sutThrowing = LIntFunctionX.lX(i -> {
            throw new UnsupportedOperationException(ORIGINAL_MESSAGE);
        });

        // when
        LIntFunction<R> wrapped = LIntFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LIntFunctionX<R,ParseException> sutThrowing = LIntFunctionX.lX(i -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LIntFunction<R> sutThrowing = LIntFunction.l(i -> {
            throw new UnsupportedOperationException();
        });

        // when
        LIntFunction<R> wrapped = sutThrowing.handleIFunc(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LIntFunction<R> wrapped = sutThrowing.handleIFunc(h -> Function4U.doNothing());
    ...
    @Test
    public void testiFuncFromInt() throws X {

        final ThreadLocal<Boolean> mainFunctionCalled = ThreadLocal.withInitial(()-> false);
        final AtomicInteger beforeCalls = new AtomicInteger(0);

        //given (+ some assertions)
        LIntFunction<Integer > sutO = i -> {
        ...
        //when
        LIntFunction<Integer > function = sutO.iFuncFromInt(before1);
    ...
    @Test
    public void testiFuncFrom() throws X {
        ...
        //when
        LFunction<Integer ,Integer > function = sutO.iFuncFrom(before1);
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingIFunc().doApply((int)100);
    }

    @Test
    public void testHandleIFunc() throws X {
        ...
        // when
        LIntFunction<R> wrapped = sutThrowing.handleIFunc(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LIntFunction: R doApply(int i)");
    }
