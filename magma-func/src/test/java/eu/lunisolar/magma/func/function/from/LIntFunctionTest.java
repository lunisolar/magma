...
public class LIntFunctionTest<R,X extends ParseException> {
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (LIntFunction: R doApply(int i)).\\E")
    ...
    public void testLMethod() throws ParseException {
        assertThat(LIntFunction.l((int i) -> testValue ))
    ...
    public void testWrapStdMethod() throws ParseException {
        assertThat(LIntFunction.wrapStd(jre))
            .isInstanceOf(LIntFunction.class);
    }
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LIntFunctionX<R,ParseException> sutThrowing = LIntFunctionX.lX((int i) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LIntFunction<R> sutThrowing = LIntFunction.l((int i) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LIntFunction<R> wrapped = LIntFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromInt() throws ParseException {
        ...
        LIntFunction<Integer > sutO = (int i) -> {
        ...
        //when
        LIntFunction<Integer > function = sutO.fromInt(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LIntFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LIntFunctionX.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LIntFunction<R> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
