...
public class LBoolToDoubleFunctionTest<X extends ParseException> {
    ...
    private LBoolToDoubleFunction sut = new LBoolToDoubleFunction(){
        public  double doApplyAsDouble(boolean a1)  {
            return testValue;
        }
    };

    private LBoolToDoubleFunctionX<X> opposite = new LBoolToDoubleFunctionX(){
        public  double doApplyAsDouble(boolean a1) throws ParseException {
            return testValue;
        }
    };
    ...
    private LBoolToDoubleFunction sutAlwaysThrowingUnckeck = LBoolToDoubleFunction.l(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LBoolSingle,Double,RuntimeException> theCall = sut;
    ...
    public void testNestingDoApplyAsDoubleUnckeck() throws X {
        ...
        // then
        try {
            sutAlwaysThrowingUnckeck.nestingDoApplyAsDouble(true);
    ...
    public void testShovingDoApplyAsDoubleUnckeck() throws X {
        ...
        // then
        try {
            sutAlwaysThrowingUnckeck.shovingDoApplyAsDouble(true);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
                    .isExactlyInstanceOf(IndexOutOfBoundsException.class)
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBoolToDoubleFunction: double doApplyAsDouble(boolean a1)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LBoolToDoubleFunction.l(a1 -> testValue ))
            .isInstanceOf(LBoolToDoubleFunction.class);
    }

    @Test
    public void testWrapMethod() throws X {
        assertThat(LBoolToDoubleFunction.wrap(opposite))
            .isInstanceOf(LBoolToDoubleFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws X {
        // given
        LBoolToDoubleFunctionX<X> sutThrowing = LBoolToDoubleFunctionX.lX(a1 -> {
            throw new UnsupportedOperationException(ORIGINAL_MESSAGE);
        });

        // when
        LBoolToDoubleFunction wrapped = LBoolToDoubleFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LBoolToDoubleFunctionX<ParseException> sutThrowing = LBoolToDoubleFunctionX.lX(a1 -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LBoolToDoubleFunction sutThrowing = LBoolToDoubleFunction.l(a1 -> {
            throw new UnsupportedOperationException();
        });

        // when
        LBoolToDoubleFunction wrapped = sutThrowing.handleBoolToDoubleFunc(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBoolToDoubleFunction wrapped = sutThrowing.handleBoolToDoubleFunc(h -> Function4U.doNothing());
    ...
    @Test
    public void testboolToDoubleFuncComposeBoolean() throws X {

        final ThreadLocal<Boolean> mainFunctionCalled = ThreadLocal.withInitial(()-> false);
        final AtomicInteger beforeCalls = new AtomicInteger(0);

        //given (+ some assertions)
        LBoolToDoubleFunction sutO = a1 -> {
        ...
        //when
        LBoolToDoubleFunction function = sutO.boolToDoubleFuncComposeBoolean(before1);
    ...
    public void testboolToDoubleFuncCompose() throws X {
        ...
        //when
        LToDoubleFunction<Integer > function = sutO.boolToDoubleFuncCompose(before1);
    ...
    public void testHandleBoolToDoubleFunc() throws X {
        ...
        // when
        LBoolToDoubleFunction wrapped = sutThrowing.handleBoolToDoubleFunc(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBoolToDoubleFunction: double doApplyAsDouble(boolean a1)");
    }
    ...
    @Test void safeCompiles() {
        LBoolToDoubleFunction r1 = LBoolToDoubleFunction.safe(sut);
        LBoolToDoubleFunctionX r2 = LBoolToDoubleFunction.safe(sut);
    }

    @Test void safePropagates() {
        Object result = LBoolToDoubleFunction.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LBoolToDoubleFunction.safe(null);
        assertThat(result).isSameAs(LBoolToDoubleFunction.l(LBoolToDoubleFunction.safe()));
    }

    @Test  void safeSupplierPropagates() {
        LSupplier<LBoolToDoubleFunction> supplier = ()->sut;
        Object result = LBoolToDoubleFunction.safeSupplier(supplier);
        assertThat(result).isSameAs(supplier);
    }

    @Test  void safeSupplierProtectsAgainstNpe() {
        Object result = LBoolToDoubleFunction.safeSupplier(null);
        assertThat(result).isSameAs(LBoolToDoubleFunction.safeSupplier());
    }

    @Test  void safeSupplierCompiles() {
        LSupplier<LBoolToDoubleFunction> r1 = LBoolToDoubleFunction.safeSupplier(()->sut);
    }
