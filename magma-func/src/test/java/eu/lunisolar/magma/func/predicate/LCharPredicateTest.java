...
public class LCharPredicateTest<X extends ParseException> {
    ...
    private LCharPredicateX<X> opposite = new LCharPredicateX(){
        public  boolean doTest(char a1) throws ParseException {
            return testValue;
        }
    };
    ...
    private LCharPredicate sutAlwaysThrowingUnckeck = LCharPredicate.l(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LCharSingle,Boolean,RuntimeException> theCall = sut;
...
@Test
    ...
    @Test void safeCompiles() {
        LCharPredicate r1 = LCharPredicate.safe(sut);
        LCharPredicateX r2 = LCharPredicate.safe(sut);
    }
    ...
    @Test void safeProtectsAgainstNpe() {
        ...
        assertThat(result).isSameAs(LCharPredicate.l(LCharPredicate.safe()));
    }
    ...
    @Test  void safeSupplierCompiles() {
        LSupplier<LCharPredicate> r1 = LCharPredicate.safeSupplier(()->sut);
    }
