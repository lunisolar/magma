...
public class LLongPredicateTest<X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LLongPredicate: boolean test(long l)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LLongPredicate.l((long l) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LLongPredicateX<ParseException> sutThrowing = LLongPredicateX.lX((long l) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LLongPredicate sutThrowing = LLongPredicate.l((long l) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LLongPredicate wrapped = LLongPredicate.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws ParseException {
        ...
        //given
        LLongPredicate fun1 = LLongPredicate.l((long l) -> f1Result);
        LLongPredicate fun2 = LLongPredicate.l((long l) -> f2Result);
    ...
    public void testfromLong() throws ParseException {
        ...
        //when
        LLongPredicate function = sutO.fromLong(before1);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LLongPredicate wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LLongPredicate: boolean test(long l)");
    }
