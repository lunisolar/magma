...
public class LBoolToByteFunctionTest<X extends ParseException> {
    ...
    private LBoolToByteFunction sutAlwaysThrowingUnckeck = LBoolToByteFunction.l(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LBoolSingle,Byte,RuntimeException> theCall = sut;
...
@Test
    ...
    @Test void safeCompiles() {
        LBoolToByteFunction r1 = LBoolToByteFunction.safe(sut);
        LBoolToByteFunctionX r2 = LBoolToByteFunction.safe(sut);
    }
    ...
    @Test  void safeSupplierCompiles() {
        LSupplier<LBoolToByteFunction> r1 = LBoolToByteFunction.safeSupplier(()->sut);
    }
