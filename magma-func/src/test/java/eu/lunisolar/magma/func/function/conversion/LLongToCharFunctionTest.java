...
public class LLongToCharFunctionTest {
    ...
    private LLongToCharFunction sutAlwaysThrowing = LLongToCharFunction.longToCharFunc(a -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LLongToCharFunction sutAlwaysThrowingUnchecked = LLongToCharFunction.longToCharFunc(a -> {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.applyAsChar(100L), testValue);
    }
    ...
    public void testNonNullApplyAsChar() throws Throwable {
            Assert.assertEquals(sut.nonNullApplyAsChar(100L), testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LLongToCharFunction: char applyAsChar(long a)");
    }

    @Test
    public void testLongToCharFuncMethod() throws Throwable {
        Assert.assertTrue(LLongToCharFunction.longToCharFunc(a -> testValue ) instanceof LLongToCharFunction);
    ...
    public void testShove() {
        ...
        // given
        LLongToCharFunction sutThrowing = LLongToCharFunction.longToCharFunc(a -> {
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LLongToCharFunction: char applyAsChar(long a)"));
