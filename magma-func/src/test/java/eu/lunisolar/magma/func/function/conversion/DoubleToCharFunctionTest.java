...
public class DoubleToCharFunctionTest<X extends ParseException> {
    ...
    private DoubleToCharFunction sut = new DoubleToCharFunction(){
        public  char applyAsChar(double d)  {
            return testValue;
        }
    };

    private DoubleToCharFunctionX<X> opposite = new DoubleToCharFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("DoubleToCharFunction: char applyAsChar(double d)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(DoubleToCharFunction.l((double d) -> testValue ))
            .isInstanceOf(DoubleToCharFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(DoubleToCharFunction.wrap(opposite))
            .isInstanceOf(DoubleToCharFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        // given
        DoubleToCharFunctionX<X> sutThrowing = DoubleToCharFunctionX.lX((double d) -> {
            throw new UnsupportedOperationException(ORIGINAL_MESSAGE);
        });

        // when
        DoubleToCharFunction wrapped = DoubleToCharFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        DoubleToCharFunctionX<ParseException> sutThrowing = DoubleToCharFunctionX.lX((double d) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        DoubleToCharFunction sutThrowing = DoubleToCharFunction.l((double d) -> {
            throw new UnsupportedOperationException();
        });

        // when
        DoubleToCharFunction wrapped = DoubleToCharFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromDouble() throws ParseException {
        ...
        DoubleToCharFunction sutO = (double d) -> {
        ...
        //when
        DoubleToCharFunction function = sutO.fromDouble(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(DoubleToCharFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(DoubleToCharFunctionX.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        DoubleToCharFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("DoubleToCharFunction: char applyAsChar(double d)");
    }
