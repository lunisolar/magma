...
public class LObjBoolFunctionTest<T,R> {
    ...
    public void testObjBoolFuncMethod() throws Throwable {
        assertThat(LObjBoolFunction.objBoolFunc((a1,a2) -> testValue ))
    ...
    public void compilerSubstituteVariantLBoolObjFunc() {
        ...
        assertThat(lambda).isInstanceOf(LObjBoolFunction.LBoolObjFunc.class);
    }
    ...
    @Test void safeProtectsAgainstNpe() {
        ...
        assertThat(result).isSameAs(LObjBoolFunction.objBoolFunc(LObjBoolFunction.safe()));
    }
