...
public class LObjBoolFunctionTest<T,R> {
    ...
    private LObjBoolFunction<Integer,Integer> sutAlwaysThrowing = LObjBoolFunction.objBoolFunc((a1,a2) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LObjBoolFunction<Integer,Integer> sutAlwaysThrowingUnchecked = LObjBoolFunction.objBoolFunc((a1,a2) -> {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.apply(100,true), testValue);
    }
    ...
    public void testNonNullApply() throws Throwable {
            Assert.assertSame(sut.nonNullApply(100,true), testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LObjBoolFunction: R apply(T a1,boolean a2)");
    }

    @Test
    public void testObjBoolFuncMethod() throws Throwable {
        Assert.assertTrue(LObjBoolFunction.objBoolFunc((a1,a2) -> testValue ) instanceof LObjBoolFunction);
    ...
    public void testShove() {
        ...
        // given
        LObjBoolFunction<Integer,Integer> sutThrowing = LObjBoolFunction.objBoolFunc((a1,a2) -> {
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LObjBoolFunction: R apply(T a1,boolean a2)"));
