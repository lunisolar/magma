...
public class LBiObjDoubleFunctionTest<T1,T2,R,X extends ParseException> {
    ...
    private LBiObjDoubleFunction<Integer,Integer,Integer> sut = new LBiObjDoubleFunction<Integer,Integer,Integer>(){
        public @Nullable Integer doApply(Integer a1,Integer a2,double a3)  {
            return testValue;
        }
    };

    private LBiObjDoubleFunctionX<Integer,Integer,Integer,X> opposite = new LBiObjDoubleFunctionX<Integer,Integer,Integer,X>(){
        public @Nullable Integer doApply(Integer a1,Integer a2,double a3)  throws X {
            return testValue;
        }
    };

    private LBiObjDoubleFunction<Integer,Integer,Integer> sutNull = new LBiObjDoubleFunction<Integer,Integer,Integer>(){
        public @Nullable Integer doApply(Integer a1,Integer a2,double a3)  {
            return null;
        }
    };
    ...
    private LBiObjDoubleFunctionX<Integer,Integer,Integer,RuntimeException> sutAlwaysThrowingUnchecked = LBiObjDoubleFunction.l((a1,a2,a3) -> {
    ...
    public void testLMethod() throws X {
        assertThat(LBiObjDoubleFunction.l((a1,a2,a3) -> testValue ))
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws X {
        ...
        // when
        LBiObjDoubleFunction<Integer,Integer,Integer> wrapped = LBiObjDoubleFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LBiObjDoubleFunctionX<Integer,Integer,Integer,ParseException> sutThrowing = LBiObjDoubleFunctionX.lX((a1,a2,a3) -> {
    ...
    public void testHandlingDoApplyMethodWrapsTheException() throws X {
        ...
        // given
        LBiObjDoubleFunction<Integer,Integer,Integer> sutThrowing = LBiObjDoubleFunction.l((a1,a2,a3) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LBiObjDoubleFunction<Integer,Integer,Integer> wrapped = sutThrowing.handleBiObjDoubleFunc(handler -> handler
    ...
    @Test
    public void testHandleBiObjDoubleFuncMethodDoNotWrapsOtherExceptionIf() throws X {
...
@Test
    public void testHandleBiObjDoubleFuncMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleBiObjDoubleFuncMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBiObjDoubleFunction<Integer,Integer,Integer> wrapped = sutThrowing.handleBiObjDoubleFunc(h -> Function4U.doNothing());
    ...
    public void testThen0() throws X  {
        ...
        //given (+ some assertions)
        LBiObjDoubleFunction<Integer,Integer,Integer> sutO = (a1,a2,a3) -> {
                mainFunctionCalled.set(true);
    ...
    public void testHandleBiObjDoubleFunc() throws X {
        ...
        // when
        LBiObjDoubleFunction<Integer,Integer,Integer> wrapped = sutThrowing.handleBiObjDoubleFunc(h -> {
    ...
    public void compilerSubstituteVariantV1() {
        LBiObjDoubleFunction lambda = LBiObjDoubleFunction./*<T1,T2,R>*/l1(this::variantV1);
    ...
    public void compilerSubstituteVariantV2() {
        LBiObjDoubleFunction lambda = LBiObjDoubleFunction./*<T1,T2,R>*/l2(this::variantV2);
    ...
    public void compilerSubstituteVariantV3() {
        LBiObjDoubleFunction lambda = LBiObjDoubleFunction./*<T1,T2,R>*/l3(this::variantV3);
    ...
    public void compilerSubstituteVariantV4() {
        LBiObjDoubleFunction lambda = LBiObjDoubleFunction./*<T1,T2,R>*/l4(this::variantV4);
    ...
    public void compilerSubstituteVariantV5() {
        LBiObjDoubleFunction lambda = LBiObjDoubleFunction./*<T1,T2,R>*/l5(this::variantV5);
    ...
    @Test  void safeSupplierPropagates() {
        LSupplier<LBiObjDoubleFunction<Integer,Integer,Integer>> supplier = ()->sut;
    ...
    @Test  void safeSupplierCompiles() {
        LSupplier<LBiObjDoubleFunction<Integer,Integer,Integer>> r1 = LBiObjDoubleFunction.safeSupplier(()->sut);  //NOSONAR
    }
