...
public class LDoubleToByteFunctionXTest<X extends ParseException> {
    ...
    private LDoubleToByteFunctionX<ParseException> sutAlwaysThrowing = LDoubleToByteFunctionX.lX((double d) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LDoubleToByteFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LDoubleToByteFunctionX.lX((double d) -> {
    ...
    public void testLXMethod() throws ParseException {
        assertThat(LDoubleToByteFunctionX.lX((double d) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LDoubleToByteFunctionX<X> sutThrowing = LDoubleToByteFunctionX.lX((double d) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LDoubleToByteFunctionX<X> wrapped = LDoubleToByteFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromDouble() throws ParseException {
        ...
        LDoubleToByteFunctionX<X> sutO = (double d) -> {
        ...
        //when
        LDoubleToByteFunctionX<X> function = sutO.fromDouble(before1);
...
//
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LDoubleToByteFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
