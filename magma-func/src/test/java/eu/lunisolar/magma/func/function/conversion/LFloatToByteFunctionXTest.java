...
public class LFloatToByteFunctionXTest<X extends ParseException> {
    ...
    private LFloatToByteFunctionX<ParseException> sutAlwaysThrowing = LFloatToByteFunctionX.lX((float f) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LFloatToByteFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LFloatToByteFunctionX.lX((float f) -> {
    ...
    public void testLXMethod() throws ParseException {
        assertThat(LFloatToByteFunctionX.lX((float f) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LFloatToByteFunctionX<X> wrapped = LFloatToByteFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromFloat() throws ParseException {
        ...
        LFloatToByteFunctionX<X> sutO = (float f) -> {
        ...
        //when
        LFloatToByteFunctionX<X> function = sutO.fromFloat(before1);
...
//
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LFloatToByteFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
