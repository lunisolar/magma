...
public class LFloatToByteFunctionXTest<X extends ParseException> {
    ...
    private LFloatToByteFunctionX<X> sut = new LFloatToByteFunctionX(){
        public  byte doApplyAsByte(float a1) throws ParseException {
            return testValue;
        }
    };
    ...
    private LFloatToByteFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LFloatToByteFunctionX.lX(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LFloatSingle,Byte,X> theCall = sut;
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // when
        LFloatToByteFunctionX<X> wrapped = sutThrowing.handleFloatToByteFuncX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LFloatToByteFunctionX<X> wrapped = sutThrowing.handleFloatToByteFuncX(h -> Function4U.doNothing());
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingFloatToByteFunc().doApplyAsByte((float)100);
    }
    ...
    public void testHandleFloatToByteFunc() throws X {
        ...
        // when
        LFloatToByteFunctionX<X> wrapped = sutThrowing.handleFloatToByteFuncX(h -> {
    ...
    @Test void safeCompiles() {
        LFloatToByteFunctionX r1 = LFloatToByteFunctionX.safe(sut);
    }

    @Test void safePropagates() {
        Object result = LFloatToByteFunctionX.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LFloatToByteFunctionX.safe(null);
        assertThat(result).isSameAs(LFloatToByteFunctionX.lX(LFloatToByteFunctionX.safe()));
    }

    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LFloatToByteFunctionX<X>,Y> supplier = ()->sut;
        Object result = LFloatToByteFunctionX.safeSupplier(supplier);
        assertThat(result).isSameAs(supplier);
    }

    @Test <Y extends Throwable> void safeSupplierProtectsAgainstNpe() {
        Object result = LFloatToByteFunctionX.safeSupplier(null);
        assertThat(result).isSameAs(LFloatToByteFunctionX.safeSupplier());
    }

    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LFloatToByteFunctionX<X>,Y> r1 = LFloatToByteFunctionX.safeSupplier(()->sut);
    }
