...
public class LFloatToByteFunctionXTest<X extends ParseException> {
    ...
    private LFloatToByteFunctionX<X> sut = new LFloatToByteFunctionX(){
    ...
    private LFloatToByteFunctionX<ParseException> sutAlwaysThrowing = LFloatToByteFunctionX.lX(f -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LFloatToByteFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LFloatToByteFunctionX.lX(f -> {
    ...
    public void testNestingDoApplyAsByteChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoApplyAsByte((float)100);
    ...
    public void testShovingDoApplyAsByteChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoApplyAsByte((float)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LFloatToByteFunctionX: byte doApplyAsByte(float f) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LFloatToByteFunctionX.lX(f -> testValue ))
            .isInstanceOf(LFloatToByteFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws X {
        assertThat(LFloatToByteFunctionX.wrapX(opposite))
            .isInstanceOf(LFloatToByteFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LFloatToByteFunctionX<X> sutThrowing = LFloatToByteFunctionX.lX(f -> {
            throw new UnsupportedOperationException();
        });

        // when
        LFloatToByteFunctionX<X> wrapped = sutThrowing.handleFToBFuncX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LFloatToByteFunctionX<X> wrapped = sutThrowing.handleFToBFuncX(h -> Function4U.doNothing());
    ...
    @Test
    public void testfToBFuncFromFloat() throws X {

        final ThreadLocal<Boolean> mainFunctionCalled = ThreadLocal.withInitial(()-> false);
        final AtomicInteger beforeCalls = new AtomicInteger(0);

        //given (+ some assertions)
        LFloatToByteFunctionX<X> sutO = f -> {
        ...
        //when
        LFloatToByteFunctionX<X> function = sutO.fToBFuncFromFloat(before1);
    ...
    @Test
    public void testfToBFuncFrom() throws X {
        ...
        //when
        LToByteFunctionX<Integer ,X> function = sutO.fToBFuncFrom(before1);
    ...
    public void testNesting() {
        assertThat(sut.nestingFToBFunc())
            .isInstanceOf(LFloatToByteFunction.class);
    }

    @Test
    public void testShoving() {
        assertThat(sut.shovingFToBFunc())
            .isInstanceOf(LFloatToByteFunction.class);
    }

    @Test
    public void testNestingX() {
        assertThat(sut.nestingFToBFuncX())
            .isInstanceOf(LFloatToByteFunctionX.class);
    }

    @Test
    public void testShovingX() {
        assertThat(sut.shovingFToBFuncX())
            .isInstanceOf(LFloatToByteFunctionX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingFToBFunc().doApplyAsByte((float)100);
    }

    @Test
    public void testHandleFToBFunc() throws X {
        ...
        // when
        LFloatToByteFunctionX<X> wrapped = sutThrowing.handleFToBFuncX(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LFloatToByteFunctionX: byte doApplyAsByte(float f) throws X");
    }
