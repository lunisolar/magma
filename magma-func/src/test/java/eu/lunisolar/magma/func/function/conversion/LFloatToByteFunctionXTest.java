...
public class LFloatToByteFunctionXTest<X extends ParseException> {
    ...
    public void testNestingDoApplyAsByteChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoApplyAsByte(100f);
    ...
    public void testShovingDoApplyAsByteChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoApplyAsByte(100f);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testHandlingDoApplyAsByteMethodWrapsTheException() throws X {
        ...
        // when
        LFloatToByteFunctionX<RuntimeException> wrapped = sutThrowing.handleFloatToByteFuncX(handler -> handler
