...
public class LObjCharFunctionXTest<T,R,X extends ParseException> {
    ...
    private LObjCharFunctionX<Integer,Integer,X> sut = new LObjCharFunctionX<Integer,Integer,X>(){
        public @Nullable Integer doApply(Integer a1,char a2)  throws X {
            return testValue;
        }
    };

    private LObjCharFunction<Integer,Integer> opposite = new LObjCharFunction<Integer,Integer>(){
        public @Nullable Integer doApply(Integer a1,char a2)  {
            return testValue;
        }
    };

    private LObjCharFunctionX<Integer,Integer,X> sutNull = new LObjCharFunctionX<Integer,Integer,X>(){
        public @Nullable Integer doApply(Integer a1,char a2)  throws X {
            return null;
        }
    };
    ...
    private LObjCharFunctionX<Integer,Integer,ParseException> sutAlwaysThrowing = LObjCharFunctionX.lX((a1,a2) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LObjCharFunctionX<Integer,Integer,RuntimeException> sutAlwaysThrowingUnchecked = LObjCharFunctionX.lX((a1,a2) -> {
    ...
    public void testNestingDoApplyChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoApply(100,'\u0100');
    ...
    public void testShovingDoApplyChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoApply(100,'\u0100');
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testLXMethod() throws X {
        assertThat(LObjCharFunctionX.lX((a1,a2) -> testValue ))
    ...
    public void testHandlingDoApplyMethodWrapsTheException() throws X {
        ...
        // when
        LObjCharFunctionX<Integer,Integer,RuntimeException> wrapped = sutThrowing.handleObjCharFuncX(handler -> handler
    ...
    @Test
    public void testHandleObjCharFuncXMethodDoNotWrapsOtherExceptionIf() throws X {
        ...
        // when
        LObjCharFunctionX<Integer,Integer,X> wrapped = sutThrowing.handleObjCharFuncX(handler -> handler
                .wrapIf(UnsupportedOperationException.class::isInstance,IllegalArgumentException::new,  EXCEPTION_WAS_WRAPPED)
...
@Test
    public void testHandleObjCharFuncXMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleObjCharFuncXMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LObjCharFunctionX<Integer,Integer,X> wrapped = sutThrowing.handleObjCharFuncX(h -> Function4U.doNothing());
    ...
    public void testHandleObjCharFunc() throws X {
        ...
        // when
        LObjCharFunctionX<Integer,Integer,X> wrapped = sutThrowing.handleObjCharFuncX(h -> {
    ...
    public void compilerSubstituteVariantV1() {
        LObjCharFunctionX lambda = LObjCharFunctionX./*<T,R,X>*/lX1(this::variantV1);

        assertThat(lambda).isInstanceOf(LObjCharFunctionX.V1.class);
    }
    ...
    @Test void safeCompiles() {
        LObjCharFunctionX r1 = LObjCharFunctionX.safe(sut); //NOSONAR
    }

    @Test void safePropagates() {
        Object result = LObjCharFunctionX.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LObjCharFunctionX.safe(null);
        assertThat(result).isSameAs(LObjCharFunctionX.lX(LObjCharFunctionX.safe()));
    }

    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LObjCharFunctionX<Integer,Integer,X>,Y> supplier = ()->sut;
        Object result = LObjCharFunctionX.safeSupplier(supplier);
        assertThat(result).isSameAs(supplier);
    }

    @Test <Y extends Throwable> void safeSupplierProtectsAgainstNpe() {
        Object result = LObjCharFunctionX.safeSupplier(null);
        assertThat(result).isSameAs(LObjCharFunctionX.safeSupplier());
    }

    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LObjCharFunctionX<Integer,Integer,X>,Y> r1 = LObjCharFunctionX.safeSupplier(()->sut);  //NOSONAR
    }
