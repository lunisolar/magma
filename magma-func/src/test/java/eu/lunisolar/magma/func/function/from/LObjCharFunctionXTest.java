...
public class LObjCharFunctionXTest<T,R,X extends ParseException> {
    ...
    private LObjCharFunctionX<T,R,ParseException> sutAlwaysThrowing = LObjCharFunctionX.lX((T t, char c) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LObjCharFunctionX<T,R,RuntimeException> sutAlwaysThrowingUnckeck = LObjCharFunctionX.lX((T t, char c) -> {
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNullDoApply() method cannot be null (LObjCharFunctionX: R doApply(T t, char c) throws X).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LObjCharFunctionX: R doApply(T t, char c) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(LObjCharFunctionX.lX((Object t, char c) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LObjCharFunctionX<T,R,X> wrapped = LObjCharFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromChar() throws ParseException {
        ...
        LObjCharFunctionX<Integer ,Integer ,X> sutO = (Integer t, char c) -> {
        ...
        //when
        LObjCharFunctionX<Integer ,Integer ,X> function = sutO.fromChar(before1,before2);
...
//
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LObjCharFunctionX<T,R,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LObjCharFunctionX: R doApply(T t, char c) throws X");
    }
