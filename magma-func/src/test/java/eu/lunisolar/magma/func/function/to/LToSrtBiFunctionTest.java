...
public class LToSrtBiFunctionTest<T1,T2> {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.applyAsSrt(100,100), testValue);
    }
    ...
    public void testNonNullApplyAsSrt() throws Throwable {
            Assert.assertEquals(sut.nonNullApplyAsSrt(100,100), testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LToSrtBiFunction: short applyAsSrt(T1 a1,T2 a2)");
    }

    @Test
    public void testToSrtBiFuncMethod() throws Throwable {
        Assert.assertTrue(LToSrtBiFunction.toSrtBiFunc((a1,a2) -> testValue ) instanceof LToSrtBiFunction);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LToSrtBiFunction: short applyAsSrt(T1 a1,T2 a2)"));
    ...
    public void compilerSubstituteVariantLToSrtObj1Obj0Func() {
        ...
        Assert.assertTrue(lambda instanceof LToSrtBiFunction.LToSrtObj1Obj0Func);
    }
