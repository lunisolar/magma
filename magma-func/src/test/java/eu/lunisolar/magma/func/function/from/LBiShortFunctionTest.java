...
public class LBiShortFunctionTest<R,X extends ParseException> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LShortPair,R,RuntimeException> theCall = sut;
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNullDoApply() method cannot be null (LBiShortFunction: R doApply(short a1,short a2)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBiShortFunction: R doApply(short a1,short a2)");
    }
    ...
    public void testWrapMethod() throws X {
        assertThat(LBiShortFunction.wrap(opposite))
            .isInstanceOf(LBiShortFunction.class);
    }
...
@Test
    ...
    public void testThen1() throws X  {
        ...
        //when
        LBiShortConsumer function = sutO.then(thenFunction);
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBiShortFunction: R doApply(short a1,short a2)");
    }
    ...
    @Test void safeCompiles() {
        LBiShortFunction r1 = LBiShortFunction.safe(sut);
        LBiShortFunctionX r2 = LBiShortFunction.safe(sut);
    }

    @Test void safePropagates() {
        Object result = LBiShortFunction.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LBiShortFunction.safe(null);
        assertThat(result).isSameAs(LBiShortFunction.l(LBiShortFunction.safe()));
    }
    ...
    @Test  void safeSupplierProtectsAgainstNpe() {
        Object result = LBiShortFunction.safeSupplier(null);
        assertThat(result).isSameAs(LBiShortFunction.safeSupplier());
    }

    @Test  void safeSupplierCompiles() {
        LSupplier<LBiShortFunction<R>> r1 = LBiShortFunction.safeSupplier(()->sut);
    }
