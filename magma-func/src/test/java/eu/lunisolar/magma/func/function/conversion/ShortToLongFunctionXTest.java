...
public class ShortToLongFunctionXTest<X extends ParseException> {
    ...
    private ShortToLongFunctionX<X> sut = new ShortToLongFunctionX(){
        public  long applyAsLong(short s) throws ParseException {
            return testValue;
        }
    };

    private ShortToLongFunction opposite = new ShortToLongFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ShortToLongFunctionX: long applyAsLong(short s) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(ShortToLongFunctionX.lX((short s) -> testValue ))
            .isInstanceOf(ShortToLongFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(ShortToLongFunctionX.wrapX(opposite))
            .isInstanceOf(ShortToLongFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        ShortToLongFunctionX<X> sutThrowing = ShortToLongFunctionX.lX((short s) -> {
            throw new UnsupportedOperationException();
        });

        // when
        ShortToLongFunctionX<X> wrapped = ShortToLongFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromShort() throws ParseException {
        ...
        ShortToLongFunctionX<X> sutO = (short s) -> {
        ...
        //when
        ShortToLongFunctionX<X> function = sutO.fromShort(before1);
    ...
    public void testfrom() throws ParseException {
        ...
        //when
        ToLongFunctionX<Integer ,X> function = sutO.from(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(ShortToLongFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(ShortToLongFunctionX.class);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        ShortToLongFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ShortToLongFunctionX: long applyAsLong(short s) throws X");
    }
