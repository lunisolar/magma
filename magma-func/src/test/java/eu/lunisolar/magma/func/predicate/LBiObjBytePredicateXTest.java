...
public class LBiObjBytePredicateXTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjBytePredicateX<T1,T2,X> sut = new LBiObjBytePredicateX(){
        public  boolean doTest(Object a1,Object a2,byte a3) throws ParseException {
            return testValue;
        }
    };

    private LBiObjBytePredicate<T1,T2> opposite = new LBiObjBytePredicate(){
    ...
    private LBiObjBytePredicateX<T1,T2,ParseException> sutAlwaysThrowing = LBiObjBytePredicateX.lX((T1 a1,T2 a2,byte a3) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiObjBytePredicateX<T1,T2,RuntimeException> sutAlwaysThrowingUnckeck = LBiObjBytePredicateX.lX((T1 a1,T2 a2,byte a3) -> {
    ...
    public void testNestingDoTestChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoTest((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),(byte)100);
    ...
    public void testShovingDoTestChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoTest((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),(byte)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testLXMethod() throws X {
        assertThat(LBiObjBytePredicateX.lX((Object a1,Object a2,byte a3) -> testValue ))
...
@Test
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws X {
        ...
        //given
        LBiObjBytePredicateX<T1,T2,X> fun1 = LBiObjBytePredicateX.lX((T1 a1,T2 a2,byte a3) -> f1Result);
        LBiObjBytePredicateX<T1,T2,X> fun2 = LBiObjBytePredicateX.lX((T1 a1,T2 a2,byte a3) -> f2Result);

        //when
        LBiObjBytePredicateX<T1,T2,X> andFunction = fun1.and(fun2);
        LBiObjBytePredicateX<T1,T2,X> orFunction = fun1.or(fun2);
        LBiObjBytePredicateX<T1,T2,X> xorFunction = fun1.xor(fun2);
    ...
    public void isEqual() throws X  {
        //when
        LBiObjBytePredicateX<T1,T2,X> equals = LBiObjBytePredicateX.isEqual((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),(byte)100);
    ...
    public void compilerSubstituteVariant1() {
        LBiObjBytePredicateX lambda = LBiObjBytePredicateX./*<T1,T2,X>*/lX1(this::variant1);
    ...
    public void compilerSubstituteVariant2() {
        LBiObjBytePredicateX lambda = LBiObjBytePredicateX./*<T1,T2,X>*/lX2(this::variant2);
    ...
    public void compilerSubstituteVariant3() {
        LBiObjBytePredicateX lambda = LBiObjBytePredicateX./*<T1,T2,X>*/lX3(this::variant3);
    ...
    public void compilerSubstituteVariant4() {
        LBiObjBytePredicateX lambda = LBiObjBytePredicateX./*<T1,T2,X>*/lX4(this::variant4);
    ...
    public void compilerSubstituteVariant5() {
        LBiObjBytePredicateX lambda = LBiObjBytePredicateX./*<T1,T2,X>*/lX5(this::variant5);
    ...
    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LBiObjBytePredicateX<T1,T2,X>,Y> supplier = ()->sut;
