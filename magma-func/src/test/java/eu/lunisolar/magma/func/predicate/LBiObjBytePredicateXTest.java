...
public class LBiObjBytePredicateXTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjBytePredicateX<T1,T2,ParseException> sutAlwaysThrowing = LBiObjBytePredicateX.lX((T1 t1,T2 t2, byte b) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiObjBytePredicateX<T1,T2,RuntimeException> sutAlwaysThrowingUnckeck = LBiObjBytePredicateX.lX((T1 t1,T2 t2, byte b) -> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBiObjBytePredicateX: boolean doTest(T1 t1,T2 t2, byte b) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(LBiObjBytePredicateX.lX((Object t1,Object t2, byte b) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LBiObjBytePredicateX<T1,T2,X> wrapped = LBiObjBytePredicateX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws ParseException {
        ...
        //given
        LBiObjBytePredicateX<T1,T2,X> fun1 = LBiObjBytePredicateX.lX((T1 t1,T2 t2, byte b) -> f1Result);
        LBiObjBytePredicateX<T1,T2,X> fun2 = LBiObjBytePredicateX.lX((T1 t1,T2 t2, byte b) -> f2Result);
    ...
    public void testfromByte() throws ParseException {
        ...
        LBiObjBytePredicateX<Integer ,Integer ,X> sutO = (Integer t1,Integer t2, byte b) -> {
        ...
        //when
        LBiObjBytePredicateX<Integer ,Integer ,X> function = sutO.fromByte(before1,before2,before3);
...
//
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().doTest((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),(byte)100);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LBiObjBytePredicateX<T1,T2,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBiObjBytePredicateX: boolean doTest(T1 t1,T2 t2, byte b) throws X");
    }
