...
public class LBiLongConsumerXTest<X extends ParseException> {
    ...
    private LBiLongConsumerX<ParseException> sutAlwaysThrowing = LBiLongConsumerX.lX((long l1,long l2) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiLongConsumerX<RuntimeException> sutAlwaysThrowingUnckeck = LBiLongConsumerX.lX((long l1,long l2) -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBiLongConsumerX: void doAccept(long l1,long l2) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LBiLongConsumerX.lX((long l1,long l2) -> Function4U.doNothing() ))
...
@Test
    ...
    public void testbiLongConsComposeLong() throws X {
        ...
        LBiLongConsumerX<X> sutO = (long l1,long l2) -> {
    ...
    public void testAndThen() throws X {
        ...
        LBiLongConsumerX<X> thenFunction = (long l1,long l2) -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBiLongConsumerX: void doAccept(long l1,long l2) throws X");
    }
