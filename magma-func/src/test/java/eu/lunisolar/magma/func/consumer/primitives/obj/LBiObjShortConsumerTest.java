...
public class LBiObjShortConsumerTest<T1,T2,X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBiObjShortConsumer: void accept(T1 t1,T2 t2, short s)");
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LBiObjShortConsumer<T1,T2> wrapped = LBiObjShortConsumer.wrapException(sutThrowing, UnsupportedOperationException.class, t -> {
    ...
    public void testfromShort() throws ParseException {
        ...
        //when
        LBiObjShortConsumer<Integer ,Integer > function = sutO.fromShort(before1,before2,before3);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LBiObjShortConsumer<T1,T2> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBiObjShortConsumer: void accept(T1 t1,T2 t2, short s)");
    }
