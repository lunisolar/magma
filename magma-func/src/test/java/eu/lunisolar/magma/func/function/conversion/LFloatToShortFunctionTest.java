...
public class LFloatToShortFunctionTest<X extends ParseException> {
    ...
    private LFloatToShortFunction sutAlwaysThrowingUnckeck = LFloatToShortFunction.l((float f) -> {
    ...
    public void testLMethod() throws ParseException {
        assertThat(LFloatToShortFunction.l((float f) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LFloatToShortFunctionX<ParseException> sutThrowing = LFloatToShortFunctionX.lX((float f) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LFloatToShortFunction sutThrowing = LFloatToShortFunction.l((float f) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LFloatToShortFunction wrapped = LFloatToShortFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromFloat() throws ParseException {
        ...
        LFloatToShortFunction sutO = (float f) -> {
        ...
        //when
        LFloatToShortFunction function = sutO.fromFloat(before1);
...
//
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().doApplyAsShort((float)100);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LFloatToShortFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
