...
public class LObjIntFunctionXTest<T,R,X extends ParseException> {
    ...
    private LObjIntFunctionX<T,R,X> sut = new LObjIntFunctionX(){
        public @Nullable Object  doApply(Object t, int i) throws ParseException {
            return testValue;
        }
    };

    private LObjIntFunction<T,R> opposite = new LObjIntFunction(){
        public @Nullable Object  doApply(Object t, int i)  {
            return testValue;
        }
    };
    ...
    private LObjIntFunctionX<T,R,ParseException> sutAlwaysThrowing = LObjIntFunctionX.lX((T t, int i) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LObjIntFunctionX<T,R,RuntimeException> sutAlwaysThrowingUnckeck = LObjIntFunctionX.lX((T t, int i) -> {
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNullDoApply() method cannot be null (LObjIntFunctionX: R doApply(T t, int i) throws X).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LObjIntFunctionX: R doApply(T t, int i) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LObjIntFunctionX.lX((Object t, int i) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // when
        LObjIntFunctionX<T,R,X> wrapped = sutThrowing.handleObjIFuncX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LObjIntFunctionX<T,R,X> wrapped = sutThrowing.handleObjIFuncX(h -> Function4U.doNothing());
    ...
    @Test
    public void testobjIFuncFromInt() throws X {

        final ThreadLocal<Boolean> mainFunctionCalled = ThreadLocal.withInitial(()-> false);
        final AtomicInteger beforeCalls = new AtomicInteger(0);

        //given (+ some assertions)
        LObjIntFunctionX<Integer ,Integer ,X> sutO = (Integer t, int i) -> {
        ...
        //when
        LObjIntFunctionX<Integer ,Integer ,X> function = sutO.objIFuncFromInt(before1,before2);
    ...
    @Test
    public void testobjIFuncFrom() throws X {
        ...
        //when
        LBiFunctionX<Integer ,Integer ,Integer ,X> function = sutO.objIFuncFrom(before1,before2);
    ...
    public void testNesting() {
        assertThat(sut.nestingObjIFunc())
            .isInstanceOf(LObjIntFunction.class);
    }

    @Test
    public void testShoving() {
        assertThat(sut.shovingObjIFunc())
            .isInstanceOf(LObjIntFunction.class);
    }

    @Test
    public void testNestingX() {
        assertThat(sut.nestingObjIFuncX())
            .isInstanceOf(LObjIntFunctionX.class);
    }

    @Test
    public void testShovingX() {
        assertThat(sut.shovingObjIFuncX())
            .isInstanceOf(LObjIntFunctionX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingObjIFunc().doApply((T)Integer.valueOf(100),(int)100);
    }

    @Test
    public void testHandleObjIFunc() throws X {
        ...
        // when
        LObjIntFunctionX<T,R,X> wrapped = sutThrowing.handleObjIFuncX(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LObjIntFunctionX: R doApply(T t, int i) throws X");
    }
