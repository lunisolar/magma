...
public class LObjIntFunctionXTest<T,R,X extends ParseException> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LObjIntFunctionX<T,R,X> wrapped = LObjIntFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromInt() throws ParseException {
        ...
        //when
        LObjIntFunctionX<Integer ,Integer ,X> function = sutO.fromInt(before1,before2);
...
//
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().doApply((T)Integer.valueOf(100),(int)100);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LObjIntFunctionX<T,R,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
