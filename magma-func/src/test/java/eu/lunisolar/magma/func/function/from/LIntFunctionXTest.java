...
public class LIntFunctionXTest<R,X extends ParseException> {
    ...
    private LIntFunctionX<R,X> sut = new LIntFunctionX(){
        public @Nullable Object  doApply(int a1) throws ParseException {
            return testValue;
        }
    };

    private LIntFunction<R> opposite = new LIntFunction(){
        public @Nullable Object  doApply(int a1)  {
            return testValue;
        }
    };
    ...
    private IntFunction jre = a1 -> testValue;


    private LIntFunctionX<R,ParseException> sutAlwaysThrowing = LIntFunctionX.lX(a1 -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LIntFunctionX<R,RuntimeException> sutAlwaysThrowingUnckeck = LIntFunctionX.lX(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LIntSingle,R,X> theCall = sut;
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LIntFunctionX<R,X> sutThrowing = LIntFunctionX.lX(a1 -> {
            throw new UnsupportedOperationException();
        });

        // when
        LIntFunctionX<R,X> wrapped = sutThrowing.handleIntFuncX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LIntFunctionX<R,X> wrapped = sutThrowing.handleIntFuncX(h -> Function4U.doNothing());
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingIntFunc().doApply((int)100);
    }
    ...
    public void testHandleIntFunc() throws X {
        ...
        // when
        LIntFunctionX<R,X> wrapped = sutThrowing.handleIntFuncX(h -> {
    ...
    @Test void safeCompiles() {
        LIntFunctionX r1 = LIntFunctionX.safe(sut);
        IntFunction r3 = LIntFunctionX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LIntFunctionX<R,X>,Y> supplier = ()->sut;
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LIntFunctionX<R,X>,Y> r1 = LIntFunctionX.safeSupplier(()->sut);
        Supplier<LIntFunctionX<R,X>> r2 = LIntFunctionX.safeSupplier(()->sut);
    }
