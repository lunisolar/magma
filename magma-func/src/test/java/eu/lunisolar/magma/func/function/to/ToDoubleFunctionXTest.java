...
public class ToDoubleFunctionXTest<T,X extends ParseException> {
    ...
    private ToDoubleFunctionX<T,X> sut = new ToDoubleFunctionX(){
        public  double applyAsDouble(Object t) throws ParseException {
            return testValue;
        }
    };

    private ToDoubleFunction<T> opposite = new ToDoubleFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ToDoubleFunctionX: double applyAsDouble(T t) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(ToDoubleFunctionX.lX((Object t) -> testValue ))
            .isInstanceOf(ToDoubleFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(ToDoubleFunctionX.wrapX(opposite))
            .isInstanceOf(ToDoubleFunctionX.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(ToDoubleFunctionX.wrapStd(jre))
            .isInstanceOf(ToDoubleFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        ToDoubleFunctionX<T,X> wrapped = ToDoubleFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfrom() throws ParseException {
        ...
        ToDoubleFunctionX<Integer ,X> sutO = (Integer t) -> {
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        ToDoubleFunctionX<T,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ToDoubleFunctionX: double applyAsDouble(T t) throws X");
    }
