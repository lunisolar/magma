...
public class LBoolToShortFunctionTest<X extends ParseException> {
    ...
    private LBoolToShortFunctionX<X> opposite = new LBoolToShortFunctionX(){
    ...
    private LBoolToShortFunction sutAlwaysThrowingUnckeck = LBoolToShortFunction.l(b -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBoolToShortFunction: short doApplyAsShort(boolean b)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LBoolToShortFunction.l(b -> testValue ))
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws X {
        // given
        LBoolToShortFunctionX<X> sutThrowing = LBoolToShortFunctionX.lX(b -> {
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LBoolToShortFunctionX<ParseException> sutThrowing = LBoolToShortFunctionX.lX(b -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LBoolToShortFunction sutThrowing = LBoolToShortFunction.l(b -> {
...
@Test
    ...
    public void testboolToShortFuncComposeBoolean() throws X {
        ...
        //when
        LBoolToShortFunction function = sutO.boolToShortFuncComposeBoolean(before1);
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBoolToShortFunction: short doApplyAsShort(boolean b)");
    }
