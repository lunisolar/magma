...
public class LObjLongFunctionTest<T,R,X extends ParseException> {
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (LObjLongFunction: R doApply(T t, long l)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LObjLongFunction: R doApply(T t, long l)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LObjLongFunction.l((Object t, long l) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LObjLongFunctionX<T,R,ParseException> sutThrowing = LObjLongFunctionX.lX((T t, long l) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LObjLongFunction<T,R> sutThrowing = LObjLongFunction.l((T t, long l) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LObjLongFunction<T,R> wrapped = LObjLongFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromLong() throws ParseException {
        ...
        LObjLongFunction<Integer ,Integer > sutO = (Integer t, long l) -> {
        ...
        //when
        LObjLongFunction<Integer ,Integer > function = sutO.fromLong(before1,before2);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LObjLongFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LObjLongFunctionX.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LObjLongFunction<T,R> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LObjLongFunction: R doApply(T t, long l)");
    }
