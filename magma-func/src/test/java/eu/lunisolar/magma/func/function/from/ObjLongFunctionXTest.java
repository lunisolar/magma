...
public class ObjLongFunctionXTest<T,R,X extends ParseException> {
    ...
    private ObjLongFunctionX<T,R,X> sut = new ObjLongFunctionX(){
        public @Nullable Object  apply(Object t, long l) throws ParseException {
            return testValue;
        }
    };

    private ObjLongFunction<T,R> opposite = new ObjLongFunction(){
        public @Nullable Object  apply(Object t, long l)  {
            return testValue;
        }
    };

    private ObjLongFunctionX<T,R,X> sutNull = new ObjLongFunctionX(){
        public @Nullable Object  apply(Object t, long l) throws ParseException {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (ObjLongFunctionX: R apply(T t, long l) throws X).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ObjLongFunctionX: R apply(T t, long l) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(ObjLongFunctionX.lX((Object t, long l) -> testValue ))
            .isInstanceOf(ObjLongFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(ObjLongFunctionX.wrapX(opposite))
            .isInstanceOf(ObjLongFunctionX.class);
    }
    ...
    public void testfromLong() throws ParseException {
        ...
        ObjLongFunctionX<Integer ,Integer ,X> sutO = (Integer t, long l) -> {
        ...
        //when
        ObjLongFunctionX<Integer ,Integer ,X> function = sutO.fromLong(before1,before2);
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        ObjLongConsumerX<Integer ,X> function = sutO.then(thenFunction);
