...
public class LObjByteConsumerTest<T> {
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LObjByteConsumer: void accept(T a1,byte a2)");
    }

    @Test
    public void testObjByteConsMethod() throws Throwable {
        Assert.assertTrue(LObjByteConsumer.objByteCons(LObjByteConsumer::doNothing) instanceof LObjByteConsumer);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LObjByteConsumer: void accept(T a1,byte a2)"));
