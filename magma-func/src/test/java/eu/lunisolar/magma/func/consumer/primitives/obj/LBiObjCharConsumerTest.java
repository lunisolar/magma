...
public class LBiObjCharConsumerTest<T1,T2,X extends ParseException> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // when
        LBiObjCharConsumer<T1,T2> wrapped = sutThrowing.handle(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBiObjCharConsumer<T1,T2> wrapped = sutThrowing.handle(h -> Function4U.doNothing());
    ...
    public void testHandle() throws X {
        ...
        // when
        LBiObjCharConsumer<T1,T2> wrapped = sutThrowing.handle(h -> {
