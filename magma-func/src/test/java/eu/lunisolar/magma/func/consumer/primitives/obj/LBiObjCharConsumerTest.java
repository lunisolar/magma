...
public class LBiObjCharConsumerTest<T1,T2> {
    ...
    private LBiObjCharConsumer<Integer,Integer> sutAlwaysThrowing = LBiObjCharConsumer.biObjCharCons((a1,a2,a3) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiObjCharConsumer<Integer,Integer> sutAlwaysThrowingUnchecked = LBiObjCharConsumer.biObjCharCons((a1,a2,a3) -> {
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LBiObjCharConsumer: void accept(T1 a1,T2 a2,char a3)");
    }

    @Test
    public void testBiObjCharConsMethod() throws Throwable {
        Assert.assertTrue(LBiObjCharConsumer.biObjCharCons(LBiObjCharConsumer::doNothing) instanceof LBiObjCharConsumer);
    ...
    @Test
    public void testBiObjCharConsCompose() throws Throwable {
    ...
    public void testShove() {
        ...
        // given
        LBiObjCharConsumer<Integer,Integer> sutThrowing = LBiObjCharConsumer.biObjCharCons((a1,a2,a3) -> {
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LBiObjCharConsumer: void accept(T1 a1,T2 a2,char a3)"));
    ...
    public void compilerSubstituteVariantLObj0Char2Obj1Cons() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjCharConsumer.LObj0Char2Obj1Cons);
    }
    ...
    public void compilerSubstituteVariantLObj1Obj0Char2Cons() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjCharConsumer.LObj1Obj0Char2Cons);
    }
    ...
    public void compilerSubstituteVariantLObj1Char2Obj0Cons() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjCharConsumer.LObj1Char2Obj0Cons);
    }
    ...
    public void compilerSubstituteVariantLChar2Obj0Obj1Cons() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjCharConsumer.LChar2Obj0Obj1Cons);
    }
    ...
    public void compilerSubstituteVariantLChar2Obj1Obj0Cons() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjCharConsumer.LChar2Obj1Obj0Cons);
    }
