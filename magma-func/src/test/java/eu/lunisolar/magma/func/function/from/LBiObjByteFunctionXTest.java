...
public class LBiObjByteFunctionXTest<T1,T2,R,X extends ParseException> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // when
        LBiObjByteFunctionX<T1,T2,R,X> wrapped = sutThrowing.handleBiObjBFuncX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBiObjByteFunctionX<T1,T2,R,X> wrapped = sutThrowing.handleBiObjBFuncX(h -> Function4U.doNothing());
    ...
    @Test
    public void testbiObjBFuncFromByte() throws X {
        ...
        //when
        LBiObjByteFunctionX<Integer ,Integer ,Integer ,X> function = sutO.biObjBFuncFromByte(before1,before2,before3);
    ...
    @Test
    public void testbiObjBFuncFrom() throws X {
        ...
        //when
        LTriFunctionX<Integer ,Integer ,Integer ,Integer ,X> function = sutO.biObjBFuncFrom(before1,before2,before3);
    ...
    public void testNesting() {
        assertThat(sut.nestingBiObjBFunc())
            .isInstanceOf(LBiObjByteFunction.class);
    }

    @Test
    public void testShoving() {
        assertThat(sut.shovingBiObjBFunc())
            .isInstanceOf(LBiObjByteFunction.class);
    }

    @Test
    public void testNestingX() {
        assertThat(sut.nestingBiObjBFuncX())
            .isInstanceOf(LBiObjByteFunctionX.class);
    }

    @Test
    public void testShovingX() {
        assertThat(sut.shovingBiObjBFuncX())
            .isInstanceOf(LBiObjByteFunctionX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingBiObjBFunc().doApply((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),(byte)100);
    }

    @Test
    public void testHandleBiObjBFunc() throws X {
        ...
        // when
        LBiObjByteFunctionX<T1,T2,R,X> wrapped = sutThrowing.handleBiObjBFuncX(h -> {
