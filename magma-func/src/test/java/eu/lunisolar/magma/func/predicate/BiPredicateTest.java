...
public class BiPredicateTest<T1,T2,X extends ParseException> {
    ...
    private BiPredicate<T1,T2> sut = new BiPredicate(){
        public  boolean test(Object t1,Object t2)  {
            return testValue;
        }
    };

    private BiPredicateX<T1,T2,X> opposite = new BiPredicateX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BiPredicate: boolean test(T1 t1,T2 t2)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(BiPredicate.l((Object t1,Object t2) -> testValue ))
            .isInstanceOf(BiPredicate.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(BiPredicate.wrap(opposite))
            .isInstanceOf(BiPredicate.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(BiPredicate.wrapStd(jre))
            .isInstanceOf(BiPredicate.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        BiPredicate<T1,T2> wrapped = BiPredicate.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        BiPredicateX<T1,T2,ParseException> sutThrowing = BiPredicateX.lX((T1 t1,T2 t2) -> {
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws ParseException {
        ...
        //given
        BiPredicate<T1,T2> fun1 = BiPredicate.l((T1 t1,T2 t2) -> f1Result);
        BiPredicate<T1,T2> fun2 = BiPredicate.l((T1 t1,T2 t2) -> f2Result);

        //when
        BiPredicate<T1,T2> andFunction = fun1.and(fun2);
        BiPredicate<T1,T2> orFunction = fun1.or(fun2);
        BiPredicate<T1,T2> xorFunction = fun1.xor(fun2);
    ...
    public void isEqual() throws ParseException  {
        //when
        BiPredicate<T1,T2> equals = BiPredicate.isEqual((T1)Integer.valueOf(100),(T2)Integer.valueOf(100));
    ...
    public void testfrom() throws ParseException {
        ...
        BiPredicate<Integer ,Integer > sutO = (Integer t1,Integer t2) -> {
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        BiPredicate<T1,T2> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BiPredicate: boolean test(T1 t1,T2 t2)");
    }
