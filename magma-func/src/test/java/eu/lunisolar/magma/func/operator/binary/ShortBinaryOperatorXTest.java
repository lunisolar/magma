...
public class ShortBinaryOperatorXTest<X extends ParseException> {
    ...
    private ShortBinaryOperatorX<X> sut = new ShortBinaryOperatorX(){
        public  short applyAsShort(short s1,short s2) throws ParseException {
            return testValue;
        }
    };

    private ShortBinaryOperator opposite = new ShortBinaryOperator(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ShortBinaryOperatorX: short applyAsShort(short s1,short s2) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(ShortBinaryOperatorX.lX((short s1,short s2) -> testValue ))
            .isInstanceOf(ShortBinaryOperatorX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(ShortBinaryOperatorX.wrapX(opposite))
            .isInstanceOf(ShortBinaryOperatorX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        ShortBinaryOperatorX<X> wrapped = ShortBinaryOperatorX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testMin() throws ParseException {
        ...
        //when
        ShortBinaryOperatorX<X> min = ShortBinaryOperatorX.min();
    ...
    public void testMax() throws ParseException {
        ...
        //when
        ShortBinaryOperatorX<X> max = ShortBinaryOperatorX.max();
    ...
    public void testfromShort() throws ParseException {
        ...
        ShortBinaryOperatorX<X> sutO = (short s1,short s2) -> {
        ...
        //when
        ShortBinaryOperatorX<X> function = sutO.fromShort(before1,before2);
    ...
    public void testfrom() throws ParseException {
        ...
        //when
        ToShortBiFunctionX<Integer ,Integer ,X> function = sutO.from(before1,before2);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        ShortBinaryOperatorX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ShortBinaryOperatorX: short applyAsShort(short s1,short s2) throws X");
    }
