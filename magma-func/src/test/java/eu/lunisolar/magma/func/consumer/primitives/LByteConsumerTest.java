...
public class LByteConsumerTest<X extends ParseException> {
    ...
    private LByteConsumer sutAlwaysThrowingUnckeck = LByteConsumer.l(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LByteSingle,LTuple.Void,RuntimeException> theCall = sut;
    ...
    public void testLMethod() throws X {
        assertThat(LByteConsumer.l(a1 -> Function4U.doNothing() ))
...
@Test
    ...
    public void testAndThen() throws X {
        ...
        LByteConsumer thenFunction = (byte a1) -> {
    ...
    @Test void safeCompiles() {
        LByteConsumer r1 = LByteConsumer.safe(sut);
        LByteConsumerX r2 = LByteConsumer.safe(sut);
    }
    ...
    @Test  void safeSupplierCompiles() {
        LSupplier<LByteConsumer> r1 = LByteConsumer.safeSupplier(()->sut);
    }
