...
public class LBooleanToCharFunctionXTest<X extends ParseException> {
    ...
    private LBooleanToCharFunctionX<X> sut = new LBooleanToCharFunctionX(){
        public  char doApplyAsChar(boolean b) throws ParseException {
            return testValue;
        }
    };

    private LBooleanToCharFunction opposite = new LBooleanToCharFunction(){
    ...
    private LBooleanToCharFunctionX<ParseException> sutAlwaysThrowing = LBooleanToCharFunctionX.lX((boolean b) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBooleanToCharFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LBooleanToCharFunctionX.lX((boolean b) -> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBooleanToCharFunctionX: char doApplyAsChar(boolean b) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(LBooleanToCharFunctionX.lX((boolean b) -> testValue ))
            .isInstanceOf(LBooleanToCharFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(LBooleanToCharFunctionX.wrapX(opposite))
            .isInstanceOf(LBooleanToCharFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LBooleanToCharFunctionX<X> wrapped = LBooleanToCharFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromBoolean() throws ParseException {
        ...
        LBooleanToCharFunctionX<X> sutO = (boolean b) -> {
        ...
        //when
        LBooleanToCharFunctionX<X> function = sutO.fromBoolean(before1);
...
//
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().doApplyAsChar(true);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LBooleanToCharFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBooleanToCharFunctionX: char doApplyAsChar(boolean b) throws X");
    }
