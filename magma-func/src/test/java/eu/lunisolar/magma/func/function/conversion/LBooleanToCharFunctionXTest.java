...
public class LBooleanToCharFunctionXTest<X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBooleanToCharFunctionX: char applyAsChar(boolean b) throws X");
    }
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LBooleanToCharFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LBooleanToCharFunctionX.class);
    }
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBooleanToCharFunctionX: char applyAsChar(boolean b) throws X");
    }
