...
public class BooleanToDoubleFunctionTest<X extends ParseException> {
    ...
    private BooleanToDoubleFunction sut = new BooleanToDoubleFunction(){
        public  double applyAsDouble(boolean b)  {
            return testValue;
        }
    };

    private BooleanToDoubleFunctionX<X> opposite = new BooleanToDoubleFunctionX(){
        public  double applyAsDouble(boolean b) throws ParseException {
            return testValue;
        }
    };
    ...
    public void testTheResult() throws ParseException {
        assertThat(sut.applyAsDouble(true))
            .isEqualTo(testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BooleanToDoubleFunction: double applyAsDouble(boolean b)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(BooleanToDoubleFunction.l((boolean b) -> testValue ))
            .isInstanceOf(BooleanToDoubleFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(BooleanToDoubleFunction.wrap(opposite))
            .isInstanceOf(BooleanToDoubleFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        // given
        BooleanToDoubleFunctionX<X> sutThrowing = BooleanToDoubleFunctionX.lX((boolean b) -> {
            throw new UnsupportedOperationException(ORIGINAL_MESSAGE);
        });

        // when
        BooleanToDoubleFunction wrapped = BooleanToDoubleFunction.wrap(sutThrowing);

        // then
        try {
            wrapped.applyAsDouble(true);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        BooleanToDoubleFunctionX<ParseException> sutThrowing = BooleanToDoubleFunctionX.lX((boolean b) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        BooleanToDoubleFunction sutThrowing = BooleanToDoubleFunction.l((boolean b) -> {
            throw new UnsupportedOperationException();
        });

        // when
        BooleanToDoubleFunction wrapped = BooleanToDoubleFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromBoolean() throws ParseException {
        ...
        BooleanToDoubleFunction sutO = (boolean b) -> {
        ...
        //when
        BooleanToDoubleFunction function = sutO.fromBoolean(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(BooleanToDoubleFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(BooleanToDoubleFunctionX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().applyAsDouble(true);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        BooleanToDoubleFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BooleanToDoubleFunction: double applyAsDouble(boolean b)");
    }
