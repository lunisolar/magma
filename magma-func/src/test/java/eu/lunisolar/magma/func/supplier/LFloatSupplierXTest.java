...
public class LFloatSupplierXTest<X extends ParseException> {
    ...
    private LFloatSupplierX<X> sut = new LFloatSupplierX<X>(){
        public  float doGetAsFloat()  throws X {
            return testValue;
        }
    };

    private LFloatSupplier opposite = new LFloatSupplier(){
    ...
    private LFloatSupplierX<RuntimeException> sutAlwaysThrowingUnchecked = LFloatSupplierX.lX(() -> {
    ...
    @Test
    public void testNonNullDoGetAsFloat() throws X {
        assertThat(sut.nonNullDoGetAsFloat())
            .isEqualTo(testValue);
    }

    @Test
    public void testNestingDoGetAsFloatChecked() throws X {
    ...
    @Test
    public void testNestingDoGetAsFloatUnchecked() throws X {

        // then
        try {
            sutAlwaysThrowingUnchecked.nestingDoGetAsFloat();
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    @Test
    public void testShovingDoGetAsFloatChecked() throws X {
    ...
    @Test
    public void testShovingDoGetAsFloatUnchecked() throws X {

        // then
        try {
            sutAlwaysThrowingUnchecked.shovingDoGetAsFloat();
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
                    .isExactlyInstanceOf(IndexOutOfBoundsException.class)
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LFloatSupplierX: float doGetAsFloat() throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LFloatSupplierX.lX(() -> testValue ))
            .isInstanceOf(LFloatSupplierX.class);
    }

    @Test
    public void testWrapXMethod() throws X {
        assertThat(LFloatSupplierX.wrapX(opposite))
            .isInstanceOf(LFloatSupplierX.class);
    }


    @Test
    public void testHandlingDoGetAsFloatMethodWrapsTheException() throws X {

        // given
        LFloatSupplierX<X> sutThrowing = LFloatSupplierX.lX(() -> {
            throw new UnsupportedOperationException();
        });

        // when
        LFloatSupplierX<RuntimeException> wrapped = sutThrowing.handleFloatSupX(handler -> handler
            .wrapIf(UnsupportedOperationException.class::isInstance,IllegalArgumentException::new,  EXCEPTION_WAS_WRAPPED));

        // then
        try {
            wrapped.doGetAsFloat();
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    @Test
    public void testHandleFloatSupXMethodDoNotWrapsOtherExceptionIf() throws X {
        ...
        // when
        LFloatSupplierX<X> wrapped = sutThrowing.handleFloatSupX(handler -> handler
                .wrapIf(UnsupportedOperationException.class::isInstance,IllegalArgumentException::new,  EXCEPTION_WAS_WRAPPED)
...
@Test
    public void testHandleFloatSupXMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleFloatSupXMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LFloatSupplierX<X> wrapped = sutThrowing.handleFloatSupX(h -> Function4U.doNothing());
    ...
    public void testHandleFloatSup() throws X {
        ...
        // when
        LFloatSupplierX<X> wrapped = sutThrowing.handleFloatSupX(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LFloatSupplierX: float doGetAsFloat() throws X");
    }
    ...
    @Test void safeCompiles() {
        LFloatSupplierX r1 = LFloatSupplierX.safe(sut); //NOSONAR
    }

    @Test void safePropagates() {
        Object result = LFloatSupplierX.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LFloatSupplierX.safe(null);
        assertThat(result).isSameAs(LFloatSupplierX.lX(LFloatSupplierX.safe()));
    }

    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LFloatSupplierX<X>,Y> supplier = ()->sut;
        Object result = LFloatSupplierX.safeSupplier(supplier);
        assertThat(result).isSameAs(supplier);
    }

    @Test <Y extends Throwable> void safeSupplierProtectsAgainstNpe() {
        Object result = LFloatSupplierX.safeSupplier(null);
        assertThat(result).isSameAs(LFloatSupplierX.safeSupplier());
    }

    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LFloatSupplierX<X>,Y> r1 = LFloatSupplierX.safeSupplier(()->sut);  //NOSONAR
    }
