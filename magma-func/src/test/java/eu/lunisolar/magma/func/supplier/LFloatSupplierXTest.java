...
public class LFloatSupplierXTest<X extends ParseException> {
    ...
    private LFloatSupplierX<X> sut = new LFloatSupplierX(){
        public  float doGetAsFloat() throws ParseException {
            return testValue;
        }
    };
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LTuple.Void,Float,X> theCall = sut;
    ...
    @Test
    public void testNestingDoGetAsFloatUnckeck() throws X {
    ...
    @Test
    public void testShovingDoGetAsFloatUnckeck() throws X {
...
@Test
    ...
    @Test void safeCompiles() {
        LFloatSupplierX r1 = LFloatSupplierX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LFloatSupplierX<X>,Y> r1 = LFloatSupplierX.safeSupplier(()->sut);
    }
