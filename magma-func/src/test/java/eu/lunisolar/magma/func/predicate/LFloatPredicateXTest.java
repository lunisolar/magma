...
public class LFloatPredicateXTest<X extends ParseException> {
    ...
    private LFloatPredicateX<X> sut = new LFloatPredicateX(){
        public  boolean doTest(float f) throws ParseException {
            return testValue;
        }
    };
    ...
    private LFloatPredicateX<ParseException> sutAlwaysThrowing = LFloatPredicateX.lX(f -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LFloatPredicateX<RuntimeException> sutAlwaysThrowingUnckeck = LFloatPredicateX.lX(f -> {
    ...
    public void testNestingDoTestChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoTest((float)100);
    ...
    public void testShovingDoTestChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoTest((float)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LFloatPredicateX: boolean doTest(float f) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LFloatPredicateX.lX(f -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LFloatPredicateX<X> sutThrowing = LFloatPredicateX.lX(f -> {
            throw new UnsupportedOperationException();
        });

        // when
        LFloatPredicateX<X> wrapped = sutThrowing.handleFPredX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LFloatPredicateX<X> wrapped = sutThrowing.handleFPredX(h -> Function4U.doNothing());
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws X {
        ...
        //given
        LFloatPredicateX<X> fun1 = LFloatPredicateX.lX(f -> f1Result);
        LFloatPredicateX<X> fun2 = LFloatPredicateX.lX(f -> f2Result);
    ...
    public void isEqual() throws X  {
        //when
        LFloatPredicateX<X> equals = LFloatPredicateX.isEqual((float)100);
    ...
    public void testfPredFromFloat() throws X {
        ...
        //when
        LFloatPredicateX<X> function = sutO.fPredFromFloat(before1);
    ...
    public void testfPredFrom() throws X {
        ...
        //when
        LPredicateX<Integer ,X> function = sutO.fPredFrom(before1);
    ...
    public void testHandleFPred() throws X {
        ...
        // when
        LFloatPredicateX<X> wrapped = sutThrowing.handleFPredX(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LFloatPredicateX: boolean doTest(float f) throws X");
    }
