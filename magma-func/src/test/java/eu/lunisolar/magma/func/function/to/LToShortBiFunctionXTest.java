...
public class LToShortBiFunctionXTest<T1,T2,X extends ParseException> {
    ...
    public void testNestingDoApplyAsShortChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoApplyAsShort((T1)Integer.valueOf(100),(T2)Integer.valueOf(100));
    ...
    public void testShovingDoApplyAsShortChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoApplyAsShort((T1)Integer.valueOf(100),(T2)Integer.valueOf(100));
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // when
        LToShortBiFunctionX<T1,T2,X> wrapped = sutThrowing.handleToShortBiFuncX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LToShortBiFunctionX<T1,T2,X> wrapped = sutThrowing.handleToShortBiFuncX(h -> Function4U.doNothing());
    ...
    public void testHandleToShortBiFunc() throws X {
        ...
        // when
        LToShortBiFunctionX<T1,T2,X> wrapped = sutThrowing.handleToShortBiFuncX(h -> {
    ...
    public void compilerSubstituteVariant1() {
        LToShortBiFunctionX lambda = LToShortBiFunctionX./*<T1,T2,X>*/lX1(this::variant1);
    ...
    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LToShortBiFunctionX<T1,T2,X>,Y> supplier = ()->sut;
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LToShortBiFunctionX<T1,T2,X>,Y> r1 = LToShortBiFunctionX.safeSupplier(()->sut);  //NOSONAR
    }
