...
public class DoubleSupplierTest<X extends ParseException> {
    ...
    private DoubleSupplier sut = new DoubleSupplier(){
        public  double getAsDouble()  {
            return testValue;
        }
    };

    private DoubleSupplierX<X> opposite = new DoubleSupplierX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("DoubleSupplier: double getAsDouble()");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(DoubleSupplier.l(() -> testValue ))
            .isInstanceOf(DoubleSupplier.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(DoubleSupplier.wrap(opposite))
            .isInstanceOf(DoubleSupplier.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(DoubleSupplier.wrapStd(jre))
            .isInstanceOf(DoubleSupplier.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        DoubleSupplier wrapped = DoubleSupplier.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        DoubleSupplierX<ParseException> sutThrowing = DoubleSupplierX.lX(() -> {
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        DoubleSupplier wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("DoubleSupplier: double getAsDouble()");
    }
