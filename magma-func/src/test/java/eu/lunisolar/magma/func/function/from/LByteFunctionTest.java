...
public class LByteFunctionTest<R,X extends ParseException> {
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (LByteFunction: R apply(byte b)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LByteFunction: R apply(byte b)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LByteFunction.l((byte b) -> testValue ))
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        // given
        LByteFunctionX<R,X> sutThrowing = LByteFunctionX.lX((byte b) -> {
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LByteFunctionX<R,ParseException> sutThrowing = LByteFunctionX.lX((byte b) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LByteFunction<R> sutThrowing = LByteFunction.l((byte b) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LByteFunction<R> wrapped = LByteFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        LByteFunction<Integer > sutO = (byte b) -> {
        ...
        //when
        LByteFunction<Integer > function = sutO.fromByte(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LByteFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LByteFunctionX.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LByteFunction<R> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LByteFunction: R apply(byte b)");
    }
