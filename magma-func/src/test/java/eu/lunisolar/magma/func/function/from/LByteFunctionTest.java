...
public class LByteFunctionTest<R,X extends ParseException> {
    ...
    private LByteFunction<R> sutAlwaysThrowingUnckeck = LByteFunction.l(b -> {
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNullDoApply() method cannot be null (LByteFunction: R doApply(byte b)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LByteFunction: R doApply(byte b)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LByteFunction.l(b -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LByteFunctionX<R,ParseException> sutThrowing = LByteFunctionX.lX(b -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LByteFunction<R> sutThrowing = LByteFunction.l(b -> {
            throw new UnsupportedOperationException();
        });

        // when
        LByteFunction<R> wrapped = sutThrowing.handleBFunc(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LByteFunction<R> wrapped = sutThrowing.handleBFunc(h -> Function4U.doNothing());
    ...
    @Test
    public void testbFuncFromByte() throws X {

        final ThreadLocal<Boolean> mainFunctionCalled = ThreadLocal.withInitial(()-> false);
        final AtomicInteger beforeCalls = new AtomicInteger(0);

        //given (+ some assertions)
        LByteFunction<Integer > sutO = b -> {
        ...
        //when
        LByteFunction<Integer > function = sutO.bFuncFromByte(before1);
    ...
    @Test
    public void testbFuncFrom() throws X {
        ...
        //when
        LFunction<Integer ,Integer > function = sutO.bFuncFrom(before1);
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingBFunc().doApply((byte)100);
    }

    @Test
    public void testHandleBFunc() throws X {
        ...
        // when
        LByteFunction<R> wrapped = sutThrowing.handleBFunc(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LByteFunction: R doApply(byte b)");
    }
