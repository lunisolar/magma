...
public class LByteFunctionTest<R> {
    ...
    private LByteFunction<Integer> sut = new LByteFunction<Integer>(){
        public @Nullable Integer applyX(byte a)  {
            return testValue;
        }
    };
    ...
    private LByteFunction<Integer> sutAlwaysThrowing = LByteFunction.byteFunc(a -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LByteFunction<Integer> sutAlwaysThrowingUnchecked = LByteFunction.byteFunc(a -> {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.apply((byte)100), testValue);
    }
    ...
    public void testNonNullApply() throws Throwable {
            Assert.assertSame(sut.nonNullApply((byte)100), testValue);
    }
    ...
    public void testNestingApplyUnchecked() throws Throwable {
        ...
        // then
        try {
            sutAlwaysThrowingUnchecked.nestingApply((byte)100);
    ...
    public void testShovingApplyUnchecked() throws Throwable {
        ...
        // then
        try {
            sutAlwaysThrowingUnchecked.shovingApply((byte)100);
            Assert.fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            Assert.assertEquals(e.getClass(), IndexOutOfBoundsException.class);
            Assert.assertNull(e.getCause());
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNullApply() method cannot be null (LByteFunction: R apply(byte a)).\\E")
    public void testNonNullCapturesNull() throws Throwable {
        sutNull.nonNullApply((byte)100);
    }


    @Test
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LByteFunction: R apply(byte a)");
    }

    @Test
    public void testByteFuncMethod() throws Throwable {
        Assert.assertTrue(LByteFunction.byteFunc(a -> testValue ) instanceof LByteFunction);
    ...
    public void testCompose() throws Throwable {
        ...
        //when
        LByteFunction<Integer> function = sutO.compose(before);
    ...
    public void testThenConsume1() throws Throwable  {
        ...
        //when
        LByteConsumer function = sutO.thenConsume(thenFunction);
    ...
    public void testShove() {
        ...
        // given
        LByteFunction<Integer> sutThrowing = LByteFunction.byteFunc(a -> {
            throw new UnsupportedOperationException();
        });

        // when
        sutThrowing.shovingApply((byte)100);
    }
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LByteFunction: R apply(byte a)"));
