...
public class BiObjByteFunctionTest<T1,T2,R,X extends ParseException> {
    ...
    private BiObjByteFunction<T1,T2,R> sut = new BiObjByteFunction(){
        public @Nullable Object  apply(Object t1,Object t2, byte i)  {
            return testValue;
        }
    };

    private BiObjByteFunctionX<T1,T2,R,X> opposite = new BiObjByteFunctionX(){
        public @Nullable Object  apply(Object t1,Object t2, byte i) throws ParseException {
            return testValue;
        }
    };

    private BiObjByteFunction<T1,T2,R> sutNull = new BiObjByteFunction(){
        public @Nullable Object  apply(Object t1,Object t2, byte i)  {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (BiObjByteFunction: R apply(T1 t1,T2 t2, byte i)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BiObjByteFunction: R apply(T1 t1,T2 t2, byte i)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(BiObjByteFunction.l((Object t1,Object t2, byte i) -> testValue ))
            .isInstanceOf(BiObjByteFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(BiObjByteFunction.wrap(opposite))
            .isInstanceOf(BiObjByteFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        BiObjByteFunction<T1,T2,R> wrapped = BiObjByteFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        BiObjByteFunctionX<T1,T2,R,ParseException> sutThrowing = BiObjByteFunctionX.lX((T1 t1,T2 t2, byte i) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        BiObjByteFunction<T1,T2,R> sutThrowing = BiObjByteFunction.l((T1 t1,T2 t2, byte i) -> {
            throw new UnsupportedOperationException();
        });

        // when
        BiObjByteFunction<T1,T2,R> wrapped = BiObjByteFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        BiObjByteFunction<Integer ,Integer ,Integer > sutO = (Integer t1,Integer t2, byte i) -> {
        ...
        //when
        BiObjByteFunction<Integer ,Integer ,Integer > function = sutO.fromByte(before1,before2,before3);
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        BiObjByteConsumer<Integer ,Integer > function = sutO.then(thenFunction);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        BiObjByteFunction<T1,T2,R> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BiObjByteFunction: R apply(T1 t1,T2 t2, byte i)");
    }
