...
public class BiObjBytePredicateXTest<T1,T2,X extends ParseException> {
    ...
    private BiObjBytePredicateX<T1,T2,X> sut = new BiObjBytePredicateX(){
        public  boolean test(Object t1,Object t2, byte b) throws ParseException {
            return testValue;
        }
    };

    private BiObjBytePredicate<T1,T2> opposite = new BiObjBytePredicate(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BiObjBytePredicateX: boolean test(T1 t1,T2 t2, byte b) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(BiObjBytePredicateX.lX((Object t1,Object t2, byte b) -> testValue ))
            .isInstanceOf(BiObjBytePredicateX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(BiObjBytePredicateX.wrapX(opposite))
            .isInstanceOf(BiObjBytePredicateX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        BiObjBytePredicateX<T1,T2,X> wrapped = BiObjBytePredicateX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws ParseException {
        ...
        //given
        BiObjBytePredicateX<T1,T2,X> fun1 = BiObjBytePredicateX.lX((T1 t1,T2 t2, byte b) -> f1Result);
        BiObjBytePredicateX<T1,T2,X> fun2 = BiObjBytePredicateX.lX((T1 t1,T2 t2, byte b) -> f2Result);

        //when
        BiObjBytePredicateX<T1,T2,X> andFunction = fun1.and(fun2);
        BiObjBytePredicateX<T1,T2,X> orFunction = fun1.or(fun2);
        BiObjBytePredicateX<T1,T2,X> xorFunction = fun1.xor(fun2);
    ...
    public void isEqual() throws ParseException  {
        //when
        BiObjBytePredicateX<T1,T2,X> equals = BiObjBytePredicateX.isEqual((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),(byte)100);
    ...
    public void testfromByte() throws ParseException {
        ...
        BiObjBytePredicateX<Integer ,Integer ,X> sutO = (Integer t1,Integer t2, byte b) -> {
        ...
        //when
        BiObjBytePredicateX<Integer ,Integer ,X> function = sutO.fromByte(before1,before2,before3);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        BiObjBytePredicateX<T1,T2,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BiObjBytePredicateX: boolean test(T1 t1,T2 t2, byte b) throws X");
    }
