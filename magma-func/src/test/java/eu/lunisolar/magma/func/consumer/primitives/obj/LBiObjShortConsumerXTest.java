...
public class LBiObjShortConsumerXTest<T1,T2,X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBiObjShortConsumerX: void accept(T1 t1,T2 t2, short s) throws X");
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LBiObjShortConsumerX<T1,T2,X> wrapped = LBiObjShortConsumerX.wrapException(sutThrowing, UnsupportedOperationException.class, t -> {
    ...
    public void testfromShort() throws ParseException {
        ...
        //when
        LBiObjShortConsumerX<Integer ,Integer ,X> function = sutO.fromShort(before1,before2,before3);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LBiObjShortConsumer.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LBiObjShortConsumerX.class);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LBiObjShortConsumerX<T1,T2,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBiObjShortConsumerX: void accept(T1 t1,T2 t2, short s) throws X");
    }
