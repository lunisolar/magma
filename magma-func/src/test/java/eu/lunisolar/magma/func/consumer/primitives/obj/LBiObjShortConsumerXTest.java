...
public class LBiObjShortConsumerXTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjShortConsumerX<Integer,Integer,X> sut = new LBiObjShortConsumerX<Integer,Integer,X>(){
        public  void doAccept(Integer a1,Integer a2,short a3)  throws X {
            Function4U.doNothing();
        }
    };

    private LBiObjShortConsumer<Integer,Integer> opposite = new LBiObjShortConsumer<Integer,Integer>(){
    ...
    private LBiObjShortConsumerX<Integer,Integer,ParseException> sutAlwaysThrowing = LBiObjShortConsumerX.lX((a1,a2,a3) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiObjShortConsumerX<Integer,Integer,RuntimeException> sutAlwaysThrowingUnchecked = LBiObjShortConsumerX.lX((a1,a2,a3) -> {
    ...
    public void testNestingDoAcceptChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoAccept(100,100,(short)100);
    ...
    public void testShovingDoAcceptChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoAccept(100,100,(short)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testLXMethod() throws X {
        assertThat(LBiObjShortConsumerX.lX(Function4U::doNothing))
    ...
    public void testHandlingDoAcceptMethodWrapsTheException() throws X {
        ...
        // when
        LBiObjShortConsumerX<Integer,Integer,RuntimeException> wrapped = sutThrowing.handleBiObjShortConsX(handler -> handler
    ...
    @Test
    public void testHandleBiObjShortConsXMethodDoNotWrapsOtherExceptionIf() throws X {
        ...
        // when
        LBiObjShortConsumerX<Integer,Integer,X> wrapped = sutThrowing.handleBiObjShortConsX(handler -> handler
                .wrapIf(UnsupportedOperationException.class::isInstance,IllegalArgumentException::new,  EXCEPTION_WAS_WRAPPED)
...
@Test
    public void testHandleBiObjShortConsXMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleBiObjShortConsXMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBiObjShortConsumerX<Integer,Integer,X> wrapped = sutThrowing.handleBiObjShortConsX(h -> Function4U.doNothing());
    ...
    public void testBiObjShortConsComposeShort() throws X {
        ...
        LBiObjShortConsumerX<Integer,Integer,X> sutO = (a1,a2,a3) -> {
    ...
    public void testAndThen() throws X {
        ...
        LBiObjShortConsumerX<Integer,Integer,X> thenFunction = (a1,a2,a3) -> {
    ...
    public void testHandleBiObjShortCons() throws X {
        ...
        // when
        LBiObjShortConsumerX<Integer,Integer,X> wrapped = sutThrowing.handleBiObjShortConsX(h -> {
    ...
    public void compilerSubstituteVariantV1() {
        LBiObjShortConsumerX lambda = LBiObjShortConsumerX./*<T1,T2,X>*/lX1(this::variantV1);
    ...
    public void compilerSubstituteVariantV2() {
        LBiObjShortConsumerX lambda = LBiObjShortConsumerX./*<T1,T2,X>*/lX2(this::variantV2);
    ...
    public void compilerSubstituteVariantV3() {
        LBiObjShortConsumerX lambda = LBiObjShortConsumerX./*<T1,T2,X>*/lX3(this::variantV3);
    ...
    public void compilerSubstituteVariantV4() {
        LBiObjShortConsumerX lambda = LBiObjShortConsumerX./*<T1,T2,X>*/lX4(this::variantV4);
    ...
    public void compilerSubstituteVariantV5() {
        LBiObjShortConsumerX lambda = LBiObjShortConsumerX./*<T1,T2,X>*/lX5(this::variantV5);
    ...
    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LBiObjShortConsumerX<Integer,Integer,X>,Y> supplier = ()->sut;
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LBiObjShortConsumerX<Integer,Integer,X>,Y> r1 = LBiObjShortConsumerX.safeSupplier(()->sut);  //NOSONAR
    }
