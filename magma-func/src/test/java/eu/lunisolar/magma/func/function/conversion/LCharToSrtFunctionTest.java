...
public class LCharToSrtFunctionTest {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.applyAsSrt('\u0100'), testValue);
    }
    ...
    public void testNonNullApplyAsSrt() throws Throwable {
            Assert.assertEquals(sut.nonNullApplyAsSrt('\u0100'), testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LCharToSrtFunction: short applyAsSrt(char a)");
    }

    @Test
    public void testCharToSrtFuncMethod() throws Throwable {
        Assert.assertTrue(LCharToSrtFunction.charToSrtFunc(a -> testValue ) instanceof LCharToSrtFunction);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LCharToSrtFunction: short applyAsSrt(char a)"));
