...
public class BiFloatPredicateXTest<X extends ParseException> {
    ...
    private BiFloatPredicateX<X> sut = new BiFloatPredicateX(){
        public  boolean test(float f1,float f2) throws ParseException {
            return testValue;
        }
    };

    private BiFloatPredicate opposite = new BiFloatPredicate(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BiFloatPredicateX: boolean test(float f1,float f2) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(BiFloatPredicateX.lX((float f1,float f2) -> testValue ))
            .isInstanceOf(BiFloatPredicateX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(BiFloatPredicateX.wrapX(opposite))
            .isInstanceOf(BiFloatPredicateX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        BiFloatPredicateX<X> wrapped = BiFloatPredicateX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws ParseException {
        ...
        //given
        BiFloatPredicateX<X> fun1 = BiFloatPredicateX.lX((float f1,float f2) -> f1Result);
        BiFloatPredicateX<X> fun2 = BiFloatPredicateX.lX((float f1,float f2) -> f2Result);

        //when
        BiFloatPredicateX<X> andFunction = fun1.and(fun2);
        BiFloatPredicateX<X> orFunction = fun1.or(fun2);
        BiFloatPredicateX<X> xorFunction = fun1.xor(fun2);
    ...
    public void isEqual() throws ParseException  {
        //when
        BiFloatPredicateX<X> equals = BiFloatPredicateX.isEqual((float)100,(float)100);
    ...
    public void testfromFloat() throws ParseException {
        ...
        BiFloatPredicateX<X> sutO = (float f1,float f2) -> {
        ...
        //when
        BiFloatPredicateX<X> function = sutO.fromFloat(before1,before2);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        BiFloatPredicateX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BiFloatPredicateX: boolean test(float f1,float f2) throws X");
    }
