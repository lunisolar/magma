...
public class ObjFloatPredicateXTest<T,X extends ParseException> {
    ...
    private ObjFloatPredicateX<T,X> sut = new ObjFloatPredicateX(){
        public  boolean test(Object t, float f) throws ParseException {
            return testValue;
        }
    };

    private ObjFloatPredicate<T> opposite = new ObjFloatPredicate(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ObjFloatPredicateX: boolean test(T t, float f) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(ObjFloatPredicateX.lX((Object t, float f) -> testValue ))
            .isInstanceOf(ObjFloatPredicateX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(ObjFloatPredicateX.wrapX(opposite))
            .isInstanceOf(ObjFloatPredicateX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        ObjFloatPredicateX<T,X> wrapped = ObjFloatPredicateX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws ParseException {
        ...
        //given
        ObjFloatPredicateX<T,X> fun1 = ObjFloatPredicateX.lX((T t, float f) -> f1Result);
        ObjFloatPredicateX<T,X> fun2 = ObjFloatPredicateX.lX((T t, float f) -> f2Result);

        //when
        ObjFloatPredicateX<T,X> andFunction = fun1.and(fun2);
        ObjFloatPredicateX<T,X> orFunction = fun1.or(fun2);
        ObjFloatPredicateX<T,X> xorFunction = fun1.xor(fun2);
    ...
    public void isEqual() throws ParseException  {
        //when
        ObjFloatPredicateX<T,X> equals = ObjFloatPredicateX.isEqual((T)Integer.valueOf(100),(float)100);
    ...
    public void testfromFloat() throws ParseException {
        ...
        ObjFloatPredicateX<Integer ,X> sutO = (Integer t, float f) -> {
        ...
        //when
        ObjFloatPredicateX<Integer ,X> function = sutO.fromFloat(before1,before2);
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().test((T)Integer.valueOf(100),(float)100);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        ObjFloatPredicateX<T,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ObjFloatPredicateX: boolean test(T t, float f) throws X");
    }
