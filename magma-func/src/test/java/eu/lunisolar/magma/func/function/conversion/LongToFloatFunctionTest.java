...
public class LongToFloatFunctionTest<X extends ParseException> {
    ...
    private LongToFloatFunction sut = new LongToFloatFunction(){
        public  float applyAsFloat(long l)  {
            return testValue;
        }
    };

    private LongToFloatFunctionX<X> opposite = new LongToFloatFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LongToFloatFunction: float applyAsFloat(long l)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LongToFloatFunction.l((long l) -> testValue ))
            .isInstanceOf(LongToFloatFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(LongToFloatFunction.wrap(opposite))
            .isInstanceOf(LongToFloatFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        LongToFloatFunction wrapped = LongToFloatFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LongToFloatFunctionX<ParseException> sutThrowing = LongToFloatFunctionX.lX((long l) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LongToFloatFunction sutThrowing = LongToFloatFunction.l((long l) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LongToFloatFunction wrapped = LongToFloatFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromLong() throws ParseException {
        ...
        LongToFloatFunction sutO = (long l) -> {
        ...
        //when
        LongToFloatFunction function = sutO.fromLong(before1);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LongToFloatFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LongToFloatFunction: float applyAsFloat(long l)");
    }
