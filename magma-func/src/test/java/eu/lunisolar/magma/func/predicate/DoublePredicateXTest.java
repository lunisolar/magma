...
public class DoublePredicateXTest<X extends ParseException> {
    ...
    private DoublePredicateX<X> sut = new DoublePredicateX(){
        public  boolean test(double d) throws ParseException {
            return testValue;
        }
    };

    private DoublePredicate opposite = new DoublePredicate(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("DoublePredicateX: boolean test(double d) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(DoublePredicateX.lX((double d) -> testValue ))
            .isInstanceOf(DoublePredicateX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(DoublePredicateX.wrapX(opposite))
            .isInstanceOf(DoublePredicateX.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(DoublePredicateX.wrapStd(jre))
            .isInstanceOf(DoublePredicateX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        DoublePredicateX<X> wrapped = DoublePredicateX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws ParseException {
        ...
        //given
        DoublePredicateX<X> fun1 = DoublePredicateX.lX((double d) -> f1Result);
        DoublePredicateX<X> fun2 = DoublePredicateX.lX((double d) -> f2Result);

        //when
        DoublePredicateX<X> andFunction = fun1.and(fun2);
        DoublePredicateX<X> orFunction = fun1.or(fun2);
        DoublePredicateX<X> xorFunction = fun1.xor(fun2);
    ...
    public void isEqual() throws ParseException  {
        //when
        DoublePredicateX<X> equals = DoublePredicateX.isEqual((double)100);
    ...
    public void testfromDouble() throws ParseException {
        ...
        DoublePredicateX<X> sutO = (double d) -> {
        ...
        //when
        DoublePredicateX<X> function = sutO.fromDouble(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        DoublePredicateX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("DoublePredicateX: boolean test(double d) throws X");
    }
