...
public class LBiObjIntPredicateXTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjIntPredicateX<T1,T2,ParseException> sutAlwaysThrowing = LBiObjIntPredicateX.lX((T1 a1,T2 a2,int a3) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiObjIntPredicateX<T1,T2,RuntimeException> sutAlwaysThrowingUnckeck = LBiObjIntPredicateX.lX((T1 a1,T2 a2,int a3) -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LBiObjIntTriple<T1,T2>,Boolean,X> theCall = sut;
    ...
    public void testNestingDoTestChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoTest((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),(int)100);
    ...
    public void testShovingDoTestChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoTest((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),(int)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testLXMethod() throws X {
        assertThat(LBiObjIntPredicateX.lX((Object a1,Object a2,int a3) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // when
        LBiObjIntPredicateX<T1,T2,X> wrapped = sutThrowing.handleBiObjIntPredX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBiObjIntPredicateX<T1,T2,X> wrapped = sutThrowing.handleBiObjIntPredX(h -> Function4U.doNothing());
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws X {
        ...
        //given
        LBiObjIntPredicateX<T1,T2,X> fun1 = LBiObjIntPredicateX.lX((T1 a1,T2 a2,int a3) -> f1Result);
        LBiObjIntPredicateX<T1,T2,X> fun2 = LBiObjIntPredicateX.lX((T1 a1,T2 a2,int a3) -> f2Result);
    ...
    public void testbiObjIntPredComposeInt() throws X {
        ...
        LBiObjIntPredicateX<Integer ,Integer ,X> sutO = (Integer a1,Integer a2,int a3) -> {
    ...
    public void testHandleBiObjIntPred() throws X {
        ...
        // when
        LBiObjIntPredicateX<T1,T2,X> wrapped = sutThrowing.handleBiObjIntPredX(h -> {
    ...
    public void compilerSubstituteVariant1() {
        LBiObjIntPredicateX lambda = LBiObjIntPredicateX./*<T1,T2,X>*/lX1(this::variant1);
    ...
    public void compilerSubstituteVariant2() {
        LBiObjIntPredicateX lambda = LBiObjIntPredicateX./*<T1,T2,X>*/lX2(this::variant2);
    ...
    public void compilerSubstituteVariant3() {
        LBiObjIntPredicateX lambda = LBiObjIntPredicateX./*<T1,T2,X>*/lX3(this::variant3);
    ...
    public void compilerSubstituteVariant4() {
        LBiObjIntPredicateX lambda = LBiObjIntPredicateX./*<T1,T2,X>*/lX4(this::variant4);
    ...
    public void compilerSubstituteVariant5() {
        LBiObjIntPredicateX lambda = LBiObjIntPredicateX./*<T1,T2,X>*/lX5(this::variant5);
    ...
    @Test void safeCompiles() {
        LBiObjIntPredicateX r1 = LBiObjIntPredicateX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LBiObjIntPredicateX<T1,T2,X>,Y> supplier = ()->sut;
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LBiObjIntPredicateX<T1,T2,X>,Y> r1 = LBiObjIntPredicateX.safeSupplier(()->sut);
    }
