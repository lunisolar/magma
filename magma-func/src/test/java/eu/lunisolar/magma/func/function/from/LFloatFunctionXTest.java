...
public class LFloatFunctionXTest<R,X extends ParseException> {
    ...
    public void testLXMethod() throws ParseException {
        assertThat(LFloatFunctionX.lX((float f) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LFloatFunctionX<R,X> wrapped = LFloatFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromFloat() throws ParseException {
        ...
        LFloatFunctionX<Integer ,X> sutO = (float f) -> {
...
//
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LFloatFunctionX<R,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
