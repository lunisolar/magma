...
public class LTieByteConsumerTest<T> {
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LTieByteConsumer: void accept(T a1,int a2,byte a3)");
    }

    @Test
    public void testTieByteConsMethod() throws Throwable {
        Assert.assertTrue(LTieByteConsumer.tieByteCons(LTieByteConsumer::doNothing) instanceof LTieByteConsumer);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LTieByteConsumer: void accept(T a1,int a2,byte a3)"));
    ...
    public void compilerSubstituteVariantLObjByteIntCons() {
        ...
        Assert.assertTrue(lambda instanceof LTieByteConsumer.LObjByteIntCons);
    }
    ...
    public void compilerSubstituteVariantLIntObjByteCons() {
        ...
        Assert.assertTrue(lambda instanceof LTieByteConsumer.LIntObjByteCons);
    }
    ...
    public void compilerSubstituteVariantLIntByteObjCons() {
        ...
        Assert.assertTrue(lambda instanceof LTieByteConsumer.LIntByteObjCons);
    }
    ...
    public void compilerSubstituteVariantLByteObjIntCons() {
        ...
        Assert.assertTrue(lambda instanceof LTieByteConsumer.LByteObjIntCons);
    }
    ...
    public void compilerSubstituteVariantLByteIntObjCons() {
        ...
        Assert.assertTrue(lambda instanceof LTieByteConsumer.LByteIntObjCons);
    }
