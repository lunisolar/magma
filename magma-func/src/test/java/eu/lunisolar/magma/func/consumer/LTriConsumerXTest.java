...
public class LTriConsumerXTest<T1,T2,T3,X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LTriConsumerX: void accept(T1 t1,T2 t2,T3 t3) throws X");
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LTriConsumerX<T1,T2,T3,X> wrapped = LTriConsumerX.wrapException(sutThrowing, UnsupportedOperationException.class, t -> {
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LTriConsumerX<T1,T2,T3,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LTriConsumerX: void accept(T1 t1,T2 t2,T3 t3) throws X");
    }
