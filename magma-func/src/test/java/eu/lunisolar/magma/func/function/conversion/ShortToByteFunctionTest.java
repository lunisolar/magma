...
public class ShortToByteFunctionTest<X extends ParseException> {
    ...
    private ShortToByteFunction sut = new ShortToByteFunction(){
        public  byte applyAsByte(short s)  {
            return testValue;
        }
    };

    private ShortToByteFunctionX<X> opposite = new ShortToByteFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ShortToByteFunction: byte applyAsByte(short s)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(ShortToByteFunction.l((short s) -> testValue ))
            .isInstanceOf(ShortToByteFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(ShortToByteFunction.wrap(opposite))
            .isInstanceOf(ShortToByteFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        // given
        ShortToByteFunctionX<X> sutThrowing = ShortToByteFunctionX.lX((short s) -> {
            throw new UnsupportedOperationException(ORIGINAL_MESSAGE);
        });

        // when
        ShortToByteFunction wrapped = ShortToByteFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        ShortToByteFunctionX<ParseException> sutThrowing = ShortToByteFunctionX.lX((short s) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        ShortToByteFunction sutThrowing = ShortToByteFunction.l((short s) -> {
            throw new UnsupportedOperationException();
        });

        // when
        ShortToByteFunction wrapped = ShortToByteFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromShort() throws ParseException {
        ...
        ShortToByteFunction sutO = (short s) -> {
        ...
        //when
        ShortToByteFunction function = sutO.fromShort(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(ShortToByteFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(ShortToByteFunctionX.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ShortToByteFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ShortToByteFunction: byte applyAsByte(short s)");
    }
