...
public class LongToDoubleFunctionTest<X extends ParseException> {
    ...
    private LongToDoubleFunction sut = new LongToDoubleFunction(){
        public  double applyAsDouble(long l)  {
            return testValue;
        }
    };

    private LongToDoubleFunctionX<X> opposite = new LongToDoubleFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LongToDoubleFunction: double applyAsDouble(long l)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LongToDoubleFunction.l((long l) -> testValue ))
            .isInstanceOf(LongToDoubleFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(LongToDoubleFunction.wrap(opposite))
            .isInstanceOf(LongToDoubleFunction.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(LongToDoubleFunction.wrapStd(jre))
            .isInstanceOf(LongToDoubleFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        LongToDoubleFunction wrapped = LongToDoubleFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LongToDoubleFunctionX<ParseException> sutThrowing = LongToDoubleFunctionX.lX((long l) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LongToDoubleFunction sutThrowing = LongToDoubleFunction.l((long l) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LongToDoubleFunction wrapped = LongToDoubleFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromLong() throws ParseException {
        ...
        LongToDoubleFunction sutO = (long l) -> {
        ...
        //when
        LongToDoubleFunction function = sutO.fromLong(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LongToDoubleFunction.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LongToDoubleFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LongToDoubleFunction: double applyAsDouble(long l)");
    }
