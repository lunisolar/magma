...
public class DoubleToCharFunctionXTest<X extends ParseException> {
    ...
    private DoubleToCharFunctionX<X> sut = new DoubleToCharFunctionX(){
        public  char applyAsChar(double d) throws ParseException {
            return testValue;
        }
    };

    private DoubleToCharFunction opposite = new DoubleToCharFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("DoubleToCharFunctionX: char applyAsChar(double d) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(DoubleToCharFunctionX.lX((double d) -> testValue ))
            .isInstanceOf(DoubleToCharFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(DoubleToCharFunctionX.wrapX(opposite))
            .isInstanceOf(DoubleToCharFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        DoubleToCharFunctionX<X> wrapped = DoubleToCharFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromDouble() throws ParseException {
        ...
        DoubleToCharFunctionX<X> sutO = (double d) -> {
        ...
        //when
        DoubleToCharFunctionX<X> function = sutO.fromDouble(before1);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        DoubleToCharFunctionX<X> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("DoubleToCharFunctionX: char applyAsChar(double d) throws X");
    }
