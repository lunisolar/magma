...
public class LCharToDoubleFunctionXTest<X extends ParseException> {
    ...
    private LCharToDoubleFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LCharToDoubleFunctionX.lX(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LCharSingle,Double,X> theCall = sut;
...
@Test
    ...
    @Test void safeCompiles() {
        LCharToDoubleFunctionX r1 = LCharToDoubleFunctionX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LCharToDoubleFunctionX<X>,Y> r1 = LCharToDoubleFunctionX.safeSupplier(()->sut);
    }
