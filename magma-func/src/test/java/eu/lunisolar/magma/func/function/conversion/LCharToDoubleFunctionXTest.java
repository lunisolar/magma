...
public class LCharToDoubleFunctionXTest<X extends ParseException> {
    ...
    private LCharToDoubleFunctionX<X> sut = new LCharToDoubleFunctionX(){
        public  double doApplyAsDouble(char c) throws ParseException {
            return testValue;
        }
    };
    ...
    private LCharToDoubleFunctionX<ParseException> sutAlwaysThrowing = LCharToDoubleFunctionX.lX(c -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LCharToDoubleFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LCharToDoubleFunctionX.lX(c -> {
    ...
    public void testNonNullDoApplyAsDouble() throws X {
        assertThat(sut.nonNullDoApplyAsDouble((char)100))
            .isEqualTo(testValue);
    }
    ...
    public void testNestingDoApplyAsDoubleChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoApplyAsDouble((char)100);
    ...
    public void testNestingDoApplyAsDoubleUnckeck() throws X {
        ...
        // then
        try {
            sutAlwaysThrowingUnckeck.nestingDoApplyAsDouble((char)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testShovingDoApplyAsDoubleChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoApplyAsDouble((char)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testShovingDoApplyAsDoubleUnckeck() throws X {
        ...
        // then
        try {
            sutAlwaysThrowingUnckeck.shovingDoApplyAsDouble((char)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
                    .isExactlyInstanceOf(IndexOutOfBoundsException.class)
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LCharToDoubleFunctionX: double doApplyAsDouble(char c) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LCharToDoubleFunctionX.lX(c -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LCharToDoubleFunctionX<X> sutThrowing = LCharToDoubleFunctionX.lX(c -> {
            throw new UnsupportedOperationException();
        });

        // when
        LCharToDoubleFunctionX<X> wrapped = sutThrowing.handleCToDFuncX(handler -> handler
            .wrapIf(UnsupportedOperationException.class::isInstance,IllegalArgumentException::new,  EXCEPTION_WAS_WRAPPED));

        // then
        try {
            wrapped.doApplyAsDouble((char)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LCharToDoubleFunctionX<X> wrapped = sutThrowing.handleCToDFuncX(h -> Function4U.doNothing());
    ...
    @Test
    public void testcToDFuncFromChar() throws X {

        final ThreadLocal<Boolean> mainFunctionCalled = ThreadLocal.withInitial(()-> false);
        final AtomicInteger beforeCalls = new AtomicInteger(0);

        //given (+ some assertions)
        LCharToDoubleFunctionX<X> sutO = c -> {
        ...
        //when
        LCharToDoubleFunctionX<X> function = sutO.cToDFuncFromChar(before1);
        function.doApplyAsDouble((char)80);
    ...
    @Test
    public void testcToDFuncFrom() throws X {
        ...
        //when
        LToDoubleFunctionX<Integer ,X> function = sutO.cToDFuncFrom(before1);
    ...
    public void testNesting() {
        assertThat(sut.nestingCToDFunc())
            .isInstanceOf(LCharToDoubleFunction.class);
    }

    @Test
    public void testShoving() {
        assertThat(sut.shovingCToDFunc())
            .isInstanceOf(LCharToDoubleFunction.class);
    }

    @Test
    public void testNestingX() {
        assertThat(sut.nestingCToDFuncX())
            .isInstanceOf(LCharToDoubleFunctionX.class);
    }

    @Test
    public void testShovingX() {
        assertThat(sut.shovingCToDFuncX())
            .isInstanceOf(LCharToDoubleFunctionX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingCToDFunc().doApplyAsDouble((char)100);
    }

    @Test
    public void testHandleCToDFunc() throws X {
        ...
        // when
        LCharToDoubleFunctionX<X> wrapped = sutThrowing.handleCToDFuncX(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LCharToDoubleFunctionX: double doApplyAsDouble(char c) throws X");
    }
