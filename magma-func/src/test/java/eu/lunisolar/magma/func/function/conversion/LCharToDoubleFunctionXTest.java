...
public class LCharToDoubleFunctionXTest<X extends ParseException> {
    ...
    private LCharToDoubleFunctionX<ParseException> sutAlwaysThrowing = LCharToDoubleFunctionX.lX((char c) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LCharToDoubleFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LCharToDoubleFunctionX.lX((char c) -> {
    ...
    public void testLXMethod() throws ParseException {
        assertThat(LCharToDoubleFunctionX.lX((char c) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LCharToDoubleFunctionX<X> sutThrowing = LCharToDoubleFunctionX.lX((char c) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LCharToDoubleFunctionX<X> wrapped = LCharToDoubleFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromChar() throws ParseException {
        ...
        LCharToDoubleFunctionX<X> sutO = (char c) -> {
        ...
        //when
        LCharToDoubleFunctionX<X> function = sutO.fromChar(before1);
...
//
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().doApplyAsDouble((char)100);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LCharToDoubleFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
