...
public class IntToDoubleFunctionXTest<X extends ParseException> {
    ...
    private IntToDoubleFunctionX<X> sut = new IntToDoubleFunctionX(){
        public  double applyAsDouble(int i) throws ParseException {
            return testValue;
        }
    };

    private IntToDoubleFunction opposite = new IntToDoubleFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("IntToDoubleFunctionX: double applyAsDouble(int i) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(IntToDoubleFunctionX.lX((int i) -> testValue ))
            .isInstanceOf(IntToDoubleFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(IntToDoubleFunctionX.wrapX(opposite))
            .isInstanceOf(IntToDoubleFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        IntToDoubleFunctionX<X> wrapped = IntToDoubleFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromInt() throws ParseException {
        ...
        IntToDoubleFunctionX<X> sutO = (int i) -> {
        ...
        //when
        IntToDoubleFunctionX<X> function = sutO.fromInt(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        IntToDoubleFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("IntToDoubleFunctionX: double applyAsDouble(int i) throws X");
    }
