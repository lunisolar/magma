...
public class LIntToCharFunctionXTest<X extends ParseException> {
    ...
    private LIntToCharFunctionX<ParseException> sutAlwaysThrowing = LIntToCharFunctionX.lX(a1 -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LIntToCharFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LIntToCharFunctionX.lX(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LIntSingle,Character,X> theCall = sut;
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LIntToCharFunctionX: char doApplyAsChar(int a1) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LIntToCharFunctionX.lX(a1 -> testValue ))
...
@Test
    ...
    public void testintToCharFuncComposeInt() throws X {
        ...
        //when
        LIntToCharFunctionX<X> function = sutO.intToCharFuncComposeInt(before1);
    ...
    public void testintToCharFuncCompose() throws X {
        ...
        //when
        LToCharFunctionX<Integer ,X> function = sutO.intToCharFuncCompose(before1);
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LIntToCharFunctionX: char doApplyAsChar(int a1) throws X");
    }
    ...
    @Test void safeCompiles() {
        LIntToCharFunctionX r1 = LIntToCharFunctionX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LIntToCharFunctionX<X>,Y> r1 = LIntToCharFunctionX.safeSupplier(()->sut);
    }
