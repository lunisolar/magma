...
public class LIntToCharFunctionXTest<X extends ParseException> {
    ...
    private LIntToCharFunctionX<ParseException> sutAlwaysThrowing = LIntToCharFunctionX.lX((int i) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LIntToCharFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LIntToCharFunctionX.lX((int i) -> {
    ...
    public void testLXMethod() throws ParseException {
        assertThat(LIntToCharFunctionX.lX((int i) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LIntToCharFunctionX<X> sutThrowing = LIntToCharFunctionX.lX((int i) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LIntToCharFunctionX<X> wrapped = LIntToCharFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromInt() throws ParseException {
        ...
        LIntToCharFunctionX<X> sutO = (int i) -> {
        ...
        //when
        LIntToCharFunctionX<X> function = sutO.fromInt(before1);
...
//
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().doApplyAsChar((int)100);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LIntToCharFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
