...
public class LIntToCharFunctionXTest<X extends ParseException> {
    ...
    private LIntToCharFunctionX<X> sut = new LIntToCharFunctionX(){
        public  char doApplyAsChar(int i) throws ParseException {
            return testValue;
        }
    };
    ...
    private LIntToCharFunctionX<ParseException> sutAlwaysThrowing = LIntToCharFunctionX.lX(i -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LIntToCharFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LIntToCharFunctionX.lX(i -> {
    ...
    public void testNestingDoApplyAsCharChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoApplyAsChar((int)100);
    ...
    public void testShovingDoApplyAsCharChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoApplyAsChar((int)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LIntToCharFunctionX: char doApplyAsChar(int i) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LIntToCharFunctionX.lX(i -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LIntToCharFunctionX<X> sutThrowing = LIntToCharFunctionX.lX(i -> {
            throw new UnsupportedOperationException();
        });

        // when
        LIntToCharFunctionX<X> wrapped = sutThrowing.handleIToCFuncX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LIntToCharFunctionX<X> wrapped = sutThrowing.handleIToCFuncX(h -> Function4U.doNothing());
    ...
    @Test
    public void testiToCFuncFromInt() throws X {

        final ThreadLocal<Boolean> mainFunctionCalled = ThreadLocal.withInitial(()-> false);
        final AtomicInteger beforeCalls = new AtomicInteger(0);

        //given (+ some assertions)
        LIntToCharFunctionX<X> sutO = i -> {
        ...
        //when
        LIntToCharFunctionX<X> function = sutO.iToCFuncFromInt(before1);
    ...
    @Test
    public void testiToCFuncFrom() throws X {
        ...
        //when
        LToCharFunctionX<Integer ,X> function = sutO.iToCFuncFrom(before1);
    ...
    public void testNesting() {
        assertThat(sut.nestingIToCFunc())
            .isInstanceOf(LIntToCharFunction.class);
    }

    @Test
    public void testShoving() {
        assertThat(sut.shovingIToCFunc())
            .isInstanceOf(LIntToCharFunction.class);
    }

    @Test
    public void testNestingX() {
        assertThat(sut.nestingIToCFuncX())
            .isInstanceOf(LIntToCharFunctionX.class);
    }

    @Test
    public void testShovingX() {
        assertThat(sut.shovingIToCFuncX())
            .isInstanceOf(LIntToCharFunctionX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingIToCFunc().doApplyAsChar((int)100);
    }

    @Test
    public void testHandleIToCFunc() throws X {
        ...
        // when
        LIntToCharFunctionX<X> wrapped = sutThrowing.handleIToCFuncX(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LIntToCharFunctionX: char doApplyAsChar(int i) throws X");
    }
