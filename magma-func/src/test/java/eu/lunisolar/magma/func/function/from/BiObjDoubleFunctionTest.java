...
public class BiObjDoubleFunctionTest<T1,T2,R,X extends ParseException> {
    ...
    private BiObjDoubleFunction<T1,T2,R> sut = new BiObjDoubleFunction(){
        public @Nullable Object  apply(Object t1,Object t2, double d)  {
            return testValue;
        }
    };

    private BiObjDoubleFunctionX<T1,T2,R,X> opposite = new BiObjDoubleFunctionX(){
        public @Nullable Object  apply(Object t1,Object t2, double d) throws ParseException {
            return testValue;
        }
    };

    private BiObjDoubleFunction<T1,T2,R> sutNull = new BiObjDoubleFunction(){
        public @Nullable Object  apply(Object t1,Object t2, double d)  {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (BiObjDoubleFunction: R apply(T1 t1,T2 t2, double d)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BiObjDoubleFunction: R apply(T1 t1,T2 t2, double d)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(BiObjDoubleFunction.l((Object t1,Object t2, double d) -> testValue ))
            .isInstanceOf(BiObjDoubleFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(BiObjDoubleFunction.wrap(opposite))
            .isInstanceOf(BiObjDoubleFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        BiObjDoubleFunction<T1,T2,R> wrapped = BiObjDoubleFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        BiObjDoubleFunctionX<T1,T2,R,ParseException> sutThrowing = BiObjDoubleFunctionX.lX((T1 t1,T2 t2, double d) -> {
    ...
    public void testfromDouble() throws ParseException {
        ...
        BiObjDoubleFunction<Integer ,Integer ,Integer > sutO = (Integer t1,Integer t2, double d) -> {
        ...
        //when
        BiObjDoubleFunction<Integer ,Integer ,Integer > function = sutO.fromDouble(before1,before2,before3);
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        BiObjDoubleConsumer<Integer ,Integer > function = sutO.then(thenFunction);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        BiObjDoubleFunction<T1,T2,R> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BiObjDoubleFunction: R apply(T1 t1,T2 t2, double d)");
    }
