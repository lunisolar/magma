...
public class BooleanToShortFunctionTest<X extends ParseException> {
    ...
    private BooleanToShortFunction sut = new BooleanToShortFunction(){
        public  short applyAsShort(boolean b)  {
            return testValue;
        }
    };

    private BooleanToShortFunctionX<X> opposite = new BooleanToShortFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BooleanToShortFunction: short applyAsShort(boolean b)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(BooleanToShortFunction.l((boolean b) -> testValue ))
            .isInstanceOf(BooleanToShortFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(BooleanToShortFunction.wrap(opposite))
            .isInstanceOf(BooleanToShortFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        BooleanToShortFunction wrapped = BooleanToShortFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        BooleanToShortFunctionX<ParseException> sutThrowing = BooleanToShortFunctionX.lX((boolean b) -> {
    ...
    public void testfromBoolean() throws ParseException {
        ...
        BooleanToShortFunction sutO = (boolean b) -> {
        ...
        //when
        BooleanToShortFunction function = sutO.fromBoolean(before1);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        BooleanToShortFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BooleanToShortFunction: short applyAsShort(boolean b)");
    }
