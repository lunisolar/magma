...
public class LDoubleToLongFunctionTest<X extends ParseException> {
    ...
    private LDoubleToLongFunction sutAlwaysThrowingUnckeck = LDoubleToLongFunction.l((double d) -> {
    ...
    public void testLMethod() throws ParseException {
        assertThat(LDoubleToLongFunction.l((double d) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LDoubleToLongFunctionX<ParseException> sutThrowing = LDoubleToLongFunctionX.lX((double d) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LDoubleToLongFunction sutThrowing = LDoubleToLongFunction.l((double d) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LDoubleToLongFunction wrapped = LDoubleToLongFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromDouble() throws ParseException {
        ...
        LDoubleToLongFunction sutO = (double d) -> {
        ...
        //when
        LDoubleToLongFunction function = sutO.fromDouble(before1);
...
//
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().doApplyAsLong((double)100);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LDoubleToLongFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
