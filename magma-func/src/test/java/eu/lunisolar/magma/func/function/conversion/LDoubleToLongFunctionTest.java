...
public class LDoubleToLongFunctionTest<X extends ParseException> {
    ...
    private LDoubleToLongFunctionX<X> opposite = new LDoubleToLongFunctionX<X>(){
    ...
    private LDoubleToLongFunctionX<RuntimeException> sutAlwaysThrowingUnchecked = LDoubleToLongFunction.l(a -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LDoubleToLongFunction: long doApplyAsLong(double a)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LDoubleToLongFunction.l(a -> testValue ))
            .isInstanceOf(LDoubleToLongFunction.class);
    }

    @Test
    public void testWrapMethod() throws X {
        assertThat(LDoubleToLongFunction.wrap(opposite))
            .isInstanceOf(LDoubleToLongFunction.class);
    }

    @Test
    public void testWrapStdMethod() throws X {
        assertThat(LDoubleToLongFunction.wrap(jre))
            .isInstanceOf(LDoubleToLongFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws X {
        ...
        // when
        LDoubleToLongFunction wrapped = LDoubleToLongFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LDoubleToLongFunctionX<ParseException> sutThrowing = LDoubleToLongFunctionX.lX(a -> {
    ...
    public void testHandlingDoApplyAsLongMethodWrapsTheException() throws X {
        ...
        // given
        LDoubleToLongFunction sutThrowing = LDoubleToLongFunction.l(a -> {
            throw new UnsupportedOperationException();
        });

        // when
        LDoubleToLongFunction wrapped = sutThrowing.handleDoubleToLongFunc(handler -> handler
    ...
    @Test
    public void testHandleDoubleToLongFuncMethodDoNotWrapsOtherExceptionIf() throws X {
...
@Test
    public void testHandleDoubleToLongFuncMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleDoubleToLongFuncMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LDoubleToLongFunction wrapped = sutThrowing.handleDoubleToLongFunc(h -> Function4U.doNothing());
    ...
    public void testDoubleToLongFuncComposeDouble() throws X {
        ...
        //when
        LDoubleToLongFunction function = sutO.doubleToLongFuncComposeDouble(before);
    ...
    public void testDoubleToLongFuncCompose() throws X {
        ...
        //when
        LToLongFunction<Integer> function = sutO.doubleToLongFuncCompose(before);
    ...
    public void testHandleDoubleToLongFunc() throws X {
        ...
        // when
        LDoubleToLongFunction wrapped = sutThrowing.handleDoubleToLongFunc(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LDoubleToLongFunction: long doApplyAsLong(double a)");
    }
    ...
    @Test void safeCompiles() {
        LDoubleToLongFunction r1 = LDoubleToLongFunction.safe(sut); //NOSONAR
        LDoubleToLongFunctionX r2 = LDoubleToLongFunction.safe(sut); //NOSONAR
        DoubleToLongFunction r3 = LDoubleToLongFunction.safe(sut); //NOSONAR
    }

    @Test void safePropagates() {
        Object result = LDoubleToLongFunction.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LDoubleToLongFunction.safe(null);
        assertThat(result).isSameAs(LDoubleToLongFunction.l(LDoubleToLongFunction.safe()));
    }

    @Test  void safeSupplierPropagates() {
        LSupplier<LDoubleToLongFunction> supplier = ()->sut;
        Object result = LDoubleToLongFunction.safeSupplier(supplier);
        assertThat(result).isSameAs(supplier);
    }

    @Test  void safeSupplierProtectsAgainstNpe() {
        Object result = LDoubleToLongFunction.safeSupplier(null);
        assertThat(result).isSameAs(LDoubleToLongFunction.safeSupplier());
    }

    @Test  void safeSupplierCompiles() {
        LSupplier<LDoubleToLongFunction> r1 = LDoubleToLongFunction.safeSupplier(()->sut);  //NOSONAR
        Supplier<LDoubleToLongFunction> r2 = LDoubleToLongFunction.safeSupplier(()->sut); //NOSONAR
    }
