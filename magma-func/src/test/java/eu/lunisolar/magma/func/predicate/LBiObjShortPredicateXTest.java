...
public class LBiObjShortPredicateXTest<T1,T2,X extends ParseException> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LBiObjShortPredicateX<T1,T2,X> wrapped = LBiObjShortPredicateX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromShort() throws ParseException {
        ...
        //when
        LBiObjShortPredicateX<Integer ,Integer ,X> function = sutO.fromShort(before1,before2,before3);
...
//
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().doTest((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),(short)100);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LBiObjShortPredicateX<T1,T2,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
