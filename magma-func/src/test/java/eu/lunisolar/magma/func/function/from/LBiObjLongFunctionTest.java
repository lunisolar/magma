...
public class LBiObjLongFunctionTest<T1,T2,R,X extends ParseException> {
    ...
    private LBiObjLongFunction<T1,T2,R> sutAlwaysThrowingUnckeck = LBiObjLongFunction.l((T1 t1,T2 t2, long l) -> {
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNullDoApply() method cannot be null (LBiObjLongFunction: R doApply(T1 t1,T2 t2, long l)).\\E")
