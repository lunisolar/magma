...
public class LBiObjLongConsumerTest<T1,T2> {
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LBiObjLongConsumer: void accept(T1 a1,T2 a2,long a3)");
    }

    @Test
    public void testBiObjLongConsMethod() throws Throwable {
        Assert.assertTrue(LBiObjLongConsumer.biObjLongCons(LBiObjLongConsumer::doNothing) instanceof LBiObjLongConsumer);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LBiObjLongConsumer: void accept(T1 a1,T2 a2,long a3)"));
    ...
    public void compilerSubstituteVariantLObj0Long2Obj1Cons() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjLongConsumer.LObj0Long2Obj1Cons);
    }
    ...
    public void compilerSubstituteVariantLObj1Obj0Long2Cons() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjLongConsumer.LObj1Obj0Long2Cons);
    }
    ...
    public void compilerSubstituteVariantLObj1Long2Obj0Cons() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjLongConsumer.LObj1Long2Obj0Cons);
    }
    ...
    public void compilerSubstituteVariantLLong2Obj0Obj1Cons() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjLongConsumer.LLong2Obj0Obj1Cons);
    }
    ...
    public void compilerSubstituteVariantLLong2Obj1Obj0Cons() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjLongConsumer.LLong2Obj1Obj0Cons);
    }
