...
public class LBiObjLongConsumerTest<T1,T2,X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBiObjLongConsumer: void accept(T1 t1,T2 t2, long l)");
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LBiObjLongConsumer<T1,T2> wrapped = LBiObjLongConsumer.wrapException(sutThrowing, UnsupportedOperationException.class, t -> {
    ...
    public void testfromLong() throws ParseException {
        ...
        //when
        LBiObjLongConsumer<Integer ,Integer > function = sutO.fromLong(before1,before2,before3);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LBiObjLongConsumer.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LBiObjLongConsumerX.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LBiObjLongConsumer<T1,T2> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBiObjLongConsumer: void accept(T1 t1,T2 t2, long l)");
    }
