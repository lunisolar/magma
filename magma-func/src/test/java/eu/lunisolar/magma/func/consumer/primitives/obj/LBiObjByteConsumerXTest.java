...
public class LBiObjByteConsumerXTest<T1,T2,X extends ParseException> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LBiObjByteConsumerX<T1,T2,X> wrapped = LBiObjByteConsumerX.wrapException(sutThrowing, UnsupportedOperationException.class, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        //when
        LBiObjByteConsumerX<Integer ,Integer ,X> function = sutO.fromByte(before1,before2,before3);
...
//
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().doAccept((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),(byte)100);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LBiObjByteConsumerX<T1,T2,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
