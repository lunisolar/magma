...
public class LBiObjIntConsumerXTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjIntConsumerX<T1,T2,X> sut = new LBiObjIntConsumerX(){
        public  void doAccept(Object a1,Object a2,int a3) throws ParseException {
            Function4U.doNothing();
        }
    };

    private LBiObjIntConsumer<T1,T2> opposite = new LBiObjIntConsumer(){
        public  void doAccept(Object a1,Object a2,int a3)  {
            Function4U.doNothing();
        }
    };
    ...
    private LBiObjIntConsumerX<T1,T2,ParseException> sutAlwaysThrowing = LBiObjIntConsumerX.lX((T1 a1,T2 a2,int a3) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiObjIntConsumerX<T1,T2,RuntimeException> sutAlwaysThrowingUnckeck = LBiObjIntConsumerX.lX((T1 a1,T2 a2,int a3) -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LBiObjIntTriple<T1,T2>,LTuple.Void,X> theCall = sut;
    ...
    public void testNestingDoAcceptChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoAccept((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),(int)100);
    ...
    public void testShovingDoAcceptChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoAccept((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),(int)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testLXMethod() throws X {
        assertThat(LBiObjIntConsumerX.lX((Object a1,Object a2,int a3) -> Function4U.doNothing() ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LBiObjIntConsumerX<T1,T2,X> sutThrowing = LBiObjIntConsumerX.lX((T1 a1,T2 a2,int a3) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LBiObjIntConsumerX<T1,T2,X> wrapped = sutThrowing.handleBiObjIntConsX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBiObjIntConsumerX<T1,T2,X> wrapped = sutThrowing.handleBiObjIntConsX(h -> Function4U.doNothing());
    ...
    public void testbiObjIntConsComposeInt() throws X {
        ...
        LBiObjIntConsumerX<Integer ,Integer ,X> sutO = (Integer a1,Integer a2,int a3) -> {
    ...
    public void testAndThen() throws X {
        ...
        LBiObjIntConsumerX<Integer ,Integer ,X> thenFunction = (Integer a1,Integer a2,int a3) -> {
    ...
    public void testHandleBiObjIntCons() throws X {
        ...
        // when
        LBiObjIntConsumerX<T1,T2,X> wrapped = sutThrowing.handleBiObjIntConsX(h -> {
    ...
    private void variant1(T1 a1,int a3,T2 a2) {
    }

    @Test
    public void compilerSubstituteVariant1() {
        LBiObjIntConsumerX lambda = LBiObjIntConsumerX./*<T1,T2,X>*/lX1(this::variant1);

        assertThat(lambda).isInstanceOf(LBiObjIntConsumerX.V1.class);
    }


    private void variant2(T2 a2,T1 a1,int a3) {
    }

    @Test
    public void compilerSubstituteVariant2() {
        LBiObjIntConsumerX lambda = LBiObjIntConsumerX./*<T1,T2,X>*/lX2(this::variant2);

        assertThat(lambda).isInstanceOf(LBiObjIntConsumerX.V2.class);
    }


    private void variant3(T2 a2,int a3,T1 a1) {
    }

    @Test
    public void compilerSubstituteVariant3() {
        LBiObjIntConsumerX lambda = LBiObjIntConsumerX./*<T1,T2,X>*/lX3(this::variant3);

        assertThat(lambda).isInstanceOf(LBiObjIntConsumerX.V3.class);
    }


    private void variant4(int a3,T1 a1,T2 a2) {
    }

    @Test
    public void compilerSubstituteVariant4() {
        LBiObjIntConsumerX lambda = LBiObjIntConsumerX./*<T1,T2,X>*/lX4(this::variant4);

        assertThat(lambda).isInstanceOf(LBiObjIntConsumerX.V4.class);
    }


    private void variant5(int a3,T2 a2,T1 a1) {
    }

    @Test
    public void compilerSubstituteVariant5() {
        LBiObjIntConsumerX lambda = LBiObjIntConsumerX./*<T1,T2,X>*/lX5(this::variant5);
    ...
    @Test void safeCompiles() {
        LBiObjIntConsumerX r1 = LBiObjIntConsumerX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LBiObjIntConsumerX<T1,T2,X>,Y> supplier = ()->sut;
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LBiObjIntConsumerX<T1,T2,X>,Y> r1 = LBiObjIntConsumerX.safeSupplier(()->sut);
    }
