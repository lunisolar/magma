...
public class LBiObjIntConsumerXTest<T1,T2,X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBiObjIntConsumerX: void accept(T1 t1,T2 t2, int i) throws X");
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LBiObjIntConsumerX<T1,T2,X> wrapped = LBiObjIntConsumerX.wrapException(sutThrowing, UnsupportedOperationException.class, t -> {
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LBiObjIntConsumer.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LBiObjIntConsumerX.class);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LBiObjIntConsumerX<T1,T2,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBiObjIntConsumerX: void accept(T1 t1,T2 t2, int i) throws X");
    }
