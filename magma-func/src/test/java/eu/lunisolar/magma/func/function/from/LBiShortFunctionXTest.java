...
public class LBiShortFunctionXTest<R,X extends ParseException> {
    ...
    private LBiShortFunctionX<R,ParseException> sutAlwaysThrowing = LBiShortFunctionX.lX((short a1,short a2) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiShortFunctionX<R,RuntimeException> sutAlwaysThrowingUnckeck = LBiShortFunctionX.lX((short a1,short a2) -> {
    ...
    public void testLXMethod() throws X {
        assertThat(LBiShortFunctionX.lX((short a1,short a2) -> testValue ))
...
@Test
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LBiShortFunctionX<R,X>,Y> r1 = LBiShortFunctionX.safeSupplier(()->sut);  //NOSONAR
    }
