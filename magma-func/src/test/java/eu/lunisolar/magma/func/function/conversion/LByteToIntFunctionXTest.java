...
public class LByteToIntFunctionXTest<X extends ParseException> {
    ...
    private LByteToIntFunctionX<ParseException> sutAlwaysThrowing = LByteToIntFunctionX.lX((byte b) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LByteToIntFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LByteToIntFunctionX.lX((byte b) -> {
    ...
    public void testLXMethod() throws ParseException {
        assertThat(LByteToIntFunctionX.lX((byte b) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LByteToIntFunctionX<X> wrapped = LByteToIntFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        LByteToIntFunctionX<X> sutO = (byte b) -> {
        ...
        //when
        LByteToIntFunctionX<X> function = sutO.fromByte(before1);
...
//
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LByteToIntFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
