...
public class LFloatToLongFunctionTest<X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LFloatToLongFunction: long applyAsLong(float f)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LFloatToLongFunction.l((float f) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LFloatToLongFunctionX<ParseException> sutThrowing = LFloatToLongFunctionX.lX((float f) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LFloatToLongFunction sutThrowing = LFloatToLongFunction.l((float f) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LFloatToLongFunction wrapped = LFloatToLongFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromFloat() throws ParseException {
        ...
        LFloatToLongFunction sutO = (float f) -> {
        ...
        //when
        LFloatToLongFunction function = sutO.fromFloat(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LFloatToLongFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LFloatToLongFunctionX.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LFloatToLongFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LFloatToLongFunction: long applyAsLong(float f)");
    }
