...
public class LLongToCharFunctionXTest<X extends ParseException> {
    ...
    private LLongToCharFunctionX<ParseException> sutAlwaysThrowing = LLongToCharFunctionX.lX((long l) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LLongToCharFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LLongToCharFunctionX.lX((long l) -> {
    ...
    public void testLXMethod() throws ParseException {
        assertThat(LLongToCharFunctionX.lX((long l) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LLongToCharFunctionX<X> sutThrowing = LLongToCharFunctionX.lX((long l) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LLongToCharFunctionX<X> wrapped = LLongToCharFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromLong() throws ParseException {
        ...
        LLongToCharFunctionX<X> sutO = (long l) -> {
        ...
        //when
        LLongToCharFunctionX<X> function = sutO.fromLong(before1);
...
//
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().doApplyAsChar((long)100);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LLongToCharFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
