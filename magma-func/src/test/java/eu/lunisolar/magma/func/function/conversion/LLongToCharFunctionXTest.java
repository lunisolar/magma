...
public class LLongToCharFunctionXTest<X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LLongToCharFunctionX: char applyAsChar(long l) throws X");
    }
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LLongToCharFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LLongToCharFunctionX.class);
    }
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LLongToCharFunctionX: char applyAsChar(long l) throws X");
    }
