...
public class LLongToCharFunctionXTest<X extends ParseException> {
    ...
    private LLongToCharFunctionX<X> sut = new LLongToCharFunctionX(){
        public  char doApplyAsChar(long l) throws ParseException {
            return testValue;
        }
    };
    ...
    private LLongToCharFunctionX<ParseException> sutAlwaysThrowing = LLongToCharFunctionX.lX(l -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LLongToCharFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LLongToCharFunctionX.lX(l -> {
    ...
    public void testNestingDoApplyAsCharChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoApplyAsChar((long)100);
    ...
    public void testShovingDoApplyAsCharChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoApplyAsChar((long)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LLongToCharFunctionX: char doApplyAsChar(long l) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LLongToCharFunctionX.lX(l -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LLongToCharFunctionX<X> sutThrowing = LLongToCharFunctionX.lX(l -> {
            throw new UnsupportedOperationException();
        });

        // when
        LLongToCharFunctionX<X> wrapped = sutThrowing.handleLongToCFuncX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LLongToCharFunctionX<X> wrapped = sutThrowing.handleLongToCFuncX(h -> Function4U.doNothing());
    ...
    @Test
    public void testlongToCFuncFromLong() throws X {

        final ThreadLocal<Boolean> mainFunctionCalled = ThreadLocal.withInitial(()-> false);
        final AtomicInteger beforeCalls = new AtomicInteger(0);

        //given (+ some assertions)
        LLongToCharFunctionX<X> sutO = l -> {
        ...
        //when
        LLongToCharFunctionX<X> function = sutO.longToCFuncFromLong(before1);
    ...
    @Test
    public void testlongToCFuncFrom() throws X {
        ...
        //when
        LToCharFunctionX<Integer ,X> function = sutO.longToCFuncFrom(before1);
    ...
    public void testNesting() {
        assertThat(sut.nestingLongToCFunc())
            .isInstanceOf(LLongToCharFunction.class);
    }

    @Test
    public void testShoving() {
        assertThat(sut.shovingLongToCFunc())
            .isInstanceOf(LLongToCharFunction.class);
    }

    @Test
    public void testNestingX() {
        assertThat(sut.nestingLongToCFuncX())
            .isInstanceOf(LLongToCharFunctionX.class);
    }

    @Test
    public void testShovingX() {
        assertThat(sut.shovingLongToCFuncX())
            .isInstanceOf(LLongToCharFunctionX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingLongToCFunc().doApplyAsChar((long)100);
    }

    @Test
    public void testHandleLongToCFunc() throws X {
        ...
        // when
        LLongToCharFunctionX<X> wrapped = sutThrowing.handleLongToCFuncX(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LLongToCharFunctionX: char doApplyAsChar(long l) throws X");
    }
