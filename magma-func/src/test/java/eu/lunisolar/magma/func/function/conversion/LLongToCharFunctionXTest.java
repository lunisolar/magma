...
public class LLongToCharFunctionXTest<X extends ParseException> {
    ...
    private LLongToCharFunctionX<ParseException> sutAlwaysThrowing = LLongToCharFunctionX.lX(a1 -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LLongToCharFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LLongToCharFunctionX.lX(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LLongSingle,Character,X> theCall = sut;
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LLongToCharFunctionX: char doApplyAsChar(long a1) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LLongToCharFunctionX.lX(a1 -> testValue ))
...
@Test
    ...
    public void testlongToCharFuncComposeLong() throws X {
        ...
        LLongToCharFunctionX<X> sutO = a1 -> {
        ...
        //when
        LLongToCharFunctionX<X> function = sutO.longToCharFuncComposeLong(before1);
    ...
    public void testlongToCharFuncCompose() throws X {
        ...
        //when
        LToCharFunctionX<Integer ,X> function = sutO.longToCharFuncCompose(before1);
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LLongToCharFunctionX: char doApplyAsChar(long a1) throws X");
    }
    ...
    @Test void safeCompiles() {
        LLongToCharFunctionX r1 = LLongToCharFunctionX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LLongToCharFunctionX<X>,Y> r1 = LLongToCharFunctionX.safeSupplier(()->sut);
    }
