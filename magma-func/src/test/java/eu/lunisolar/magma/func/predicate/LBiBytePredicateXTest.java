...
public class LBiBytePredicateXTest<X extends ParseException> {
    ...
    private LBiBytePredicateX<X> sut = new LBiBytePredicateX(){
        public  boolean doTest(byte a1,byte a2) throws ParseException {
            return testValue;
        }
    };
    ...
    private LBiBytePredicateX<ParseException> sutAlwaysThrowing = LBiBytePredicateX.lX((byte a1,byte a2) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiBytePredicateX<RuntimeException> sutAlwaysThrowingUnckeck = LBiBytePredicateX.lX((byte a1,byte a2) -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LBytePair,Boolean,X> theCall = sut;
    ...
    public void testLXMethod() throws X {
        assertThat(LBiBytePredicateX.lX((byte a1,byte a2) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LBiBytePredicateX<X> sutThrowing = LBiBytePredicateX.lX((byte a1,byte a2) -> {
...
@Test
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws X {
        ...
        //given
        LBiBytePredicateX<X> fun1 = LBiBytePredicateX.lX((byte a1,byte a2) -> f1Result);
        LBiBytePredicateX<X> fun2 = LBiBytePredicateX.lX((byte a1,byte a2) -> f2Result);
    ...
    private boolean variant1(byte a2,byte a1) {
        return true;
    }

    @Test
    public void compilerSubstituteVariant1() {
        LBiBytePredicateX lambda = LBiBytePredicateX./*<X>*/lX1(this::variant1);
    ...
    @Test void safeCompiles() {
        LBiBytePredicateX r1 = LBiBytePredicateX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LBiBytePredicateX<X>,Y> r1 = LBiBytePredicateX.safeSupplier(()->sut);
    }
