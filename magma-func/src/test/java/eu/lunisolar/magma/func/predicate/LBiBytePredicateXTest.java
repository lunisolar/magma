...
public class LBiBytePredicateXTest<X extends ParseException> {
    ...
    private LBiBytePredicateX<X> sut = new LBiBytePredicateX<X>(){
    ...
    private LBiBytePredicateX<ParseException> sutAlwaysThrowing = LBiBytePredicateX.lX((a1,a2) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiBytePredicateX<RuntimeException> sutAlwaysThrowingUnchecked = LBiBytePredicateX.lX((a1,a2) -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBiBytePredicateX: boolean doTest(byte a1,byte a2) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LBiBytePredicateX.lX((a1,a2) -> testValue ))
    ...
    public void testHandlingDoTestMethodWrapsTheException() throws X {
        ...
        // when
        LBiBytePredicateX<RuntimeException> wrapped = sutThrowing.handleBiBytePredX(handler -> handler
    ...
    @Test
    public void testHandleBiBytePredXMethodDoNotWrapsOtherExceptionIf() throws X {
        ...
        // when
        LBiBytePredicateX<X> wrapped = sutThrowing.handleBiBytePredX(handler -> handler
                .wrapIf(UnsupportedOperationException.class::isInstance,IllegalArgumentException::new,  EXCEPTION_WAS_WRAPPED)
...
@Test
    public void testHandleBiBytePredXMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleBiBytePredXMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBiBytePredicateX<X> wrapped = sutThrowing.handleBiBytePredX(h -> Function4U.doNothing());
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws X {
        ...
        //given
        LBiBytePredicateX<X> fun1 = LBiBytePredicateX.lX((a1,a2) -> f1Result);
        LBiBytePredicateX<X> fun2 = LBiBytePredicateX.lX((a1,a2) -> f2Result);
    ...
    public void testIsEqual() throws X  {
        //when
        LBiBytePredicateX<X> equals = LBiBytePredicateX.isEqual((byte)1,(byte)1);
    ...
    public void testBiBytePredComposeByte() throws X {
        ...
        LBiBytePredicateX<X> sutO = (byte a1,byte a2) -> {
        ...
        //when
        LBiBytePredicateX<X> function = sutO.biBytePredComposeByte(before1,before2);
    ...
    public void testBiBytePredCompose() throws X {
        ...
        //when
        LBiPredicateX<Integer,Integer,X> function = sutO.biBytePredCompose(before1,before2);
    ...
    public void testBoolToBiByteFunction0() throws X  {
        ...
        //given (+ some assertions)
        LBiBytePredicateX<X> sutO = (a1,a2) -> {
                mainFunctionCalled.set(true);
    ...
    public void testHandleBiBytePred() throws X {
        ...
        // when
        LBiBytePredicateX<X> wrapped = sutThrowing.handleBiBytePredX(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBiBytePredicateX: boolean doTest(byte a1,byte a2) throws X");
    }
    ...
    public void compilerSubstituteVariantV1() {
        LBiBytePredicateX lambda = LBiBytePredicateX./*<X>*/lX1(this::variantV1);

        assertThat(lambda).isInstanceOf(LBiBytePredicateX.V1.class);
    }
    ...
    @Test void safeCompiles() {
        LBiBytePredicateX r1 = LBiBytePredicateX.safe(sut); //NOSONAR
    }

    @Test void safePropagates() {
        Object result = LBiBytePredicateX.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LBiBytePredicateX.safe(null);
        assertThat(result).isSameAs(LBiBytePredicateX.lX(LBiBytePredicateX.safe()));
    }

    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LBiBytePredicateX<X>,Y> supplier = ()->sut;
        Object result = LBiBytePredicateX.safeSupplier(supplier);
        assertThat(result).isSameAs(supplier);
    }

    @Test <Y extends Throwable> void safeSupplierProtectsAgainstNpe() {
        Object result = LBiBytePredicateX.safeSupplier(null);
        assertThat(result).isSameAs(LBiBytePredicateX.safeSupplier());
    }

    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LBiBytePredicateX<X>,Y> r1 = LBiBytePredicateX.safeSupplier(()->sut);  //NOSONAR
    }
