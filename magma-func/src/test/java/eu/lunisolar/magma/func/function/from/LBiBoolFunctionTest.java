...
public class LBiBoolFunctionTest<R> {
    ...
    public void testNonNullApply() throws Throwable {
            Assert.assertSame(sut.nonNullApply(true,true), testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LBiBoolFunction: R apply(boolean a1,boolean a2)");
    }

    @Test
    public void testBiBoolFuncMethod() throws Throwable {
        Assert.assertTrue(LBiBoolFunction.biBoolFunc((a1,a2) -> testValue ) instanceof LBiBoolFunction);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LBiBoolFunction: R apply(boolean a1,boolean a2)"));
