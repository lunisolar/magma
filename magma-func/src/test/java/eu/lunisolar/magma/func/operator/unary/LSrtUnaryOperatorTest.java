...
public class LSrtUnaryOperatorTest {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.applyAsSrt((short)100), testValue);
    }
    ...
    public void testNonNullApplyAsSrt() throws Throwable {
            Assert.assertEquals(sut.nonNullApplyAsSrt((short)100), testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LSrtUnaryOperator: short applyAsSrt(short a)");
    }

    @Test
    public void testSrtUnaryOpMethod() throws Throwable {
        Assert.assertTrue(LSrtUnaryOperator.srtUnaryOp(a -> testValue ) instanceof LSrtUnaryOperator);
    ...
    public void identity() throws Throwable {
        ...
        Assert.assertEquals(identityFunction.applyAsSrt((short)8), (Object) (short)8);
    }
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LSrtUnaryOperator: short applyAsSrt(short a)"));
