...
public class ToShortFunctionTest<T,X extends ParseException> {
    ...
    private ToShortFunction<T> sut = new ToShortFunction(){
        public  short applyAsShort(Object t)  {
            return testValue;
        }
    };

    private ToShortFunctionX<T,X> opposite = new ToShortFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ToShortFunction: short applyAsShort(T t)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(ToShortFunction.l((Object t) -> testValue ))
            .isInstanceOf(ToShortFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(ToShortFunction.wrap(opposite))
            .isInstanceOf(ToShortFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        ToShortFunction<T> wrapped = ToShortFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        ToShortFunctionX<T,ParseException> sutThrowing = ToShortFunctionX.lX((T t) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        ToShortFunction<T> sutThrowing = ToShortFunction.l((T t) -> {
            throw new UnsupportedOperationException();
        });

        // when
        ToShortFunction<T> wrapped = ToShortFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfrom() throws ParseException {
        ...
        ToShortFunction<Integer > sutO = (Integer t) -> {
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ToShortFunction<T> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ToShortFunction: short applyAsShort(T t)");
    }
