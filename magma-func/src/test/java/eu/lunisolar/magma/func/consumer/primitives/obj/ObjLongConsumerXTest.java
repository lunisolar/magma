...
public class ObjLongConsumerXTest<T,X extends ParseException> {
    ...
    private ObjLongConsumerX<T,X> sut = new ObjLongConsumerX(){
        public  void accept(Object t, long l) throws ParseException {
            Function4U.doNothing();
        }
    };

    private ObjLongConsumer<T> opposite = new ObjLongConsumer(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ObjLongConsumerX: void accept(T t, long l) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(ObjLongConsumerX.lX((Object t, long l) -> Function4U.doNothing() ))
            .isInstanceOf(ObjLongConsumerX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(ObjLongConsumerX.wrapX(opposite))
            .isInstanceOf(ObjLongConsumerX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        ObjLongConsumerX<T,X> wrapped = ObjLongConsumerX.wrapException(sutThrowing, UnsupportedOperationException.class, t -> {
    ...
    public void testfromLong() throws ParseException {
        ...
        ObjLongConsumerX<Integer ,X> sutO = (Integer t, long l) -> {
        ...
        //when
        ObjLongConsumerX<Integer ,X> function = sutO.fromLong(before1,before2);
    ...
    public void testAndThen() throws ParseException {
        ...
        ObjLongConsumerX<Integer ,X> thenFunction = (Integer t, long l) -> {
        ...
        //when
        ObjLongConsumerX<Integer ,X> function = sutO.andThen(thenFunction);
        function.accept((Integer )Integer.valueOf(80),(long)81);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        ObjLongConsumerX<T,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ObjLongConsumerX: void accept(T t, long l) throws X");
    }
