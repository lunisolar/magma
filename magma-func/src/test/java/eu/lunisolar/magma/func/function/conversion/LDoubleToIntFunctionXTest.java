...
public class LDoubleToIntFunctionXTest<X extends ParseException> {
    ...
    private LDoubleToIntFunctionX<ParseException> sutAlwaysThrowing = LDoubleToIntFunctionX.lX(a1 -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LDoubleToIntFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LDoubleToIntFunctionX.lX(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LDoubleSingle,Integer,X> theCall = sut;
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LDoubleToIntFunctionX: int doApplyAsInt(double a1) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LDoubleToIntFunctionX.lX(a1 -> testValue ))
...
@Test
    ...
    public void testdoubleToIntFuncComposeDouble() throws X {
        ...
        LDoubleToIntFunctionX<X> sutO = a1 -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LDoubleToIntFunctionX: int doApplyAsInt(double a1) throws X");
    }
    ...
    @Test void safeCompiles() {
        LDoubleToIntFunctionX r1 = LDoubleToIntFunctionX.safe(sut);
        DoubleToIntFunction r3 = LDoubleToIntFunctionX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LDoubleToIntFunctionX<X>,Y> r1 = LDoubleToIntFunctionX.safeSupplier(()->sut);
        Supplier<LDoubleToIntFunctionX<X>> r2 = LDoubleToIntFunctionX.safeSupplier(()->sut);
    }
