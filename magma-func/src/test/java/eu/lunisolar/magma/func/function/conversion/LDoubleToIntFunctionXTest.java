...
public class LDoubleToIntFunctionXTest<X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LDoubleToIntFunctionX: int applyAsInt(double d) throws X");
    }
    ...
    public void testWrapStdMethod() throws ParseException {
        assertThat(LDoubleToIntFunctionX.wrapStd(jre))
            .isInstanceOf(LDoubleToIntFunctionX.class);
    }
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LDoubleToIntFunctionX: int applyAsInt(double d) throws X");
    }
