...
public class LBoolToSrtFunctionTest {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.applyAsSrt(true), testValue);
    }
    ...
    public void testNonNullApplyAsSrt() throws Throwable {
            Assert.assertEquals(sut.nonNullApplyAsSrt(true), testValue);
    }
    ...
    public void testNestingApplyAsSrtUnchecked() throws Throwable {
        ...
        // then
        try {
            sutAlwaysThrowingUnchecked.nestingApplyAsSrt(true);
    ...
    public void testShovingApplyAsSrtUnchecked() throws Throwable {
        ...
        // then
        try {
            sutAlwaysThrowingUnchecked.shovingApplyAsSrt(true);
            Assert.fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            Assert.assertEquals(e.getClass(), IndexOutOfBoundsException.class);
            Assert.assertNull(e.getCause());
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LBoolToSrtFunction: short applyAsSrt(boolean a)");
    }

    @Test
    public void testBoolToSrtFuncMethod() throws Throwable {
        Assert.assertTrue(LBoolToSrtFunction.boolToSrtFunc(a -> testValue ) instanceof LBoolToSrtFunction);
    ...
    public void testCompose() throws Throwable {
        ...
        //when
        LBoolToSrtFunction function = sutO.compose(before);
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingApplyAsSrt(true);
    }
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LBoolToSrtFunction: short applyAsSrt(boolean a)"));
