...
public class LLongToFloatFunctionXTest<X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LLongToFloatFunctionX: float applyAsFloat(long l) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(LLongToFloatFunctionX.lX((long l) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LLongToFloatFunctionX<X> wrapped = LLongToFloatFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromLong() throws ParseException {
        ...
        LLongToFloatFunctionX<X> sutO = (long l) -> {
        ...
        //when
        LLongToFloatFunctionX<X> function = sutO.fromLong(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LLongToFloatFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LLongToFloatFunctionX: float applyAsFloat(long l) throws X");
    }
