...
public class LBiIntConsumerTest<X extends ParseException> {
    ...
    private LBiIntConsumer sutAlwaysThrowingUnckeck = LBiIntConsumer.l((int i1,int i2) -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBiIntConsumer: void doAccept(int i1,int i2)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LBiIntConsumer.l((int i1,int i2) -> Function4U.doNothing() ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LBiIntConsumerX<ParseException> sutThrowing = LBiIntConsumerX.lX((int i1,int i2) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LBiIntConsumer sutThrowing = LBiIntConsumer.l((int i1,int i2) -> {
...
@Test
    ...
    public void testbiIntConsComposeInt() throws X {
        ...
        LBiIntConsumer sutO = (int i1,int i2) -> {
    ...
    public void testAndThen() throws X {
        ...
        LBiIntConsumer thenFunction = (int i1,int i2) -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBiIntConsumer: void doAccept(int i1,int i2)");
    }
