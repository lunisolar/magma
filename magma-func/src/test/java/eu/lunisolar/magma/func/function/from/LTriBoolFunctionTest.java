...
public class LTriBoolFunctionTest<R> {
    ...
    public void testNonNullApply() throws Throwable {
            Assert.assertSame(sut.nonNullApply(true,true,true), testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LTriBoolFunction: R apply(boolean a1,boolean a2,boolean a3)");
    }

    @Test
    public void testTriBoolFuncMethod() throws Throwable {
        Assert.assertTrue(LTriBoolFunction.triBoolFunc((a1,a2,a3) -> testValue ) instanceof LTriBoolFunction);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LTriBoolFunction: R apply(boolean a1,boolean a2,boolean a3)"));
