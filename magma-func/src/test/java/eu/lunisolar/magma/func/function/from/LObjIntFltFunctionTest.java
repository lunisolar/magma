...
public class LObjIntFltFunctionTest<T,R> {
    ...
    private LObjIntFltFunction<Integer,Integer> sut = new LObjIntFltFunction<Integer,Integer>(){
        public @Nullable Integer doApplyX(Integer a1,int a2,float a3)  {
            return testValue;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNullDoApply() method cannot be null (LObjIntFltFunction: R doApply(T a1,int a2,float a3)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LObjIntFltFunction: R doApply(T a1,int a2,float a3)");
    }
    ...
    @Test
    public void testObjIntFltFuncComposeIntFlt() throws Throwable {
        ...
        //when
        LObjIntFltFunction<Integer,Integer> function = sutO.objIntFltFuncComposeIntFlt(before1,before2,before3);
    ...
    public void testNesting() {
        assertThat(sut.nestingObjIntFltFunc())
            .isSameAs(sut)
            .isInstanceOf(LObjIntFltFunction.class);
    }
    ...
    public void testShoving() {
        assertThat(sut.shovingObjIntFltFunc())
            .isSameAs(sut)
            .isInstanceOf(LObjIntFltFunction.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingObjIntFltFunc().doApply(100,100,100f);
    }
    ...
    public void testToString() throws Throwable {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LObjIntFltFunction: R doApply(T a1,int a2,float a3)");
    }
