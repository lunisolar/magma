...
public class IntToByteFunctionTest<X extends ParseException> {
    ...
    private IntToByteFunction sut = new IntToByteFunction(){
        public  byte applyAsByte(int i)  {
            return testValue;
        }
    };

    private IntToByteFunctionX<X> opposite = new IntToByteFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("IntToByteFunction: byte applyAsByte(int i)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(IntToByteFunction.l((int i) -> testValue ))
            .isInstanceOf(IntToByteFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(IntToByteFunction.wrap(opposite))
            .isInstanceOf(IntToByteFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        IntToByteFunction wrapped = IntToByteFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        IntToByteFunctionX<ParseException> sutThrowing = IntToByteFunctionX.lX((int i) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        IntToByteFunction sutThrowing = IntToByteFunction.l((int i) -> {
            throw new UnsupportedOperationException();
        });

        // when
        IntToByteFunction wrapped = IntToByteFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromInt() throws ParseException {
        ...
        //when
        IntToByteFunction function = sutO.fromInt(before1);
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().applyAsByte((int)100);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        IntToByteFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("IntToByteFunction: byte applyAsByte(int i)");
    }
