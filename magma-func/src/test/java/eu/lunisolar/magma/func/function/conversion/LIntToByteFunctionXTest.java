...
public class LIntToByteFunctionXTest<X extends ParseException> {
    ...
    private LIntToByteFunctionX<X> sut = new LIntToByteFunctionX(){
    ...
    private LIntToByteFunctionX<ParseException> sutAlwaysThrowing = LIntToByteFunctionX.lX((int i) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LIntToByteFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LIntToByteFunctionX.lX((int i) -> {
    ...
    public void testNestingDoApplyAsByte_checked() throws ParseException {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoApplyAsByte((int)100);
    ...
    public void testShovingDoApplyAsByte_checked() throws ParseException {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoApplyAsByte((int)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LIntToByteFunctionX: byte doApplyAsByte(int i) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(LIntToByteFunctionX.lX((int i) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LIntToByteFunctionX<X> sutThrowing = LIntToByteFunctionX.lX((int i) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LIntToByteFunctionX<X> wrapped = LIntToByteFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromInt() throws ParseException {
        ...
        LIntToByteFunctionX<X> sutO = (int i) -> {
        ...
        //when
        LIntToByteFunctionX<X> function = sutO.fromInt(before1);
...
//
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().doApplyAsByte((int)100);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LIntToByteFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LIntToByteFunctionX: byte doApplyAsByte(int i) throws X");
    }
