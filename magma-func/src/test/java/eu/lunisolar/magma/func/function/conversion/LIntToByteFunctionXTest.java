...
public class LIntToByteFunctionXTest<X extends ParseException> {
    ...
    private LIntToByteFunctionX<ParseException> sutAlwaysThrowing = LIntToByteFunctionX.lX(a1 -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LIntToByteFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LIntToByteFunctionX.lX(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LIntSingle,Byte,X> theCall = sut;
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LIntToByteFunctionX: byte doApplyAsByte(int a1) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LIntToByteFunctionX.lX(a1 -> testValue ))
...
@Test
    ...
    public void testintToByteFuncComposeInt() throws X {
        ...
        //when
        LIntToByteFunctionX<X> function = sutO.intToByteFuncComposeInt(before1);
    ...
    public void testintToByteFuncCompose() throws X {
        ...
        //when
        LToByteFunctionX<Integer ,X> function = sutO.intToByteFuncCompose(before1);
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LIntToByteFunctionX: byte doApplyAsByte(int a1) throws X");
    }
    ...
    @Test void safeCompiles() {
        LIntToByteFunctionX r1 = LIntToByteFunctionX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LIntToByteFunctionX<X>,Y> r1 = LIntToByteFunctionX.safeSupplier(()->sut);
    }
