...
public class LBiObjFloatFunctionTest<T1,T2,R,X extends ParseException> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // when
        LBiObjFloatFunction<T1,T2,R> wrapped = sutThrowing.handle(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBiObjFloatFunction<T1,T2,R> wrapped = sutThrowing.handle(h -> Function4U.doNothing());
    ...
    public void testHandle() throws X {
        ...
        // when
        LBiObjFloatFunction<T1,T2,R> wrapped = sutThrowing.handle(h -> {
