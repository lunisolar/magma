...
public class LBiObjBoolConsumerTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjBoolConsumer<T1,T2> sut = new LBiObjBoolConsumer(){
        public  void doAccept(Object a1,Object a2,boolean a3)  {
            Function4U.doNothing();
        }
    };

    private LBiObjBoolConsumerX<T1,T2,X> opposite = new LBiObjBoolConsumerX(){
    ...
    private LBiObjBoolConsumer<T1,T2> sutAlwaysThrowingUnckeck = LBiObjBoolConsumer.l((T1 a1,T2 a2,boolean a3) -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LBiObjBoolTriple<T1,T2>,LTuple.Void,RuntimeException> theCall = sut;
    ...
    public void testLMethod() throws X {
        assertThat(LBiObjBoolConsumer.l((Object a1,Object a2,boolean a3) -> Function4U.doNothing() ))
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws X {
        ...
        // when
        LBiObjBoolConsumer<T1,T2> wrapped = LBiObjBoolConsumer.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LBiObjBoolConsumerX<T1,T2,ParseException> sutThrowing = LBiObjBoolConsumerX.lX((T1 a1,T2 a2,boolean a3) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LBiObjBoolConsumer<T1,T2> sutThrowing = LBiObjBoolConsumer.l((T1 a1,T2 a2,boolean a3) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LBiObjBoolConsumer<T1,T2> wrapped = sutThrowing.handleBiObjBoolCons(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBiObjBoolConsumer<T1,T2> wrapped = sutThrowing.handleBiObjBoolCons(h -> Function4U.doNothing());
    ...
    public void testbiObjBoolConsComposeBoolean() throws X {
        ...
        //when
        LBiObjBoolConsumer<Integer ,Integer > function = sutO.biObjBoolConsComposeBoolean(before1,before2,before3);
    ...
    public void testAndThen() throws X {
        ...
        LBiObjBoolConsumer<Integer ,Integer > thenFunction = (Integer a1,Integer a2,boolean a3) -> {
    ...
    public void testHandleBiObjBoolCons() throws X {
        ...
        // when
        LBiObjBoolConsumer<T1,T2> wrapped = sutThrowing.handleBiObjBoolCons(h -> {
    ...
    public void compilerSubstituteVariant1() {
        LBiObjBoolConsumer lambda = LBiObjBoolConsumer./*<T1,T2>*/l1(this::variant1);
    ...
    public void compilerSubstituteVariant2() {
        LBiObjBoolConsumer lambda = LBiObjBoolConsumer./*<T1,T2>*/l2(this::variant2);
    ...
    public void compilerSubstituteVariant3() {
        LBiObjBoolConsumer lambda = LBiObjBoolConsumer./*<T1,T2>*/l3(this::variant3);
    ...
    public void compilerSubstituteVariant4() {
        LBiObjBoolConsumer lambda = LBiObjBoolConsumer./*<T1,T2>*/l4(this::variant4);
    ...
    public void compilerSubstituteVariant5() {
        LBiObjBoolConsumer lambda = LBiObjBoolConsumer./*<T1,T2>*/l5(this::variant5);
    ...
    @Test void safeCompiles() {
        LBiObjBoolConsumer r1 = LBiObjBoolConsumer.safe(sut);
        LBiObjBoolConsumerX r2 = LBiObjBoolConsumer.safe(sut);
    }
    ...
    @Test  void safeSupplierPropagates() {
        LSupplier<LBiObjBoolConsumer<T1,T2>> supplier = ()->sut;
    ...
    @Test  void safeSupplierCompiles() {
        LSupplier<LBiObjBoolConsumer<T1,T2>> r1 = LBiObjBoolConsumer.safeSupplier(()->sut);
    }
