...
public class LBiObjBoolConsumerTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjBoolConsumer<T1,T2> sutAlwaysThrowingUnckeck = LBiObjBoolConsumer.l((T1 t1,T2 t2, boolean b) -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBiObjBoolConsumer: void doAccept(T1 t1,T2 t2, boolean b)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LBiObjBoolConsumer.l((Object t1,Object t2, boolean b) -> Function4U.doNothing() ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LBiObjBoolConsumerX<T1,T2,ParseException> sutThrowing = LBiObjBoolConsumerX.lX((T1 t1,T2 t2, boolean b) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LBiObjBoolConsumer<T1,T2> sutThrowing = LBiObjBoolConsumer.l((T1 t1,T2 t2, boolean b) -> {
...
@Test
    ...
    public void testbiObjBoolConsComposeBoolean() throws X {
        ...
        LBiObjBoolConsumer<Integer ,Integer > sutO = (Integer t1,Integer t2, boolean b) -> {
    ...
    public void testAndThen() throws X {
        ...
        LBiObjBoolConsumer<Integer ,Integer > thenFunction = (Integer t1,Integer t2, boolean b) -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBiObjBoolConsumer: void doAccept(T1 t1,T2 t2, boolean b)");
    }
