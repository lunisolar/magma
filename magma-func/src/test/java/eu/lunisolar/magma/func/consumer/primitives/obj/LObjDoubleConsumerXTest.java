...
public class LObjDoubleConsumerXTest<T,X extends ParseException> {
    ...
    private LObjDoubleConsumerX<Integer,X> sut = new LObjDoubleConsumerX<Integer,X>(){
        public  void doAccept(Integer a1,double a2)  throws X {
            Function4U.doNothing();
        }
    };

    private LObjDoubleConsumer<Integer> opposite = new LObjDoubleConsumer<Integer>(){
    ...
    private LObjDoubleConsumerX<Integer,ParseException> sutAlwaysThrowing = LObjDoubleConsumerX.lX((a1,a2) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LObjDoubleConsumerX<Integer,RuntimeException> sutAlwaysThrowingUnchecked = LObjDoubleConsumerX.lX((a1,a2) -> {
    ...
    public void testNestingDoAcceptChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoAccept(100,100d);
    ...
    public void testShovingDoAcceptChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoAccept(100,100d);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testLXMethod() throws X {
        assertThat(LObjDoubleConsumerX.lX(Function4U::doNothing))
    ...
    public void testHandlingDoAcceptMethodWrapsTheException() throws X {
        ...
        // when
        LObjDoubleConsumerX<Integer,RuntimeException> wrapped = sutThrowing.handleObjDoubleConsX(handler -> handler
    ...
    @Test
    public void testHandleObjDoubleConsXMethodDoNotWrapsOtherExceptionIf() throws X {
        ...
        // when
        LObjDoubleConsumerX<Integer,X> wrapped = sutThrowing.handleObjDoubleConsX(handler -> handler
                .wrapIf(UnsupportedOperationException.class::isInstance,IllegalArgumentException::new,  EXCEPTION_WAS_WRAPPED)
...
@Test
    public void testHandleObjDoubleConsXMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleObjDoubleConsXMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LObjDoubleConsumerX<Integer,X> wrapped = sutThrowing.handleObjDoubleConsX(h -> Function4U.doNothing());
    ...
    public void testAndThen() throws X {
        ...
        final ThreadLocal<Boolean> thenFunctionCalled = ThreadLocal.withInitial(()-> false);
         ...
         //given (+ some assertions)
        LObjDoubleConsumerX<Integer,X> sutO = (a1,a2) -> {
                mainFunctionCalled.set(true);
                assertThat(a1).isEqualTo(80);
                assertThat(a2).isEqualTo(81d);
        };

        LObjDoubleConsumerX<Integer,X> thenFunction = (a1,a2) -> {
    ...
    public void testHandleObjDoubleCons() throws X {
        ...
        // when
        LObjDoubleConsumerX<Integer,X> wrapped = sutThrowing.handleObjDoubleConsX(h -> {
    ...
    public void compilerSubstituteVariantV1() {
        LObjDoubleConsumerX lambda = LObjDoubleConsumerX./*<T,X>*/lX1(this::variantV1);
    ...
    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LObjDoubleConsumerX<Integer,X>,Y> supplier = ()->sut;
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LObjDoubleConsumerX<Integer,X>,Y> r1 = LObjDoubleConsumerX.safeSupplier(()->sut);  //NOSONAR
        Supplier<LObjDoubleConsumerX<Integer,X>> r2 = LObjDoubleConsumerX.safeSupplier(()->sut); //NOSONAR
    }
