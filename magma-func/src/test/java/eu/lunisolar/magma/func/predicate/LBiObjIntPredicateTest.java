...
public class LBiObjIntPredicateTest<T1,T2> {
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LBiObjIntPredicate: boolean test(T1 a1,T2 a2,int a3)");
    }

    @Test
    public void testBiObjIntPredMethod() throws Throwable {
        Assert.assertTrue(LBiObjIntPredicate.biObjIntPred((a1,a2,a3) -> testValue ) instanceof LBiObjIntPredicate);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LBiObjIntPredicate: boolean test(T1 a1,T2 a2,int a3)"));
    ...
    public void compilerSubstituteVariantLObj1Obj0Int2Pred() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjIntPredicate.LObj1Obj0Int2Pred);
    }
    ...
    public void compilerSubstituteVariantLInt2Obj0Obj1Pred() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjIntPredicate.LInt2Obj0Obj1Pred);
    }
    ...
    public void compilerSubstituteVariantLInt2Obj1Obj0Pred() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjIntPredicate.LInt2Obj1Obj0Pred);
    }
