...
public class LLongUnaryOperatorXTest<X extends ParseException> {
    ...
    public void testWrapStdMethod() throws ParseException {
        assertThat(LLongUnaryOperatorX.wrapStd(jre))
            .isInstanceOf(LLongUnaryOperatorX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LLongUnaryOperatorX<X> wrapped = LLongUnaryOperatorX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LLongUnaryOperator.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LLongUnaryOperatorX.class);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LLongUnaryOperatorX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
