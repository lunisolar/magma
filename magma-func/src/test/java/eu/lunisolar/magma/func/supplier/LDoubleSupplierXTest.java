...
public class LDoubleSupplierXTest<X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LDoubleSupplierX: double getAsDouble() throws X");
    }
    ...
    public void testWrapStdMethod() throws ParseException {
        assertThat(LDoubleSupplierX.wrapStd(jre))
            .isInstanceOf(LDoubleSupplierX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LDoubleSupplierX<X> wrapped = LDoubleSupplierX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LDoubleSupplierX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LDoubleSupplierX: double getAsDouble() throws X");
    }
