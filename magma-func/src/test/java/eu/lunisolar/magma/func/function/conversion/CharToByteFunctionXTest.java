...
public class CharToByteFunctionXTest<X extends ParseException> {
    ...
    private CharToByteFunctionX<X> sut = new CharToByteFunctionX(){
        public  byte applyAsByte(char c) throws ParseException {
            return testValue;
        }
    };

    private CharToByteFunction opposite = new CharToByteFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("CharToByteFunctionX: byte applyAsByte(char c) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(CharToByteFunctionX.lX((char c) -> testValue ))
            .isInstanceOf(CharToByteFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(CharToByteFunctionX.wrapX(opposite))
            .isInstanceOf(CharToByteFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        CharToByteFunctionX<X> wrapped = CharToByteFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromChar() throws ParseException {
        ...
        CharToByteFunctionX<X> sutO = (char c) -> {
        ...
        //when
        CharToByteFunctionX<X> function = sutO.fromChar(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        CharToByteFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("CharToByteFunctionX: byte applyAsByte(char c) throws X");
    }
