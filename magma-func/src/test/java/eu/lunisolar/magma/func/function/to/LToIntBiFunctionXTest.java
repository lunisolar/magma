...
public class LToIntBiFunctionXTest<T1,T2,X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LToIntBiFunctionX: int applyAsInt(T1 t1,T2 t2) throws X");
    }
    ...
    public void testWrapStdMethod() throws ParseException {
        assertThat(LToIntBiFunctionX.wrapStd(jre))
            .isInstanceOf(LToIntBiFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LToIntBiFunctionX<T1,T2,X> wrapped = LToIntBiFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LToIntBiFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LToIntBiFunctionX.class);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LToIntBiFunctionX<T1,T2,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LToIntBiFunctionX: int applyAsInt(T1 t1,T2 t2) throws X");
    }
