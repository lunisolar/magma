...
public class LBiByteFunctionTest<R,X extends ParseException> {
    ...
    private LBiByteFunction<R> sutAlwaysThrowingUnckeck = LBiByteFunction.l((byte b1,byte b2) -> {
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNullDoApply() method cannot be null (LBiByteFunction: R doApply(byte b1,byte b2)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBiByteFunction: R doApply(byte b1,byte b2)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LBiByteFunction.l((byte b1,byte b2) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LBiByteFunctionX<R,ParseException> sutThrowing = LBiByteFunctionX.lX((byte b1,byte b2) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LBiByteFunction<R> sutThrowing = LBiByteFunction.l((byte b1,byte b2) -> {
...
@Test
    ...
    public void testbiByteFuncComposeByte() throws X {
        ...
        LBiByteFunction<Integer > sutO = (byte b1,byte b2) -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBiByteFunction: R doApply(byte b1,byte b2)");
    }
