...
public class BiObjCharPredicateTest<T1,T2,X extends ParseException> {
    ...
    private BiObjCharPredicate<T1,T2> sut = new BiObjCharPredicate(){
        public  boolean test(Object t1,Object t2, char c)  {
            return testValue;
        }
    };

    private BiObjCharPredicateX<T1,T2,X> opposite = new BiObjCharPredicateX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BiObjCharPredicate: boolean test(T1 t1,T2 t2, char c)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(BiObjCharPredicate.l((Object t1,Object t2, char c) -> testValue ))
            .isInstanceOf(BiObjCharPredicate.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(BiObjCharPredicate.wrap(opposite))
            .isInstanceOf(BiObjCharPredicate.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        BiObjCharPredicate<T1,T2> wrapped = BiObjCharPredicate.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        BiObjCharPredicateX<T1,T2,ParseException> sutThrowing = BiObjCharPredicateX.lX((T1 t1,T2 t2, char c) -> {
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws ParseException {
        ...
        //given
        BiObjCharPredicate<T1,T2> fun1 = BiObjCharPredicate.l((T1 t1,T2 t2, char c) -> f1Result);
        BiObjCharPredicate<T1,T2> fun2 = BiObjCharPredicate.l((T1 t1,T2 t2, char c) -> f2Result);

        //when
        BiObjCharPredicate<T1,T2> andFunction = fun1.and(fun2);
        BiObjCharPredicate<T1,T2> orFunction = fun1.or(fun2);
        BiObjCharPredicate<T1,T2> xorFunction = fun1.xor(fun2);
    ...
    public void isEqual() throws ParseException  {
        //when
        BiObjCharPredicate<T1,T2> equals = BiObjCharPredicate.isEqual((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),(char)100);
    ...
    public void testfromChar() throws ParseException {
        ...
        BiObjCharPredicate<Integer ,Integer > sutO = (Integer t1,Integer t2, char c) -> {
        ...
        //when
        BiObjCharPredicate<Integer ,Integer > function = sutO.fromChar(before1,before2,before3);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        BiObjCharPredicate<T1,T2> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BiObjCharPredicate: boolean test(T1 t1,T2 t2, char c)");
    }
