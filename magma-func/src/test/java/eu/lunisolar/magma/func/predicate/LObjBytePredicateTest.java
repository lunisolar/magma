...
public class LObjBytePredicateTest<T,X extends ParseException> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LObjBytePredicate<T> wrapped = LObjBytePredicate.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        //when
        LObjBytePredicate<Integer > function = sutO.fromByte(before1,before2);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LObjBytePredicate.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LObjBytePredicateX.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LObjBytePredicate<T> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
