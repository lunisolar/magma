...
public class LObjBytePredicateTest<T,X extends ParseException> {
    ...
    private LObjBytePredicate<T> sutAlwaysThrowingUnckeck = LObjBytePredicate.l((T t, byte b) -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LObjBytePredicate: boolean doTest(T t, byte b)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LObjBytePredicate.l((Object t, byte b) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LObjBytePredicateX<T,ParseException> sutThrowing = LObjBytePredicateX.lX((T t, byte b) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LObjBytePredicate<T> sutThrowing = LObjBytePredicate.l((T t, byte b) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LObjBytePredicate<T> wrapped = sutThrowing.handleObjBPred(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LObjBytePredicate<T> wrapped = sutThrowing.handleObjBPred(h -> Function4U.doNothing());
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws X {
        ...
        //given
        LObjBytePredicate<T> fun1 = LObjBytePredicate.l((T t, byte b) -> f1Result);
        LObjBytePredicate<T> fun2 = LObjBytePredicate.l((T t, byte b) -> f2Result);
    ...
    public void testobjBPredFromByte() throws X {
        ...
        LObjBytePredicate<Integer > sutO = (Integer t, byte b) -> {
        ...
        //when
        LObjBytePredicate<Integer > function = sutO.objBPredFromByte(before1,before2);
    ...
    public void testobjBPredFrom() throws X {
        ...
        //when
        LBiPredicate<Integer ,Integer > function = sutO.objBPredFrom(before1,before2);
    ...
    public void testHandleObjBPred() throws X {
        ...
        // when
        LObjBytePredicate<T> wrapped = sutThrowing.handleObjBPred(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LObjBytePredicate: boolean doTest(T t, byte b)");
    }
