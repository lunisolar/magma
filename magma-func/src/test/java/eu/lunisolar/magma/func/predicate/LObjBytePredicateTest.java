...
public class LObjBytePredicateTest<T,X extends ParseException> {
    ...
    private LObjBytePredicate<T> sut = new LObjBytePredicate(){
        public  boolean doTest(Object a1,byte a2)  {
            return testValue;
        }
    };

    private LObjBytePredicateX<T,X> opposite = new LObjBytePredicateX(){
    ...
    private LObjBytePredicate<T> sutAlwaysThrowingUnckeck = LObjBytePredicate.l((T a1,byte a2) -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LObjBytePair<T>,Boolean,RuntimeException> theCall = sut;
    ...
    public void testLMethod() throws X {
        assertThat(LObjBytePredicate.l((Object a1,byte a2) -> testValue ))
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws X {
        ...
        // when
        LObjBytePredicate<T> wrapped = LObjBytePredicate.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LObjBytePredicateX<T,ParseException> sutThrowing = LObjBytePredicateX.lX((T a1,byte a2) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LObjBytePredicate<T> sutThrowing = LObjBytePredicate.l((T a1,byte a2) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LObjBytePredicate<T> wrapped = sutThrowing.handleObjBytePred(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LObjBytePredicate<T> wrapped = sutThrowing.handleObjBytePred(h -> Function4U.doNothing());
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws X {
        ...
        //given
        LObjBytePredicate<T> fun1 = LObjBytePredicate.l((T a1,byte a2) -> f1Result);
        LObjBytePredicate<T> fun2 = LObjBytePredicate.l((T a1,byte a2) -> f2Result);

        //when
        LObjBytePredicate<T> andFunction = fun1.and(fun2);
        LObjBytePredicate<T> orFunction = fun1.or(fun2);
        LObjBytePredicate<T> xorFunction = fun1.xor(fun2);
    ...
    public void isEqual() throws X  {
        //when
        LObjBytePredicate<T> equals = LObjBytePredicate.isEqual((T)Integer.valueOf(100),(byte)100);
    ...
    public void testobjBytePredComposeByte() throws X {
        ...
        LObjBytePredicate<Integer > sutO = (Integer a1,byte a2) -> {
    ...
    public void testThen0() throws X  {
        ...
        //when
        LObjByteFunction<Integer ,Integer > function = sutO.boolToObjByteFunction(thenFunction);
    ...
    public void testHandleObjBytePred() throws X {
        ...
        // when
        LObjBytePredicate<T> wrapped = sutThrowing.handleObjBytePred(h -> {
    ...
    public void compilerSubstituteVariant1() {
        LObjBytePredicate lambda = LObjBytePredicate./*<T>*/l1(this::variant1);
    ...
    @Test void safeCompiles() {
        LObjBytePredicate r1 = LObjBytePredicate.safe(sut);
        LObjBytePredicateX r2 = LObjBytePredicate.safe(sut);
    }
    ...
    @Test  void safeSupplierPropagates() {
        LSupplier<LObjBytePredicate<T>> supplier = ()->sut;
    ...
    @Test  void safeSupplierCompiles() {
        LSupplier<LObjBytePredicate<T>> r1 = LObjBytePredicate.safeSupplier(()->sut);
    }
