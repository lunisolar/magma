...
public class TernaryOperatorXTest<T,X extends ParseException> {
    ...
    private TernaryOperatorX<T,X> sut = new TernaryOperatorX(){
        public @Nullable Object  apply(Object t1,Object t2,Object t3) throws ParseException {
            return testValue;
        }
    };

    private TernaryOperator<T> opposite = new TernaryOperator(){
        public @Nullable Object  apply(Object t1,Object t2,Object t3)  {
            return testValue;
        }
    };

    private TernaryOperatorX<T,X> sutNull = new TernaryOperatorX(){
        public @Nullable Object  apply(Object t1,Object t2,Object t3) throws ParseException {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (TernaryOperatorX: T apply(T t1,T t2,T t3) throws X).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("TernaryOperatorX: T apply(T t1,T t2,T t3) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(TernaryOperatorX.lX((Object t1,Object t2,Object t3) -> testValue ))
            .isInstanceOf(TernaryOperatorX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(TernaryOperatorX.wrapX(opposite))
            .isInstanceOf(TernaryOperatorX.class);
    }
    ...
    public void testThen0() throws ParseException  {
        ...
        TernaryOperatorX<Integer ,X> sutO = (Integer t1,Integer t2,Integer t3) -> {
