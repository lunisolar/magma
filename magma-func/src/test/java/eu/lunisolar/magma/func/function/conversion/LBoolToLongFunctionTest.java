...
public class LBoolToLongFunctionTest {
    ...
    private LBoolToLongFunction sut = new LBoolToLongFunction(){
        public  long applyAsLongX(boolean a)  {
            return testValue;
        }
    };
    ...
    private LBoolToLongFunction sutAlwaysThrowing = LBoolToLongFunction.boolToLongFunc(a -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBoolToLongFunction sutAlwaysThrowingUnchecked = LBoolToLongFunction.boolToLongFunc(a -> {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.applyAsLong(true), testValue);
    }
    ...
    public void testNonNullApplyAsLong() throws Throwable {
            Assert.assertEquals(sut.nonNullApplyAsLong(true), testValue);
    }
    ...
    public void testNestingApplyAsLongUnchecked() throws Throwable {
        ...
        // then
        try {
            sutAlwaysThrowingUnchecked.nestingApplyAsLong(true);
    ...
    public void testShovingApplyAsLongUnchecked() throws Throwable {
        ...
        // then
        try {
            sutAlwaysThrowingUnchecked.shovingApplyAsLong(true);
            Assert.fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            Assert.assertEquals(e.getClass(), IndexOutOfBoundsException.class);
            Assert.assertNull(e.getCause());
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LBoolToLongFunction: long applyAsLong(boolean a)");
    }

    @Test
    public void testBoolToLongFuncMethod() throws Throwable {
        Assert.assertTrue(LBoolToLongFunction.boolToLongFunc(a -> testValue ) instanceof LBoolToLongFunction);
    ...
    public void testCompose() throws Throwable {
        ...
        //when
        LBoolToLongFunction function = sutO.compose(before);
    ...
    @Test
    public void testBoolToLongFuncCompose() throws Throwable {
    ...
    public void testShove() {
        ...
        // given
        LBoolToLongFunction sutThrowing = LBoolToLongFunction.boolToLongFunc(a -> {
            throw new UnsupportedOperationException();
        });

        // when
        sutThrowing.shovingApplyAsLong(true);
    }
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LBoolToLongFunction: long applyAsLong(boolean a)"));
