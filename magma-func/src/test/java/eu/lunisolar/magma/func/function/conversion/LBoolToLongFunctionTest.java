...
public class LBoolToLongFunctionTest {
    ...
    private LBoolToLongFunction sut = new LBoolToLongFunction(){
        public  long doApplyAsLongX(boolean a)  {
            return testValue;
        }
    };
    ...
    public void testBoolToLongFuncMethod() throws Throwable {
        assertThat(LBoolToLongFunction.boolToLongFunc(a -> testValue ))
    ...
    @Test
    public void testBoolToLongFuncComposeBool() throws Throwable {
