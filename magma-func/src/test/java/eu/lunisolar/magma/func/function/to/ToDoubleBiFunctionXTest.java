...
public class ToDoubleBiFunctionXTest<T1,T2,X extends ParseException> {
    ...
    private ToDoubleBiFunctionX<T1,T2,X> sut = new ToDoubleBiFunctionX(){
        public  double applyAsDouble(Object t1,Object t2) throws ParseException {
            return testValue;
        }
    };

    private ToDoubleBiFunction<T1,T2> opposite = new ToDoubleBiFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ToDoubleBiFunctionX: double applyAsDouble(T1 t1,T2 t2) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(ToDoubleBiFunctionX.lX((Object t1,Object t2) -> testValue ))
            .isInstanceOf(ToDoubleBiFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(ToDoubleBiFunctionX.wrapX(opposite))
            .isInstanceOf(ToDoubleBiFunctionX.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(ToDoubleBiFunctionX.wrapStd(jre))
            .isInstanceOf(ToDoubleBiFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        ToDoubleBiFunctionX<T1,T2,X> wrapped = ToDoubleBiFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfrom() throws ParseException {
        ...
        ToDoubleBiFunctionX<Integer ,Integer ,X> sutO = (Integer t1,Integer t2) -> {
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        ToDoubleBiFunctionX<T1,T2,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ToDoubleBiFunctionX: double applyAsDouble(T1 t1,T2 t2) throws X");
    }
