...
public class ObjDoublePredicateXTest<T,X extends ParseException> {
    ...
    private ObjDoublePredicateX<T,X> sut = new ObjDoublePredicateX(){
        public  boolean test(Object t, double d) throws ParseException {
            return testValue;
        }
    };

    private ObjDoublePredicate<T> opposite = new ObjDoublePredicate(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ObjDoublePredicateX: boolean test(T t, double d) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(ObjDoublePredicateX.lX((Object t, double d) -> testValue ))
            .isInstanceOf(ObjDoublePredicateX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(ObjDoublePredicateX.wrapX(opposite))
            .isInstanceOf(ObjDoublePredicateX.class);
    }
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws ParseException {
        ...
        //given
        ObjDoublePredicateX<T,X> fun1 = ObjDoublePredicateX.lX((T t, double d) -> f1Result);
        ObjDoublePredicateX<T,X> fun2 = ObjDoublePredicateX.lX((T t, double d) -> f2Result);

        //when
        ObjDoublePredicateX<T,X> andFunction = fun1.and(fun2);
        ObjDoublePredicateX<T,X> orFunction = fun1.or(fun2);
        ObjDoublePredicateX<T,X> xorFunction = fun1.xor(fun2);
    ...
    public void isEqual() throws ParseException  {
        //when
        ObjDoublePredicateX<T,X> equals = ObjDoublePredicateX.isEqual((T)Integer.valueOf(100),(double)100);
    ...
    public void testfromDouble() throws ParseException {
        ...
        ObjDoublePredicateX<Integer ,X> sutO = (Integer t, double d) -> {
        ...
        //when
        ObjDoublePredicateX<Integer ,X> function = sutO.fromDouble(before1,before2);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        ObjDoublePredicateX<T,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ObjDoublePredicateX: boolean test(T t, double d) throws X");
    }
