...
public class LIntToCharFunctionTest<X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LIntToCharFunction: char applyAsChar(int i)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LIntToCharFunction.l((int i) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LIntToCharFunctionX<ParseException> sutThrowing = LIntToCharFunctionX.lX((int i) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LIntToCharFunction sutThrowing = LIntToCharFunction.l((int i) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LIntToCharFunction wrapped = LIntToCharFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromInt() throws ParseException {
        ...
        //when
        LIntToCharFunction function = sutO.fromInt(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LIntToCharFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LIntToCharFunctionX.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LIntToCharFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LIntToCharFunction: char applyAsChar(int i)");
    }
