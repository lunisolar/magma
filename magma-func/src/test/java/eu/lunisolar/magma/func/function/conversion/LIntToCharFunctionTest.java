...
public class LIntToCharFunctionTest {
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LIntToCharFunction: char applyAsChar(int a)");
    }

    @Test
    public void testIntToCharFuncMethod() throws Throwable {
        Assert.assertTrue(LIntToCharFunction.intToCharFunc(a -> testValue ) instanceof LIntToCharFunction);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LIntToCharFunction: char applyAsChar(int a)"));
