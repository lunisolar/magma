...
public class LByteToCharFunctionXTest<X extends ParseException> {
    ...
    private LByteToCharFunctionX<ParseException> sutAlwaysThrowing = LByteToCharFunctionX.lX((byte b) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LByteToCharFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LByteToCharFunctionX.lX((byte b) -> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LByteToCharFunctionX: char doApplyAsChar(byte b) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(LByteToCharFunctionX.lX((byte b) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LByteToCharFunctionX<X> sutThrowing = LByteToCharFunctionX.lX((byte b) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LByteToCharFunctionX<X> wrapped = LByteToCharFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        LByteToCharFunctionX<X> sutO = (byte b) -> {
        ...
        //when
        LByteToCharFunctionX<X> function = sutO.fromByte(before1);
...
//
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LByteToCharFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LByteToCharFunctionX: char doApplyAsChar(byte b) throws X");
    }
