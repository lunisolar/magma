...
public class LToIntFunctionTest<T> {
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LToIntFunction: int applyAsInt(T a)");
    }

    @Test
    public void testToIntFuncMethod() throws Throwable {
        Assert.assertTrue(LToIntFunction.toIntFunc(a -> testValue ) instanceof LToIntFunction);
    ...
    public void testWrapStdMethod() throws Throwable {
        Assert.assertTrue(LToIntFunction.wrap(jre) instanceof LToIntFunction);
    }
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LToIntFunction: int applyAsInt(T a)"));
