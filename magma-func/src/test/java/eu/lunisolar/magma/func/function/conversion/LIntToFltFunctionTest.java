...
public class LIntToFltFunctionTest {
    ...
    private LIntToFltFunction sut = new LIntToFltFunction(){
    ...
    private LIntToFltFunction sutAlwaysThrowing = LIntToFltFunction.intToFltFunc(a -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LIntToFltFunction sutAlwaysThrowingUnchecked = LIntToFltFunction.intToFltFunc(a -> {
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LIntToFltFunction: float doApplyAsFlt(int a)");
    }

    @Test
    public void testIntToFltFuncMethod() throws Throwable {
        assertThat(LIntToFltFunction.intToFltFunc(a -> testValue ))
            .isInstanceOf(LIntToFltFunction.class);
    }
    ...
    @Test
    public void testIntToFltFuncComposeInt() throws Throwable {

        final ThreadLocal<Boolean> mainFunctionCalled = ThreadLocal.withInitial(()-> false);
        final AtomicInteger beforeCalls = new AtomicInteger(0);

        //given (+ some assertions)
        LIntToFltFunction sutO = a -> {
        ...
        //when
        LIntToFltFunction function = sutO.intToFltFuncComposeInt(before);
    ...
    @Test
    public void testIntToFltFuncCompose() throws Throwable {
        ...
        //when
        LToFltFunction<Integer> function = sutO.intToFltFuncCompose(before);
        function.doApplyAsFlt(80);
    ...
    public void testNesting() {
        assertThat(sut.nestingIntToFltFunc())
            .isSameAs(sut)
            .isInstanceOf(LIntToFltFunction.class);
    }
    ...
    public void testShoving() {
        assertThat(sut.shovingIntToFltFunc())
            .isSameAs(sut)
            .isInstanceOf(LIntToFltFunction.class);
    }
    ...
    public void testShove() {
        ...
        // given
        LIntToFltFunction sutThrowing = LIntToFltFunction.intToFltFunc(a -> {
            throw new UnsupportedOperationException();
        });

        // when
        sutThrowing.shovingIntToFltFunc().doApplyAsFlt(100);
    }
    ...
    public void testToString() throws Throwable {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LIntToFltFunction: float doApplyAsFlt(int a)");
    }
    ...
    @Test void safeCompiles() {
        LIntToFltFunction r1 = LIntToFltFunction.safe(sut); //NOSONAR
    }

    @Test void safePropagates() {
        Object result = LIntToFltFunction.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LIntToFltFunction.safe(null);
        assertThat(result).isSameAs(LIntToFltFunction.intToFltFunc(LIntToFltFunction.safe()));
    }

    @Test  void safeSupplierPropagates() {
        LSupplier<LIntToFltFunction> supplier = ()->sut;
        Object result = LIntToFltFunction.safeSupplier(supplier);
        assertThat(result).isSameAs(supplier);
    }

    @Test  void safeSupplierProtectsAgainstNpe() {
        Object result = LIntToFltFunction.safeSupplier(null);
        assertThat(result).isSameAs(LIntToFltFunction.safeSupplier());
    }

    @Test  void safeSupplierCompiles() {
        LSupplier<LIntToFltFunction> r1 = LIntToFltFunction.safeSupplier(()->sut);  //NOSONAR
    }
