...
public class LIntToFltFunctionTest {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.applyAsFlt(100), testValue);
    }
    ...
    public void testNonNullApplyAsFlt() throws Throwable {
            Assert.assertEquals(sut.nonNullApplyAsFlt(100), testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LIntToFltFunction: float applyAsFlt(int a)");
    }

    @Test
    public void testIntToFltFuncMethod() throws Throwable {
        Assert.assertTrue(LIntToFltFunction.intToFltFunc(a -> testValue ) instanceof LIntToFltFunction);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LIntToFltFunction: float applyAsFlt(int a)"));
