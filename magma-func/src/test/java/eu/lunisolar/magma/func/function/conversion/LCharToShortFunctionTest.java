...
public class LCharToShortFunctionTest<X extends ParseException> {
    ...
    private LCharToShortFunction sutAlwaysThrowingUnckeck = LCharToShortFunction.l(c -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LCharToShortFunction: short doApplyAsShort(char c)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LCharToShortFunction.l(c -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LCharToShortFunctionX<ParseException> sutThrowing = LCharToShortFunctionX.lX(c -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LCharToShortFunction sutThrowing = LCharToShortFunction.l(c -> {
...
@Test
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LCharToShortFunction: short doApplyAsShort(char c)");
    }
