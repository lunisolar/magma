...
public class LCharToShortFunctionTest<X extends ParseException> {
    ...
    private LCharToShortFunctionX<X> opposite = new LCharToShortFunctionX(){
        public  short doApplyAsShort(char a1) throws ParseException {
            return testValue;
        }
    };
    ...
    private LCharToShortFunction sutAlwaysThrowingUnckeck = LCharToShortFunction.l(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LCharSingle,Short,RuntimeException> theCall = sut;
...
@Test
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingCharToShortFunc().doApplyAsShort((char)100);
    }
    ...
    @Test void safeCompiles() {
        LCharToShortFunction r1 = LCharToShortFunction.safe(sut);
        LCharToShortFunctionX r2 = LCharToShortFunction.safe(sut);
    }
    ...
    @Test  void safeSupplierCompiles() {
        LSupplier<LCharToShortFunction> r1 = LCharToShortFunction.safeSupplier(()->sut);
    }
