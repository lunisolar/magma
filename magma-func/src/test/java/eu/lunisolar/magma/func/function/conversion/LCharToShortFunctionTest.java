...
public class LCharToShortFunctionTest<X extends ParseException> {
    ...
    private LCharToShortFunctionX<X> opposite = new LCharToShortFunctionX<X>(){
    ...
    private LCharToShortFunctionX<RuntimeException> sutAlwaysThrowingUnchecked = LCharToShortFunction.l(a1 -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LCharToShortFunction: short doApplyAsShort(char a1)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LCharToShortFunction.l(a1 -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LCharToShortFunctionX<ParseException> sutThrowing = LCharToShortFunctionX.lX(a1 -> {
    ...
    public void testHandlingDoApplyAsShortMethodWrapsTheException() throws X {
        ...
        // given
        LCharToShortFunction sutThrowing = LCharToShortFunction.l(a1 -> {
            throw new UnsupportedOperationException();
        });

        // when
        LCharToShortFunction wrapped = sutThrowing.handleCharToShortFunc(handler -> handler
    ...
    @Test
    public void testHandleCharToShortFuncMethodDoNotWrapsOtherExceptionIf() throws X {
...
@Test
    public void testHandleCharToShortFuncMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleCharToShortFuncMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LCharToShortFunction wrapped = sutThrowing.handleCharToShortFunc(h -> Function4U.doNothing());
    ...
    public void testCharToShortFuncComposeChar() throws X {
        ...
        //when
        LCharToShortFunction function = sutO.charToShortFuncComposeChar(before1);
    ...
    public void testCharToShortFuncCompose() throws X {
        ...
        //when
        LToShortFunction<Integer> function = sutO.charToShortFuncCompose(before1);
    ...
    public void testHandleCharToShortFunc() throws X {
        ...
        // when
        LCharToShortFunction wrapped = sutThrowing.handleCharToShortFunc(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LCharToShortFunction: short doApplyAsShort(char a1)");
    }
    ...
    @Test void safeCompiles() {
        LCharToShortFunction r1 = LCharToShortFunction.safe(sut); //NOSONAR
        LCharToShortFunctionX r2 = LCharToShortFunction.safe(sut); //NOSONAR
    }

    @Test void safePropagates() {
        Object result = LCharToShortFunction.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LCharToShortFunction.safe(null);
        assertThat(result).isSameAs(LCharToShortFunction.l(LCharToShortFunction.safe()));
    }

    @Test  void safeSupplierPropagates() {
        LSupplier<LCharToShortFunction> supplier = ()->sut;
        Object result = LCharToShortFunction.safeSupplier(supplier);
        assertThat(result).isSameAs(supplier);
    }

    @Test  void safeSupplierProtectsAgainstNpe() {
        Object result = LCharToShortFunction.safeSupplier(null);
        assertThat(result).isSameAs(LCharToShortFunction.safeSupplier());
    }

    @Test  void safeSupplierCompiles() {
        LSupplier<LCharToShortFunction> r1 = LCharToShortFunction.safeSupplier(()->sut);  //NOSONAR
    }
