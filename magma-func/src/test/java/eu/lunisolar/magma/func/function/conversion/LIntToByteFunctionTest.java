...
public class LIntToByteFunctionTest {
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LIntToByteFunction: byte applyAsByte(int a)");
    }

    @Test
    public void testIntToByteFuncMethod() throws Throwable {
        Assert.assertTrue(LIntToByteFunction.intToByteFunc(a -> testValue ) instanceof LIntToByteFunction);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LIntToByteFunction: byte applyAsByte(int a)"));
