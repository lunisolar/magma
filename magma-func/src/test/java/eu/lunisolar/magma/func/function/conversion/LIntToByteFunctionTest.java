...
public class LIntToByteFunctionTest<X extends ParseException> {
    ...
    private LIntToByteFunctionX<X> opposite = new LIntToByteFunctionX(){
        public  byte doApplyAsByte(int i) throws ParseException {
            return testValue;
        }
    };
    ...
    private LIntToByteFunction sutAlwaysThrowingUnckeck = LIntToByteFunction.l(i -> {
    ...
    public void testTheResult() throws X {
        assertThat(sut.doApplyAsByte((int)100))
            .isEqualTo(testValue);
    }

    @Test
    public void testNonNullDoApplyAsByte() throws X {
        assertThat(sut.nonNullDoApplyAsByte((int)100))
            .isEqualTo(testValue);
    }
    ...
    public void testNestingDoApplyAsByteUnckeck() throws X {
        ...
        // then
        try {
            sutAlwaysThrowingUnckeck.nestingDoApplyAsByte((int)100);
    ...
    public void testShovingDoApplyAsByteUnckeck() throws X {
        ...
        // then
        try {
            sutAlwaysThrowingUnckeck.shovingDoApplyAsByte((int)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
                    .isExactlyInstanceOf(IndexOutOfBoundsException.class)
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LIntToByteFunction: byte doApplyAsByte(int i)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LIntToByteFunction.l(i -> testValue ))
            .isInstanceOf(LIntToByteFunction.class);
    }

    @Test
    public void testWrapMethod() throws X {
        assertThat(LIntToByteFunction.wrap(opposite))
            .isInstanceOf(LIntToByteFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws X {
        // given
        LIntToByteFunctionX<X> sutThrowing = LIntToByteFunctionX.lX(i -> {
            throw new UnsupportedOperationException(ORIGINAL_MESSAGE);
        });

        // when
        LIntToByteFunction wrapped = LIntToByteFunction.wrap(sutThrowing);

        // then
        try {
            wrapped.doApplyAsByte((int)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LIntToByteFunctionX<ParseException> sutThrowing = LIntToByteFunctionX.lX(i -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LIntToByteFunction sutThrowing = LIntToByteFunction.l(i -> {
            throw new UnsupportedOperationException();
        });

        // when
        LIntToByteFunction wrapped = sutThrowing.handleIToBFunc(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LIntToByteFunction wrapped = sutThrowing.handleIToBFunc(h -> Function4U.doNothing());
    ...
    @Test
    public void testiToBFuncFromInt() throws X {

        final ThreadLocal<Boolean> mainFunctionCalled = ThreadLocal.withInitial(()-> false);
        final AtomicInteger beforeCalls = new AtomicInteger(0);

        //given (+ some assertions)
        LIntToByteFunction sutO = i -> {
        ...
        //when
        LIntToByteFunction function = sutO.iToBFuncFromInt(before1);
        function.doApplyAsByte((int)80);
    ...
    @Test
    public void testiToBFuncFrom() throws X {
        ...
        //when
        LToByteFunction<Integer > function = sutO.iToBFuncFrom(before1);
    ...
    public void testNesting() {
        assertThat(sut.nestingIToBFunc())
            .isSameAs(sut)
            .isInstanceOf(LIntToByteFunction.class);
    }
    ...
    public void testShoving() {
        assertThat(sut.shovingIToBFunc())
            .isSameAs(sut)
            .isInstanceOf(LIntToByteFunction.class);
    }
    ...
    public void testNestingX() {
        assertThat(sut.nestingIToBFuncX())
            .isSameAs(sut)
    ...
    public void testShovingX() {
        assertThat(sut.shovingIToBFuncX())
            .isSameAs(sut)
            .isInstanceOf(LIntToByteFunctionX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingIToBFunc().doApplyAsByte((int)100);
    }

    @Test
    public void testHandleIToBFunc() throws X {
        ...
        // when
        LIntToByteFunction wrapped = sutThrowing.handleIToBFunc(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LIntToByteFunction: byte doApplyAsByte(int i)");
    }
