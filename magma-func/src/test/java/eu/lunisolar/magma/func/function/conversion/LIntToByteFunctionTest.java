...
public class LIntToByteFunctionTest<X extends ParseException> {
    ...
    private LIntToByteFunction sut = new LIntToByteFunction(){
        public  byte doApplyAsByte(int a1)  {
            return testValue;
        }
    };

    private LIntToByteFunctionX<X> opposite = new LIntToByteFunctionX(){
        public  byte doApplyAsByte(int a1) throws ParseException {
            return testValue;
        }
    };
    ...
    private LIntToByteFunction sutAlwaysThrowingUnckeck = LIntToByteFunction.l(a1 -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LIntToByteFunction: byte doApplyAsByte(int a1)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LIntToByteFunction.l(a1 -> testValue ))
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws X {
        // given
        LIntToByteFunctionX<X> sutThrowing = LIntToByteFunctionX.lX(a1 -> {
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LIntToByteFunctionX<ParseException> sutThrowing = LIntToByteFunctionX.lX(a1 -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LIntToByteFunction sutThrowing = LIntToByteFunction.l(a1 -> {
            throw new UnsupportedOperationException();
        });

        // when
        LIntToByteFunction wrapped = sutThrowing.handleIntToByteFunc(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LIntToByteFunction wrapped = sutThrowing.handleIntToByteFunc(h -> Function4U.doNothing());
    ...
    public void testintToByteFuncComposeInt() throws X {
        ...
        //when
        LIntToByteFunction function = sutO.intToByteFuncComposeInt(before1);
    ...
    public void testintToByteFuncCompose() throws X {
        ...
        //when
        LToByteFunction<Integer > function = sutO.intToByteFuncCompose(before1);
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingIntToByteFunc().doApplyAsByte((int)100);
    }
    ...
    public void testHandleIntToByteFunc() throws X {
        ...
        // when
        LIntToByteFunction wrapped = sutThrowing.handleIntToByteFunc(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LIntToByteFunction: byte doApplyAsByte(int a1)");
    }
    ...
    @Test void safeProtectsAgainstNpe() {
        ...
        assertThat(result).isSameAs(LIntToByteFunction.l(LIntToByteFunction.safe()));
    }
