...
public class LToByteBiFunctionXTest<T1,T2,X extends ParseException> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LToByteBiFunctionX<T1,T2,X> wrapped = LToByteBiFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
...
//
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LToByteBiFunctionX<T1,T2,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
