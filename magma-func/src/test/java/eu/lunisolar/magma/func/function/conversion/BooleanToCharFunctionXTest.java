...
public class BooleanToCharFunctionXTest<X extends ParseException> {
    ...
    private BooleanToCharFunctionX<X> sut = new BooleanToCharFunctionX(){
        public  char applyAsChar(boolean b) throws ParseException {
            return testValue;
        }
    };

    private BooleanToCharFunction opposite = new BooleanToCharFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BooleanToCharFunctionX: char applyAsChar(boolean b) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(BooleanToCharFunctionX.lX((boolean b) -> testValue ))
            .isInstanceOf(BooleanToCharFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(BooleanToCharFunctionX.wrapX(opposite))
            .isInstanceOf(BooleanToCharFunctionX.class);
    }
    ...
    public void testfromBoolean() throws ParseException {
        ...
        BooleanToCharFunctionX<X> sutO = (boolean b) -> {
        ...
        //when
        BooleanToCharFunctionX<X> function = sutO.fromBoolean(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        BooleanToCharFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BooleanToCharFunctionX: char applyAsChar(boolean b) throws X");
    }
