...
public class LShortSupplierTest<X extends ParseException> {
    ...
    private LShortSupplierX<X> opposite = new LShortSupplierX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LShortSupplier: short getAsShort()");
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LShortSupplier wrapped = LShortSupplier.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LShortSupplier.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LShortSupplierX.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LShortSupplier wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LShortSupplier: short getAsShort()");
    }
