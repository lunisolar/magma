...
public class LBiObjFloatFunctionXTest<T1,T2,R,X extends ParseException> {
    ...
    private LBiObjFloatFunctionX<Integer,Integer,Integer,X> sut = new LBiObjFloatFunctionX<Integer,Integer,Integer,X>(){
        public @Nullable Integer doApply(Integer a1,Integer a2,float a3)  throws X {
            return testValue;
        }
    };

    private LBiObjFloatFunction<Integer,Integer,Integer> opposite = new LBiObjFloatFunction<Integer,Integer,Integer>(){
        public @Nullable Integer doApply(Integer a1,Integer a2,float a3)  {
            return testValue;
        }
    };

    private LBiObjFloatFunctionX<Integer,Integer,Integer,X> sutNull = new LBiObjFloatFunctionX<Integer,Integer,Integer,X>(){
        public @Nullable Integer doApply(Integer a1,Integer a2,float a3)  throws X {
            return null;
        }
    };
    ...
    private LBiObjFloatFunctionX<Integer,Integer,Integer,ParseException> sutAlwaysThrowing = LBiObjFloatFunctionX.lX((a1,a2,a3) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiObjFloatFunctionX<Integer,Integer,Integer,RuntimeException> sutAlwaysThrowingUnchecked = LBiObjFloatFunctionX.lX((a1,a2,a3) -> {
    ...
    public void testNestingDoApplyChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoApply(100,100,100f);
    ...
    public void testShovingDoApplyChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoApply(100,100,100f);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testLXMethod() throws X {
        assertThat(LBiObjFloatFunctionX.lX((a1,a2,a3) -> testValue ))
    ...
    public void testHandlingDoApplyMethodWrapsTheException() throws X {
        ...
        // when
        LBiObjFloatFunctionX<Integer,Integer,Integer,RuntimeException> wrapped = sutThrowing.handleBiObjFloatFuncX(handler -> handler
    ...
    @Test
    public void testHandleBiObjFloatFuncXMethodDoNotWrapsOtherExceptionIf() throws X {
        ...
        // when
        LBiObjFloatFunctionX<Integer,Integer,Integer,X> wrapped = sutThrowing.handleBiObjFloatFuncX(handler -> handler
                .wrapIf(UnsupportedOperationException.class::isInstance,IllegalArgumentException::new,  EXCEPTION_WAS_WRAPPED)
...
@Test
    public void testHandleBiObjFloatFuncXMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleBiObjFloatFuncXMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBiObjFloatFunctionX<Integer,Integer,Integer,X> wrapped = sutThrowing.handleBiObjFloatFuncX(h -> Function4U.doNothing());
    ...
    public void testBiObjFloatFuncComposeFloat() throws X {
        ...
        LBiObjFloatFunctionX<Integer,Integer,Integer,X> sutO = (a1,a2,a3) -> {
    ...
    public void testHandleBiObjFloatFunc() throws X {
        ...
        // when
        LBiObjFloatFunctionX<Integer,Integer,Integer,X> wrapped = sutThrowing.handleBiObjFloatFuncX(h -> {
    ...
    public void compilerSubstituteVariantV1() {
        LBiObjFloatFunctionX lambda = LBiObjFloatFunctionX./*<T1,T2,R,X>*/lX1(this::variantV1);
    ...
    public void compilerSubstituteVariantV2() {
        LBiObjFloatFunctionX lambda = LBiObjFloatFunctionX./*<T1,T2,R,X>*/lX2(this::variantV2);
    ...
    public void compilerSubstituteVariantV3() {
        LBiObjFloatFunctionX lambda = LBiObjFloatFunctionX./*<T1,T2,R,X>*/lX3(this::variantV3);
    ...
    public void compilerSubstituteVariantV4() {
        LBiObjFloatFunctionX lambda = LBiObjFloatFunctionX./*<T1,T2,R,X>*/lX4(this::variantV4);
    ...
    public void compilerSubstituteVariantV5() {
        LBiObjFloatFunctionX lambda = LBiObjFloatFunctionX./*<T1,T2,R,X>*/lX5(this::variantV5);
    ...
    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LBiObjFloatFunctionX<Integer,Integer,Integer,X>,Y> supplier = ()->sut;
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LBiObjFloatFunctionX<Integer,Integer,Integer,X>,Y> r1 = LBiObjFloatFunctionX.safeSupplier(()->sut);  //NOSONAR
    }
