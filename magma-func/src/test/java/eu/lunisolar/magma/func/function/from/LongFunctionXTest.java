...
public class LongFunctionXTest<R,X extends ParseException> {
    ...
    private LongFunctionX<R,X> sut = new LongFunctionX(){
        public @Nullable Object  apply(long l) throws ParseException {
            return testValue;
        }
    };

    private LongFunction<R> opposite = new LongFunction(){
        public @Nullable Object  apply(long l)  {
            return testValue;
        }
    };

    private LongFunctionX<R,X> sutNull = new LongFunctionX(){
        public @Nullable Object  apply(long l) throws ParseException {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (LongFunctionX: R apply(long l) throws X).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LongFunctionX: R apply(long l) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(LongFunctionX.lX((long l) -> testValue ))
            .isInstanceOf(LongFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(LongFunctionX.wrapX(opposite))
            .isInstanceOf(LongFunctionX.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(LongFunctionX.wrapStd(jre))
            .isInstanceOf(LongFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LongFunctionX<R,X> wrapped = LongFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromLong() throws ParseException {
        ...
        LongFunctionX<Integer ,X> sutO = (long l) -> {
        ...
        //when
        LongFunctionX<Integer ,X> function = sutO.fromLong(before1);
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        LongConsumerX<X> function = sutO.then(thenFunction);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LongFunctionX<R,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LongFunctionX: R apply(long l) throws X");
    }
