...
public class BooleanTriConsumerXTest<X extends ParseException> {
    ...
    private BooleanTriConsumerX<X> sut = new BooleanTriConsumerX(){
        public  void accept(boolean b1,boolean b2,boolean b3) throws ParseException {
            Function4U.doNothing();
        }
    };

    private BooleanTriConsumer opposite = new BooleanTriConsumer(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BooleanTriConsumerX: void accept(boolean b1,boolean b2,boolean b3) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(BooleanTriConsumerX.lX((boolean b1,boolean b2,boolean b3) -> Function4U.doNothing() ))
            .isInstanceOf(BooleanTriConsumerX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(BooleanTriConsumerX.wrapX(opposite))
            .isInstanceOf(BooleanTriConsumerX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        BooleanTriConsumerX<X> wrapped = BooleanTriConsumerX.wrapException(sutThrowing, UnsupportedOperationException.class, t -> {
    ...
    public void testfromBoolean() throws ParseException {
        ...
        BooleanTriConsumerX<X> sutO = (boolean b1,boolean b2,boolean b3) -> {
        ...
        //when
        BooleanTriConsumerX<X> function = sutO.fromBoolean(before1,before2,before3);
    ...
    public void testAndThen() throws ParseException {
        ...
        BooleanTriConsumerX<X> thenFunction = (boolean b1,boolean b2,boolean b3) -> {
        ...
        //when
        BooleanTriConsumerX<X> function = sutO.andThen(thenFunction);
        function.accept(true,true,true);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        BooleanTriConsumerX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BooleanTriConsumerX: void accept(boolean b1,boolean b2,boolean b3) throws X");
    }
