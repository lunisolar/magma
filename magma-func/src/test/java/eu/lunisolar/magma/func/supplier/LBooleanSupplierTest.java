...
public class LBooleanSupplierTest<X extends ParseException> {
    ...
    private LBooleanSupplier sut = new LBooleanSupplier(){
        public  boolean doGetAsBoolean()  {
            return testValue;
        }
    };

    private LBooleanSupplierX<X> opposite = new LBooleanSupplierX(){
        public  boolean doGetAsBoolean() throws ParseException {
            return testValue;
        }
    };
    ...
    private LBooleanSupplier sutAlwaysThrowingUnckeck = LBooleanSupplier.l(() -> {
    ...
    @Test
    public void testNonNullDoGetAsBoolean() throws X {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBooleanSupplier: boolean doGetAsBoolean()");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LBooleanSupplier.l(() -> testValue ))
            .isInstanceOf(LBooleanSupplier.class);
    }

    @Test
    public void testWrapMethod() throws X {
        assertThat(LBooleanSupplier.wrap(opposite))
            .isInstanceOf(LBooleanSupplier.class);
    }

    @Test
    public void testWrapStdMethod() throws X {
        assertThat(LBooleanSupplier.wrap(jre))
            .isInstanceOf(LBooleanSupplier.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws X {
        ...
        // when
        LBooleanSupplier wrapped = LBooleanSupplier.wrap(sutThrowing);

        // then
        try {
            wrapped.doGetAsBoolean();
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LBooleanSupplierX<ParseException> sutThrowing = LBooleanSupplierX.lX(() -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // when
        LBooleanSupplier wrapped = sutThrowing.handleBoolSup(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBooleanSupplier wrapped = sutThrowing.handleBoolSup(h -> Function4U.doNothing());
    ...
    public void testHandleBoolSup() throws X {
        ...
        // when
        LBooleanSupplier wrapped = sutThrowing.handleBoolSup(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBooleanSupplier: boolean doGetAsBoolean()");
    }
