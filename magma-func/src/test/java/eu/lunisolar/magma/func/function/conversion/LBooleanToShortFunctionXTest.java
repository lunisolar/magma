...
public class LBooleanToShortFunctionXTest<X extends ParseException> {
    ...
    private LBooleanToShortFunctionX<ParseException> sutAlwaysThrowing = LBooleanToShortFunctionX.lX(b -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBooleanToShortFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LBooleanToShortFunctionX.lX(b -> {
    ...
    public void testLXMethod() throws X {
        assertThat(LBooleanToShortFunctionX.lX(b -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // when
        LBooleanToShortFunctionX<X> wrapped = sutThrowing.handleX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBooleanToShortFunctionX<X> wrapped = sutThrowing.handleX(h -> Function4U.doNothing());
    ...
    public void testfromBoolean() throws X {
        ...
        LBooleanToShortFunctionX<X> sutO = b -> {
    ...
    public void testHandle() throws X {
        ...
        // when
        LBooleanToShortFunctionX<X> wrapped = sutThrowing.handleX(h -> {
