...
public class LToByteBiFunctionTest<T1,T2,X extends ParseException> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LToByteBiFunction<T1,T2> wrapped = LToByteBiFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfrom() throws ParseException {
        ...
        //when
        LToByteBiFunction<Integer ,Integer > function = sutO.from(before1,before2);
...
//
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LToByteBiFunction<T1,T2> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
