...
public class LToByteBiFunctionTest<T1,T2> {
    ...
    public void testTheResult() throws Throwable {
        assertThat(sut.applyAsByte(100,100))
            .isEqualTo(testValue);
    }
    ...
    public void testNonNullApplyAsByte() throws Throwable {
        assertThat(sut.nonNullApplyAsByte(100,100))
            .isEqualTo(testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LToByteBiFunction: byte applyAsByte(T1 a1,T2 a2)");
    }

    @Test
    public void testToByteBiFuncMethod() throws Throwable {
        assertThat(LToByteBiFunction.toByteBiFunc((a1,a2) -> testValue ))
    ...
    public void testToString() throws Throwable {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LToByteBiFunction: byte applyAsByte(T1 a1,T2 a2)");
    }
    ...
    public void compilerSubstituteVariantLToByteObj1Obj0Func() {
        ...
        assertThat(lambda).isInstanceOf(LToByteBiFunction.LToByteObj1Obj0Func.class);
    }
