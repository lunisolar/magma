...
public class LToByteBiFunctionTest<T1,T2> {
    ...
    private LToByteBiFunction<Integer,Integer> sut = new LToByteBiFunction<Integer,Integer>(){
        public  byte applyAsByteX(Integer a1,Integer a2)  {
            return testValue;
        }
    };
    ...
    private LToByteBiFunction<Integer,Integer> sutAlwaysThrowing = LToByteBiFunction.toByteBiFunc((a1,a2) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LToByteBiFunction<Integer,Integer> sutAlwaysThrowingUnchecked = LToByteBiFunction.toByteBiFunc((a1,a2) -> {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.applyAsByte(100,100), testValue);
    }
    ...
    public void testNonNullApplyAsByte() throws Throwable {
            Assert.assertEquals(sut.nonNullApplyAsByte(100,100), testValue);
    }
    ...
    public void testNestingApplyAsByteUnchecked() throws Throwable {
        ...
        // then
        try {
            sutAlwaysThrowingUnchecked.nestingApplyAsByte(100,100);
    ...
    public void testShovingApplyAsByteUnchecked() throws Throwable {
        ...
        // then
        try {
            sutAlwaysThrowingUnchecked.shovingApplyAsByte(100,100);
            Assert.fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            Assert.assertEquals(e.getClass(), IndexOutOfBoundsException.class);
            Assert.assertNull(e.getCause());
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LToByteBiFunction: byte applyAsByte(T1 a1,T2 a2)");
    }

    @Test
    public void testToByteBiFuncMethod() throws Throwable {
        Assert.assertTrue(LToByteBiFunction.toByteBiFunc((a1,a2) -> testValue ) instanceof LToByteBiFunction);
    ...
    public void testCompose() throws Throwable {
        ...
        //when
        LToByteBiFunction<Integer,Integer> function = sutO.compose(before1,before2);
    ...
    public void testShove() {
        ...
        // given
        LToByteBiFunction<Integer,Integer> sutThrowing = LToByteBiFunction.toByteBiFunc((a1,a2) -> {
            throw new UnsupportedOperationException();
        });

        // when
        sutThrowing.shovingApplyAsByte(100,100);
    }
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LToByteBiFunction: byte applyAsByte(T1 a1,T2 a2)"));
