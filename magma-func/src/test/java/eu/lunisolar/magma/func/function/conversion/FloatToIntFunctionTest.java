...
public class FloatToIntFunctionTest<X extends ParseException> {
    ...
    private FloatToIntFunction sut = new FloatToIntFunction(){
        public  int applyAsInt(float f)  {
            return testValue;
        }
    };

    private FloatToIntFunctionX<X> opposite = new FloatToIntFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("FloatToIntFunction: int applyAsInt(float f)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(FloatToIntFunction.l((float f) -> testValue ))
            .isInstanceOf(FloatToIntFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(FloatToIntFunction.wrap(opposite))
            .isInstanceOf(FloatToIntFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        FloatToIntFunction wrapped = FloatToIntFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        FloatToIntFunctionX<ParseException> sutThrowing = FloatToIntFunctionX.lX((float f) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        FloatToIntFunction sutThrowing = FloatToIntFunction.l((float f) -> {
            throw new UnsupportedOperationException();
        });

        // when
        FloatToIntFunction wrapped = FloatToIntFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromFloat() throws ParseException {
        ...
        FloatToIntFunction sutO = (float f) -> {
        ...
        //when
        FloatToIntFunction function = sutO.fromFloat(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(FloatToIntFunction.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        FloatToIntFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("FloatToIntFunction: int applyAsInt(float f)");
    }
