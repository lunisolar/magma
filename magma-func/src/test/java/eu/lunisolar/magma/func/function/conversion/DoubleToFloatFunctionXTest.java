...
public class DoubleToFloatFunctionXTest<X extends ParseException> {
    ...
    private DoubleToFloatFunctionX<X> sut = new DoubleToFloatFunctionX(){
        public  float applyAsFloat(double d) throws ParseException {
            return testValue;
        }
    };

    private DoubleToFloatFunction opposite = new DoubleToFloatFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("DoubleToFloatFunctionX: float applyAsFloat(double d) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(DoubleToFloatFunctionX.lX((double d) -> testValue ))
            .isInstanceOf(DoubleToFloatFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(DoubleToFloatFunctionX.wrapX(opposite))
            .isInstanceOf(DoubleToFloatFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        DoubleToFloatFunctionX<X> wrapped = DoubleToFloatFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromDouble() throws ParseException {
        ...
        DoubleToFloatFunctionX<X> sutO = (double d) -> {
        ...
        //when
        DoubleToFloatFunctionX<X> function = sutO.fromDouble(before1);
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().applyAsFloat((double)100);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        DoubleToFloatFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("DoubleToFloatFunctionX: float applyAsFloat(double d) throws X");
    }
