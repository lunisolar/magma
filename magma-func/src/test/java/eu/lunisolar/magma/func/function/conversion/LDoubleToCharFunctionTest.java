...
public class LDoubleToCharFunctionTest<X extends ParseException> {
    ...
    private LDoubleToCharFunctionX<X> opposite = new LDoubleToCharFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LDoubleToCharFunction: char doApplyAsChar(double d)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LDoubleToCharFunction.l((double d) -> testValue ))
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        // given
        LDoubleToCharFunctionX<X> sutThrowing = LDoubleToCharFunctionX.lX((double d) -> {
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LDoubleToCharFunctionX<ParseException> sutThrowing = LDoubleToCharFunctionX.lX((double d) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LDoubleToCharFunction sutThrowing = LDoubleToCharFunction.l((double d) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LDoubleToCharFunction wrapped = LDoubleToCharFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromDouble() throws ParseException {
        ...
        LDoubleToCharFunction sutO = (double d) -> {
        ...
        //when
        LDoubleToCharFunction function = sutO.fromDouble(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LDoubleToCharFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LDoubleToCharFunctionX.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LDoubleToCharFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LDoubleToCharFunction: char doApplyAsChar(double d)");
    }
