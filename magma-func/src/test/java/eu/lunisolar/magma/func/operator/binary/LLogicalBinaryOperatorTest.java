...
public class LLogicalBinaryOperatorTest<X extends ParseException> {
    ...
    private LLogicalBinaryOperator sut = new LLogicalBinaryOperator(){
        public  boolean doApply(boolean b1,boolean b2)  {
            return testValue;
        }
    };

    private LLogicalBinaryOperatorX<X> opposite = new LLogicalBinaryOperatorX(){
        public  boolean doApply(boolean b1,boolean b2) throws ParseException {
            return testValue;
        }
    };
    ...
    private LLogicalBinaryOperator sutAlwaysThrowingUnckeck = LLogicalBinaryOperator.l((boolean b1,boolean b2) -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LLogicalBinaryOperator: boolean doApply(boolean b1,boolean b2)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LLogicalBinaryOperator.l((boolean b1,boolean b2) -> testValue ))
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws X {
        // given
        LLogicalBinaryOperatorX<X> sutThrowing = LLogicalBinaryOperatorX.lX((boolean b1,boolean b2) -> {
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LLogicalBinaryOperatorX<ParseException> sutThrowing = LLogicalBinaryOperatorX.lX((boolean b1,boolean b2) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LLogicalBinaryOperator sutThrowing = LLogicalBinaryOperator.l((boolean b1,boolean b2) -> {
...
@Test
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws X {
        ...
        //given
        LLogicalBinaryOperator fun1 = LLogicalBinaryOperator.l((boolean b1,boolean b2) -> f1Result);
        LLogicalBinaryOperator fun2 = LLogicalBinaryOperator.l((boolean b1,boolean b2) -> f2Result);
    ...
    public void testlogicalBinaryOpFromBoolean() throws X {
        ...
        LLogicalBinaryOperator sutO = (boolean b1,boolean b2) -> {
        ...
        //when
        LLogicalBinaryOperator function = sutO.logicalBinaryOpFromBoolean(before1,before2);
    ...
    public void testlogicalBinaryOpFrom() throws X {
        ...
        //when
        LBiPredicate<Integer ,Integer > function = sutO.logicalBinaryOpFrom(before1,before2);
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LLogicalBinaryOperator: boolean doApply(boolean b1,boolean b2)");
    }
