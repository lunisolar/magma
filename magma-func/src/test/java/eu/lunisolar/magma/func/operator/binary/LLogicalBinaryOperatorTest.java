...
public class LLogicalBinaryOperatorTest<X extends ParseException> {
    ...
    private LLogicalBinaryOperatorX<X> opposite = new LLogicalBinaryOperatorX<X>(){
    ...
    private LLogicalBinaryOperatorX<RuntimeException> sutAlwaysThrowingUnchecked = LLogicalBinaryOperator.l((a1,a2) -> {
    ...
    public void testLMethod() throws X {
        assertThat(LLogicalBinaryOperator.l((a1,a2) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LLogicalBinaryOperatorX<ParseException> sutThrowing = LLogicalBinaryOperatorX.lX((a1,a2) -> {
    ...
    public void testHandlingDoApplyMethodWrapsTheException() throws X {
        ...
        // given
        LLogicalBinaryOperator sutThrowing = LLogicalBinaryOperator.l((a1,a2) -> {
    ...
    @Test
    public void testHandleLogicalBinaryOpMethodDoNotWrapsOtherExceptionIf() throws X {
...
@Test
    public void testHandleLogicalBinaryOpMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleLogicalBinaryOpMishandlingExceptionIsAllowed() throws X {
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws X {
        ...
        //given
        LLogicalBinaryOperator fun1 = LLogicalBinaryOperator.l((a1,a2) -> f1Result);
        LLogicalBinaryOperator fun2 = LLogicalBinaryOperator.l((a1,a2) -> f2Result);
