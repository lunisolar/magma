...
public class DoubleUnaryOperatorXTest<X extends ParseException> {
    ...
    public void testStdMethod() throws ParseException {
        assertThat(DoubleUnaryOperatorX.std(jre))
            .isInstanceOf(DoubleUnaryOperatorX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        DoubleUnaryOperatorX<X> wrapped = DoubleUnaryOperatorX.wrapException(sutThrowing, UnsupportedOperationException.class, t -> {
