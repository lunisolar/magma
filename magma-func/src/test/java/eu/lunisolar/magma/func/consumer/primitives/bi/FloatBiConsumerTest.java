...
public class FloatBiConsumerTest<X extends ParseException> {
    ...
    private FloatBiConsumer sut = new FloatBiConsumer(){
        public  void accept(float f1,float f2)  {
            Function4U.doNothing();
        }
    };

    private FloatBiConsumerX<X> opposite = new FloatBiConsumerX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("FloatBiConsumer: void accept(float f1,float f2)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(FloatBiConsumer.l((float f1,float f2) -> Function4U.doNothing() ))
            .isInstanceOf(FloatBiConsumer.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(FloatBiConsumer.wrap(opposite))
            .isInstanceOf(FloatBiConsumer.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        FloatBiConsumer wrapped = FloatBiConsumer.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        FloatBiConsumerX<ParseException> sutThrowing = FloatBiConsumerX.lX((float f1,float f2) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        FloatBiConsumer wrapped = FloatBiConsumer.wrapException(sutThrowing, UnsupportedOperationException.class, t -> {
    ...
    public void testfromFloat() throws ParseException {
        ...
        FloatBiConsumer sutO = (float f1,float f2) -> {
        ...
        //when
        FloatBiConsumer function = sutO.fromFloat(before1,before2);
    ...
    public void testAndThen() throws ParseException {
        ...
        FloatBiConsumer thenFunction = (float f1,float f2) -> {
        ...
        //when
        FloatBiConsumer function = sutO.andThen(thenFunction);
        function.accept((float)80,(float)81);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        FloatBiConsumer wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("FloatBiConsumer: void accept(float f1,float f2)");
    }
