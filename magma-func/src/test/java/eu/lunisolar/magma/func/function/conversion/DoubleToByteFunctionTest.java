...
public class DoubleToByteFunctionTest<X extends ParseException> {
    ...
    private DoubleToByteFunction sut = new DoubleToByteFunction(){
        public  byte applyAsByte(double d)  {
            return testValue;
        }
    };

    private DoubleToByteFunctionX<X> opposite = new DoubleToByteFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("DoubleToByteFunction: byte applyAsByte(double d)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(DoubleToByteFunction.l((double d) -> testValue ))
            .isInstanceOf(DoubleToByteFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(DoubleToByteFunction.wrap(opposite))
            .isInstanceOf(DoubleToByteFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        DoubleToByteFunction wrapped = DoubleToByteFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        DoubleToByteFunctionX<ParseException> sutThrowing = DoubleToByteFunctionX.lX((double d) -> {
    ...
    public void testfromDouble() throws ParseException {
        ...
        DoubleToByteFunction sutO = (double d) -> {
        ...
        //when
        DoubleToByteFunction function = sutO.fromDouble(before1);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        DoubleToByteFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("DoubleToByteFunction: byte applyAsByte(double d)");
    }
