...
public class LLongToDoubleFunctionTest<X extends ParseException> {
    ...
    private LLongToDoubleFunctionX<X> opposite = new LLongToDoubleFunctionX(){
        public  double applyAsDouble(long l) throws ParseException {
            return testValue;
        }
    };
    ...
    public void testTheResult() throws ParseException {
        assertThat(sut.applyAsDouble((long)100))
            .isEqualTo(testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LLongToDoubleFunction: double applyAsDouble(long l)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LLongToDoubleFunction.l((long l) -> testValue ))
    ...
    public void testWrapStdMethod() throws ParseException {
        assertThat(LLongToDoubleFunction.wrapStd(jre))
            .isInstanceOf(LLongToDoubleFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // then
        try {
            wrapped.applyAsDouble((long)100);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LLongToDoubleFunctionX<ParseException> sutThrowing = LLongToDoubleFunctionX.lX((long l) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LLongToDoubleFunction sutThrowing = LLongToDoubleFunction.l((long l) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LLongToDoubleFunction wrapped = LLongToDoubleFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromLong() throws ParseException {
        ...
        LLongToDoubleFunction sutO = (long l) -> {
        ...
        //when
        LLongToDoubleFunction function = sutO.fromLong(before1);
        function.applyAsDouble((long)80);
    ...
    @Test
    public void testStd() {
        assertThat(sut.std()).isInstanceOf(java.util.function.LongToDoubleFunction.class);
    }

    @Test
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LLongToDoubleFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LLongToDoubleFunctionX.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LLongToDoubleFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LLongToDoubleFunction: double applyAsDouble(long l)");
    }
