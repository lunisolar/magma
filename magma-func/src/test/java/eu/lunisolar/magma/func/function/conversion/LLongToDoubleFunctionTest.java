...
public class LLongToDoubleFunctionTest<X extends ParseException> {
    ...
    private LLongToDoubleFunction sut = new LLongToDoubleFunction(){
        public  double doApplyAsDouble(long l)  {
            return testValue;
        }
    };

    private LLongToDoubleFunctionX<X> opposite = new LLongToDoubleFunctionX(){
    ...
    private java.util.function.LongToDoubleFunction jre = l -> testValue;



    private LLongToDoubleFunction sutAlwaysThrowingUnckeck = LLongToDoubleFunction.l(l -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LLongToDoubleFunction: double doApplyAsDouble(long l)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LLongToDoubleFunction.l(l -> testValue ))
            .isInstanceOf(LLongToDoubleFunction.class);
    }

    @Test
    public void testWrapMethod() throws X {
        assertThat(LLongToDoubleFunction.wrap(opposite))
            .isInstanceOf(LLongToDoubleFunction.class);
    }

    @Test
    public void testWrapStdMethod() throws X {
        assertThat(LLongToDoubleFunction.wrap(jre))
            .isInstanceOf(LLongToDoubleFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws X {
        // given
        LLongToDoubleFunctionX<X> sutThrowing = LLongToDoubleFunctionX.lX(l -> {
            throw new UnsupportedOperationException(ORIGINAL_MESSAGE);
        });

        // when
        LLongToDoubleFunction wrapped = LLongToDoubleFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LLongToDoubleFunctionX<ParseException> sutThrowing = LLongToDoubleFunctionX.lX(l -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LLongToDoubleFunction sutThrowing = LLongToDoubleFunction.l(l -> {
            throw new UnsupportedOperationException();
        });

        // when
        LLongToDoubleFunction wrapped = sutThrowing.handleLongToDFunc(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LLongToDoubleFunction wrapped = sutThrowing.handleLongToDFunc(h -> Function4U.doNothing());
    ...
    @Test
    public void testlongToDFuncFromLong() throws X {

        final ThreadLocal<Boolean> mainFunctionCalled = ThreadLocal.withInitial(()-> false);
        final AtomicInteger beforeCalls = new AtomicInteger(0);

        //given (+ some assertions)
        LLongToDoubleFunction sutO = l -> {
        ...
        //when
        LLongToDoubleFunction function = sutO.longToDFuncFromLong(before1);
    ...
    @Test
    public void testlongToDFuncFrom() throws X {
        ...
        //when
        LToDoubleFunction<Integer > function = sutO.longToDFuncFrom(before1);
    ...
    public void testNesting() {
        assertThat(sut.nestingLongToDFunc())
            .isSameAs(sut)
            .isInstanceOf(LLongToDoubleFunction.class);
    }
    ...
    public void testShoving() {
        assertThat(sut.shovingLongToDFunc())
            .isSameAs(sut)
            .isInstanceOf(LLongToDoubleFunction.class);
    }
    ...
    public void testNestingX() {
        assertThat(sut.nestingLongToDFuncX())
            .isSameAs(sut)
    ...
    public void testShovingX() {
        assertThat(sut.shovingLongToDFuncX())
            .isSameAs(sut)
            .isInstanceOf(LLongToDoubleFunctionX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingLongToDFunc().doApplyAsDouble((long)100);
    }

    @Test
    public void testHandleLongToDFunc() throws X {
        ...
        // when
        LLongToDoubleFunction wrapped = sutThrowing.handleLongToDFunc(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LLongToDoubleFunction: double doApplyAsDouble(long l)");
    }
