...
public class LBiIntPredicateXTest<X extends ParseException> {
    ...
    private LBiIntPredicateX<X> sut = new LBiIntPredicateX<X>(){
    ...
    private LBiIntPredicateX<ParseException> sutAlwaysThrowing = LBiIntPredicateX.lX((a1,a2) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiIntPredicateX<RuntimeException> sutAlwaysThrowingUnchecked = LBiIntPredicateX.lX((a1,a2) -> {
    ...
    public void testLXMethod() throws X {
        assertThat(LBiIntPredicateX.lX((a1,a2) -> testValue ))
    ...
    public void testHandlingDoTestMethodWrapsTheException() throws X {
        ...
        // when
        LBiIntPredicateX<RuntimeException> wrapped = sutThrowing.handleBiIntPredX(handler -> handler
    ...
    @Test
    public void testHandleBiIntPredXMethodDoNotWrapsOtherExceptionIf() throws X {
...
@Test
    public void testHandleBiIntPredXMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleBiIntPredXMishandlingExceptionIsAllowed() throws X {
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws X {
        ...
        //given
        LBiIntPredicateX<X> fun1 = LBiIntPredicateX.lX((a1,a2) -> f1Result);
        LBiIntPredicateX<X> fun2 = LBiIntPredicateX.lX((a1,a2) -> f2Result);
    ...
    public void testIsEqual() throws X  {
        //when
        LBiIntPredicateX<X> equals = LBiIntPredicateX.isEqual(1,1);
    ...
    public void testBoolToBiIntFunc0() throws X  {
        ...
        //when
        LBiIntFunctionX<Integer,X> function = sutO.boolToBiIntFunc(thenFunction);
    ...
    public void compilerSubstituteVariantV1() {
        LBiIntPredicateX lambda = LBiIntPredicateX./*<X>*/lX1(this::variantV1);
