...
public class ShortSupplierTest<X extends ParseException> {
    ...
    private ShortSupplier sut = new ShortSupplier(){
        public  short getAsShort()  {
            return testValue;
        }
    };

    private ShortSupplierX<X> opposite = new ShortSupplierX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ShortSupplier: short getAsShort()");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(ShortSupplier.l(() -> testValue ))
            .isInstanceOf(ShortSupplier.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(ShortSupplier.wrap(opposite))
            .isInstanceOf(ShortSupplier.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        ShortSupplier wrapped = ShortSupplier.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        ShortSupplierX<ParseException> sutThrowing = ShortSupplierX.lX(() -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        ShortSupplier sutThrowing = ShortSupplier.l(() -> {
            throw new UnsupportedOperationException();
        });

        // when
        ShortSupplier wrapped = ShortSupplier.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ShortSupplier wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ShortSupplier: short getAsShort()");
    }
