...
public class LDoubleToLongFunctionXTest<X extends ParseException> {
    ...
    private LDoubleToLongFunctionX<ParseException> sutAlwaysThrowing = LDoubleToLongFunctionX.lX(a1 -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LDoubleToLongFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LDoubleToLongFunctionX.lX(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LDoubleSingle,Long,X> theCall = sut;
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LDoubleToLongFunctionX: long doApplyAsLong(double a1) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LDoubleToLongFunctionX.lX(a1 -> testValue ))
...
@Test
    ...
    public void testdoubleToLongFuncComposeDouble() throws X {
        ...
        LDoubleToLongFunctionX<X> sutO = a1 -> {
        ...
        //when
        LDoubleToLongFunctionX<X> function = sutO.doubleToLongFuncComposeDouble(before1);
    ...
    public void testdoubleToLongFuncCompose() throws X {
        ...
        //when
        LToLongFunctionX<Integer ,X> function = sutO.doubleToLongFuncCompose(before1);
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LDoubleToLongFunctionX: long doApplyAsLong(double a1) throws X");
    }
    ...
    @Test void safeCompiles() {
        LDoubleToLongFunctionX r1 = LDoubleToLongFunctionX.safe(sut);
        DoubleToLongFunction r3 = LDoubleToLongFunctionX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LDoubleToLongFunctionX<X>,Y> r1 = LDoubleToLongFunctionX.safeSupplier(()->sut);
        Supplier<LDoubleToLongFunctionX<X>> r2 = LDoubleToLongFunctionX.safeSupplier(()->sut);
    }
