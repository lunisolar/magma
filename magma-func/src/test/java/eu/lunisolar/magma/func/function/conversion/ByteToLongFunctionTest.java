...
public class ByteToLongFunctionTest<X extends ParseException> {
    ...
    private ByteToLongFunction sut = new ByteToLongFunction(){
        public  long applyAsLong(byte b)  {
            return testValue;
        }
    };

    private ByteToLongFunctionX<X> opposite = new ByteToLongFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ByteToLongFunction: long applyAsLong(byte b)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(ByteToLongFunction.l((byte b) -> testValue ))
            .isInstanceOf(ByteToLongFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(ByteToLongFunction.wrap(opposite))
            .isInstanceOf(ByteToLongFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        ByteToLongFunction wrapped = ByteToLongFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        ByteToLongFunctionX<ParseException> sutThrowing = ByteToLongFunctionX.lX((byte b) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        ByteToLongFunction sutThrowing = ByteToLongFunction.l((byte b) -> {
            throw new UnsupportedOperationException();
        });

        // when
        ByteToLongFunction wrapped = ByteToLongFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        ByteToLongFunction sutO = (byte b) -> {
        ...
        //when
        ByteToLongFunction function = sutO.fromByte(before1);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ByteToLongFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ByteToLongFunction: long applyAsLong(byte b)");
    }
