...
public class LLongFunctionXTest<R,X extends ParseException> {
    ...
    private LLongFunctionX<Integer,X> sut = new LLongFunctionX<Integer,X>(){
        public @Nullable Integer doApply(long a)  throws X {
            return testValue;
        }
    };

    private LLongFunction<Integer> opposite = new LLongFunction<Integer>(){
        public @Nullable Integer doApply(long a)  {
            return testValue;
        }
    };

    private LLongFunctionX<Integer,X> sutNull = new LLongFunctionX<Integer,X>(){
        public @Nullable Integer doApply(long a)  throws X {
            return null;
        }
    };
    ...
    private LongFunction<Integer> jre = a -> testValue;


    private LLongFunctionX<Integer,ParseException> sutAlwaysThrowing = LLongFunctionX.lX(a -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LLongFunctionX<Integer,RuntimeException> sutAlwaysThrowingUnchecked = LLongFunctionX.lX(a -> {
    ...
    public void testNestingDoApplyChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoApply(100L);
    ...
    public void testShovingDoApplyChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoApply(100L);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNullDoApply() method cannot be null (LLongFunctionX: R doApply(long a) throws X).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LLongFunctionX: R doApply(long a) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LLongFunctionX.lX(a -> testValue ))
    ...
    public void testHandlingDoApplyMethodWrapsTheException() throws X {
        ...
        // given
        LLongFunctionX<Integer,X> sutThrowing = LLongFunctionX.lX(a -> {
            throw new UnsupportedOperationException();
        });

        // when
        LLongFunctionX<Integer,RuntimeException> wrapped = sutThrowing.handleLongFuncX(handler -> handler
            .wrapIf(UnsupportedOperationException.class::isInstance,IllegalArgumentException::new,  EXCEPTION_WAS_WRAPPED));

        // then
        try {
            wrapped.doApply(100L);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    @Test
    public void testHandleLongFuncXMethodDoNotWrapsOtherExceptionIf() throws X {
        ...
        // when
        LLongFunctionX<Integer,X> wrapped = sutThrowing.handleLongFuncX(handler -> handler
                .wrapIf(UnsupportedOperationException.class::isInstance,IllegalArgumentException::new,  EXCEPTION_WAS_WRAPPED)
...
@Test
    public void testHandleLongFuncXMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleLongFuncXMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LLongFunctionX<Integer,X> wrapped = sutThrowing.handleLongFuncX(h -> Function4U.doNothing());
    ...
    public void testLongFuncComposeLong() throws X {
        ...
        LLongFunctionX<Integer,X> sutO = a -> {
        ...
        //when
        LLongFunctionX<Integer,X> function = sutO.longFuncComposeLong(before);
    ...
    public void testLongFuncCompose() throws X {
        ...
        //when
        LFunctionX<Integer,Integer,X> function = sutO.longFuncCompose(before);
        function.doApply(80);
    ...
    public void testHandleLongFunc() throws X {
        ...
        // when
        LLongFunctionX<Integer,X> wrapped = sutThrowing.handleLongFuncX(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LLongFunctionX: R doApply(long a) throws X");
    }
    ...
    @Test void safeCompiles() {
        LLongFunctionX r1 = LLongFunctionX.safe(sut); //NOSONAR
        LongFunction r3 = LLongFunctionX.safe(sut); //NOSONAR
    }

    @Test void safePropagates() {
        Object result = LLongFunctionX.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LLongFunctionX.safe(null);
        assertThat(result).isSameAs(LLongFunctionX.lX(LLongFunctionX.safe()));
    }

    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LLongFunctionX<Integer,X>,Y> supplier = ()->sut;
        Object result = LLongFunctionX.safeSupplier(supplier);
        assertThat(result).isSameAs(supplier);
    }

    @Test <Y extends Throwable> void safeSupplierProtectsAgainstNpe() {
        Object result = LLongFunctionX.safeSupplier(null);
        assertThat(result).isSameAs(LLongFunctionX.safeSupplier());
    }

    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LLongFunctionX<Integer,X>,Y> r1 = LLongFunctionX.safeSupplier(()->sut);  //NOSONAR
        Supplier<LLongFunctionX<Integer,X>> r2 = LLongFunctionX.safeSupplier(()->sut); //NOSONAR
    }
