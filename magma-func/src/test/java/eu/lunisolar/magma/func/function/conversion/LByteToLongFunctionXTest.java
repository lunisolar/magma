...
public class LByteToLongFunctionXTest<X extends ParseException> {
    ...
    private LByteToLongFunctionX<ParseException> sutAlwaysThrowing = LByteToLongFunctionX.lX((byte b) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LByteToLongFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LByteToLongFunctionX.lX((byte b) -> {
    ...
    public void testLXMethod() throws ParseException {
        assertThat(LByteToLongFunctionX.lX((byte b) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LByteToLongFunctionX<X> wrapped = LByteToLongFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        LByteToLongFunctionX<X> sutO = (byte b) -> {
        ...
        //when
        LByteToLongFunctionX<X> function = sutO.fromByte(before1);
...
//
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LByteToLongFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
