...
public class LByteToLongFunctionXTest<X extends ParseException> {
    ...
    private LByteToLongFunctionX<ParseException> sutAlwaysThrowing = LByteToLongFunctionX.lX(a1 -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LByteToLongFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LByteToLongFunctionX.lX(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LByteSingle,Long,X> theCall = sut;
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LByteToLongFunctionX: long doApplyAsLong(byte a1) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LByteToLongFunctionX.lX(a1 -> testValue ))
...
@Test
    ...
    public void testbyteToLongFuncComposeByte() throws X {
        ...
        LByteToLongFunctionX<X> sutO = a1 -> {
        ...
        //when
        LByteToLongFunctionX<X> function = sutO.byteToLongFuncComposeByte(before1);
    ...
    public void testbyteToLongFuncCompose() throws X {
        ...
        //when
        LToLongFunctionX<Integer ,X> function = sutO.byteToLongFuncCompose(before1);
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LByteToLongFunctionX: long doApplyAsLong(byte a1) throws X");
    }
    ...
    @Test void safeCompiles() {
        LByteToLongFunctionX r1 = LByteToLongFunctionX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LByteToLongFunctionX<X>,Y> r1 = LByteToLongFunctionX.safeSupplier(()->sut);
    }
