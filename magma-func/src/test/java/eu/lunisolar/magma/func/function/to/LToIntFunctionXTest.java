...
public class LToIntFunctionXTest<T,X extends ParseException> {
    ...
    private LToIntFunctionX<T,ParseException> sutAlwaysThrowing = LToIntFunctionX.lX(a1 -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LToIntFunctionX<T,RuntimeException> sutAlwaysThrowingUnckeck = LToIntFunctionX.lX(a1 -> {
...
@Test
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LToIntFunctionX<T,X>,Y> r1 = LToIntFunctionX.safeSupplier(()->sut);  //NOSONAR
        Supplier<LToIntFunctionX<T,X>> r2 = LToIntFunctionX.safeSupplier(()->sut); //NOSONAR
    }
