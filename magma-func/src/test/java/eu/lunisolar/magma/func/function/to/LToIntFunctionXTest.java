...
public class LToIntFunctionXTest<T,X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LToIntFunctionX: int applyAsInt(T t) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(LToIntFunctionX.lX((Object t) -> testValue ))
    ...
    public void testWrapStdMethod() throws ParseException {
        assertThat(LToIntFunctionX.wrapStd(jre))
            .isInstanceOf(LToIntFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LToIntFunctionX<T,X> wrapped = LToIntFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfrom() throws ParseException {
        ...
        LToIntFunctionX<Integer ,X> sutO = (Integer t) -> {
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LToIntFunctionX<T,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LToIntFunctionX: int applyAsInt(T t) throws X");
    }
