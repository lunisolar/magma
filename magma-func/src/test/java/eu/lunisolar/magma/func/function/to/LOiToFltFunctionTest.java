...
public class LOiToFltFunctionTest<T> {
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LOiToFltFunction: float applyAsFlt(T a1,int a2)");
    }

    @Test
    public void testOiToFltFuncMethod() throws Throwable {
        Assert.assertTrue(LOiToFltFunction.oiToFltFunc((a1,a2) -> testValue ) instanceof LOiToFltFunction);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LOiToFltFunction: float applyAsFlt(T a1,int a2)"));
