...
public class LOiToFltFunctionTest<T> {
    ...
    private LOiToFltFunction<Integer> sut = new LOiToFltFunction<Integer>(){
        public  float doApplyAsFltX(Integer a1,int a2)  {
            return testValue;
        }
    };
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LOiToFltFunction: float doApplyAsFlt(T a1,int a2)");
    }
    ...
    @Test
    public void testOiToFltFuncComposeInt() throws Throwable {
        ...
        //when
        LOiToFltFunction<Integer> function = sutO.oiToFltFuncComposeInt(before1,before2);
    ...
    public void testNesting() {
        assertThat(sut.nestingOiToFltFunc())
            .isSameAs(sut)
            .isInstanceOf(LOiToFltFunction.class);
    }
    ...
    public void testShoving() {
        assertThat(sut.shovingOiToFltFunc())
            .isSameAs(sut)
            .isInstanceOf(LOiToFltFunction.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingOiToFltFunc().doApplyAsFlt(100,100);
    }
    ...
    public void testToString() throws Throwable {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LOiToFltFunction: float doApplyAsFlt(T a1,int a2)");
    }
