...
public class LFloatToCharFunctionXTest<X extends ParseException> {
    ...
    private LFloatToCharFunctionX<ParseException> sutAlwaysThrowing = LFloatToCharFunctionX.lX((float f) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LFloatToCharFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LFloatToCharFunctionX.lX((float f) -> {
    ...
    public void testLXMethod() throws ParseException {
        assertThat(LFloatToCharFunctionX.lX((float f) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LFloatToCharFunctionX<X> sutThrowing = LFloatToCharFunctionX.lX((float f) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LFloatToCharFunctionX<X> wrapped = LFloatToCharFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromFloat() throws ParseException {
        ...
        LFloatToCharFunctionX<X> sutO = (float f) -> {
        ...
        //when
        LFloatToCharFunctionX<X> function = sutO.fromFloat(before1);
...
//
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().doApplyAsChar((float)100);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LFloatToCharFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
