...
public class ShortUnaryOperatorXTest<X extends ParseException> {
    ...
    private ShortUnaryOperatorX<X> sut = new ShortUnaryOperatorX(){
        public  short applyAsShort(short s) throws ParseException {
            return testValue;
        }
    };

    private ShortUnaryOperator opposite = new ShortUnaryOperator(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ShortUnaryOperatorX: short applyAsShort(short s) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(ShortUnaryOperatorX.lX((short s) -> testValue ))
            .isInstanceOf(ShortUnaryOperatorX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(ShortUnaryOperatorX.wrapX(opposite))
            .isInstanceOf(ShortUnaryOperatorX.class);
    }
    ...
    public void testfromShort() throws ParseException {
        ...
        ShortUnaryOperatorX<X> sutO = (short s) -> {
        ...
        //when
        ShortUnaryOperatorX<X> function = sutO.fromShort(before1);
    ...
    public void identity() throws ParseException {
        ShortUnaryOperatorX<X> identityFunction = ShortUnaryOperatorX.identity();
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        ShortUnaryOperatorX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ShortUnaryOperatorX: short applyAsShort(short s) throws X");
    }
