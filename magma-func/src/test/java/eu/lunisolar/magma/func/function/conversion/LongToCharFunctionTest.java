...
public class LongToCharFunctionTest<X extends ParseException> {
    ...
    private LongToCharFunction sut = new LongToCharFunction(){
        public  char applyAsChar(long l)  {
            return testValue;
        }
    };

    private LongToCharFunctionX<X> opposite = new LongToCharFunctionX(){
        public  char applyAsChar(long l) throws ParseException {
            return testValue;
        }
    };
    ...
    public void testTheResult() throws ParseException {
        assertThat(sut.applyAsChar((long)100))
            .isEqualTo(testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LongToCharFunction: char applyAsChar(long l)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LongToCharFunction.l((long l) -> testValue ))
            .isInstanceOf(LongToCharFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(LongToCharFunction.wrap(opposite))
            .isInstanceOf(LongToCharFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        // given
        LongToCharFunctionX<X> sutThrowing = LongToCharFunctionX.lX((long l) -> {
            throw new UnsupportedOperationException(ORIGINAL_MESSAGE);
        });

        // when
        LongToCharFunction wrapped = LongToCharFunction.wrap(sutThrowing);

        // then
        try {
            wrapped.applyAsChar((long)100);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LongToCharFunctionX<ParseException> sutThrowing = LongToCharFunctionX.lX((long l) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LongToCharFunction sutThrowing = LongToCharFunction.l((long l) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LongToCharFunction wrapped = LongToCharFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromLong() throws ParseException {
        ...
        LongToCharFunction sutO = (long l) -> {
        ...
        //when
        LongToCharFunction function = sutO.fromLong(before1);
        function.applyAsChar((long)80);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LongToCharFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LongToCharFunctionX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shove().applyAsChar((long)100);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LongToCharFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LongToCharFunction: char applyAsChar(long l)");
    }
