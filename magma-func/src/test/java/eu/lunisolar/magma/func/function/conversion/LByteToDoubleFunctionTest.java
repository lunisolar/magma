...
public class LByteToDoubleFunctionTest<X extends ParseException> {
    ...
    private LByteToDoubleFunction sutAlwaysThrowingUnckeck = LByteToDoubleFunction.l((byte b) -> {
    ...
    public void testLMethod() throws ParseException {
        assertThat(LByteToDoubleFunction.l((byte b) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LByteToDoubleFunctionX<ParseException> sutThrowing = LByteToDoubleFunctionX.lX((byte b) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LByteToDoubleFunction sutThrowing = LByteToDoubleFunction.l((byte b) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LByteToDoubleFunction wrapped = LByteToDoubleFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        LByteToDoubleFunction sutO = (byte b) -> {
        ...
        //when
        LByteToDoubleFunction function = sutO.fromByte(before1);
...
//
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LByteToDoubleFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
