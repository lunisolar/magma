...
public class ShortUnaryOperatorTest<X extends ParseException> {
    ...
    private ShortUnaryOperator sut = new ShortUnaryOperator(){
        public  short applyAsShort(short s)  {
            return testValue;
        }
    };

    private ShortUnaryOperatorX<X> opposite = new ShortUnaryOperatorX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ShortUnaryOperator: short applyAsShort(short s)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(ShortUnaryOperator.l((short s) -> testValue ))
            .isInstanceOf(ShortUnaryOperator.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(ShortUnaryOperator.wrap(opposite))
            .isInstanceOf(ShortUnaryOperator.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        ShortUnaryOperator wrapped = ShortUnaryOperator.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        ShortUnaryOperatorX<ParseException> sutThrowing = ShortUnaryOperatorX.lX((short s) -> {
    ...
    public void testfromShort() throws ParseException {
        ...
        ShortUnaryOperator sutO = (short s) -> {
        ...
        //when
        ShortUnaryOperator function = sutO.fromShort(before1);
    ...
    public void identity() throws ParseException {
        ShortUnaryOperator identityFunction = ShortUnaryOperator.identity();
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(ShortUnaryOperator.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ShortUnaryOperator wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ShortUnaryOperator: short applyAsShort(short s)");
    }
