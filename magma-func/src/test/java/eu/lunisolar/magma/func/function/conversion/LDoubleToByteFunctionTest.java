...
public class LDoubleToByteFunctionTest<X extends ParseException> {
    ...
    private LDoubleToByteFunction sutAlwaysThrowingUnckeck = LDoubleToByteFunction.l((double d) -> {
    ...
    public void testLMethod() throws ParseException {
        assertThat(LDoubleToByteFunction.l((double d) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LDoubleToByteFunctionX<ParseException> sutThrowing = LDoubleToByteFunctionX.lX((double d) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LDoubleToByteFunction sutThrowing = LDoubleToByteFunction.l((double d) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LDoubleToByteFunction wrapped = LDoubleToByteFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromDouble() throws ParseException {
        ...
        LDoubleToByteFunction sutO = (double d) -> {
...
//
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LDoubleToByteFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
