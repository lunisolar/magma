...
public class LBiObjBooleanPredicateXTest<T1,T2,X extends ParseException> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LBiObjBooleanPredicateX<T1,T2,X> wrapped = LBiObjBooleanPredicateX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromBoolean() throws ParseException {
        ...
        //when
        LBiObjBooleanPredicateX<Integer ,Integer ,X> function = sutO.fromBoolean(before1,before2,before3);
...
//
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LBiObjBooleanPredicateX<T1,T2,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
