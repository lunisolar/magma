...
public class BiPredicateXTest<T1,T2,X extends ParseException> {
    ...
    private BiPredicateX<T1,T2,X> sut = new BiPredicateX(){
        public  boolean test(Object t1,Object t2) throws ParseException {
            return testValue;
        }
    };

    private BiPredicate<T1,T2> opposite = new BiPredicate(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BiPredicateX: boolean test(T1 t1,T2 t2) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(BiPredicateX.lX((Object t1,Object t2) -> testValue ))
            .isInstanceOf(BiPredicateX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(BiPredicateX.wrapX(opposite))
            .isInstanceOf(BiPredicateX.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(BiPredicateX.wrapStd(jre))
            .isInstanceOf(BiPredicateX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        BiPredicateX<T1,T2,X> sutThrowing = BiPredicateX.lX((T1 t1,T2 t2) -> {
            throw new UnsupportedOperationException();
        });

        // when
        BiPredicateX<T1,T2,X> wrapped = BiPredicateX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws ParseException {
        ...
        //given
        BiPredicateX<T1,T2,X> fun1 = BiPredicateX.lX((T1 t1,T2 t2) -> f1Result);
        BiPredicateX<T1,T2,X> fun2 = BiPredicateX.lX((T1 t1,T2 t2) -> f2Result);

        //when
        BiPredicateX<T1,T2,X> andFunction = fun1.and(fun2);
        BiPredicateX<T1,T2,X> orFunction = fun1.or(fun2);
        BiPredicateX<T1,T2,X> xorFunction = fun1.xor(fun2);
    ...
    public void isEqual() throws ParseException  {
        //when
        BiPredicateX<T1,T2,X> equals = BiPredicateX.isEqual((T1)Integer.valueOf(100),(T2)Integer.valueOf(100));
    ...
    public void testfrom() throws ParseException {
        ...
        BiPredicateX<Integer ,Integer ,X> sutO = (Integer t1,Integer t2) -> {
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(BiPredicate.class);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        BiPredicateX<T1,T2,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BiPredicateX: boolean test(T1 t1,T2 t2) throws X");
    }
