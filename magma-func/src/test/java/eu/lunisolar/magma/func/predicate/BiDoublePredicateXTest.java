...
public class BiDoublePredicateXTest<X extends ParseException> {
    ...
    private BiDoublePredicateX<X> sut = new BiDoublePredicateX(){
        public  boolean test(double d1,double d2) throws ParseException {
            return testValue;
        }
    };

    private BiDoublePredicate opposite = new BiDoublePredicate(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BiDoublePredicateX: boolean test(double d1,double d2) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(BiDoublePredicateX.lX((double d1,double d2) -> testValue ))
            .isInstanceOf(BiDoublePredicateX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(BiDoublePredicateX.wrapX(opposite))
            .isInstanceOf(BiDoublePredicateX.class);
    }
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws ParseException {
        ...
        //given
        BiDoublePredicateX<X> fun1 = BiDoublePredicateX.lX((double d1,double d2) -> f1Result);
        BiDoublePredicateX<X> fun2 = BiDoublePredicateX.lX((double d1,double d2) -> f2Result);

        //when
        BiDoublePredicateX<X> andFunction = fun1.and(fun2);
        BiDoublePredicateX<X> orFunction = fun1.or(fun2);
        BiDoublePredicateX<X> xorFunction = fun1.xor(fun2);
    ...
    public void isEqual() throws ParseException  {
        //when
        BiDoublePredicateX<X> equals = BiDoublePredicateX.isEqual((double)100,(double)100);
    ...
    public void testfromDouble() throws ParseException {
        ...
        BiDoublePredicateX<X> sutO = (double d1,double d2) -> {
        ...
        //when
        BiDoublePredicateX<X> function = sutO.fromDouble(before1,before2);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        BiDoublePredicateX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BiDoublePredicateX: boolean test(double d1,double d2) throws X");
    }
