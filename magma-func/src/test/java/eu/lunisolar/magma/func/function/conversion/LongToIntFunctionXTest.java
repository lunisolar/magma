...
public class LongToIntFunctionXTest<X extends ParseException> {
    ...
    private LongToIntFunctionX<X> sut = new LongToIntFunctionX(){
        public  int applyAsInt(long l) throws ParseException {
            return testValue;
        }
    };

    private LongToIntFunction opposite = new LongToIntFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LongToIntFunctionX: int applyAsInt(long l) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(LongToIntFunctionX.lX((long l) -> testValue ))
            .isInstanceOf(LongToIntFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(LongToIntFunctionX.wrapX(opposite))
            .isInstanceOf(LongToIntFunctionX.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(LongToIntFunctionX.wrapStd(jre))
            .isInstanceOf(LongToIntFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LongToIntFunctionX<X> wrapped = LongToIntFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromLong() throws ParseException {
        ...
        LongToIntFunctionX<X> sutO = (long l) -> {
        ...
        //when
        LongToIntFunctionX<X> function = sutO.fromLong(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LongToIntFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LongToIntFunctionX: int applyAsInt(long l) throws X");
    }
