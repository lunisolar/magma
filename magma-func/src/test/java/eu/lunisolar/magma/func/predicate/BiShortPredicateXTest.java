...
public class BiShortPredicateXTest<X extends ParseException> {
    ...
    private BiShortPredicateX<X> sut = new BiShortPredicateX(){
        public  boolean test(short s1,short s2) throws ParseException {
            return testValue;
        }
    };

    private BiShortPredicate opposite = new BiShortPredicate(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BiShortPredicateX: boolean test(short s1,short s2) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(BiShortPredicateX.lX((short s1,short s2) -> testValue ))
            .isInstanceOf(BiShortPredicateX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(BiShortPredicateX.wrapX(opposite))
            .isInstanceOf(BiShortPredicateX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        BiShortPredicateX<X> wrapped = BiShortPredicateX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws ParseException {
        ...
        //given
        BiShortPredicateX<X> fun1 = BiShortPredicateX.lX((short s1,short s2) -> f1Result);
        BiShortPredicateX<X> fun2 = BiShortPredicateX.lX((short s1,short s2) -> f2Result);

        //when
        BiShortPredicateX<X> andFunction = fun1.and(fun2);
        BiShortPredicateX<X> orFunction = fun1.or(fun2);
        BiShortPredicateX<X> xorFunction = fun1.xor(fun2);
    ...
    public void isEqual() throws ParseException  {
        //when
        BiShortPredicateX<X> equals = BiShortPredicateX.isEqual((short)100,(short)100);
    ...
    public void testfromShort() throws ParseException {
        ...
        BiShortPredicateX<X> sutO = (short s1,short s2) -> {
        ...
        //when
        BiShortPredicateX<X> function = sutO.fromShort(before1,before2);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        BiShortPredicateX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BiShortPredicateX: boolean test(short s1,short s2) throws X");
    }
