...
public class LTieDblFunctionTest<T> {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.applyAsInt(100,100,100d), testValue);
    }
    ...
    public void testNonNullApplyAsInt() throws Throwable {
            Assert.assertEquals(sut.nonNullApplyAsInt(100,100,100d), testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LTieDblFunction: int applyAsInt(T a1,int a2,double a3)");
    }

    @Test
    public void testTieDblFuncMethod() throws Throwable {
        Assert.assertTrue(LTieDblFunction.tieDblFunc((a1,a2,a3) -> testValue ) instanceof LTieDblFunction);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LTieDblFunction: int applyAsInt(T a1,int a2,double a3)"));
    ...
    public void compilerSubstituteVariantLObjDblIntToIntFunc() {
        ...
        Assert.assertTrue(lambda instanceof LTieDblFunction.LObjDblIntToIntFunc);
    }
    ...
    public void compilerSubstituteVariantLIntObjDblToIntFunc() {
        ...
        Assert.assertTrue(lambda instanceof LTieDblFunction.LIntObjDblToIntFunc);
    }
    ...
    public void compilerSubstituteVariantLIntDblObjToIntFunc() {
        ...
        Assert.assertTrue(lambda instanceof LTieDblFunction.LIntDblObjToIntFunc);
    }
    ...
    public void compilerSubstituteVariantLDblObjIntToIntFunc() {
        ...
        Assert.assertTrue(lambda instanceof LTieDblFunction.LDblObjIntToIntFunc);
    }
    ...
    public void compilerSubstituteVariantLDblIntObjToIntFunc() {
        ...
        Assert.assertTrue(lambda instanceof LTieDblFunction.LDblIntObjToIntFunc);
    }
