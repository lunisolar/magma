...
public class LObjLongConsumerTest<T,X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LObjLongConsumer: void accept(T t, long l)");
    }
    ...
    public void testWrapStdMethod() throws ParseException {
        assertThat(LObjLongConsumer.wrapStd(jre))
            .isInstanceOf(LObjLongConsumer.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LObjLongConsumer<T> wrapped = LObjLongConsumer.wrapException(sutThrowing, UnsupportedOperationException.class, t -> {
    ...
    public void testfromLong() throws ParseException {
        ...
        //when
        LObjLongConsumer<Integer > function = sutO.fromLong(before1,before2);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LObjLongConsumer<T> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LObjLongConsumer: void accept(T t, long l)");
    }
