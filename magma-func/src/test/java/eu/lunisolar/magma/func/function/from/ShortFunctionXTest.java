...
public class ShortFunctionXTest<R,X extends ParseException> {
    ...
    private ShortFunctionX<R,X> sut = new ShortFunctionX(){
        public @Nullable Object  apply(short s) throws ParseException {
            return testValue;
        }
    };

    private ShortFunction<R> opposite = new ShortFunction(){
        public @Nullable Object  apply(short s)  {
            return testValue;
        }
    };

    private ShortFunctionX<R,X> sutNull = new ShortFunctionX(){
        public @Nullable Object  apply(short s) throws ParseException {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (ShortFunctionX: R apply(short s) throws X).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ShortFunctionX: R apply(short s) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(ShortFunctionX.lX((short s) -> testValue ))
            .isInstanceOf(ShortFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(ShortFunctionX.wrapX(opposite))
            .isInstanceOf(ShortFunctionX.class);
    }
    ...
    public void testfromShort() throws ParseException {
        ...
        ShortFunctionX<Integer ,X> sutO = (short s) -> {
        ...
        //when
        ShortFunctionX<Integer ,X> function = sutO.fromShort(before1);
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        ShortConsumerX<X> function = sutO.then(thenFunction);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        ShortFunctionX<R,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ShortFunctionX: R apply(short s) throws X");
    }
