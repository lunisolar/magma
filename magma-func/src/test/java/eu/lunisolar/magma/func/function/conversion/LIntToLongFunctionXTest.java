...
public class LIntToLongFunctionXTest<X extends ParseException> {
    ...
    private LIntToLongFunctionX<X> sut = new LIntToLongFunctionX(){
        public  long doApplyAsLong(int a1) throws ParseException {
            return testValue;
        }
    };
    ...
    private LIntToLongFunctionX<ParseException> sutAlwaysThrowing = LIntToLongFunctionX.lX(a1 -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LIntToLongFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LIntToLongFunctionX.lX(a1 -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LIntToLongFunctionX: long doApplyAsLong(int a1) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LIntToLongFunctionX.lX(a1 -> testValue ))
...
@Test
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LIntToLongFunctionX: long doApplyAsLong(int a1) throws X");
    }
