...
public class LIntToLongFunctionXTest<X extends ParseException> {
    ...
    private LIntToLongFunctionX<ParseException> sutAlwaysThrowing = LIntToLongFunctionX.lX((int i) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LIntToLongFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LIntToLongFunctionX.lX((int i) -> {
    ...
    public void testLXMethod() throws ParseException {
        assertThat(LIntToLongFunctionX.lX((int i) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LIntToLongFunctionX<X> wrapped = LIntToLongFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromInt() throws ParseException {
        ...
        LIntToLongFunctionX<X> sutO = (int i) -> {
...
//
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LIntToLongFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
