...
public class LIntToLongFunctionXTest<X extends ParseException> {
    ...
    private LIntToLongFunctionX<X> sut = new LIntToLongFunctionX(){
    ...
    private java.util.function.IntToLongFunction jre = i -> testValue;


    private LIntToLongFunctionX<ParseException> sutAlwaysThrowing = LIntToLongFunctionX.lX(i -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LIntToLongFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LIntToLongFunctionX.lX(i -> {
    ...
    public void testNestingDoApplyAsLongChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoApplyAsLong((int)100);
    ...
    public void testShovingDoApplyAsLongChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoApplyAsLong((int)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LIntToLongFunctionX: long doApplyAsLong(int i) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LIntToLongFunctionX.lX(i -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LIntToLongFunctionX<X> sutThrowing = LIntToLongFunctionX.lX(i -> {
            throw new UnsupportedOperationException();
        });

        // when
        LIntToLongFunctionX<X> wrapped = sutThrowing.handleIToLongFuncX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LIntToLongFunctionX<X> wrapped = sutThrowing.handleIToLongFuncX(h -> Function4U.doNothing());
    ...
    @Test
    public void testiToLongFuncFromInt() throws X {

        final ThreadLocal<Boolean> mainFunctionCalled = ThreadLocal.withInitial(()-> false);
        final AtomicInteger beforeCalls = new AtomicInteger(0);

        //given (+ some assertions)
        LIntToLongFunctionX<X> sutO = i -> {
        ...
        //when
        LIntToLongFunctionX<X> function = sutO.iToLongFuncFromInt(before1);
    ...
    @Test
    public void testiToLongFuncFrom() throws X {
        ...
        //when
        LToLongFunctionX<Integer ,X> function = sutO.iToLongFuncFrom(before1);
    ...
    public void testNesting() {
        assertThat(sut.nestingIToLongFunc())
            .isInstanceOf(LIntToLongFunction.class);
    }

    @Test
    public void testShoving() {
        assertThat(sut.shovingIToLongFunc())
            .isInstanceOf(LIntToLongFunction.class);
    }

    @Test
    public void testNestingX() {
        assertThat(sut.nestingIToLongFuncX())
            .isInstanceOf(LIntToLongFunctionX.class);
    }

    @Test
    public void testShovingX() {
        assertThat(sut.shovingIToLongFuncX())
            .isInstanceOf(LIntToLongFunctionX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingIToLongFunc().doApplyAsLong((int)100);
    }

    @Test
    public void testHandleIToLongFunc() throws X {
        ...
        // when
        LIntToLongFunctionX<X> wrapped = sutThrowing.handleIToLongFuncX(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LIntToLongFunctionX: long doApplyAsLong(int i) throws X");
    }
