...
public class LObjDoubleFunctionXTest<T,R,X extends ParseException> {
    ...
    private LObjDoubleFunctionX<Integer,Integer,X> sut = new LObjDoubleFunctionX<Integer,Integer,X>(){
        public @Nullable Integer doApply(Integer a1,double a2)  throws X {
            return testValue;
        }
    };

    private LObjDoubleFunction<Integer,Integer> opposite = new LObjDoubleFunction<Integer,Integer>(){
        public @Nullable Integer doApply(Integer a1,double a2)  {
            return testValue;
        }
    };

    private LObjDoubleFunctionX<Integer,Integer,X> sutNull = new LObjDoubleFunctionX<Integer,Integer,X>(){
        public @Nullable Integer doApply(Integer a1,double a2)  throws X {
            return null;
        }
    };
    ...
    private LObjDoubleFunctionX<Integer,Integer,ParseException> sutAlwaysThrowing = LObjDoubleFunctionX.lX((a1,a2) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LObjDoubleFunctionX<Integer,Integer,RuntimeException> sutAlwaysThrowingUnchecked = LObjDoubleFunctionX.lX((a1,a2) -> {
    ...
    public void testNestingDoApplyChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoApply(100,100d);
    ...
    public void testShovingDoApplyChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoApply(100,100d);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testLXMethod() throws X {
        assertThat(LObjDoubleFunctionX.lX((a1,a2) -> testValue ))
    ...
    public void testHandlingDoApplyMethodWrapsTheException() throws X {
        ...
        // when
        LObjDoubleFunctionX<Integer,Integer,RuntimeException> wrapped = sutThrowing.handleObjDoubleFuncX(handler -> handler
    ...
    @Test
    public void testHandleObjDoubleFuncXMethodDoNotWrapsOtherExceptionIf() throws X {
        ...
        // when
        LObjDoubleFunctionX<Integer,Integer,X> wrapped = sutThrowing.handleObjDoubleFuncX(handler -> handler
                .wrapIf(UnsupportedOperationException.class::isInstance,IllegalArgumentException::new,  EXCEPTION_WAS_WRAPPED)
...
@Test
    public void testHandleObjDoubleFuncXMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleObjDoubleFuncXMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LObjDoubleFunctionX<Integer,Integer,X> wrapped = sutThrowing.handleObjDoubleFuncX(h -> Function4U.doNothing());
    ...
    public void testObjDoubleFuncComposeDouble() throws X {
        ...
        LObjDoubleFunctionX<Integer,Integer,X> sutO = (a1,a2) -> {
    ...
    public void testHandleObjDoubleFunc() throws X {
        ...
        // when
        LObjDoubleFunctionX<Integer,Integer,X> wrapped = sutThrowing.handleObjDoubleFuncX(h -> {
    ...
    public void compilerSubstituteVariantV1() {
        LObjDoubleFunctionX lambda = LObjDoubleFunctionX./*<T,R,X>*/lX1(this::variantV1);
    ...
    @Test void safeCompiles() {
        LObjDoubleFunctionX r1 = LObjDoubleFunctionX.safe(sut); //NOSONAR
    }
    ...
    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LObjDoubleFunctionX<Integer,Integer,X>,Y> supplier = ()->sut;
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LObjDoubleFunctionX<Integer,Integer,X>,Y> r1 = LObjDoubleFunctionX.safeSupplier(()->sut);  //NOSONAR
    }
