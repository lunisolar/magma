...
public class LObjDoubleFunctionXTest<T,R,X extends ParseException> {
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (LObjDoubleFunctionX: R apply(T t, double d) throws X).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LObjDoubleFunctionX: R apply(T t, double d) throws X");
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LObjDoubleFunctionX<T,R,X> wrapped = LObjDoubleFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LObjDoubleFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LObjDoubleFunctionX.class);
    }
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LObjDoubleFunctionX<T,R,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LObjDoubleFunctionX: R apply(T t, double d) throws X");
    }
