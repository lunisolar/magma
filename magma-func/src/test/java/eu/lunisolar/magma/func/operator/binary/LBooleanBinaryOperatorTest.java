...
public class LBooleanBinaryOperatorTest<X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBooleanBinaryOperator: boolean applyAsBoolean(boolean b1,boolean b2)");
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LBooleanBinaryOperator wrapped = LBooleanBinaryOperator.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LBooleanBinaryOperator wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBooleanBinaryOperator: boolean applyAsBoolean(boolean b1,boolean b2)");
    }
