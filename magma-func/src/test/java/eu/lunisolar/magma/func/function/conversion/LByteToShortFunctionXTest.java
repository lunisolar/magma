...
public class LByteToShortFunctionXTest<X extends ParseException> {
    ...
    private LByteToShortFunctionX<ParseException> sutAlwaysThrowing = LByteToShortFunctionX.lX((byte b) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LByteToShortFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LByteToShortFunctionX.lX((byte b) -> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LByteToShortFunctionX: short doApplyAsShort(byte b) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(LByteToShortFunctionX.lX((byte b) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LByteToShortFunctionX<X> wrapped = LByteToShortFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        LByteToShortFunctionX<X> sutO = (byte b) -> {
        ...
        //when
        LByteToShortFunctionX<X> function = sutO.fromByte(before1);
...
//
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LByteToShortFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LByteToShortFunctionX: short doApplyAsShort(byte b) throws X");
    }
