...
public class LByteToShortFunctionXTest<X extends ParseException> {
    ...
    private LByteToShortFunctionX<ParseException> sutAlwaysThrowing = LByteToShortFunctionX.lX(b -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LByteToShortFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LByteToShortFunctionX.lX(b -> {
    ...
    public void testLXMethod() throws X {
        assertThat(LByteToShortFunctionX.lX(b -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // when
        LByteToShortFunctionX<X> wrapped = sutThrowing.handleX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LByteToShortFunctionX<X> wrapped = sutThrowing.handleX(h -> Function4U.doNothing());
    ...
    public void testfromByte() throws X {
        ...
        LByteToShortFunctionX<X> sutO = b -> {
    ...
    public void testHandle() throws X {
        ...
        // when
        LByteToShortFunctionX<X> wrapped = sutThrowing.handleX(h -> {
