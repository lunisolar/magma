...
public class LByteToShortFunctionXTest<X extends ParseException> {
    ...
    private LByteToShortFunctionX<X> sut = new LByteToShortFunctionX(){
    ...
    private LByteToShortFunctionX<ParseException> sutAlwaysThrowing = LByteToShortFunctionX.lX(a1 -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LByteToShortFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LByteToShortFunctionX.lX(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LByteSingle,Short,X> theCall = sut;
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LByteToShortFunctionX: short doApplyAsShort(byte a1) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LByteToShortFunctionX.lX(a1 -> testValue ))
...
@Test
    ...
    public void testbyteToShortFuncComposeByte() throws X {
        ...
        LByteToShortFunctionX<X> sutO = a1 -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LByteToShortFunctionX: short doApplyAsShort(byte a1) throws X");
    }
    ...
    @Test void safeCompiles() {
        LByteToShortFunctionX r1 = LByteToShortFunctionX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LByteToShortFunctionX<X>,Y> r1 = LByteToShortFunctionX.safeSupplier(()->sut);
    }
