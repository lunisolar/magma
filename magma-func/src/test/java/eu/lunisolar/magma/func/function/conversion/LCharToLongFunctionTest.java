...
public class LCharToLongFunctionTest<X extends ParseException> {
    ...
    private LCharToLongFunctionX<X> opposite = new LCharToLongFunctionX(){
        public  long doApplyAsLong(char a1) throws ParseException {
            return testValue;
        }
    };
    ...
    private LCharToLongFunction sutAlwaysThrowingUnckeck = LCharToLongFunction.l(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LCharSingle,Long,RuntimeException> theCall = sut;
...
@Test
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingCharToLongFunc().doApplyAsLong((char)100);
    }
