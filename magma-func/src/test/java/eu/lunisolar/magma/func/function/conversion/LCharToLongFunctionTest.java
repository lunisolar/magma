...
public class LCharToLongFunctionTest<X extends ParseException> {
    ...
    private LCharToLongFunction sutAlwaysThrowingUnckeck = LCharToLongFunction.l(c -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LCharToLongFunction: long doApplyAsLong(char c)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LCharToLongFunction.l(c -> testValue ))
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws X {
        // given
        LCharToLongFunctionX<X> sutThrowing = LCharToLongFunctionX.lX(c -> {
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LCharToLongFunctionX<ParseException> sutThrowing = LCharToLongFunctionX.lX(c -> {
...
@Test
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LCharToLongFunction: long doApplyAsLong(char c)");
    }
