...
public class LBoolToFloatFunctionTest<X extends ParseException> {
    ...
    private LBoolToFloatFunctionX<X> opposite = new LBoolToFloatFunctionX(){
    ...
    private LBoolToFloatFunction sutAlwaysThrowingUnckeck = LBoolToFloatFunction.l(a1 -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBoolToFloatFunction: float doApplyAsFloat(boolean a1)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LBoolToFloatFunction.l(a1 -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LBoolToFloatFunctionX<ParseException> sutThrowing = LBoolToFloatFunctionX.lX(a1 -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LBoolToFloatFunction sutThrowing = LBoolToFloatFunction.l(a1 -> {
...
@Test
    ...
    public void testboolToFloatFuncComposeBoolean() throws X {
        ...
        //when
        LBoolToFloatFunction function = sutO.boolToFloatFuncComposeBoolean(before1);
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBoolToFloatFunction: float doApplyAsFloat(boolean a1)");
    }
