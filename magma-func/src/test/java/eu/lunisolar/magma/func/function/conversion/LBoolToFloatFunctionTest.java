...
public class LBoolToFloatFunctionTest<X extends ParseException> {
    ...
    private LBoolToFloatFunction sutAlwaysThrowingUnckeck = LBoolToFloatFunction.l(b -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBoolToFloatFunction: float doApplyAsFloat(boolean b)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LBoolToFloatFunction.l(b -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LBoolToFloatFunctionX<ParseException> sutThrowing = LBoolToFloatFunctionX.lX(b -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LBoolToFloatFunction sutThrowing = LBoolToFloatFunction.l(b -> {
...
@Test
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBoolToFloatFunction: float doApplyAsFloat(boolean b)");
    }
