...
public class LDoublePredicateXTest<X extends ParseException> {
    ...
    private LDoublePredicateX<ParseException> sutAlwaysThrowing = LDoublePredicateX.lX(d -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LDoublePredicateX<RuntimeException> sutAlwaysThrowingUnckeck = LDoublePredicateX.lX(d -> {
    ...
    public void testNestingDoTestChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoTest((double)100);
    ...
    public void testShovingDoTestChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoTest((double)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testLXMethod() throws X {
        assertThat(LDoublePredicateX.lX(d -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // when
        LDoublePredicateX<X> wrapped = sutThrowing.handleDPredX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LDoublePredicateX<X> wrapped = sutThrowing.handleDPredX(h -> Function4U.doNothing());
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws X {
        ...
        //given
        LDoublePredicateX<X> fun1 = LDoublePredicateX.lX(d -> f1Result);
        LDoublePredicateX<X> fun2 = LDoublePredicateX.lX(d -> f2Result);
    ...
    @Test
    public void testdPredFromDouble() throws X {

        final ThreadLocal<Boolean> mainFunctionCalled = ThreadLocal.withInitial(()-> false);
        final AtomicInteger beforeCalls = new AtomicInteger(0);

        //given (+ some assertions)
        LDoublePredicateX<X> sutO = d -> {
        ...
        //when
        LDoublePredicateX<X> function = sutO.dPredFromDouble(before1);
    ...
    @Test
    public void testdPredFrom() throws X {
        ...
        //when
        LPredicateX<Integer ,X> function = sutO.dPredFrom(before1);
    ...
    public void testNesting() {
        assertThat(sut.nestingDPred())
            .isInstanceOf(LDoublePredicate.class);
    }

    @Test
    public void testShoving() {
        assertThat(sut.shovingDPred())
            .isInstanceOf(LDoublePredicate.class);
    }

    @Test
    public void testNestingX() {
        assertThat(sut.nestingDPredX())
            .isInstanceOf(LDoublePredicateX.class);
    }

    @Test
    public void testShovingX() {
        assertThat(sut.shovingDPredX())
            .isInstanceOf(LDoublePredicateX.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingDPred().doTest((double)100);
    }

    @Test
    public void testHandleDPred() throws X {
        ...
        // when
        LDoublePredicateX<X> wrapped = sutThrowing.handleDPredX(h -> {
