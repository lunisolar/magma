...
public class LDoublePredicateXTest<X extends ParseException> {
    ...
    public void testWrapStdMethod() throws ParseException {
        assertThat(LDoublePredicateX.wrapStd(jre))
            .isInstanceOf(LDoublePredicateX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LDoublePredicateX<X> wrapped = LDoublePredicateX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LDoublePredicateX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
