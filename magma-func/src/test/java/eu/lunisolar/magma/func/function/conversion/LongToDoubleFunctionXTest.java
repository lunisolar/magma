...
public class LongToDoubleFunctionXTest<X extends ParseException> {
    ...
    private LongToDoubleFunctionX<X> sut = new LongToDoubleFunctionX(){
        public  double applyAsDouble(long l) throws ParseException {
            return testValue;
        }
    };

    private LongToDoubleFunction opposite = new LongToDoubleFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LongToDoubleFunctionX: double applyAsDouble(long l) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(LongToDoubleFunctionX.lX((long l) -> testValue ))
            .isInstanceOf(LongToDoubleFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(LongToDoubleFunctionX.wrapX(opposite))
            .isInstanceOf(LongToDoubleFunctionX.class);
    }
    ...
    public void testfromLong() throws ParseException {
        ...
        LongToDoubleFunctionX<X> sutO = (long l) -> {
        ...
        //when
        LongToDoubleFunctionX<X> function = sutO.fromLong(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LongToDoubleFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LongToDoubleFunctionX: double applyAsDouble(long l) throws X");
    }
