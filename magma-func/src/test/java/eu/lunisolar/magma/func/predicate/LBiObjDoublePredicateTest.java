...
public class LBiObjDoublePredicateTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjDoublePredicate<T1,T2> sutAlwaysThrowingUnckeck = LBiObjDoublePredicate.l((T1 a1,T2 a2,double a3) -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LBiObjDoubleTriple<T1,T2>,Boolean,RuntimeException> theCall = sut;
    ...
    public void testLMethod() throws X {
        assertThat(LBiObjDoublePredicate.l((Object a1,Object a2,double a3) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LBiObjDoublePredicateX<T1,T2,ParseException> sutThrowing = LBiObjDoublePredicateX.lX((T1 a1,T2 a2,double a3) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LBiObjDoublePredicate<T1,T2> sutThrowing = LBiObjDoublePredicate.l((T1 a1,T2 a2,double a3) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LBiObjDoublePredicate<T1,T2> wrapped = sutThrowing.handleBiObjDoublePred(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBiObjDoublePredicate<T1,T2> wrapped = sutThrowing.handleBiObjDoublePred(h -> Function4U.doNothing());
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws X {
        ...
        //given
        LBiObjDoublePredicate<T1,T2> fun1 = LBiObjDoublePredicate.l((T1 a1,T2 a2,double a3) -> f1Result);
        LBiObjDoublePredicate<T1,T2> fun2 = LBiObjDoublePredicate.l((T1 a1,T2 a2,double a3) -> f2Result);
    ...
    public void testbiObjDoublePredComposeDouble() throws X {
        ...
        LBiObjDoublePredicate<Integer ,Integer > sutO = (Integer a1,Integer a2,double a3) -> {
    ...
    public void testHandleBiObjDoublePred() throws X {
        ...
        // when
        LBiObjDoublePredicate<T1,T2> wrapped = sutThrowing.handleBiObjDoublePred(h -> {
    ...
    public void compilerSubstituteVariant1() {
        LBiObjDoublePredicate lambda = LBiObjDoublePredicate./*<T1,T2>*/l1(this::variant1);
    ...
    public void compilerSubstituteVariant2() {
        LBiObjDoublePredicate lambda = LBiObjDoublePredicate./*<T1,T2>*/l2(this::variant2);
    ...
    public void compilerSubstituteVariant3() {
        LBiObjDoublePredicate lambda = LBiObjDoublePredicate./*<T1,T2>*/l3(this::variant3);
    ...
    public void compilerSubstituteVariant4() {
        LBiObjDoublePredicate lambda = LBiObjDoublePredicate./*<T1,T2>*/l4(this::variant4);
    ...
    public void compilerSubstituteVariant5() {
        LBiObjDoublePredicate lambda = LBiObjDoublePredicate./*<T1,T2>*/l5(this::variant5);
    ...
    @Test void safeCompiles() {
        LBiObjDoublePredicate r1 = LBiObjDoublePredicate.safe(sut);
        LBiObjDoublePredicateX r2 = LBiObjDoublePredicate.safe(sut);
    }
    ...
    @Test  void safeSupplierPropagates() {
        LSupplier<LBiObjDoublePredicate<T1,T2>> supplier = ()->sut;
    ...
    @Test  void safeSupplierCompiles() {
        LSupplier<LBiObjDoublePredicate<T1,T2>> r1 = LBiObjDoublePredicate.safeSupplier(()->sut);
    }
