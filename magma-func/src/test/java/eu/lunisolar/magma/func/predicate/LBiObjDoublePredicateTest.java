...
public class LBiObjDoublePredicateTest<T1,T2,X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBiObjDoublePredicate: boolean test(T1 t1,T2 t2, double d)");
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LBiObjDoublePredicate<T1,T2> wrapped = LBiObjDoublePredicate.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromDouble() throws ParseException {
        ...
        //when
        LBiObjDoublePredicate<Integer ,Integer > function = sutO.fromDouble(before1,before2,before3);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LBiObjDoublePredicate<T1,T2> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBiObjDoublePredicate: boolean test(T1 t1,T2 t2, double d)");
    }
