...
public class ByteToIntFunctionTest<X extends ParseException> {
    ...
    private ByteToIntFunction sut = new ByteToIntFunction(){
        public  int applyAsInt(byte b)  {
            return testValue;
        }
    };

    private ByteToIntFunctionX<X> opposite = new ByteToIntFunctionX(){
        public  int applyAsInt(byte b) throws ParseException {
            return testValue;
        }
    };
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ByteToIntFunction: int applyAsInt(byte b)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(ByteToIntFunction.l((byte b) -> testValue ))
            .isInstanceOf(ByteToIntFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(ByteToIntFunction.wrap(opposite))
            .isInstanceOf(ByteToIntFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        ByteToIntFunction wrapped = ByteToIntFunction.wrap(sutThrowing);

        // then
        try {
            wrapped.applyAsInt((byte)100);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        ByteToIntFunctionX<ParseException> sutThrowing = ByteToIntFunctionX.lX((byte b) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        ByteToIntFunction sutThrowing = ByteToIntFunction.l((byte b) -> {
            throw new UnsupportedOperationException();
        });

        // when
        ByteToIntFunction wrapped = ByteToIntFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        //when
        ByteToIntFunction function = sutO.fromByte(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(ByteToIntFunction.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ByteToIntFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ByteToIntFunction: int applyAsInt(byte b)");
    }
