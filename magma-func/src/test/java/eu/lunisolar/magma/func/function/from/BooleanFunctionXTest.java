...
public class BooleanFunctionXTest<R,X extends ParseException> {
    ...
    private BooleanFunctionX<R,X> sut = new BooleanFunctionX(){
        public @Nullable Object  apply(boolean b) throws ParseException {
            return testValue;
        }
    };

    private BooleanFunction<R> opposite = new BooleanFunction(){
        public @Nullable Object  apply(boolean b)  {
            return testValue;
        }
    };

    private BooleanFunctionX<R,X> sutNull = new BooleanFunctionX(){
        public @Nullable Object  apply(boolean b) throws ParseException {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (BooleanFunctionX: R apply(boolean b) throws X).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BooleanFunctionX: R apply(boolean b) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(BooleanFunctionX.lX((boolean b) -> testValue ))
            .isInstanceOf(BooleanFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(BooleanFunctionX.wrapX(opposite))
            .isInstanceOf(BooleanFunctionX.class);
    }
    ...
    public void testfromBoolean() throws ParseException {
        ...
        BooleanFunctionX<Integer ,X> sutO = (boolean b) -> {
        ...
        //when
        BooleanFunctionX<Integer ,X> function = sutO.fromBoolean(before1);
        function.apply(true);
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        BooleanConsumerX<X> function = sutO.then(thenFunction);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        BooleanFunctionX<R,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BooleanFunctionX: R apply(boolean b) throws X");
    }
