...
public class LObjShortFunctionXTest<T,R,X extends ParseException> {
    ...
    public void testNestingDoApplyChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoApply((T)Integer.valueOf(100),(short)100);
    ...
    public void testShovingDoApplyChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoApply((T)Integer.valueOf(100),(short)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // when
        LObjShortFunctionX<T,R,X> wrapped = sutThrowing.handleObjShortFuncX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LObjShortFunctionX<T,R,X> wrapped = sutThrowing.handleObjShortFuncX(h -> Function4U.doNothing());
    ...
    public void testHandleObjShortFunc() throws X {
        ...
        // when
        LObjShortFunctionX<T,R,X> wrapped = sutThrowing.handleObjShortFuncX(h -> {
    ...
    public void compilerSubstituteVariant1() {
        LObjShortFunctionX lambda = LObjShortFunctionX./*<T,R,X>*/lX1(this::variant1);
    ...
    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LObjShortFunctionX<T,R,X>,Y> supplier = ()->sut;
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LObjShortFunctionX<T,R,X>,Y> r1 = LObjShortFunctionX.safeSupplier(()->sut);  //NOSONAR
    }
