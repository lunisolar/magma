...
public class FloatUnaryOperatorTest<X extends ParseException> {
    ...
    private FloatUnaryOperator sut = new FloatUnaryOperator(){
        public  float applyAsFloat(float f)  {
            return testValue;
        }
    };

    private FloatUnaryOperatorX<X> opposite = new FloatUnaryOperatorX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("FloatUnaryOperator: float applyAsFloat(float f)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(FloatUnaryOperator.l((float f) -> testValue ))
            .isInstanceOf(FloatUnaryOperator.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(FloatUnaryOperator.wrap(opposite))
            .isInstanceOf(FloatUnaryOperator.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        FloatUnaryOperator wrapped = FloatUnaryOperator.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        FloatUnaryOperatorX<ParseException> sutThrowing = FloatUnaryOperatorX.lX((float f) -> {
    ...
    public void testfromFloat() throws ParseException {
        ...
        FloatUnaryOperator sutO = (float f) -> {
        ...
        //when
        FloatUnaryOperator function = sutO.fromFloat(before1);
    ...
    public void identity() throws ParseException {
        FloatUnaryOperator identityFunction = FloatUnaryOperator.identity();
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        FloatUnaryOperator wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("FloatUnaryOperator: float applyAsFloat(float f)");
    }
