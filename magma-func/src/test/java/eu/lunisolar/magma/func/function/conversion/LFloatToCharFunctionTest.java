...
public class LFloatToCharFunctionTest<X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LFloatToCharFunction: char applyAsChar(float f)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LFloatToCharFunction.l((float f) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LFloatToCharFunctionX<ParseException> sutThrowing = LFloatToCharFunctionX.lX((float f) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LFloatToCharFunction sutThrowing = LFloatToCharFunction.l((float f) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LFloatToCharFunction wrapped = LFloatToCharFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromFloat() throws ParseException {
        ...
        LFloatToCharFunction sutO = (float f) -> {
        ...
        //when
        LFloatToCharFunction function = sutO.fromFloat(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LFloatToCharFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LFloatToCharFunctionX.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LFloatToCharFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LFloatToCharFunction: char applyAsChar(float f)");
    }
