...
public class LIntToSrtFunctionTest {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.applyAsSrt(100), testValue);
    }
    ...
    public void testNonNullApplyAsSrt() throws Throwable {
            Assert.assertEquals(sut.nonNullApplyAsSrt(100), testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LIntToSrtFunction: short applyAsSrt(int a)");
    }

    @Test
    public void testIntToSrtFuncMethod() throws Throwable {
        Assert.assertTrue(LIntToSrtFunction.intToSrtFunc(a -> testValue ) instanceof LIntToSrtFunction);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LIntToSrtFunction: short applyAsSrt(int a)"));
