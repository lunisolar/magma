...
public class LDoubleToCharFunctionXTest<X extends ParseException> {
    ...
    private LDoubleToCharFunctionX<X> sut = new LDoubleToCharFunctionX<X>(){
    ...
    private LDoubleToCharFunctionX<ParseException> sutAlwaysThrowing = LDoubleToCharFunctionX.lX(a -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LDoubleToCharFunctionX<RuntimeException> sutAlwaysThrowingUnchecked = LDoubleToCharFunctionX.lX(a -> {
    ...
    public void testNestingDoApplyAsCharChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoApplyAsChar(100d);
    ...
    public void testShovingDoApplyAsCharChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoApplyAsChar(100d);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LDoubleToCharFunctionX: char doApplyAsChar(double a) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LDoubleToCharFunctionX.lX(a -> testValue ))
    ...
    public void testHandlingDoApplyAsCharMethodWrapsTheException() throws X {
        ...
        // when
        LDoubleToCharFunctionX<RuntimeException> wrapped = sutThrowing.handleDoubleToCharFuncX(handler -> handler
    ...
    @Test
    public void testHandleDoubleToCharFuncXMethodDoNotWrapsOtherExceptionIf() throws X {
...
@Test
    public void testHandleDoubleToCharFuncXMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleDoubleToCharFuncXMishandlingExceptionIsAllowed() throws X {
    ...
    public void testDoubleToCharFuncComposeDouble() throws X {
        ...
        LDoubleToCharFunctionX<X> sutO = a -> {
        ...
        //when
        LDoubleToCharFunctionX<X> function = sutO.doubleToCharFuncComposeDouble(before);
    ...
    public void testDoubleToCharFuncCompose() throws X {
        ...
        //when
        LToCharFunctionX<Integer,X> function = sutO.doubleToCharFuncCompose(before);
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LDoubleToCharFunctionX: char doApplyAsChar(double a) throws X");
    }
    ...
    @Test void safeCompiles() {
        LDoubleToCharFunctionX r1 = LDoubleToCharFunctionX.safe(sut); //NOSONAR
    }
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LDoubleToCharFunctionX<X>,Y> r1 = LDoubleToCharFunctionX.safeSupplier(()->sut);  //NOSONAR
    }
