...
public class LDoubleToCharFunctionXTest<X extends ParseException> {
    ...
    private LDoubleToCharFunctionX<ParseException> sutAlwaysThrowing = LDoubleToCharFunctionX.lX((double d) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LDoubleToCharFunctionX<RuntimeException> sutAlwaysThrowingUnckeck = LDoubleToCharFunctionX.lX((double d) -> {
    ...
    public void testLXMethod() throws ParseException {
        assertThat(LDoubleToCharFunctionX.lX((double d) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LDoubleToCharFunctionX<X> wrapped = LDoubleToCharFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromDouble() throws ParseException {
        ...
        LDoubleToCharFunctionX<X> sutO = (double d) -> {
...
//
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LDoubleToCharFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
