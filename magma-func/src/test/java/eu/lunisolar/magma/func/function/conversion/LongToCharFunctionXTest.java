...
public class LongToCharFunctionXTest<X extends ParseException> {
    ...
    private LongToCharFunctionX<X> sut = new LongToCharFunctionX(){
        public  char applyAsChar(long l) throws ParseException {
            return testValue;
        }
    };

    private LongToCharFunction opposite = new LongToCharFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LongToCharFunctionX: char applyAsChar(long l) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(LongToCharFunctionX.lX((long l) -> testValue ))
            .isInstanceOf(LongToCharFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(LongToCharFunctionX.wrapX(opposite))
            .isInstanceOf(LongToCharFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LongToCharFunctionX<X> wrapped = LongToCharFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromLong() throws ParseException {
        ...
        LongToCharFunctionX<X> sutO = (long l) -> {
        ...
        //when
        LongToCharFunctionX<X> function = sutO.fromLong(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LongToCharFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LongToCharFunctionX: char applyAsChar(long l) throws X");
    }
