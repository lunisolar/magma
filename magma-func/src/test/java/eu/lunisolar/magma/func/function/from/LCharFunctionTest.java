...
public class LCharFunctionTest<R,X extends ParseException> {
    ...
    private LCharFunction<R> sutAlwaysThrowingUnckeck = LCharFunction.l((char c) -> {
    ...
    public void testLMethod() throws ParseException {
        assertThat(LCharFunction.l((char c) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LCharFunctionX<R,ParseException> sutThrowing = LCharFunctionX.lX((char c) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LCharFunction<R> sutThrowing = LCharFunction.l((char c) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LCharFunction<R> wrapped = LCharFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromChar() throws ParseException {
        ...
        LCharFunction<Integer > sutO = (char c) -> {
...
//
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LCharFunction<R> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
