...
public class LTriDblPredicateTest {
    ...
    public void testTheResult() throws Throwable {
        assertThat(sut.test(100d,100d,100d))
            .isEqualTo(testValue);
    }
    ...
    public void testNonNullTest() throws Throwable {
        assertThat(sut.nonNullTest(100d,100d,100d))
            .isEqualTo(testValue);
    }
    ...
    public void testApplyAsBooleanShouldNotModifyValue() throws Throwable {
        assertThat(sut.doApplyAsBoolean(100d,100d,100d))
            .isEqualTo(testValue);
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LTriDblPredicate: boolean test(double a1,double a2,double a3)");
    }

    @Test
    public void testTriDblPredMethod() throws Throwable {
        assertThat(LTriDblPredicate.triDblPred((a1,a2,a3) -> testValue ))
            .isInstanceOf(LTriDblPredicate.class);
    }
    ...
    public void testnegate() throws Throwable {
        assertThat(sut.negate().test(100d,100d,100d))
            .isEqualTo(!testValue);
    }
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws Throwable {
        ...
        //then
        assertThat(andFunction.test(100d,100d,100d))
                .isEqualTo(andResult);

        assertThat(orFunction.test(100d,100d,100d))
                .isEqualTo(orResult);

        assertThat(xorFunction.test(100d,100d,100d))
                .isEqualTo(xorResult);
    }
    ...
    public void testIsEqual() throws Throwable  {
        ...
        //then
        assertThat(equals.test(1d,1d,1d))
                .isTrue();

        assertThat(equals.test(0d,0d,0d))
                .isFalse();
    }
    ...
    @Test
    public void testTriDblPredCompose() throws Throwable {
        ...
        //when
        LTriPredicate<Integer,Integer,Integer> function = sutO.triDblPredCompose(before1,before2,before3);
    ...
    public void testToString() throws Throwable {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LTriDblPredicate: boolean test(double a1,double a2,double a3)");
    }
