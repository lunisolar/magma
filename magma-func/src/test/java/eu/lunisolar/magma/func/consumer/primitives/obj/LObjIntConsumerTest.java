...
public class LObjIntConsumerTest<T,X extends ParseException> {
    ...
    private LObjIntConsumer<T> sutAlwaysThrowingUnckeck = LObjIntConsumer.l((T a1,int a2) -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LObjIntPair<T>,LTuple.Void,RuntimeException> theCall = sut;
    ...
    public void testLMethod() throws X {
        assertThat(LObjIntConsumer.l((Object a1,int a2) -> Function4U.doNothing() ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LObjIntConsumerX<T,ParseException> sutThrowing = LObjIntConsumerX.lX((T a1,int a2) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LObjIntConsumer<T> sutThrowing = LObjIntConsumer.l((T a1,int a2) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LObjIntConsumer<T> wrapped = sutThrowing.handleObjIntCons(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LObjIntConsumer<T> wrapped = sutThrowing.handleObjIntCons(h -> Function4U.doNothing());
    ...
    public void testAndThen() throws X {
        ...
        LObjIntConsumer<Integer > thenFunction = (Integer a1,int a2) -> {
    ...
    public void testHandleObjIntCons() throws X {
        ...
        // when
        LObjIntConsumer<T> wrapped = sutThrowing.handleObjIntCons(h -> {
    ...
    private void variant1(int a2,T a1) {
    }

    @Test
    public void compilerSubstituteVariant1() {
        LObjIntConsumer lambda = LObjIntConsumer./*<T>*/l1(this::variant1);
    ...
    @Test void safeCompiles() {
        LObjIntConsumer r1 = LObjIntConsumer.safe(sut);
        LObjIntConsumerX r2 = LObjIntConsumer.safe(sut);
        ObjIntConsumer r3 = LObjIntConsumer.safe(sut);
    }
    ...
    @Test  void safeSupplierPropagates() {
        LSupplier<LObjIntConsumer<T>> supplier = ()->sut;
    ...
    @Test  void safeSupplierCompiles() {
        LSupplier<LObjIntConsumer<T>> r1 = LObjIntConsumer.safeSupplier(()->sut);
        Supplier<LObjIntConsumer<T>> r2 = LObjIntConsumer.safeSupplier(()->sut);
    }
