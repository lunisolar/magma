...
public class LBoolToCharFunctionTest<X extends ParseException> {
    ...
    private LBoolToCharFunction sutAlwaysThrowingUnckeck = LBoolToCharFunction.l(b -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBoolToCharFunction: char doApplyAsChar(boolean b)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LBoolToCharFunction.l(b -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LBoolToCharFunctionX<ParseException> sutThrowing = LBoolToCharFunctionX.lX(b -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LBoolToCharFunction sutThrowing = LBoolToCharFunction.l(b -> {
...
@Test
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBoolToCharFunction: char doApplyAsChar(boolean b)");
    }
