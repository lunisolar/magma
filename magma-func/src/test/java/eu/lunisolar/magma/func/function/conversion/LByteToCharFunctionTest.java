...
public class LByteToCharFunctionTest<X extends ParseException> {
    ...
    private LByteToCharFunction sutAlwaysThrowingUnckeck = LByteToCharFunction.l(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LByteSingle,Character,RuntimeException> theCall = sut;
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LByteToCharFunction: char doApplyAsChar(byte a1)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LByteToCharFunction.l(a1 -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LByteToCharFunctionX<ParseException> sutThrowing = LByteToCharFunctionX.lX(a1 -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LByteToCharFunction sutThrowing = LByteToCharFunction.l(a1 -> {
...
@Test
    ...
    public void testbyteToCharFuncComposeByte() throws X {
        ...
        //when
        LByteToCharFunction function = sutO.byteToCharFuncComposeByte(before1);
    ...
    public void testbyteToCharFuncCompose() throws X {
        ...
        //when
        LToCharFunction<Integer > function = sutO.byteToCharFuncCompose(before1);
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LByteToCharFunction: char doApplyAsChar(byte a1)");
    }
    ...
    @Test void safeCompiles() {
        LByteToCharFunction r1 = LByteToCharFunction.safe(sut);
        LByteToCharFunctionX r2 = LByteToCharFunction.safe(sut);
    }
    ...
    @Test  void safeSupplierCompiles() {
        LSupplier<LByteToCharFunction> r1 = LByteToCharFunction.safeSupplier(()->sut);
    }
