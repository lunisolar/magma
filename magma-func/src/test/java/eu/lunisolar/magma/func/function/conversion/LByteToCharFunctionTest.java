...
public class LByteToCharFunctionTest<X extends ParseException> {
    ...
    public void testLMethod() throws ParseException {
        assertThat(LByteToCharFunction.l((byte b) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LByteToCharFunctionX<ParseException> sutThrowing = LByteToCharFunctionX.lX((byte b) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LByteToCharFunction sutThrowing = LByteToCharFunction.l((byte b) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LByteToCharFunction wrapped = LByteToCharFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        LByteToCharFunction sutO = (byte b) -> {
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LByteToCharFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
