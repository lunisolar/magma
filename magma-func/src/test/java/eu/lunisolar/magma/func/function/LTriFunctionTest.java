...
public class LTriFunctionTest<T1,T2,T3,R,X extends ParseException> {
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (LTriFunction: R doApply(T1 t1,T2 t2,T3 t3)).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LTriFunction: R doApply(T1 t1,T2 t2,T3 t3)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LTriFunction.l((Object t1,Object t2,Object t3) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LTriFunctionX<T1,T2,T3,R,ParseException> sutThrowing = LTriFunctionX.lX((T1 t1,T2 t2,T3 t3) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LTriFunction<T1,T2,T3,R> wrapped = LTriFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfrom() throws ParseException {
        ...
        LTriFunction<Integer ,Integer ,Integer ,Integer > sutO = (Integer t1,Integer t2,Integer t3) -> {
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LTriFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LTriFunctionX.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LTriFunction<T1,T2,T3,R> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LTriFunction: R doApply(T1 t1,T2 t2,T3 t3)");
    }
