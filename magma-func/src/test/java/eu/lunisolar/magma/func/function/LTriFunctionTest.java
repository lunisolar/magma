...
public class LTriFunctionTest<T1,T2,T3,R> {
    ...
    public void compilerSubstituteVariantLObj0Obj2Obj1Func() {
        ...
        Assert.assertTrue(lambda instanceof LTriFunction.LObj0Obj2Obj1Func);
    }
    ...
    public void compilerSubstituteVariantLObj1BiObj2Func() {
        ...
        Assert.assertTrue(lambda instanceof LTriFunction.LObj1BiObj2Func);
    }
    ...
    public void compilerSubstituteVariantLObj1Obj2Obj0Func() {
        ...
        Assert.assertTrue(lambda instanceof LTriFunction.LObj1Obj2Obj0Func);
    }
    ...
    public void compilerSubstituteVariantLObj2Obj0Obj1Func() {
        ...
        Assert.assertTrue(lambda instanceof LTriFunction.LObj2Obj0Obj1Func);
    }
    ...
    public void compilerSubstituteVariantLBiObj1Obj0Func() {
        ...
        Assert.assertTrue(lambda instanceof LTriFunction.LBiObj1Obj0Func);
    }
