...
public class LConsumerXTest<T,X extends ParseException> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LConsumerX<T,X> wrapped = LConsumerX.wrapException(sutThrowing, UnsupportedOperationException.class, t -> {
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LConsumerX<T,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
