...
public class CharBinaryOperatorXTest<X extends ParseException> {
    ...
    private CharBinaryOperatorX<X> sut = new CharBinaryOperatorX(){
        public  char applyAsChar(char c1,char c2) throws ParseException {
            return testValue;
        }
    };

    private CharBinaryOperator opposite = new CharBinaryOperator(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("CharBinaryOperatorX: char applyAsChar(char c1,char c2) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(CharBinaryOperatorX.lX((char c1,char c2) -> testValue ))
            .isInstanceOf(CharBinaryOperatorX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(CharBinaryOperatorX.wrapX(opposite))
            .isInstanceOf(CharBinaryOperatorX.class);
    }
    ...
    public void testMin() throws ParseException {
        ...
        //when
        CharBinaryOperatorX<X> min = CharBinaryOperatorX.min();
    ...
    public void testMax() throws ParseException {
        ...
        //when
        CharBinaryOperatorX<X> max = CharBinaryOperatorX.max();
    ...
    public void testfromChar() throws ParseException {
        ...
        CharBinaryOperatorX<X> sutO = (char c1,char c2) -> {
        ...
        //when
        CharBinaryOperatorX<X> function = sutO.fromChar(before1,before2);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        CharBinaryOperatorX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("CharBinaryOperatorX: char applyAsChar(char c1,char c2) throws X");
    }
