...
public class BiObjFloatPredicateTest<T1,T2,X extends ParseException> {
    ...
    private BiObjFloatPredicate<T1,T2> sut = new BiObjFloatPredicate(){
        public  boolean test(Object t1,Object t2, float f)  {
            return testValue;
        }
    };

    private BiObjFloatPredicateX<T1,T2,X> opposite = new BiObjFloatPredicateX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("BiObjFloatPredicate: boolean test(T1 t1,T2 t2, float f)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(BiObjFloatPredicate.l((Object t1,Object t2, float f) -> testValue ))
            .isInstanceOf(BiObjFloatPredicate.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(BiObjFloatPredicate.wrap(opposite))
            .isInstanceOf(BiObjFloatPredicate.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        BiObjFloatPredicate<T1,T2> wrapped = BiObjFloatPredicate.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        BiObjFloatPredicateX<T1,T2,ParseException> sutThrowing = BiObjFloatPredicateX.lX((T1 t1,T2 t2, float f) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        BiObjFloatPredicate<T1,T2> sutThrowing = BiObjFloatPredicate.l((T1 t1,T2 t2, float f) -> {
            throw new UnsupportedOperationException();
        });

        // when
        BiObjFloatPredicate<T1,T2> wrapped = BiObjFloatPredicate.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws ParseException {
        ...
        //given
        BiObjFloatPredicate<T1,T2> fun1 = BiObjFloatPredicate.l((T1 t1,T2 t2, float f) -> f1Result);
        BiObjFloatPredicate<T1,T2> fun2 = BiObjFloatPredicate.l((T1 t1,T2 t2, float f) -> f2Result);

        //when
        BiObjFloatPredicate<T1,T2> andFunction = fun1.and(fun2);
        BiObjFloatPredicate<T1,T2> orFunction = fun1.or(fun2);
        BiObjFloatPredicate<T1,T2> xorFunction = fun1.xor(fun2);
    ...
    public void isEqual() throws ParseException  {
        //when
        BiObjFloatPredicate<T1,T2> equals = BiObjFloatPredicate.isEqual((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),(float)100);
    ...
    public void testfromFloat() throws ParseException {
        ...
        BiObjFloatPredicate<Integer ,Integer > sutO = (Integer t1,Integer t2, float f) -> {
        ...
        //when
        BiObjFloatPredicate<Integer ,Integer > function = sutO.fromFloat(before1,before2,before3);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        BiObjFloatPredicate<T1,T2> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("BiObjFloatPredicate: boolean test(T1 t1,T2 t2, float f)");
    }
