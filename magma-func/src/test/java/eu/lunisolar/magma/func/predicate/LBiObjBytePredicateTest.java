...
public class LBiObjBytePredicateTest<T1,T2> {
    ...
    public void compilerSubstituteVariantLObj0Byte2Obj1Pred() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjBytePredicate.LObj0Byte2Obj1Pred);
    }
    ...
    public void compilerSubstituteVariantLObj1Obj0Byte2Pred() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjBytePredicate.LObj1Obj0Byte2Pred);
    }
    ...
    public void compilerSubstituteVariantLObj1Byte2Obj0Pred() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjBytePredicate.LObj1Byte2Obj0Pred);
    }
    ...
    public void compilerSubstituteVariantLByte2Obj0Obj1Pred() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjBytePredicate.LByte2Obj0Obj1Pred);
    }
    ...
    public void compilerSubstituteVariantLByte2Obj1Obj0Pred() {
        ...
        Assert.assertTrue(lambda instanceof LBiObjBytePredicate.LByte2Obj1Obj0Pred);
    }
