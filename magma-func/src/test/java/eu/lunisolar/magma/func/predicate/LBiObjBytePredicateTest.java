...
public class LBiObjBytePredicateTest<T1,T2,X extends ParseException> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBiObjBytePredicate: boolean test(T1 t1,T2 t2, byte b)");
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LBiObjBytePredicate<T1,T2> wrapped = LBiObjBytePredicate.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        //when
        LBiObjBytePredicate<Integer ,Integer > function = sutO.fromByte(before1,before2,before3);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LBiObjBytePredicate<T1,T2> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBiObjBytePredicate: boolean test(T1 t1,T2 t2, byte b)");
    }
