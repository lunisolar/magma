...
public class IntUnaryOperatorXTest<X extends ParseException> {
    ...
    private IntUnaryOperatorX<X> sut = new IntUnaryOperatorX(){
        public  int applyAsInt(int i) throws ParseException {
            return testValue;
        }
    };

    private IntUnaryOperator opposite = new IntUnaryOperator(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("IntUnaryOperatorX: int applyAsInt(int i) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(IntUnaryOperatorX.lX((int i) -> testValue ))
            .isInstanceOf(IntUnaryOperatorX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(IntUnaryOperatorX.wrapX(opposite))
            .isInstanceOf(IntUnaryOperatorX.class);
    }

    @Test
    public void testWrapStdMethod() throws ParseException {
        assertThat(IntUnaryOperatorX.wrapStd(jre))
            .isInstanceOf(IntUnaryOperatorX.class);
    }
    ...
    public void testfromInt() throws ParseException {
        ...
        IntUnaryOperatorX<X> sutO = (int i) -> {
        ...
        //when
        IntUnaryOperatorX<X> function = sutO.fromInt(before1);
    ...
    public void identity() throws ParseException {
        IntUnaryOperatorX<X> identityFunction = IntUnaryOperatorX.identity();
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        IntUnaryOperatorX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("IntUnaryOperatorX: int applyAsInt(int i) throws X");
    }
