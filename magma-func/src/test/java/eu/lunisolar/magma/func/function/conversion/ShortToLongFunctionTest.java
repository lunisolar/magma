...
public class ShortToLongFunctionTest<X extends ParseException> {
    ...
    private ShortToLongFunction sut = new ShortToLongFunction(){
        public  long applyAsLong(short s)  {
            return testValue;
        }
    };

    private ShortToLongFunctionX<X> opposite = new ShortToLongFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ShortToLongFunction: long applyAsLong(short s)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(ShortToLongFunction.l((short s) -> testValue ))
            .isInstanceOf(ShortToLongFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(ShortToLongFunction.wrap(opposite))
            .isInstanceOf(ShortToLongFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        ShortToLongFunction wrapped = ShortToLongFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        ShortToLongFunctionX<ParseException> sutThrowing = ShortToLongFunctionX.lX((short s) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        ShortToLongFunction sutThrowing = ShortToLongFunction.l((short s) -> {
            throw new UnsupportedOperationException();
        });

        // when
        ShortToLongFunction wrapped = ShortToLongFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromShort() throws ParseException {
        ...
        ShortToLongFunction sutO = (short s) -> {
        ...
        //when
        ShortToLongFunction function = sutO.fromShort(before1);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ShortToLongFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ShortToLongFunction: long applyAsLong(short s)");
    }
