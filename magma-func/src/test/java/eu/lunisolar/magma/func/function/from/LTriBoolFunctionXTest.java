...
public class LTriBoolFunctionXTest<R,X extends ParseException> {
    ...
    private LTriBoolFunctionX<Integer,X> sut = new LTriBoolFunctionX<Integer,X>(){
        public @Nullable Integer doApply(boolean a1,boolean a2,boolean a3)  throws X {
            return testValue;
        }
    };

    private LTriBoolFunction<Integer> opposite = new LTriBoolFunction<Integer>(){
        public @Nullable Integer doApply(boolean a1,boolean a2,boolean a3)  {
            return testValue;
        }
    };

    private LTriBoolFunctionX<Integer,X> sutNull = new LTriBoolFunctionX<Integer,X>(){
        public @Nullable Integer doApply(boolean a1,boolean a2,boolean a3)  throws X {
            return null;
        }
    };
    ...
    private LTriBoolFunctionX<Integer,ParseException> sutAlwaysThrowing = LTriBoolFunctionX.lX((a1,a2,a3) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LTriBoolFunctionX<Integer,RuntimeException> sutAlwaysThrowingUnchecked = LTriBoolFunctionX.lX((a1,a2,a3) -> {
    ...
    public void testLXMethod() throws X {
        assertThat(LTriBoolFunctionX.lX((a1,a2,a3) -> testValue ))
    ...
    public void testHandlingDoApplyMethodWrapsTheException() throws X {
        ...
        // when
        LTriBoolFunctionX<Integer,RuntimeException> wrapped = sutThrowing.handleTriBoolFuncX(handler -> handler
    ...
    @Test
    public void testHandleTriBoolFuncXMethodDoNotWrapsOtherExceptionIf() throws X {
        ...
        // when
        LTriBoolFunctionX<Integer,X> wrapped = sutThrowing.handleTriBoolFuncX(handler -> handler
                .wrapIf(UnsupportedOperationException.class::isInstance,IllegalArgumentException::new,  EXCEPTION_WAS_WRAPPED)
...
@Test
    public void testHandleTriBoolFuncXMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleTriBoolFuncXMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LTriBoolFunctionX<Integer,X> wrapped = sutThrowing.handleTriBoolFuncX(h -> Function4U.doNothing());
    ...
    public void testTriBoolFuncComposeBool() throws X {
        ...
        LTriBoolFunctionX<Integer,X> sutO = (a1,a2,a3) -> {
        ...
        //when
        LTriBoolFunctionX<Integer,X> function = sutO.triBoolFuncComposeBool(before1,before2,before3);
    ...
    public void testHandleTriBoolFunc() throws X {
        ...
        // when
        LTriBoolFunctionX<Integer,X> wrapped = sutThrowing.handleTriBoolFuncX(h -> {
    ...
    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LTriBoolFunctionX<Integer,X>,Y> supplier = ()->sut;
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LTriBoolFunctionX<Integer,X>,Y> r1 = LTriBoolFunctionX.safeSupplier(()->sut);  //NOSONAR
    }
