...
public class LQuadFunctionTest<T1,T2,T3,T4,R> {
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.apply(100,100,100,100), testValue);
    }
    ...
    public void testNonNullApply() throws Throwable {
            Assert.assertSame(sut.nonNullApply(100,100,100,100), testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LQuadFunction: R apply(T1 a1,T2 a2,T3 a3,T4 a4)");
    }

    @Test
    public void testQuadFuncMethod() throws Throwable {
        Assert.assertTrue(LQuadFunction.quadFunc((a1,a2,a3,a4) -> testValue ) instanceof LQuadFunction);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LQuadFunction: R apply(T1 a1,T2 a2,T3 a3,T4 a4)"));
