...
public class LBiCharConsumerXTest<X extends ParseException> {
    ...
    private LBiCharConsumerX<X> sut = new LBiCharConsumerX(){
        public  void doAccept(char a1,char a2) throws ParseException {
    ...
    private LBiCharConsumerX<ParseException> sutAlwaysThrowing = LBiCharConsumerX.lX((char a1,char a2) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiCharConsumerX<RuntimeException> sutAlwaysThrowingUnckeck = LBiCharConsumerX.lX((char a1,char a2) -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LCharPair,LTuple.Void,X> theCall = sut;
    ...
    public void testLXMethod() throws X {
        assertThat(LBiCharConsumerX.lX((char a1,char a2) -> Function4U.doNothing() ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LBiCharConsumerX<X> sutThrowing = LBiCharConsumerX.lX((char a1,char a2) -> {
...
@Test
    ...
    public void testAndThen() throws X {
        ...
        LBiCharConsumerX<X> thenFunction = (char a1,char a2) -> {
    ...
    public void compilerSubstituteVariant1() {
        LBiCharConsumerX lambda = LBiCharConsumerX./*<X>*/lX1(this::variant1);
    ...
    @Test void safeCompiles() {
        LBiCharConsumerX r1 = LBiCharConsumerX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LBiCharConsumerX<X>,Y> r1 = LBiCharConsumerX.safeSupplier(()->sut);
    }
