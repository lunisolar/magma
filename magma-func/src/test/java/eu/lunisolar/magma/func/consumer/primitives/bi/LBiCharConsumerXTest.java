...
public class LBiCharConsumerXTest<X extends ParseException> {
    ...
    private LBiCharConsumerX<ParseException> sutAlwaysThrowing = LBiCharConsumerX.lX((char c1,char c2) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiCharConsumerX<RuntimeException> sutAlwaysThrowingUnckeck = LBiCharConsumerX.lX((char c1,char c2) -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBiCharConsumerX: void doAccept(char c1,char c2) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LBiCharConsumerX.lX((char c1,char c2) -> Function4U.doNothing() ))
...
@Test
    ...
    public void testbiCharConsComposeChar() throws X {
        ...
        LBiCharConsumerX<X> sutO = (char c1,char c2) -> {
    ...
    public void testAndThen() throws X {
        ...
        LBiCharConsumerX<X> thenFunction = (char c1,char c2) -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBiCharConsumerX: void doAccept(char c1,char c2) throws X");
    }
