...
public class LTriLongPredicateTest {
    ...
    private LTriLongPredicate sut = new LTriLongPredicate(){
        public  boolean testX(long a1,long a2,long a3)  {
            return testValue;
        }
    };
    ...
    private LTriLongPredicate sutAlwaysThrowing = LTriLongPredicate.triLongPred((a1,a2,a3) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LTriLongPredicate sutAlwaysThrowingUnchecked = LTriLongPredicate.triLongPred((a1,a2,a3) -> {
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws Throwable {
        ...
        //given
        LTriLongPredicate fun1 = LTriLongPredicate.triLongPred((a1,a2,a3) -> f1Result);
        LTriLongPredicate fun2 = LTriLongPredicate.triLongPred((a1,a2,a3) -> f2Result);

        //when
        LTriLongPredicate andFunction = fun1.and(fun2);
        LTriLongPredicate orFunction = fun1.or(fun2);
    ...
    public void testCompose() throws Throwable {
        ...
        //when
        LTriLongPredicate function = sutO.compose(before1,before2,before3);
    ...
    @Test
    public void testTriLongPredCompose() throws Throwable {
        ...
        //when
        LTriPredicate<Integer,Integer,Integer> function = sutO.triLongPredCompose(before1,before2,before3);
    ...
    @Test
    public void testBoolToTriLongFunc0() throws Throwable  {
        ...
        //when
        LTriLongFunction<Integer> function = sutO.boolToTriLongFunc(thenFunction);
    ...
    @Test
    public void testBoolToLongTernaryOp1() throws Throwable  {
        ...
        //when
        LLongTernaryOperator function = sutO.boolToLongTernaryOp(thenFunction);
    ...
    @Test
    public void testBoolToTriLongPred2() throws Throwable  {
        ...
        //when
        LTriLongPredicate function = sutO.boolToTriLongPred(thenFunction);
    ...
    public void testShove() {
        ...
        // given
        LTriLongPredicate sutThrowing = LTriLongPredicate.triLongPred((a1,a2,a3) -> {
            throw new UnsupportedOperationException();
        });

        // when
        sutThrowing.shovingTest(100L,100L,100L);
    }
