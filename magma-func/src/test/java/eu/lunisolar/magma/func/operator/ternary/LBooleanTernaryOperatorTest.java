...
public class LBooleanTernaryOperatorTest<X extends ParseException> {
    ...
    public void testLMethod() throws ParseException {
        assertThat(LBooleanTernaryOperator.l((boolean b1,boolean b2,boolean b3) -> testValue ))
            .isInstanceOf(LBooleanTernaryOperator.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(LBooleanTernaryOperator.wrap(opposite))
            .isInstanceOf(LBooleanTernaryOperator.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        LBooleanTernaryOperator wrapped = LBooleanTernaryOperator.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LBooleanTernaryOperatorX<ParseException> sutThrowing = LBooleanTernaryOperatorX.lX((boolean b1,boolean b2,boolean b3) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        LBooleanTernaryOperator wrapped = LBooleanTernaryOperator.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testAndOrXor(final boolean f1Result, final boolean f2Result, final boolean andResult, final boolean orResult, final boolean xorResult) throws ParseException {
        ...
        //given
        LBooleanTernaryOperator fun1 = LBooleanTernaryOperator.l((boolean b1,boolean b2,boolean b3) -> f1Result);
        LBooleanTernaryOperator fun2 = LBooleanTernaryOperator.l((boolean b1,boolean b2,boolean b3) -> f2Result);

        //when
        LBooleanTernaryOperator andFunction = fun1.and(fun2);
        LBooleanTernaryOperator orFunction = fun1.or(fun2);
    ...
    public void testfromBoolean() throws ParseException {
        ...
        LBooleanTernaryOperator sutO = (boolean b1,boolean b2,boolean b3) -> {
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LBooleanTernaryOperator wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
