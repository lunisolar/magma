...
public class LongToByteFunctionTest<X extends ParseException> {
    ...
    private LongToByteFunction sut = new LongToByteFunction(){
        public  byte applyAsByte(long l)  {
            return testValue;
        }
    };

    private LongToByteFunctionX<X> opposite = new LongToByteFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LongToByteFunction: byte applyAsByte(long l)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LongToByteFunction.l((long l) -> testValue ))
            .isInstanceOf(LongToByteFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(LongToByteFunction.wrap(opposite))
            .isInstanceOf(LongToByteFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        // given
        LongToByteFunctionX<X> sutThrowing = LongToByteFunctionX.lX((long l) -> {
            throw new UnsupportedOperationException(ORIGINAL_MESSAGE);
        });

        // when
        LongToByteFunction wrapped = LongToByteFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LongToByteFunctionX<ParseException> sutThrowing = LongToByteFunctionX.lX((long l) -> {
    ...
    public void testfromLong() throws ParseException {
        ...
        LongToByteFunction sutO = (long l) -> {
        ...
        //when
        LongToByteFunction function = sutO.fromLong(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LongToByteFunction.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LongToByteFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LongToByteFunction: byte applyAsByte(long l)");
    }
