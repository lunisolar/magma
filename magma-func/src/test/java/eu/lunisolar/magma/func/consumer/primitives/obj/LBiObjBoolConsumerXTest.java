...
public class LBiObjBoolConsumerXTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjBoolConsumerX<T1,T2,X> sut = new LBiObjBoolConsumerX(){
        public  void doAccept(Object a1,Object a2,boolean a3) throws ParseException {
            Function4U.doNothing();
        }
    };

    private LBiObjBoolConsumer<T1,T2> opposite = new LBiObjBoolConsumer(){
        public  void doAccept(Object a1,Object a2,boolean a3)  {
            Function4U.doNothing();
        }
    };
    ...
    private LBiObjBoolConsumerX<T1,T2,ParseException> sutAlwaysThrowing = LBiObjBoolConsumerX.lX((T1 a1,T2 a2,boolean a3) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiObjBoolConsumerX<T1,T2,RuntimeException> sutAlwaysThrowingUnckeck = LBiObjBoolConsumerX.lX((T1 a1,T2 a2,boolean a3) -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LBiObjBoolTriple<T1,T2>,LTuple.Void,X> theCall = sut;
    ...
    public void testNestingDoAcceptChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoAccept((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),true);
    ...
    public void testShovingDoAcceptChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoAccept((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),true);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testLXMethod() throws X {
        assertThat(LBiObjBoolConsumerX.lX((Object a1,Object a2,boolean a3) -> Function4U.doNothing() ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LBiObjBoolConsumerX<T1,T2,X> sutThrowing = LBiObjBoolConsumerX.lX((T1 a1,T2 a2,boolean a3) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LBiObjBoolConsumerX<T1,T2,X> wrapped = sutThrowing.handleBiObjBoolConsX(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LBiObjBoolConsumerX<T1,T2,X> wrapped = sutThrowing.handleBiObjBoolConsX(h -> Function4U.doNothing());
    ...
    @Test
    public void testbiObjBoolConsComposeBoolean() throws X {

        final ThreadLocal<Boolean> mainFunctionCalled = ThreadLocal.withInitial(()-> false);
        final AtomicInteger beforeCalls = new AtomicInteger(0);

        //given (+ some assertions)
        LBiObjBoolConsumerX<Integer ,Integer ,X> sutO = (Integer a1,Integer a2,boolean a3) -> {
        ...
        //when
        LBiObjBoolConsumerX<Integer ,Integer ,X> function = sutO.biObjBoolConsComposeBoolean(before1,before2,before3);
    ...
    public void testAndThen() throws X {
        ...
        LBiObjBoolConsumerX<Integer ,Integer ,X> thenFunction = (Integer a1,Integer a2,boolean a3) -> {
    ...
    public void testHandleBiObjBoolCons() throws X {
        ...
        // when
        LBiObjBoolConsumerX<T1,T2,X> wrapped = sutThrowing.handleBiObjBoolConsX(h -> {
    ...
    private void variant1(T1 a1,boolean a3,T2 a2) {
    }

    @Test
    public void compilerSubstituteVariant1() {
        LBiObjBoolConsumerX lambda = LBiObjBoolConsumerX./*<T1,T2,X>*/lX1(this::variant1);

        assertThat(lambda).isInstanceOf(LBiObjBoolConsumerX.V1.class);
    }


    private void variant2(T2 a2,T1 a1,boolean a3) {
    }

    @Test
    public void compilerSubstituteVariant2() {
        LBiObjBoolConsumerX lambda = LBiObjBoolConsumerX./*<T1,T2,X>*/lX2(this::variant2);

        assertThat(lambda).isInstanceOf(LBiObjBoolConsumerX.V2.class);
    }


    private void variant3(T2 a2,boolean a3,T1 a1) {
    }

    @Test
    public void compilerSubstituteVariant3() {
        LBiObjBoolConsumerX lambda = LBiObjBoolConsumerX./*<T1,T2,X>*/lX3(this::variant3);

        assertThat(lambda).isInstanceOf(LBiObjBoolConsumerX.V3.class);
    }


    private void variant4(boolean a3,T1 a1,T2 a2) {
    }

    @Test
    public void compilerSubstituteVariant4() {
        LBiObjBoolConsumerX lambda = LBiObjBoolConsumerX./*<T1,T2,X>*/lX4(this::variant4);

        assertThat(lambda).isInstanceOf(LBiObjBoolConsumerX.V4.class);
    }


    private void variant5(boolean a3,T2 a2,T1 a1) {
    }

    @Test
    public void compilerSubstituteVariant5() {
        LBiObjBoolConsumerX lambda = LBiObjBoolConsumerX./*<T1,T2,X>*/lX5(this::variant5);
    ...
    @Test void safeCompiles() {
        LBiObjBoolConsumerX r1 = LBiObjBoolConsumerX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LBiObjBoolConsumerX<T1,T2,X>,Y> supplier = ()->sut;
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LBiObjBoolConsumerX<T1,T2,X>,Y> r1 = LBiObjBoolConsumerX.safeSupplier(()->sut);
    }
