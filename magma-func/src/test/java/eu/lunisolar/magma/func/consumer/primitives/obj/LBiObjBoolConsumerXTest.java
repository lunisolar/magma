...
public class LBiObjBoolConsumerXTest<T1,T2,X extends ParseException> {
    ...
    private LBiObjBoolConsumerX<T1,T2,ParseException> sutAlwaysThrowing = LBiObjBoolConsumerX.lX((T1 t1,T2 t2, boolean b) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiObjBoolConsumerX<T1,T2,RuntimeException> sutAlwaysThrowingUnckeck = LBiObjBoolConsumerX.lX((T1 t1,T2 t2, boolean b) -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LBiObjBoolConsumerX: void doAccept(T1 t1,T2 t2, boolean b) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LBiObjBoolConsumerX.lX((Object t1,Object t2, boolean b) -> Function4U.doNothing() ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LBiObjBoolConsumerX<T1,T2,X> sutThrowing = LBiObjBoolConsumerX.lX((T1 t1,T2 t2, boolean b) -> {
...
@Test
    ...
    public void testbiObjBoolConsComposeBoolean() throws X {
        ...
        LBiObjBoolConsumerX<Integer ,Integer ,X> sutO = (Integer t1,Integer t2, boolean b) -> {
    ...
    public void testAndThen() throws X {
        ...
        LBiObjBoolConsumerX<Integer ,Integer ,X> thenFunction = (Integer t1,Integer t2, boolean b) -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LBiObjBoolConsumerX: void doAccept(T1 t1,T2 t2, boolean b) throws X");
    }
