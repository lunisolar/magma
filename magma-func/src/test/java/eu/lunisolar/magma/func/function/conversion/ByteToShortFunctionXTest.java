...
public class ByteToShortFunctionXTest<X extends ParseException> {
    ...
    private ByteToShortFunctionX<X> sut = new ByteToShortFunctionX(){
        public  short applyAsShort(byte b) throws ParseException {
            return testValue;
        }
    };

    private ByteToShortFunction opposite = new ByteToShortFunction(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ByteToShortFunctionX: short applyAsShort(byte b) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(ByteToShortFunctionX.lX((byte b) -> testValue ))
            .isInstanceOf(ByteToShortFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(ByteToShortFunctionX.wrapX(opposite))
            .isInstanceOf(ByteToShortFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        ByteToShortFunctionX<X> wrapped = ByteToShortFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        ByteToShortFunctionX<X> sutO = (byte b) -> {
        ...
        //when
        ByteToShortFunctionX<X> function = sutO.fromByte(before1);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        ByteToShortFunctionX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ByteToShortFunctionX: short applyAsShort(byte b) throws X");
    }
