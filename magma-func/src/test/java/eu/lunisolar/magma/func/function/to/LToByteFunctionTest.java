...
public class LToByteFunctionTest<T> {
    ...
    private LToByteFunction<Integer> sut = new LToByteFunction<Integer>(){
        public  byte applyAsByteX(Integer a)  {
            return testValue;
        }
    };
    ...
    public void testTheResult() throws Throwable {
         Assert.assertEquals(sut.applyAsByte(100), testValue);
    }
    ...
    public void testNonNullApplyAsByte() throws Throwable {
            Assert.assertEquals(sut.nonNullApplyAsByte(100), testValue);
    }
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LToByteFunction: byte applyAsByte(T a)");
    }

    @Test
    public void testToByteFuncMethod() throws Throwable {
        Assert.assertTrue(LToByteFunction.toByteFunc(a -> testValue ) instanceof LToByteFunction);
    ...
    public void testCompose() throws Throwable {
        ...
        LToByteFunction<Integer> sutO = a -> {
        ...
        //when
        LToByteFunction<Integer> function = sutO.compose(before);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LToByteFunction: byte applyAsByte(T a)"));
