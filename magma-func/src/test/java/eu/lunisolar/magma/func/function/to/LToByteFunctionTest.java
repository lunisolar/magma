...
public class LToByteFunctionTest<T,X extends ParseException> {
    ...
    private LToByteFunction<T> sutAlwaysThrowingUnckeck = LToByteFunction.l(a1 -> {
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LToByteFunction: byte doApplyAsByte(T a1)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LToByteFunction.l(a1 -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LToByteFunctionX<T,ParseException> sutThrowing = LToByteFunctionX.lX(a1 -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LToByteFunction<T> sutThrowing = LToByteFunction.l(a1 -> {
            throw new UnsupportedOperationException();
        });

        // when
        LToByteFunction<T> wrapped = sutThrowing.handleToByteFunc(handler -> handler
...
@Test
    ...
    public void testWrapExceptionMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LToByteFunction<T> wrapped = sutThrowing.handleToByteFunc(h -> Function4U.doNothing());
    ...
    public void testtoByteFuncCompose() throws X {
        ...
        LToByteFunction<Integer > sutO = a1 -> {
        ...
        //when
        LToByteFunction<Integer > function = sutO.toByteFuncCompose(before1);
    ...
    public void testHandleToByteFunc() throws X {
        ...
        // when
        LToByteFunction<T> wrapped = sutThrowing.handleToByteFunc(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LToByteFunction: byte doApplyAsByte(T a1)");
    }
    ...
    @Test  void safeSupplierCompiles() {
        LSupplier<LToByteFunction<T>> r1 = LToByteFunction.safeSupplier(()->sut);  //NOSONAR
    }
