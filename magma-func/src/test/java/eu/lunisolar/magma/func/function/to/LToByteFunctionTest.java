...
public class LToByteFunctionTest<T,X extends ParseException> {
    ...
    private LToByteFunction<T> sut = new LToByteFunction(){
        public  byte doApplyAsByte(Object t)  {
            return testValue;
        }
    };

    private LToByteFunctionX<T,X> opposite = new LToByteFunctionX(){
        public  byte doApplyAsByte(Object t) throws ParseException {
            return testValue;
        }
    };
    ...
    private LToByteFunction<T> sutAlwaysThrowingUnckeck = LToByteFunction.l((T t) -> {
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LToByteFunction: byte doApplyAsByte(T t)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LToByteFunction.l((Object t) -> testValue ))
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        LToByteFunction<T> wrapped = LToByteFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LToByteFunctionX<T,ParseException> sutThrowing = LToByteFunctionX.lX((T t) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LToByteFunction<T> sutThrowing = LToByteFunction.l((T t) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LToByteFunction<T> wrapped = LToByteFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfrom() throws ParseException {
        ...
        LToByteFunction<Integer > sutO = (Integer t) -> {
...
//
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LToByteFunction<T> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LToByteFunction: byte doApplyAsByte(T t)");
    }
