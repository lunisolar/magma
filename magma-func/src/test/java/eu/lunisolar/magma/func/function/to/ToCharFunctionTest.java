...
public class ToCharFunctionTest<T,X extends ParseException> {
    ...
    private ToCharFunction<T> sut = new ToCharFunction(){
        public  char applyAsChar(Object t)  {
            return testValue;
        }
    };

    private ToCharFunctionX<T,X> opposite = new ToCharFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ToCharFunction: char applyAsChar(T t)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(ToCharFunction.l((Object t) -> testValue ))
            .isInstanceOf(ToCharFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(ToCharFunction.wrap(opposite))
            .isInstanceOf(ToCharFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        ToCharFunction<T> wrapped = ToCharFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        ToCharFunctionX<T,ParseException> sutThrowing = ToCharFunctionX.lX((T t) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        ToCharFunction<T> sutThrowing = ToCharFunction.l((T t) -> {
            throw new UnsupportedOperationException();
        });

        // when
        ToCharFunction<T> wrapped = ToCharFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfrom() throws ParseException {
        ...
        ToCharFunction<Integer > sutO = (Integer t) -> {
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(ToCharFunction.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ToCharFunction<T> wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ToCharFunction: char applyAsChar(T t)");
    }
