...
public class ByteBiFunctionXTest<R,X extends ParseException> {
    ...
    private ByteBiFunctionX<R,X> sut = new ByteBiFunctionX(){
        public @Nullable Object  apply(byte b1,byte b2) throws ParseException {
            return testValue;
        }
    };

    private ByteBiFunction<R> opposite = new ByteBiFunction(){
        public @Nullable Object  apply(byte b1,byte b2)  {
            return testValue;
        }
    };

    private ByteBiFunctionX<R,X> sutNull = new ByteBiFunctionX(){
        public @Nullable Object  apply(byte b1,byte b2) throws ParseException {
            return null;
        }
    };
    ...
    @Test(expectedExceptions=NullPointerException.class, expectedExceptionsMessageRegExp="\\QEvaluated value by nonNull() method cannot be null (ByteBiFunctionX: R apply(byte b1,byte b2) throws X).\\E")
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ByteBiFunctionX: R apply(byte b1,byte b2) throws X");
    }

    @Test
    public void testLXMethod() throws ParseException {
        assertThat(ByteBiFunctionX.lX((byte b1,byte b2) -> testValue ))
            .isInstanceOf(ByteBiFunctionX.class);
    }

    @Test
    public void testWrapXMethod() throws ParseException {
        assertThat(ByteBiFunctionX.wrapX(opposite))
            .isInstanceOf(ByteBiFunctionX.class);
    }
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // when
        ByteBiFunctionX<R,X> wrapped = ByteBiFunctionX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        ByteBiFunctionX<Integer ,X> sutO = (byte b1,byte b2) -> {
        ...
        //when
        ByteBiFunctionX<Integer ,X> function = sutO.fromByte(before1,before2);
    ...
    public void testThen1() throws ParseException  {
        ...
        //when
        ByteBiConsumerX<X> function = sutO.then(thenFunction);
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        ByteBiFunctionX<R,X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ByteBiFunctionX: R apply(byte b1,byte b2) throws X");
    }
