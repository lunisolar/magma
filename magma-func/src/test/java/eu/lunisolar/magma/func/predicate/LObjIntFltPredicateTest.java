...
public class LObjIntFltPredicateTest<T> {
    ...
    private LObjIntFltPredicate<Integer> sut = new LObjIntFltPredicate<Integer>(){
        public  boolean doTestX(Integer a1,int a2,float a3)  {
            return testValue;
        }
    };
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LObjIntFltPredicate: boolean doTest(T a1,int a2,float a3)");
    }
    ...
    @Test
    public void testObjIntFltPredComposeIntFlt() throws Throwable {
        ...
        //when
        LObjIntFltPredicate<Integer> function = sutO.objIntFltPredComposeIntFlt(before1,before2,before3);
    ...
    public void testNesting() {
        assertThat(sut.nestingObjIntFltPred())
            .isSameAs(sut)
            .isInstanceOf(LObjIntFltPredicate.class);
    }
    ...
    public void testShoving() {
        assertThat(sut.shovingObjIntFltPred())
            .isSameAs(sut)
            .isInstanceOf(LObjIntFltPredicate.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingObjIntFltPred().doTest(100,100,100f);
    }
    ...
    public void testToString() throws Throwable {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LObjIntFltPredicate: boolean doTest(T a1,int a2,float a3)");
    }
    ...
    @Test void safeCompiles() {
        LObjIntFltPredicate r1 = LObjIntFltPredicate.safe(sut); //NOSONAR
    }

    @Test void safePropagates() {
        Object result = LObjIntFltPredicate.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LObjIntFltPredicate.safe(null);
        assertThat(result).isSameAs(LObjIntFltPredicate.objIntFltPred(LObjIntFltPredicate.safe()));
    }

    @Test  void safeSupplierPropagates() {
        LSupplier<LObjIntFltPredicate<Integer>> supplier = ()->sut;
        Object result = LObjIntFltPredicate.safeSupplier(supplier);
        assertThat(result).isSameAs(supplier);
    }

    @Test  void safeSupplierProtectsAgainstNpe() {
        Object result = LObjIntFltPredicate.safeSupplier(null);
        assertThat(result).isSameAs(LObjIntFltPredicate.safeSupplier());
    }

    @Test  void safeSupplierCompiles() {
        LSupplier<LObjIntFltPredicate<Integer>> r1 = LObjIntFltPredicate.safeSupplier(()->sut);  //NOSONAR
    }
