...
public class LTieConsumerTest<T1,T2> {
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LTieConsumer: void accept(T1 a1,int a2,T2 a3)");
    }

    @Test
    public void testTieConsMethod() throws Throwable {
        Assert.assertTrue(LTieConsumer.tieCons(LTieConsumer::doNothing) instanceof LTieConsumer);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LTieConsumer: void accept(T1 a1,int a2,T2 a3)"));
