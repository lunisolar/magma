...
public class LShortUnaryOperatorXTest<X extends ParseException> {
    ...
    private LShortUnaryOperatorX<X> sut = new LShortUnaryOperatorX<X>(){
    ...
    private LShortUnaryOperatorX<ParseException> sutAlwaysThrowing = LShortUnaryOperatorX.lX(a -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LShortUnaryOperatorX<RuntimeException> sutAlwaysThrowingUnchecked = LShortUnaryOperatorX.lX(a -> {
    ...
    public void testNestingDoApplyAsShortChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.nestingDoApplyAsShort((short)100);
    ...
    public void testShovingDoApplyAsShortChecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowing.shovingDoApplyAsShort((short)100);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LShortUnaryOperatorX: short doApplyAsShort(short a) throws X");
    }

    @Test
    public void testLXMethod() throws X {
        assertThat(LShortUnaryOperatorX.lX(a -> testValue ))
            .isInstanceOf(LShortUnaryOperatorX.class);
    }

    @Test
    public void testWrapXMethod() throws X {
        assertThat(LShortUnaryOperatorX.wrapX(opposite))
            .isInstanceOf(LShortUnaryOperatorX.class);
    }
    ...
    public void testHandlingDoApplyAsShortMethodWrapsTheException() throws X {
        ...
        // when
        LShortUnaryOperatorX<RuntimeException> wrapped = sutThrowing.handleShortUnaryOpX(handler -> handler
    ...
    @Test
    public void testHandleShortUnaryOpXMethodDoNotWrapsOtherExceptionIf() throws X {
        ...
        // when
        LShortUnaryOperatorX<X> wrapped = sutThrowing.handleShortUnaryOpX(handler -> handler
                .wrapIf(UnsupportedOperationException.class::isInstance,IllegalArgumentException::new,  EXCEPTION_WAS_WRAPPED)
...
@Test
    public void testHandleShortUnaryOpXMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleShortUnaryOpXMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LShortUnaryOperatorX<X> wrapped = sutThrowing.handleShortUnaryOpX(h -> Function4U.doNothing());
    ...
    public void testShortUnaryOpComposeShort() throws X {
        ...
        //when
        LShortUnaryOperatorX<X> function = sutO.shortUnaryOpComposeShort(before);
    ...
    public void testShortUnaryOpCompose() throws X {
        ...
        //when
        LToShortFunctionX<Integer,X> function = sutO.shortUnaryOpCompose(before);
    ...
    public void identity() throws X {
        LShortUnaryOperatorX<X> identityFunction = LShortUnaryOperatorX.identity();
    ...
    public void testHandleShortUnaryOp() throws X {
        ...
        // when
        LShortUnaryOperatorX<X> wrapped = sutThrowing.handleShortUnaryOpX(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LShortUnaryOperatorX: short doApplyAsShort(short a) throws X");
    }
    ...
    @Test void safeCompiles() {
        LShortUnaryOperatorX r1 = LShortUnaryOperatorX.safe(sut); //NOSONAR
    }

    @Test void safePropagates() {
        Object result = LShortUnaryOperatorX.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LShortUnaryOperatorX.safe(null);
        assertThat(result).isSameAs(LShortUnaryOperatorX.lX(LShortUnaryOperatorX.safe()));
    }

    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LShortUnaryOperatorX<X>,Y> supplier = ()->sut;
        Object result = LShortUnaryOperatorX.safeSupplier(supplier);
        assertThat(result).isSameAs(supplier);
    }

    @Test <Y extends Throwable> void safeSupplierProtectsAgainstNpe() {
        Object result = LShortUnaryOperatorX.safeSupplier(null);
        assertThat(result).isSameAs(LShortUnaryOperatorX.safeSupplier());
    }

    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LShortUnaryOperatorX<X>,Y> r1 = LShortUnaryOperatorX.safeSupplier(()->sut);  //NOSONAR
    }
