...
public class LShortUnaryOperatorXTest<X extends ParseException> {
    ...
    private LShortUnaryOperatorX<ParseException> sutAlwaysThrowing = LShortUnaryOperatorX.lX((short s) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LShortUnaryOperatorX<RuntimeException> sutAlwaysThrowingUnckeck = LShortUnaryOperatorX.lX((short s) -> {
    ...
    public void testLXMethod() throws ParseException {
        assertThat(LShortUnaryOperatorX.lX((short s) -> testValue ))
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LShortUnaryOperatorX<X> sutThrowing = LShortUnaryOperatorX.lX((short s) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LShortUnaryOperatorX<X> wrapped = LShortUnaryOperatorX.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromShort() throws ParseException {
        ...
        LShortUnaryOperatorX<X> sutO = (short s) -> {
...
//
    ...
    public void testHandleX() throws ParseException {
        ...
        // when
        LShortUnaryOperatorX<X> wrapped = sutThrowing.handleX(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
