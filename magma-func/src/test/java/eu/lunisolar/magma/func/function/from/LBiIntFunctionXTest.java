...
public class LBiIntFunctionXTest<R,X extends ParseException> {
    ...
    private LBiIntFunctionX<R,ParseException> sutAlwaysThrowing = LBiIntFunctionX.lX((int a1,int a2) -> {
            throw new ParseException(ORIGINAL_MESSAGE, 0);
    });

    private LBiIntFunctionX<R,RuntimeException> sutAlwaysThrowingUnckeck = LBiIntFunctionX.lX((int a1,int a2) -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LIntPair,R,X> theCall = sut;
    ...
    public void testLXMethod() throws X {
        assertThat(LBiIntFunctionX.lX((int a1,int a2) -> testValue ))
...
@Test
    ...
    public void testbiIntFuncComposeInt() throws X {
        ...
        LBiIntFunctionX<Integer ,X> sutO = (int a1,int a2) -> {
    ...
    public void compilerSubstituteVariant1() {
        LBiIntFunctionX lambda = LBiIntFunctionX./*<R,X>*/lX1(this::variant1);
    ...
    @Test void safeCompiles() {
        LBiIntFunctionX r1 = LBiIntFunctionX.safe(sut);
    }
    ...
    @Test <Y extends Throwable> void safeSupplierPropagates() {
        LSupplierX<LBiIntFunctionX<R,X>,Y> supplier = ()->sut;
    ...
    @Test <Y extends Throwable> void safeSupplierCompiles() {
        LSupplierX<LBiIntFunctionX<R,X>,Y> r1 = LBiIntFunctionX.safeSupplier(()->sut);
    }
