...
public class ByteToCharFunctionTest<X extends ParseException> {
    ...
    private ByteToCharFunction sut = new ByteToCharFunction(){
        public  char applyAsChar(byte b)  {
            return testValue;
        }
    };

    private ByteToCharFunctionX<X> opposite = new ByteToCharFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("ByteToCharFunction: char applyAsChar(byte b)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(ByteToCharFunction.l((byte b) -> testValue ))
            .isInstanceOf(ByteToCharFunction.class);
    }

    @Test
    public void testWrapMethod() throws ParseException {
        assertThat(ByteToCharFunction.wrap(opposite))
            .isInstanceOf(ByteToCharFunction.class);
    }
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws ParseException {
        ...
        // when
        ByteToCharFunction wrapped = ByteToCharFunction.wrap(sutThrowing);
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        ByteToCharFunctionX<ParseException> sutThrowing = ByteToCharFunctionX.lX((byte b) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        ByteToCharFunction sutThrowing = ByteToCharFunction.l((byte b) -> {
            throw new UnsupportedOperationException();
        });

        // when
        ByteToCharFunction wrapped = ByteToCharFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromByte() throws ParseException {
        ...
        ByteToCharFunction sutO = (byte b) -> {
        ...
        //when
        ByteToCharFunction function = sutO.fromByte(before1);
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        ByteToCharFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("ByteToCharFunction: char applyAsChar(byte b)");
    }
