...
public class LTieFltConsumerTest<T> {
    ...
    private LTieFltConsumer<Integer> sut = new LTieFltConsumer<Integer>(){
        public  void doAcceptX(Integer a1,int a2,float a3)  {
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LTieFltConsumer: void doAccept(T a1,int a2,float a3)");
    }
    ...
    @Test
    public void testTieFltConsComposeIntFlt() throws Throwable {
        ...
        //when
        LTieFltConsumer<Integer> function = sutO.tieFltConsComposeIntFlt(before1,before2,before3);
    ...
    public void testNesting() {
        assertThat(sut.nestingTieFltCons())
            .isSameAs(sut)
            .isInstanceOf(LTieFltConsumer.class);
    }
    ...
    public void testShoving() {
        assertThat(sut.shovingTieFltCons())
            .isSameAs(sut)
            .isInstanceOf(LTieFltConsumer.class);
    }
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingTieFltCons().doAccept(100,100,100f);
    }
    ...
    public void testToString() throws Throwable {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LTieFltConsumer: void doAccept(T a1,int a2,float a3)");
    }
    ...
    @Test void safeCompiles() {
        LTieFltConsumer r1 = LTieFltConsumer.safe(sut); //NOSONAR
    }

    @Test void safePropagates() {
        Object result = LTieFltConsumer.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LTieFltConsumer.safe(null);
        assertThat(result).isSameAs(LTieFltConsumer.tieFltCons(LTieFltConsumer.safe()));
    }

    @Test  void safeSupplierPropagates() {
        LSupplier<LTieFltConsumer<Integer>> supplier = ()->sut;
        Object result = LTieFltConsumer.safeSupplier(supplier);
        assertThat(result).isSameAs(supplier);
    }

    @Test  void safeSupplierProtectsAgainstNpe() {
        Object result = LTieFltConsumer.safeSupplier(null);
        assertThat(result).isSameAs(LTieFltConsumer.safeSupplier());
    }

    @Test  void safeSupplierCompiles() {
        LSupplier<LTieFltConsumer<Integer>> r1 = LTieFltConsumer.safeSupplier(()->sut);  //NOSONAR
    }
