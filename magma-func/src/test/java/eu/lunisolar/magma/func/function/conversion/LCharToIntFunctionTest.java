...
public class LCharToIntFunctionTest<X extends ParseException> {
    ...
    private LCharToIntFunctionX<X> opposite = new LCharToIntFunctionX(){
        public  int doApplyAsInt(char a1) throws ParseException {
            return testValue;
        }
    };
    ...
    private LCharToIntFunction sutAlwaysThrowingUnckeck = LCharToIntFunction.l(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LCharSingle,Integer,RuntimeException> theCall = sut;
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LCharToIntFunction: int doApplyAsInt(char a1)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LCharToIntFunction.l(a1 -> testValue ))
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws X {
        // given
        LCharToIntFunctionX<X> sutThrowing = LCharToIntFunctionX.lX(a1 -> {
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LCharToIntFunctionX<ParseException> sutThrowing = LCharToIntFunctionX.lX(a1 -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws X {
        ...
        // given
        LCharToIntFunction sutThrowing = LCharToIntFunction.l(a1 -> {
...
@Test
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LCharToIntFunction: int doApplyAsInt(char a1)");
    }
