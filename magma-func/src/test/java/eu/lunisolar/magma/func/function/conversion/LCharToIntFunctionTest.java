...
public class LCharToIntFunctionTest<X extends ParseException> {
    ...
    private LCharToIntFunctionX<X> opposite = new LCharToIntFunctionX(){
    ...
    public void testFunctionalInterfaceDescription() throws ParseException {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LCharToIntFunction: int applyAsInt(char c)");
    }

    @Test
    public void testLMethod() throws ParseException {
        assertThat(LCharToIntFunction.l((char c) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LCharToIntFunctionX<ParseException> sutThrowing = LCharToIntFunctionX.lX((char c) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LCharToIntFunction sutThrowing = LCharToIntFunction.l((char c) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LCharToIntFunction wrapped = LCharToIntFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromChar() throws ParseException {
        ...
        LCharToIntFunction sutO = (char c) -> {
        ...
        //when
        LCharToIntFunction function = sutO.fromChar(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LCharToIntFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LCharToIntFunctionX.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LCharToIntFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
    ...
    public void testToString() throws ParseException {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LCharToIntFunction: int applyAsInt(char c)");
    }
