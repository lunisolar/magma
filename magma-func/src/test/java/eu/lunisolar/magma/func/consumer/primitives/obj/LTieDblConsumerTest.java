...
public class LTieDblConsumerTest<T> {
    ...
    public void testFunctionalInterfaceDescription() throws Throwable {
        Assert.assertEquals(sut.functionalInterfaceDescription(), "LTieDblConsumer: void accept(T a1,int a2,double a3)");
    }

    @Test
    public void testTieDblConsMethod() throws Throwable {
        Assert.assertTrue(LTieDblConsumer.tieDblCons(LTieDblConsumer::doNothing) instanceof LTieDblConsumer);
    ...
    public void testToString() throws Throwable {
        ...
        Assert.assertTrue(String.format("%s", sut).contains("LTieDblConsumer: void accept(T a1,int a2,double a3)"));
    ...
    public void compilerSubstituteVariantLObjDblIntCons() {
        ...
        Assert.assertTrue(lambda instanceof LTieDblConsumer.LObjDblIntCons);
    }
    ...
    public void compilerSubstituteVariantLIntObjDblCons() {
        ...
        Assert.assertTrue(lambda instanceof LTieDblConsumer.LIntObjDblCons);
    }
    ...
    public void compilerSubstituteVariantLIntDblObjCons() {
        ...
        Assert.assertTrue(lambda instanceof LTieDblConsumer.LIntDblObjCons);
    }
    ...
    public void compilerSubstituteVariantLDblObjIntCons() {
        ...
        Assert.assertTrue(lambda instanceof LTieDblConsumer.LDblObjIntCons);
    }
    ...
    public void compilerSubstituteVariantLDblIntObjCons() {
        ...
        Assert.assertTrue(lambda instanceof LTieDblConsumer.LDblIntObjCons);
    }
