...
public class LDoubleToFloatFunctionTest<X extends ParseException> {
    ...
    private LDoubleToFloatFunctionX<X> opposite = new LDoubleToFloatFunctionX(){
        public  float doApplyAsFloat(double a1) throws ParseException {
            return testValue;
        }
    };
    ...
    private LDoubleToFloatFunction sutAlwaysThrowingUnckeck = LDoubleToFloatFunction.l(a1 -> {
    ...
    public void testTupleCall() throws X {
        ...
        //FunctionalCall<LDoubleSingle,Float,RuntimeException> theCall = sut;
...
@Test
    ...
    @Test void safeCompiles() {
        LDoubleToFloatFunction r1 = LDoubleToFloatFunction.safe(sut);
        LDoubleToFloatFunctionX r2 = LDoubleToFloatFunction.safe(sut);
    }
    ...
    @Test  void safeSupplierCompiles() {
        LSupplier<LDoubleToFloatFunction> r1 = LDoubleToFloatFunction.safeSupplier(()->sut);
    }
