...
public class LDoubleToFloatFunctionTest<X extends ParseException> {
    ...
    public void testLMethod() throws ParseException {
        assertThat(LDoubleToFloatFunction.l((double d) -> testValue ))
    ...
    public void testWrapMethodWrapsCheckedException() throws ParseException {
        // given
        LDoubleToFloatFunctionX<ParseException> sutThrowing = LDoubleToFloatFunctionX.lX((double d) -> {
    ...
    public void testWrapExceptionMethodWrapsTheException() throws ParseException {
        ...
        // given
        LDoubleToFloatFunction sutThrowing = LDoubleToFloatFunction.l((double d) -> {
            throw new UnsupportedOperationException();
        });

        // when
        LDoubleToFloatFunction wrapped = LDoubleToFloatFunction.wrapException(sutThrowing, UnsupportedOperationException.class, null, t -> {
    ...
    public void testfromDouble() throws ParseException {
        ...
        LDoubleToFloatFunction sutO = (double d) -> {
        ...
        //when
        LDoubleToFloatFunction function = sutO.fromDouble(before1);
    ...
    public void testNonThrowing() {
        assertThat(sut.nonThrowing()).isInstanceOf(LDoubleToFloatFunction.class);
    }

    @Test
    public void testUncheck() {
        assertThat(sut.uncheck()).isInstanceOf(LDoubleToFloatFunctionX.class);
    }
    ...
    public void testHandle() throws ParseException {
        ...
        // when
        LDoubleToFloatFunction wrapped = sutThrowing.handle(UnsupportedOperationException.class, t -> {
            throw new IllegalArgumentException(EXCEPTION_WAS_WRAPPED, t);
        });
