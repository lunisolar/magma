...
public class LDoubleToFloatFunctionTest<X extends ParseException> {
    ...
    private LDoubleToFloatFunctionX<X> opposite = new LDoubleToFloatFunctionX<X>(){
    ...
    private LDoubleToFloatFunctionX<RuntimeException> sutAlwaysThrowingUnchecked = LDoubleToFloatFunction.l(a1 -> {
    ...
    public void testTheResult() throws X {
        assertThat(sut.doApplyAsFloat(100d))
            .isEqualTo(testValue);
    }
    ...
    public void testNonNullDoApplyAsFloat() throws X {
        assertThat(sut.nonNullDoApplyAsFloat(100d))
            .isEqualTo(testValue);
    }
    ...
    public void testNestingDoApplyAsFloatUnchecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowingUnchecked.nestingDoApplyAsFloat(100d);
    ...
    public void testShovingDoApplyAsFloatUnchecked() throws X {
        ...
        // then
        try {
            sutAlwaysThrowingUnchecked.shovingDoApplyAsFloat(100d);
            fail(NO_EXCEPTION_WERE_THROWN);
        } catch (Exception e) {
            assertThat(e)
                    .isExactlyInstanceOf(IndexOutOfBoundsException.class)
    ...
    public void testFunctionalInterfaceDescription() throws X {
        assertThat(sut.functionalInterfaceDescription())
            .isEqualTo("LDoubleToFloatFunction: float doApplyAsFloat(double a1)");
    }

    @Test
    public void testLMethod() throws X {
        assertThat(LDoubleToFloatFunction.l(a1 -> testValue ))
    ...
    public void testWrapMethodDoNotWrapsRuntimeException() throws X {
        // given
        LDoubleToFloatFunctionX<X> sutThrowing = LDoubleToFloatFunctionX.lX(a1 -> {
    ...
    public void testWrapMethodWrapsCheckedException() throws X {
        // given
        LDoubleToFloatFunctionX<ParseException> sutThrowing = LDoubleToFloatFunctionX.lX(a1 -> {
    ...
    public void testHandlingDoApplyAsFloatMethodWrapsTheException() throws X {
        ...
        // given
        LDoubleToFloatFunction sutThrowing = LDoubleToFloatFunction.l(a1 -> {
            throw new UnsupportedOperationException();
        });

        // when
        LDoubleToFloatFunction wrapped = sutThrowing.handleDoubleToFloatFunc(handler -> handler
    ...
    @Test
    public void testHandleDoubleToFloatFuncMethodDoNotWrapsOtherExceptionIf() throws X {
...
@Test
    public void testHandleDoubleToFloatFuncMethodDoNotWrapsOtherExceptionWhen() throws X {
    ...
    @Test
    public void testHandleDoubleToFloatFuncMishandlingExceptionIsAllowed() throws X {
        ...
        // when
        LDoubleToFloatFunction wrapped = sutThrowing.handleDoubleToFloatFunc(h -> Function4U.doNothing());
    ...
    public void testDoubleToFloatFuncComposeDouble() throws X {
        ...
        LDoubleToFloatFunction sutO = a1 -> {
        ...
        //when
        LDoubleToFloatFunction function = sutO.doubleToFloatFuncComposeDouble(before1);
        function.doApplyAsFloat(80d);
    ...
    public void testDoubleToFloatFuncCompose() throws X {
        ...
        //when
        LToFloatFunction<Integer> function = sutO.doubleToFloatFuncCompose(before1);
    ...
    public void testShove() {
        ...
        // when
        sutThrowing.shovingDoubleToFloatFunc().doApplyAsFloat(100d);
    }
    ...
    public void testHandleDoubleToFloatFunc() throws X {
        ...
        // when
        LDoubleToFloatFunction wrapped = sutThrowing.handleDoubleToFloatFunc(h -> {
    ...
    public void testToString() throws X {
        ...
        assertThat(String.format("%s", sut))
                .isInstanceOf(String.class)
                .contains("LDoubleToFloatFunction: float doApplyAsFloat(double a1)");
    }
    ...
    @Test void safeCompiles() {
        LDoubleToFloatFunction r1 = LDoubleToFloatFunction.safe(sut); //NOSONAR
        LDoubleToFloatFunctionX r2 = LDoubleToFloatFunction.safe(sut); //NOSONAR
    }

    @Test void safePropagates() {
        Object result = LDoubleToFloatFunction.safe(sut);
        assertThat(result).isSameAs(sut);
    }

    @Test void safeProtectsAgainstNpe() {
        Object result = LDoubleToFloatFunction.safe(null);
        assertThat(result).isSameAs(LDoubleToFloatFunction.l(LDoubleToFloatFunction.safe()));
    }

    @Test  void safeSupplierPropagates() {
        LSupplier<LDoubleToFloatFunction> supplier = ()->sut;
        Object result = LDoubleToFloatFunction.safeSupplier(supplier);
        assertThat(result).isSameAs(supplier);
    }

    @Test  void safeSupplierProtectsAgainstNpe() {
        Object result = LDoubleToFloatFunction.safeSupplier(null);
        assertThat(result).isSameAs(LDoubleToFloatFunction.safeSupplier());
    }

    @Test  void safeSupplierCompiles() {
        LSupplier<LDoubleToFloatFunction> r1 = LDoubleToFloatFunction.safeSupplier(()->sut);  //NOSONAR
    }
