...
public interface LObjDblConsumer<T> extends ObjDoubleConsumer<T>, MetaConsumer, MetaInterface.NonThrowing, TeConsumer<T, aDouble> {

	String DESCRIPTION = "LObjDblConsumer: void doAccept(T a1,double a2)";

	/**
	 * Default implementation for JRE method that calls exception nesting method.
	 * @deprecated Calling this method via LObjDblConsumer interface should be discouraged.
	 */
	@Override
	@Deprecated
	...
	/**
	 * Implement this, but call doAccept(T a1,double a2)
	 */
	void doAcceptX(T a1, double a2) throws Throwable;
	...
	default void handlingDoAccept(T a1, double a2, HandlingInstructions<Throwable, RuntimeException> handling) {
		try {
			this.doAcceptX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default void tryDoAccept(T a1, double a2, @Nonnull ExceptionWrapWithMessageFactory<RuntimeException> exceptionFactory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		try {
			this.doAcceptX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default void tryDoAccept(T a1, double a2, @Nonnull ExceptionWrapFactory<RuntimeException> exceptionFactory) {
		try {
			this.doAcceptX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default void tryDoAcceptThen(T a1, double a2, @Nonnull LConsumer<Throwable> handler) {
		try {
			this.doAcceptX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	static <T> void handlingDoAccept(T a1, double a2, LObjDblConsumer<T> func, HandlingInstructions<Throwable, RuntimeException> handling) { // <-
		Null.nonNullArg(func, "func");
		func.handlingDoAccept(a1, a2, handling);
	}

	static <T> void tryDoAccept(T a1, double a2, LObjDblConsumer<T> func) {
		tryDoAccept(a1, a2, func, null);
	}

	static <T> void tryDoAccept(T a1, double a2, LObjDblConsumer<T> func, @Nonnull ExceptionWrapWithMessageFactory<RuntimeException> exceptionFactory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		Null.nonNullArg(func, "func");
		func.tryDoAccept(a1, a2, exceptionFactory, newMessage, messageParams);
	}

	static <T> void tryDoAccept(T a1, double a2, LObjDblConsumer<T> func, @Nonnull ExceptionWrapFactory<RuntimeException> exceptionFactory) {
		Null.nonNullArg(func, "func");
		func.tryDoAccept(a1, a2, exceptionFactory);
	}

	static <T> void tryDoAcceptThen(T a1, double a2, LObjDblConsumer<T> func, @Nonnull LConsumer<Throwable> handler) {
		Null.nonNullArg(func, "func");
		func.tryDoAcceptThen(a1, a2, handler);
	}

	default void failSafeDoAccept(T a1, double a2, @Nonnull LObjDblConsumer<T> failSafe) {
		try {
			doAccept(a1, a2);
		} catch (Throwable e) { // NOSONAR
			Handling.handleErrors(e);
	...
	static <T> void failSafeDoAccept(T a1, double a2, LObjDblConsumer<T> func, @Nonnull LObjDblConsumer<T> failSafe) {
	...
	static <T> LObjDblConsumer<T> failSafeObjDblCons(LObjDblConsumer<T> func, @Nonnull LObjDblConsumer<T> failSafe) {
		Null.nonNullArg(failSafe, "failSafe");
	...
	/**  */
	public static <T> LObjDblConsumer<T> uncurryObjDblCons(LFunction<T, LDblConsumer> func) {
		return (T a1, double a2) -> func.doApply(a1).doAccept(a2);
	}

	/** Captures arguments but delays the evaluation. */
	default LAction captureObjDblCons(T a1, double a2) {
	...
	static <T> LObjDblConsumer<T> recursive(final @Nonnull LFunction<LObjDblConsumer<T>, LObjDblConsumer<T>> selfLambda) {
		...
		LObjDblConsumer<T> func = selfLambda.doApply(single);
		single.target = func;
		return func;
	}
	...
	final class LObjDblConsumerSingle<T> implements LSingle<LObjDblConsumer<T>>, LObjDblConsumer<T> {
		...
		@Override
		public void doAcceptX(T a1, double a2) throws Throwable {
	...
	@Nonnull
	static <T> LObjDblConsumer<T> objDblConsThrowing(final @Nonnull ExceptionFactory<Throwable> exceptionFactory) {
	...
	@Nonnull
	static <T> LObjDblConsumer<T> objDblConsThrowing(final String message, final @Nonnull ExceptionWithMessageFactory<Throwable> exceptionFactory) {
		Null.nonNullArg(exceptionFactory, "exceptionFactory");
		return (a1, a2) -> {
	...
	@Nonnull
	default <V1> LObjDblConsumer<V1> objDblConsComposeDbl(@Nonnull final LFunction<? super V1, ? extends T> before1, @Nonnull final LDblUnaryOperator before2) {
		Null.nonNullArg(before1, "before1");
		Null.nonNullArg(before2, "before2");
		return (v1, v2) -> this.doAccept(before1.doApply(v1), before2.doApplyAsDbl(v2));
	}

	public static <V1, T> LObjDblConsumer<V1> composedDbl(@Nonnull final LFunction<? super V1, ? extends T> before1, @Nonnull final LDblUnaryOperator before2, LObjDblConsumer<T> after) {
		return after.objDblConsComposeDbl(before1, before2);
	}
	...
	@Nonnull
	default LObjDblConsumer<T> nestingObjDblCons() {
		return this;
	}

	/** Converts to non-throwing variant that will propagate checked exception as it would be unchecked - there is no exception wrapping involved (at least not here). */
	default LObjDblConsumer<T> shovingObjDblCons() {
		return this;
	}
	...
	interface LDblObjCons<T> extends LObjDblConsumer<T> {
		...
		void doAcceptDblObj(double a2, T a1);

		@Override
		default void doAcceptX(T a1, double a2) {
			this.doAcceptDblObj(a2, a1);
		}
	}
	...
	// JUST_CONSUME: FOR, [SourcePurpose{arg=T a1, type=IA}, SourcePurpose{arg=double a2, type=IA}, SourcePurpose{arg=LObjDblConsumer<? super T> consumer,
	// type=CONST}]
	...
	// JUST_CONSUME: WHILE, [SourcePurpose{arg=T a1, type=SA}, SourcePurpose{arg=double a2, type=IA}, SourcePurpose{arg=LObjDblConsumer<? super T> consumer,
	// type=CONST}]
	...
	// JUST_CONSUME: WHILE, [SourcePurpose{arg=T a1, type=IA}, SourcePurpose{arg=double a2, type=SA}, SourcePurpose{arg=LObjDblConsumer<? super T> consumer,
	// type=CONST}]
	...
	// JUST_CONSUME: WHILE, [SourcePurpose{arg=T a1, type=SA}, SourcePurpose{arg=double a2, type=SA}, SourcePurpose{arg=LObjDblConsumer<? super T> consumer,
	// type=CONST}]
	...
	// CONSUME_WITH_TARGET: FOR, [SourcePurpose{arg=T a1, type=CONST}, SourcePurpose{arg=double a2, type=IA}, SourcePurpose{arg=LObjDblConsumer<? super T>
	// consumer, type=CONST}]
	...
	// CONSUME_WITH_TARGET: WHILE, [SourcePurpose{arg=T a1, type=CONST}, SourcePurpose{arg=double a2, type=SA}, SourcePurpose{arg=LObjDblConsumer<? super T>
	// consumer, type=CONST}]
	...
	// TE_CONSUMER_GEN_IA: FOR, [SourcePurpose{arg=T a1, type=CONST}, SourcePurpose{arg=double a2, type=IA}]
	...
	// TE_CONSUMER_GEN_SA: WHILE, [SourcePurpose{arg=T a1, type=CONST}, SourcePurpose{arg=double a2, type=SA}]
