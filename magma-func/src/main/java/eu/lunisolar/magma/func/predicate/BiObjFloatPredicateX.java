...
/**
 * Throwing functional interface (lambda) BiObjFloatPredicateX for Java 8.
 *
 * Type: predicate
 *
 ...
 * Co-domain: none
 *
 * @see BiObjFloatPredicate
 */
@FunctionalInterface
@SuppressWarnings("UnusedDeclaration")
public interface BiObjFloatPredicateX<T1, T2, X extends Exception> extends MetaPredicate, PrimitiveCodomain<Object>, MetaInterface.Throwing<X> { // NOSONAR
	...
	default BooleanSupplierX<X> capture(T1 t1, T2 t2, float f) {
		return () -> this.test(t1, t2, f);
	}

	public static <T1, T2, X extends Exception> BiObjFloatPredicateX<T1, T2, X> constant(boolean r) {
		return (t1, t2, f) -> r;
	}
	...
	default BiObjFloatPredicate<T1, T2> shove() {
		BiObjFloatPredicateX<T1, T2, RuntimeException> exceptionCast = (BiObjFloatPredicateX<T1, T2, RuntimeException>) this;
	...
	@Nonnull
	public static <T1, T2, X extends Exception, E extends Exception, Y extends Exception> BiObjFloatPredicateX<T1, T2, Y> wrapException(@Nonnull final BiObjFloatPredicateX<T1, T2, X> other, Class<E> exception, BooleanSupplierX<X> supplier,
	...
	@Nonnull
	default <E extends Exception, Y extends Exception> BiObjFloatPredicateX<T1, T2, Y> handleX(Class<E> exception, ExceptionHandler<E, Y> handler) {
		Objects.requireNonNull(exception, Function4U.VALIDATION_MESSAGE_EXCEPTION);
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return BiObjFloatPredicateX.wrapException(this, exception, null, (ExceptionHandler) handler);
	}

	/** Wraps with exception handling that for any exception (including unchecked exception that might be different from X) will call handler function to determine the final exception. */
	@Nonnull
	default <Y extends Exception> BiObjFloatPredicateX<T1, T2, Y> handleX(ExceptionHandler<Exception, Y> handler) {
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return BiObjFloatPredicateX.wrapException(this, Exception.class, null, (ExceptionHandler) handler);
	}

	/** Wraps with exception handling that for argument exception class will call supplier and return default value instead for propagating exception.  */
	@Nonnull
	default <E extends Exception, Y extends Exception> BiObjFloatPredicateX<T1, T2, Y> handleX(Class<E> exception, BooleanSupplierX<X> supplier) {
		Objects.requireNonNull(exception, Function4U.VALIDATION_MESSAGE_EXCEPTION);
		Objects.requireNonNull(supplier, Function4U.VALIDATION_MESSAGE_HANDLER);

		return BiObjFloatPredicateX.wrapException(this, exception, supplier, null);
	}

	/** Wraps with exception handling that for any exception will call supplier and return default value instead for propagating exception.  */
	@Nonnull
	default <Y extends Exception> BiObjFloatPredicateX<T1, T2, Y> handleX(BooleanSupplierX<X> supplier) {
		Objects.requireNonNull(supplier, Function4U.VALIDATION_MESSAGE_HANDLER);

		return BiObjFloatPredicateX.wrapException(this, Exception.class, supplier, null);
	}
