...
public interface LCharSupplierX<X extends Throwable> extends MetaSupplier, MetaInterface.Throwing<X> {

	String DESCRIPTION = "LCharSupplierX: char doGetAsChar() throws X";

	char doGetAsChar() throws X;

	default Character tupleGetAsChar(LTuple.Void args) throws X {
		return doGetAsChar();
	}
