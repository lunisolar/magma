...
public interface LBiObjByteFunctionX<T1, T2, R, X extends Throwable> extends MetaFunction, MetaInterface.Throwing<X> { // NOSONAR
	...
	interface V1<T1, T2, R, X extends Throwable> extends LBiObjByteFunctionX<T1, T2, R, X> {
		@Nullable
		R apply1(T1 a1, byte a3, T2 a2) throws X;
	...
	/** Permutation of LBiObjByteFunctionX for method references. */
	@FunctionalInterface
	interface V2<T1, T2, R, X extends Throwable> extends LBiObjByteFunctionX<T1, T2, R, X> {
		@Nullable
		R apply2(T2 a2, T1 a1, byte a3) throws X;
	...
	/** Permutation of LBiObjByteFunctionX for method references. */
	@FunctionalInterface
	interface V3<T1, T2, R, X extends Throwable> extends LBiObjByteFunctionX<T1, T2, R, X> {
		@Nullable
		R apply3(T2 a2, byte a3, T1 a1) throws X;
	...
	interface V4<T1, T2, R, X extends Throwable> extends LBiObjByteFunctionX<T1, T2, R, X> {
		@Nullable
		R apply4(byte a3, T1 a1, T2 a2) throws X;
	...
	/** Permutation of LBiObjByteFunctionX for method references. */
	@FunctionalInterface
	interface V5<T1, T2, R, X extends Throwable> extends LBiObjByteFunctionX<T1, T2, R, X> {
		@Nullable
		R apply5(byte a3, T2 a2, T1 a1) throws X;
