...
public interface LQuadConsumer<T1, T2, T3, T4> extends MetaConsumer, MetaInterface.NonThrowing, Codomain<aVoid>, Domain4<a<T1>, a<T2>, a<T3>, a<T4>> {
	...
	default void accept(T1 a1, T2 a2, T3 a3, T4 a4, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		try {
			this.acceptX(a1, a2, a3, a4);
		} catch (Throwable e) { // NOSONAR
	...
	default void accept(T1 a1, T2 a2, T3 a3, T4 a4, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		try {
			this.acceptX(a1, a2, a3, a4);
		} catch (Throwable e) { // NOSONAR
	...
	default void accept(T1 a1, T2 a2, T3 a3, T4 a4, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		try {
			this.acceptX(a1, a2, a3, a4);
		} catch (Throwable e) { // NOSONAR
	...
	default void accept(T1 a1, T2 a2, T3 a3, T4 a4, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		try {
			this.acceptX(a1, a2, a3, a4);
		} catch (Throwable e) { // NOSONAR
	...
	default LQuadConsumer<T1, T2, T3, T4> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		return (a1, a2, a3, a4) -> accept(a1, a2, a3, a4, exF, newMessage);
	}

	default LQuadConsumer<T1, T2, T3, T4> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		return (a1, a2, a3, a4) -> accept(a1, a2, a3, a4, exF, newMessage, param1);
	}

	default LQuadConsumer<T1, T2, T3, T4> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		return (a1, a2, a3, a4) -> accept(a1, a2, a3, a4, exF, newMessage, param1, param1);
	}

	default LQuadConsumer<T1, T2, T3, T4> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		return (a1, a2, a3, a4) -> accept(a1, a2, a3, a4, exF, newMessage, param1, param2, param3);
	}
	...
	static <T1, T2, T3, T4> void tryAccept(T1 a1, T2 a2, T3 a3, T4 a4, LQuadConsumer<T1, T2, T3, T4> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		Null.nonNullArg(func, "func");
		func.accept(a1, a2, a3, a4, exF, newMessage);
	}

	static <T1, T2, T3, T4> void tryAccept(T1 a1, T2 a2, T3 a3, T4 a4, LQuadConsumer<T1, T2, T3, T4> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		Null.nonNullArg(func, "func");
		func.accept(a1, a2, a3, a4, exF, newMessage, param1);
	}

	static <T1, T2, T3, T4> void tryAccept(T1 a1, T2 a2, T3 a3, T4 a4, LQuadConsumer<T1, T2, T3, T4> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		Null.nonNullArg(func, "func");
		func.accept(a1, a2, a3, a4, exF, newMessage, param1, param2);
	}

	static <T1, T2, T3, T4> void tryAccept(T1 a1, T2 a2, T3 a3, T4 a4, LQuadConsumer<T1, T2, T3, T4> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		Null.nonNullArg(func, "func");
		func.accept(a1, a2, a3, a4, exF, newMessage, param1, param2, param3);
	}
