...
/**
 *
 * @see {@link eu.lunisolar.magma.func.function.conversion.DoubleToLongFunction}
 */
@FunctionalInterface
...
public interface DoubleToLongFunctionX<X extends Exception> extends MetaFunction, PrimitiveCodomain<DoubleToLongFunctionX<X>>, MetaThrowingInterface<X> { // NOSONAR
	...
	/** Wraps JRE instance. */
	@Nonnull
	public static <X extends Exception> DoubleToLongFunctionX<X> std(final java.util.function.DoubleToLongFunction other) {
	...
	@Nonnull
	public static <X extends Exception, Y extends Exception> DoubleToLongFunctionX<Y> wrapException(@Nonnull final DoubleToLongFunctionX<X> other, Class<? extends Exception> exception, ExceptionHandler<Exception, Y> rethrower) {
		return (double d) -> {
			try {
	...
	@Nonnull
	default <Y extends Exception> DoubleToLongFunctionX<Y> handle(Class<? extends Exception> exception, ExceptionHandler<? super X, Y> handler) {
		Objects.requireNonNull(exception, Function4U.VALIDATION_MESSAGE_EXCEPTION);
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return DoubleToLongFunctionX.wrapException(this, exception, (ExceptionHandler) handler);
	}

	/** Wraps with exception handling that for argument exception class will call function to determine the final exception. */
	@Nonnull
	default <Y extends Exception> DoubleToLongFunctionX<Y> handle(ExceptionHandler<? super X, Y> handler) {
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return DoubleToLongFunctionX.wrapException(this, Exception.class, (ExceptionHandler) handler);
	}
