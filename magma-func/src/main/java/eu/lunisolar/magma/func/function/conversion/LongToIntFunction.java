...
/**
 *
 * @see {@link eu.lunisolar.magma.func.function.conversion.LongToIntFunctionX}
 */
@FunctionalInterface
...
public interface LongToIntFunction extends java.util.function.LongToIntFunction, MetaFunction, PrimitiveCodomain<LongToIntFunction> { // NOSONAR
	...
	@Nonnull
	public static <X extends Exception, Y extends RuntimeException> LongToIntFunction wrapException(@Nonnull final LongToIntFunction other, Class<? extends Exception> exception, ExceptionHandler<Exception, Y> rethrower) {
		return (long l) -> {
			try {
				return other.applyAsInt(l);
			} catch (Exception e) {
	...
	@Nonnull
	default <Y extends RuntimeException> LongToIntFunction handle(Class<? extends Exception> exception, ExceptionHandler<? super RuntimeException, Y> handler) {
		Objects.requireNonNull(exception, Function4U.VALIDATION_MESSAGE_EXCEPTION);
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return LongToIntFunction.wrapException(this, exception, (ExceptionHandler) handler);
	}

	/** Wraps with exception handling that for argument exception class will call function to determine the final exception. */
	@Nonnull
	default <Y extends RuntimeException> LongToIntFunction handle(ExceptionHandler<? super RuntimeException, Y> handler) {
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return LongToIntFunction.wrapException(this, Exception.class, (ExceptionHandler) handler);
	}
