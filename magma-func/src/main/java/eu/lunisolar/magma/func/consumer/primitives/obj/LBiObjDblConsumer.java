...
public interface LBiObjDblConsumer<T1, T2> extends MetaConsumer, MetaInterface.NonThrowing, Codomain<aVoid>, Domain3<a<T1>, a<T2>, aDouble> {
	...
	default void accept(T1 a1, T2 a2, double a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		try {
			this.acceptX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LBiObjDblConsumer<T1, T2> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		return (a1, a2, a3) -> accept(a1, a2, a3, exF, newMessage, messageParams);
	}

	default void accept(T1 a1, T2 a2, double a3, @Nonnull ExWF<RuntimeException> exF) {
		try {
			this.acceptX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LBiObjDblConsumer<T1, T2> trying(@Nonnull ExWF<RuntimeException> exF) {
	...
	static <T1, T2> void tryAccept(T1 a1, T2 a2, double a3, LBiObjDblConsumer<T1, T2> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		Null.nonNullArg(func, "func");
		func.accept(a1, a2, a3, exF, newMessage, messageParams);
	}

	static <T1, T2> void tryAccept(T1 a1, T2 a2, double a3, LBiObjDblConsumer<T1, T2> func, @Nonnull ExWF<RuntimeException> exF) {
		Null.nonNullArg(func, "func");
	...
	/**  */
	public static <T1, T2> LBiObjDblConsumer<T1, T2> uncurry(LFunction<T1, LFunction<T2, LDblConsumer>> func) {
		return (T1 a1, T2 a2, double a3) -> func.apply(a1).apply(a2).accept(a3);
	}

	/** Cast that removes generics. */
	public default LBiObjDblConsumer untyped() {
		return this;
	}

	/** Cast that replace generics. */
	public default <V2, V3> LBiObjDblConsumer<V2, V3> cast() {
		return untyped();
	}

	/** Cast that replace generics. */
	public static <V2, V3, T1, T2> LBiObjDblConsumer<V2, V3> cast(LBiObjDblConsumer<T1, T2> function) {
	...
	@Nonnull
	static <T1, T2> LBiObjDblConsumer<T1, T2> biObjDblCons(Class<T1> c1, Class<T2> c2, final @Nonnull LBiObjDblConsumer<T1, T2> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2> LObj0Dbl2Obj1Cons<T1, T2> obj0Dbl2Obj1Cons(final @Nonnull LObj0Dbl2Obj1Cons<T1, T2> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1> LObj1Obj0Dbl2Cons<T2, T1> obj1Obj0Dbl2Cons(final @Nonnull LObj1Obj0Dbl2Cons<T2, T1> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1> LObj1Dbl2Obj0Cons<T2, T1> obj1Dbl2Obj0Cons(final @Nonnull LObj1Dbl2Obj0Cons<T2, T1> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2> LDbl2Obj0Obj1Cons<T1, T2> dbl2Obj0Obj1Cons(final @Nonnull LDbl2Obj0Obj1Cons<T1, T2> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1> LDbl2Obj1Obj0Cons<T2, T1> dbl2Obj1Obj0Cons(final @Nonnull LDbl2Obj1Obj0Cons<T2, T1> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
