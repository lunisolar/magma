...
/**
 *
 * @see {@link eu.lunisolar.magma.func.operator.binary.ShortBinaryOperator}
 */
@FunctionalInterface
...
public interface ShortBinaryOperatorX<X extends Exception> extends MetaOperator, PrimitiveCodomain<ShortBinaryOperatorX<X>>, MetaThrowingInterface<X> { // NOSONAR
	...
	@Nonnull
	public static <X extends Exception, Y extends Exception> ShortBinaryOperatorX<Y> wrapException(@Nonnull final ShortBinaryOperatorX<X> other, Class<? extends Exception> exception, ExceptionHandler<Exception, Y> rethrower) {
	...
	@Nonnull
	default <Y extends Exception> ShortBinaryOperatorX<Y> handle(Class<? extends Exception> exception, ExceptionHandler<? super X, Y> handler) {
		Objects.requireNonNull(exception, Function4U.VALIDATION_MESSAGE_EXCEPTION);
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return ShortBinaryOperatorX.wrapException(this, exception, (ExceptionHandler) handler);
	}

	/** Wraps with exception handling that for argument exception class will call function to determine the final exception. */
	@Nonnull
	default <Y extends Exception> ShortBinaryOperatorX<Y> handle(ExceptionHandler<? super X, Y> handler) {
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return ShortBinaryOperatorX.wrapException(this, Exception.class, (ExceptionHandler) handler);
	}
