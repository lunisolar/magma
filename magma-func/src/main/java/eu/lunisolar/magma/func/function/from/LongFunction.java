...
public interface LongFunction<R> extends java.util.function.LongFunction<R>, LongFunctionX<R, RuntimeException>, MetaFunction, MetaInterface.NonThrowing { // NOSONAR
