...
public interface LTieLongFunction<T> extends MetaFunction, MetaInterface.NonThrowing, TieFunction<T, aLong>, Codomain<aInt>, Domain3<a<T>, aInt, aLong> { // NOSONAR
	...
	default int applyAsInt(T a1, int a2, long a3, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage) {
		try {
			return this.applyAsIntX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default int applyAsInt(T a1, int a2, long a3, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1) {
		try {
			return this.applyAsIntX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default int applyAsInt(T a1, int a2, long a3, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		try {
			return this.applyAsIntX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default int applyAsInt(T a1, int a2, long a3, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		try {
			return this.applyAsIntX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LTieLongFunction<T> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage) {
		return (a1, a2, a3) -> applyAsInt(a1, a2, a3, factory, newMessage);
	}

	default LTieLongFunction<T> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1) {
		return (a1, a2, a3) -> applyAsInt(a1, a2, a3, factory, newMessage, param1);
	}

	default LTieLongFunction<T> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		return (a1, a2, a3) -> applyAsInt(a1, a2, a3, factory, newMessage, param1, param1);
	}

	default LTieLongFunction<T> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		return (a1, a2, a3) -> applyAsInt(a1, a2, a3, factory, newMessage, param1, param2, param3);
	}

	default int applyAsInt(T a1, int a2, long a3, @Nonnull ExWF<RuntimeException> factory) {
		try {
			return this.applyAsIntX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LTieLongFunction<T> trying(@Nonnull ExWF<RuntimeException> factory) {
	...
	static <T> int shovingApplyAsInt(T a1, int a2, long a3, LTieLongFunction<T> func) {
	...
	static <T> int tryApplyAsInt(T a1, int a2, long a3, LTieLongFunction<T> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage) {
		Null.nonNullArg(func, "func");
		return func.applyAsInt(a1, a2, a3, factory, newMessage);
	}

	static <T> int tryApplyAsInt(T a1, int a2, long a3, LTieLongFunction<T> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1) {
		Null.nonNullArg(func, "func");
		return func.applyAsInt(a1, a2, a3, factory, newMessage, param1);
	}

	static <T> int tryApplyAsInt(T a1, int a2, long a3, LTieLongFunction<T> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		Null.nonNullArg(func, "func");
		return func.applyAsInt(a1, a2, a3, factory, newMessage, param1, param2);
	}

	static <T> int tryApplyAsInt(T a1, int a2, long a3, LTieLongFunction<T> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		Null.nonNullArg(func, "func");
		return func.applyAsInt(a1, a2, a3, factory, newMessage, param1, param2, param3);
	}

	static <T> int tryApplyAsInt(T a1, int a2, long a3, LTieLongFunction<T> func, @Nonnull ExWF<RuntimeException> factory) {
		Null.nonNullArg(func, "func");
	...
	public static <T> void fromTo(int min_i, int max_i, T a1, int a2, long a3, @Nonnull LTieLongFunction<T> func) {
		Null.nonNullArg(func, "func");
		if (min_i <= max_i) {
	...
	/** From-To. Intended to be used with non-capturing lambda. */
	public static <T> void fromTill(int min_i, int max_i, T a1, int a2, long a3, @Nonnull LTieLongFunction<T> func) {
		Null.nonNullArg(func, "func");
		if (min_i <= max_i) {
			for (int i = min_i; i < max_i; i++) {
				func.applyAsInt(a1, a2, a3);
	...
	/** From-To. Intended to be used with non-capturing lambda. */
	public static <T> void times(int max_i, T a1, int a2, long a3, @Nonnull LTieLongFunction<T> func) {
		if (max_i < 0)
			return;
	...
	public static <M, K, V> int from(@Nonnull M container, LBiFunction<M, K, V> extractor, K key, int a2, long a3, @Nonnull LTieLongFunction<V> function, int orElse) {
	...
	default LOiToIntFunction<T> with(long a3) {
		return (a1, a2) -> applyAsInt(a1, a2, a3);
	}

	default LLongToIntFunction _with(T a1, int a2) {
		return a3 -> applyAsInt(a1, a2, a3);
	}

	default LToIntFunction<T> with(int a2, long a3) {
	...
	default LTieLongFunction<T> beforeDo(@Nonnull LTieLongConsumer<T> before) {
	...
	default LTieLongFunction<T> afterDo(@Nonnull LIntConsumer after) {
	...
	public static <T> M<T> mementoOf(T a1, int a2, long a3, LTieLongFunction<T> function) {
		var initialValue = function.applyAsInt(a1, a2, a3);
		return initializedMementoOf(initialValue, function);
	}

	public static <T> M<T> initializedMementoOf(int initialValue, LTieLongFunction<T> function) {
		return memento(initialValue, initialValue, function, (m, x1, x2) -> x2);
	}

	public static <T> M<T> deltaOf(T a1, int a2, long a3, LTieLongFunction<T> function, LIntBinaryOperator deltaFunction) {
		var initialValue = function.applyAsInt(a1, a2, a3);
		return initializedDeltaOf(initialValue, function, deltaFunction);
	}

	public static <T> M<T> deltaOf(T a1, int a2, long a3, LTieLongFunction<T> function) {
		var initialValue = function.applyAsInt(a1, a2, a3);
		return initializedDeltaOf(initialValue, function, (x1, x2) -> (x2 - x1));
	}

	public static <T> M<T> initializedDeltaOf(int initialValue, LTieLongFunction<T> function, LIntBinaryOperator deltaFunction) {
	...
	public static <T> M<T> memento(int initialBaseValue, int initialValue, LTieLongFunction<T> baseFunction, LIntTernaryOperator mementoFunction) {
		return new M(initialBaseValue, initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not confuse it with math concepts). Very short name is intended to be used with parent (LTieLongFunction.M)
	 */
	@NotThreadSafe
	final class M<T> implements LTieLongFunction<T> {

		private final LTieLongFunction<T> baseFunction;
		private int lastBaseValue;
		private int lastValue;
		private final LIntTernaryOperator mementoFunction;

		private M(int lastBaseValue, int lastValue, LTieLongFunction<T> baseFunction, LIntTernaryOperator mementoFunction) {
		...
		public int currentApplyAsInt(T a1, int a2, long a3) {
			int x1 = lastBaseValue;
		...
		public int currentBaseValue(T a1, int a2, long a3) {
	...
	/** Allows to manipulate the domain of the function. */
	@Nonnull
	default <V1, V2, V3> LToIntTriFunction<V1, V2, V3> unboxingCompose(@Nonnull final LFunction<? super V1, ? extends T> before1, @Nonnull final LToIntFunction<? super V2> before2, @Nonnull final LToLongFunction<? super V3> before3) {
		Null.nonNullArg(before1, "before1");
		Null.nonNullArg(before2, "before2");
		Null.nonNullArg(before3, "before3");
		return (v1, v2, v3) -> this.applyAsInt(before1.apply(v1), before2.applyAsInt(v2), before3.applyAsLong(v3));
	...
	default LTieLongFunction<T> shoving() {

		return new LTieLongFunction<T>() {

			public int applyAsInt(T a1, int a2, long a3) {
				try {
					return this.applyAsIntX(a1, a2, a3);
				} catch (Throwable e) { // NOSONAR
					Handling.handleErrors(e);
			...
			public int applyAsIntX(T a1, int a2, long a3) throws Throwable {
				return LTieLongFunction.this.applyAsIntX(a1, a2, a3);
			}
