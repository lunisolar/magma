...
public interface IntFunction<R> extends java.util.function.IntFunction<R>, IntFunctionX<R, RuntimeException>, MetaFunction, MetaInterface.NonThrowing { // NOSONAR
