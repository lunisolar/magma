 ...
 * Non-throwing interface/lambda variant: IntToCharFunction
 *
...
public interface IntToCharFunctionX<X extends Exception> extends MetaFunction, PrimitiveCodomain<IntToCharFunctionX<X>>, MetaThrowingInterface<X> { // NOSONAR
	...
	@Nonnull
	default <E extends Exception, Y extends Exception> IntToCharFunctionX<Y> handle(Class<E> exception, ExceptionHandler<E, Y> handler) {
	...
	@Nonnull
	default <Y extends Exception> IntToCharFunctionX<Y> handle(ExceptionHandler<Exception, Y> handler) {
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);
	...
	@Nonnull
	default <E extends Exception, Y extends Exception> IntToCharFunctionX<Y> handle(Class<E> exception, CharSupplierX<X> supplier) {
		Objects.requireNonNull(exception, Function4U.VALIDATION_MESSAGE_EXCEPTION);
	...
	@Nonnull
	default <Y extends Exception> IntToCharFunctionX<Y> handle(CharSupplierX<X> supplier) {
		Objects.requireNonNull(supplier, Function4U.VALIDATION_MESSAGE_HANDLER);
