...
public interface LBiObjShortPredicate<T1, T2> extends LBiObjShortPredicateX<T1, T2, RuntimeException>, MetaPredicate, MetaInterface.NonThrowing { // NOSONAR
	 ...
	 */
	@Nonnull
	static <T1, T2> LBiObjShortPredicate<T1, T2> isEqual(T1 v1, T2 v2, short v3) {
	...
	@Nonnull
	default <V> LBiObjShortFunction<T1, T2, V> boolToBiObjShortFunc(@Nonnull LBoolFunction<? extends V> after) {
	...
	interface V1<T1, T2> extends LBiObjShortPredicate<T1, T2> {
		...
		boolean doTestV1(T1 a1, short a3, T2 a2);
	...
	/** Permutation of LBiObjShortPredicate for method references. */
	@FunctionalInterface
	interface V2<T2, T1> extends LBiObjShortPredicate<T1, T2> {

		boolean doTestV2(T2 a2, T1 a1, short a3);
	...
	/** Permutation of LBiObjShortPredicate for method references. */
	@FunctionalInterface
	interface V3<T2, T1> extends LBiObjShortPredicate<T1, T2> {

		boolean doTestV3(T2 a2, short a3, T1 a1);
	...
	interface V4<T1, T2> extends LBiObjShortPredicate<T1, T2> {
		...
		boolean doTestV4(short a3, T1 a1, T2 a2);
	...
	/** Permutation of LBiObjShortPredicate for method references. */
	@FunctionalInterface
	interface V5<T2, T1> extends LBiObjShortPredicate<T1, T2> {

		boolean doTestV5(short a3, T2 a2, T1 a1);
