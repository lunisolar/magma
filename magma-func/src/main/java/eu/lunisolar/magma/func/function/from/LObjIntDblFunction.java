...
public interface LObjIntDblFunction<T, R> extends MetaFunction, MetaInterface.NonThrowing, Codomain<a<R>>, Domain3<a<T>, aInt, aDouble> { // NOSONAR
	...
	default R apply(T a1, int a2, double a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LObjIntDblFunction<T, R> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
	...
	static <T, R> R tryApply(T a1, int a2, double a3, LObjIntDblFunction<T, R> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		Null.nonNullArg(func, "func");
	...
	public default LOiFunction<T, R> rShrink(@Nonnull LOiToDblFunction<T> right) {
		Null.nonNullArg(right, "right");
		return (a1, a2) -> apply(a1, a2, right.applyAsDbl(a1, a2));
	}

	public default LOiFunction<T, R> rShrink_(double a3) {
	...
	public default <V2, V3> LObjIntDblFunction<V2, V3> cast() {
		return untyped();
	}
	...
	public default LObjIntDblFunction<T, R> beforeDo(@Nonnull LTieDblConsumer<T> before) {
	...
	public default LObjIntDblFunction<T, R> afterDo(@Nonnull LConsumer<R> after) {
