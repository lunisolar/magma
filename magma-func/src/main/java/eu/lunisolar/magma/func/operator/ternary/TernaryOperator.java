...
/**
 * Non-throwing functional interface (lambda) TernaryOperator for Java 8.
 *
 * Type: operator
 *
...
public interface TernaryOperator<T> extends TernaryOperatorX<T, RuntimeException>, MetaOperator, MetaInterface.NonThrowing { // NOSONAR
