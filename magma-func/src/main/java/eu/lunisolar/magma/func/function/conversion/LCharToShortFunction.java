...
public interface LCharToShortFunction extends LCharToShortFunctionX<RuntimeException>, MetaFunction, MetaInterface.NonThrowing { // NOSONAR
	...
	String DESCRIPTION = "LCharToShortFunction: short doApplyAsShort(char a1)";

	short doApplyAsShort(char a1);
	...
	default short nonNullDoApplyAsShort(char a1) {
	...
	default LShortSupplier captureCharToShortFunc(char a1) {
		return () -> this.doApplyAsShort(a1);
	}
