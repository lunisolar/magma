...
public interface LBoolIntPredicate extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain2<aBool, aInt> { //NOSONAR
	...
	default LIntPredicate _with(boolean a1) {
		return a2 -> test(a1, a2);
	}

	default LLogicalOperator with(int a2) {
	...
	final class M implements LBoolIntPredicate {
		...
		public boolean currentBaseValue(boolean a1, int a2) {
	...
	public static boolean any(boolean expected, boolean a1, int a2, @Nonnull Collection<? extends LBoolIntPredicate> predicates) {
		return any(expected, a1, a2, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static boolean any(boolean expected, boolean a1, int a2, @Nonnull Stream<? extends LBoolIntPredicate> predicates) {
		return any(expected, a1, a2, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static boolean any(boolean expected, boolean a1, int a2, @Nonnull Iterator<? extends LBoolIntPredicate> predicates) {
		Null.nonNullArg(predicates, "predicates");
	...
	public static boolean any(boolean expected, boolean a1, int a2, @Nonnull LBoolIntPredicate... predicates) {
		Null.nonNullArg(predicates, "predicates");
	...
	default LBoolIntPredicate shoving() {

		return new LBoolIntPredicate() {

			public boolean test(boolean a1, int a2) {
				try {
					return this.testX(a1, a2);
				} catch (Throwable e) { // NOSONAR
					Handling.handleErrors(e);
			...
			public boolean testX(boolean a1, int a2) throws Throwable {
				return LBoolIntPredicate.this.testX(a1, a2);
			}
