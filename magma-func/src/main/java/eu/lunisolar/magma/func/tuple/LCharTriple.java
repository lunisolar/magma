...
public interface LCharTriple extends LTuple<Character>, Comparable<LCharTriple> {
	...
	public static Iterator<LCharTriple.MutCharTriple> mutIterator(PrimitiveIterator.OfInt items) {
		return iterator(items, LCharTriple::of);
	}

	public static Iterator<LCharTriple> immIterator(PrimitiveIterator.OfInt items) {
		return iterator(items, LCharTriple::immutableOf);
	}
	...
	public static Stream<LCharTriple.MutCharTriple> mutStream(IntStream items) {
		return stream(items, LCharTriple::of);
	}

	public static Stream<LCharTriple> immStream(IntStream items) {
		return stream(items, LCharTriple::immutableOf);
	}
	...
	public static <C, R> Iterator<R> iterator(SequentialRead<C, ?, aChar> sa_, C source, LTriCharFunction<R> factory) {
