...
public interface LByteToCharFunction extends MetaFunction, MetaInterface.NonThrowing, Codomain<aChar>, Domain1<aByte> { // NOSONAR
	...
	default char applyAsChar(byte a, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		try {
			return this.applyAsCharX(a);
		} catch (Throwable e) { // NOSONAR
	...
	static char tryApplyAsChar(byte a, LByteToCharFunction func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		Null.nonNullArg(func, "func");
	...
	public default LByteToCharFunction beforeDo(@Nonnull LByteConsumer before) {
	...
	public default LByteToCharFunction afterDo(@Nonnull LCharConsumer after) {
