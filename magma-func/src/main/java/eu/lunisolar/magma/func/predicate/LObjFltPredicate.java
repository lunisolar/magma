...
public interface LObjFltPredicate<T> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain2<a<T>, aFloat> { // NOSONAR
	...
	static <T> void throwIf(T a1, float a2, LObjFltPredicate<T> pred, ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		if (pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}

	static <T> void throwIfNot(T a1, float a2, LObjFltPredicate<T> pred, ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}
	...
	/**  */
	public static <T> LObjFltPredicate<T> uncurry(LFunction<T, LFltPredicate> func) {
	...
	@Nonnull
	static <T> LObjFltPredicate<T> objFltPred(Class<T> c1, final @Nonnull LObjFltPredicate<T> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
