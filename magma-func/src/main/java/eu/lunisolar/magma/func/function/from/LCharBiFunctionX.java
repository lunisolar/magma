...
public interface LCharBiFunctionX<R, X extends Throwable> extends MetaFunction, MetaInterface.Throwing<X> { // NOSONAR
	...
	static final String DESCRIPTION = "LCharBiFunctionX: R doApply(char c1,char c2) throws X";
	...
	static <R, X extends Throwable> LCharBiFunctionX<R, X> constant(R r) {
		return (c1, c2) -> r;
	}

	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <R, X extends Throwable> LCharBiFunctionX<R, X> lX(final @Nonnull LCharBiFunctionX<R, X> lambda) {
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <R, X extends Throwable> LCharBiFunctionX<R, X> lX(@Nonnull Class<X> xClass, final @Nonnull LCharBiFunctionX<R, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	@Nonnull
	static <R, X extends Throwable> LCharBiFunctionX<R, X> wrapX(final @Nonnull LCharBiFunction<R> other) {
