...
/**
 * Throwing functional interface (lambda) ObjBooleanPredicateX for Java 8.
 *
 * Type: predicate
 *
...
public interface ObjBooleanPredicateX<T, X extends Exception> extends MetaPredicate, PrimitiveCodomain<Object>, MetaInterface.Throwing<X> { // NOSONAR
	...
	default BooleanSupplierX<X> capture(T t, boolean b) {
		return () -> this.test(t, b);
	}

	public static <T, X extends Exception> ObjBooleanPredicateX<T, X> constant(boolean r) {
		return (t, b) -> r;
	}
	...
	default ObjBooleanPredicateX<T, RuntimeException> uncheck() {
		return (ObjBooleanPredicateX) this;
	}

	/** Dirty way, checked exception will propagate as it would be unchecked - there is no exception wrapping involved (at least not here). */
	default ObjBooleanPredicate<T> shove() {
		ObjBooleanPredicateX<T, RuntimeException> exceptionCast = (ObjBooleanPredicateX<T, RuntimeException>) this;
	...
	@Nonnull
	public static <T, X extends Exception, E extends Exception, Y extends Exception> ObjBooleanPredicateX<T, Y> wrapException(@Nonnull final ObjBooleanPredicateX<T, X> other, Class<E> exception, BooleanSupplierX<X> supplier, ExceptionHandler<E, Y> handler) {
	...
	@Nonnull
	default <E extends Exception, Y extends Exception> ObjBooleanPredicateX<T, Y> handleX(Class<E> exception, ExceptionHandler<E, Y> handler) {
		Objects.requireNonNull(exception, Function4U.VALIDATION_MESSAGE_EXCEPTION);
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return ObjBooleanPredicateX.wrapException(this, exception, null, (ExceptionHandler) handler);
	}

	/** Wraps with exception handling that for any exception (including unchecked exception that might be different from X) will call handler function to determine the final exception. */
	@Nonnull
	default <Y extends Exception> ObjBooleanPredicateX<T, Y> handleX(ExceptionHandler<Exception, Y> handler) {
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return ObjBooleanPredicateX.wrapException(this, Exception.class, null, (ExceptionHandler) handler);
	}

	/** Wraps with exception handling that for argument exception class will call supplier and return default value instead for propagating exception.  */
	@Nonnull
	default <E extends Exception, Y extends Exception> ObjBooleanPredicateX<T, Y> handleX(Class<E> exception, BooleanSupplierX<X> supplier) {
		Objects.requireNonNull(exception, Function4U.VALIDATION_MESSAGE_EXCEPTION);
		Objects.requireNonNull(supplier, Function4U.VALIDATION_MESSAGE_HANDLER);

		return ObjBooleanPredicateX.wrapException(this, exception, supplier, null);
	}

	/** Wraps with exception handling that for any exception will call supplier and return default value instead for propagating exception.  */
	@Nonnull
	default <Y extends Exception> ObjBooleanPredicateX<T, Y> handleX(BooleanSupplierX<X> supplier) {
		Objects.requireNonNull(supplier, Function4U.VALIDATION_MESSAGE_HANDLER);

		return ObjBooleanPredicateX.wrapException(this, Exception.class, supplier, null);
	}
