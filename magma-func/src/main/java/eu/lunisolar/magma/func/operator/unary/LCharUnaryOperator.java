...
public interface LCharUnaryOperator extends MetaOperator, MetaInterface.NonThrowing, Codomain<aChar>, Domain1<aChar> { // NOSONAR
	 ...
	 */
	public static M memento(char initialValue, LCharUnaryOperator baseFunction, LCharBinaryOperator mementoFunction) {
		return new M(initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not ). Very short name is intended to be used with parent (LCharUnaryOperator.D)
	 */
	final class M implements LCharUnaryOperator {
		...
		private M(char lastValue, LCharUnaryOperator baseFunction, LCharBinaryOperator mementoFunction) {
