 ...
 * | {@link eu.lunisolar.magma.func.operator.unary.LLogicalOperator}                  | boolean b                                | boolean    |
 * | {@link eu.lunisolar.magma.func.operator.unary.LLogicalOperatorX}                 | boolean b                                | boolean    |
 * |                                                                                   |                                          |            |
 ...
 * | {@link eu.lunisolar.magma.func.operator.binary.LLogicalBinaryOperator}           | boolean b1,boolean b2                    | boolean    |
 * | {@link eu.lunisolar.magma.func.operator.binary.LLogicalBinaryOperatorX}          | boolean b1,boolean b2                    | boolean    |
 * |                                                                                   |                                          |            |
 * | {@link eu.lunisolar.magma.func.operator.ternary.LLogicalTernaryOperator}         | boolean b1,boolean b2,boolean b3         | boolean    |
 * | {@link eu.lunisolar.magma.func.operator.ternary.LLogicalTernaryOperatorX}        | boolean b1,boolean b2,boolean b3         | boolean    |
 * |                                                                                   |                                          |            |
