...
public interface LObjIntPredicate<T> extends LObjIntPredicateX<T, RuntimeException>, MetaPredicate, MetaInterface.NonThrowing { // NOSONAR
	...
	@Nonnull
	default <V> LObjIntFunction<T, V> boolToObjIntFunc(@Nonnull LBoolFunction<? extends V> after) {
	...
	@FunctionalInterface
	interface V1<T> extends LObjIntPredicate<T> {

		boolean doTestV1(int a2, T a1);
