...
/**
 *
 * @see {@link eu.lunisolar.magma.func.operator.binary.IntBinaryOperator}
 */
@FunctionalInterface
...
public interface IntBinaryOperatorX<X extends Exception> extends MetaOperator, PrimitiveCodomain<IntBinaryOperatorX<X>>, MetaThrowingInterface<X> { // NOSONAR
	...
	/** Wraps JRE instance. */
	@Nonnull
	public static <X extends Exception> IntBinaryOperatorX<X> std(final java.util.function.IntBinaryOperator other) {
	...
	@Nonnull
	public static <X extends Exception, Y extends Exception> IntBinaryOperatorX<Y> wrapException(@Nonnull final IntBinaryOperatorX<X> other, Class<? extends Exception> exception, ExceptionHandler<Exception, Y> rethrower) {
	...
	@Nonnull
	default <Y extends Exception> IntBinaryOperatorX<Y> handle(Class<? extends Exception> exception, ExceptionHandler<? super X, Y> handler) {
		Objects.requireNonNull(exception, Function4U.VALIDATION_MESSAGE_EXCEPTION);
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return IntBinaryOperatorX.wrapException(this, exception, (ExceptionHandler) handler);
	}

	/** Wraps with exception handling that for argument exception class will call function to determine the final exception. */
	@Nonnull
	default <Y extends Exception> IntBinaryOperatorX<Y> handle(ExceptionHandler<? super X, Y> handler) {
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return IntBinaryOperatorX.wrapException(this, Exception.class, (ExceptionHandler) handler);
	}
