...
public interface DoubleBinaryOperator extends java.util.function.DoubleBinaryOperator, DoubleBinaryOperatorX<RuntimeException>, MetaOperator, PrimitiveCodomain<Object>, MetaInterface.NonThrowing { // NOSONAR
