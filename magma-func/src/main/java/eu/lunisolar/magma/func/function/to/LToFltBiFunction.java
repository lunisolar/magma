...
public interface LToFltBiFunction<T1, T2> extends MetaFunction, MetaInterface.NonThrowing { // NOSONAR

	String DESCRIPTION = "LToFltBiFunction: float doApplyAsFlt(T1 a1,T2 a2)";

	// float doApplyAsFlt(T1 a1,T2 a2) ;
	default float doApplyAsFlt(T1 a1, T2 a2) {
	...
	/**
	 * Implement this, but call doApplyAsFlt(T1 a1,T2 a2)
	 */
	float doApplyAsFltX(T1 a1, T2 a2) throws Throwable;
	...
	default float handlingDoApplyAsFlt(T1 a1, T2 a2, HandlingInstructions<Throwable, RuntimeException> handling) {
		try {
			return this.doApplyAsFltX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default float tryDoApplyAsFlt(T1 a1, T2 a2, @Nonnull ExceptionWrapWithMessageFactory<RuntimeException> exceptionFactory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		try {
			return this.doApplyAsFltX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default float tryDoApplyAsFlt(T1 a1, T2 a2, @Nonnull ExceptionWrapFactory<RuntimeException> exceptionFactory) {
		try {
			return this.doApplyAsFltX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default float tryDoApplyAsFltThen(T1 a1, T2 a2, @Nonnull LToFltFunction<Throwable> handler) {
		try {
			return this.doApplyAsFltX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default float nestingDoApplyAsFlt(T1 a1, T2 a2) {
		try {
			return this.doApplyAsFltX(a1, a2);
		} catch (Throwable e) { // NOSONAR
			throw Handling.nestCheckedAndThrow(e);
	...
	default float shovingDoApplyAsFlt(T1 a1, T2 a2) {
		try {
			return this.doApplyAsFltX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	static <T1, T2> float handlingDoApplyAsFlt(T1 a1, T2 a2, LToFltBiFunction<T1, T2> func, HandlingInstructions<Throwable, RuntimeException> handling) { // <-
		Null.nonNullArg(func, "func");
		return func.handlingDoApplyAsFlt(a1, a2, handling);
	}

	static <T1, T2> float tryDoApplyAsFlt(T1 a1, T2 a2, LToFltBiFunction<T1, T2> func) {
		return tryDoApplyAsFlt(a1, a2, func, null);
	}

	static <T1, T2> float tryDoApplyAsFlt(T1 a1, T2 a2, LToFltBiFunction<T1, T2> func, @Nonnull ExceptionWrapWithMessageFactory<RuntimeException> exceptionFactory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		Null.nonNullArg(func, "func");
		return func.tryDoApplyAsFlt(a1, a2, exceptionFactory, newMessage, messageParams);
	}

	static <T1, T2> float tryDoApplyAsFlt(T1 a1, T2 a2, LToFltBiFunction<T1, T2> func, @Nonnull ExceptionWrapFactory<RuntimeException> exceptionFactory) {
		Null.nonNullArg(func, "func");
		return func.tryDoApplyAsFlt(a1, a2, exceptionFactory);
	}

	static <T1, T2> float tryDoApplyAsFltThen(T1 a1, T2 a2, LToFltBiFunction<T1, T2> func, @Nonnull LToFltFunction<Throwable> handler) {
		Null.nonNullArg(func, "func");
		return func.tryDoApplyAsFltThen(a1, a2, handler);
	}

	default float failSafeDoApplyAsFlt(T1 a1, T2 a2, @Nonnull LToFltBiFunction<T1, T2> failSafe) {
		try {
	...
	static <T1, T2> float failSafeDoApplyAsFlt(T1 a1, T2 a2, LToFltBiFunction<T1, T2> func, @Nonnull LToFltBiFunction<T1, T2> failSafe) {
	...
	static <T1, T2> LToFltBiFunction<T1, T2> failSafeToFltBiFunc(LToFltBiFunction<T1, T2> func, @Nonnull LToFltBiFunction<T1, T2> failSafe) {
		Null.nonNullArg(failSafe, "failSafe");
		return (a1, a2) -> failSafeDoApplyAsFlt(a1, a2, func, failSafe);
	}

	/** Just to mirror the method: Ensures the result is not null */
	default float nonNullDoApplyAsFlt(T1 a1, T2 a2) {
		return doApplyAsFlt(a1, a2);
	}
	...
	public default LToFltFunction<T1> rShrink(LFunction<T1, T2> right) {
		return a1 -> doApplyAsFlt(a1, right.doApply(a1));
	}
	...
	/**  */
	public static <T1, T2> LToFltBiFunction<T1, T2> uncurryToFltBiFunc(LFunction<T1, LToFltFunction<T2>> func) {
		return (T1 a1, T2 a2) -> func.doApply(a1).doApplyAsFlt(a2);
	}

	/** Captures arguments but delays the evaluation. */
	default LFltSupplier captureToFltBiFunc(T1 a1, T2 a2) {
	...
	static <T1, T2> LToFltBiFunction<T1, T2> recursive(final @Nonnull LFunction<LToFltBiFunction<T1, T2>, LToFltBiFunction<T1, T2>> selfLambda) {
		...
		LToFltBiFunction<T1, T2> func = selfLambda.doApply(single);
		single.target = func;
		return func;
	}
	...
	final class LToFltBiFunctionSingle<T1, T2> implements LSingle<LToFltBiFunction<T1, T2>>, LToFltBiFunction<T1, T2> {
		...
		@Override
		public float doApplyAsFltX(T1 a1, T2 a2) throws Throwable {
	...
	@Nonnull
	static <T1, T2> LToFltBiFunction<T1, T2> toFltBiFuncThrowing(final @Nonnull ExceptionFactory<Throwable> exceptionFactory) {
	...
	@Nonnull
	static <T1, T2> LToFltBiFunction<T1, T2> toFltBiFuncThrowing(final String message, final @Nonnull ExceptionWithMessageFactory<Throwable> exceptionFactory) {
		Null.nonNullArg(exceptionFactory, "exceptionFactory");
		return (a1, a2) -> {
	...
	@Nonnull
	default <V1, V2> LToFltBiFunction<V1, V2> toFltBiFuncCompose(@Nonnull final LFunction<? super V1, ? extends T1> before1, @Nonnull final LFunction<? super V2, ? extends T2> before2) {
		Null.nonNullArg(before1, "before1");
		Null.nonNullArg(before2, "before2");
		return (v1, v2) -> this.doApplyAsFlt(before1.doApply(v1), before2.doApply(v2));
	}
	...
	public static <V1, V2, T1, T2> LToFltBiFunction<V1, V2> composed(@Nonnull final LFunction<? super V1, ? extends T1> before1, @Nonnull final LFunction<? super V2, ? extends T2> before2, LToFltBiFunction<T1, T2> after) {
		return after.toFltBiFuncCompose(before1, before2);
	}
	...
	@Nonnull
	default LToFltBiFunction<T1, T2> nestingToFltBiFunc() {
		return this;
	}

	/** Converts to non-throwing variant that will propagate checked exception as it would be unchecked - there is no exception wrapping involved (at least not here). */
	default LToFltBiFunction<T1, T2> shovingToFltBiFunc() {
		return this;
	}
	...
	interface LToFltObj1Obj0Func<T2, T1> extends LToFltBiFunction<T1, T2> {
		...
		float doApplyAsFltObj1Obj0(T2 a2, T1 a1);

		@Override
		default float doApplyAsFltX(T1 a1, T2 a2) {
			return this.doApplyAsFltObj1Obj0(a2, a1);
		}
	}
	...
	// MAP: FOR, [SourcePurpose{arg=T1 a1, type=IA}, SourcePurpose{arg=T2 a2, type=IA}, SourcePurpose{arg=LFltConsumer consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T1 a1, type=SA}, SourcePurpose{arg=T2 a2, type=IA}, SourcePurpose{arg=LFltConsumer consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T1 a1, type=IA}, SourcePurpose{arg=T2 a2, type=SA}, SourcePurpose{arg=LFltConsumer consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T1 a1, type=SA}, SourcePurpose{arg=T2 a2, type=SA}, SourcePurpose{arg=LFltConsumer consumer, type=CONST}]
