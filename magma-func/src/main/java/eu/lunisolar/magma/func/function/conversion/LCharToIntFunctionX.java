...
public interface LCharToIntFunctionX<X extends Exception> extends MetaFunction, PrimitiveCodomain<Object>, MetaInterface.Throwing<X> { // NOSONAR

	public static final String DESCRIPTION = "LCharToIntFunctionX: int applyAsInt(char c) throws X";
	...
	public static <X extends Exception> LCharToIntFunctionX<X> constant(int r) {
		return (c) -> r;
	}
	...
	@Nonnull
	public static <X extends Exception> LCharToIntFunctionX<X> lX(final @Nonnull LCharToIntFunctionX<X> lambda) {
	...
	@Nonnull
	public static <X extends Exception> LCharToIntFunctionX<X> wrapX(final @Nonnull LCharToIntFunction other) {
	...
	default LCharToIntFunction nonThrowing() {
		return LCharToIntFunction.wrap(this);
	}
	...
	default LCharToIntFunction shove() {
		LCharToIntFunctionX<RuntimeException> exceptionCast = (LCharToIntFunctionX<RuntimeException>) this;
	...
	@Nonnull
	public static <X extends Exception, E extends Exception, Y extends Exception> LCharToIntFunctionX<Y> wrapException(@Nonnull final LCharToIntFunctionX<X> other, Class<E> exception, LIntSupplierX<X> supplier, ExceptionHandler<E, Y> handler) {
		return (char c) -> {
			try {
	...
	@Nonnull
	default <E extends Exception, Y extends Exception> LCharToIntFunctionX<Y> handleX(Class<E> exception, ExceptionHandler<E, Y> handler) {
		Objects.requireNonNull(exception, Function4U.VALIDATION_MESSAGE_EXCEPTION);
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return LCharToIntFunctionX.wrapException(this, exception, null, (ExceptionHandler) handler);
	}

	/** Wraps with exception handling that for any exception (including unchecked exception that might be different from X) will call handler function to determine the final exception. */
	@Nonnull
	default <Y extends Exception> LCharToIntFunctionX<Y> handleX(ExceptionHandler<Exception, Y> handler) {
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return LCharToIntFunctionX.wrapException(this, Exception.class, null, (ExceptionHandler) handler);
	}

	/** Wraps with exception handling that for argument exception class will call supplier and return default value instead for propagating exception.  */
	@Nonnull
	default <E extends Exception, Y extends Exception> LCharToIntFunctionX<Y> handleX(Class<E> exception, LIntSupplierX<X> supplier) {
		Objects.requireNonNull(exception, Function4U.VALIDATION_MESSAGE_EXCEPTION);
		Objects.requireNonNull(supplier, Function4U.VALIDATION_MESSAGE_HANDLER);

		return LCharToIntFunctionX.wrapException(this, exception, supplier, null);
	}

	/** Wraps with exception handling that for any exception will call supplier and return default value instead for propagating exception.  */
	@Nonnull
	default <Y extends Exception> LCharToIntFunctionX<Y> handleX(LIntSupplierX<X> supplier) {
		Objects.requireNonNull(supplier, Function4U.VALIDATION_MESSAGE_HANDLER);

		return LCharToIntFunctionX.wrapException(this, Exception.class, supplier, null);
	}
