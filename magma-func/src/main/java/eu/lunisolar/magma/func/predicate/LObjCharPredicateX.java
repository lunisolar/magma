...
public interface LObjCharPredicateX<T, X extends Throwable> extends MetaPredicate, PrimitiveCodomain<Object>, MetaInterface.Throwing<X> { // NOSONAR
	...
	public static <T, X extends Throwable> LObjCharPredicateX<T, X> constant(boolean r) {
		return (t, c) -> r;
	}

	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	public static <T, X extends Throwable> LObjCharPredicateX<T, X> lX(final @Nonnull LObjCharPredicateX<T, X> lambda) {
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	public static <T, X extends Throwable> LObjCharPredicateX<T, X> lX(@Nonnull Class<X> xClass, final @Nonnull LObjCharPredicateX<T, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	@Nonnull
	public static <T, X extends Throwable> LObjCharPredicateX<T, X> wrapX(final @Nonnull LObjCharPredicate<T> other) {
	 ...
	 */
	@Nonnull
	public static <T1, X extends Throwable> LObjCharPredicateX<T1, X> isEqual(final T1 v1, final char v2) {
