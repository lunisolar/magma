...
public interface LBiObjDoublePredicate<T1, T2> extends LBiObjDoublePredicateX<T1, T2, RuntimeException>, MetaPredicate, MetaInterface.NonThrowing { // NOSONAR
	...
	@Nonnull
	static <T1, T2> LBiObjDoublePredicate<T1, T2> safe() {
		return Function4U::alwaysFalse;
	}

	/** Safe instance supplier. Returns supplier of safe() instance. */
	@Nonnull
	static <T1, T2> LSupplier<LBiObjDoublePredicate<T1, T2>> safeSupplier() {
		return () -> safe();
	}

	/** Safe wrapping. Either argument function is returned (if it is not null) or safe() instance. */
	@Nonnull
	static <T1, T2> LBiObjDoublePredicate<T1, T2> safe(final @Nullable LBiObjDoublePredicate<T1, T2> other) {
		if (other == null) {
			return safe();
		} else {
			return other;
	...
	@Nonnull
	static <T1, T2> LSupplier<LBiObjDoublePredicate<T1, T2>> safeSupplier(final @Nullable LSupplier<LBiObjDoublePredicate<T1, T2>> supplier) {
		if (supplier == null) {
			return safeSupplier();
		} else {
			return supplier;
	 ...
	 */
	@Nonnull
	static <T1, T2> LBiObjDoublePredicate<T1, T2> isEqual(T1 v1, T2 v2, double v3) {
	...
	@Nonnull
	default <V> LBiObjDoubleFunction<T1, T2, V> boolToBiObjDoubleFunc(@Nonnull LBoolFunction<? extends V> after) {
	...
	/** Permutation of LBiObjDoublePredicate for method references. */
	@FunctionalInterface
	interface V1<T1, T2> extends LBiObjDoublePredicate<T1, T2> {

		boolean doTestV1(T1 a1, double a3, T2 a2);
	...
	/** Permutation of LBiObjDoublePredicate for method references. */
	@FunctionalInterface
	interface V2<T2, T1> extends LBiObjDoublePredicate<T1, T2> {

		boolean doTestV2(T2 a2, T1 a1, double a3);
	...
	/** Permutation of LBiObjDoublePredicate for method references. */
	@FunctionalInterface
	interface V3<T2, T1> extends LBiObjDoublePredicate<T1, T2> {

		boolean doTestV3(T2 a2, double a3, T1 a1);
	...
	/** Permutation of LBiObjDoublePredicate for method references. */
	@FunctionalInterface
	interface V4<T1, T2> extends LBiObjDoublePredicate<T1, T2> {

		boolean doTestV4(double a3, T1 a1, T2 a2);
	...
	/** Permutation of LBiObjDoublePredicate for method references. */
	@FunctionalInterface
	interface V5<T2, T1> extends LBiObjDoublePredicate<T1, T2> {

		boolean doTestV5(double a3, T2 a2, T1 a1);
