...
/**
 * Throwing functional interface (lambda) BooleanTernaryOperatorX for Java 8.
 *
 * Type: operator
 *
...
public interface BooleanTernaryOperatorX<X extends Exception> extends MetaLogicalOperator, PrimitiveCodomain<Object>, MetaInterface.Throwing<X> { // NOSONAR
	...
	@Nonnull
	default <E extends Exception, Y extends Exception> BooleanTernaryOperatorX<Y> handleX(Class<E> exception, ExceptionHandler<E, Y> handler) {
	...
	@Nonnull
	default <Y extends Exception> BooleanTernaryOperatorX<Y> handleX(ExceptionHandler<Exception, Y> handler) {
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);
	...
	@Nonnull
	default <E extends Exception, Y extends Exception> BooleanTernaryOperatorX<Y> handleX(Class<E> exception, BooleanSupplierX<X> supplier) {
		Objects.requireNonNull(exception, Function4U.VALIDATION_MESSAGE_EXCEPTION);
	...
	@Nonnull
	default <Y extends Exception> BooleanTernaryOperatorX<Y> handleX(BooleanSupplierX<X> supplier) {
		Objects.requireNonNull(supplier, Function4U.VALIDATION_MESSAGE_HANDLER);
