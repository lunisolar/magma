...
public interface LBoolToFloatFunctionX<X extends Throwable> extends MetaFunction, PrimitiveCodomain<Object>, MetaInterface.Throwing<X> { // NOSONAR

	static final String DESCRIPTION = "LBoolToFloatFunctionX: float doApplyAsFloat(boolean b) throws X";
	...
	default float shovingDoApplyAsFloat(boolean b) {
		return ((LBoolToFloatFunctionX<RuntimeException>) this).doApplyAsFloat(b);
	}
