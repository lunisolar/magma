...
public interface LBiObjIntFunctionX<T1, T2, R, X extends Throwable> extends MetaFunction, MetaInterface.Throwing<X> { // NOSONAR
	...
	default <V1, V2> LBiObjIntFunctionX<V1, V2, R, X> biObjIntFuncComposeInt(@Nonnull final LFunctionX<? super V1, ? extends T1, X> before1, @Nonnull final LFunctionX<? super V2, ? extends T2, X> before2, @Nonnull final LIntUnaryOperatorX<X> before3) {
		...
		return (V1 v1, V2 v2, int v3) -> this.doApply(before1.doApply(v1), before2.doApply(v2), before3.doApplyAsInt(v3));
	}
	...
	interface V1<T1, T2, R, X extends Throwable> extends LBiObjIntFunctionX<T1, T2, R, X> {
		@Nullable
		R doApplyV1(T1 a1, int a3, T2 a2) throws X;
	...
	/** Permutation of LBiObjIntFunctionX for method references. */
	@FunctionalInterface
	interface V2<T2, T1, R, X extends Throwable> extends LBiObjIntFunctionX<T1, T2, R, X> {
		@Nullable
		R doApplyV2(T2 a2, T1 a1, int a3) throws X;
	...
	/** Permutation of LBiObjIntFunctionX for method references. */
	@FunctionalInterface
	interface V3<T2, T1, R, X extends Throwable> extends LBiObjIntFunctionX<T1, T2, R, X> {
		@Nullable
		R doApplyV3(T2 a2, int a3, T1 a1) throws X;
	...
	interface V4<T1, T2, R, X extends Throwable> extends LBiObjIntFunctionX<T1, T2, R, X> {
		@Nullable
		R doApplyV4(int a3, T1 a1, T2 a2) throws X;
	...
	/** Permutation of LBiObjIntFunctionX for method references. */
	@FunctionalInterface
	interface V5<T2, T1, R, X extends Throwable> extends LBiObjIntFunctionX<T1, T2, R, X> {
		@Nullable
		R doApplyV5(int a3, T2 a2, T1 a1) throws X;
