...
public interface LBiCharConsumerX<X extends Throwable> extends MetaConsumer, MetaInterface.Throwing<X> {
	...
	static <X extends Throwable> void shoving(char a1, char a2, final @Nonnull LBiCharConsumerX<X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		lambda.shovingDoAccept(a1, a2);
	}

	static <X extends Throwable> void nesting(char a1, char a2, final @Nonnull LBiCharConsumerX<X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		lambda.nestingDoAccept(a1, a2);
	}

	static <X extends Throwable, Y extends Throwable> void handling(char a1, char a2, final HandlingInstructions<Throwable, Y> handling, final @Nonnull LBiCharConsumerX<X> lambda) throws Y {
		Null.nonNullArg(lambda, "lambda");
	...
	/** Combines two LBiCharConsumerX<X> together in a order. */
	@Nonnull
	...
	interface V1<X extends Throwable> extends LBiCharConsumerX<X> {
		...
		void doAcceptV1(char a2, char a1) throws X;
