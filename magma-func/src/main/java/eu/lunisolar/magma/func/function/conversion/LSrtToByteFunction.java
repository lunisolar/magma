...
public interface LSrtToByteFunction extends MetaFunction, MetaInterface.NonThrowing, Codomain<aByte>, Domain1<aShort> { // NOSONAR
	 ...
	 */
	public static M memento(byte initialValue, LSrtToByteFunction baseFunction, LByteBinaryOperator mementoFunction) {
		return new M(initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not ). Very short name is intended to be used with parent (LSrtToByteFunction.D)
	 */
	final class M implements LSrtToByteFunction {
		...
		private M(byte lastValue, LSrtToByteFunction baseFunction, LByteBinaryOperator mementoFunction) {
