...
/**
 * Non-throwing functional interface (lambda) ByteBiConsumer for Java 8.
 *
 * Type: consumer
 *
...
public interface ByteBiConsumer extends ByteBiConsumerX<RuntimeException>, MetaConsumer, MetaInterface.NonThrowing {

	public static final String DESCRIPTION = "ByteBiConsumer: void accept(byte b1,byte b2)";
	...
	@Nonnull
	public static ByteBiConsumer l(final @Nonnull ByteBiConsumer lambda) {
	...
	@Nonnull
	public static <X extends Exception> ByteBiConsumer wrap(final @Nonnull ByteBiConsumerX<X> other) {
	 ...
	 */
	@Nonnull
	default ByteBiConsumer fromByte(@Nonnull final ByteUnaryOperator before1, @Nonnull final ByteUnaryOperator before2) {
	 ...
	 */
	@Nonnull
	default <V1, V2> BiConsumer<V1, V2> from(@Nonnull final ToByteFunction<? super V1> before1, @Nonnull final ToByteFunction<? super V2> before2) {
		Objects.requireNonNull(before1, Function4U.VALIDATION_MESSAGE_BEFORE1);
		Objects.requireNonNull(before2, Function4U.VALIDATION_MESSAGE_BEFORE2);
	...
	@Nonnull
	default ByteBiConsumer andThen(@Nonnull ByteBiConsumer after) {
