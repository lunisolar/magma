...
public interface LObjLongPredicate<T> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain2<a<T>, aLong> { //NOSONAR
	...
	default LLongPredicate _with(T a1) {
		return a2 -> test(a1, a2);
	}

	default LPredicate<T> with(long a2) {
	...
	final class M<T> implements LObjLongPredicate<T> {
		...
		public boolean currentTest(T a1, long a2) {
			boolean x1 = lastBaseValue;
		...
		public boolean currentBaseValue(T a1, long a2) {
	...
	public static <T> boolean any(boolean expected, T a1, long a2, @Nonnull Collection<? extends LObjLongPredicate<? super T>> predicates) {
		return any(expected, a1, a2, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static <T> boolean any(boolean expected, T a1, long a2, @Nonnull Stream<? extends LObjLongPredicate<? super T>> predicates) {
		return any(expected, a1, a2, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static <T> boolean any(boolean expected, T a1, long a2, @Nonnull Iterator<? extends LObjLongPredicate<? super T>> predicates) {
		Null.nonNullArg(predicates, "predicates");
	...
	public static <T> boolean any(boolean expected, T a1, long a2, @Nonnull LObjLongPredicate<? super T>... predicates) {
		Null.nonNullArg(predicates, "predicates");
