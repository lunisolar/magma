...
public interface LBiObjFltFunction<T1, T2, R> extends MetaFunction, MetaInterface.NonThrowing, Codomain<a<R>>, Domain3<a<T1>, a<T2>, aFloat> { // NOSONAR
	...
	default R apply(T1 a1, T2 a2, float a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LBiObjFltFunction<T1, T2, R> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
	...
	static <T1, T2, R> R tryApply(T1 a1, T2 a2, float a3, LBiObjFltFunction<T1, T2, R> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		Null.nonNullArg(func, "func");
	...
	public default LObjFltFunction<T2, R> lShrink(@Nonnull LObjFltFunction<T2, T1> left) {
		Null.nonNullArg(left, "left");
		return (a2, a3) -> apply(left.apply(a2, a3), a2, a3);
	}

	public default LObjFltFunction<T2, R> lShrink_(T1 a1) {
	...
	public default LBiFunction<T1, T2, R> rShrink(@Nonnull LToFltBiFunction<T1, T2> right) {
		Null.nonNullArg(right, "right");
		return (a1, a2) -> apply(a1, a2, right.applyAsFlt(a1, a2));
	}

	public default LBiFunction<T1, T2, R> rShrink_(float a3) {
	...
	public default LBiObjFltFunction untyped() {
		return this;
	}

	/** Cast that replace generics. */
	public default <V2, V3, V4> LBiObjFltFunction<V2, V3, V4> cast() {
		return untyped();
	}
	...
	public default LBiObjFltFunction<T1, T2, R> beforeDo(@Nonnull LBiObjFltConsumer<T1, T2> before) {
	...
	public default LBiObjFltFunction<T1, T2, R> afterDo(@Nonnull LConsumer<R> after) {
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2, R> LObj0Flt2Obj1Func<T1, T2, R> obj0Flt2Obj1Func(final @Nonnull LObj0Flt2Obj1Func<T1, T2, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1, R> LObj1Obj0Flt2Func<T2, T1, R> obj1Obj0Flt2Func(final @Nonnull LObj1Obj0Flt2Func<T2, T1, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1, R> LObj1Flt2Obj0Func<T2, T1, R> obj1Flt2Obj0Func(final @Nonnull LObj1Flt2Obj0Func<T2, T1, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2, R> LFlt2Obj0Obj1Func<T1, T2, R> flt2Obj0Obj1Func(final @Nonnull LFlt2Obj0Obj1Func<T1, T2, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1, R> LFlt2Obj1Obj0Func<T2, T1, R> flt2Obj1Obj0Func(final @Nonnull LFlt2Obj1Obj0Func<T2, T1, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
