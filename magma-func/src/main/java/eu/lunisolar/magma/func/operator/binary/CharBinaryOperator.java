...
/**
 * Non-throwing functional interface (lambda) CharBinaryOperator for Java 8.
 *
 * Type: operator
 *
...
public interface CharBinaryOperator extends CharBinaryOperatorX<RuntimeException>, MetaOperator, PrimitiveCodomain<Object>, MetaInterface.NonThrowing { // NOSONAR
