...
public interface LBiCharPredicate extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain2<aChar, aChar> { // NOSONAR
	...
	public static boolean any(boolean expected, char a1, char a2, @Nonnull Collection<? extends LBiCharPredicate> predicates) {
		return any(expected, a1, a2, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static boolean any(boolean expected, char a1, char a2, @Nonnull Stream<? extends LBiCharPredicate> predicates) {
		return any(expected, a1, a2, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static boolean any(boolean expected, char a1, char a2, @Nonnull Iterator<? extends LBiCharPredicate> predicates) {
		Null.nonNullArg(predicates, "predicates");
	...
	public static boolean any(boolean expected, char a1, char a2, @Nonnull LBiCharPredicate... predicates) {
		Null.nonNullArg(predicates, "predicates");
	...
	default LBiCharPredicate shoving() {

		return new LBiCharPredicate() {

			public boolean test(char a1, char a2) {
				try {
					return this.testX(a1, a2);
				} catch (Throwable e) { // NOSONAR
					Handling.handleErrors(e);
			...
			public boolean testX(char a1, char a2) throws Throwable {
				return LBiCharPredicate.this.testX(a1, a2);
			}
