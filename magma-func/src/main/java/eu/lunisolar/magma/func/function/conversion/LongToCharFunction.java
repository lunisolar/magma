...
/**
 * Non-throwing functional interface (lambda) LongToCharFunction for Java 8.
 *
 * Type: function
 *
 * Domain (lvl: 1): long l
...
public interface LongToCharFunction extends LongToCharFunctionX<RuntimeException>, MetaFunction, PrimitiveCodomain<Object>, MetaInterface.NonThrowing { // NOSONAR
