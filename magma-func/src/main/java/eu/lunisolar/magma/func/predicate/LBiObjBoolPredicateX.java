...
public interface LBiObjBoolPredicateX<T1, T2, X extends Throwable> extends MetaPredicate, MetaInterface.Throwing<X> { // NOSONAR
	...
	@Nonnull
	static <T1, T2, X extends Throwable> LBiObjBoolPredicateX<T1, T2, X> safe() {
		return Function4U::alwaysFalse;
	}

	/** Safe instance supplier. Returns supplier of safe() instance. */
	@Nonnull
	static <T1, T2, X extends Throwable, Y extends Throwable> LSupplierX<LBiObjBoolPredicateX<T1, T2, X>, Y> safeSupplier() {
		return () -> safe();
	}

	/** Safe wrapping. Either argument function is returned (if it is not null) or safe() instance. */
	@Nonnull
	static <T1, T2, X extends Throwable> LBiObjBoolPredicateX<T1, T2, X> safe(final @Nullable LBiObjBoolPredicateX<T1, T2, X> other) {
		if (other == null) {
			return safe();
		} else {
			return other;
	...
	@Nonnull
	static <T1, T2, X extends Throwable, Y extends Throwable> LSupplierX<LBiObjBoolPredicateX<T1, T2, X>, Y> safeSupplier(final @Nullable LSupplierX<LBiObjBoolPredicateX<T1, T2, X>, Y> supplier) {
		if (supplier == null) {
			return safeSupplier();
		} else {
			return supplier;
	 ...
	 */
	@Nonnull
	static <T1, T2, X extends Throwable> LBiObjBoolPredicateX<T1, T2, X> isEqual(T1 v1, T2 v2, boolean v3) {
	...
	@Nonnull
	default <V1, V2> LBiObjBoolPredicateX<V1, V2, X> biObjBoolPredComposeBool(@Nonnull final LFunctionX<? super V1, ? extends T1, X> before1, @Nonnull final LFunctionX<? super V2, ? extends T2, X> before2, @Nonnull final LLogicalOperatorX<X> before3) {
	...
	@Nonnull
	default <V> LBiObjBoolFunctionX<T1, T2, V, X> boolToBiObjBoolFunc(@Nonnull LBoolFunctionX<? extends V, X> after) {
	...
	/** Permutation of LBiObjBoolPredicateX for method references. */
	@FunctionalInterface
	interface V1<T1, T2, X extends Throwable> extends LBiObjBoolPredicateX<T1, T2, X> {

		boolean doTestV1(T1 a1, boolean a3, T2 a2) throws X;

		@Override
		default boolean doTest(T1 a1, T2 a2, boolean a3) throws X {
	...
	/** Permutation of LBiObjBoolPredicateX for method references. */
	@FunctionalInterface
	interface V2<T2, T1, X extends Throwable> extends LBiObjBoolPredicateX<T1, T2, X> {

		boolean doTestV2(T2 a2, T1 a1, boolean a3) throws X;
	...
	/** Permutation of LBiObjBoolPredicateX for method references. */
	@FunctionalInterface
	interface V3<T2, T1, X extends Throwable> extends LBiObjBoolPredicateX<T1, T2, X> {

		boolean doTestV3(T2 a2, boolean a3, T1 a1) throws X;
	...
	/** Permutation of LBiObjBoolPredicateX for method references. */
	@FunctionalInterface
	interface V4<T1, T2, X extends Throwable> extends LBiObjBoolPredicateX<T1, T2, X> {

		boolean doTestV4(boolean a3, T1 a1, T2 a2) throws X;
	...
	/** Permutation of LBiObjBoolPredicateX for method references. */
	@FunctionalInterface
	interface V5<T2, T1, X extends Throwable> extends LBiObjBoolPredicateX<T1, T2, X> {

		boolean doTestV5(boolean a3, T2 a2, T1 a1) throws X;
