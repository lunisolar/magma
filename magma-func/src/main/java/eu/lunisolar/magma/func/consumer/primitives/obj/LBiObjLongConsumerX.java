...
public interface LBiObjLongConsumerX<T1, T2, X extends Throwable> extends MetaConsumer, MetaInterface.Throwing<X> {
	...
	/** Safe instance. */
	@Nonnull
	static <T1, T2, X extends Throwable> LBiObjLongConsumerX<T1, T2, X> safe() {
		return Function4U::doNothing;
	}

	/** Safe instance supplier. Returns supplier of safe() instance. */
	@Nonnull
	static <T1, T2, X extends Throwable, Y extends Throwable> LSupplierX<LBiObjLongConsumerX<T1, T2, X>, Y> safeSupplier() {
		return () -> safe();
	}

	/** Safe wrapping. Either argument function is returned (if it is not null) or safe() instance. */
	@Nonnull
	static <T1, T2, X extends Throwable> LBiObjLongConsumerX<T1, T2, X> safe(final @Nullable LBiObjLongConsumerX<T1, T2, X> other) {
		if (other == null) {
			return safe();
		} else {
			return other;
	...
	@Nonnull
	static <T1, T2, X extends Throwable, Y extends Throwable> LSupplierX<LBiObjLongConsumerX<T1, T2, X>, Y> safeSupplier(final @Nullable LSupplierX<LBiObjLongConsumerX<T1, T2, X>, Y> supplier) {
		if (supplier == null) {
			return safeSupplier();
		} else {
			return supplier;
	...
	default <V1, V2> LBiObjLongConsumerX<V1, V2, X> biObjLongConsComposeLong(@Nonnull final LFunctionX<? super V1, ? extends T1, X> before1, @Nonnull final LFunctionX<? super V2, ? extends T2, X> before2, @Nonnull final LLongUnaryOperatorX<X> before3) {
		...
		return (V1 v1, V2 v2, long v3) -> this.doAccept(before1.doApply(v1), before2.doApply(v2), before3.doApplyAsLong(v3));
	}
	...
	/** Combines two LBiObjLongConsumerX<T1,T2,X> together in a order. */
	@Nonnull
	...
	/** Permutation of LBiObjLongConsumerX for method references. */
	@FunctionalInterface
	interface V1<T1, T2, X extends Throwable> extends LBiObjLongConsumerX<T1, T2, X> {

		void doAcceptV1(T1 a1, long a3, T2 a2) throws X;

		@Override
		default void doAccept(T1 a1, T2 a2, long a3) throws X {
	...
	/** Permutation of LBiObjLongConsumerX for method references. */
	@FunctionalInterface
	interface V2<T2, T1, X extends Throwable> extends LBiObjLongConsumerX<T1, T2, X> {

		void doAcceptV2(T2 a2, T1 a1, long a3) throws X;
	...
	/** Permutation of LBiObjLongConsumerX for method references. */
	@FunctionalInterface
	interface V3<T2, T1, X extends Throwable> extends LBiObjLongConsumerX<T1, T2, X> {

		void doAcceptV3(T2 a2, long a3, T1 a1) throws X;
	...
	/** Permutation of LBiObjLongConsumerX for method references. */
	@FunctionalInterface
	interface V4<T1, T2, X extends Throwable> extends LBiObjLongConsumerX<T1, T2, X> {

		void doAcceptV4(long a3, T1 a1, T2 a2) throws X;
	...
	/** Permutation of LBiObjLongConsumerX for method references. */
	@FunctionalInterface
	interface V5<T2, T1, X extends Throwable> extends LBiObjLongConsumerX<T1, T2, X> {

		void doAcceptV5(long a3, T2 a2, T1 a1) throws X;
