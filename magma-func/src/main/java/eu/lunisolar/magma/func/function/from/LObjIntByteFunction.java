...
public interface LObjIntByteFunction<T, R> extends MetaFunction, MetaInterface.NonThrowing, Codomain<a<R>>, Domain3<a<T>, aInt, aByte> { // NOSONAR
	...
	default R apply(T a1, int a2, byte a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LObjIntByteFunction<T, R> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
	...
	static <T, R> R tryApply(T a1, int a2, byte a3, LObjIntByteFunction<T, R> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		Null.nonNullArg(func, "func");
	...
	public static <R, M, K, V> R from(M container, LBiFunction<M, K, V> extractor, K key, int a2, byte a3, LObjIntByteFunction<V, R> function) {
	...
	/**  */
	public static <T, R> LObjIntByteFunction<T, R> uncurry(LFunction<T, LIntFunction<LByteFunction<R>>> func) {
		return (T a1, int a2, byte a3) -> func.apply(a1).apply(a2).apply(a3);
	}

	/** Cast that removes generics. */
	public default LObjIntByteFunction untyped() {
		return this;
	}

	/** Cast that replace generics. */
	public default <V2, V3> LObjIntByteFunction<V2, V3> cast() {
		return untyped();
	}
