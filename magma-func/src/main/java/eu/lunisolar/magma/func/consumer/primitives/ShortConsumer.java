...
/**
 * Non-throwing functional interface (lambda) ShortConsumer for Java 8.
 *
 * Type: consumer
 *
...
public interface ShortConsumer extends ShortConsumerX<RuntimeException>, MetaConsumer, MetaInterface.NonThrowing {

	public static final String DESCRIPTION = "ShortConsumer: void accept(short s)";
	...
	@Nonnull
	public static ShortConsumer l(final @Nonnull ShortConsumer lambda) {
	...
	@Nonnull
	public static <X extends Exception> ShortConsumer wrap(final @Nonnull ShortConsumerX<X> other) {
		return (short s) -> {
			try {
				other.accept(s);
			} catch (Exception e) {
	 ...
	 */
	@Nonnull
	default ShortConsumer fromShort(@Nonnull final ShortUnaryOperator before1) {
	 ...
	 */
	@Nonnull
	default <V1> Consumer<V1> from(@Nonnull final ToShortFunction<? super V1> before1) {
		Objects.requireNonNull(before1, Function4U.VALIDATION_MESSAGE_BEFORE1);
