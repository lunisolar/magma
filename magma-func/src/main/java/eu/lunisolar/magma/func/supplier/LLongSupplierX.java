...
public interface LLongSupplierX<X extends Throwable> extends LongSupplier, MetaSupplier, MetaInterface.Throwing<X> { // NOSONAR
	...
	@Nonnull
	static <X extends Throwable> LLongSupplierX<X> safe() {
		return Function4U::produceLong;
	}

	/** Safe instance supplier. Returns supplier of safe() instance. */
	@Nonnull
	static <X extends Throwable, Y extends Throwable> LSupplierX<LLongSupplierX<X>, Y> safeSupplier() {
		return () -> safe();
	}

	/** Safe wrapping. Either argument function is returned (if it is not null) or safe() instance. */
	@Nonnull
	static <X extends Throwable> LLongSupplierX<X> safe(final @Nullable LLongSupplierX<X> other) {
		if (other == null) {
			return safe();
		} else {
			return other;
	...
	@Nonnull
	static <X extends Throwable, Y extends Throwable> LSupplierX<LLongSupplierX<X>, Y> safeSupplier(final @Nullable LSupplierX<LLongSupplierX<X>, Y> supplier) {
		if (supplier == null) {
			return safeSupplier();
		} else {
			return supplier;
	...
	@Nonnull
	default <V> LSupplierX<V, X> toSup(@Nonnull LLongFunctionX<? extends V, X> after) {
	...
	/** Combines two functions together in a order. */
	@Nonnull
	default LByteSupplierX<X> toByteSup(@Nonnull LLongToByteFunctionX<X> after) {
		Null.nonNullArg(after, "after");
	...
	/** Combines two functions together in a order. */
	@Nonnull
	default LShortSupplierX<X> toShortSup(@Nonnull LLongToShortFunctionX<X> after) {
		Null.nonNullArg(after, "after");
	...
	/** Combines two functions together in a order. */
	@Nonnull
	default LIntSupplierX<X> toIntSup(@Nonnull LLongToIntFunctionX<X> after) {
		Null.nonNullArg(after, "after");
	...
	/** Combines two functions together in a order. */
	@Nonnull
	default LLongSupplierX<X> toLongSup(@Nonnull LLongUnaryOperatorX<X> after) {
		Null.nonNullArg(after, "after");
	...
	/** Combines two functions together in a order. */
	@Nonnull
	default LFloatSupplierX<X> toFloatSup(@Nonnull LLongToFloatFunctionX<X> after) {
		Null.nonNullArg(after, "after");
	...
	/** Combines two functions together in a order. */
	@Nonnull
	default LDoubleSupplierX<X> toDoubleSup(@Nonnull LLongToDoubleFunctionX<X> after) {
		Null.nonNullArg(after, "after");
	...
	/** Combines two functions together in a order. */
	@Nonnull
	default LCharSupplierX<X> toCharSup(@Nonnull LLongToCharFunctionX<X> after) {
		Null.nonNullArg(after, "after");
	...
	/** Combines two functions together in a order. */
	@Nonnull
	default LBoolSupplierX<X> toBoolSup(@Nonnull LLongPredicateX<X> after) {
		Null.nonNullArg(after, "after");
