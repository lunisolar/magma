...
public interface LDblTriple extends LTuple<Double>, Comparable<LDblTriple> {
	...
	public static Iterator<LDblTriple.MutDblTriple> mutIterator(PrimitiveIterator.OfDouble items) {
		return iterator(items, LDblTriple::of);
	}

	public static Iterator<LDblTriple> immIterator(PrimitiveIterator.OfDouble items) {
		return iterator(items, LDblTriple::immutableOf);
	}
	...
	public static Stream<LDblTriple.MutDblTriple> mutStream(DoubleStream items) {
		return stream(items, LDblTriple::of);
	}

	public static Stream<LDblTriple> immStream(DoubleStream items) {
		return stream(items, LDblTriple::immutableOf);
	}
	...
	public static <C, R> Iterator<R> iterator(SequentialRead<C, ?, aDouble> sa_, C source, LTriDblFunction<R> factory) {
