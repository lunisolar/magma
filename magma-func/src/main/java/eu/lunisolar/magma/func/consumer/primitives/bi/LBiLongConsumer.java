...
public interface LBiLongConsumer extends MetaConsumer, MetaInterface.NonThrowing, Codomain<aVoid>, Domain2<aLong, aLong> {
	...
	default void accept(long a1, long a2, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage) {
		try {
			this.acceptX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default void accept(long a1, long a2, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1) {
		try {
			this.acceptX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default void accept(long a1, long a2, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		try {
			this.acceptX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default void accept(long a1, long a2, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		try {
			this.acceptX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default LBiLongConsumer trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage) {
		return (a1, a2) -> accept(a1, a2, factory, newMessage);
	}

	default LBiLongConsumer trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1) {
		return (a1, a2) -> accept(a1, a2, factory, newMessage, param1);
	}

	default LBiLongConsumer trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		return (a1, a2) -> accept(a1, a2, factory, newMessage, param1, param1);
	}

	default LBiLongConsumer trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		return (a1, a2) -> accept(a1, a2, factory, newMessage, param1, param2, param3);
	}

	default void accept(long a1, long a2, @Nonnull ExWF<RuntimeException> factory) {
		try {
			this.acceptX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default LBiLongConsumer trying(@Nonnull ExWF<RuntimeException> factory) {
	...
	static void shovingAccept(long a1, long a2, LBiLongConsumer func) {
	...
	static void tryAccept(long a1, long a2, LBiLongConsumer func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage) {
		Null.nonNullArg(func, "func");
		func.accept(a1, a2, factory, newMessage);
	}

	static void tryAccept(long a1, long a2, LBiLongConsumer func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1) {
		Null.nonNullArg(func, "func");
		func.accept(a1, a2, factory, newMessage, param1);
	}

	static void tryAccept(long a1, long a2, LBiLongConsumer func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		Null.nonNullArg(func, "func");
		func.accept(a1, a2, factory, newMessage, param1, param2);
	}

	static void tryAccept(long a1, long a2, LBiLongConsumer func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		Null.nonNullArg(func, "func");
		func.accept(a1, a2, factory, newMessage, param1, param2, param3);
	}

	static void tryAccept(long a1, long a2, LBiLongConsumer func, @Nonnull ExWF<RuntimeException> factory) {
		Null.nonNullArg(func, "func");
	...
	public static void fromTo(int min_i, int max_i, long a1, long a2, @Nonnull LBiLongConsumer func) {
		Null.nonNullArg(func, "func");
		if (min_i <= max_i) {
	...
	/** From-To. Intended to be used with non-capturing lambda. */
	public static void fromTill(int min_i, int max_i, long a1, long a2, @Nonnull LBiLongConsumer func) {
		Null.nonNullArg(func, "func");
		if (min_i <= max_i) {
			for (int i = min_i; i < max_i; i++) {
				func.accept(a1, a2);
	...
	/** From-To. Intended to be used with non-capturing lambda. */
	public static void times(int max_i, long a1, long a2, @Nonnull LBiLongConsumer func) {
		if (max_i < 0)
			return;
		fromTill(0, max_i, a1, a2, func);
	}

	default LLongConsumer lShrink(@Nonnull LLongUnaryOperator left) {
		Null.nonNullArg(left, "left");
		return a2 -> accept(left.applyAsLong(a2), a2);
	}

	default LLongConsumer lShrink_(long a1) {
		return a2 -> accept(a1, a2);
	}

	public static LLongConsumer lShrunken(@Nonnull LLongUnaryOperator left, @Nonnull LBiLongConsumer func) {
		Null.nonNullArg(left, "left");
		Null.nonNullArg(func, "func");
		return func.lShrink(left);
	}

	public static LLongConsumer lShrunken_(long a1, @Nonnull LBiLongConsumer func) {
		Null.nonNullArg(func, "func");
		return func.lShrink_(a1);
	}

	default LLongConsumer rShrink(@Nonnull LLongUnaryOperator right) {
		Null.nonNullArg(right, "right");
		return a1 -> accept(a1, right.applyAsLong(a1));
	}

	default LLongConsumer rShrink_(long a2) {
		return a1 -> accept(a1, a2);
	}

	public static LLongConsumer rShrunken(@Nonnull LLongUnaryOperator right, @Nonnull LBiLongConsumer func) {
		Null.nonNullArg(right, "right");
		Null.nonNullArg(func, "func");
		return func.rShrink(right);
	}

	public static LLongConsumer rShrunken_(long a2, @Nonnull LBiLongConsumer func) {
		Null.nonNullArg(func, "func");
	...
	default <T> LBiLongFunction<T> returning(T value) {
		return (a1, a2) -> {
			LBiLongConsumer.this.accept(a1, a2);
			return value;
		};
	}

	/** Calls domain consumer before main function. */
	default LBiLongConsumer beforeDo(@Nonnull LBiLongConsumer before) {
	...
	final class S implements LBiLongConsumer {
