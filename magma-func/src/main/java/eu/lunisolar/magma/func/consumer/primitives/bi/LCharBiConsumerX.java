...
public interface LCharBiConsumerX<X extends Exception> extends MetaConsumer, MetaInterface.Throwing<X> {

	public static final String DESCRIPTION = "LCharBiConsumerX: void accept(char c1,char c2) throws X";
	...
	@Nonnull
	public static <X extends Exception> LCharBiConsumerX<X> lX(final @Nonnull LCharBiConsumerX<X> lambda) {
	...
	@Nonnull
	public static <X extends Exception, E extends Exception, Y extends Exception> LCharBiConsumerX<Y> wrapException(@Nonnull final LCharBiConsumerX<X> other, Class<E> exception, ExceptionHandler<E, Y> handler) {
		return (char c1, char c2) -> {
			try {
				other.accept(c1, c2);
			} catch (Exception e) {
	...
	@Nonnull
	default <E extends Exception, Y extends Exception> LCharBiConsumerX<Y> handleX(Class<E> exception, ExceptionHandler<E, Y> handler) {
		Objects.requireNonNull(exception, Function4U.VALIDATION_MESSAGE_EXCEPTION);
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return LCharBiConsumerX.wrapException(this, exception, (ExceptionHandler) handler);
	}

	/** Wraps with exception handling that for any exception (including unchecked exception that might be different from X) will call handler function to determine the final exception. */
	@Nonnull
	default <Y extends Exception> LCharBiConsumerX<Y> handleX(ExceptionHandler<Exception, Y> handler) {
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return LCharBiConsumerX.wrapException(this, Exception.class, (ExceptionHandler) handler);
	}
