...
public interface LByteToLongFunction extends MetaFunction, MetaInterface.NonThrowing, Codomain<aLong>, Domain1<aByte> { // NOSONAR
	...
	public default LByteToLongFunction beforeDo(@Nonnull LByteConsumer before) {
	...
	public default LByteToLongFunction afterDo(@Nonnull LLongConsumer after) {
	...
	final class LByteToLongFunctionSingle implements LByteToLongFunction {
