...
public interface LObjIntObjPredicate<T1, T2> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<a<T1>, aInt, a<T2>> { // NOSONAR
	...
	final class M<T1, T2> implements LObjIntObjPredicate<T1, T2> {
		...
		public boolean currentTest(T1 a1, int a2, T2 a3) {
			boolean x1 = lastBaseValue;
		...
		public boolean currentBaseValue(T1 a1, int a2, T2 a3) {
	...
	public static <T1, T2> boolean any(boolean expected, T1 a1, int a2, T2 a3, @Nonnull Collection<? extends LObjIntObjPredicate<? super T1, ? super T2>> predicates) {
		return any(expected, a1, a2, a3, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static <T1, T2> boolean any(boolean expected, T1 a1, int a2, T2 a3, @Nonnull Stream<? extends LObjIntObjPredicate<? super T1, ? super T2>> predicates) {
		return any(expected, a1, a2, a3, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static <T1, T2> boolean any(boolean expected, T1 a1, int a2, T2 a3, @Nonnull Iterator<? extends LObjIntObjPredicate<? super T1, ? super T2>> predicates) {
		Null.nonNullArg(predicates, "predicates");
	...
	public static <T1, T2> boolean any(boolean expected, T1 a1, int a2, T2 a3, @Nonnull LObjIntObjPredicate<? super T1, ? super T2>... predicates) {
		Null.nonNullArg(predicates, "predicates");
