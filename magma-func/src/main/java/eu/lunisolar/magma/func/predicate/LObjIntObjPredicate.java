...
public interface LObjIntObjPredicate<T1, T2> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<a<T1>, aInt, a<T2>> { // NOSONAR
	 ...
	 */
	public static <T1, T2> M<T1, T2> memento(boolean initialValue, LObjIntObjPredicate<T1, T2> baseFunction, LLogicalBinaryOperator mementoFunction) {
		return new M(initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not ). Very short name is intended to be used with parent (LObjIntObjPredicate.D)
	 */
	final class M<T1, T2> implements LObjIntObjPredicate<T1, T2> {
		...
		private M(boolean lastValue, LObjIntObjPredicate<T1, T2> baseFunction, LLogicalBinaryOperator mementoFunction) {
