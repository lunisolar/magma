...
public interface LSrtIntConsumer extends MetaConsumer, MetaInterface.NonThrowing, Codomain<aVoid>, Domain2<aShort, aInt> {
	...
	default LIntConsumer _with(short a1) {
		return a2 -> accept(a1, a2);
	}

	default LSrtConsumer with(int a2) {
	...
	default LSrtIntConsumer shoving() {

		return new LSrtIntConsumer() {

			public void accept(short a1, int a2) {
				try {
					this.acceptX(a1, a2);
				} catch (Throwable e) { // NOSONAR
					Handling.handleErrors(e);
			...
			public void acceptX(short a1, int a2) throws Throwable {
				LSrtIntConsumer.this.acceptX(a1, a2);
			}
