...
public interface LSrtIntConsumer extends MetaConsumer, MetaInterface.NonThrowing, Codomain<aVoid>, Domain2<aShort, aInt> {
	...
	default void accept(short a1, int a2, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		try {
			this.acceptX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	static void tryAccept(short a1, int a2, LSrtIntConsumer func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		Null.nonNullArg(func, "func");
	...
	public default LIntConsumer lShrink(@Nonnull LIntToSrtFunction left) {
		Null.nonNullArg(left, "left");
		return a2 -> accept(left.applyAsSrt(a2), a2);
	}

	public default LIntConsumer lShrink_(short a1) {
	...
	public default LSrtConsumer rShrink(@Nonnull LSrtToIntFunction right) {
		Null.nonNullArg(right, "right");
		return a1 -> accept(a1, right.applyAsInt(a1));
	}

	public default LSrtConsumer rShrink_(int a2) {
	...
	public default LSrtIntConsumer beforeDo(@Nonnull LSrtIntConsumer before) {
