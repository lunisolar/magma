...
public interface BiObjIntFunction<T1, T2, R> extends BiObjIntFunctionX<T1, T2, R, RuntimeException>, MetaFunction, MetaInterface.NonThrowing { // NOSONAR
	...
	public static <T1, T2, R> BiObjIntFunction<T1, T2, R> constant(R r) {
		return (t1, t2, i) -> r;
	}
