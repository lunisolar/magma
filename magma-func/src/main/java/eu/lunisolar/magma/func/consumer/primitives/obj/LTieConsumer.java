...
public interface LTieConsumer<T1, T2> extends MetaConsumer, MetaInterface.NonThrowing, TieConsumer<T1, a<T2>>, Codomain<aVoid>, Domain3<a<T1>, aInt, a<T2>> {
	...
	static <T1, T2> void tryAccept(T1 a1, int a2, T2 a3, LTieConsumer<T1, T2> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		Null.nonNullArg(func, "func");
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2> LObj0Obj2Int1Cons<T1, T2> obj0Obj2Int1Cons(final @Nonnull LObj0Obj2Int1Cons<T1, T2> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2> LInt1BiObj2Cons<T1, T2> int1BiObj2Cons(final @Nonnull LInt1BiObj2Cons<T1, T2> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1> LInt1Obj2Obj0Cons<T2, T1> int1Obj2Obj0Cons(final @Nonnull LInt1Obj2Obj0Cons<T2, T1> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1> LObj2Obj0Int1Cons<T2, T1> obj2Obj0Int1Cons(final @Nonnull LObj2Obj0Int1Cons<T2, T1> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1> LObj2Int1Obj0Cons<T2, T1> obj2Int1Obj0Cons(final @Nonnull LObj2Int1Obj0Cons<T2, T1> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
