...
public interface LObjCharFunctionX<T, R, X extends Throwable> extends MetaFunction, MetaInterface.Throwing<X> { // NOSONAR
	...
	public static <T, R, X extends Throwable> LObjCharFunctionX<T, R, X> constant(R r) {
		return (t, c) -> r;
	}

	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	public static <T, R, X extends Throwable> LObjCharFunctionX<T, R, X> lX(final @Nonnull LObjCharFunctionX<T, R, X> lambda) {
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	public static <T, R, X extends Throwable> LObjCharFunctionX<T, R, X> lX(@Nonnull Class<X> xClass, final @Nonnull LObjCharFunctionX<T, R, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	@Nonnull
	public static <T, R, X extends Throwable> LObjCharFunctionX<T, R, X> wrapX(final @Nonnull LObjCharFunction<T, R> other) {
