...
public interface LDblToLongFunction extends DoubleToLongFunction, MetaFunction, MetaInterface.NonThrowing, Codomain<aLong>, Domain1<aDouble> { // NOSONAR
	...
	public default LDblToLongFunction beforeDo(@Nonnull LDblConsumer before) {
	...
	public default LDblToLongFunction afterDo(@Nonnull LLongConsumer after) {
	...
	static LDblToLongFunction safe() {
		return LDblToLongFunction::produceLong;
	}
