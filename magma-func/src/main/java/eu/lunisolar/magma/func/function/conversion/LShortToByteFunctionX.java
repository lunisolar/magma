...
public interface LShortToByteFunctionX<X extends Throwable> extends MetaFunction, MetaInterface.Throwing<X> { // NOSONAR
	...
	String DESCRIPTION = "LShortToByteFunctionX: byte doApplyAsByte(short a1) throws X";

	byte doApplyAsByte(short a1) throws X;
	...
	default byte shovingDoApplyAsByte(short a1) {
		return ((LShortToByteFunctionX<RuntimeException>) this).doApplyAsByte(a1);
	}

	/** Function call that handles exceptions according to the instructions. */
	default <Y extends Throwable> byte handlingDoApplyAsByte(short a1, HandlingInstructions<Throwable, Y> handling) throws Y {
	...
	default byte nonNullDoApplyAsByte(short a1) throws X {
	...
	default LByteSupplierX<X> captureShortToByteFunc(short a1) {
		return () -> this.doApplyAsByte(a1);
	}
	...
	static <X extends Throwable> byte call(short a1, final @Nonnull LShortToByteFunctionX<X> lambda) throws X {
		Null.nonNullArg(lambda, "lambda");
		return lambda.doApplyAsByte(a1);
	}

	static <X extends Throwable> byte shoving(short a1, final @Nonnull LShortToByteFunctionX<X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.shovingDoApplyAsByte(a1);
	}

	static <X extends Throwable> byte nesting(short a1, final @Nonnull LShortToByteFunctionX<X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.nestingDoApplyAsByte(a1);
	}

	static <X extends Throwable, Y extends Throwable> byte handling(short a1, final HandlingInstructions<Throwable, Y> handling, final @Nonnull LShortToByteFunctionX<X> lambda) throws Y {
		Null.nonNullArg(lambda, "lambda");
