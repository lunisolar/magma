...
/**
 * Non-throwing functional interface (lambda) CharToDoubleFunction for Java 8.
 *
 * Type: function
 *
 * Domain (lvl: 1): char c
...
public interface CharToDoubleFunction extends CharToDoubleFunctionX<RuntimeException>, MetaFunction, PrimitiveCodomain<Object>, MetaInterface.NonThrowing { // NOSONAR
	...
	public static CharToDoubleFunction constant(double r) {
		return (c) -> r;
	}
