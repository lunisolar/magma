...
public interface LFltToByteFunction extends MetaFunction, MetaInterface.NonThrowing, Codomain<aByte>, Domain1<aFloat> { // NOSONAR
	...
	public default LFltToByteFunction beforeDo(@Nonnull LFltConsumer before) {
	...
	public default LFltToByteFunction afterDo(@Nonnull LByteConsumer after) {
	...
	final class LFltToByteFunctionSingle implements LFltToByteFunction {
