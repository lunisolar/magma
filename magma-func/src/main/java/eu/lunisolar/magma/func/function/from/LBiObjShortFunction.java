...
public interface LBiObjShortFunction<T1, T2, R> extends LBiObjShortFunctionX<T1, T2, R, RuntimeException>, MetaFunction, MetaInterface.NonThrowing { // NOSONAR
	...
	String DESCRIPTION = "LBiObjShortFunction: R doApply(T1 a1,T2 a2,short a3)";

	@Nullable
	R doApply(T1 a1, T2 a2, short a3);

	default R tupleApply(LBiObjShortTriple<T1, T2> args) {
	...
	default LSupplier<R> captureBiObjShortFunc(T1 a1, T2 a2, short a3) {
		return () -> this.doApply(a1, a2, a3);
	}
	...
	@Nonnull
	static <T1, T2, R> LBiObjShortFunction<T1, T2, R> apply1st(@Nonnull LFunction<T1, R> func) {
		return (a1, a2, a3) -> func.doApply(a1);
	}

	/** Captures single parameter function into this interface where only 2nd parameter will be used. */
	@Nonnull
	static <T1, T2, R> LBiObjShortFunction<T1, T2, R> apply2nd(@Nonnull LFunction<T2, R> func) {
		return (a1, a2, a3) -> func.doApply(a2);
	}

	/** Captures single parameter function into this interface where only 3rd parameter will be used. */
	@Nonnull
	static <T1, T2, R> LBiObjShortFunction<T1, T2, R> apply3rd(@Nonnull LShortFunction<R> func) {
	...
	@Nonnull
	static <T1, T2, R> LBiObjShortFunction<T1, T2, R> safe() {
		return Function4U::produce;
	}

	/** Safe instance supplier. Returns supplier of safe() instance. */
	@Nonnull
	static <T1, T2, R> LSupplier<LBiObjShortFunction<T1, T2, R>> safeSupplier() {
		return () -> safe();
	}

	/** Safe wrapping. Either argument function is returned (if it is not null) or safe() instance. */
	@Nonnull
	static <T1, T2, R> LBiObjShortFunction<T1, T2, R> safe(final @Nullable LBiObjShortFunction<T1, T2, R> other) {
		if (other == null) {
			return safe();
		} else {
			return other;
	...
	@Nonnull
	static <T1, T2, R> LSupplier<LBiObjShortFunction<T1, T2, R>> safeSupplier(final @Nullable LSupplier<LBiObjShortFunction<T1, T2, R>> supplier) {
		if (supplier == null) {
			return safeSupplier();
		} else {
			return supplier;
	...
	@Nonnull
	default <V1, V2> LBiObjShortFunction<V1, V2, R> biObjShortFuncComposeShort(@Nonnull final LFunction<? super V1, ? extends T1> before1, @Nonnull final LFunction<? super V2, ? extends T2> before2, @Nonnull final LShortUnaryOperator before3) {
		Null.nonNullArg(before1, "before1");
		Null.nonNullArg(before2, "before2");
		Null.nonNullArg(before3, "before3");
		return (v1, v2, v3) -> this.doApply(before1.doApply(v1), before2.doApply(v2), before3.doApplyAsShort(v3));
	}

	/** Allows to manipulate the domain of the function. */
	@Nonnull
	default <V1, V2, V3> LTriFunction<V1, V2, V3, R> biObjShortFuncCompose(@Nonnull final LFunction<? super V1, ? extends T1> before1, @Nonnull final LFunction<? super V2, ? extends T2> before2, @Nonnull final LToShortFunction<? super V3> before3) {
		Null.nonNullArg(before1, "before1");
		Null.nonNullArg(before2, "before2");
		Null.nonNullArg(before3, "before3");
		return (v1, v2, v3) -> this.doApply(before1.doApply(v1), before2.doApply(v2), before3.doApplyAsShort(v3));
	...
	@Nonnull
	default LBiObjShortFunction<T1, T2, R> nonNullBiObjShortFunc() {
		return this::nonNullDoApply;
	}

	// <editor-fold desc="interface variants">

	/** Permutation of LBiObjShortFunction for method references. */
	@FunctionalInterface
	interface V1<T1, T2, R> extends LBiObjShortFunction<T1, T2, R> {
		@Nullable
		R doApplyV1(T1 a1, short a3, T2 a2);
	...
	/** Permutation of LBiObjShortFunction for method references. */
	@FunctionalInterface
	interface V2<T2, T1, R> extends LBiObjShortFunction<T1, T2, R> {
		@Nullable
		R doApplyV2(T2 a2, T1 a1, short a3);
	...
	/** Permutation of LBiObjShortFunction for method references. */
	@FunctionalInterface
	interface V3<T2, T1, R> extends LBiObjShortFunction<T1, T2, R> {
		@Nullable
		R doApplyV3(T2 a2, short a3, T1 a1);
	...
	/** Permutation of LBiObjShortFunction for method references. */
	@FunctionalInterface
	interface V4<T1, T2, R> extends LBiObjShortFunction<T1, T2, R> {
		@Nullable
		R doApplyV4(short a3, T1 a1, T2 a2);
	...
	/** Permutation of LBiObjShortFunction for method references. */
	@FunctionalInterface
	interface V5<T2, T1, R> extends LBiObjShortFunction<T1, T2, R> {
		@Nullable
		R doApplyV5(short a3, T2 a2, T1 a1);
