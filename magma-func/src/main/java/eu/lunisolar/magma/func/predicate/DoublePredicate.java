...
public interface DoublePredicate extends java.util.function.DoublePredicate, DoublePredicateX<RuntimeException>, MetaPredicate, PrimitiveCodomain<Object>, MetaInterface.NonThrowing { // NOSONAR
