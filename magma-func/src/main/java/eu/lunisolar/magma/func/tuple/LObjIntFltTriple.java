...
public interface LObjIntFltTriple<T> extends LTuple<Object> {
	...
	interface Mut<T, SELF extends Mut<T, SELF>> extends LObjIntFltTriple<T> {
		...
		default LObjIntFltTriple<T> value(float value) {
			third(value);
			return this;
		}
	...
	public static <T> LObjIntFltTriple<T> immutableOf(T a1, int a2, float a3) {
		return new ImmObjIntFltTriple(a1, a2, a3);
	}

	public static <T> LObjIntFltTriple<T> immutableCopyOf(LObjIntFltTriple<T> tuple) {
