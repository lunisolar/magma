...
/**
 * Non-throwing functional interface (lambda) IntBinaryOperator for Java 8.
 *
 * Type: operator
 *
...
public interface IntBinaryOperator extends java.util.function.IntBinaryOperator, IntBinaryOperatorX<RuntimeException>, MetaOperator, PrimitiveCodomain<Object>, MetaInterface.NonThrowing { // NOSONAR
