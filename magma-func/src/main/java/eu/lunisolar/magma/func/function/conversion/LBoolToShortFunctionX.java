...
public interface LBoolToShortFunctionX<X extends Throwable> extends MetaFunction, PrimitiveCodomain<Object>, MetaInterface.Throwing<X> { // NOSONAR

	static final String DESCRIPTION = "LBoolToShortFunctionX: short doApplyAsShort(boolean b) throws X";
	...
	default short shovingDoApplyAsShort(boolean b) {
		return ((LBoolToShortFunctionX<RuntimeException>) this).doApplyAsShort(b);
	}
	...
	default LShortSupplierX<X> captureBoolToShortFunc(boolean b) {
		return () -> this.doApplyAsShort(b);
	}
