...
public interface LBoolToShortFunctionX<X extends Throwable> extends MetaFunction, MetaInterface.Throwing<X> { // NOSONAR
	...
	String DESCRIPTION = "LBoolToShortFunctionX: short doApplyAsShort(boolean a1) throws X";

	short doApplyAsShort(boolean a1) throws X;
	...
	default short nestingDoApplyAsShort(boolean a1) {
		try {
	...
	default short shovingDoApplyAsShort(boolean a1) {
		return ((LBoolToShortFunctionX<RuntimeException>) this).doApplyAsShort(a1);
	}

	/** Function call that handles exceptions according to the instructions. */
	default <Y extends Throwable> short handlingDoApplyAsShort(boolean a1, HandlingInstructions<Throwable, Y> handling) throws Y {
	...
	default short nonNullDoApplyAsShort(boolean a1) throws X {
	...
	default LShortSupplierX<X> captureBoolToShortFunc(boolean a1) {
		return () -> this.doApplyAsShort(a1);
	}
	...
	static <X extends Throwable> short call(boolean a1, final @Nonnull LBoolToShortFunctionX<X> lambda) throws X {
		Null.nonNullArg(lambda, "lambda");
		return lambda.doApplyAsShort(a1);
	}

	static <X extends Throwable> short shoving(boolean a1, final @Nonnull LBoolToShortFunctionX<X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.shovingDoApplyAsShort(a1);
	}

	static <X extends Throwable> short nesting(boolean a1, final @Nonnull LBoolToShortFunctionX<X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.nestingDoApplyAsShort(a1);
	}

	static <X extends Throwable, Y extends Throwable> short handling(boolean a1, final HandlingInstructions<Throwable, Y> handling, final @Nonnull LBoolToShortFunctionX<X> lambda) throws Y {
		Null.nonNullArg(lambda, "lambda");
	...
	@Nonnull
	default LBoolToShortFunctionX<X> boolToShortFuncComposeBoolean(@Nonnull final LLogicalOperatorX<X> before1) {
	...
	/** Allows to manipulate the domain of the function. */
	@Nonnull
	default <V1> LToShortFunctionX<V1, X> boolToShortFuncCompose(@Nonnull final LPredicateX<? super V1, X> before1) {
		Null.nonNullArg(before1, "before1");
