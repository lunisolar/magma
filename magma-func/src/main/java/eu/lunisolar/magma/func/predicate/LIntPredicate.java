...
public interface LIntPredicate extends IntPredicate, MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain1<aInt> { // NOSONAR
	...
	public static <X extends Throwable> int throwIf(int a, @Nonnull LIntPredicate pred, @Nonnull ExMF<X> factory, LIntFunction<? extends String> msgFunc) throws X {
		if (pred.test(a)) {
	...
	/** Throws new exception if condition is met. */
	public static <X extends Throwable> int throwIfNot(int a, @Nonnull LIntPredicate pred, @Nonnull ExMF<X> factory, LIntFunction<? extends String> msgFunc) throws X {
		if (!pred.test(a)) {
			throw Handling.create(factory, msgFunc.apply(a), a);
		}
		return a;
	...
	public static <X extends Throwable> int throwIfNot$(int a, LIntFunction<? extends String> specialPredicate, @Nonnull ExMF<X> factory) throws X {
