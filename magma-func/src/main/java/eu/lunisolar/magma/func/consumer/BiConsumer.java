...
/**
 * A consumer.
 * @see {@link eu.lunisolar.magma.func.consumer.BiConsumerX}
 */
@FunctionalInterface
...
public interface BiConsumer<T1, T2> extends java.util.function.BiConsumer<T1, T2>, MetaConsumer {
	...
	/** Wraps JRE instance. */
	@Nonnull
	public static <T1, T2> BiConsumer<T1, T2> std(final java.util.function.BiConsumer<T1, T2> other) {
		return other::accept;
	}
	...
	@Nonnull
	public static <T1, T2, X extends Exception, Y extends RuntimeException> BiConsumer<T1, T2> wrapException(@Nonnull final BiConsumer<T1, T2> other, Class<? extends Exception> exception, ExceptionHandler<Exception, Y> rethrower) {
		return (T1 t1, T2 t2) -> {
			try {
				other.accept(t1, t2);
			} catch (Exception e) {
	...
	@Nonnull
	default <Y extends RuntimeException> BiConsumer<T1, T2> handle(Class<? extends Exception> exception, ExceptionHandler<? super RuntimeException, Y> handler) {
	...
	/** Wraps with exception handling that for argument exception class will call function to determine the final exception. */
	@Nonnull
	default <Y extends RuntimeException> BiConsumer<T1, T2> handle(ExceptionHandler<? super RuntimeException, Y> handler) {
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);
