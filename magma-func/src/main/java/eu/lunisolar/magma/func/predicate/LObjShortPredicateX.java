...
public interface LObjShortPredicateX<T, X extends Throwable> extends MetaPredicate, MetaInterface.Throwing<X> { // NOSONAR

	String DESCRIPTION = "LObjShortPredicateX: boolean doTest(T a1,short a2) throws X";

	boolean doTest(T a1, short a2) throws X;

	default boolean tupleTest(LObjShortPair<T> args) throws X {
	...
	default boolean shovingDoTest(T a1, short a2) {
		return ((LObjShortPredicateX<T, RuntimeException>) this).doTest(a1, a2);
	}

	/** Function call that handles exceptions according to the instructions. */
	default <Y extends Throwable> boolean handlingDoTest(T a1, short a2, HandlingInstructions<Throwable, Y> handling) throws Y {
	...
	default boolean nonNullDoTest(T a1, short a2) throws X {
		return doTest(a1, a2);
	}

	/** For convenience, where "test()" makes things more confusing than "applyAsBoolean()". */

	default boolean doApplyAsBoolean(T a1, short a2) throws X {
		return doTest(a1, a2);
	}
	...
	default LBoolSupplierX<X> captureObjShortPred(T a1, short a2) {
		return () -> this.doTest(a1, a2);
	}
	...
	@Nonnull
	static <T, X extends Throwable> LObjShortPredicateX<T, X> test1st(@Nonnull LPredicateX<T, X> func) {
		return (a1, a2) -> func.doTest(a1);
	}

	/** Captures single parameter function into this interface where only 2nd parameter will be used. */
	@Nonnull
	static <T, X extends Throwable> LObjShortPredicateX<T, X> test2nd(@Nonnull LShortPredicateX<X> func) {
	...
	static <T, X extends Throwable> boolean shoving(T a1, short a2, final @Nonnull LObjShortPredicateX<T, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.shovingDoTest(a1, a2);
	}

	static <T, X extends Throwable> boolean nesting(T a1, short a2, final @Nonnull LObjShortPredicateX<T, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.nestingDoTest(a1, a2);
	}

	static <T, X extends Throwable, Y extends Throwable> boolean handling(T a1, short a2, final HandlingInstructions<Throwable, Y> handling, final @Nonnull LObjShortPredicateX<T, X> lambda) throws Y {
		Null.nonNullArg(lambda, "lambda");
	 ...
	 */
	@Nonnull
	static <T, X extends Throwable> LObjShortPredicateX<T, X> isEqual(T v1, short v2) {
	...
	interface V1<T, X extends Throwable> extends LObjShortPredicateX<T, X> {
		...
		boolean doTestV1(short a2, T a1) throws X;
