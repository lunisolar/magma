...
public interface LBoolTriple extends LTuple<Boolean>, Comparable<LBoolTriple> {
	...
	public static Iterator<LBoolTriple.MutBoolTriple> mutIterator(PrimitiveIterator.OfInt items) {
		return iterator(items, LBoolTriple::of);
	}

	public static Iterator<LBoolTriple> immIterator(PrimitiveIterator.OfInt items) {
		return iterator(items, LBoolTriple::immutableOf);
	}
	...
	public static Stream<LBoolTriple.MutBoolTriple> mutStream(IntStream items) {
		return stream(items, LBoolTriple::of);
	}

	public static Stream<LBoolTriple> immStream(IntStream items) {
		return stream(items, LBoolTriple::immutableOf);
	}
