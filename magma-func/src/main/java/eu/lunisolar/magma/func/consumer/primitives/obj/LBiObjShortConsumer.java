...
public interface LBiObjShortConsumer<T1, T2> extends LBiObjShortConsumerX<T1, T2, RuntimeException>, MetaConsumer, MetaInterface.NonThrowing {
	...
	String DESCRIPTION = "LBiObjShortConsumer: void doAccept(T1 a1,T2 a2,short a3)";

	void doAccept(T1 a1, T2 a2, short a3);

	default LTuple.Void tupleAccept(LBiObjShortTriple<T1, T2> args) {
	...
	default LAction captureBiObjShortCons(T1 a1, T2 a2, short a3) {
	...
	static <T1, T2> void call(T1 a1, T2 a2, short a3, final @Nonnull LBiObjShortConsumer<T1, T2> lambda) {
		Null.nonNullArg(lambda, "lambda");
	...
	/** Safe instance. */
	@Nonnull
	static <T1, T2> LBiObjShortConsumer<T1, T2> safe() {
		return Function4U::doNothing;
	}

	/** Safe instance supplier. Returns supplier of safe() instance. */
	@Nonnull
	static <T1, T2> LSupplier<LBiObjShortConsumer<T1, T2>> safeSupplier() {
		return () -> safe();
	}

	/** Safe wrapping. Either argument function is returned (if it is not null) or safe() instance. */
	@Nonnull
	static <T1, T2> LBiObjShortConsumer<T1, T2> safe(final @Nullable LBiObjShortConsumer<T1, T2> other) {
		if (other == null) {
			return safe();
		} else {
			return other;
	...
	@Nonnull
	static <T1, T2> LSupplier<LBiObjShortConsumer<T1, T2>> safeSupplier(final @Nullable LSupplier<LBiObjShortConsumer<T1, T2>> supplier) {
		if (supplier == null) {
			return safeSupplier();
		} else {
			return supplier;
	...
	/** Combines two LBiObjShortConsumer<T1,T2> together in a order. */
	@Nonnull
	...
	/** Permutation of LBiObjShortConsumer for method references. */
	@FunctionalInterface
	interface V1<T1, T2> extends LBiObjShortConsumer<T1, T2> {

		void doAcceptV1(T1 a1, short a3, T2 a2);
	...
	/** Permutation of LBiObjShortConsumer for method references. */
	@FunctionalInterface
	interface V2<T2, T1> extends LBiObjShortConsumer<T1, T2> {

		void doAcceptV2(T2 a2, T1 a1, short a3);
	...
	/** Permutation of LBiObjShortConsumer for method references. */
	@FunctionalInterface
	interface V3<T2, T1> extends LBiObjShortConsumer<T1, T2> {

		void doAcceptV3(T2 a2, short a3, T1 a1);
	...
	/** Permutation of LBiObjShortConsumer for method references. */
	@FunctionalInterface
	interface V4<T1, T2> extends LBiObjShortConsumer<T1, T2> {

		void doAcceptV4(short a3, T1 a1, T2 a2);
	...
	/** Permutation of LBiObjShortConsumer for method references. */
	@FunctionalInterface
	interface V5<T2, T1> extends LBiObjShortConsumer<T1, T2> {

		void doAcceptV5(short a3, T2 a2, T1 a1);
