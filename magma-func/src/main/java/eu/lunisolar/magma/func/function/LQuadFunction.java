...
public interface LQuadFunction<T1, T2, T3, T4, R> extends MetaFunction, MetaInterface.NonThrowing, Codomain<a<R>>, Domain4<a<T1>, a<T2>, a<T3>, a<T4>> { // NOSONAR
	...
	default LQuadFunction<T1, T2, T3, T4, R> trying(@Nonnull ExWF<RuntimeException> exF) {
		return (a1, a2, a3, a4) -> apply(a1, a2, a3, a4, exF);
	}
	...
	static <T1, T2, T3, T4, R> R tryApply(T1 a1, T2 a2, T3 a3, T4 a4, LQuadFunction<T1, T2, T3, T4, R> func, @Nonnull ExWF<RuntimeException> exF) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, a3, a4, exF);
	}
	...
	static <T1, T2, T3, T4, R> LQuadFunction<T1, T2, T3, T4, R> recursive(final @Nonnull LFunction<LQuadFunction<T1, T2, T3, T4, R>, LQuadFunction<T1, T2, T3, T4, R>> selfLambda) {
		final LQuadFunctionSingle<T1, T2, T3, T4, R> single = new LQuadFunctionSingle();
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2, T4, T3, R> LBiObj1Obj3Obj2Func<T1, T2, T4, T3, R> biObj1Obj3Obj2Func(final @Nonnull LBiObj1Obj3Obj2Func<T1, T2, T4, T3, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T3, T2, T4, R> LObj0Obj2BiObj3Func<T1, T3, T2, T4, R> obj0Obj2BiObj3Func(final @Nonnull LObj0Obj2BiObj3Func<T1, T3, T2, T4, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T3, T4, T2, R> LObj0Obj2Obj3Obj1Func<T1, T3, T4, T2, R> obj0Obj2Obj3Obj1Func(final @Nonnull LObj0Obj2Obj3Obj1Func<T1, T3, T4, T2, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T4, T2, T3, R> LObj0Obj3Obj1Obj2Func<T1, T4, T2, T3, R> obj0Obj3Obj1Obj2Func(final @Nonnull LObj0Obj3Obj1Obj2Func<T1, T4, T2, T3, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T4, T3, T2, R> LObj0BiObj2Obj1Func<T1, T4, T3, T2, R> obj0BiObj2Obj1Func(final @Nonnull LObj0BiObj2Obj1Func<T1, T4, T3, T2, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1, T3, T4, R> LObj1TriObj3Func<T2, T1, T3, T4, R> obj1TriObj3Func(final @Nonnull LObj1TriObj3Func<T2, T1, T3, T4, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1, T4, T3, R> LObj1Obj0Obj3Obj2Func<T2, T1, T4, T3, R> obj1Obj0Obj3Obj2Func(final @Nonnull LObj1Obj0Obj3Obj2Func<T2, T1, T4, T3, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T3, T1, T4, R> LObj1Obj2BiObj3Func<T2, T3, T1, T4, R> obj1Obj2BiObj3Func(final @Nonnull LObj1Obj2BiObj3Func<T2, T3, T1, T4, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T3, T4, T1, R> LObj1Obj2Obj3Obj0Func<T2, T3, T4, T1, R> obj1Obj2Obj3Obj0Func(final @Nonnull LObj1Obj2Obj3Obj0Func<T2, T3, T4, T1, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T4, T1, T3, R> LObj1Obj3Obj0Obj2Func<T2, T4, T1, T3, R> obj1Obj3Obj0Obj2Func(final @Nonnull LObj1Obj3Obj0Obj2Func<T2, T4, T1, T3, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T4, T3, T1, R> LObj1BiObj2Obj0Func<T2, T4, T3, T1, R> obj1BiObj2Obj0Func(final @Nonnull LObj1BiObj2Obj0Func<T2, T4, T3, T1, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T3, T1, T2, T4, R> LObj2Obj0BiObj3Func<T3, T1, T2, T4, R> obj2Obj0BiObj3Func(final @Nonnull LObj2Obj0BiObj3Func<T3, T1, T2, T4, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T3, T1, T4, T2, R> LObj2Obj0Obj3Obj1Func<T3, T1, T4, T2, R> obj2Obj0Obj3Obj1Func(final @Nonnull LObj2Obj0Obj3Obj1Func<T3, T1, T4, T2, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T3, T2, T1, T4, R> LBiObj1BiObj3Func<T3, T2, T1, T4, R> biObj1BiObj3Func(final @Nonnull LBiObj1BiObj3Func<T3, T2, T1, T4, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T3, T2, T4, T1, R> LBiObj1Obj3Obj0Func<T3, T2, T4, T1, R> biObj1Obj3Obj0Func(final @Nonnull LBiObj1Obj3Obj0Func<T3, T2, T4, T1, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T3, T4, T1, T2, R> LObj2Obj3Obj0Obj1Func<T3, T4, T1, T2, R> obj2Obj3Obj0Obj1Func(final @Nonnull LObj2Obj3Obj0Obj1Func<T3, T4, T1, T2, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T3, T4, T2, T1, R> LObj2Obj3Obj1Obj0Func<T3, T4, T2, T1, R> obj2Obj3Obj1Obj0Func(final @Nonnull LObj2Obj3Obj1Obj0Func<T3, T4, T2, T1, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T4, T1, T2, T3, R> LObj3Obj0Obj1Obj2Func<T4, T1, T2, T3, R> obj3Obj0Obj1Obj2Func(final @Nonnull LObj3Obj0Obj1Obj2Func<T4, T1, T2, T3, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T4, T1, T3, T2, R> LObj3BiObj2Obj1Func<T4, T1, T3, T2, R> obj3BiObj2Obj1Func(final @Nonnull LObj3BiObj2Obj1Func<T4, T1, T3, T2, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T4, T2, T1, T3, R> LBiObj1Obj0Obj2Func<T4, T2, T1, T3, R> biObj1Obj0Obj2Func(final @Nonnull LBiObj1Obj0Obj2Func<T4, T2, T1, T3, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T4, T2, T3, T1, R> LTriObj2Obj0Func<T4, T2, T3, T1, R> triObj2Obj0Func(final @Nonnull LTriObj2Obj0Func<T4, T2, T3, T1, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T4, T3, T1, T2, R> LObj3Obj2Obj0Obj1Func<T4, T3, T1, T2, R> obj3Obj2Obj0Obj1Func(final @Nonnull LObj3Obj2Obj0Obj1Func<T4, T3, T1, T2, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T4, T3, T2, T1, R> LObj3Obj2Obj1Obj0Func<T4, T3, T2, T1, R> obj3Obj2Obj1Obj0Func(final @Nonnull LObj3Obj2Obj1Obj0Func<T4, T3, T2, T1, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Permutation of LQuadFunction for method references. */
	@FunctionalInterface
	interface LBiObj1Obj3Obj2Func<T1, T2, T4, T3, R> extends LQuadFunction<T1, T2, T3, T4, R> {
		@Nullable
		R applyBiObj1Obj3Obj2(T1 a1, T2 a2, T4 a4, T3 a3);

		@Override
		default R applyX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.applyBiObj1Obj3Obj2(a1, a2, a4, a3);
		}
	}

	/** Permutation of LQuadFunction for method references. */
	@FunctionalInterface
	interface LObj0Obj2BiObj3Func<T1, T3, T2, T4, R> extends LQuadFunction<T1, T2, T3, T4, R> {
		@Nullable
		R applyObj0Obj2BiObj3(T1 a1, T3 a3, T2 a2, T4 a4);

		@Override
		default R applyX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.applyObj0Obj2BiObj3(a1, a3, a2, a4);
		}
	}

	/** Permutation of LQuadFunction for method references. */
	@FunctionalInterface
	interface LObj0Obj2Obj3Obj1Func<T1, T3, T4, T2, R> extends LQuadFunction<T1, T2, T3, T4, R> {
		@Nullable
		R applyObj0Obj2Obj3Obj1(T1 a1, T3 a3, T4 a4, T2 a2);

		@Override
		default R applyX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.applyObj0Obj2Obj3Obj1(a1, a3, a4, a2);
		}
	}

	/** Permutation of LQuadFunction for method references. */
	@FunctionalInterface
	interface LObj0Obj3Obj1Obj2Func<T1, T4, T2, T3, R> extends LQuadFunction<T1, T2, T3, T4, R> {
		@Nullable
		R applyObj0Obj3Obj1Obj2(T1 a1, T4 a4, T2 a2, T3 a3);

		@Override
		default R applyX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.applyObj0Obj3Obj1Obj2(a1, a4, a2, a3);
		}
	}

	/** Permutation of LQuadFunction for method references. */
	@FunctionalInterface
	interface LObj0BiObj2Obj1Func<T1, T4, T3, T2, R> extends LQuadFunction<T1, T2, T3, T4, R> {
		@Nullable
		R applyObj0BiObj2Obj1(T1 a1, T4 a4, T3 a3, T2 a2);

		@Override
		default R applyX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.applyObj0BiObj2Obj1(a1, a4, a3, a2);
		}
	}

	/** Permutation of LQuadFunction for method references. */
	@FunctionalInterface
	interface LObj1TriObj3Func<T2, T1, T3, T4, R> extends LQuadFunction<T1, T2, T3, T4, R> {
		@Nullable
		R applyObj1TriObj3(T2 a2, T1 a1, T3 a3, T4 a4);

		@Override
		default R applyX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.applyObj1TriObj3(a2, a1, a3, a4);
		}
	}

	/** Permutation of LQuadFunction for method references. */
	@FunctionalInterface
	interface LObj1Obj0Obj3Obj2Func<T2, T1, T4, T3, R> extends LQuadFunction<T1, T2, T3, T4, R> {
		@Nullable
		R applyObj1Obj0Obj3Obj2(T2 a2, T1 a1, T4 a4, T3 a3);

		@Override
		default R applyX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.applyObj1Obj0Obj3Obj2(a2, a1, a4, a3);
		}
	}

	/** Permutation of LQuadFunction for method references. */
	@FunctionalInterface
	interface LObj1Obj2BiObj3Func<T2, T3, T1, T4, R> extends LQuadFunction<T1, T2, T3, T4, R> {
		@Nullable
		R applyObj1Obj2BiObj3(T2 a2, T3 a3, T1 a1, T4 a4);

		@Override
		default R applyX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.applyObj1Obj2BiObj3(a2, a3, a1, a4);
		}
	}

	/** Permutation of LQuadFunction for method references. */
	@FunctionalInterface
	interface LObj1Obj2Obj3Obj0Func<T2, T3, T4, T1, R> extends LQuadFunction<T1, T2, T3, T4, R> {
		@Nullable
		R applyObj1Obj2Obj3Obj0(T2 a2, T3 a3, T4 a4, T1 a1);

		@Override
		default R applyX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.applyObj1Obj2Obj3Obj0(a2, a3, a4, a1);
		}
	}

	/** Permutation of LQuadFunction for method references. */
	@FunctionalInterface
	interface LObj1Obj3Obj0Obj2Func<T2, T4, T1, T3, R> extends LQuadFunction<T1, T2, T3, T4, R> {
		@Nullable
		R applyObj1Obj3Obj0Obj2(T2 a2, T4 a4, T1 a1, T3 a3);

		@Override
		default R applyX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.applyObj1Obj3Obj0Obj2(a2, a4, a1, a3);
		}
	}

	/** Permutation of LQuadFunction for method references. */
	@FunctionalInterface
	interface LObj1BiObj2Obj0Func<T2, T4, T3, T1, R> extends LQuadFunction<T1, T2, T3, T4, R> {
		@Nullable
		R applyObj1BiObj2Obj0(T2 a2, T4 a4, T3 a3, T1 a1);

		@Override
		default R applyX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.applyObj1BiObj2Obj0(a2, a4, a3, a1);
		}
	}

	/** Permutation of LQuadFunction for method references. */
	@FunctionalInterface
	interface LObj2Obj0BiObj3Func<T3, T1, T2, T4, R> extends LQuadFunction<T1, T2, T3, T4, R> {
		@Nullable
		R applyObj2Obj0BiObj3(T3 a3, T1 a1, T2 a2, T4 a4);

		@Override
		default R applyX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.applyObj2Obj0BiObj3(a3, a1, a2, a4);
		}
	}

	/** Permutation of LQuadFunction for method references. */
	@FunctionalInterface
	interface LObj2Obj0Obj3Obj1Func<T3, T1, T4, T2, R> extends LQuadFunction<T1, T2, T3, T4, R> {
		@Nullable
		R applyObj2Obj0Obj3Obj1(T3 a3, T1 a1, T4 a4, T2 a2);

		@Override
		default R applyX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.applyObj2Obj0Obj3Obj1(a3, a1, a4, a2);
		}
	}

	/** Permutation of LQuadFunction for method references. */
	@FunctionalInterface
	interface LBiObj1BiObj3Func<T3, T2, T1, T4, R> extends LQuadFunction<T1, T2, T3, T4, R> {
		@Nullable
		R applyBiObj1BiObj3(T3 a3, T2 a2, T1 a1, T4 a4);

		@Override
		default R applyX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.applyBiObj1BiObj3(a3, a2, a1, a4);
		}
	}

	/** Permutation of LQuadFunction for method references. */
	@FunctionalInterface
	interface LBiObj1Obj3Obj0Func<T3, T2, T4, T1, R> extends LQuadFunction<T1, T2, T3, T4, R> {
		@Nullable
		R applyBiObj1Obj3Obj0(T3 a3, T2 a2, T4 a4, T1 a1);

		@Override
		default R applyX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.applyBiObj1Obj3Obj0(a3, a2, a4, a1);
		}
	}

	/** Permutation of LQuadFunction for method references. */
	@FunctionalInterface
	interface LObj2Obj3Obj0Obj1Func<T3, T4, T1, T2, R> extends LQuadFunction<T1, T2, T3, T4, R> {
		@Nullable
		R applyObj2Obj3Obj0Obj1(T3 a3, T4 a4, T1 a1, T2 a2);

		@Override
		default R applyX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.applyObj2Obj3Obj0Obj1(a3, a4, a1, a2);
		}
	}

	/** Permutation of LQuadFunction for method references. */
	@FunctionalInterface
	interface LObj2Obj3Obj1Obj0Func<T3, T4, T2, T1, R> extends LQuadFunction<T1, T2, T3, T4, R> {
		@Nullable
		R applyObj2Obj3Obj1Obj0(T3 a3, T4 a4, T2 a2, T1 a1);

		@Override
		default R applyX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.applyObj2Obj3Obj1Obj0(a3, a4, a2, a1);
		}
	}

	/** Permutation of LQuadFunction for method references. */
	@FunctionalInterface
	interface LObj3Obj0Obj1Obj2Func<T4, T1, T2, T3, R> extends LQuadFunction<T1, T2, T3, T4, R> {
		@Nullable
		R applyObj3Obj0Obj1Obj2(T4 a4, T1 a1, T2 a2, T3 a3);

		@Override
		default R applyX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.applyObj3Obj0Obj1Obj2(a4, a1, a2, a3);
		}
	}

	/** Permutation of LQuadFunction for method references. */
	@FunctionalInterface
	interface LObj3BiObj2Obj1Func<T4, T1, T3, T2, R> extends LQuadFunction<T1, T2, T3, T4, R> {
		@Nullable
		R applyObj3BiObj2Obj1(T4 a4, T1 a1, T3 a3, T2 a2);

		@Override
		default R applyX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.applyObj3BiObj2Obj1(a4, a1, a3, a2);
		}
	}

	/** Permutation of LQuadFunction for method references. */
	@FunctionalInterface
	interface LBiObj1Obj0Obj2Func<T4, T2, T1, T3, R> extends LQuadFunction<T1, T2, T3, T4, R> {
		@Nullable
		R applyBiObj1Obj0Obj2(T4 a4, T2 a2, T1 a1, T3 a3);

		@Override
		default R applyX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.applyBiObj1Obj0Obj2(a4, a2, a1, a3);
		}
	}

	/** Permutation of LQuadFunction for method references. */
	@FunctionalInterface
	interface LTriObj2Obj0Func<T4, T2, T3, T1, R> extends LQuadFunction<T1, T2, T3, T4, R> {
		@Nullable
		R applyTriObj2Obj0(T4 a4, T2 a2, T3 a3, T1 a1);

		@Override
		default R applyX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.applyTriObj2Obj0(a4, a2, a3, a1);
		}
	}

	/** Permutation of LQuadFunction for method references. */
	@FunctionalInterface
	interface LObj3Obj2Obj0Obj1Func<T4, T3, T1, T2, R> extends LQuadFunction<T1, T2, T3, T4, R> {
		@Nullable
		R applyObj3Obj2Obj0Obj1(T4 a4, T3 a3, T1 a1, T2 a2);

		@Override
		default R applyX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.applyObj3Obj2Obj0Obj1(a4, a3, a1, a2);
		}
	}

	/** Permutation of LQuadFunction for method references. */
	@FunctionalInterface
	interface LObj3Obj2Obj1Obj0Func<T4, T3, T2, T1, R> extends LQuadFunction<T1, T2, T3, T4, R> {
		@Nullable
		R applyObj3Obj2Obj1Obj0(T4 a4, T3 a3, T2 a2, T1 a1);

		@Override
		default R applyX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.applyObj3Obj2Obj1Obj0(a4, a3, a2, a1);
		}
	}
