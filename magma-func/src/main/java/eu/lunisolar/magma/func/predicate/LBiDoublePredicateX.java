...
public interface LBiDoublePredicateX<X extends Throwable> extends MetaPredicate, MetaInterface.Throwing<X> { // NOSONAR

	String DESCRIPTION = "LBiDoublePredicateX: boolean doTest(double a1,double a2) throws X";

	boolean doTest(double a1, double a2) throws X;

	default boolean tupleTest(LDoublePair args) throws X {
	...
	default boolean shovingDoTest(double a1, double a2) {
		return ((LBiDoublePredicateX<RuntimeException>) this).doTest(a1, a2);
	}

	/** Function call that handles exceptions according to the instructions. */
	default <Y extends Throwable> boolean handlingDoTest(double a1, double a2, HandlingInstructions<Throwable, Y> handling) throws Y {
	...
	default boolean nonNullDoTest(double a1, double a2) throws X {
		return doTest(a1, a2);
	}

	/** For convenience, where "test()" makes things more confusing than "applyAsBoolean()". */

	default boolean doApplyAsBoolean(double a1, double a2) throws X {
		return doTest(a1, a2);
	}
	...
	default LBoolSupplierX<X> captureBiDoublePred(double a1, double a2) {
		return () -> this.doTest(a1, a2);
	}
	...
	@Nonnull
	static <X extends Throwable> LBiDoublePredicateX<X> test1st(@Nonnull LDoublePredicateX<X> func) {
		return (a1, a2) -> func.doTest(a1);
	}

	/** Captures single parameter function into this interface where only 2nd parameter will be used. */
	@Nonnull
	static <X extends Throwable> LBiDoublePredicateX<X> test2nd(@Nonnull LDoublePredicateX<X> func) {
	...
	@Nonnull
	static <X extends Throwable> LBiDoublePredicateX<X> safe() {
		return Function4U::alwaysFalse;
	}

	/** Safe instance supplier. Returns supplier of safe() instance. */
	@Nonnull
	static <X extends Throwable, Y extends Throwable> LSupplierX<LBiDoublePredicateX<X>, Y> safeSupplier() {
		return () -> safe();
	}

	/** Safe wrapping. Either argument function is returned (if it is not null) or safe() instance. */
	@Nonnull
	static <X extends Throwable> LBiDoublePredicateX<X> safe(final @Nullable LBiDoublePredicateX<X> other) {
		if (other == null) {
			return safe();
		} else {
			return other;
	...
	@Nonnull
	static <X extends Throwable, Y extends Throwable> LSupplierX<LBiDoublePredicateX<X>, Y> safeSupplier(final @Nullable LSupplierX<LBiDoublePredicateX<X>, Y> supplier) {
		if (supplier == null) {
			return safeSupplier();
		} else {
			return supplier;
	 ...
	 */
	@Nonnull
	static <X extends Throwable> LBiDoublePredicateX<X> isEqual(double v1, double v2) {
	...
	@Nonnull
	default <V> LBiDoubleFunctionX<V, X> boolToBiDoubleFunc(@Nonnull LBoolFunctionX<? extends V, X> after) {
	...
	/** Permutation of LBiDoublePredicateX for method references. */
	@FunctionalInterface
	interface V1<X extends Throwable> extends LBiDoublePredicateX<X> {

		boolean doTestV1(double a2, double a1) throws X;

		@Override
		default boolean doTest(double a1, double a2) throws X {
