...
public interface LSrtPair extends LTuple<Short>, Comparable<LSrtPair> {
	...
	interface Mut<SELF extends Mut<SELF>> extends LSrtPair {
		...
		default LSrtPair value(short value) {
			second(value);
			return this;
		}
	...
	public static Iterator<LSrtPair.MutSrtPair> mutIterator(PrimitiveIterator.OfInt items) {
		return iterator(items, LSrtPair::of);
	}

	public static Iterator<LSrtPair> immIterator(PrimitiveIterator.OfInt items) {
		return iterator(items, LSrtPair::immutableOf);
	}
	...
	public static Stream<LSrtPair.MutSrtPair> mutStream(IntStream items) {
		return stream(items, LSrtPair::of);
	}

	public static Stream<LSrtPair> immStream(IntStream items) {
		return stream(items, LSrtPair::immutableOf);
	}
	...
	public static <C, R> Iterator<R> iterator(SequentialRead<C, ?, aShort> sa_, C source, LBiSrtFunction<R> factory) {
