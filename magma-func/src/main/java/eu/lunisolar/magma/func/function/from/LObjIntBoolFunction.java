...
public interface LObjIntBoolFunction<T, R> extends MetaFunction, MetaInterface.NonThrowing, Codomain<a<R>>, Domain3<a<T>, aInt, aBool> { // NOSONAR

	String DESCRIPTION = "LObjIntBoolFunction: R apply(T a1,int a2,boolean a3)";

	@Nullable
	// R apply(T a1,int a2,boolean a3) ;
	default R apply(T a1, int a2, boolean a3) {
	 ...
	 */
	R applyX(T a1, int a2, boolean a3) throws Throwable;
	...
	default R handlingApply(T a1, int a2, boolean a3, HandlingInstructions<Throwable, RuntimeException> handling) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LObjIntBoolFunction<T, R> handling(HandlingInstructions<Throwable, RuntimeException> handling) {
		return (a1, a2, a3) -> handlingApply(a1, a2, a3, handling);
	}

	default R apply(T a1, int a2, boolean a3, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default R apply(T a1, int a2, boolean a3, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default R apply(T a1, int a2, boolean a3, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default R apply(T a1, int a2, boolean a3, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LObjIntBoolFunction<T, R> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage) {
		return (a1, a2, a3) -> apply(a1, a2, a3, factory, newMessage);
	}

	default LObjIntBoolFunction<T, R> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1) {
		return (a1, a2, a3) -> apply(a1, a2, a3, factory, newMessage, param1);
	}

	default LObjIntBoolFunction<T, R> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		return (a1, a2, a3) -> apply(a1, a2, a3, factory, newMessage, param1, param1);
	}

	default LObjIntBoolFunction<T, R> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		return (a1, a2, a3) -> apply(a1, a2, a3, factory, newMessage, param1, param2, param3);
	}

	default R apply(T a1, int a2, boolean a3, @Nonnull ExWF<RuntimeException> factory) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LObjIntBoolFunction<T, R> trying(@Nonnull ExWF<RuntimeException> factory) {
		return (a1, a2, a3) -> apply(a1, a2, a3, factory);
	}

	default R applyThen(T a1, int a2, boolean a3, @Nonnull LFunction<Throwable, R> handler) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LObjIntBoolFunction<T, R> tryingThen(@Nonnull LFunction<Throwable, R> handler) {
		return (a1, a2, a3) -> applyThen(a1, a2, a3, handler);
	}

	/** Function call that handles exceptions by always nesting checked exceptions and propagating the others as is. */
	default R nestingApply(T a1, int a2, boolean a3) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
			throw Handling.nestCheckedAndThrow(e);
	...
	default R shovingApply(T a1, int a2, boolean a3) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	static <T, R> R shovingApply(T a1, int a2, boolean a3, LObjIntBoolFunction<T, R> func) {
		Null.nonNullArg(func, "func");
		return func.shovingApply(a1, a2, a3);
	}

	static <T, R> R handlingApply(T a1, int a2, boolean a3, LObjIntBoolFunction<T, R> func, HandlingInstructions<Throwable, RuntimeException> handling) { // <-
		Null.nonNullArg(func, "func");
		return func.handlingApply(a1, a2, a3, handling);
	}

	static <T, R> R tryApply(T a1, int a2, boolean a3, LObjIntBoolFunction<T, R> func) {
		Null.nonNullArg(func, "func");
		return func.nestingApply(a1, a2, a3);
	}

	static <T, R> R tryApply(T a1, int a2, boolean a3, LObjIntBoolFunction<T, R> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, a3, factory, newMessage);
	}

	static <T, R> R tryApply(T a1, int a2, boolean a3, LObjIntBoolFunction<T, R> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, a3, factory, newMessage, param1);
	}

	static <T, R> R tryApply(T a1, int a2, boolean a3, LObjIntBoolFunction<T, R> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, a3, factory, newMessage, param1, param2);
	}

	static <T, R> R tryApply(T a1, int a2, boolean a3, LObjIntBoolFunction<T, R> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, a3, factory, newMessage, param1, param2, param3);
	}

	static <T, R> R tryApply(T a1, int a2, boolean a3, LObjIntBoolFunction<T, R> func, @Nonnull ExWF<RuntimeException> factory) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, a3, factory);
	}

	static <T, R> R tryApplyThen(T a1, int a2, boolean a3, LObjIntBoolFunction<T, R> func, @Nonnull LFunction<Throwable, R> handler) {
		Null.nonNullArg(func, "func");
		return func.applyThen(a1, a2, a3, handler);
	}

	default R failSafeApply(T a1, int a2, boolean a3, @Nonnull LObjIntBoolFunction<T, R> failSafe) {
		try {
	...
	static <T, R> R failSafeApply(T a1, int a2, boolean a3, LObjIntBoolFunction<T, R> func, @Nonnull LObjIntBoolFunction<T, R> failSafe) {
	...
	static <T, R> LObjIntBoolFunction<T, R> failSafe(LObjIntBoolFunction<T, R> func, @Nonnull LObjIntBoolFunction<T, R> failSafe) {
		Null.nonNullArg(failSafe, "failSafe");
	...
	public static <T, R> void fromTo(int min_a2, int max_a2, T a1, boolean a3, @Nonnull LObjIntBoolFunction<T, R> func) {
		Null.nonNullArg(func, "func");
		if (min_a2 <= max_a2) {
	...
	/** From-To. Intended to be used with non-capturing lambda. */
	public static <T, R> void fromTill(int min_a2, int max_a2, T a1, boolean a3, @Nonnull LObjIntBoolFunction<T, R> func) {
		Null.nonNullArg(func, "func");
		if (min_a2 <= max_a2) {
			for (int a2 = min_a2; a2 < max_a2; a2++) {
				func.apply(a1, a2, a3);
	...
	/** From-To. Intended to be used with non-capturing lambda. */
	public static <T, R> void times(int max_a2, T a1, boolean a3, @Nonnull LObjIntBoolFunction<T, R> func) {
		if (max_a2 < 0)
			return;
	...
	default LOiFunction<T, R> rShrink(@Nonnull LObjIntPredicate<T> right) {
		Null.nonNullArg(right, "right");
		return (a1, a2) -> apply(a1, a2, right.test(a1, a2));
	}

	default LOiFunction<T, R> rShrink_(boolean a3) {
	...
	default LObjIntBoolFunction untyped() {
		return this;
	}

	/** Cast that replace generics. */
	default <V2, V3> LObjIntBoolFunction<V2, V3> cast() {
		return untyped();
	}
	...
	default LObjIntBoolFunction<T, R> beforeDo(@Nonnull LTieBoolConsumer<T> before) {
	...
	default LObjIntBoolFunction<T, R> afterDo(@Nonnull LConsumer<R> after) {
	...
	@Nonnull
	static <T, R> LObjIntBoolFunction<T, R> objIntBoolFunc(@Nullable Class<T> c1, @Nullable Class<R> c2, final @Nonnull LObjIntBoolFunction<T, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	final class S<T, R> implements LObjIntBoolFunction<T, R> {
		...
		@Override
		public R applyX(T a1, int a2, boolean a3) throws Throwable {
	...
	static <T, R> LObjIntBoolFunction<T, R> recursive(final @Nonnull LFunction<LObjIntBoolFunction<T, R>, LObjIntBoolFunction<T, R>> selfLambda) {
		...
		LObjIntBoolFunction<T, R> func = selfLambda.apply(single);
		single.target = func;
		return func;
	}
	...
	public static <T, R> M<T, R> initializedMementoOf(R initialValue, LObjIntBoolFunction<T, R> function) {
		return memento(initialValue, initialValue, function, (m, x1, x2) -> x2);
	}

	public static <T, R> M<T, R> deltaOf(T a1, int a2, boolean a3, LObjIntBoolFunction<T, R> function, LBinaryOperator<R> deltaFunction) {
		var initialValue = function.apply(a1, a2, a3);
		return initializedDeltaOf(initialValue, function, deltaFunction);
	}

	public static <T, R> M<T, R> initializedDeltaOf(R initialValue, LObjIntBoolFunction<T, R> function, LBinaryOperator<R> deltaFunction) {
		return memento(initialValue, deltaFunction.apply(initialValue, initialValue), function, (m, x1, x2) -> deltaFunction.apply(x1, x2));
	}

	public static <T, R> M<T, R> memento(R initialBaseValue, R initialValue, LObjIntBoolFunction<T, R> baseFunction, LTernaryOperator<R> mementoFunction) {
		return new M(initialBaseValue, initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not confuse it with math concepts). Very short name is intended to be used with parent (LObjIntBoolFunction.M)
	 */
	@NotThreadSafe
	final class M<T, R> implements LObjIntBoolFunction<T, R> {

		private final LObjIntBoolFunction<T, R> baseFunction;
		private R lastBaseValue;
		private R lastValue;
		private final LTernaryOperator<R> mementoFunction;

		private M(R lastBaseValue, R lastValue, LObjIntBoolFunction<T, R> baseFunction, LTernaryOperator<R> mementoFunction) {
	...
	@Nonnull
	static <T, R> LObjIntBoolFunction<T, R> objIntBoolFuncThrowing(final String message, final @Nonnull ExMF<Throwable> exF) {
		Null.nonNullArg(exF, "exF");
		return (a1, a2, a3) -> {
	...
	@Nonnull
	default <V1> LObjIntBoolFunction<V1, R> compose(@Nonnull final LFunction<? super V1, ? extends T> before1, @Nonnull final LIntUnaryOperator before2, @Nonnull final LLogicalOperator before3) {
	...
	public static <V1, T, R> LObjIntBoolFunction<V1, R> composed(@Nonnull final LFunction<? super V1, ? extends T> before1, @Nonnull final LIntUnaryOperator before2, @Nonnull final LLogicalOperator before3, LObjIntBoolFunction<T, R> after) {
	...
	default <V1, V2, V3> LTriFunction<V1, V2, V3, R> objIntBoolFuncCompose(@Nonnull final LFunction<? super V1, ? extends T> before1, @Nonnull final LToIntFunction<? super V2> before2, @Nonnull final LPredicate<? super V3> before3) {
		...
		Null.nonNullArg(before2, "before2");
		Null.nonNullArg(before3, "before3");
		return (v1, v2, v3) -> this.apply(before1.apply(v1), before2.applyAsInt(v2), before3.test(v3));
	}
	...
	@Nonnull
	default LObjIntBoolFunction<T, R> nonNullable() {
