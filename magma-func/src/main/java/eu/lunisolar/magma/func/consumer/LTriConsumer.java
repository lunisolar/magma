...
public interface LTriConsumer<T1, T2, T3> extends LTriConsumerX<T1, T2, T3, RuntimeException>, MetaConsumer, MetaInterface.NonThrowing {
	...
	@FunctionalInterface
	interface V1<T1, T3, T2> extends LTriConsumer<T1, T2, T3> {

		void doAcceptV1(T1 a1, T3 a3, T2 a2);
	...
	/** Permutation of LTriConsumer for method references. */
	@FunctionalInterface
	interface V2<T2, T1, T3> extends LTriConsumer<T1, T2, T3> {

		void doAcceptV2(T2 a2, T1 a1, T3 a3);
	...
	/** Permutation of LTriConsumer for method references. */
	@FunctionalInterface
	interface V3<T2, T3, T1> extends LTriConsumer<T1, T2, T3> {

		void doAcceptV3(T2 a2, T3 a3, T1 a1);
	...
	/** Permutation of LTriConsumer for method references. */
	@FunctionalInterface
	interface V4<T3, T1, T2> extends LTriConsumer<T1, T2, T3> {

		void doAcceptV4(T3 a3, T1 a1, T2 a2);
	...
	/** Permutation of LTriConsumer for method references. */
	@FunctionalInterface
	interface V5<T3, T2, T1> extends LTriConsumer<T1, T2, T3> {

		void doAcceptV5(T3 a3, T2 a2, T1 a1);
