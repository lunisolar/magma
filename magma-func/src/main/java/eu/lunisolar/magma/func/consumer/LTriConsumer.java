...
public interface LTriConsumer<T1, T2, T3> extends MetaConsumer, MetaInterface.NonThrowing, Codomain<aVoid>, Domain3<a<T1>, a<T2>, a<T3>> {
	...
	default @Nonnull LTriConsumer<T1, T2, T3> wrapWith(@Nonnull CallContext ctx) {
		Null.nonNullArg(ctx, "ctx");
		return (a1, a2, a3) -> acceptX(ctx, a1, a2, a3, this);
	}

	static <T1, T2, T3> void acceptX(@Nonnull CallContext ctx, T1 a1, T2 a2, T3 a3, @Nonnull LTriConsumer<T1, T2, T3> function) throws Throwable {
		Null.nonNullArg(ctx, "ctx");
	...
	static <T1, T2, T3> void nestingAccept(@Nonnull CallContext ctx, T1 a1, T2 a2, T3 a3, @Nonnull LTriConsumer<T1, T2, T3> function) {
		Null.nonNullArg(ctx, "ctx");
		Null.nonNullArg(function, "function");
		try {
			acceptX(ctx, a1, a2, a3, function);
		} catch (Throwable e) {
			throw Handling.nestCheckedAndThrow(e);
		}
	}

	static <T1, T2, T3> void shovingAccept(@Nonnull CallContext ctx, T1 a1, T2 a2, T3 a3, @Nonnull LTriConsumer<T1, T2, T3> function) {
		Null.nonNullArg(ctx, "ctx");
		Null.nonNullArg(function, "function");
		try {
			acceptX(ctx, a1, a2, a3, function);
	...
	static <T1, T2, T3> CompletableFuture<Void> asyncAccept(@Nonnull AsyncCallContext async, @Nonnull CallContext ctx, T1 a1, T2 a2, T3 a3, @Nonnull LTriConsumer<T1, T2, T3> function) {
		Null.nonNullArg(async, "async");
		Null.nonNullArg(ctx, "ctx");
		Null.nonNullArg(function, "function");
		CompletableFuture<Void> future = new CompletableFuture<>();
		try {
			async.call(() -> {
				try {
					LTriConsumer.acceptX(ctx, a1, a2, a3, function);
					future.complete(null);
				} catch (Throwable e) {
					Handling.handleErrors(e);
					future.completeExceptionally(e);
