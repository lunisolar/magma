...
public interface LBiObjFloatPredicateX<T1, T2, X extends Throwable> extends MetaPredicate, MetaInterface.Throwing<X> { // NOSONAR
	...
	interface V1<T1, T2, X extends Throwable> extends LBiObjFloatPredicateX<T1, T2, X> {
		...
		boolean doTestV1(T1 a1, float a3, T2 a2) throws X;
	...
	/** Permutation of LBiObjFloatPredicateX for method references. */
	@FunctionalInterface
	interface V2<T2, T1, X extends Throwable> extends LBiObjFloatPredicateX<T1, T2, X> {

		boolean doTestV2(T2 a2, T1 a1, float a3) throws X;
	...
	/** Permutation of LBiObjFloatPredicateX for method references. */
	@FunctionalInterface
	interface V3<T2, T1, X extends Throwable> extends LBiObjFloatPredicateX<T1, T2, X> {

		boolean doTestV3(T2 a2, float a3, T1 a1) throws X;
	...
	interface V4<T1, T2, X extends Throwable> extends LBiObjFloatPredicateX<T1, T2, X> {
		...
		boolean doTestV4(float a3, T1 a1, T2 a2) throws X;
	...
	/** Permutation of LBiObjFloatPredicateX for method references. */
	@FunctionalInterface
	interface V5<T2, T1, X extends Throwable> extends LBiObjFloatPredicateX<T1, T2, X> {

		boolean doTestV5(float a3, T2 a2, T1 a1) throws X;
