...
public interface LTriIntPredicate extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<aInt, aInt, aInt> { // NOSONAR
	...
	public static <X extends Throwable> int throwIf(int a1, int a2, int a3, @Nonnull LTriIntPredicate pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
	...
	/** Throws new exception if condition is met. */
	public static <X extends Throwable> int throwIf(int a1, @Nonnull LTriIntPredicate pred, int a2, int a3, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	public static <X extends Throwable> int throwIfNot(int a1, int a2, int a3, @Nonnull LTriIntPredicate pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <X extends Throwable> int throwIfNot(int a1, @Nonnull LTriIntPredicate pred, int a2, int a3, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	/** Throws new exception if condition is met. */
	public static <X extends Throwable> int throwIf(int a1, int a2, int a3, @Nonnull LTriIntPredicate pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (pred.test(a1, a2, a3)) {
	...
	/** Throws new exception if condition is met. */
	public static <X extends Throwable> int throwIf(int a1, @Nonnull LTriIntPredicate pred, int a2, int a3, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <X extends Throwable> int throwIfNot(int a1, int a2, int a3, @Nonnull LTriIntPredicate pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <X extends Throwable> int throwIfNot(int a1, @Nonnull LTriIntPredicate pred, int a2, int a3, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
