...
/**
 * A consumer.
 * @see {@link eu.lunisolar.magma.func.consumer.primitives.obj.BiObjBooleanConsumerX}
 */
@FunctionalInterface
@SuppressWarnings("UnusedDeclaration")
public interface BiObjBooleanConsumer<T1, T2> extends MetaConsumer {

	public static final String DESCRIPTION = "BiObjBooleanConsumer: void accept(T1 t1,T2 t2, boolean b)";

	public void accept(T1 t1, T2 t2, boolean b);
	...
	@Nonnull
	public static <T1, T2, X extends Exception, Y extends RuntimeException> BiObjBooleanConsumer<T1, T2> wrapException(@Nonnull final BiObjBooleanConsumer<T1, T2> other, Class<? extends Exception> exception, ExceptionHandler<Exception, Y> rethrower) {
		return (T1 t1, T2 t2, boolean b) -> {
			try {
				other.accept(t1, t2, b);
			} catch (Exception e) {
	...
	@Nonnull
	default <Y extends RuntimeException> BiObjBooleanConsumer<T1, T2> handle(Class<? extends Exception> exception, ExceptionHandler<? super RuntimeException, Y> handler) {
	...
	/** Wraps with exception handling that for argument exception class will call function to determine the final exception. */
	@Nonnull
	default <Y extends RuntimeException> BiObjBooleanConsumer<T1, T2> handle(ExceptionHandler<? super RuntimeException, Y> handler) {
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);
