...
public interface LObjIntFltPredicate<T> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<a<T>, aInt, aFloat> { // NOSONAR
	...
	default LObjIntPredicate<T> with(float a3) {
		return (a1, a2) -> test(a1, a2, a3);
	}

	default LFltPredicate _with(T a1, int a2) {
		return a3 -> test(a1, a2, a3);
	}

	default LPredicate<T> with(int a2, float a3) {
	...
	final class M<T> implements LObjIntFltPredicate<T> {
		...
		public boolean currentTest(T a1, int a2, float a3) {
			boolean x1 = lastBaseValue;
		...
		public boolean currentBaseValue(T a1, int a2, float a3) {
	...
	default LObjIntFltPredicate<T> shoving() {

		return new LObjIntFltPredicate<T>() {

			public boolean test(T a1, int a2, float a3) {
				try {
					return this.testX(a1, a2, a3);
				} catch (Throwable e) { // NOSONAR
					Handling.handleErrors(e);
			...
			public boolean testX(T a1, int a2, float a3) throws Throwable {
				return LObjIntFltPredicate.this.testX(a1, a2, a3);
			}
