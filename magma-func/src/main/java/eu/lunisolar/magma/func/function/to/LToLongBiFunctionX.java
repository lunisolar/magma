...
public interface LToLongBiFunctionX<T1, T2, X extends Throwable> extends ToLongBiFunction<T1, T2>, MetaFunction, MetaInterface.Throwing<X> { // NOSONAR
	...
	@Nonnull
	static <T1, T2, X extends Throwable> LToLongBiFunctionX<T1, T2, X> safe() {
		return Function4U::produceLong;
	}

	/** Safe instance supplier. Returns supplier of safe() instance. */
	@Nonnull
	static <T1, T2, X extends Throwable, Y extends Throwable> LSupplierX<LToLongBiFunctionX<T1, T2, X>, Y> safeSupplier() {
		return () -> safe();
	}

	/** Safe wrapping. Either argument function is returned (if it is not null) or safe() instance. */
	@Nonnull
	static <T1, T2, X extends Throwable> LToLongBiFunctionX<T1, T2, X> safe(final @Nullable LToLongBiFunctionX<T1, T2, X> other) {
		if (other == null) {
			return safe();
		} else {
			return other;
	...
	@Nonnull
	static <T1, T2, X extends Throwable, Y extends Throwable> LSupplierX<LToLongBiFunctionX<T1, T2, X>, Y> safeSupplier(final @Nullable LSupplierX<LToLongBiFunctionX<T1, T2, X>, Y> supplier) {
		if (supplier == null) {
			return safeSupplier();
		} else {
			return supplier;
	...
	/** Permutation of LToLongBiFunctionX for method references. */
	@FunctionalInterface
	interface V1<T2, T1, X extends Throwable> extends LToLongBiFunctionX<T1, T2, X> {

		long doApplyAsLongV1(T2 a2, T1 a1) throws X;

		@Override
		default long doApplyAsLong(T1 a1, T2 a2) throws X {
			return this.doApplyAsLongV1(a2, a1);
		}
	}
