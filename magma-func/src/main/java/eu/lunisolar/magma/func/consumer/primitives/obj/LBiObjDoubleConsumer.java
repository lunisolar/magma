...
public interface LBiObjDoubleConsumer<T1, T2> extends LBiObjDoubleConsumerX<T1, T2, RuntimeException>, MetaConsumer, MetaInterface.NonThrowing {
	...
	String DESCRIPTION = "LBiObjDoubleConsumer: void doAccept(T1 a1,T2 a2,double a3)";

	void doAccept(T1 a1, T2 a2, double a3);

	default LTuple.Void tupleAccept(LBiObjDoubleTriple<T1, T2> args) {
	...
	default LAction captureBiObjDoubleCons(T1 a1, T2 a2, double a3) {
		return () -> this.doAccept(a1, a2, a3);
	}

	/** Captures single parameter function into this interface where only 1st parameter will be used. */
	@Nonnull
	static <T1, T2> LBiObjDoubleConsumer<T1, T2> accept1st(@Nonnull LConsumer<T1> func) {
		return (a1, a2, a3) -> func.doAccept(a1);
	}

	/** Captures single parameter function into this interface where only 2nd parameter will be used. */
	@Nonnull
	static <T1, T2> LBiObjDoubleConsumer<T1, T2> accept2nd(@Nonnull LConsumer<T2> func) {
		return (a1, a2, a3) -> func.doAccept(a2);
	}

	/** Captures single parameter function into this interface where only 3rd parameter will be used. */
	@Nonnull
	static <T1, T2> LBiObjDoubleConsumer<T1, T2> accept3rd(@Nonnull LDoubleConsumer func) {
		return (a1, a2, a3) -> func.doAccept(a3);
	}

	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2> LBiObjDoubleConsumer<T1, T2> l(final @Nonnull LBiObjDoubleConsumer<T1, T2> lambda) {
	...
	@Nonnull
	default <V1, V2> LBiObjDoubleConsumer<V1, V2> biObjDoubleConsComposeDouble(@Nonnull final LFunction<? super V1, ? extends T1> before1, @Nonnull final LFunction<? super V2, ? extends T2> before2, @Nonnull final LDoubleUnaryOperator before3) {
	...
	/** Allows to manipulate the domain of the function. */
	@Nonnull
	default <V1, V2, V3> LTriConsumer<V1, V2, V3> biObjDoubleConsCompose(@Nonnull final LFunction<? super V1, ? extends T1> before1, @Nonnull final LFunction<? super V2, ? extends T2> before2, @Nonnull final LToDoubleFunction<? super V3> before3) {
		Null.nonNullArg(before1, "before1");
		Null.nonNullArg(before2, "before2");
		Null.nonNullArg(before3, "before3");
	...
	/** Combines two LBiObjDoubleConsumer<T1,T2> together in a order. */
	@Nonnull
	...
	interface V1<T1, T2> extends LBiObjDoubleConsumer<T1, T2> {
		...
		void doAcceptV1(T1 a1, double a3, T2 a2);
	...
	/** Permutation of LBiObjDoubleConsumer for method references. */
	@FunctionalInterface
	interface V2<T2, T1> extends LBiObjDoubleConsumer<T1, T2> {

		void doAcceptV2(T2 a2, T1 a1, double a3);
	...
	/** Permutation of LBiObjDoubleConsumer for method references. */
	@FunctionalInterface
	interface V3<T2, T1> extends LBiObjDoubleConsumer<T1, T2> {

		void doAcceptV3(T2 a2, double a3, T1 a1);
	...
	interface V4<T1, T2> extends LBiObjDoubleConsumer<T1, T2> {
		...
		void doAcceptV4(double a3, T1 a1, T2 a2);
	...
	/** Permutation of LBiObjDoubleConsumer for method references. */
	@FunctionalInterface
	interface V5<T2, T1> extends LBiObjDoubleConsumer<T1, T2> {

		void doAcceptV5(double a3, T2 a2, T1 a1);
