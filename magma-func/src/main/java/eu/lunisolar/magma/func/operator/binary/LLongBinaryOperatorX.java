...
public interface LLongBinaryOperatorX<X extends Throwable> extends LongBinaryOperator, MetaOperator, MetaInterface.Throwing<X> { // NOSONAR
	...
	@Nonnull
	static <X extends Throwable> LLongBinaryOperatorX<X> safe() {
		return Function4U::produceLong;
	}

	/** Safe instance supplier. Returns supplier of safe() instance. */
	@Nonnull
	static <X extends Throwable, Y extends Throwable> LSupplierX<LLongBinaryOperatorX<X>, Y> safeSupplier() {
		return () -> safe();
	}

	/** Safe wrapping. Either argument function is returned (if it is not null) or safe() instance. */
	@Nonnull
	static <X extends Throwable> LLongBinaryOperatorX<X> safe(final @Nullable LLongBinaryOperatorX<X> other) {
		if (other == null) {
			return safe();
		} else {
			return other;
	...
	@Nonnull
	static <X extends Throwable, Y extends Throwable> LSupplierX<LLongBinaryOperatorX<X>, Y> safeSupplier(final @Nullable LSupplierX<LLongBinaryOperatorX<X>, Y> supplier) {
		if (supplier == null) {
			return safeSupplier();
		} else {
			return supplier;
