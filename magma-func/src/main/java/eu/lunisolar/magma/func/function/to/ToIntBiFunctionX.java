...
/**
 * Throwing functional interface (lambda) ToIntBiFunctionX for Java 8.
 *
 * Type: function
 *
...
public interface ToIntBiFunctionX<T1, T2, X extends Exception> extends MetaFunction, PrimitiveCodomain<Object>, MetaInterface.Throwing<X> { // NOSONAR

	public static final String DESCRIPTION = "ToIntBiFunctionX: int applyAsInt(T1 t1,T2 t2) throws X";
	...
	@Nonnull
	public static <T1, T2, X extends Exception> ToIntBiFunctionX<T1, T2, X> lX(final @Nonnull ToIntBiFunctionX<T1, T2, X> lambda) {
	 ...
	 */
	@Nonnull
	default <V1, V2> ToIntBiFunctionX<V1, V2, X> from(@Nonnull final FunctionX<? super V1, ? extends T1, X> before1, @Nonnull final FunctionX<? super V2, ? extends T2, X> before2) {
	...
	@Nonnull
	default <V> BiFunctionX<T1, T2, V, X> then(@Nonnull IntFunctionX<? extends V, X> after) {
	...
	default java.util.function.ToIntBiFunction<T1, T2> std() {
		return ToIntBiFunction.wrap(this)::applyAsInt;
	}

	/** Converts to non-throwing variant (if required). */
	@Nonnull
	default ToIntBiFunction<T1, T2> nonThrowing() {
		return ToIntBiFunction.wrap(this);
	}
	...
	@Nonnull
	default <E extends Exception, Y extends Exception> ToIntBiFunctionX<T1, T2, Y> handleX(Class<E> exception, ExceptionHandler<E, Y> handler) {
	...
	@Nonnull
	default <Y extends Exception> ToIntBiFunctionX<T1, T2, Y> handleX(ExceptionHandler<Exception, Y> handler) {
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);
	...
	@Nonnull
	default <E extends Exception, Y extends Exception> ToIntBiFunctionX<T1, T2, Y> handleX(Class<E> exception, IntSupplierX<X> supplier) {
		Objects.requireNonNull(exception, Function4U.VALIDATION_MESSAGE_EXCEPTION);
	...
	@Nonnull
	default <Y extends Exception> ToIntBiFunctionX<T1, T2, Y> handleX(IntSupplierX<X> supplier) {
		Objects.requireNonNull(supplier, Function4U.VALIDATION_MESSAGE_HANDLER);
