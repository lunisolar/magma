...
public interface ToIntBiFunctionX<T1, T2, X extends Exception> extends MetaFunction, PrimitiveCodomain<ToIntBiFunctionX<T1, T2, X>>, MetaThrowingInterface<X> { // NOSONAR
