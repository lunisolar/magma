...
public interface LObjFltFunction<T, R> extends MetaFunction, MetaInterface.NonThrowing, Codomain<a<R>>, Domain2<a<T>, aFloat> { // NOSONAR
	...
	default R apply(T a1, float a2, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage) {
		try {
			return this.applyX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default R apply(T a1, float a2, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1) {
		try {
			return this.applyX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default R apply(T a1, float a2, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		try {
			return this.applyX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default R apply(T a1, float a2, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		try {
			return this.applyX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default LObjFltFunction<T, R> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage) {
		return (a1, a2) -> apply(a1, a2, factory, newMessage);
	}

	default LObjFltFunction<T, R> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1) {
		return (a1, a2) -> apply(a1, a2, factory, newMessage, param1);
	}

	default LObjFltFunction<T, R> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		return (a1, a2) -> apply(a1, a2, factory, newMessage, param1, param1);
	}

	default LObjFltFunction<T, R> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		return (a1, a2) -> apply(a1, a2, factory, newMessage, param1, param2, param3);
	}

	default R apply(T a1, float a2, @Nonnull ExWF<RuntimeException> factory) {
		try {
			return this.applyX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default LObjFltFunction<T, R> trying(@Nonnull ExWF<RuntimeException> factory) {
	...
	static <T, R> R shovingApply(T a1, float a2, LObjFltFunction<T, R> func) {
	...
	static <T, R> R tryApply(T a1, float a2, LObjFltFunction<T, R> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, factory, newMessage);
	}

	static <T, R> R tryApply(T a1, float a2, LObjFltFunction<T, R> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, factory, newMessage, param1);
	}

	static <T, R> R tryApply(T a1, float a2, LObjFltFunction<T, R> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, factory, newMessage, param1, param2);
	}

	static <T, R> R tryApply(T a1, float a2, LObjFltFunction<T, R> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, factory, newMessage, param1, param2, param3);
	}

	static <T, R> R tryApply(T a1, float a2, LObjFltFunction<T, R> func, @Nonnull ExWF<RuntimeException> factory) {
		Null.nonNullArg(func, "func");
	...
	public static <T, R> void fromTo(int min_i, int max_i, T a1, float a2, @Nonnull LObjFltFunction<T, R> func) {
		Null.nonNullArg(func, "func");
		if (min_i <= max_i) {
	...
	/** From-To. Intended to be used with non-capturing lambda. */
	public static <T, R> void fromTill(int min_i, int max_i, T a1, float a2, @Nonnull LObjFltFunction<T, R> func) {
		Null.nonNullArg(func, "func");
		if (min_i <= max_i) {
			for (int i = min_i; i < max_i; i++) {
				func.apply(a1, a2);
	...
	/** From-To. Intended to be used with non-capturing lambda. */
	public static <T, R> void times(int max_i, T a1, float a2, @Nonnull LObjFltFunction<T, R> func) {
		if (max_i < 0)
			return;
	...
	public static <R, M, K, V> R from(@Nonnull M container, LBiFunction<M, K, V> extractor, K key, float a2, @Nonnull LObjFltFunction<V, R> function) {
	...
	public static <R, T> LFltFunction<R> lShrunken(@Nonnull LFltFunction<T> left, @Nonnull LObjFltFunction<T, R> func) {
		Null.nonNullArg(left, "left");
		Null.nonNullArg(func, "func");
		return func.lShrink(left);
	}

	public static <R, T> LFltFunction<R> lShrunken_(T a1, @Nonnull LObjFltFunction<T, R> func) {
		Null.nonNullArg(func, "func");
	...
	public static <T, R> LFunction<T, R> rShrunken(@Nonnull LToFltFunction<T> right, @Nonnull LObjFltFunction<T, R> func) {
		Null.nonNullArg(right, "right");
		Null.nonNullArg(func, "func");
		return func.rShrink(right);
	}

	public static <T, R> LFunction<T, R> rShrunken_(float a2, @Nonnull LObjFltFunction<T, R> func) {
		Null.nonNullArg(func, "func");
	...
	/** Cast that replace generics. */
	public static <V2, V3> LObjFltFunction<V2, V3> cast(LObjFltFunction<?, ?> function) {
	...
	@Nonnull
	static <T, R> LObjFltFunction<T, R> objFltFunc(@Nullable Class<T> c1, @Nullable Class<R> c2, final @Nonnull LObjFltFunction<T, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}

	final class S<T, R> implements LObjFltFunction<T, R> {
	...
	public static <T, R> M<T, R> mementoOf(T a1, float a2, LObjFltFunction<T, R> function) {
		var initialValue = function.apply(a1, a2);
		return initializedMementoOf(initialValue, function);
	}

	public static <T, R> M<T, R> initializedMementoOf(R initialValue, LObjFltFunction<T, R> function) {
		return memento(initialValue, initialValue, function, (m, x1, x2) -> x2);
	}

	public static <T, R> M<T, R> deltaOf(T a1, float a2, LObjFltFunction<T, R> function, LBinaryOperator<R> deltaFunction) {
		var initialValue = function.apply(a1, a2);
		return initializedDeltaOf(initialValue, function, deltaFunction);
	}

	public static <T, R> M<T, R> initializedDeltaOf(R initialValue, LObjFltFunction<T, R> function, LBinaryOperator<R> deltaFunction) {
		return memento(initialValue, deltaFunction.apply(initialValue, initialValue), function, (m, x1, x2) -> deltaFunction.apply(x1, x2));
	}

	public static <T, R> M<T, R> memento(R initialBaseValue, R initialValue, LObjFltFunction<T, R> baseFunction, LTernaryOperator<R> mementoFunction) {
		return new M(initialBaseValue, initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not confuse it with math concepts). Very short name is intended to be used with parent (LObjFltFunction.M)
	 */
	@NotThreadSafe
	final class M<T, R> implements LObjFltFunction<T, R> {

		private final LObjFltFunction<T, R> baseFunction;
		private R lastBaseValue;
		private R lastValue;
		private final LTernaryOperator<R> mementoFunction;

		private M(R lastBaseValue, R lastValue, LObjFltFunction<T, R> baseFunction, LTernaryOperator<R> mementoFunction) {
	...
	static <T, R> LObjFltFunction<T, R> safe() {
		return LObjFltFunction::doNothing;
	}
	...
	public static <T, R> R doNothing(T a1, float a2) {
		return (R) Function4U.defaultObject;
	}

	/** Does nothing (LObjFltFunction.LFltObjFunc) Function */
	public static <T, R> R doNothing(float a2, T a1) {
		return (R) Function4U.defaultObject;
	}
