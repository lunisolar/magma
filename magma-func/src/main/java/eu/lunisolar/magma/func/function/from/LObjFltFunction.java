...
public interface LObjFltFunction<T, R> extends MetaFunction, MetaInterface.NonThrowing { // NOSONAR

	String DESCRIPTION = "LObjFltFunction: R doApply(T a1,float a2)";

	@Nullable
	// R doApply(T a1,float a2) ;
	...
	/**
	 * Implement this, but call doApply(T a1,float a2)
	 */
	R doApplyX(T a1, float a2) throws Throwable;
	...
	default R handlingDoApply(T a1, float a2, HandlingInstructions<Throwable, RuntimeException> handling) {
		try {
			return this.doApplyX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default R tryDoApply(T a1, float a2, @Nonnull ExceptionWrapWithMessageFactory<RuntimeException> exceptionFactory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		try {
			return this.doApplyX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default R tryDoApply(T a1, float a2, @Nonnull ExceptionWrapFactory<RuntimeException> exceptionFactory) {
		try {
			return this.doApplyX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default R tryDoApplyThen(T a1, float a2, @Nonnull LFunction<Throwable, R> handler) {
		try {
			return this.doApplyX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default R shovingDoApply(T a1, float a2) {
		try {
			return this.doApplyX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	static <T, R> R handlingDoApply(T a1, float a2, LObjFltFunction<T, R> func, HandlingInstructions<Throwable, RuntimeException> handling) { // <-
		Null.nonNullArg(func, "func");
		return func.handlingDoApply(a1, a2, handling);
	}

	static <T, R> R tryDoApply(T a1, float a2, LObjFltFunction<T, R> func) {
		return tryDoApply(a1, a2, func, null);
	}

	static <T, R> R tryDoApply(T a1, float a2, LObjFltFunction<T, R> func, @Nonnull ExceptionWrapWithMessageFactory<RuntimeException> exceptionFactory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		Null.nonNullArg(func, "func");
		return func.tryDoApply(a1, a2, exceptionFactory, newMessage, messageParams);
	}

	static <T, R> R tryDoApply(T a1, float a2, LObjFltFunction<T, R> func, @Nonnull ExceptionWrapFactory<RuntimeException> exceptionFactory) {
		Null.nonNullArg(func, "func");
		return func.tryDoApply(a1, a2, exceptionFactory);
	}

	static <T, R> R tryDoApplyThen(T a1, float a2, LObjFltFunction<T, R> func, @Nonnull LFunction<Throwable, R> handler) {
		Null.nonNullArg(func, "func");
		return func.tryDoApplyThen(a1, a2, handler);
	}

	default R failSafeDoApply(T a1, float a2, @Nonnull LObjFltFunction<T, R> failSafe) {
		try {
	...
	static <T, R> R failSafeDoApply(T a1, float a2, LObjFltFunction<T, R> func, @Nonnull LObjFltFunction<T, R> failSafe) {
	...
	static <T, R> LObjFltFunction<T, R> failSafeObjFltFunc(LObjFltFunction<T, R> func, @Nonnull LObjFltFunction<T, R> failSafe) {
		Null.nonNullArg(failSafe, "failSafe");
	...
	@Nonnull
	default R nonNullDoApply(T a1, float a2) {
	...
	/**  */
	public static <T, R> LObjFltFunction<T, R> uncurryObjFltFunc(LFunction<T, LFltFunction<R>> func) {
		return (T a1, float a2) -> func.doApply(a1).doApply(a2);
	}

	/** Captures arguments but delays the evaluation. */
	default LSupplier<R> captureObjFltFunc(T a1, float a2) {
	...
	static <T, R> LObjFltFunction<T, R> recursive(final @Nonnull LFunction<LObjFltFunction<T, R>, LObjFltFunction<T, R>> selfLambda) {
		...
		LObjFltFunction<T, R> func = selfLambda.doApply(single);
		single.target = func;
		return func;
	}
	...
	final class LObjFltFunctionSingle<T, R> implements LSingle<LObjFltFunction<T, R>>, LObjFltFunction<T, R> {
		...
		@Override
		public R doApplyX(T a1, float a2) throws Throwable {
	...
	@Nonnull
	static <T, R> LObjFltFunction<T, R> objFltFuncThrowing(final @Nonnull ExceptionFactory<Throwable> exceptionFactory) {
	...
	@Nonnull
	static <T, R> LObjFltFunction<T, R> objFltFuncThrowing(final String message, final @Nonnull ExceptionWithMessageFactory<Throwable> exceptionFactory) {
		Null.nonNullArg(exceptionFactory, "exceptionFactory");
		return (a1, a2) -> {
	...
	@Nonnull
	default <V1> LObjFltFunction<V1, R> objFltFuncComposeFlt(@Nonnull final LFunction<? super V1, ? extends T> before1, @Nonnull final LFltUnaryOperator before2) {
		Null.nonNullArg(before1, "before1");
		Null.nonNullArg(before2, "before2");
		return (v1, v2) -> this.doApply(before1.doApply(v1), before2.doApplyAsFlt(v2));
	}

	public static <V1, T, R> LObjFltFunction<V1, R> composedFlt(@Nonnull final LFunction<? super V1, ? extends T> before1, @Nonnull final LFltUnaryOperator before2, LObjFltFunction<T, R> after) {
		return after.objFltFuncComposeFlt(before1, before2);
	}
	...
	@Nonnull
	default LObjFltFunction<T, R> nestingObjFltFunc() {
		return this;
	}

	/** Converts to non-throwing variant that will propagate checked exception as it would be unchecked - there is no exception wrapping involved (at least not here). */
	default LObjFltFunction<T, R> shovingObjFltFunc() {
		return this;
	}
	...
	@Nonnull
	default LObjFltFunction<T, R> nonNullObjFltFunc() {
	...
	interface LFltObjFunc<T, R> extends LObjFltFunction<T, R> {
		@Nullable
		R doApplyFltObj(float a2, T a1);

		@Override
		default R doApplyX(T a1, float a2) {
			return this.doApplyFltObj(a2, a1);
		}
	}
	...
	// MAP: FOR, [SourcePurpose{arg=T a1, type=IA}, SourcePurpose{arg=float a2, type=IA}, SourcePurpose{arg=LConsumer<? super R> consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T a1, type=SA}, SourcePurpose{arg=float a2, type=IA}, SourcePurpose{arg=LConsumer<? super R> consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T a1, type=IA}, SourcePurpose{arg=float a2, type=SA}, SourcePurpose{arg=LConsumer<? super R> consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T a1, type=SA}, SourcePurpose{arg=float a2, type=SA}, SourcePurpose{arg=LConsumer<? super R> consumer, type=CONST}]
