...
public interface LBiFunctionX<T1, T2, R, X extends Exception> extends java.util.function.BiFunction<T1, T2, R>, MetaFunction, MetaInterface.Throwing<X> { // NOSONAR
	...
	/** Wraps JRE instance. */
	@Nonnull
	public static <T1, T2, R, X extends Exception> LBiFunctionX<T1, T2, R, X> wrap(final java.util.function.BiFunction<T1, T2, R> other) {
		return other::apply;
	}
