...
public interface LBoolToIntFunction extends LBoolToIntFunctionX<RuntimeException>, MetaFunction, PrimitiveCodomain<Object>, MetaInterface.NonThrowing { // NOSONAR

	static final String DESCRIPTION = "LBoolToIntFunction: int doApplyAsInt(boolean b)";
