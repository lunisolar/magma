...
public interface LDblPredicate extends DoublePredicate, MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain1<aDouble> { // NOSONAR
	...
	public static double throwIf(double a, @Nonnull LDblPredicate pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (pred.test(a)) {
	...
	public static double throwIfNot(double a, @Nonnull LDblPredicate pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (!pred.test(a)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a;
	...
	/** Throws new exception if condition is met. */
	public static double throwIf(double a, @Nonnull LDblPredicate pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage) {
		if (pred.test(a)) {
	...
	/** Throws new exception if condition is not met. */
	public static double throwIfNot(double a, @Nonnull LDblPredicate pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage) {
		if (!pred.test(a)) {
			throw Handling.create(factory, newMessage);
		}
		return a;
