...
public interface LIntToFltFunction extends MetaFunction, MetaInterface.NonThrowing, Codomain<aFloat>, Domain1<aInt> { // NOSONAR
	 ...
	 */
	public static M memento(float initialValue, LIntToFltFunction baseFunction, LFltBinaryOperator mementoFunction) {
		return new M(initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not ). Very short name is intended to be used with parent (LIntToFltFunction.D)
	 */
	final class M implements LIntToFltFunction {
		...
		private M(float lastValue, LIntToFltFunction baseFunction, LFltBinaryOperator mementoFunction) {
