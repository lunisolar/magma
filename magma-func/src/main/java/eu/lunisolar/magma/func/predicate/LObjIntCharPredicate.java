...
public interface LObjIntCharPredicate<T> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<a<T>, aInt, aChar> { // NOSONAR
	...
	public default LObjIntPredicate<T> rShrink(@Nonnull LOiToCharFunction<T> right) {
		Null.nonNullArg(right, "right");
		return (a1, a2) -> test(a1, a2, right.applyAsChar(a1, a2));
	}

	public default LObjIntPredicate<T> rShrink_(char a3) {
	...
	public default LObjIntCharPredicate<T> beforeDo(@Nonnull LTieCharConsumer<T> before) {
	...
	public default LObjIntCharPredicate<T> afterDo(@Nonnull LBoolConsumer after) {
	...
	public static <T, X extends Throwable> T throwIf(T a1, int a2, char a3, @Nonnull LObjIntCharPredicate<T> pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
	...
	/** Throws new exception if condition is met. */
	public static <T, X extends Throwable> T throwIf(T a1, @Nonnull LObjIntCharPredicate<T> pred, int a2, char a3, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	public static <T, X extends Throwable> T throwIfNot(T a1, int a2, char a3, @Nonnull LObjIntCharPredicate<T> pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <T, X extends Throwable> T throwIfNot(T a1, @Nonnull LObjIntCharPredicate<T> pred, int a2, char a3, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	/** Throws new exception if condition is met. */
	public static <T, X extends Throwable> T throwIf(T a1, int a2, char a3, @Nonnull LObjIntCharPredicate<T> pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (pred.test(a1, a2, a3)) {
	...
	/** Throws new exception if condition is met. */
	public static <T, X extends Throwable> T throwIf(T a1, @Nonnull LObjIntCharPredicate<T> pred, int a2, char a3, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <T, X extends Throwable> T throwIfNot(T a1, int a2, char a3, @Nonnull LObjIntCharPredicate<T> pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <T, X extends Throwable> T throwIfNot(T a1, @Nonnull LObjIntCharPredicate<T> pred, int a2, char a3, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
