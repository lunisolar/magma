...
public interface LBiShortPredicateX<X extends Throwable> extends MetaPredicate, MetaInterface.Throwing<X> { // NOSONAR
	...
	@Nonnull
	static <X extends Throwable> LBiShortPredicateX<X> safe() {
		return Function4U::alwaysFalse;
	}

	/** Safe instance supplier. Returns supplier of safe() instance. */
	@Nonnull
	static <X extends Throwable, Y extends Throwable> LSupplierX<LBiShortPredicateX<X>, Y> safeSupplier() {
		return () -> safe();
	}

	/** Safe wrapping. Either argument function is returned (if it is not null) or safe() instance. */
	@Nonnull
	static <X extends Throwable> LBiShortPredicateX<X> safe(final @Nullable LBiShortPredicateX<X> other) {
		if (other == null) {
			return safe();
		} else {
			return other;
	...
	@Nonnull
	static <X extends Throwable, Y extends Throwable> LSupplierX<LBiShortPredicateX<X>, Y> safeSupplier(final @Nullable LSupplierX<LBiShortPredicateX<X>, Y> supplier) {
		if (supplier == null) {
			return safeSupplier();
		} else {
			return supplier;
	...
	default LBiShortPredicateX<X> biShortPredComposeShort(@Nonnull final LShortUnaryOperatorX<X> before1, @Nonnull final LShortUnaryOperatorX<X> before2) {
		...
		return (v1, v2) -> this.doTest(before1.doApplyAsShort(v1), before2.doApplyAsShort(v2));
	}
	...
	@Nonnull
	default <V> LBiShortFunctionX<V, X> boolToBiShortFunc(@Nonnull LBoolFunctionX<? extends V, X> after) {
	...
	/** Permutation of LBiShortPredicateX for method references. */
	@FunctionalInterface
	interface V1<X extends Throwable> extends LBiShortPredicateX<X> {

		boolean doTestV1(short a2, short a1) throws X;

		@Override
		default boolean doTest(short a1, short a2) throws X {
