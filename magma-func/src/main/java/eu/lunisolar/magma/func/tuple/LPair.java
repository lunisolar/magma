...
public interface LPair<T1, T2> extends LTuple<Object>, Map.Entry<T1, T2> {
	...
	public static <T> Iterator<LPair.MutPair> mutIterator(Iterator<? extends T> items) {
		return iterator(items, LPair::of);
	}

	public static <T> Iterator<LPair> immIterator(Iterator<? extends T> items) {
		return iterator(items, LPair::immutableOf);
	}
	...
	public static <T> Stream<LPair.MutPair> mutStream(Stream<? extends T> items) {
		return stream(items, LPair::of);
	}

	public static <T> Stream<LPair> immStream(Stream<? extends T> items) {
		return stream(items, LPair::immutableOf);
	}
