...
/**
 * Non-throwing functional interface (lambda) BiShortPredicate for Java 8.
 *
 * Type: predicate
 *
...
public interface BiShortPredicate extends BiShortPredicateX<RuntimeException>, MetaPredicate, PrimitiveCodomain<Object>, MetaInterface.NonThrowing { // NOSONAR
