...
public interface LLongPair extends LTuple<Long>, Comparable<LLongPair> {
	...
	public static Iterator<LLongPair.MutLongPair> mutIterator(PrimitiveIterator.OfLong items) {
		return iterator(items, LLongPair::of);
	}

	public static Iterator<LLongPair> immIterator(PrimitiveIterator.OfLong items) {
		return iterator(items, LLongPair::immutableOf);
	}
	...
	public static Stream<LLongPair.MutLongPair> mutStream(LongStream items) {
		return stream(items, LLongPair::of);
	}

	public static Stream<LLongPair> immStream(LongStream items) {
		return stream(items, LLongPair::immutableOf);
	}
