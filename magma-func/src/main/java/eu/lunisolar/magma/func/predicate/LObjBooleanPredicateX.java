...
public interface LObjBooleanPredicateX<T, X extends Throwable> extends MetaPredicate, PrimitiveCodomain<Object>, MetaInterface.Throwing<X> { // NOSONAR
	...
	@Nonnull
	static <T, X extends Throwable> LObjBooleanPredicateX<T, X> test1st(@Nonnull LPredicateX<T, X> func) {
		return (t, b) -> func.doTest(t);
	}

	/** Captures single parameter function into this interface where only 2nd parameter will be used. */
	@Nonnull
	static <T, X extends Throwable> LObjBooleanPredicateX<T, X> test2nd(@Nonnull LLogicalOperatorX<X> func) {
	...
	@Nonnull
	default <V1> LObjBooleanPredicateX<V1, X> objBoolPredComposeBoolean(@Nonnull final LFunctionX<? super V1, ? extends T, X> before1, @Nonnull final LLogicalOperatorX<X> before2) {
