...
public interface LTriFunctionX<T1, T2, T3, R, X extends Throwable> extends MetaFunction, MetaInterface.Throwing<X> { // NOSONAR
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T3, T2, R, X extends Throwable> V1<T1, T3, T2, R, X> lX1(final @Nonnull V1<T1, T3, T2, R, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T3, T2, R, X extends Throwable> V1<T1, T3, T2, R, X> lX1(@Nonnull Class<X> xClass, final @Nonnull V1<T1, T3, T2, R, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1, T3, R, X extends Throwable> V2<T2, T1, T3, R, X> lX2(final @Nonnull V2<T2, T1, T3, R, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1, T3, R, X extends Throwable> V2<T2, T1, T3, R, X> lX2(@Nonnull Class<X> xClass, final @Nonnull V2<T2, T1, T3, R, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T3, T1, R, X extends Throwable> V3<T2, T3, T1, R, X> lX3(final @Nonnull V3<T2, T3, T1, R, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T3, T1, R, X extends Throwable> V3<T2, T3, T1, R, X> lX3(@Nonnull Class<X> xClass, final @Nonnull V3<T2, T3, T1, R, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T3, T1, T2, R, X extends Throwable> V4<T3, T1, T2, R, X> lX4(final @Nonnull V4<T3, T1, T2, R, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T3, T1, T2, R, X extends Throwable> V4<T3, T1, T2, R, X> lX4(@Nonnull Class<X> xClass, final @Nonnull V4<T3, T1, T2, R, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T3, T2, T1, R, X extends Throwable> V5<T3, T2, T1, R, X> lX5(final @Nonnull V5<T3, T2, T1, R, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T3, T2, T1, R, X extends Throwable> V5<T3, T2, T1, R, X> lX5(@Nonnull Class<X> xClass, final @Nonnull V5<T3, T2, T1, R, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Permutation of LTriFunctionX for method references. */
	@FunctionalInterface
	interface V1<T1, T3, T2, R, X extends Throwable> extends LTriFunctionX<T1, T2, T3, R, X> {
		@Nullable
		R doApplyV1(T1 a1, T3 a3, T2 a2) throws X;

		@Override
		default R doApply(T1 a1, T2 a2, T3 a3) throws X {
	...
	/** Permutation of LTriFunctionX for method references. */
	@FunctionalInterface
	interface V2<T2, T1, T3, R, X extends Throwable> extends LTriFunctionX<T1, T2, T3, R, X> {
		@Nullable
		R doApplyV2(T2 a2, T1 a1, T3 a3) throws X;
	...
	/** Permutation of LTriFunctionX for method references. */
	@FunctionalInterface
	interface V3<T2, T3, T1, R, X extends Throwable> extends LTriFunctionX<T1, T2, T3, R, X> {
		@Nullable
		R doApplyV3(T2 a2, T3 a3, T1 a1) throws X;
	...
	/** Permutation of LTriFunctionX for method references. */
	@FunctionalInterface
	interface V4<T3, T1, T2, R, X extends Throwable> extends LTriFunctionX<T1, T2, T3, R, X> {
		@Nullable
		R doApplyV4(T3 a3, T1 a1, T2 a2) throws X;
	...
	/** Permutation of LTriFunctionX for method references. */
	@FunctionalInterface
	interface V5<T3, T2, T1, R, X extends Throwable> extends LTriFunctionX<T1, T2, T3, R, X> {
		@Nullable
		R doApplyV5(T3 a3, T2 a2, T1 a1) throws X;
