...
public interface LBiObjFloatPredicate<T1, T2> extends LBiObjFloatPredicateX<T1, T2, RuntimeException>, MetaPredicate, MetaInterface.NonThrowing { // NOSONAR

	String DESCRIPTION = "LBiObjFloatPredicate: boolean doTest(T1 a1,T2 a2,float a3)";

	boolean doTest(T1 a1, T2 a2, float a3);

	default boolean tupleTest(LBiObjFloatTriple<T1, T2> args) {
	...
	default LBoolSupplier captureBiObjFloatPred(T1 a1, T2 a2, float a3) {
		return () -> this.doTest(a1, a2, a3);
	}
	 ...
	 */
	@Nonnull
	static <T1, T2> LBiObjFloatPredicate<T1, T2> isEqual(T1 v1, T2 v2, float v3) {
	...
	default <V1, V2> LBiObjFloatPredicate<V1, V2> biObjFloatPredComposeFloat(@Nonnull final LFunction<? super V1, ? extends T1> before1, @Nonnull final LFunction<? super V2, ? extends T2> before2, @Nonnull final LFloatUnaryOperator before3) {
		...
		return (V1 v1, V2 v2, float v3) -> this.doTest(before1.doApply(v1), before2.doApply(v2), before3.doApplyAsFloat(v3));
	}
	...
	interface V1<T1, T2> extends LBiObjFloatPredicate<T1, T2> {
		...
		boolean doTestV1(T1 a1, float a3, T2 a2);
	...
	/** Permutation of LBiObjFloatPredicate for method references. */
	@FunctionalInterface
	interface V2<T2, T1> extends LBiObjFloatPredicate<T1, T2> {

		boolean doTestV2(T2 a2, T1 a1, float a3);
	...
	/** Permutation of LBiObjFloatPredicate for method references. */
	@FunctionalInterface
	interface V3<T2, T1> extends LBiObjFloatPredicate<T1, T2> {

		boolean doTestV3(T2 a2, float a3, T1 a1);
	...
	interface V4<T1, T2> extends LBiObjFloatPredicate<T1, T2> {
		...
		boolean doTestV4(float a3, T1 a1, T2 a2);
	...
	/** Permutation of LBiObjFloatPredicate for method references. */
	@FunctionalInterface
	interface V5<T2, T1> extends LBiObjFloatPredicate<T1, T2> {

		boolean doTestV5(float a3, T2 a2, T1 a1);
