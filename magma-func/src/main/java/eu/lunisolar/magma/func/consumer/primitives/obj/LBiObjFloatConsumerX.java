...
public interface LBiObjFloatConsumerX<T1, T2, X extends Throwable> extends MetaConsumer, MetaInterface.Throwing<X> {
	...
	interface V1<T1, T2, X extends Throwable> extends LBiObjFloatConsumerX<T1, T2, X> {
		...
		void apply1(T1 a1, float a3, T2 a2) throws X;
	...
	/** Permutation of LBiObjFloatConsumerX for method references. */
	@FunctionalInterface
	interface V2<T1, T2, X extends Throwable> extends LBiObjFloatConsumerX<T1, T2, X> {

		void apply2(T2 a2, T1 a1, float a3) throws X;
	...
	/** Permutation of LBiObjFloatConsumerX for method references. */
	@FunctionalInterface
	interface V3<T1, T2, X extends Throwable> extends LBiObjFloatConsumerX<T1, T2, X> {

		void apply3(T2 a2, float a3, T1 a1) throws X;
	...
	interface V4<T1, T2, X extends Throwable> extends LBiObjFloatConsumerX<T1, T2, X> {
		...
		void apply4(float a3, T1 a1, T2 a2) throws X;
	...
	/** Permutation of LBiObjFloatConsumerX for method references. */
	@FunctionalInterface
	interface V5<T1, T2, X extends Throwable> extends LBiObjFloatConsumerX<T1, T2, X> {

		void apply5(float a3, T2 a2, T1 a1) throws X;
