...
public interface LBiObjFloatConsumerX<T1, T2, X extends Throwable> extends MetaConsumer, MetaInterface.Throwing<X> {
	...
	String DESCRIPTION = "LBiObjFloatConsumerX: void doAccept(T1 a1,T2 a2,float a3) throws X";

	void doAccept(T1 a1, T2 a2, float a3) throws X;

	default LTuple.Void tupleAccept(LBiObjFloatTriple<T1, T2> args) throws X {
	...
	default void shovingDoAccept(T1 a1, T2 a2, float a3) {
		((LBiObjFloatConsumerX<T1, T2, RuntimeException>) this).doAccept(a1, a2, a3);
	}

	/** Function call that handles exceptions according to the instructions. */
	default <Y extends Throwable> void handlingDoAccept(T1 a1, T2 a2, float a3, HandlingInstructions<Throwable, Y> handling) throws Y {
	...
	default LActionX<X> captureBiObjFloatCons(T1 a1, T2 a2, float a3) {
	...
	static <T1, T2, X extends Throwable> void call(T1 a1, T2 a2, float a3, final @Nonnull LBiObjFloatConsumerX<T1, T2, X> lambda) throws X {
		Null.nonNullArg(lambda, "lambda");
		lambda.doAccept(a1, a2, a3);
	}

	static <T1, T2, X extends Throwable> void shoving(T1 a1, T2 a2, float a3, final @Nonnull LBiObjFloatConsumerX<T1, T2, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		lambda.shovingDoAccept(a1, a2, a3);
	}

	static <T1, T2, X extends Throwable> void nesting(T1 a1, T2 a2, float a3, final @Nonnull LBiObjFloatConsumerX<T1, T2, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		lambda.nestingDoAccept(a1, a2, a3);
	}

	static <T1, T2, X extends Throwable, Y extends Throwable> void handling(T1 a1, T2 a2, float a3, final HandlingInstructions<Throwable, Y> handling, final @Nonnull LBiObjFloatConsumerX<T1, T2, X> lambda) throws Y {
		Null.nonNullArg(lambda, "lambda");
	...
	/** Safe instance. */
	@Nonnull
	static <T1, T2, X extends Throwable> LBiObjFloatConsumerX<T1, T2, X> safe() {
		return Function4U::doNothing;
	}

	/** Safe instance supplier. Returns supplier of safe() instance. */
	@Nonnull
	static <T1, T2, X extends Throwable, Y extends Throwable> LSupplierX<LBiObjFloatConsumerX<T1, T2, X>, Y> safeSupplier() {
		return () -> safe();
	}

	/** Safe wrapping. Either argument function is returned (if it is not null) or safe() instance. */
	@Nonnull
	static <T1, T2, X extends Throwable> LBiObjFloatConsumerX<T1, T2, X> safe(final @Nullable LBiObjFloatConsumerX<T1, T2, X> other) {
		if (other == null) {
			return safe();
		} else {
			return other;
	...
	@Nonnull
	static <T1, T2, X extends Throwable, Y extends Throwable> LSupplierX<LBiObjFloatConsumerX<T1, T2, X>, Y> safeSupplier(final @Nullable LSupplierX<LBiObjFloatConsumerX<T1, T2, X>, Y> supplier) {
		if (supplier == null) {
			return safeSupplier();
		} else {
			return supplier;
	...
	default <V1, V2> LBiObjFloatConsumerX<V1, V2, X> biObjFloatConsComposeFloat(@Nonnull final LFunctionX<? super V1, ? extends T1, X> before1, @Nonnull final LFunctionX<? super V2, ? extends T2, X> before2, @Nonnull final LFloatUnaryOperatorX<X> before3) {
		...
		return (V1 v1, V2 v2, float v3) -> this.doAccept(before1.doApply(v1), before2.doApply(v2), before3.doApplyAsFloat(v3));
	}
	...
	/** Combines two LBiObjFloatConsumerX<T1,T2,X> together in a order. */
	@Nonnull
	...
	default LBiObjFloatConsumer<T1, T2> handleBiObjFloatCons(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
		return (T1 a1, T2 a2, float a3) -> this.handlingDoAccept(a1, a2, a3, handling);
	}
	...
	/** Permutation of LBiObjFloatConsumerX for method references. */
	@FunctionalInterface
	interface V1<T1, T2, X extends Throwable> extends LBiObjFloatConsumerX<T1, T2, X> {

		void doAcceptV1(T1 a1, float a3, T2 a2) throws X;

		@Override
		default void doAccept(T1 a1, T2 a2, float a3) throws X {
	...
	/** Permutation of LBiObjFloatConsumerX for method references. */
	@FunctionalInterface
	interface V2<T2, T1, X extends Throwable> extends LBiObjFloatConsumerX<T1, T2, X> {

		void doAcceptV2(T2 a2, T1 a1, float a3) throws X;
	...
	/** Permutation of LBiObjFloatConsumerX for method references. */
	@FunctionalInterface
	interface V3<T2, T1, X extends Throwable> extends LBiObjFloatConsumerX<T1, T2, X> {

		void doAcceptV3(T2 a2, float a3, T1 a1) throws X;
	...
	/** Permutation of LBiObjFloatConsumerX for method references. */
	@FunctionalInterface
	interface V4<T1, T2, X extends Throwable> extends LBiObjFloatConsumerX<T1, T2, X> {

		void doAcceptV4(float a3, T1 a1, T2 a2) throws X;
	...
	/** Permutation of LBiObjFloatConsumerX for method references. */
	@FunctionalInterface
	interface V5<T2, T1, X extends Throwable> extends LBiObjFloatConsumerX<T1, T2, X> {

		void doAcceptV5(float a3, T2 a2, T1 a1) throws X;
