...
public interface LBiLongFunction<R> extends MetaFunction, MetaInterface.NonThrowing, Codomain<a<R>>, Domain2<aLong, aLong> { // NOSONAR
	...
	static <R> R tryApply(long a1, long a2, LBiLongFunction<R> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		Null.nonNullArg(func, "func");
	...
	public default LBiLongFunction untyped() {
		return this;
	}

	/** Cast that replace generics. */
	public default <V2> LBiLongFunction<V2> cast() {
		return untyped();
	}
