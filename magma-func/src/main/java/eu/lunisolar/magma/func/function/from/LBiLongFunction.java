...
public interface LBiLongFunction<R> extends MetaFunction, MetaInterface.NonThrowing { // NOSONAR

	String DESCRIPTION = "LBiLongFunction: R doApply(long a1,long a2)";

	@Nullable
	// R doApply(long a1,long a2) ;
	default R doApply(long a1, long a2) {
	...
	/**
	 * Implement this, but call doApply(long a1,long a2)
	 */
	R doApplyX(long a1, long a2) throws Throwable;
	...
	default R handlingDoApply(long a1, long a2, HandlingInstructions<Throwable, RuntimeException> handling) {
		try {
			return this.doApplyX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default R tryDoApply(long a1, long a2, @Nonnull ExceptionWrapWithMessageFactory<RuntimeException> exceptionFactory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		try {
			return this.doApplyX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default R tryDoApply(long a1, long a2, @Nonnull ExceptionWrapFactory<RuntimeException> exceptionFactory) {
		try {
			return this.doApplyX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default R tryDoApplyThen(long a1, long a2, @Nonnull LFunction<Throwable, R> handler) {
		try {
			return this.doApplyX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	static <R> R handlingDoApply(long a1, long a2, LBiLongFunction<R> func, HandlingInstructions<Throwable, RuntimeException> handling) { // <-
		Null.nonNullArg(func, "func");
		return func.handlingDoApply(a1, a2, handling);
	}

	static <R> R tryDoApply(long a1, long a2, LBiLongFunction<R> func) {
		return tryDoApply(a1, a2, func, null);
	}

	static <R> R tryDoApply(long a1, long a2, LBiLongFunction<R> func, @Nonnull ExceptionWrapWithMessageFactory<RuntimeException> exceptionFactory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		Null.nonNullArg(func, "func");
		return func.tryDoApply(a1, a2, exceptionFactory, newMessage, messageParams);
	}

	static <R> R tryDoApply(long a1, long a2, LBiLongFunction<R> func, @Nonnull ExceptionWrapFactory<RuntimeException> exceptionFactory) {
		Null.nonNullArg(func, "func");
		return func.tryDoApply(a1, a2, exceptionFactory);
	}

	static <R> R tryDoApplyThen(long a1, long a2, LBiLongFunction<R> func, @Nonnull LFunction<Throwable, R> handler) {
		Null.nonNullArg(func, "func");
		return func.tryDoApplyThen(a1, a2, handler);
	}

	default R failSafeDoApply(long a1, long a2, @Nonnull LBiLongFunction<R> failSafe) {
		try {
	...
	static <R> R failSafeDoApply(long a1, long a2, LBiLongFunction<R> func, @Nonnull LBiLongFunction<R> failSafe) {
	...
	static <R> LBiLongFunction<R> failSafeBiLongFunc(LBiLongFunction<R> func, @Nonnull LBiLongFunction<R> failSafe) {
		Null.nonNullArg(failSafe, "failSafe");
	...
	@Nonnull
	default R nonNullDoApply(long a1, long a2) {
	...
	public default LLongFunction<R> lShrink(LLongUnaryOperator left) {
		return a2 -> doApply(left.doApplyAsLong(a2), a2);
	}
	...
	/**  */
	public static <R> LBiLongFunction<R> uncurryBiLongFunc(LLongFunction<LLongFunction<R>> func) {
		return (long a1, long a2) -> func.doApply(a1).doApply(a2);
	}

	/** Captures arguments but delays the evaluation. */
	default LSupplier<R> captureBiLongFunc(long a1, long a2) {
	...
	static <R> LBiLongFunction<R> recursive(final @Nonnull LFunction<LBiLongFunction<R>, LBiLongFunction<R>> selfLambda) {
		final LBiLongFunctionSingle<R> single = new LBiLongFunctionSingle();
		LBiLongFunction<R> func = selfLambda.doApply(single);
		single.target = func;
		return func;
	}
	...
	final class LBiLongFunctionSingle<R> implements LSingle<LBiLongFunction<R>>, LBiLongFunction<R> {
		...
		@Override
		public R doApplyX(long a1, long a2) throws Throwable {
	...
	@Nonnull
	static <R> LBiLongFunction<R> biLongFuncThrowing(final @Nonnull ExceptionFactory<Throwable> exceptionFactory) {
	...
	@Nonnull
	static <R> LBiLongFunction<R> biLongFuncThrowing(final String message, final @Nonnull ExceptionWithMessageFactory<Throwable> exceptionFactory) {
		Null.nonNullArg(exceptionFactory, "exceptionFactory");
		return (a1, a2) -> {
	...
	@Nonnull
	static <R> LBiLongFunction<R> safe() {
		return LBiLongFunction::produce;
	}

	/** Safe instance supplier. Returns supplier of safe() instance. */
	@Nonnull
	static <R> LSupplier<LBiLongFunction<R>> safeSupplier() {
		return () -> safe();
	}

	/** Safe wrapping. Either argument function is returned (if it is not null) or safe() instance. */
	@Nonnull
	static <R> LBiLongFunction<R> safe(final @Nullable LBiLongFunction<R> other) {
		if (other == null) {
			return safe();
		} else {
			return other;
	...
	@Nonnull
	static <R> LSupplier<LBiLongFunction<R>> safeSupplier(final @Nullable LSupplier<LBiLongFunction<R>> supplier) {
		if (supplier == null) {
			return safeSupplier();
		} else {
			return supplier;
	...
	@Nonnull
	default LBiLongFunction<R> biLongFuncComposeLong(@Nonnull final LLongUnaryOperator before1, @Nonnull final LLongUnaryOperator before2) {
		Null.nonNullArg(before1, "before1");
		Null.nonNullArg(before2, "before2");
		return (v1, v2) -> this.doApply(before1.doApplyAsLong(v1), before2.doApplyAsLong(v2));
	}

	public static <R> LBiLongFunction<R> composedLong(@Nonnull final LLongUnaryOperator before1, @Nonnull final LLongUnaryOperator before2, LBiLongFunction<R> after) {
		return after.biLongFuncComposeLong(before1, before2);
	}
	...
	@Nonnull
	default LBiLongFunction<R> nonNullBiLongFunc() {
	...
	interface LLong1Long0Func<R> extends LBiLongFunction<R> {
		@Nullable
		R doApplyLong1Long0(long a2, long a1);

		@Override
		default R doApplyX(long a1, long a2) {
			return this.doApplyLong1Long0(a2, a1);
		}
	}
	...
	// MAP: FOR, [SourcePurpose{arg=long a1, type=IA}, SourcePurpose{arg=long a2, type=IA}, SourcePurpose{arg=LConsumer<? super R> consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=long a1, type=SA}, SourcePurpose{arg=long a2, type=IA}, SourcePurpose{arg=LConsumer<? super R> consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=long a1, type=IA}, SourcePurpose{arg=long a2, type=SA}, SourcePurpose{arg=LConsumer<? super R> consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=long a1, type=SA}, SourcePurpose{arg=long a2, type=SA}, SourcePurpose{arg=LConsumer<? super R> consumer, type=CONST}]
