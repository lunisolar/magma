 ...
 * Co-domain: R
 *
 * @see LBiLongFunctionX
 */
@FunctionalInterface
@SuppressWarnings("UnusedDeclaration")
public interface LBiLongFunction<R> extends LBiLongFunctionX<R, RuntimeException>, MetaFunction, MetaInterface.NonThrowing { // NOSONAR
	...
	@Nonnull
	static <R> LBiLongFunction<R> l(final @Nonnull LBiLongFunction<R> lambda) {
	...
	@Nonnull
	static <R, X extends Throwable> LBiLongFunction<R> wrap(final @Nonnull LBiLongFunctionX<R, X> other) {
	...
	/** Combines two functions together in a order. */
	@Nonnull
	default LBiLongConsumer then(@Nonnull LConsumer<? super R> after) {
		Null.nonNullArg(after, "after");
	...
	@FunctionalInterface
	interface V1<R> extends LBiLongFunction<R> {
		@Nullable
		R doApplyV1(long a2, long a1);
