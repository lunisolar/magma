 ...
 * Co-domain: R
 *
 * @see LObjBoolFunctionX
 */
@FunctionalInterface
@SuppressWarnings("UnusedDeclaration")
public interface LObjBoolFunction<T, R> extends LObjBoolFunctionX<T, R, RuntimeException>, MetaFunction, MetaInterface.NonThrowing { // NOSONAR

	static final String DESCRIPTION = "LObjBoolFunction: R doApply(T t, boolean b)";
	...
	@Nonnull
	static <T, R> LObjBoolFunction<T, R> l(final @Nonnull LObjBoolFunction<T, R> lambda) {
	...
	@Nonnull
	static <T, R, X extends Throwable> LObjBoolFunction<T, R> wrap(final @Nonnull LObjBoolFunctionX<T, R, X> other) {
	...
	@Nonnull
	default <V1> LObjBoolFunction<V1, R> objBoolFuncComposeBoolean(@Nonnull final LFunction<? super V1, ? extends T> before1, @Nonnull final LLogicalOperator before2) {
