...
/**
 * Non-throwing functional interface (lambda) ToByteFunction for Java 8.
 *
 * Type: function
 *
 * Domain (lvl: 1): T t
...
public interface ToByteFunction<T> extends ToByteFunctionX<T, RuntimeException>, MetaFunction, PrimitiveCodomain<Object>, MetaInterface.NonThrowing { // NOSONAR
