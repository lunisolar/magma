...
public interface LObjBiIntTriple<T> extends LTuple<Object> {
	...
	interface Mut<T, SELF extends Mut<T, SELF>> extends LObjBiIntTriple<T> {
		...
		default LObjBiIntTriple<T> value(int value) {
			third(value);
			return this;
		}
	...
	public static <T> LObjBiIntTriple<T> immutableOf(T a1, int a2, int a3) {
		return new ImmObjBiIntTriple(a1, a2, a3);
	}

	public static <T> LObjBiIntTriple<T> immutableCopyOf(LObjBiIntTriple<T> tuple) {
