...
public interface LLongPredicate extends LongPredicate, MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain1<aLong> { // NOSONAR
	 ...
	 */
	public static M memento(boolean initialValue, LLongPredicate baseFunction, LLogicalBinaryOperator mementoFunction) {
		return new M(initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not ). Very short name is intended to be used with parent (LLongPredicate.D)
	 */
	final class M implements LLongPredicate {
		...
		private M(boolean lastValue, LLongPredicate baseFunction, LLogicalBinaryOperator mementoFunction) {
