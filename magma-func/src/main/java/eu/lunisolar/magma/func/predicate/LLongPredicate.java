...
public interface LLongPredicate extends LongPredicate, MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain1<aLong> { // NOSONAR
	...
	final class M implements LLongPredicate {
		...
		public boolean currentTest(long a) {
			boolean x1 = lastBaseValue;
	...
	public static boolean any(boolean expected, long a, @Nonnull Collection<? extends LLongPredicate> predicates) {
		return any(expected, a, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static boolean any(boolean expected, long a, @Nonnull Stream<? extends LLongPredicate> predicates) {
		return any(expected, a, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static boolean any(boolean expected, long a, @Nonnull Iterator<? extends LLongPredicate> predicates) {
		Null.nonNullArg(predicates, "predicates");
	...
	public static boolean any(boolean expected, long a, @Nonnull LLongPredicate... predicates) {
		Null.nonNullArg(predicates, "predicates");
