...
public interface LDoubleBiFunctionX<R, X extends Throwable> extends MetaFunction, MetaInterface.Throwing<X> { // NOSONAR
	...
	static final String DESCRIPTION = "LDoubleBiFunctionX: R doApply(double d1,double d2) throws X";

	@Nullable
	R doApply(double d1, double d2) throws X;
	...
	static <R, X extends Throwable> LDoubleBiFunctionX<R, X> constant(R r) {
		return (d1, d2) -> r;
	}

	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <R, X extends Throwable> LDoubleBiFunctionX<R, X> lX(final @Nonnull LDoubleBiFunctionX<R, X> lambda) {
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <R, X extends Throwable> LDoubleBiFunctionX<R, X> lX(@Nonnull Class<X> xClass, final @Nonnull LDoubleBiFunctionX<R, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	@Nonnull
	static <R, X extends Throwable> LDoubleBiFunctionX<R, X> wrapX(final @Nonnull LDoubleBiFunction<R> other) {
