...
public interface LBiDoubleConsumer extends LBiDoubleConsumerX<RuntimeException>, MetaConsumer, MetaInterface.NonThrowing {
	...
	/** Safe instance. */
	@Nonnull
	static LBiDoubleConsumer safe() {
		return Function4U::doNothing;
	}

	/** Safe instance supplier. Returns supplier of safe() instance. */
	@Nonnull
	static LSupplier<LBiDoubleConsumer> safeSupplier() {
		return () -> safe();
	}

	/** Safe wrapping. Either argument function is returned (if it is not null) or safe() instance. */
	@Nonnull
	static LBiDoubleConsumer safe(final @Nullable LBiDoubleConsumer other) {
		if (other == null) {
			return safe();
		} else {
			return other;
	...
	@Nonnull
	static LSupplier<LBiDoubleConsumer> safeSupplier(final @Nullable LSupplier<LBiDoubleConsumer> supplier) {
		if (supplier == null) {
			return safeSupplier();
		} else {
			return supplier;
	...
	default LBiDoubleConsumer biDoubleConsComposeDouble(@Nonnull final LDoubleUnaryOperator before1, @Nonnull final LDoubleUnaryOperator before2) {
		...
		return (double v1, double v2) -> this.doAccept(before1.doApplyAsDouble(v1), before2.doApplyAsDouble(v2));
	}
	...
	/** Combines two LBiDoubleConsumer together in a order. */
	@Nonnull
	...
	/** Permutation of LBiDoubleConsumer for method references. */
	@FunctionalInterface
	interface V1 extends LBiDoubleConsumer {

		void doAcceptV1(double a2, double a1);
