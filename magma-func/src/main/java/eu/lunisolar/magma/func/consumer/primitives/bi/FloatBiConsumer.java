...
/**
 * Non-throwing functional interface (lambda) FloatBiConsumer for Java 8.
 *
 * Type: consumer
 *
...
public interface FloatBiConsumer extends FloatBiConsumerX<RuntimeException>, MetaConsumer, MetaInterface.NonThrowing {
