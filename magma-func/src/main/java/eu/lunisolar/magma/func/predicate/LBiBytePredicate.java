...
public interface LBiBytePredicate extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain2<aByte, aByte> { // NOSONAR
	...
	public static <X extends Throwable> byte throwIf(byte a1, byte a2, @Nonnull LBiBytePredicate pred, @Nonnull ExMF<X> factory, LBiByteFunction<? extends String> msgFunc) throws X {
		if (pred.test(a1, a2)) {
	...
	/** Throws new exception if condition is met. */
	public static <X extends Throwable> byte throwIfNot(byte a1, byte a2, @Nonnull LBiBytePredicate pred, @Nonnull ExMF<X> factory, LBiByteFunction<? extends String> msgFunc) throws X {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, msgFunc.apply(a1, a2), a1, a2);
		}
		return a1;
	...
	/** Throws new exception if condition is met. */
	public static <X extends Throwable> byte throwIf(byte a1, @Nonnull LBiBytePredicate pred, byte a2, @Nonnull ExMF<X> factory, LBiByteFunction<? extends String> msgFunc) throws X {
		if (pred.test(a1, a2)) {
			throw Handling.create(factory, msgFunc.apply(a1, a2), a1, a2);
		}
		return a1;
	...
	/** Throws new exception if condition is met. */
	public static <X extends Throwable> byte throwIfNot(byte a1, @Nonnull LBiBytePredicate pred, byte a2, @Nonnull ExMF<X> factory, LBiByteFunction<? extends String> msgFunc) throws X {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, msgFunc.apply(a1, a2), a1, a2);
		}
		return a1;
	...
	public static <X extends Throwable> byte throwIfNot$(byte a1, byte a2, LBiByteFunction<? extends String> specialPredicate, @Nonnull ExMF<X> factory) throws X {
	...
	/** Throws new exception if condition is met. String is used as a result of test. Non NULL String means condition is not met and Strings content is used for exception message. */
	public static <X extends Throwable> byte throwIfNot$(byte a1, LBiByteFunction<? extends String> specialPredicate, byte a2, @Nonnull ExMF<X> factory) throws X {
		var msg = specialPredicate.apply(a1, a2);
		if (msg != null) {
			throw Handling.create(factory, msg);
		}
	...
	/** Throws new exception if condition is met. */
	public static <X extends Throwable> byte throwIf(byte a1, byte a2, @Nonnull LBiBytePredicate pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (pred.test(a1, a2)) {
	...
	/** Throws new exception if condition is met. */
	public static <X extends Throwable> byte throwIf(byte a1, @Nonnull LBiBytePredicate pred, byte a2, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	public static <X extends Throwable> byte throwIfNot(byte a1, byte a2, @Nonnull LBiBytePredicate pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <X extends Throwable> byte throwIfNot(byte a1, @Nonnull LBiBytePredicate pred, byte a2, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	/** Throws new exception if condition is met. */
	public static <X extends Throwable> byte throwIf(byte a1, byte a2, @Nonnull LBiBytePredicate pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (pred.test(a1, a2)) {
	...
	/** Throws new exception if condition is met. */
	public static <X extends Throwable> byte throwIf(byte a1, @Nonnull LBiBytePredicate pred, byte a2, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <X extends Throwable> byte throwIfNot(byte a1, byte a2, @Nonnull LBiBytePredicate pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <X extends Throwable> byte throwIfNot(byte a1, @Nonnull LBiBytePredicate pred, byte a2, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
	...
	*/
	...
	final class LBiBytePredicateSingle implements LBiBytePredicate {
