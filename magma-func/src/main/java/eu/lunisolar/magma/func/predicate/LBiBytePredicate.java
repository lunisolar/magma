...
public interface LBiBytePredicate extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain2<aByte, aByte> { // NOSONAR
	 ...
	 */
	public static M memento(boolean initialValue, LBiBytePredicate baseFunction, LLogicalBinaryOperator mementoFunction) {
		return new M(initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not ). Very short name is intended to be used with parent (LBiBytePredicate.D)
	 */
	final class M implements LBiBytePredicate {
		...
		private M(boolean lastValue, LBiBytePredicate baseFunction, LLogicalBinaryOperator mementoFunction) {
