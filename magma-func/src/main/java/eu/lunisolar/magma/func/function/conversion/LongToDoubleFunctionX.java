...
/**
 *
 * @see {@link eu.lunisolar.magma.func.function.conversion.LongToDoubleFunction}
 */
@FunctionalInterface
...
public interface LongToDoubleFunctionX<X extends Exception> extends MetaFunction, PrimitiveCodomain<LongToDoubleFunctionX<X>>, MetaThrowingInterface<X> { // NOSONAR
	...
	@Nonnull
	public static <X extends Exception, Y extends Exception> LongToDoubleFunctionX<Y> wrapException(@Nonnull final LongToDoubleFunctionX<X> other, Class<? extends Exception> exception, ExceptionHandler<Exception, Y> rethrower) {
		return (long l) -> {
			try {
	...
	@Nonnull
	default <Y extends Exception> LongToDoubleFunctionX<Y> handle(Class<? extends Exception> exception, ExceptionHandler<? super X, Y> handler) {
		Objects.requireNonNull(exception, Function4U.VALIDATION_MESSAGE_EXCEPTION);
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return LongToDoubleFunctionX.wrapException(this, exception, (ExceptionHandler) handler);
	}

	/** Wraps with exception handling that for argument exception class will call function to determine the final exception. */
	@Nonnull
	default <Y extends Exception> LongToDoubleFunctionX<Y> handle(ExceptionHandler<? super X, Y> handler) {
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return LongToDoubleFunctionX.wrapException(this, Exception.class, (ExceptionHandler) handler);
	}
