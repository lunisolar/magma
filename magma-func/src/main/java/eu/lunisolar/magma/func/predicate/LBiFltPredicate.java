...
public interface LBiFltPredicate extends MetaPredicate, MetaInterface.NonThrowing { // NOSONAR

	String DESCRIPTION = "LBiFltPredicate: boolean doTest(float a1,float a2)";

	// boolean doTest(float a1,float a2) ;
	default boolean doTest(float a1, float a2) {
	...
	/**
	 * Implement this, but call doTest(float a1,float a2)
	 */
	boolean doTestX(float a1, float a2) throws Throwable;
	...
	default boolean handlingDoTest(float a1, float a2, HandlingInstructions<Throwable, RuntimeException> handling) {
		try {
			return this.doTestX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default boolean tryDoTest(float a1, float a2, @Nonnull ExceptionWrapWithMessageFactory<RuntimeException> exceptionFactory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		try {
			return this.doTestX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default boolean tryDoTest(float a1, float a2, @Nonnull ExceptionWrapFactory<RuntimeException> exceptionFactory) {
		try {
			return this.doTestX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default boolean tryDoTestThen(float a1, float a2, @Nonnull LPredicate<Throwable> handler) {
		try {
			return this.doTestX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	static boolean handlingDoTest(float a1, float a2, LBiFltPredicate func, HandlingInstructions<Throwable, RuntimeException> handling) { // <-
		Null.nonNullArg(func, "func");
		return func.handlingDoTest(a1, a2, handling);
	}

	static boolean tryDoTest(float a1, float a2, LBiFltPredicate func) {
		return tryDoTest(a1, a2, func, null);
	}

	static boolean tryDoTest(float a1, float a2, LBiFltPredicate func, @Nonnull ExceptionWrapWithMessageFactory<RuntimeException> exceptionFactory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		Null.nonNullArg(func, "func");
		return func.tryDoTest(a1, a2, exceptionFactory, newMessage, messageParams);
	}

	static boolean tryDoTest(float a1, float a2, LBiFltPredicate func, @Nonnull ExceptionWrapFactory<RuntimeException> exceptionFactory) {
		Null.nonNullArg(func, "func");
		return func.tryDoTest(a1, a2, exceptionFactory);
	}

	static boolean tryDoTestThen(float a1, float a2, LBiFltPredicate func, @Nonnull LPredicate<Throwable> handler) {
		Null.nonNullArg(func, "func");
		return func.tryDoTestThen(a1, a2, handler);
	}

	default boolean failSafeDoTest(float a1, float a2, @Nonnull LBiFltPredicate failSafe) {
		try {
			return doTest(a1, a2);
		} catch (Throwable e) { // NOSONAR
			Handling.handleErrors(e);
	...
	static boolean failSafeDoTest(float a1, float a2, LBiFltPredicate func, @Nonnull LBiFltPredicate failSafe) {
	...
	static LBiFltPredicate failSafeBiFltPred(LBiFltPredicate func, @Nonnull LBiFltPredicate failSafe) {
		Null.nonNullArg(failSafe, "failSafe");
	...
	default boolean doIf(float a1, float a2, LBiFltConsumer consumer) {
		if (doTest(a1, a2)) {
	...
	static void throwIf(float a1, float a2, LBiFltPredicate pred, ExceptionWithMessageFactory<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		if (pred.doTest(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}

	static void throwIfNot(float a1, float a2, LBiFltPredicate pred, ExceptionWithMessageFactory<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		if (!pred.doTest(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}
	...
	/**  */
	public static LBiFltPredicate uncurryBiFltPred(LFltFunction<LFltPredicate> func) {
		return (float a1, float a2) -> func.doApply(a1).doTest(a2);
	}

	/** Captures arguments but delays the evaluation. */
	default LBoolSupplier captureBiFltPred(float a1, float a2) {
	...
	static LBiFltPredicate recursive(final @Nonnull LFunction<LBiFltPredicate, LBiFltPredicate> selfLambda) {
		...
		LBiFltPredicate func = selfLambda.doApply(single);
		single.target = func;
		return func;
	}
	...
	final class LBiFltPredicateSingle implements LSingle<LBiFltPredicate>, LBiFltPredicate {
		...
		@Override
		public boolean doTestX(float a1, float a2) throws Throwable {
	...
	@Nonnull
	static LBiFltPredicate biFltPredThrowing(final @Nonnull ExceptionFactory<Throwable> exceptionFactory) {
	...
	@Nonnull
	static LBiFltPredicate biFltPredThrowing(final String message, final @Nonnull ExceptionWithMessageFactory<Throwable> exceptionFactory) {
		Null.nonNullArg(exceptionFactory, "exceptionFactory");
		return (a1, a2) -> {
	...
	@Nonnull
	default LBiFltPredicate biFltPredComposeFlt(@Nonnull final LFltUnaryOperator before1, @Nonnull final LFltUnaryOperator before2) {
		Null.nonNullArg(before1, "before1");
		Null.nonNullArg(before2, "before2");
		return (v1, v2) -> this.doTest(before1.doApplyAsFlt(v1), before2.doApplyAsFlt(v2));
	}

	public static LBiFltPredicate composedFlt(@Nonnull final LFltUnaryOperator before1, @Nonnull final LFltUnaryOperator before2, LBiFltPredicate after) {
		return after.biFltPredComposeFlt(before1, before2);
	}
	...
	@Nonnull
	default LBiFltPredicate nestingBiFltPred() {
		return this;
	}

	/** Converts to non-throwing variant that will propagate checked exception as it would be unchecked - there is no exception wrapping involved (at least not here). */
	default LBiFltPredicate shovingBiFltPred() {
		return this;
	}
	...
	interface LFlt1Flt0Pred extends LBiFltPredicate {
		...
		boolean doTestFlt1Flt0(float a2, float a1);

		@Override
		default boolean doTestX(float a1, float a2) {
			return this.doTestFlt1Flt0(a2, a1);
		}
	}
	...
	// FILTER: FOR, [SourcePurpose{arg=float a1, type=IA}, SourcePurpose{arg=float a2, type=IA}, SourcePurpose{arg=LBiFltConsumer consumer, type=CONST}]
	default <C1, C2> void forEach(IndexedRead<C1, aFloat> ia1, C1 source1, IndexedRead<C2, aFloat> ia2, C2 source2, LBiFltConsumer consumer) {
	...
	// FILTER: WHILE, [SourcePurpose{arg=float a1, type=SA}, SourcePurpose{arg=float a2, type=IA}, SourcePurpose{arg=LBiFltConsumer consumer, type=CONST}]
	default <C1, I1, C2> void iterate(SequentialRead<C1, I1, aFloat> sa1, C1 source1, IndexedRead<C2, aFloat> ia2, C2 source2, LBiFltConsumer consumer) {
	...
	// FILTER: WHILE, [SourcePurpose{arg=float a1, type=IA}, SourcePurpose{arg=float a2, type=SA}, SourcePurpose{arg=LBiFltConsumer consumer, type=CONST}]
	default <C1, C2, I2> void iterate(IndexedRead<C1, aFloat> ia1, C1 source1, SequentialRead<C2, I2, aFloat> sa2, C2 source2, LBiFltConsumer consumer) {
		int size = ia1.size(source1);
		LOiToFltFunction<Object> oiFunc1 = (LOiToFltFunction) ia1.getter();
	...
	// FILTER: WHILE, [SourcePurpose{arg=float a1, type=SA}, SourcePurpose{arg=float a2, type=SA}, SourcePurpose{arg=LBiFltConsumer consumer, type=CONST}]
	default <C1, I1, C2, I2> void iterate(SequentialRead<C1, I1, aFloat> sa1, C1 source1, SequentialRead<C2, I2, aFloat> sa2, C2 source2, LBiFltConsumer consumer) {
		Object iterator1 = ((LFunction) sa1.adapter()).doApply(source1);
		LPredicate<Object> testFunc1 = (LPredicate) sa1.tester();
		LToFltFunction<Object> nextFunc1 = (LToFltFunction) sa1.getter();
		Object iterator2 = ((LFunction) sa2.adapter()).doApply(source2);
