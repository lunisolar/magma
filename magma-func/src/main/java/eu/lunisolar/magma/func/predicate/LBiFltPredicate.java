...
public interface LBiFltPredicate extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain2<aFloat, aFloat> { // NOSONAR
	...
	public static <X extends Throwable> float throwIf(float a1, float a2, @Nonnull LBiFltPredicate pred, @Nonnull ExMF<X> factory, LBiFltFunction<? extends String> msgFunc) throws X {
		if (pred.test(a1, a2)) {
	...
	/** Throws new exception if condition is met. */
	public static <X extends Throwable> float throwIfNot(float a1, float a2, @Nonnull LBiFltPredicate pred, @Nonnull ExMF<X> factory, LBiFltFunction<? extends String> msgFunc) throws X {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, msgFunc.apply(a1, a2), a1, a2);
		}
		return a1;
	...
	/** Throws new exception if condition is met. */
	public static <X extends Throwable> float throwIf(float a1, @Nonnull LBiFltPredicate pred, float a2, @Nonnull ExMF<X> factory, LBiFltFunction<? extends String> msgFunc) throws X {
		if (pred.test(a1, a2)) {
			throw Handling.create(factory, msgFunc.apply(a1, a2), a1, a2);
		}
		return a1;
	...
	/** Throws new exception if condition is met. */
	public static <X extends Throwable> float throwIfNot(float a1, @Nonnull LBiFltPredicate pred, float a2, @Nonnull ExMF<X> factory, LBiFltFunction<? extends String> msgFunc) throws X {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, msgFunc.apply(a1, a2), a1, a2);
		}
		return a1;
	...
	public static <X extends Throwable> float throwIfNot$(float a1, float a2, LBiFltFunction<? extends String> specialPredicate, @Nonnull ExMF<X> factory) throws X {
	...
	/** Throws new exception if condition is met. String is used as a result of test. Non NULL String means condition is not met and Strings content is used for exception message. */
	public static <X extends Throwable> float throwIfNot$(float a1, LBiFltFunction<? extends String> specialPredicate, float a2, @Nonnull ExMF<X> factory) throws X {
		var msg = specialPredicate.apply(a1, a2);
		if (msg != null) {
			throw Handling.create(factory, msg);
		}
