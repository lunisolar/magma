...
/**
 * Non-throwing functional interface (lambda) CharToShortFunction for Java 8.
 *
 * Type: function
 *
 * Domain (lvl: 1): char c
...
public interface CharToShortFunction extends CharToShortFunctionX<RuntimeException>, MetaFunction, PrimitiveCodomain<Object>, MetaInterface.NonThrowing { // NOSONAR
