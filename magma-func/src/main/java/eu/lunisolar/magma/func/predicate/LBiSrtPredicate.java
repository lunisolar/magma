...
public interface LBiSrtPredicate extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain2<aShort, aShort> { // NOSONAR
	...
	final class M implements LBiSrtPredicate {
		...
		public boolean currentTest(short a1, short a2) {
			boolean x1 = lastBaseValue;
	...
	public static boolean any(boolean expected, short a1, short a2, @Nonnull Collection<? extends LBiSrtPredicate> predicates) {
		return any(expected, a1, a2, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static boolean any(boolean expected, short a1, short a2, @Nonnull Stream<? extends LBiSrtPredicate> predicates) {
		return any(expected, a1, a2, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static boolean any(boolean expected, short a1, short a2, @Nonnull Iterator<? extends LBiSrtPredicate> predicates) {
		Null.nonNullArg(predicates, "predicates");
	...
	public static boolean any(boolean expected, short a1, short a2, @Nonnull LBiSrtPredicate... predicates) {
		Null.nonNullArg(predicates, "predicates");
	...
	default LBiSrtPredicate shoving() {

		return new LBiSrtPredicate() {

			public boolean test(short a1, short a2) {
				try {
					return this.testX(a1, a2);
				} catch (Throwable e) { // NOSONAR
					Handling.handleErrors(e);
			...
			public boolean testX(short a1, short a2) throws Throwable {
				return LBiSrtPredicate.this.testX(a1, a2);
			}
