...
public interface LBiSrtPredicate extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain2<aShort, aShort> { // NOSONAR
	 ...
	 */
	public static M memento(boolean initialValue, LBiSrtPredicate baseFunction, LLogicalBinaryOperator mementoFunction) {
		return new M(initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not ). Very short name is intended to be used with parent (LBiSrtPredicate.D)
	 */
	final class M implements LBiSrtPredicate {
		...
		private M(boolean lastValue, LBiSrtPredicate baseFunction, LLogicalBinaryOperator mementoFunction) {
