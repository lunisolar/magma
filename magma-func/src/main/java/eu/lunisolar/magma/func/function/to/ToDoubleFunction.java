...
public interface ToDoubleFunction<T> extends java.util.function.ToDoubleFunction<T>, ToDoubleFunctionX<T, RuntimeException>, MetaFunction, PrimitiveCodomain<Object>, MetaInterface.NonThrowing { // NOSONAR
