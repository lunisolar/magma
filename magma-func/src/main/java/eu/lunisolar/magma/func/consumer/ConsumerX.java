...
public interface ConsumerX<T, X extends Exception> extends MetaConsumer, MetaThrowingInterface<X> {
	...
	/** Wraps JRE instance. */
	@Nonnull
	public static <T, X extends Exception> ConsumerX<T, X> std(final java.util.function.Consumer<T> other) {
		return other::accept;
	}
