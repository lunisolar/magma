...
/**
 * Non-throwing functional interface (lambda) ObjByteConsumer for Java 8.
 *
 * Type: consumer
 *
...
public interface ObjByteConsumer<T> extends ObjByteConsumerX<T, RuntimeException>, MetaConsumer, MetaInterface.NonThrowing {
