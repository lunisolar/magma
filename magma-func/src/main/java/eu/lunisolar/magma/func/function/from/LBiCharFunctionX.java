...
public interface LBiCharFunctionX<R, X extends Throwable> extends MetaFunction, MetaInterface.Throwing<X> { // NOSONAR
	...
	String DESCRIPTION = "LBiCharFunctionX: R doApply(char a1,char a2) throws X";

	@Nullable
	R doApply(char a1, char a2) throws X;

	default R tupleApply(LCharPair args) throws X {
	...
	default R shovingDoApply(char a1, char a2) {
		return ((LBiCharFunctionX<R, RuntimeException>) this).doApply(a1, a2);
	}

	/** Function call that handles exceptions according to the instructions. */
	default <Y extends Throwable> R handlingDoApply(char a1, char a2, HandlingInstructions<Throwable, Y> handling) throws Y {
	...
	@Nonnull
	default R nonNullDoApply(char a1, char a2) throws X {
	...
	default LSupplierX<R, X> captureBiCharFunc(char a1, char a2) {
		return () -> this.doApply(a1, a2);
	}
	...
	@Nonnull
	static <R, X extends Throwable> LBiCharFunctionX<R, X> safe() {
		return Function4U::produce;
	}

	/** Safe instance supplier. Returns supplier of safe() instance. */
	@Nonnull
	static <R, X extends Throwable, Y extends Throwable> LSupplierX<LBiCharFunctionX<R, X>, Y> safeSupplier() {
		return () -> safe();
	}

	/** Safe wrapping. Either argument function is returned (if it is not null) or safe() instance. */
	@Nonnull
	static <R, X extends Throwable> LBiCharFunctionX<R, X> safe(final @Nullable LBiCharFunctionX<R, X> other) {
		if (other == null) {
			return safe();
		} else {
			return other;
	...
	@Nonnull
	static <R, X extends Throwable, Y extends Throwable> LSupplierX<LBiCharFunctionX<R, X>, Y> safeSupplier(final @Nullable LSupplierX<LBiCharFunctionX<R, X>, Y> supplier) {
		if (supplier == null) {
			return safeSupplier();
		} else {
			return supplier;
	...
	/** Permutation of LBiCharFunctionX for method references. */
	@FunctionalInterface
	interface V1<R, X extends Throwable> extends LBiCharFunctionX<R, X> {
		@Nullable
		R doApplyV1(char a2, char a1) throws X;

		@Override
		default R doApply(char a1, char a2) throws X {
