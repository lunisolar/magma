...
public interface LObjIntDblPredicate<T> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<a<T>, aInt, aDouble> { // NOSONAR
	...
	static <T> void throwIf(T a1, int a2, double a3, LObjIntDblPredicate<T> pred, ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		if (pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}

	static <T> void throwIfNot(T a1, int a2, double a3, LObjIntDblPredicate<T> pred, ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}
	...
	public static <M, K, V> boolean from(M container, LBiFunction<M, K, V> extractor, K key, int a2, double a3, LObjIntDblPredicate<V> function) {
	...
	/**  */
	public static <T> LObjIntDblPredicate<T> uncurry(LFunction<T, LIntFunction<LDblPredicate>> func) {
	...
	@Nonnull
	static <T> LObjIntDblPredicate<T> objIntDblPred(Class<T> c1, final @Nonnull LObjIntDblPredicate<T> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
