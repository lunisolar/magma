...
public interface LObjIntDblPredicate<T> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<a<T>, aInt, aDouble> { //NOSONAR
	...
	final class M<T> implements LObjIntDblPredicate<T> {
		...
		public boolean currentTest(T a1, int a2, double a3) {
			boolean x1 = lastBaseValue;
		...
		public boolean currentBaseValue(T a1, int a2, double a3) {
	...
	public static <T> boolean any(boolean expected, T a1, int a2, double a3, @Nonnull Collection<? extends LObjIntDblPredicate<? super T>> predicates) {
		return any(expected, a1, a2, a3, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static <T> boolean any(boolean expected, T a1, int a2, double a3, @Nonnull Stream<? extends LObjIntDblPredicate<? super T>> predicates) {
		return any(expected, a1, a2, a3, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static <T> boolean any(boolean expected, T a1, int a2, double a3, @Nonnull Iterator<? extends LObjIntDblPredicate<? super T>> predicates) {
		Null.nonNullArg(predicates, "predicates");
	...
	public static <T> boolean any(boolean expected, T a1, int a2, double a3, @Nonnull LObjIntDblPredicate<? super T>... predicates) {
		Null.nonNullArg(predicates, "predicates");
	...
	default LObjIntDblPredicate<T> shoving() {

		return new LObjIntDblPredicate<T>() {

			public boolean test(T a1, int a2, double a3) {
				try {
					return this.testX(a1, a2, a3);
				} catch (Throwable e) { // NOSONAR
					Handling.handleErrors(e);
			...
			public boolean testX(T a1, int a2, double a3) throws Throwable {
				return LObjIntDblPredicate.this.testX(a1, a2, a3);
			}
