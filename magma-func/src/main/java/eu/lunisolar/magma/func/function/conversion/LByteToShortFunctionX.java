...
public interface LByteToShortFunctionX<X extends Throwable> extends MetaFunction, MetaInterface.Throwing<X> { // NOSONAR
	...
	String DESCRIPTION = "LByteToShortFunctionX: short doApplyAsShort(byte a1) throws X";

	short doApplyAsShort(byte a1) throws X;
	...
	default short shovingDoApplyAsShort(byte a1) {
		return ((LByteToShortFunctionX<RuntimeException>) this).doApplyAsShort(a1);
	}

	/** Function call that handles exceptions according to the instructions. */
	default <Y extends Throwable> short handlingDoApplyAsShort(byte a1, HandlingInstructions<Throwable, Y> handling) throws Y {
	...
	default short nonNullDoApplyAsShort(byte a1) throws X {
	...
	default LShortSupplierX<X> captureByteToShortFunc(byte a1) {
		return () -> this.doApplyAsShort(a1);
	}
	...
	static <X extends Throwable> short call(byte a1, final @Nonnull LByteToShortFunctionX<X> lambda) throws X {
		Null.nonNullArg(lambda, "lambda");
		return lambda.doApplyAsShort(a1);
	}

	static <X extends Throwable> short shoving(byte a1, final @Nonnull LByteToShortFunctionX<X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.shovingDoApplyAsShort(a1);
	}

	static <X extends Throwable> short nesting(byte a1, final @Nonnull LByteToShortFunctionX<X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.nestingDoApplyAsShort(a1);
	}

	static <X extends Throwable, Y extends Throwable> short handling(byte a1, final HandlingInstructions<Throwable, Y> handling, final @Nonnull LByteToShortFunctionX<X> lambda) throws Y {
		Null.nonNullArg(lambda, "lambda");
