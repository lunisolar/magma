...
public interface LObjBoolPredicate<T> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain2<a<T>, aBool> { // NOSONAR
	...
	static <T> void throwIf(T a1, boolean a2, LObjBoolPredicate<T> pred, ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		if (pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}

	static <T> void throwIfNot(T a1, boolean a2, LObjBoolPredicate<T> pred, ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}
	...
	/**  */
	public static <T> LObjBoolPredicate<T> uncurry(LFunction<T, LLogicalOperator> func) {
	...
	@Nonnull
	static <T> LObjBoolPredicate<T> objBoolPred(Class<T> c1, final @Nonnull LObjBoolPredicate<T> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
