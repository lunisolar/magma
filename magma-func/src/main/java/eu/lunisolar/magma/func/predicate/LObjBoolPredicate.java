...
public interface LObjBoolPredicate<T> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain2<a<T>, aBool> { // NOSONAR
	...
	public default <V> boolean doIf(V a1, T a2, boolean a3, @Nonnull LBiObjBoolConsumer<V, ? super T> consumer) {
		Null.nonNullArg(consumer, "consumer");
		if (test(a2, a3)) {
	...
	public default LLogicalOperator lShrink(@Nonnull LBoolFunction<T> left) {
		Null.nonNullArg(left, "left");
		return a2 -> test(left.apply(a2), a2);
	}

	public default LLogicalOperator lShrink_(T a1) {
	...
	public default LPredicate<T> rShrink(@Nonnull LPredicate<T> right) {
		Null.nonNullArg(right, "right");
		return a1 -> test(a1, right.test(a1));
	}

	public default LPredicate<T> rShrink_(boolean a2) {
	...
	public default LObjBoolPredicate untyped() {
		return this;
	}

	/** Cast that replace generics. */
	public default <V2> LObjBoolPredicate<V2> cast() {
		return untyped();
	}
	...
	public default LObjBoolPredicate<T> beforeDo(@Nonnull LObjBoolConsumer<T> before) {
	...
	public default LObjBoolPredicate<T> afterDo(@Nonnull LBoolConsumer after) {
	...
	public static <T> T throwIf(T a1, boolean a2, @Nonnull LObjBoolPredicate<T> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (pred.test(a1, a2)) {
	...
	/** Throws new exception if condition is met. */
	public static <T> T throwIf(T a1, @Nonnull LObjBoolPredicate<T> pred, boolean a2, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	public static <T> T throwIfNot(T a1, boolean a2, @Nonnull LObjBoolPredicate<T> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <T> T throwIfNot(T a1, @Nonnull LObjBoolPredicate<T> pred, boolean a2, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	/** Throws new exception if condition is met. */
	public static <T> T throwIf(T a1, boolean a2, @Nonnull LObjBoolPredicate<T> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage) {
		if (pred.test(a1, a2)) {
	...
	/** Throws new exception if condition is met. */
	public static <T> T throwIf(T a1, @Nonnull LObjBoolPredicate<T> pred, boolean a2, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage) {
		if (pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <T> T throwIfNot(T a1, boolean a2, @Nonnull LObjBoolPredicate<T> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage) {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <T> T throwIfNot(T a1, @Nonnull LObjBoolPredicate<T> pred, boolean a2, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage) {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
