...
public interface LObjBoolPredicate<T> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain2<a<T>, aBool> { // NOSONAR
	...
	default LLogicalOperator _with(T a1) {
		return a2 -> test(a1, a2);
	}

	default LPredicate<T> with(boolean a2) {
	...
	final class M<T> implements LObjBoolPredicate<T> {
		...
		public boolean currentTest(T a1, boolean a2) {
			boolean x1 = lastBaseValue;
		...
		public boolean currentBaseValue(T a1, boolean a2) {
	...
	public static <T> boolean any(boolean expected, T a1, boolean a2, @Nonnull Collection<? extends LObjBoolPredicate<? super T>> predicates) {
		return any(expected, a1, a2, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static <T> boolean any(boolean expected, T a1, boolean a2, @Nonnull Stream<? extends LObjBoolPredicate<? super T>> predicates) {
		return any(expected, a1, a2, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static <T> boolean any(boolean expected, T a1, boolean a2, @Nonnull Iterator<? extends LObjBoolPredicate<? super T>> predicates) {
		Null.nonNullArg(predicates, "predicates");
	...
	public static <T> boolean any(boolean expected, T a1, boolean a2, @Nonnull LObjBoolPredicate<? super T>... predicates) {
		Null.nonNullArg(predicates, "predicates");
	...
	default LObjBoolPredicate<T> shoving() {

		return new LObjBoolPredicate<T>() {

			public boolean test(T a1, boolean a2) {
				try {
					return this.testX(a1, a2);
				} catch (Throwable e) { // NOSONAR
					Handling.handleErrors(e);
			...
			public boolean testX(T a1, boolean a2) throws Throwable {
				return LObjBoolPredicate.this.testX(a1, a2);
			}
