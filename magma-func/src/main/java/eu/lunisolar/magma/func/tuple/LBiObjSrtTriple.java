...
public interface LBiObjSrtTriple<T1,T2> extends LTuple<Object> 
  ...
  public static <T1 extends Comparable<? super T1>,T2 extends Comparable<? super T2>> MutCompBiObjSrtTriple<T1,T2> comparableOf() { 
      return comparableOf(  null ,  null ,  (short)0 );
  }
      

  public static <T1 extends Comparable<? super T1>,T2 extends Comparable<? super T2>> MutCompBiObjSrtTriple<T1,T2> comparableOf(T1 a1,T2 a2,short a3){
        return new MutCompBiObjSrtTriple(a1,a2,a3);
  }

  public static <T1 extends Comparable<? super T1>,T2 extends Comparable<? super T2>> MutCompBiObjSrtTriple<T1,T2> comparableCopyOf(LBiObjSrtTriple<T1,T2> tuple) {
    ...
    final  class  MutCompBiObjSrtTriple<T1 extends Comparable<? super T1>,T2 extends Comparable<? super T2>>  extends AbstractBiObjSrtTriple<T1,T2> implements ComparableBiObjSrtTriple<T1,T2>,Mut<T1,T2,MutCompBiObjSrtTriple<T1,T2>>   {
        ...
        public @Override MutCompBiObjSrtTriple<T1,T2> first(T1 first)    {
            this.first = first;
            return this;
        }
        ...
        public @Override MutCompBiObjSrtTriple<T1,T2> second(T2 second)    {
            this.second = second;
            return this;
        }
        ...
        public @Override MutCompBiObjSrtTriple<T1,T2> third(short third)    {
            this.third = third;
            return this;
        }
  ...
  public static <T1,T2> ImmBiObjSrtTriple<T1,T2> immutableOf(T1 a1,T2 a2,short a3){
        return new ImmBiObjSrtTriple(a1,a2,a3);
  }

  public static <T1,T2> ImmBiObjSrtTriple<T1,T2> immutableCopyOf(LBiObjSrtTriple<T1,T2> tuple) {
...
@Immutable
  ...
  public static <T1 extends Comparable<? super T1>,T2 extends Comparable<? super T2>> ImmCompBiObjSrtTriple<T1,T2> immutableComparableOf(T1 a1,T2 a2,short a3){
        return new ImmCompBiObjSrtTriple(a1,a2,a3);
  }

  public static <T1 extends Comparable<? super T1>,T2 extends Comparable<? super T2>> ImmCompBiObjSrtTriple<T1,T2> immutableComparableCopyOf(LBiObjSrtTriple<T1,T2> tuple) {
