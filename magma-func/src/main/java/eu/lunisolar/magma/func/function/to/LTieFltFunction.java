...
public interface LTieFltFunction<T> extends MetaFunction, MetaInterface.NonThrowing, TieFunction<T, aFloat>, Codomain<aInt>, Domain3<a<T>, aInt, aFloat> { // NOSONAR
	...
	default int applyAsInt(T a1, int a2, float a3, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage) {
		try {
			return this.applyAsIntX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default int applyAsInt(T a1, int a2, float a3, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1) {
		try {
			return this.applyAsIntX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default int applyAsInt(T a1, int a2, float a3, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		try {
			return this.applyAsIntX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default int applyAsInt(T a1, int a2, float a3, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		try {
			return this.applyAsIntX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LTieFltFunction<T> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage) {
		return (a1, a2, a3) -> applyAsInt(a1, a2, a3, factory, newMessage);
	}

	default LTieFltFunction<T> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1) {
		return (a1, a2, a3) -> applyAsInt(a1, a2, a3, factory, newMessage, param1);
	}

	default LTieFltFunction<T> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		return (a1, a2, a3) -> applyAsInt(a1, a2, a3, factory, newMessage, param1, param1);
	}

	default LTieFltFunction<T> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		return (a1, a2, a3) -> applyAsInt(a1, a2, a3, factory, newMessage, param1, param2, param3);
	}

	default int applyAsInt(T a1, int a2, float a3, @Nonnull ExWF<RuntimeException> factory) {
		try {
			return this.applyAsIntX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LTieFltFunction<T> trying(@Nonnull ExWF<RuntimeException> factory) {
	...
	static <T> int tryApplyAsInt(T a1, int a2, float a3, LTieFltFunction<T> func) {
		Null.nonNullArg(func, "func");
		return func.nestingApplyAsInt(a1, a2, a3);
	}

	static <T> int tryApplyAsInt(T a1, int a2, float a3, LTieFltFunction<T> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage) {
		Null.nonNullArg(func, "func");
		return func.applyAsInt(a1, a2, a3, factory, newMessage);
	}

	static <T> int tryApplyAsInt(T a1, int a2, float a3, LTieFltFunction<T> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1) {
		Null.nonNullArg(func, "func");
		return func.applyAsInt(a1, a2, a3, factory, newMessage, param1);
	}

	static <T> int tryApplyAsInt(T a1, int a2, float a3, LTieFltFunction<T> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		Null.nonNullArg(func, "func");
		return func.applyAsInt(a1, a2, a3, factory, newMessage, param1, param2);
	}

	static <T> int tryApplyAsInt(T a1, int a2, float a3, LTieFltFunction<T> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		Null.nonNullArg(func, "func");
		return func.applyAsInt(a1, a2, a3, factory, newMessage, param1, param2, param3);
	}

	static <T> int tryApplyAsInt(T a1, int a2, float a3, LTieFltFunction<T> func, @Nonnull ExWF<RuntimeException> factory) {
		Null.nonNullArg(func, "func");
		return func.applyAsInt(a1, a2, a3, factory);
	}

	static <T> int tryApplyAsIntThen(T a1, int a2, float a3, LTieFltFunction<T> func, @Nonnull LToIntFunction<Throwable> handler) {
		Null.nonNullArg(func, "func");
	...
	static <T> int failSafeApplyAsInt(T a1, int a2, float a3, LTieFltFunction<T> func, @Nonnull LTieFltFunction<T> failSafe) {
	...
	default LOiToIntFunction<T> rShrink(@Nonnull LOiToFltFunction<T> right) {
		Null.nonNullArg(right, "right");
		return (a1, a2) -> applyAsInt(a1, a2, right.applyAsFlt(a1, a2));
	}

	default LOiToIntFunction<T> rShrink_(float a3) {
	...
	/** Cast that replace generics. */
	public static <V2> LTieFltFunction<V2> cast(LTieFltFunction<?> function) {
	...
	default LTieFltFunction<T> beforeDo(@Nonnull LTieFltConsumer<T> before) {
	...
	default LTieFltFunction<T> afterDo(@Nonnull LIntConsumer after) {
	...
	public static <T> M<T> memento(int initialBaseValue, int initialValue, LTieFltFunction<T> baseFunction, LIntTernaryOperator mementoFunction) {
		return new M(initialBaseValue, initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not confuse it with math concepts). Very short name is intended to be used with parent (LTieFltFunction.M)
	 */
	@NotThreadSafe
	final class M<T> implements LTieFltFunction<T> {
		...
		private M(int lastBaseValue, int lastValue, LTieFltFunction<T> baseFunction, LIntTernaryOperator mementoFunction) {
	...
	@Nonnull
	static <T> LTieFltFunction<T> tieFltFuncThrowing(final @Nonnull ExF<Throwable> exF) {
	...
	@Nonnull
	static <T> LTieFltFunction<T> tieFltFuncThrowing(final String message, final @Nonnull ExMF<Throwable> exF) {
		Null.nonNullArg(exF, "exF");
		return (a1, a2, a3) -> {
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T> LTieFltFunction.LObjFltIntToIntFunc<T> objFltIntToIntFunc(final @Nonnull LTieFltFunction.LObjFltIntToIntFunc<T> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T> LTieFltFunction.LIntObjFltToIntFunc<T> intObjFltToIntFunc(final @Nonnull LTieFltFunction.LIntObjFltToIntFunc<T> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T> LTieFltFunction.LIntFltObjToIntFunc<T> intFltObjToIntFunc(final @Nonnull LTieFltFunction.LIntFltObjToIntFunc<T> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T> LTieFltFunction.LFltObjIntToIntFunc<T> fltObjIntToIntFunc(final @Nonnull LTieFltFunction.LFltObjIntToIntFunc<T> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T> LTieFltFunction.LFltIntObjToIntFunc<T> fltIntObjToIntFunc(final @Nonnull LTieFltFunction.LFltIntObjToIntFunc<T> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	static <T> LTieFltFunction<T> safe() {
		return LTieFltFunction::doNothing;
	}
	...
	@Nonnull
	default <V1> LTieFltFunction<V1> compose(@Nonnull final LFunction<? super V1, ? extends T> before1, @Nonnull final LIntUnaryOperator before2, @Nonnull final LFltUnaryOperator before3) {
	...
	public static <V1, T> LTieFltFunction<V1> composed(@Nonnull final LFunction<? super V1, ? extends T> before1, @Nonnull final LIntUnaryOperator before2, @Nonnull final LFltUnaryOperator before3, LTieFltFunction<T> after) {
	...
	interface LObjFltIntToIntFunc<T> extends LTieFltFunction<T> {
		...
		default int applyAsIntObjFltInt(T a1, float a3, int a2) {
			// return nestingApplyAsIntObjFltInt(a1,a3,a2);
			try {
				return this.applyAsIntObjFltIntX(a1, a3, a2);
			} catch (Throwable e) { // NOSONAR
				throw Handling.nestCheckedAndThrow(e);
			}
		}
		...
		/**
		 * Implement this, but call applyAsIntObjFltInt(T a1,float a3,int a2)
		 */
		int applyAsIntObjFltIntX(T a1, float a3, int a2) throws Throwable;
	}
	...
	interface LIntObjFltToIntFunc<T> extends LTieFltFunction<T> {
		...
		default int applyAsIntIntObjFlt(int a2, T a1, float a3) {
			// return nestingApplyAsIntIntObjFlt(a2,a1,a3);
			try {
				return this.applyAsIntIntObjFltX(a2, a1, a3);
			} catch (Throwable e) { // NOSONAR
				throw Handling.nestCheckedAndThrow(e);
			}
		}
		...
		/**
		 * Implement this, but call applyAsIntIntObjFlt(int a2,T a1,float a3)
		 */
		int applyAsIntIntObjFltX(int a2, T a1, float a3) throws Throwable;
	}
	...
	interface LIntFltObjToIntFunc<T> extends LTieFltFunction<T> {
		...
		default int applyAsIntIntFltObj(int a2, float a3, T a1) {
			// return nestingApplyAsIntIntFltObj(a2,a3,a1);
			try {
				return this.applyAsIntIntFltObjX(a2, a3, a1);
			} catch (Throwable e) { // NOSONAR
				throw Handling.nestCheckedAndThrow(e);
			}
		}
		...
		/**
		 * Implement this, but call applyAsIntIntFltObj(int a2,float a3,T a1)
		 */
		int applyAsIntIntFltObjX(int a2, float a3, T a1) throws Throwable;
	}
	...
	interface LFltObjIntToIntFunc<T> extends LTieFltFunction<T> {
		...
		default int applyAsIntFltObjInt(float a3, T a1, int a2) {
			// return nestingApplyAsIntFltObjInt(a3,a1,a2);
			try {
				return this.applyAsIntFltObjIntX(a3, a1, a2);
			} catch (Throwable e) { // NOSONAR
				throw Handling.nestCheckedAndThrow(e);
			}
		}
		...
		/**
		 * Implement this, but call applyAsIntFltObjInt(float a3,T a1,int a2)
		 */
		int applyAsIntFltObjIntX(float a3, T a1, int a2) throws Throwable;
	}
	...
	interface LFltIntObjToIntFunc<T> extends LTieFltFunction<T> {
		...
		default int applyAsIntFltIntObj(float a3, int a2, T a1) {
			// return nestingApplyAsIntFltIntObj(a3,a2,a1);
			try {
				return this.applyAsIntFltIntObjX(a3, a2, a1);
			} catch (Throwable e) { // NOSONAR
				throw Handling.nestCheckedAndThrow(e);
			}
		}
		...
		/**
		 * Implement this, but call applyAsIntFltIntObj(float a3,int a2,T a1)
		 */
		int applyAsIntFltIntObjX(float a3, int a2, T a1) throws Throwable;
	}

	// </editor-fold>

	/** Does nothing (LTieFltFunction) Function */
	public static <T> int doNothing(T a1, int a2, float a3) {
		return Function4U.defaultInteger;
	}

	/** Does nothing (LTieFltFunction.LObjFltIntToIntFunc) Function */
	public static <T> int doNothing(T a1, float a3, int a2) {
		return Function4U.defaultInteger;
	}

	/** Does nothing (LTieFltFunction.LIntObjFltToIntFunc) Function */
	public static <T> int doNothing(int a2, T a1, float a3) {
		return Function4U.defaultInteger;
	}

	/** Does nothing (LTieFltFunction.LIntFltObjToIntFunc) Function */
	public static <T> int doNothing(int a2, float a3, T a1) {
		return Function4U.defaultInteger;
	}

	/** Does nothing (LTieFltFunction.LFltObjIntToIntFunc) Function */
	public static <T> int doNothing(float a3, T a1, int a2) {
		return Function4U.defaultInteger;
	}

	/** Does nothing (LTieFltFunction.LFltIntObjToIntFunc) Function */
	public static <T> int doNothing(float a3, int a2, T a1) {
		return Function4U.defaultInteger;
	}
	...
	default <SRC> int genericTieForEach(int sStart, int tStart, T trg1, SRC src3, OFunction<SRC, aBool> srcTest3, OFunction<SRC, aFloat> srcAcc3) {
