...
public interface LObjIntObjFunction<T1, T2, R> extends MetaFunction, MetaInterface.NonThrowing, Codomain<a<R>>, Domain3<a<T1>, aInt, a<T2>> { // NOSONAR
	...
	default R apply(T1 a1, int a2, T2 a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default R apply(T1 a1, int a2, T2 a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default R apply(T1 a1, int a2, T2 a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default R apply(T1 a1, int a2, T2 a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LObjIntObjFunction<T1, T2, R> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		return (a1, a2, a3) -> apply(a1, a2, a3, exF, newMessage);
	}

	default LObjIntObjFunction<T1, T2, R> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		return (a1, a2, a3) -> apply(a1, a2, a3, exF, newMessage, param1);
	}

	default LObjIntObjFunction<T1, T2, R> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		return (a1, a2, a3) -> apply(a1, a2, a3, exF, newMessage, param1, param1);
	}

	default LObjIntObjFunction<T1, T2, R> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
	...
	static <T1, T2, R> R tryApply(T1 a1, int a2, T2 a3, LObjIntObjFunction<T1, T2, R> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, a3, exF, newMessage);
	}

	static <T1, T2, R> R tryApply(T1 a1, int a2, T2 a3, LObjIntObjFunction<T1, T2, R> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, a3, exF, newMessage, param1);
	}

	static <T1, T2, R> R tryApply(T1 a1, int a2, T2 a3, LObjIntObjFunction<T1, T2, R> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, a3, exF, newMessage, param1, param2);
	}

	static <T1, T2, R> R tryApply(T1 a1, int a2, T2 a3, LObjIntObjFunction<T1, T2, R> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		Null.nonNullArg(func, "func");
	 ...
	 */
	public static <T1, T2, R> M<T1, T2, R> memento(R initialValue, LObjIntObjFunction<T1, T2, R> baseFunction, LBinaryOperator<R> mementoFunction) {
		return new M(initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not ). Very short name is intended to be used with parent (LObjIntObjFunction.D)
	 */
	final class M<T1, T2, R> implements LObjIntObjFunction<T1, T2, R> {
		...
		private M(R lastValue, LObjIntObjFunction<T1, T2, R> baseFunction, LBinaryOperator<R> mementoFunction) {
	...
	static <T1, T2, R> LObjIntObjFunction<T1, T2, R> safe() {
		return LObjIntObjFunction::doNothing;
	}
