...
public interface LDblIntPredicate extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain2<aDouble, aInt> { // NOSONAR
	 ...
	 */
	public static M memento(boolean initialValue, LDblIntPredicate baseFunction, LLogicalBinaryOperator mementoFunction) {
		return new M(initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not ). Very short name is intended to be used with parent (LDblIntPredicate.D)
	 */
	final class M implements LDblIntPredicate {
		...
		private M(boolean lastValue, LDblIntPredicate baseFunction, LLogicalBinaryOperator mementoFunction) {
