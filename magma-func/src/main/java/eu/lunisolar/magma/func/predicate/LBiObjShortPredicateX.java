...
public interface LBiObjShortPredicateX<T1, T2, X extends Throwable> extends MetaPredicate, MetaInterface.Throwing<X> { // NOSONAR
	 ...
	 */
	@Nonnull
	static <T1, T2, X extends Throwable> LBiObjShortPredicateX<T1, T2, X> isEqual(final T1 v1, final T2 v2, final short v3) {
	...
	interface V1<T1, T2, X extends Throwable> extends LBiObjShortPredicateX<T1, T2, X> {
		...
		boolean apply1(T1 a1, short a3, T2 a2) throws X;
	...
	/** Permutation of LBiObjShortPredicateX for method references. */
	@FunctionalInterface
	interface V2<T1, T2, X extends Throwable> extends LBiObjShortPredicateX<T1, T2, X> {

		boolean apply2(T2 a2, T1 a1, short a3) throws X;
	...
	/** Permutation of LBiObjShortPredicateX for method references. */
	@FunctionalInterface
	interface V3<T1, T2, X extends Throwable> extends LBiObjShortPredicateX<T1, T2, X> {

		boolean apply3(T2 a2, short a3, T1 a1) throws X;
	...
	interface V4<T1, T2, X extends Throwable> extends LBiObjShortPredicateX<T1, T2, X> {
		...
		boolean apply4(short a3, T1 a1, T2 a2) throws X;
	...
	/** Permutation of LBiObjShortPredicateX for method references. */
	@FunctionalInterface
	interface V5<T1, T2, X extends Throwable> extends LBiObjShortPredicateX<T1, T2, X> {

		boolean apply5(short a3, T2 a2, T1 a1) throws X;
