...
public interface LBiObjShortPredicateX<T1, T2, X extends Throwable> extends MetaPredicate, MetaInterface.Throwing<X> { // NOSONAR

	String DESCRIPTION = "LBiObjShortPredicateX: boolean doTest(T1 a1,T2 a2,short a3) throws X";

	boolean doTest(T1 a1, T2 a2, short a3) throws X;

	default boolean tupleTest(LBiObjShortTriple<T1, T2> args) throws X {
	...
	default boolean shovingDoTest(T1 a1, T2 a2, short a3) {
		return ((LBiObjShortPredicateX<T1, T2, RuntimeException>) this).doTest(a1, a2, a3);
	}

	/** Function call that handles exceptions according to the instructions. */
	default <Y extends Throwable> boolean handlingDoTest(T1 a1, T2 a2, short a3, HandlingInstructions<Throwable, Y> handling) throws Y {
	...
	default boolean nonNullDoTest(T1 a1, T2 a2, short a3) throws X {
		return doTest(a1, a2, a3);
	}

	/** For convenience, where "test()" makes things more confusing than "applyAsBoolean()". */

	default boolean doApplyAsBoolean(T1 a1, T2 a2, short a3) throws X {
		return doTest(a1, a2, a3);
	}
	...
	default LBoolSupplierX<X> captureBiObjShortPred(T1 a1, T2 a2, short a3) {
		return () -> this.doTest(a1, a2, a3);
	}

	/** Creates function that always returns the same value. */
	static <T1, T2, X extends Throwable> LBiObjShortPredicateX<T1, T2, X> constant(boolean r) {
		return (a1, a2, a3) -> r;
	}

	/** Captures single parameter function into this interface where only 1st parameter will be used. */
	@Nonnull
	static <T1, T2, X extends Throwable> LBiObjShortPredicateX<T1, T2, X> test1st(@Nonnull LPredicateX<T1, X> func) {
		return (a1, a2, a3) -> func.doTest(a1);
	}

	/** Captures single parameter function into this interface where only 2nd parameter will be used. */
	@Nonnull
	static <T1, T2, X extends Throwable> LBiObjShortPredicateX<T1, T2, X> test2nd(@Nonnull LPredicateX<T2, X> func) {
		return (a1, a2, a3) -> func.doTest(a2);
	}

	/** Captures single parameter function into this interface where only 3rd parameter will be used. */
	@Nonnull
	static <T1, T2, X extends Throwable> LBiObjShortPredicateX<T1, T2, X> test3rd(@Nonnull LShortPredicateX<X> func) {
		return (a1, a2, a3) -> func.doTest(a3);
	}

	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2, X extends Throwable> LBiObjShortPredicateX<T1, T2, X> lX(final @Nonnull LBiObjShortPredicateX<T1, T2, X> lambda) {
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2, X extends Throwable> LBiObjShortPredicateX<T1, T2, X> lX(@Nonnull Class<X> xClass, final @Nonnull LBiObjShortPredicateX<T1, T2, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	@Nonnull
	static <T1, T2, X extends Throwable> LBiObjShortPredicateX<T1, T2, X> wrapX(final @Nonnull LBiObjShortPredicate<T1, T2> other) {
	...
	@Nonnull
	static <T1, T2, X extends Throwable> LBiObjShortPredicateX<T1, T2, X> safe() {
		return Function4U::alwaysFalse;
	}

	/** Safe instance supplier. Returns supplier of safe() instance. */
	@Nonnull
	static <T1, T2, X extends Throwable, Y extends Throwable> LSupplierX<LBiObjShortPredicateX<T1, T2, X>, Y> safeSupplier() {
		return () -> safe();
	}

	/** Safe wrapping. Either argument function is returned (if it is not null) or safe() instance. */
	@Nonnull
	static <T1, T2, X extends Throwable> LBiObjShortPredicateX<T1, T2, X> safe(final @Nullable LBiObjShortPredicateX<T1, T2, X> other) {
		if (other == null) {
			return safe();
		} else {
			return other;
	...
	@Nonnull
	static <T1, T2, X extends Throwable, Y extends Throwable> LSupplierX<LBiObjShortPredicateX<T1, T2, X>, Y> safeSupplier(final @Nullable LSupplierX<LBiObjShortPredicateX<T1, T2, X>, Y> supplier) {
		if (supplier == null) {
			return safeSupplier();
		} else {
			return supplier;
	 ...
	 */
	@Nonnull
	static <T1, T2, X extends Throwable> LBiObjShortPredicateX<T1, T2, X> isEqual(T1 v1, T2 v2, short v3) {
		return (T1 a1, T2 a2, short a3) -> (a1 == null ? v1 == null : a1.equals(v1)) && (a2 == null ? v2 == null : a2.equals(v2)) && (a3 == v3);
	}
	...
	@Nonnull
	default <V1, V2> LBiObjShortPredicateX<V1, V2, X> biObjShortPredComposeShort(@Nonnull final LFunctionX<? super V1, ? extends T1, X> before1, @Nonnull final LFunctionX<? super V2, ? extends T2, X> before2, @Nonnull final LShortUnaryOperatorX<X> before3) {
	...
	/** Allows to manipulate the domain of the function. */
	@Nonnull
	default <V1, V2, V3> LTriPredicateX<V1, V2, V3, X> biObjShortPredCompose(@Nonnull final LFunctionX<? super V1, ? extends T1, X> before1, @Nonnull final LFunctionX<? super V2, ? extends T2, X> before2,
	...
	/** Permutation of LBiObjShortPredicateX for method references. */
	@FunctionalInterface
	interface V1<T1, T2, X extends Throwable> extends LBiObjShortPredicateX<T1, T2, X> {

		boolean doTestV1(T1 a1, short a3, T2 a2) throws X;

		@Override
		default boolean doTest(T1 a1, T2 a2, short a3) throws X {
	...
	/** Permutation of LBiObjShortPredicateX for method references. */
	@FunctionalInterface
	interface V2<T2, T1, X extends Throwable> extends LBiObjShortPredicateX<T1, T2, X> {

		boolean doTestV2(T2 a2, T1 a1, short a3) throws X;
	...
	/** Permutation of LBiObjShortPredicateX for method references. */
	@FunctionalInterface
	interface V3<T2, T1, X extends Throwable> extends LBiObjShortPredicateX<T1, T2, X> {

		boolean doTestV3(T2 a2, short a3, T1 a1) throws X;
	...
	/** Permutation of LBiObjShortPredicateX for method references. */
	@FunctionalInterface
	interface V4<T1, T2, X extends Throwable> extends LBiObjShortPredicateX<T1, T2, X> {

		boolean doTestV4(short a3, T1 a1, T2 a2) throws X;
	...
	/** Permutation of LBiObjShortPredicateX for method references. */
	@FunctionalInterface
	interface V5<T2, T1, X extends Throwable> extends LBiObjShortPredicateX<T1, T2, X> {

		boolean doTestV5(short a3, T2 a2, T1 a1) throws X;
