...
public interface LTriFunction<T1, T2, T3, R> extends MetaFunction, MetaInterface.NonThrowing, Codomain<a<R>>, Domain3<a<T1>, a<T2>, a<T3>> { // NOSONAR
	 ...
	 */
	R applyX(T1 a1, T2 a2, T3 a3) throws Throwable;
	...
	default LTriFunction<T1, T2, T3, R> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage) {
		return (a1, a2, a3) -> apply(a1, a2, a3, factory, newMessage);
	}

	default LTriFunction<T1, T2, T3, R> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1) {
		return (a1, a2, a3) -> apply(a1, a2, a3, factory, newMessage, param1);
	}

	default LTriFunction<T1, T2, T3, R> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		return (a1, a2, a3) -> apply(a1, a2, a3, factory, newMessage, param1, param1);
	}

	default LTriFunction<T1, T2, T3, R> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
	...
	default LTriFunction<T1, T2, T3, R> trying(@Nonnull ExWF<RuntimeException> factory) {
	...
	default LTriFunction<T1, T2, T3, R> tryingThen(@Nonnull LFunction<Throwable, R> handler) {
		return (a1, a2, a3) -> applyThen(a1, a2, a3, handler);
	}

	/** Function call that handles exceptions by always nesting checked exceptions and propagating the others as is. */
	default R nestingApply(T1 a1, T2 a2, T3 a3) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
			throw Handling.nestCheckedAndThrow(e);
	...
	static <T1, T2, T3, R> R tryApply(T1 a1, T2 a2, T3 a3, LTriFunction<T1, T2, T3, R> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, a3, factory, newMessage);
	}

	static <T1, T2, T3, R> R tryApply(T1 a1, T2 a2, T3 a3, LTriFunction<T1, T2, T3, R> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, a3, factory, newMessage, param1);
	}

	static <T1, T2, T3, R> R tryApply(T1 a1, T2 a2, T3 a3, LTriFunction<T1, T2, T3, R> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, a3, factory, newMessage, param1, param2);
	}

	static <T1, T2, T3, R> R tryApply(T1 a1, T2 a2, T3 a3, LTriFunction<T1, T2, T3, R> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, a3, factory, newMessage, param1, param2, param3);
	}

	static <T1, T2, T3, R> R tryApply(T1 a1, T2 a2, T3 a3, LTriFunction<T1, T2, T3, R> func, @Nonnull ExWF<RuntimeException> factory) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, a3, factory);
	}

	static <T1, T2, T3, R> R tryApplyThen(T1 a1, T2 a2, T3 a3, LTriFunction<T1, T2, T3, R> func, @Nonnull LFunction<Throwable, R> handler) {
		Null.nonNullArg(func, "func");
		return func.applyThen(a1, a2, a3, handler);
	}

	default R failSafeApply(T1 a1, T2 a2, T3 a3, @Nonnull LTriFunction<T1, T2, T3, R> failSafe) {
		try {
	...
	static <T1, T2, T3, R> R failSafeApply(T1 a1, T2 a2, T3 a3, LTriFunction<T1, T2, T3, R> func, @Nonnull LTriFunction<T1, T2, T3, R> failSafe) {
	...
	static <T1, T2, T3, R> LTriFunction<T1, T2, T3, R> failSafe(LTriFunction<T1, T2, T3, R> func, @Nonnull LTriFunction<T1, T2, T3, R> failSafe) {
		Null.nonNullArg(failSafe, "failSafe");
	...
	@Nonnull
	default R nonNullApply(T1 a1, T2 a2, T3 a3) {
	...
	public static <T1, T2, T3, R> void fromTo(int min_i, int max_i, T1 a1, T2 a2, T3 a3, @Nonnull LTriFunction<T1, T2, T3, R> func) {
		Null.nonNullArg(func, "func");
		if (min_i <= max_i) {
	...
	/** From-To. Intended to be used with non-capturing lambda. */
	public static <T1, T2, T3, R> void fromTill(int min_i, int max_i, T1 a1, T2 a2, T3 a3, @Nonnull LTriFunction<T1, T2, T3, R> func) {
		Null.nonNullArg(func, "func");
		if (min_i <= max_i) {
			for (int i = min_i; i < max_i; i++) {
				func.apply(a1, a2, a3);
	...
	/** From-To. Intended to be used with non-capturing lambda. */
	public static <T1, T2, T3, R> void times(int max_i, T1 a1, T2 a2, T3 a3, @Nonnull LTriFunction<T1, T2, T3, R> func) {
		if (max_i < 0)
			return;
	...
	public static <R, M, K, V, T2, T3> R from(@Nonnull M container, LBiFunction<M, K, V> extractor, K key, T2 a2, T3 a3, @Nonnull LTriFunction<V, T2, T3, R> function) {
	...
	default @Nonnull LTriFunction<T1, T2, T3, R> wrapWith(@Nonnull CallContext ctx) {
		Null.nonNullArg(ctx, "ctx");
		return (a1, a2, a3) -> applyX(ctx, a1, a2, a3, this);
	}

	static <T1, T2, T3, R> R applyX(@Nonnull CallContext ctx, T1 a1, T2 a2, T3 a3, @Nonnull LTriFunction<T1, T2, T3, R> function) throws Throwable {
		Null.nonNullArg(ctx, "ctx");
		Null.nonNullArg(function, "function");
		return (R) ctx.call(() -> function.applyX(a1, a2, a3));
	}

	static <T1, T2, T3, R> R nestingApply(@Nonnull CallContext ctx, T1 a1, T2 a2, T3 a3, @Nonnull LTriFunction<T1, T2, T3, R> function) {
		Null.nonNullArg(ctx, "ctx");
		Null.nonNullArg(function, "function");
		try {
	...
	static <T1, T2, T3, R> R shovingApply(@Nonnull CallContext ctx, T1 a1, T2 a2, T3 a3, @Nonnull LTriFunction<T1, T2, T3, R> function) {
		Null.nonNullArg(ctx, "ctx");
		Null.nonNullArg(function, "function");
		try {
			return applyX(ctx, a1, a2, a3, function);
	...
	static <T1, T2, T3, R> CompletableFuture<R> asyncApply(@Nonnull AsyncCallContext async, T1 a1, T2 a2, T3 a3, @Nonnull LTriFunction<T1, T2, T3, R> function) {
	...
	static <T1, T2, T3, R> CompletableFuture<R> asyncApply(@Nonnull AsyncCallContext async, @Nonnull CallContext ctx, T1 a1, T2 a2, T3 a3, @Nonnull LTriFunction<T1, T2, T3, R> function) {
		Null.nonNullArg(async, "async");
		Null.nonNullArg(ctx, "ctx");
		Null.nonNullArg(function, "function");
		CompletableFuture<R> future = new CompletableFuture<>();
		try {
			async.call(() -> {
				try {
					var v = LTriFunction.applyX(ctx, a1, a2, a3, function);
					future.complete(v);
				} catch (Throwable e) {
					Handling.handleErrors(e);
					future.completeExceptionally(e);
	...
	final class S<T1, T2, T3, R> implements LTriFunction<T1, T2, T3, R> {
		...
		@Override
		public R applyX(T1 a1, T2 a2, T3 a3) throws Throwable {
	...
	static <T1, T2, T3, R> LTriFunction<T1, T2, T3, R> recursive(final @Nonnull LFunction<LTriFunction<T1, T2, T3, R>, LTriFunction<T1, T2, T3, R>> selfLambda) {
		final S<T1, T2, T3, R> single = new S();
		LTriFunction<T1, T2, T3, R> func = selfLambda.apply(single);
		single.target = func;
		return func;
	}
	...
	public static <T1, T2, T3, R> M<T1, T2, T3, R> initializedMementoOf(R initialValue, LTriFunction<T1, T2, T3, R> function) {
		return memento(initialValue, initialValue, function, (m, x1, x2) -> x2);
	}

	public static <T1, T2, T3, R> M<T1, T2, T3, R> deltaOf(T1 a1, T2 a2, T3 a3, LTriFunction<T1, T2, T3, R> function, LBinaryOperator<R> deltaFunction) {
		var initialValue = function.apply(a1, a2, a3);
		return initializedDeltaOf(initialValue, function, deltaFunction);
	}

	public static <T1, T2, T3, R> M<T1, T2, T3, R> initializedDeltaOf(R initialValue, LTriFunction<T1, T2, T3, R> function, LBinaryOperator<R> deltaFunction) {
		return memento(initialValue, deltaFunction.apply(initialValue, initialValue), function, (m, x1, x2) -> deltaFunction.apply(x1, x2));
	}

	public static <T1, T2, T3, R> M<T1, T2, T3, R> memento(R initialBaseValue, R initialValue, LTriFunction<T1, T2, T3, R> baseFunction, LTernaryOperator<R> mementoFunction) {
	...
	final class M<T1, T2, T3, R> implements LTriFunction<T1, T2, T3, R> {
		...
		private M(R lastBaseValue, R lastValue, LTriFunction<T1, T2, T3, R> baseFunction, LTernaryOperator<R> mementoFunction) {
	...
	@Nonnull
	static <T1, T2, T3, R> LTriFunction<T1, T2, T3, R> triFuncThrowing(final String message, final @Nonnull ExMF<Throwable> exF) {
		Null.nonNullArg(exF, "exF");
		return (a1, a2, a3) -> {
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T3, T2, R> LTriFunction.LObj0Obj2Obj1Func<T1, T3, T2, R> obj0Obj2Obj1Func(final @Nonnull LTriFunction.LObj0Obj2Obj1Func<T1, T3, T2, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1, T3, R> LTriFunction.LObj1BiObj2Func<T2, T1, T3, R> obj1BiObj2Func(final @Nonnull LTriFunction.LObj1BiObj2Func<T2, T1, T3, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T3, T1, R> LTriFunction.LObj1Obj2Obj0Func<T2, T3, T1, R> obj1Obj2Obj0Func(final @Nonnull LTriFunction.LObj1Obj2Obj0Func<T2, T3, T1, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T3, T1, T2, R> LTriFunction.LObj2Obj0Obj1Func<T3, T1, T2, R> obj2Obj0Obj1Func(final @Nonnull LTriFunction.LObj2Obj0Obj1Func<T3, T1, T2, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T3, T2, T1, R> LTriFunction.LBiObj1Obj0Func<T3, T2, T1, R> biObj1Obj0Func(final @Nonnull LTriFunction.LBiObj1Obj0Func<T3, T2, T1, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	@Nonnull
	default <V1, V2, V3> LTriFunction<V1, V2, V3, R> compose(@Nonnull final LFunction<? super V1, ? extends T1> before1, @Nonnull final LFunction<? super V2, ? extends T2> before2, @Nonnull final LFunction<? super V3, ? extends T3> before3) {
	...
	@FunctionalInterface
	interface LObj0Obj2Obj1Func<T1, T3, T2, R> extends LTriFunction<T1, T2, T3, R> {

		/**
		 * Implement this, but call apply(T1 a1,T2 a2,T3 a3)
		 */
		default R applyX(T1 a1, T2 a2, T3 a3) {
			return this.applyObj0Obj2Obj1(a1, a3, a2);
		}

		@Nullable
		// R applyObj0Obj2Obj1(T1 a1,T3 a3,T2 a2) ;
		default R applyObj0Obj2Obj1(T1 a1, T3 a3, T2 a2) {
			// return nestingApplyObj0Obj2Obj1(a1,a3,a2);
			try {
				return this.applyObj0Obj2Obj1X(a1, a3, a2);
			} catch (Throwable e) { // NOSONAR
				throw Handling.nestCheckedAndThrow(e);
			}
		}
		...
		/**
		 * Implement this, but call applyObj0Obj2Obj1(T1 a1,T3 a3,T2 a2)
		 */
		R applyObj0Obj2Obj1X(T1 a1, T3 a3, T2 a2) throws Throwable;
	}

	/** Permutation of LTriFunction for method references. */
	@FunctionalInterface
	interface LObj1BiObj2Func<T2, T1, T3, R> extends LTriFunction<T1, T2, T3, R> {

		/**
		 * Implement this, but call applyObj0Obj2Obj1(T1 a1,T3 a3,T2 a2)
		 */
		default R applyX(T1 a1, T2 a2, T3 a3) {
			return this.applyObj1BiObj2(a2, a1, a3);
		}

		@Nullable
		// R applyObj1BiObj2(T2 a2,T1 a1,T3 a3) ;
		default R applyObj1BiObj2(T2 a2, T1 a1, T3 a3) {
			// return nestingApplyObj1BiObj2(a2,a1,a3);
			try {
				return this.applyObj1BiObj2X(a2, a1, a3);
			} catch (Throwable e) { // NOSONAR
				throw Handling.nestCheckedAndThrow(e);
			}
		}
		...
		/**
		 * Implement this, but call applyObj1BiObj2(T2 a2,T1 a1,T3 a3)
		 */
		R applyObj1BiObj2X(T2 a2, T1 a1, T3 a3) throws Throwable;
	}
	...
	interface LObj1Obj2Obj0Func<T2, T3, T1, R> extends LTriFunction<T1, T2, T3, R> {
		 ...
		 */
		default R applyX(T1 a1, T2 a2, T3 a3) {
			return this.applyObj1Obj2Obj0(a2, a3, a1);
		}

		@Nullable
		// R applyObj1Obj2Obj0(T2 a2,T3 a3,T1 a1) ;
		default R applyObj1Obj2Obj0(T2 a2, T3 a3, T1 a1) {
			// return nestingApplyObj1Obj2Obj0(a2,a3,a1);
			try {
				return this.applyObj1Obj2Obj0X(a2, a3, a1);
			} catch (Throwable e) { // NOSONAR
				throw Handling.nestCheckedAndThrow(e);
			}
		}
		...
		/**
		 * Implement this, but call applyObj1Obj2Obj0(T2 a2,T3 a3,T1 a1)
		 */
		R applyObj1Obj2Obj0X(T2 a2, T3 a3, T1 a1) throws Throwable;
	}
	...
	interface LObj2Obj0Obj1Func<T3, T1, T2, R> extends LTriFunction<T1, T2, T3, R> {
		 ...
		 */
		default R applyX(T1 a1, T2 a2, T3 a3) {
			return this.applyObj2Obj0Obj1(a3, a1, a2);
		}

		@Nullable
		// R applyObj2Obj0Obj1(T3 a3,T1 a1,T2 a2) ;
		default R applyObj2Obj0Obj1(T3 a3, T1 a1, T2 a2) {
			// return nestingApplyObj2Obj0Obj1(a3,a1,a2);
			try {
				return this.applyObj2Obj0Obj1X(a3, a1, a2);
			} catch (Throwable e) { // NOSONAR
				throw Handling.nestCheckedAndThrow(e);
			}
		}
		...
		/**
		 * Implement this, but call applyObj2Obj0Obj1(T3 a3,T1 a1,T2 a2)
		 */
		R applyObj2Obj0Obj1X(T3 a3, T1 a1, T2 a2) throws Throwable;
	}

	/** Permutation of LTriFunction for method references. */
	@FunctionalInterface
	interface LBiObj1Obj0Func<T3, T2, T1, R> extends LTriFunction<T1, T2, T3, R> {

		/**
		 * Implement this, but call applyObj2Obj0Obj1(T3 a3,T1 a1,T2 a2)
		 */
		default R applyX(T1 a1, T2 a2, T3 a3) {
			return this.applyBiObj1Obj0(a3, a2, a1);
		}

		@Nullable
		// R applyBiObj1Obj0(T3 a3,T2 a2,T1 a1) ;
		default R applyBiObj1Obj0(T3 a3, T2 a2, T1 a1) {
			// return nestingApplyBiObj1Obj0(a3,a2,a1);
			try {
				return this.applyBiObj1Obj0X(a3, a2, a1);
			} catch (Throwable e) { // NOSONAR
				throw Handling.nestCheckedAndThrow(e);
			}
		}
		...
		/**
		 * Implement this, but call applyBiObj1Obj0(T3 a3,T2 a2,T1 a1)
		 */
		R applyBiObj1Obj0X(T3 a3, T2 a2, T1 a1) throws Throwable;
	}
