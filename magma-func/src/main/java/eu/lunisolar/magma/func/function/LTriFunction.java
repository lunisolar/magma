...
public interface LTriFunction<T1, T2, T3, R> extends MetaFunction, MetaInterface.NonThrowing, Codomain<a<R>>, Domain3<a<T1>, a<T2>, a<T3>> { // NOSONAR
	...
	default R apply(T1 a1, T2 a2, T3 a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default R apply(T1 a1, T2 a2, T3 a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default R apply(T1 a1, T2 a2, T3 a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default R apply(T1 a1, T2 a2, T3 a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LTriFunction<T1, T2, T3, R> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		return (a1, a2, a3) -> apply(a1, a2, a3, exF, newMessage);
	}

	default LTriFunction<T1, T2, T3, R> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		return (a1, a2, a3) -> apply(a1, a2, a3, exF, newMessage, param1);
	}

	default LTriFunction<T1, T2, T3, R> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		return (a1, a2, a3) -> apply(a1, a2, a3, exF, newMessage, param1, param1);
	}

	default LTriFunction<T1, T2, T3, R> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		return (a1, a2, a3) -> apply(a1, a2, a3, exF, newMessage, param1, param2, param3);
	}

	default R apply(T1 a1, T2 a2, T3 a3, @Nonnull ExWF<RuntimeException> exF) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LTriFunction<T1, T2, T3, R> trying(@Nonnull ExWF<RuntimeException> exF) {
	...
	static <T1, T2, T3, R> R tryApply(T1 a1, T2 a2, T3 a3, LTriFunction<T1, T2, T3, R> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, a3, exF, newMessage);
	}

	static <T1, T2, T3, R> R tryApply(T1 a1, T2 a2, T3 a3, LTriFunction<T1, T2, T3, R> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, a3, exF, newMessage, param1);
	}

	static <T1, T2, T3, R> R tryApply(T1 a1, T2 a2, T3 a3, LTriFunction<T1, T2, T3, R> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, a3, exF, newMessage, param1, param2);
	}

	static <T1, T2, T3, R> R tryApply(T1 a1, T2 a2, T3 a3, LTriFunction<T1, T2, T3, R> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, a3, exF, newMessage, param1, param2, param3);
	}

	static <T1, T2, T3, R> R tryApply(T1 a1, T2 a2, T3 a3, LTriFunction<T1, T2, T3, R> func, @Nonnull ExWF<RuntimeException> exF) {
		Null.nonNullArg(func, "func");
	 ...
	 */
	public static <T1, T2, T3, R> M<T1, T2, T3, R> memento(R initialValue, LTriFunction<T1, T2, T3, R> baseFunction, LBinaryOperator<R> mementoFunction) {
		return new M(initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not ). Very short name is intended to be used with parent (LTriFunction.D)
	 */
	final class M<T1, T2, T3, R> implements LTriFunction<T1, T2, T3, R> {
		...
		private M(R lastValue, LTriFunction<T1, T2, T3, R> baseFunction, LBinaryOperator<R> mementoFunction) {
