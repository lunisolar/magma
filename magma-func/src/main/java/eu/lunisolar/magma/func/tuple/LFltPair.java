...
public interface LFltPair extends LTuple<Float>, Comparable<LFltPair> {
	...
	public static Iterator<LFltPair.MutFltPair> mutIterator(PrimitiveIterator.OfDouble items) {
		return iterator(items, LFltPair::of);
	}

	public static Iterator<LFltPair> immIterator(PrimitiveIterator.OfDouble items) {
		return iterator(items, LFltPair::immutableOf);
	}
	...
	public static Stream<LFltPair.MutFltPair> mutStream(DoubleStream items) {
		return stream(items, LFltPair::of);
	}

	public static Stream<LFltPair> immStream(DoubleStream items) {
		return stream(items, LFltPair::immutableOf);
	}
	...
	public static <C, R> Iterator<R> iterator(SequentialRead<C, ?, aFloat> sa_, C source, LBiFltFunction<R> factory) {
