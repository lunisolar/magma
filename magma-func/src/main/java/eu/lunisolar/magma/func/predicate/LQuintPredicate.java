...
public interface LQuintPredicate<T1, T2, T3, T4, T5> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain5<a<T1>, a<T2>, a<T3>, a<T4>, a<T5>> { // NOSONAR
	...
	public static <T1, T2, T3, T4, T5> void throwIf(T1 a1, T2 a2, T3 a3, T4 a4, T5 a5, @Nonnull LQuintPredicate<T1, T2, T3, T4, T5> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
	...
	/** Throws new exception if condition is met. */
	public static <T1, T2, T3, T4, T5> void throwIf(T1 a1, @Nonnull LQuintPredicate<T1, T2, T3, T4, T5> pred, T2 a2, T3 a3, T4 a4, T5 a5, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (pred.test(a1, a2, a3, a4, a5)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}
	...
	public static <T1, T2, T3, T4, T5> void throwIfNot(T1 a1, T2 a2, T3 a3, T4 a4, T5 a5, @Nonnull LQuintPredicate<T1, T2, T3, T4, T5> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (!pred.test(a1, a2, a3, a4, a5)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}
	...
	/** Throws new exception if condition is not met. */
	public static <T1, T2, T3, T4, T5> void throwIfNot(T1 a1, @Nonnull LQuintPredicate<T1, T2, T3, T4, T5> pred, T2 a2, T3 a3, T4 a4, T5 a5, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (!pred.test(a1, a2, a3, a4, a5)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}
	...
	public static <T1, T2, T3, T4, T5> T1 complying(T1 a1, T2 a2, T3 a3, T4 a4, T5 a5, @Nonnull LQuintPredicate<T1, T2, T3, T4, T5> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (pred.test(a1, a2, a3, a4, a5)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	public static <T1, T2, T3, T4, T5> T1 notComplying(T1 a1, T2 a2, T3 a3, T4 a4, T5 a5, @Nonnull LQuintPredicate<T1, T2, T3, T4, T5> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (!pred.test(a1, a2, a3, a4, a5)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
