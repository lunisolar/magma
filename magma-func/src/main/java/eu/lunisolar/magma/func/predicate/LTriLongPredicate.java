...
public interface LTriLongPredicate extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<aLong, aLong, aLong> { // NOSONAR
	...
	default LTriLongPredicate trying(@Nonnull ExWF<RuntimeException> exF) {
	...
	public static long throwIf(long a1, long a2, long a3, @Nonnull LTriLongPredicate pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
	...
	/** Throws new exception if condition is met. */
	public static long throwIf(long a1, @Nonnull LTriLongPredicate pred, long a2, long a3, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	public static long throwIfNot(long a1, long a2, long a3, @Nonnull LTriLongPredicate pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static long throwIfNot(long a1, @Nonnull LTriLongPredicate pred, long a2, long a3, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	/** Throws new exception if condition is met. */
	public static long throwIf(long a1, long a2, long a3, @Nonnull LTriLongPredicate pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage) {
		if (pred.test(a1, a2, a3)) {
	...
	/** Throws new exception if condition is met. */
	public static long throwIf(long a1, @Nonnull LTriLongPredicate pred, long a2, long a3, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage) {
		if (pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static long throwIfNot(long a1, long a2, long a3, @Nonnull LTriLongPredicate pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage) {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static long throwIfNot(long a1, @Nonnull LTriLongPredicate pred, long a2, long a3, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage) {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
	...
	*/
	...
	static LTriLongPredicate recursive(final @Nonnull LFunction<LTriLongPredicate, LTriLongPredicate> selfLambda) {
		final LTriLongPredicateSingle single = new LTriLongPredicateSingle();
		LTriLongPredicate func = selfLambda.apply(single);
		single.target = func;
		return func;
	}

	final class LTriLongPredicateSingle implements LSingle<LTriLongPredicate>, LTriLongPredicate {
		...
		@Override
		public LTriLongPredicate value() {
			return target;
		}
	}
