...
public interface LTriLongPredicate extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<aLong, aLong, aLong> { // NOSONAR
	 ...
	 */
	public static M memento(boolean initialValue, LTriLongPredicate baseFunction, LLogicalBinaryOperator mementoFunction) {
		return new M(initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not ). Very short name is intended to be used with parent (LTriLongPredicate.D)
	 */
	final class M implements LTriLongPredicate {
		...
		private M(boolean lastValue, LTriLongPredicate baseFunction, LLogicalBinaryOperator mementoFunction) {
