...
public interface LBiObjIntFunction<T1, T2, R> extends LBiObjIntFunctionX<T1, T2, R, RuntimeException>, MetaFunction, MetaInterface.NonThrowing { // NOSONAR
	...
	/** Permutation of LBiObjIntFunction for method references. */
	@FunctionalInterface
	interface V2<T1, T2, R> extends LBiObjIntFunction<T1, T2, R> {
		@Nullable
		R apply2(T2 a2, T1 a1, int a3);
	...
	/** Permutation of LBiObjIntFunction for method references. */
	@FunctionalInterface
	interface V3<T1, T2, R> extends LBiObjIntFunction<T1, T2, R> {
		@Nullable
		R apply3(T2 a2, int a3, T1 a1);
	...
	/** Permutation of LBiObjIntFunction for method references. */
	@FunctionalInterface
	interface V5<T1, T2, R> extends LBiObjIntFunction<T1, T2, R> {
		@Nullable
		R apply5(int a3, T2 a2, T1 a1);
