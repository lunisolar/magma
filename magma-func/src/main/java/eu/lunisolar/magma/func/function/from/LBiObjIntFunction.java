...
public interface LBiObjIntFunction<T1, T2, R> extends MetaFunction, MetaInterface.NonThrowing, Codomain<a<R>>, Domain3<a<T1>, a<T2>, aInt> { //NOSONAR
	...
	default LOiFunction<T2, R> _with(T1 a1) {
		return (a2, a3) -> apply(a1, a2, a3);
	}

	default LBiFunction<T1, T2, R> with(int a3) {
		return (a1, a2) -> apply(a1, a2, a3);
	}

	default LIntFunction<R> _with(T1 a1, T2 a2) {
		return a3 -> apply(a1, a2, a3);
	}

	default LFunction<T1, R> with(T2 a2, int a3) {
	...
	final class M<T1, T2, R> implements LBiObjIntFunction<T1, T2, R> {
		...
		public R currentBaseValue(T1 a1, T2 a2, int a3) {
	...
	default LBiObjIntFunction<T1, T2, R> shoving() {

		return new LBiObjIntFunction<T1, T2, R>() {
			...
			public R applyX(T1 a1, T2 a2, int a3) throws Throwable {
				return LBiObjIntFunction.this.applyX(a1, a2, a3);
			}
