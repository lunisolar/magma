...
public interface LBiObjIntFunction<T1, T2, R> extends LBiObjIntFunctionX<T1, T2, R, RuntimeException>, MetaFunction, MetaInterface.NonThrowing { // NOSONAR
	...
	@FunctionalInterface
	interface V1<T1, T2, R> extends LBiObjIntFunction<T1, T2, R> {
		@Nullable
		R doApplyV1(T1 a1, int a3, T2 a2);
	...
	/** Permutation of LBiObjIntFunction for method references. */
	@FunctionalInterface
	interface V2<T2, T1, R> extends LBiObjIntFunction<T1, T2, R> {
		@Nullable
		R doApplyV2(T2 a2, T1 a1, int a3);
	...
	/** Permutation of LBiObjIntFunction for method references. */
	@FunctionalInterface
	interface V3<T2, T1, R> extends LBiObjIntFunction<T1, T2, R> {
		@Nullable
		R doApplyV3(T2 a2, int a3, T1 a1);
	...
	/** Permutation of LBiObjIntFunction for method references. */
	@FunctionalInterface
	interface V4<T1, T2, R> extends LBiObjIntFunction<T1, T2, R> {
		@Nullable
		R doApplyV4(int a3, T1 a1, T2 a2);
	...
	/** Permutation of LBiObjIntFunction for method references. */
	@FunctionalInterface
	interface V5<T2, T1, R> extends LBiObjIntFunction<T1, T2, R> {
		@Nullable
		R doApplyV5(int a3, T2 a2, T1 a1);
