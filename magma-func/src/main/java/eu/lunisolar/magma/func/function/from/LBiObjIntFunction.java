...
public interface LBiObjIntFunction<T1, T2, R> extends MetaFunction, MetaInterface.NonThrowing, Codomain<a<R>>, Domain3<a<T1>, a<T2>, aInt> { // NOSONAR
	...
	public default LBiObjIntFunction<T1, T2, R> before(@Nonnull LBiObjIntConsumer<T1, T2> before) {
	...
	public default LBiObjIntFunction<T1, T2, R> after(@Nonnull LConsumer<R> after) {
