...
public interface LBiObjIntFunction<T1, T2, R> extends MetaFunction, MetaInterface.NonThrowing, Codomain<a<R>>, Domain3<a<T1>, a<T2>, aInt> { // NOSONAR
	...
	public static <R, M, K, V, T2> R from(M container, LBiFunction<M, K, V> extractor, K key, T2 a2, int a3, LBiObjIntFunction<V, T2, R> function) {
	...
	/**  */
	public static <T1, T2, R> LBiObjIntFunction<T1, T2, R> uncurry(LFunction<T1, LFunction<T2, LIntFunction<R>>> func) {
	...
	@Nonnull
	static <T1, T2, R> LBiObjIntFunction<T1, T2, R> biObjIntFunc(Class<T1> c1, Class<T2> c2, Class<R> c3, final @Nonnull LBiObjIntFunction<T1, T2, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2, R> LObj0Int2Obj1Func<T1, T2, R> obj0Int2Obj1Func(final @Nonnull LObj0Int2Obj1Func<T1, T2, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1, R> LObj1Obj0Int2Func<T2, T1, R> obj1Obj0Int2Func(final @Nonnull LObj1Obj0Int2Func<T2, T1, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1, R> LObj1Int2Obj0Func<T2, T1, R> obj1Int2Obj0Func(final @Nonnull LObj1Int2Obj0Func<T2, T1, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2, R> LInt2Obj0Obj1Func<T1, T2, R> int2Obj0Obj1Func(final @Nonnull LInt2Obj0Obj1Func<T1, T2, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1, R> LInt2Obj1Obj0Func<T2, T1, R> int2Obj1Obj0Func(final @Nonnull LInt2Obj1Obj0Func<T2, T1, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
