...
public interface LLongBiConsumerX<X extends Throwable> extends MetaConsumer, MetaInterface.Throwing<X> {
	...
	default LActionX<X> captureLongBiCons(long l1, long l2) {
	 ...
	 */
	@Nonnull
	default LLongBiConsumerX<X> longBiConsFromLong(@Nonnull final LLongUnaryOperatorX<X> before1, @Nonnull final LLongUnaryOperatorX<X> before2) {
	 ...
	 */
	@Nonnull
	default <V1, V2> LBiConsumerX<V1, V2, X> longBiConsFrom(@Nonnull final LToLongFunctionX<? super V1, X> before1, @Nonnull final LToLongFunctionX<? super V2, X> before2) {
		Null.nonNullArg(before1, "before1");
		Null.nonNullArg(before2, "before2");
	...
	@Nonnull
	default LLongBiConsumer handleLongBiCons(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
		return (long l1, long l2) -> this.handlingDoAccept(l1, l2, handling);
	}

	@Nonnull
	default <Y extends Throwable> LLongBiConsumerX<Y> handleLongBiConsX(@Nonnull HandlingInstructions<Throwable, Y> handling) {
		return (long l1, long l2) -> this.handlingDoAccept(l1, l2, handling);
	}
