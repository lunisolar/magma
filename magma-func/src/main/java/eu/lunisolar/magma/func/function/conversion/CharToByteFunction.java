...
/**
 * Non-throwing functional interface (lambda) CharToByteFunction for Java 8.
 *
 * Type: function
 *
 * Domain (lvl: 1): char c
...
public interface CharToByteFunction extends CharToByteFunctionX<RuntimeException>, MetaFunction, PrimitiveCodomain<Object>, MetaInterface.NonThrowing { // NOSONAR
