...
public interface LObjIntFltFunction<T, R> extends MetaFunction, MetaInterface.NonThrowing, Codomain<a<R>>, Domain3<a<T>, aInt, aFloat> { // NOSONAR
	...
	default R apply(T a1, int a2, float a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LObjIntFltFunction<T, R> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
	...
	static <T, R> R tryApply(T a1, int a2, float a3, LObjIntFltFunction<T, R> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		Null.nonNullArg(func, "func");
	...
	public static <T, R> void fromTo(int min_a2, int max_a2, T a1, float a3, LObjIntFltFunction<T, R> func) {
		Null.nonNullArg(func, "func");
		if (min_a2 <= max_a2) {
	...
	/** From-To. Intended to be used with non-capturing lambda. */
	public static <T, R> void fromTill(int min_a2, int max_a2, T a1, float a3, LObjIntFltFunction<T, R> func) {
		Null.nonNullArg(func, "func");
		if (min_a2 <= max_a2) {
			for (int a2 = min_a2; a2 < max_a2; a2++) {
				func.apply(a1, a2, a3);
	...
	/** From-To. Intended to be used with non-capturing lambda. */
	public static <T, R> void times(int max_a2, T a1, float a3, LObjIntFltFunction<T, R> func) {
		if (max_a2 < 0)
			return;
	...
	public static <R, M, K, V> R from(M container, LBiFunction<M, K, V> extractor, K key, int a2, float a3, LObjIntFltFunction<V, R> function) {
	...
	/**  */
	public static <T, R> LObjIntFltFunction<T, R> uncurry(LFunction<T, LIntFunction<LFltFunction<R>>> func) {
		return (T a1, int a2, float a3) -> func.apply(a1).apply(a2).apply(a3);
	}

	/** Cast that removes generics. */
	public default LObjIntFltFunction untyped() {
		return this;
	}

	/** Cast that replace generics. */
	public default <V2, V3> LObjIntFltFunction<V2, V3> cast() {
		return untyped();
	}
	...
	@Nonnull
	static <T, R> LObjIntFltFunction<T, R> objIntFltFunc(Class<T> c1, Class<R> c2, final @Nonnull LObjIntFltFunction<T, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	final class LObjIntFltFunctionSingle<T, R> implements LSingle<LObjIntFltFunction<T, R>>, LObjIntFltFunction<T, R> {
		...
		@Override
		public LObjIntFltFunction<T, R> value() {
			return target;
		}
	}
	...
	@Nonnull
	default LObjIntFltFunction<T, R> before(@Nonnull LTieFltConsumer<? super T> before) {
	...
	@Nonnull
	default LObjIntFltFunction<T, R> after(@Nonnull LConsumer<? super R> after) {
		Null.nonNullArg(after, "after");
		return (a1, a2, a3) -> {
