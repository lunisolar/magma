...
public interface LObjIntFltFunction<T, R> extends MetaFunction, MetaInterface.NonThrowing { // NOSONAR

	String DESCRIPTION = "LObjIntFltFunction: R doApply(T a1,int a2,float a3)";

	@Nullable
	// R doApply(T a1,int a2,float a3) ;
	default R doApply(T a1, int a2, float a3) {
	...
	/**
	 * Implement this, but call doApply(T a1,int a2,float a3)
	 */
	R doApplyX(T a1, int a2, float a3) throws Throwable;
	...
	default R handlingDoApply(T a1, int a2, float a3, HandlingInstructions<Throwable, RuntimeException> handling) {
		try {
			return this.doApplyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default R tryDoApply(T a1, int a2, float a3, @Nonnull ExceptionWrapWithMessageFactory<RuntimeException> exceptionFactory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		try {
			return this.doApplyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default R tryDoApply(T a1, int a2, float a3, @Nonnull ExceptionWrapFactory<RuntimeException> exceptionFactory) {
		try {
			return this.doApplyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default R tryDoApplyThen(T a1, int a2, float a3, @Nonnull LFunction<Throwable, R> handler) {
		try {
			return this.doApplyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default R nestingDoApply(T a1, int a2, float a3) {
		try {
			return this.doApplyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
			throw Handling.nestCheckedAndThrow(e);
	...
	default R shovingDoApply(T a1, int a2, float a3) {
		try {
			return this.doApplyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	static <T, R> R handlingDoApply(T a1, int a2, float a3, LObjIntFltFunction<T, R> func, HandlingInstructions<Throwable, RuntimeException> handling) { // <-
		Null.nonNullArg(func, "func");
		return func.handlingDoApply(a1, a2, a3, handling);
	}

	static <T, R> R tryDoApply(T a1, int a2, float a3, LObjIntFltFunction<T, R> func) {
		return tryDoApply(a1, a2, a3, func, null);
	}

	static <T, R> R tryDoApply(T a1, int a2, float a3, LObjIntFltFunction<T, R> func, @Nonnull ExceptionWrapWithMessageFactory<RuntimeException> exceptionFactory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		Null.nonNullArg(func, "func");
		return func.tryDoApply(a1, a2, a3, exceptionFactory, newMessage, messageParams);
	}

	static <T, R> R tryDoApply(T a1, int a2, float a3, LObjIntFltFunction<T, R> func, @Nonnull ExceptionWrapFactory<RuntimeException> exceptionFactory) {
		Null.nonNullArg(func, "func");
		return func.tryDoApply(a1, a2, a3, exceptionFactory);
	}

	static <T, R> R tryDoApplyThen(T a1, int a2, float a3, LObjIntFltFunction<T, R> func, @Nonnull LFunction<Throwable, R> handler) {
		Null.nonNullArg(func, "func");
		return func.tryDoApplyThen(a1, a2, a3, handler);
	}

	default R failSafeDoApply(T a1, int a2, float a3, @Nonnull LObjIntFltFunction<T, R> failSafe) {
		try {
	...
	static <T, R> R failSafeDoApply(T a1, int a2, float a3, LObjIntFltFunction<T, R> func, @Nonnull LObjIntFltFunction<T, R> failSafe) {
	...
	static <T, R> LObjIntFltFunction<T, R> failSafeObjIntFltFunc(LObjIntFltFunction<T, R> func, @Nonnull LObjIntFltFunction<T, R> failSafe) {
		Null.nonNullArg(failSafe, "failSafe");
	...
	@Nonnull
	default R nonNullDoApply(T a1, int a2, float a3) {
	...
	/**  */
	public static <T, R> LObjIntFltFunction<T, R> uncurryObjIntFltFunc(LFunction<T, LIntFunction<LFltFunction<R>>> func) {
		return (T a1, int a2, float a3) -> func.doApply(a1).doApply(a2).doApply(a3);
	}

	/** Captures arguments but delays the evaluation. */
	default LSupplier<R> captureObjIntFltFunc(T a1, int a2, float a3) {
	...
	static <T, R> LObjIntFltFunction<T, R> recursive(final @Nonnull LFunction<LObjIntFltFunction<T, R>, LObjIntFltFunction<T, R>> selfLambda) {
		...
		LObjIntFltFunction<T, R> func = selfLambda.doApply(single);
		single.target = func;
		return func;
	}
	...
	final class LObjIntFltFunctionSingle<T, R> implements LSingle<LObjIntFltFunction<T, R>>, LObjIntFltFunction<T, R> {
		...
		@Override
		public R doApplyX(T a1, int a2, float a3) throws Throwable {
	...
	@Nonnull
	static <T, R> LObjIntFltFunction<T, R> objIntFltFuncThrowing(final @Nonnull ExceptionFactory<Throwable> exceptionFactory) {
	...
	@Nonnull
	static <T, R> LObjIntFltFunction<T, R> objIntFltFuncThrowing(final String message, final @Nonnull ExceptionWithMessageFactory<Throwable> exceptionFactory) {
		Null.nonNullArg(exceptionFactory, "exceptionFactory");
		return (a1, a2, a3) -> {
	...
	@Nonnull
	default <V1> LObjIntFltFunction<V1, R> objIntFltFuncComposeIntFlt(@Nonnull final LFunction<? super V1, ? extends T> before1, @Nonnull final LIntUnaryOperator before2, @Nonnull final LFltUnaryOperator before3) {
		Null.nonNullArg(before1, "before1");
		Null.nonNullArg(before2, "before2");
		Null.nonNullArg(before3, "before3");
		return (v1, v2, v3) -> this.doApply(before1.doApply(v1), before2.doApplyAsInt(v2), before3.doApplyAsFlt(v3));
	}

	public static <V1, T, R> LObjIntFltFunction<V1, R> composedIntFlt(@Nonnull final LFunction<? super V1, ? extends T> before1, @Nonnull final LIntUnaryOperator before2, @Nonnull final LFltUnaryOperator before3, LObjIntFltFunction<T, R> after) {
		return after.objIntFltFuncComposeIntFlt(before1, before2, before3);
	}
	...
	@Nonnull
	default LObjIntFltFunction<T, R> nestingObjIntFltFunc() {
		return this;
	}

	/** Converts to non-throwing variant that will propagate checked exception as it would be unchecked - there is no exception wrapping involved (at least not here). */
	default LObjIntFltFunction<T, R> shovingObjIntFltFunc() {
		return this;
	}
	...
	@Nonnull
	default LObjIntFltFunction<T, R> nonNullObjIntFltFunc() {
	...
	interface LObjFltIntFunc<T, R> extends LObjIntFltFunction<T, R> {
		@Nullable
		R doApplyObjFltInt(T a1, float a3, int a2);

		@Override
		default R doApplyX(T a1, int a2, float a3) {
			return this.doApplyObjFltInt(a1, a3, a2);
		}
	}
	...
	interface LIntObjFltFunc<T, R> extends LObjIntFltFunction<T, R> {
		@Nullable
		R doApplyIntObjFlt(int a2, T a1, float a3);

		@Override
		default R doApplyX(T a1, int a2, float a3) {
			return this.doApplyIntObjFlt(a2, a1, a3);
		}
	}
	...
	interface LIntFltObjFunc<T, R> extends LObjIntFltFunction<T, R> {
		@Nullable
		R doApplyIntFltObj(int a2, float a3, T a1);

		@Override
		default R doApplyX(T a1, int a2, float a3) {
			return this.doApplyIntFltObj(a2, a3, a1);
		}
	}
	...
	interface LFltObjIntFunc<T, R> extends LObjIntFltFunction<T, R> {
		@Nullable
		R doApplyFltObjInt(float a3, T a1, int a2);

		@Override
		default R doApplyX(T a1, int a2, float a3) {
			return this.doApplyFltObjInt(a3, a1, a2);
		}
	}
	...
	interface LFltIntObjFunc<T, R> extends LObjIntFltFunction<T, R> {
		@Nullable
		R doApplyFltIntObj(float a3, int a2, T a1);

		@Override
		default R doApplyX(T a1, int a2, float a3) {
			return this.doApplyFltIntObj(a3, a2, a1);
		}
	}
	...
	// MAP: FOR, [SourcePurpose{arg=T a1, type=IA}, SourcePurpose{arg=int a2, type=IA}, SourcePurpose{arg=float a3, type=IA}, SourcePurpose{arg=LConsumer<?
	...
	// MAP: WHILE, [SourcePurpose{arg=T a1, type=SA}, SourcePurpose{arg=int a2, type=IA}, SourcePurpose{arg=float a3, type=IA}, SourcePurpose{arg=LConsumer<?
	// super R> consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T a1, type=IA}, SourcePurpose{arg=int a2, type=SA}, SourcePurpose{arg=float a3, type=IA}, SourcePurpose{arg=LConsumer<?
	// super R> consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T a1, type=SA}, SourcePurpose{arg=int a2, type=SA}, SourcePurpose{arg=float a3, type=IA}, SourcePurpose{arg=LConsumer<?
	// super R> consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T a1, type=IA}, SourcePurpose{arg=int a2, type=IA}, SourcePurpose{arg=float a3, type=SA}, SourcePurpose{arg=LConsumer<?
	// super R> consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T a1, type=SA}, SourcePurpose{arg=int a2, type=IA}, SourcePurpose{arg=float a3, type=SA}, SourcePurpose{arg=LConsumer<?
	// super R> consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T a1, type=IA}, SourcePurpose{arg=int a2, type=SA}, SourcePurpose{arg=float a3, type=SA}, SourcePurpose{arg=LConsumer<?
	// super R> consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T a1, type=SA}, SourcePurpose{arg=int a2, type=SA}, SourcePurpose{arg=float a3, type=SA}, SourcePurpose{arg=LConsumer<?
	// super R> consumer, type=CONST}]
