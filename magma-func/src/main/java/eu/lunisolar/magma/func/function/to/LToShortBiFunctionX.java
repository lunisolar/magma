...
public interface LToShortBiFunctionX<T1, T2, X extends Throwable> extends MetaFunction, MetaInterface.Throwing<X> { // NOSONAR

	String DESCRIPTION = "LToShortBiFunctionX: short doApplyAsShort(T1 a1,T2 a2) throws X";

	short doApplyAsShort(T1 a1, T2 a2) throws X;

	default short tupleApplyAsShort(LPair<T1, T2> args) throws X {
	...
	default short shovingDoApplyAsShort(T1 a1, T2 a2) {
		return ((LToShortBiFunctionX<T1, T2, RuntimeException>) this).doApplyAsShort(a1, a2);
	}

	/** Function call that handles exceptions according to the instructions. */
	default <Y extends Throwable> short handlingDoApplyAsShort(T1 a1, T2 a2, HandlingInstructions<Throwable, Y> handling) throws Y {
	...
	default short nonNullDoApplyAsShort(T1 a1, T2 a2) throws X {
	...
	default LShortSupplierX<X> captureToShortBiFunc(T1 a1, T2 a2) {
		return () -> this.doApplyAsShort(a1, a2);
	}
	...
	@Nonnull
	static <T1, T2, X extends Throwable> LToShortBiFunctionX<T1, T2, X> safe() {
		return Function4U::produceShort;
	}

	/** Safe instance supplier. Returns supplier of safe() instance. */
	@Nonnull
	static <T1, T2, X extends Throwable, Y extends Throwable> LSupplierX<LToShortBiFunctionX<T1, T2, X>, Y> safeSupplier() {
		return () -> safe();
	}

	/** Safe wrapping. Either argument function is returned (if it is not null) or safe() instance. */
	@Nonnull
	static <T1, T2, X extends Throwable> LToShortBiFunctionX<T1, T2, X> safe(final @Nullable LToShortBiFunctionX<T1, T2, X> other) {
		if (other == null) {
			return safe();
		} else {
			return other;
	...
	@Nonnull
	static <T1, T2, X extends Throwable, Y extends Throwable> LSupplierX<LToShortBiFunctionX<T1, T2, X>, Y> safeSupplier(final @Nullable LSupplierX<LToShortBiFunctionX<T1, T2, X>, Y> supplier) {
		if (supplier == null) {
			return safeSupplier();
		} else {
			return supplier;
	...
	default LToShortBiFunction<T1, T2> handleToShortBiFunc(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
		return (T1 a1, T2 a2) -> this.handlingDoApplyAsShort(a1, a2, handling);
	}
	...
	/** Permutation of LToShortBiFunctionX for method references. */
	@FunctionalInterface
	interface V1<T2, T1, X extends Throwable> extends LToShortBiFunctionX<T1, T2, X> {

		short doApplyAsShortV1(T2 a2, T1 a1) throws X;

		@Override
		default short doApplyAsShort(T1 a1, T2 a2) throws X {
			return this.doApplyAsShortV1(a2, a1);
		}
	}
