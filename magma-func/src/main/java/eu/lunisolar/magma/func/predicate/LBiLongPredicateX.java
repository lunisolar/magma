...
public interface LBiLongPredicateX<X extends Throwable> extends MetaPredicate, MetaInterface.Throwing<X> { // NOSONAR

	String DESCRIPTION = "LBiLongPredicateX: boolean doTest(long a1,long a2) throws X";

	boolean doTest(long a1, long a2) throws X;

	default boolean tupleTest(LLongPair args) throws X {
	...
	default boolean shovingDoTest(long a1, long a2) {
		return ((LBiLongPredicateX<RuntimeException>) this).doTest(a1, a2);
	}

	/** Function call that handles exceptions according to the instructions. */
	default <Y extends Throwable> boolean handlingDoTest(long a1, long a2, HandlingInstructions<Throwable, Y> handling) throws Y {
	...
	default boolean nonNullDoTest(long a1, long a2) throws X {
		return doTest(a1, a2);
	}

	/** For convenience, where "test()" makes things more confusing than "applyAsBoolean()". */

	default boolean doApplyAsBoolean(long a1, long a2) throws X {
		return doTest(a1, a2);
	}
	...
	default LBoolSupplierX<X> captureBiLongPred(long a1, long a2) {
		return () -> this.doTest(a1, a2);
	}
	...
	static <X extends Throwable> boolean call(long a1, long a2, final @Nonnull LBiLongPredicateX<X> lambda) throws X {
		Null.nonNullArg(lambda, "lambda");
		return lambda.doTest(a1, a2);
	}

	static <X extends Throwable> boolean shoving(long a1, long a2, final @Nonnull LBiLongPredicateX<X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.shovingDoTest(a1, a2);
	}

	static <X extends Throwable> boolean nesting(long a1, long a2, final @Nonnull LBiLongPredicateX<X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.nestingDoTest(a1, a2);
	}

	static <X extends Throwable, Y extends Throwable> boolean handling(long a1, long a2, final HandlingInstructions<Throwable, Y> handling, final @Nonnull LBiLongPredicateX<X> lambda) throws Y {
		Null.nonNullArg(lambda, "lambda");
	...
	@Nonnull
	static <X extends Throwable> LBiLongPredicateX<X> safe() {
		return Function4U::alwaysFalse;
	}

	/** Safe instance supplier. Returns supplier of safe() instance. */
	@Nonnull
	static <X extends Throwable, Y extends Throwable> LSupplierX<LBiLongPredicateX<X>, Y> safeSupplier() {
		return () -> safe();
	}

	/** Safe wrapping. Either argument function is returned (if it is not null) or safe() instance. */
	@Nonnull
	static <X extends Throwable> LBiLongPredicateX<X> safe(final @Nullable LBiLongPredicateX<X> other) {
		if (other == null) {
			return safe();
		} else {
			return other;
	...
	@Nonnull
	static <X extends Throwable, Y extends Throwable> LSupplierX<LBiLongPredicateX<X>, Y> safeSupplier(final @Nullable LSupplierX<LBiLongPredicateX<X>, Y> supplier) {
		if (supplier == null) {
			return safeSupplier();
		} else {
			return supplier;
	 ...
	 */
	@Nonnull
	static <X extends Throwable> LBiLongPredicateX<X> isEqual(long v1, long v2) {
	...
	@Nonnull
	default <V> LBiLongFunctionX<V, X> boolToBiLongFunc(@Nonnull LBoolFunctionX<? extends V, X> after) {
	...
	/** Permutation of LBiLongPredicateX for method references. */
	@FunctionalInterface
	interface V1<X extends Throwable> extends LBiLongPredicateX<X> {

		boolean doTestV1(long a2, long a1) throws X;

		@Override
		default boolean doTest(long a1, long a2) throws X {
