...
public interface LObjFloatFunction<T, R> extends LObjFloatFunctionX<T, R, RuntimeException>, MetaFunction, MetaInterface.NonThrowing { // NOSONAR
	...
	String DESCRIPTION = "LObjFloatFunction: R doApply(T a1,float a2)";

	@Nullable
	R doApply(T a1, float a2);

	default R tupleApply(LObjFloatPair<T> args) {
	...
	default LSupplier<R> captureObjFloatFunc(T a1, float a2) {
		return () -> this.doApply(a1, a2);
	}
