...
public interface LBiObjBooleanFunctionX<T1, T2, R, X extends Throwable> extends MetaFunction, MetaInterface.Throwing<X> { // NOSONAR
	...
	@Nonnull
	static <T1, T2, R, X extends Throwable> LBiObjBooleanFunctionX<T1, T2, R, X> apply1st(@Nonnull LFunctionX<T1, R, X> func) {
		return (t1, t2, b) -> func.doApply(t1);
	}

	/** Captures single parameter function into this interface where only 2nd parameter will be used. */
	@Nonnull
	static <T1, T2, R, X extends Throwable> LBiObjBooleanFunctionX<T1, T2, R, X> apply2nd(@Nonnull LFunctionX<T2, R, X> func) {
		return (t1, t2, b) -> func.doApply(t2);
	}

	/** Captures single parameter function into this interface where only 3rd parameter will be used. */
	@Nonnull
	static <T1, T2, R, X extends Throwable> LBiObjBooleanFunctionX<T1, T2, R, X> apply3rd(@Nonnull LBooleanFunctionX<R, X> func) {
	...
	@Nonnull
	default <V1, V2> LBiObjBooleanFunctionX<V1, V2, R, X> biObjBoolFuncComposeBoolean(@Nonnull final LFunctionX<? super V1, ? extends T1, X> before1, @Nonnull final LFunctionX<? super V2, ? extends T2, X> before2,
			@Nonnull final LLogicalOperatorX<X> before3) {
	...
	@Nonnull
	default LBiObjBooleanFunctionX<T1, T2, R, X> nonNullBiObjBoolFunc() {
	...
	@Nonnull
	default LBiObjBooleanFunction<T1, T2, R> handleBiObjBoolFunc(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
		return (T1 t1, T2 t2, boolean b) -> this.handlingDoApply(t1, t2, b, handling);
	}

	/** Converts to function that handles exceptions according to the instructions. */
	@Nonnull
	default <Y extends Throwable> LBiObjBooleanFunctionX<T1, T2, R, Y> handleBiObjBoolFuncX(@Nonnull HandlingInstructions<Throwable, Y> handling) {
		return (T1 t1, T2 t2, boolean b) -> this.handlingDoApply(t1, t2, b, handling);
	}
