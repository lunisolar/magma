...
public interface LBiObjIntConsumer<T1, T2> extends LBiObjIntConsumerX<T1, T2, RuntimeException>, MetaConsumer, MetaInterface.NonThrowing {
	...
	@Nonnull
	public static <T1, T2> LBiObjIntConsumer<T1, T2> l(final @Nonnull LBiObjIntConsumer<T1, T2> lambda) {
	...
	@Nonnull
	default LBiObjIntConsumer<T1, T2> nonThrowing() {
		return this;
	}

	/** Converts to throwing variant (RuntimeException). */
	@Nonnull
	default LBiObjIntConsumerX<T1, T2, RuntimeException> uncheck() {
		return (LBiObjIntConsumerX) this;
	}
	...
	@Nonnull
	default <E extends Exception, Y extends RuntimeException> LBiObjIntConsumer<T1, T2> handle(Class<E> exception, ExceptionHandler<E, Y> handler) {
		Objects.requireNonNull(exception, Function4U.VALIDATION_MESSAGE_EXCEPTION);
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return LBiObjIntConsumer.wrapException(this, exception, (ExceptionHandler) handler);
	}

	/** Wraps with exception handling that for any exception (including unchecked exception that might be different from X) will call handler function to determine the final exception. */
	@Nonnull
	default <Y extends RuntimeException> LBiObjIntConsumer<T1, T2> handle(ExceptionHandler<Exception, Y> handler) {
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return LBiObjIntConsumer.wrapException(this, Exception.class, (ExceptionHandler) handler);
	}
