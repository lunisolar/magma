...
public interface LBiObjIntConsumer<T1, T2> extends LBiObjIntConsumerX<T1, T2, RuntimeException>, MetaConsumer, MetaInterface.NonThrowing {
	...
	interface V1<T1, T2> extends LBiObjIntConsumer<T1, T2> {
		...
		void apply1(T1 a1, int a3, T2 a2);
	...
	/** Permutation of LBiObjIntConsumer for method references. */
	@FunctionalInterface
	interface V2<T1, T2> extends LBiObjIntConsumer<T1, T2> {

		void apply2(T2 a2, T1 a1, int a3);
	...
	/** Permutation of LBiObjIntConsumer for method references. */
	@FunctionalInterface
	interface V3<T1, T2> extends LBiObjIntConsumer<T1, T2> {

		void apply3(T2 a2, int a3, T1 a1);
	...
	interface V4<T1, T2> extends LBiObjIntConsumer<T1, T2> {
		...
		void apply4(int a3, T1 a1, T2 a2);
	...
	/** Permutation of LBiObjIntConsumer for method references. */
	@FunctionalInterface
	interface V5<T1, T2> extends LBiObjIntConsumer<T1, T2> {

		void apply5(int a3, T2 a2, T1 a1);
