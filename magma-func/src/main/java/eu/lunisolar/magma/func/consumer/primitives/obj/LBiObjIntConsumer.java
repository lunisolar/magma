...
public interface LBiObjIntConsumer<T1, T2> extends LBiObjIntConsumerX<T1, T2, RuntimeException>, MetaConsumer, MetaInterface.NonThrowing {
	...
	default <V1, V2> LBiObjIntConsumer<V1, V2> biObjIntConsComposeInt(@Nonnull final LFunction<? super V1, ? extends T1> before1, @Nonnull final LFunction<? super V2, ? extends T2> before2, @Nonnull final LIntUnaryOperator before3) {
		...
		return (V1 v1, V2 v2, int v3) -> this.doAccept(before1.doApply(v1), before2.doApply(v2), before3.doApplyAsInt(v3));
	}
	...
	@FunctionalInterface
	interface V1<T1, T2> extends LBiObjIntConsumer<T1, T2> {

		void doAcceptV1(T1 a1, int a3, T2 a2);
	...
	/** Permutation of LBiObjIntConsumer for method references. */
	@FunctionalInterface
	interface V2<T2, T1> extends LBiObjIntConsumer<T1, T2> {

		void doAcceptV2(T2 a2, T1 a1, int a3);
	...
	/** Permutation of LBiObjIntConsumer for method references. */
	@FunctionalInterface
	interface V3<T2, T1> extends LBiObjIntConsumer<T1, T2> {

		void doAcceptV3(T2 a2, int a3, T1 a1);
	...
	/** Permutation of LBiObjIntConsumer for method references. */
	@FunctionalInterface
	interface V4<T1, T2> extends LBiObjIntConsumer<T1, T2> {

		void doAcceptV4(int a3, T1 a1, T2 a2);
	...
	/** Permutation of LBiObjIntConsumer for method references. */
	@FunctionalInterface
	interface V5<T2, T1> extends LBiObjIntConsumer<T1, T2> {

		void doAcceptV5(int a3, T2 a2, T1 a1);
