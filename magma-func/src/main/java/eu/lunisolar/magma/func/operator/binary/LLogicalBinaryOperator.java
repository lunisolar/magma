...
public interface LLogicalBinaryOperator extends MetaInterface.NonThrowing, MetaLogicalOperator, Codomain<aBool>, Domain2<aBool, aBool> { // NOSONAR
	...
	static void throwIf(boolean a1, boolean a2, LLogicalBinaryOperator pred, ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		if (pred.apply(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}

	static void throwIfNot(boolean a1, boolean a2, LLogicalBinaryOperator pred, ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		if (!pred.apply(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}
