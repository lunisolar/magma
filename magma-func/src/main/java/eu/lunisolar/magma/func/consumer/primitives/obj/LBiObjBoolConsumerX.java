...
public interface LBiObjBoolConsumerX<T1, T2, X extends Throwable> extends MetaConsumer, MetaInterface.Throwing<X> {
	...
	static final String DESCRIPTION = "LBiObjBoolConsumerX: void doAccept(T1 t1,T2 t2, boolean b) throws X";
	...
	default void shovingDoAccept(T1 t1, T2 t2, boolean b) {
		((LBiObjBoolConsumerX<T1, T2, RuntimeException>) this).doAccept(t1, t2, b);
	}
