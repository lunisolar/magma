...
public interface LBiDblPredicate extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain2<aDouble, aDouble> { // NOSONAR
	...
	public static double throwIf(double a1, double a2, @Nonnull LBiDblPredicate pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (pred.test(a1, a2)) {
	...
	/** Throws new exception if condition is met. */
	public static double throwIf(double a1, @Nonnull LBiDblPredicate pred, double a2, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	public static double throwIfNot(double a1, double a2, @Nonnull LBiDblPredicate pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static double throwIfNot(double a1, @Nonnull LBiDblPredicate pred, double a2, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	/** Throws new exception if condition is met. */
	public static double throwIf(double a1, double a2, @Nonnull LBiDblPredicate pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage) {
		if (pred.test(a1, a2)) {
	...
	/** Throws new exception if condition is met. */
	public static double throwIf(double a1, @Nonnull LBiDblPredicate pred, double a2, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage) {
		if (pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static double throwIfNot(double a1, double a2, @Nonnull LBiDblPredicate pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage) {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static double throwIfNot(double a1, @Nonnull LBiDblPredicate pred, double a2, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage) {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
