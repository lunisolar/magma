...
public interface LObjSrtPredicate<T> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain2<a<T>, aShort> { // NOSONAR
	...
	public static <T, X extends Throwable> T throwIf(T a1, short a2, @Nonnull LObjSrtPredicate<? super T> pred, @Nonnull ExMF<X> factory, LObjSrtFunction<? super T, ? extends String> msgFunc) throws X {
		if (pred.test(a1, a2)) {
	...
	/** Throws new exception if condition is met. */
	public static <T, X extends Throwable> T throwIfNot(T a1, short a2, @Nonnull LObjSrtPredicate<? super T> pred, @Nonnull ExMF<X> factory, LObjSrtFunction<? super T, ? extends String> msgFunc) throws X {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, msgFunc.apply(a1, a2), a1, a2);
		}
		return a1;
	...
	/** Throws new exception if condition is met. */
	public static <T, X extends Throwable> T throwIf(T a1, @Nonnull LObjSrtPredicate<? super T> pred, short a2, @Nonnull ExMF<X> factory, LObjSrtFunction<? super T, ? extends String> msgFunc) throws X {
		if (pred.test(a1, a2)) {
			throw Handling.create(factory, msgFunc.apply(a1, a2), a1, a2);
		}
		return a1;
	...
	/** Throws new exception if condition is met. */
	public static <T, X extends Throwable> T throwIfNot(T a1, @Nonnull LObjSrtPredicate<? super T> pred, short a2, @Nonnull ExMF<X> factory, LObjSrtFunction<? super T, ? extends String> msgFunc) throws X {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, msgFunc.apply(a1, a2), a1, a2);
		}
		return a1;
	...
	public static <T, X extends Throwable> T throwIfNot$(T a1, short a2, LObjSrtFunction<? super T, ? extends String> specialPredicate, @Nonnull ExMF<X> factory) throws X {
	...
	/** Throws new exception if condition is met. String is used as a result of test. Non NULL String means condition is not met and Strings content is used for exception message. */
	public static <T, X extends Throwable> T throwIfNot$(T a1, LObjSrtFunction<? super T, ? extends String> specialPredicate, short a2, @Nonnull ExMF<X> factory) throws X {
		var msg = specialPredicate.apply(a1, a2);
		if (msg != null) {
			throw Handling.create(factory, msg);
		}
	...
	/** Throws new exception if condition is met. */
	public static <T, X extends Throwable> T throwIf(T a1, short a2, @Nonnull LObjSrtPredicate<? super T> pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (pred.test(a1, a2)) {
	...
	/** Throws new exception if condition is met. */
	public static <T, X extends Throwable> T throwIf(T a1, @Nonnull LObjSrtPredicate<? super T> pred, short a2, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	public static <T, X extends Throwable> T throwIfNot(T a1, short a2, @Nonnull LObjSrtPredicate<? super T> pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <T, X extends Throwable> T throwIfNot(T a1, @Nonnull LObjSrtPredicate<? super T> pred, short a2, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	/** Throws new exception if condition is met. */
	public static <T, X extends Throwable> T throwIf(T a1, short a2, @Nonnull LObjSrtPredicate<? super T> pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (pred.test(a1, a2)) {
	...
	/** Throws new exception if condition is met. */
	public static <T, X extends Throwable> T throwIf(T a1, @Nonnull LObjSrtPredicate<? super T> pred, short a2, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <T, X extends Throwable> T throwIfNot(T a1, short a2, @Nonnull LObjSrtPredicate<? super T> pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <T, X extends Throwable> T throwIfNot(T a1, @Nonnull LObjSrtPredicate<? super T> pred, short a2, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
