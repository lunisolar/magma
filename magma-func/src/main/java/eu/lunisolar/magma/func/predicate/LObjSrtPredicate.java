...
public interface LObjSrtPredicate<T> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain2<a<T>, aShort> { // NOSONAR
	...
	public default <V> boolean doIf(V a1, T a2, short a3, @Nonnull LBiObjSrtConsumer<V, ? super T> consumer) {
		Null.nonNullArg(consumer, "consumer");
		if (test(a2, a3)) {
	...
	public default LSrtPredicate lShrink(@Nonnull LSrtFunction<T> left) {
		Null.nonNullArg(left, "left");
		return a2 -> test(left.apply(a2), a2);
	}

	public default LSrtPredicate lShrink_(T a1) {
	...
	public default LPredicate<T> rShrink(@Nonnull LToSrtFunction<T> right) {
		Null.nonNullArg(right, "right");
		return a1 -> test(a1, right.applyAsSrt(a1));
	}

	public default LPredicate<T> rShrink_(short a2) {
	...
	public default LObjSrtConsumer<T> toConsumer() {
		return this::test;
	}

	/** Calls domain consumer before main function. */
	public default LObjSrtPredicate<T> beforeDo(@Nonnull LObjSrtConsumer<T> before) {
	...
	public default LObjSrtPredicate<T> afterDo(@Nonnull LBoolConsumer after) {
	...
	public static <T, X extends Throwable> T throwIf(T a1, short a2, @Nonnull LObjSrtPredicate<T> pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (pred.test(a1, a2)) {
	...
	/** Throws new exception if condition is met. */
	public static <T, X extends Throwable> T throwIf(T a1, @Nonnull LObjSrtPredicate<T> pred, short a2, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	public static <T, X extends Throwable> T throwIfNot(T a1, short a2, @Nonnull LObjSrtPredicate<T> pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <T, X extends Throwable> T throwIfNot(T a1, @Nonnull LObjSrtPredicate<T> pred, short a2, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	/** Throws new exception if condition is met. */
	public static <T, X extends Throwable> T throwIf(T a1, short a2, @Nonnull LObjSrtPredicate<T> pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (pred.test(a1, a2)) {
	...
	/** Throws new exception if condition is met. */
	public static <T, X extends Throwable> T throwIf(T a1, @Nonnull LObjSrtPredicate<T> pred, short a2, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <T, X extends Throwable> T throwIfNot(T a1, short a2, @Nonnull LObjSrtPredicate<T> pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <T, X extends Throwable> T throwIfNot(T a1, @Nonnull LObjSrtPredicate<T> pred, short a2, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
