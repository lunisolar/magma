...
public interface LLongUnaryOperatorX<X extends Throwable> extends LongUnaryOperator, MetaOperator, MetaInterface.Throwing<X> { // NOSONAR
	...
	String DESCRIPTION = "LLongUnaryOperatorX: long doApplyAsLong(long a) throws X";
	...
	long doApplyAsLong(long a) throws X;
	...
	default long shovingDoApplyAsLong(long a) {
		return ((LLongUnaryOperatorX<RuntimeException>) this).doApplyAsLong(a);
	}

	/** Function call that handles exceptions according to the instructions. */
	default <Y extends Throwable> long handlingDoApplyAsLong(long a, HandlingInstructions<Throwable, Y> handling) throws Y {
	...
	default long nonNullDoApplyAsLong(long a) throws X {
	...
	default LLongSupplierX<X> captureLongUnaryOp(long a) {
		return () -> this.doApplyAsLong(a);
	}
	...
	static <X extends Throwable> long call(long a, final @Nonnull LLongUnaryOperatorX<X> lambda) throws X {
		Null.nonNullArg(lambda, "lambda");
		return lambda.doApplyAsLong(a);
	}

	static <X extends Throwable> long shoving(long a, final @Nonnull LLongUnaryOperatorX<X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.shovingDoApplyAsLong(a);
	}

	static <X extends Throwable> long nesting(long a, final @Nonnull LLongUnaryOperatorX<X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.nestingDoApplyAsLong(a);
	}

	static <X extends Throwable, Y extends Throwable> long handling(long a, final HandlingInstructions<Throwable, Y> handling, final @Nonnull LLongUnaryOperatorX<X> lambda) throws Y {
		Null.nonNullArg(lambda, "lambda");
	...
	@Nonnull
	default LLongUnaryOperatorX<X> longUnaryOpComposeLong(@Nonnull final LLongUnaryOperatorX<X> before) {
	...
	/** Allows to manipulate the domain of the function. */
	@Nonnull
	default <V> LToLongFunctionX<V, X> longUnaryOpCompose(@Nonnull final LToLongFunctionX<? super V, X> before) {
		Null.nonNullArg(before, "before");
		return v -> this.doApplyAsLong(before.doApplyAsLong(v));
	}
