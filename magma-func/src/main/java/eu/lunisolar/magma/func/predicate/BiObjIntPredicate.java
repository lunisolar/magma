...
/**
 * Non-throwing functional interface (lambda) BiObjIntPredicate for Java 8.
 *
 * Type: predicate
 *
...
public interface BiObjIntPredicate<T1, T2> extends BiObjIntPredicateX<T1, T2, RuntimeException>, MetaPredicate, PrimitiveCodomain<Object>, MetaInterface.NonThrowing { // NOSONAR
	...
	public static <T1, T2> BiObjIntPredicate<T1, T2> constant(boolean r) {
		return (t1, t2, i) -> r;
	}
