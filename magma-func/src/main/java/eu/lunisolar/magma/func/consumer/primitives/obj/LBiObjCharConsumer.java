...
public interface LBiObjCharConsumer<T1, T2> extends MetaConsumer, MetaInterface.NonThrowing, Codomain<aVoid>, Domain3<a<T1>, a<T2>, aChar> {
	...
	public static <T2, T1> LObjCharConsumer<T2> lShrinkedc(T1 a1, LBiObjCharConsumer<T1, T2> func) {
	...
	public static <T1, T2> LBiConsumer<T1, T2> rShrinkedc(char a3, LBiObjCharConsumer<T1, T2> func) {
	...
	@Nonnull
	static <T1, T2> LBiObjCharConsumer<T1, T2> biObjCharCons(Class<T1> c1, Class<T2> c2, final @Nonnull LBiObjCharConsumer<T1, T2> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
