...
public interface LBiObjCharConsumer<T1, T2> extends LBiObjCharConsumerX<T1, T2, RuntimeException>, MetaConsumer, MetaInterface.NonThrowing {
	...
	interface V1<T1, T2> extends LBiObjCharConsumer<T1, T2> {
		...
		void apply1(T1 a1, char a3, T2 a2);
	...
	/** Permutation of LBiObjCharConsumer for method references. */
	@FunctionalInterface
	interface V2<T1, T2> extends LBiObjCharConsumer<T1, T2> {

		void apply2(T2 a2, T1 a1, char a3);
	...
	/** Permutation of LBiObjCharConsumer for method references. */
	@FunctionalInterface
	interface V3<T1, T2> extends LBiObjCharConsumer<T1, T2> {

		void apply3(T2 a2, char a3, T1 a1);
	...
	interface V4<T1, T2> extends LBiObjCharConsumer<T1, T2> {
		...
		void apply4(char a3, T1 a1, T2 a2);
	...
	/** Permutation of LBiObjCharConsumer for method references. */
	@FunctionalInterface
	interface V5<T1, T2> extends LBiObjCharConsumer<T1, T2> {

		void apply5(char a3, T2 a2, T1 a1);
