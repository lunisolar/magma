...
public interface LBoolPair extends LTuple<Boolean>, Comparable<LBoolPair> {
	...
	public static Iterator<LBoolPair.MutBoolPair> mutIterator(PrimitiveIterator.OfInt items) {
		return iterator(items, LBoolPair::of);
	}

	public static Iterator<LBoolPair> immIterator(PrimitiveIterator.OfInt items) {
		return iterator(items, LBoolPair::immutableOf);
	}
	...
	public static Stream<LBoolPair.MutBoolPair> mutStream(IntStream items) {
		return stream(items, LBoolPair::of);
	}

	public static Stream<LBoolPair> immStream(IntStream items) {
		return stream(items, LBoolPair::immutableOf);
	}
