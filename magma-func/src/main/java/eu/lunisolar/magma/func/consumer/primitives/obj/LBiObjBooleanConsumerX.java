...
public interface LBiObjBooleanConsumerX<T1, T2, X extends Exception> extends MetaConsumer, MetaInterface.Throwing<X> {
	...
	@Nonnull
	public static <T1, T2, X extends Exception> LBiObjBooleanConsumerX<T1, T2, X> lX(final @Nonnull LBiObjBooleanConsumerX<T1, T2, X> lambda) {
	 ...
	 */
	@Nonnull
	default <V1, V2> LBiObjBooleanConsumerX<V1, V2, X> fromBoolean(@Nonnull final LFunctionX<? super V1, ? extends T1, X> before1, @Nonnull final LFunctionX<? super V2, ? extends T2, X> before2, @Nonnull final LBooleanUnaryOperatorX<X> before3) {
	 ...
	 */
	@Nonnull
	default <V1, V2, V3> LTriConsumerX<V1, V2, V3, X> from(@Nonnull final LFunctionX<? super V1, ? extends T1, X> before1, @Nonnull final LFunctionX<? super V2, ? extends T2, X> before2, @Nonnull final LPredicateX<? super V3, X> before3) {
		Objects.requireNonNull(before1, Function4U.VALIDATION_MESSAGE_BEFORE1);
		Objects.requireNonNull(before2, Function4U.VALIDATION_MESSAGE_BEFORE2);
		Objects.requireNonNull(before3, Function4U.VALIDATION_MESSAGE_BEFORE3);
	...
	@Nonnull
	default LBiObjBooleanConsumer<T1, T2> nonThrowing() {
		return LBiObjBooleanConsumer.wrap(this);
	}

	/** Converts to throwing variant (RuntimeException). */
	@Nonnull
	default LBiObjBooleanConsumerX<T1, T2, RuntimeException> uncheck() {
		return (LBiObjBooleanConsumerX) this;
	}
	...
	@Nonnull
	default <E extends Exception, Y extends Exception> LBiObjBooleanConsumerX<T1, T2, Y> handleX(Class<E> exception, ExceptionHandler<E, Y> handler) {
		Objects.requireNonNull(exception, Function4U.VALIDATION_MESSAGE_EXCEPTION);
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return LBiObjBooleanConsumerX.wrapException(this, exception, (ExceptionHandler) handler);
	}

	/** Wraps with exception handling that for any exception (including unchecked exception that might be different from X) will call handler function to determine the final exception. */
	@Nonnull
	default <Y extends Exception> LBiObjBooleanConsumerX<T1, T2, Y> handleX(ExceptionHandler<Exception, Y> handler) {
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return LBiObjBooleanConsumerX.wrapException(this, Exception.class, (ExceptionHandler) handler);
	}
