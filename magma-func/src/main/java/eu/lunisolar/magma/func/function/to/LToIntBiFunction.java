...
public interface LToIntBiFunction<T1, T2> extends LToIntBiFunctionX<T1, T2, RuntimeException>, MetaFunction, MetaInterface.NonThrowing { // NOSONAR
	...
	default Integer tupleApplyAsInt(LPair<T1, T2> args) {
	...
	@FunctionalInterface
	interface V1<T1, T2> extends LToIntBiFunction<T1, T2> {

		int apply1(T2 a2, T1 a1);
