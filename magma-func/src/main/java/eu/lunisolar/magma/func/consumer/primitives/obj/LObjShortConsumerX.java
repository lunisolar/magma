...
public interface LObjShortConsumerX<T, X extends Throwable> extends MetaConsumer, MetaInterface.Throwing<X> {
	...
	/** Safe instance. */
	@Nonnull
	static <T, X extends Throwable> LObjShortConsumerX<T, X> safe() {
		return Function4U::doNothing;
	}

	/** Safe instance supplier. Returns supplier of safe() instance. */
	@Nonnull
	static <T, X extends Throwable, Y extends Throwable> LSupplierX<LObjShortConsumerX<T, X>, Y> safeSupplier() {
		return () -> safe();
	}

	/** Safe wrapping. Either argument function is returned (if it is not null) or safe() instance. */
	@Nonnull
	static <T, X extends Throwable> LObjShortConsumerX<T, X> safe(final @Nullable LObjShortConsumerX<T, X> other) {
		if (other == null) {
			return safe();
		} else {
			return other;
	...
	@Nonnull
	static <T, X extends Throwable, Y extends Throwable> LSupplierX<LObjShortConsumerX<T, X>, Y> safeSupplier(final @Nullable LSupplierX<LObjShortConsumerX<T, X>, Y> supplier) {
		if (supplier == null) {
			return safeSupplier();
		} else {
			return supplier;
	...
	/** Combines two LObjShortConsumerX<T,X> together in a order. */
	@Nonnull
	...
	/** Permutation of LObjShortConsumerX for method references. */
	@FunctionalInterface
	interface V1<T, X extends Throwable> extends LObjShortConsumerX<T, X> {

		void doAcceptV1(short a2, T a1) throws X;

		@Override
		default void doAccept(T a1, short a2) throws X {
