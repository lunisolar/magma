...
public interface LQuadPredicate<T1, T2, T3, T4> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain4<a<T1>, a<T2>, a<T3>, a<T4>> { // NOSONAR
	...
	default boolean test(T1 a1, T2 a2, T3 a3, T4 a4, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		try {
			return this.testX(a1, a2, a3, a4);
		} catch (Throwable e) { // NOSONAR
	...
	default LQuadPredicate<T1, T2, T3, T4> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		return (a1, a2, a3, a4) -> test(a1, a2, a3, a4, exF, newMessage, messageParams);
	}
	...
	static <T1, T2, T3, T4> boolean tryTest(T1 a1, T2 a2, T3 a3, T4 a4, LQuadPredicate<T1, T2, T3, T4> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		Null.nonNullArg(func, "func");
		return func.test(a1, a2, a3, a4, exF, newMessage, messageParams);
	}
	...
	public static <T1, T2, T3, T4> void throwIf(T1 a1, T2 a2, T3 a3, T4 a4, @Nonnull LQuadPredicate<T1, T2, T3, T4> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
	...
	public static <T1, T2, T3, T4> T1 complying(T1 a1, T2 a2, T3 a3, T4 a4, @Nonnull LQuadPredicate<T1, T2, T3, T4> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (pred.test(a1, a2, a3, a4)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	public static <T1, T2, T3, T4> T1 notComplying(T1 a1, T2 a2, T3 a3, T4 a4, @Nonnull LQuadPredicate<T1, T2, T3, T4> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (!pred.test(a1, a2, a3, a4)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	static <T1, T2, T3, T4> LQuadPredicate<T1, T2, T3, T4> recursive(final @Nonnull LFunction<LQuadPredicate<T1, T2, T3, T4>, LQuadPredicate<T1, T2, T3, T4>> selfLambda) {
		final LQuadPredicateSingle<T1, T2, T3, T4> single = new LQuadPredicateSingle();
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2, T4, T3> LBiObj1Obj3Obj2Pred<T1, T2, T4, T3> biObj1Obj3Obj2Pred(final @Nonnull LBiObj1Obj3Obj2Pred<T1, T2, T4, T3> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T3, T2, T4> LObj0Obj2BiObj3Pred<T1, T3, T2, T4> obj0Obj2BiObj3Pred(final @Nonnull LObj0Obj2BiObj3Pred<T1, T3, T2, T4> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T3, T4, T2> LObj0Obj2Obj3Obj1Pred<T1, T3, T4, T2> obj0Obj2Obj3Obj1Pred(final @Nonnull LObj0Obj2Obj3Obj1Pred<T1, T3, T4, T2> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T4, T2, T3> LObj0Obj3Obj1Obj2Pred<T1, T4, T2, T3> obj0Obj3Obj1Obj2Pred(final @Nonnull LObj0Obj3Obj1Obj2Pred<T1, T4, T2, T3> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T4, T3, T2> LObj0BiObj2Obj1Pred<T1, T4, T3, T2> obj0BiObj2Obj1Pred(final @Nonnull LObj0BiObj2Obj1Pred<T1, T4, T3, T2> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1, T3, T4> LObj1TriObj3Pred<T2, T1, T3, T4> obj1TriObj3Pred(final @Nonnull LObj1TriObj3Pred<T2, T1, T3, T4> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1, T4, T3> LObj1Obj0Obj3Obj2Pred<T2, T1, T4, T3> obj1Obj0Obj3Obj2Pred(final @Nonnull LObj1Obj0Obj3Obj2Pred<T2, T1, T4, T3> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T3, T1, T4> LObj1Obj2BiObj3Pred<T2, T3, T1, T4> obj1Obj2BiObj3Pred(final @Nonnull LObj1Obj2BiObj3Pred<T2, T3, T1, T4> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T3, T4, T1> LObj1Obj2Obj3Obj0Pred<T2, T3, T4, T1> obj1Obj2Obj3Obj0Pred(final @Nonnull LObj1Obj2Obj3Obj0Pred<T2, T3, T4, T1> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T4, T1, T3> LObj1Obj3Obj0Obj2Pred<T2, T4, T1, T3> obj1Obj3Obj0Obj2Pred(final @Nonnull LObj1Obj3Obj0Obj2Pred<T2, T4, T1, T3> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T4, T3, T1> LObj1BiObj2Obj0Pred<T2, T4, T3, T1> obj1BiObj2Obj0Pred(final @Nonnull LObj1BiObj2Obj0Pred<T2, T4, T3, T1> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T3, T1, T2, T4> LObj2Obj0BiObj3Pred<T3, T1, T2, T4> obj2Obj0BiObj3Pred(final @Nonnull LObj2Obj0BiObj3Pred<T3, T1, T2, T4> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T3, T1, T4, T2> LObj2Obj0Obj3Obj1Pred<T3, T1, T4, T2> obj2Obj0Obj3Obj1Pred(final @Nonnull LObj2Obj0Obj3Obj1Pred<T3, T1, T4, T2> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T3, T2, T1, T4> LBiObj1BiObj3Pred<T3, T2, T1, T4> biObj1BiObj3Pred(final @Nonnull LBiObj1BiObj3Pred<T3, T2, T1, T4> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T3, T2, T4, T1> LBiObj1Obj3Obj0Pred<T3, T2, T4, T1> biObj1Obj3Obj0Pred(final @Nonnull LBiObj1Obj3Obj0Pred<T3, T2, T4, T1> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T3, T4, T1, T2> LObj2Obj3Obj0Obj1Pred<T3, T4, T1, T2> obj2Obj3Obj0Obj1Pred(final @Nonnull LObj2Obj3Obj0Obj1Pred<T3, T4, T1, T2> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T3, T4, T2, T1> LObj2Obj3Obj1Obj0Pred<T3, T4, T2, T1> obj2Obj3Obj1Obj0Pred(final @Nonnull LObj2Obj3Obj1Obj0Pred<T3, T4, T2, T1> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T4, T1, T2, T3> LObj3Obj0Obj1Obj2Pred<T4, T1, T2, T3> obj3Obj0Obj1Obj2Pred(final @Nonnull LObj3Obj0Obj1Obj2Pred<T4, T1, T2, T3> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T4, T1, T3, T2> LObj3BiObj2Obj1Pred<T4, T1, T3, T2> obj3BiObj2Obj1Pred(final @Nonnull LObj3BiObj2Obj1Pred<T4, T1, T3, T2> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T4, T2, T1, T3> LBiObj1Obj0Obj2Pred<T4, T2, T1, T3> biObj1Obj0Obj2Pred(final @Nonnull LBiObj1Obj0Obj2Pred<T4, T2, T1, T3> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T4, T2, T3, T1> LTriObj2Obj0Pred<T4, T2, T3, T1> triObj2Obj0Pred(final @Nonnull LTriObj2Obj0Pred<T4, T2, T3, T1> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T4, T3, T1, T2> LObj3Obj2Obj0Obj1Pred<T4, T3, T1, T2> obj3Obj2Obj0Obj1Pred(final @Nonnull LObj3Obj2Obj0Obj1Pred<T4, T3, T1, T2> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T4, T3, T2, T1> LObj3Obj2Obj1Obj0Pred<T4, T3, T2, T1> obj3Obj2Obj1Obj0Pred(final @Nonnull LObj3Obj2Obj1Obj0Pred<T4, T3, T2, T1> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Permutation of LQuadPredicate for method references. */
	@FunctionalInterface
	interface LBiObj1Obj3Obj2Pred<T1, T2, T4, T3> extends LQuadPredicate<T1, T2, T3, T4> {

		boolean testBiObj1Obj3Obj2(T1 a1, T2 a2, T4 a4, T3 a3);

		@Override
		default boolean testX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.testBiObj1Obj3Obj2(a1, a2, a4, a3);
		}
	}

	/** Permutation of LQuadPredicate for method references. */
	@FunctionalInterface
	interface LObj0Obj2BiObj3Pred<T1, T3, T2, T4> extends LQuadPredicate<T1, T2, T3, T4> {

		boolean testObj0Obj2BiObj3(T1 a1, T3 a3, T2 a2, T4 a4);

		@Override
		default boolean testX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.testObj0Obj2BiObj3(a1, a3, a2, a4);
		}
	}

	/** Permutation of LQuadPredicate for method references. */
	@FunctionalInterface
	interface LObj0Obj2Obj3Obj1Pred<T1, T3, T4, T2> extends LQuadPredicate<T1, T2, T3, T4> {

		boolean testObj0Obj2Obj3Obj1(T1 a1, T3 a3, T4 a4, T2 a2);

		@Override
		default boolean testX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.testObj0Obj2Obj3Obj1(a1, a3, a4, a2);
		}
	}

	/** Permutation of LQuadPredicate for method references. */
	@FunctionalInterface
	interface LObj0Obj3Obj1Obj2Pred<T1, T4, T2, T3> extends LQuadPredicate<T1, T2, T3, T4> {

		boolean testObj0Obj3Obj1Obj2(T1 a1, T4 a4, T2 a2, T3 a3);

		@Override
		default boolean testX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.testObj0Obj3Obj1Obj2(a1, a4, a2, a3);
		}
	}

	/** Permutation of LQuadPredicate for method references. */
	@FunctionalInterface
	interface LObj0BiObj2Obj1Pred<T1, T4, T3, T2> extends LQuadPredicate<T1, T2, T3, T4> {

		boolean testObj0BiObj2Obj1(T1 a1, T4 a4, T3 a3, T2 a2);

		@Override
		default boolean testX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.testObj0BiObj2Obj1(a1, a4, a3, a2);
		}
	}

	/** Permutation of LQuadPredicate for method references. */
	@FunctionalInterface
	interface LObj1TriObj3Pred<T2, T1, T3, T4> extends LQuadPredicate<T1, T2, T3, T4> {

		boolean testObj1TriObj3(T2 a2, T1 a1, T3 a3, T4 a4);

		@Override
		default boolean testX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.testObj1TriObj3(a2, a1, a3, a4);
		}
	}

	/** Permutation of LQuadPredicate for method references. */
	@FunctionalInterface
	interface LObj1Obj0Obj3Obj2Pred<T2, T1, T4, T3> extends LQuadPredicate<T1, T2, T3, T4> {

		boolean testObj1Obj0Obj3Obj2(T2 a2, T1 a1, T4 a4, T3 a3);

		@Override
		default boolean testX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.testObj1Obj0Obj3Obj2(a2, a1, a4, a3);
		}
	}

	/** Permutation of LQuadPredicate for method references. */
	@FunctionalInterface
	interface LObj1Obj2BiObj3Pred<T2, T3, T1, T4> extends LQuadPredicate<T1, T2, T3, T4> {

		boolean testObj1Obj2BiObj3(T2 a2, T3 a3, T1 a1, T4 a4);

		@Override
		default boolean testX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.testObj1Obj2BiObj3(a2, a3, a1, a4);
		}
	}

	/** Permutation of LQuadPredicate for method references. */
	@FunctionalInterface
	interface LObj1Obj2Obj3Obj0Pred<T2, T3, T4, T1> extends LQuadPredicate<T1, T2, T3, T4> {

		boolean testObj1Obj2Obj3Obj0(T2 a2, T3 a3, T4 a4, T1 a1);

		@Override
		default boolean testX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.testObj1Obj2Obj3Obj0(a2, a3, a4, a1);
		}
	}

	/** Permutation of LQuadPredicate for method references. */
	@FunctionalInterface
	interface LObj1Obj3Obj0Obj2Pred<T2, T4, T1, T3> extends LQuadPredicate<T1, T2, T3, T4> {

		boolean testObj1Obj3Obj0Obj2(T2 a2, T4 a4, T1 a1, T3 a3);

		@Override
		default boolean testX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.testObj1Obj3Obj0Obj2(a2, a4, a1, a3);
		}
	}

	/** Permutation of LQuadPredicate for method references. */
	@FunctionalInterface
	interface LObj1BiObj2Obj0Pred<T2, T4, T3, T1> extends LQuadPredicate<T1, T2, T3, T4> {

		boolean testObj1BiObj2Obj0(T2 a2, T4 a4, T3 a3, T1 a1);

		@Override
		default boolean testX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.testObj1BiObj2Obj0(a2, a4, a3, a1);
		}
	}

	/** Permutation of LQuadPredicate for method references. */
	@FunctionalInterface
	interface LObj2Obj0BiObj3Pred<T3, T1, T2, T4> extends LQuadPredicate<T1, T2, T3, T4> {

		boolean testObj2Obj0BiObj3(T3 a3, T1 a1, T2 a2, T4 a4);

		@Override
		default boolean testX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.testObj2Obj0BiObj3(a3, a1, a2, a4);
		}
	}

	/** Permutation of LQuadPredicate for method references. */
	@FunctionalInterface
	interface LObj2Obj0Obj3Obj1Pred<T3, T1, T4, T2> extends LQuadPredicate<T1, T2, T3, T4> {

		boolean testObj2Obj0Obj3Obj1(T3 a3, T1 a1, T4 a4, T2 a2);

		@Override
		default boolean testX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.testObj2Obj0Obj3Obj1(a3, a1, a4, a2);
		}
	}

	/** Permutation of LQuadPredicate for method references. */
	@FunctionalInterface
	interface LBiObj1BiObj3Pred<T3, T2, T1, T4> extends LQuadPredicate<T1, T2, T3, T4> {

		boolean testBiObj1BiObj3(T3 a3, T2 a2, T1 a1, T4 a4);

		@Override
		default boolean testX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.testBiObj1BiObj3(a3, a2, a1, a4);
		}
	}

	/** Permutation of LQuadPredicate for method references. */
	@FunctionalInterface
	interface LBiObj1Obj3Obj0Pred<T3, T2, T4, T1> extends LQuadPredicate<T1, T2, T3, T4> {

		boolean testBiObj1Obj3Obj0(T3 a3, T2 a2, T4 a4, T1 a1);

		@Override
		default boolean testX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.testBiObj1Obj3Obj0(a3, a2, a4, a1);
		}
	}

	/** Permutation of LQuadPredicate for method references. */
	@FunctionalInterface
	interface LObj2Obj3Obj0Obj1Pred<T3, T4, T1, T2> extends LQuadPredicate<T1, T2, T3, T4> {

		boolean testObj2Obj3Obj0Obj1(T3 a3, T4 a4, T1 a1, T2 a2);

		@Override
		default boolean testX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.testObj2Obj3Obj0Obj1(a3, a4, a1, a2);
		}
	}

	/** Permutation of LQuadPredicate for method references. */
	@FunctionalInterface
	interface LObj2Obj3Obj1Obj0Pred<T3, T4, T2, T1> extends LQuadPredicate<T1, T2, T3, T4> {

		boolean testObj2Obj3Obj1Obj0(T3 a3, T4 a4, T2 a2, T1 a1);

		@Override
		default boolean testX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.testObj2Obj3Obj1Obj0(a3, a4, a2, a1);
		}
	}

	/** Permutation of LQuadPredicate for method references. */
	@FunctionalInterface
	interface LObj3Obj0Obj1Obj2Pred<T4, T1, T2, T3> extends LQuadPredicate<T1, T2, T3, T4> {

		boolean testObj3Obj0Obj1Obj2(T4 a4, T1 a1, T2 a2, T3 a3);

		@Override
		default boolean testX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.testObj3Obj0Obj1Obj2(a4, a1, a2, a3);
		}
	}

	/** Permutation of LQuadPredicate for method references. */
	@FunctionalInterface
	interface LObj3BiObj2Obj1Pred<T4, T1, T3, T2> extends LQuadPredicate<T1, T2, T3, T4> {

		boolean testObj3BiObj2Obj1(T4 a4, T1 a1, T3 a3, T2 a2);

		@Override
		default boolean testX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.testObj3BiObj2Obj1(a4, a1, a3, a2);
		}
	}

	/** Permutation of LQuadPredicate for method references. */
	@FunctionalInterface
	interface LBiObj1Obj0Obj2Pred<T4, T2, T1, T3> extends LQuadPredicate<T1, T2, T3, T4> {

		boolean testBiObj1Obj0Obj2(T4 a4, T2 a2, T1 a1, T3 a3);

		@Override
		default boolean testX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.testBiObj1Obj0Obj2(a4, a2, a1, a3);
		}
	}

	/** Permutation of LQuadPredicate for method references. */
	@FunctionalInterface
	interface LTriObj2Obj0Pred<T4, T2, T3, T1> extends LQuadPredicate<T1, T2, T3, T4> {

		boolean testTriObj2Obj0(T4 a4, T2 a2, T3 a3, T1 a1);

		@Override
		default boolean testX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.testTriObj2Obj0(a4, a2, a3, a1);
		}
	}

	/** Permutation of LQuadPredicate for method references. */
	@FunctionalInterface
	interface LObj3Obj2Obj0Obj1Pred<T4, T3, T1, T2> extends LQuadPredicate<T1, T2, T3, T4> {

		boolean testObj3Obj2Obj0Obj1(T4 a4, T3 a3, T1 a1, T2 a2);

		@Override
		default boolean testX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.testObj3Obj2Obj0Obj1(a4, a3, a1, a2);
		}
	}

	/** Permutation of LQuadPredicate for method references. */
	@FunctionalInterface
	interface LObj3Obj2Obj1Obj0Pred<T4, T3, T2, T1> extends LQuadPredicate<T1, T2, T3, T4> {

		boolean testObj3Obj2Obj1Obj0(T4 a4, T3 a3, T2 a2, T1 a1);

		@Override
		default boolean testX(T1 a1, T2 a2, T3 a3, T4 a4) {
			return this.testObj3Obj2Obj1Obj0(a4, a3, a2, a1);
		}
	}
