...
public interface LQuadPredicate<T1, T2, T3, T4> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain4<a<T1>, a<T2>, a<T3>, a<T4>> { // NOSONAR
	 ...
	 */
	public static <T1, T2, T3, T4> M<T1, T2, T3, T4> memento(boolean initialValue, LQuadPredicate<T1, T2, T3, T4> baseFunction, LLogicalBinaryOperator mementoFunction) {
		return new M(initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not ). Very short name is intended to be used with parent (LQuadPredicate.D)
	 */
	final class M<T1, T2, T3, T4> implements LQuadPredicate<T1, T2, T3, T4> {
		...
		private M(boolean lastValue, LQuadPredicate<T1, T2, T3, T4> baseFunction, LLogicalBinaryOperator mementoFunction) {
		...
		@Override
		public boolean testX(T1 a1, T2 a2, T3 a3, T4 a4) throws Throwable {
			boolean x2 = baseFunction.testX(a1, a2, a3, a4);
