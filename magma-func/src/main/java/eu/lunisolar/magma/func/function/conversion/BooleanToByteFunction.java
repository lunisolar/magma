...
/**
 * Non-throwing functional interface (lambda) BooleanToByteFunction for Java 8.
 *
 * Type: function
 *
...
public interface BooleanToByteFunction extends BooleanToByteFunctionX<RuntimeException>, MetaFunction, PrimitiveCodomain<Object>, MetaInterface.NonThrowing { // NOSONAR
