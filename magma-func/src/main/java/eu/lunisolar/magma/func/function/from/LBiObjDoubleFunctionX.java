...
public interface LBiObjDoubleFunctionX<T1, T2, R, X extends Throwable> extends MetaFunction, MetaInterface.Throwing<X> { // NOSONAR
	...
	String DESCRIPTION = "LBiObjDoubleFunctionX: R doApply(T1 a1,T2 a2,double a3) throws X";

	@Nullable
	R doApply(T1 a1, T2 a2, double a3) throws X;

	default R tupleApply(LBiObjDoubleTriple<T1, T2> args) throws X {
	...
	default R shovingDoApply(T1 a1, T2 a2, double a3) {
		return ((LBiObjDoubleFunctionX<T1, T2, R, RuntimeException>) this).doApply(a1, a2, a3);
	}

	/** Function call that handles exceptions according to the instructions. */
	default <Y extends Throwable> R handlingDoApply(T1 a1, T2 a2, double a3, HandlingInstructions<Throwable, Y> handling) throws Y {
	...
	@Nonnull
	default R nonNullDoApply(T1 a1, T2 a2, double a3) throws X {
	...
	default LSupplierX<R, X> captureBiObjDoubleFunc(T1 a1, T2 a2, double a3) {
		return () -> this.doApply(a1, a2, a3);
	}
	...
	@Nonnull
	static <T1, T2, R, X extends Throwable> LBiObjDoubleFunctionX<T1, T2, R, X> apply1st(@Nonnull LFunctionX<T1, R, X> func) {
		return (a1, a2, a3) -> func.doApply(a1);
	}

	/** Captures single parameter function into this interface where only 2nd parameter will be used. */
	@Nonnull
	static <T1, T2, R, X extends Throwable> LBiObjDoubleFunctionX<T1, T2, R, X> apply2nd(@Nonnull LFunctionX<T2, R, X> func) {
		return (a1, a2, a3) -> func.doApply(a2);
	}

	/** Captures single parameter function into this interface where only 3rd parameter will be used. */
	@Nonnull
	static <T1, T2, R, X extends Throwable> LBiObjDoubleFunctionX<T1, T2, R, X> apply3rd(@Nonnull LDoubleFunctionX<R, X> func) {
	...
	static <T1, T2, R, X extends Throwable> R shoving(T1 a1, T2 a2, double a3, final @Nonnull LBiObjDoubleFunctionX<T1, T2, R, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.shovingDoApply(a1, a2, a3);
	}

	static <T1, T2, R, X extends Throwable> R nesting(T1 a1, T2 a2, double a3, final @Nonnull LBiObjDoubleFunctionX<T1, T2, R, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.nestingDoApply(a1, a2, a3);
	}

	static <T1, T2, R, X extends Throwable, Y extends Throwable> R handling(T1 a1, T2 a2, double a3, final HandlingInstructions<Throwable, Y> handling, final @Nonnull LBiObjDoubleFunctionX<T1, T2, R, X> lambda) throws Y {
		Null.nonNullArg(lambda, "lambda");
	...
	@Nonnull
	default <V1, V2> LBiObjDoubleFunctionX<V1, V2, R, X> biObjDoubleFuncComposeDouble(@Nonnull final LFunctionX<? super V1, ? extends T1, X> before1, @Nonnull final LFunctionX<? super V2, ? extends T2, X> before2,
	...
	/** Allows to manipulate the domain of the function. */
	@Nonnull
	default <V1, V2, V3> LTriFunctionX<V1, V2, V3, R, X> biObjDoubleFuncCompose(@Nonnull final LFunctionX<? super V1, ? extends T1, X> before1, @Nonnull final LFunctionX<? super V2, ? extends T2, X> before2,
	...
	@Nonnull
	default LBiObjDoubleFunctionX<T1, T2, R, X> nonNullBiObjDoubleFunc() {
