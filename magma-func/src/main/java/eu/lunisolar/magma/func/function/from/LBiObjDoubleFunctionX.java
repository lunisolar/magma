...
public interface LBiObjDoubleFunctionX<T1, T2, R, X extends Exception> extends MetaFunction, MetaInterface.Throwing<X> { // NOSONAR
	...
	@Nonnull
	public static <T1, T2, R, X extends Exception> LBiObjDoubleFunctionX<T1, T2, R, X> lX(final @Nonnull LBiObjDoubleFunctionX<T1, T2, R, X> lambda) {
	...
	default LBiObjDoubleFunction<T1, T2, R> nonThrowing() {
		return LBiObjDoubleFunction.wrap(this);
	}
	...
	@Nonnull
	public static <T1, T2, R, X extends Exception, E extends Exception, Y extends Exception> LBiObjDoubleFunctionX<T1, T2, R, Y> wrapException(@Nonnull final LBiObjDoubleFunctionX<T1, T2, R, X> other, Class<E> exception, LSupplierX<R, X> supplier,
	...
	@Nonnull
	default <E extends Exception, Y extends Exception> LBiObjDoubleFunctionX<T1, T2, R, Y> handleX(Class<E> exception, ExceptionHandler<E, Y> handler) {
		Objects.requireNonNull(exception, Function4U.VALIDATION_MESSAGE_EXCEPTION);
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return LBiObjDoubleFunctionX.wrapException(this, exception, null, (ExceptionHandler) handler);
	}

	/** Wraps with exception handling that for any exception (including unchecked exception that might be different from X) will call handler function to determine the final exception. */
	@Nonnull
	default <Y extends Exception> LBiObjDoubleFunctionX<T1, T2, R, Y> handleX(ExceptionHandler<Exception, Y> handler) {
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return LBiObjDoubleFunctionX.wrapException(this, Exception.class, null, (ExceptionHandler) handler);
	}

	/** Wraps with exception handling that for argument exception class will call supplier and return default value instead for propagating exception.  */
	@Nonnull
	default <E extends Exception, Y extends Exception> LBiObjDoubleFunctionX<T1, T2, R, Y> handleX(Class<E> exception, LSupplierX<R, X> supplier) {
		Objects.requireNonNull(exception, Function4U.VALIDATION_MESSAGE_EXCEPTION);
		Objects.requireNonNull(supplier, Function4U.VALIDATION_MESSAGE_HANDLER);

		return LBiObjDoubleFunctionX.wrapException(this, exception, supplier, null);
	}

	/** Wraps with exception handling that for any exception will call supplier and return default value instead for propagating exception.  */
	@Nonnull
	default <Y extends Exception> LBiObjDoubleFunctionX<T1, T2, R, Y> handleX(LSupplierX<R, X> supplier) {
		Objects.requireNonNull(supplier, Function4U.VALIDATION_MESSAGE_HANDLER);

		return LBiObjDoubleFunctionX.wrapException(this, Exception.class, supplier, null);
	}
