...
public interface LIntToFloatFunctionX<X extends Exception> extends MetaFunction, PrimitiveCodomain<Object>, MetaInterface.Throwing<X> { // NOSONAR
	...
	public static final String DESCRIPTION = "LIntToFloatFunctionX: float applyAsFloat(int i) throws X";
	...
	default LIntToFloatFunction nonThrowing() {
		return LIntToFloatFunction.wrap(this);
	}
	...
	default LIntToFloatFunction shove() {
		LIntToFloatFunctionX<RuntimeException> exceptionCast = (LIntToFloatFunctionX<RuntimeException>) this;
