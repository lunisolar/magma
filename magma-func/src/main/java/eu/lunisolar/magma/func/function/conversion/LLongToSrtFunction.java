...
public interface LLongToSrtFunction extends MetaFunction, MetaInterface.NonThrowing, Codomain<aShort>, Domain1<aLong> { // NOSONAR
	...
	default short applyAsSrt(long a, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		try {
			return this.applyAsSrtX(a);
		} catch (Throwable e) { // NOSONAR
	...
	default short applyAsSrt(long a, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		try {
			return this.applyAsSrtX(a);
		} catch (Throwable e) { // NOSONAR
	...
	default short applyAsSrt(long a, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		try {
			return this.applyAsSrtX(a);
		} catch (Throwable e) { // NOSONAR
	...
	default short applyAsSrt(long a, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		try {
			return this.applyAsSrtX(a);
		} catch (Throwable e) { // NOSONAR
	...
	default LLongToSrtFunction trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		return a -> applyAsSrt(a, exF, newMessage);
	}

	default LLongToSrtFunction trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		return a -> applyAsSrt(a, exF, newMessage, param1);
	}

	default LLongToSrtFunction trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		return a -> applyAsSrt(a, exF, newMessage, param1, param1);
	}

	default LLongToSrtFunction trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		return a -> applyAsSrt(a, exF, newMessage, param1, param2, param3);
	}

	default short applyAsSrt(long a, @Nonnull ExWF<RuntimeException> exF) {
		try {
			return this.applyAsSrtX(a);
		} catch (Throwable e) { // NOSONAR
	...
	static short tryApplyAsSrt(long a, LLongToSrtFunction func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		Null.nonNullArg(func, "func");
		return func.applyAsSrt(a, exF, newMessage);
	}

	static short tryApplyAsSrt(long a, LLongToSrtFunction func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		Null.nonNullArg(func, "func");
		return func.applyAsSrt(a, exF, newMessage, param1);
	}

	static short tryApplyAsSrt(long a, LLongToSrtFunction func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		Null.nonNullArg(func, "func");
		return func.applyAsSrt(a, exF, newMessage, param1, param2);
	}

	static short tryApplyAsSrt(long a, LLongToSrtFunction func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		Null.nonNullArg(func, "func");
		return func.applyAsSrt(a, exF, newMessage, param1, param2, param3);
	}

	static short tryApplyAsSrt(long a, LLongToSrtFunction func, @Nonnull ExWF<RuntimeException> exF) {
		Null.nonNullArg(func, "func");
	...
	default short failSafeApplyAsSrt(long a, @Nonnull LLongToSrtFunction failSafe) {
		try {
			return applyAsSrt(a);
		} catch (Throwable e) { // NOSONAR
			Handling.handleErrors(e);
	...
	static short failSafeApplyAsSrt(long a, LLongToSrtFunction func, @Nonnull LLongToSrtFunction failSafe) {
	 ...
	 */
	public static M memento(short initialValue, LLongToSrtFunction baseFunction, LSrtBinaryOperator mementoFunction) {
		return new M(initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not ). Very short name is intended to be used with parent (LLongToSrtFunction.D)
	 */
	final class M implements LLongToSrtFunction {
		...
		private M(short lastValue, LLongToSrtFunction baseFunction, LSrtBinaryOperator mementoFunction) {
	...
	static LLongToSrtFunction safe() {
		return LLongToSrtFunction::doNothing;
	}
