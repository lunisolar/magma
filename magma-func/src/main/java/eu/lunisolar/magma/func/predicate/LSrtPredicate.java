...
public interface LSrtPredicate extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain1<aShort> { // NOSONAR
	 ...
	 */
	public static M memento(boolean initialValue, LSrtPredicate baseFunction, LLogicalBinaryOperator mementoFunction) {
		return new M(initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not ). Very short name is intended to be used with parent (LSrtPredicate.D)
	 */
	final class M implements LSrtPredicate {
		...
		private M(boolean lastValue, LSrtPredicate baseFunction, LLogicalBinaryOperator mementoFunction) {
