...
/**
 * Throwing functional interface (lambda) TriConsumerX for Java 8.
 *
 * Type: consumer
 *
...
public interface TriConsumerX<T1, T2, T3, X extends Exception> extends MetaConsumer, MetaInterface.Throwing<X> {
	...
	default ActionX<X> capture(T1 t1, T2 t2, T3 t3) {
	...
	default TriConsumer<T1, T2, T3> shove() {
		TriConsumerX<T1, T2, T3, RuntimeException> exceptionCast = (TriConsumerX<T1, T2, T3, RuntimeException>) this;
	...
	@Nonnull
	public static <T1, T2, T3, X extends Exception, E extends Exception, Y extends Exception> TriConsumerX<T1, T2, T3, Y> wrapException(@Nonnull final TriConsumerX<T1, T2, T3, X> other, Class<E> exception, ExceptionHandler<E, Y> handler) {
		return (T1 t1, T2 t2, T3 t3) -> {
			try {
	...
	@Nonnull
	default <E extends Exception, Y extends Exception> TriConsumerX<T1, T2, T3, Y> handleX(Class<E> exception, ExceptionHandler<E, Y> handler) {
	...
	@Nonnull
	default <Y extends Exception> TriConsumerX<T1, T2, T3, Y> handleX(ExceptionHandler<Exception, Y> handler) {
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);
