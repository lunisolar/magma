...
/**
 * Non-throwing functional interface (lambda) BooleanToShortFunction for Java 8.
 *
 * Type: function
 *
...
public interface BooleanToShortFunction extends BooleanToShortFunctionX<RuntimeException>, MetaFunction, PrimitiveCodomain<Object>, MetaInterface.NonThrowing { // NOSONAR
