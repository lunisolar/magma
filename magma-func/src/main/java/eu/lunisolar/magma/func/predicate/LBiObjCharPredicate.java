...
public interface LBiObjCharPredicate<T1, T2> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<a<T1>, a<T2>, aChar> { // NOSONAR
	...
	default boolean test(T1 a1, T2 a2, char a3, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage) {
		try {
			return this.testX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default boolean test(T1 a1, T2 a2, char a3, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1) {
		try {
			return this.testX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default boolean test(T1 a1, T2 a2, char a3, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		try {
			return this.testX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default boolean test(T1 a1, T2 a2, char a3, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		try {
			return this.testX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LBiObjCharPredicate<T1, T2> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage) {
		return (a1, a2, a3) -> test(a1, a2, a3, factory, newMessage);
	}

	default LBiObjCharPredicate<T1, T2> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1) {
		return (a1, a2, a3) -> test(a1, a2, a3, factory, newMessage, param1);
	}

	default LBiObjCharPredicate<T1, T2> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		return (a1, a2, a3) -> test(a1, a2, a3, factory, newMessage, param1, param1);
	}

	default LBiObjCharPredicate<T1, T2> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		return (a1, a2, a3) -> test(a1, a2, a3, factory, newMessage, param1, param2, param3);
	}

	default boolean test(T1 a1, T2 a2, char a3, @Nonnull ExWF<RuntimeException> factory) {
		try {
			return this.testX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LBiObjCharPredicate<T1, T2> trying(@Nonnull ExWF<RuntimeException> factory) {
	...
	static <T1, T2> boolean shovingTest(T1 a1, T2 a2, char a3, LBiObjCharPredicate<T1, T2> func) {
	...
	static <T1, T2> boolean tryTest(T1 a1, T2 a2, char a3, LBiObjCharPredicate<T1, T2> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage) {
		Null.nonNullArg(func, "func");
		return func.test(a1, a2, a3, factory, newMessage);
	}

	static <T1, T2> boolean tryTest(T1 a1, T2 a2, char a3, LBiObjCharPredicate<T1, T2> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1) {
		Null.nonNullArg(func, "func");
		return func.test(a1, a2, a3, factory, newMessage, param1);
	}

	static <T1, T2> boolean tryTest(T1 a1, T2 a2, char a3, LBiObjCharPredicate<T1, T2> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		Null.nonNullArg(func, "func");
		return func.test(a1, a2, a3, factory, newMessage, param1, param2);
	}

	static <T1, T2> boolean tryTest(T1 a1, T2 a2, char a3, LBiObjCharPredicate<T1, T2> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		Null.nonNullArg(func, "func");
		return func.test(a1, a2, a3, factory, newMessage, param1, param2, param3);
	}

	static <T1, T2> boolean tryTest(T1 a1, T2 a2, char a3, LBiObjCharPredicate<T1, T2> func, @Nonnull ExWF<RuntimeException> factory) {
		Null.nonNullArg(func, "func");
	...
	default LObjCharPredicate<T2> lShrink(@Nonnull LObjCharFunction<T2, T1> left) {
		Null.nonNullArg(left, "left");
		return (a2, a3) -> test(left.apply(a2, a3), a2, a3);
	}

	default LObjCharPredicate<T2> lShrink_(T1 a1) {
	...
	default LBiPredicate<T1, T2> rShrink(@Nonnull LToCharBiFunction<T1, T2> right) {
		Null.nonNullArg(right, "right");
		return (a1, a2) -> test(a1, a2, right.applyAsChar(a1, a2));
	}

	default LBiPredicate<T1, T2> rShrink_(char a3) {
	...
	default LBiObjCharPredicate<T1, T2> beforeDo(@Nonnull LBiObjCharConsumer<T1, T2> before) {
	...
	default LBiObjCharPredicate<T1, T2> afterDo(@Nonnull LBoolConsumer after) {
	...
	public static <T1, T2, X extends Throwable> T1 throwIf(T1 a1, T2 a2, char a3, @Nonnull LBiObjCharPredicate<? super T1, ? super T2> pred, @Nonnull ExMF<X> factory, @Nonnull LBiObjCharFunction<? super T1, ? super T2, ? extends String> msgFunc) throws X {
	...
	/** Throws new exception if condition is met. */
	public static <T1, T2, X extends Throwable> T1 throwIf(T1 a1, T2 a2, char a3, @Nonnull LBiObjCharPredicate<? super T1, ? super T2> pred, @Nonnull ExMF<X> factory, @Nonnull String msg) throws X {
		Null.nonNullArg(pred, "pred");
		Null.nonNullArg(factory, "factory");
	...
	/** Throws new exception if condition is met. */
	public static <T1, T2, X extends Throwable> T1 throwIf(T1 a1, T2 a2, char a3, @Nonnull LBiObjCharPredicate<? super T1, ? super T2> pred, @Nonnull ExMF<X> factory, @Nonnull String message, @Nullable Object param1) throws X {
		Null.nonNullArg(pred, "pred");
		Null.nonNullArg(factory, "factory");
	...
	/** Throws new exception if condition is met. */
	public static <T1, T2, X extends Throwable> T1 throwIf(T1 a1, T2 a2, char a3, @Nonnull LBiObjCharPredicate<? super T1, ? super T2> pred, @Nonnull ExMF<X> factory, @Nonnull String message, @Nullable Object param1, @Nullable Object param2) throws X {
		Null.nonNullArg(pred, "pred");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(message, "message");
		if (pred.test(a1, a2, a3)) {
	...
	/** Throws new exception if condition is met. */
	public static <T1, T2, X extends Throwable> T1 throwIf(T1 a1, T2 a2, char a3, @Nonnull LBiObjCharPredicate<? super T1, ? super T2> pred, @Nonnull ExMF<X> factory, @Nonnull String message, @Nullable Object param1, @Nullable Object param2,
	...
	public static <T1, T2, X extends Throwable> T1 throwIfNot(T1 a1, T2 a2, char a3, @Nonnull LBiObjCharPredicate<? super T1, ? super T2> pred, @Nonnull ExMF<X> factory, @Nonnull LBiObjCharFunction<? super T1, ? super T2, ? extends String> msgFunc)
			throws X {
		Null.nonNullArg(pred, "pred");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(msgFunc, "msgFunc");
	...
	/** Throws new exception if condition is NOT met. */
	public static <T1, T2, X extends Throwable> T1 throwIfNot(T1 a1, T2 a2, char a3, @Nonnull LBiObjCharPredicate<? super T1, ? super T2> pred, @Nonnull ExMF<X> factory, @Nonnull String msg) throws X {
		Null.nonNullArg(pred, "pred");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(msg, "msg");
		if (!pred.test(a1, a2, a3)) {
	...
	/** Throws new exception if condition is NOT met. */
	public static <T1, T2, X extends Throwable> T1 throwIfNot(T1 a1, T2 a2, char a3, @Nonnull LBiObjCharPredicate<? super T1, ? super T2> pred, @Nonnull ExMF<X> factory, @Nonnull String message, @Nullable Object param1) throws X {
		Null.nonNullArg(pred, "pred");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(message, "message");
		if (!pred.test(a1, a2, a3)) {
	...
	/** Throws new exception if condition is NOT met. */
	public static <T1, T2, X extends Throwable> T1 throwIfNot(T1 a1, T2 a2, char a3, @Nonnull LBiObjCharPredicate<? super T1, ? super T2> pred, @Nonnull ExMF<X> factory, @Nonnull String message, @Nullable Object param1, @Nullable Object param2) throws X {
		Null.nonNullArg(pred, "pred");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(message, "message");
		if (!pred.test(a1, a2, a3)) {
	...
	/** Throws new exception if condition is NOT met. */
	public static <T1, T2, X extends Throwable> T1 throwIfNot(T1 a1, T2 a2, char a3, @Nonnull LBiObjCharPredicate<? super T1, ? super T2> pred, @Nonnull ExMF<X> factory, @Nonnull String message, @Nullable Object param1, @Nullable Object param2,
			@Nullable Object param3) throws X {
		Null.nonNullArg(pred, "pred");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(message, "message");
	...
	/** Throws new exception if condition is met. */
	public static <T1, T2, X extends Throwable> T1 throwIf(T1 a1, T2 a2, char a3, @Nonnull LBiObjCharPredicate<? super T1, ? super T2> pred, @Nonnull ExF<X> noArgFactory) throws X {
		Null.nonNullArg(pred, "pred");
	...
	/** Throws new exception if condition is NOT met. */
	public static <T1, T2, X extends Throwable> T1 throwIfNot(T1 a1, T2 a2, char a3, @Nonnull LBiObjCharPredicate<? super T1, ? super T2> pred, @Nonnull ExF<X> noArgFactory) throws X {
		Null.nonNullArg(pred, "pred");
		Null.nonNullArg(noArgFactory, "noArgFactory");
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(noArgFactory);
	...
	/** Throws new exception if condition is met. */
	public static <T1, T2, X extends Throwable> T1 throwIf(T1 a1, @Nonnull LBiObjCharPredicate<? super T1, ? super T2> pred, T2 a2, char a3, @Nonnull ExMF<X> factory, @Nonnull LBiObjCharFunction<? super T1, ? super T2, ? extends String> msgFunc) throws X {
		Null.nonNullArg(pred, "pred");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(msgFunc, "msgFunc");
		if (pred.test(a1, a2, a3)) {
	...
	/** Throws new exception if condition is met. */
	public static <T1, T2, X extends Throwable> T1 throwIf(T1 a1, @Nonnull LBiObjCharPredicate<? super T1, ? super T2> pred, T2 a2, char a3, @Nonnull ExMF<X> factory, @Nonnull String msg) throws X {
		Null.nonNullArg(pred, "pred");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(msg, "msg");
		if (pred.test(a1, a2, a3)) {
	...
	/** Throws new exception if condition is met. */
	public static <T1, T2, X extends Throwable> T1 throwIf(T1 a1, @Nonnull LBiObjCharPredicate<? super T1, ? super T2> pred, T2 a2, char a3, @Nonnull ExMF<X> factory, @Nonnull String message, @Nullable Object param1) throws X {
		Null.nonNullArg(pred, "pred");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(message, "message");
		if (pred.test(a1, a2, a3)) {
	...
	/** Throws new exception if condition is met. */
	public static <T1, T2, X extends Throwable> T1 throwIf(T1 a1, @Nonnull LBiObjCharPredicate<? super T1, ? super T2> pred, T2 a2, char a3, @Nonnull ExMF<X> factory, @Nonnull String message, @Nullable Object param1, @Nullable Object param2) throws X {
		Null.nonNullArg(pred, "pred");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(message, "message");
		if (pred.test(a1, a2, a3)) {
	...
	/** Throws new exception if condition is met. */
	public static <T1, T2, X extends Throwable> T1 throwIf(T1 a1, @Nonnull LBiObjCharPredicate<? super T1, ? super T2> pred, T2 a2, char a3, @Nonnull ExMF<X> factory, @Nonnull String message, @Nullable Object param1, @Nullable Object param2,
			@Nullable Object param3) throws X {
		Null.nonNullArg(pred, "pred");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(message, "message");
	...
	/** Throws new exception if condition is NOT met. */
	public static <T1, T2, X extends Throwable> T1 throwIfNot(T1 a1, @Nonnull LBiObjCharPredicate<? super T1, ? super T2> pred, T2 a2, char a3, @Nonnull ExMF<X> factory, @Nonnull LBiObjCharFunction<? super T1, ? super T2, ? extends String> msgFunc)
			throws X {
		Null.nonNullArg(pred, "pred");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(msgFunc, "msgFunc");
	...
	/** Throws new exception if condition is NOT met. */
	public static <T1, T2, X extends Throwable> T1 throwIfNot(T1 a1, @Nonnull LBiObjCharPredicate<? super T1, ? super T2> pred, T2 a2, char a3, @Nonnull ExMF<X> factory, @Nonnull String msg) throws X {
		Null.nonNullArg(pred, "pred");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(msg, "msg");
		if (!pred.test(a1, a2, a3)) {
	...
	/** Throws new exception if condition is NOT met. */
	public static <T1, T2, X extends Throwable> T1 throwIfNot(T1 a1, @Nonnull LBiObjCharPredicate<? super T1, ? super T2> pred, T2 a2, char a3, @Nonnull ExMF<X> factory, @Nonnull String message, @Nullable Object param1) throws X {
		Null.nonNullArg(pred, "pred");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(message, "message");
		if (!pred.test(a1, a2, a3)) {
	...
	/** Throws new exception if condition is NOT met. */
	public static <T1, T2, X extends Throwable> T1 throwIfNot(T1 a1, @Nonnull LBiObjCharPredicate<? super T1, ? super T2> pred, T2 a2, char a3, @Nonnull ExMF<X> factory, @Nonnull String message, @Nullable Object param1, @Nullable Object param2) throws X {
		Null.nonNullArg(pred, "pred");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(message, "message");
		if (!pred.test(a1, a2, a3)) {
	...
	/** Throws new exception if condition is NOT met. */
	public static <T1, T2, X extends Throwable> T1 throwIfNot(T1 a1, @Nonnull LBiObjCharPredicate<? super T1, ? super T2> pred, T2 a2, char a3, @Nonnull ExMF<X> factory, @Nonnull String message, @Nullable Object param1, @Nullable Object param2,
			@Nullable Object param3) throws X {
		Null.nonNullArg(pred, "pred");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(message, "message");
	...
	/** Throws new exception if condition is met. */
	public static <T1, T2, X extends Throwable> T1 throwIf(T1 a1, @Nonnull LBiObjCharPredicate<? super T1, ? super T2> pred, T2 a2, char a3, @Nonnull ExF<X> noArgFactory) throws X {
		Null.nonNullArg(pred, "pred");
		Null.nonNullArg(noArgFactory, "noArgFactory");
		if (pred.test(a1, a2, a3)) {
			throw Handling.create(noArgFactory);
	...
	/** Throws new exception if condition is NOT met. */
	public static <T1, T2, X extends Throwable> T1 throwIfNot(T1 a1, @Nonnull LBiObjCharPredicate<? super T1, ? super T2> pred, T2 a2, char a3, @Nonnull ExF<X> noArgFactory) throws X {
		Null.nonNullArg(pred, "pred");
		Null.nonNullArg(noArgFactory, "noArgFactory");
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(noArgFactory);
	...
	public static <T1, T2, X extends Throwable> T1 throwIfNotEx(T1 a1, T2 a2, char a3, @Nonnull LBiObjCharFunction<? super T1, ? super T2, ? extends String> specialPredicate, @Nonnull ExMF<X> factory) throws X {
	...
	/** Throws new exception if condition is not met (non null message is returned by 'predicate') */
	public static <T1, T2, X extends Throwable> T1 throwIfNotEx(T1 a1, T2 a2, char a3, @Nonnull LBiObjCharFunction<? super T1, ? super T2, ? extends String> specialPredicate, @Nonnull ExMF<X> factory, @Nonnull String msg) throws X {
		Null.nonNullArg(specialPredicate, "specialPredicate");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(msg, "msg");
		var m = specialPredicate.apply(a1, a2, a3);
	...
	/** Throws new exception if condition is not met (non null message is returned by 'predicate') */
	public static <T1, T2, X extends Throwable> T1 throwIfNotEx(T1 a1, T2 a2, char a3, @Nonnull LBiObjCharFunction<? super T1, ? super T2, ? extends String> specialPredicate, @Nonnull ExMF<X> factory, @Nonnull String message, @Nullable Object param1)
			throws X {
		Null.nonNullArg(specialPredicate, "specialPredicate");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(message, "message");
	...
	/** Throws new exception if condition is not met (non null message is returned by 'predicate') */
	public static <T1, T2, X extends Throwable> T1 throwIfNotEx(T1 a1, @Nonnull LBiObjCharFunction<? super T1, ? super T2, ? extends String> specialPredicate, T2 a2, char a3, @Nonnull ExMF<X> factory) throws X {
		Null.nonNullArg(specialPredicate, "specialPredicate");
		Null.nonNullArg(factory, "factory");
		var m = specialPredicate.apply(a1, a2, a3);
		if (m != null) {
	...
	/** Throws new exception if condition is not met (non null message is returned by 'predicate') */
	public static <T1, T2, X extends Throwable> T1 throwIfNotEx(T1 a1, @Nonnull LBiObjCharFunction<? super T1, ? super T2, ? extends String> specialPredicate, T2 a2, char a3, @Nonnull ExMF<X> factory, @Nonnull String msg) throws X {
		Null.nonNullArg(specialPredicate, "specialPredicate");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(msg, "msg");
		var m = specialPredicate.apply(a1, a2, a3);
	...
	/** Throws new exception if condition is not met (non null message is returned by 'predicate') */
	public static <T1, T2, X extends Throwable> T1 throwIfNotEx(T1 a1, @Nonnull LBiObjCharFunction<? super T1, ? super T2, ? extends String> specialPredicate, T2 a2, char a3, @Nonnull ExMF<X> factory, @Nonnull String message, @Nullable Object param1)
			throws X {
		Null.nonNullArg(specialPredicate, "specialPredicate");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(message, "message");
	...
	final class S<T1, T2> implements LBiObjCharPredicate<T1, T2> {
	...
	public static <T1, T2> M<T1, T2> mementoOf(T1 a1, T2 a2, char a3, LBiObjCharPredicate<T1, T2> function) {
		var initialValue = function.test(a1, a2, a3);
		return initializedMementoOf(initialValue, function);
	}

	public static <T1, T2> M<T1, T2> initializedMementoOf(boolean initialValue, LBiObjCharPredicate<T1, T2> function) {
		return memento(initialValue, initialValue, function, (m, x1, x2) -> x2);
	}

	public static <T1, T2> M<T1, T2> deltaOf(T1 a1, T2 a2, char a3, LBiObjCharPredicate<T1, T2> function, LLogicalBinaryOperator deltaFunction) {
		var initialValue = function.test(a1, a2, a3);
		return initializedDeltaOf(initialValue, function, deltaFunction);
	}

	public static <T1, T2> M<T1, T2> deltaOf(T1 a1, T2 a2, char a3, LBiObjCharPredicate<T1, T2> function) {
		var initialValue = function.test(a1, a2, a3);
		return initializedDeltaOf(initialValue, function, (x1, x2) -> x1 != x2);
	}

	public static <T1, T2> M<T1, T2> initializedDeltaOf(boolean initialValue, LBiObjCharPredicate<T1, T2> function, LLogicalBinaryOperator deltaFunction) {
		return memento(initialValue, deltaFunction.apply(initialValue, initialValue), function, (m, x1, x2) -> deltaFunction.apply(x1, x2));
	}

	public static <T1, T2> M<T1, T2> memento(boolean initialBaseValue, boolean initialValue, LBiObjCharPredicate<T1, T2> baseFunction, LLogicalTernaryOperator mementoFunction) {
		return new M(initialBaseValue, initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not confuse it with math concepts). Very short name is intended to be used with parent (LBiObjCharPredicate.M)
	 */
	@NotThreadSafe
	final class M<T1, T2> implements LBiObjCharPredicate<T1, T2> {

		private final LBiObjCharPredicate<T1, T2> baseFunction;
		private boolean lastBaseValue;
		private boolean lastValue;
		private final LLogicalTernaryOperator mementoFunction;

		private M(boolean lastBaseValue, boolean lastValue, LBiObjCharPredicate<T1, T2> baseFunction, LLogicalTernaryOperator mementoFunction) {
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2> LBiObjCharPredicate.LObj0Char2Obj1Pred<T1, T2> obj0Char2Obj1Pred(final @Nonnull LBiObjCharPredicate.LObj0Char2Obj1Pred<T1, T2> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1> LBiObjCharPredicate.LObj1Obj0Char2Pred<T2, T1> obj1Obj0Char2Pred(final @Nonnull LBiObjCharPredicate.LObj1Obj0Char2Pred<T2, T1> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1> LBiObjCharPredicate.LObj1Char2Obj0Pred<T2, T1> obj1Char2Obj0Pred(final @Nonnull LBiObjCharPredicate.LObj1Char2Obj0Pred<T2, T1> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2> LBiObjCharPredicate.LChar2Obj0Obj1Pred<T1, T2> char2Obj0Obj1Pred(final @Nonnull LBiObjCharPredicate.LChar2Obj0Obj1Pred<T1, T2> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1> LBiObjCharPredicate.LChar2Obj1Obj0Pred<T2, T1> char2Obj1Obj0Pred(final @Nonnull LBiObjCharPredicate.LChar2Obj1Obj0Pred<T2, T1> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	@Nonnull
	static <T1, T2> LBiObjCharPredicate<T1, T2> not(@Nonnull LBiObjCharPredicate<T1, T2> pred) {
		Null.nonNullArg(pred, "pred");
		return pred.negate();
	}
	...
	@Nonnull
	public static <T1, T2> LBiObjCharPredicate<T1, T2> and(@Nonnull LBiObjCharPredicate<? super T1, ? super T2>... predicates) {
		Null.nonNullArg(predicates, "predicates");
		return (a1, a2, a3) -> {
			for (LBiObjCharPredicate<? super T1, ? super T2> p : predicates) {
				if (!p.test(a1, a2, a3)) {
					return false;
				}
			}
	...
	@Nonnull
	public static <T1, T2> LBiObjCharPredicate<T1, T2> or(@Nonnull LBiObjCharPredicate<? super T1, ? super T2>... predicates) {
		Null.nonNullArg(predicates, "predicates");
		return (a1, a2, a3) -> {
			for (LBiObjCharPredicate<? super T1, ? super T2> p : predicates) {
				if (p.test(a1, a2, a3)) {
	...
	interface LObj0Char2Obj1Pred<T1, T2> extends LBiObjCharPredicate<T1, T2> {
		...
		default boolean testObj0Char2Obj1(T1 a1, char a3, T2 a2) {
			// return nestingTestObj0Char2Obj1(a1,a3,a2);
			try {
				return this.testObj0Char2Obj1X(a1, a3, a2);
			} catch (Throwable e) { // NOSONAR
				throw Handling.nestCheckedAndThrow(e);
			}
		}
		...
		/**
		 * Implement this, but call testObj0Char2Obj1(T1 a1,char a3,T2 a2)
		 */
		boolean testObj0Char2Obj1X(T1 a1, char a3, T2 a2) throws Throwable;
	}
	...
	interface LObj1Obj0Char2Pred<T2, T1> extends LBiObjCharPredicate<T1, T2> {
		...
		default boolean testObj1Obj0Char2(T2 a2, T1 a1, char a3) {
			// return nestingTestObj1Obj0Char2(a2,a1,a3);
			try {
				return this.testObj1Obj0Char2X(a2, a1, a3);
			} catch (Throwable e) { // NOSONAR
				throw Handling.nestCheckedAndThrow(e);
			}
		}
		...
		/**
		 * Implement this, but call testObj1Obj0Char2(T2 a2,T1 a1,char a3)
		 */
		boolean testObj1Obj0Char2X(T2 a2, T1 a1, char a3) throws Throwable;
	}
	...
	interface LObj1Char2Obj0Pred<T2, T1> extends LBiObjCharPredicate<T1, T2> {
		...
		default boolean testObj1Char2Obj0(T2 a2, char a3, T1 a1) {
			// return nestingTestObj1Char2Obj0(a2,a3,a1);
			try {
				return this.testObj1Char2Obj0X(a2, a3, a1);
			} catch (Throwable e) { // NOSONAR
				throw Handling.nestCheckedAndThrow(e);
			}
		}
		...
		/**
		 * Implement this, but call testObj1Char2Obj0(T2 a2,char a3,T1 a1)
		 */
		boolean testObj1Char2Obj0X(T2 a2, char a3, T1 a1) throws Throwable;
	}
	...
	interface LChar2Obj0Obj1Pred<T1, T2> extends LBiObjCharPredicate<T1, T2> {
		...
		default boolean testChar2Obj0Obj1(char a3, T1 a1, T2 a2) {
			// return nestingTestChar2Obj0Obj1(a3,a1,a2);
			try {
				return this.testChar2Obj0Obj1X(a3, a1, a2);
			} catch (Throwable e) { // NOSONAR
				throw Handling.nestCheckedAndThrow(e);
			}
		}
		...
		/**
		 * Implement this, but call testChar2Obj0Obj1(char a3,T1 a1,T2 a2)
		 */
		boolean testChar2Obj0Obj1X(char a3, T1 a1, T2 a2) throws Throwable;
	}
	...
	interface LChar2Obj1Obj0Pred<T2, T1> extends LBiObjCharPredicate<T1, T2> {
		...
		default boolean testChar2Obj1Obj0(char a3, T2 a2, T1 a1) {
			// return nestingTestChar2Obj1Obj0(a3,a2,a1);
			try {
				return this.testChar2Obj1Obj0X(a3, a2, a1);
			} catch (Throwable e) { // NOSONAR
				throw Handling.nestCheckedAndThrow(e);
			}
		}
		...
		/**
		 * Implement this, but call testChar2Obj1Obj0(char a3,T2 a2,T1 a1)
		 */
		boolean testChar2Obj1Obj0X(char a3, T2 a2, T1 a1) throws Throwable;
	}
