...
public interface LQuintConsumer<T1, T2, T3, T4, T5> extends MetaConsumer, MetaInterface.NonThrowing, Codomain<aVoid>, Domain5<a<T1>, a<T2>, a<T3>, a<T4>, a<T5>> {
	...
	default @Nonnull LQuintConsumer<T1, T2, T3, T4, T5> wrapWith(@Nonnull CallContext ctx) {
		Null.nonNullArg(ctx, "ctx");
		return (a1, a2, a3, a4, a5) -> acceptX(ctx, a1, a2, a3, a4, a5, this);
	}

	static <T1, T2, T3, T4, T5> void acceptX(@Nonnull CallContext ctx, T1 a1, T2 a2, T3 a3, T4 a4, T5 a5, @Nonnull LQuintConsumer<T1, T2, T3, T4, T5> function) throws Throwable {
		Null.nonNullArg(ctx, "ctx");
	...
	static <T1, T2, T3, T4, T5> void nestingAccept(@Nonnull CallContext ctx, T1 a1, T2 a2, T3 a3, T4 a4, T5 a5, @Nonnull LQuintConsumer<T1, T2, T3, T4, T5> function) {
		Null.nonNullArg(ctx, "ctx");
		Null.nonNullArg(function, "function");
		try {
			acceptX(ctx, a1, a2, a3, a4, a5, function);
		} catch (Throwable e) {
			throw Handling.nestCheckedAndThrow(e);
		}
	}

	static <T1, T2, T3, T4, T5> void shovingAccept(@Nonnull CallContext ctx, T1 a1, T2 a2, T3 a3, T4 a4, T5 a5, @Nonnull LQuintConsumer<T1, T2, T3, T4, T5> function) {
		Null.nonNullArg(ctx, "ctx");
		Null.nonNullArg(function, "function");
		try {
			acceptX(ctx, a1, a2, a3, a4, a5, function);
	...
	static <T1, T2, T3, T4, T5> CompletableFuture<Void> asyncAccept(@Nonnull AsyncCallContext async, @Nonnull CallContext ctx, T1 a1, T2 a2, T3 a3, T4 a4, T5 a5, @Nonnull LQuintConsumer<T1, T2, T3, T4, T5> function) {
		Null.nonNullArg(async, "async");
		Null.nonNullArg(ctx, "ctx");
		Null.nonNullArg(function, "function");
		CompletableFuture<Void> future = new CompletableFuture<>();
		try {
			async.call(() -> {
				try {
					LQuintConsumer.acceptX(ctx, a1, a2, a3, a4, a5, function);
					future.complete(null);
				} catch (Throwable e) {
					Handling.handleErrors(e);
					future.completeExceptionally(e);
