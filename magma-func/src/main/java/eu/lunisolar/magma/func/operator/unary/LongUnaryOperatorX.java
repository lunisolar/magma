...
/**
 *
 * @see {@link eu.lunisolar.magma.func.operator.unary.LongUnaryOperator}
 */
@FunctionalInterface
...
public interface LongUnaryOperatorX<X extends Exception> extends MetaOperator, PrimitiveCodomain<LongUnaryOperatorX<X>>, MetaThrowingInterface<X> { // NOSONAR
	...
	@Nonnull
	public static <X extends Exception, Y extends Exception> LongUnaryOperatorX<Y> wrapException(@Nonnull final LongUnaryOperatorX<X> other, Class<? extends Exception> exception, ExceptionHandler<Exception, Y> rethrower) {
		return (long l) -> {
			try {
	...
	@Nonnull
	default <Y extends Exception> LongUnaryOperatorX<Y> handle(Class<? extends Exception> exception, ExceptionHandler<? super X, Y> handler) {
		Objects.requireNonNull(exception, Function4U.VALIDATION_MESSAGE_EXCEPTION);
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return LongUnaryOperatorX.wrapException(this, exception, (ExceptionHandler) handler);
	}

	/** Wraps with exception handling that for argument exception class will call function to determine the final exception. */
	@Nonnull
	default <Y extends Exception> LongUnaryOperatorX<Y> handle(ExceptionHandler<? super X, Y> handler) {
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return LongUnaryOperatorX.wrapException(this, Exception.class, (ExceptionHandler) handler);
	}
