...
public interface LTriBoolConsumerX<X extends Throwable> extends MetaConsumer, MetaInterface.Throwing<X> {
	...
	String DESCRIPTION = "LTriBoolConsumerX: void doAccept(boolean a1,boolean a2,boolean a3) throws X";

	void doAccept(boolean a1, boolean a2, boolean a3) throws X;

	default LTuple.Void tupleAccept(LBoolTriple args) throws X {
	...
	default void shovingDoAccept(boolean a1, boolean a2, boolean a3) {
		((LTriBoolConsumerX<RuntimeException>) this).doAccept(a1, a2, a3);
	}

	/** Function call that handles exceptions according to the instructions. */
	default <Y extends Throwable> void handlingDoAccept(boolean a1, boolean a2, boolean a3, HandlingInstructions<Throwable, Y> handling) throws Y {
	...
	default LActionX<X> captureTriBoolCons(boolean a1, boolean a2, boolean a3) {
	...
	/** Safe instance. */
	@Nonnull
	static <X extends Throwable> LTriBoolConsumerX<X> safe() {
		return Function4U::doNothing;
	}

	/** Safe instance supplier. Returns supplier of safe() instance. */
	@Nonnull
	static <X extends Throwable, Y extends Throwable> LSupplierX<LTriBoolConsumerX<X>, Y> safeSupplier() {
		return () -> safe();
	}

	/** Safe wrapping. Either argument function is returned (if it is not null) or safe() instance. */
	@Nonnull
	static <X extends Throwable> LTriBoolConsumerX<X> safe(final @Nullable LTriBoolConsumerX<X> other) {
		if (other == null) {
			return safe();
		} else {
			return other;
	...
	@Nonnull
	static <X extends Throwable, Y extends Throwable> LSupplierX<LTriBoolConsumerX<X>, Y> safeSupplier(final @Nullable LSupplierX<LTriBoolConsumerX<X>, Y> supplier) {
		if (supplier == null) {
			return safeSupplier();
		} else {
			return supplier;
	...
	@Nonnull
	default LTriBoolConsumerX<X> triBoolConsComposeBool(@Nonnull final LLogicalOperatorX<X> before1, @Nonnull final LLogicalOperatorX<X> before2, @Nonnull final LLogicalOperatorX<X> before3) {
	...
	/** Combines two LTriBoolConsumerX<X> together in a order. */
	@Nonnull
