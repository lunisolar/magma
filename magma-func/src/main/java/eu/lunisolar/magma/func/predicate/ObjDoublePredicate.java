...
/**
 * Non-throwing functional interface (lambda) ObjDoublePredicate for Java 8.
 *
 * Type: predicate
 *
...
public interface ObjDoublePredicate<T> extends ObjDoublePredicateX<T, RuntimeException>, MetaPredicate, PrimitiveCodomain<Object>, MetaInterface.NonThrowing { // NOSONAR
	...
	public static <T> ObjDoublePredicate<T> constant(boolean r) {
		return (t, d) -> r;
	}
