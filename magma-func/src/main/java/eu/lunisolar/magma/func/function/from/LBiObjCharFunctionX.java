...
public interface LBiObjCharFunctionX<T1, T2, R, X extends Throwable> extends MetaFunction, MetaInterface.Throwing<X> { // NOSONAR
	...
	static <T1, T2, R, X extends Throwable> R call(T1 a1, T2 a2, char a3, final @Nonnull LBiObjCharFunctionX<T1, T2, R, X> lambda) throws X {
		Null.nonNullArg(lambda, "lambda");
		return lambda.doApply(a1, a2, a3);
	}

	static <T1, T2, R, X extends Throwable> R shoving(T1 a1, T2 a2, char a3, final @Nonnull LBiObjCharFunctionX<T1, T2, R, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.shovingDoApply(a1, a2, a3);
	}

	static <T1, T2, R, X extends Throwable> R nesting(T1 a1, T2 a2, char a3, final @Nonnull LBiObjCharFunctionX<T1, T2, R, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.nestingDoApply(a1, a2, a3);
	}

	static <T1, T2, R, X extends Throwable, Y extends Throwable> R handling(T1 a1, T2 a2, char a3, final HandlingInstructions<Throwable, Y> handling, final @Nonnull LBiObjCharFunctionX<T1, T2, R, X> lambda) throws Y {
		Null.nonNullArg(lambda, "lambda");
	...
	@Nonnull
	static <T1, T2, R, X extends Throwable> LBiObjCharFunctionX<T1, T2, R, X> safe() {
		return Function4U::produce;
	}

	/** Safe instance supplier. Returns supplier of safe() instance. */
	@Nonnull
	static <T1, T2, R, X extends Throwable, Y extends Throwable> LSupplierX<LBiObjCharFunctionX<T1, T2, R, X>, Y> safeSupplier() {
		return () -> safe();
	}

	/** Safe wrapping. Either argument function is returned (if it is not null) or safe() instance. */
	@Nonnull
	static <T1, T2, R, X extends Throwable> LBiObjCharFunctionX<T1, T2, R, X> safe(final @Nullable LBiObjCharFunctionX<T1, T2, R, X> other) {
		if (other == null) {
			return safe();
		} else {
			return other;
	...
	@Nonnull
	static <T1, T2, R, X extends Throwable, Y extends Throwable> LSupplierX<LBiObjCharFunctionX<T1, T2, R, X>, Y> safeSupplier(final @Nullable LSupplierX<LBiObjCharFunctionX<T1, T2, R, X>, Y> supplier) {
		if (supplier == null) {
			return safeSupplier();
		} else {
			return supplier;
	...
	default <V1, V2> LBiObjCharFunctionX<V1, V2, R, X> biObjCharFuncComposeChar(@Nonnull final LFunctionX<? super V1, ? extends T1, X> before1, @Nonnull final LFunctionX<? super V2, ? extends T2, X> before2, @Nonnull final LCharUnaryOperatorX<X> before3) {
		...
		return (V1 v1, V2 v2, char v3) -> this.doApply(before1.doApply(v1), before2.doApply(v2), before3.doApplyAsChar(v3));
	}
	...
	/** Permutation of LBiObjCharFunctionX for method references. */
	@FunctionalInterface
	interface V1<T1, T2, R, X extends Throwable> extends LBiObjCharFunctionX<T1, T2, R, X> {
		@Nullable
		R doApplyV1(T1 a1, char a3, T2 a2) throws X;

		@Override
		default R doApply(T1 a1, T2 a2, char a3) throws X {
	...
	/** Permutation of LBiObjCharFunctionX for method references. */
	@FunctionalInterface
	interface V2<T2, T1, R, X extends Throwable> extends LBiObjCharFunctionX<T1, T2, R, X> {
		@Nullable
		R doApplyV2(T2 a2, T1 a1, char a3) throws X;
	...
	/** Permutation of LBiObjCharFunctionX for method references. */
	@FunctionalInterface
	interface V3<T2, T1, R, X extends Throwable> extends LBiObjCharFunctionX<T1, T2, R, X> {
		@Nullable
		R doApplyV3(T2 a2, char a3, T1 a1) throws X;
	...
	/** Permutation of LBiObjCharFunctionX for method references. */
	@FunctionalInterface
	interface V4<T1, T2, R, X extends Throwable> extends LBiObjCharFunctionX<T1, T2, R, X> {
		@Nullable
		R doApplyV4(char a3, T1 a1, T2 a2) throws X;
	...
	/** Permutation of LBiObjCharFunctionX for method references. */
	@FunctionalInterface
	interface V5<T2, T1, R, X extends Throwable> extends LBiObjCharFunctionX<T1, T2, R, X> {
		@Nullable
		R doApplyV5(char a3, T2 a2, T1 a1) throws X;
