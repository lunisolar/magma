...
public interface LBiObjCharFunctionX<T1, T2, R, X extends Throwable> extends MetaFunction, MetaInterface.Throwing<X> { // NOSONAR
	...
	public static <T1, T2, R, X extends Throwable> LBiObjCharFunctionX<T1, T2, R, X> constant(R r) {
		return (t1, t2, c) -> r;
	}

	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	public static <T1, T2, R, X extends Throwable> LBiObjCharFunctionX<T1, T2, R, X> lX(final @Nonnull LBiObjCharFunctionX<T1, T2, R, X> lambda) {
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	public static <T1, T2, R, X extends Throwable> LBiObjCharFunctionX<T1, T2, R, X> lX(@Nonnull Class<X> xClass, final @Nonnull LBiObjCharFunctionX<T1, T2, R, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	@Nonnull
	public static <T1, T2, R, X extends Throwable> LBiObjCharFunctionX<T1, T2, R, X> wrapX(final @Nonnull LBiObjCharFunction<T1, T2, R> other) {
