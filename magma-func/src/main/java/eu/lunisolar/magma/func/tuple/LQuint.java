...
public interface LQuint<T1, T2, T3, T4, T5> extends LTuple<Object>, Map.Entry<T1, T2> {
	...
	public static <T> Iterator<LQuint.MutQuint> mutIterator(Iterator<? extends T> items) {
		return iterator(items, LQuint::of);
	}

	public static <T> Iterator<LQuint> immIterator(Iterator<? extends T> items) {
		return iterator(items, LQuint::immutableOf);
	}
	...
	public static <T> Stream<LQuint.MutQuint> mutStream(Stream<? extends T> items) {
		return stream(items, LQuint::of);
	}

	public static <T> Stream<LQuint> immStream(Stream<? extends T> items) {
		return stream(items, LQuint::immutableOf);
	}
