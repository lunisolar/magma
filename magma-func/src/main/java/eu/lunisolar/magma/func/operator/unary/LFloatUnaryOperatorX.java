...
public interface LFloatUnaryOperatorX<X extends Throwable> extends MetaOperator, MetaInterface.Throwing<X> { // NOSONAR
	...
	String DESCRIPTION = "LFloatUnaryOperatorX: float doApplyAsFloat(float a) throws X";

	float doApplyAsFloat(float a) throws X;
	...
	default float shovingDoApplyAsFloat(float a) {
		return ((LFloatUnaryOperatorX<RuntimeException>) this).doApplyAsFloat(a);
	}

	/** Function call that handles exceptions according to the instructions. */
	default <Y extends Throwable> float handlingDoApplyAsFloat(float a, HandlingInstructions<Throwable, Y> handling) throws Y {
	...
	default float nonNullDoApplyAsFloat(float a) throws X {
	...
	default LFloatSupplierX<X> captureFloatUnaryOp(float a) {
		return () -> this.doApplyAsFloat(a);
	}
	...
	static <X extends Throwable> float call(float a, final @Nonnull LFloatUnaryOperatorX<X> lambda) throws X {
		Null.nonNullArg(lambda, "lambda");
		return lambda.doApplyAsFloat(a);
	}

	static <X extends Throwable> float shoving(float a, final @Nonnull LFloatUnaryOperatorX<X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.shovingDoApplyAsFloat(a);
	}

	static <X extends Throwable> float nesting(float a, final @Nonnull LFloatUnaryOperatorX<X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.nestingDoApplyAsFloat(a);
	}

	static <X extends Throwable, Y extends Throwable> float handling(float a, final HandlingInstructions<Throwable, Y> handling, final @Nonnull LFloatUnaryOperatorX<X> lambda) throws Y {
		Null.nonNullArg(lambda, "lambda");
	...
	@Nonnull
	static <X extends Throwable> LFloatUnaryOperatorX<X> safe() {
		return Function4U::produceFloat;
	}

	/** Safe instance supplier. Returns supplier of safe() instance. */
	@Nonnull
	static <X extends Throwable, Y extends Throwable> LSupplierX<LFloatUnaryOperatorX<X>, Y> safeSupplier() {
		return () -> safe();
	}

	/** Safe wrapping. Either argument function is returned (if it is not null) or safe() instance. */
	@Nonnull
	static <X extends Throwable> LFloatUnaryOperatorX<X> safe(final @Nullable LFloatUnaryOperatorX<X> other) {
		if (other == null) {
			return safe();
		} else {
			return other;
	...
	@Nonnull
	static <X extends Throwable, Y extends Throwable> LSupplierX<LFloatUnaryOperatorX<X>, Y> safeSupplier(final @Nullable LSupplierX<LFloatUnaryOperatorX<X>, Y> supplier) {
		if (supplier == null) {
			return safeSupplier();
		} else {
			return supplier;
	...
	@Nonnull
	default LFloatUnaryOperatorX<X> floatUnaryOpComposeFloat(@Nonnull final LFloatUnaryOperatorX<X> before) {
	...
	/** Allows to manipulate the domain of the function. */
	@Nonnull
	default <V> LToFloatFunctionX<V, X> floatUnaryOpCompose(@Nonnull final LToFloatFunctionX<? super V, X> before) {
		Null.nonNullArg(before, "before");
		return v -> this.doApplyAsFloat(before.doApplyAsFloat(v));
	}
