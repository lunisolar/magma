...
public interface LFloatUnaryOperatorX<X extends Throwable> extends MetaOperator, MetaInterface.Throwing<X> { // NOSONAR
	...
	static <X extends Throwable> float call(float a1, final @Nonnull LFloatUnaryOperatorX<X> lambda) throws X {
		Null.nonNullArg(lambda, "lambda");
		return lambda.doApplyAsFloat(a1);
	}

	static <X extends Throwable> float shoving(float a1, final @Nonnull LFloatUnaryOperatorX<X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.shovingDoApplyAsFloat(a1);
	}

	static <X extends Throwable> float nesting(float a1, final @Nonnull LFloatUnaryOperatorX<X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.nestingDoApplyAsFloat(a1);
	}

	static <X extends Throwable, Y extends Throwable> float handling(float a1, final HandlingInstructions<Throwable, Y> handling, final @Nonnull LFloatUnaryOperatorX<X> lambda) throws Y {
		Null.nonNullArg(lambda, "lambda");
