...
public interface LObjCharPredicate<T> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain2<a<T>, aChar> { // NOSONAR
	...
	default LCharPredicate _with(T a1) {
		return a2 -> test(a1, a2);
	}

	default LPredicate<T> with(char a2) {
	...
	final class M<T> implements LObjCharPredicate<T> {
		...
		public boolean currentTest(T a1, char a2) {
			boolean x1 = lastBaseValue;
		...
		public boolean currentBaseValue(T a1, char a2) {
	...
	public static <T> boolean any(boolean expected, T a1, char a2, @Nonnull Collection<? extends LObjCharPredicate<? super T>> predicates) {
		return any(expected, a1, a2, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static <T> boolean any(boolean expected, T a1, char a2, @Nonnull Stream<? extends LObjCharPredicate<? super T>> predicates) {
		return any(expected, a1, a2, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static <T> boolean any(boolean expected, T a1, char a2, @Nonnull Iterator<? extends LObjCharPredicate<? super T>> predicates) {
		Null.nonNullArg(predicates, "predicates");
	...
	public static <T> boolean any(boolean expected, T a1, char a2, @Nonnull LObjCharPredicate<? super T>... predicates) {
		Null.nonNullArg(predicates, "predicates");
