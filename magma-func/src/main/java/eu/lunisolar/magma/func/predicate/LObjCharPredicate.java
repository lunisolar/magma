...
public interface LObjCharPredicate<T> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain2<a<T>, aChar> { // NOSONAR
	...
	public static <T> void throwIf(T a1, char a2, @Nonnull LObjCharPredicate<T> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (pred.test(a1, a2)) {
	...
	/** Throws new exception if condition is met. */
	public static <T> void throwIf(T a1, @Nonnull LObjCharPredicate<T> pred, char a2, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}
	...
	public static <T> void throwIfNot(T a1, char a2, @Nonnull LObjCharPredicate<T> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}
	...
	/** Throws new exception if condition is not met. */
	public static <T> void throwIfNot(T a1, @Nonnull LObjCharPredicate<T> pred, char a2, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}
	...
	public static <T> T complying(T a1, char a2, @Nonnull LObjCharPredicate<T> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	public static <T> T notComplying(T a1, char a2, @Nonnull LObjCharPredicate<T> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (!pred.test(a1, a2)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
