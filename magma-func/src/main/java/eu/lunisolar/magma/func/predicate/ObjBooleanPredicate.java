...
/**
 * Non-throwing functional interface (lambda) ObjBooleanPredicate for Java 8.
 *
 * Type: predicate
 *
...
public interface ObjBooleanPredicate<T> extends ObjBooleanPredicateX<T, RuntimeException>, MetaPredicate, PrimitiveCodomain<Object>, MetaInterface.NonThrowing { // NOSONAR

	public static final String DESCRIPTION = "ObjBooleanPredicate: boolean test(T t, boolean b)";
	...
	@Nonnull
	public static <T> ObjBooleanPredicate<T> l(final @Nonnull ObjBooleanPredicate<T> lambda) {
	...
	@Nonnull
	public static <T, X extends Exception> ObjBooleanPredicate<T> wrap(final @Nonnull ObjBooleanPredicateX<T, X> other) {
	 ...
	 */
	@Nonnull
	public static <T1> ObjBooleanPredicate<T1> isEqual(final T1 v1, final boolean v2) {
	 ...
	 */
	@Nonnull
	default <V1> ObjBooleanPredicate<V1> fromBoolean(@Nonnull final Function<? super V1, ? extends T> before1, @Nonnull final BooleanUnaryOperator before2) {
	 ...
	 */
	@Nonnull
	default <V1, V2> BiPredicate<V1, V2> from(@Nonnull final Function<? super V1, ? extends T> before1, @Nonnull final Predicate<? super V2> before2) {
		Objects.requireNonNull(before1, Function4U.VALIDATION_MESSAGE_BEFORE1);
		Objects.requireNonNull(before2, Function4U.VALIDATION_MESSAGE_BEFORE2);
	...
	@Nonnull
	default <V> ObjBooleanFunction<T, V> then(@Nonnull BooleanFunction<? extends V> after) {
