...
public interface LBiObjSrtFunction<T1, T2, R> extends MetaFunction, MetaInterface.NonThrowing, Codomain<a<R>>, Domain3<a<T1>, a<T2>, aShort> { // NOSONAR
	...
	default R apply(T1 a1, T2 a2, short a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LBiObjSrtFunction<T1, T2, R> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
	...
	static <T1, T2, R> R tryApply(T1 a1, T2 a2, short a3, LBiObjSrtFunction<T1, T2, R> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		Null.nonNullArg(func, "func");
	...
	public default LBiObjSrtFunction untyped() {
		return this;
	}

	/** Cast that replace generics. */
	public default <V2, V3, V4> LBiObjSrtFunction<V2, V3, V4> cast() {
		return untyped();
	}

	/** Cast that replace generics. */
	public static <V2, V3, V4, T1, T2, R> LBiObjSrtFunction<V2, V3, V4> cast(LBiObjSrtFunction<T1, T2, R> function) {
	...
	public default LBiObjSrtFunction<T1, T2, R> beforeDo(@Nonnull LBiObjSrtConsumer<T1, T2> before) {
	...
	public default LBiObjSrtFunction<T1, T2, R> afterDo(@Nonnull LConsumer<R> after) {
