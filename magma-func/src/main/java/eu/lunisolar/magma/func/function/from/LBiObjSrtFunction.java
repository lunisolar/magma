...
public interface LBiObjSrtFunction<T1, T2, R> extends MetaFunction, MetaInterface.NonThrowing { // NOSONAR

	String DESCRIPTION = "LBiObjSrtFunction: R doApply(T1 a1,T2 a2,short a3)";

	@Nullable
	// R doApply(T1 a1,T2 a2,short a3) ;
	default R doApply(T1 a1, T2 a2, short a3) {
	...
	/**
	 * Implement this, but call doApply(T1 a1,T2 a2,short a3)
	 */
	R doApplyX(T1 a1, T2 a2, short a3) throws Throwable;
	...
	default R handlingDoApply(T1 a1, T2 a2, short a3, HandlingInstructions<Throwable, RuntimeException> handling) {
		try {
			return this.doApplyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default R tryDoApply(T1 a1, T2 a2, short a3, @Nonnull ExceptionWrapWithMessageFactory<RuntimeException> exceptionFactory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		try {
			return this.doApplyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default R tryDoApply(T1 a1, T2 a2, short a3, @Nonnull ExceptionWrapFactory<RuntimeException> exceptionFactory) {
		try {
			return this.doApplyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default R tryDoApplyThen(T1 a1, T2 a2, short a3, @Nonnull LFunction<Throwable, R> handler) {
		try {
			return this.doApplyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	static <T1, T2, R> R handlingDoApply(T1 a1, T2 a2, short a3, LBiObjSrtFunction<T1, T2, R> func, HandlingInstructions<Throwable, RuntimeException> handling) { // <-
		Null.nonNullArg(func, "func");
		return func.handlingDoApply(a1, a2, a3, handling);
	}

	static <T1, T2, R> R tryDoApply(T1 a1, T2 a2, short a3, LBiObjSrtFunction<T1, T2, R> func) {
		return tryDoApply(a1, a2, a3, func, null);
	}

	static <T1, T2, R> R tryDoApply(T1 a1, T2 a2, short a3, LBiObjSrtFunction<T1, T2, R> func, @Nonnull ExceptionWrapWithMessageFactory<RuntimeException> exceptionFactory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		Null.nonNullArg(func, "func");
		return func.tryDoApply(a1, a2, a3, exceptionFactory, newMessage, messageParams);
	}

	static <T1, T2, R> R tryDoApply(T1 a1, T2 a2, short a3, LBiObjSrtFunction<T1, T2, R> func, @Nonnull ExceptionWrapFactory<RuntimeException> exceptionFactory) {
		Null.nonNullArg(func, "func");
		return func.tryDoApply(a1, a2, a3, exceptionFactory);
	}

	static <T1, T2, R> R tryDoApplyThen(T1 a1, T2 a2, short a3, LBiObjSrtFunction<T1, T2, R> func, @Nonnull LFunction<Throwable, R> handler) {
		Null.nonNullArg(func, "func");
		return func.tryDoApplyThen(a1, a2, a3, handler);
	}

	default R failSafeDoApply(T1 a1, T2 a2, short a3, @Nonnull LBiObjSrtFunction<T1, T2, R> failSafe) {
		try {
	...
	static <T1, T2, R> R failSafeDoApply(T1 a1, T2 a2, short a3, LBiObjSrtFunction<T1, T2, R> func, @Nonnull LBiObjSrtFunction<T1, T2, R> failSafe) {
	...
	static <T1, T2, R> LBiObjSrtFunction<T1, T2, R> failSafeBiObjSrtFunc(LBiObjSrtFunction<T1, T2, R> func, @Nonnull LBiObjSrtFunction<T1, T2, R> failSafe) {
		Null.nonNullArg(failSafe, "failSafe");
	...
	@Nonnull
	default R nonNullDoApply(T1 a1, T2 a2, short a3) {
	...
	public default LBiFunction<T1, T2, R> rShrink(LToSrtBiFunction<T1, T2> right) {
		return (a1, a2) -> doApply(a1, a2, right.doApplyAsSrt(a1, a2));
	}
	...
	/**  */
	public static <T1, T2, R> LBiObjSrtFunction<T1, T2, R> uncurryBiObjSrtFunc(LFunction<T1, LFunction<T2, LSrtFunction<R>>> func) {
		return (T1 a1, T2 a2, short a3) -> func.doApply(a1).doApply(a2).doApply(a3);
	}

	/** Captures arguments but delays the evaluation. */
	default LSupplier<R> captureBiObjSrtFunc(T1 a1, T2 a2, short a3) {
	...
	static <T1, T2, R> LBiObjSrtFunction<T1, T2, R> recursive(final @Nonnull LFunction<LBiObjSrtFunction<T1, T2, R>, LBiObjSrtFunction<T1, T2, R>> selfLambda) {
		final LBiObjSrtFunctionSingle<T1, T2, R> single = new LBiObjSrtFunctionSingle();
		LBiObjSrtFunction<T1, T2, R> func = selfLambda.doApply(single);
		single.target = func;
		return func;
	}

	final class LBiObjSrtFunctionSingle<T1, T2, R> implements LSingle<LBiObjSrtFunction<T1, T2, R>>, LBiObjSrtFunction<T1, T2, R> {
		private LBiObjSrtFunction<T1, T2, R> target = null;

		@Override
		public R doApplyX(T1 a1, T2 a2, short a3) throws Throwable {
			return target.doApplyX(a1, a2, a3);
		}

		@Override
		public LBiObjSrtFunction<T1, T2, R> value() {
			return target;
		}
	}

	@Nonnull
	static <T1, T2, R> LBiObjSrtFunction<T1, T2, R> biObjSrtFuncThrowing(final @Nonnull ExceptionFactory<Throwable> exceptionFactory) {
	...
	@Nonnull
	static <T1, T2, R> LBiObjSrtFunction<T1, T2, R> biObjSrtFuncThrowing(final String message, final @Nonnull ExceptionWithMessageFactory<Throwable> exceptionFactory) {
		Null.nonNullArg(exceptionFactory, "exceptionFactory");
		return (a1, a2, a3) -> {
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2, R> LObjSrtObj1Func<T1, T2, R> objSrtObj1Func(final @Nonnull LObjSrtObj1Func<T1, T2, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1, R> LObj1Obj0SrtFunc<T2, T1, R> obj1Obj0SrtFunc(final @Nonnull LObj1Obj0SrtFunc<T2, T1, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1, R> LObj1SrtObj0Func<T2, T1, R> obj1SrtObj0Func(final @Nonnull LObj1SrtObj0Func<T2, T1, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2, R> LSrtObj0Obj1Func<T1, T2, R> srtObj0Obj1Func(final @Nonnull LSrtObj0Obj1Func<T1, T2, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1, R> LSrtObjObj0Func<T2, T1, R> srtObjObj0Func(final @Nonnull LSrtObjObj0Func<T2, T1, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	static <T1, T2, R> LBiObjSrtFunction<T1, T2, R> safe() {
		return LBiObjSrtFunction::produce;
	}
	...
	@Nonnull
	default <V1, V2> LBiObjSrtFunction<V1, V2, R> biObjSrtFuncComposeSrt(@Nonnull final LFunction<? super V1, ? extends T1> before1, @Nonnull final LFunction<? super V2, ? extends T2> before2, @Nonnull final LSrtUnaryOperator before3) {
		Null.nonNullArg(before1, "before1");
		Null.nonNullArg(before2, "before2");
		Null.nonNullArg(before3, "before3");
		return (v1, v2, v3) -> this.doApply(before1.doApply(v1), before2.doApply(v2), before3.doApplyAsSrt(v3));
	}

	public static <V1, V2, T1, T2, R> LBiObjSrtFunction<V1, V2, R> composedSrt(@Nonnull final LFunction<? super V1, ? extends T1> before1, @Nonnull final LFunction<? super V2, ? extends T2> before2, @Nonnull final LSrtUnaryOperator before3,
			LBiObjSrtFunction<T1, T2, R> after) {
		return after.biObjSrtFuncComposeSrt(before1, before2, before3);
	}
	...
	@Nonnull
	default LBiObjSrtFunction<T1, T2, R> nestingBiObjSrtFunc() {
		return this;
	}

	/** Converts to non-throwing variant that will propagate checked exception as it would be unchecked - there is no exception wrapping involved (at least not here). */
	default LBiObjSrtFunction<T1, T2, R> shovingBiObjSrtFunc() {
		return this;
	}
	...
	@Nonnull
	default LBiObjSrtFunction<T1, T2, R> nonNullBiObjSrtFunc() {
	...
	@FunctionalInterface
	interface LObjSrtObj1Func<T1, T2, R> extends LBiObjSrtFunction<T1, T2, R> {
		@Nullable
		R doApplyObjSrtObj1(T1 a1, short a3, T2 a2);

		@Override
		default R doApplyX(T1 a1, T2 a2, short a3) {
			return this.doApplyObjSrtObj1(a1, a3, a2);
		}
	}

	/** Permutation of LBiObjSrtFunction for method references. */
	@FunctionalInterface
	interface LObj1Obj0SrtFunc<T2, T1, R> extends LBiObjSrtFunction<T1, T2, R> {
		@Nullable
		R doApplyObj1Obj0Srt(T2 a2, T1 a1, short a3);

		@Override
		default R doApplyX(T1 a1, T2 a2, short a3) {
			return this.doApplyObj1Obj0Srt(a2, a1, a3);
		}
	}

	/** Permutation of LBiObjSrtFunction for method references. */
	@FunctionalInterface
	interface LObj1SrtObj0Func<T2, T1, R> extends LBiObjSrtFunction<T1, T2, R> {
		@Nullable
		R doApplyObj1SrtObj0(T2 a2, short a3, T1 a1);

		@Override
		default R doApplyX(T1 a1, T2 a2, short a3) {
			return this.doApplyObj1SrtObj0(a2, a3, a1);
		}
	}

	/** Permutation of LBiObjSrtFunction for method references. */
	@FunctionalInterface
	interface LSrtObj0Obj1Func<T1, T2, R> extends LBiObjSrtFunction<T1, T2, R> {
		@Nullable
		R doApplySrtObj0Obj1(short a3, T1 a1, T2 a2);

		@Override
		default R doApplyX(T1 a1, T2 a2, short a3) {
			return this.doApplySrtObj0Obj1(a3, a1, a2);
		}
	}

	/** Permutation of LBiObjSrtFunction for method references. */
	@FunctionalInterface
	interface LSrtObjObj0Func<T2, T1, R> extends LBiObjSrtFunction<T1, T2, R> {
		@Nullable
		R doApplySrtObjObj0(short a3, T2 a2, T1 a1);

		@Override
		default R doApplyX(T1 a1, T2 a2, short a3) {
			return this.doApplySrtObjObj0(a3, a2, a1);
		}
	}
	...
	/** Does nothing (LBiObjSrtFunction.LObjSrtObj1Func) Function */
	public static <T1, T2, R> R produce(T1 a1, short a3, T2 a2) {
		return (R) Function4U.defaultObject;
	}

	/** Does nothing (LBiObjSrtFunction.LSrtObj0Obj1Func) Function */
	public static <T1, T2, R> R produce(short a3, T1 a1, T2 a2) {
		return (R) Function4U.defaultObject;
	}

	// MAP: FOR, [SourcePurpose{arg=T1 a1, type=IA}, SourcePurpose{arg=T2 a2, type=IA}, SourcePurpose{arg=short a3, type=IA}, SourcePurpose{arg=LConsumer<?
	...
	// MAP: WHILE, [SourcePurpose{arg=T1 a1, type=SA}, SourcePurpose{arg=T2 a2, type=IA}, SourcePurpose{arg=short a3, type=IA}, SourcePurpose{arg=LConsumer<?
	// super R> consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T1 a1, type=IA}, SourcePurpose{arg=T2 a2, type=SA}, SourcePurpose{arg=short a3, type=IA}, SourcePurpose{arg=LConsumer<?
	// super R> consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T1 a1, type=SA}, SourcePurpose{arg=T2 a2, type=SA}, SourcePurpose{arg=short a3, type=IA}, SourcePurpose{arg=LConsumer<?
	// super R> consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T1 a1, type=IA}, SourcePurpose{arg=T2 a2, type=IA}, SourcePurpose{arg=short a3, type=SA}, SourcePurpose{arg=LConsumer<?
	// super R> consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T1 a1, type=SA}, SourcePurpose{arg=T2 a2, type=IA}, SourcePurpose{arg=short a3, type=SA}, SourcePurpose{arg=LConsumer<?
	// super R> consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T1 a1, type=IA}, SourcePurpose{arg=T2 a2, type=SA}, SourcePurpose{arg=short a3, type=SA}, SourcePurpose{arg=LConsumer<?
	// super R> consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T1 a1, type=SA}, SourcePurpose{arg=T2 a2, type=SA}, SourcePurpose{arg=short a3, type=SA}, SourcePurpose{arg=LConsumer<?
	// super R> consumer, type=CONST}]
