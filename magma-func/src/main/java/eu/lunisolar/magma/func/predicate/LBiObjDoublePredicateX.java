...
public interface LBiObjDoublePredicateX<T1, T2, X extends Throwable> extends MetaPredicate, MetaInterface.Throwing<X> { // NOSONAR
	...
	interface V1<T1, T2, X extends Throwable> extends LBiObjDoublePredicateX<T1, T2, X> {
		...
		boolean apply1(T1 a1, double a3, T2 a2) throws X;
	...
	/** Permutation of LBiObjDoublePredicateX for method references. */
	@FunctionalInterface
	interface V2<T1, T2, X extends Throwable> extends LBiObjDoublePredicateX<T1, T2, X> {

		boolean apply2(T2 a2, T1 a1, double a3) throws X;
	...
	/** Permutation of LBiObjDoublePredicateX for method references. */
	@FunctionalInterface
	interface V3<T1, T2, X extends Throwable> extends LBiObjDoublePredicateX<T1, T2, X> {

		boolean apply3(T2 a2, double a3, T1 a1) throws X;
	...
	interface V4<T1, T2, X extends Throwable> extends LBiObjDoublePredicateX<T1, T2, X> {
		...
		boolean apply4(double a3, T1 a1, T2 a2) throws X;
	...
	/** Permutation of LBiObjDoublePredicateX for method references. */
	@FunctionalInterface
	interface V5<T1, T2, X extends Throwable> extends LBiObjDoublePredicateX<T1, T2, X> {

		boolean apply5(double a3, T2 a2, T1 a1) throws X;
