...
public interface LBiObjDoublePredicateX<T1, T2, X extends Exception> extends MetaPredicate, PrimitiveCodomain<Object>, MetaInterface.Throwing<X> { // NOSONAR

	public static final String DESCRIPTION = "LBiObjDoublePredicateX: boolean test(T1 t1,T2 t2, double d) throws X";
	...
	public static <T1, T2, X extends Exception> LBiObjDoublePredicateX<T1, T2, X> constant(boolean r) {
		return (t1, t2, d) -> r;
	}
	...
	@Nonnull
	public static <T1, T2, X extends Exception> LBiObjDoublePredicateX<T1, T2, X> lX(final @Nonnull LBiObjDoublePredicateX<T1, T2, X> lambda) {
	...
	@Nonnull
	public static <T1, T2, X extends Exception> LBiObjDoublePredicateX<T1, T2, X> wrapX(final @Nonnull LBiObjDoublePredicate<T1, T2> other) {
		return other::test;
	}
	 ...
	 */
	@Nonnull
	public static <T1, T2, X extends Exception> LBiObjDoublePredicateX<T1, T2, X> isEqual(final T1 v1, final T2 v2, final double v3) {
	...
	default LBiObjDoublePredicate<T1, T2> nonThrowing() {
		return LBiObjDoublePredicate.wrap(this);
	}
	...
	default LBiObjDoublePredicate<T1, T2> shove() {
		LBiObjDoublePredicateX<T1, T2, RuntimeException> exceptionCast = (LBiObjDoublePredicateX<T1, T2, RuntimeException>) this;
	...
	@Nonnull
	public static <T1, T2, X extends Exception, E extends Exception, Y extends Exception> LBiObjDoublePredicateX<T1, T2, Y> wrapException(@Nonnull final LBiObjDoublePredicateX<T1, T2, X> other, Class<E> exception, LBooleanSupplierX<X> supplier,
	...
	@Nonnull
	default <E extends Exception, Y extends Exception> LBiObjDoublePredicateX<T1, T2, Y> handleX(Class<E> exception, ExceptionHandler<E, Y> handler) {
		Objects.requireNonNull(exception, Function4U.VALIDATION_MESSAGE_EXCEPTION);
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return LBiObjDoublePredicateX.wrapException(this, exception, null, (ExceptionHandler) handler);
	}

	/** Wraps with exception handling that for any exception (including unchecked exception that might be different from X) will call handler function to determine the final exception. */
	@Nonnull
	default <Y extends Exception> LBiObjDoublePredicateX<T1, T2, Y> handleX(ExceptionHandler<Exception, Y> handler) {
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return LBiObjDoublePredicateX.wrapException(this, Exception.class, null, (ExceptionHandler) handler);
	}

	/** Wraps with exception handling that for argument exception class will call supplier and return default value instead for propagating exception.  */
	@Nonnull
	default <E extends Exception, Y extends Exception> LBiObjDoublePredicateX<T1, T2, Y> handleX(Class<E> exception, LBooleanSupplierX<X> supplier) {
		Objects.requireNonNull(exception, Function4U.VALIDATION_MESSAGE_EXCEPTION);
		Objects.requireNonNull(supplier, Function4U.VALIDATION_MESSAGE_HANDLER);

		return LBiObjDoublePredicateX.wrapException(this, exception, supplier, null);
	}

	/** Wraps with exception handling that for any exception will call supplier and return default value instead for propagating exception.  */
	@Nonnull
	default <Y extends Exception> LBiObjDoublePredicateX<T1, T2, Y> handleX(LBooleanSupplierX<X> supplier) {
		Objects.requireNonNull(supplier, Function4U.VALIDATION_MESSAGE_HANDLER);

		return LBiObjDoublePredicateX.wrapException(this, Exception.class, supplier, null);
	}
