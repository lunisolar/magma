...
public interface LDoubleSupplierX<X extends Throwable> extends DoubleSupplier, MetaSupplier, MetaInterface.Throwing<X> { // NOSONAR
	...
	@Nonnull
	static <X extends Throwable> LDoubleSupplierX<X> safe() {
		return Function4U::produceDouble;
	}

	/** Safe instance supplier. Returns supplier of safe() instance. */
	@Nonnull
	static <X extends Throwable, Y extends Throwable> LSupplierX<LDoubleSupplierX<X>, Y> safeSupplier() {
		return () -> safe();
	}

	/** Safe wrapping. Either argument function is returned (if it is not null) or safe() instance. */
	@Nonnull
	static <X extends Throwable> LDoubleSupplierX<X> safe(final @Nullable LDoubleSupplierX<X> other) {
		if (other == null) {
			return safe();
		} else {
			return other;
	...
	@Nonnull
	static <X extends Throwable, Y extends Throwable> LSupplierX<LDoubleSupplierX<X>, Y> safeSupplier(final @Nullable LSupplierX<LDoubleSupplierX<X>, Y> supplier) {
		if (supplier == null) {
			return safeSupplier();
		} else {
			return supplier;
	...
	@Nonnull
	default <V> LSupplierX<V, X> toSup(@Nonnull LDoubleFunctionX<? extends V, X> after) {
	...
	/** Combines two functions together in a order. */
	@Nonnull
	default LByteSupplierX<X> toByteSup(@Nonnull LDoubleToByteFunctionX<X> after) {
		Null.nonNullArg(after, "after");
	...
	/** Combines two functions together in a order. */
	@Nonnull
	default LShortSupplierX<X> toShortSup(@Nonnull LDoubleToShortFunctionX<X> after) {
		Null.nonNullArg(after, "after");
	...
	/** Combines two functions together in a order. */
	@Nonnull
	default LIntSupplierX<X> toIntSup(@Nonnull LDoubleToIntFunctionX<X> after) {
		Null.nonNullArg(after, "after");
	...
	/** Combines two functions together in a order. */
	@Nonnull
	default LLongSupplierX<X> toLongSup(@Nonnull LDoubleToLongFunctionX<X> after) {
		Null.nonNullArg(after, "after");
	...
	/** Combines two functions together in a order. */
	@Nonnull
	default LFloatSupplierX<X> toFloatSup(@Nonnull LDoubleToFloatFunctionX<X> after) {
		Null.nonNullArg(after, "after");
	...
	/** Combines two functions together in a order. */
	@Nonnull
	default LDoubleSupplierX<X> toDoubleSup(@Nonnull LDoubleUnaryOperatorX<X> after) {
		Null.nonNullArg(after, "after");
	...
	/** Combines two functions together in a order. */
	@Nonnull
	default LCharSupplierX<X> toCharSup(@Nonnull LDoubleToCharFunctionX<X> after) {
		Null.nonNullArg(after, "after");
	...
	/** Combines two functions together in a order. */
	@Nonnull
	default LBoolSupplierX<X> toBoolSup(@Nonnull LDoublePredicateX<X> after) {
		Null.nonNullArg(after, "after");
