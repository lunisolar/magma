...
public interface LBiObjLongFunction<T1, T2, R> extends LBiObjLongFunctionX<T1, T2, R, RuntimeException>, MetaFunction, MetaInterface.NonThrowing { // NOSONAR
	...
	/** Permutation of LBiObjLongFunction for method references. */
	@FunctionalInterface
	interface V2<T1, T2, R> extends LBiObjLongFunction<T1, T2, R> {
		@Nullable
		R apply2(T2 a2, T1 a1, long a3);
	...
	/** Permutation of LBiObjLongFunction for method references. */
	@FunctionalInterface
	interface V3<T1, T2, R> extends LBiObjLongFunction<T1, T2, R> {
		@Nullable
		R apply3(T2 a2, long a3, T1 a1);
	...
	/** Permutation of LBiObjLongFunction for method references. */
	@FunctionalInterface
	interface V5<T1, T2, R> extends LBiObjLongFunction<T1, T2, R> {
		@Nullable
		R apply5(long a3, T2 a2, T1 a1);
