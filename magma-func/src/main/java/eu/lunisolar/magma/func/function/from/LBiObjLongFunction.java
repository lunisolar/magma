...
public interface LBiObjLongFunction<T1, T2, R> extends LBiObjLongFunctionX<T1, T2, R, RuntimeException>, MetaFunction, MetaInterface.NonThrowing { // NOSONAR
	...
	@Nonnull
	static <T1, T2, R> LBiObjLongFunction<T1, T2, R> l(final @Nonnull LBiObjLongFunction<T1, T2, R> lambda) {
	...
	@Nonnull
	static <T1, T2, R, X extends Throwable> LBiObjLongFunction<T1, T2, R> wrap(final @Nonnull LBiObjLongFunctionX<T1, T2, R, X> other) {
	...
	@FunctionalInterface
	interface V1<T1, T2, R> extends LBiObjLongFunction<T1, T2, R> {
		@Nullable
		R doApplyV1(T1 a1, long a3, T2 a2);
	...
	/** Permutation of LBiObjLongFunction for method references. */
	@FunctionalInterface
	interface V2<T2, T1, R> extends LBiObjLongFunction<T1, T2, R> {
		@Nullable
		R doApplyV2(T2 a2, T1 a1, long a3);
	...
	/** Permutation of LBiObjLongFunction for method references. */
	@FunctionalInterface
	interface V3<T2, T1, R> extends LBiObjLongFunction<T1, T2, R> {
		@Nullable
		R doApplyV3(T2 a2, long a3, T1 a1);
	...
	/** Permutation of LBiObjLongFunction for method references. */
	@FunctionalInterface
	interface V4<T1, T2, R> extends LBiObjLongFunction<T1, T2, R> {
		@Nullable
		R doApplyV4(long a3, T1 a1, T2 a2);
	...
	/** Permutation of LBiObjLongFunction for method references. */
	@FunctionalInterface
	interface V5<T2, T1, R> extends LBiObjLongFunction<T1, T2, R> {
		@Nullable
		R doApplyV5(long a3, T2 a2, T1 a1);
