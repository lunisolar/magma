...
/**
 * Throwing functional interface (lambda) ByteToShortFunctionX for Java 8.
 *
 * Type: function
 *
 * Domain (lvl: 1): byte b
...
public interface ByteToShortFunctionX<X extends Exception> extends MetaFunction, PrimitiveCodomain<Object>, MetaInterface.Throwing<X> { // NOSONAR
	...
	public static <X extends Exception> ByteToShortFunctionX<X> constant(short r) {
		return (b) -> r;
	}
	...
	default ByteToShortFunctionX<RuntimeException> uncheck() {
		return (ByteToShortFunctionX) this;
	}
	...
	@Nonnull
	default <E extends Exception, Y extends Exception> ByteToShortFunctionX<Y> handleX(Class<E> exception, ExceptionHandler<E, Y> handler) {
	...
	@Nonnull
	default <Y extends Exception> ByteToShortFunctionX<Y> handleX(ExceptionHandler<Exception, Y> handler) {
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);
	...
	@Nonnull
	default <E extends Exception, Y extends Exception> ByteToShortFunctionX<Y> handleX(Class<E> exception, ShortSupplierX<X> supplier) {
		Objects.requireNonNull(exception, Function4U.VALIDATION_MESSAGE_EXCEPTION);
	...
	@Nonnull
	default <Y extends Exception> ByteToShortFunctionX<Y> handleX(ShortSupplierX<X> supplier) {
		Objects.requireNonNull(supplier, Function4U.VALIDATION_MESSAGE_HANDLER);
