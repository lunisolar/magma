...
public interface LFloatToLongFunctionX<X extends Throwable> extends MetaFunction, MetaInterface.Throwing<X> { // NOSONAR

	String DESCRIPTION = "LFloatToLongFunctionX: long doApplyAsLong(float a) throws X";

	long doApplyAsLong(float a) throws X;

	default long tupleApplyAsLong(LFloatSingle args) throws X {
	...
	default long shovingDoApplyAsLong(float a) {
		return ((LFloatToLongFunctionX<RuntimeException>) this).doApplyAsLong(a);
	}

	/** Function call that handles exceptions according to the instructions. */
	default <Y extends Throwable> long handlingDoApplyAsLong(float a, HandlingInstructions<Throwable, Y> handling) throws Y {
	...
	default long nonNullDoApplyAsLong(float a) throws X {
	...
	default LLongSupplierX<X> captureFloatToLongFunc(float a) {
		return () -> this.doApplyAsLong(a);
	}
	...
	static <X extends Throwable> long call(float a, final @Nonnull LFloatToLongFunctionX<X> lambda) throws X {
		Null.nonNullArg(lambda, "lambda");
		return lambda.doApplyAsLong(a);
	}

	static <X extends Throwable> long shoving(float a, final @Nonnull LFloatToLongFunctionX<X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.shovingDoApplyAsLong(a);
	}

	static <X extends Throwable> long nesting(float a, final @Nonnull LFloatToLongFunctionX<X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.nestingDoApplyAsLong(a);
	}

	static <X extends Throwable, Y extends Throwable> long handling(float a, final HandlingInstructions<Throwable, Y> handling, final @Nonnull LFloatToLongFunctionX<X> lambda) throws Y {
		Null.nonNullArg(lambda, "lambda");
	...
	@Nonnull
	static <X extends Throwable> LFloatToLongFunctionX<X> safe() {
		return Function4U::produceLong;
	}

	/** Safe instance supplier. Returns supplier of safe() instance. */
	@Nonnull
	static <X extends Throwable, Y extends Throwable> LSupplierX<LFloatToLongFunctionX<X>, Y> safeSupplier() {
		return () -> safe();
	}

	/** Safe wrapping. Either argument function is returned (if it is not null) or safe() instance. */
	@Nonnull
	static <X extends Throwable> LFloatToLongFunctionX<X> safe(final @Nullable LFloatToLongFunctionX<X> other) {
		if (other == null) {
			return safe();
		} else {
			return other;
	...
	@Nonnull
	static <X extends Throwable, Y extends Throwable> LSupplierX<LFloatToLongFunctionX<X>, Y> safeSupplier(final @Nullable LSupplierX<LFloatToLongFunctionX<X>, Y> supplier) {
		if (supplier == null) {
			return safeSupplier();
		} else {
			return supplier;
	...
	@Nonnull
	default LFloatToLongFunctionX<X> floatToLongFuncComposeFloat(@Nonnull final LFloatUnaryOperatorX<X> before) {
	...
	/** Allows to manipulate the domain of the function. */
	@Nonnull
	default <V> LToLongFunctionX<V, X> floatToLongFuncCompose(@Nonnull final LToFloatFunctionX<? super V, X> before) {
		Null.nonNullArg(before, "before");
		return v -> this.doApplyAsLong(before.doApplyAsFloat(v));
	}
	...
	/** Combines two functions together in a order. */
	@Nonnull
	default LFloatPredicateX<X> thenToBool(@Nonnull LLongPredicateX<X> after) {
		Null.nonNullArg(after, "after");
