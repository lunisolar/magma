...
public interface LFloatToLongFunctionX<X extends Throwable> extends MetaFunction, MetaInterface.Throwing<X> { // NOSONAR
	...
	String DESCRIPTION = "LFloatToLongFunctionX: long doApplyAsLong(float a1) throws X";

	long doApplyAsLong(float a1) throws X;
	...
	default long nestingDoApplyAsLong(float a1) {
		try {
	...
	default long shovingDoApplyAsLong(float a1) {
		return ((LFloatToLongFunctionX<RuntimeException>) this).doApplyAsLong(a1);
	}

	/** Function call that handles exceptions according to the instructions. */
	default <Y extends Throwable> long handlingDoApplyAsLong(float a1, HandlingInstructions<Throwable, Y> handling) throws Y {
	...
	default long nonNullDoApplyAsLong(float a1) throws X {
	...
	default LLongSupplierX<X> captureFloatToLongFunc(float a1) {
		return () -> this.doApplyAsLong(a1);
	}
	...
	static <X extends Throwable> long call(float a1, final @Nonnull LFloatToLongFunctionX<X> lambda) throws X {
		Null.nonNullArg(lambda, "lambda");
		return lambda.doApplyAsLong(a1);
	}

	static <X extends Throwable> long shoving(float a1, final @Nonnull LFloatToLongFunctionX<X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.shovingDoApplyAsLong(a1);
	}

	static <X extends Throwable> long nesting(float a1, final @Nonnull LFloatToLongFunctionX<X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.nestingDoApplyAsLong(a1);
	}

	static <X extends Throwable, Y extends Throwable> long handling(float a1, final HandlingInstructions<Throwable, Y> handling, final @Nonnull LFloatToLongFunctionX<X> lambda) throws Y {
		Null.nonNullArg(lambda, "lambda");
