...
public interface LObjIntConsumer<T> extends ObjIntConsumer<T>, MetaConsumer, MetaInterface.NonThrowing, TeConsumer<T, aInt>, Codomain<aVoid>, Domain2<a<T>, aInt> {
	...
	static <T> void tryAccept(T a1, int a2, LObjIntConsumer<T> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		Null.nonNullArg(func, "func");
	...
	public default LObjIntConsumer untyped() {
		return this;
	}

	/** Cast that replace generics. */
	public default <V2> LObjIntConsumer<V2> cast() {
		return untyped();
	}
