...
public interface LObjBytePredicate<T> extends LObjBytePredicateX<T, RuntimeException>, MetaPredicate, MetaInterface.NonThrowing { // NOSONAR
	...
	@FunctionalInterface
	interface V1<T> extends LObjBytePredicate<T> {

		boolean doTestV1(byte a2, T a1);
