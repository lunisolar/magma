...
public interface LObjBytePredicate<T> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain2<a<T>, aByte> { // NOSONAR
	...
	default LBytePredicate _with(T a1) {
		return a2 -> test(a1, a2);
	}

	default LPredicate<T> with(byte a2) {
	...
	public static <T, X extends Throwable> T throwIfNotEx(T a1, byte a2, @Nonnull LObjByteFunction<? super T, ? extends String> specialPredicate, @Nonnull ExMF<X> factory) throws X {
	...
	/** Throws new exception if condition is not met (non null message is returned by 'predicate') */
	public static <T, X extends Throwable> T throwIfNotEx(T a1, byte a2, @Nonnull LObjByteFunction<? super T, ? extends String> specialPredicate, @Nonnull ExMF<X> factory, @Nonnull String msg) throws X {
		Null.nonNullArg(specialPredicate, "specialPredicate");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(msg, "msg");
		var m = specialPredicate.apply(a1, a2);
	...
	/** Throws new exception if condition is not met (non null message is returned by 'predicate') */
	public static <T, X extends Throwable> T throwIfNotEx(T a1, byte a2, @Nonnull LObjByteFunction<? super T, ? extends String> specialPredicate, @Nonnull ExMF<X> factory, @Nonnull String message, @Nullable Object param1) throws X {
		Null.nonNullArg(specialPredicate, "specialPredicate");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(message, "message");
		var m = specialPredicate.apply(a1, a2);
	...
	/** Throws new exception if condition is not met (non null message is returned by 'predicate') */
	public static <T, X extends Throwable> T throwIfNotEx(T a1, byte a2, @Nonnull LObjByteFunction<? super T, ? extends String> specialPredicate, @Nonnull ExMF<X> factory, @Nonnull String message, @Nullable Object param1, @Nullable Object param2)
			throws X {
		Null.nonNullArg(specialPredicate, "specialPredicate");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(message, "message");
	...
	/** Throws new exception if condition is not met (non null message is returned by 'predicate') */
	public static <T, X extends Throwable> T throwIfNotEx(T a1, @Nonnull LObjByteFunction<? super T, ? extends String> specialPredicate, byte a2, @Nonnull ExMF<X> factory) throws X {
		Null.nonNullArg(specialPredicate, "specialPredicate");
		Null.nonNullArg(factory, "factory");
		var m = specialPredicate.apply(a1, a2);
		if (m != null) {
	...
	/** Throws new exception if condition is not met (non null message is returned by 'predicate') */
	public static <T, X extends Throwable> T throwIfNotEx(T a1, @Nonnull LObjByteFunction<? super T, ? extends String> specialPredicate, byte a2, @Nonnull ExMF<X> factory, @Nonnull String msg) throws X {
		Null.nonNullArg(specialPredicate, "specialPredicate");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(msg, "msg");
		var m = specialPredicate.apply(a1, a2);
	...
	/** Throws new exception if condition is not met (non null message is returned by 'predicate') */
	public static <T, X extends Throwable> T throwIfNotEx(T a1, @Nonnull LObjByteFunction<? super T, ? extends String> specialPredicate, byte a2, @Nonnull ExMF<X> factory, @Nonnull String message, @Nullable Object param1) throws X {
		Null.nonNullArg(specialPredicate, "specialPredicate");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(message, "message");
		var m = specialPredicate.apply(a1, a2);
	...
	/** Throws new exception if condition is not met (non null message is returned by 'predicate') */
	public static <T, X extends Throwable> T throwIfNotEx(T a1, @Nonnull LObjByteFunction<? super T, ? extends String> specialPredicate, byte a2, @Nonnull ExMF<X> factory, @Nonnull String message, @Nullable Object param1, @Nullable Object param2)
			throws X {
		Null.nonNullArg(specialPredicate, "specialPredicate");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(message, "message");
	...
	final class M<T> implements LObjBytePredicate<T> {
		...
		public boolean currentTest(T a1, byte a2) {
			boolean x1 = lastBaseValue;
		...
		public boolean currentBaseValue(T a1, byte a2) {
	...
	public static <T> boolean any(boolean expected, T a1, byte a2, @Nonnull Collection<? extends LObjBytePredicate<? super T>> predicates) {
		return any(expected, a1, a2, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static <T> boolean any(boolean expected, T a1, byte a2, @Nonnull Stream<? extends LObjBytePredicate<? super T>> predicates) {
		return any(expected, a1, a2, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static <T> boolean any(boolean expected, T a1, byte a2, @Nonnull Iterator<? extends LObjBytePredicate<? super T>> predicates) {
		Null.nonNullArg(predicates, "predicates");
	...
	public static <T> boolean any(boolean expected, T a1, byte a2, @Nonnull LObjBytePredicate<? super T>... predicates) {
		Null.nonNullArg(predicates, "predicates");
	...
	/** Allows to manipulate the domain of the function. */
	@Nonnull
	default <V1, V2> LBiPredicate<V1, V2> unboxingCompose(@Nonnull final LFunction<? super V1, ? extends T> before1, @Nonnull final LToByteFunction<? super V2> before2) {
		Null.nonNullArg(before1, "before1");
		Null.nonNullArg(before2, "before2");
		return (v1, v2) -> this.test(before1.apply(v1), before2.applyAsByte(v2));
	}
	...
	default LObjBytePredicate<T> shoving() {

		return new LObjBytePredicate<T>() {

			public boolean test(T a1, byte a2) {
				try {
					return this.testX(a1, a2);
				} catch (Throwable e) { // NOSONAR
					Handling.handleErrors(e);
			...
			public boolean testX(T a1, byte a2) throws Throwable {
				return LObjBytePredicate.this.testX(a1, a2);
			}
