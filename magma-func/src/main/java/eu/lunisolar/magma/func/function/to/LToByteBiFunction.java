...
public interface LToByteBiFunction<T1, T2> extends MetaFunction, MetaInterface.NonThrowing, Codomain<aByte>, Domain2<a<T1>, a<T2>> { // NOSONAR
	...
	/**  */
	public static <T1, T2> LToByteBiFunction<T1, T2> uncurry(LFunction<T1, LToByteFunction<T2>> func) {
	...
	@Nonnull
	static <T1, T2> LToByteBiFunction<T1, T2> toByteBiFunc(Class<T1> c1, Class<T2> c2, final @Nonnull LToByteBiFunction<T1, T2> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
