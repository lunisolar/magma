...
/**
 * Throwing functional interface (lambda) BiDoublePredicateX for Java 8.
 *
 * Type: predicate
 *
...
public interface BiDoublePredicateX<X extends Exception> extends MetaPredicate, PrimitiveCodomain<BiDoublePredicateX<X>>, MetaThrowingInterface<X> { // NOSONAR
	...
	default BooleanSupplierX<X> capture(double d1, double d2) {
	...
	default BiDoublePredicate shove() {
		BiDoublePredicateX<RuntimeException> exceptionCast = (BiDoublePredicateX<RuntimeException>) this;
	...
	@Nonnull
	public static <X extends Exception, E extends Exception, Y extends Exception> BiDoublePredicateX<Y> wrapException(@Nonnull final BiDoublePredicateX<X> other, Class<E> exception, BooleanSupplierX<X> supplier, ExceptionHandler<E, Y> handler) {
	...
	default <E extends Exception, Y extends Exception> BiDoublePredicateX<Y> handle(Class<E> exception, ExceptionHandler<E, Y> handler) {
		...
		return BiDoublePredicateX.wrapException(this, exception, null, (ExceptionHandler) handler);
	}
	...
	default <E extends Exception, Y extends Exception> BiDoublePredicateX<Y> handle(Class<E> exception, BooleanSupplierX<X> supplier) {
		...
		return BiDoublePredicateX.wrapException(this, exception, supplier, null);
	}
