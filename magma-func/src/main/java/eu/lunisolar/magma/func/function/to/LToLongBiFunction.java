...
public interface LToLongBiFunction<T1, T2> extends ToLongBiFunction<T1, T2>, MetaFunction, MetaInterface.NonThrowing, Codomain<aLong>, Domain2<a<T1>, a<T2>> { // NOSONAR
	...
	/**  */
	public static <T1, T2> LToLongBiFunction<T1, T2> uncurry(LFunction<T1, LToLongFunction<T2>> func) {
	...
	@Nonnull
	static <T1, T2> LToLongBiFunction<T1, T2> toLongBiFunc(Class<T1> c1, Class<T2> c2, final @Nonnull LToLongBiFunction<T1, T2> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
