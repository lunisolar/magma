...
public interface LBiObjBoolPredicate<T1, T2> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<a<T1>, a<T2>, aBool> { // NOSONAR
	...
	static <T1, T2> void throwIf(T1 a1, T2 a2, boolean a3, LBiObjBoolPredicate<T1, T2> pred, ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		if (pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}

	static <T1, T2> void throwIfNot(T1 a1, T2 a2, boolean a3, LBiObjBoolPredicate<T1, T2> pred, ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}
	...
	public static <M, K, V, T2> boolean from(M container, LBiFunction<M, K, V> extractor, K key, T2 a2, boolean a3, LBiObjBoolPredicate<V, T2> function) {
	...
	/**  */
	public static <T1, T2> LBiObjBoolPredicate<T1, T2> uncurry(LFunction<T1, LFunction<T2, LLogicalOperator>> func) {
	...
	@Nonnull
	static <T1, T2> LBiObjBoolPredicate<T1, T2> biObjBoolPred(Class<T1> c1, Class<T2> c2, final @Nonnull LBiObjBoolPredicate<T1, T2> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
