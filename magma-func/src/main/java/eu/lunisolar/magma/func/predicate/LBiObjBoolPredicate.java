...
public interface LBiObjBoolPredicate<T1, T2> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<a<T1>, a<T2>, aBool> { // NOSONAR
	...
	default LObjBoolPredicate<T2> _with(T1 a1) {
		return (a2, a3) -> test(a1, a2, a3);
	}

	default LBiPredicate<T1, T2> with(boolean a3) {
		return (a1, a2) -> test(a1, a2, a3);
	}

	default LLogicalOperator _with(T1 a1, T2 a2) {
		return a3 -> test(a1, a2, a3);
	}

	default LPredicate<T1> with(T2 a2, boolean a3) {
	...
	final class M<T1, T2> implements LBiObjBoolPredicate<T1, T2> {
		...
		public boolean currentTest(T1 a1, T2 a2, boolean a3) {
			boolean x1 = lastBaseValue;
		...
		public boolean currentBaseValue(T1 a1, T2 a2, boolean a3) {
	...
	default LBiObjBoolPredicate<T1, T2> shoving() {

		return new LBiObjBoolPredicate<T1, T2>() {

			public boolean test(T1 a1, T2 a2, boolean a3) {
				try {
					return this.testX(a1, a2, a3);
				} catch (Throwable e) { // NOSONAR
					Handling.handleErrors(e);
			...
			public boolean testX(T1 a1, T2 a2, boolean a3) throws Throwable {
				return LBiObjBoolPredicate.this.testX(a1, a2, a3);
			}
