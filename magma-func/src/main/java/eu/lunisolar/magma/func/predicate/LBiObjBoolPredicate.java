...
public interface LBiObjBoolPredicate<T1, T2> extends LBiObjBoolPredicateX<T1, T2, RuntimeException>, MetaPredicate, MetaInterface.NonThrowing { // NOSONAR
	...
	interface V1<T1, T2> extends LBiObjBoolPredicate<T1, T2> {
		...
		boolean apply1(T1 a1, boolean a3, T2 a2);
	...
	/** Permutation of LBiObjBoolPredicate for method references. */
	@FunctionalInterface
	interface V2<T1, T2> extends LBiObjBoolPredicate<T1, T2> {

		boolean apply2(T2 a2, T1 a1, boolean a3);
	...
	/** Permutation of LBiObjBoolPredicate for method references. */
	@FunctionalInterface
	interface V3<T1, T2> extends LBiObjBoolPredicate<T1, T2> {

		boolean apply3(T2 a2, boolean a3, T1 a1);
	...
	interface V4<T1, T2> extends LBiObjBoolPredicate<T1, T2> {
		...
		boolean apply4(boolean a3, T1 a1, T2 a2);
	...
	/** Permutation of LBiObjBoolPredicate for method references. */
	@FunctionalInterface
	interface V5<T1, T2> extends LBiObjBoolPredicate<T1, T2> {

		boolean apply5(boolean a3, T2 a2, T1 a1);
