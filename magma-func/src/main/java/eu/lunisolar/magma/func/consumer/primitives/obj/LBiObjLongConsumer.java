...
public interface LBiObjLongConsumer<T1, T2> extends LBiObjLongConsumerX<T1, T2, RuntimeException>, MetaConsumer, MetaInterface.NonThrowing {
	...
	@FunctionalInterface
	interface V1<T1, T2> extends LBiObjLongConsumer<T1, T2> {

		void doAcceptV1(T1 a1, long a3, T2 a2);
	...
	/** Permutation of LBiObjLongConsumer for method references. */
	@FunctionalInterface
	interface V2<T2, T1> extends LBiObjLongConsumer<T1, T2> {

		void doAcceptV2(T2 a2, T1 a1, long a3);
	...
	/** Permutation of LBiObjLongConsumer for method references. */
	@FunctionalInterface
	interface V3<T2, T1> extends LBiObjLongConsumer<T1, T2> {

		void doAcceptV3(T2 a2, long a3, T1 a1);
	...
	/** Permutation of LBiObjLongConsumer for method references. */
	@FunctionalInterface
	interface V4<T1, T2> extends LBiObjLongConsumer<T1, T2> {

		void doAcceptV4(long a3, T1 a1, T2 a2);
	...
	/** Permutation of LBiObjLongConsumer for method references. */
	@FunctionalInterface
	interface V5<T2, T1> extends LBiObjLongConsumer<T1, T2> {

		void doAcceptV5(long a3, T2 a2, T1 a1);
