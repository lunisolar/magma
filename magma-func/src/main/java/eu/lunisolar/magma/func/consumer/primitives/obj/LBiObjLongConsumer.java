...
public interface LBiObjLongConsumer<T1, T2> extends MetaConsumer, MetaInterface.NonThrowing, Codomain<aVoid>, Domain3<a<T1>, a<T2>, aLong> {
	...
	static <T1, T2> void tryAccept(T1 a1, T2 a2, long a3, LBiObjLongConsumer<T1, T2> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		Null.nonNullArg(func, "func");
	...
	public default LBiObjLongConsumer untyped() {
		return this;
	}

	/** Cast that replace generics. */
	public default <V2, V3> LBiObjLongConsumer<V2, V3> cast() {
		return untyped();
	}
	...
	public default LBiObjLongConsumer<T1, T2> beforeDo(@Nonnull LBiObjLongConsumer<T1, T2> before) {
