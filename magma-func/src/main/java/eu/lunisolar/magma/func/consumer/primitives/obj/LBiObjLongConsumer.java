...
public interface LBiObjLongConsumer<T1, T2> extends LBiObjLongConsumerX<T1, T2, RuntimeException>, MetaConsumer, MetaInterface.NonThrowing {
	...
	interface V1<T1, T2> extends LBiObjLongConsumer<T1, T2> {
		...
		void apply1(T1 a1, long a3, T2 a2);
	...
	/** Permutation of LBiObjLongConsumer for method references. */
	@FunctionalInterface
	interface V2<T1, T2> extends LBiObjLongConsumer<T1, T2> {

		void apply2(T2 a2, T1 a1, long a3);
	...
	/** Permutation of LBiObjLongConsumer for method references. */
	@FunctionalInterface
	interface V3<T1, T2> extends LBiObjLongConsumer<T1, T2> {

		void apply3(T2 a2, long a3, T1 a1);
	...
	interface V4<T1, T2> extends LBiObjLongConsumer<T1, T2> {
		...
		void apply4(long a3, T1 a1, T2 a2);
	...
	/** Permutation of LBiObjLongConsumer for method references. */
	@FunctionalInterface
	interface V5<T1, T2> extends LBiObjLongConsumer<T1, T2> {

		void apply5(long a3, T2 a2, T1 a1);
