...
public interface LBiObjFloatFunctionX<T1, T2, R, X extends Throwable> extends MetaFunction, MetaInterface.Throwing<X> { // NOSONAR
	...
	public static <T1, T2, R, X extends Throwable> LBiObjFloatFunctionX<T1, T2, R, X> constant(R r) {
		return (t1, t2, f) -> r;
	}

	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	public static <T1, T2, R, X extends Throwable> LBiObjFloatFunctionX<T1, T2, R, X> lX(final @Nonnull LBiObjFloatFunctionX<T1, T2, R, X> lambda) {
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	public static <T1, T2, R, X extends Throwable> LBiObjFloatFunctionX<T1, T2, R, X> lX(@Nonnull Class<X> xClass, final @Nonnull LBiObjFloatFunctionX<T1, T2, R, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	@Nonnull
	public static <T1, T2, R, X extends Throwable> LBiObjFloatFunctionX<T1, T2, R, X> wrapX(final @Nonnull LBiObjFloatFunction<T1, T2, R> other) {
	...
	@Nonnull
	default LBiObjFloatFunction<T1, T2, R> handle(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
		return (T1 t1, T2 t2, float f) -> this.handlingDoApply(t1, t2, f, handling);
	}

	@Nonnull
	default <Y extends Throwable> LBiObjFloatFunctionX<T1, T2, R, Y> handleX(@Nonnull HandlingInstructions<Throwable, Y> handling) {
		return (T1 t1, T2 t2, float f) -> this.handlingDoApply(t1, t2, f, handling);
	}
