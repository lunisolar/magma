...
public interface LBiObjFloatFunctionX<T1, T2, R, X extends Throwable> extends MetaFunction, MetaInterface.Throwing<X> { // NOSONAR
	...
	interface V1<T1, T2, R, X extends Throwable> extends LBiObjFloatFunctionX<T1, T2, R, X> {
		@Nullable
		R apply1(T1 a1, float a3, T2 a2) throws X;
	...
	/** Permutation of LBiObjFloatFunctionX for method references. */
	@FunctionalInterface
	interface V2<T1, T2, R, X extends Throwable> extends LBiObjFloatFunctionX<T1, T2, R, X> {
		@Nullable
		R apply2(T2 a2, T1 a1, float a3) throws X;
	...
	/** Permutation of LBiObjFloatFunctionX for method references. */
	@FunctionalInterface
	interface V3<T1, T2, R, X extends Throwable> extends LBiObjFloatFunctionX<T1, T2, R, X> {
		@Nullable
		R apply3(T2 a2, float a3, T1 a1) throws X;
	...
	interface V4<T1, T2, R, X extends Throwable> extends LBiObjFloatFunctionX<T1, T2, R, X> {
		@Nullable
		R apply4(float a3, T1 a1, T2 a2) throws X;
	...
	/** Permutation of LBiObjFloatFunctionX for method references. */
	@FunctionalInterface
	interface V5<T1, T2, R, X extends Throwable> extends LBiObjFloatFunctionX<T1, T2, R, X> {
		@Nullable
		R apply5(float a3, T2 a2, T1 a1) throws X;
