...
public interface LBiObjFloatFunctionX<T1, T2, R, X extends Throwable> extends MetaFunction, MetaInterface.Throwing<X> { // NOSONAR
	...
	@Nonnull
	static <T1, T2, R, X extends Throwable> LBiObjFloatFunctionX<T1, T2, R, X> safe() {
		return Function4U::produce;
	}

	/** Safe instance supplier. Returns supplier of safe() instance. */
	@Nonnull
	static <T1, T2, R, X extends Throwable, Y extends Throwable> LSupplierX<LBiObjFloatFunctionX<T1, T2, R, X>, Y> safeSupplier() {
		return () -> safe();
	}

	/** Safe wrapping. Either argument function is returned (if it is not null) or safe() instance. */
	@Nonnull
	static <T1, T2, R, X extends Throwable> LBiObjFloatFunctionX<T1, T2, R, X> safe(final @Nullable LBiObjFloatFunctionX<T1, T2, R, X> other) {
		if (other == null) {
			return safe();
		} else {
			return other;
	...
	@Nonnull
	static <T1, T2, R, X extends Throwable, Y extends Throwable> LSupplierX<LBiObjFloatFunctionX<T1, T2, R, X>, Y> safeSupplier(final @Nullable LSupplierX<LBiObjFloatFunctionX<T1, T2, R, X>, Y> supplier) {
		if (supplier == null) {
			return safeSupplier();
		} else {
			return supplier;
	...
	/** Permutation of LBiObjFloatFunctionX for method references. */
	@FunctionalInterface
	interface V1<T1, T2, R, X extends Throwable> extends LBiObjFloatFunctionX<T1, T2, R, X> {
		@Nullable
		R doApplyV1(T1 a1, float a3, T2 a2) throws X;

		@Override
		default R doApply(T1 a1, T2 a2, float a3) throws X {
	...
	/** Permutation of LBiObjFloatFunctionX for method references. */
	@FunctionalInterface
	interface V2<T2, T1, R, X extends Throwable> extends LBiObjFloatFunctionX<T1, T2, R, X> {
		@Nullable
		R doApplyV2(T2 a2, T1 a1, float a3) throws X;
	...
	/** Permutation of LBiObjFloatFunctionX for method references. */
	@FunctionalInterface
	interface V3<T2, T1, R, X extends Throwable> extends LBiObjFloatFunctionX<T1, T2, R, X> {
		@Nullable
		R doApplyV3(T2 a2, float a3, T1 a1) throws X;
	...
	/** Permutation of LBiObjFloatFunctionX for method references. */
	@FunctionalInterface
	interface V4<T1, T2, R, X extends Throwable> extends LBiObjFloatFunctionX<T1, T2, R, X> {
		@Nullable
		R doApplyV4(float a3, T1 a1, T2 a2) throws X;
	...
	/** Permutation of LBiObjFloatFunctionX for method references. */
	@FunctionalInterface
	interface V5<T2, T1, R, X extends Throwable> extends LBiObjFloatFunctionX<T1, T2, R, X> {
		@Nullable
		R doApplyV5(float a3, T2 a2, T1 a1) throws X;
