...
public interface LIntTriple extends LTuple<Integer>, Comparable<LIntTriple> {
	...
	public static Iterator<LIntTriple.MutIntTriple> mutIterator(PrimitiveIterator.OfInt items) {
		return iterator(items, LIntTriple::of);
	}

	public static Iterator<LIntTriple> immIterator(PrimitiveIterator.OfInt items) {
		return iterator(items, LIntTriple::immutableOf);
	}
	...
	public static Stream<LIntTriple.MutIntTriple> mutStream(IntStream items) {
		return stream(items, LIntTriple::of);
	}

	public static Stream<LIntTriple> immStream(IntStream items) {
		return stream(items, LIntTriple::immutableOf);
	}
