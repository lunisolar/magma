...
public interface LBiObjDblFunction<T1, T2, R> extends MetaFunction, MetaInterface.NonThrowing, Codomain<a<R>>, Domain3<a<T1>, a<T2>, aDouble> { // NOSONAR
	...
	public static <M, K, V, T2, R> R from(@Nonnull M container, LBiFunction<M, K, V> extractor, K key, T2 a2, double a3, @Nonnull LBiObjDblFunction<V, T2, R> function) {
	...
	final class M<T1, T2, R> implements LBiObjDblFunction<T1, T2, R> {
		...
		public R currentApply(T1 a1, T2 a2, double a3) {
			R x1 = lastBaseValue;
		...
		public R currentBaseValue(T1 a1, T2 a2, double a3) {
	...
	/** Allows to manipulate the domain of the function. */
	@Nonnull
	default <V1, V2, V3> LTriFunction<V1, V2, V3, R> unboxingCompose(@Nonnull final LFunction<? super V1, ? extends T1> before1, @Nonnull final LFunction<? super V2, ? extends T2> before2, @Nonnull final LToDblFunction<? super V3> before3) {
		Null.nonNullArg(before1, "before1");
		Null.nonNullArg(before2, "before2");
		Null.nonNullArg(before3, "before3");
		return (v1, v2, v3) -> this.apply(before1.apply(v1), before2.apply(v2), before3.applyAsDbl(v3));
	...
	default LBiObjDblFunction<T1, T2, R> shoving() {

		return new LBiObjDblFunction<T1, T2, R>() {
			...
			public R applyX(T1 a1, T2 a2, double a3) throws Throwable {
				return LBiObjDblFunction.this.applyX(a1, a2, a3);
			}
