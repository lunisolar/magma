...
public interface LBiObjDblFunction<T1, T2, R> extends MetaFunction, MetaInterface.NonThrowing { // NOSONAR

	String DESCRIPTION = "LBiObjDblFunction: R doApply(T1 a1,T2 a2,double a3)";

	@Nullable
	// R doApply(T1 a1,T2 a2,double a3) ;
	default R doApply(T1 a1, T2 a2, double a3) {
	...
	/**
	 * Implement this, but call doApply(T1 a1,T2 a2,double a3)
	 */
	R doApplyX(T1 a1, T2 a2, double a3) throws Throwable;
	...
	default R handlingDoApply(T1 a1, T2 a2, double a3, HandlingInstructions<Throwable, RuntimeException> handling) {
		try {
			return this.doApplyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default R tryDoApply(T1 a1, T2 a2, double a3, @Nonnull ExceptionWrapWithMessageFactory<RuntimeException> exceptionFactory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		try {
			return this.doApplyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default R tryDoApply(T1 a1, T2 a2, double a3, @Nonnull ExceptionWrapFactory<RuntimeException> exceptionFactory) {
		try {
			return this.doApplyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default R tryDoApplyThen(T1 a1, T2 a2, double a3, @Nonnull LFunction<Throwable, R> handler) {
		try {
			return this.doApplyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default R shovingDoApply(T1 a1, T2 a2, double a3) {
		try {
			return this.doApplyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	static <T1, T2, R> R handlingDoApply(T1 a1, T2 a2, double a3, LBiObjDblFunction<T1, T2, R> func, HandlingInstructions<Throwable, RuntimeException> handling) { // <-
		Null.nonNullArg(func, "func");
		return func.handlingDoApply(a1, a2, a3, handling);
	}

	static <T1, T2, R> R tryDoApply(T1 a1, T2 a2, double a3, LBiObjDblFunction<T1, T2, R> func) {
		return tryDoApply(a1, a2, a3, func, null);
	}

	static <T1, T2, R> R tryDoApply(T1 a1, T2 a2, double a3, LBiObjDblFunction<T1, T2, R> func, @Nonnull ExceptionWrapWithMessageFactory<RuntimeException> exceptionFactory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		Null.nonNullArg(func, "func");
		return func.tryDoApply(a1, a2, a3, exceptionFactory, newMessage, messageParams);
	}

	static <T1, T2, R> R tryDoApply(T1 a1, T2 a2, double a3, LBiObjDblFunction<T1, T2, R> func, @Nonnull ExceptionWrapFactory<RuntimeException> exceptionFactory) {
		Null.nonNullArg(func, "func");
		return func.tryDoApply(a1, a2, a3, exceptionFactory);
	}

	static <T1, T2, R> R tryDoApplyThen(T1 a1, T2 a2, double a3, LBiObjDblFunction<T1, T2, R> func, @Nonnull LFunction<Throwable, R> handler) {
		Null.nonNullArg(func, "func");
		return func.tryDoApplyThen(a1, a2, a3, handler);
	}

	default R failSafeDoApply(T1 a1, T2 a2, double a3, @Nonnull LBiObjDblFunction<T1, T2, R> failSafe) {
		try {
	...
	static <T1, T2, R> R failSafeDoApply(T1 a1, T2 a2, double a3, LBiObjDblFunction<T1, T2, R> func, @Nonnull LBiObjDblFunction<T1, T2, R> failSafe) {
	...
	static <T1, T2, R> LBiObjDblFunction<T1, T2, R> failSafeBiObjDblFunc(LBiObjDblFunction<T1, T2, R> func, @Nonnull LBiObjDblFunction<T1, T2, R> failSafe) {
		Null.nonNullArg(failSafe, "failSafe");
	...
	@Nonnull
	default R nonNullDoApply(T1 a1, T2 a2, double a3) {
	...
	public default LBiFunction<T1, T2, R> rShrink(LToDblBiFunction<T1, T2> right) {
		return (a1, a2) -> doApply(a1, a2, right.doApplyAsDbl(a1, a2));
	}
	...
	/**  */
	public static <T1, T2, R> LBiObjDblFunction<T1, T2, R> uncurryBiObjDblFunc(LFunction<T1, LFunction<T2, LDblFunction<R>>> func) {
		return (T1 a1, T2 a2, double a3) -> func.doApply(a1).doApply(a2).doApply(a3);
	}

	/** Captures arguments but delays the evaluation. */
	default LSupplier<R> captureBiObjDblFunc(T1 a1, T2 a2, double a3) {
	...
	static <T1, T2, R> LBiObjDblFunction<T1, T2, R> recursive(final @Nonnull LFunction<LBiObjDblFunction<T1, T2, R>, LBiObjDblFunction<T1, T2, R>> selfLambda) {
		...
		LBiObjDblFunction<T1, T2, R> func = selfLambda.doApply(single);
		single.target = func;
		return func;
	}
	...
	final class LBiObjDblFunctionSingle<T1, T2, R> implements LSingle<LBiObjDblFunction<T1, T2, R>>, LBiObjDblFunction<T1, T2, R> {
		...
		@Override
		public R doApplyX(T1 a1, T2 a2, double a3) throws Throwable {
	...
	@Nonnull
	static <T1, T2, R> LBiObjDblFunction<T1, T2, R> biObjDblFuncThrowing(final @Nonnull ExceptionFactory<Throwable> exceptionFactory) {
	...
	@Nonnull
	static <T1, T2, R> LBiObjDblFunction<T1, T2, R> biObjDblFuncThrowing(final String message, final @Nonnull ExceptionWithMessageFactory<Throwable> exceptionFactory) {
		Null.nonNullArg(exceptionFactory, "exceptionFactory");
		return (a1, a2, a3) -> {
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2, R> LObjDblObj1Func<T1, T2, R> objDblObj1Func(final @Nonnull LObjDblObj1Func<T1, T2, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1, R> LObj1Obj0DblFunc<T2, T1, R> obj1Obj0DblFunc(final @Nonnull LObj1Obj0DblFunc<T2, T1, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1, R> LObj1DblObj0Func<T2, T1, R> obj1DblObj0Func(final @Nonnull LObj1DblObj0Func<T2, T1, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2, R> LDblObj0Obj1Func<T1, T2, R> dblObj0Obj1Func(final @Nonnull LDblObj0Obj1Func<T1, T2, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1, R> LDblObjObj0Func<T2, T1, R> dblObjObj0Func(final @Nonnull LDblObjObj0Func<T2, T1, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	@Nonnull
	default <V1, V2> LBiObjDblFunction<V1, V2, R> biObjDblFuncComposeDbl(@Nonnull final LFunction<? super V1, ? extends T1> before1, @Nonnull final LFunction<? super V2, ? extends T2> before2, @Nonnull final LDblUnaryOperator before3) {
		Null.nonNullArg(before1, "before1");
		Null.nonNullArg(before2, "before2");
		Null.nonNullArg(before3, "before3");
		return (v1, v2, v3) -> this.doApply(before1.doApply(v1), before2.doApply(v2), before3.doApplyAsDbl(v3));
	}

	public static <V1, V2, T1, T2, R> LBiObjDblFunction<V1, V2, R> composedDbl(@Nonnull final LFunction<? super V1, ? extends T1> before1, @Nonnull final LFunction<? super V2, ? extends T2> before2, @Nonnull final LDblUnaryOperator before3,
			LBiObjDblFunction<T1, T2, R> after) {
		return after.biObjDblFuncComposeDbl(before1, before2, before3);
	}
	...
	@Nonnull
	default LBiObjDblFunction<T1, T2, R> nestingBiObjDblFunc() {
		return this;
	}

	/** Converts to non-throwing variant that will propagate checked exception as it would be unchecked - there is no exception wrapping involved (at least not here). */
	default LBiObjDblFunction<T1, T2, R> shovingBiObjDblFunc() {
		return this;
	}
	...
	@Nonnull
	default LBiObjDblFunction<T1, T2, R> nonNullBiObjDblFunc() {
	...
	@FunctionalInterface
	interface LObjDblObj1Func<T1, T2, R> extends LBiObjDblFunction<T1, T2, R> {
		@Nullable
		R doApplyObjDblObj1(T1 a1, double a3, T2 a2);

		@Override
		default R doApplyX(T1 a1, T2 a2, double a3) {
			return this.doApplyObjDblObj1(a1, a3, a2);
		}
	}

	/** Permutation of LBiObjDblFunction for method references. */
	@FunctionalInterface
	interface LObj1Obj0DblFunc<T2, T1, R> extends LBiObjDblFunction<T1, T2, R> {
		@Nullable
		R doApplyObj1Obj0Dbl(T2 a2, T1 a1, double a3);

		@Override
		default R doApplyX(T1 a1, T2 a2, double a3) {
			return this.doApplyObj1Obj0Dbl(a2, a1, a3);
		}
	}

	/** Permutation of LBiObjDblFunction for method references. */
	@FunctionalInterface
	interface LObj1DblObj0Func<T2, T1, R> extends LBiObjDblFunction<T1, T2, R> {
		@Nullable
		R doApplyObj1DblObj0(T2 a2, double a3, T1 a1);

		@Override
		default R doApplyX(T1 a1, T2 a2, double a3) {
			return this.doApplyObj1DblObj0(a2, a3, a1);
		}
	}

	/** Permutation of LBiObjDblFunction for method references. */
	@FunctionalInterface
	interface LDblObj0Obj1Func<T1, T2, R> extends LBiObjDblFunction<T1, T2, R> {
		@Nullable
		R doApplyDblObj0Obj1(double a3, T1 a1, T2 a2);

		@Override
		default R doApplyX(T1 a1, T2 a2, double a3) {
			return this.doApplyDblObj0Obj1(a3, a1, a2);
		}
	}

	/** Permutation of LBiObjDblFunction for method references. */
	@FunctionalInterface
	interface LDblObjObj0Func<T2, T1, R> extends LBiObjDblFunction<T1, T2, R> {
		@Nullable
		R doApplyDblObjObj0(double a3, T2 a2, T1 a1);

		@Override
		default R doApplyX(T1 a1, T2 a2, double a3) {
			return this.doApplyDblObjObj0(a3, a2, a1);
		}
	}
	...
	/** Does nothing (LBiObjDblFunction.LObjDblObj1Func) Function */
	public static <T1, T2, R> R produce(T1 a1, double a3, T2 a2) {
		return (R) Function4U.defaultObject;
	}

	/** Does nothing (LBiObjDblFunction.LDblObj0Obj1Func) Function */
	public static <T1, T2, R> R produce(double a3, T1 a1, T2 a2) {
		return (R) Function4U.defaultObject;
	}

	// MAP: FOR, [SourcePurpose{arg=T1 a1, type=IA}, SourcePurpose{arg=T2 a2, type=IA}, SourcePurpose{arg=double a3, type=IA}, SourcePurpose{arg=LConsumer<?
	...
	// MAP: WHILE, [SourcePurpose{arg=T1 a1, type=SA}, SourcePurpose{arg=T2 a2, type=IA}, SourcePurpose{arg=double a3, type=IA}, SourcePurpose{arg=LConsumer<?
	// super R> consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T1 a1, type=IA}, SourcePurpose{arg=T2 a2, type=SA}, SourcePurpose{arg=double a3, type=IA}, SourcePurpose{arg=LConsumer<?
	// super R> consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T1 a1, type=SA}, SourcePurpose{arg=T2 a2, type=SA}, SourcePurpose{arg=double a3, type=IA}, SourcePurpose{arg=LConsumer<?
	// super R> consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T1 a1, type=IA}, SourcePurpose{arg=T2 a2, type=IA}, SourcePurpose{arg=double a3, type=SA}, SourcePurpose{arg=LConsumer<?
	// super R> consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T1 a1, type=SA}, SourcePurpose{arg=T2 a2, type=IA}, SourcePurpose{arg=double a3, type=SA}, SourcePurpose{arg=LConsumer<?
	// super R> consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T1 a1, type=IA}, SourcePurpose{arg=T2 a2, type=SA}, SourcePurpose{arg=double a3, type=SA}, SourcePurpose{arg=LConsumer<?
	// super R> consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T1 a1, type=SA}, SourcePurpose{arg=T2 a2, type=SA}, SourcePurpose{arg=double a3, type=SA}, SourcePurpose{arg=LConsumer<?
	// super R> consumer, type=CONST}]
