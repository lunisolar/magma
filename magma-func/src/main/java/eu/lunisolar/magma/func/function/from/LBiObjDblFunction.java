...
public interface LBiObjDblFunction<T1, T2, R> extends MetaFunction, MetaInterface.NonThrowing, Codomain<a<R>>, Domain3<a<T1>, a<T2>, aDouble> { // NOSONAR
	...
	default R apply(T1 a1, T2 a2, double a3, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default R apply(T1 a1, T2 a2, double a3, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default R apply(T1 a1, T2 a2, double a3, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default R apply(T1 a1, T2 a2, double a3, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LBiObjDblFunction<T1, T2, R> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage) {
		return (a1, a2, a3) -> apply(a1, a2, a3, factory, newMessage);
	}

	default LBiObjDblFunction<T1, T2, R> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1) {
		return (a1, a2, a3) -> apply(a1, a2, a3, factory, newMessage, param1);
	}

	default LBiObjDblFunction<T1, T2, R> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		return (a1, a2, a3) -> apply(a1, a2, a3, factory, newMessage, param1, param1);
	}

	default LBiObjDblFunction<T1, T2, R> trying(@Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		return (a1, a2, a3) -> apply(a1, a2, a3, factory, newMessage, param1, param2, param3);
	}

	default R apply(T1 a1, T2 a2, double a3, @Nonnull ExWF<RuntimeException> factory) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LBiObjDblFunction<T1, T2, R> trying(@Nonnull ExWF<RuntimeException> factory) {
	...
	static <T1, T2, R> R shovingApply(T1 a1, T2 a2, double a3, LBiObjDblFunction<T1, T2, R> func) {
	...
	static <T1, T2, R> R tryApply(T1 a1, T2 a2, double a3, LBiObjDblFunction<T1, T2, R> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, a3, factory, newMessage);
	}

	static <T1, T2, R> R tryApply(T1 a1, T2 a2, double a3, LBiObjDblFunction<T1, T2, R> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, a3, factory, newMessage, param1);
	}

	static <T1, T2, R> R tryApply(T1 a1, T2 a2, double a3, LBiObjDblFunction<T1, T2, R> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, a3, factory, newMessage, param1, param2);
	}

	static <T1, T2, R> R tryApply(T1 a1, T2 a2, double a3, LBiObjDblFunction<T1, T2, R> func, @Nonnull ExWMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, a3, factory, newMessage, param1, param2, param3);
	}

	static <T1, T2, R> R tryApply(T1 a1, T2 a2, double a3, LBiObjDblFunction<T1, T2, R> func, @Nonnull ExWF<RuntimeException> factory) {
		Null.nonNullArg(func, "func");
	...
	public static <T1, T2, R> void fromTo(int min_i, int max_i, T1 a1, T2 a2, double a3, @Nonnull LBiObjDblFunction<T1, T2, R> func) {
		Null.nonNullArg(func, "func");
		if (min_i <= max_i) {
	...
	/** From-To. Intended to be used with non-capturing lambda. */
	public static <T1, T2, R> void fromTill(int min_i, int max_i, T1 a1, T2 a2, double a3, @Nonnull LBiObjDblFunction<T1, T2, R> func) {
		Null.nonNullArg(func, "func");
		if (min_i <= max_i) {
			for (int i = min_i; i < max_i; i++) {
				func.apply(a1, a2, a3);
	...
	/** From-To. Intended to be used with non-capturing lambda. */
	public static <T1, T2, R> void times(int max_i, T1 a1, T2 a2, double a3, @Nonnull LBiObjDblFunction<T1, T2, R> func) {
		if (max_i < 0)
			return;
	...
	public static <R, M, K, V, T2> R from(@Nonnull M container, LBiFunction<M, K, V> extractor, K key, T2 a2, double a3, @Nonnull LBiObjDblFunction<V, T2, R> function) {
	...
	default LObjDblFunction<T2, R> lShrink(@Nonnull LObjDblFunction<T2, T1> left) {
		Null.nonNullArg(left, "left");
		return (a2, a3) -> apply(left.apply(a2, a3), a2, a3);
	}

	default LObjDblFunction<T2, R> lShrink_(T1 a1) {
		return (a2, a3) -> apply(a1, a2, a3);
	}

	public static <T2, R, T1> LObjDblFunction<T2, R> lShrunken(@Nonnull LObjDblFunction<T2, T1> left, @Nonnull LBiObjDblFunction<T1, T2, R> func) {
		Null.nonNullArg(left, "left");
		Null.nonNullArg(func, "func");
		return func.lShrink(left);
	}

	public static <T2, R, T1> LObjDblFunction<T2, R> lShrunken_(T1 a1, @Nonnull LBiObjDblFunction<T1, T2, R> func) {
		Null.nonNullArg(func, "func");
		return func.lShrink_(a1);
	}

	default LBiFunction<T1, T2, R> rShrink(@Nonnull LToDblBiFunction<T1, T2> right) {
		Null.nonNullArg(right, "right");
		return (a1, a2) -> apply(a1, a2, right.applyAsDbl(a1, a2));
	}

	default LBiFunction<T1, T2, R> rShrink_(double a3) {
		return (a1, a2) -> apply(a1, a2, a3);
	}

	public static <T1, T2, R> LBiFunction<T1, T2, R> rShrunken(@Nonnull LToDblBiFunction<T1, T2> right, @Nonnull LBiObjDblFunction<T1, T2, R> func) {
		Null.nonNullArg(right, "right");
		Null.nonNullArg(func, "func");
		return func.rShrink(right);
	}

	public static <T1, T2, R> LBiFunction<T1, T2, R> rShrunken_(double a3, @Nonnull LBiObjDblFunction<T1, T2, R> func) {
		Null.nonNullArg(func, "func");
	...
	/** Cast that replace generics. */
	public static <V2, V3, V4> LBiObjDblFunction<V2, V3, V4> cast(LBiObjDblFunction<?, ?, ?> function) {
	...
	default LBiObjDblFunction<T1, T2, R> beforeDo(@Nonnull LBiObjDblConsumer<T1, T2> before) {
	...
	default LBiObjDblFunction<T1, T2, R> afterDo(@Nonnull LConsumer<R> after) {
	...
	@Nonnull
	static <T1, T2, R> LBiObjDblFunction<T1, T2, R> biObjDblFunc(@Nullable Class<T1> c1, @Nullable Class<T2> c2, @Nullable Class<R> c3, final @Nonnull LBiObjDblFunction<T1, T2, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	public static <T1, T2, R> M<T1, T2, R> initializedMementoOf(R initialValue, LBiObjDblFunction<T1, T2, R> function) {
		return memento(initialValue, initialValue, function, (m, x1, x2) -> x2);
	}

	public static <T1, T2, R> M<T1, T2, R> deltaOf(T1 a1, T2 a2, double a3, LBiObjDblFunction<T1, T2, R> function, LBinaryOperator<R> deltaFunction) {
		var initialValue = function.apply(a1, a2, a3);
		return initializedDeltaOf(initialValue, function, deltaFunction);
	}

	public static <T1, T2, R> M<T1, T2, R> initializedDeltaOf(R initialValue, LBiObjDblFunction<T1, T2, R> function, LBinaryOperator<R> deltaFunction) {
		return memento(initialValue, deltaFunction.apply(initialValue, initialValue), function, (m, x1, x2) -> deltaFunction.apply(x1, x2));
	}

	public static <T1, T2, R> M<T1, T2, R> memento(R initialBaseValue, R initialValue, LBiObjDblFunction<T1, T2, R> baseFunction, LTernaryOperator<R> mementoFunction) {
		return new M(initialBaseValue, initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not confuse it with math concepts). Very short name is intended to be used with parent (LBiObjDblFunction.M)
	 */
	@NotThreadSafe
	final class M<T1, T2, R> implements LBiObjDblFunction<T1, T2, R> {

		private final LBiObjDblFunction<T1, T2, R> baseFunction;
		private R lastBaseValue;
		private R lastValue;
		private final LTernaryOperator<R> mementoFunction;

		private M(R lastBaseValue, R lastValue, LBiObjDblFunction<T1, T2, R> baseFunction, LTernaryOperator<R> mementoFunction) {
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2, R> LBiObjDblFunction.LObj0Dbl2Obj1Func<T1, T2, R> obj0Dbl2Obj1Func(final @Nonnull LBiObjDblFunction.LObj0Dbl2Obj1Func<T1, T2, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1, R> LBiObjDblFunction.LObj1Obj0Dbl2Func<T2, T1, R> obj1Obj0Dbl2Func(final @Nonnull LBiObjDblFunction.LObj1Obj0Dbl2Func<T2, T1, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1, R> LBiObjDblFunction.LObj1Dbl2Obj0Func<T2, T1, R> obj1Dbl2Obj0Func(final @Nonnull LBiObjDblFunction.LObj1Dbl2Obj0Func<T2, T1, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2, R> LBiObjDblFunction.LDbl2Obj0Obj1Func<T1, T2, R> dbl2Obj0Obj1Func(final @Nonnull LBiObjDblFunction.LDbl2Obj0Obj1Func<T1, T2, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1, R> LBiObjDblFunction.LDbl2Obj1Obj0Func<T2, T1, R> dbl2Obj1Obj0Func(final @Nonnull LBiObjDblFunction.LDbl2Obj1Obj0Func<T2, T1, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	static <T1, T2, R> LBiObjDblFunction<T1, T2, R> safe() {
		return LBiObjDblFunction::doNothing;
	}
	...
	interface LObj0Dbl2Obj1Func<T1, T2, R> extends LBiObjDblFunction<T1, T2, R> {
		...
		default R applyObj0Dbl2Obj1(T1 a1, double a3, T2 a2) {
			// return nestingApplyObj0Dbl2Obj1(a1,a3,a2);
			try {
				return this.applyObj0Dbl2Obj1X(a1, a3, a2);
			} catch (Throwable e) { // NOSONAR
				throw Handling.nestCheckedAndThrow(e);
			}
		}
		...
		/**
		 * Implement this, but call applyObj0Dbl2Obj1(T1 a1,double a3,T2 a2)
		 */
		R applyObj0Dbl2Obj1X(T1 a1, double a3, T2 a2) throws Throwable;
	}
	...
	interface LObj1Obj0Dbl2Func<T2, T1, R> extends LBiObjDblFunction<T1, T2, R> {
		...
		default R applyObj1Obj0Dbl2(T2 a2, T1 a1, double a3) {
			// return nestingApplyObj1Obj0Dbl2(a2,a1,a3);
			try {
				return this.applyObj1Obj0Dbl2X(a2, a1, a3);
			} catch (Throwable e) { // NOSONAR
				throw Handling.nestCheckedAndThrow(e);
			}
		}
		...
		/**
		 * Implement this, but call applyObj1Obj0Dbl2(T2 a2,T1 a1,double a3)
		 */
		R applyObj1Obj0Dbl2X(T2 a2, T1 a1, double a3) throws Throwable;
	}
	...
	interface LObj1Dbl2Obj0Func<T2, T1, R> extends LBiObjDblFunction<T1, T2, R> {
		...
		default R applyObj1Dbl2Obj0(T2 a2, double a3, T1 a1) {
			// return nestingApplyObj1Dbl2Obj0(a2,a3,a1);
			try {
				return this.applyObj1Dbl2Obj0X(a2, a3, a1);
			} catch (Throwable e) { // NOSONAR
				throw Handling.nestCheckedAndThrow(e);
			}
		}
		...
		/**
		 * Implement this, but call applyObj1Dbl2Obj0(T2 a2,double a3,T1 a1)
		 */
		R applyObj1Dbl2Obj0X(T2 a2, double a3, T1 a1) throws Throwable;
	}
	...
	interface LDbl2Obj0Obj1Func<T1, T2, R> extends LBiObjDblFunction<T1, T2, R> {
		...
		default R applyDbl2Obj0Obj1(double a3, T1 a1, T2 a2) {
			// return nestingApplyDbl2Obj0Obj1(a3,a1,a2);
			try {
				return this.applyDbl2Obj0Obj1X(a3, a1, a2);
			} catch (Throwable e) { // NOSONAR
				throw Handling.nestCheckedAndThrow(e);
			}
		}
		...
		/**
		 * Implement this, but call applyDbl2Obj0Obj1(double a3,T1 a1,T2 a2)
		 */
		R applyDbl2Obj0Obj1X(double a3, T1 a1, T2 a2) throws Throwable;
	}
	...
	interface LDbl2Obj1Obj0Func<T2, T1, R> extends LBiObjDblFunction<T1, T2, R> {
		...
		default R applyDbl2Obj1Obj0(double a3, T2 a2, T1 a1) {
			// return nestingApplyDbl2Obj1Obj0(a3,a2,a1);
			try {
				return this.applyDbl2Obj1Obj0X(a3, a2, a1);
			} catch (Throwable e) { // NOSONAR
				throw Handling.nestCheckedAndThrow(e);
			}
		}
		...
		/**
		 * Implement this, but call applyDbl2Obj1Obj0(double a3,T2 a2,T1 a1)
		 */
		R applyDbl2Obj1Obj0X(double a3, T2 a2, T1 a1) throws Throwable;
	}

	// </editor-fold>

	/** Does nothing (LBiObjDblFunction) Function */
	public static <T1, T2, R> R doNothing(T1 a1, T2 a2, double a3) {
		return (R) Function4U.defaultObject;
	}

	/** Does nothing (LBiObjDblFunction.LObj0Dbl2Obj1Func) Function */
	public static <T1, T2, R> R doNothing(T1 a1, double a3, T2 a2) {
		return (R) Function4U.defaultObject;
	}

	/** Does nothing (LBiObjDblFunction.LDbl2Obj0Obj1Func) Function */
	public static <T1, T2, R> R doNothing(double a3, T1 a1, T2 a2) {
		return (R) Function4U.defaultObject;
	}
