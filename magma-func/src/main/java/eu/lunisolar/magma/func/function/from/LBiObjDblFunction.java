...
public interface LBiObjDblFunction<T1, T2, R> extends MetaFunction, MetaInterface.NonThrowing, Codomain<a<R>>, Domain3<a<T1>, a<T2>, aDouble> { // NOSONAR
	 ...
	 */
	public static <T1, T2, R> M<T1, T2, R> memento(R initialValue, LBiObjDblFunction<T1, T2, R> baseFunction, LBinaryOperator<R> mementoFunction) {
		return new M(initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not ). Very short name is intended to be used with parent (LBiObjDblFunction.D)
	 */
	final class M<T1, T2, R> implements LBiObjDblFunction<T1, T2, R> {
		...
		private M(R lastValue, LBiObjDblFunction<T1, T2, R> baseFunction, LBinaryOperator<R> mementoFunction) {
