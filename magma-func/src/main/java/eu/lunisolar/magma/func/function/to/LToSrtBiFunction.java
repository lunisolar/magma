...
public interface LToSrtBiFunction<T1, T2> extends MetaFunction, MetaInterface.NonThrowing, Codomain<aShort>, Domain2<a<T1>, a<T2>> { // NOSONAR
	...
	default short applyAsSrt(T1 a1, T2 a2, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		try {
			return this.applyAsSrtX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default short applyAsSrt(T1 a1, T2 a2, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		try {
			return this.applyAsSrtX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default short applyAsSrt(T1 a1, T2 a2, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		try {
			return this.applyAsSrtX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default short applyAsSrt(T1 a1, T2 a2, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		try {
			return this.applyAsSrtX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default LToSrtBiFunction<T1, T2> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		return (a1, a2) -> applyAsSrt(a1, a2, exF, newMessage);
	}

	default LToSrtBiFunction<T1, T2> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		return (a1, a2) -> applyAsSrt(a1, a2, exF, newMessage, param1);
	}

	default LToSrtBiFunction<T1, T2> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		return (a1, a2) -> applyAsSrt(a1, a2, exF, newMessage, param1, param1);
	}

	default LToSrtBiFunction<T1, T2> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
	...
	static <T1, T2> short tryApplyAsSrt(T1 a1, T2 a2, LToSrtBiFunction<T1, T2> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		Null.nonNullArg(func, "func");
		return func.applyAsSrt(a1, a2, exF, newMessage);
	}

	static <T1, T2> short tryApplyAsSrt(T1 a1, T2 a2, LToSrtBiFunction<T1, T2> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		Null.nonNullArg(func, "func");
		return func.applyAsSrt(a1, a2, exF, newMessage, param1);
	}

	static <T1, T2> short tryApplyAsSrt(T1 a1, T2 a2, LToSrtBiFunction<T1, T2> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		Null.nonNullArg(func, "func");
		return func.applyAsSrt(a1, a2, exF, newMessage, param1, param2);
	}

	static <T1, T2> short tryApplyAsSrt(T1 a1, T2 a2, LToSrtBiFunction<T1, T2> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		Null.nonNullArg(func, "func");
		return func.applyAsSrt(a1, a2, exF, newMessage, param1, param2, param3);
	}

	static <T1, T2> short tryApplyAsSrt(T1 a1, T2 a2, LToSrtBiFunction<T1, T2> func, @Nonnull ExWF<RuntimeException> exF) {
		Null.nonNullArg(func, "func");
	...
	/** Cast that replace generics. */
	public static <V2, V3, T1, T2> LToSrtBiFunction<V2, V3> cast(LToSrtBiFunction<T1, T2> function) {
