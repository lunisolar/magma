...
public interface LTieByteFunction<T> extends MetaFunction, MetaInterface.NonThrowing, TieFunction<T, aByte>, Codomain<aInt>, Domain3<a<T>, aInt, aByte> { // NOSONAR
	...
	default LOiToIntFunction<T> rShrink(@Nonnull LOiToByteFunction<T> right) {
		Null.nonNullArg(right, "right");
		return (a1, a2) -> applyAsInt(a1, a2, right.applyAsByte(a1, a2));
	}

	default LOiToIntFunction<T> rShrink_(byte a3) {
	...
	@Nonnull
	static <T> LTieByteFunction<T> tieByteFunc(@Nullable Class<T> c1, final @Nonnull LTieByteFunction<T> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
