...
public interface LBoolToDoubleFunction extends LBoolToDoubleFunctionX<RuntimeException>, MetaFunction, MetaInterface.NonThrowing { // NOSONAR

	String DESCRIPTION = "LBoolToDoubleFunction: double doApplyAsDouble(boolean a)";

	double doApplyAsDouble(boolean a);

	default double tupleApplyAsDouble(LBoolSingle args) {
	...
	default double nonNullDoApplyAsDouble(boolean a) {
	...
	default LDoubleSupplier captureBoolToDoubleFunc(boolean a) {
		return () -> this.doApplyAsDouble(a);
	}
	...
	static double call(boolean a, final @Nonnull LBoolToDoubleFunction lambda) {
		Null.nonNullArg(lambda, "lambda");
	...
	@Nonnull
	default LBoolToDoubleFunction boolToDoubleFuncComposeBool(@Nonnull final LLogicalOperator before) {
	...
	/** Allows to manipulate the domain of the function. */
	@Nonnull
	default <V> LToDoubleFunction<V> boolToDoubleFuncCompose(@Nonnull final LPredicate<? super V> before) {
		Null.nonNullArg(before, "before");
	...
	/** Combines two functions together in a order. */
	@Nonnull
	default LLogicalOperator thenToBool(@Nonnull LDoublePredicate after) {
		Null.nonNullArg(after, "after");
