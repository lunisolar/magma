...
/**
 * Non-throwing functional interface (lambda) ShortUnaryOperator for Java 8.
 *
 * Type: operator
 *
...
public interface ShortUnaryOperator extends ShortUnaryOperatorX<RuntimeException>, MetaOperator, PrimitiveCodomain<Object>, MetaInterface.NonThrowing { // NOSONAR
