...
public interface LBiObjLongPredicate<T1, T2> extends LBiObjLongPredicateX<T1, T2, RuntimeException>, MetaPredicate, MetaInterface.NonThrowing { // NOSONAR
	...
	interface V1<T1, T2> extends LBiObjLongPredicate<T1, T2> {
		...
		boolean apply1(T1 a1, long a3, T2 a2);
	...
	/** Permutation of LBiObjLongPredicate for method references. */
	@FunctionalInterface
	interface V2<T1, T2> extends LBiObjLongPredicate<T1, T2> {

		boolean apply2(T2 a2, T1 a1, long a3);
	...
	/** Permutation of LBiObjLongPredicate for method references. */
	@FunctionalInterface
	interface V3<T1, T2> extends LBiObjLongPredicate<T1, T2> {

		boolean apply3(T2 a2, long a3, T1 a1);
	...
	interface V4<T1, T2> extends LBiObjLongPredicate<T1, T2> {
		...
		boolean apply4(long a3, T1 a1, T2 a2);
	...
	/** Permutation of LBiObjLongPredicate for method references. */
	@FunctionalInterface
	interface V5<T1, T2> extends LBiObjLongPredicate<T1, T2> {

		boolean apply5(long a3, T2 a2, T1 a1);
