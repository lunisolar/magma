...
public interface LBiObjLongPredicate<T1, T2> extends LBiObjLongPredicateX<T1, T2, RuntimeException>, MetaPredicate, MetaInterface.NonThrowing { // NOSONAR
	...
	@FunctionalInterface
	interface V1<T1, T2> extends LBiObjLongPredicate<T1, T2> {

		boolean doTestV1(T1 a1, long a3, T2 a2);
	...
	/** Permutation of LBiObjLongPredicate for method references. */
	@FunctionalInterface
	interface V2<T2, T1> extends LBiObjLongPredicate<T1, T2> {

		boolean doTestV2(T2 a2, T1 a1, long a3);
	...
	/** Permutation of LBiObjLongPredicate for method references. */
	@FunctionalInterface
	interface V3<T2, T1> extends LBiObjLongPredicate<T1, T2> {

		boolean doTestV3(T2 a2, long a3, T1 a1);
	...
	/** Permutation of LBiObjLongPredicate for method references. */
	@FunctionalInterface
	interface V4<T1, T2> extends LBiObjLongPredicate<T1, T2> {

		boolean doTestV4(long a3, T1 a1, T2 a2);
	...
	/** Permutation of LBiObjLongPredicate for method references. */
	@FunctionalInterface
	interface V5<T2, T1> extends LBiObjLongPredicate<T1, T2> {

		boolean doTestV5(long a3, T2 a2, T1 a1);
