...
public interface LBiObjLongPredicate<T1, T2> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<a<T1>, a<T2>, aLong> { //NOSONAR
	...
	default LObjLongPredicate<T2> _with(T1 a1) {
		return (a2, a3) -> test(a1, a2, a3);
	}

	default LBiPredicate<T1, T2> with(long a3) {
		return (a1, a2) -> test(a1, a2, a3);
	}

	default LLongPredicate _with(T1 a1, T2 a2) {
		return a3 -> test(a1, a2, a3);
	}

	default LPredicate<T1> with(T2 a2, long a3) {
	...
	public static <T1, T2, X extends Throwable> T1 throwIf(T1 a1, T2 a2, long a3, @Nonnull LBiObjLongPredicate<? super T1, ? super T2> pred, @Nonnull ExMF<X> factory, @Nonnull LBiObjLongFunction<? super T1, ? super T2, ? extends String> msgFunc)
			throws X {
	...
	/** Throws new exception if condition is met. */
	public static <T1, T2, X extends Throwable> T1 throwIf(T1 a1, @Nonnull LBiObjLongPredicate<? super T1, ? super T2> pred, T2 a2, long a3, @Nonnull ExMF<X> factory, @Nonnull LBiObjLongFunction<? super T1, ? super T2, ? extends String> msgFunc)
			throws X {
		Null.nonNullArg(pred, "pred");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(msgFunc, "msgFunc");
	...
	final class M<T1, T2> implements LBiObjLongPredicate<T1, T2> {
		...
		public boolean currentTest(T1 a1, T2 a2, long a3) {
			boolean x1 = lastBaseValue;
		...
		public boolean currentBaseValue(T1 a1, T2 a2, long a3) {
	...
	public static <T1, T2> boolean any(boolean expected, T1 a1, T2 a2, long a3, @Nonnull Collection<? extends LBiObjLongPredicate<? super T1, ? super T2>> predicates) {
		return any(expected, a1, a2, a3, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static <T1, T2> boolean any(boolean expected, T1 a1, T2 a2, long a3, @Nonnull Stream<? extends LBiObjLongPredicate<? super T1, ? super T2>> predicates) {
		return any(expected, a1, a2, a3, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static <T1, T2> boolean any(boolean expected, T1 a1, T2 a2, long a3, @Nonnull Iterator<? extends LBiObjLongPredicate<? super T1, ? super T2>> predicates) {
		Null.nonNullArg(predicates, "predicates");
	...
	public static <T1, T2> boolean any(boolean expected, T1 a1, T2 a2, long a3, @Nonnull LBiObjLongPredicate<? super T1, ? super T2>... predicates) {
		Null.nonNullArg(predicates, "predicates");
	...
	/** Allows to manipulate the domain of the function. */
	@Nonnull
	default <V1, V2, V3> LTriPredicate<V1, V2, V3> unboxingCompose(@Nonnull final LFunction<? super V1, ? extends T1> before1, @Nonnull final LFunction<? super V2, ? extends T2> before2, @Nonnull final LToLongFunction<? super V3> before3) {
		Null.nonNullArg(before1, "before1");
		Null.nonNullArg(before2, "before2");
		Null.nonNullArg(before3, "before3");
		return (v1, v2, v3) -> this.test(before1.apply(v1), before2.apply(v2), before3.applyAsLong(v3));
