...
public interface LBiObjLongPredicate<T1, T2> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<a<T1>, a<T2>, aLong> { // NOSONAR
	...
	public default LObjLongPredicate<T2> lShrink(@Nonnull LObjLongFunction<T2, T1> left) {
		Null.nonNullArg(left, "left");
		return (a2, a3) -> test(left.apply(a2, a3), a2, a3);
	}

	public default LObjLongPredicate<T2> lShrink_(T1 a1) {
	...
	public default LBiPredicate<T1, T2> rShrink(@Nonnull LToLongBiFunction<T1, T2> right) {
		Null.nonNullArg(right, "right");
		return (a1, a2) -> test(a1, a2, right.applyAsLong(a1, a2));
	}

	public default LBiPredicate<T1, T2> rShrink_(long a3) {
	...
	public default LBiObjLongPredicate untyped() {
		return this;
	}

	/** Cast that replace generics. */
	public default <V2, V3> LBiObjLongPredicate<V2, V3> cast() {
		return untyped();
	}
	...
	public static <T1, T2> void throwIf(T1 a1, T2 a2, long a3, @Nonnull LBiObjLongPredicate<T1, T2> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
	...
	/** Throws new exception if condition is met. */
	public static <T1, T2> void throwIf(T1 a1, @Nonnull LBiObjLongPredicate<T1, T2> pred, T2 a2, long a3, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}
	...
	public static <T1, T2> void throwIfNot(T1 a1, T2 a2, long a3, @Nonnull LBiObjLongPredicate<T1, T2> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}
	...
	/** Throws new exception if condition is not met. */
	public static <T1, T2> void throwIfNot(T1 a1, @Nonnull LBiObjLongPredicate<T1, T2> pred, T2 a2, long a3, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}
	...
	public static <T1, T2> T1 complying(T1 a1, T2 a2, long a3, @Nonnull LBiObjLongPredicate<T1, T2> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	public static <T1, T2> T1 notComplying(T1 a1, T2 a2, long a3, @Nonnull LBiObjLongPredicate<T1, T2> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2> LObj0Long2Obj1Pred<T1, T2> obj0Long2Obj1Pred(final @Nonnull LObj0Long2Obj1Pred<T1, T2> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1> LObj1Obj0Long2Pred<T2, T1> obj1Obj0Long2Pred(final @Nonnull LObj1Obj0Long2Pred<T2, T1> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1> LObj1Long2Obj0Pred<T2, T1> obj1Long2Obj0Pred(final @Nonnull LObj1Long2Obj0Pred<T2, T1> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2> LLong2Obj0Obj1Pred<T1, T2> long2Obj0Obj1Pred(final @Nonnull LLong2Obj0Obj1Pred<T1, T2> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1> LLong2Obj1Obj0Pred<T2, T1> long2Obj1Obj0Pred(final @Nonnull LLong2Obj1Obj0Pred<T2, T1> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
