...
public interface LIntSupplier extends LIntSupplierX<RuntimeException>, MetaSupplier, MetaInterface.NonThrowing {
	...
	default Integer tupleGetAsInt(LTuple.Void args) {
		return doGetAsInt();
	}
