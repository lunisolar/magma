...
public interface LBiObjDblPredicate<T1, T2> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<a<T1>, a<T2>, aDouble> { // NOSONAR
	...
	public static <M, K, V, T2> boolean from(M container, LBiFunction<M, K, V> extractor, K key, T2 a2, double a3, LBiObjDblPredicate<V, T2> function) {
	...
	@Nonnull
	static <T1, T2> LBiObjDblPredicate<T1, T2> biObjDblPred(Class<T1> c1, Class<T2> c2, final @Nonnull LBiObjDblPredicate<T1, T2> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
