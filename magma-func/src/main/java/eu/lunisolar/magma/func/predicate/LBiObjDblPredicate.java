...
public interface LBiObjDblPredicate<T1, T2> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<a<T1>, a<T2>, aDouble> { //NOSONAR
	...
	public static <T1, T2, X extends Throwable> T1 throwIf(T1 a1, T2 a2, double a3, @Nonnull LBiObjDblPredicate<? super T1, ? super T2> pred, @Nonnull ExMF<X> factory, @Nonnull LBiObjDblFunction<? super T1, ? super T2, ? extends String> msgFunc)
			throws X {
	...
	/** Throws new exception if condition is met. */
	public static <T1, T2, X extends Throwable> T1 throwIf(T1 a1, @Nonnull LBiObjDblPredicate<? super T1, ? super T2> pred, T2 a2, double a3, @Nonnull ExMF<X> factory, @Nonnull LBiObjDblFunction<? super T1, ? super T2, ? extends String> msgFunc)
			throws X {
		Null.nonNullArg(pred, "pred");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(msgFunc, "msgFunc");
	...
	final class M<T1, T2> implements LBiObjDblPredicate<T1, T2> {
		...
		public boolean currentBaseValue(T1 a1, T2 a2, double a3) {
	...
	public static <T1, T2> boolean any(boolean expected, T1 a1, T2 a2, double a3, @Nonnull Collection<? extends LBiObjDblPredicate<? super T1, ? super T2>> predicates) {
		return any(expected, a1, a2, a3, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static <T1, T2> boolean any(boolean expected, T1 a1, T2 a2, double a3, @Nonnull Stream<? extends LBiObjDblPredicate<? super T1, ? super T2>> predicates) {
		return any(expected, a1, a2, a3, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static <T1, T2> boolean any(boolean expected, T1 a1, T2 a2, double a3, @Nonnull Iterator<? extends LBiObjDblPredicate<? super T1, ? super T2>> predicates) {
		Null.nonNullArg(predicates, "predicates");
	...
	public static <T1, T2> boolean any(boolean expected, T1 a1, T2 a2, double a3, @Nonnull LBiObjDblPredicate<? super T1, ? super T2>... predicates) {
		Null.nonNullArg(predicates, "predicates");
	...
	/** Allows to manipulate the domain of the function. */
	@Nonnull
	default <V1, V2, V3> LTriPredicate<V1, V2, V3> unboxingCompose(@Nonnull final LFunction<? super V1, ? extends T1> before1, @Nonnull final LFunction<? super V2, ? extends T2> before2, @Nonnull final LToDblFunction<? super V3> before3) {
		Null.nonNullArg(before1, "before1");
		Null.nonNullArg(before2, "before2");
		Null.nonNullArg(before3, "before3");
		return (v1, v2, v3) -> this.test(before1.apply(v1), before2.apply(v2), before3.applyAsDbl(v3));
	...
	default LBiObjDblPredicate<T1, T2> shoving() {

		return new LBiObjDblPredicate<T1, T2>() {

			public boolean test(T1 a1, T2 a2, double a3) {
				try {
					return this.testX(a1, a2, a3);
				} catch (Throwable e) { // NOSONAR
					Handling.handleErrors(e);
			...
			public boolean testX(T1 a1, T2 a2, double a3) throws Throwable {
				return LBiObjDblPredicate.this.testX(a1, a2, a3);
			}
