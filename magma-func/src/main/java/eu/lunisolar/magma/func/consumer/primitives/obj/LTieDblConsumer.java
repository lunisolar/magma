...
public interface LTieDblConsumer<T> extends MetaConsumer, MetaInterface.NonThrowing, TieConsumer<T, aDouble>, Codomain<aVoid>, Domain3<a<T>, aInt, aDouble> {
	...
	default void accept(T a1, int a2, double a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		try {
			this.acceptX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LTieDblConsumer<T> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
	...
	static <T> void tryAccept(T a1, int a2, double a3, LTieDblConsumer<T> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		Null.nonNullArg(func, "func");
	...
	public default LObjIntConsumer<T> rShrink(@Nonnull LOiToDblFunction<T> right) {
		Null.nonNullArg(right, "right");
		return (a1, a2) -> accept(a1, a2, right.applyAsDbl(a1, a2));
	}

	public default LObjIntConsumer<T> rShrink_(double a3) {
	...
	public default LTieDblConsumer untyped() {
		return this;
	}

	/** Cast that replace generics. */
	public default <V2> LTieDblConsumer<V2> cast() {
		return untyped();
	}
	...
	*/
	...
	public default <SRC> int genericTieForEach(int sStart, int tStart, T trg1, SRC src3, OFunction<SRC, aBool> srcTest3, OFunction<SRC, aDouble> srcAcc3) {
