...
public interface LTieDblConsumer<T> extends MetaConsumer, MetaInterface.NonThrowing, TieConsumer<T, aDouble>, Codomain<aVoid>, Domain3<a<T>, aInt, aDouble> {
	...
	default void accept(T a1, int a2, double a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		try {
			this.acceptX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default void accept(T a1, int a2, double a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		try {
			this.acceptX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default void accept(T a1, int a2, double a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		try {
			this.acceptX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default void accept(T a1, int a2, double a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		try {
			this.acceptX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LTieDblConsumer<T> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		return (a1, a2, a3) -> accept(a1, a2, a3, exF, newMessage);
	}

	default LTieDblConsumer<T> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		return (a1, a2, a3) -> accept(a1, a2, a3, exF, newMessage, param1);
	}

	default LTieDblConsumer<T> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		return (a1, a2, a3) -> accept(a1, a2, a3, exF, newMessage, param1, param1);
	}

	default LTieDblConsumer<T> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		return (a1, a2, a3) -> accept(a1, a2, a3, exF, newMessage, param1, param2, param3);
	}

	default void accept(T a1, int a2, double a3, @Nonnull ExWF<RuntimeException> exF) {
		try {
			this.acceptX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LTieDblConsumer<T> trying(@Nonnull ExWF<RuntimeException> exF) {
	...
	static <T> void tryAccept(T a1, int a2, double a3, LTieDblConsumer<T> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		Null.nonNullArg(func, "func");
		func.accept(a1, a2, a3, exF, newMessage);
	}

	static <T> void tryAccept(T a1, int a2, double a3, LTieDblConsumer<T> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		Null.nonNullArg(func, "func");
		func.accept(a1, a2, a3, exF, newMessage, param1);
	}

	static <T> void tryAccept(T a1, int a2, double a3, LTieDblConsumer<T> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		Null.nonNullArg(func, "func");
		func.accept(a1, a2, a3, exF, newMessage, param1, param2);
	}

	static <T> void tryAccept(T a1, int a2, double a3, LTieDblConsumer<T> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		Null.nonNullArg(func, "func");
		func.accept(a1, a2, a3, exF, newMessage, param1, param2, param3);
	}

	static <T> void tryAccept(T a1, int a2, double a3, LTieDblConsumer<T> func, @Nonnull ExWF<RuntimeException> exF) {
		Null.nonNullArg(func, "func");
	...
	/** Cast that replace generics. */
	public static <V2, T> LTieDblConsumer<V2> cast(LTieDblConsumer<T> function) {
	...
	final class LTieDblConsumerSingle<T> implements LTieDblConsumer<T> {
