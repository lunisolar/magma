...
public interface LToDblBiFunction<T1, T2> extends ToDoubleBiFunction<T1, T2>, MetaFunction, MetaInterface.NonThrowing, Codomain<aDouble>, Domain2<a<T1>, a<T2>> { // NOSONAR
	...
	default double applyAsDbl(T1 a1, T2 a2, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		try {
			return this.applyAsDblX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default double applyAsDbl(T1 a1, T2 a2, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		try {
			return this.applyAsDblX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default double applyAsDbl(T1 a1, T2 a2, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		try {
			return this.applyAsDblX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default double applyAsDbl(T1 a1, T2 a2, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		try {
			return this.applyAsDblX(a1, a2);
		} catch (Throwable e) { // NOSONAR
	...
	default LToDblBiFunction<T1, T2> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		return (a1, a2) -> applyAsDbl(a1, a2, exF, newMessage);
	}

	default LToDblBiFunction<T1, T2> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		return (a1, a2) -> applyAsDbl(a1, a2, exF, newMessage, param1);
	}

	default LToDblBiFunction<T1, T2> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		return (a1, a2) -> applyAsDbl(a1, a2, exF, newMessage, param1, param1);
	}

	default LToDblBiFunction<T1, T2> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
	...
	static <T1, T2> double tryApplyAsDbl(T1 a1, T2 a2, LToDblBiFunction<T1, T2> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		Null.nonNullArg(func, "func");
		return func.applyAsDbl(a1, a2, exF, newMessage);
	}

	static <T1, T2> double tryApplyAsDbl(T1 a1, T2 a2, LToDblBiFunction<T1, T2> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		Null.nonNullArg(func, "func");
		return func.applyAsDbl(a1, a2, exF, newMessage, param1);
	}

	static <T1, T2> double tryApplyAsDbl(T1 a1, T2 a2, LToDblBiFunction<T1, T2> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		Null.nonNullArg(func, "func");
		return func.applyAsDbl(a1, a2, exF, newMessage, param1, param2);
	}

	static <T1, T2> double tryApplyAsDbl(T1 a1, T2 a2, LToDblBiFunction<T1, T2> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		Null.nonNullArg(func, "func");
	 ...
	 */
	public static <T1, T2> M<T1, T2> memento(double initialValue, LToDblBiFunction<T1, T2> baseFunction, LDblBinaryOperator mementoFunction) {
		return new M(initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not ). Very short name is intended to be used with parent (LToDblBiFunction.D)
	 */
	final class M<T1, T2> implements LToDblBiFunction<T1, T2> {
		...
		private M(double lastValue, LToDblBiFunction<T1, T2> baseFunction, LDblBinaryOperator mementoFunction) {
		...
		@Override
		public double applyAsDblX(T1 a1, T2 a2) throws Throwable {
			double x2 = baseFunction.applyAsDblX(a1, a2);
			double x1 = lastValue;
