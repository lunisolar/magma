...
public interface LTriLongConsumer extends MetaConsumer, MetaInterface.NonThrowing, Codomain<aVoid>, Domain3<aLong, aLong, aLong> {
	...
	default void accept(long a1, long a2, long a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		try {
			this.acceptX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default void accept(long a1, long a2, long a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		try {
			this.acceptX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default void accept(long a1, long a2, long a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		try {
			this.acceptX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default void accept(long a1, long a2, long a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		try {
			this.acceptX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LTriLongConsumer trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		return (a1, a2, a3) -> accept(a1, a2, a3, exF, newMessage);
	}

	default LTriLongConsumer trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		return (a1, a2, a3) -> accept(a1, a2, a3, exF, newMessage, param1);
	}

	default LTriLongConsumer trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		return (a1, a2, a3) -> accept(a1, a2, a3, exF, newMessage, param1, param1);
	}

	default LTriLongConsumer trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		return (a1, a2, a3) -> accept(a1, a2, a3, exF, newMessage, param1, param2, param3);
	}

	default void accept(long a1, long a2, long a3, @Nonnull ExWF<RuntimeException> exF) {
		try {
			this.acceptX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LTriLongConsumer trying(@Nonnull ExWF<RuntimeException> exF) {
	...
	static void tryAccept(long a1, long a2, long a3, LTriLongConsumer func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		Null.nonNullArg(func, "func");
		func.accept(a1, a2, a3, exF, newMessage);
	}

	static void tryAccept(long a1, long a2, long a3, LTriLongConsumer func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		Null.nonNullArg(func, "func");
		func.accept(a1, a2, a3, exF, newMessage, param1);
	}

	static void tryAccept(long a1, long a2, long a3, LTriLongConsumer func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		Null.nonNullArg(func, "func");
		func.accept(a1, a2, a3, exF, newMessage, param1, param2);
	}

	static void tryAccept(long a1, long a2, long a3, LTriLongConsumer func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		Null.nonNullArg(func, "func");
		func.accept(a1, a2, a3, exF, newMessage, param1, param2, param3);
	}

	static void tryAccept(long a1, long a2, long a3, LTriLongConsumer func, @Nonnull ExWF<RuntimeException> exF) {
		Null.nonNullArg(func, "func");
	...
	static LTriLongConsumer recursive(final @Nonnull LFunction<LTriLongConsumer, LTriLongConsumer> selfLambda) {
		final LTriLongConsumerSingle single = new LTriLongConsumerSingle();
		LTriLongConsumer func = selfLambda.apply(single);
		single.target = func;
		return func;
	}

	final class LTriLongConsumerSingle implements LTriLongConsumer {
