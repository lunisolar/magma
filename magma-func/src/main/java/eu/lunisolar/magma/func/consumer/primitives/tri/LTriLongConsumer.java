...
public interface LTriLongConsumer extends MetaConsumer, MetaInterface.NonThrowing, Codomain<aVoid>, Domain3<aLong, aLong, aLong> {
	...
	default void accept(long a1, long a2, long a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		try {
			this.acceptX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LTriLongConsumer trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
	...
	static void tryAccept(long a1, long a2, long a3, LTriLongConsumer func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		Null.nonNullArg(func, "func");
	...
	public default LBiLongConsumer lShrink(@Nonnull LLongBinaryOperator left) {
		Null.nonNullArg(left, "left");
		return (a2, a3) -> accept(left.applyAsLong(a2, a3), a2, a3);
	}

	public default LBiLongConsumer lShrink_(long a1) {
	...
	public default LBiLongConsumer rShrink(@Nonnull LLongBinaryOperator right) {
		Null.nonNullArg(right, "right");
		return (a1, a2) -> accept(a1, a2, right.applyAsLong(a1, a2));
	}

	public default LBiLongConsumer rShrink_(long a3) {
	...
	public default LTriLongConsumer beforeDo(@Nonnull LTriLongConsumer before) {
	...
	final class LTriLongConsumerSingle implements LSingle<LTriLongConsumer>, LTriLongConsumer {
