...
public interface LBoolSupplier extends LBoolSupplierX<RuntimeException>, MetaSupplier, PrimitiveCodomain<Object>, MetaInterface.NonThrowing {

	static final String DESCRIPTION = "LBoolSupplier: boolean doGetAsBool()";
	...
	/** Wraps JRE instance. */
	@Nonnull
	static LBoolSupplier wrap(final java.util.function.BooleanSupplier other) {
