...
public interface LTriLongFunction<R> extends MetaFunction, MetaInterface.NonThrowing, Codomain<a<R>>, Domain3<aLong, aLong, aLong> { // NOSONAR
	...
	@Nullable
	// R apply(long a1,long a2,long a3) ;
	...
	default R failSafeApply(long a1, long a2, long a3, @Nonnull LTriLongFunction<R> failSafe) {
		try {
	...
	static <R> R failSafeApply(long a1, long a2, long a3, LTriLongFunction<R> func, @Nonnull LTriLongFunction<R> failSafe) {
	...
	static <R> LTriLongFunction<R> failSafe(LTriLongFunction<R> func, @Nonnull LTriLongFunction<R> failSafe) {
		Null.nonNullArg(failSafe, "failSafe");
	...
	default LBiLongFunction<R> lShrink(@Nonnull LLongBinaryOperator left) {
		Null.nonNullArg(left, "left");
		return (a2, a3) -> apply(left.applyAsLong(a2, a3), a2, a3);
	}

	default LBiLongFunction<R> lShrink_(long a1) {
		return (a2, a3) -> apply(a1, a2, a3);
	}

	public static <R> LBiLongFunction<R> lShrunken(@Nonnull LLongBinaryOperator left, @Nonnull LTriLongFunction<R> func) {
		Null.nonNullArg(left, "left");
		Null.nonNullArg(func, "func");
		return func.lShrink(left);
	}

	public static <R> LBiLongFunction<R> lShrunken_(long a1, @Nonnull LTriLongFunction<R> func) {
		Null.nonNullArg(func, "func");
		return func.lShrink_(a1);
	}

	default LBiLongFunction<R> rShrink(@Nonnull LLongBinaryOperator right) {
		Null.nonNullArg(right, "right");
		return (a1, a2) -> apply(a1, a2, right.applyAsLong(a1, a2));
	}

	default LBiLongFunction<R> rShrink_(long a3) {
		return (a1, a2) -> apply(a1, a2, a3);
	}

	public static <R> LBiLongFunction<R> rShrunken(@Nonnull LLongBinaryOperator right, @Nonnull LTriLongFunction<R> func) {
		Null.nonNullArg(right, "right");
		Null.nonNullArg(func, "func");
		return func.rShrink(right);
	}

	public static <R> LBiLongFunction<R> rShrunken_(long a3, @Nonnull LTriLongFunction<R> func) {
		Null.nonNullArg(func, "func");
	...
	default LSupplier<R> capture(long a1, long a2, long a3) {
	...
	@Nonnull
	static <R> LTriLongFunction<R> apply1st(@Nonnull LLongFunction<R> func) {
		return (a1, a2, a3) -> func.apply(a1);
	}

	/** Captures single parameter function into this interface where only 2nd parameter will be used. */
	@Nonnull
	static <R> LTriLongFunction<R> apply2nd(@Nonnull LLongFunction<R> func) {
		return (a1, a2, a3) -> func.apply(a2);
	}

	/** Captures single parameter function into this interface where only 3rd parameter will be used. */
	@Nonnull
	static <R> LTriLongFunction<R> apply3rd(@Nonnull LLongFunction<R> func) {
	...
	@Nonnull
	static <R> LTriLongFunction<R> safe() {
		return LTriLongFunction::doNothing;
	}

	/** Safe instance supplier. Returns supplier of safe() instance. */
	@Nonnull
	static <R> LSupplier<LTriLongFunction<R>> safeSupplier() {
		return () -> safe();
	}

	/** Safe wrapping. Either argument function is returned (if it is not null) or safe() instance. */
	@Nonnull
	static <R> LTriLongFunction<R> safe(final @Nullable LTriLongFunction<R> other) {
		if (other == null) {
			return safe();
		} else {
			return other;
	...
	@Nonnull
	static <R> LSupplier<LTriLongFunction<R>> safeSupplier(final @Nullable LSupplier<LTriLongFunction<R>> supplier) {
		if (supplier == null) {
			return safeSupplier();
		} else {
			return supplier;
	...
	public static <R> LTriLongFunction<R> composed(@Nonnull final LLongUnaryOperator before1, @Nonnull final LLongUnaryOperator before2, @Nonnull final LLongUnaryOperator before3, LTriLongFunction<R> after) {
		return after.compose(before1, before2, before3);
	}

	/** Allows to manipulate the domain of the function. */
	@Nonnull
	default <V1, V2, V3> LTriFunction<V1, V2, V3, R> triLongFuncCompose(@Nonnull final LToLongFunction<? super V1> before1, @Nonnull final LToLongFunction<? super V2> before2, @Nonnull final LToLongFunction<? super V3> before3) {
		Null.nonNullArg(before1, "before1");
		Null.nonNullArg(before2, "before2");
		Null.nonNullArg(before3, "before3");
		return (v1, v2, v3) -> this.apply(before1.applyAsLong(v1), before2.applyAsLong(v2), before3.applyAsLong(v3));
	...
	public static <V1, V2, V3, R> LTriFunction<V1, V2, V3, R> composed(@Nonnull final LToLongFunction<? super V1> before1, @Nonnull final LToLongFunction<? super V2> before2, @Nonnull final LToLongFunction<? super V3> before3, LTriLongFunction<R> after) {
		return after.triLongFuncCompose(before1, before2, before3);
	}
	...
	*/
	default <C1, C2, C3> void forEach(IndexedRead<C1, aLong> ia1, C1 source1, IndexedRead<C2, aLong> ia2, C2 source2, IndexedRead<C3, aLong> ia3, C3 source3, LConsumer<? super R> consumer) {
	...
	* Thread safety, fail-fast, fail-safety of this method is not expected.
	*/
	default <C1, I1, C2, C3> void iterate(SequentialRead<C1, I1, aLong> sa1, C1 source1, IndexedRead<C2, aLong> ia2, C2 source2, IndexedRead<C3, aLong> ia3, C3 source3, LConsumer<? super R> consumer) {
	...
	* Thread safety, fail-fast, fail-safety of this method is not expected.
	*/
	default <C1, C2, I2, C3> void iterate(IndexedRead<C1, aLong> ia1, C1 source1, SequentialRead<C2, I2, aLong> sa2, C2 source2, IndexedRead<C3, aLong> ia3, C3 source3, LConsumer<? super R> consumer) {
		int size = ia1.size(source1);
		LOiToLongFunction<Object> oiFunc1 = (LOiToLongFunction) ia1.getter();
	...
	* Thread safety, fail-fast, fail-safety of this method is not expected.
	*/
	default <C1, I1, C2, I2, C3> void iterate(SequentialRead<C1, I1, aLong> sa1, C1 source1, SequentialRead<C2, I2, aLong> sa2, C2 source2, IndexedRead<C3, aLong> ia3, C3 source3, LConsumer<? super R> consumer) {
		Object iterator1 = ((LFunction) sa1.adapter()).apply(source1);
		LPredicate<Object> testFunc1 = (LPredicate) sa1.tester();
		LToLongFunction<Object> nextFunc1 = (LToLongFunction) sa1.supplier();
		Object iterator2 = ((LFunction) sa2.adapter()).apply(source2);
	...
	* Thread safety, fail-fast, fail-safety of this method is not expected.
	*/
	default <C1, C2, C3, I3> void iterate(IndexedRead<C1, aLong> ia1, C1 source1, IndexedRead<C2, aLong> ia2, C2 source2, SequentialRead<C3, I3, aLong> sa3, C3 source3, LConsumer<? super R> consumer) {
		int size = ia1.size(source1);
		LOiToLongFunction<Object> oiFunc1 = (LOiToLongFunction) ia1.getter();
		size = Integer.min(size, ia2.size(source2));
		LOiToLongFunction<Object> oiFunc2 = (LOiToLongFunction) ia2.getter();
	...
	* Thread safety, fail-fast, fail-safety of this method is not expected.
	*/
	default <C1, I1, C2, C3, I3> void iterate(SequentialRead<C1, I1, aLong> sa1, C1 source1, IndexedRead<C2, aLong> ia2, C2 source2, SequentialRead<C3, I3, aLong> sa3, C3 source3, LConsumer<? super R> consumer) {
		Object iterator1 = ((LFunction) sa1.adapter()).apply(source1);
		LPredicate<Object> testFunc1 = (LPredicate) sa1.tester();
		LToLongFunction<Object> nextFunc1 = (LToLongFunction) sa1.supplier();
		int size = ia2.size(source2);
	...
	* Thread safety, fail-fast, fail-safety of this method is not expected.
	*/
	default <C1, C2, I2, C3, I3> void iterate(IndexedRead<C1, aLong> ia1, C1 source1, SequentialRead<C2, I2, aLong> sa2, C2 source2, SequentialRead<C3, I3, aLong> sa3, C3 source3, LConsumer<? super R> consumer) {
		int size = ia1.size(source1);
		LOiToLongFunction<Object> oiFunc1 = (LOiToLongFunction) ia1.getter();
		Object iterator2 = ((LFunction) sa2.adapter()).apply(source2);
		LPredicate<Object> testFunc2 = (LPredicate) sa2.tester();
	...
	*/
	default <C1, I1, C2, I2, C3, I3> void iterate(SequentialRead<C1, I1, aLong> sa1, C1 source1, SequentialRead<C2, I2, aLong> sa2, C2 source2, SequentialRead<C3, I3, aLong> sa3, C3 source3, LConsumer<? super R> consumer) {
		Object iterator1 = ((LFunction) sa1.adapter()).apply(source1);
		LPredicate<Object> testFunc1 = (LPredicate) sa1.tester();
		LToLongFunction<Object> nextFunc1 = (LToLongFunction) sa1.supplier();
		Object iterator2 = ((LFunction) sa2.adapter()).apply(source2);
