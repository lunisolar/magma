...
public interface LFltPredicate extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain1<aFloat> { // NOSONAR
	...
	default boolean test(float a, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		try {
			return this.testX(a);
		} catch (Throwable e) { // NOSONAR
	...
	static boolean tryTest(float a, LFltPredicate func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		Null.nonNullArg(func, "func");
	...
	public static <X extends Throwable> float throwIf(float a, @Nonnull LFltPredicate pred, @Nonnull ExMF<X> factory, LFltFunction<? extends String> msgFunc) throws X {
		if (pred.test(a)) {
	...
	/** Throws new exception if condition is met. */
	public static <X extends Throwable> float throwIfNot(float a, @Nonnull LFltPredicate pred, @Nonnull ExMF<X> factory, LFltFunction<? extends String> msgFunc) throws X {
		if (!pred.test(a)) {
			throw Handling.create(factory, msgFunc.apply(a), a);
		}
		return a;
	...
	public static <X extends Throwable> float throwIfNot$(float a, LFltFunction<? extends String> specialPredicate, @Nonnull ExMF<X> factory) throws X {
	...
	/** Throws new exception if condition is met. */
	public static <X extends Throwable> float throwIf(float a, @Nonnull LFltPredicate pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (pred.test(a)) {
	...
	public static <X extends Throwable> float throwIfNot(float a, @Nonnull LFltPredicate pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (!pred.test(a)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a;
	...
	/** Throws new exception if condition is met. */
	public static <X extends Throwable> float throwIf(float a, @Nonnull LFltPredicate pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (pred.test(a)) {
	...
	/** Throws new exception if condition is not met. */
	public static <X extends Throwable> float throwIfNot(float a, @Nonnull LFltPredicate pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (!pred.test(a)) {
			throw Handling.create(factory, newMessage);
		}
		return a;
