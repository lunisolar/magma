...
public interface LFltPredicate extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain1<aFloat> { // NOSONAR
	...
	public default <V> boolean doIf(V a1, float a2, @Nonnull LObjFltConsumer<V> consumer) {
		Null.nonNullArg(consumer, "consumer");
		if (test(a2)) {
	...
	public default LFltPredicate beforeDo(@Nonnull LFltConsumer before) {
	...
	public default LFltPredicate afterDo(@Nonnull LBoolConsumer after) {
	...
	public static void throwIf(float a, @Nonnull LFltPredicate pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (pred.test(a)) {
	...
	public static void throwIfNot(float a, @Nonnull LFltPredicate pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (!pred.test(a)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}
	...
	public static float complying(float a, @Nonnull LFltPredicate pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (pred.test(a)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a;
	...
	public static float notComplying(float a, @Nonnull LFltPredicate pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (!pred.test(a)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a;
