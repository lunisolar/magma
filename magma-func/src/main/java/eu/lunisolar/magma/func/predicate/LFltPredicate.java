...
public interface LFltPredicate extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain1<aFloat> { // NOSONAR
	...
	public static float throwIf(float a, @Nonnull LFltPredicate pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (pred.test(a)) {
	...
	public static float throwIfNot(float a, @Nonnull LFltPredicate pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (!pred.test(a)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a;
	...
	/** Throws new exception if condition is met. */
	public static float throwIf(float a, @Nonnull LFltPredicate pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage) {
		if (pred.test(a)) {
	...
	/** Throws new exception if condition is not met. */
	public static float throwIfNot(float a, @Nonnull LFltPredicate pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage) {
		if (!pred.test(a)) {
			throw Handling.create(factory, newMessage);
		}
		return a;
