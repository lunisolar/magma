...
public interface LFltPredicate extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain1<aFloat> { // NOSONAR
	 ...
	 */
	public static M memento(boolean initialValue, LFltPredicate baseFunction, LLogicalBinaryOperator mementoFunction) {
		return new M(initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not ). Very short name is intended to be used with parent (LFltPredicate.D)
	 */
	final class M implements LFltPredicate {
		...
		private M(boolean lastValue, LFltPredicate baseFunction, LLogicalBinaryOperator mementoFunction) {
