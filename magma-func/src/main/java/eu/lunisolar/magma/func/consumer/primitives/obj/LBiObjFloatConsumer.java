...
public interface LBiObjFloatConsumer<T1, T2> extends LBiObjFloatConsumerX<T1, T2, RuntimeException>, MetaConsumer, MetaInterface.NonThrowing {
	...
	interface V1<T1, T2> extends LBiObjFloatConsumer<T1, T2> {
		...
		void apply1(T1 a1, float a3, T2 a2);
	...
	/** Permutation of LBiObjFloatConsumer for method references. */
	@FunctionalInterface
	interface V2<T1, T2> extends LBiObjFloatConsumer<T1, T2> {

		void apply2(T2 a2, T1 a1, float a3);
	...
	/** Permutation of LBiObjFloatConsumer for method references. */
	@FunctionalInterface
	interface V3<T1, T2> extends LBiObjFloatConsumer<T1, T2> {

		void apply3(T2 a2, float a3, T1 a1);
	...
	interface V4<T1, T2> extends LBiObjFloatConsumer<T1, T2> {
		...
		void apply4(float a3, T1 a1, T2 a2);
	...
	/** Permutation of LBiObjFloatConsumer for method references. */
	@FunctionalInterface
	interface V5<T1, T2> extends LBiObjFloatConsumer<T1, T2> {

		void apply5(float a3, T2 a2, T1 a1);
