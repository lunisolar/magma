...
public interface LBiObjFloatConsumer<T1, T2> extends LBiObjFloatConsumerX<T1, T2, RuntimeException>, MetaConsumer, MetaInterface.NonThrowing {
	...
	static final String DESCRIPTION = "LBiObjFloatConsumer: void doAccept(T1 t1,T2 t2, float f)";

	void doAccept(T1 t1, T2 t2, float f);
	...
	default LAction captureBiObjFCons(T1 t1, T2 t2, float f) {
	 ...
	 */
	@Nonnull
	default <V1, V2> LBiObjFloatConsumer<V1, V2> biObjFConsFromFloat(@Nonnull final LFunction<? super V1, ? extends T1> before1, @Nonnull final LFunction<? super V2, ? extends T2> before2, @Nonnull final LFloatUnaryOperator before3) {
	 ...
	 */
	@Nonnull
	default <V1, V2, V3> LTriConsumer<V1, V2, V3> biObjFConsFrom(@Nonnull final LFunction<? super V1, ? extends T1> before1, @Nonnull final LFunction<? super V2, ? extends T2> before2, @Nonnull final LToFloatFunction<? super V3> before3) {
		Null.nonNullArg(before1, "before1");
		Null.nonNullArg(before2, "before2");
		Null.nonNullArg(before3, "before3");
