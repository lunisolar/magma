...
public interface LTriFltPredicate extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<aFloat, aFloat, aFloat> { // NOSONAR
	...
	final class M implements LTriFltPredicate {
		...
		public boolean currentTest(float a1, float a2, float a3) {
			boolean x1 = lastBaseValue;
		...
		public boolean currentBaseValue(float a1, float a2, float a3) {
	...
	public static boolean any(boolean expected, float a1, float a2, float a3, @Nonnull Collection<? extends LTriFltPredicate> predicates) {
		return any(expected, a1, a2, a3, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static boolean any(boolean expected, float a1, float a2, float a3, @Nonnull Stream<? extends LTriFltPredicate> predicates) {
		return any(expected, a1, a2, a3, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static boolean any(boolean expected, float a1, float a2, float a3, @Nonnull Iterator<? extends LTriFltPredicate> predicates) {
		Null.nonNullArg(predicates, "predicates");
	...
	public static boolean any(boolean expected, float a1, float a2, float a3, @Nonnull LTriFltPredicate... predicates) {
		Null.nonNullArg(predicates, "predicates");
