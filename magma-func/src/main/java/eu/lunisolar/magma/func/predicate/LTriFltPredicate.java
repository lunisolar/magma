...
public interface LTriFltPredicate extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<aFloat, aFloat, aFloat> { // NOSONAR
	...
	default boolean test(float a1, float a2, float a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		try {
			return this.testX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LTriFltPredicate trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
	...
	static boolean tryTest(float a1, float a2, float a3, LTriFltPredicate func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object... messageParams) {
		Null.nonNullArg(func, "func");
	...
	public static <X extends Throwable> float throwIf(float a1, float a2, float a3, @Nonnull LTriFltPredicate pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
	...
	/** Throws new exception if condition is met. */
	public static <X extends Throwable> float throwIf(float a1, @Nonnull LTriFltPredicate pred, float a2, float a3, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	public static <X extends Throwable> float throwIfNot(float a1, float a2, float a3, @Nonnull LTriFltPredicate pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <X extends Throwable> float throwIfNot(float a1, @Nonnull LTriFltPredicate pred, float a2, float a3, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	/** Throws new exception if condition is met. */
	public static <X extends Throwable> float throwIf(float a1, float a2, float a3, @Nonnull LTriFltPredicate pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (pred.test(a1, a2, a3)) {
	...
	/** Throws new exception if condition is met. */
	public static <X extends Throwable> float throwIf(float a1, @Nonnull LTriFltPredicate pred, float a2, float a3, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <X extends Throwable> float throwIfNot(float a1, float a2, float a3, @Nonnull LTriFltPredicate pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <X extends Throwable> float throwIfNot(float a1, @Nonnull LTriFltPredicate pred, float a2, float a3, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
	...
	*/
	...
	static LTriFltPredicate recursive(final @Nonnull LFunction<LTriFltPredicate, LTriFltPredicate> selfLambda) {
		final LTriFltPredicateSingle single = new LTriFltPredicateSingle();
		LTriFltPredicate func = selfLambda.apply(single);
		single.target = func;
		return func;
	}

	final class LTriFltPredicateSingle implements LTriFltPredicate {
