...
public interface LIntToCharFunctionX<X extends Throwable> extends MetaFunction, MetaInterface.Throwing<X> { // NOSONAR
	...
	String DESCRIPTION = "LIntToCharFunctionX: char doApplyAsChar(int a) throws X";

	char doApplyAsChar(int a) throws X;

	default char tupleApplyAsChar(LIntSingle args) throws X {
	...
	default char shovingDoApplyAsChar(int a) {
		return ((LIntToCharFunctionX<RuntimeException>) this).doApplyAsChar(a);
	}

	/** Function call that handles exceptions according to the instructions. */
	default <Y extends Throwable> char handlingDoApplyAsChar(int a, HandlingInstructions<Throwable, Y> handling) throws Y {
	...
	default char nonNullDoApplyAsChar(int a) throws X {
	...
	default LCharSupplierX<X> captureIntToCharFunc(int a) {
		return () -> this.doApplyAsChar(a);
	}
	...
	static <X extends Throwable> char call(int a, final @Nonnull LIntToCharFunctionX<X> lambda) throws X {
		Null.nonNullArg(lambda, "lambda");
		return lambda.doApplyAsChar(a);
	}

	static <X extends Throwable> char shoving(int a, final @Nonnull LIntToCharFunctionX<X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.shovingDoApplyAsChar(a);
	}

	static <X extends Throwable> char nesting(int a, final @Nonnull LIntToCharFunctionX<X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.nestingDoApplyAsChar(a);
	}

	static <X extends Throwable, Y extends Throwable> char handling(int a, final HandlingInstructions<Throwable, Y> handling, final @Nonnull LIntToCharFunctionX<X> lambda) throws Y {
		Null.nonNullArg(lambda, "lambda");
	...
	@Nonnull
	default LIntToCharFunctionX<X> intToCharFuncComposeInt(@Nonnull final LIntUnaryOperatorX<X> before) {
	...
	/** Allows to manipulate the domain of the function. */
	@Nonnull
	default <V> LToCharFunctionX<V, X> intToCharFuncCompose(@Nonnull final LToIntFunctionX<? super V, X> before) {
		Null.nonNullArg(before, "before");
		return v -> this.doApplyAsChar(before.doApplyAsInt(v));
	}
