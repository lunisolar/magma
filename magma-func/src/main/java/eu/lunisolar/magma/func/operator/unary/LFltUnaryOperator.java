...
public interface LFltUnaryOperator extends MetaOperator, MetaInterface.NonThrowing, Codomain<aFloat>, Domain1<aFloat> { // NOSONAR
	...
	default float applyAsFlt(float a, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		try {
			return this.applyAsFltX(a);
		} catch (Throwable e) { // NOSONAR
	...
	default float applyAsFlt(float a, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		try {
			return this.applyAsFltX(a);
		} catch (Throwable e) { // NOSONAR
	...
	default float applyAsFlt(float a, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		try {
			return this.applyAsFltX(a);
		} catch (Throwable e) { // NOSONAR
	...
	default float applyAsFlt(float a, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		try {
			return this.applyAsFltX(a);
		} catch (Throwable e) { // NOSONAR
	...
	default LFltUnaryOperator trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		return a -> applyAsFlt(a, exF, newMessage);
	}

	default LFltUnaryOperator trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		return a -> applyAsFlt(a, exF, newMessage, param1);
	}

	default LFltUnaryOperator trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		return a -> applyAsFlt(a, exF, newMessage, param1, param1);
	}

	default LFltUnaryOperator trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		return a -> applyAsFlt(a, exF, newMessage, param1, param2, param3);
	}

	default float applyAsFlt(float a, @Nonnull ExWF<RuntimeException> exF) {
		try {
			return this.applyAsFltX(a);
		} catch (Throwable e) { // NOSONAR
	...
	static float tryApplyAsFlt(float a, LFltUnaryOperator func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		Null.nonNullArg(func, "func");
		return func.applyAsFlt(a, exF, newMessage);
	}

	static float tryApplyAsFlt(float a, LFltUnaryOperator func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		Null.nonNullArg(func, "func");
		return func.applyAsFlt(a, exF, newMessage, param1);
	}

	static float tryApplyAsFlt(float a, LFltUnaryOperator func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		Null.nonNullArg(func, "func");
		return func.applyAsFlt(a, exF, newMessage, param1, param2);
	}

	static float tryApplyAsFlt(float a, LFltUnaryOperator func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		Null.nonNullArg(func, "func");
		return func.applyAsFlt(a, exF, newMessage, param1, param2, param3);
	}

	static float tryApplyAsFlt(float a, LFltUnaryOperator func, @Nonnull ExWF<RuntimeException> exF) {
		Null.nonNullArg(func, "func");
	...
	default float failSafeApplyAsFlt(float a, @Nonnull LFltUnaryOperator failSafe) {
		try {
			return applyAsFlt(a);
		} catch (Throwable e) { // NOSONAR
			Handling.handleErrors(e);
	...
	static float failSafeApplyAsFlt(float a, LFltUnaryOperator func, @Nonnull LFltUnaryOperator failSafe) {
	 ...
	 */
	public static M memento(float initialValue, LFltUnaryOperator baseFunction, LFltBinaryOperator mementoFunction) {
		return new M(initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not ). Very short name is intended to be used with parent (LFltUnaryOperator.D)
	 */
	final class M implements LFltUnaryOperator {
		...
		private M(float lastValue, LFltUnaryOperator baseFunction, LFltBinaryOperator mementoFunction) {
