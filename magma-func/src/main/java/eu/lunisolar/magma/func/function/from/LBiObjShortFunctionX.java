...
public interface LBiObjShortFunctionX<T1, T2, R, X extends Throwable> extends MetaFunction, MetaInterface.Throwing<X> { // NOSONAR
	...
	interface V1<T1, T2, R, X extends Throwable> extends LBiObjShortFunctionX<T1, T2, R, X> {
		@Nullable
		R apply1(T1 a1, short a3, T2 a2) throws X;
	...
	/** Permutation of LBiObjShortFunctionX for method references. */
	@FunctionalInterface
	interface V2<T1, T2, R, X extends Throwable> extends LBiObjShortFunctionX<T1, T2, R, X> {
		@Nullable
		R apply2(T2 a2, T1 a1, short a3) throws X;
	...
	/** Permutation of LBiObjShortFunctionX for method references. */
	@FunctionalInterface
	interface V3<T1, T2, R, X extends Throwable> extends LBiObjShortFunctionX<T1, T2, R, X> {
		@Nullable
		R apply3(T2 a2, short a3, T1 a1) throws X;
	...
	interface V4<T1, T2, R, X extends Throwable> extends LBiObjShortFunctionX<T1, T2, R, X> {
		@Nullable
		R apply4(short a3, T1 a1, T2 a2) throws X;
	...
	/** Permutation of LBiObjShortFunctionX for method references. */
	@FunctionalInterface
	interface V5<T1, T2, R, X extends Throwable> extends LBiObjShortFunctionX<T1, T2, R, X> {
		@Nullable
		R apply5(short a3, T2 a2, T1 a1) throws X;
