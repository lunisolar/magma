...
public interface LBiObjShortFunctionX<T1, T2, R, X extends Exception> extends MetaFunction, MetaInterface.Throwing<X> { // NOSONAR
	...
	public static final String DESCRIPTION = "LBiObjShortFunctionX: R apply(T1 t1,T2 t2, short s) throws X";
	...
	default LBiObjShortFunction<T1, T2, R> nonThrowing() {
		return LBiObjShortFunction.wrap(this);
	}
	...
	default LBiObjShortFunction<T1, T2, R> shove() {
		LBiObjShortFunctionX<T1, T2, R, RuntimeException> exceptionCast = (LBiObjShortFunctionX<T1, T2, R, RuntimeException>) this;
