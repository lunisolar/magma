...
public interface LObjIntCharTriple<T> extends LTuple<Object> {
	...
	interface Mut<T, SELF extends Mut<T, SELF>> extends LObjIntCharTriple<T> {
		...
		default LObjIntCharTriple<T> value(char value) {
			third(value);
			return this;
		}
	...
	public static <T> LObjIntCharTriple<T> immutableOf(T a1, int a2, char a3) {
		return new ImmObjIntCharTriple(a1, a2, a3);
	}

	public static <T> LObjIntCharTriple<T> immutableCopyOf(LObjIntCharTriple<T> tuple) {
