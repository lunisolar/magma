...
/**
 * Non-throwing functional interface (lambda) ShortBinaryOperator for Java 8.
 *
 * Type: operator
 *
...
public interface ShortBinaryOperator extends ShortBinaryOperatorX<RuntimeException>, MetaOperator, PrimitiveCodomain<Object>, MetaInterface.NonThrowing { // NOSONAR
