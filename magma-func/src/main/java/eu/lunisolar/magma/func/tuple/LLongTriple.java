...
public interface LLongTriple extends LTuple<Long>, Comparable<LLongTriple> {
	...
	public static Iterator<LLongTriple.MutLongTriple> mutIterator(PrimitiveIterator.OfLong items) {
		return iterator(items, LLongTriple::of);
	}

	public static Iterator<LLongTriple> immIterator(PrimitiveIterator.OfLong items) {
		return iterator(items, LLongTriple::immutableOf);
	}
	...
	public static Stream<LLongTriple.MutLongTriple> mutStream(LongStream items) {
		return stream(items, LLongTriple::of);
	}

	public static Stream<LLongTriple> immStream(LongStream items) {
		return stream(items, LLongTriple::immutableOf);
	}
