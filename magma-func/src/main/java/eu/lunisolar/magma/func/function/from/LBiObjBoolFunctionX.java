...
public interface LBiObjBoolFunctionX<T1, T2, R, X extends Throwable> extends MetaFunction, MetaInterface.Throwing<X> { // NOSONAR
	...
	String DESCRIPTION = "LBiObjBoolFunctionX: R doApply(T1 a1,T2 a2,boolean a3) throws X";

	@Nullable
	R doApply(T1 a1, T2 a2, boolean a3) throws X;

	default R tupleApply(LBiObjBoolTriple<T1, T2> args) throws X {
	...
	default R shovingDoApply(T1 a1, T2 a2, boolean a3) {
		return ((LBiObjBoolFunctionX<T1, T2, R, RuntimeException>) this).doApply(a1, a2, a3);
	}

	/** Function call that handles exceptions according to the instructions. */
	default <Y extends Throwable> R handlingDoApply(T1 a1, T2 a2, boolean a3, HandlingInstructions<Throwable, Y> handling) throws Y {
	...
	@Nonnull
	default R nonNullDoApply(T1 a1, T2 a2, boolean a3) throws X {
	...
	default LSupplierX<R, X> captureBiObjBoolFunc(T1 a1, T2 a2, boolean a3) {
		return () -> this.doApply(a1, a2, a3);
	}
	...
	static <T1, T2, R, X extends Throwable> R call(T1 a1, T2 a2, boolean a3, final @Nonnull LBiObjBoolFunctionX<T1, T2, R, X> lambda) throws X {
		Null.nonNullArg(lambda, "lambda");
		return lambda.doApply(a1, a2, a3);
	}

	static <T1, T2, R, X extends Throwable> R shoving(T1 a1, T2 a2, boolean a3, final @Nonnull LBiObjBoolFunctionX<T1, T2, R, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.shovingDoApply(a1, a2, a3);
	}

	static <T1, T2, R, X extends Throwable> R nesting(T1 a1, T2 a2, boolean a3, final @Nonnull LBiObjBoolFunctionX<T1, T2, R, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.nestingDoApply(a1, a2, a3);
	}

	static <T1, T2, R, X extends Throwable, Y extends Throwable> R handling(T1 a1, T2 a2, boolean a3, final HandlingInstructions<Throwable, Y> handling, final @Nonnull LBiObjBoolFunctionX<T1, T2, R, X> lambda) throws Y {
		Null.nonNullArg(lambda, "lambda");
	...
	@Nonnull
	static <T1, T2, R, X extends Throwable> LBiObjBoolFunctionX<T1, T2, R, X> safe() {
		return Function4U::produce;
	}

	/** Safe instance supplier. Returns supplier of safe() instance. */
	@Nonnull
	static <T1, T2, R, X extends Throwable, Y extends Throwable> LSupplierX<LBiObjBoolFunctionX<T1, T2, R, X>, Y> safeSupplier() {
		return () -> safe();
	}

	/** Safe wrapping. Either argument function is returned (if it is not null) or safe() instance. */
	@Nonnull
	static <T1, T2, R, X extends Throwable> LBiObjBoolFunctionX<T1, T2, R, X> safe(final @Nullable LBiObjBoolFunctionX<T1, T2, R, X> other) {
		if (other == null) {
			return safe();
		} else {
			return other;
	...
	@Nonnull
	static <T1, T2, R, X extends Throwable, Y extends Throwable> LSupplierX<LBiObjBoolFunctionX<T1, T2, R, X>, Y> safeSupplier(final @Nullable LSupplierX<LBiObjBoolFunctionX<T1, T2, R, X>, Y> supplier) {
		if (supplier == null) {
			return safeSupplier();
		} else {
			return supplier;
	...
	@Nonnull
	default <V1, V2> LBiObjBoolFunctionX<V1, V2, R, X> biObjBoolFuncComposeBool(@Nonnull final LFunctionX<? super V1, ? extends T1, X> before1, @Nonnull final LFunctionX<? super V2, ? extends T2, X> before2, @Nonnull final LLogicalOperatorX<X> before3) {
		Null.nonNullArg(before1, "before1");
		Null.nonNullArg(before2, "before2");
		Null.nonNullArg(before3, "before3");
		return (V1 v1, V2 v2, boolean v3) -> this.doApply(before1.doApply(v1), before2.doApply(v2), before3.doApply(v3));
	}
	...
	default <V> LBiObjBoolFunctionX<T1, T2, V, X> then(@Nonnull LFunctionX<? super R, ? extends V, X> after) {
		...
		return (T1 a1, T2 a2, boolean a3) -> after.doApply(this.doApply(a1, a2, a3));
	}
	...
	default LBiObjBoolConsumerX<T1, T2, X> then(@Nonnull LConsumerX<? super R, X> after) {
		Null.nonNullArg(after, "after");
		return (T1 a1, T2 a2, boolean a3) -> after.doAccept(this.doApply(a1, a2, a3));
	}
	...
	default LBiObjBoolFunction<T1, T2, R> handleBiObjBoolFunc(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
		return (T1 a1, T2 a2, boolean a3) -> this.handlingDoApply(a1, a2, a3, handling);
	}
	...
	/** Permutation of LBiObjBoolFunctionX for method references. */
	@FunctionalInterface
	interface V1<T1, T2, R, X extends Throwable> extends LBiObjBoolFunctionX<T1, T2, R, X> {
		@Nullable
		R doApplyV1(T1 a1, boolean a3, T2 a2) throws X;

		@Override
		default R doApply(T1 a1, T2 a2, boolean a3) throws X {
	...
	/** Permutation of LBiObjBoolFunctionX for method references. */
	@FunctionalInterface
	interface V2<T2, T1, R, X extends Throwable> extends LBiObjBoolFunctionX<T1, T2, R, X> {
		@Nullable
		R doApplyV2(T2 a2, T1 a1, boolean a3) throws X;
	...
	/** Permutation of LBiObjBoolFunctionX for method references. */
	@FunctionalInterface
	interface V3<T2, T1, R, X extends Throwable> extends LBiObjBoolFunctionX<T1, T2, R, X> {
		@Nullable
		R doApplyV3(T2 a2, boolean a3, T1 a1) throws X;
	...
	/** Permutation of LBiObjBoolFunctionX for method references. */
	@FunctionalInterface
	interface V4<T1, T2, R, X extends Throwable> extends LBiObjBoolFunctionX<T1, T2, R, X> {
		@Nullable
		R doApplyV4(boolean a3, T1 a1, T2 a2) throws X;
	...
	/** Permutation of LBiObjBoolFunctionX for method references. */
	@FunctionalInterface
	interface V5<T2, T1, R, X extends Throwable> extends LBiObjBoolFunctionX<T1, T2, R, X> {
		@Nullable
		R doApplyV5(boolean a3, T2 a2, T1 a1) throws X;
