...
/**
 *
 * @see {@link eu.lunisolar.magma.func.function.conversion.ShortToCharFunction}
 */
@FunctionalInterface
...
public interface ShortToCharFunctionX<X extends Exception> extends MetaFunction, PrimitiveCodomain<ShortToCharFunctionX<X>>, MetaThrowingInterface<X> { // NOSONAR
	...
	@Nonnull
	public static <X extends Exception, Y extends Exception> ShortToCharFunctionX<Y> wrapException(@Nonnull final ShortToCharFunctionX<X> other, Class<? extends Exception> exception, ExceptionHandler<Exception, Y> rethrower) {
		return (short s) -> {
			try {
	...
	@Nonnull
	default <Y extends Exception> ShortToCharFunctionX<Y> handle(Class<? extends Exception> exception, ExceptionHandler<? super X, Y> handler) {
		Objects.requireNonNull(exception, Function4U.VALIDATION_MESSAGE_EXCEPTION);
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return ShortToCharFunctionX.wrapException(this, exception, (ExceptionHandler) handler);
	}

	/** Wraps with exception handling that for argument exception class will call function to determine the final exception. */
	@Nonnull
	default <Y extends Exception> ShortToCharFunctionX<Y> handle(ExceptionHandler<? super X, Y> handler) {
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);

		return ShortToCharFunctionX.wrapException(this, Exception.class, (ExceptionHandler) handler);
	}
