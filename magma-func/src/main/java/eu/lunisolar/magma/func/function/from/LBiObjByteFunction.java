...
public interface LBiObjByteFunction<T1, T2, R> extends LBiObjByteFunctionX<T1, T2, R, RuntimeException>, MetaFunction, MetaInterface.NonThrowing { // NOSONAR
	...
	/** Permutation of LBiObjByteFunction for method references. */
	@FunctionalInterface
	interface V2<T1, T2, R> extends LBiObjByteFunction<T1, T2, R> {
		@Nullable
		R apply2(T2 a2, T1 a1, byte a3);
	...
	/** Permutation of LBiObjByteFunction for method references. */
	@FunctionalInterface
	interface V3<T1, T2, R> extends LBiObjByteFunction<T1, T2, R> {
		@Nullable
		R apply3(T2 a2, byte a3, T1 a1);
	...
	/** Permutation of LBiObjByteFunction for method references. */
	@FunctionalInterface
	interface V5<T1, T2, R> extends LBiObjByteFunction<T1, T2, R> {
		@Nullable
		R apply5(byte a3, T2 a2, T1 a1);
