...
public interface LBiObjByteFunction<T1, T2, R> extends MetaFunction, MetaInterface.NonThrowing, Codomain<a<R>>, Domain3<a<T1>, a<T2>, aByte> { // NOSONAR
	...
	default R apply(T1 a1, T2 a2, byte a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default R apply(T1 a1, T2 a2, byte a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default R apply(T1 a1, T2 a2, byte a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default R apply(T1 a1, T2 a2, byte a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		try {
			return this.applyX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LBiObjByteFunction<T1, T2, R> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		return (a1, a2, a3) -> apply(a1, a2, a3, exF, newMessage);
	}

	default LBiObjByteFunction<T1, T2, R> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		return (a1, a2, a3) -> apply(a1, a2, a3, exF, newMessage, param1);
	}

	default LBiObjByteFunction<T1, T2, R> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		return (a1, a2, a3) -> apply(a1, a2, a3, exF, newMessage, param1, param1);
	}

	default LBiObjByteFunction<T1, T2, R> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
	...
	static <T1, T2, R> R tryApply(T1 a1, T2 a2, byte a3, LBiObjByteFunction<T1, T2, R> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, a3, exF, newMessage);
	}

	static <T1, T2, R> R tryApply(T1 a1, T2 a2, byte a3, LBiObjByteFunction<T1, T2, R> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, a3, exF, newMessage, param1);
	}

	static <T1, T2, R> R tryApply(T1 a1, T2 a2, byte a3, LBiObjByteFunction<T1, T2, R> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		Null.nonNullArg(func, "func");
		return func.apply(a1, a2, a3, exF, newMessage, param1, param2);
	}

	static <T1, T2, R> R tryApply(T1 a1, T2 a2, byte a3, LBiObjByteFunction<T1, T2, R> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		Null.nonNullArg(func, "func");
	...
	public static <R, M, K, V, T2> R from(@Nonnull M container, LBiFunction<M, K, V> extractor, K key, T2 a2, byte a3, @Nonnull LBiObjByteFunction<V, T2, R> function) {
	...
	public static <T2, R, T1> LObjByteFunction<T2, R> lShrunken(@Nonnull LObjByteFunction<T2, T1> left, @Nonnull LBiObjByteFunction<T1, T2, R> func) {
		Null.nonNullArg(left, "left");
		Null.nonNullArg(func, "func");
		return func.lShrink(left);
	}

	public static <T2, R, T1> LObjByteFunction<T2, R> lShrunken_(T1 a1, @Nonnull LBiObjByteFunction<T1, T2, R> func) {
		Null.nonNullArg(func, "func");
	...
	public static <T1, T2, R> LBiFunction<T1, T2, R> rShrunken(@Nonnull LToByteBiFunction<T1, T2> right, @Nonnull LBiObjByteFunction<T1, T2, R> func) {
		Null.nonNullArg(right, "right");
		Null.nonNullArg(func, "func");
		return func.rShrink(right);
	}

	public static <T1, T2, R> LBiFunction<T1, T2, R> rShrunken_(byte a3, @Nonnull LBiObjByteFunction<T1, T2, R> func) {
		Null.nonNullArg(func, "func");
	...
	@Nonnull
	static <T1, T2, R> LBiObjByteFunction<T1, T2, R> biObjByteFunc(@Nullable Class<T1> c1, @Nullable Class<T2> c2, @Nullable Class<R> c3, final @Nonnull LBiObjByteFunction<T1, T2, R> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	 ...
	 */
	public static <T1, T2, R> M<T1, T2, R> memento(R initialValue, LBiObjByteFunction<T1, T2, R> baseFunction, LBinaryOperator<R> mementoFunction) {
		return new M(initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not ). Very short name is intended to be used with parent (LBiObjByteFunction.D)
	 */
	final class M<T1, T2, R> implements LBiObjByteFunction<T1, T2, R> {
		...
		private M(R lastValue, LBiObjByteFunction<T1, T2, R> baseFunction, LBinaryOperator<R> mementoFunction) {
	...
	public static <T1, T2, R> R doNothing(T1 a1, byte a3, T2 a2) {
		return (R) Function4U.defaultObject;
	}

	/** Does nothing (LBiObjByteFunction.LByte2Obj0Obj1Func) Function */
	public static <T1, T2, R> R doNothing(byte a3, T1 a1, T2 a2) {
		return (R) Function4U.defaultObject;
	}
