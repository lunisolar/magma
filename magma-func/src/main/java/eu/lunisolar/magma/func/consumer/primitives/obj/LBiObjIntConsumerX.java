...
public interface LBiObjIntConsumerX<T1, T2, X extends Exception> extends MetaConsumer, MetaInterface.Throwing<X> {
	...
	public static final String DESCRIPTION = "LBiObjIntConsumerX: void accept(T1 t1,T2 t2, int i) throws X";
	...
	default LBiObjIntConsumer<T1, T2> nonThrowing() {
		return LBiObjIntConsumer.wrap(this);
	}
	...
	default LBiObjIntConsumer<T1, T2> shove() {
		LBiObjIntConsumerX<T1, T2, RuntimeException> exceptionCast = (LBiObjIntConsumerX<T1, T2, RuntimeException>) this;
