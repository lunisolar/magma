...
public interface LBiObjBytePredicate<T1, T2> extends LBiObjBytePredicateX<T1, T2, RuntimeException>, MetaPredicate, MetaInterface.NonThrowing { // NOSONAR
	...
	@Nonnull
	default <V> LBiObjByteFunction<T1, T2, V> boolToBiObjByteFunction(@Nonnull LBoolFunction<? extends V> after) {
	...
	@FunctionalInterface
	interface V1<T1, T2> extends LBiObjBytePredicate<T1, T2> {

		boolean doTestV1(T1 a1, byte a3, T2 a2);
	...
	/** Permutation of LBiObjBytePredicate for method references. */
	@FunctionalInterface
	interface V2<T2, T1> extends LBiObjBytePredicate<T1, T2> {

		boolean doTestV2(T2 a2, T1 a1, byte a3);
	...
	/** Permutation of LBiObjBytePredicate for method references. */
	@FunctionalInterface
	interface V3<T2, T1> extends LBiObjBytePredicate<T1, T2> {

		boolean doTestV3(T2 a2, byte a3, T1 a1);
	...
	/** Permutation of LBiObjBytePredicate for method references. */
	@FunctionalInterface
	interface V4<T1, T2> extends LBiObjBytePredicate<T1, T2> {

		boolean doTestV4(byte a3, T1 a1, T2 a2);
	...
	/** Permutation of LBiObjBytePredicate for method references. */
	@FunctionalInterface
	interface V5<T2, T1> extends LBiObjBytePredicate<T1, T2> {

		boolean doTestV5(byte a3, T2 a2, T1 a1);
