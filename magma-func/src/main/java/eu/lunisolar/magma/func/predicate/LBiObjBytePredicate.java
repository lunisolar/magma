...
public interface LBiObjBytePredicate<T1, T2> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<a<T1>, a<T2>, aByte> { // NOSONAR
	...
	public static <T1, T2> void throwIf(T1 a1, T2 a2, byte a3, @Nonnull LBiObjBytePredicate<T1, T2> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
	...
	/** Throws new exception if condition is met. */
	public static <T1, T2> void throwIf(T1 a1, @Nonnull LBiObjBytePredicate<T1, T2> pred, T2 a2, byte a3, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}
	...
	public static <T1, T2> void throwIfNot(T1 a1, T2 a2, byte a3, @Nonnull LBiObjBytePredicate<T1, T2> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}
	...
	/** Throws new exception if condition is not met. */
	public static <T1, T2> void throwIfNot(T1 a1, @Nonnull LBiObjBytePredicate<T1, T2> pred, T2 a2, byte a3, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}
	...
	public static <T1, T2> T1 complying(T1 a1, T2 a2, byte a3, @Nonnull LBiObjBytePredicate<T1, T2> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	public static <T1, T2> T1 notComplying(T1 a1, T2 a2, byte a3, @Nonnull LBiObjBytePredicate<T1, T2> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
