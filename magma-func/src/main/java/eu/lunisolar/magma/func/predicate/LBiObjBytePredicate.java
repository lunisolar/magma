...
public interface LBiObjBytePredicate<T1, T2> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<a<T1>, a<T2>, aByte> { // NOSONAR
	...
	default LObjBytePredicate<T2> lShrink(@Nonnull LObjByteFunction<T2, T1> left) {
		Null.nonNullArg(left, "left");
		return (a2, a3) -> test(left.apply(a2, a3), a2, a3);
	}

	default LObjBytePredicate<T2> lShrink_(T1 a1) {
	...
	default LBiPredicate<T1, T2> rShrink(@Nonnull LToByteBiFunction<T1, T2> right) {
		Null.nonNullArg(right, "right");
		return (a1, a2) -> test(a1, a2, right.applyAsByte(a1, a2));
	}

	default LBiPredicate<T1, T2> rShrink_(byte a3) {
	...
	default LBiObjBytePredicate untyped() {
		return this;
	}

	/** Cast that replace generics. */
	default <V2, V3> LBiObjBytePredicate<V2, V3> cast() {
		return untyped();
	}

	/** Cast that replace generics. */
	public static <V2, V3> LBiObjBytePredicate<V2, V3> cast(LBiObjBytePredicate<?, ?> function) {
	...
	public static <T1, T2> LBiObjBytePredicate<T1, T2> and(@Nonnull LBiObjBytePredicate<? super T1, ? super T2>... predicates) {
		...
		return (a1, a2, a3) -> {
			for (LBiObjBytePredicate<? super T1, ? super T2> p : predicates) {
				if (!p.test(a1, a2, a3)) {
					return false;
				}
			}
