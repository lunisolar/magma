...
public interface LBiObjBytePredicate<T1, T2> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<a<T1>, a<T2>, aByte> { // NOSONAR
	...
	static <T1, T2> void throwIf(T1 a1, T2 a2, byte a3, LBiObjBytePredicate<T1, T2> pred, ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		if (pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}

	static <T1, T2> void throwIfNot(T1 a1, T2 a2, byte a3, LBiObjBytePredicate<T1, T2> pred, ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
	}
	...
	/**  */
	public static <T1, T2> LBiObjBytePredicate<T1, T2> uncurry(LFunction<T1, LFunction<T2, LBytePredicate>> func) {
	...
	@Nonnull
	static <T1, T2> LBiObjBytePredicate<T1, T2> biObjBytePred(Class<T1> c1, Class<T2> c2, final @Nonnull LBiObjBytePredicate<T1, T2> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
