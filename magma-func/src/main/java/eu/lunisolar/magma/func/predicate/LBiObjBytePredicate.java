...
public interface LBiObjBytePredicate<T1, T2> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<a<T1>, a<T2>, aByte> { // NOSONAR
	...
	public static <T1, T2, X extends Throwable> T1 throwIf(T1 a1, T2 a2, byte a3, @Nonnull LBiObjBytePredicate<? super T1, ? super T2> pred, @Nonnull ExMF<X> factory, LBiObjByteFunction<? super T1, ? super T2, ? extends String> msgFunc) throws X {
	...
	/** Throws new exception if condition is met. */
	public static <T1, T2, X extends Throwable> T1 throwIfNot(T1 a1, T2 a2, byte a3, @Nonnull LBiObjBytePredicate<? super T1, ? super T2> pred, @Nonnull ExMF<X> factory, LBiObjByteFunction<? super T1, ? super T2, ? extends String> msgFunc) throws X {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, msgFunc.apply(a1, a2, a3), a1, a2, a3);
		}
		return a1;
	...
	/** Throws new exception if condition is met. */
	public static <T1, T2, X extends Throwable> T1 throwIf(T1 a1, @Nonnull LBiObjBytePredicate<? super T1, ? super T2> pred, T2 a2, byte a3, @Nonnull ExMF<X> factory, LBiObjByteFunction<? super T1, ? super T2, ? extends String> msgFunc) throws X {
		if (pred.test(a1, a2, a3)) {
			throw Handling.create(factory, msgFunc.apply(a1, a2, a3), a1, a2, a3);
		}
		return a1;
	...
	/** Throws new exception if condition is met. */
	public static <T1, T2, X extends Throwable> T1 throwIfNot(T1 a1, @Nonnull LBiObjBytePredicate<? super T1, ? super T2> pred, T2 a2, byte a3, @Nonnull ExMF<X> factory, LBiObjByteFunction<? super T1, ? super T2, ? extends String> msgFunc) throws X {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, msgFunc.apply(a1, a2, a3), a1, a2, a3);
		}
		return a1;
	...
	public static <T1, T2, X extends Throwable> T1 throwIfNot$(T1 a1, T2 a2, byte a3, LBiObjByteFunction<? super T1, ? super T2, ? extends String> specialPredicate, @Nonnull ExMF<X> factory) throws X {
	...
	/** Throws new exception if condition is met. String is used as a result of test. Non NULL String means condition is not met and Strings content is used for exception message. */
	public static <T1, T2, X extends Throwable> T1 throwIfNot$(T1 a1, LBiObjByteFunction<? super T1, ? super T2, ? extends String> specialPredicate, T2 a2, byte a3, @Nonnull ExMF<X> factory) throws X {
		var msg = specialPredicate.apply(a1, a2, a3);
		if (msg != null) {
			throw Handling.create(factory, msg);
		}
	...
	/** Throws new exception if condition is met. */
	public static <T1, T2, X extends Throwable> T1 throwIf(T1 a1, T2 a2, byte a3, @Nonnull LBiObjBytePredicate<? super T1, ? super T2> pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (pred.test(a1, a2, a3)) {
	...
	/** Throws new exception if condition is met. */
	public static <T1, T2, X extends Throwable> T1 throwIf(T1 a1, @Nonnull LBiObjBytePredicate<? super T1, ? super T2> pred, T2 a2, byte a3, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	public static <T1, T2, X extends Throwable> T1 throwIfNot(T1 a1, T2 a2, byte a3, @Nonnull LBiObjBytePredicate<? super T1, ? super T2> pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <T1, T2, X extends Throwable> T1 throwIfNot(T1 a1, @Nonnull LBiObjBytePredicate<? super T1, ? super T2> pred, T2 a2, byte a3, @Nonnull ExMF<X> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) throws X {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	/** Throws new exception if condition is met. */
	public static <T1, T2, X extends Throwable> T1 throwIf(T1 a1, T2 a2, byte a3, @Nonnull LBiObjBytePredicate<? super T1, ? super T2> pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (pred.test(a1, a2, a3)) {
	...
	/** Throws new exception if condition is met. */
	public static <T1, T2, X extends Throwable> T1 throwIf(T1 a1, @Nonnull LBiObjBytePredicate<? super T1, ? super T2> pred, T2 a2, byte a3, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <T1, T2, X extends Throwable> T1 throwIfNot(T1 a1, T2 a2, byte a3, @Nonnull LBiObjBytePredicate<? super T1, ? super T2> pred, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <T1, T2, X extends Throwable> T1 throwIfNot(T1 a1, @Nonnull LBiObjBytePredicate<? super T1, ? super T2> pred, T2 a2, byte a3, @Nonnull ExMF<X> factory, @Nonnull String newMessage) throws X {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
