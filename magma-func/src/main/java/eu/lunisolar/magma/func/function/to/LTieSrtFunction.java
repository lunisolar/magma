...
public interface LTieSrtFunction<T> extends MetaFunction, MetaInterface.NonThrowing, TieFunction<T, aShort> { // NOSONAR

	String DESCRIPTION = "LTieSrtFunction: int doApplyAsInt(T a1,int a2,short a3)";

	// int doApplyAsInt(T a1,int a2,short a3) ;
	default int doApplyAsInt(T a1, int a2, short a3) {
	...
	/**
	 * Implement this, but call doApplyAsInt(T a1,int a2,short a3)
	 */
	int doApplyAsIntX(T a1, int a2, short a3) throws Throwable;
	...
	default int handlingDoApplyAsInt(T a1, int a2, short a3, HandlingInstructions<Throwable, RuntimeException> handling) {
		try {
			return this.doApplyAsIntX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default int tryDoApplyAsInt(T a1, int a2, short a3, @Nonnull ExceptionWrapWithMessageFactory<RuntimeException> exceptionFactory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		try {
			return this.doApplyAsIntX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default int tryDoApplyAsInt(T a1, int a2, short a3, @Nonnull ExceptionWrapFactory<RuntimeException> exceptionFactory) {
		try {
			return this.doApplyAsIntX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default int tryDoApplyAsIntThen(T a1, int a2, short a3, @Nonnull LToIntFunction<Throwable> handler) {
		try {
			return this.doApplyAsIntX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default int nestingDoApplyAsInt(T a1, int a2, short a3) {
		try {
			return this.doApplyAsIntX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
			throw Handling.nestCheckedAndThrow(e);
	...
	default int shovingDoApplyAsInt(T a1, int a2, short a3) {
		try {
			return this.doApplyAsIntX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	static <T> int handlingDoApplyAsInt(T a1, int a2, short a3, LTieSrtFunction<T> func, HandlingInstructions<Throwable, RuntimeException> handling) { // <-
		Null.nonNullArg(func, "func");
		return func.handlingDoApplyAsInt(a1, a2, a3, handling);
	}

	static <T> int tryDoApplyAsInt(T a1, int a2, short a3, LTieSrtFunction<T> func) {
		return tryDoApplyAsInt(a1, a2, a3, func, null);
	}

	static <T> int tryDoApplyAsInt(T a1, int a2, short a3, LTieSrtFunction<T> func, @Nonnull ExceptionWrapWithMessageFactory<RuntimeException> exceptionFactory, @Nonnull String newMessage, @Nullable Object... messageParams) {
		Null.nonNullArg(func, "func");
		return func.tryDoApplyAsInt(a1, a2, a3, exceptionFactory, newMessage, messageParams);
	}

	static <T> int tryDoApplyAsInt(T a1, int a2, short a3, LTieSrtFunction<T> func, @Nonnull ExceptionWrapFactory<RuntimeException> exceptionFactory) {
		Null.nonNullArg(func, "func");
		return func.tryDoApplyAsInt(a1, a2, a3, exceptionFactory);
	}

	static <T> int tryDoApplyAsIntThen(T a1, int a2, short a3, LTieSrtFunction<T> func, @Nonnull LToIntFunction<Throwable> handler) {
		Null.nonNullArg(func, "func");
		return func.tryDoApplyAsIntThen(a1, a2, a3, handler);
	}

	default int failSafeDoApplyAsInt(T a1, int a2, short a3, @Nonnull LTieSrtFunction<T> failSafe) {
		try {
	...
	static <T> int failSafeDoApplyAsInt(T a1, int a2, short a3, LTieSrtFunction<T> func, @Nonnull LTieSrtFunction<T> failSafe) {
	...
	static <T> LTieSrtFunction<T> failSafeTieSrtFunc(LTieSrtFunction<T> func, @Nonnull LTieSrtFunction<T> failSafe) {
		Null.nonNullArg(failSafe, "failSafe");
		return (a1, a2, a3) -> failSafeDoApplyAsInt(a1, a2, a3, func, failSafe);
	}

	/** Just to mirror the method: Ensures the result is not null */
	default int nonNullDoApplyAsInt(T a1, int a2, short a3) {
		return doApplyAsInt(a1, a2, a3);
	}
	...
	public static <T> void fromTo(int min_a2, int max_a2, T a1, short a3, LTieSrtFunction<T> func) {
		Null.nonNullArg(func, "func");
		if (min_a2 <= min_a2) {
	...
	/** From-To. Intended to be used with non-capturing lambda. */
	public static <T> void fromTill(int min_a2, int max_a2, T a1, short a3, LTieSrtFunction<T> func) {
		Null.nonNullArg(func, "func");
		if (min_a2 <= min_a2) {
			for (int a2 = min_a2; a2 < max_a2; a2++) {
				func.doApplyAsInt(a1, a2, a3);
	...
	/** From-To. Intended to be used with non-capturing lambda. */
	public static <T> void times(int max_a2, T a1, short a3, LTieSrtFunction<T> func) {
		fromTill(0, max_a2, a1, a3, func);
	}

	/**  */
	public static <T> LTieSrtFunction<T> uncurryTieSrtFunc(LFunction<T, LIntFunction<LSrtToIntFunction>> func) {
		return (T a1, int a2, short a3) -> func.doApply(a1).doApply(a2).doApplyAsInt(a3);
	}

	/** Captures arguments but delays the evaluation. */
	default LIntSupplier captureTieSrtFunc(T a1, int a2, short a3) {
	...
	static <T> LTieSrtFunction<T> recursive(final @Nonnull LFunction<LTieSrtFunction<T>, LTieSrtFunction<T>> selfLambda) {
		...
		LTieSrtFunction<T> func = selfLambda.doApply(single);
		single.target = func;
		return func;
	}

	final class LTieSrtFunctionSingle<T> implements LSingle<LTieSrtFunction<T>>, LTieSrtFunction<T> {
		private LTieSrtFunction<T> target = null;

		@Override
		public int doApplyAsIntX(T a1, int a2, short a3) throws Throwable {
			return target.doApplyAsIntX(a1, a2, a3);
		}

		@Override
		public LTieSrtFunction<T> value() {
			return target;
		}
	}

	@Nonnull
	static <T> LTieSrtFunction<T> tieSrtFuncThrowing(final @Nonnull ExceptionFactory<Throwable> exceptionFactory) {
	...
	@Nonnull
	static <T> LTieSrtFunction<T> tieSrtFuncThrowing(final String message, final @Nonnull ExceptionWithMessageFactory<Throwable> exceptionFactory) {
		Null.nonNullArg(exceptionFactory, "exceptionFactory");
		return (a1, a2, a3) -> {
	...
	static <T> LTieSrtFunction<T> safe() {
		return LTieSrtFunction::produceInt;
	}
	...
	@Nonnull
	default <V1> LTieSrtFunction<V1> tieSrtFuncComposeIntSrt(@Nonnull final LFunction<? super V1, ? extends T> before1, @Nonnull final LIntUnaryOperator before2, @Nonnull final LSrtUnaryOperator before3) {
		Null.nonNullArg(before1, "before1");
		Null.nonNullArg(before2, "before2");
		Null.nonNullArg(before3, "before3");
		return (v1, v2, v3) -> this.doApplyAsInt(before1.doApply(v1), before2.doApplyAsInt(v2), before3.doApplyAsSrt(v3));
	}

	public static <V1, T> LTieSrtFunction<V1> composedIntSrt(@Nonnull final LFunction<? super V1, ? extends T> before1, @Nonnull final LIntUnaryOperator before2, @Nonnull final LSrtUnaryOperator before3, LTieSrtFunction<T> after) {
		return after.tieSrtFuncComposeIntSrt(before1, before2, before3);
	}
	...
	@Nonnull
	default LTieSrtFunction<T> nestingTieSrtFunc() {
		return this;
	}

	/** Converts to non-throwing variant that will propagate checked exception as it would be unchecked - there is no exception wrapping involved (at least not here). */
	default LTieSrtFunction<T> shovingTieSrtFunc() {
		return this;
	}
	...
	interface LObjSrtIntToIntFunc<T> extends LTieSrtFunction<T> {
		...
		int doApplyAsIntObjSrtInt(T a1, short a3, int a2);

		@Override
		default int doApplyAsIntX(T a1, int a2, short a3) {
			return this.doApplyAsIntObjSrtInt(a1, a3, a2);
		}
	}
	...
	interface LIntObjSrtToIntFunc<T> extends LTieSrtFunction<T> {
		...
		int doApplyAsIntIntObjSrt(int a2, T a1, short a3);

		@Override
		default int doApplyAsIntX(T a1, int a2, short a3) {
			return this.doApplyAsIntIntObjSrt(a2, a1, a3);
		}
	}
	...
	interface LIntSrtObjToIntFunc<T> extends LTieSrtFunction<T> {
		...
		int doApplyAsIntIntSrtObj(int a2, short a3, T a1);

		@Override
		default int doApplyAsIntX(T a1, int a2, short a3) {
			return this.doApplyAsIntIntSrtObj(a2, a3, a1);
		}
	}
	...
	interface LSrtObjIntToIntFunc<T> extends LTieSrtFunction<T> {
		...
		int doApplyAsIntSrtObjInt(short a3, T a1, int a2);

		@Override
		default int doApplyAsIntX(T a1, int a2, short a3) {
			return this.doApplyAsIntSrtObjInt(a3, a1, a2);
		}
	}
	...
	interface LSrtIntObjToIntFunc<T> extends LTieSrtFunction<T> {
		...
		int doApplyAsIntSrtIntObj(short a3, int a2, T a1);

		@Override
		default int doApplyAsIntX(T a1, int a2, short a3) {
			return this.doApplyAsIntSrtIntObj(a3, a2, a1);
		}
	}
	...
	public static <T> int produceInt(T a1, int a2, short a3) {
		return Function4U.defaultInteger;
	}

	/** Does nothing (LTieSrtFunction.LObjSrtIntToIntFunc) Function */
	public static <T> int produceInt(T a1, short a3, int a2) {
		return Function4U.defaultInteger;
	}

	/** Does nothing (LTieSrtFunction.LIntObjSrtToIntFunc) Function */
	public static <T> int produceInt(int a2, T a1, short a3) {
		return Function4U.defaultInteger;
	}

	/** Does nothing (LTieSrtFunction.LIntSrtObjToIntFunc) Function */
	public static <T> int produceInt(int a2, short a3, T a1) {
		return Function4U.defaultInteger;
	}

	/** Does nothing (LTieSrtFunction.LSrtObjIntToIntFunc) Function */
	public static <T> int produceInt(short a3, T a1, int a2) {
		return Function4U.defaultInteger;
	}

	/** Does nothing (LTieSrtFunction.LSrtIntObjToIntFunc) Function */
	public static <T> int produceInt(short a3, int a2, T a1) {
		return Function4U.defaultInteger;
	}
	...
	// TARGETED_INDEXED_FOR_EACH: FOR, [SourcePurpose{arg=T trg1, type=CONST}, SourcePurpose{arg=short a3, type=IA}, SourcePurpose{arg=LTieSrtFunction<? super
	...
	// SourcePurpose{arg=LTieSrtFunction<? super T> consumer, type=CONST}]
	...
	// TIE_CONSUMER_SHORT: FOR, [SourcePurpose{arg=T trg1, type=CONST}, SourcePurpose{arg=short a3, type=IA}, SourcePurpose{arg=LTieSrtFunction<? super T>
	// consumer, type=CONST}]
	...
	// TIE_CONSUMER2_SHORT: WHILE, [SourcePurpose{arg=T trg1, type=CONST}, SourcePurpose{arg=short a3, type=SA}, SourcePurpose{arg=LTieSrtFunction<? super T>
	// consumer, type=CONST}]
	...
	// TARGETED_INDEXED_ITERATE: WHILE, [SourcePurpose{arg=T trg1, type=CONST}, SourcePurpose{arg=short a3, type=SA}, SourcePurpose{arg=LTieSrtFunction<? super
	// T> consumer, type=CONST}]
	...
	// TARGETED_INDEXED_ITERATE_NEW: WHILE, [SourcePurpose{arg=T trg1, type=SUPPLIER}, SourcePurpose{arg=short a3, type=SA}, SourcePurpose{arg=LTieSrtFunction<?
	...
	// MAP: FOR, [SourcePurpose{arg=T a1, type=IA}, SourcePurpose{arg=int a2, type=IA}, SourcePurpose{arg=short a3, type=IA}, SourcePurpose{arg=LIntConsumer
	// consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T a1, type=SA}, SourcePurpose{arg=int a2, type=IA}, SourcePurpose{arg=short a3, type=IA}, SourcePurpose{arg=LIntConsumer
	// consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T a1, type=IA}, SourcePurpose{arg=int a2, type=SA}, SourcePurpose{arg=short a3, type=IA}, SourcePurpose{arg=LIntConsumer
	// consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T a1, type=SA}, SourcePurpose{arg=int a2, type=SA}, SourcePurpose{arg=short a3, type=IA}, SourcePurpose{arg=LIntConsumer
	// consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T a1, type=IA}, SourcePurpose{arg=int a2, type=IA}, SourcePurpose{arg=short a3, type=SA}, SourcePurpose{arg=LIntConsumer
	// consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T a1, type=SA}, SourcePurpose{arg=int a2, type=IA}, SourcePurpose{arg=short a3, type=SA}, SourcePurpose{arg=LIntConsumer
	// consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T a1, type=IA}, SourcePurpose{arg=int a2, type=SA}, SourcePurpose{arg=short a3, type=SA}, SourcePurpose{arg=LIntConsumer
	// consumer, type=CONST}]
	...
	// MAP: WHILE, [SourcePurpose{arg=T a1, type=SA}, SourcePurpose{arg=int a2, type=SA}, SourcePurpose{arg=short a3, type=SA}, SourcePurpose{arg=LIntConsumer
	// consumer, type=CONST}]
