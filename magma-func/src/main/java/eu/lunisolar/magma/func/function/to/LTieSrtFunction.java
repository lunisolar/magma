...
public interface LTieSrtFunction<T> extends MetaFunction, MetaInterface.NonThrowing, TieFunction<T, aShort>, Codomain<aInt>, Domain3<a<T>, aInt, aShort> { // NOSONAR
	...
	default int applyAsInt(T a1, int a2, short a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		try {
			return this.applyAsIntX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default int applyAsInt(T a1, int a2, short a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		try {
			return this.applyAsIntX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default int applyAsInt(T a1, int a2, short a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		try {
			return this.applyAsIntX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default int applyAsInt(T a1, int a2, short a3, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		try {
			return this.applyAsIntX(a1, a2, a3);
		} catch (Throwable e) { // NOSONAR
	...
	default LTieSrtFunction<T> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		return (a1, a2, a3) -> applyAsInt(a1, a2, a3, exF, newMessage);
	}

	default LTieSrtFunction<T> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		return (a1, a2, a3) -> applyAsInt(a1, a2, a3, exF, newMessage, param1);
	}

	default LTieSrtFunction<T> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		return (a1, a2, a3) -> applyAsInt(a1, a2, a3, exF, newMessage, param1, param1);
	}

	default LTieSrtFunction<T> trying(@Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
	...
	static <T> int tryApplyAsInt(T a1, int a2, short a3, LTieSrtFunction<T> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage) {
		Null.nonNullArg(func, "func");
		return func.applyAsInt(a1, a2, a3, exF, newMessage);
	}

	static <T> int tryApplyAsInt(T a1, int a2, short a3, LTieSrtFunction<T> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1) {
		Null.nonNullArg(func, "func");
		return func.applyAsInt(a1, a2, a3, exF, newMessage, param1);
	}

	static <T> int tryApplyAsInt(T a1, int a2, short a3, LTieSrtFunction<T> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2) {
		Null.nonNullArg(func, "func");
		return func.applyAsInt(a1, a2, a3, exF, newMessage, param1, param2);
	}

	static <T> int tryApplyAsInt(T a1, int a2, short a3, LTieSrtFunction<T> func, @Nonnull ExWMF<RuntimeException> exF, @Nonnull String newMessage, @Nullable Object param1, @Nullable Object param2, @Nullable Object param3) {
		Null.nonNullArg(func, "func");
	...
	default LOiToIntFunction<T> rShrink(@Nonnull LOiToSrtFunction<T> right) {
		Null.nonNullArg(right, "right");
		return (a1, a2) -> applyAsInt(a1, a2, right.applyAsSrt(a1, a2));
	}

	default LOiToIntFunction<T> rShrink_(short a3) {
	 ...
	 */
	public static <T> M<T> memento(int initialValue, LTieSrtFunction<T> baseFunction, LIntBinaryOperator mementoFunction) {
		return new M(initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not ). Very short name is intended to be used with parent (LTieSrtFunction.D)
	 */
	final class M<T> implements LTieSrtFunction<T> {
		...
		private M(int lastValue, LTieSrtFunction<T> baseFunction, LIntBinaryOperator mementoFunction) {
