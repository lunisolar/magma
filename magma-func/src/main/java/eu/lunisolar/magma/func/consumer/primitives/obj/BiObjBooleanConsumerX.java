...
/**
 * A consumer.
 * @see {@link eu.lunisolar.magma.func.consumer.primitives.obj.BiObjBooleanConsumer}
 */
@FunctionalInterface
@SuppressWarnings("UnusedDeclaration")
public interface BiObjBooleanConsumerX<T1, T2, X extends Exception> extends MetaConsumer, MetaThrowingInterface<X> {
	...
	@Nonnull
	public static <T1, T2, X extends Exception, Y extends Exception> BiObjBooleanConsumerX<T1, T2, Y> wrapException(@Nonnull final BiObjBooleanConsumerX<T1, T2, X> other, Class<? extends Exception> exception, ExceptionHandler<Exception, Y> rethrower) {
	...
	@Nonnull
	default <Y extends Exception> BiObjBooleanConsumerX<T1, T2, Y> handle(Class<? extends Exception> exception, ExceptionHandler<? super X, Y> handler) {
	...
	/** Wraps with exception handling that for argument exception class will call function to determine the final exception. */
	@Nonnull
	default <Y extends Exception> BiObjBooleanConsumerX<T1, T2, Y> handle(ExceptionHandler<? super X, Y> handler) {
		Objects.requireNonNull(handler, Function4U.VALIDATION_MESSAGE_HANDLER);
