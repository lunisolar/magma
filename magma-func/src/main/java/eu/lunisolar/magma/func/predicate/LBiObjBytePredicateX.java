...
public interface LBiObjBytePredicateX<T1, T2, X extends Throwable> extends MetaPredicate, PrimitiveCodomain<Object>, MetaInterface.Throwing<X> { // NOSONAR
	...
	public static <T1, T2, X extends Throwable> LBiObjBytePredicateX<T1, T2, X> constant(boolean r) {
		return (t1, t2, b) -> r;
	}

	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	public static <T1, T2, X extends Throwable> LBiObjBytePredicateX<T1, T2, X> lX(final @Nonnull LBiObjBytePredicateX<T1, T2, X> lambda) {
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	public static <T1, T2, X extends Throwable> LBiObjBytePredicateX<T1, T2, X> lX(@Nonnull Class<X> xClass, final @Nonnull LBiObjBytePredicateX<T1, T2, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	@Nonnull
	public static <T1, T2, X extends Throwable> LBiObjBytePredicateX<T1, T2, X> wrapX(final @Nonnull LBiObjBytePredicate<T1, T2> other) {
	 ...
	 */
	@Nonnull
	public static <T1, T2, X extends Throwable> LBiObjBytePredicateX<T1, T2, X> isEqual(final T1 v1, final T2 v2, final byte v3) {
