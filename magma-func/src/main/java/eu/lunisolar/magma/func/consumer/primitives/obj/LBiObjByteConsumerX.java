...
public interface LBiObjByteConsumerX<T1, T2, X extends Throwable> extends MetaConsumer, MetaInterface.Throwing<X> {
	...
	/** Combines two LBiObjByteConsumerX<T1,T2,X> together in a order. */
	@Nonnull
	...
	interface V1<T1, T2, X extends Throwable> extends LBiObjByteConsumerX<T1, T2, X> {
		...
		void doAcceptV1(T1 a1, byte a3, T2 a2) throws X;
	...
	/** Permutation of LBiObjByteConsumerX for method references. */
	@FunctionalInterface
	interface V2<T2, T1, X extends Throwable> extends LBiObjByteConsumerX<T1, T2, X> {

		void doAcceptV2(T2 a2, T1 a1, byte a3) throws X;
	...
	/** Permutation of LBiObjByteConsumerX for method references. */
	@FunctionalInterface
	interface V3<T2, T1, X extends Throwable> extends LBiObjByteConsumerX<T1, T2, X> {

		void doAcceptV3(T2 a2, byte a3, T1 a1) throws X;
	...
	interface V4<T1, T2, X extends Throwable> extends LBiObjByteConsumerX<T1, T2, X> {
		...
		void doAcceptV4(byte a3, T1 a1, T2 a2) throws X;
	...
	/** Permutation of LBiObjByteConsumerX for method references. */
	@FunctionalInterface
	interface V5<T2, T1, X extends Throwable> extends LBiObjByteConsumerX<T1, T2, X> {

		void doAcceptV5(byte a3, T2 a2, T1 a1) throws X;
