...
public interface LBiObjByteConsumerX<T1, T2, X extends Throwable> extends MetaConsumer, MetaInterface.Throwing<X> {
	...
	public static final String DESCRIPTION = "LBiObjByteConsumerX: void doAccept(T1 t1,T2 t2, byte b) throws X";

	public void doAccept(T1 t1, T2 t2, byte b) throws X;
	...
	@Nonnull
	public static <T1, T2, X extends Throwable> LBiObjByteConsumerX<T1, T2, X> lX(final @Nonnull LBiObjByteConsumerX<T1, T2, X> lambda) {
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	public static <T1, T2, X extends Throwable> LBiObjByteConsumerX<T1, T2, X> lX(@Nonnull Class<X> xClass, final @Nonnull LBiObjByteConsumerX<T1, T2, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	@Nonnull
	public static <T1, T2, X extends Throwable> LBiObjByteConsumerX<T1, T2, X> wrapX(final @Nonnull LBiObjByteConsumer<T1, T2> other) {
