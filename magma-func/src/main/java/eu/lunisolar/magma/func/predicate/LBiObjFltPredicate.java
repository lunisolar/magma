...
public interface LBiObjFltPredicate<T1, T2> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<a<T1>, a<T2>, aFloat> { // NOSONAR
	...
	public static <M, K, V, T2> boolean from(M container, LBiFunction<M, K, V> extractor, K key, T2 a2, float a3, LBiObjFltPredicate<V, T2> function) {
	...
	/**  */
	public static <T1, T2> LBiObjFltPredicate<T1, T2> uncurry(LFunction<T1, LFunction<T2, LFltPredicate>> func) {
