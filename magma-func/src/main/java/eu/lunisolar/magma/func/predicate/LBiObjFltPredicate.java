...
public interface LBiObjFltPredicate<T1, T2> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<a<T1>, a<T2>, aFloat> { // NOSONAR
	...
	public default LObjFltPredicate<T2> lShrink(@Nonnull LObjFltFunction<T2, T1> left) {
		Null.nonNullArg(left, "left");
		return (a2, a3) -> test(left.apply(a2, a3), a2, a3);
	}

	public default LObjFltPredicate<T2> lShrink_(T1 a1) {
	...
	public default LBiPredicate<T1, T2> rShrink(@Nonnull LToFltBiFunction<T1, T2> right) {
		Null.nonNullArg(right, "right");
		return (a1, a2) -> test(a1, a2, right.applyAsFlt(a1, a2));
	}

	public default LBiPredicate<T1, T2> rShrink_(float a3) {
	...
	public default LBiObjFltPredicate untyped() {
		return this;
	}

	/** Cast that replace generics. */
	public default <V2, V3> LBiObjFltPredicate<V2, V3> cast() {
		return untyped();
	}
	...
	public default LBiObjFltConsumer<T1, T2> toConsumer() {
		return this::test;
	}

	/** Calls domain consumer before main function. */
	public default LBiObjFltPredicate<T1, T2> beforeDo(@Nonnull LBiObjFltConsumer<T1, T2> before) {
	...
	public default LBiObjFltPredicate<T1, T2> afterDo(@Nonnull LBoolConsumer after) {
	...
	public static <T1, T2> T1 throwIf(T1 a1, T2 a2, float a3, @Nonnull LBiObjFltPredicate<T1, T2> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
	...
	/** Throws new exception if condition is met. */
	public static <T1, T2> T1 throwIf(T1 a1, @Nonnull LBiObjFltPredicate<T1, T2> pred, T2 a2, float a3, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	public static <T1, T2> T1 throwIfNot(T1 a1, T2 a2, float a3, @Nonnull LBiObjFltPredicate<T1, T2> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <T1, T2> T1 throwIfNot(T1 a1, @Nonnull LBiObjFltPredicate<T1, T2> pred, T2 a2, float a3, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage, @Nonnull Object... messageParams) {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage, messageParams);
		}
		return a1;
	...
	/** Throws new exception if condition is met. */
	public static <T1, T2> T1 throwIf(T1 a1, T2 a2, float a3, @Nonnull LBiObjFltPredicate<T1, T2> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage) {
		if (pred.test(a1, a2, a3)) {
	...
	/** Throws new exception if condition is met. */
	public static <T1, T2> T1 throwIf(T1 a1, @Nonnull LBiObjFltPredicate<T1, T2> pred, T2 a2, float a3, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage) {
		if (pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <T1, T2> T1 throwIfNot(T1 a1, T2 a2, float a3, @Nonnull LBiObjFltPredicate<T1, T2> pred, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage) {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
	...
	/** Throws new exception if condition is not met. */
	public static <T1, T2> T1 throwIfNot(T1 a1, @Nonnull LBiObjFltPredicate<T1, T2> pred, T2 a2, float a3, @Nonnull ExMF<RuntimeException> factory, @Nonnull String newMessage) {
		if (!pred.test(a1, a2, a3)) {
			throw Handling.create(factory, newMessage);
		}
		return a1;
	...
	*/
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2> LObj0Flt2Obj1Pred<T1, T2> obj0Flt2Obj1Pred(final @Nonnull LObj0Flt2Obj1Pred<T1, T2> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1> LObj1Obj0Flt2Pred<T2, T1> obj1Obj0Flt2Pred(final @Nonnull LObj1Obj0Flt2Pred<T2, T1> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1> LObj1Flt2Obj0Pred<T2, T1> obj1Flt2Obj0Pred(final @Nonnull LObj1Flt2Obj0Pred<T2, T1> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2> LFlt2Obj0Obj1Pred<T1, T2> flt2Obj0Obj1Pred(final @Nonnull LFlt2Obj0Obj1Pred<T1, T2> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T2, T1> LFlt2Obj1Obj0Pred<T2, T1> flt2Obj1Obj0Pred(final @Nonnull LFlt2Obj1Obj0Pred<T2, T1> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
