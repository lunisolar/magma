...
public interface LBiObjFltPredicate<T1, T2> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<a<T1>, a<T2>, aFloat> { // NOSONAR
	...
	default LObjFltPredicate<T2> _with(T1 a1) {
		return (a2, a3) -> test(a1, a2, a3);
	}

	default LBiPredicate<T1, T2> with(float a3) {
		return (a1, a2) -> test(a1, a2, a3);
	}

	default LFltPredicate _with(T1 a1, T2 a2) {
		return a3 -> test(a1, a2, a3);
	}

	default LPredicate<T1> with(T2 a2, float a3) {
	...
	final class M<T1, T2> implements LBiObjFltPredicate<T1, T2> {
		...
		public boolean currentTest(T1 a1, T2 a2, float a3) {
			boolean x1 = lastBaseValue;
		...
		public boolean currentBaseValue(T1 a1, T2 a2, float a3) {
	...
	public static <T1, T2> boolean any(boolean expected, T1 a1, T2 a2, float a3, @Nonnull Collection<? extends LBiObjFltPredicate<? super T1, ? super T2>> predicates) {
		return any(expected, a1, a2, a3, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static <T1, T2> boolean any(boolean expected, T1 a1, T2 a2, float a3, @Nonnull Stream<? extends LBiObjFltPredicate<? super T1, ? super T2>> predicates) {
		return any(expected, a1, a2, a3, Null.nonNullArg(predicates, "predicates").iterator());
	}

	public static <T1, T2> boolean any(boolean expected, T1 a1, T2 a2, float a3, @Nonnull Iterator<? extends LBiObjFltPredicate<? super T1, ? super T2>> predicates) {
		Null.nonNullArg(predicates, "predicates");
	...
	public static <T1, T2> boolean any(boolean expected, T1 a1, T2 a2, float a3, @Nonnull LBiObjFltPredicate<? super T1, ? super T2>... predicates) {
		Null.nonNullArg(predicates, "predicates");
	...
	default LBiObjFltPredicate<T1, T2> shoving() {

		return new LBiObjFltPredicate<T1, T2>() {

			public boolean test(T1 a1, T2 a2, float a3) {
				try {
					return this.testX(a1, a2, a3);
				} catch (Throwable e) { // NOSONAR
					Handling.handleErrors(e);
			...
			public boolean testX(T1 a1, T2 a2, float a3) throws Throwable {
				return LBiObjFltPredicate.this.testX(a1, a2, a3);
			}
