...
public interface LBiObjFltPredicate<T1, T2> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<a<T1>, a<T2>, aFloat> { // NOSONAR
	 ...
	 */
	public static <T1, T2> M<T1, T2> memento(boolean initialValue, LBiObjFltPredicate<T1, T2> baseFunction, LLogicalBinaryOperator mementoFunction) {
		return new M(initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not ). Very short name is intended to be used with parent (LBiObjFltPredicate.D)
	 */
	final class M<T1, T2> implements LBiObjFltPredicate<T1, T2> {
		...
		private M(boolean lastValue, LBiObjFltPredicate<T1, T2> baseFunction, LLogicalBinaryOperator mementoFunction) {
