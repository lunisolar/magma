...
public interface LBiObjFltPredicate<T1, T2> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<a<T1>, a<T2>, aFloat> { // NOSONAR
	...
	public default LBiObjFltPredicate<T1, T2> before(@Nonnull LBiObjFltConsumer<T1, T2> before) {
	...
	public default LBiObjFltPredicate<T1, T2> after(@Nonnull LBoolConsumer after) {
