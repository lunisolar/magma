...
public interface LBiLongPredicate extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain2<aLong, aLong> { // NOSONAR
	 ...
	 */
	public static M memento(boolean initialValue, LBiLongPredicate baseFunction, LLogicalBinaryOperator mementoFunction) {
		return new M(initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not ). Very short name is intended to be used with parent (LBiLongPredicate.D)
	 */
	final class M implements LBiLongPredicate {
		...
		private M(boolean lastValue, LBiLongPredicate baseFunction, LLogicalBinaryOperator mementoFunction) {
