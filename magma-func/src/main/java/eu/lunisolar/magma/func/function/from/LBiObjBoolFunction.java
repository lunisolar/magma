...
public interface LBiObjBoolFunction<T1, T2, R> extends LBiObjBoolFunctionX<T1, T2, R, RuntimeException>, MetaFunction, MetaInterface.NonThrowing { // NOSONAR
	...
	@Nonnull
	default <V1, V2> LBiObjBoolFunction<V1, V2, R> biObjBoolFuncComposeBoolean(@Nonnull final LFunction<? super V1, ? extends T1> before1, @Nonnull final LFunction<? super V2, ? extends T2> before2, @Nonnull final LLogicalOperator before3) {
	...
	interface V1<T1, T2, R> extends LBiObjBoolFunction<T1, T2, R> {
		@Nullable
		R apply1(T1 a1, boolean a3, T2 a2);
	...
	/** Permutation of LBiObjBoolFunction for method references. */
	@FunctionalInterface
	interface V2<T1, T2, R> extends LBiObjBoolFunction<T1, T2, R> {
		@Nullable
		R apply2(T2 a2, T1 a1, boolean a3);
	...
	/** Permutation of LBiObjBoolFunction for method references. */
	@FunctionalInterface
	interface V3<T1, T2, R> extends LBiObjBoolFunction<T1, T2, R> {
		@Nullable
		R apply3(T2 a2, boolean a3, T1 a1);
	...
	interface V4<T1, T2, R> extends LBiObjBoolFunction<T1, T2, R> {
		@Nullable
		R apply4(boolean a3, T1 a1, T2 a2);
	...
	/** Permutation of LBiObjBoolFunction for method references. */
	@FunctionalInterface
	interface V5<T1, T2, R> extends LBiObjBoolFunction<T1, T2, R> {
		@Nullable
		R apply5(boolean a3, T2 a2, T1 a1);
