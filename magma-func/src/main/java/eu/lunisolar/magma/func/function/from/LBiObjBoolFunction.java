...
public interface LBiObjBoolFunction<T1, T2, R> extends MetaFunction, MetaInterface.NonThrowing, Codomain<a<R>>, Domain3<a<T1>, a<T2>, aBool> { // NOSONAR
	...
	default LObjBoolFunction<T2, R> _with(T1 a1) {
		return (a2, a3) -> apply(a1, a2, a3);
	}

	default LBiFunction<T1, T2, R> with(boolean a3) {
		return (a1, a2) -> apply(a1, a2, a3);
	}

	default LBoolFunction<R> _with(T1 a1, T2 a2) {
		return a3 -> apply(a1, a2, a3);
	}

	default LFunction<T1, R> with(T2 a2, boolean a3) {
	...
	final class M<T1, T2, R> implements LBiObjBoolFunction<T1, T2, R> {
		...
		public R currentApply(T1 a1, T2 a2, boolean a3) {
			R x1 = lastBaseValue;
		...
		public R currentBaseValue(T1 a1, T2 a2, boolean a3) {
	...
	/** Allows to manipulate the domain of the function. */
	@Nonnull
	default <V1, V2, V3> LTriFunction<V1, V2, V3, R> unboxingCompose(@Nonnull final LFunction<? super V1, ? extends T1> before1, @Nonnull final LFunction<? super V2, ? extends T2> before2, @Nonnull final LPredicate<? super V3> before3) {
		Null.nonNullArg(before1, "before1");
		Null.nonNullArg(before2, "before2");
		Null.nonNullArg(before3, "before3");
	...
	default LBiObjBoolFunction<T1, T2, R> shoving() {

		return new LBiObjBoolFunction<T1, T2, R>() {
			...
			public R applyX(T1 a1, T2 a2, boolean a3) throws Throwable {
				return LBiObjBoolFunction.this.applyX(a1, a2, a3);
			}
