...
public interface LLongToDoubleFunctionX<X extends Throwable> extends LongToDoubleFunction, MetaFunction, MetaInterface.Throwing<X> { // NOSONAR
	...
	String DESCRIPTION = "LLongToDoubleFunctionX: double doApplyAsDouble(long a) throws X";
	...
	double doApplyAsDouble(long a) throws X;
	...
	default double shovingDoApplyAsDouble(long a) {
		return ((LLongToDoubleFunctionX<RuntimeException>) this).doApplyAsDouble(a);
	}

	/** Function call that handles exceptions according to the instructions. */
	default <Y extends Throwable> double handlingDoApplyAsDouble(long a, HandlingInstructions<Throwable, Y> handling) throws Y {
	...
	default double nonNullDoApplyAsDouble(long a) throws X {
	...
	default LDoubleSupplierX<X> captureLongToDoubleFunc(long a) {
		return () -> this.doApplyAsDouble(a);
	}
	...
	static <X extends Throwable> double call(long a, final @Nonnull LLongToDoubleFunctionX<X> lambda) throws X {
		Null.nonNullArg(lambda, "lambda");
		return lambda.doApplyAsDouble(a);
	}

	static <X extends Throwable> double shoving(long a, final @Nonnull LLongToDoubleFunctionX<X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.shovingDoApplyAsDouble(a);
	}

	static <X extends Throwable> double nesting(long a, final @Nonnull LLongToDoubleFunctionX<X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda.nestingDoApplyAsDouble(a);
	}

	static <X extends Throwable, Y extends Throwable> double handling(long a, final HandlingInstructions<Throwable, Y> handling, final @Nonnull LLongToDoubleFunctionX<X> lambda) throws Y {
		Null.nonNullArg(lambda, "lambda");
	...
	@Nonnull
	default LLongToDoubleFunctionX<X> longToDoubleFuncComposeLong(@Nonnull final LLongUnaryOperatorX<X> before) {
	...
	/** Allows to manipulate the domain of the function. */
	@Nonnull
	default <V> LToDoubleFunctionX<V, X> longToDoubleFuncCompose(@Nonnull final LToLongFunctionX<? super V, X> before) {
		Null.nonNullArg(before, "before");
		return v -> this.doApplyAsDouble(before.doApplyAsLong(v));
	}
