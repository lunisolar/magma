...
public interface LBiObjBooleanPredicateX<T1, T2, X extends Throwable> extends MetaPredicate, PrimitiveCodomain<Object>, MetaInterface.Throwing<X> { // NOSONAR

	static final String DESCRIPTION = "LBiObjBooleanPredicateX: boolean doTest(T1 t1,T2 t2, boolean b) throws X";
	...
	default boolean shovingDoTest(T1 t1, T2 t2, boolean b) {
		return ((LBiObjBooleanPredicateX<T1, T2, RuntimeException>) this).doTest(t1, t2, b);
	}
	...
	static <T1, T2, X extends Throwable> LBiObjBooleanPredicateX<T1, T2, X> constant(boolean r) {
		return (t1, t2, b) -> r;
	}

	/** Captures single parameter function into this interface where only 1st parameter will be used. */
	@Nonnull
	static <T1, T2, X extends Throwable> LBiObjBooleanPredicateX<T1, T2, X> test1st(@Nonnull LPredicateX<T1, X> func) {
		return (t1, t2, b) -> func.doTest(t1);
	}

	/** Captures single parameter function into this interface where only 2nd parameter will be used. */
	@Nonnull
	static <T1, T2, X extends Throwable> LBiObjBooleanPredicateX<T1, T2, X> test2nd(@Nonnull LPredicateX<T2, X> func) {
		return (t1, t2, b) -> func.doTest(t2);
	}

	/** Captures single parameter function into this interface where only 3rd parameter will be used. */
	@Nonnull
	static <T1, T2, X extends Throwable> LBiObjBooleanPredicateX<T1, T2, X> test3rd(@Nonnull LLogicalOperatorX<X> func) {
		return (t1, t2, b) -> func.doApply(b);
	}

	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2, X extends Throwable> LBiObjBooleanPredicateX<T1, T2, X> lX(final @Nonnull LBiObjBooleanPredicateX<T1, T2, X> lambda) {
	...
	/** Convenient method in case lambda expression is ambiguous for the compiler (that might happen for overloaded methods accepting different interfaces). */
	@Nonnull
	static <T1, T2, X extends Throwable> LBiObjBooleanPredicateX<T1, T2, X> lX(@Nonnull Class<X> xClass, final @Nonnull LBiObjBooleanPredicateX<T1, T2, X> lambda) {
		Null.nonNullArg(lambda, "lambda");
		return lambda;
	}
	...
	@Nonnull
	static <T1, T2, X extends Throwable> LBiObjBooleanPredicateX<T1, T2, X> wrapX(final @Nonnull LBiObjBooleanPredicate<T1, T2> other) {
		return (LBiObjBooleanPredicateX) other;
	}
	 ...
	 */
	@Nonnull
	static <T1, T2, X extends Throwable> LBiObjBooleanPredicateX<T1, T2, X> isEqual(final T1 v1, final T2 v2, final boolean v3) {
	...
	@Nonnull
	default <V1, V2> LBiObjBooleanPredicateX<V1, V2, X> biObjBoolPredComposeBoolean(@Nonnull final LFunctionX<? super V1, ? extends T1, X> before1, @Nonnull final LFunctionX<? super V2, ? extends T2, X> before2, @Nonnull final LLogicalOperatorX<X> before3) {
