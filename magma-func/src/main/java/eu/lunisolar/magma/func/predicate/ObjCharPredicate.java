...
public interface ObjCharPredicate<T> extends ObjCharPredicateX<T, RuntimeException>, MetaPredicate, PrimitiveCodomain<Object>, MetaInterface.NonThrowing { // NOSONAR
	...
	public static <T> ObjCharPredicate<T> constant(boolean r) {
		return (t, c) -> r;
	}
