...
public interface LBiObjIntPredicate<T1, T2> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<a<T1>, a<T2>, aInt> { // NOSONAR
	 ...
	 */
	public static <T1, T2> M<T1, T2> memento(boolean initialValue, LBiObjIntPredicate<T1, T2> baseFunction, LLogicalBinaryOperator mementoFunction) {
		return new M(initialValue, baseFunction, mementoFunction);
	}

	/**
	 * Implementation that allows to create derivative functions (do not ). Very short name is intended to be used with parent (LBiObjIntPredicate.D)
	 */
	final class M<T1, T2> implements LBiObjIntPredicate<T1, T2> {
		...
		private M(boolean lastValue, LBiObjIntPredicate<T1, T2> baseFunction, LLogicalBinaryOperator mementoFunction) {
