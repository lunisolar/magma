...
public interface LBiObjIntPredicate<T1, T2> extends LBiObjIntPredicateX<T1, T2, RuntimeException>, MetaPredicate, MetaInterface.NonThrowing { // NOSONAR
	...
	@Nonnull
	default <V> LBiObjIntFunction<T1, T2, V> boolToBiObjIntFunction(@Nonnull LBoolFunction<? extends V> after) {
	...
	@FunctionalInterface
	interface V1<T1, T2> extends LBiObjIntPredicate<T1, T2> {

		boolean doTestV1(T1 a1, int a3, T2 a2);
	...
	/** Permutation of LBiObjIntPredicate for method references. */
	@FunctionalInterface
	interface V2<T2, T1> extends LBiObjIntPredicate<T1, T2> {

		boolean doTestV2(T2 a2, T1 a1, int a3);
	...
	/** Permutation of LBiObjIntPredicate for method references. */
	@FunctionalInterface
	interface V3<T2, T1> extends LBiObjIntPredicate<T1, T2> {

		boolean doTestV3(T2 a2, int a3, T1 a1);
	...
	/** Permutation of LBiObjIntPredicate for method references. */
	@FunctionalInterface
	interface V4<T1, T2> extends LBiObjIntPredicate<T1, T2> {

		boolean doTestV4(int a3, T1 a1, T2 a2);
	...
	/** Permutation of LBiObjIntPredicate for method references. */
	@FunctionalInterface
	interface V5<T2, T1> extends LBiObjIntPredicate<T1, T2> {

		boolean doTestV5(int a3, T2 a2, T1 a1);
