...
public interface LBiObjIntPredicate<T1, T2> extends LBiObjIntPredicateX<T1, T2, RuntimeException>, MetaPredicate, PrimitiveCodomain<Object>, MetaInterface.NonThrowing { // NOSONAR
	...
	public static final String DESCRIPTION = "LBiObjIntPredicate: boolean doTest(T1 t1,T2 t2, int i)";

	public boolean doTest(T1 t1, T2 t2, int i);
	...
	@Nonnull
	public static <T1, T2, X extends Throwable> LBiObjIntPredicate<T1, T2> wrap(final @Nonnull LBiObjIntPredicateX<T1, T2, X> other) {
