...
public interface LBiObjIntPredicate<T1, T2> extends LBiObjIntPredicateX<T1, T2, RuntimeException>, MetaPredicate, MetaInterface.NonThrowing { // NOSONAR
	...
	interface V1<T1, T2> extends LBiObjIntPredicate<T1, T2> {
		...
		boolean apply1(T1 a1, int a3, T2 a2);
	...
	/** Permutation of LBiObjIntPredicate for method references. */
	@FunctionalInterface
	interface V2<T1, T2> extends LBiObjIntPredicate<T1, T2> {

		boolean apply2(T2 a2, T1 a1, int a3);
	...
	/** Permutation of LBiObjIntPredicate for method references. */
	@FunctionalInterface
	interface V3<T1, T2> extends LBiObjIntPredicate<T1, T2> {

		boolean apply3(T2 a2, int a3, T1 a1);
	...
	interface V4<T1, T2> extends LBiObjIntPredicate<T1, T2> {
		...
		boolean apply4(int a3, T1 a1, T2 a2);
	...
	/** Permutation of LBiObjIntPredicate for method references. */
	@FunctionalInterface
	interface V5<T1, T2> extends LBiObjIntPredicate<T1, T2> {

		boolean apply5(int a3, T2 a2, T1 a1);
