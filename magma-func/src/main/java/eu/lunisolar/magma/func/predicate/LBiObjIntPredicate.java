...
public interface LBiObjIntPredicate<T1, T2> extends MetaPredicate, MetaInterface.NonThrowing, Codomain<aBool>, Domain3<a<T1>, a<T2>, aInt> { //NOSONAR
	...
	public static <T1, T2, X extends Throwable> T1 throwIfNot(T1 a1, T2 a2, int a3, @Nonnull LBiObjIntPredicate<? super T1, ? super T2> pred, @Nonnull ExMF<X> factory, @Nonnull LBiObjIntFunction<? super T1, ? super T2, ? extends String> msgFunc)
			throws X {
		Null.nonNullArg(pred, "pred");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(msgFunc, "msgFunc");
	...
	/** Throws new exception if condition is NOT met. */
	public static <T1, T2, X extends Throwable> T1 throwIfNot(T1 a1, @Nonnull LBiObjIntPredicate<? super T1, ? super T2> pred, T2 a2, int a3, @Nonnull ExMF<X> factory, @Nonnull LBiObjIntFunction<? super T1, ? super T2, ? extends String> msgFunc)
			throws X {
		Null.nonNullArg(pred, "pred");
		Null.nonNullArg(factory, "factory");
		Null.nonNullArg(msgFunc, "msgFunc");
	...
	final class M<T1, T2> implements LBiObjIntPredicate<T1, T2> {
		...
		public boolean currentBaseValue(T1 a1, T2 a2, int a3) {
