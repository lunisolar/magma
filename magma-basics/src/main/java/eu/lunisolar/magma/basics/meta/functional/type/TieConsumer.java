 ...
 */
public interface TieConsumer<C, T extends aType> extends MetaConsumer, Codomain<aVoid>, eu.lunisolar.magma.basics.meta.functional.domain.Domain {
