...
import static eu.lunisolar.magma.func.build.function.from.LBiIntFunctionBuilder.biIntFunction;
import static eu.lunisolar.magma.func.build.function.from.LBiIntFunctionBuilder.biIntFunctionFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBiIntFunctionBuilderTest<R>{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LBiIntFunction<Integer> function = biIntFunctionFrom(b-> b
                .build()
            );
