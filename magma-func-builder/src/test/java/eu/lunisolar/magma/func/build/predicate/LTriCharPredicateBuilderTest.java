...
import static eu.lunisolar.magma.func.build.predicate.LTriCharPredicateBuilder.triCharPredicate;
import static eu.lunisolar.magma.func.build.predicate.LTriCharPredicateBuilder.triCharPredicateFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LTriCharPredicateBuilderTest{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LTriCharPredicate function = triCharPredicateFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        LTriCharPredicate function = triCharPredicateFrom( b -> b
            ...
            .inCase((a1,a2,a3) -> a1 > '\u0000' && a1 < '\u0010').evaluate((a1,a2,a3) -> true)
            .inCase((a1,a2,a3) -> a1 > '\u0010' && a1 < '\u0020').evaluate((a1,a2,a3) -> true)
