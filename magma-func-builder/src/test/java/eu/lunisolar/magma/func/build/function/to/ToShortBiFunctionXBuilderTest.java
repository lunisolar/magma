...
import static eu.lunisolar.magma.func.build.function.to.ToShortBiFunctionXBuilder.toShortBiFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ToShortBiFunctionXBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ToShortBiFunctionX function = ToShortBiFunctionXBuilder
                .toShortBiFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ToShortBiFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ToShortBiFunctionX<Integer ,Integer ,ParseException> function = toShortBiFunctionX((ToShortBiFunctionX<Integer ,Integer ,ParseException> f)-> doNothing())
