...
import static eu.lunisolar.magma.func.build.consumer.primitives.tri.LTriBoolConsumerXBuilder.triBoolConsumerXFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LTriBoolConsumerXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LTriBoolConsumerX<X> function = triBoolConsumerXFrom(b-> b
                .build()
            );
