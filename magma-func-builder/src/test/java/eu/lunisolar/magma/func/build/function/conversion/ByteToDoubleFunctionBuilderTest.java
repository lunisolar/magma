...
import static eu.lunisolar.magma.func.build.function.conversion.ByteToDoubleFunctionBuilder.byteToDoubleFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ByteToDoubleFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ByteToDoubleFunction function = ByteToDoubleFunctionBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ByteToDoubleFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ByteToDoubleFunction function = byteToDoubleFunction((ByteToDoubleFunction f)-> doNothing())
