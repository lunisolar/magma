...
import static eu.lunisolar.magma.func.build.function.conversion.FloatToByteFunctionXBuilder.floatToByteFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class FloatToByteFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            FloatToByteFunctionX function = FloatToByteFunctionXBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(FloatToByteFunctionX.DESCRIPTION);
