...
import static eu.lunisolar.magma.func.build.function.to.LToIntTriFunctionBuilder.toIntTriFunction;
import static eu.lunisolar.magma.func.build.function.to.LToIntTriFunctionBuilder.toIntTriFunctionFrom;

public class LToIntTriFunctionBuilderTest<T1,T2,T3>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LToIntTriFunction<Integer,Integer,Integer> function = toIntTriFunctionFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestToIntTriFunc(function)
            .doesApplyAsInt(0,0,0).when(null).to(a -> a.mustEx(Be::equalEx, 0))
            .doesApplyAsInt(5,5,5).when(null).to(a -> a.mustEx(Be::equalEx, 1))
            .doesApplyAsInt(15,15,15).when(null).to(a -> a.mustEx(Be::equalEx, 2))
            .doesApplyAsInt(10,10,10).when(null).to(a -> a.mustEx(Be::equalEx, 99))
        ;
