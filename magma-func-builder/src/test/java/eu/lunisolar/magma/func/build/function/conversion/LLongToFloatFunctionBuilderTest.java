...
public class LLongToFloatFunctionBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LLongToFloatFunction function = LLongToFloatFunctionBuilder.longToFloatFunction()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LLongToFloatFunction.DESCRIPTION);
    }
