...
import static eu.lunisolar.magma.func.build.function.from.LOiFunctionBuilder.oiFunction;
import static eu.lunisolar.magma.func.build.function.from.LOiFunctionBuilder.oiFunctionFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LOiFunctionBuilderTest<T,R>{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LOiFunction<Integer,Integer> function = oiFunctionFrom(b-> b
                .build()
            );
