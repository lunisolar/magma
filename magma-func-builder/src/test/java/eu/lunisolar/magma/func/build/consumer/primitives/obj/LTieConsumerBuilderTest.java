...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LTieConsumerBuilder.tieConsumer;
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LTieConsumerBuilder.tieConsumerFrom;

public class LTieConsumerBuilderTest<T1,T2>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LTieConsumer<Integer,Integer> function = tieConsumerFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestTieCons(function)
