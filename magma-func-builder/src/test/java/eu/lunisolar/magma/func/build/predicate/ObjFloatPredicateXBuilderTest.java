...
import static eu.lunisolar.magma.func.build.predicate.ObjFloatPredicateXBuilder.objFloatPredicateX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjFloatPredicateXBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjFloatPredicateX function = ObjFloatPredicateXBuilder
                .objFloatPredicateX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjFloatPredicateX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ObjFloatPredicateX<Integer ,ParseException> function = objFloatPredicateX((ObjFloatPredicateX<Integer ,ParseException> f)-> doNothing())
