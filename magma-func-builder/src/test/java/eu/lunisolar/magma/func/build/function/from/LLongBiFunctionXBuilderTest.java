...
import static eu.lunisolar.magma.func.build.function.from.LLongBiFunctionXBuilder.longBiFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LLongBiFunctionXBuilderTest<R,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LLongBiFunctionX function = LLongBiFunctionXBuilder.longBiFunctionX()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LLongBiFunctionX.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LLongBiFunctionX<Integer ,ParseException> function = longBiFunctionX((LLongBiFunctionX<Integer ,ParseException> f)-> doNothing())
