...
import static eu.lunisolar.magma.func.build.function.conversion.ByteToLongFunctionBuilder.byteToLongFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ByteToLongFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ByteToLongFunction function = ByteToLongFunctionBuilder
                .byteToLongFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ByteToLongFunction.DESCRIPTION);
