...
import static eu.lunisolar.magma.func.build.function.from.LLongBiFunctionBuilder.longBiFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LLongBiFunctionBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LLongBiFunction function = LLongBiFunctionBuilder
                .longBiFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LLongBiFunction.DESCRIPTION);
