...
import static eu.lunisolar.magma.func.build.function.from.LObjSrtFunctionBuilder.objSrtFunction;
import static eu.lunisolar.magma.func.build.function.from.LObjSrtFunctionBuilder.objSrtFunctionFrom;

public class LObjSrtFunctionBuilderTest<T,R>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LObjSrtFunction<Integer,Integer> function = objSrtFunctionFrom(b-> b
                .build()
            );

            function.apply(100,(short)100);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestObjSrtFunc(function)
            .doesApply(0,(short)0).when(null).to(a -> a.mustEx(Be::equalEx, 0))
            .doesApply(5,(short)5).when(null).to(a -> a.mustEx(Be::equalEx, 1))
            .doesApply(15,(short)15).when(null).to(a -> a.mustEx(Be::equalEx, 2))
            .doesApply(10,(short)10).when(null).to(a -> a.mustEx(Be::equalEx, 99))
        ;
