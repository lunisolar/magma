...
import static eu.lunisolar.magma.func.build.predicate.ObjIntPredicateXBuilder.objIntPredicateX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjIntPredicateXBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjIntPredicateX function = ObjIntPredicateXBuilder
                .objIntPredicateX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjIntPredicateX.DESCRIPTION);
