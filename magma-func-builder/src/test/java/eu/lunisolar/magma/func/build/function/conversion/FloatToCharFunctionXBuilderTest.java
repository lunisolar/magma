...
import static eu.lunisolar.magma.func.build.function.conversion.FloatToCharFunctionXBuilder.floatToCharFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class FloatToCharFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            FloatToCharFunctionX function = FloatToCharFunctionXBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(FloatToCharFunctionX.DESCRIPTION);
