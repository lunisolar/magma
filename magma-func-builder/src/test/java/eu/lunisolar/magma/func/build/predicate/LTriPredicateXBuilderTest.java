...
import static eu.lunisolar.magma.func.build.predicate.LTriPredicateXBuilder.triPredicateXFrom;
...
public class LTriPredicateXBuilderTest<T1,T2,T3,X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LTriPredicateX<Integer,Integer,Integer,X> function = triPredicateXFrom(b-> b
                .build()
            );
