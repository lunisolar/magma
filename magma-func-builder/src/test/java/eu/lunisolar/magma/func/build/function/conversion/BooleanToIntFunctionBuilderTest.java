...
import static eu.lunisolar.magma.func.build.function.conversion.BooleanToIntFunctionBuilder.booleanToIntFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BooleanToIntFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BooleanToIntFunction function = BooleanToIntFunctionBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BooleanToIntFunction.DESCRIPTION);
