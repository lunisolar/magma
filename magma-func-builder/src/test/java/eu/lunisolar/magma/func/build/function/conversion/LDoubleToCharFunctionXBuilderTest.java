...
public class LDoubleToCharFunctionXBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws Throwable {
        ...
        assertThatThrownBy(() -> {
            LDoubleToCharFunctionX function = LDoubleToCharFunctionXBuilder.doubleToCharFunctionX()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LDoubleToCharFunctionX.DESCRIPTION);
    }
    ...
    public void testBuild() throws Throwable {
        ...
        LDoubleToCharFunctionX<ParseException> function = doubleToCharFunctionX((LDoubleToCharFunctionX<ParseException> f)-> doNothing())
