...
import static eu.lunisolar.magma.func.build.function.to.ToCharBiFunctionBuilder.toCharBiFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ToCharBiFunctionBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ToCharBiFunction function = ToCharBiFunctionBuilder
                .toCharBiFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ToCharBiFunction.DESCRIPTION);
