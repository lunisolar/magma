...
import static eu.lunisolar.magma.func.build.consumer.primitives.LDblConsumerBuilder.dblConsumer;
import static eu.lunisolar.magma.func.build.consumer.primitives.LDblConsumerBuilder.dblConsumerFrom;

public class LDblConsumerBuilderTest{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LDblConsumer function = dblConsumerFrom(b-> b
                .build()
            );

            function.accept(100d);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestDblCons(function)
            .doesAccept(0d).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 0))
            .doesAccept(5d).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 1))
            .doesAccept(15d).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 2))
            .doesAccept(10d).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 99))
        ;
