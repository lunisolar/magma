...
import static eu.lunisolar.magma.func.build.consumer.TriConsumerBuilder.triConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class TriConsumerBuilderTest<T1,T2,T3,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            TriConsumer function = TriConsumerBuilder
                .triConsumer()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(TriConsumer.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        TriConsumer<Integer ,Integer ,Integer > function = triConsumer((TriConsumer<Integer ,Integer ,Integer > f)-> doNothing())
