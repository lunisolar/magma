...
import static eu.lunisolar.magma.func.build.predicate.LBiSrtPredicateBuilder.biSrtPredicate;
import static eu.lunisolar.magma.func.build.predicate.LBiSrtPredicateBuilder.biSrtPredicateFrom;

public class LBiSrtPredicateBuilderTest{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LBiSrtPredicate function = biSrtPredicateFrom(b-> b
                .build()
            );

            function.test((short)100,(short)100);
    ...
    public void testBuild()  {
        ...
        LBiSrtPredicate function = biSrtPredicateFrom( b -> b
            ...
            .inCase((a1,a2) -> a1 > (short)0 && a1 < (short)10).evaluate((a1,a2) -> true)
            .inCase((a1,a2) -> a1 > (short)10 && a1 < (short)20).evaluate((a1,a2) -> true)
            .otherwise((a1,a2) -> true)
            .build()
        );


        FuncAttests.attestBiSrtPred(function)
            .doesTest((short)0,(short)0).when(null).to(a -> a.mustEx(Be::equalEx, false))
            .doesTest((short)5,(short)5).when(null).to(a -> a.mustEx(Be::equalEx, true))
        ;
