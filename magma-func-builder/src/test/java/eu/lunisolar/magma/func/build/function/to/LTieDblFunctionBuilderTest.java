...
public class LTieDblFunctionBuilderTest<T>{
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestTieDblFunc(function)
            .doesApplyAsInt(0,0,0d).when(null).to(a -> a.must$(Be::equal$, 0))
            .doesApplyAsInt(5,5,5d).when(null).to(a -> a.must$(Be::equal$, 1))
            .doesApplyAsInt(15,15,15d).when(null).to(a -> a.must$(Be::equal$, 2))
            .doesApplyAsInt(10,10,10d).when(null).to(a -> a.must$(Be::equal$, 99))
        ;
