...
import static eu.lunisolar.magma.func.build.predicate.ObjDoublePredicateBuilder.objDoublePredicate;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjDoublePredicateBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjDoublePredicate function = ObjDoublePredicateBuilder
                .objDoublePredicate()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjDoublePredicate.DESCRIPTION);
