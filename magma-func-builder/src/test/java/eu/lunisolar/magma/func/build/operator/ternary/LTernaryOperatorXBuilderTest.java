...
import static eu.lunisolar.magma.func.build.operator.ternary.LTernaryOperatorXBuilder.ternaryOperatorXFrom;
...
public class LTernaryOperatorXBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LTernaryOperatorX<Integer,X> function = ternaryOperatorXFrom(b-> b
                .build()
            );
