...
import static eu.lunisolar.magma.func.build.supplier.SupplierXBuilder.supplierX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class SupplierXBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            SupplierX function = SupplierXBuilder
                .supplierX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(SupplierX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        SupplierX<Integer ,ParseException> function = supplierX((SupplierX<Integer ,ParseException> f)-> doNothing())
