...
import static eu.lunisolar.magma.func.build.function.from.ObjCharFunctionBuilder.objCharFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjCharFunctionBuilderTest<T,R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjCharFunction function = ObjCharFunctionBuilder
                .objCharFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjCharFunction.DESCRIPTION);
