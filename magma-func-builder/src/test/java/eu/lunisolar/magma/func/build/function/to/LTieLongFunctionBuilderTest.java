...
import static eu.lunisolar.magma.func.build.function.to.LTieLongFunctionBuilder.tieLongFunction;
import static eu.lunisolar.magma.func.build.function.to.LTieLongFunctionBuilder.tieLongFunctionFrom;
...
public class LTieLongFunctionBuilderTest<T>{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LTieLongFunction<Integer> function = tieLongFunctionFrom(b-> b
                .build()
            );

            function.doApplyAsInt(100,100,100L);
