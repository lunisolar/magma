...
import static eu.lunisolar.magma.func.build.function.from.LongFunctionXBuilder.longFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LongFunctionXBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LongFunctionX function = LongFunctionXBuilder
                .longFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LongFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        LongFunctionX<Integer ,ParseException> function = longFunctionX((LongFunctionX<Integer ,ParseException> f)-> doNothing())
