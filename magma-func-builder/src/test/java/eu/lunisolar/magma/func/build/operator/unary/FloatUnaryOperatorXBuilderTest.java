...
import static eu.lunisolar.magma.func.build.operator.unary.FloatUnaryOperatorXBuilder.floatUnaryOperatorX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class FloatUnaryOperatorXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            FloatUnaryOperatorX function = FloatUnaryOperatorXBuilder
                .floatUnaryOperatorX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(FloatUnaryOperatorX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        FloatUnaryOperatorX<ParseException> function = floatUnaryOperatorX((FloatUnaryOperatorX<ParseException> f)-> doNothing())
