...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LTieIntConsumerBuilder.tieIntConsumer;
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LTieIntConsumerBuilder.tieIntConsumerFrom;

public class LTieIntConsumerBuilderTest<T>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LTieIntConsumer<Integer> function = tieIntConsumerFrom(b-> b
                .build()
            );

            function.accept(100,100,100);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestTieIntCons(function)
            .doesAccept(0,0,0).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 0))
            .doesAccept(5,5,5).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 1))
            .doesAccept(15,15,15).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 2))
            .doesAccept(10,10,10).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 99))
        ;
