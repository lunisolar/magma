...
public class LBoolToByteFunctionBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LBoolToByteFunction function = LBoolToByteFunctionBuilder.boolToByteFunction()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LBoolToByteFunction.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LBoolToByteFunction function = boolToByteFunction((LBoolToByteFunction f)-> doNothing())
