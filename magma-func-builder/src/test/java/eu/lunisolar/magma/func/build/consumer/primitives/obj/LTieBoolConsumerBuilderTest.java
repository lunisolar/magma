...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LTieBoolConsumerBuilder.tieBoolConsumer;
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LTieBoolConsumerBuilder.tieBoolConsumerFrom;

public class LTieBoolConsumerBuilderTest<T>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LTieBoolConsumer<Integer> function = tieBoolConsumerFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestTieBoolCons(function)
            .doesAccept(0,0,false).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 0))
            .doesAccept(5,5,true).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 1))
            .doesAccept(15,15,true).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 2))
            .doesAccept(10,10,true).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 99))
        ;
