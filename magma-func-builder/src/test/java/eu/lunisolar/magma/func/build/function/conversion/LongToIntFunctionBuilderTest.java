...
import static eu.lunisolar.magma.func.build.function.conversion.LongToIntFunctionBuilder.longToIntFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LongToIntFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LongToIntFunction function = LongToIntFunctionBuilder
                .longToIntFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LongToIntFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        LongToIntFunction function = longToIntFunction((LongToIntFunction f)-> doNothing())
