...
import static eu.lunisolar.magma.func.build.function.conversion.LongToFloatFunctionBuilder.longToFloatFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LongToFloatFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LongToFloatFunction function = LongToFloatFunctionBuilder
                .longToFloatFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LongToFloatFunction.DESCRIPTION);
