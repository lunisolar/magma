...
import static eu.lunisolar.magma.func.build.predicate.LObjCharPredicateXBuilder.objCharPredicateXFrom;
...
public class LObjCharPredicateXBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LObjCharPredicateX<Integer,X> function = objCharPredicateXFrom(b-> b
                .build()
            );

            function.doTest(100,'\u0100');
