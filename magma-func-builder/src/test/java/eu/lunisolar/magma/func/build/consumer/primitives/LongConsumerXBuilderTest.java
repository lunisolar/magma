...
import static eu.lunisolar.magma.func.build.consumer.primitives.LongConsumerXBuilder.longConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LongConsumerXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LongConsumerX function = LongConsumerXBuilder
                .longConsumerX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LongConsumerX.DESCRIPTION);
