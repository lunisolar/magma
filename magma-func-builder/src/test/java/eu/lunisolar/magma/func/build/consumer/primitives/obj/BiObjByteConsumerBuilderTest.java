...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.BiObjByteConsumerBuilder.biObjByteConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiObjByteConsumerBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiObjByteConsumer function = BiObjByteConsumerBuilder
                .biObjByteConsumer()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiObjByteConsumer.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BiObjByteConsumer<Integer ,Integer > function = biObjByteConsumer((BiObjByteConsumer<Integer ,Integer > f)-> doNothing())
