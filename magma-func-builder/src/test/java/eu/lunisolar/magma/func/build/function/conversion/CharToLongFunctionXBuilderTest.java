...
import static eu.lunisolar.magma.func.build.function.conversion.CharToLongFunctionXBuilder.charToLongFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class CharToLongFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            CharToLongFunctionX function = CharToLongFunctionXBuilder
                .charToLongFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(CharToLongFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        CharToLongFunctionX<ParseException> function = charToLongFunctionX((CharToLongFunctionX<ParseException> f)-> doNothing())
