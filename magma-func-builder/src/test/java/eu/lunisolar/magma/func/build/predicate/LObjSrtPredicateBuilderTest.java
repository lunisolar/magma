...
import static eu.lunisolar.magma.func.build.predicate.LObjSrtPredicateBuilder.objSrtPredicate;
import static eu.lunisolar.magma.func.build.predicate.LObjSrtPredicateBuilder.objSrtPredicateFrom;
...
public class LObjSrtPredicateBuilderTest<T>{
    ...
    public void testOtherwiseThrow()  {
        ...
        try {
            LObjSrtPredicate<Integer> function = objSrtPredicateFrom(b-> b
                .build()
            );

            function.test(100,(short)100);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestObjSrtPred(function)
            .doesTest(0,(short)0).when(null).to(a -> a.mustEx(Be::equalEx, false))
            .doesTest(5,(short)5).when(null).to(a -> a.mustEx(Be::equalEx, true))
        ;
