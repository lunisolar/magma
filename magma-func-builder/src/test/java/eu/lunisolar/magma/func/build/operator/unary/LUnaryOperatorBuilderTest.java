...
import static eu.lunisolar.magma.func.build.operator.unary.LUnaryOperatorBuilder.unaryOperatorFrom;

public class LUnaryOperatorBuilderTest<T>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LUnaryOperator<Integer> function = unaryOperatorFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestUnaryOp(function)
            .doesApply(0).when(null).to(a -> a.mustEx(Be::equalEx, 0))
            .doesApply(5).when(null).to(a -> a.mustEx(Be::equalEx, 1))
            .doesApply(15).when(null).to(a -> a.mustEx(Be::equalEx, 2))
            .doesApply(10).when(null).to(a -> a.mustEx(Be::equalEx, 99))
        ;
