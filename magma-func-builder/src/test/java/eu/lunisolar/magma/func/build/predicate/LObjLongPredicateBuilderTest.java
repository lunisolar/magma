...
public class LObjLongPredicateBuilderTest<T,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LObjLongPredicate function = LObjLongPredicateBuilder.objLongPredicate()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LObjLongPredicate.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LObjLongPredicate<Integer > function = objLongPredicate((LObjLongPredicate<Integer > f)-> doNothing())
