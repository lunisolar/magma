...
import static eu.lunisolar.magma.func.build.function.from.LBiObjByteFunctionBuilder.biObjByteFunctionFrom;

public class LBiObjByteFunctionBuilderTest<T1,T2,R>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LBiObjByteFunction<Integer,Integer,Integer> function = biObjByteFunctionFrom(b-> b
                .build()
            );

            function.apply(100,100,(byte)100);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestBiObjByteFunc(function)
            .doesApply(0,0,(byte)0).when(null).to(a -> a.mustEx(Be::equalEx, 0))
            .doesApply(5,5,(byte)5).when(null).to(a -> a.mustEx(Be::equalEx, 1))
            .doesApply(15,15,(byte)15).when(null).to(a -> a.mustEx(Be::equalEx, 2))
            .doesApply(10,10,(byte)10).when(null).to(a -> a.mustEx(Be::equalEx, 99))
        ;
