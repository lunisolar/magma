...
import static eu.lunisolar.magma.func.build.operator.binary.LDblBinaryOperatorBuilder.dblBinaryOperator;
import static eu.lunisolar.magma.func.build.operator.binary.LDblBinaryOperatorBuilder.dblBinaryOperatorFrom;
...
public class LDblBinaryOperatorBuilderTest{
    ...
    public void testOtherwiseThrow()  {
        ...
        try {
            LDblBinaryOperator function = dblBinaryOperatorFrom(b-> b
                .build()
            );
