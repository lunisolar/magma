...
import static eu.lunisolar.magma.func.build.function.from.CharFunctionXBuilder.charFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class CharFunctionXBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            CharFunctionX function = CharFunctionXBuilder
                .charFunctionX()
                .build();

            function.apply((char)100);
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(CharFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        CharFunctionX<Integer ,ParseException> function = charFunctionX((CharFunctionX<Integer ,ParseException> f)-> doNothing())
