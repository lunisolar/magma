...
import static eu.lunisolar.magma.func.build.function.from.ObjCharFunctionXBuilder.objCharFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjCharFunctionXBuilderTest<T,R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjCharFunctionX function = ObjCharFunctionXBuilder
                .objCharFunctionX()
                .build();

            function.apply((T)Integer.valueOf(100),(char)100);
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjCharFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ObjCharFunctionX<Integer ,Integer ,ParseException> function = objCharFunctionX((ObjCharFunctionX<Integer ,Integer ,ParseException> f)-> doNothing())
