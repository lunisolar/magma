...
import static eu.lunisolar.magma.func.build.consumer.TriConsumerXBuilder.triConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class TriConsumerXBuilderTest<T1,T2,T3,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            TriConsumerX function = TriConsumerXBuilder
                .triConsumerX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(TriConsumerX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        TriConsumerX<Integer ,Integer ,Integer ,ParseException> function = triConsumerX((TriConsumerX<Integer ,Integer ,Integer ,ParseException> f)-> doNothing())
