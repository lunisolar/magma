...
import static eu.lunisolar.magma.func.build.function.to.ToLongBiFunctionBuilder.toLongBiFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ToLongBiFunctionBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ToLongBiFunction function = ToLongBiFunctionBuilder
                .toLongBiFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ToLongBiFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ToLongBiFunction<Integer ,Integer > function = toLongBiFunction((ToLongBiFunction<Integer ,Integer > f)-> doNothing())
