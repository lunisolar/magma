...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LObjSrtConsumerBuilder.objSrtConsumer;
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LObjSrtConsumerBuilder.objSrtConsumerFrom;

public class LObjSrtConsumerBuilderTest<T>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LObjSrtConsumer<Integer> function = objSrtConsumerFrom(b-> b
                .build()
            );

            function.accept(100,(short)100);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestObjSrtCons(function)
            .doesAccept(0,(short)0).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 0))
            .doesAccept(5,(short)5).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 1))
            .doesAccept(15,(short)15).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 2))
            .doesAccept(10,(short)10).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 99))
        ;
