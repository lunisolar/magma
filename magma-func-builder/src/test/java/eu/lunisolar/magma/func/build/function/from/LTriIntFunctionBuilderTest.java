...
import static eu.lunisolar.magma.func.build.function.from.LTriIntFunctionBuilder.triIntFunction;
import static eu.lunisolar.magma.func.build.function.from.LTriIntFunctionBuilder.triIntFunctionFrom;

public class LTriIntFunctionBuilderTest<R>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LTriIntFunction<Integer> function = triIntFunctionFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestTriIntFunc(function)
