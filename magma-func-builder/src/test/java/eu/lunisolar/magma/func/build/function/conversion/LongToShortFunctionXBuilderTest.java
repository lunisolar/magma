...
import static eu.lunisolar.magma.func.build.function.conversion.LongToShortFunctionXBuilder.longToShortFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LongToShortFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LongToShortFunctionX function = LongToShortFunctionXBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LongToShortFunctionX.DESCRIPTION);
