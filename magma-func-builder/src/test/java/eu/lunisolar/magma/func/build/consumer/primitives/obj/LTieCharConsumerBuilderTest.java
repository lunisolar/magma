...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LTieCharConsumerBuilder.tieCharConsumer;
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LTieCharConsumerBuilder.tieCharConsumerFrom;

public class LTieCharConsumerBuilderTest<T>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LTieCharConsumer<Integer> function = tieCharConsumerFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestTieCharCons(function)
