...
import static eu.lunisolar.magma.func.build.operator.unary.LDblUnaryOperatorBuilder.dblUnaryOperator;
import static eu.lunisolar.magma.func.build.operator.unary.LDblUnaryOperatorBuilder.dblUnaryOperatorFrom;

public class LDblUnaryOperatorBuilderTest{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LDblUnaryOperator function = dblUnaryOperatorFrom(b-> b
                .build()
            );

            function.applyAsDbl(100d);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestDblUnaryOp(function)
            .doesApplyAsDbl(0d).when(null).to(a -> a.mustEx(Be::equalEx, 0d))
            .doesApplyAsDbl(5d).when(null).to(a -> a.mustEx(Be::equalEx, 1d))
            .doesApplyAsDbl(15d).when(null).to(a -> a.mustEx(Be::equalEx, 2d))
            .doesApplyAsDbl(10d).when(null).to(a -> a.mustEx(Be::equalEx, 99d))
        ;
