...
import static eu.lunisolar.magma.func.build.function.to.ToDoubleBiFunctionBuilder.toDoubleBiFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ToDoubleBiFunctionBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ToDoubleBiFunction function = ToDoubleBiFunctionBuilder
                .toDoubleBiFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ToDoubleBiFunction.DESCRIPTION);
