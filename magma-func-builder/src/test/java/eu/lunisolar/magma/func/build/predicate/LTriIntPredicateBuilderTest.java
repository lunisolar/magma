...
import static eu.lunisolar.magma.func.build.predicate.LTriIntPredicateBuilder.triIntPredicate;
import static eu.lunisolar.magma.func.build.predicate.LTriIntPredicateBuilder.triIntPredicateFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LTriIntPredicateBuilderTest{
    ...
    public void testOtherwiseThrow()  {
        ...
        assertThatThrownBy(() -> {
            LTriIntPredicate function = triIntPredicateFrom(b-> b
                .build()
            );
