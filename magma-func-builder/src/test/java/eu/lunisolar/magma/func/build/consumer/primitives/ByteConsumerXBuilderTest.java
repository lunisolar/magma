...
import static eu.lunisolar.magma.func.build.consumer.primitives.ByteConsumerXBuilder.byteConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ByteConsumerXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ByteConsumerX function = ByteConsumerXBuilder
                .byteConsumerX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ByteConsumerX.DESCRIPTION);
