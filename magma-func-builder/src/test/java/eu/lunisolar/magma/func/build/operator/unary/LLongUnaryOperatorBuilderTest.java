...
public class LLongUnaryOperatorBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LLongUnaryOperator function = LLongUnaryOperatorBuilder.longUnaryOperator()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LLongUnaryOperator.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LLongUnaryOperator function = longUnaryOperator((LLongUnaryOperator f)-> doNothing())
