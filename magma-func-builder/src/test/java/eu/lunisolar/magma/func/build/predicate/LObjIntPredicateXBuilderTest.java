...
import static eu.lunisolar.magma.func.build.predicate.LObjIntPredicateXBuilder.objIntPredicateXFrom;
...
public class LObjIntPredicateXBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LObjIntPredicateX<Integer,X> function = objIntPredicateXFrom(b-> b
                .build()
            );
