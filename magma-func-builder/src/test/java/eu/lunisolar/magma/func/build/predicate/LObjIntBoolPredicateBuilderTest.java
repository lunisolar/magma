...
import static eu.lunisolar.magma.func.build.predicate.LObjIntBoolPredicateBuilder.objIntBoolPredicate;
import static eu.lunisolar.magma.func.build.predicate.LObjIntBoolPredicateBuilder.objIntBoolPredicateFrom;

public class LObjIntBoolPredicateBuilderTest<T>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LObjIntBoolPredicate<Integer> function = objIntBoolPredicateFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestObjIntBoolPred(function)
