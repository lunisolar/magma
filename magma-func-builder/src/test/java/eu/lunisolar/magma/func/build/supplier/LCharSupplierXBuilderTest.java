...
import static eu.lunisolar.magma.func.build.supplier.LCharSupplierXBuilder.charSupplierX;
import static eu.lunisolar.magma.func.build.supplier.LCharSupplierXBuilder.charSupplierXFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LCharSupplierXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LCharSupplierX<X> function = charSupplierXFrom(b-> b
                .build()
            );
