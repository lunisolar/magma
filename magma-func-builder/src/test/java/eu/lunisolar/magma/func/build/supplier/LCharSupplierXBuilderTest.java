...
public class LCharSupplierXBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws Throwable {
        ...
        assertThatThrownBy(() -> {
            LCharSupplierX function = LCharSupplierXBuilder.charSupplierX()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LCharSupplierX.DESCRIPTION);
    }
