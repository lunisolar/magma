...
import static eu.lunisolar.magma.func.build.operator.unary.LongUnaryOperatorBuilder.longUnaryOperator;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LongUnaryOperatorBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LongUnaryOperator function = LongUnaryOperatorBuilder
                .longUnaryOperator()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LongUnaryOperator.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        LongUnaryOperator function = longUnaryOperator((LongUnaryOperator f)-> doNothing())
