...
import static eu.lunisolar.magma.func.build.function.FunctionBuilder.function;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class FunctionBuilderTest<T,R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(Function.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        Function<Integer ,Integer > function = function((Function<Integer ,Integer > f)-> doNothing())
