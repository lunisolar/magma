...
import static eu.lunisolar.magma.func.build.predicate.BiDoublePredicateBuilder.biDoublePredicate;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiDoublePredicateBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiDoublePredicate function = BiDoublePredicateBuilder
                .biDoublePredicate()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiDoublePredicate.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BiDoublePredicate function = biDoublePredicate((BiDoublePredicate f)-> doNothing())
