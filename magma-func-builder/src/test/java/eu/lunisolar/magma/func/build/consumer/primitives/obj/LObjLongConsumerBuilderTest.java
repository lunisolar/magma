...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LObjLongConsumerBuilder.objLongConsumer;
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LObjLongConsumerBuilder.objLongConsumerFrom;

public class LObjLongConsumerBuilderTest<T>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LObjLongConsumer<Integer> function = objLongConsumerFrom(b-> b
                .build()
            );

            function.accept(100,100L);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestObjLongCons(function)
            .doesAccept(0,0L).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 0))
            .doesAccept(5,5L).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 1))
            .doesAccept(15,15L).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 2))
            .doesAccept(10,10L).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 99))
        ;
