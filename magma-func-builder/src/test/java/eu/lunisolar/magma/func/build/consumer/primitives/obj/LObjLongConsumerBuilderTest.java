...
public class LObjLongConsumerBuilderTest<T,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LObjLongConsumer function = LObjLongConsumerBuilder.objLongConsumer()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LObjLongConsumer.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LObjLongConsumer<Integer > function = objLongConsumer((LObjLongConsumer<Integer > f)-> doNothing())
