...
import static eu.lunisolar.magma.func.build.function.conversion.CharToShortFunctionBuilder.charToShortFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class CharToShortFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            CharToShortFunction function = CharToShortFunctionBuilder
                .charToShortFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(CharToShortFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        CharToShortFunction function = charToShortFunction((CharToShortFunction f)-> doNothing())
