...
public class LBiByteConsumerBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LBiByteConsumer function = LBiByteConsumerBuilder.biByteConsumer()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LBiByteConsumer.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LBiByteConsumer function = biByteConsumer((LBiByteConsumer f)-> doNothing())
