...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.ObjDoubleConsumerBuilder.objDoubleConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjDoubleConsumerBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjDoubleConsumer function = ObjDoubleConsumerBuilder
                .objDoubleConsumer()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjDoubleConsumer.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ObjDoubleConsumer<Integer > function = objDoubleConsumer((ObjDoubleConsumer<Integer > f)-> doNothing())
