...
import static eu.lunisolar.magma.func.build.consumer.primitives.LFloatConsumerXBuilder.floatConsumerXFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LFloatConsumerXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LFloatConsumerX<X> function = floatConsumerXFrom(b-> b
                .build()
            );

            function.doAccept(100f);
