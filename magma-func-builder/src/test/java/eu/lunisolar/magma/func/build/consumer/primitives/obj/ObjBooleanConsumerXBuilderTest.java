...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.ObjBooleanConsumerXBuilder.objBooleanConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjBooleanConsumerXBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjBooleanConsumerX function = ObjBooleanConsumerXBuilder
                .objBooleanConsumerX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjBooleanConsumerX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ObjBooleanConsumerX<Integer ,ParseException> function = objBooleanConsumerX((ObjBooleanConsumerX<Integer ,ParseException> f)-> doNothing())
