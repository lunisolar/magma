...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LTieDblConsumerBuilder.tieDblConsumer;
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LTieDblConsumerBuilder.tieDblConsumerFrom;

public class LTieDblConsumerBuilderTest<T>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LTieDblConsumer<Integer> function = tieDblConsumerFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestTieDblCons(function)
