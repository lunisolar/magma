...
import static eu.lunisolar.magma.func.build.function.from.LObjIntFunctionXBuilder.objIntFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LObjIntFunctionXBuilderTest<T,R,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LObjIntFunctionX function = LObjIntFunctionXBuilder.objIntFunctionX()
                .build();

            function.doApply((T)Integer.valueOf(100),(int)100);

            fail("No exception were thrown.");
        })
                    .isExactlyInstanceOf(IllegalStateException.class)
                    .hasMessageContaining("No case specified for:")
                    .hasMessageContaining(LObjIntFunctionX.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LObjIntFunctionX<Integer ,Integer ,ParseException> function = objIntFunctionX((LObjIntFunctionX<Integer ,Integer ,ParseException> f)-> doNothing())
