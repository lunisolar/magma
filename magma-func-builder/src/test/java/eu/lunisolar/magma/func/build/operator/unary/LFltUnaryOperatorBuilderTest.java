...
import static eu.lunisolar.magma.func.build.operator.unary.LFltUnaryOperatorBuilder.fltUnaryOperator;
import static eu.lunisolar.magma.func.build.operator.unary.LFltUnaryOperatorBuilder.fltUnaryOperatorFrom;

public class LFltUnaryOperatorBuilderTest{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LFltUnaryOperator function = fltUnaryOperatorFrom(b-> b
                .build()
            );

            function.applyAsFlt(100f);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestFltUnaryOp(function)
            .doesApplyAsFlt(0f).when(null).to(a -> a.mustEx(Be::equalEx, 0f))
            .doesApplyAsFlt(5f).when(null).to(a -> a.mustEx(Be::equalEx, 1f))
            .doesApplyAsFlt(15f).when(null).to(a -> a.mustEx(Be::equalEx, 2f))
            .doesApplyAsFlt(10f).when(null).to(a -> a.mustEx(Be::equalEx, 99f))
        ;
