...
import static eu.lunisolar.magma.func.build.operator.unary.LLongUnaryOperatorXBuilder.longUnaryOperatorXFrom;
...
public class LLongUnaryOperatorXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LLongUnaryOperatorX<X> function = longUnaryOperatorXFrom(b-> b
                .build()
            );
