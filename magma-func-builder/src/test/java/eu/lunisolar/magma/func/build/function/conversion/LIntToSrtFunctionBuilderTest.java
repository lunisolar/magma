...
import static eu.lunisolar.magma.func.build.function.conversion.LIntToSrtFunctionBuilder.intToSrtFunction;
import static eu.lunisolar.magma.func.build.function.conversion.LIntToSrtFunctionBuilder.intToSrtFunctionFrom;
...
public class LIntToSrtFunctionBuilderTest{
    ...
    public void testOtherwiseThrow()  {
        ...
        try {
            LIntToSrtFunction function = intToSrtFunctionFrom(b-> b
                .build()
            );
