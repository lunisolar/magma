...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LObjBooleanConsumerBuilder.objBooleanConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LObjBooleanConsumerBuilderTest<T,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LObjBooleanConsumer function = LObjBooleanConsumerBuilder.objBooleanConsumer()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LObjBooleanConsumer.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LObjBooleanConsumer<Integer > function = objBooleanConsumer((LObjBooleanConsumer<Integer > f)-> doNothing())
