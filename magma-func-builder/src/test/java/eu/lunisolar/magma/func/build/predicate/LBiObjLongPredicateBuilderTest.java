...
import static eu.lunisolar.magma.func.build.predicate.LBiObjLongPredicateBuilder.biObjLongPredicateFrom;

public class LBiObjLongPredicateBuilderTest<T1,T2>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LBiObjLongPredicate<Integer,Integer> function = biObjLongPredicateFrom(b-> b
                .build()
            );

            function.test(100,100,100L);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestBiObjLongPred(function)
            .doesTest(0,0,0L).when(null).to(a -> a.mustEx(Be::equalEx, false))
            .doesTest(5,5,5L).when(null).to(a -> a.mustEx(Be::equalEx, true))
        ;
