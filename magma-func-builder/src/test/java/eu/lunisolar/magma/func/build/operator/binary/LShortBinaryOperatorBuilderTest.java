...
import static eu.lunisolar.magma.func.build.operator.binary.LShortBinaryOperatorBuilder.shortBinaryOperatorFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LShortBinaryOperatorBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LShortBinaryOperator function = shortBinaryOperatorFrom(b-> b
                .build()
            );
