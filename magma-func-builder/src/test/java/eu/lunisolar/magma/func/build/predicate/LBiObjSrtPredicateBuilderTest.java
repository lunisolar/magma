...
import static eu.lunisolar.magma.func.build.predicate.LBiObjSrtPredicateBuilder.biObjSrtPredicate;
import static eu.lunisolar.magma.func.build.predicate.LBiObjSrtPredicateBuilder.biObjSrtPredicateFrom;

public class LBiObjSrtPredicateBuilderTest<T1,T2>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LBiObjSrtPredicate<Integer,Integer> function = biObjSrtPredicateFrom(b-> b
                .build()
            );

            function.test(100,100,(short)100);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestBiObjSrtPred(function)
            .doesTest(0,0,(short)0).when(null).to(a -> a.mustEx(Be::equalEx, false))
            .doesTest(5,5,(short)5).when(null).to(a -> a.mustEx(Be::equalEx, true))
        ;
