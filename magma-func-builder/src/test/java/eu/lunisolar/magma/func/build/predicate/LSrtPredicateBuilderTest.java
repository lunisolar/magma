...
import static eu.lunisolar.magma.func.build.predicate.LSrtPredicateBuilder.srtPredicate;
import static eu.lunisolar.magma.func.build.predicate.LSrtPredicateBuilder.srtPredicateFrom;

public class LSrtPredicateBuilderTest{
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestSrtPred(function)
            .doesTest((short)0).when(null).to(a -> a.mustEx(Be::equalEx, false))
            .doesTest((short)5).when(null).to(a -> a.mustEx(Be::equalEx, true))
        ;
