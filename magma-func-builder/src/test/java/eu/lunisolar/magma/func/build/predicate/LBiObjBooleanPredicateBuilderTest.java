...
public class LBiObjBooleanPredicateBuilderTest<T1,T2,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LBiObjBooleanPredicate function = LBiObjBooleanPredicateBuilder.biObjBooleanPredicate()
                .build();
