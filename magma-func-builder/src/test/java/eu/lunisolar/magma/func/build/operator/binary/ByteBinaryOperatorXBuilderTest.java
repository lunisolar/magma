...
import static eu.lunisolar.magma.func.build.operator.binary.ByteBinaryOperatorXBuilder.byteBinaryOperatorX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ByteBinaryOperatorXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ByteBinaryOperatorX function = ByteBinaryOperatorXBuilder
                .byteBinaryOperatorX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ByteBinaryOperatorX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ByteBinaryOperatorX<ParseException> function = byteBinaryOperatorX((ByteBinaryOperatorX<ParseException> f)-> doNothing())
