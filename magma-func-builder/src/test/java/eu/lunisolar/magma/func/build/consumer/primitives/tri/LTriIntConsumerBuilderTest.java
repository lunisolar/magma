...
import static eu.lunisolar.magma.func.build.consumer.primitives.tri.LTriIntConsumerBuilder.triIntConsumer;
import static eu.lunisolar.magma.func.build.consumer.primitives.tri.LTriIntConsumerBuilder.triIntConsumerFrom;

public class LTriIntConsumerBuilderTest{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LTriIntConsumer function = triIntConsumerFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestTriIntCons(function)
