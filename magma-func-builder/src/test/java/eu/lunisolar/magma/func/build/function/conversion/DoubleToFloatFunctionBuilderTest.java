...
import static eu.lunisolar.magma.func.build.function.conversion.DoubleToFloatFunctionBuilder.doubleToFloatFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class DoubleToFloatFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            DoubleToFloatFunction function = DoubleToFloatFunctionBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(DoubleToFloatFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        DoubleToFloatFunction function = doubleToFloatFunction((DoubleToFloatFunction f)-> doNothing())
