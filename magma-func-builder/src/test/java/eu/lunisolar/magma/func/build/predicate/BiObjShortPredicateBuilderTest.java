...
import static eu.lunisolar.magma.func.build.predicate.BiObjShortPredicateBuilder.biObjShortPredicate;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiObjShortPredicateBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiObjShortPredicate function = BiObjShortPredicateBuilder
                .biObjShortPredicate()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiObjShortPredicate.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BiObjShortPredicate<Integer ,Integer > function = biObjShortPredicate((BiObjShortPredicate<Integer ,Integer > f)-> doNothing())
