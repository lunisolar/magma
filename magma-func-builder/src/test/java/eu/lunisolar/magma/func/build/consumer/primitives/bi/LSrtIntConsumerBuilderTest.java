...
public class LSrtIntConsumerBuilderTest{
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestSrtIntCons(function)
            .doesAccept((short)0,0).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 0))
            .doesAccept((short)5,5).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 1))
            .doesAccept((short)15,15).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 2))
            .doesAccept((short)10,10).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 99))
        ;
