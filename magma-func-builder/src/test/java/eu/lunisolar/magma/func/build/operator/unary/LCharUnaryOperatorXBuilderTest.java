...
import static eu.lunisolar.magma.func.build.operator.unary.LCharUnaryOperatorXBuilder.charUnaryOperatorX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LCharUnaryOperatorXBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LCharUnaryOperatorX function = LCharUnaryOperatorXBuilder.charUnaryOperatorX()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LCharUnaryOperatorX.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LCharUnaryOperatorX<ParseException> function = charUnaryOperatorX((LCharUnaryOperatorX<ParseException> f)-> doNothing())
