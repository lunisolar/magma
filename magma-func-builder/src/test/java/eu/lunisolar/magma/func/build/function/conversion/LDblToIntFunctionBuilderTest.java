...
import static eu.lunisolar.magma.func.build.function.conversion.LDblToIntFunctionBuilder.dblToIntFunction;
import static eu.lunisolar.magma.func.build.function.conversion.LDblToIntFunctionBuilder.dblToIntFunctionFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LDblToIntFunctionBuilderTest{
    ...
    public void testOtherwiseThrow()  {
        ...
        assertThatThrownBy(() -> {
            LDblToIntFunction function = dblToIntFunctionFrom(b-> b
                .build()
            );
