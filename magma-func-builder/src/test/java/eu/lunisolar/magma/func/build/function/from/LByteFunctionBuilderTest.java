...
public class LByteFunctionBuilderTest<R,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LByteFunction function = LByteFunctionBuilder.byteFunction()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LByteFunction.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LByteFunction<Integer > function = byteFunction((LByteFunction<Integer > f)-> doNothing())
