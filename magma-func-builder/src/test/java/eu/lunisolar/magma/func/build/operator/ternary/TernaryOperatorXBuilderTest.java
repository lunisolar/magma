...
import static eu.lunisolar.magma.func.build.operator.ternary.TernaryOperatorXBuilder.ternaryOperatorX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class TernaryOperatorXBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            TernaryOperatorX function = TernaryOperatorXBuilder
                .ternaryOperatorX()
                .build();

            function.apply((T)Integer.valueOf(100),(T)Integer.valueOf(100),(T)Integer.valueOf(100));
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(TernaryOperatorX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        TernaryOperatorX<Integer ,ParseException> function = ternaryOperatorX((TernaryOperatorX<Integer ,ParseException> f)-> doNothing())
