...
public class LBiByteFunctionXBuilderTest<R,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LBiByteFunctionX function = LBiByteFunctionXBuilder.biByteFunctionX()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LBiByteFunctionX.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LBiByteFunctionX<Integer ,ParseException> function = biByteFunctionX((LBiByteFunctionX<Integer ,ParseException> f)-> doNothing())
