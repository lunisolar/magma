...
import static eu.lunisolar.magma.func.build.supplier.ShortSupplierXBuilder.shortSupplierX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ShortSupplierXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ShortSupplierX function = ShortSupplierXBuilder
                .shortSupplierX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ShortSupplierX.DESCRIPTION);
