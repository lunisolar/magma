...
import static eu.lunisolar.magma.func.build.function.conversion.LSrtToIntFunctionBuilder.srtToIntFunction;
import static eu.lunisolar.magma.func.build.function.conversion.LSrtToIntFunctionBuilder.srtToIntFunctionFrom;

public class LSrtToIntFunctionBuilderTest{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LSrtToIntFunction function = srtToIntFunctionFrom(b-> b
                .build()
            );

            function.applyAsInt((short)100);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestSrtToIntFunc(function)
            .doesApplyAsInt((short)0).when(null).to(a -> a.mustEx(Be::equalEx, 0))
            .doesApplyAsInt((short)5).when(null).to(a -> a.mustEx(Be::equalEx, 1))
            .doesApplyAsInt((short)15).when(null).to(a -> a.mustEx(Be::equalEx, 2))
            .doesApplyAsInt((short)10).when(null).to(a -> a.mustEx(Be::equalEx, 99))
        ;
