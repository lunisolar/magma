...
import static eu.lunisolar.magma.func.build.predicate.ShortPredicateXBuilder.shortPredicateX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ShortPredicateXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ShortPredicateX function = ShortPredicateXBuilder
                .shortPredicateX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ShortPredicateX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ShortPredicateX<ParseException> function = shortPredicateX((ShortPredicateX<ParseException> f)-> doNothing())
