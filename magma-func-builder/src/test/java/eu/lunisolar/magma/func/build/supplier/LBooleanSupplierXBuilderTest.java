...
import static eu.lunisolar.magma.func.build.supplier.LBooleanSupplierXBuilder.booleanSupplierX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBooleanSupplierXBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LBooleanSupplierX function = LBooleanSupplierXBuilder.booleanSupplierX()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LBooleanSupplierX.DESCRIPTION);
    }
