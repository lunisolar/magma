...
import static eu.lunisolar.magma.func.build.function.conversion.ShortToByteFunctionXBuilder.shortToByteFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ShortToByteFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ShortToByteFunctionX function = ShortToByteFunctionXBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ShortToByteFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ShortToByteFunctionX<ParseException> function = shortToByteFunctionX((ShortToByteFunctionX<ParseException> f)-> doNothing())
