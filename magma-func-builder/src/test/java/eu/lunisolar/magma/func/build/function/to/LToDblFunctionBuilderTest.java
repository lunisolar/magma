...
import static eu.lunisolar.magma.func.build.function.to.LToDblFunctionBuilder.toDblFunction;
import static eu.lunisolar.magma.func.build.function.to.LToDblFunctionBuilder.toDblFunctionFrom;
...
public class LToDblFunctionBuilderTest<T>{
    ...
    public void testOtherwiseThrow()  {
        ...
        try {
            LToDblFunction<Integer> function = toDblFunctionFrom(b-> b
                .build()
            );
