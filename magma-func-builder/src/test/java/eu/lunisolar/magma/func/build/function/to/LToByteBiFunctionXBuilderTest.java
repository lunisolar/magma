...
import static eu.lunisolar.magma.func.build.function.to.LToByteBiFunctionXBuilder.toByteBiFunctionXFrom;
...
public class LToByteBiFunctionXBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LToByteBiFunctionX<Integer,Integer,X> function = toByteBiFunctionXFrom(b-> b
                .build()
            );

            function.doApplyAsByte(100,100);
