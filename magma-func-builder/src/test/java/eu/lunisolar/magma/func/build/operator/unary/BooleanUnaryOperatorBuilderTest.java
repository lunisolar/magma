...
import static eu.lunisolar.magma.func.build.operator.unary.BooleanUnaryOperatorBuilder.booleanUnaryOperator;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BooleanUnaryOperatorBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BooleanUnaryOperator function = BooleanUnaryOperatorBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BooleanUnaryOperator.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BooleanUnaryOperator function = booleanUnaryOperator((BooleanUnaryOperator f)-> doNothing())
