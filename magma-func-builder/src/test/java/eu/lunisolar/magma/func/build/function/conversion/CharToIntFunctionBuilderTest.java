...
import static eu.lunisolar.magma.func.build.function.conversion.CharToIntFunctionBuilder.charToIntFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class CharToIntFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            CharToIntFunction function = CharToIntFunctionBuilder
                .charToIntFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(CharToIntFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        CharToIntFunction function = charToIntFunction((CharToIntFunction f)-> doNothing())
