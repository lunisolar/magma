...
import static eu.lunisolar.magma.func.build.consumer.primitives.BooleanConsumerBuilder.booleanConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BooleanConsumerBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BooleanConsumer function = BooleanConsumerBuilder
                .booleanConsumer()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BooleanConsumer.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BooleanConsumer function = booleanConsumer((BooleanConsumer f)-> doNothing())
