...
import static eu.lunisolar.magma.func.build.predicate.LObjShortPredicateBuilder.objShortPredicateFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LObjShortPredicateBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LObjShortPredicate<Integer> function = objShortPredicateFrom(b-> b
                .build()
            );

            function.doTest(100,(short)100);
