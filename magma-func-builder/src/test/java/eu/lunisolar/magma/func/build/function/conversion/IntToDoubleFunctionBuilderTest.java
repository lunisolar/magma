...
import static eu.lunisolar.magma.func.build.function.conversion.IntToDoubleFunctionBuilder.intToDoubleFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class IntToDoubleFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            IntToDoubleFunction function = IntToDoubleFunctionBuilder
                .intToDoubleFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(IntToDoubleFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        IntToDoubleFunction function = intToDoubleFunction((IntToDoubleFunction f)-> doNothing())
