...
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.LongBiConsumerXBuilder.longBiConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LongBiConsumerXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LongBiConsumerX function = LongBiConsumerXBuilder
                .longBiConsumerX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LongBiConsumerX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        LongBiConsumerX<ParseException> function = longBiConsumerX((LongBiConsumerX<ParseException> f)-> doNothing())
