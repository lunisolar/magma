...
import static eu.lunisolar.magma.func.build.supplier.LFloatSupplierXBuilder.floatSupplierX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LFloatSupplierXBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LFloatSupplierX function = LFloatSupplierXBuilder.floatSupplierX()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LFloatSupplierX.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LFloatSupplierX<ParseException> function = floatSupplierX((LFloatSupplierX<ParseException> f)-> doNothing())
