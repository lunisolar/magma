...
import static eu.lunisolar.magma.func.build.function.conversion.BooleanToShortFunctionBuilder.booleanToShortFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BooleanToShortFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BooleanToShortFunction function = BooleanToShortFunctionBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BooleanToShortFunction.DESCRIPTION);
