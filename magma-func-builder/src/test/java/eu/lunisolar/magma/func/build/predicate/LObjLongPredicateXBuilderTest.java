...
import static eu.lunisolar.magma.func.build.predicate.LObjLongPredicateXBuilder.objLongPredicateXFrom;
...
public class LObjLongPredicateXBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LObjLongPredicateX<Integer,X> function = objLongPredicateXFrom(b-> b
                .build()
            );

            function.doTest(100,100L);
