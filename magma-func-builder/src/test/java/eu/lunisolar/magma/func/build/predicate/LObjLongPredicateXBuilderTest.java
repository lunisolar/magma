...
import static eu.lunisolar.magma.func.build.predicate.LObjLongPredicateXBuilder.objLongPredicateX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LObjLongPredicateXBuilderTest<T,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LObjLongPredicateX function = LObjLongPredicateXBuilder.objLongPredicateX()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LObjLongPredicateX.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LObjLongPredicateX<Integer ,ParseException> function = objLongPredicateX((LObjLongPredicateX<Integer ,ParseException> f)-> doNothing())
