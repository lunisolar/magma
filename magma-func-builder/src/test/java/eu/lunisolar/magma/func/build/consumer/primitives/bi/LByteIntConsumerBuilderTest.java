...
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.LByteIntConsumerBuilder.byteIntConsumer;
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.LByteIntConsumerBuilder.byteIntConsumerFrom;

public class LByteIntConsumerBuilderTest{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LByteIntConsumer function = byteIntConsumerFrom(b-> b
                .build()
            );

            function.accept((byte)100,100);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestByteIntCons(function)
            .doesAccept((byte)0,0).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 0))
            .doesAccept((byte)5,5).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 1))
            .doesAccept((byte)15,15).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 2))
            .doesAccept((byte)10,10).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 99))
        ;
