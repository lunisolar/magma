...
import static eu.lunisolar.magma.func.build.function.to.ToByteFunctionBuilder.toByteFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ToByteFunctionBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ToByteFunction function = ToByteFunctionBuilder
                .toByteFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ToByteFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ToByteFunction<Integer > function = toByteFunction((ToByteFunction<Integer > f)-> doNothing())
