...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LObjFloatConsumerBuilder.objFloatConsumerFrom;
...
public class LObjFloatConsumerBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LObjFloatConsumer<Integer> function = objFloatConsumerFrom(b-> b
                .build()
            );
