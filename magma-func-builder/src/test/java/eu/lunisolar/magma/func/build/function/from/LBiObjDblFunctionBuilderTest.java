...
import static eu.lunisolar.magma.func.build.function.from.LBiObjDblFunctionBuilder.biObjDblFunction;
import static eu.lunisolar.magma.func.build.function.from.LBiObjDblFunctionBuilder.biObjDblFunctionFrom;

public class LBiObjDblFunctionBuilderTest<T1,T2,R>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LBiObjDblFunction<Integer,Integer,Integer> function = biObjDblFunctionFrom(b-> b
                .build()
            );

            function.apply(100,100,100d);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestBiObjDblFunc(function)
            .doesApply(0,0,0d).when(null).to(a -> a.mustEx(Be::equalEx, 0))
            .doesApply(5,5,5d).when(null).to(a -> a.mustEx(Be::equalEx, 1))
            .doesApply(15,15,15d).when(null).to(a -> a.mustEx(Be::equalEx, 2))
            .doesApply(10,10,10d).when(null).to(a -> a.mustEx(Be::equalEx, 99))
        ;
