...
import static eu.lunisolar.magma.func.build.predicate.BiBytePredicateXBuilder.biBytePredicateX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiBytePredicateXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiBytePredicateX function = BiBytePredicateXBuilder
                .biBytePredicateX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiBytePredicateX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BiBytePredicateX<ParseException> function = biBytePredicateX((BiBytePredicateX<ParseException> f)-> doNothing())
