...
import static eu.lunisolar.magma.func.build.function.conversion.BooleanToDoubleFunctionXBuilder.booleanToDoubleFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BooleanToDoubleFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BooleanToDoubleFunctionX function = BooleanToDoubleFunctionXBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BooleanToDoubleFunctionX.DESCRIPTION);
