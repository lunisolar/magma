...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.ObjShortConsumerBuilder.objShortConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjShortConsumerBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjShortConsumer function = ObjShortConsumerBuilder
                .objShortConsumer()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjShortConsumer.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ObjShortConsumer<Integer > function = objShortConsumer((ObjShortConsumer<Integer > f)-> doNothing())
