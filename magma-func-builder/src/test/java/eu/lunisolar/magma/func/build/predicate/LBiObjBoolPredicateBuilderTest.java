...
import static eu.lunisolar.magma.func.build.predicate.LBiObjBoolPredicateBuilder.biObjBoolPredicate;
import static eu.lunisolar.magma.func.build.predicate.LBiObjBoolPredicateBuilder.biObjBoolPredicateFrom;

public class LBiObjBoolPredicateBuilderTest<T1,T2>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LBiObjBoolPredicate<Integer,Integer> function = biObjBoolPredicateFrom(b-> b
                .build()
            );

            function.test(100,100,true);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestBiObjBoolPred(function)
            .doesTest(0,0,false).when(null).to(a -> a.mustEx(Be::equalEx, false))
            .doesTest(5,5,true).when(null).to(a -> a.mustEx(Be::equalEx, true))
        ;
