...
import static eu.lunisolar.magma.func.build.predicate.LTriDblPredicateBuilder.triDblPredicate;
import static eu.lunisolar.magma.func.build.predicate.LTriDblPredicateBuilder.triDblPredicateFrom;

public class LTriDblPredicateBuilderTest{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LTriDblPredicate function = triDblPredicateFrom(b-> b
                .build()
            );

            function.test(100d,100d,100d);
    ...
    public void testBuild()  {
        ...
        LTriDblPredicate function = triDblPredicateFrom( b -> b
            ...
            .inCase((a1,a2,a3) -> a1 > 0d && a1 < 10d).evaluate((a1,a2,a3) -> true)
            .inCase((a1,a2,a3) -> a1 > 10d && a1 < 20d).evaluate((a1,a2,a3) -> true)
            .otherwise((a1,a2,a3) -> true)
            .build()
        );


        FuncAttests.attestTriDblPred(function)
            .doesTest(0d,0d,0d).when(null).to(a -> a.mustEx(Be::equalEx, false))
            .doesTest(5d,5d,5d).when(null).to(a -> a.mustEx(Be::equalEx, true))
        ;
