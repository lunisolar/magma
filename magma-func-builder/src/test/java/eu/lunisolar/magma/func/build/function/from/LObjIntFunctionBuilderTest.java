...
import static eu.lunisolar.magma.func.build.function.from.LObjIntFunctionBuilder.objIntFunctionFrom;
...
public class LObjIntFunctionBuilderTest<T,R,X extends ParseException>{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LObjIntFunction<Integer,Integer> function = objIntFunctionFrom(b-> b
                .build()
            );
