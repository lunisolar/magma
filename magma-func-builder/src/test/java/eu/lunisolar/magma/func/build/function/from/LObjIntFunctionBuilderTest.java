...
import static eu.lunisolar.magma.func.build.function.from.LObjIntFunctionBuilder.objIntFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LObjIntFunctionBuilderTest<T,R,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LObjIntFunction function = LObjIntFunctionBuilder.objIntFunction()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LObjIntFunction.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LObjIntFunction<Integer ,Integer > function = objIntFunction((LObjIntFunction<Integer ,Integer > f)-> doNothing())
