...
import static eu.lunisolar.magma.func.build.function.conversion.LongToFloatFunctionXBuilder.longToFloatFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LongToFloatFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LongToFloatFunctionX function = LongToFloatFunctionXBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LongToFloatFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        LongToFloatFunctionX<ParseException> function = longToFloatFunctionX((LongToFloatFunctionX<ParseException> f)-> doNothing())
