...
import static eu.lunisolar.magma.func.build.operator.unary.LLogicalOperatorXBuilder.logicalOperatorX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LLogicalOperatorXBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LLogicalOperatorX function = LLogicalOperatorXBuilder.logicalOperatorX()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LLogicalOperatorX.DESCRIPTION);
    }
