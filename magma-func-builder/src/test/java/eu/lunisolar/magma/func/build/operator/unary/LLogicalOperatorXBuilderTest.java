...
import static eu.lunisolar.magma.func.build.operator.unary.LLogicalOperatorXBuilder.logicalOperatorXFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LLogicalOperatorXBuilderTest<X extends ParseException>{
