...
public class LFloatToCharFunctionBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LFloatToCharFunction function = LFloatToCharFunctionBuilder.floatToCharFunction()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LFloatToCharFunction.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LFloatToCharFunction function = floatToCharFunction((LFloatToCharFunction f)-> doNothing())
