...
import static eu.lunisolar.magma.func.build.operator.binary.FloatBinaryOperatorXBuilder.floatBinaryOperatorX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class FloatBinaryOperatorXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            FloatBinaryOperatorX function = FloatBinaryOperatorXBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(FloatBinaryOperatorX.DESCRIPTION);
