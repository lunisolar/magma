...
import static eu.lunisolar.magma.func.build.operator.unary.FloatUnaryOperatorBuilder.floatUnaryOperator;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class FloatUnaryOperatorBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            FloatUnaryOperator function = FloatUnaryOperatorBuilder
                .floatUnaryOperator()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(FloatUnaryOperator.DESCRIPTION);
