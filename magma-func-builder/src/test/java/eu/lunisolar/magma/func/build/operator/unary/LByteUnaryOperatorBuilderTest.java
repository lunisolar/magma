...
public class LByteUnaryOperatorBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LByteUnaryOperator function = LByteUnaryOperatorBuilder.byteUnaryOperator()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LByteUnaryOperator.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LByteUnaryOperator function = byteUnaryOperator((LByteUnaryOperator f)-> doNothing())
