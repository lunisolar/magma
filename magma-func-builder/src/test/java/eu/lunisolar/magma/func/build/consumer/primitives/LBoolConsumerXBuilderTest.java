...
public class LBoolConsumerXBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LBoolConsumerX function = LBoolConsumerXBuilder.boolConsumerX()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LBoolConsumerX.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LBoolConsumerX<ParseException> function = boolConsumerX((LBoolConsumerX<ParseException> f)-> doNothing())
