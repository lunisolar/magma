...
import static eu.lunisolar.magma.func.build.function.from.ObjBooleanFunctionXBuilder.objBooleanFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjBooleanFunctionXBuilderTest<T,R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjBooleanFunctionX function = ObjBooleanFunctionXBuilder
                .objBooleanFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjBooleanFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ObjBooleanFunctionX<Integer ,Integer ,ParseException> function = objBooleanFunctionX((ObjBooleanFunctionX<Integer ,Integer ,ParseException> f)-> doNothing())
