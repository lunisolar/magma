...
import static eu.lunisolar.magma.func.build.function.from.ObjFloatFunctionXBuilder.objFloatFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjFloatFunctionXBuilderTest<T,R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjFloatFunctionX function = ObjFloatFunctionXBuilder
                .objFloatFunctionX()
                .build();

            function.apply((T)Integer.valueOf(100),(float)100);
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjFloatFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ObjFloatFunctionX<Integer ,Integer ,ParseException> function = objFloatFunctionX((ObjFloatFunctionX<Integer ,Integer ,ParseException> f)-> doNothing())
