...
import static eu.lunisolar.magma.func.build.function.conversion.CharToDoubleFunctionBuilder.charToDoubleFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class CharToDoubleFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            CharToDoubleFunction function = CharToDoubleFunctionBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(CharToDoubleFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        CharToDoubleFunction function = charToDoubleFunction((CharToDoubleFunction f)-> doNothing())
