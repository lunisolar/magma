...
import static eu.lunisolar.magma.func.build.operator.binary.ShortBinaryOperatorXBuilder.shortBinaryOperatorX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ShortBinaryOperatorXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ShortBinaryOperatorX function = ShortBinaryOperatorXBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ShortBinaryOperatorX.DESCRIPTION);
