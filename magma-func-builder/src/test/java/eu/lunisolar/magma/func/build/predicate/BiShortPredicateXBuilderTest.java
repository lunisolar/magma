...
import static eu.lunisolar.magma.func.build.predicate.BiShortPredicateXBuilder.biShortPredicateX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiShortPredicateXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiShortPredicateX function = BiShortPredicateXBuilder
                .biShortPredicateX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiShortPredicateX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BiShortPredicateX<ParseException> function = biShortPredicateX((BiShortPredicateX<ParseException> f)-> doNothing())
