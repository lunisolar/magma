...
public class LBiObjBooleanConsumerBuilderTest<T1,T2,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LBiObjBooleanConsumer function = LBiObjBooleanConsumerBuilder.biObjBooleanConsumer()
                .build();
