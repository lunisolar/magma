...
import static eu.lunisolar.magma.func.build.predicate.LDblIntPredicateBuilder.dblIntPredicate;
import static eu.lunisolar.magma.func.build.predicate.LDblIntPredicateBuilder.dblIntPredicateFrom;
...
public class LDblIntPredicateBuilderTest{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LDblIntPredicate function = dblIntPredicateFrom(b-> b
                .build()
            );

            function.doTest(100d,100);
