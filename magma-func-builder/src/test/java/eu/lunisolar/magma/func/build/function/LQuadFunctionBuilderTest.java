...
import static eu.lunisolar.magma.func.build.function.LQuadFunctionBuilder.quadFunction;
import static eu.lunisolar.magma.func.build.function.LQuadFunctionBuilder.quadFunctionFrom;

public class LQuadFunctionBuilderTest<T1,T2,T3,T4,R>{
    ...
    public void testOtherwiseThrow()  {
        ...
        try {
            ...
            function.apply(100,100,100,100);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestQuadFunc(function)
            .doesApply(0,0,0,0).when(null).to(a -> a.mustEx(Be::equalEx, 0))
            .doesApply(5,5,5,5).when(null).to(a -> a.mustEx(Be::equalEx, 1))
            .doesApply(15,15,15,15).when(null).to(a -> a.mustEx(Be::equalEx, 2))
            .doesApply(10,10,10,10).when(null).to(a -> a.mustEx(Be::equalEx, 99))
        ;
