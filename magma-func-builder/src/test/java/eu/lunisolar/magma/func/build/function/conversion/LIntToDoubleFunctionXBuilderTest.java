...
import static eu.lunisolar.magma.func.build.function.conversion.LIntToDoubleFunctionXBuilder.intToDoubleFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LIntToDoubleFunctionXBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LIntToDoubleFunctionX.DESCRIPTION);
    }
