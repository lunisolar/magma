...
import static eu.lunisolar.magma.func.build.function.conversion.LIntToDoubleFunctionXBuilder.intToDoubleFunctionXFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LIntToDoubleFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LIntToDoubleFunctionX<X> function = intToDoubleFunctionXFrom(b-> b
                .build()
            );

            function.doApplyAsDouble(100);
