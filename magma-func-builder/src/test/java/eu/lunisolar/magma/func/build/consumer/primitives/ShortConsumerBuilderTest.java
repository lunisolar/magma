...
import static eu.lunisolar.magma.func.build.consumer.primitives.ShortConsumerBuilder.shortConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ShortConsumerBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ShortConsumer function = ShortConsumerBuilder
                .shortConsumer()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ShortConsumer.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ShortConsumer function = shortConsumer((ShortConsumer f)-> doNothing())
