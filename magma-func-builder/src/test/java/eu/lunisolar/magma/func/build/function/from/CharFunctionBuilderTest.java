...
import static eu.lunisolar.magma.func.build.function.from.CharFunctionBuilder.charFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class CharFunctionBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            CharFunction function = CharFunctionBuilder
                .charFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(CharFunction.DESCRIPTION);
