...
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.LongBiConsumerBuilder.longBiConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LongBiConsumerBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LongBiConsumer function = LongBiConsumerBuilder
                .longBiConsumer()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LongBiConsumer.DESCRIPTION);
