...
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.LLongIntConsumerBuilder.longIntConsumer;
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.LLongIntConsumerBuilder.longIntConsumerFrom;

public class LLongIntConsumerBuilderTest{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LLongIntConsumer function = longIntConsumerFrom(b-> b
                .build()
            );

            function.accept(100L,100);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestLongIntCons(function)
            .doesAccept(0L,0).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 0))
            .doesAccept(5L,5).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 1))
            .doesAccept(15L,15).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 2))
            .doesAccept(10L,10).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 99))
        ;
