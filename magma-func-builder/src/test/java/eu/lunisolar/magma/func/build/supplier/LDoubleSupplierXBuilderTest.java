...
public class LDoubleSupplierXBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LDoubleSupplierX function = LDoubleSupplierXBuilder.doubleSupplierX()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LDoubleSupplierX.DESCRIPTION);
    }
