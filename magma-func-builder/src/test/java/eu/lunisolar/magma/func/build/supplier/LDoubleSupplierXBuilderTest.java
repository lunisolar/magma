...
import static eu.lunisolar.magma.func.build.supplier.LDoubleSupplierXBuilder.doubleSupplierX;
import static eu.lunisolar.magma.func.build.supplier.LDoubleSupplierXBuilder.doubleSupplierXFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LDoubleSupplierXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LDoubleSupplierX<X> function = doubleSupplierXFrom(b-> b
                .build()
            );
