...
import static eu.lunisolar.magma.func.build.operator.ternary.TernaryOperatorBuilder.ternaryOperator;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class TernaryOperatorBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            TernaryOperator function = TernaryOperatorBuilder
                .ternaryOperator()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(TernaryOperator.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        TernaryOperator<Integer > function = ternaryOperator((TernaryOperator<Integer > f)-> doNothing())
