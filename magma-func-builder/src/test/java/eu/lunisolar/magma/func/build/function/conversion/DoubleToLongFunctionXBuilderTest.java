...
import static eu.lunisolar.magma.func.build.function.conversion.DoubleToLongFunctionXBuilder.doubleToLongFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class DoubleToLongFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            DoubleToLongFunctionX function = DoubleToLongFunctionXBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(DoubleToLongFunctionX.DESCRIPTION);
