...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.BiObjIntConsumerBuilder.biObjIntConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiObjIntConsumerBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiObjIntConsumer function = BiObjIntConsumerBuilder
                .biObjIntConsumer()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiObjIntConsumer.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BiObjIntConsumer<Integer ,Integer > function = biObjIntConsumer((BiObjIntConsumer<Integer ,Integer > f)-> doNothing())
