...
import static eu.lunisolar.magma.func.build.operator.unary.IntUnaryOperatorBuilder.intUnaryOperator;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class IntUnaryOperatorBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(IntUnaryOperator.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        IntUnaryOperator function = intUnaryOperator((IntUnaryOperator f)-> doNothing())
