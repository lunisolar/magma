...
import static eu.lunisolar.magma.func.build.supplier.LDblSupplierBuilder.dblSupplier;
import static eu.lunisolar.magma.func.build.supplier.LDblSupplierBuilder.dblSupplierFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LDblSupplierBuilderTest{
    ...
    public void testOtherwiseThrow()  {
        ...
        assertThatThrownBy(() -> {
            LDblSupplier function = dblSupplierFrom(b-> b
                .build()
            );
