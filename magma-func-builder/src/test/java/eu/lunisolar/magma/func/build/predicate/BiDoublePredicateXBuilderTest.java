...
import static eu.lunisolar.magma.func.build.predicate.BiDoublePredicateXBuilder.biDoublePredicateX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiDoublePredicateXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiDoublePredicateX function = BiDoublePredicateXBuilder
                .biDoublePredicateX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiDoublePredicateX.DESCRIPTION);
