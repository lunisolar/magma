...
import static eu.lunisolar.magma.func.build.predicate.BiFloatPredicateBuilder.biFloatPredicate;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiFloatPredicateBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiFloatPredicate function = BiFloatPredicateBuilder
                .biFloatPredicate()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiFloatPredicate.DESCRIPTION);
