...
import static eu.lunisolar.magma.func.build.predicate.IntPredicateXBuilder.intPredicateX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class IntPredicateXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            IntPredicateX function = IntPredicateXBuilder
                .intPredicateX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(IntPredicateX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        IntPredicateX<ParseException> function = intPredicateX((IntPredicateX<ParseException> f)-> doNothing())
