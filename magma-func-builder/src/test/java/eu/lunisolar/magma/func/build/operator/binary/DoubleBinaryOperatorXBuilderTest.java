...
import static eu.lunisolar.magma.func.build.operator.binary.DoubleBinaryOperatorXBuilder.doubleBinaryOperatorX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class DoubleBinaryOperatorXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            DoubleBinaryOperatorX function = DoubleBinaryOperatorXBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(DoubleBinaryOperatorX.DESCRIPTION);
