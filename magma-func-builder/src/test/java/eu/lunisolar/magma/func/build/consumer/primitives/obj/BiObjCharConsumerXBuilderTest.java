...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.BiObjCharConsumerXBuilder.biObjCharConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiObjCharConsumerXBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiObjCharConsumerX function = BiObjCharConsumerXBuilder
                .biObjCharConsumerX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiObjCharConsumerX.DESCRIPTION);
