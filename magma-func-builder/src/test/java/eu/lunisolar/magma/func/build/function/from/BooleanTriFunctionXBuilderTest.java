...
import static eu.lunisolar.magma.func.build.function.from.BooleanTriFunctionXBuilder.booleanTriFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BooleanTriFunctionXBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BooleanTriFunctionX function = BooleanTriFunctionXBuilder
                .booleanTriFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BooleanTriFunctionX.DESCRIPTION);
