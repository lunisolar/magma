...
import static eu.lunisolar.magma.func.build.function.from.LBiObjShortFunctionBuilder.biObjShortFunctionFrom;
...
public class LBiObjShortFunctionBuilderTest<T1,T2,R,X extends ParseException>{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LBiObjShortFunction<Integer,Integer,Integer> function = biObjShortFunctionFrom(b-> b
                .build()
            );
