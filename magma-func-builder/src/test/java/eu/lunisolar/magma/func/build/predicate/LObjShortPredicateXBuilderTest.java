...
import static eu.lunisolar.magma.func.build.predicate.LObjShortPredicateXBuilder.objShortPredicateXFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LObjShortPredicateXBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LObjShortPredicateX<Integer,X> function = objShortPredicateXFrom(b-> b
                .build()
            );
