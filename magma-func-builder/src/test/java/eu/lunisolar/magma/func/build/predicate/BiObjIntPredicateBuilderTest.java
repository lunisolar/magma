...
import static eu.lunisolar.magma.func.build.predicate.BiObjIntPredicateBuilder.biObjIntPredicate;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiObjIntPredicateBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiObjIntPredicate function = BiObjIntPredicateBuilder
                .biObjIntPredicate()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiObjIntPredicate.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BiObjIntPredicate<Integer ,Integer > function = biObjIntPredicate((BiObjIntPredicate<Integer ,Integer > f)-> doNothing())
