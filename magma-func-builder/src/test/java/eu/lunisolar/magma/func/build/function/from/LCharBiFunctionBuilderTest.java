...
import static eu.lunisolar.magma.func.build.function.from.LCharBiFunctionBuilder.charBiFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LCharBiFunctionBuilderTest<R,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws Throwable {
        ...
        assertThatThrownBy(() -> {
            LCharBiFunction function = LCharBiFunctionBuilder.charBiFunction()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LCharBiFunction.DESCRIPTION);
    }
    ...
    public void testBuild() throws Throwable {
        ...
        LCharBiFunction<Integer > function = charBiFunction((LCharBiFunction<Integer > f)-> doNothing())
