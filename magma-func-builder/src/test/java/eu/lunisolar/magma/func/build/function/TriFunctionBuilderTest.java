...
import static eu.lunisolar.magma.func.build.function.TriFunctionBuilder.triFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class TriFunctionBuilderTest<T1,T2,T3,R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            TriFunction function = TriFunctionBuilder
                .triFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(TriFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        TriFunction<Integer ,Integer ,Integer ,Integer > function = triFunction((TriFunction<Integer ,Integer ,Integer ,Integer > f)-> doNothing())
