...
import static eu.lunisolar.magma.func.build.function.conversion.LByteToShortFunctionXBuilder.byteToShortFunctionXFrom;
...
public class LByteToShortFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LByteToShortFunctionX<X> function = byteToShortFunctionXFrom(b-> b
                .build()
            );
