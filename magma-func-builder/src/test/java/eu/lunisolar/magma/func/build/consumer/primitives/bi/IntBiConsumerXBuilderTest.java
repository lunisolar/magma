...
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.IntBiConsumerXBuilder.intBiConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class IntBiConsumerXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            IntBiConsumerX function = IntBiConsumerXBuilder
                .intBiConsumerX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(IntBiConsumerX.DESCRIPTION);
