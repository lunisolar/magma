...
import static eu.lunisolar.magma.func.build.function.conversion.LongToCharFunctionBuilder.longToCharFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LongToCharFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LongToCharFunction function = LongToCharFunctionBuilder
                .longToCharFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LongToCharFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        LongToCharFunction function = longToCharFunction((LongToCharFunction f)-> doNothing())
