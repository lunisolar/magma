...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.ObjIntConsumerBuilder.objIntConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjIntConsumerBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjIntConsumer function = ObjIntConsumerBuilder
                .objIntConsumer()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjIntConsumer.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ObjIntConsumer<Integer > function = objIntConsumer((ObjIntConsumer<Integer > f)-> doNothing())
