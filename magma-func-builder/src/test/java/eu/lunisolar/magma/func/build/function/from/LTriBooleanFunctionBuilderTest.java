...
import static eu.lunisolar.magma.func.build.function.from.LTriBooleanFunctionBuilder.triBooleanFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LTriBooleanFunctionBuilderTest<R,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LTriBooleanFunction function = LTriBooleanFunctionBuilder.triBooleanFunction()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LTriBooleanFunction.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LTriBooleanFunction<Integer > function = triBooleanFunction((LTriBooleanFunction<Integer > f)-> doNothing())
