...
import static eu.lunisolar.magma.func.build.function.conversion.ByteToDoubleFunctionXBuilder.byteToDoubleFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ByteToDoubleFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ByteToDoubleFunctionX function = ByteToDoubleFunctionXBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ByteToDoubleFunctionX.DESCRIPTION);
