...
import static eu.lunisolar.magma.func.build.function.from.LDoubleFunctionBuilder.doubleFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LDoubleFunctionBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LDoubleFunction function = LDoubleFunctionBuilder
                .doubleFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LDoubleFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        LDoubleFunction<Integer > function = doubleFunction((LDoubleFunction<Integer > f)-> doNothing())
