...
import static eu.lunisolar.magma.func.build.function.from.LDoubleFunctionBuilder.doubleFunctionFrom;
...
public class LDoubleFunctionBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LDoubleFunction<Integer> function = doubleFunctionFrom(b-> b
                .build()
            );
