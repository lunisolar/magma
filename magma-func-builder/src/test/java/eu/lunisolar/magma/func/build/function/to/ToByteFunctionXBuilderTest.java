...
import static eu.lunisolar.magma.func.build.function.to.ToByteFunctionXBuilder.toByteFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ToByteFunctionXBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ToByteFunctionX function = ToByteFunctionXBuilder
                .toByteFunctionX()
                .build();

            function.applyAsByte((T)Integer.valueOf(100));
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ToByteFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ToByteFunctionX<Integer ,ParseException> function = toByteFunctionX((ToByteFunctionX<Integer ,ParseException> f)-> doNothing())
            .addCase(ce -> ce.of((t) -> t == Integer.valueOf(0))
                             .evaluate((t) -> (byte)0))
            .inCase((t) -> t > 0 && t < 10).evaluate((t) -> (byte)1)
            .inCase((t) -> t > 10 && t < 20).evaluate((t) -> (byte)2)
            .eventually((t) -> (byte)99)
            .build();
