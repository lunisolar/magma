...
import static eu.lunisolar.magma.func.build.function.conversion.IntToCharFunctionBuilder.intToCharFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class IntToCharFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            IntToCharFunction function = IntToCharFunctionBuilder
                .intToCharFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(IntToCharFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        IntToCharFunction function = intToCharFunction((IntToCharFunction f)-> doNothing())
