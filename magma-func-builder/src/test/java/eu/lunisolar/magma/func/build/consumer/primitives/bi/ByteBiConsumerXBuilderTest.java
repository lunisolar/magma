...
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.ByteBiConsumerXBuilder.byteBiConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ByteBiConsumerXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ByteBiConsumerX function = ByteBiConsumerXBuilder
                .byteBiConsumerX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ByteBiConsumerX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ByteBiConsumerX<ParseException> function = byteBiConsumerX((ByteBiConsumerX<ParseException> f)-> doNothing())
