...
import static eu.lunisolar.magma.func.build.function.conversion.LIntToDblFunctionBuilder.intToDblFunction;
import static eu.lunisolar.magma.func.build.function.conversion.LIntToDblFunctionBuilder.intToDblFunctionFrom;

public class LIntToDblFunctionBuilderTest{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LIntToDblFunction function = intToDblFunctionFrom(b-> b
                .build()
            );

            function.applyAsDbl(100);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestIntToDblFunc(function)
            .doesApplyAsDbl(0).when(null).to(a -> a.mustEx(Be::equalEx, 0d))
            .doesApplyAsDbl(5).when(null).to(a -> a.mustEx(Be::equalEx, 1d))
            .doesApplyAsDbl(15).when(null).to(a -> a.mustEx(Be::equalEx, 2d))
            .doesApplyAsDbl(10).when(null).to(a -> a.mustEx(Be::equalEx, 99d))
        ;
