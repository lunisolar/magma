...
import static eu.lunisolar.magma.func.build.function.from.ShortFunctionBuilder.shortFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ShortFunctionBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ShortFunction function = ShortFunctionBuilder
                .shortFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ShortFunction.DESCRIPTION);
