...
import static eu.lunisolar.magma.func.build.function.from.LBiBoolFunctionBuilder.biBoolFunctionFrom;

public class LBiBoolFunctionBuilderTest<R>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LBiBoolFunction<Integer> function = biBoolFunctionFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        LBiBoolFunction<Integer> function = biBoolFunctionFrom( b -> b
            .aCase(ce -> ce.of((a1,a2) -> a1 == false)
                             .evaluate((a1,a2) -> 0))
            .inCase((a1,a2) -> a1 == true ).evaluate((a1,a2) -> 1)
            .otherwise((a1,a2) -> 99)
            .build()
        );


        FuncAttests.attestBiBoolFunc(function)
            .doesApply(false,false).when(null).to(a -> a.mustEx(Be::equalEx, 0))
            .doesApply(true,true).when(null).to(a -> a.mustEx(Be::equalEx, 1))
        ;
