...
import static eu.lunisolar.magma.func.build.consumer.primitives.FloatConsumerXBuilder.floatConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class FloatConsumerXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            FloatConsumerX function = FloatConsumerXBuilder
                .floatConsumerX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(FloatConsumerX.DESCRIPTION);
