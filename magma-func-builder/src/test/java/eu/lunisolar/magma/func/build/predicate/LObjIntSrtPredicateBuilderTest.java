...
import static eu.lunisolar.magma.func.build.predicate.LObjIntSrtPredicateBuilder.objIntSrtPredicate;
import static eu.lunisolar.magma.func.build.predicate.LObjIntSrtPredicateBuilder.objIntSrtPredicateFrom;

public class LObjIntSrtPredicateBuilderTest<T>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LObjIntSrtPredicate<Integer> function = objIntSrtPredicateFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestObjIntSrtPred(function)
