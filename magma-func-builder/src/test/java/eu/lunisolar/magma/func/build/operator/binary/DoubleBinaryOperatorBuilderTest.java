...
import static eu.lunisolar.magma.func.build.operator.binary.DoubleBinaryOperatorBuilder.doubleBinaryOperator;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class DoubleBinaryOperatorBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            DoubleBinaryOperator function = DoubleBinaryOperatorBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(DoubleBinaryOperator.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        DoubleBinaryOperator function = doubleBinaryOperator((DoubleBinaryOperator f)-> doNothing())
