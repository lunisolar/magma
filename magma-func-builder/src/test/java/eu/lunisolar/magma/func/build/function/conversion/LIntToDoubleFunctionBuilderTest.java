...
import static eu.lunisolar.magma.func.build.function.conversion.LIntToDoubleFunctionBuilder.intToDoubleFunctionFrom;
...
public class LIntToDoubleFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LIntToDoubleFunction function = intToDoubleFunctionFrom(b-> b
                .build()
            );
