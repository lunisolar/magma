...
import static eu.lunisolar.magma.func.build.action.ActionBuilder.action;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ActionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(Action.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        Action function = action((Action f)-> doNothing())
