...
import static eu.lunisolar.magma.func.build.operator.ternary.LBooleanTernaryOperatorBuilder.booleanTernaryOperator;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBooleanTernaryOperatorBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws Throwable {
        ...
        assertThatThrownBy(() -> {
            LBooleanTernaryOperator function = LBooleanTernaryOperatorBuilder.booleanTernaryOperator()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LBooleanTernaryOperator.DESCRIPTION);
    }
    ...
    public void testBuild() throws Throwable {
        ...
        LBooleanTernaryOperator function = booleanTernaryOperator((LBooleanTernaryOperator f)-> doNothing())
