...
import static eu.lunisolar.magma.func.build.function.conversion.ByteToCharFunctionBuilder.byteToCharFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ByteToCharFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ByteToCharFunction function = ByteToCharFunctionBuilder
                .byteToCharFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ByteToCharFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ByteToCharFunction function = byteToCharFunction((ByteToCharFunction f)-> doNothing())
