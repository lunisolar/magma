...
import static eu.lunisolar.magma.func.build.function.from.LSrtFunctionBuilder.srtFunction;
import static eu.lunisolar.magma.func.build.function.from.LSrtFunctionBuilder.srtFunctionFrom;

public class LSrtFunctionBuilderTest<R>{
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestSrtFunc(function)
            .doesApply((short)0).when(null).to(a -> a.mustEx(Be::equalEx, 0))
            .doesApply((short)5).when(null).to(a -> a.mustEx(Be::equalEx, 1))
            .doesApply((short)15).when(null).to(a -> a.mustEx(Be::equalEx, 2))
            .doesApply((short)10).when(null).to(a -> a.mustEx(Be::equalEx, 99))
        ;
