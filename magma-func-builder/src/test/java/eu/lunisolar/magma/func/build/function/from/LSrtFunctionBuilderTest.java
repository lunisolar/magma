...
public class LSrtFunctionBuilderTest<R>{
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestSrtFunc(function)
            .doesApply((short)0).when(null).to(a -> a.must$(Be::equal$, 0))
            .doesApply((short)5).when(null).to(a -> a.must$(Be::equal$, 1))
            .doesApply((short)15).when(null).to(a -> a.must$(Be::equal$, 2))
            .doesApply((short)10).when(null).to(a -> a.must$(Be::equal$, 99))
        ;
