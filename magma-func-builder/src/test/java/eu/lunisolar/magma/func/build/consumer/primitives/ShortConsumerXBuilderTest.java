...
import static eu.lunisolar.magma.func.build.consumer.primitives.ShortConsumerXBuilder.shortConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ShortConsumerXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ShortConsumerX function = ShortConsumerXBuilder
                .shortConsumerX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ShortConsumerX.DESCRIPTION);
