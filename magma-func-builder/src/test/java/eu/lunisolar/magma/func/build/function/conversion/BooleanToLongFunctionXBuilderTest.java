...
import static eu.lunisolar.magma.func.build.function.conversion.BooleanToLongFunctionXBuilder.booleanToLongFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BooleanToLongFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BooleanToLongFunctionX function = BooleanToLongFunctionXBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BooleanToLongFunctionX.DESCRIPTION);
