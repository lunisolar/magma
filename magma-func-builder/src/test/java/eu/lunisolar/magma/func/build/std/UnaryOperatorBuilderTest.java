...
import static eu.lunisolar.magma.func.build.std.UnaryOperatorBuilder.unaryOperator;
import static eu.lunisolar.magma.func.build.std.UnaryOperatorBuilder.unaryOperatorFrom;

public class UnaryOperatorBuilderTest<T>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            UnaryOperator<Integer> function = unaryOperatorFrom(b-> b
                .build()
            );
