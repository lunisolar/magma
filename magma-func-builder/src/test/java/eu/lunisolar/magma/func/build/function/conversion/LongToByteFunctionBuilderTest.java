...
import static eu.lunisolar.magma.func.build.function.conversion.LongToByteFunctionBuilder.longToByteFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LongToByteFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LongToByteFunction function = LongToByteFunctionBuilder
                .longToByteFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LongToByteFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        LongToByteFunction function = longToByteFunction((LongToByteFunction f)-> doNothing())
