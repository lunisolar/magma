...
import static eu.lunisolar.magma.func.build.supplier.LIntSupplierBuilder.intSupplier;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LIntSupplierBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LIntSupplier function = LIntSupplierBuilder.intSupplier()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LIntSupplier.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LIntSupplier function = intSupplier((LIntSupplier f)-> doNothing())
