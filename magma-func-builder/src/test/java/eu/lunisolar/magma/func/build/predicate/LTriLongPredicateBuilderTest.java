...
import static eu.lunisolar.magma.func.build.predicate.LTriLongPredicateBuilder.triLongPredicate;
import static eu.lunisolar.magma.func.build.predicate.LTriLongPredicateBuilder.triLongPredicateFrom;

public class LTriLongPredicateBuilderTest{
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestTriLongPred(function)
            .doesTest(0L,0L,0L).when(null).to(a -> a.mustEx(Be::equalEx, false))
            .doesTest(5L,5L,5L).when(null).to(a -> a.mustEx(Be::equalEx, true))
        ;
