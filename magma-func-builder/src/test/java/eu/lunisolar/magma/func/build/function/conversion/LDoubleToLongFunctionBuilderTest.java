...
public class LDoubleToLongFunctionBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LDoubleToLongFunction function = LDoubleToLongFunctionBuilder.doubleToLongFunction()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LDoubleToLongFunction.DESCRIPTION);
    }
