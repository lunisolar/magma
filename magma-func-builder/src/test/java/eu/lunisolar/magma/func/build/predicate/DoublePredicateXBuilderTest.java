...
import static eu.lunisolar.magma.func.build.predicate.DoublePredicateXBuilder.doublePredicateX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class DoublePredicateXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            DoublePredicateX function = DoublePredicateXBuilder
                .doublePredicateX()
                .build();

            function.test((double)100);
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(DoublePredicateX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        DoublePredicateX<ParseException> function = doublePredicateX((DoublePredicateX<ParseException> f)-> doNothing())
