...
import static eu.lunisolar.magma.func.build.function.from.ObjLongFunctionBuilder.objLongFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjLongFunctionBuilderTest<T,R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjLongFunction function = ObjLongFunctionBuilder
                .objLongFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjLongFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ObjLongFunction<Integer ,Integer > function = objLongFunction((ObjLongFunction<Integer ,Integer > f)-> doNothing())
