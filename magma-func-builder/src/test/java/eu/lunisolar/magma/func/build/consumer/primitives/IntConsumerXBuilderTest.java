...
import static eu.lunisolar.magma.func.build.consumer.primitives.IntConsumerXBuilder.intConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class IntConsumerXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            IntConsumerX function = IntConsumerXBuilder
                .intConsumerX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(IntConsumerX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        IntConsumerX<ParseException> function = intConsumerX((IntConsumerX<ParseException> f)-> doNothing())
