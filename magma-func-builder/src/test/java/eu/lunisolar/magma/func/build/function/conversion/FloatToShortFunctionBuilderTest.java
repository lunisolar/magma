...
import static eu.lunisolar.magma.func.build.function.conversion.FloatToShortFunctionBuilder.floatToShortFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class FloatToShortFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            FloatToShortFunction function = FloatToShortFunctionBuilder
                .floatToShortFunction()
                .build();

            function.applyAsShort((float)100);
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(FloatToShortFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        FloatToShortFunction function = floatToShortFunction((FloatToShortFunction f)-> doNothing())
