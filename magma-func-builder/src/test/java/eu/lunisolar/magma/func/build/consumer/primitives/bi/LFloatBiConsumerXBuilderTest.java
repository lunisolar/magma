...
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.LFloatBiConsumerXBuilder.floatBiConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LFloatBiConsumerXBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LFloatBiConsumerX function = LFloatBiConsumerXBuilder.floatBiConsumerX()
                .build();

            function.doAccept((float)100,(float)100);

            fail("No exception were thrown.");
        })
                    .isExactlyInstanceOf(IllegalStateException.class)
                    .hasMessageContaining("No case specified for:")
                    .hasMessageContaining(LFloatBiConsumerX.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LFloatBiConsumerX<ParseException> function = floatBiConsumerX((LFloatBiConsumerX<ParseException> f)-> doNothing())
