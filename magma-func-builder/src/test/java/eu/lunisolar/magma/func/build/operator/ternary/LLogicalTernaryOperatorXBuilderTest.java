...
public class LLogicalTernaryOperatorXBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LLogicalTernaryOperatorX function = LLogicalTernaryOperatorXBuilder.logicalTernaryOperatorX()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LLogicalTernaryOperatorX.DESCRIPTION);
    }
