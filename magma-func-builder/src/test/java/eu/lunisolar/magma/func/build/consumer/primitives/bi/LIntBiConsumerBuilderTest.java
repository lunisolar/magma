...
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.LIntBiConsumerBuilder.intBiConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LIntBiConsumerBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LIntBiConsumer function = LIntBiConsumerBuilder
                .intBiConsumer()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LIntBiConsumer.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        LIntBiConsumer function = intBiConsumer((LIntBiConsumer f)-> doNothing())
