...
import static eu.lunisolar.magma.func.build.function.conversion.FloatToByteFunctionBuilder.floatToByteFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class FloatToByteFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            FloatToByteFunction function = FloatToByteFunctionBuilder
                .floatToByteFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(FloatToByteFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        FloatToByteFunction function = floatToByteFunction((FloatToByteFunction f)-> doNothing())
