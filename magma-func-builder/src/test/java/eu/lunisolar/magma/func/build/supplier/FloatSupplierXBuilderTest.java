...
import static eu.lunisolar.magma.func.build.supplier.FloatSupplierXBuilder.floatSupplierX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class FloatSupplierXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            FloatSupplierX function = FloatSupplierXBuilder
                .floatSupplierX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(FloatSupplierX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        FloatSupplierX<ParseException> function = floatSupplierX((FloatSupplierX<ParseException> f)-> doNothing())
