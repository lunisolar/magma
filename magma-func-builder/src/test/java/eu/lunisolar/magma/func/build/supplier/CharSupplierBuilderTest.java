...
import static eu.lunisolar.magma.func.build.supplier.CharSupplierBuilder.charSupplier;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class CharSupplierBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            CharSupplier function = CharSupplierBuilder
                .charSupplier()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(CharSupplier.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        CharSupplier function = charSupplier((CharSupplier f)-> doNothing())
