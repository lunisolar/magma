...
import static eu.lunisolar.magma.func.build.function.conversion.ShortToDoubleFunctionXBuilder.shortToDoubleFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ShortToDoubleFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ShortToDoubleFunctionX function = ShortToDoubleFunctionXBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ShortToDoubleFunctionX.DESCRIPTION);
