...
import static eu.lunisolar.magma.func.build.function.conversion.DoubleToIntFunctionBuilder.doubleToIntFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class DoubleToIntFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            DoubleToIntFunction function = DoubleToIntFunctionBuilder
                .doubleToIntFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(DoubleToIntFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        DoubleToIntFunction function = doubleToIntFunction((DoubleToIntFunction f)-> doNothing())
