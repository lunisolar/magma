...
import static eu.lunisolar.magma.func.build.function.conversion.LIntToByteFunctionXBuilder.intToByteFunctionXFrom;
...
public class LIntToByteFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LIntToByteFunctionX<X> function = intToByteFunctionXFrom(b-> b
                .build()
            );
