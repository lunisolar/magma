...
import static eu.lunisolar.magma.func.build.function.conversion.LongToCharFunctionXBuilder.longToCharFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LongToCharFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LongToCharFunctionX function = LongToCharFunctionXBuilder
                .longToCharFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LongToCharFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        LongToCharFunctionX<ParseException> function = longToCharFunctionX((LongToCharFunctionX<ParseException> f)-> doNothing())
