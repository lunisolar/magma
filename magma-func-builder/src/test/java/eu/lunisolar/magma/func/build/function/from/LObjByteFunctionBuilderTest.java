...
import static eu.lunisolar.magma.func.build.function.from.LObjByteFunctionBuilder.objByteFunctionFrom;

public class LObjByteFunctionBuilderTest<T,R>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LObjByteFunction<Integer,Integer> function = objByteFunctionFrom(b-> b
                .build()
            );

            function.apply(100,(byte)100);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestObjByteFunc(function)
            .doesApply(0,(byte)0).when(null).to(a -> a.mustEx(Be::equalEx, 0))
            .doesApply(5,(byte)5).when(null).to(a -> a.mustEx(Be::equalEx, 1))
            .doesApply(15,(byte)15).when(null).to(a -> a.mustEx(Be::equalEx, 2))
            .doesApply(10,(byte)10).when(null).to(a -> a.mustEx(Be::equalEx, 99))
        ;
