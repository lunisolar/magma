...
import static eu.lunisolar.magma.func.build.function.from.LObjIntLongFunctionBuilder.objIntLongFunction;
import static eu.lunisolar.magma.func.build.function.from.LObjIntLongFunctionBuilder.objIntLongFunctionFrom;

public class LObjIntLongFunctionBuilderTest<T,R>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LObjIntLongFunction<Integer,Integer> function = objIntLongFunctionFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestObjIntLongFunc(function)
            .doesApply(0,0,0L).when(null).to(a -> a.mustEx(Be::equalEx, 0))
            .doesApply(5,5,5L).when(null).to(a -> a.mustEx(Be::equalEx, 1))
            .doesApply(15,15,15L).when(null).to(a -> a.mustEx(Be::equalEx, 2))
            .doesApply(10,10,10L).when(null).to(a -> a.mustEx(Be::equalEx, 99))
        ;
