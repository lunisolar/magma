...
import static eu.lunisolar.magma.func.build.operator.binary.CharBinaryOperatorXBuilder.charBinaryOperatorX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class CharBinaryOperatorXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            CharBinaryOperatorX function = CharBinaryOperatorXBuilder
                .charBinaryOperatorX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(CharBinaryOperatorX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        CharBinaryOperatorX<ParseException> function = charBinaryOperatorX((CharBinaryOperatorX<ParseException> f)-> doNothing())
