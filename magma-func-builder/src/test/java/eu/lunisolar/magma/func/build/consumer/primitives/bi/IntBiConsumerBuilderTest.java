...
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.IntBiConsumerBuilder.intBiConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class IntBiConsumerBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            IntBiConsumer function = IntBiConsumerBuilder
                .intBiConsumer()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(IntBiConsumer.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        IntBiConsumer function = intBiConsumer((IntBiConsumer f)-> doNothing())
