...
import static eu.lunisolar.magma.func.build.operator.binary.LBinaryOperatorBuilder.binaryOperatorFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBinaryOperatorBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LBinaryOperator<Integer> function = binaryOperatorFrom(b-> b
                .build()
            );
