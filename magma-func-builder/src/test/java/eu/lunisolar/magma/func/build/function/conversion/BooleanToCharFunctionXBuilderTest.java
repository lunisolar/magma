...
import static eu.lunisolar.magma.func.build.function.conversion.BooleanToCharFunctionXBuilder.booleanToCharFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BooleanToCharFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BooleanToCharFunctionX function = BooleanToCharFunctionXBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BooleanToCharFunctionX.DESCRIPTION);
