...
import static eu.lunisolar.magma.func.build.function.conversion.DoubleToByteFunctionXBuilder.doubleToByteFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class DoubleToByteFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            DoubleToByteFunctionX function = DoubleToByteFunctionXBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(DoubleToByteFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        DoubleToByteFunctionX<ParseException> function = doubleToByteFunctionX((DoubleToByteFunctionX<ParseException> f)-> doNothing())
