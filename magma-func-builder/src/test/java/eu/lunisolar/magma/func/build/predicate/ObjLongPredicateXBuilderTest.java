...
import static eu.lunisolar.magma.func.build.predicate.ObjLongPredicateXBuilder.objLongPredicateX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjLongPredicateXBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjLongPredicateX function = ObjLongPredicateXBuilder
                .objLongPredicateX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjLongPredicateX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ObjLongPredicateX<Integer ,ParseException> function = objLongPredicateX((ObjLongPredicateX<Integer ,ParseException> f)-> doNothing())
