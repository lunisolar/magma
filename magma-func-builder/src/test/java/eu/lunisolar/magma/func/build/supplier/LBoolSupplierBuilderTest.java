...
public class LBoolSupplierBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LBoolSupplier function = LBoolSupplierBuilder.boolSupplier()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LBoolSupplier.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LBoolSupplier function = boolSupplier((LBoolSupplier f)-> doNothing())
