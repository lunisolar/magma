...
public class LToIntFunctionBuilderTest<T,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LToIntFunction function = LToIntFunctionBuilder.toIntFunction()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LToIntFunction.DESCRIPTION);
    }
