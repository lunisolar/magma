...
import static eu.lunisolar.magma.func.build.function.conversion.IntToLongFunctionXBuilder.intToLongFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class IntToLongFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            IntToLongFunctionX function = IntToLongFunctionXBuilder
                .intToLongFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(IntToLongFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        IntToLongFunctionX<ParseException> function = intToLongFunctionX((IntToLongFunctionX<ParseException> f)-> doNothing())
