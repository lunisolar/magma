...
import static eu.lunisolar.magma.func.build.function.conversion.BooleanToDoubleFunctionBuilder.booleanToDoubleFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BooleanToDoubleFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BooleanToDoubleFunction function = BooleanToDoubleFunctionBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BooleanToDoubleFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BooleanToDoubleFunction function = booleanToDoubleFunction((BooleanToDoubleFunction f)-> doNothing())
