...
import static eu.lunisolar.magma.func.build.operator.unary.UnaryOperatorXBuilder.unaryOperatorX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class UnaryOperatorXBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            UnaryOperatorX function = UnaryOperatorXBuilder
                .unaryOperatorX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(UnaryOperatorX.DESCRIPTION);
