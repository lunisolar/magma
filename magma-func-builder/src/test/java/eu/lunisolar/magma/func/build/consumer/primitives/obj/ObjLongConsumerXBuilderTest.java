...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.ObjLongConsumerXBuilder.objLongConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjLongConsumerXBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjLongConsumerX function = ObjLongConsumerXBuilder
                .objLongConsumerX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjLongConsumerX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ObjLongConsumerX<Integer ,ParseException> function = objLongConsumerX((ObjLongConsumerX<Integer ,ParseException> f)-> doNothing())
