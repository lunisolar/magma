...
import static eu.lunisolar.magma.func.build.function.to.LToByteFunctionBuilder.toByteFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LToByteFunctionBuilderTest<T,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LToByteFunction function = LToByteFunctionBuilder.toByteFunction()
                .build();

            function.doApplyAsByte((T)Integer.valueOf(100));

            fail("No exception were thrown.");
        })
                    .isExactlyInstanceOf(IllegalStateException.class)
                    .hasMessageContaining("No case specified for:")
                    .hasMessageContaining(LToByteFunction.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LToByteFunction<Integer > function = toByteFunction((LToByteFunction<Integer > f)-> doNothing())
