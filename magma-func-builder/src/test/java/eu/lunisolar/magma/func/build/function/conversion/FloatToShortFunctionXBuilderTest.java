...
import static eu.lunisolar.magma.func.build.function.conversion.FloatToShortFunctionXBuilder.floatToShortFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class FloatToShortFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            FloatToShortFunctionX function = FloatToShortFunctionXBuilder
                .floatToShortFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(FloatToShortFunctionX.DESCRIPTION);
