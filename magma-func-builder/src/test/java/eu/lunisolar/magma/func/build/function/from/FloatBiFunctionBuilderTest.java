...
import static eu.lunisolar.magma.func.build.function.from.FloatBiFunctionBuilder.floatBiFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class FloatBiFunctionBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            FloatBiFunction function = FloatBiFunctionBuilder
                .floatBiFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(FloatBiFunction.DESCRIPTION);
