...
import static eu.lunisolar.magma.func.build.predicate.BiObjBooleanPredicateXBuilder.biObjBooleanPredicateX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiObjBooleanPredicateXBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiObjBooleanPredicateX function = BiObjBooleanPredicateXBuilder
                .biObjBooleanPredicateX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiObjBooleanPredicateX.DESCRIPTION);
