...
import static eu.lunisolar.magma.func.build.function.to.LToSrtFunctionBuilder.toSrtFunction;
import static eu.lunisolar.magma.func.build.function.to.LToSrtFunctionBuilder.toSrtFunctionFrom;

public class LToSrtFunctionBuilderTest<T>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LToSrtFunction<Integer> function = toSrtFunctionFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestToSrtFunc(function)
            .doesApplyAsSrt(0).when(null).to(a -> a.mustEx(Be::equalEx, (short)0))
            .doesApplyAsSrt(5).when(null).to(a -> a.mustEx(Be::equalEx, (short)1))
            .doesApplyAsSrt(15).when(null).to(a -> a.mustEx(Be::equalEx, (short)2))
            .doesApplyAsSrt(10).when(null).to(a -> a.mustEx(Be::equalEx, (short)99))
        ;
