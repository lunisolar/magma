...
import static eu.lunisolar.magma.func.build.function.conversion.LLongToIntFunctionXBuilder.longToIntFunctionXFrom;
...
public class LLongToIntFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LLongToIntFunctionX<X> function = longToIntFunctionXFrom(b-> b
                .build()
            );

            function.doApplyAsInt(100L);
