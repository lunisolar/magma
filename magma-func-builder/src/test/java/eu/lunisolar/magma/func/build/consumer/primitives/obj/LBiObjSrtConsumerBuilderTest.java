...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LBiObjSrtConsumerBuilder.biObjSrtConsumer;
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LBiObjSrtConsumerBuilder.biObjSrtConsumerFrom;

public class LBiObjSrtConsumerBuilderTest<T1,T2>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LBiObjSrtConsumer<Integer,Integer> function = biObjSrtConsumerFrom(b-> b
                .build()
            );

            function.accept(100,100,(short)100);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestBiObjSrtCons(function)
            .doesAccept(0,0,(short)0).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 0))
            .doesAccept(5,5,(short)5).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 1))
            .doesAccept(15,15,(short)15).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 2))
            .doesAccept(10,10,(short)10).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 99))
        ;
