...
import static eu.lunisolar.magma.func.build.function.from.LIntFunctionBuilder.intFunctionFrom;

public class LIntFunctionBuilderTest<R>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LIntFunction<Integer> function = intFunctionFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestIntFunc(function)
