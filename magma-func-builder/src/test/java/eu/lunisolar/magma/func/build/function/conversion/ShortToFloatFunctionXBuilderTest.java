...
import static eu.lunisolar.magma.func.build.function.conversion.ShortToFloatFunctionXBuilder.shortToFloatFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ShortToFloatFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ShortToFloatFunctionX function = ShortToFloatFunctionXBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ShortToFloatFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ShortToFloatFunctionX<ParseException> function = shortToFloatFunctionX((ShortToFloatFunctionX<ParseException> f)-> doNothing())
