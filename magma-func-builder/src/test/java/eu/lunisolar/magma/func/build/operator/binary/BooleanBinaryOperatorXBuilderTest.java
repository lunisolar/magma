...
import static eu.lunisolar.magma.func.build.operator.binary.BooleanBinaryOperatorXBuilder.booleanBinaryOperatorX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BooleanBinaryOperatorXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BooleanBinaryOperatorX function = BooleanBinaryOperatorXBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BooleanBinaryOperatorX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BooleanBinaryOperatorX<ParseException> function = booleanBinaryOperatorX((BooleanBinaryOperatorX<ParseException> f)-> doNothing())
