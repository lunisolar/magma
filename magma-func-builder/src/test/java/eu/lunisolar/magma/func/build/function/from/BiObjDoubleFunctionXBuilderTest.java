...
import static eu.lunisolar.magma.func.build.function.from.BiObjDoubleFunctionXBuilder.biObjDoubleFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiObjDoubleFunctionXBuilderTest<T1,T2,R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiObjDoubleFunctionX function = BiObjDoubleFunctionXBuilder
                .biObjDoubleFunctionX()
                .build();

            function.apply((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),(double)100);
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiObjDoubleFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BiObjDoubleFunctionX<Integer ,Integer ,Integer ,ParseException> function = biObjDoubleFunctionX((BiObjDoubleFunctionX<Integer ,Integer ,Integer ,ParseException> f)-> doNothing())
        ...
        // Integer t1,Integer t2, double d
        // Integer.valueOf(0),Integer.valueOf(0),(double)0
