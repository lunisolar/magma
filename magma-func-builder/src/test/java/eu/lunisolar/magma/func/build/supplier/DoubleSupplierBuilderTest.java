...
import static eu.lunisolar.magma.func.build.supplier.DoubleSupplierBuilder.doubleSupplier;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class DoubleSupplierBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            DoubleSupplier function = DoubleSupplierBuilder
                .doubleSupplier()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(DoubleSupplier.DESCRIPTION);
