...
import static eu.lunisolar.magma.func.build.function.conversion.LFltToIntFunctionBuilder.fltToIntFunction;
import static eu.lunisolar.magma.func.build.function.conversion.LFltToIntFunctionBuilder.fltToIntFunctionFrom;

public class LFltToIntFunctionBuilderTest{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LFltToIntFunction function = fltToIntFunctionFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestFltToIntFunc(function)
            .doesApplyAsInt(0f).when(null).to(a -> a.mustEx(Be::equalEx, 0))
            .doesApplyAsInt(5f).when(null).to(a -> a.mustEx(Be::equalEx, 1))
            .doesApplyAsInt(15f).when(null).to(a -> a.mustEx(Be::equalEx, 2))
            .doesApplyAsInt(10f).when(null).to(a -> a.mustEx(Be::equalEx, 99))
        ;
