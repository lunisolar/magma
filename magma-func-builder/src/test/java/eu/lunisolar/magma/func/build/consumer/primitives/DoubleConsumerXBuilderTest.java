...
import static eu.lunisolar.magma.func.build.consumer.primitives.DoubleConsumerXBuilder.doubleConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class DoubleConsumerXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            DoubleConsumerX function = DoubleConsumerXBuilder
                .doubleConsumerX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(DoubleConsumerX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        DoubleConsumerX<ParseException> function = doubleConsumerX((DoubleConsumerX<ParseException> f)-> doNothing())
