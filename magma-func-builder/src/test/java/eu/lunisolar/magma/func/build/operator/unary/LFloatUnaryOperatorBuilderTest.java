...
import static eu.lunisolar.magma.func.build.operator.unary.LFloatUnaryOperatorBuilder.floatUnaryOperator;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LFloatUnaryOperatorBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LFloatUnaryOperator function = LFloatUnaryOperatorBuilder.floatUnaryOperator()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LFloatUnaryOperator.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LFloatUnaryOperator function = floatUnaryOperator((LFloatUnaryOperator f)-> doNothing())
