...
import static eu.lunisolar.magma.func.build.function.from.DoubleFunctionXBuilder.doubleFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class DoubleFunctionXBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            DoubleFunctionX function = DoubleFunctionXBuilder
                .doubleFunctionX()
                .build();

            function.apply((double)100);
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(DoubleFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        DoubleFunctionX<Integer ,ParseException> function = doubleFunctionX((DoubleFunctionX<Integer ,ParseException> f)-> doNothing())
