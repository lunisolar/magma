...
import static eu.lunisolar.magma.func.build.function.to.ToShortBiFunctionBuilder.toShortBiFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ToShortBiFunctionBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ToShortBiFunction function = ToShortBiFunctionBuilder
                .toShortBiFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ToShortBiFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ToShortBiFunction<Integer ,Integer > function = toShortBiFunction((ToShortBiFunction<Integer ,Integer > f)-> doNothing())
