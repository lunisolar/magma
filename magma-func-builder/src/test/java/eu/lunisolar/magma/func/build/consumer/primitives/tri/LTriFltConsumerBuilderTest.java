...
import static eu.lunisolar.magma.func.build.consumer.primitives.tri.LTriFltConsumerBuilder.triFltConsumer;
import static eu.lunisolar.magma.func.build.consumer.primitives.tri.LTriFltConsumerBuilder.triFltConsumerFrom;

public class LTriFltConsumerBuilderTest{
    ...
    public void testOtherwiseThrow()  {
        ...
        try {
            ...
            function.accept(100f,100f,100f);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestTriFltCons(function)
            .doesAccept(0f,0f,0f).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 0))
            .doesAccept(5f,5f,5f).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 1))
            .doesAccept(15f,15f,15f).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 2))
            .doesAccept(10f,10f,10f).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 99))
        ;
