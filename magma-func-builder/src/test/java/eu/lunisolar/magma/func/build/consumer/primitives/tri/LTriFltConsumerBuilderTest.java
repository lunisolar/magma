...
public class LTriFltConsumerBuilderTest{
    ...
    public void testBuild()  {
        ...
        A.attestTriFltCons(function)
            .doesAccept(0f,0f,0f).when(null).soThat(() -> assertThat(externalEffect.get()).isEqualTo(0))
            .doesAccept(5f,5f,5f).when(null).soThat(() -> assertThat(externalEffect.get()).isEqualTo(1))
            .doesAccept(15f,15f,15f).when(null).soThat(() -> assertThat(externalEffect.get()).isEqualTo(2))
            .doesAccept(10f,10f,10f).when(null).soThat(() -> assertThat(externalEffect.get()).isEqualTo(99))
        ;
