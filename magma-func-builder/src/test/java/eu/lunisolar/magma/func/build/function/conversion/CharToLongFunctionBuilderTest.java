...
import static eu.lunisolar.magma.func.build.function.conversion.CharToLongFunctionBuilder.charToLongFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class CharToLongFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            CharToLongFunction function = CharToLongFunctionBuilder
                .charToLongFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(CharToLongFunction.DESCRIPTION);
