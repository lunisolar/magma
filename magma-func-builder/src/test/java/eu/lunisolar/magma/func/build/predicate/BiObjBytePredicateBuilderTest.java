...
import static eu.lunisolar.magma.func.build.predicate.BiObjBytePredicateBuilder.biObjBytePredicate;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiObjBytePredicateBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiObjBytePredicate function = BiObjBytePredicateBuilder
                .biObjBytePredicate()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiObjBytePredicate.DESCRIPTION);
