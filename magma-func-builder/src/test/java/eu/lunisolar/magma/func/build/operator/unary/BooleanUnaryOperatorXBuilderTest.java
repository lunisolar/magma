...
import static eu.lunisolar.magma.func.build.operator.unary.BooleanUnaryOperatorXBuilder.booleanUnaryOperatorX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BooleanUnaryOperatorXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BooleanUnaryOperatorX function = BooleanUnaryOperatorXBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BooleanUnaryOperatorX.DESCRIPTION);
