...
import static eu.lunisolar.magma.func.build.function.conversion.FloatToIntFunctionBuilder.floatToIntFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class FloatToIntFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            FloatToIntFunction function = FloatToIntFunctionBuilder
                .floatToIntFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(FloatToIntFunction.DESCRIPTION);
