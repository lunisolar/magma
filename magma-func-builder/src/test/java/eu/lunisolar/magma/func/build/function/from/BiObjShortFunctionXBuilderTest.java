...
import static eu.lunisolar.magma.func.build.function.from.BiObjShortFunctionXBuilder.biObjShortFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiObjShortFunctionXBuilderTest<T1,T2,R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiObjShortFunctionX function = BiObjShortFunctionXBuilder
                .biObjShortFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiObjShortFunctionX.DESCRIPTION);
