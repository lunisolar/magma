...
import static eu.lunisolar.magma.func.build.supplier.ByteSupplierBuilder.byteSupplier;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ByteSupplierBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ByteSupplier function = ByteSupplierBuilder
                .byteSupplier()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ByteSupplier.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ByteSupplier function = byteSupplier((ByteSupplier f)-> doNothing())
