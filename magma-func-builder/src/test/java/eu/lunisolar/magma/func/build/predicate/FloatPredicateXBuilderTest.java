...
import static eu.lunisolar.magma.func.build.predicate.FloatPredicateXBuilder.floatPredicateX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class FloatPredicateXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            FloatPredicateX function = FloatPredicateXBuilder
                .floatPredicateX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(FloatPredicateX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        FloatPredicateX<ParseException> function = floatPredicateX((FloatPredicateX<ParseException> f)-> doNothing())
