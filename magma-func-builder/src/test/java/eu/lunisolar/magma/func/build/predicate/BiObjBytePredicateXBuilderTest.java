...
import static eu.lunisolar.magma.func.build.predicate.BiObjBytePredicateXBuilder.biObjBytePredicateX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiObjBytePredicateXBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiObjBytePredicateX function = BiObjBytePredicateXBuilder
                .biObjBytePredicateX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiObjBytePredicateX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BiObjBytePredicateX<Integer ,Integer ,ParseException> function = biObjBytePredicateX((BiObjBytePredicateX<Integer ,Integer ,ParseException> f)-> doNothing())
