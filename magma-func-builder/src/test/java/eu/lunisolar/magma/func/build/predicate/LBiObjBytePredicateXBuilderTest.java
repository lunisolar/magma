...
import static eu.lunisolar.magma.func.build.predicate.LBiObjBytePredicateXBuilder.biObjBytePredicateXFrom;
...
public class LBiObjBytePredicateXBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LBiObjBytePredicateX<Integer,Integer,X> function = biObjBytePredicateXFrom(b-> b
                .build()
            );

            function.doTest(100,100,(byte)100);
