...
import static eu.lunisolar.magma.func.build.supplier.SupplierBuilder.supplier;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class SupplierBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            Supplier function = SupplierBuilder
                .supplier()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(Supplier.DESCRIPTION);
