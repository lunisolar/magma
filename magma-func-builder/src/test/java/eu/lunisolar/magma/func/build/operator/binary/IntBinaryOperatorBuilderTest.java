...
import static eu.lunisolar.magma.func.build.operator.binary.IntBinaryOperatorBuilder.intBinaryOperator;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class IntBinaryOperatorBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            IntBinaryOperator function = IntBinaryOperatorBuilder
                .intBinaryOperator()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(IntBinaryOperator.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        IntBinaryOperator function = intBinaryOperator((IntBinaryOperator f)-> doNothing())
