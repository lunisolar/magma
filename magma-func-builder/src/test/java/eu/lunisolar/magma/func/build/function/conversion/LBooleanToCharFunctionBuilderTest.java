...
import static eu.lunisolar.magma.func.build.function.conversion.LBooleanToCharFunctionBuilder.booleanToCharFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBooleanToCharFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LBooleanToCharFunction function = LBooleanToCharFunctionBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LBooleanToCharFunction.DESCRIPTION);
