...
import static eu.lunisolar.magma.func.build.function.BiFunctionXBuilder.biFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiFunctionXBuilderTest<T1,T2,R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiFunctionX function = BiFunctionXBuilder
                .biFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BiFunctionX<Integer ,Integer ,Integer ,ParseException> function = biFunctionX((BiFunctionX<Integer ,Integer ,Integer ,ParseException> f)-> doNothing())
