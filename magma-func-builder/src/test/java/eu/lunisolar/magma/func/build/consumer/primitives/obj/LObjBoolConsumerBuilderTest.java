...
public class LObjBoolConsumerBuilderTest<T,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LObjBoolConsumer function = LObjBoolConsumerBuilder.objBoolConsumer()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LObjBoolConsumer.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LObjBoolConsumer<Integer > function = objBoolConsumer((LObjBoolConsumer<Integer > f)-> doNothing())
