...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LObjBoolConsumerBuilder.objBoolConsumer;
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LObjBoolConsumerBuilder.objBoolConsumerFrom;

public class LObjBoolConsumerBuilderTest<T>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LObjBoolConsumer<Integer> function = objBoolConsumerFrom(b-> b
                .build()
            );

            function.accept(100,true);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestObjBoolCons(function)
            .doesAccept(0,false).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 0))
            .doesAccept(5,true).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 1))
            .doesAccept(15,true).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 2))
            .doesAccept(10,true).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 99))
        ;
