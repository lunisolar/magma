...
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.LCharBiConsumerXBuilder.charBiConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LCharBiConsumerXBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LCharBiConsumerX function = LCharBiConsumerXBuilder.charBiConsumerX()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LCharBiConsumerX.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LCharBiConsumerX<ParseException> function = charBiConsumerX((LCharBiConsumerX<ParseException> f)-> doNothing())
