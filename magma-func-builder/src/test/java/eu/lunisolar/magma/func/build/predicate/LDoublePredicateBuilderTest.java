...
import static eu.lunisolar.magma.func.build.predicate.LDoublePredicateBuilder.doublePredicateFrom;
...
public class LDoublePredicateBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LDoublePredicate function = doublePredicateFrom(b-> b
                .build()
            );

            function.doTest(100d);
