...
import static eu.lunisolar.magma.func.build.supplier.LongSupplierXBuilder.longSupplierX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LongSupplierXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LongSupplierX function = LongSupplierXBuilder
                .longSupplierX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LongSupplierX.DESCRIPTION);
