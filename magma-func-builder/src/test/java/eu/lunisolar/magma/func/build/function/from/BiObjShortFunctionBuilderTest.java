...
import static eu.lunisolar.magma.func.build.function.from.BiObjShortFunctionBuilder.biObjShortFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiObjShortFunctionBuilderTest<T1,T2,R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiObjShortFunction function = BiObjShortFunctionBuilder
                .biObjShortFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiObjShortFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BiObjShortFunction<Integer ,Integer ,Integer > function = biObjShortFunction((BiObjShortFunction<Integer ,Integer ,Integer > f)-> doNothing())
