...
import static eu.lunisolar.magma.func.build.supplier.FloatSupplierBuilder.floatSupplier;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class FloatSupplierBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            FloatSupplier function = FloatSupplierBuilder
                .floatSupplier()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(FloatSupplier.DESCRIPTION);
