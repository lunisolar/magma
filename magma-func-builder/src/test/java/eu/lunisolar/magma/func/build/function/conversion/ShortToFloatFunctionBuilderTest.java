...
import static eu.lunisolar.magma.func.build.function.conversion.ShortToFloatFunctionBuilder.shortToFloatFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ShortToFloatFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ShortToFloatFunction function = ShortToFloatFunctionBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ShortToFloatFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ShortToFloatFunction function = shortToFloatFunction((ShortToFloatFunction f)-> doNothing())
