...
public class LSrtToLongFunctionBuilderTest{
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestSrtToLongFunc(function)
            .doesApplyAsLong((short)0).when(null).to(a -> a.mustEx(Be::equalEx, 0L))
            .doesApplyAsLong((short)5).when(null).to(a -> a.mustEx(Be::equalEx, 1L))
            .doesApplyAsLong((short)15).when(null).to(a -> a.mustEx(Be::equalEx, 2L))
            .doesApplyAsLong((short)10).when(null).to(a -> a.mustEx(Be::equalEx, 99L))
        ;
