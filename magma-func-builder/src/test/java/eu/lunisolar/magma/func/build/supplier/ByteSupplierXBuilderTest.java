...
import static eu.lunisolar.magma.func.build.supplier.ByteSupplierXBuilder.byteSupplierX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ByteSupplierXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ByteSupplierX function = ByteSupplierXBuilder
                .byteSupplierX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ByteSupplierX.DESCRIPTION);
