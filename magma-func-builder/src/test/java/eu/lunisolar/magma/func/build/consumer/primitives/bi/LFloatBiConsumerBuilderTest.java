...
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.LFloatBiConsumerBuilder.floatBiConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LFloatBiConsumerBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LFloatBiConsumer function = LFloatBiConsumerBuilder.floatBiConsumer()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LFloatBiConsumer.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LFloatBiConsumer function = floatBiConsumer((LFloatBiConsumer f)-> doNothing())
