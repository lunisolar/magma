...
import static eu.lunisolar.magma.func.build.function.from.LObjIntObjFunctionBuilder.objIntObjFunction;
import static eu.lunisolar.magma.func.build.function.from.LObjIntObjFunctionBuilder.objIntObjFunctionFrom;

public class LObjIntObjFunctionBuilderTest<T1,T2,R>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LObjIntObjFunction<Integer,Integer,Integer> function = objIntObjFunctionFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestObjIntObjFunc(function)
            .doesApply(0,0,0).when(null).to(a -> a.mustEx(Be::equalEx, 0))
            .doesApply(5,5,5).when(null).to(a -> a.mustEx(Be::equalEx, 1))
            .doesApply(15,15,15).when(null).to(a -> a.mustEx(Be::equalEx, 2))
            .doesApply(10,10,10).when(null).to(a -> a.mustEx(Be::equalEx, 99))
        ;
