...
import static eu.lunisolar.magma.func.build.function.from.CharBiFunctionXBuilder.charBiFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class CharBiFunctionXBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            CharBiFunctionX function = CharBiFunctionXBuilder
                .charBiFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(CharBiFunctionX.DESCRIPTION);
