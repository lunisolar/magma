...
import static eu.lunisolar.magma.func.build.function.from.LObjIntCharFunctionBuilder.objIntCharFunction;
import static eu.lunisolar.magma.func.build.function.from.LObjIntCharFunctionBuilder.objIntCharFunctionFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LObjIntCharFunctionBuilderTest<T,R>{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LObjIntCharFunction<Integer,Integer> function = objIntCharFunctionFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        A.assertObjIntCharFunc(function)
