...
import static eu.lunisolar.magma.func.build.predicate.ObjDoublePredicateXBuilder.objDoublePredicateX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjDoublePredicateXBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjDoublePredicateX function = ObjDoublePredicateXBuilder
                .objDoublePredicateX()
                .build();

            function.test((T)Integer.valueOf(100),(double)100);
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjDoublePredicateX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ObjDoublePredicateX<Integer ,ParseException> function = objDoublePredicateX((ObjDoublePredicateX<Integer ,ParseException> f)-> doNothing())
