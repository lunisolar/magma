...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.ObjFloatConsumerBuilder.objFloatConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjFloatConsumerBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjFloatConsumer function = ObjFloatConsumerBuilder
                .objFloatConsumer()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjFloatConsumer.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ObjFloatConsumer<Integer > function = objFloatConsumer((ObjFloatConsumer<Integer > f)-> doNothing())
