...
import static eu.lunisolar.magma.func.build.function.conversion.LBooleanToDoubleFunctionXBuilder.booleanToDoubleFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBooleanToDoubleFunctionXBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LBooleanToDoubleFunctionX function = LBooleanToDoubleFunctionXBuilder.booleanToDoubleFunctionX()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LBooleanToDoubleFunctionX.DESCRIPTION);
    }
