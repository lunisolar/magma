...
import static eu.lunisolar.magma.func.build.predicate.BiCharPredicateXBuilder.biCharPredicateX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiCharPredicateXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiCharPredicateX function = BiCharPredicateXBuilder
                .biCharPredicateX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiCharPredicateX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BiCharPredicateX<ParseException> function = biCharPredicateX((BiCharPredicateX<ParseException> f)-> doNothing())
