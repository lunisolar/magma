...
import static eu.lunisolar.magma.func.build.function.from.LDblFunctionBuilder.dblFunction;
import static eu.lunisolar.magma.func.build.function.from.LDblFunctionBuilder.dblFunctionFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LDblFunctionBuilderTest<R>{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LDblFunction<Integer> function = dblFunctionFrom(b-> b
                .build()
            );
