...
import static eu.lunisolar.magma.func.build.function.to.LToDblBiFunctionBuilder.toDblBiFunction;
import static eu.lunisolar.magma.func.build.function.to.LToDblBiFunctionBuilder.toDblBiFunctionFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LToDblBiFunctionBuilderTest<T1,T2>{
    ...
    public void testOtherwiseThrow()  {
        ...
        assertThatThrownBy(() -> {
            LToDblBiFunction<Integer,Integer> function = toDblBiFunctionFrom(b-> b
                .build()
            );
