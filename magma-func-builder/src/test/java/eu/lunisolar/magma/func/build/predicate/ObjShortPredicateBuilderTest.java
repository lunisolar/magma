...
import static eu.lunisolar.magma.func.build.predicate.ObjShortPredicateBuilder.objShortPredicate;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjShortPredicateBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjShortPredicate function = ObjShortPredicateBuilder
                .objShortPredicate()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjShortPredicate.DESCRIPTION);
