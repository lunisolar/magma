...
import static eu.lunisolar.magma.func.build.operator.binary.BinaryOperatorXBuilder.binaryOperatorX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BinaryOperatorXBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BinaryOperatorX function = BinaryOperatorXBuilder
                .binaryOperatorX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BinaryOperatorX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BinaryOperatorX<Integer ,ParseException> function = binaryOperatorX((BinaryOperatorX<Integer ,ParseException> f)-> doNothing())
