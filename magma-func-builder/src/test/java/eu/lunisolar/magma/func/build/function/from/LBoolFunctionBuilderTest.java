...
import static eu.lunisolar.magma.func.build.function.from.LBoolFunctionBuilder.boolFunctionFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBoolFunctionBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LBoolFunction<Integer> function = boolFunctionFrom(b-> b
                .build()
            );
