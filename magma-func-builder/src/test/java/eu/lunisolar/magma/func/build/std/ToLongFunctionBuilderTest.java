...
import static eu.lunisolar.magma.func.build.std.ToLongFunctionBuilder.toLongFunction;
import static eu.lunisolar.magma.func.build.std.ToLongFunctionBuilder.toLongFunctionFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ToLongFunctionBuilderTest<T>{
    ...
    public void testOtherwiseThrow()  {
        ...
        assertThatThrownBy(() -> {
            ToLongFunction<Integer> function = toLongFunctionFrom(b-> b
                .build()
            );
