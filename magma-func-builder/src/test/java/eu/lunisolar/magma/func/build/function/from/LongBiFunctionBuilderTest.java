...
import static eu.lunisolar.magma.func.build.function.from.LongBiFunctionBuilder.longBiFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LongBiFunctionBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LongBiFunction function = LongBiFunctionBuilder
                .longBiFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LongBiFunction.DESCRIPTION);
