...
import static eu.lunisolar.magma.func.build.predicate.LTriSrtPredicateBuilder.triSrtPredicate;
import static eu.lunisolar.magma.func.build.predicate.LTriSrtPredicateBuilder.triSrtPredicateFrom;

public class LTriSrtPredicateBuilderTest{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LTriSrtPredicate function = triSrtPredicateFrom(b-> b
                .build()
            );

            function.test((short)100,(short)100,(short)100);
    ...
    public void testBuild()  {
        ...
        LTriSrtPredicate function = triSrtPredicateFrom( b -> b
            ...
            .inCase((a1,a2,a3) -> a1 > (short)0 && a1 < (short)10).evaluate((a1,a2,a3) -> true)
            .inCase((a1,a2,a3) -> a1 > (short)10 && a1 < (short)20).evaluate((a1,a2,a3) -> true)
            .otherwise((a1,a2,a3) -> true)
            .build()
        );


        FuncAttests.attestTriSrtPred(function)
            .doesTest((short)0,(short)0,(short)0).when(null).to(a -> a.mustEx(Be::equalEx, false))
            .doesTest((short)5,(short)5,(short)5).when(null).to(a -> a.mustEx(Be::equalEx, true))
        ;
