...
import static eu.lunisolar.magma.func.build.predicate.ObjIntPredicateBuilder.objIntPredicate;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjIntPredicateBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjIntPredicate function = ObjIntPredicateBuilder
                .objIntPredicate()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjIntPredicate.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ObjIntPredicate<Integer > function = objIntPredicate((ObjIntPredicate<Integer > f)-> doNothing())
