...
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.FloatBiConsumerBuilder.floatBiConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class FloatBiConsumerBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            FloatBiConsumer function = FloatBiConsumerBuilder
                .floatBiConsumer()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(FloatBiConsumer.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        FloatBiConsumer function = floatBiConsumer((FloatBiConsumer f)-> doNothing())
