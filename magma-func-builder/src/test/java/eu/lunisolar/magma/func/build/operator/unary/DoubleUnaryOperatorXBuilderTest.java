...
import static eu.lunisolar.magma.func.build.operator.unary.DoubleUnaryOperatorXBuilder.doubleUnaryOperatorX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class DoubleUnaryOperatorXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            DoubleUnaryOperatorX function = DoubleUnaryOperatorXBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(DoubleUnaryOperatorX.DESCRIPTION);
