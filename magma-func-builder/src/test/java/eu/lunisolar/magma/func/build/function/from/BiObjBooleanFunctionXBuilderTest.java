...
import static eu.lunisolar.magma.func.build.function.from.BiObjBooleanFunctionXBuilder.biObjBooleanFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiObjBooleanFunctionXBuilderTest<T1,T2,R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiObjBooleanFunctionX function = BiObjBooleanFunctionXBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiObjBooleanFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BiObjBooleanFunctionX<Integer ,Integer ,Integer ,ParseException> function = biObjBooleanFunctionX((BiObjBooleanFunctionX<Integer ,Integer ,Integer ,ParseException> f)-> doNothing())
