...
import static eu.lunisolar.magma.func.build.operator.ternary.LIntTernaryOperatorBuilder.intTernaryOperator;
import static eu.lunisolar.magma.func.build.operator.ternary.LIntTernaryOperatorBuilder.intTernaryOperatorFrom;

public class LIntTernaryOperatorBuilderTest{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LIntTernaryOperator function = intTernaryOperatorFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestIntTernaryOp(function)
