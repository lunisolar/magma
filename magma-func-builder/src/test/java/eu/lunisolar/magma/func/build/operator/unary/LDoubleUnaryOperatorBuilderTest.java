...
import static eu.lunisolar.magma.func.build.operator.unary.LDoubleUnaryOperatorBuilder.doubleUnaryOperatorFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LDoubleUnaryOperatorBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LDoubleUnaryOperator function = doubleUnaryOperatorFrom(b-> b
                .build()
            );

            function.doApplyAsDouble(100d);
    ...
    public void testBuild()  {
        ...
        LDoubleUnaryOperator function = doubleUnaryOperatorFrom( b -> b
            .aCase(ce -> ce.of(a1 -> a1 == 0d)
                             .evaluate(a1 -> 0d))
            .inCase(a1 -> a1 > 0d && a1 < 10d).evaluate(a1 -> 1d)
            .inCase(a1 -> a1 > 10d && a1 < 20d).evaluate(a1 -> 2d)
            .eventually(a1 -> 99d)
            .build()
        );
