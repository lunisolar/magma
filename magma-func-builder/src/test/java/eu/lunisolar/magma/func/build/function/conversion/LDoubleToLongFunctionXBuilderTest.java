...
public class LDoubleToLongFunctionXBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws Throwable {
        ...
        assertThatThrownBy(() -> {
            LDoubleToLongFunctionX function = LDoubleToLongFunctionXBuilder.doubleToLongFunctionX()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LDoubleToLongFunctionX.DESCRIPTION);
    }
    ...
    public void testBuild() throws Throwable {
        ...
        LDoubleToLongFunctionX<ParseException> function = doubleToLongFunctionX((LDoubleToLongFunctionX<ParseException> f)-> doNothing())
