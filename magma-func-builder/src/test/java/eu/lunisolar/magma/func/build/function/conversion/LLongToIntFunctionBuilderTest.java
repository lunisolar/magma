...
import static eu.lunisolar.magma.func.build.function.conversion.LLongToIntFunctionBuilder.longToIntFunctionFrom;
...
public class LLongToIntFunctionBuilderTest{
    ...
    public void testOtherwiseThrow()  {
        ...
        try {
            LLongToIntFunction function = longToIntFunctionFrom(b-> b
                .build()
            );

            function.applyAsInt(100L);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestLongToIntFunc(function)
            .doesApplyAsInt(0L).when(null).to(a -> a.mustEx(Be::equalEx, 0))
            .doesApplyAsInt(5L).when(null).to(a -> a.mustEx(Be::equalEx, 1))
            .doesApplyAsInt(15L).when(null).to(a -> a.mustEx(Be::equalEx, 2))
            .doesApplyAsInt(10L).when(null).to(a -> a.mustEx(Be::equalEx, 99))
        ;
