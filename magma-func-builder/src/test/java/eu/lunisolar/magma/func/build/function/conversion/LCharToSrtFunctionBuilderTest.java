...
import static eu.lunisolar.magma.func.build.function.conversion.LCharToSrtFunctionBuilder.charToSrtFunction;
import static eu.lunisolar.magma.func.build.function.conversion.LCharToSrtFunctionBuilder.charToSrtFunctionFrom;
...
public class LCharToSrtFunctionBuilderTest{
    ...
    public void testBuild()  {
        ...
        A.assertCharToSrtFunc(function)
            ...
            .doesApplyAsSrt('\u0010').when(null).to(a -> a.isEqualTo((short)99))
        ;
