...
import static eu.lunisolar.magma.func.build.action.ActionXBuilder.actionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ActionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ActionX function = ActionXBuilder
                .actionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ActionX.DESCRIPTION);
