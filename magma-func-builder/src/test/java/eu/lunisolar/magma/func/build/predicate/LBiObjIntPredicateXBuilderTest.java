...
import static eu.lunisolar.magma.func.build.predicate.LBiObjIntPredicateXBuilder.biObjIntPredicateXFrom;
...
public class LBiObjIntPredicateXBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LBiObjIntPredicateX<Integer,Integer,X> function = biObjIntPredicateXFrom(b-> b
                .build()
            );

            function.doTest(100,100,100);
