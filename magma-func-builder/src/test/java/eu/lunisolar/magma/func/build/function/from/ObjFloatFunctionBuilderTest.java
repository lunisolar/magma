...
import static eu.lunisolar.magma.func.build.function.from.ObjFloatFunctionBuilder.objFloatFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjFloatFunctionBuilderTest<T,R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjFloatFunction function = ObjFloatFunctionBuilder
                .objFloatFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjFloatFunction.DESCRIPTION);
