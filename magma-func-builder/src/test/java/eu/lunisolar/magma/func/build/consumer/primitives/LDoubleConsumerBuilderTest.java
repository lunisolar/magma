...
import static eu.lunisolar.magma.func.build.consumer.primitives.LDoubleConsumerBuilder.doubleConsumerFrom;
...
public class LDoubleConsumerBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LDoubleConsumer function = doubleConsumerFrom(b-> b
                .build()
            );
