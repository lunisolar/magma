...
public class LTriDblConsumerBuilderTest{
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestTriDblCons(function)
            .doesAccept(0d,0d,0d).when(null).soThat(() -> Checks.attest(externalEffect.get()).must$(Be::equal$, 0))
            .doesAccept(5d,5d,5d).when(null).soThat(() -> Checks.attest(externalEffect.get()).must$(Be::equal$, 1))
            .doesAccept(15d,15d,15d).when(null).soThat(() -> Checks.attest(externalEffect.get()).must$(Be::equal$, 2))
            .doesAccept(10d,10d,10d).when(null).soThat(() -> Checks.attest(externalEffect.get()).must$(Be::equal$, 99))
        ;
