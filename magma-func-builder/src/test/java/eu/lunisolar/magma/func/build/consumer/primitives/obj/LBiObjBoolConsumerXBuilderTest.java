...
public class LBiObjBoolConsumerXBuilderTest<T1,T2,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LBiObjBoolConsumerX function = LBiObjBoolConsumerXBuilder.biObjBoolConsumerX()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LBiObjBoolConsumerX.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LBiObjBoolConsumerX<Integer ,Integer ,ParseException> function = biObjBoolConsumerX((LBiObjBoolConsumerX<Integer ,Integer ,ParseException> f)-> doNothing())
