...
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.LBiByteConsumerXBuilder.biByteConsumerXFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBiByteConsumerXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LBiByteConsumerX<X> function = biByteConsumerXFrom(b-> b
                .build()
            );
