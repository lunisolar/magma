...
import static eu.lunisolar.magma.func.build.function.to.ToCharFunctionXBuilder.toCharFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ToCharFunctionXBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ToCharFunctionX function = ToCharFunctionXBuilder
                .toCharFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ToCharFunctionX.DESCRIPTION);
