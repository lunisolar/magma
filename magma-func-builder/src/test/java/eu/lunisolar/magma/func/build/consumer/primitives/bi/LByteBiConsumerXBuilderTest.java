...
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.LByteBiConsumerXBuilder.byteBiConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LByteBiConsumerXBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws Throwable {
        ...
        assertThatThrownBy(() -> {
            LByteBiConsumerX function = LByteBiConsumerXBuilder.byteBiConsumerX()
                .build();

            function.doAccept((byte)100,(byte)100);

            fail("No exception were thrown.");
        })
                    .isExactlyInstanceOf(IllegalStateException.class)
                    .hasMessageContaining("No case specified for:")
                    .hasMessageContaining(LByteBiConsumerX.DESCRIPTION);
    }
    ...
    public void testBuild() throws Throwable {
        ...
        LByteBiConsumerX<ParseException> function = byteBiConsumerX((LByteBiConsumerX<ParseException> f)-> doNothing())
            .addCase(ce -> ce.of((b1,b2) -> b1 == (byte)0)
                             .evaluate((b1,b2) -> externalEffect.set(0)))
            .inCase((b1,b2) -> b1 > 0 && b1 < 10).evaluate((b1,b2) -> externalEffect.set(1))
            .inCase((b1,b2) -> b1 > 10 && b1 < 20).evaluate((b1,b2) -> externalEffect.set(2))
