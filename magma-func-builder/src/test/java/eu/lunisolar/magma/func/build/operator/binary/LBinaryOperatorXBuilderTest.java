...
public class LBinaryOperatorXBuilderTest<T,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws Throwable {
        ...
        assertThatThrownBy(() -> {
            LBinaryOperatorX function = LBinaryOperatorXBuilder.binaryOperatorX()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LBinaryOperatorX.DESCRIPTION);
    }
    ...
    public void testBuild() throws Throwable {
        ...
        LBinaryOperatorX<Integer ,ParseException> function = binaryOperatorX((LBinaryOperatorX<Integer ,ParseException> f)-> doNothing())
