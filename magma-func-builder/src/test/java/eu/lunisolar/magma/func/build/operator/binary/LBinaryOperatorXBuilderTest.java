...
import static eu.lunisolar.magma.func.build.operator.binary.LBinaryOperatorXBuilder.binaryOperatorX;
import static eu.lunisolar.magma.func.build.operator.binary.LBinaryOperatorXBuilder.binaryOperatorXFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBinaryOperatorXBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LBinaryOperatorX<Integer,X> function = binaryOperatorXFrom(b-> b
                .build()
            );
