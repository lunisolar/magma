...
import static eu.lunisolar.magma.func.build.predicate.LByteIntPredicateBuilder.byteIntPredicate;
import static eu.lunisolar.magma.func.build.predicate.LByteIntPredicateBuilder.byteIntPredicateFrom;
...
public class LByteIntPredicateBuilderTest{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LByteIntPredicate function = byteIntPredicateFrom(b-> b
                .build()
            );

            function.doTest((byte)100,100);
