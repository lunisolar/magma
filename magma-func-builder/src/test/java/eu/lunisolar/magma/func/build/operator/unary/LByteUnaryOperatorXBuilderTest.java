...
import static eu.lunisolar.magma.func.build.operator.unary.LByteUnaryOperatorXBuilder.byteUnaryOperatorX;
import static eu.lunisolar.magma.func.build.operator.unary.LByteUnaryOperatorXBuilder.byteUnaryOperatorXFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LByteUnaryOperatorXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LByteUnaryOperatorX<X> function = byteUnaryOperatorXFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  throws X {
        ...
        LByteUnaryOperatorX<X> function = byteUnaryOperatorXFrom( b -> b
            .aCase(ce -> ce.of(a1 -> a1 == (byte)0)
                             .evaluate(a1 -> (byte)0))
            .inCase(a1 -> a1 > (byte)0 && a1 < (byte)10).evaluate(a1 -> (byte)1)
            .inCase(a1 -> a1 > (byte)10 && a1 < (byte)20).evaluate(a1 -> (byte)2)
