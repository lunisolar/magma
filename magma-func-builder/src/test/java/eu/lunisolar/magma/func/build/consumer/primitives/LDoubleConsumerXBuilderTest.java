...
import static eu.lunisolar.magma.func.build.consumer.primitives.LDoubleConsumerXBuilder.doubleConsumerXFrom;
...
public class LDoubleConsumerXBuilderTest<X extends ParseException>{
    ...
    public void testBuild()  throws X {
        ...
        A.assertThat(function)
            ...
            .doesAccept(10d).when(null).soThat(() -> assertThat(externalEffect.get()).isEqualTo(99))
        ;
