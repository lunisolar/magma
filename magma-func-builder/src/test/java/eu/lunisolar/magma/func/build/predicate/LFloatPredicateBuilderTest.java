...
import static eu.lunisolar.magma.func.build.predicate.LFloatPredicateBuilder.floatPredicate;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LFloatPredicateBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LFloatPredicate function = LFloatPredicateBuilder
                .floatPredicate()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LFloatPredicate.DESCRIPTION);
