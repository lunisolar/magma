...
import static eu.lunisolar.magma.func.build.function.from.IntFunctionXBuilder.intFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class IntFunctionXBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            IntFunctionX function = IntFunctionXBuilder
                .intFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(IntFunctionX.DESCRIPTION);
