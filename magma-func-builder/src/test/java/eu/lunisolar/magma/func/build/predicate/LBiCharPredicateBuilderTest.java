...
public class LBiCharPredicateBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LBiCharPredicate function = LBiCharPredicateBuilder.biCharPredicate()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LBiCharPredicate.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LBiCharPredicate function = biCharPredicate((LBiCharPredicate f)-> doNothing())
