...
import static eu.lunisolar.magma.func.build.predicate.LObjIntPredicateBuilder.objIntPredicateFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LObjIntPredicateBuilderTest<T>{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LObjIntPredicate<Integer> function = objIntPredicateFrom(b-> b
                .build()
            );
