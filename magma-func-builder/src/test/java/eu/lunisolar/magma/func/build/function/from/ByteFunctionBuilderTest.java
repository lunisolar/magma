...
import static eu.lunisolar.magma.func.build.function.from.ByteFunctionBuilder.byteFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ByteFunctionBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ByteFunction function = ByteFunctionBuilder
                .byteFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ByteFunction.DESCRIPTION);
