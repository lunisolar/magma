...
import static eu.lunisolar.magma.func.build.function.conversion.FloatToCharFunctionBuilder.floatToCharFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class FloatToCharFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            FloatToCharFunction function = FloatToCharFunctionBuilder
                .floatToCharFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(FloatToCharFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        FloatToCharFunction function = floatToCharFunction((FloatToCharFunction f)-> doNothing())
