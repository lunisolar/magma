...
import static eu.lunisolar.magma.func.build.operator.binary.BinaryOperatorBuilder.binaryOperator;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BinaryOperatorBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BinaryOperator function = BinaryOperatorBuilder
                .binaryOperator()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BinaryOperator.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BinaryOperator<Integer > function = binaryOperator((BinaryOperator<Integer > f)-> doNothing())
