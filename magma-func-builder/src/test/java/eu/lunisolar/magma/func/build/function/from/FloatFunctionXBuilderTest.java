...
import static eu.lunisolar.magma.func.build.function.from.FloatFunctionXBuilder.floatFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class FloatFunctionXBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            FloatFunctionX function = FloatFunctionXBuilder
                .floatFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(FloatFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        FloatFunctionX<Integer ,ParseException> function = floatFunctionX((FloatFunctionX<Integer ,ParseException> f)-> doNothing())
