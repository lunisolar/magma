...
import static eu.lunisolar.magma.func.build.predicate.ShortPredicateBuilder.shortPredicate;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ShortPredicateBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ShortPredicate function = ShortPredicateBuilder
                .shortPredicate()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ShortPredicate.DESCRIPTION);
