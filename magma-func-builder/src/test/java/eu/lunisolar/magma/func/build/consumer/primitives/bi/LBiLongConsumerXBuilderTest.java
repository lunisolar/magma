...
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.LBiLongConsumerXBuilder.biLongConsumerXFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBiLongConsumerXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LBiLongConsumerX<X> function = biLongConsumerXFrom(b-> b
                .build()
            );

            function.doAccept(100L,100L);
