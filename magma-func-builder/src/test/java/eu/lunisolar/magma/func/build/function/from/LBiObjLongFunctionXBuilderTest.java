...
import static eu.lunisolar.magma.func.build.function.from.LBiObjLongFunctionXBuilder.biObjLongFunctionXFrom;
...
public class LBiObjLongFunctionXBuilderTest<T1,T2,R,X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LBiObjLongFunctionX<Integer,Integer,Integer,X> function = biObjLongFunctionXFrom(b-> b
                .build()
            );

            function.doApply(100,100,100L);
