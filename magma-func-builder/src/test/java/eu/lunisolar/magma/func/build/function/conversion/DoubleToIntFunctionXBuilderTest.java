...
import static eu.lunisolar.magma.func.build.function.conversion.DoubleToIntFunctionXBuilder.doubleToIntFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class DoubleToIntFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            DoubleToIntFunctionX function = DoubleToIntFunctionXBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(DoubleToIntFunctionX.DESCRIPTION);
