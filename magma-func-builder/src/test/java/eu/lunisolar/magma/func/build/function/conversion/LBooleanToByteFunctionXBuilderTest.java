...
import static eu.lunisolar.magma.func.build.function.conversion.LBooleanToByteFunctionXBuilder.booleanToByteFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBooleanToByteFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LBooleanToByteFunctionX function = LBooleanToByteFunctionXBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LBooleanToByteFunctionX.DESCRIPTION);
