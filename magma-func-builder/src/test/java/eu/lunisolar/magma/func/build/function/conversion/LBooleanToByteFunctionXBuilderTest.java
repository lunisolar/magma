...
public class LBooleanToByteFunctionXBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LBooleanToByteFunctionX function = LBooleanToByteFunctionXBuilder.booleanToByteFunctionX()
                .build();
