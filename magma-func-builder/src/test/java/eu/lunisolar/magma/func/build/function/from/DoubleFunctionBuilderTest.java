...
import static eu.lunisolar.magma.func.build.function.from.DoubleFunctionBuilder.doubleFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class DoubleFunctionBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            DoubleFunction function = DoubleFunctionBuilder
                .doubleFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(DoubleFunction.DESCRIPTION);
