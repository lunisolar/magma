...
import static eu.lunisolar.magma.func.build.predicate.LObjBiIntPredicateBuilder.objBiIntPredicate;
import static eu.lunisolar.magma.func.build.predicate.LObjBiIntPredicateBuilder.objBiIntPredicateFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LObjBiIntPredicateBuilderTest<T>{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LObjBiIntPredicate<Integer> function = objBiIntPredicateFrom(b-> b
                .build()
            );
