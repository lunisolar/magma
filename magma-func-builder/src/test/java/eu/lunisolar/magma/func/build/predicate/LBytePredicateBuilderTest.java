...
import static eu.lunisolar.magma.func.build.predicate.LBytePredicateBuilder.bytePredicateFrom;

public class LBytePredicateBuilderTest{
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestBytePred(function)
            .doesTest((byte)0).when(null).to(a -> a.mustEx(Be::equalEx, false))
            .doesTest((byte)5).when(null).to(a -> a.mustEx(Be::equalEx, true))
        ;
