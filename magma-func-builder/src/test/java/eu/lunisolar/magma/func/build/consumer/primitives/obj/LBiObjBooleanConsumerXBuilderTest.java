...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LBiObjBooleanConsumerXBuilder.biObjBooleanConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBiObjBooleanConsumerXBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LBiObjBooleanConsumerX function = LBiObjBooleanConsumerXBuilder
                .biObjBooleanConsumerX()
                .build();

            function.accept((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),true);
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LBiObjBooleanConsumerX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        LBiObjBooleanConsumerX<Integer ,Integer ,ParseException> function = biObjBooleanConsumerX((LBiObjBooleanConsumerX<Integer ,Integer ,ParseException> f)-> doNothing())
