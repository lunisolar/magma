...
public class LBiObjBooleanConsumerXBuilderTest<T1,T2,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LBiObjBooleanConsumerX function = LBiObjBooleanConsumerXBuilder.biObjBooleanConsumerX()
                .build();
