...
import static eu.lunisolar.magma.func.build.function.from.IntBiFunctionXBuilder.intBiFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class IntBiFunctionXBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            IntBiFunctionX function = IntBiFunctionXBuilder
                .intBiFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(IntBiFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        IntBiFunctionX<Integer ,ParseException> function = intBiFunctionX((IntBiFunctionX<Integer ,ParseException> f)-> doNothing())
