...
import static eu.lunisolar.magma.func.build.function.from.LBiObjSrtFunctionBuilder.biObjSrtFunction;
import static eu.lunisolar.magma.func.build.function.from.LBiObjSrtFunctionBuilder.biObjSrtFunctionFrom;

public class LBiObjSrtFunctionBuilderTest<T1,T2,R>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LBiObjSrtFunction<Integer,Integer,Integer> function = biObjSrtFunctionFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestBiObjSrtFunc(function)
            .doesApply(0,0,(short)0).when(null).to(a -> a.mustEx(Be::equalEx, 0))
            .doesApply(5,5,(short)5).when(null).to(a -> a.mustEx(Be::equalEx, 1))
            .doesApply(15,15,(short)15).when(null).to(a -> a.mustEx(Be::equalEx, 2))
            .doesApply(10,10,(short)10).when(null).to(a -> a.mustEx(Be::equalEx, 99))
        ;
