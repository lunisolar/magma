...
import static eu.lunisolar.magma.func.build.consumer.primitives.LByteConsumerXBuilder.byteConsumerXFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LByteConsumerXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LByteConsumerX<X> function = byteConsumerXFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  throws X {
        ...
        A.assertThat(function)
            ...
            .doesAccept((byte)10).when(null).soThat(() -> assertThat(externalEffect.get()).isEqualTo(99))
        ;
