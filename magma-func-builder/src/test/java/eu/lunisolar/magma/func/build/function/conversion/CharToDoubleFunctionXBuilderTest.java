...
import static eu.lunisolar.magma.func.build.function.conversion.CharToDoubleFunctionXBuilder.charToDoubleFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class CharToDoubleFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            CharToDoubleFunctionX function = CharToDoubleFunctionXBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(CharToDoubleFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        CharToDoubleFunctionX<ParseException> function = charToDoubleFunctionX((CharToDoubleFunctionX<ParseException> f)-> doNothing())
