...
import static eu.lunisolar.magma.func.build.function.conversion.LLongToCharFunctionXBuilder.longToCharFunctionXFrom;
...
public class LLongToCharFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LLongToCharFunctionX<X> function = longToCharFunctionXFrom(b-> b
                .build()
            );
