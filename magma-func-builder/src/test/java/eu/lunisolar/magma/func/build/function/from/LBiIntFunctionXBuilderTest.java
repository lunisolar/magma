...
import static eu.lunisolar.magma.func.build.function.from.LBiIntFunctionXBuilder.biIntFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBiIntFunctionXBuilderTest<R,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LBiIntFunctionX function = LBiIntFunctionXBuilder.biIntFunctionX()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LBiIntFunctionX.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LBiIntFunctionX<Integer ,ParseException> function = biIntFunctionX((LBiIntFunctionX<Integer ,ParseException> f)-> doNothing())
