...
import static eu.lunisolar.magma.func.build.predicate.LObjFltPredicateBuilder.objFltPredicate;
import static eu.lunisolar.magma.func.build.predicate.LObjFltPredicateBuilder.objFltPredicateFrom;

public class LObjFltPredicateBuilderTest<T>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LObjFltPredicate<Integer> function = objFltPredicateFrom(b-> b
                .build()
            );

            function.test(100,100f);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestObjFltPred(function)
            .doesTest(0,0f).when(null).to(a -> a.mustEx(Be::equalEx, false))
            .doesTest(5,5f).when(null).to(a -> a.mustEx(Be::equalEx, true))
        ;
