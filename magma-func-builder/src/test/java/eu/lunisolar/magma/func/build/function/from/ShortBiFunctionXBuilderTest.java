...
import static eu.lunisolar.magma.func.build.function.from.ShortBiFunctionXBuilder.shortBiFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ShortBiFunctionXBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ShortBiFunctionX function = ShortBiFunctionXBuilder
                .shortBiFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ShortBiFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ShortBiFunctionX<Integer ,ParseException> function = shortBiFunctionX((ShortBiFunctionX<Integer ,ParseException> f)-> doNothing())
