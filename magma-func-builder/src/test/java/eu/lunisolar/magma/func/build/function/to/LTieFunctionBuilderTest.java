...
import static eu.lunisolar.magma.func.build.function.to.LTieFunctionBuilder.tieFunction;
import static eu.lunisolar.magma.func.build.function.to.LTieFunctionBuilder.tieFunctionFrom;

public class LTieFunctionBuilderTest<T1,T2>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LTieFunction<Integer,Integer> function = tieFunctionFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestTieFunc(function)
