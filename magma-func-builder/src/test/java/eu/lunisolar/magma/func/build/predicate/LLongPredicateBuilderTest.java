...
import static eu.lunisolar.magma.func.build.predicate.LLongPredicateBuilder.longPredicateFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LLongPredicateBuilderTest{
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestLongPred(function)
            .doesTest(0L).when(null).to(a -> a.must$(Be::equal$, false))
            .doesTest(5L).when(null).to(a -> a.must$(Be::equal$, true))
        ;
