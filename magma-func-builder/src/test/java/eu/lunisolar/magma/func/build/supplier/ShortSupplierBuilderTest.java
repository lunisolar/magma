...
import static eu.lunisolar.magma.func.build.supplier.ShortSupplierBuilder.shortSupplier;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ShortSupplierBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ShortSupplier function = ShortSupplierBuilder
                .shortSupplier()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ShortSupplier.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ShortSupplier function = shortSupplier((ShortSupplier f)-> doNothing())
