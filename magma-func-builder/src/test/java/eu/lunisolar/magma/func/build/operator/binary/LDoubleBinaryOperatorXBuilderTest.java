...
import static eu.lunisolar.magma.func.build.operator.binary.LDoubleBinaryOperatorXBuilder.doubleBinaryOperatorXFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LDoubleBinaryOperatorXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LDoubleBinaryOperatorX<X> function = doubleBinaryOperatorXFrom(b-> b
                .build()
            );

            function.doApplyAsDouble(100d,100d);
