...
import static eu.lunisolar.magma.func.build.function.conversion.ShortToDoubleFunctionBuilder.shortToDoubleFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ShortToDoubleFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ShortToDoubleFunction function = ShortToDoubleFunctionBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ShortToDoubleFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ShortToDoubleFunction function = shortToDoubleFunction((ShortToDoubleFunction f)-> doNothing())
