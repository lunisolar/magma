...
import static eu.lunisolar.magma.func.build.function.conversion.LBoolToIntFunctionXBuilder.boolToIntFunctionXFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBoolToIntFunctionXBuilderTest<X extends ParseException>{
