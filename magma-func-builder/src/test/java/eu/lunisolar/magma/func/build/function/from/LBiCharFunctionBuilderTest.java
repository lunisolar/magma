...
import static eu.lunisolar.magma.func.build.function.from.LBiCharFunctionBuilder.biCharFunction;
import static eu.lunisolar.magma.func.build.function.from.LBiCharFunctionBuilder.biCharFunctionFrom;

public class LBiCharFunctionBuilderTest<R>{
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestBiCharFunc(function)
