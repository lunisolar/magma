...
public class LBiCharFunctionBuilderTest<R,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LBiCharFunction function = LBiCharFunctionBuilder.biCharFunction()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LBiCharFunction.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LBiCharFunction<Integer > function = biCharFunction((LBiCharFunction<Integer > f)-> doNothing())
