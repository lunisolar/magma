...
public class LBoolConsumerBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LBoolConsumer function = LBoolConsumerBuilder.boolConsumer()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LBoolConsumer.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LBoolConsumer function = boolConsumer((LBoolConsumer f)-> doNothing())
