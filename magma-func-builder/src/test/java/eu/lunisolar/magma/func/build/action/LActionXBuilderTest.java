...
import static eu.lunisolar.magma.func.build.action.LActionXBuilder.actionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LActionXBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws Throwable {
        ...
        assertThatThrownBy(() -> {
            LActionX function = LActionXBuilder.actionX()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LActionX.DESCRIPTION);
    }
    ...
    public void testBuild() throws Throwable {
        ...
        LActionX<ParseException> function = actionX((LActionX<ParseException> f)-> doNothing())
