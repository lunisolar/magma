...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LBiObjByteConsumerXBuilder.biObjByteConsumerXFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBiObjByteConsumerXBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LBiObjByteConsumerX<Integer,Integer,X> function = biObjByteConsumerXFrom(b-> b
                .build()
            );
