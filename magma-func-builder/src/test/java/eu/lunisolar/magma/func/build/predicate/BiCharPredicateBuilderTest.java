...
import static eu.lunisolar.magma.func.build.predicate.BiCharPredicateBuilder.biCharPredicate;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiCharPredicateBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiCharPredicate function = BiCharPredicateBuilder
                .biCharPredicate()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiCharPredicate.DESCRIPTION);
