...
import static eu.lunisolar.magma.func.build.operator.ternary.BooleanTernaryOperatorBuilder.booleanTernaryOperator;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BooleanTernaryOperatorBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BooleanTernaryOperator function = BooleanTernaryOperatorBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BooleanTernaryOperator.DESCRIPTION);
