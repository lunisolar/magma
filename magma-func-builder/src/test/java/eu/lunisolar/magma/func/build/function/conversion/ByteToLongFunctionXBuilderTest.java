...
import static eu.lunisolar.magma.func.build.function.conversion.ByteToLongFunctionXBuilder.byteToLongFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ByteToLongFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ByteToLongFunctionX function = ByteToLongFunctionXBuilder
                .byteToLongFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ByteToLongFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ByteToLongFunctionX<ParseException> function = byteToLongFunctionX((ByteToLongFunctionX<ParseException> f)-> doNothing())
