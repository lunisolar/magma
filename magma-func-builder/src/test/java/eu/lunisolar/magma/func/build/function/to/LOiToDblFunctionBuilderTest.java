...
import static eu.lunisolar.magma.func.build.function.to.LOiToDblFunctionBuilder.oiToDblFunction;
import static eu.lunisolar.magma.func.build.function.to.LOiToDblFunctionBuilder.oiToDblFunctionFrom;

public class LOiToDblFunctionBuilderTest<T>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LOiToDblFunction<Integer> function = oiToDblFunctionFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestOiToDblFunc(function)
