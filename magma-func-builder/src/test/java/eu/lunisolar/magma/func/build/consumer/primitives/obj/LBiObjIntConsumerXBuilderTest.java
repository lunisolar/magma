...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LBiObjIntConsumerXBuilder.biObjIntConsumerXFrom;
...
public class LBiObjIntConsumerXBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LBiObjIntConsumerX<Integer,Integer,X> function = biObjIntConsumerXFrom(b-> b
                .build()
            );

            function.doAccept(100,100,100);
    ...
    public void testBuild()  throws X {
        ...
        A.assertThat(function)
            ...
            .doesAccept(10,10,10).when(null).soThat(() -> assertThat(externalEffect.get()).isEqualTo(99))
        ;
