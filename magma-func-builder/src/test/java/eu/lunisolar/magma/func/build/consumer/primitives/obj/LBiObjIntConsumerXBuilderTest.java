...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LBiObjIntConsumerXBuilder.biObjIntConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBiObjIntConsumerXBuilderTest<T1,T2,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws Throwable {
        ...
        assertThatThrownBy(() -> {
            LBiObjIntConsumerX function = LBiObjIntConsumerXBuilder.biObjIntConsumerX()
                .build();

            function.doAccept((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),(int)100);

            fail("No exception were thrown.");
        })
                    .isExactlyInstanceOf(IllegalStateException.class)
                    .hasMessageContaining("No case specified for:")
                    .hasMessageContaining(LBiObjIntConsumerX.DESCRIPTION);
    }
    ...
    public void testBuild() throws Throwable {
        ...
        LBiObjIntConsumerX<Integer ,Integer ,ParseException> function = biObjIntConsumerX((LBiObjIntConsumerX<Integer ,Integer ,ParseException> f)-> doNothing())
            .addCase(ce -> ce.of((t1,t2, i) -> t1 == Integer.valueOf(0))
                             .evaluate((t1,t2, i) -> externalEffect.set(0)))
            .inCase((t1,t2, i) -> t1 > 0 && t1 < 10).evaluate((t1,t2, i) -> externalEffect.set(1))
            .inCase((t1,t2, i) -> t1 > 10 && t1 < 20).evaluate((t1,t2, i) -> externalEffect.set(2))
            .eventually((t1,t2, i) -> externalEffect.set(99))
            .build();
