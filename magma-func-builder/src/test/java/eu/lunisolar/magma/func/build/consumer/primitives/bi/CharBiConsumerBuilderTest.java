...
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.CharBiConsumerBuilder.charBiConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class CharBiConsumerBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            CharBiConsumer function = CharBiConsumerBuilder
                .charBiConsumer()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(CharBiConsumer.DESCRIPTION);
