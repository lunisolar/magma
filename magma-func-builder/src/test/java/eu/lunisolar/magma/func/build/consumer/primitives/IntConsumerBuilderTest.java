...
import static eu.lunisolar.magma.func.build.consumer.primitives.IntConsumerBuilder.intConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class IntConsumerBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            IntConsumer function = IntConsumerBuilder
                .intConsumer()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(IntConsumer.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        IntConsumer function = intConsumer((IntConsumer f)-> doNothing())
