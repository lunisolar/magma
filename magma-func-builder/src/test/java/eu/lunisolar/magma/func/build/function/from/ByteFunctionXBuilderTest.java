...
import static eu.lunisolar.magma.func.build.function.from.ByteFunctionXBuilder.byteFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ByteFunctionXBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ByteFunctionX function = ByteFunctionXBuilder
                .byteFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ByteFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ByteFunctionX<Integer ,ParseException> function = byteFunctionX((ByteFunctionX<Integer ,ParseException> f)-> doNothing())
