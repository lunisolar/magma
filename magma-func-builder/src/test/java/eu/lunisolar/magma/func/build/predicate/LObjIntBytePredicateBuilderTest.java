...
import static eu.lunisolar.magma.func.build.predicate.LObjIntBytePredicateBuilder.objIntBytePredicate;
import static eu.lunisolar.magma.func.build.predicate.LObjIntBytePredicateBuilder.objIntBytePredicateFrom;

public class LObjIntBytePredicateBuilderTest<T>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LObjIntBytePredicate<Integer> function = objIntBytePredicateFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestObjIntBytePred(function)
            .doesTest(0,0,(byte)0).when(null).to(a -> a.mustEx(Be::equalEx, false))
            .doesTest(5,5,(byte)5).when(null).to(a -> a.mustEx(Be::equalEx, true))
        ;
