...
import static eu.lunisolar.magma.func.build.predicate.LBiObjIntPredicateBuilder.biObjIntPredicateFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBiObjIntPredicateBuilderTest<T1,T2>{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LBiObjIntPredicate<Integer,Integer> function = biObjIntPredicateFrom(b-> b
                .build()
            );
