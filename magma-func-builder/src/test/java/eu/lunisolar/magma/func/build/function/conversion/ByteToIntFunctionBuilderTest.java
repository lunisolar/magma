...
import static eu.lunisolar.magma.func.build.function.conversion.ByteToIntFunctionBuilder.byteToIntFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ByteToIntFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ByteToIntFunction function = ByteToIntFunctionBuilder
                .byteToIntFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ByteToIntFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ByteToIntFunction function = byteToIntFunction((ByteToIntFunction f)-> doNothing())
