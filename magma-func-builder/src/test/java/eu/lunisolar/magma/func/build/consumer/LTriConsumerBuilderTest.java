...
import static eu.lunisolar.magma.func.build.consumer.LTriConsumerBuilder.triConsumerFrom;
...
public class LTriConsumerBuilderTest<T1,T2,T3>{
    ...
    public void testOtherwiseThrow()  {
        ...
        try {
            LTriConsumer<Integer,Integer,Integer> function = triConsumerFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestTriCons(function)
