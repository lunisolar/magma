...
import static eu.lunisolar.magma.func.build.consumer.LTriConsumerBuilder.triConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LTriConsumerBuilderTest<T1,T2,T3,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LTriConsumer function = LTriConsumerBuilder.triConsumer()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LTriConsumer.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LTriConsumer<Integer ,Integer ,Integer > function = triConsumer((LTriConsumer<Integer ,Integer ,Integer > f)-> doNothing())
