...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.BiObjLongConsumerBuilder.biObjLongConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiObjLongConsumerBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiObjLongConsumer function = BiObjLongConsumerBuilder
                .biObjLongConsumer()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiObjLongConsumer.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BiObjLongConsumer<Integer ,Integer > function = biObjLongConsumer((BiObjLongConsumer<Integer ,Integer > f)-> doNothing())
