...
import static eu.lunisolar.magma.func.build.operator.binary.BooleanBinaryOperatorBuilder.booleanBinaryOperator;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BooleanBinaryOperatorBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BooleanBinaryOperator function = BooleanBinaryOperatorBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BooleanBinaryOperator.DESCRIPTION);
