...
import static eu.lunisolar.magma.func.build.function.from.BooleanBiFunctionXBuilder.booleanBiFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BooleanBiFunctionXBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BooleanBiFunctionX function = BooleanBiFunctionXBuilder
                .booleanBiFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BooleanBiFunctionX.DESCRIPTION);
