...
import static eu.lunisolar.magma.func.build.supplier.LDoubleSupplierBuilder.doubleSupplier;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LDoubleSupplierBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LDoubleSupplier function = LDoubleSupplierBuilder.doubleSupplier()
                .build();

            function.doGetAsDouble();

            fail("No exception were thrown.");
        })
                    .isExactlyInstanceOf(IllegalStateException.class)
                    .hasMessageContaining("No case specified for:")
                    .hasMessageContaining(LDoubleSupplier.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LDoubleSupplier function = doubleSupplier((LDoubleSupplier f)-> doNothing())
