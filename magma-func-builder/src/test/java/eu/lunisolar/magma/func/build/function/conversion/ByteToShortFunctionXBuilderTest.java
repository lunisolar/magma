...
import static eu.lunisolar.magma.func.build.function.conversion.ByteToShortFunctionXBuilder.byteToShortFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ByteToShortFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ByteToShortFunctionX function = ByteToShortFunctionXBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ByteToShortFunctionX.DESCRIPTION);
