...
import static eu.lunisolar.magma.func.build.function.from.LObjIntDblFunctionBuilder.objIntDblFunction;
import static eu.lunisolar.magma.func.build.function.from.LObjIntDblFunctionBuilder.objIntDblFunctionFrom;

public class LObjIntDblFunctionBuilderTest<T,R>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LObjIntDblFunction<Integer,Integer> function = objIntDblFunctionFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestObjIntDblFunc(function)
