...
import static eu.lunisolar.magma.func.build.function.from.ObjByteFunctionXBuilder.objByteFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjByteFunctionXBuilderTest<T,R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjByteFunctionX function = ObjByteFunctionXBuilder
                .objByteFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjByteFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ObjByteFunctionX<Integer ,Integer ,ParseException> function = objByteFunctionX((ObjByteFunctionX<Integer ,Integer ,ParseException> f)-> doNothing())
