...
import static eu.lunisolar.magma.func.build.operator.unary.CharUnaryOperatorXBuilder.charUnaryOperatorX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class CharUnaryOperatorXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            CharUnaryOperatorX function = CharUnaryOperatorXBuilder
                .charUnaryOperatorX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(CharUnaryOperatorX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        CharUnaryOperatorX<ParseException> function = charUnaryOperatorX((CharUnaryOperatorX<ParseException> f)-> doNothing())
