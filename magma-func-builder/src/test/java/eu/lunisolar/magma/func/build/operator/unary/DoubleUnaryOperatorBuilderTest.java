...
import static eu.lunisolar.magma.func.build.operator.unary.DoubleUnaryOperatorBuilder.doubleUnaryOperator;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class DoubleUnaryOperatorBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            DoubleUnaryOperator function = DoubleUnaryOperatorBuilder
                .doubleUnaryOperator()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(DoubleUnaryOperator.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        DoubleUnaryOperator function = doubleUnaryOperator((DoubleUnaryOperator f)-> doNothing())
