...
import static eu.lunisolar.magma.func.build.supplier.IntSupplierBuilder.intSupplier;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class IntSupplierBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            IntSupplier function = IntSupplierBuilder
                .intSupplier()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(IntSupplier.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        IntSupplier function = intSupplier((IntSupplier f)-> doNothing())
