...
import static eu.lunisolar.magma.func.build.function.from.LBiObjBoolFunctionBuilder.biObjBoolFunctionFrom;

public class LBiObjBoolFunctionBuilderTest<T1,T2,R>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LBiObjBoolFunction<Integer,Integer,Integer> function = biObjBoolFunctionFrom(b-> b
                .build()
            );

            function.apply(100,100,true);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestBiObjBoolFunc(function)
            .doesApply(0,0,false).when(null).to(a -> a.mustEx(Be::equalEx, 0))
            .doesApply(5,5,true).when(null).to(a -> a.mustEx(Be::equalEx, 1))
            .doesApply(15,15,true).when(null).to(a -> a.mustEx(Be::equalEx, 2))
            .doesApply(10,10,true).when(null).to(a -> a.mustEx(Be::equalEx, 99))
        ;
