...
import static eu.lunisolar.magma.func.build.predicate.BiFloatPredicateXBuilder.biFloatPredicateX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiFloatPredicateXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiFloatPredicateX function = BiFloatPredicateXBuilder
                .biFloatPredicateX()
                .build();

            function.test((float)100,(float)100);
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiFloatPredicateX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BiFloatPredicateX<ParseException> function = biFloatPredicateX((BiFloatPredicateX<ParseException> f)-> doNothing())
