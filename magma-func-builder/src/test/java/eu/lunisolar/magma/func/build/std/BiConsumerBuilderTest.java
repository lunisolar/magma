...
import static eu.lunisolar.magma.func.build.std.BiConsumerBuilder.biConsumer;
import static eu.lunisolar.magma.func.build.std.BiConsumerBuilder.biConsumerFrom;

public class BiConsumerBuilderTest<T1,T2>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            BiConsumer<Integer,Integer> function = biConsumerFrom(b-> b
                .build()
            );
