...
import static eu.lunisolar.magma.func.build.function.conversion.LByteToShortFunctionBuilder.byteToShortFunctionFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LByteToShortFunctionBuilderTest<X extends ParseException>{
