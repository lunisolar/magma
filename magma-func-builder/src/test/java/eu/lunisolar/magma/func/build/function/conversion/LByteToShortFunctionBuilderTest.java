...
import static eu.lunisolar.magma.func.build.function.conversion.LByteToShortFunctionBuilder.byteToShortFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LByteToShortFunctionBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LByteToShortFunction.DESCRIPTION);
    }
