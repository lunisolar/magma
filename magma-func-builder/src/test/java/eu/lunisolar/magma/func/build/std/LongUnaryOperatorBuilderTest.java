...
import static eu.lunisolar.magma.func.build.std.LongUnaryOperatorBuilder.longUnaryOperator;
import static eu.lunisolar.magma.func.build.std.LongUnaryOperatorBuilder.longUnaryOperatorFrom;

public class LongUnaryOperatorBuilderTest{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LongUnaryOperator function = longUnaryOperatorFrom(b-> b
                .build()
            );

            function.applyAsLong(100L);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestLongUnaryOp(function)
            .doesApplyAsLong(0L).when(null).to(a -> a.mustEx(Be::equalEx, 0L))
            .doesApplyAsLong(5L).when(null).to(a -> a.mustEx(Be::equalEx, 1L))
            .doesApplyAsLong(15L).when(null).to(a -> a.mustEx(Be::equalEx, 2L))
            .doesApplyAsLong(10L).when(null).to(a -> a.mustEx(Be::equalEx, 99L))
        ;
