...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LTieFltConsumerBuilder.tieFltConsumer;
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LTieFltConsumerBuilder.tieFltConsumerFrom;

public class LTieFltConsumerBuilderTest<T>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LTieFltConsumer<Integer> function = tieFltConsumerFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestTieFltCons(function)
