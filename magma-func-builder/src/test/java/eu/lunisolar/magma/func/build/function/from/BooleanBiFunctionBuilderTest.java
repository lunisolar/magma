...
import static eu.lunisolar.magma.func.build.function.from.BooleanBiFunctionBuilder.booleanBiFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BooleanBiFunctionBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BooleanBiFunction function = BooleanBiFunctionBuilder
                .booleanBiFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BooleanBiFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BooleanBiFunction<Integer > function = booleanBiFunction((BooleanBiFunction<Integer > f)-> doNothing())
