...
import static eu.lunisolar.magma.func.build.function.to.ToCharFunctionBuilder.toCharFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ToCharFunctionBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ToCharFunction function = ToCharFunctionBuilder
                .toCharFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ToCharFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ToCharFunction<Integer > function = toCharFunction((ToCharFunction<Integer > f)-> doNothing())
