...
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.LBiSrtConsumerBuilder.biSrtConsumer;
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.LBiSrtConsumerBuilder.biSrtConsumerFrom;

public class LBiSrtConsumerBuilderTest{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LBiSrtConsumer function = biSrtConsumerFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestBiSrtCons(function)
            .doesAccept((short)0,(short)0).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 0))
            .doesAccept((short)5,(short)5).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 1))
            .doesAccept((short)15,(short)15).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 2))
            .doesAccept((short)10,(short)10).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 99))
        ;
