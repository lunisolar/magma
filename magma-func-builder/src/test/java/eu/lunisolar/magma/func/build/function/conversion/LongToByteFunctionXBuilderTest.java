...
import static eu.lunisolar.magma.func.build.function.conversion.LongToByteFunctionXBuilder.longToByteFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LongToByteFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LongToByteFunctionX function = LongToByteFunctionXBuilder
                .longToByteFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LongToByteFunctionX.DESCRIPTION);
