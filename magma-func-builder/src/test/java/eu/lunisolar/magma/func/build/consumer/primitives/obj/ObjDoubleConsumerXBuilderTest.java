...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.ObjDoubleConsumerXBuilder.objDoubleConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjDoubleConsumerXBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjDoubleConsumerX function = ObjDoubleConsumerXBuilder
                .objDoubleConsumerX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjDoubleConsumerX.DESCRIPTION);
