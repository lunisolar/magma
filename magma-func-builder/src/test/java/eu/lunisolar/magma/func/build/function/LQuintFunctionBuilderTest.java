...
public class LQuintFunctionBuilderTest<T1,T2,T3,T4,T5,R>{
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestQuintFunc(function)
            .doesApply(0,0,0,0,0).when(null).to(a -> a.must$(Be::equal$, 0))
            .doesApply(5,5,5,5,5).when(null).to(a -> a.must$(Be::equal$, 1))
            .doesApply(15,15,15,15,15).when(null).to(a -> a.must$(Be::equal$, 2))
            .doesApply(10,10,10,10,10).when(null).to(a -> a.must$(Be::equal$, 99))
        ;
