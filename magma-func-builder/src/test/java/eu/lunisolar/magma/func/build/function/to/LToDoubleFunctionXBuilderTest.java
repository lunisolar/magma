...
import static eu.lunisolar.magma.func.build.function.to.LToDoubleFunctionXBuilder.toDoubleFunctionXFrom;
...
public class LToDoubleFunctionXBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LToDoubleFunctionX<Integer,X> function = toDoubleFunctionXFrom(b-> b
                .build()
            );
