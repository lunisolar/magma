...
import static eu.lunisolar.magma.func.build.function.conversion.IntToByteFunctionBuilder.intToByteFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class IntToByteFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            IntToByteFunction function = IntToByteFunctionBuilder
                .intToByteFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(IntToByteFunction.DESCRIPTION);
