...
import static eu.lunisolar.magma.func.build.predicate.LBiFltPredicateBuilder.biFltPredicate;
import static eu.lunisolar.magma.func.build.predicate.LBiFltPredicateBuilder.biFltPredicateFrom;

public class LBiFltPredicateBuilderTest{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LBiFltPredicate function = biFltPredicateFrom(b-> b
                .build()
            );

            function.test(100f,100f);
    ...
    public void testBuild()  {
        ...
        LBiFltPredicate function = biFltPredicateFrom( b -> b
            ...
            .inCase((a1,a2) -> a1 > 0f && a1 < 10f).evaluate((a1,a2) -> true)
            .inCase((a1,a2) -> a1 > 10f && a1 < 20f).evaluate((a1,a2) -> true)
            .otherwise((a1,a2) -> true)
            .build()
        );


        FuncAttests.attestBiFltPred(function)
            .doesTest(0f,0f).when(null).to(a -> a.mustEx(Be::equalEx, false))
            .doesTest(5f,5f).when(null).to(a -> a.mustEx(Be::equalEx, true))
        ;
