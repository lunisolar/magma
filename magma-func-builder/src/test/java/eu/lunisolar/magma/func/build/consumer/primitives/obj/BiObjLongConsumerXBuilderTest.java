...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.BiObjLongConsumerXBuilder.biObjLongConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiObjLongConsumerXBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiObjLongConsumerX function = BiObjLongConsumerXBuilder
                .biObjLongConsumerX()
                .build();

            function.accept((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),(long)100);
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiObjLongConsumerX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BiObjLongConsumerX<Integer ,Integer ,ParseException> function = biObjLongConsumerX((BiObjLongConsumerX<Integer ,Integer ,ParseException> f)-> doNothing())
