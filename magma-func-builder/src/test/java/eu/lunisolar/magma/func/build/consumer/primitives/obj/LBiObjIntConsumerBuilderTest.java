...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LBiObjIntConsumerBuilder.biObjIntConsumer;
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LBiObjIntConsumerBuilder.biObjIntConsumerFrom;

public class LBiObjIntConsumerBuilderTest<T1,T2>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LBiObjIntConsumer<Integer,Integer> function = biObjIntConsumerFrom(b-> b
                .build()
            );
