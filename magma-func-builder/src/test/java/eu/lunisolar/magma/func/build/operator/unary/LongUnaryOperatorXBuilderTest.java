...
import static eu.lunisolar.magma.func.build.operator.unary.LongUnaryOperatorXBuilder.longUnaryOperatorX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LongUnaryOperatorXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LongUnaryOperatorX function = LongUnaryOperatorXBuilder
                .longUnaryOperatorX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LongUnaryOperatorX.DESCRIPTION);
