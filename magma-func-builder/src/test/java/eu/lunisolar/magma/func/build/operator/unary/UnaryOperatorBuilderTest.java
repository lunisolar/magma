...
import static eu.lunisolar.magma.func.build.operator.unary.UnaryOperatorBuilder.unaryOperator;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class UnaryOperatorBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            UnaryOperator function = UnaryOperatorBuilder
                .unaryOperator()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(UnaryOperator.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        UnaryOperator<Integer > function = unaryOperator((UnaryOperator<Integer > f)-> doNothing())
