...
import static eu.lunisolar.magma.func.build.function.conversion.IntToDoubleFunctionXBuilder.intToDoubleFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class IntToDoubleFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            IntToDoubleFunctionX function = IntToDoubleFunctionXBuilder
                .intToDoubleFunctionX()
                .build();

            function.applyAsDouble((int)100);
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(IntToDoubleFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        IntToDoubleFunctionX<ParseException> function = intToDoubleFunctionX((IntToDoubleFunctionX<ParseException> f)-> doNothing())
