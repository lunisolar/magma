...
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.LCharBiConsumerBuilder.charBiConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LCharBiConsumerBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LCharBiConsumer function = LCharBiConsumerBuilder
                .charBiConsumer()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LCharBiConsumer.DESCRIPTION);
