...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LTieSrtConsumerBuilder.tieSrtConsumer;
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LTieSrtConsumerBuilder.tieSrtConsumerFrom;

public class LTieSrtConsumerBuilderTest<T>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LTieSrtConsumer<Integer> function = tieSrtConsumerFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestTieSrtCons(function)
