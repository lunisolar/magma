...
import static eu.lunisolar.magma.func.build.predicate.BiLongPredicateXBuilder.biLongPredicateX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiLongPredicateXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiLongPredicateX function = BiLongPredicateXBuilder
                .biLongPredicateX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiLongPredicateX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BiLongPredicateX<ParseException> function = biLongPredicateX((BiLongPredicateX<ParseException> f)-> doNothing())
