...
import static eu.lunisolar.magma.func.build.function.to.ToLongBiFunctionXBuilder.toLongBiFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ToLongBiFunctionXBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ToLongBiFunctionX function = ToLongBiFunctionXBuilder
                .toLongBiFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ToLongBiFunctionX.DESCRIPTION);
