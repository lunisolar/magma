...
import static eu.lunisolar.magma.func.build.operator.binary.LLogicalBinaryOperatorXBuilder.logicalBinaryOperatorX;
import static eu.lunisolar.magma.func.build.operator.binary.LLogicalBinaryOperatorXBuilder.logicalBinaryOperatorXFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LLogicalBinaryOperatorXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LLogicalBinaryOperatorX<X> function = logicalBinaryOperatorXFrom(b-> b
                .build()
            );
