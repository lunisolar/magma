...
public class LObjDblConsumerBuilderTest<T>{
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestObjDblCons(function)
            .doesAccept(0,0d).when(null).soThat(() -> Checks.attest(externalEffect.get()).must$(Be::equal$, 0))
            .doesAccept(5,5d).when(null).soThat(() -> Checks.attest(externalEffect.get()).must$(Be::equal$, 1))
            .doesAccept(15,15d).when(null).soThat(() -> Checks.attest(externalEffect.get()).must$(Be::equal$, 2))
            .doesAccept(10,10d).when(null).soThat(() -> Checks.attest(externalEffect.get()).must$(Be::equal$, 99))
        ;
