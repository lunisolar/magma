...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LObjDblConsumerBuilder.objDblConsumer;
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LObjDblConsumerBuilder.objDblConsumerFrom;

public class LObjDblConsumerBuilderTest<T>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LObjDblConsumer<Integer> function = objDblConsumerFrom(b-> b
                .build()
            );

            function.accept(100,100d);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestObjDblCons(function)
            .doesAccept(0,0d).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 0))
            .doesAccept(5,5d).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 1))
            .doesAccept(15,15d).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 2))
            .doesAccept(10,10d).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 99))
        ;
