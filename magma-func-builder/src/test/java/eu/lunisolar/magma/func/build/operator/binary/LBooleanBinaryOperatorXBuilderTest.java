...
import static eu.lunisolar.magma.func.build.operator.binary.LBooleanBinaryOperatorXBuilder.booleanBinaryOperatorX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBooleanBinaryOperatorXBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws Throwable {
        ...
        assertThatThrownBy(() -> {
            LBooleanBinaryOperatorX function = LBooleanBinaryOperatorXBuilder.booleanBinaryOperatorX()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LBooleanBinaryOperatorX.DESCRIPTION);
    }
    ...
    public void testBuild() throws Throwable {
        ...
        LBooleanBinaryOperatorX<ParseException> function = booleanBinaryOperatorX((LBooleanBinaryOperatorX<ParseException> f)-> doNothing())
