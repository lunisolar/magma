...
import static eu.lunisolar.magma.func.build.function.conversion.LByteToSrtFunctionBuilder.byteToSrtFunction;
import static eu.lunisolar.magma.func.build.function.conversion.LByteToSrtFunctionBuilder.byteToSrtFunctionFrom;

public class LByteToSrtFunctionBuilderTest{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LByteToSrtFunction function = byteToSrtFunctionFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestByteToSrtFunc(function)
            .doesApplyAsSrt((byte)0).when(null).to(a -> a.mustEx(Be::equalEx, (short)0))
            .doesApplyAsSrt((byte)5).when(null).to(a -> a.mustEx(Be::equalEx, (short)1))
            .doesApplyAsSrt((byte)15).when(null).to(a -> a.mustEx(Be::equalEx, (short)2))
            .doesApplyAsSrt((byte)10).when(null).to(a -> a.mustEx(Be::equalEx, (short)99))
        ;
