...
import static eu.lunisolar.magma.func.build.operator.unary.LBooleanUnaryOperatorBuilder.booleanUnaryOperator;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBooleanUnaryOperatorBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws Throwable {
        ...
        assertThatThrownBy(() -> {
            LBooleanUnaryOperator function = LBooleanUnaryOperatorBuilder.booleanUnaryOperator()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LBooleanUnaryOperator.DESCRIPTION);
    }
    ...
    public void testBuild() throws Throwable {
        ...
        LBooleanUnaryOperator function = booleanUnaryOperator((LBooleanUnaryOperator f)-> doNothing())
