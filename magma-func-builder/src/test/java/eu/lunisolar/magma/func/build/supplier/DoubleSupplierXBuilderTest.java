...
import static eu.lunisolar.magma.func.build.supplier.DoubleSupplierXBuilder.doubleSupplierX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class DoubleSupplierXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            DoubleSupplierX function = DoubleSupplierXBuilder
                .doubleSupplierX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(DoubleSupplierX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        DoubleSupplierX<ParseException> function = doubleSupplierX((DoubleSupplierX<ParseException> f)-> doNothing())
