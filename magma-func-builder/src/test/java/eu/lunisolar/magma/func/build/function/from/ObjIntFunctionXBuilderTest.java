...
import static eu.lunisolar.magma.func.build.function.from.ObjIntFunctionXBuilder.objIntFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjIntFunctionXBuilderTest<T,R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjIntFunctionX function = ObjIntFunctionXBuilder
                .objIntFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjIntFunctionX.DESCRIPTION);
