...
import static eu.lunisolar.magma.func.build.function.conversion.ShortToIntFunctionXBuilder.shortToIntFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ShortToIntFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ShortToIntFunctionX function = ShortToIntFunctionXBuilder
                .shortToIntFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ShortToIntFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ShortToIntFunctionX<ParseException> function = shortToIntFunctionX((ShortToIntFunctionX<ParseException> f)-> doNothing())
