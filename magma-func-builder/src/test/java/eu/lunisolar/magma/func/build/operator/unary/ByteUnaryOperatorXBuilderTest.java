...
import static eu.lunisolar.magma.func.build.operator.unary.ByteUnaryOperatorXBuilder.byteUnaryOperatorX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ByteUnaryOperatorXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ByteUnaryOperatorX function = ByteUnaryOperatorXBuilder
                .byteUnaryOperatorX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ByteUnaryOperatorX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ByteUnaryOperatorX<ParseException> function = byteUnaryOperatorX((ByteUnaryOperatorX<ParseException> f)-> doNothing())
