...
import static eu.lunisolar.magma.func.build.consumer.primitives.LongConsumerBuilder.longConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LongConsumerBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LongConsumer function = LongConsumerBuilder
                .longConsumer()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LongConsumer.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        LongConsumer function = longConsumer((LongConsumer f)-> doNothing())
