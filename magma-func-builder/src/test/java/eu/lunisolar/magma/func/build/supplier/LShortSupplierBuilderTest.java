...
import static eu.lunisolar.magma.func.build.supplier.LShortSupplierBuilder.shortSupplier;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LShortSupplierBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LShortSupplier function = LShortSupplierBuilder.shortSupplier()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LShortSupplier.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LShortSupplier function = shortSupplier((LShortSupplier f)-> doNothing())
