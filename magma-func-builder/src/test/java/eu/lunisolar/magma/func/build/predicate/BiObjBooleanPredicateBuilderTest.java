...
import static eu.lunisolar.magma.func.build.predicate.BiObjBooleanPredicateBuilder.biObjBooleanPredicate;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiObjBooleanPredicateBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiObjBooleanPredicate function = BiObjBooleanPredicateBuilder
                .biObjBooleanPredicate()
                .build();

            function.test((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),true);
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiObjBooleanPredicate.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BiObjBooleanPredicate<Integer ,Integer > function = biObjBooleanPredicate((BiObjBooleanPredicate<Integer ,Integer > f)-> doNothing())
