...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.BiObjByteConsumerXBuilder.biObjByteConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiObjByteConsumerXBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiObjByteConsumerX function = BiObjByteConsumerXBuilder
                .biObjByteConsumerX()
                .build();

            function.accept((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),(byte)100);
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiObjByteConsumerX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BiObjByteConsumerX<Integer ,Integer ,ParseException> function = biObjByteConsumerX((BiObjByteConsumerX<Integer ,Integer ,ParseException> f)-> doNothing())
