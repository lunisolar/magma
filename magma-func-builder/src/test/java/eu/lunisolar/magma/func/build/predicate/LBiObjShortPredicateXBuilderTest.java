...
public class LBiObjShortPredicateXBuilderTest<T1,T2,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LBiObjShortPredicateX function = LBiObjShortPredicateXBuilder.biObjShortPredicateX()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LBiObjShortPredicateX.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LBiObjShortPredicateX<Integer ,Integer ,ParseException> function = biObjShortPredicateX((LBiObjShortPredicateX<Integer ,Integer ,ParseException> f)-> doNothing())
