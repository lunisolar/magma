...
import static eu.lunisolar.magma.func.build.consumer.primitives.tri.BooleanTriConsumerXBuilder.booleanTriConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BooleanTriConsumerXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BooleanTriConsumerX function = BooleanTriConsumerXBuilder
                .booleanTriConsumerX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BooleanTriConsumerX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BooleanTriConsumerX<ParseException> function = booleanTriConsumerX((BooleanTriConsumerX<ParseException> f)-> doNothing())
