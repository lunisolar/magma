...
import static eu.lunisolar.magma.func.build.function.from.LCharBiFunctionXBuilder.charBiFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LCharBiFunctionXBuilderTest<R,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws Throwable {
        ...
        assertThatThrownBy(() -> {
            LCharBiFunctionX function = LCharBiFunctionXBuilder.charBiFunctionX()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LCharBiFunctionX.DESCRIPTION);
    }
    ...
    public void testBuild() throws Throwable {
        ...
        LCharBiFunctionX<Integer ,ParseException> function = charBiFunctionX((LCharBiFunctionX<Integer ,ParseException> f)-> doNothing())
