...
import static eu.lunisolar.magma.func.build.function.from.ShortFunctionXBuilder.shortFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ShortFunctionXBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ShortFunctionX function = ShortFunctionXBuilder
                .shortFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ShortFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ShortFunctionX<Integer ,ParseException> function = shortFunctionX((ShortFunctionX<Integer ,ParseException> f)-> doNothing())
