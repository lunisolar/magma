...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LObjDoubleConsumerXBuilder.objDoubleConsumerXFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LObjDoubleConsumerXBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LObjDoubleConsumerX<Integer,X> function = objDoubleConsumerXFrom(b-> b
                .build()
            );
