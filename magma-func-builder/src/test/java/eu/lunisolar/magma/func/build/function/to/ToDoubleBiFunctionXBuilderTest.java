...
import static eu.lunisolar.magma.func.build.function.to.ToDoubleBiFunctionXBuilder.toDoubleBiFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ToDoubleBiFunctionXBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ToDoubleBiFunctionX function = ToDoubleBiFunctionXBuilder
                .toDoubleBiFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ToDoubleBiFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ToDoubleBiFunctionX<Integer ,Integer ,ParseException> function = toDoubleBiFunctionX((ToDoubleBiFunctionX<Integer ,Integer ,ParseException> f)-> doNothing())
