...
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.LBiDoubleConsumerBuilder.biDoubleConsumerFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBiDoubleConsumerBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LBiDoubleConsumer function = biDoubleConsumerFrom(b-> b
                .build()
            );
