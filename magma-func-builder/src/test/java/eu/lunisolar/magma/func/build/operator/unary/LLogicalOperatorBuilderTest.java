...
public class LLogicalOperatorBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LLogicalOperator function = LLogicalOperatorBuilder.logicalOperator()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LLogicalOperator.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LLogicalOperator function = logicalOperator((LLogicalOperator f)-> doNothing())
