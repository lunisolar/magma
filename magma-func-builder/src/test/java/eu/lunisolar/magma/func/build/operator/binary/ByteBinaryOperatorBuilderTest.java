...
import static eu.lunisolar.magma.func.build.operator.binary.ByteBinaryOperatorBuilder.byteBinaryOperator;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ByteBinaryOperatorBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ByteBinaryOperator function = ByteBinaryOperatorBuilder
                .byteBinaryOperator()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ByteBinaryOperator.DESCRIPTION);
