...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.ObjCharConsumerBuilder.objCharConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjCharConsumerBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjCharConsumer function = ObjCharConsumerBuilder
                .objCharConsumer()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjCharConsumer.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ObjCharConsumer<Integer > function = objCharConsumer((ObjCharConsumer<Integer > f)-> doNothing())
