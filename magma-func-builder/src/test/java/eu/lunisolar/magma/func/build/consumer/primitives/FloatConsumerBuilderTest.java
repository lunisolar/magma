...
import static eu.lunisolar.magma.func.build.consumer.primitives.FloatConsumerBuilder.floatConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class FloatConsumerBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            FloatConsumer function = FloatConsumerBuilder
                .floatConsumer()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(FloatConsumer.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        FloatConsumer function = floatConsumer((FloatConsumer f)-> doNothing())
