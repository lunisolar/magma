...
public class LDoubleToFloatFunctionXBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws Throwable {
        ...
        assertThatThrownBy(() -> {
            LDoubleToFloatFunctionX function = LDoubleToFloatFunctionXBuilder.doubleToFloatFunctionX()
                .build();

            function.doApplyAsFloat((double)100);

            fail("No exception were thrown.");
        })
                    .isExactlyInstanceOf(IllegalStateException.class)
                    .hasMessageContaining("No case specified for:")
                    .hasMessageContaining(LDoubleToFloatFunctionX.DESCRIPTION);
    }
    ...
    public void testBuild() throws Throwable {
        ...
        LDoubleToFloatFunctionX<ParseException> function = doubleToFloatFunctionX((LDoubleToFloatFunctionX<ParseException> f)-> doNothing())
