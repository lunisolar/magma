...
import static eu.lunisolar.magma.func.build.function.conversion.CharToShortFunctionXBuilder.charToShortFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class CharToShortFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            CharToShortFunctionX function = CharToShortFunctionXBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(CharToShortFunctionX.DESCRIPTION);
