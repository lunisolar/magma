...
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.FloatBiConsumerXBuilder.floatBiConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class FloatBiConsumerXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            FloatBiConsumerX function = FloatBiConsumerXBuilder
                .floatBiConsumerX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(FloatBiConsumerX.DESCRIPTION);
