...
import static eu.lunisolar.magma.func.build.supplier.LongSupplierBuilder.longSupplier;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LongSupplierBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LongSupplier function = LongSupplierBuilder
                .longSupplier()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LongSupplier.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        LongSupplier function = longSupplier((LongSupplier f)-> doNothing())
