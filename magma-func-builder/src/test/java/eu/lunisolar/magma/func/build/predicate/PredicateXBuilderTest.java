...
import static eu.lunisolar.magma.func.build.predicate.PredicateXBuilder.predicateX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class PredicateXBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            PredicateX function = PredicateXBuilder
                .predicateX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(PredicateX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        PredicateX<Integer ,ParseException> function = predicateX((PredicateX<Integer ,ParseException> f)-> doNothing())
