...
import static eu.lunisolar.magma.func.build.operator.binary.IntBinaryOperatorXBuilder.intBinaryOperatorX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class IntBinaryOperatorXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            IntBinaryOperatorX function = IntBinaryOperatorXBuilder
                .intBinaryOperatorX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(IntBinaryOperatorX.DESCRIPTION);
