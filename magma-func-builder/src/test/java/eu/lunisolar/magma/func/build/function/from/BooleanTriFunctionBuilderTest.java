...
import static eu.lunisolar.magma.func.build.function.from.BooleanTriFunctionBuilder.booleanTriFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BooleanTriFunctionBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BooleanTriFunction function = BooleanTriFunctionBuilder
                .booleanTriFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BooleanTriFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BooleanTriFunction<Integer > function = booleanTriFunction((BooleanTriFunction<Integer > f)-> doNothing())
