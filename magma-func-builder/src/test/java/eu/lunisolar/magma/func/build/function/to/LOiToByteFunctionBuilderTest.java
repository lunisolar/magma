...
import static eu.lunisolar.magma.func.build.function.to.LOiToByteFunctionBuilder.oiToByteFunction;
import static eu.lunisolar.magma.func.build.function.to.LOiToByteFunctionBuilder.oiToByteFunctionFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LOiToByteFunctionBuilderTest<T>{
    ...
    public void testOtherwiseThrow()  {
        ...
        assertThatThrownBy(() -> {
            LOiToByteFunction<Integer> function = oiToByteFunctionFrom(b-> b
                .build()
            );

            function.applyAsByte(100,100);
    ...
    public void testBuild()  {
        ...
        LOiToByteFunction<Integer> function = oiToByteFunctionFrom( b -> b
            ...
            .otherwise((a1,a2) -> (byte)99)
            .build()
        );


        A.assertOiToByteFunc(function)
            ...
            .doesApplyAsByte(10,10).when(null).to(a -> a.isEqualTo((byte)99))
        ;
