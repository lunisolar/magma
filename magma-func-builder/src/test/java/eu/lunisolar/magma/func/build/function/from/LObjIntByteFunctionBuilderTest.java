...
import static eu.lunisolar.magma.func.build.function.from.LObjIntByteFunctionBuilder.objIntByteFunction;
import static eu.lunisolar.magma.func.build.function.from.LObjIntByteFunctionBuilder.objIntByteFunctionFrom;

public class LObjIntByteFunctionBuilderTest<T,R>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LObjIntByteFunction<Integer,Integer> function = objIntByteFunctionFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestObjIntByteFunc(function)
