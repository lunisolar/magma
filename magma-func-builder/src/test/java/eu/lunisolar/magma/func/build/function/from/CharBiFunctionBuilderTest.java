...
import static eu.lunisolar.magma.func.build.function.from.CharBiFunctionBuilder.charBiFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class CharBiFunctionBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            CharBiFunction function = CharBiFunctionBuilder
                .charBiFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(CharBiFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        CharBiFunction<Integer > function = charBiFunction((CharBiFunction<Integer > f)-> doNothing())
