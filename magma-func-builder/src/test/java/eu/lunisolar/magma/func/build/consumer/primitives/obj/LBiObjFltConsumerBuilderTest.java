...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LBiObjFltConsumerBuilder.biObjFltConsumer;
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LBiObjFltConsumerBuilder.biObjFltConsumerFrom;

public class LBiObjFltConsumerBuilderTest<T1,T2>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LBiObjFltConsumer<Integer,Integer> function = biObjFltConsumerFrom(b-> b
                .build()
            );

            function.accept(100,100,100f);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestBiObjFltCons(function)
            .doesAccept(0,0,0f).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 0))
            .doesAccept(5,5,5f).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 1))
            .doesAccept(15,15,15f).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 2))
            .doesAccept(10,10,10f).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 99))
        ;
