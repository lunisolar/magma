...
import static eu.lunisolar.magma.func.build.function.to.LTieSrtFunctionBuilder.tieSrtFunction;
import static eu.lunisolar.magma.func.build.function.to.LTieSrtFunctionBuilder.tieSrtFunctionFrom;

public class LTieSrtFunctionBuilderTest<T>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LTieSrtFunction<Integer> function = tieSrtFunctionFrom(b-> b
                .build()
            );

            function.applyAsInt(100,100,(short)100);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestTieSrtFunc(function)
            .doesApplyAsInt(0,0,(short)0).when(null).to(a -> a.mustEx(Be::equalEx, 0))
            .doesApplyAsInt(5,5,(short)5).when(null).to(a -> a.mustEx(Be::equalEx, 1))
            .doesApplyAsInt(15,15,(short)15).when(null).to(a -> a.mustEx(Be::equalEx, 2))
            .doesApplyAsInt(10,10,(short)10).when(null).to(a -> a.mustEx(Be::equalEx, 99))
        ;
