...
import static eu.lunisolar.magma.func.build.consumer.primitives.LBooleanConsumerXBuilder.booleanConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBooleanConsumerXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LBooleanConsumerX function = LBooleanConsumerXBuilder
                .booleanConsumerX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LBooleanConsumerX.DESCRIPTION);
