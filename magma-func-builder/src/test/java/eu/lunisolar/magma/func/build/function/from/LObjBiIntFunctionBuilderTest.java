...
import static eu.lunisolar.magma.func.build.function.from.LObjBiIntFunctionBuilder.objBiIntFunction;
import static eu.lunisolar.magma.func.build.function.from.LObjBiIntFunctionBuilder.objBiIntFunctionFrom;

public class LObjBiIntFunctionBuilderTest<T,R>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LObjBiIntFunction<Integer,Integer> function = objBiIntFunctionFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestObjBiIntFunc(function)
