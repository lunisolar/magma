...
public class LBiObjShortPredicateBuilderTest<T1,T2,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LBiObjShortPredicate function = LBiObjShortPredicateBuilder.biObjShortPredicate()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LBiObjShortPredicate.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LBiObjShortPredicate<Integer ,Integer > function = biObjShortPredicate((LBiObjShortPredicate<Integer ,Integer > f)-> doNothing())
