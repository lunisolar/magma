...
import static eu.lunisolar.magma.func.build.function.from.ShortBiFunctionBuilder.shortBiFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ShortBiFunctionBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ShortBiFunction function = ShortBiFunctionBuilder
                .shortBiFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ShortBiFunction.DESCRIPTION);
