...
import static eu.lunisolar.magma.func.build.function.to.LToDoubleBiFunctionBuilder.toDoubleBiFunctionFrom;
...
public class LToDoubleBiFunctionBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LToDoubleBiFunction<Integer,Integer> function = toDoubleBiFunctionFrom(b-> b
                .build()
            );
