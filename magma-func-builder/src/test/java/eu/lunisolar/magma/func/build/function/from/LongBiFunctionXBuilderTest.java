...
import static eu.lunisolar.magma.func.build.function.from.LongBiFunctionXBuilder.longBiFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LongBiFunctionXBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LongBiFunctionX function = LongBiFunctionXBuilder
                .longBiFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LongBiFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        LongBiFunctionX<Integer ,ParseException> function = longBiFunctionX((LongBiFunctionX<Integer ,ParseException> f)-> doNothing())
