...
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.ByteBiConsumerBuilder.byteBiConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ByteBiConsumerBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ByteBiConsumer function = ByteBiConsumerBuilder
                .byteBiConsumer()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ByteBiConsumer.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ByteBiConsumer function = byteBiConsumer((ByteBiConsumer f)-> doNothing())
