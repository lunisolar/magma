...
import static eu.lunisolar.magma.func.build.function.from.LLongFunctionXBuilder.longFunctionXFrom;
...
public class LLongFunctionXBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LLongFunctionX<Integer,X> function = longFunctionXFrom(b-> b
                .build()
            );

            function.doApply(100L);
