...
import static eu.lunisolar.magma.func.build.predicate.PredicateBuilder.predicate;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class PredicateBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            Predicate function = PredicateBuilder
                .predicate()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(Predicate.DESCRIPTION);
