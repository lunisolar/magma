...
public class LObjFltFunctionBuilderTest<T,R>{
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestObjFltFunc(function)
            .doesApply(0,0f).when(null).to(a -> a.must$(Be::equal$, 0))
            .doesApply(5,5f).when(null).to(a -> a.must$(Be::equal$, 1))
            .doesApply(15,15f).when(null).to(a -> a.must$(Be::equal$, 2))
            .doesApply(10,10f).when(null).to(a -> a.must$(Be::equal$, 99))
        ;
