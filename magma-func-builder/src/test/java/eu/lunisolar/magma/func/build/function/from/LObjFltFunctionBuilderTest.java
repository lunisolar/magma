...
import static eu.lunisolar.magma.func.build.function.from.LObjFltFunctionBuilder.objFltFunction;
import static eu.lunisolar.magma.func.build.function.from.LObjFltFunctionBuilder.objFltFunctionFrom;

public class LObjFltFunctionBuilderTest<T,R>{
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestObjFltFunc(function)
            .doesApply(0,0f).when(null).to(a -> a.mustEx(Be::equalEx, 0))
            .doesApply(5,5f).when(null).to(a -> a.mustEx(Be::equalEx, 1))
            .doesApply(15,15f).when(null).to(a -> a.mustEx(Be::equalEx, 2))
            .doesApply(10,10f).when(null).to(a -> a.mustEx(Be::equalEx, 99))
        ;
