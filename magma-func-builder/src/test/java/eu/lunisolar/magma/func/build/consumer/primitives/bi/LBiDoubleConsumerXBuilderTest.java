...
public class LBiDoubleConsumerXBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LBiDoubleConsumerX function = LBiDoubleConsumerXBuilder.biDoubleConsumerX()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LBiDoubleConsumerX.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LBiDoubleConsumerX<ParseException> function = biDoubleConsumerX((LBiDoubleConsumerX<ParseException> f)-> doNothing())
