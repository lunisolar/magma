...
import static eu.lunisolar.magma.func.build.consumer.primitives.BooleanConsumerXBuilder.booleanConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BooleanConsumerXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BooleanConsumerX function = BooleanConsumerXBuilder
                .booleanConsumerX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BooleanConsumerX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BooleanConsumerX<ParseException> function = booleanConsumerX((BooleanConsumerX<ParseException> f)-> doNothing())
