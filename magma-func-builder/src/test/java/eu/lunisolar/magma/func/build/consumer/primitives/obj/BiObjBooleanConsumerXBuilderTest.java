...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.BiObjBooleanConsumerXBuilder.biObjBooleanConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiObjBooleanConsumerXBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiObjBooleanConsumerX function = BiObjBooleanConsumerXBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiObjBooleanConsumerX.DESCRIPTION);
