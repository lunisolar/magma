...
import static eu.lunisolar.magma.func.build.function.FunctionXBuilder.functionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class FunctionXBuilderTest<T,R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            FunctionX function = FunctionXBuilder
                .functionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(FunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        FunctionX<Integer ,Integer ,ParseException> function = functionX((FunctionX<Integer ,Integer ,ParseException> f)-> doNothing())
