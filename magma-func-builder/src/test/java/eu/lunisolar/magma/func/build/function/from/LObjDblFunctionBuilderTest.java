...
import static eu.lunisolar.magma.func.build.function.from.LObjDblFunctionBuilder.objDblFunction;
import static eu.lunisolar.magma.func.build.function.from.LObjDblFunctionBuilder.objDblFunctionFrom;
...
public class LObjDblFunctionBuilderTest<T,R>{
    ...
    public void testOtherwiseThrow()  {
        ...
        try {
            LObjDblFunction<Integer,Integer> function = objDblFunctionFrom(b-> b
                .build()
            );

            function.apply(100,100d);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestObjDblFunc(function)
            .doesApply(0,0d).when(null).to(a -> a.mustEx(Be::equalEx, 0))
            .doesApply(5,5d).when(null).to(a -> a.mustEx(Be::equalEx, 1))
            .doesApply(15,15d).when(null).to(a -> a.mustEx(Be::equalEx, 2))
            .doesApply(10,10d).when(null).to(a -> a.mustEx(Be::equalEx, 99))
        ;
