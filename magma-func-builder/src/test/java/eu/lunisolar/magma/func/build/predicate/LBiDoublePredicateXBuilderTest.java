...
import static eu.lunisolar.magma.func.build.predicate.LBiDoublePredicateXBuilder.biDoublePredicateXFrom;
...
public class LBiDoublePredicateXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LBiDoublePredicateX<X> function = biDoublePredicateXFrom(b-> b
                .build()
            );
