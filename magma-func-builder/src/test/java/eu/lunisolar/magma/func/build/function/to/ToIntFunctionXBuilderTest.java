...
import static eu.lunisolar.magma.func.build.function.to.ToIntFunctionXBuilder.toIntFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ToIntFunctionXBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ToIntFunctionX function = ToIntFunctionXBuilder
                .toIntFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ToIntFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ToIntFunctionX<Integer ,ParseException> function = toIntFunctionX((ToIntFunctionX<Integer ,ParseException> f)-> doNothing())
