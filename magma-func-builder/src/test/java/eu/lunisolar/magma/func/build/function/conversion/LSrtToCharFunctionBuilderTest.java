...
import static eu.lunisolar.magma.func.build.function.conversion.LSrtToCharFunctionBuilder.srtToCharFunction;
import static eu.lunisolar.magma.func.build.function.conversion.LSrtToCharFunctionBuilder.srtToCharFunctionFrom;
...
public class LSrtToCharFunctionBuilderTest{
    ...
    public void testOtherwiseThrow()  {
        ...
        try {
            LSrtToCharFunction function = srtToCharFunctionFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestSrtToCharFunc(function)
            .doesApplyAsChar((short)0).when(null).to(a -> a.mustEx(Be::equalEx, '\u0000'))
            .doesApplyAsChar((short)5).when(null).to(a -> a.mustEx(Be::equalEx, '\u0001'))
            .doesApplyAsChar((short)15).when(null).to(a -> a.mustEx(Be::equalEx, '\u0002'))
            .doesApplyAsChar((short)10).when(null).to(a -> a.mustEx(Be::equalEx, '\u0099'))
        ;
