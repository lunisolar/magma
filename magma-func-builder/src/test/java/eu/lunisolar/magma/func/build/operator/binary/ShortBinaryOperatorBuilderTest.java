...
import static eu.lunisolar.magma.func.build.operator.binary.ShortBinaryOperatorBuilder.shortBinaryOperator;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ShortBinaryOperatorBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ShortBinaryOperator function = ShortBinaryOperatorBuilder
                .shortBinaryOperator()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ShortBinaryOperator.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ShortBinaryOperator function = shortBinaryOperator((ShortBinaryOperator f)-> doNothing())
