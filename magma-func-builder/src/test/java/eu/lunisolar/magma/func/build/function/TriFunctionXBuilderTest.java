...
import static eu.lunisolar.magma.func.build.function.TriFunctionXBuilder.triFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class TriFunctionXBuilderTest<T1,T2,T3,R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            TriFunctionX function = TriFunctionXBuilder
                .triFunctionX()
                .build();

            function.apply((T1)Integer.valueOf(100),(T2)Integer.valueOf(100),(T3)Integer.valueOf(100));
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(TriFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        TriFunctionX<Integer ,Integer ,Integer ,Integer ,ParseException> function = triFunctionX((TriFunctionX<Integer ,Integer ,Integer ,Integer ,ParseException> f)-> doNothing())
            .addCase(ce -> ce.of((t1,t2,t3) -> t1 == 0)
                             .evaluate((t1,t2,t3) -> Integer.valueOf(0)))
            .inCase((t1,t2,t3) -> t1 > 0 && t1 < 10).evaluate((t1,t2,t3) -> Integer.valueOf(1))
            .inCase((t1,t2,t3) -> t1 > 10 && t1 < 20).evaluate((t1,t2,t3) -> Integer.valueOf(2))
