...
import static eu.lunisolar.magma.func.build.supplier.LLongSupplierBuilder.longSupplier;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LLongSupplierBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LLongSupplier function = LLongSupplierBuilder.longSupplier()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LLongSupplier.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LLongSupplier function = longSupplier((LLongSupplier f)-> doNothing())
