...
import static eu.lunisolar.magma.func.build.supplier.LLongSupplierBuilder.longSupplierFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LLongSupplierBuilderTest<X extends ParseException>{
