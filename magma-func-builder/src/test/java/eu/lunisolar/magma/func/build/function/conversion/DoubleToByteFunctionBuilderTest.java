...
import static eu.lunisolar.magma.func.build.function.conversion.DoubleToByteFunctionBuilder.doubleToByteFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class DoubleToByteFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            DoubleToByteFunction function = DoubleToByteFunctionBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(DoubleToByteFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        DoubleToByteFunction function = doubleToByteFunction((DoubleToByteFunction f)-> doNothing())
