...
import static eu.lunisolar.magma.func.build.supplier.BooleanSupplierBuilder.booleanSupplier;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BooleanSupplierBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BooleanSupplier function = BooleanSupplierBuilder
                .booleanSupplier()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BooleanSupplier.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BooleanSupplier function = booleanSupplier((BooleanSupplier f)-> doNothing())
