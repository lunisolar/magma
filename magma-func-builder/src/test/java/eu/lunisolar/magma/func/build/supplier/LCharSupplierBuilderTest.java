...
public class LCharSupplierBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LCharSupplier function = LCharSupplierBuilder.charSupplier()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LCharSupplier.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LCharSupplier function = charSupplier((LCharSupplier f)-> doNothing())
