...
import static eu.lunisolar.magma.func.build.predicate.BiShortPredicateBuilder.biShortPredicate;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiShortPredicateBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiShortPredicate function = BiShortPredicateBuilder
                .biShortPredicate()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiShortPredicate.DESCRIPTION);
