...
import static eu.lunisolar.magma.func.build.predicate.LCharIntPredicateBuilder.charIntPredicate;
import static eu.lunisolar.magma.func.build.predicate.LCharIntPredicateBuilder.charIntPredicateFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LCharIntPredicateBuilderTest{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LCharIntPredicate function = charIntPredicateFrom(b-> b
                .build()
            );

            function.doTest('\u0100',100);
