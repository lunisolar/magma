...
public class LTieByteFunctionBuilderTest<T>{
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestTieByteFunc(function)
            .doesApplyAsInt(0,0,(byte)0).when(null).to(a -> a.must$(Be::equal$, 0))
            .doesApplyAsInt(5,5,(byte)5).when(null).to(a -> a.must$(Be::equal$, 1))
            .doesApplyAsInt(15,15,(byte)15).when(null).to(a -> a.must$(Be::equal$, 2))
            .doesApplyAsInt(10,10,(byte)10).when(null).to(a -> a.must$(Be::equal$, 99))
        ;
