...
import static eu.lunisolar.magma.func.build.function.to.LTieByteFunctionBuilder.tieByteFunction;
import static eu.lunisolar.magma.func.build.function.to.LTieByteFunctionBuilder.tieByteFunctionFrom;
...
public class LTieByteFunctionBuilderTest<T>{
    ...
    public void testOtherwiseThrow()  {
        ...
        try {
            ...
            function.applyAsInt(100,100,(byte)100);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestTieByteFunc(function)
            .doesApplyAsInt(0,0,(byte)0).when(null).to(a -> a.mustEx(Be::equalEx, 0))
            .doesApplyAsInt(5,5,(byte)5).when(null).to(a -> a.mustEx(Be::equalEx, 1))
            .doesApplyAsInt(15,15,(byte)15).when(null).to(a -> a.mustEx(Be::equalEx, 2))
            .doesApplyAsInt(10,10,(byte)10).when(null).to(a -> a.mustEx(Be::equalEx, 99))
        ;
