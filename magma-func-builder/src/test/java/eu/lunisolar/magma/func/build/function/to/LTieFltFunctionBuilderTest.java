...
import static eu.lunisolar.magma.func.build.function.to.LTieFltFunctionBuilder.tieFltFunction;
import static eu.lunisolar.magma.func.build.function.to.LTieFltFunctionBuilder.tieFltFunctionFrom;

public class LTieFltFunctionBuilderTest<T>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LTieFltFunction<Integer> function = tieFltFunctionFrom(b-> b
                .build()
            );

            function.applyAsInt(100,100,100f);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestTieFltFunc(function)
            .doesApplyAsInt(0,0,0f).when(null).to(a -> a.mustEx(Be::equalEx, 0))
            .doesApplyAsInt(5,5,5f).when(null).to(a -> a.mustEx(Be::equalEx, 1))
            .doesApplyAsInt(15,15,15f).when(null).to(a -> a.mustEx(Be::equalEx, 2))
            .doesApplyAsInt(10,10,10f).when(null).to(a -> a.mustEx(Be::equalEx, 99))
        ;
