...
import static eu.lunisolar.magma.func.build.predicate.LObjBytePredicateBuilder.objBytePredicateFrom;

public class LObjBytePredicateBuilderTest<T>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LObjBytePredicate<Integer> function = objBytePredicateFrom(b-> b
                .build()
            );

            function.test(100,(byte)100);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestObjBytePred(function)
            .doesTest(0,(byte)0).when(null).to(a -> a.mustEx(Be::equalEx, false))
            .doesTest(5,(byte)5).when(null).to(a -> a.mustEx(Be::equalEx, true))
        ;
