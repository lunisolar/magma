...
import static eu.lunisolar.magma.func.build.function.from.FloatFunctionBuilder.floatFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class FloatFunctionBuilderTest<R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            FloatFunction function = FloatFunctionBuilder
                .floatFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(FloatFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        FloatFunction<Integer > function = floatFunction((FloatFunction<Integer > f)-> doNothing())
