...
import static eu.lunisolar.magma.func.build.consumer.LTriConsumerXBuilder.triConsumerXFrom;
...
public class LTriConsumerXBuilderTest<T1,T2,T3,X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LTriConsumerX<Integer,Integer,Integer,X> function = triConsumerXFrom(b-> b
                .build()
            );
