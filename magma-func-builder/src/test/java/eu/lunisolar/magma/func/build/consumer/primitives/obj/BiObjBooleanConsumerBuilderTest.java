...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.BiObjBooleanConsumerBuilder.biObjBooleanConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiObjBooleanConsumerBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiObjBooleanConsumer function = BiObjBooleanConsumerBuilder
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiObjBooleanConsumer.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BiObjBooleanConsumer<Integer ,Integer > function = biObjBooleanConsumer((BiObjBooleanConsumer<Integer ,Integer > f)-> doNothing())
