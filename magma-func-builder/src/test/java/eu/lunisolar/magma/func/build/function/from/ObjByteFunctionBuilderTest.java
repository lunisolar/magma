...
import static eu.lunisolar.magma.func.build.function.from.ObjByteFunctionBuilder.objByteFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjByteFunctionBuilderTest<T,R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjByteFunction function = ObjByteFunctionBuilder
                .objByteFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjByteFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ObjByteFunction<Integer ,Integer > function = objByteFunction((ObjByteFunction<Integer ,Integer > f)-> doNothing())
