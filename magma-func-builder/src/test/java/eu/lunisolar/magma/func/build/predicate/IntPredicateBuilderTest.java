...
import static eu.lunisolar.magma.func.build.predicate.IntPredicateBuilder.intPredicate;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class IntPredicateBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            IntPredicate function = IntPredicateBuilder
                .intPredicate()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(IntPredicate.DESCRIPTION);
