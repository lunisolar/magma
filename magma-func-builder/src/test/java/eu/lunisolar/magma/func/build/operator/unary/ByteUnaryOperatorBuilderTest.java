...
import static eu.lunisolar.magma.func.build.operator.unary.ByteUnaryOperatorBuilder.byteUnaryOperator;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ByteUnaryOperatorBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ByteUnaryOperator function = ByteUnaryOperatorBuilder
                .byteUnaryOperator()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ByteUnaryOperator.DESCRIPTION);
