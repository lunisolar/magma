...
import static eu.lunisolar.magma.func.build.supplier.LBoolSupplierXBuilder.boolSupplierX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBoolSupplierXBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LBoolSupplierX function = LBoolSupplierXBuilder.boolSupplierX()
                .build();

            function.doGetAsBool();

            fail("No exception were thrown.");
        })
                    .isExactlyInstanceOf(IllegalStateException.class)
                    .hasMessageContaining("No case specified for:")
                    .hasMessageContaining(LBoolSupplierX.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LBoolSupplierX<ParseException> function = boolSupplierX((LBoolSupplierX<ParseException> f)-> doNothing())
