...
import static eu.lunisolar.magma.func.build.supplier.LBoolSupplierXBuilder.boolSupplierXFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBoolSupplierXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LBoolSupplierX<X> function = boolSupplierXFrom(b-> b
                .build()
            );
