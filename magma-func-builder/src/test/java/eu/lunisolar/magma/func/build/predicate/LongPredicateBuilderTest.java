...
import static eu.lunisolar.magma.func.build.predicate.LongPredicateBuilder.longPredicate;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LongPredicateBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LongPredicate function = LongPredicateBuilder
                .longPredicate()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LongPredicate.DESCRIPTION);
