...
import static eu.lunisolar.magma.func.build.function.from.BiObjDoubleFunctionBuilder.biObjDoubleFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiObjDoubleFunctionBuilderTest<T1,T2,R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiObjDoubleFunction function = BiObjDoubleFunctionBuilder
                .biObjDoubleFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiObjDoubleFunction.DESCRIPTION);
