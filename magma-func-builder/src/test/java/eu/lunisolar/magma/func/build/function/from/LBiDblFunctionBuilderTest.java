...
import static eu.lunisolar.magma.func.build.function.from.LBiDblFunctionBuilder.biDblFunction;
import static eu.lunisolar.magma.func.build.function.from.LBiDblFunctionBuilder.biDblFunctionFrom;
...
public class LBiDblFunctionBuilderTest<R>{
    ...
    public void testOtherwiseThrow()  {
        ...
        try {
            LBiDblFunction<Integer> function = biDblFunctionFrom(b-> b
                .build()
            );

            function.apply(100d,100d);
    ...
    public void testBuild()  {
        ...
        LBiDblFunction<Integer> function = biDblFunctionFrom( b -> b
            .aCase(ce -> ce.of((a1,a2) -> a1 == 0d)
                             .evaluate((a1,a2) -> 0))
            .inCase((a1,a2) -> a1 > 0d && a1 < 10d).evaluate((a1,a2) -> 1)
            .inCase((a1,a2) -> a1 > 10d && a1 < 20d).evaluate((a1,a2) -> 2)
            .otherwise((a1,a2) -> 99)
            .build()
        );
        ...
        FuncAttests.attestBiDblFunc(function)
            .doesApply(0d,0d).when(null).to(a -> a.mustEx(Be::equalEx, 0))
            .doesApply(5d,5d).when(null).to(a -> a.mustEx(Be::equalEx, 1))
            .doesApply(15d,15d).when(null).to(a -> a.mustEx(Be::equalEx, 2))
            .doesApply(10d,10d).when(null).to(a -> a.mustEx(Be::equalEx, 99))
        ;
