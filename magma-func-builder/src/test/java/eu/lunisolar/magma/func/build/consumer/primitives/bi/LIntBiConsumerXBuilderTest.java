...
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.LIntBiConsumerXBuilder.intBiConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LIntBiConsumerXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LIntBiConsumerX function = LIntBiConsumerXBuilder
                .intBiConsumerX()
                .build();

            function.accept((int)100,(int)100);
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LIntBiConsumerX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        LIntBiConsumerX<ParseException> function = intBiConsumerX((LIntBiConsumerX<ParseException> f)-> doNothing())
