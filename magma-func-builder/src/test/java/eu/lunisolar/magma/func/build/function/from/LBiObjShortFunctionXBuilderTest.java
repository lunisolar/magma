...
import static eu.lunisolar.magma.func.build.function.from.LBiObjShortFunctionXBuilder.biObjShortFunctionXFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBiObjShortFunctionXBuilderTest<T1,T2,R,X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LBiObjShortFunctionX<Integer,Integer,Integer,X> function = biObjShortFunctionXFrom(b-> b
                .build()
            );

            function.doApply(100,100,(short)100);
