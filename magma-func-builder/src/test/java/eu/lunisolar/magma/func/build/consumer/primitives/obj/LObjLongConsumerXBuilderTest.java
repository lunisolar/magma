...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LObjLongConsumerXBuilder.objLongConsumerXFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LObjLongConsumerXBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LObjLongConsumerX<Integer,X> function = objLongConsumerXFrom(b-> b
                .build()
            );

            function.doAccept(100,100L);
    ...
    public void testBuild()  throws X {
        ...
        A.assertThat(function)
            ...
            .doesAccept(10,10L).when(null).soThat(() -> assertThat(externalEffect.get()).isEqualTo(99))
        ;
