...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LObjLongConsumerXBuilder.objLongConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LObjLongConsumerXBuilderTest<T,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LObjLongConsumerX function = LObjLongConsumerXBuilder.objLongConsumerX()
                .build();

            function.doAccept((T)Integer.valueOf(100),(long)100);

            fail("No exception were thrown.");
        })
                    .isExactlyInstanceOf(IllegalStateException.class)
                    .hasMessageContaining("No case specified for:")
                    .hasMessageContaining(LObjLongConsumerX.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LObjLongConsumerX<Integer ,ParseException> function = objLongConsumerX((LObjLongConsumerX<Integer ,ParseException> f)-> doNothing())
