...
import static eu.lunisolar.magma.func.build.consumer.LQuintConsumerBuilder.quintConsumer;
import static eu.lunisolar.magma.func.build.consumer.LQuintConsumerBuilder.quintConsumerFrom;

public class LQuintConsumerBuilderTest<T1,T2,T3,T4,T5>{
    ...
    public void testOtherwiseThrow()  {
        ...
        try {
            ...
            function.accept(100,100,100,100,100);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestQuintCons(function)
            .doesAccept(0,0,0,0,0).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 0))
            .doesAccept(5,5,5,5,5).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 1))
            .doesAccept(15,15,15,15,15).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 2))
            .doesAccept(10,10,10,10,10).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 99))
        ;
