...
public class LQuintConsumerBuilderTest<T1,T2,T3,T4,T5>{
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestQuintCons(function)
            .doesAccept(0,0,0,0,0).when(null).soThat(() -> Checks.attest(externalEffect.get()).must$(Be::equal$, 0))
            .doesAccept(5,5,5,5,5).when(null).soThat(() -> Checks.attest(externalEffect.get()).must$(Be::equal$, 1))
            .doesAccept(15,15,15,15,15).when(null).soThat(() -> Checks.attest(externalEffect.get()).must$(Be::equal$, 2))
            .doesAccept(10,10,10,10,10).when(null).soThat(() -> Checks.attest(externalEffect.get()).must$(Be::equal$, 99))
        ;
