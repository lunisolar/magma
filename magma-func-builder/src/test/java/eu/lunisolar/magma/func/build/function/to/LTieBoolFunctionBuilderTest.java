...
public class LTieBoolFunctionBuilderTest<T>{
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestTieBoolFunc(function)
            .doesApplyAsInt(0,0,false).when(null).to(a -> a.mustEx(Be::equalEx, 0))
            .doesApplyAsInt(5,5,true).when(null).to(a -> a.mustEx(Be::equalEx, 1))
            .doesApplyAsInt(15,15,true).when(null).to(a -> a.mustEx(Be::equalEx, 2))
            .doesApplyAsInt(10,10,true).when(null).to(a -> a.mustEx(Be::equalEx, 99))
        ;
