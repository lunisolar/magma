...
import static eu.lunisolar.magma.func.build.predicate.LObjDblPredicateBuilder.objDblPredicate;
import static eu.lunisolar.magma.func.build.predicate.LObjDblPredicateBuilder.objDblPredicateFrom;

public class LObjDblPredicateBuilderTest<T>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LObjDblPredicate<Integer> function = objDblPredicateFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestObjDblPred(function)
            .doesTest(0,0d).when(null).to(a -> a.mustEx(Be::equalEx, false))
            .doesTest(5,5d).when(null).to(a -> a.mustEx(Be::equalEx, true))
        ;
