...
import static eu.lunisolar.magma.func.build.function.from.ObjShortFunctionBuilder.objShortFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjShortFunctionBuilderTest<T,R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjShortFunction function = ObjShortFunctionBuilder
                .objShortFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjShortFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ObjShortFunction<Integer ,Integer > function = objShortFunction((ObjShortFunction<Integer ,Integer > f)-> doNothing())
