...
public class LBiFloatConsumerBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LBiFloatConsumer function = LBiFloatConsumerBuilder.biFloatConsumer()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LBiFloatConsumer.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LBiFloatConsumer function = biFloatConsumer((LBiFloatConsumer f)-> doNothing())
