...
import static eu.lunisolar.magma.func.build.function.conversion.ShortToByteFunctionBuilder.shortToByteFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ShortToByteFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ShortToByteFunction function = ShortToByteFunctionBuilder
                .shortToByteFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ShortToByteFunction.DESCRIPTION);
