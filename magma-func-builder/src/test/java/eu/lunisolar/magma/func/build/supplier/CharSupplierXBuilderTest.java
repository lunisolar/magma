...
import static eu.lunisolar.magma.func.build.supplier.CharSupplierXBuilder.charSupplierX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class CharSupplierXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            CharSupplierX function = CharSupplierXBuilder
                .charSupplierX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(CharSupplierX.DESCRIPTION);
