...
import static eu.lunisolar.magma.func.build.function.conversion.LByteToFloatFunctionBuilder.byteToFloatFunctionFrom;
...
public class LByteToFloatFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  {
        ...
        assertThatThrownBy(() -> {
            LByteToFloatFunction function = byteToFloatFunctionFrom(b-> b
                .build()
            );
