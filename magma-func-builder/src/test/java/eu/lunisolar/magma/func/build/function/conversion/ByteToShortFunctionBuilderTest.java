...
import static eu.lunisolar.magma.func.build.function.conversion.ByteToShortFunctionBuilder.byteToShortFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ByteToShortFunctionBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ByteToShortFunction function = ByteToShortFunctionBuilder
                .byteToShortFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ByteToShortFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ByteToShortFunction function = byteToShortFunction((ByteToShortFunction f)-> doNothing())
