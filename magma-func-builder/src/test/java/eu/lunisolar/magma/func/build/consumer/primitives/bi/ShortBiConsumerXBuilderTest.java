...
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.ShortBiConsumerXBuilder.shortBiConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ShortBiConsumerXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ShortBiConsumerX function = ShortBiConsumerXBuilder
                .shortBiConsumerX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ShortBiConsumerX.DESCRIPTION);
