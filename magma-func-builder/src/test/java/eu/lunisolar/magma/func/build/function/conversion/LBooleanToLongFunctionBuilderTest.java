...
import static eu.lunisolar.magma.func.build.function.conversion.LBooleanToLongFunctionBuilder.booleanToLongFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBooleanToLongFunctionBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws Throwable {
        ...
        assertThatThrownBy(() -> {
            LBooleanToLongFunction function = LBooleanToLongFunctionBuilder.booleanToLongFunction()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LBooleanToLongFunction.DESCRIPTION);
    }
