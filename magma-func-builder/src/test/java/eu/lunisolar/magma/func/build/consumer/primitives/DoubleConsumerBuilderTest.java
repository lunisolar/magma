...
import static eu.lunisolar.magma.func.build.consumer.primitives.DoubleConsumerBuilder.doubleConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class DoubleConsumerBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            DoubleConsumer function = DoubleConsumerBuilder
                .doubleConsumer()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(DoubleConsumer.DESCRIPTION);
