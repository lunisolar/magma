...
import static eu.lunisolar.magma.func.build.function.from.LObjBoolFunctionBuilder.objBoolFunction;
import static eu.lunisolar.magma.func.build.function.from.LObjBoolFunctionBuilder.objBoolFunctionFrom;

public class LObjBoolFunctionBuilderTest<T,R>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LObjBoolFunction<Integer,Integer> function = objBoolFunctionFrom(b-> b
                .build()
            );

            function.apply(100,true);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestObjBoolFunc(function)
            .doesApply(0,false).when(null).to(a -> a.mustEx(Be::equalEx, 0))
            .doesApply(5,true).when(null).to(a -> a.mustEx(Be::equalEx, 1))
            .doesApply(15,true).when(null).to(a -> a.mustEx(Be::equalEx, 2))
            .doesApply(10,true).when(null).to(a -> a.mustEx(Be::equalEx, 99))
        ;
