...
import static eu.lunisolar.magma.func.build.function.from.LObjIntBoolFunctionBuilder.objIntBoolFunction;
import static eu.lunisolar.magma.func.build.function.from.LObjIntBoolFunctionBuilder.objIntBoolFunctionFrom;

public class LObjIntBoolFunctionBuilderTest<T,R>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LObjIntBoolFunction<Integer,Integer> function = objIntBoolFunctionFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestObjIntBoolFunc(function)
