...
import static eu.lunisolar.magma.func.build.function.to.ToIntFunctionBuilder.toIntFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ToIntFunctionBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ToIntFunction function = ToIntFunctionBuilder
                .toIntFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ToIntFunction.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ToIntFunction<Integer > function = toIntFunction((ToIntFunction<Integer > f)-> doNothing())
