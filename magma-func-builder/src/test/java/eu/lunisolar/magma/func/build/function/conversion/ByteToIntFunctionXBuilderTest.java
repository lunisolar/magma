...
import static eu.lunisolar.magma.func.build.function.conversion.ByteToIntFunctionXBuilder.byteToIntFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ByteToIntFunctionXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ByteToIntFunctionX function = ByteToIntFunctionXBuilder
                .byteToIntFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ByteToIntFunctionX.DESCRIPTION);
