...
public class LFltTernaryOperatorBuilderTest{
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestFltTernaryOp(function)
            .doesApplyAsFlt(0f,0f,0f).when(null).to(a -> a.mustEx(Be::equalEx, 0f))
            .doesApplyAsFlt(5f,5f,5f).when(null).to(a -> a.mustEx(Be::equalEx, 1f))
            .doesApplyAsFlt(15f,15f,15f).when(null).to(a -> a.mustEx(Be::equalEx, 2f))
            .doesApplyAsFlt(10f,10f,10f).when(null).to(a -> a.mustEx(Be::equalEx, 99f))
        ;
