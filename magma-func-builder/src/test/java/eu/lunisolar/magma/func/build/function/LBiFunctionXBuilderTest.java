...
import static eu.lunisolar.magma.func.build.function.LBiFunctionXBuilder.biFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBiFunctionXBuilderTest<T1,T2,R,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LBiFunctionX function = LBiFunctionXBuilder.biFunctionX()
                .build();

            function.doApply((T1)Integer.valueOf(100),(T2)Integer.valueOf(100));

            fail("No exception were thrown.");
        })
                    .isExactlyInstanceOf(IllegalStateException.class)
                    .hasMessageContaining("No case specified for:")
                    .hasMessageContaining(LBiFunctionX.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LBiFunctionX<Integer ,Integer ,Integer ,ParseException> function = biFunctionX((LBiFunctionX<Integer ,Integer ,Integer ,ParseException> f)-> doNothing())
