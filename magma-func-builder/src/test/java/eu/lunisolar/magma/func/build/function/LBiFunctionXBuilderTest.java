...
import static eu.lunisolar.magma.func.build.function.LBiFunctionXBuilder.biFunctionXFrom;
...
public class LBiFunctionXBuilderTest<T1,T2,R,X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LBiFunctionX<Integer,Integer,Integer,X> function = biFunctionXFrom(b-> b
                .build()
            );
