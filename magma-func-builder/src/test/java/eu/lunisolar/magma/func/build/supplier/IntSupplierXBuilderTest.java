...
import static eu.lunisolar.magma.func.build.supplier.IntSupplierXBuilder.intSupplierX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class IntSupplierXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            IntSupplierX function = IntSupplierXBuilder
                .intSupplierX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(IntSupplierX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        IntSupplierX<ParseException> function = intSupplierX((IntSupplierX<ParseException> f)-> doNothing())
