...
import static eu.lunisolar.magma.func.build.predicate.ObjLongPredicateBuilder.objLongPredicate;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjLongPredicateBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjLongPredicate function = ObjLongPredicateBuilder
                .objLongPredicate()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjLongPredicate.DESCRIPTION);
