...
import static eu.lunisolar.magma.func.build.function.conversion.LBooleanToShortFunctionBuilder.booleanToShortFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBooleanToShortFunctionBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws Throwable {
        ...
        assertThatThrownBy(() -> {
            LBooleanToShortFunction function = LBooleanToShortFunctionBuilder.booleanToShortFunction()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LBooleanToShortFunction.DESCRIPTION);
    }
