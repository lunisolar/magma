...
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.LBiBoolConsumerXBuilder.biBoolConsumerXFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBiBoolConsumerXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LBiBoolConsumerX<X> function = biBoolConsumerXFrom(b-> b
                .build()
            );
