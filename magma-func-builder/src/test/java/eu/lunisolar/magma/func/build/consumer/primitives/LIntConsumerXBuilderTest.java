...
import static eu.lunisolar.magma.func.build.consumer.primitives.LIntConsumerXBuilder.intConsumerXFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LIntConsumerXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LIntConsumerX<X> function = intConsumerXFrom(b-> b
                .build()
            );

            function.doAccept(100);
