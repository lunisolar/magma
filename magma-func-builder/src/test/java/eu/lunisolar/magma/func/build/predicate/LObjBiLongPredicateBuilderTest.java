...
import static eu.lunisolar.magma.func.build.predicate.LObjBiLongPredicateBuilder.objBiLongPredicate;
import static eu.lunisolar.magma.func.build.predicate.LObjBiLongPredicateBuilder.objBiLongPredicateFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LObjBiLongPredicateBuilderTest<T>{
    ...
    public void testOtherwiseThrow()  {
        ...
        assertThatThrownBy(() -> {
            LObjBiLongPredicate<Integer> function = objBiLongPredicateFrom(b-> b
                .build()
            );

            function.test(100,100L,100L);
    ...
    public void testBuild()  {
        ...
        A.attestObjBiLongPred(function)
            .doesTest(0,0L,0L).when(null).to(a -> a.isEqualTo(false))
            .doesTest(5,5L,5L).when(null).to(a -> a.isEqualTo(true))
        ;
