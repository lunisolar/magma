...
import static eu.lunisolar.magma.func.build.supplier.LSupplierXBuilder.supplierXFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LSupplierXBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LSupplierX<Integer,X> function = supplierXFrom(b-> b
                .build()
            );
