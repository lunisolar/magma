...
import static eu.lunisolar.magma.func.build.supplier.LSupplierXBuilder.supplierX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LSupplierXBuilderTest<R,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LSupplierX function = LSupplierXBuilder.supplierX()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LSupplierX.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LSupplierX<Integer ,ParseException> function = supplierX((LSupplierX<Integer ,ParseException> f)-> doNothing())
