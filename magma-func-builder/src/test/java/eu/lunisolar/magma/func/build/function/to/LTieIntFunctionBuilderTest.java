...
import static eu.lunisolar.magma.func.build.function.to.LTieIntFunctionBuilder.tieIntFunction;
import static eu.lunisolar.magma.func.build.function.to.LTieIntFunctionBuilder.tieIntFunctionFrom;

public class LTieIntFunctionBuilderTest<T>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LTieIntFunction<Integer> function = tieIntFunctionFrom(b-> b
                .build()
            );
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestTieIntFunc(function)
