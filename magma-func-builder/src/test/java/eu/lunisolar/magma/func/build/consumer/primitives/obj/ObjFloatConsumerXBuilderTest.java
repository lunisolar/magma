...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.ObjFloatConsumerXBuilder.objFloatConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjFloatConsumerXBuilderTest<T,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjFloatConsumerX function = ObjFloatConsumerXBuilder
                .objFloatConsumerX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjFloatConsumerX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ObjFloatConsumerX<Integer ,ParseException> function = objFloatConsumerX((ObjFloatConsumerX<Integer ,ParseException> f)-> doNothing())
