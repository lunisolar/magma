...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LObjBooleanConsumerXBuilder.objBooleanConsumerX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LObjBooleanConsumerXBuilderTest<T,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LObjBooleanConsumerX function = LObjBooleanConsumerXBuilder.objBooleanConsumerX()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LObjBooleanConsumerX.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LObjBooleanConsumerX<Integer ,ParseException> function = objBooleanConsumerX((LObjBooleanConsumerX<Integer ,ParseException> f)-> doNothing())
