...
import static eu.lunisolar.magma.func.build.operator.unary.CharUnaryOperatorBuilder.charUnaryOperator;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class CharUnaryOperatorBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            CharUnaryOperator function = CharUnaryOperatorBuilder
                .charUnaryOperator()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(CharUnaryOperator.DESCRIPTION);
