...
import static eu.lunisolar.magma.func.build.function.from.LTriCharFunctionBuilder.triCharFunction;
import static eu.lunisolar.magma.func.build.function.from.LTriCharFunctionBuilder.triCharFunctionFrom;

public class LTriCharFunctionBuilderTest<R>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LTriCharFunction<Integer> function = triCharFunctionFrom(b-> b
                .build()
            );

            function.apply('\u0100','\u0100','\u0100');
    ...
    public void testBuild()  {
        ...
        LTriCharFunction<Integer> function = triCharFunctionFrom( b -> b
            .aCase(ce -> ce.of((a1,a2,a3) -> a1 == '\u0000')
                             .evaluate((a1,a2,a3) -> 0))
            .inCase((a1,a2,a3) -> a1 > '\u0000' && a1 < '\u0010').evaluate((a1,a2,a3) -> 1)
            .inCase((a1,a2,a3) -> a1 > '\u0010' && a1 < '\u0020').evaluate((a1,a2,a3) -> 2)
            .otherwise((a1,a2,a3) -> 99)
            .build()
        );


        FuncAttests.attestTriCharFunc(function)
            .doesApply('\u0000','\u0000','\u0000').when(null).to(a -> a.mustEx(Be::equalEx, 0))
            .doesApply('\u0005','\u0005','\u0005').when(null).to(a -> a.mustEx(Be::equalEx, 1))
            .doesApply('\u0015','\u0015','\u0015').when(null).to(a -> a.mustEx(Be::equalEx, 2))
            .doesApply('\u0010','\u0010','\u0010').when(null).to(a -> a.mustEx(Be::equalEx, 99))
        ;
