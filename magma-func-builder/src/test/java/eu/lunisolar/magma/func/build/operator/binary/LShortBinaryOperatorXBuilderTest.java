...
import static eu.lunisolar.magma.func.build.operator.binary.LShortBinaryOperatorXBuilder.shortBinaryOperatorX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LShortBinaryOperatorXBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LShortBinaryOperatorX function = LShortBinaryOperatorXBuilder.shortBinaryOperatorX()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LShortBinaryOperatorX.DESCRIPTION);
    }
