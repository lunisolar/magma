...
import static eu.lunisolar.magma.func.build.operator.binary.LShortBinaryOperatorXBuilder.shortBinaryOperatorXFrom;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LShortBinaryOperatorXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow()  throws X {
        ...
        assertThatThrownBy(() -> {
            LShortBinaryOperatorX<X> function = shortBinaryOperatorXFrom(b-> b
                .build()
            );
