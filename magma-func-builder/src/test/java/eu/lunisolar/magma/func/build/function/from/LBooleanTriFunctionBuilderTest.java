...
import static eu.lunisolar.magma.func.build.function.from.LBooleanTriFunctionBuilder.booleanTriFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBooleanTriFunctionBuilderTest<R,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws Throwable {
        ...
        assertThatThrownBy(() -> {
            LBooleanTriFunction function = LBooleanTriFunctionBuilder.booleanTriFunction()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LBooleanTriFunction.DESCRIPTION);
    }
    ...
    public void testBuild() throws Throwable {
        ...
        LBooleanTriFunction<Integer > function = booleanTriFunction((LBooleanTriFunction<Integer > f)-> doNothing())
