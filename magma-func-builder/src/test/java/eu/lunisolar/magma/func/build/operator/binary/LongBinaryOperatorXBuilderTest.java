...
import static eu.lunisolar.magma.func.build.operator.binary.LongBinaryOperatorXBuilder.longBinaryOperatorX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LongBinaryOperatorXBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            LongBinaryOperatorX function = LongBinaryOperatorXBuilder
                .longBinaryOperatorX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(LongBinaryOperatorX.DESCRIPTION);
