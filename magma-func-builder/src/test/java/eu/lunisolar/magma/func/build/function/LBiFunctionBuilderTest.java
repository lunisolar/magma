...
import static eu.lunisolar.magma.func.build.function.LBiFunctionBuilder.biFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBiFunctionBuilderTest<T1,T2,R,X extends Throwable>{
    ...
    public void testEventuallyThrow() throws Throwable {
        ...
        assertThatThrownBy(() -> {
            LBiFunction function = LBiFunctionBuilder.biFunction()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LBiFunction.DESCRIPTION);
    }
    ...
    public void testBuild() throws Throwable {
        ...
        LBiFunction<Integer ,Integer ,Integer > function = biFunction((LBiFunction<Integer ,Integer ,Integer > f)-> doNothing())
