...
import static eu.lunisolar.magma.func.build.supplier.LBooleanSupplierBuilder.booleanSupplier;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class LBooleanSupplierBuilderTest<X extends Throwable>{
    ...
    public void testEventuallyThrow() throws X {
        ...
        assertThatThrownBy(() -> {
            LBooleanSupplier function = LBooleanSupplierBuilder.booleanSupplier()
                .build();
            ...
            fail("No exception were thrown.");
                    ...
                    .hasMessageContaining(LBooleanSupplier.DESCRIPTION);
    }
    ...
    public void testBuild() throws X {
        ...
        LBooleanSupplier function = booleanSupplier((LBooleanSupplier f)-> doNothing())
