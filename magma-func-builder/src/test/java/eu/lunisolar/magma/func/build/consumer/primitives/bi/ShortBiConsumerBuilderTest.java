...
import static eu.lunisolar.magma.func.build.consumer.primitives.bi.ShortBiConsumerBuilder.shortBiConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ShortBiConsumerBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ShortBiConsumer function = ShortBiConsumerBuilder
                .shortBiConsumer()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ShortBiConsumer.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ShortBiConsumer function = shortBiConsumer((ShortBiConsumer f)-> doNothing())
