...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.LObjByteConsumerBuilder.objByteConsumerFrom;

public class LObjByteConsumerBuilderTest<T>{

    @Test
    public void testOtherwiseThrow()  {

        try {
            LObjByteConsumer<Integer> function = objByteConsumerFrom(b-> b
                .build()
            );

            function.accept(100,(byte)100);
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestObjByteCons(function)
            .doesAccept(0,(byte)0).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 0))
            .doesAccept(5,(byte)5).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 1))
            .doesAccept(15,(byte)15).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 2))
            .doesAccept(10,(byte)10).when(null).soThat(() -> Checks.attest(externalEffect.get()).mustEx(Be::equalEx, 99))
        ;
