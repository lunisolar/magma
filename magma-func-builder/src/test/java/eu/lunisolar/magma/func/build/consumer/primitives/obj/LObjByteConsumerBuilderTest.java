...
public class LObjByteConsumerBuilderTest<T>{
    ...
    public void testBuild()  {
        ...
        FuncAttests.attestObjByteCons(function)
            .doesAccept(0,(byte)0).when(null).soThat(() -> Checks.attest(externalEffect.get()).must$(Be::equal$, 0))
            .doesAccept(5,(byte)5).when(null).soThat(() -> Checks.attest(externalEffect.get()).must$(Be::equal$, 1))
            .doesAccept(15,(byte)15).when(null).soThat(() -> Checks.attest(externalEffect.get()).must$(Be::equal$, 2))
            .doesAccept(10,(byte)10).when(null).soThat(() -> Checks.attest(externalEffect.get()).must$(Be::equal$, 99))
        ;
