...
import static eu.lunisolar.magma.func.build.function.from.ObjBooleanFunctionBuilder.objBooleanFunction;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ObjBooleanFunctionBuilderTest<T,R,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ObjBooleanFunction function = ObjBooleanFunctionBuilder
                .objBooleanFunction()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ObjBooleanFunction.DESCRIPTION);
