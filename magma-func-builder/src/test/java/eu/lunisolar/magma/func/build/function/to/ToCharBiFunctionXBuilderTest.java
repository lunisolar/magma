...
import static eu.lunisolar.magma.func.build.function.to.ToCharBiFunctionXBuilder.toCharBiFunctionX;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ToCharBiFunctionXBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ToCharBiFunctionX function = ToCharBiFunctionXBuilder
                .toCharBiFunctionX()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ToCharBiFunctionX.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ToCharBiFunctionX<Integer ,Integer ,ParseException> function = toCharBiFunctionX((ToCharBiFunctionX<Integer ,Integer ,ParseException> f)-> doNothing())
