...
import static eu.lunisolar.magma.func.build.consumer.primitives.ByteConsumerBuilder.byteConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class ByteConsumerBuilderTest<X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            ByteConsumer function = ByteConsumerBuilder
                .byteConsumer()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(ByteConsumer.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        ByteConsumer function = byteConsumer((ByteConsumer f)-> doNothing())
