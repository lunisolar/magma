...
import static eu.lunisolar.magma.func.build.consumer.primitives.obj.BiObjCharConsumerBuilder.biObjCharConsumer;
import static org.assertj.core.api.Assertions.*; //NOSONAR

public class BiObjCharConsumerBuilderTest<T1,T2,X extends ParseException>{
    ...
    public void testEventuallyThrow() throws Exception {
        ...
        try {
            BiObjCharConsumer function = BiObjCharConsumerBuilder
                .biObjCharConsumer()
                .build();
            ...
            assertThat(e)
                    ...
                    .hasMessageContaining(BiObjCharConsumer.DESCRIPTION);
    ...
    public void testBuild() throws Exception {
        ...
        BiObjCharConsumer<Integer ,Integer > function = biObjCharConsumer((BiObjCharConsumer<Integer ,Integer > f)-> doNothing())
