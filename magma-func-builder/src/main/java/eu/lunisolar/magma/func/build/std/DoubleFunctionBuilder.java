...
public final class DoubleFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<DoubleFunctionBuilder<R>, LDblPredicate, DoubleFunction<R>, R> {
	...
	@Nonnull
	public static <R> DoubleFunction<R> dblFunctionFrom(Consumer<DoubleFunctionBuilder<R>> buildingFunction) {
		DoubleFunctionBuilder builder = new DoubleFunctionBuilder();
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final DoubleFunctionBuilder<R> withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public final DoubleFunction<R> build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
