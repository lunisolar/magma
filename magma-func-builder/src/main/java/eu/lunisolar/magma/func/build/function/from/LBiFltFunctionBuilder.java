...
public final class LBiFltFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LBiFltFunctionBuilder<R>, LBiFltPredicate, LBiFltFunction<R>, R> {
	...
	public static final LBiFltFunction EVENTUALLY_THROW = LBiFltFunction.biFltFunc((a1, a2) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LBiFltFunctionBuilder(@Nullable Consumer<LBiFltFunction<R>> consumer) {
		super(EVENTUALLY_THROW, LBiFltFunction::constant, () -> new LBiFltFunctionBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LBiFltFunctionBuilder<R> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LBiFltFunction<R> build() {
		...
		final LBiFltFunction<R> eventuallyFinal = this.eventually;
	...
	public final LBiFltFunction<R> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
