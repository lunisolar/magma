...
public final class LToByteFunctionBuilder<T> extends PerCaseBuilderWithByteProduct.Base<LToByteFunctionBuilder<T>, LPredicate<T>, LToByteFunction<T>> {
	...
	public static final LToByteFunction EVENTUALLY_THROW = LToByteFunction.l((Object t) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", t, LToByteFunction.DESCRIPTION);
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LToByteFunctionBuilder<T> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LToByteFunction<T> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
