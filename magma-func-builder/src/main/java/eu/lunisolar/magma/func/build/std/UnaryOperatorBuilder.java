...
public final class UnaryOperatorBuilder<T> extends PerCaseBuilderWithProduct.Base<UnaryOperatorBuilder<T>, LPredicate<T>, UnaryOperator<T>, T> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final UnaryOperatorBuilder<T> withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	@Nonnull
	public <V extends T> UnaryOperatorBuilder<T> casesOf(Class<V> argC, Consumer<UnaryOperatorBuilder<V>> pcpConsumer) {
	...
	@Nonnull
	public <V extends T> UnaryOperatorBuilder<T> aCase(Class<V> argC, UnaryOperator<V> function) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod(a -> (argC == null || argC.isInstance(a)));
	...
	public final UnaryOperator<T> build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
