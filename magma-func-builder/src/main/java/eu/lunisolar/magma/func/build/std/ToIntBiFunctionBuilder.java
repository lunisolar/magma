...
public final class ToIntBiFunctionBuilder<T1, T2> extends PerCaseBuilderWithIntProduct.Base<ToIntBiFunctionBuilder<T1, T2>, LBiPredicate<T1, T2>, java.util.function.ToIntBiFunction<T1, T2>> {
	...
	public ToIntBiFunctionBuilder(@Nullable Consumer<java.util.function.ToIntBiFunction<T1, T2>> consumer) {
	...
	@Nonnull
	public static <T1, T2> ToIntBiFunctionBuilder<T1, T2> toIntBiFunction(Consumer<java.util.function.ToIntBiFunction<T1, T2>> consumer) {
	...
	@Nonnull
	public final java.util.function.ToIntBiFunction<T1, T2> build() {

		final java.util.function.ToIntBiFunction<T1, T2> eventuallyFinal = this.eventually;
	...
	public final java.util.function.ToIntBiFunction<T1, T2> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
