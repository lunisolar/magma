...
public final class LObjShortConsumerXBuilder<T, X extends Throwable> extends PerCaseBuilder.Base<LObjShortConsumerXBuilder<T, X>, LObjShortPredicateX<T, X>, LObjShortConsumerX<T, X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T, X extends Throwable> LObjShortConsumerXBuilder<T, X> objShortConsumerX() {
		return new LObjShortConsumerXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T, X extends Throwable> LObjShortConsumerXBuilder<T, X> objShortConsumerX(Consumer<LObjShortConsumerX<T, X>> consumer) {
	...
	public final LObjShortConsumerX<T, X> build() {
		...
		retval = LObjShortConsumerX.<T, X> lX((T t, short s) -> {
			try {
