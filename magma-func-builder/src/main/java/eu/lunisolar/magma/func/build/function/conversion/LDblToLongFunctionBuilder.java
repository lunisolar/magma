...
public final class LDblToLongFunctionBuilder extends PerCaseBuilderWithLongProduct.Base<LDblToLongFunctionBuilder, LDblPredicate, LDblToLongFunction> {
	...
	public static final LDblToLongFunction EVENTUALLY_THROW = LDblToLongFunction.dblToLongFunc(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LDblToLongFunctionBuilder(@Nullable Consumer<LDblToLongFunction> consumer) {
		super(EVENTUALLY_THROW, LDblToLongFunction::constant, () -> new LDblToLongFunctionBuilder(null));
	...
	@Nonnull
	public static LDblToLongFunction dblToLongFunctionFrom(Function<LDblToLongFunctionBuilder, LDblToLongFunction> buildingFunction) {
		return buildingFunction.apply(new LDblToLongFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LDblToLongFunctionBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LDblToLongFunction build() {
		...
		final LDblToLongFunction eventuallyFinal = this.eventually;
	...
	public final LDblToLongFunction build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
