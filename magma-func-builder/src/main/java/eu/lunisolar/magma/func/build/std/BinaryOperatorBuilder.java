...
public final class BinaryOperatorBuilder<T> extends PerCaseBuilderWithProduct.Base<BinaryOperatorBuilder<T>, LBiPredicate<T, T>, BinaryOperator<T>, T> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <T> BinaryOperatorBuilder<T> binaryOperator() {
		return new BinaryOperatorBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static <T> BinaryOperator<T> binaryOperatorFrom(Consumer<BinaryOperatorBuilder<T>> buildingFunction) {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final BinaryOperatorBuilder<T> withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public final BinaryOperator<T> build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
