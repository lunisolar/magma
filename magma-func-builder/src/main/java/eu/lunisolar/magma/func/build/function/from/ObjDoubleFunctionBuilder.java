...
public final class ObjDoubleFunctionBuilder<T, R> extends PerCaseBuilderWithProduct.Base<ObjDoubleFunctionBuilder<T, R>, ObjDoublePredicate<T>, ObjDoubleFunction<T, R>, R> {
