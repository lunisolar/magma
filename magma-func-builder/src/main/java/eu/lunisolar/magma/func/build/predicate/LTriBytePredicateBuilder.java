...
public final class LTriBytePredicateBuilder extends PerCaseBuilderWithBoolProduct.Base<LTriBytePredicateBuilder, LTriBytePredicate, LTriBytePredicate> {
	...
	public static final LTriBytePredicate EVENTUALLY_THROW = LTriBytePredicate.triBytePred((a1, a2, a3) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LTriBytePredicateBuilder(@Nullable Consumer<LTriBytePredicate> consumer) {
		super(EVENTUALLY_THROW, LTriBytePredicate::constant, () -> new LTriBytePredicateBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LTriBytePredicateBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LTriBytePredicate build() {
		...
		final LTriBytePredicate eventuallyFinal = this.eventually;
	...
	public final LTriBytePredicate build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
