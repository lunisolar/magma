...
public final class CharToShortFunctionXBuilder<X extends Exception> extends PerCaseBuilderWithShortProduct<CharToShortFunctionXBuilder<X>, CharPredicateX<X>, CharToShortFunctionX<X>> {
