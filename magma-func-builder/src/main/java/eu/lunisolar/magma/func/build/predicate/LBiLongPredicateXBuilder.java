...
public final class LBiLongPredicateXBuilder<X extends Throwable> extends PerCaseBuilderWithBoolProduct.Base<LBiLongPredicateXBuilder<X>, LBiLongPredicateX<X>, LBiLongPredicateX<X>> {
	...
	public static final LBiLongPredicateX EVENTUALLY_THROW = LBiLongPredicateX.lX((a1, a2) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LBiLongPredicateXBuilder(@Nullable Consumer<LBiLongPredicateX<X>> consumer) {
		super(EVENTUALLY_THROW, LBiLongPredicateX::constant, () -> new LBiLongPredicateXBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <X extends Throwable> LBiLongPredicateXBuilder<X> biLongPredicateX() {
		return new LBiLongPredicateXBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static <X extends Throwable> LBiLongPredicateX<X> biLongPredicateXFrom(Function<LBiLongPredicateXBuilder<X>, LBiLongPredicateX<X>> buildingFunction) {
		return buildingFunction.apply(new LBiLongPredicateXBuilder());
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <X extends Throwable> LBiLongPredicateXBuilder<X> biLongPredicateX(Consumer<LBiLongPredicateX<X>> consumer) {
	...
	public final LBiLongPredicateX<X> build() {
		...
		retval = LBiLongPredicateX.<X> lX((a1, a2) -> {
			try {
