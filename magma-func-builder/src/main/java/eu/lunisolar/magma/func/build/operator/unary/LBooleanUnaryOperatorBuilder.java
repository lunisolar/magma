...
public final class LBooleanUnaryOperatorBuilder extends PerCaseBuilderWithBooleanProduct.Base<LBooleanUnaryOperatorBuilder, LBooleanUnaryOperator, LBooleanUnaryOperator> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LBooleanUnaryOperatorBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LBooleanUnaryOperator build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
