...
public final class LDoubleToShortFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithShortProduct.Base<LDoubleToShortFunctionXBuilder<X>, LDoublePredicateX<X>, LDoubleToShortFunctionX<X>> {
	...
	public static final LDoubleToShortFunctionX EVENTUALLY_THROW = LDoubleToShortFunctionX.lX((double a1) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", a1, LDoubleToShortFunctionX.DESCRIPTION);
