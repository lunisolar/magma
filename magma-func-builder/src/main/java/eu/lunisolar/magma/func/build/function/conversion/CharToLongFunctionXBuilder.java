...
public final class CharToLongFunctionXBuilder<X extends Exception> extends PerCaseBuilderWithLongProduct.Base<CharToLongFunctionXBuilder<X>, CharPredicateX<X>, CharToLongFunctionX<X>> {
