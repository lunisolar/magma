...
public final class LTieLongConsumerBuilder<T> extends PerCaseBuilder.Base<LTieLongConsumerBuilder<T>, LObjIntLongPredicate<T>, LTieLongConsumer<T>> {
	...
	public static final LTieLongConsumer EVENTUALLY_THROW = LTieLongConsumer.tieLongCons((a1, a2, a3) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LTieLongConsumerBuilder(@Nullable Consumer<LTieLongConsumer<T>> consumer) {
		super(EVENTUALLY_THROW, () -> new LTieLongConsumerBuilder(null));
	...
	@Nonnull
	public static <T> LTieLongConsumer<T> tieLongConsumerFrom(Function<LTieLongConsumerBuilder<T>, LTieLongConsumer<T>> buildingFunction) {
		return buildingFunction.apply(new LTieLongConsumerBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LTieLongConsumerBuilder<T> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	@Nonnull
	public <V extends T> LTieLongConsumerBuilder<T> aCase(Class<V> argC1, LTieLongConsumer<V> function) {
		PartialCase.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LTieLongConsumer<T> build() {
		...
		final LTieLongConsumer<T> eventuallyFinal = this.eventually;
	...
	public final LTieLongConsumer<T> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
