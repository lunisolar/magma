...
public final class LObjDblConsumerBuilder<T> extends PerCaseBuilder.Base<LObjDblConsumerBuilder<T>, LObjDblPredicate<T>, LObjDblConsumer<T>> {
	...
	public static final LObjDblConsumer EVENTUALLY_THROW = LObjDblConsumer.objDblCons((a1, a2) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LObjDblConsumerBuilder(@Nullable Consumer<LObjDblConsumer<T>> consumer) {
		super(EVENTUALLY_THROW, () -> new LObjDblConsumerBuilder(null));
	...
	@Nonnull
	public static <T> LObjDblConsumer<T> objDblConsumerFrom(Function<LObjDblConsumerBuilder<T>, LObjDblConsumer<T>> buildingFunction) {
		return buildingFunction.apply(new LObjDblConsumerBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LObjDblConsumerBuilder<T> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	@Nonnull
	public <V extends T> LObjDblConsumerBuilder<T> aCase(Class<V> argC1, LObjDblConsumer<V> function) {
		PartialCase.The pc = partialCaseFactoryMethod((a1, a2) -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LObjDblConsumer<T> build() {
		...
		final LObjDblConsumer<T> eventuallyFinal = this.eventually;
	...
	public final LObjDblConsumer<T> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
