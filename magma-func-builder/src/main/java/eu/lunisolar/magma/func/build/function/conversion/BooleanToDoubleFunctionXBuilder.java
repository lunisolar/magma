...
public final class BooleanToDoubleFunctionXBuilder<X extends Exception> extends PerCaseBuilder<BooleanToDoubleFunctionXBuilder<X>, BooleanUnaryOperatorX<X>, BooleanToDoubleFunctionX<X>> {
