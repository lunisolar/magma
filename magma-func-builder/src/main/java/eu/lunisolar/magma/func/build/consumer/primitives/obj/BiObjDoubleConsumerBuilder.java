...
/** Builder for BiObjDoubleConsumer. */
public final class BiObjDoubleConsumerBuilder<T1, T2> extends PerCaseBuilder.Base<BiObjDoubleConsumerBuilder<T1, T2>, BiObjDoublePredicate<T1, T2>, BiObjDoubleConsumer<T1, T2>> {
