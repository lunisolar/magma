...
public final class LToSrtFunctionBuilder<T> extends PerCaseBuilderWithSrtProduct.Base<LToSrtFunctionBuilder<T>, LPredicate<T>, LToSrtFunction<T>> {
	...
	@Nonnull
	public static <T> LToSrtFunction<T> toSrtFunctionFrom(Function<LToSrtFunctionBuilder<T>, LToSrtFunction<T>> buildingFunction) {
		return buildingFunction.apply(new LToSrtFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LToSrtFunctionBuilder<T> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LToSrtFunction<T> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
