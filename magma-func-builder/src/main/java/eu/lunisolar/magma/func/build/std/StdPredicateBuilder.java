...
public final class StdPredicateBuilder<T> extends PerCaseBuilder<StdPredicateBuilder<T>, Predicate<T>, java.util.function.Predicate<T>> {
	...
	public StdPredicateBuilder(@Nullable Consumer<java.util.function.Predicate<T>> consumer) {
		super(EVENTUALLY_THROW);
		this.consumer = consumer;
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	public StdPredicateBuilder() {
		this(null);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T> StdPredicateBuilder<T> stdPredicate() {
		return new StdPredicateBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T> StdPredicateBuilder<T> stdPredicate(Consumer<java.util.function.Predicate<T>> consumer) {
		return new StdPredicateBuilder(consumer);
	}
	...
	public final java.util.function.Predicate<T> build() {
		...
		if (cases.isEmpty()) {
			...
			final Case<Predicate<T>, java.util.function.Predicate<T>>[] casesArray = cases.toArray(new Case[cases.size()]);
			retval = Function4U.l((T t) -> {
				for (Case<Predicate<T>, java.util.function.Predicate<T>> aCase : casesArray) {
