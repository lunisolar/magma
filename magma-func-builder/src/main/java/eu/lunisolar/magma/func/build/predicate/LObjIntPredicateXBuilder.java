...
public final class LObjIntPredicateXBuilder<T, X extends Exception> extends PerCaseBuilderWithBooleanProduct.Base<LObjIntPredicateXBuilder<T, X>, LObjIntPredicateX<T, X>, LObjIntPredicateX<T, X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T, X extends Exception> LObjIntPredicateXBuilder<T, X> objIntPredicateX() {
		return new LObjIntPredicateXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T, X extends Exception> LObjIntPredicateXBuilder<T, X> objIntPredicateX(Consumer<LObjIntPredicateX<T, X>> consumer) {
