...
public final class LDblIntPredicateBuilder extends PerCaseBuilderWithBoolProduct.Base<LDblIntPredicateBuilder, LDblIntPredicate, LDblIntPredicate> {
	...
	public static final LDblIntPredicate EVENTUALLY_THROW = LDblIntPredicate.dblIntPred((a1, a2) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LDblIntPredicateBuilder(@Nullable Consumer<LDblIntPredicate> consumer) {
		super(EVENTUALLY_THROW, LDblIntPredicate::constant, () -> new LDblIntPredicateBuilder(null));
	...
	@Nonnull
	public static LDblIntPredicate dblIntPredicateFrom(Function<LDblIntPredicateBuilder, LDblIntPredicate> buildingFunction) {
		return buildingFunction.apply(new LDblIntPredicateBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LDblIntPredicateBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LDblIntPredicate build() {
		...
		final LDblIntPredicate eventuallyFinal = this.eventually;
	...
	public final LDblIntPredicate build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
