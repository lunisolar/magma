...
public final class RunnableBuilder extends PerCaseBuilder.Base<RunnableBuilder, LBoolSupplier, Runnable> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final RunnableBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public final Runnable build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
