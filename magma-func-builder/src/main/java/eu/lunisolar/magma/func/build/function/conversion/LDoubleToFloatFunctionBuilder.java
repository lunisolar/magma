...
public final class LDoubleToFloatFunctionBuilder extends PerCaseBuilderWithFloatProduct.Base<LDoubleToFloatFunctionBuilder, LDoublePredicate, LDoubleToFloatFunction> {
	...
	public static final LDoubleToFloatFunction EVENTUALLY_THROW = LDoubleToFloatFunction.l(a1 -> {
	...
	@Nonnull
	public static LDoubleToFloatFunction doubleToFloatFunctionFrom(Function<LDoubleToFloatFunctionBuilder, LDoubleToFloatFunction> buildingFunction) {
		return buildingFunction.apply(new LDoubleToFloatFunctionBuilder());
	}
	...
	public final LDoubleToFloatFunction build() {
		...
		retval = LDoubleToFloatFunction.l(a1 -> {
			try {
