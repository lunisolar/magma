...
public final class BiObjBooleanPredicateXBuilder<T1, T2, X extends Exception> extends PerCaseBuilderWithBooleanProduct.Base<BiObjBooleanPredicateXBuilder<T1, T2, X>, BiObjBooleanPredicateX<T1, T2, X>, BiObjBooleanPredicateX<T1, T2, X>> {
	...
	public BiObjBooleanPredicateXBuilder(@Nullable Consumer<BiObjBooleanPredicateX<T1, T2, X>> consumer) {
		super(EVENTUALLY_THROW, BiObjBooleanPredicateX::constant);
