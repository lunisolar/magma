...
public final class LToShortFunctionBuilder<T> extends PerCaseBuilderWithShortProduct.Base<LToShortFunctionBuilder<T>, LPredicate<T>, LToShortFunction<T>> {
	...
	@Nonnull
	public static <T> LToShortFunction<T> toShortFunctionFrom(Function<LToShortFunctionBuilder<T>, LToShortFunction<T>> buildingFunction) {
		return buildingFunction.apply(new LToShortFunctionBuilder());
	}
