...
public final class ToCharBiFunctionBuilder<T1, T2> extends PerCaseBuilderWithCharProduct<ToCharBiFunctionBuilder<T1, T2>, BiPredicate<T1, T2>, ToCharBiFunction<T1, T2>> {
