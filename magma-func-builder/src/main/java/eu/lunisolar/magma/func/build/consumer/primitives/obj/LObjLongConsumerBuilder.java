...
public final class LObjLongConsumerBuilder<T> extends PerCaseBuilder.Base<LObjLongConsumerBuilder<T>, LObjLongPredicate<T>, LObjLongConsumer<T>> {
	...
	public static final LObjLongConsumer OTHERWISE_THROW = LObjLongConsumer.objLongCons((a1, a2) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LObjLongConsumerBuilder(@Nullable Consumer<LObjLongConsumer<T>> consumer) {
		super(OTHERWISE_THROW, () -> new LObjLongConsumerBuilder(null));
	...
	@Nonnull
	public static <T> LObjLongConsumer<T> objLongConsumerFrom(Consumer<LObjLongConsumerBuilder<T>> buildingFunction) {
		LObjLongConsumerBuilder builder = new LObjLongConsumerBuilder();
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LObjLongConsumerBuilder<T> withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public <V extends T> LObjLongConsumerBuilder<T> forValue(T v1, long v2, LObjLongConsumer<V> function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public <V extends T> PartialCase.The<LObjLongConsumerBuilder<T>, LObjLongPredicate<T>, LObjLongConsumer<T>> forValue(T v1, long v2) {
	...
	@Nonnull
	public <V extends T> LObjLongConsumerBuilder<T> forClass(Class<V> argC1, LObjLongConsumer<V> function) {
		PartialCase.The pc = partialCaseFactoryMethod((a1, a2) -> (argC1 == null || argC1.isInstance(a1)));
		pc.evaluate(function);
		return fluentCtx();
	}
	...
	/** Adds full new case for the argument that are of specific classes (matched by instanceOf, null is a wildcard). */
	@Nonnull
	public <V extends T> PartialCase.The<LObjLongConsumerBuilder<T>, LObjLongPredicate<T>, LObjLongConsumer<T>> forClass(Class<V> argC1) {
	...
	public final LObjLongConsumer<T> build() {
		...
		final LObjLongConsumer<T> otherwiseFinal = this.otherwise;
	...
	public final LObjLongConsumer<T> build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
