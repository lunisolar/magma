...
public final class LQuadFunctionBuilder<T1, T2, T3, T4, R> extends PerCaseBuilderWithProduct.Base<LQuadFunctionBuilder<T1, T2, T3, T4, R>, LQuadPredicate<T1, T2, T3, T4>, LQuadFunction<T1, T2, T3, T4, R>, R> {
	...
	public static final LQuadFunction EVENTUALLY_THROW = LQuadFunction.quadFunc((a1, a2, a3, a4) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LQuadFunctionBuilder(@Nullable Consumer<LQuadFunction<T1, T2, T3, T4, R>> consumer) {
		super(EVENTUALLY_THROW, LQuadFunction::constant, () -> new LQuadFunctionBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LQuadFunctionBuilder<T1, T2, T3, T4, R> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2, V3 extends T3, V4 extends T4> LQuadFunctionBuilder<T1, T2, T3, T4, R> aCase(Class<V1> argC1, Class<V2> argC2, Class<V3> argC3, Class<V4> argC4, LQuadFunction<V1, V2, V3, V4, R> function) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod((a1, a2, a3, a4) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)) && (argC3 == null || argC3.isInstance(a3)) && (argC4 == null || argC4.isInstance(a4)));
	...
	public final LQuadFunction<T1, T2, T3, T4, R> build() {
		...
		final LQuadFunction<T1, T2, T3, T4, R> eventuallyFinal = this.eventually;
		...
		retval = LQuadFunction.<T1, T2, T3, T4, R> quadFunc((a1, a2, a3, a4) -> {
			try {
				...
				return eventuallyFinal.apply(a1, a2, a3, a4);
	...
	public final LQuadFunction<T1, T2, T3, T4, R> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
