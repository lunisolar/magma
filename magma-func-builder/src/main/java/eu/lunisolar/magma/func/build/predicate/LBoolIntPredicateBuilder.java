...
public final class LBoolIntPredicateBuilder extends PerCaseBuilderWithBoolProduct.Base<LBoolIntPredicateBuilder, LBoolIntPredicate, LBoolIntPredicate> {
	...
	public static final LBoolIntPredicate EVENTUALLY_THROW = LBoolIntPredicate.boolIntPred((a1, a2) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LBoolIntPredicateBuilder(@Nullable Consumer<LBoolIntPredicate> consumer) {
		super(EVENTUALLY_THROW, LBoolIntPredicate::constant, () -> new LBoolIntPredicateBuilder(null));
	...
	@Nonnull
	public static LBoolIntPredicate boolIntPredicateFrom(Function<LBoolIntPredicateBuilder, LBoolIntPredicate> buildingFunction) {
		return buildingFunction.apply(new LBoolIntPredicateBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LBoolIntPredicateBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LBoolIntPredicate build() {
		...
		final LBoolIntPredicate eventuallyFinal = this.eventually;
	...
	public final LBoolIntPredicate build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
