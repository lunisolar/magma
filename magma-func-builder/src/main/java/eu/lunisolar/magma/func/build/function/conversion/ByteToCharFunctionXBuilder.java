...
public final class ByteToCharFunctionXBuilder<X extends Exception> extends PerCaseBuilderWithCharProduct.Base<ByteToCharFunctionXBuilder<X>, BytePredicateX<X>, ByteToCharFunctionX<X>> {
