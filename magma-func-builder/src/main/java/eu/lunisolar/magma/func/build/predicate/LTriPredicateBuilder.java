...
public final class LTriPredicateBuilder<T1, T2, T3> extends PerCaseBuilderWithBooleanProduct.Base<LTriPredicateBuilder<T1, T2, T3>, LTriPredicate<T1, T2, T3>, LTriPredicate<T1, T2, T3>> {
	...
	public static final LTriPredicate EVENTUALLY_THROW = LTriPredicate.l((Object a1, Object a2, Object a3) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s ,%s  as function %s.", a1, a2, a3, LTriPredicate.DESCRIPTION);
	...
	public LTriPredicateBuilder(@Nullable Consumer<LTriPredicate<T1, T2, T3>> consumer) {
		super(EVENTUALLY_THROW, LTriPredicate::constant, () -> new LTriPredicateBuilder(null));
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2, E3 extends T3> LTriPredicateBuilder<T1, T2, T3> casesOf(Class<E1> argC1, Class<E2> argC2, Class<E3> argC3, Consumer<LTriPredicateBuilder<E1, E2, E3>> pcpConsumer) {
		PartialCaseWithBooleanProduct.The pc = partialCaseFactoryMethod((T1 a1, T2 a2, T3 a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)) && (argC3 == null || argC3.isInstance(a3)));
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2, E3 extends T3> LTriPredicateBuilder<T1, T2, T3> aCase(Class<E1> argC1, Class<E2> argC2, Class<E3> argC3, LTriPredicate<E1, E2, E3> function) {
		PartialCaseWithBooleanProduct.The pc = partialCaseFactoryMethod((T1 a1, T2 a2, T3 a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)) && (argC3 == null || argC3.isInstance(a3)));
	...
	public final LTriPredicate<T1, T2, T3> build() {
		...
		retval = LTriPredicate.<T1, T2, T3> l((T1 a1, T2 a2, T3 a3) -> {
			try {
