...
public final class LIntToShortFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithShortProduct.Base<LIntToShortFunctionXBuilder<X>, LIntPredicateX<X>, LIntToShortFunctionX<X>> {
	...
	public static final LIntToShortFunctionX EVENTUALLY_THROW = LIntToShortFunctionX.lX(a1 -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LIntToShortFunctionXBuilder(@Nullable Consumer<LIntToShortFunctionX<X>> consumer) {
		super(EVENTUALLY_THROW, LIntToShortFunctionX::constant, () -> new LIntToShortFunctionXBuilder(null));

		this.consumer = consumer;
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	public LIntToShortFunctionXBuilder() {
		this(null);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <X extends Throwable> LIntToShortFunctionXBuilder<X> intToShortFunctionX() {
		return new LIntToShortFunctionXBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static <X extends Throwable> LIntToShortFunctionX<X> intToShortFunctionXFrom(Function<LIntToShortFunctionXBuilder<X>, LIntToShortFunctionX<X>> buildingFunction) {
		return buildingFunction.apply(new LIntToShortFunctionXBuilder());
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <X extends Throwable> LIntToShortFunctionXBuilder<X> intToShortFunctionX(Consumer<LIntToShortFunctionX<X>> consumer) {
	...
	@Nonnull
	public final LIntToShortFunctionX<X> build() {

		final LIntToShortFunctionX<X> eventuallyFinal = this.eventually;
		...
		retval = LIntToShortFunctionX.<X> lX(a1 -> {
			try {
