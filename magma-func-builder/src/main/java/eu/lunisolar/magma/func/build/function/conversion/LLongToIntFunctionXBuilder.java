...
public final class LLongToIntFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithIntProduct.Base<LLongToIntFunctionXBuilder<X>, LLongPredicateX<X>, LLongToIntFunctionX<X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Throwable> LLongToIntFunctionXBuilder<X> longToIntFunctionX() {
		return new LLongToIntFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Throwable> LLongToIntFunctionXBuilder<X> longToIntFunctionX(Consumer<LLongToIntFunctionX<X>> consumer) {
