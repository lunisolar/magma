...
public final class LObjIntSrtPredicateBuilder<T> extends PerCaseBuilderWithBoolProduct.Base<LObjIntSrtPredicateBuilder<T>, LObjIntSrtPredicate<T>, LObjIntSrtPredicate<T>> {
	...
	@Nonnull
	public static <T> LObjIntSrtPredicate<T> objIntSrtPredicateFrom(Function<LObjIntSrtPredicateBuilder<T>, LObjIntSrtPredicate<T>> buildingFunction) {
		return buildingFunction.apply(new LObjIntSrtPredicateBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LObjIntSrtPredicateBuilder<T> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	@Nonnull
	public <V extends T> LObjIntSrtPredicateBuilder<T> aCase(Class<V> argC1, LObjIntSrtPredicate<V> function) {
		PartialCaseWithBoolProduct.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LObjIntSrtPredicate<T> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
