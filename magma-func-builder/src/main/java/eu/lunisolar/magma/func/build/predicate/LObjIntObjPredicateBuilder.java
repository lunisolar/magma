...
public final class LObjIntObjPredicateBuilder<T1, T2> extends PerCaseBuilderWithBoolProduct.Base<LObjIntObjPredicateBuilder<T1, T2>, LObjIntObjPredicate<T1, T2>, LObjIntObjPredicate<T1, T2>> {
	...
	@Nonnull
	public static <T1, T2> LObjIntObjPredicate<T1, T2> objIntObjPredicateFrom(Function<LObjIntObjPredicateBuilder<T1, T2>, LObjIntObjPredicate<T1, T2>> buildingFunction) {
		return buildingFunction.apply(new LObjIntObjPredicateBuilder());
	}
