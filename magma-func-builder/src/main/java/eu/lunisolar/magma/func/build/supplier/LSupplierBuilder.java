...
public final class LSupplierBuilder<T> extends PerCaseBuilderWithProduct.Base<LSupplierBuilder<T>, LBoolSupplier, LSupplier<T>, T> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LSupplierBuilder<T> withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public final LSupplier<T> build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
