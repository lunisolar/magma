...
public final class LShortToFloatFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithFloatProduct.Base<LShortToFloatFunctionXBuilder<X>, LShortPredicateX<X>, LShortToFloatFunctionX<X>> {
	...
	@Nonnull
	public static <X extends Throwable> LShortToFloatFunctionX<X> shortToFloatFunctionXFrom(Function<LShortToFloatFunctionXBuilder<X>, LShortToFloatFunctionX<X>> buildingFunction) {
		return buildingFunction.apply(new LShortToFloatFunctionXBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LShortToFloatFunctionXBuilder<X> withHandling(@Nonnull HandlingInstructions<X, X> handling) {
	...
	public final LShortToFloatFunctionX<X> build(@Nonnull HandlingInstructions<X, X> handling) {
