...
public final class LActionBuilder extends PerCaseBuilder.Base<LActionBuilder, LBoolSupplier, LAction> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LActionBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public final LAction build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
