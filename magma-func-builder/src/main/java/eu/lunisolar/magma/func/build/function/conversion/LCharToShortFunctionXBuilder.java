...
public final class LCharToShortFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithShortProduct.Base<LCharToShortFunctionXBuilder<X>, LCharPredicateX<X>, LCharToShortFunctionX<X>> {
	...
	public static final LCharToShortFunctionX EVENTUALLY_THROW = LCharToShortFunctionX.lX((char a1) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", a1, LCharToShortFunctionX.DESCRIPTION);
