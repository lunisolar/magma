...
public final class LToCharFunctionXBuilder<T, X extends Throwable> extends PerCaseBuilderWithCharProduct.Base<LToCharFunctionXBuilder<T, X>, LPredicateX<T, X>, LToCharFunctionX<T, X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T, X extends Throwable> LToCharFunctionXBuilder<T, X> toCharFunctionX() {
		return new LToCharFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T, X extends Throwable> LToCharFunctionXBuilder<T, X> toCharFunctionX(Consumer<LToCharFunctionX<T, X>> consumer) {
