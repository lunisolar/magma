...
public final class LObjByteConsumerXBuilder<T, X extends Exception> extends PerCaseBuilder.Base<LObjByteConsumerXBuilder<T, X>, LObjBytePredicateX<T, X>, LObjByteConsumerX<T, X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T, X extends Exception> LObjByteConsumerXBuilder<T, X> objByteConsumerX() {
		return new LObjByteConsumerXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T, X extends Exception> LObjByteConsumerXBuilder<T, X> objByteConsumerX(Consumer<LObjByteConsumerX<T, X>> consumer) {
