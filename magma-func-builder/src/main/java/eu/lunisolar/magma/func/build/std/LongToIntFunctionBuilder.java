...
public final class LongToIntFunctionBuilder extends PerCaseBuilderWithIntProduct.Base<LongToIntFunctionBuilder, LLongPredicate, LongToIntFunction> {
	...
	public static final LongToIntFunction OTHERWISE_THROW = Function4U.longToIntFunc(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LongToIntFunctionBuilder(@Nullable Consumer<LongToIntFunction> consumer) {
		super(OTHERWISE_THROW, LLongToIntFunction::constant, () -> new LongToIntFunctionBuilder(null));
	...
	@Nonnull
	public static LongToIntFunctionBuilder longToIntFunction(Consumer<LongToIntFunction> consumer) {
		return new LongToIntFunctionBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LongToIntFunctionBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public final LongToIntFunction build() {
		...
		final LongToIntFunction otherwiseFinal = this.otherwise;
	...
	public final LongToIntFunction build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
