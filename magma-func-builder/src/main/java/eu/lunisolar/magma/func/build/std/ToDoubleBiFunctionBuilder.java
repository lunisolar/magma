...
public final class ToDoubleBiFunctionBuilder<T1, T2> extends PerCaseBuilderWithDblProduct.Base<ToDoubleBiFunctionBuilder<T1, T2>, LBiPredicate<T1, T2>, ToDoubleBiFunction<T1, T2>> {
	...
	@Nonnull
	public static <T1, T2> ToDoubleBiFunction<T1, T2> toDblBiFunctionFrom(Consumer<ToDoubleBiFunctionBuilder<T1, T2>> buildingFunction) {
		ToDoubleBiFunctionBuilder builder = new ToDoubleBiFunctionBuilder();
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final ToDoubleBiFunctionBuilder<T1, T2> withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public final ToDoubleBiFunction<T1, T2> build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
