...
public final class LShortToFloatFunctionBuilder extends PerCaseBuilderWithFloatProduct.Base<LShortToFloatFunctionBuilder, LShortPredicate, LShortToFloatFunction> {
	...
	@Nonnull
	public static LShortToFloatFunction shortToFloatFunctionFrom(Function<LShortToFloatFunctionBuilder, LShortToFloatFunction> buildingFunction) {
		return buildingFunction.apply(new LShortToFloatFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LShortToFloatFunctionBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LShortToFloatFunction build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
