...
public final class StdToLongFunctionBuilder<T> extends PerCaseBuilderWithLongProduct<StdToLongFunctionBuilder<T>, Predicate<T>, java.util.function.ToLongFunction<T>> {

	private Consumer<java.util.function.ToLongFunction<T>> consumer;

	public static final java.util.function.ToLongFunction EVENTUALLY_THROW = Function4U.toLongFunction((Object t) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", t, "java.util.function.ToLongFunction: long applyAsLong(T t)");
	...
	public StdToLongFunctionBuilder() {
		this(null);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T> StdToLongFunctionBuilder<T> stdToLongFunction() {
		return new StdToLongFunctionBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T> StdToLongFunctionBuilder<T> stdToLongFunction(Consumer<java.util.function.ToLongFunction<T>> consumer) {
		return new StdToLongFunctionBuilder(consumer);
	}
