...
public final class LBiObjBoolFunctionXBuilder<T1, T2, R, X extends Throwable> extends PerCaseBuilderWithProduct.Base<LBiObjBoolFunctionXBuilder<T1, T2, R, X>, LBiObjBoolPredicateX<T1, T2, X>, LBiObjBoolFunctionX<T1, T2, R, X>, R> {
	...
	public static final LBiObjBoolFunctionX EVENTUALLY_THROW = LBiObjBoolFunctionX.lX((a1, a2, a3) -> {
	...
	@Nonnull
	public static <T1, T2, R, X extends Throwable> LBiObjBoolFunctionX<T1, T2, R, X> biObjBoolFunctionXFrom(Function<LBiObjBoolFunctionXBuilder<T1, T2, R, X>, LBiObjBoolFunctionX<T1, T2, R, X>> buildingFunction) {
		return buildingFunction.apply(new LBiObjBoolFunctionXBuilder());
	}
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjBoolFunctionXBuilder<T1, T2, R, X> casesOf(Class<V1> argC1, Class<V2> argC2, Consumer<LBiObjBoolFunctionXBuilder<V1, V2, R, X>> pcpConsumer) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjBoolFunctionXBuilder<T1, T2, R, X> aCase(Class<V1> argC1, Class<V2> argC2, LBiObjBoolFunctionX<V1, V2, R, X> function) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LBiObjBoolFunctionX<T1, T2, R, X> build() {
		...
		retval = LBiObjBoolFunctionX.<T1, T2, R, X> lX((a1, a2, a3) -> {
			try {
