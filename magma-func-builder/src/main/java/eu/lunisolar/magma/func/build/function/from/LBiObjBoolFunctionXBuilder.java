...
public final class LBiObjBoolFunctionXBuilder<T1, T2, R, X extends Throwable> extends PerCaseBuilderWithProduct.Base<LBiObjBoolFunctionXBuilder<T1, T2, R, X>, LBiObjBoolPredicateX<T1, T2, X>, LBiObjBoolFunctionX<T1, T2, R, X>, R> {
	...
	public static final LBiObjBoolFunctionX EVENTUALLY_THROW = LBiObjBoolFunctionX.lX((Object a1, Object a2, boolean a3) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s ,%s  as function %s.", a1, a2, a3, LBiObjBoolFunctionX.DESCRIPTION);
	...
	public final LBiObjBoolFunctionX<T1, T2, R, X> build() {
		...
		retval = LBiObjBoolFunctionX.<T1, T2, R, X> lX((T1 a1, T2 a2, boolean a3) -> {
			try {
