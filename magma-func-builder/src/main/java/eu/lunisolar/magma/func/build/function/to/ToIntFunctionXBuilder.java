...
public final class ToIntFunctionXBuilder<T, X extends Exception> extends PerCaseBuilderWithIntProduct<ToIntFunctionXBuilder<T, X>, PredicateX<T, X>, ToIntFunctionX<T, X>> {
