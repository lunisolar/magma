...
public final class LTriFunctionXBuilder<T1, T2, T3, R, X extends Exception> extends PerCaseBuilderWithProduct.Base<LTriFunctionXBuilder<T1, T2, T3, R, X>, LTriPredicateX<T1, T2, T3, X>, LTriFunctionX<T1, T2, T3, R, X>, R> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T1, T2, T3, R, X extends Exception> LTriFunctionXBuilder<T1, T2, T3, R, X> triFunctionX() {
		return new LTriFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T1, T2, T3, R, X extends Exception> LTriFunctionXBuilder<T1, T2, T3, R, X> triFunctionX(Consumer<LTriFunctionX<T1, T2, T3, R, X>> consumer) {
