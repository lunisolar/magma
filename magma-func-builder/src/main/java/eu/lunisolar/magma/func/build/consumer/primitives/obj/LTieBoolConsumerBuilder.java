...
public final class LTieBoolConsumerBuilder<T> extends PerCaseBuilder.Base<LTieBoolConsumerBuilder<T>, LObjIntBoolPredicate<T>, LTieBoolConsumer<T>> {
	...
	public static final LTieBoolConsumer OTHERWISE_THROW = LTieBoolConsumer.tieBoolCons((a1, a2, a3) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LTieBoolConsumerBuilder(@Nullable Consumer<LTieBoolConsumer<T>> consumer) {
		super(OTHERWISE_THROW, () -> new LTieBoolConsumerBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LTieBoolConsumerBuilder<T> withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public <V extends T> LTieBoolConsumerBuilder<T> forValue(T v1, int v2, boolean v3, LTieBoolConsumer<V> function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public <V extends T> PartialCase.The<LTieBoolConsumerBuilder<T>, LObjIntBoolPredicate<T>, LTieBoolConsumer<T>> forValue(T v1, int v2, boolean v3) {
	...
	@Nonnull
	public <V extends T> LTieBoolConsumerBuilder<T> forClass(Class<V> argC1, LTieBoolConsumer<V> function) {
		PartialCase.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)));
		pc.evaluate(function);
		return fluentCtx();
	}
	...
	/** Adds full new case for the argument that are of specific classes (matched by instanceOf, null is a wildcard). */
	@Nonnull
	public <V extends T> PartialCase.The<LTieBoolConsumerBuilder<T>, LObjIntBoolPredicate<T>, LTieBoolConsumer<T>> forClass(Class<V> argC1) {
	...
	public final LTieBoolConsumer<T> build() {
		...
		final LTieBoolConsumer<T> otherwiseFinal = this.otherwise;
	...
	public final LTieBoolConsumer<T> build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
