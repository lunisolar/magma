...
public final class LFloatBinaryOperatorXBuilder<X extends Throwable> extends PerCaseBuilderWithFloatProduct.Base<LFloatBinaryOperatorXBuilder<X>, LBiFloatPredicateX<X>, LFloatBinaryOperatorX<X>> {
	...
	public static final LFloatBinaryOperatorX EVENTUALLY_THROW = LFloatBinaryOperatorX.lX((float a1, float a2) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s  as function %s.", a1, a2, LFloatBinaryOperatorX.DESCRIPTION);
	...
	public final LFloatBinaryOperatorX<X> build() {
		...
		retval = LFloatBinaryOperatorX.<X> lX((float a1, float a2) -> {
			try {
