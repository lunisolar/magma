...
public final class LObjBooleanFunctionXBuilder<T, R, X extends Throwable> extends PerCaseBuilderWithProduct.Base<LObjBooleanFunctionXBuilder<T, R, X>, LObjBooleanPredicateX<T, X>, LObjBooleanFunctionX<T, R, X>, R> {
	...
	public LObjBooleanFunctionXBuilder(@Nullable Consumer<LObjBooleanFunctionX<T, R, X>> consumer) {
		super(EVENTUALLY_THROW, LObjBooleanFunctionX::constant, () -> new LObjBooleanFunctionXBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <T, R, X extends Throwable> LObjBooleanFunctionXBuilder<T, R, X> objBooleanFunctionX() {
		return new LObjBooleanFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <T, R, X extends Throwable> LObjBooleanFunctionXBuilder<T, R, X> objBooleanFunctionX(Consumer<LObjBooleanFunctionX<T, R, X>> consumer) {
	...
	@Nonnull
	public <E1 extends T> LObjBooleanFunctionXBuilder<T, R, X> casesOf(Class<E1> argC1, Consumer<LObjBooleanFunctionXBuilder<E1, R, X>> pcpConsumer) {
	...
	@Nonnull
	public <E1 extends T> LObjBooleanFunctionXBuilder<T, R, X> aCase(Class<E1> argC1, LObjBooleanFunctionX<E1, R, X> function) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod((T t, boolean b) -> (argC1 == null || argC1.isInstance(t)));
	...
	public final LObjBooleanFunctionX<T, R, X> build() {
		...
		retval = LObjBooleanFunctionX.<T, R, X> lX((T t, boolean b) -> {
			try {
