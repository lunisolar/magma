...
public final class LFloatUnaryOperatorBuilder extends PerCaseBuilderWithFloatProduct.Base<LFloatUnaryOperatorBuilder, LFloatPredicate, LFloatUnaryOperator> {
	...
	public LFloatUnaryOperatorBuilder(@Nullable Consumer<LFloatUnaryOperator> consumer) {
		super(EVENTUALLY_THROW, LFloatUnaryOperator::constant, () -> new LFloatUnaryOperatorBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static LFloatUnaryOperatorBuilder floatUnaryOperator() {
		return new LFloatUnaryOperatorBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static LFloatUnaryOperator floatUnaryOperatorFrom(Function<LFloatUnaryOperatorBuilder, LFloatUnaryOperator> buildingFunction) {
		return buildingFunction.apply(new LFloatUnaryOperatorBuilder());
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static LFloatUnaryOperatorBuilder floatUnaryOperator(Consumer<LFloatUnaryOperator> consumer) {
		return new LFloatUnaryOperatorBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LFloatUnaryOperatorBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LFloatUnaryOperator build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
