...
public final class LCharToFltFunctionBuilder extends PerCaseBuilderWithFltProduct.Base<LCharToFltFunctionBuilder, LCharPredicate, LCharToFltFunction> {
	...
	@Nonnull
	public static LCharToFltFunction charToFltFunctionFrom(Function<LCharToFltFunctionBuilder, LCharToFltFunction> buildingFunction) {
		return buildingFunction.apply(new LCharToFltFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LCharToFltFunctionBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LCharToFltFunction build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
