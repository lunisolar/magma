...
public final class DoubleSupplierBuilder extends PerCaseBuilderWithDblProduct.Base<DoubleSupplierBuilder, LBoolSupplier, DoubleSupplier> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final DoubleSupplierBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public final DoubleSupplier build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
