...
public final class LObjBytePredicateXBuilder<T, X extends Throwable> extends PerCaseBuilderWithBooleanProduct.Base<LObjBytePredicateXBuilder<T, X>, LObjBytePredicateX<T, X>, LObjBytePredicateX<T, X>> {

	private Consumer<LObjBytePredicateX<T, X>> consumer;

	private @Nullable HandlingInstructions handling;

	public static final LObjBytePredicateX EVENTUALLY_THROW = LObjBytePredicateX.lX((Object a1, byte a2) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s  as function %s.", a1, a2, LObjBytePredicateX.DESCRIPTION);
	...
	@Nonnull
	public <E1 extends T> LObjBytePredicateXBuilder<T, X> casesOf(Class<E1> argC1, Consumer<LObjBytePredicateXBuilder<E1, X>> pcpConsumer) {
	...
	@Nonnull
	public <E1 extends T> LObjBytePredicateXBuilder<T, X> aCase(Class<E1> argC1, LObjBytePredicateX<E1, X> function) {
		PartialCaseWithBooleanProduct.The pc = partialCaseFactoryMethod((T a1, byte a2) -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LObjBytePredicateX<T, X> build() {
		...
		retval = LObjBytePredicateX.<T, X> lX((T a1, byte a2) -> {
			try {
