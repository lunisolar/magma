...
public final class LUnaryOperatorXBuilder<T, X extends Throwable> extends PerCaseBuilderWithProduct.Base<LUnaryOperatorXBuilder<T, X>, LPredicateX<T, X>, LUnaryOperatorX<T, X>, T> {
	...
	public static final LUnaryOperatorX EVENTUALLY_THROW = LUnaryOperatorX.lX(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LUnaryOperatorXBuilder(@Nullable Consumer<LUnaryOperatorX<T, X>> consumer) {
		super(EVENTUALLY_THROW, LUnaryOperatorX::constant, () -> new LUnaryOperatorXBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <T, X extends Throwable> LUnaryOperatorXBuilder<T, X> unaryOperatorX() {
		return new LUnaryOperatorXBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static <T, X extends Throwable> LUnaryOperatorX<T, X> unaryOperatorXFrom(Function<LUnaryOperatorXBuilder<T, X>, LUnaryOperatorX<T, X>> buildingFunction) {
		return buildingFunction.apply(new LUnaryOperatorXBuilder());
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <T, X extends Throwable> LUnaryOperatorXBuilder<T, X> unaryOperatorX(Consumer<LUnaryOperatorX<T, X>> consumer) {
	...
	@Nonnull
	public <V extends T> LUnaryOperatorXBuilder<T, X> casesOf(Class<V> argC, Consumer<LUnaryOperatorXBuilder<V, X>> pcpConsumer) {
	...
	@Nonnull
	public <V extends T> LUnaryOperatorXBuilder<T, X> aCase(Class<V> argC, LUnaryOperatorX<V, X> function) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod(a -> (argC == null || argC.isInstance(a)));
	...
	public final LUnaryOperatorX<T, X> build() {
		...
		retval = LUnaryOperatorX.<T, X> lX(a -> {
			try {
