...
public final class LUnaryOperatorXBuilder<T, X extends Exception> extends PerCaseBuilderWithProduct.Base<LUnaryOperatorXBuilder<T, X>, LPredicateX<T, X>, LUnaryOperatorX<T, X>, T> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T, X extends Exception> LUnaryOperatorXBuilder<T, X> unaryOperatorX() {
		return new LUnaryOperatorXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T, X extends Exception> LUnaryOperatorXBuilder<T, X> unaryOperatorX(Consumer<LUnaryOperatorX<T, X>> consumer) {
