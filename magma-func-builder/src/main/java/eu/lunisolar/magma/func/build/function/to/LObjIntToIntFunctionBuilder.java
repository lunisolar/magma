...
public final class LObjIntToIntFunctionBuilder<T> extends PerCaseBuilderWithIntProduct.Base<LObjIntToIntFunctionBuilder<T>, LObjIntPredicate<T>, LObjIntToIntFunction<T>> {
	...
	public static final LObjIntToIntFunction EVENTUALLY_THROW = LObjIntToIntFunction.l((a1, a2) -> {
	...
	@Nonnull
	public static <T> LObjIntToIntFunction<T> objIntToIntFunctionFrom(Function<LObjIntToIntFunctionBuilder<T>, LObjIntToIntFunction<T>> buildingFunction) {
		return buildingFunction.apply(new LObjIntToIntFunctionBuilder());
	}
	...
	@Nonnull
	public <V extends T> LObjIntToIntFunctionBuilder<T> casesOf(Class<V> argC1, Consumer<LObjIntToIntFunctionBuilder<V>> pcpConsumer) {
	...
	@Nonnull
	public <V extends T> LObjIntToIntFunctionBuilder<T> aCase(Class<V> argC1, LObjIntToIntFunction<V> function) {
		PartialCaseWithIntProduct.The pc = partialCaseFactoryMethod((a1, a2) -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LObjIntToIntFunction<T> build() {
		...
		retval = LObjIntToIntFunction.<T> l((a1, a2) -> {
			try {
