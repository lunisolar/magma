...
public final class LObjIntToIntFunctionBuilder<T> extends PerCaseBuilderWithIntProduct.Base<LObjIntToIntFunctionBuilder<T>, LObjIntPredicate<T>, LObjIntToIntFunction<T>> {
	...
	public static final LObjIntToIntFunction EVENTUALLY_THROW = LObjIntToIntFunction.l((Object a1, int a2) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s  as function %s.", a1, a2, LObjIntToIntFunction.DESCRIPTION);
	...
	public final LObjIntToIntFunction<T> build() {
		...
		retval = LObjIntToIntFunction.<T> l((T a1, int a2) -> {
			try {
