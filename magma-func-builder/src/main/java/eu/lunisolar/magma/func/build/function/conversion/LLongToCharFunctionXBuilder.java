...
public final class LLongToCharFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithCharProduct.Base<LLongToCharFunctionXBuilder<X>, LLongPredicateX<X>, LLongToCharFunctionX<X>> {
	...
	public static final LLongToCharFunctionX EVENTUALLY_THROW = LLongToCharFunctionX.lX(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LLongToCharFunctionXBuilder(@Nullable Consumer<LLongToCharFunctionX<X>> consumer) {
		super(EVENTUALLY_THROW, LLongToCharFunctionX::constant, () -> new LLongToCharFunctionXBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <X extends Throwable> LLongToCharFunctionXBuilder<X> longToCharFunctionX() {
		return new LLongToCharFunctionXBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static <X extends Throwable> LLongToCharFunctionX<X> longToCharFunctionXFrom(Function<LLongToCharFunctionXBuilder<X>, LLongToCharFunctionX<X>> buildingFunction) {
		return buildingFunction.apply(new LLongToCharFunctionXBuilder());
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <X extends Throwable> LLongToCharFunctionXBuilder<X> longToCharFunctionX(Consumer<LLongToCharFunctionX<X>> consumer) {
		return new LLongToCharFunctionXBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LLongToCharFunctionXBuilder<X> withHandling(@Nonnull HandlingInstructions<X, X> handling) {
	...
	public final LLongToCharFunctionX<X> build() {
		...
		retval = LLongToCharFunctionX.<X> lX(a -> {
			try {
	...
	public final LLongToCharFunctionX<X> build(@Nonnull HandlingInstructions<X, X> handling) {
