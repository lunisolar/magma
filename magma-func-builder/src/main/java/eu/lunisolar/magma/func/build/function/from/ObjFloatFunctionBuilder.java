...
public final class ObjFloatFunctionBuilder<T, R> extends PerCaseBuilderWithProduct.Base<ObjFloatFunctionBuilder<T, R>, ObjFloatPredicate<T>, ObjFloatFunction<T, R>, R> {
