...
public final class LSrtBinaryOperatorBuilder extends PerCaseBuilderWithSrtProduct.Base<LSrtBinaryOperatorBuilder, LBiSrtPredicate, LSrtBinaryOperator> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LSrtBinaryOperatorBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LSrtBinaryOperator build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
