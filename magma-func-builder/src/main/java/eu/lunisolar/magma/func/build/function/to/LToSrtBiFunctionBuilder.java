...
public final class LToSrtBiFunctionBuilder<T1, T2> extends PerCaseBuilderWithSrtProduct.Base<LToSrtBiFunctionBuilder<T1, T2>, LBiPredicate<T1, T2>, LToSrtBiFunction<T1, T2>> {
	...
	@Nonnull
	public static <T1, T2> LToSrtBiFunction<T1, T2> toSrtBiFunctionFrom(Function<LToSrtBiFunctionBuilder<T1, T2>, LToSrtBiFunction<T1, T2>> buildingFunction) {
		return buildingFunction.apply(new LToSrtBiFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LToSrtBiFunctionBuilder<T1, T2> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LToSrtBiFunctionBuilder<T1, T2> aCase(Class<V1> argC1, Class<V2> argC2, LToSrtBiFunction<V1, V2> function) {
		PartialCaseWithSrtProduct.The pc = partialCaseFactoryMethod((a1, a2) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LToSrtBiFunction<T1, T2> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
