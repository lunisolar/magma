...
public final class LTernaryOperatorXBuilder<T, X extends Exception> extends PerCaseBuilderWithProduct.Base<LTernaryOperatorXBuilder<T, X>, LTriPredicateX<T, T, T, X>, LTernaryOperatorX<T, X>, T> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T, X extends Exception> LTernaryOperatorXBuilder<T, X> ternaryOperatorX() {
		return new LTernaryOperatorXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T, X extends Exception> LTernaryOperatorXBuilder<T, X> ternaryOperatorX(Consumer<LTernaryOperatorX<T, X>> consumer) {
