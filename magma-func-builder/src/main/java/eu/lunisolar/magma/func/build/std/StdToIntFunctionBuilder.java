...
public final class StdToIntFunctionBuilder<T> extends PerCaseBuilderWithIntProduct<StdToIntFunctionBuilder<T>, Predicate<T>, java.util.function.ToIntFunction<T>> {
	...
	public StdToIntFunctionBuilder() {
		this(null);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T> StdToIntFunctionBuilder<T> stdToIntFunction() {
		return new StdToIntFunctionBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T> StdToIntFunctionBuilder<T> stdToIntFunction(Consumer<java.util.function.ToIntFunction<T>> consumer) {
		return new StdToIntFunctionBuilder(consumer);
	}
