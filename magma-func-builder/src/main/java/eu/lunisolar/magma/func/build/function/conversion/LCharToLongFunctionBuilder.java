...
public final class LCharToLongFunctionBuilder extends PerCaseBuilderWithLongProduct.Base<LCharToLongFunctionBuilder, LCharPredicate, LCharToLongFunction> {
	...
	public static final LCharToLongFunction EVENTUALLY_THROW = LCharToLongFunction.l((char c) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", c, LCharToLongFunction.DESCRIPTION);
	...
	public LCharToLongFunctionBuilder(@Nullable Consumer<LCharToLongFunction> consumer) {
		super(EVENTUALLY_THROW, LCharToLongFunction::constant);
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final LCharToLongFunctionBuilder charToLongFunction() {
		return new LCharToLongFunctionBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final LCharToLongFunctionBuilder charToLongFunction(Consumer<LCharToLongFunction> consumer) {
		return new LCharToLongFunctionBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LCharToLongFunctionBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LCharToLongFunction build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
