...
public final class LCharToLongFunctionBuilder extends PerCaseBuilderWithLongProduct.Base<LCharToLongFunctionBuilder, LCharPredicate, LCharToLongFunction> {
	...
	public LCharToLongFunctionBuilder forValue(char v, LCharToLongFunction function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithLongProduct.The<LCharToLongFunctionBuilder, LCharPredicate, LCharToLongFunction> forValue(char v) {
