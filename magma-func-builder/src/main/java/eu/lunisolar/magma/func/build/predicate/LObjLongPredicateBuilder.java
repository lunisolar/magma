...
public final class LObjLongPredicateBuilder<T> extends PerCaseBuilderWithBooleanProduct.Base<LObjLongPredicateBuilder<T>, LObjLongPredicate<T>, LObjLongPredicate<T>> {
	...
	public static final LObjLongPredicate EVENTUALLY_THROW = LObjLongPredicate.l((Object t, long l) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s  as function %s.", t, l, LObjLongPredicate.DESCRIPTION);
	...
	public LObjLongPredicateBuilder(@Nullable Consumer<LObjLongPredicate<T>> consumer) {
		super(EVENTUALLY_THROW, LObjLongPredicate::constant);
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T> LObjLongPredicateBuilder<T> objLongPredicate() {
		return new LObjLongPredicateBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T> LObjLongPredicateBuilder<T> objLongPredicate(Consumer<LObjLongPredicate<T>> consumer) {
	...
	public final LObjLongPredicate<T> build() {
		...
		retval = LObjLongPredicate.<T> l((T t, long l) -> {
			try {
