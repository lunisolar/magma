...
public final class LByteToIntFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithIntProduct.Base<LByteToIntFunctionXBuilder<X>, LBytePredicateX<X>, LByteToIntFunctionX<X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Throwable> LByteToIntFunctionXBuilder<X> byteToIntFunctionX() {
		return new LByteToIntFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Throwable> LByteToIntFunctionXBuilder<X> byteToIntFunctionX(Consumer<LByteToIntFunctionX<X>> consumer) {
