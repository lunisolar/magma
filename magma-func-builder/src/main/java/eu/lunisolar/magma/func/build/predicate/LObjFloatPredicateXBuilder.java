...
public final class LObjFloatPredicateXBuilder<T, X extends Exception> extends PerCaseBuilderWithBooleanProduct.Base<LObjFloatPredicateXBuilder<T, X>, LObjFloatPredicateX<T, X>, LObjFloatPredicateX<T, X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T, X extends Exception> LObjFloatPredicateXBuilder<T, X> objFloatPredicateX() {
		return new LObjFloatPredicateXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T, X extends Exception> LObjFloatPredicateXBuilder<T, X> objFloatPredicateX(Consumer<LObjFloatPredicateX<T, X>> consumer) {
	...
	public final LObjFloatPredicateX<T, X> build() {
		...
		if (cases.isEmpty()) {
			...
			retval = LObjFloatPredicateX.lX((T t, float f) -> {
