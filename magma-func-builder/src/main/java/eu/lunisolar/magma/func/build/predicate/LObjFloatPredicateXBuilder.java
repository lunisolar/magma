...
public final class LObjFloatPredicateXBuilder<T, X extends Throwable> extends PerCaseBuilderWithBooleanProduct.Base<LObjFloatPredicateXBuilder<T, X>, LObjFloatPredicateX<T, X>, LObjFloatPredicateX<T, X>> {
	...
	public static final LObjFloatPredicateX EVENTUALLY_THROW = LObjFloatPredicateX.lX((Object a1, float a2) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s  as function %s.", a1, a2, LObjFloatPredicateX.DESCRIPTION);
	...
	@Nonnull
	public <E1 extends T> LObjFloatPredicateXBuilder<T, X> casesOf(Class<E1> argC1, Consumer<LObjFloatPredicateXBuilder<E1, X>> pcpConsumer) {
	...
	@Nonnull
	public <E1 extends T> LObjFloatPredicateXBuilder<T, X> aCase(Class<E1> argC1, LObjFloatPredicateX<E1, X> function) {
		PartialCaseWithBooleanProduct.The pc = partialCaseFactoryMethod((T a1, float a2) -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LObjFloatPredicateX<T, X> build() {
		...
		retval = LObjFloatPredicateX.<T, X> lX((T a1, float a2) -> {
			try {
