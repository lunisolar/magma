...
public final class LSrtToByteFunctionBuilder extends PerCaseBuilderWithByteProduct.Base<LSrtToByteFunctionBuilder, LSrtPredicate, LSrtToByteFunction> {
	...
	public static final LSrtToByteFunction EVENTUALLY_THROW = LSrtToByteFunction.srtToByteFunc(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LSrtToByteFunctionBuilder(@Nullable Consumer<LSrtToByteFunction> consumer) {
		super(EVENTUALLY_THROW, LSrtToByteFunction::constant, () -> new LSrtToByteFunctionBuilder(null));
	...
	@Nonnull
	public static LSrtToByteFunction srtToByteFunctionFrom(Function<LSrtToByteFunctionBuilder, LSrtToByteFunction> buildingFunction) {
		return buildingFunction.apply(new LSrtToByteFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LSrtToByteFunctionBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LSrtToByteFunction build() {
		...
		final LSrtToByteFunction eventuallyFinal = this.eventually;
	...
	public final LSrtToByteFunction build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
