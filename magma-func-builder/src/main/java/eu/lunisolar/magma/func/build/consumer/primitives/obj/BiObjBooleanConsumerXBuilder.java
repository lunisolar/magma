...
public final class BiObjBooleanConsumerXBuilder<T1, T2, X extends Exception> extends PerCaseBuilder.Base<BiObjBooleanConsumerXBuilder<T1, T2, X>, BiObjBooleanPredicateX<T1, T2, X>, BiObjBooleanConsumerX<T1, T2, X>> {
