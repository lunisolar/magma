...
public final class LLongToDoubleFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithDoubleProduct.Base<LLongToDoubleFunctionXBuilder<X>, LLongPredicateX<X>, LLongToDoubleFunctionX<X>> {
	...
	public static final LLongToDoubleFunctionX EVENTUALLY_THROW = LLongToDoubleFunctionX.lX((long a1) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", a1, LLongToDoubleFunctionX.DESCRIPTION);
