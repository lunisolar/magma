...
public final class LToDoubleBiFunctionBuilder<T1, T2> extends PerCaseBuilderWithDoubleProduct.Base<LToDoubleBiFunctionBuilder<T1, T2>, LBiPredicate<T1, T2>, LToDoubleBiFunction<T1, T2>> {
	...
	public static final LToDoubleBiFunction EVENTUALLY_THROW = LToDoubleBiFunction.l((a1, a2) -> {
	...
	@Nonnull
	public static <T1, T2> LToDoubleBiFunction<T1, T2> toDoubleBiFunctionFrom(Function<LToDoubleBiFunctionBuilder<T1, T2>, LToDoubleBiFunction<T1, T2>> buildingFunction) {
		return buildingFunction.apply(new LToDoubleBiFunctionBuilder());
	}
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LToDoubleBiFunctionBuilder<T1, T2> casesOf(Class<V1> argC1, Class<V2> argC2, Consumer<LToDoubleBiFunctionBuilder<V1, V2>> pcpConsumer) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LToDoubleBiFunctionBuilder<T1, T2> aCase(Class<V1> argC1, Class<V2> argC2, LToDoubleBiFunction<V1, V2> function) {
		PartialCaseWithDoubleProduct.The pc = partialCaseFactoryMethod((a1, a2) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LToDoubleBiFunction<T1, T2> build() {
		...
		retval = LToDoubleBiFunction.<T1, T2> l((a1, a2) -> {
			try {
