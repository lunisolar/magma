...
public final class StdLongConsumerBuilder extends PerCaseBuilder.Base<StdLongConsumerBuilder, LLongPredicate, java.util.function.LongConsumer> {
	...
	public StdLongConsumerBuilder(@Nullable Consumer<java.util.function.LongConsumer> consumer) {
	...
	public StdLongConsumerBuilder() {
		this(null);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final StdLongConsumerBuilder stdLongConsumer() {
		return new StdLongConsumerBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final StdLongConsumerBuilder stdLongConsumer(Consumer<java.util.function.LongConsumer> consumer) {
		return new StdLongConsumerBuilder(consumer);
	}
