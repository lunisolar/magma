...
public final class LBiObjDblConsumerBuilder<T1, T2> extends PerCaseBuilder.Base<LBiObjDblConsumerBuilder<T1, T2>, LBiObjDblPredicate<T1, T2>, LBiObjDblConsumer<T1, T2>> {
	...
	public static final LBiObjDblConsumer EVENTUALLY_THROW = LBiObjDblConsumer.biObjDblCons((a1, a2, a3) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LBiObjDblConsumerBuilder(@Nullable Consumer<LBiObjDblConsumer<T1, T2>> consumer) {
		super(EVENTUALLY_THROW, () -> new LBiObjDblConsumerBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LBiObjDblConsumerBuilder<T1, T2> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjDblConsumerBuilder<T1, T2> aCase(Class<V1> argC1, Class<V2> argC2, LBiObjDblConsumer<V1, V2> function) {
		PartialCase.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LBiObjDblConsumer<T1, T2> build() {
		...
		final LBiObjDblConsumer<T1, T2> eventuallyFinal = this.eventually;
	...
	public final LBiObjDblConsumer<T1, T2> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
