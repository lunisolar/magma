...
public final class BooleanToShortFunctionXBuilder<X extends Exception> extends PerCaseBuilderWithShortProduct<BooleanToShortFunctionXBuilder<X>, BooleanUnaryOperatorX<X>, BooleanToShortFunctionX<X>> {
