...
public final class LBiObjCharFunctionXBuilder<T1, T2, R, X extends Throwable> extends PerCaseBuilderWithProduct.Base<LBiObjCharFunctionXBuilder<T1, T2, R, X>, LBiObjCharPredicateX<T1, T2, X>, LBiObjCharFunctionX<T1, T2, R, X>, R> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T1, T2, R, X extends Throwable> LBiObjCharFunctionXBuilder<T1, T2, R, X> biObjCharFunctionX() {
		return new LBiObjCharFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T1, T2, R, X extends Throwable> LBiObjCharFunctionXBuilder<T1, T2, R, X> biObjCharFunctionX(Consumer<LBiObjCharFunctionX<T1, T2, R, X>> consumer) {
