...
public final class LBoolToLongFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithLongProduct.Base<LBoolToLongFunctionXBuilder<X>, LLogicalOperatorX<X>, LBoolToLongFunctionX<X>> {
	...
	@Nonnull
	public static <X extends Throwable> LBoolToLongFunctionX<X> boolToLongFunctionXFrom(Function<LBoolToLongFunctionXBuilder<X>, LBoolToLongFunctionX<X>> buildingFunction) {
		return buildingFunction.apply(new LBoolToLongFunctionXBuilder());
	}
