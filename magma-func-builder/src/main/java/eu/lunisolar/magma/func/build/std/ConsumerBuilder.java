...
public final class ConsumerBuilder<T> extends PerCaseBuilder.Base<ConsumerBuilder<T>, LPredicate<T>, Consumer<T>> {
	...
	public static final Consumer OTHERWISE_THROW = Function4U.cons(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public ConsumerBuilder(@Nullable Consumer<Consumer<T>> consumer) {
		super(OTHERWISE_THROW, () -> new ConsumerBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <T> ConsumerBuilder<T> consumer() {
		return new ConsumerBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static <T> Consumer<T> consumerFrom(Consumer<ConsumerBuilder<T>> buildingFunction) {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final ConsumerBuilder<T> withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	@Nonnull
	public <V extends T> ConsumerBuilder<T> casesOf(Class<V> argC, Consumer<ConsumerBuilder<V>> pcpConsumer) {
	...
	@Nonnull
	public <V extends T> ConsumerBuilder<T> aCase(Class<V> argC, Consumer<V> function) {
		PartialCase.The pc = partialCaseFactoryMethod(a -> (argC == null || argC.isInstance(a)));
	...
	public final Consumer<T> build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
