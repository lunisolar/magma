...
/** Builder for DoubleToFloatFunction. */
public final class DoubleToFloatFunctionBuilder extends PerCaseBuilderWithFloatProduct.Base<DoubleToFloatFunctionBuilder, DoublePredicate, DoubleToFloatFunction> {
	...
	public DoubleToFloatFunctionBuilder(@Nullable Consumer<DoubleToFloatFunction> consumer) {
		super(EVENTUALLY_THROW, DoubleToFloatFunction::constant);
