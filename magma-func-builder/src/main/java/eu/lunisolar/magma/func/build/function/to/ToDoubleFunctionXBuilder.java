...
public final class ToDoubleFunctionXBuilder<T, X extends Exception> extends PerCaseBuilderWithDoubleProduct<ToDoubleFunctionXBuilder<T, X>, PredicateX<T, X>, ToDoubleFunctionX<T, X>> {
