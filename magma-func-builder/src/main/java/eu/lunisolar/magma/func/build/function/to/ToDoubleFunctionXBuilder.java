...
public final class ToDoubleFunctionXBuilder<T, X extends Exception> extends PerCaseBuilder<ToDoubleFunctionXBuilder<T, X>, PredicateX<T, X>, ToDoubleFunctionX<T, X>> {
