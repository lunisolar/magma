...
public final class LObjFloatPredicateBuilder<T> extends PerCaseBuilderWithBoolProduct.Base<LObjFloatPredicateBuilder<T>, LObjFloatPredicate<T>, LObjFloatPredicate<T>> {
	...
	public static final LObjFloatPredicate EVENTUALLY_THROW = LObjFloatPredicate.l((a1, a2) -> {
	...
	@Nonnull
	public static <T> LObjFloatPredicate<T> objFloatPredicateFrom(Function<LObjFloatPredicateBuilder<T>, LObjFloatPredicate<T>> buildingFunction) {
		return buildingFunction.apply(new LObjFloatPredicateBuilder());
	}
	...
	@Nonnull
	public <V extends T> LObjFloatPredicateBuilder<T> casesOf(Class<V> argC1, Consumer<LObjFloatPredicateBuilder<V>> pcpConsumer) {
	...
	@Nonnull
	public <V extends T> LObjFloatPredicateBuilder<T> aCase(Class<V> argC1, LObjFloatPredicate<V> function) {
		PartialCaseWithBoolProduct.The pc = partialCaseFactoryMethod((a1, a2) -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LObjFloatPredicate<T> build() {
		...
		retval = LObjFloatPredicate.<T> l((a1, a2) -> {
			try {
