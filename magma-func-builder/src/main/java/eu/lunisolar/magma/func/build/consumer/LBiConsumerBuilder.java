...
public final class LBiConsumerBuilder<T1, T2> extends PerCaseBuilder.Base<LBiConsumerBuilder<T1, T2>, LBiPredicate<T1, T2>, LBiConsumer<T1, T2>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T1, T2> LBiConsumerBuilder<T1, T2> biConsumer() {
		return new LBiConsumerBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T1, T2> LBiConsumerBuilder<T1, T2> biConsumer(Consumer<LBiConsumer<T1, T2>> consumer) {
