...
public final class LBiConsumerBuilder<T1, T2> extends PerCaseBuilder.Base<LBiConsumerBuilder<T1, T2>, LBiPredicate<T1, T2>, LBiConsumer<T1, T2>> {
	...
	public static final LBiConsumer EVENTUALLY_THROW = LBiConsumer.l((Object a1, Object a2) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s  as function %s.", a1, a2, LBiConsumer.DESCRIPTION);
	...
	public LBiConsumerBuilder(@Nullable Consumer<LBiConsumer<T1, T2>> consumer) {
		super(EVENTUALLY_THROW, () -> new LBiConsumerBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LBiConsumerBuilder<T1, T2> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2> LBiConsumerBuilder<T1, T2> casesOf(Class<E1> argC1, Class<E2> argC2, Consumer<LBiConsumerBuilder<E1, E2>> pcpConsumer) {
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2> LBiConsumerBuilder<T1, T2> aCase(Class<E1> argC1, Class<E2> argC2, LBiConsumer<E1, E2> function) {
		PartialCase.The pc = partialCaseFactoryMethod((T1 a1, T2 a2) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LBiConsumer<T1, T2> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
