...
public final class LBiConsumerBuilder<T1, T2> extends PerCaseBuilder.Base<LBiConsumerBuilder<T1, T2>, LBiPredicate<T1, T2>, LBiConsumer<T1, T2>> {
	...
	public static final LBiConsumer EVENTUALLY_THROW = LBiConsumer.l((a1, a2) -> {
	...
	@Nonnull
	public static <T1, T2> LBiConsumer<T1, T2> biConsumerFrom(Function<LBiConsumerBuilder<T1, T2>, LBiConsumer<T1, T2>> buildingFunction) {
		return buildingFunction.apply(new LBiConsumerBuilder());
	}
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiConsumerBuilder<T1, T2> aCase(Class<V1> argC1, Class<V2> argC2, LBiConsumer<V1, V2> function) {
		PartialCase.The pc = partialCaseFactoryMethod((a1, a2) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LBiConsumer<T1, T2> build() {
		...
		retval = LBiConsumer.<T1, T2> l((a1, a2) -> {
			try {
