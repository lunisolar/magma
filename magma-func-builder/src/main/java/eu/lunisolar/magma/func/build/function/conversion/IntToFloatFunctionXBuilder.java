...
public final class IntToFloatFunctionXBuilder<X extends Exception> extends PerCaseBuilderWithFloatProduct.Base<IntToFloatFunctionXBuilder<X>, IntPredicateX<X>, IntToFloatFunctionX<X>> {
