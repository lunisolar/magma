...
public final class IntToFloatFunctionXBuilder<X extends Exception> extends PerCaseBuilder<IntToFloatFunctionXBuilder<X>, IntPredicateX<X>, IntToFloatFunctionX<X>> {
