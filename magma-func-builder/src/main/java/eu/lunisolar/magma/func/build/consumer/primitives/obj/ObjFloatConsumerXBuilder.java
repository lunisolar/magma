...
public final class ObjFloatConsumerXBuilder<T, X extends Exception> extends PerCaseBuilder.Base<ObjFloatConsumerXBuilder<T, X>, ObjFloatPredicateX<T, X>, ObjFloatConsumerX<T, X>> {
