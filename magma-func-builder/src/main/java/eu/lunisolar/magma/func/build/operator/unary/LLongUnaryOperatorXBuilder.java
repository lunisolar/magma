...
public final class LLongUnaryOperatorXBuilder<X extends Throwable> extends PerCaseBuilderWithLongProduct.Base<LLongUnaryOperatorXBuilder<X>, LLongPredicateX<X>, LLongUnaryOperatorX<X>> {
	...
	public static final LLongUnaryOperatorX EVENTUALLY_THROW = LLongUnaryOperatorX.lX(a -> {
	...
	@Nonnull
	public static <X extends Throwable> LLongUnaryOperatorXBuilder<X> longUnaryOperatorX(Consumer<LLongUnaryOperatorX<X>> consumer) {
		return new LLongUnaryOperatorXBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LLongUnaryOperatorXBuilder<X> withHandling(@Nonnull HandlingInstructions<X, X> handling) {
	...
	public final LLongUnaryOperatorX<X> build() {
		...
		retval = LLongUnaryOperatorX.<X> lX(a -> {
			try {
	...
	public final LLongUnaryOperatorX<X> build(@Nonnull HandlingInstructions<X, X> handling) {
