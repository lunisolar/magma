...
public final class LBooleanConsumerBuilder extends PerCaseBuilder.Base<LBooleanConsumerBuilder, LBooleanUnaryOperator, LBooleanConsumer> {
	...
	public static final LBooleanConsumer EVENTUALLY_THROW = LBooleanConsumer.l((boolean b) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", b, LBooleanConsumer.DESCRIPTION);
	...
	public LBooleanConsumerBuilder() {
		this(null);
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LBooleanConsumerBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	@Nonnull
	public final LBooleanConsumer build() {

		final LBooleanConsumer eventuallyFinal = this.eventually;
	...
	public final LBooleanConsumer build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
