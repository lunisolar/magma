...
public final class LDblPredicateBuilder extends PerCaseBuilderWithBoolProduct.Base<LDblPredicateBuilder, LDblPredicate, LDblPredicate> {
	...
	public static final LDblPredicate EVENTUALLY_THROW = LDblPredicate.dblPred(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LDblPredicateBuilder(@Nullable Consumer<LDblPredicate> consumer) {
		super(EVENTUALLY_THROW, LDblPredicate::constant, () -> new LDblPredicateBuilder(null));
	...
	@Nonnull
	public static LDblPredicate dblPredicateFrom(Function<LDblPredicateBuilder, LDblPredicate> buildingFunction) {
		return buildingFunction.apply(new LDblPredicateBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LDblPredicateBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LDblPredicate build() {
		...
		final LDblPredicate eventuallyFinal = this.eventually;
	...
	public final LDblPredicate build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
