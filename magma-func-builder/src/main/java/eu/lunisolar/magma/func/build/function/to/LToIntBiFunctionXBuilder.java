...
public final class LToIntBiFunctionXBuilder<T1, T2, X extends Throwable> extends PerCaseBuilderWithIntProduct.Base<LToIntBiFunctionXBuilder<T1, T2, X>, LBiPredicateX<T1, T2, X>, LToIntBiFunctionX<T1, T2, X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T1, T2, X extends Throwable> LToIntBiFunctionXBuilder<T1, T2, X> toIntBiFunctionX() {
		return new LToIntBiFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T1, T2, X extends Throwable> LToIntBiFunctionXBuilder<T1, T2, X> toIntBiFunctionX(Consumer<LToIntBiFunctionX<T1, T2, X>> consumer) {
