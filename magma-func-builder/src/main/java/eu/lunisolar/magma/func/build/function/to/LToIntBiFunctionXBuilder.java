...
public final class LToIntBiFunctionXBuilder<T1, T2, X extends Throwable> extends PerCaseBuilderWithIntProduct.Base<LToIntBiFunctionXBuilder<T1, T2, X>, LBiPredicateX<T1, T2, X>, LToIntBiFunctionX<T1, T2, X>> {
	...
	public static final LToIntBiFunctionX EVENTUALLY_THROW = LToIntBiFunctionX.lX((a1, a2) -> {
	...
	@Nonnull
	public static <T1, T2, X extends Throwable> LToIntBiFunctionX<T1, T2, X> toIntBiFunctionXFrom(Function<LToIntBiFunctionXBuilder<T1, T2, X>, LToIntBiFunctionX<T1, T2, X>> buildingFunction) {
		return buildingFunction.apply(new LToIntBiFunctionXBuilder());
	}
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LToIntBiFunctionXBuilder<T1, T2, X> casesOf(Class<V1> argC1, Class<V2> argC2, Consumer<LToIntBiFunctionXBuilder<V1, V2, X>> pcpConsumer) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LToIntBiFunctionXBuilder<T1, T2, X> aCase(Class<V1> argC1, Class<V2> argC2, LToIntBiFunctionX<V1, V2, X> function) {
		PartialCaseWithIntProduct.The pc = partialCaseFactoryMethod((a1, a2) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LToIntBiFunctionX<T1, T2, X> build() {
		...
		retval = LToIntBiFunctionX.<T1, T2, X> lX((a1, a2) -> {
			try {
