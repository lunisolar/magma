...
@Immutable
@ThreadSafe
public class PartialCaseWithCharProduct<SELF extends PartialCaseWithCharProduct<SELF, PCB, P, F>, PCB extends PerCaseBuilderWithCharProduct<PCB, P, F, SELF>, P, F> extends PartialCase<SELF, PCB, P, F> {
