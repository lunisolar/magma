...
@Immutable
@ThreadSafe
public class PartialCaseWithCharProduct<SELF extends PartialCaseWithCharProduct<SELF, PCB, P, F>, PCB extends PerCaseBuilderWithCharProduct<PCB, P, F, SELF>, P extends MetaFunctionalInterface, F extends MetaFunctionalInterface>
		extends
			PartialCase<SELF, PCB, P, F> {

	public PartialCaseWithCharProduct(@Nonnull PCB superContext, @Nonnull P casePredicate, @Nonnull Supplier<PCB> subCasesFactory) {
	...
	public static final class The<PCB extends PerCaseBuilderWithCharProduct<PCB, P, F, The<PCB, P, F>>, P extends MetaFunctionalInterface, F extends MetaFunctionalInterface> extends PartialCaseWithCharProduct<The<PCB, P, F>, PCB, P, F> {
