...
public final class LLongToIntFunctionBuilder extends PerCaseBuilderWithIntProduct.Base<LLongToIntFunctionBuilder, LLongPredicate, LLongToIntFunction> {
	...
	public static final LLongToIntFunction OTHERWISE_THROW = LLongToIntFunction.longToIntFunc(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LLongToIntFunctionBuilder(@Nullable Consumer<LLongToIntFunction> consumer) {
		super(OTHERWISE_THROW, LLongToIntFunction::constant, () -> new LLongToIntFunctionBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static LLongToIntFunctionBuilder longToIntFunction() {
	...
	@Nonnull
	public static LLongToIntFunctionBuilder longToIntFunction(Consumer<LLongToIntFunction> consumer) {
		return new LLongToIntFunctionBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LLongToIntFunctionBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public LLongToIntFunctionBuilder forValue(long v, LLongToIntFunction function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithIntProduct.The<LLongToIntFunctionBuilder, LLongPredicate, LLongToIntFunction> forValue(long v) {
	...
	public final LLongToIntFunction build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
