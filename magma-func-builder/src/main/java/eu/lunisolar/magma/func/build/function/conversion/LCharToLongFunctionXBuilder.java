...
public final class LCharToLongFunctionXBuilder<X extends Exception> extends PerCaseBuilderWithLongProduct.Base<LCharToLongFunctionXBuilder<X>, LCharPredicateX<X>, LCharToLongFunctionX<X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Exception> LCharToLongFunctionXBuilder<X> charToLongFunctionX() {
		return new LCharToLongFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Exception> LCharToLongFunctionXBuilder<X> charToLongFunctionX(Consumer<LCharToLongFunctionX<X>> consumer) {
	...
	public final LCharToLongFunctionX<X> build() {
		...
		if (cases.isEmpty()) {
			...
			retval = LCharToLongFunctionX.lX((char c) -> {
