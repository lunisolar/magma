...
public final class LCharToLongFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithLongProduct.Base<LCharToLongFunctionXBuilder<X>, LCharPredicateX<X>, LCharToLongFunctionX<X>> {
	...
	public static final LCharToLongFunctionX EVENTUALLY_THROW = LCharToLongFunctionX.lX(a1 -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LCharToLongFunctionXBuilder(@Nullable Consumer<LCharToLongFunctionX<X>> consumer) {
		super(EVENTUALLY_THROW, LCharToLongFunctionX::constant, () -> new LCharToLongFunctionXBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <X extends Throwable> LCharToLongFunctionXBuilder<X> charToLongFunctionX() {
		return new LCharToLongFunctionXBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static <X extends Throwable> LCharToLongFunctionX<X> charToLongFunctionXFrom(Function<LCharToLongFunctionXBuilder<X>, LCharToLongFunctionX<X>> buildingFunction) {
		return buildingFunction.apply(new LCharToLongFunctionXBuilder());
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <X extends Throwable> LCharToLongFunctionXBuilder<X> charToLongFunctionX(Consumer<LCharToLongFunctionX<X>> consumer) {
	...
	public final LCharToLongFunctionX<X> build() {
		...
		retval = LCharToLongFunctionX.<X> lX(a1 -> {
			try {
