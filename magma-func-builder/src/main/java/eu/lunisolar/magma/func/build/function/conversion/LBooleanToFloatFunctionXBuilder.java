...
public final class LBooleanToFloatFunctionXBuilder<X extends Exception> extends PerCaseBuilderWithFloatProduct.Base<LBooleanToFloatFunctionXBuilder<X>, LBooleanUnaryOperatorX<X>, LBooleanToFloatFunctionX<X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Exception> LBooleanToFloatFunctionXBuilder<X> booleanToFloatFunctionX() {
		return new LBooleanToFloatFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Exception> LBooleanToFloatFunctionXBuilder<X> booleanToFloatFunctionX(Consumer<LBooleanToFloatFunctionX<X>> consumer) {
