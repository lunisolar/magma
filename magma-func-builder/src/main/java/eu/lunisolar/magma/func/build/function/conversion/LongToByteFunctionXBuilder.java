...
public final class LongToByteFunctionXBuilder<X extends Exception> extends PerCaseBuilder<LongToByteFunctionXBuilder<X>, LongPredicateX<X>, LongToByteFunctionX<X>> {
