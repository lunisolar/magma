...
public final class LongToByteFunctionXBuilder<X extends Exception> extends PerCaseBuilderWithByteProduct<LongToByteFunctionXBuilder<X>, LongPredicateX<X>, LongToByteFunctionX<X>> {
