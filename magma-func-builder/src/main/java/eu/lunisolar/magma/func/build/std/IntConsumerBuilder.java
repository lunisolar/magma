...
public final class IntConsumerBuilder extends PerCaseBuilder.Base<IntConsumerBuilder, LIntPredicate, java.util.function.IntConsumer> {
	...
	public IntConsumerBuilder(@Nullable Consumer<java.util.function.IntConsumer> consumer) {
	...
	@Nonnull
	public static IntConsumerBuilder intConsumer(Consumer<java.util.function.IntConsumer> consumer) {
	...
	public final java.util.function.IntConsumer build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
