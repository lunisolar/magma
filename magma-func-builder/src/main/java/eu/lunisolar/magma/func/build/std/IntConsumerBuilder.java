...
public final class IntConsumerBuilder extends PerCaseBuilder.Base<IntConsumerBuilder, LIntPredicate, IntConsumer> {
	...
	public static final IntConsumer OTHERWISE_THROW = Function4U.intCons(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public IntConsumerBuilder(@Nullable Consumer<IntConsumer> consumer) {
		super(OTHERWISE_THROW, () -> new IntConsumerBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final IntConsumerBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public final IntConsumer build() {
		...
		final IntConsumer otherwiseFinal = this.otherwise;
	...
	public final IntConsumer build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
