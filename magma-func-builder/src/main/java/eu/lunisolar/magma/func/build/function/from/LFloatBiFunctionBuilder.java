...
public final class LFloatBiFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LFloatBiFunctionBuilder<R>, LBiFloatPredicate, LFloatBiFunction<R>, R> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LFloatBiFunctionBuilder<R> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LFloatBiFunction<R> build() {
		...
		retval = LFloatBiFunction.<R> l((float f1, float f2) -> {
			try {
	...
	public final LFloatBiFunction<R> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
