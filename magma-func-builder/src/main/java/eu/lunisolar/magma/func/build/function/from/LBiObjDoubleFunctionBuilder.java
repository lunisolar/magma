...
public final class LBiObjDoubleFunctionBuilder<T1, T2, R> extends PerCaseBuilderWithProduct.Base<LBiObjDoubleFunctionBuilder<T1, T2, R>, LBiObjDoublePredicate<T1, T2>, LBiObjDoubleFunction<T1, T2, R>, R> {
	...
	public static final LBiObjDoubleFunction EVENTUALLY_THROW = LBiObjDoubleFunction.l((Object a1, Object a2, double a3) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s ,%s  as function %s.", a1, a2, a3, LBiObjDoubleFunction.DESCRIPTION);
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2> LBiObjDoubleFunctionBuilder<T1, T2, R> casesOf(Class<E1> argC1, Class<E2> argC2, Consumer<LBiObjDoubleFunctionBuilder<E1, E2, R>> pcpConsumer) {
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2> LBiObjDoubleFunctionBuilder<T1, T2, R> aCase(Class<E1> argC1, Class<E2> argC2, LBiObjDoubleFunction<E1, E2, R> function) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod((T1 a1, T2 a2, double a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LBiObjDoubleFunction<T1, T2, R> build() {
		...
		retval = LBiObjDoubleFunction.<T1, T2, R> l((T1 a1, T2 a2, double a3) -> {
			try {
