...
public final class StdIntBinaryOperatorBuilder extends PerCaseBuilderWithIntProduct<StdIntBinaryOperatorBuilder, BiIntPredicate, java.util.function.IntBinaryOperator> {
	...
	public StdIntBinaryOperatorBuilder() {
		this(null);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final StdIntBinaryOperatorBuilder stdIntBinaryOperator() {
		return new StdIntBinaryOperatorBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final StdIntBinaryOperatorBuilder stdIntBinaryOperator(Consumer<java.util.function.IntBinaryOperator> consumer) {
		return new StdIntBinaryOperatorBuilder(consumer);
	}
