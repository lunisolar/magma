...
public final class BiObjCharPredicateXBuilder<T1, T2, X extends Exception> extends PerCaseBuilder<BiObjCharPredicateXBuilder<T1, T2, X>, BiObjCharPredicateX<T1, T2, X>, BiObjCharPredicateX<T1, T2, X>> {
