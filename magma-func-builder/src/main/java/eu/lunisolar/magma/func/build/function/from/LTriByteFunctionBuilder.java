...
public final class LTriByteFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LTriByteFunctionBuilder<R>, LTriBytePredicate, LTriByteFunction<R>, R> {
	...
	public LTriByteFunctionBuilder<R> forValue(byte v1, byte v2, byte v3, LTriByteFunction<R> function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithProduct.The<LTriByteFunctionBuilder<R>, LTriBytePredicate, LTriByteFunction<R>, R> forValue(byte v1, byte v2, byte v3) {
