...
public final class TriFunctionBuilder<T1, T2, T3, R> extends PerCaseBuilderWithProduct.Base<TriFunctionBuilder<T1, T2, T3, R>, TriPredicate<T1, T2, T3>, TriFunction<T1, T2, T3, R>, R> {
