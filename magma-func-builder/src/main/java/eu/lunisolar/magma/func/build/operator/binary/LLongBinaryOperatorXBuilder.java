...
public final class LLongBinaryOperatorXBuilder<X extends Exception> extends PerCaseBuilderWithLongProduct.Base<LLongBinaryOperatorXBuilder<X>, LBiLongPredicateX<X>, LLongBinaryOperatorX<X>> {

	private Consumer<LLongBinaryOperatorX<X>> consumer;

	public static final LLongBinaryOperatorX EVENTUALLY_THROW = LLongBinaryOperatorX.lX((long l1, long l2) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s  as function %s.", l1, l2, LLongBinaryOperatorX.DESCRIPTION);
	...
	public LLongBinaryOperatorXBuilder(@Nullable Consumer<LLongBinaryOperatorX<X>> consumer) {
		super(EVENTUALLY_THROW, LLongBinaryOperatorX::constant);
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Exception> LLongBinaryOperatorXBuilder<X> longBinaryOperatorX() {
		return new LLongBinaryOperatorXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Exception> LLongBinaryOperatorXBuilder<X> longBinaryOperatorX(Consumer<LLongBinaryOperatorX<X>> consumer) {
