...
public final class LLongBinaryOperatorXBuilder<X extends Throwable> extends PerCaseBuilderWithLongProduct.Base<LLongBinaryOperatorXBuilder<X>, LBiLongPredicateX<X>, LLongBinaryOperatorX<X>> {
	...
	public static final LLongBinaryOperatorX EVENTUALLY_THROW = LLongBinaryOperatorX.lX((a1, a2) -> {
	...
	@Nonnull
	public static <X extends Throwable> LLongBinaryOperatorX<X> longBinaryOperatorXFrom(Function<LLongBinaryOperatorXBuilder<X>, LLongBinaryOperatorX<X>> buildingFunction) {
		return buildingFunction.apply(new LLongBinaryOperatorXBuilder());
	}
	...
	public final LLongBinaryOperatorX<X> build() {
		...
		retval = LLongBinaryOperatorX.<X> lX((a1, a2) -> {
			try {
