...
public final class LObjShortFunctionXBuilder<T, R, X extends Throwable> extends PerCaseBuilderWithProduct.Base<LObjShortFunctionXBuilder<T, R, X>, LObjShortPredicateX<T, X>, LObjShortFunctionX<T, R, X>, R> {
	...
	public static final LObjShortFunctionX EVENTUALLY_THROW = LObjShortFunctionX.lX((a1, a2) -> {
	...
	@Nonnull
	public static <T, R, X extends Throwable> LObjShortFunctionX<T, R, X> objShortFunctionXFrom(Function<LObjShortFunctionXBuilder<T, R, X>, LObjShortFunctionX<T, R, X>> buildingFunction) {
		return buildingFunction.apply(new LObjShortFunctionXBuilder());
	}
	...
	@Nonnull
	public <V extends T> LObjShortFunctionXBuilder<T, R, X> casesOf(Class<V> argC1, Consumer<LObjShortFunctionXBuilder<V, R, X>> pcpConsumer) {
	...
	@Nonnull
	public <V extends T> LObjShortFunctionXBuilder<T, R, X> aCase(Class<V> argC1, LObjShortFunctionX<V, R, X> function) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod((a1, a2) -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LObjShortFunctionX<T, R, X> build() {
		...
		retval = LObjShortFunctionX.<T, R, X> lX((a1, a2) -> {
			try {
