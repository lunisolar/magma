...
public final class BiObjDoubleConsumerXBuilder<T1, T2, X extends Exception> extends PerCaseBuilder.Base<BiObjDoubleConsumerXBuilder<T1, T2, X>, BiObjDoublePredicateX<T1, T2, X>, BiObjDoubleConsumerX<T1, T2, X>> {
