...
public final class LBooleanBiConsumerXBuilder<X extends Throwable> extends PerCaseBuilder.Base<LBooleanBiConsumerXBuilder<X>, LLogicalBinaryOperatorX<X>, LBooleanBiConsumerX<X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Throwable> LBooleanBiConsumerXBuilder<X> booleanBiConsumerX() {
		return new LBooleanBiConsumerXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Throwable> LBooleanBiConsumerXBuilder<X> booleanBiConsumerX(Consumer<LBooleanBiConsumerX<X>> consumer) {
		return new LBooleanBiConsumerXBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LBooleanBiConsumerXBuilder<X> withHandling(@Nonnull HandlingInstructions<X, X> handling) {
	...
	public final LBooleanBiConsumerX<X> build() {
		...
		final Case<LLogicalBinaryOperatorX<X>, LBooleanBiConsumerX<X>>[] casesArray = cases.toArray(new Case[cases.size()]);
		retval = LBooleanBiConsumerX.<X> lX((boolean b1, boolean b2) -> {
			try {
				for (Case<LLogicalBinaryOperatorX<X>, LBooleanBiConsumerX<X>> aCase : casesArray) {
	...
	public final LBooleanBiConsumerX<X> build(@Nonnull HandlingInstructions<X, X> handling) {
