...
public final class PredicateBuilder<T> extends PerCaseBuilderWithBoolProduct.Base<PredicateBuilder<T>, LPredicate<T>, Predicate<T>> {
	...
	public static final Predicate OTHERWISE_THROW = Function4U.pred(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public PredicateBuilder(@Nullable Consumer<Predicate<T>> consumer) {
		super(OTHERWISE_THROW, LPredicate::constant, () -> new PredicateBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final PredicateBuilder<T> withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public final Predicate<T> build() {
		...
		final Predicate<T> otherwiseFinal = this.otherwise;
	...
	public final Predicate<T> build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
