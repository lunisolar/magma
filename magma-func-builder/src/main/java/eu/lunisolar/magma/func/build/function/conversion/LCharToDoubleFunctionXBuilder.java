...
public final class LCharToDoubleFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithDoubleProduct.Base<LCharToDoubleFunctionXBuilder<X>, LCharPredicateX<X>, LCharToDoubleFunctionX<X>> {
	...
	public static final LCharToDoubleFunctionX EVENTUALLY_THROW = LCharToDoubleFunctionX.lX((char a1) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", a1, LCharToDoubleFunctionX.DESCRIPTION);
