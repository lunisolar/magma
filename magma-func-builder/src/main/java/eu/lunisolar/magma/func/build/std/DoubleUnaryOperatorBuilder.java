...
public final class DoubleUnaryOperatorBuilder extends PerCaseBuilderWithDblProduct.Base<DoubleUnaryOperatorBuilder, LDblPredicate, DoubleUnaryOperator> {
	...
	public static final DoubleUnaryOperator OTHERWISE_THROW = Function4U.dblUnaryOp(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public DoubleUnaryOperatorBuilder(@Nullable Consumer<DoubleUnaryOperator> consumer) {
		super(OTHERWISE_THROW, LDblUnaryOperator::constant, () -> new DoubleUnaryOperatorBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final DoubleUnaryOperatorBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public final DoubleUnaryOperator build() {
		...
		final DoubleUnaryOperator otherwiseFinal = this.otherwise;
	...
	public final DoubleUnaryOperator build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
