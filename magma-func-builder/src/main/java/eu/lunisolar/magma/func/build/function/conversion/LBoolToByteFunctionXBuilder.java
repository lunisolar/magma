...
public final class LBoolToByteFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithByteProduct.Base<LBoolToByteFunctionXBuilder<X>, LLogicalOperatorX<X>, LBoolToByteFunctionX<X>> {
	...
	@Nonnull
	public static <X extends Throwable> LBoolToByteFunctionX<X> boolToByteFunctionXFrom(Function<LBoolToByteFunctionXBuilder<X>, LBoolToByteFunctionX<X>> buildingFunction) {
		return buildingFunction.apply(new LBoolToByteFunctionXBuilder());
	}
