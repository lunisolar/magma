...
public final class ObjDoubleConsumerBuilder<T> extends PerCaseBuilder.Base<ObjDoubleConsumerBuilder<T>, LObjDblPredicate<T>, ObjDoubleConsumer<T>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final ObjDoubleConsumerBuilder<T> withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public final ObjDoubleConsumer<T> build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
