...
public final class LTriConsumerBuilder<T1, T2, T3> extends PerCaseBuilder.Base<LTriConsumerBuilder<T1, T2, T3>, LTriPredicate<T1, T2, T3>, LTriConsumer<T1, T2, T3>> {
	...
	public static final LTriConsumer EVENTUALLY_THROW = LTriConsumer.l((a1, a2, a3) -> {
	...
	@Nonnull
	public static <T1, T2, T3> LTriConsumer<T1, T2, T3> triConsumerFrom(Function<LTriConsumerBuilder<T1, T2, T3>, LTriConsumer<T1, T2, T3>> buildingFunction) {
		return buildingFunction.apply(new LTriConsumerBuilder());
	}
	...
	public final LTriConsumer<T1, T2, T3> build() {
		...
		retval = LTriConsumer.<T1, T2, T3> l((a1, a2, a3) -> {
			try {
