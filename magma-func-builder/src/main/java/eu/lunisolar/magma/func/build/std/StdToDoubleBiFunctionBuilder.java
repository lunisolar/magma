...
public final class StdToDoubleBiFunctionBuilder<T1, T2> extends PerCaseBuilderWithDoubleProduct.Base<StdToDoubleBiFunctionBuilder<T1, T2>, LBiPredicate<T1, T2>, java.util.function.ToDoubleBiFunction<T1, T2>> {
