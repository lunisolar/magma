...
public final class SupplierXBuilder<R, X extends Exception> extends PerCaseBuilderWithProduct.Base<SupplierXBuilder<R, X>, BooleanSupplierX<X>, SupplierX<R, X>, R> {
