...
public final class LDoubleUnaryOperatorBuilder extends PerCaseBuilderWithDoubleProduct.Base<LDoubleUnaryOperatorBuilder, LDoublePredicate, LDoubleUnaryOperator> {
	...
	public static final LDoubleUnaryOperator EVENTUALLY_THROW = LDoubleUnaryOperator.l(a1 -> {
	...
	@Nonnull
	public static LDoubleUnaryOperator doubleUnaryOperatorFrom(Function<LDoubleUnaryOperatorBuilder, LDoubleUnaryOperator> buildingFunction) {
		return buildingFunction.apply(new LDoubleUnaryOperatorBuilder());
	}
	...
	public final LDoubleUnaryOperator build() {
		...
		retval = LDoubleUnaryOperator.l(a1 -> {
			try {
