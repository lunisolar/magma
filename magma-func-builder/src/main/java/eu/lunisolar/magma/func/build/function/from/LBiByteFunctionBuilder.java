...
public final class LBiByteFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LBiByteFunctionBuilder<R>, LBiBytePredicate, LBiByteFunction<R>, R> {
	...
	public LBiByteFunctionBuilder<R> forValue(byte v1, byte v2, LBiByteFunction<R> function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithProduct.The<LBiByteFunctionBuilder<R>, LBiBytePredicate, LBiByteFunction<R>, R> forValue(byte v1, byte v2) {
