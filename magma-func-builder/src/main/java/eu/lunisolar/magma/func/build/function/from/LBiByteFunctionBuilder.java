...
public final class LBiByteFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LBiByteFunctionBuilder<R>, LBiBytePredicate, LBiByteFunction<R>, R> {
	...
	public static final LBiByteFunction EVENTUALLY_THROW = LBiByteFunction.l((a1, a2) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LBiByteFunctionBuilder(@Nullable Consumer<LBiByteFunction<R>> consumer) {
		super(EVENTUALLY_THROW, LBiByteFunction::constant, () -> new LBiByteFunctionBuilder(null));
	...
	@Nonnull
	public static <R> LBiByteFunction<R> biByteFunctionFrom(Function<LBiByteFunctionBuilder<R>, LBiByteFunction<R>> buildingFunction) {
		return buildingFunction.apply(new LBiByteFunctionBuilder());
	}
	...
	public final LBiByteFunction<R> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
