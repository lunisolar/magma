...
public final class LBiByteFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LBiByteFunctionBuilder<R>, LBiBytePredicate, LBiByteFunction<R>, R> {
	...
	public static final LBiByteFunction EVENTUALLY_THROW = LBiByteFunction.l((byte a1, byte a2) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s  as function %s.", a1, a2, LBiByteFunction.DESCRIPTION);
	...
	public final LBiByteFunction<R> build() {
		...
		retval = LBiByteFunction.<R> l((byte a1, byte a2) -> {
			try {
