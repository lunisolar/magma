...
public final class LBiShortConsumerXBuilder<X extends Throwable> extends PerCaseBuilder.Base<LBiShortConsumerXBuilder<X>, LBiShortPredicateX<X>, LBiShortConsumerX<X>> {
	...
	public static final LBiShortConsumerX EVENTUALLY_THROW = LBiShortConsumerX.lX((a1, a2) -> {
	...
	@Nonnull
	public static <X extends Throwable> LBiShortConsumerX<X> biShortConsumerXFrom(Function<LBiShortConsumerXBuilder<X>, LBiShortConsumerX<X>> buildingFunction) {
		return buildingFunction.apply(new LBiShortConsumerXBuilder());
	}
	...
	public final LBiShortConsumerX<X> build() {
		...
		retval = LBiShortConsumerX.<X> lX((a1, a2) -> {
			try {
