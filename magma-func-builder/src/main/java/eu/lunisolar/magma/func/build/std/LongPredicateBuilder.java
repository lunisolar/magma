 ...
 */
public final class LongPredicateBuilder extends PerCaseBuilderWithBoolProduct.Base<LongPredicateBuilder, LLongPredicate, LongPredicate> {
	...
	public static final LongPredicate OTHERWISE_THROW = Function4U.longPred(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LongPredicateBuilder(@Nullable Consumer<LongPredicate> consumer) {
		super(OTHERWISE_THROW, LLongPredicate::constant, () -> new LongPredicateBuilder(null));
	...
	@Nonnull
	public static LongPredicateBuilder longPredicate(Consumer<LongPredicate> consumer) {
		return new LongPredicateBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LongPredicateBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public final LongPredicate build() {
		...
		final LongPredicate otherwiseFinal = this.otherwise;
	...
	public final LongPredicate build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
