...
public final class FunctionXBuilder<T, R, X extends Exception> extends PerCaseBuilderWithProduct.Base<FunctionXBuilder<T, R, X>, PredicateX<T, X>, FunctionX<T, R, X>, R> {
