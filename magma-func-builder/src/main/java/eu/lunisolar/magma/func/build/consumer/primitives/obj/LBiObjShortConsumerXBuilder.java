...
public final class LBiObjShortConsumerXBuilder<T1, T2, X extends Throwable> extends PerCaseBuilder.Base<LBiObjShortConsumerXBuilder<T1, T2, X>, LBiObjShortPredicateX<T1, T2, X>, LBiObjShortConsumerX<T1, T2, X>> {
	...
	public static final LBiObjShortConsumerX EVENTUALLY_THROW = LBiObjShortConsumerX.lX((Object a1, Object a2, short a3) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s ,%s  as function %s.", a1, a2, a3, LBiObjShortConsumerX.DESCRIPTION);
	...
	public LBiObjShortConsumerXBuilder(@Nullable Consumer<LBiObjShortConsumerX<T1, T2, X>> consumer) {
		super(EVENTUALLY_THROW, () -> new LBiObjShortConsumerXBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <T1, T2, X extends Throwable> LBiObjShortConsumerXBuilder<T1, T2, X> biObjShortConsumerX() {
		return new LBiObjShortConsumerXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <T1, T2, X extends Throwable> LBiObjShortConsumerXBuilder<T1, T2, X> biObjShortConsumerX(Consumer<LBiObjShortConsumerX<T1, T2, X>> consumer) {
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2> LBiObjShortConsumerXBuilder<T1, T2, X> casesOf(Class<E1> argC1, Class<E2> argC2, Consumer<LBiObjShortConsumerXBuilder<E1, E2, X>> pcpConsumer) {
		PartialCase.The pc = partialCaseFactoryMethod((T1 a1, T2 a2, short a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2> LBiObjShortConsumerXBuilder<T1, T2, X> aCase(Class<E1> argC1, Class<E2> argC2, LBiObjShortConsumerX<E1, E2, X> function) {
		PartialCase.The pc = partialCaseFactoryMethod((T1 a1, T2 a2, short a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LBiObjShortConsumerX<T1, T2, X> build() {
		...
		retval = LBiObjShortConsumerX.<T1, T2, X> lX((T1 a1, T2 a2, short a3) -> {
			try {
