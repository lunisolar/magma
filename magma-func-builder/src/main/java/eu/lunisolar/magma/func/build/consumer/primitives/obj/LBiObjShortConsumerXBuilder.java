...
public final class LBiObjShortConsumerXBuilder<T1, T2, X extends Throwable> extends PerCaseBuilder.Base<LBiObjShortConsumerXBuilder<T1, T2, X>, LBiObjShortPredicateX<T1, T2, X>, LBiObjShortConsumerX<T1, T2, X>> {
	...
	public static final LBiObjShortConsumerX EVENTUALLY_THROW = LBiObjShortConsumerX.lX((a1, a2, a3) -> {
	...
	@Nonnull
	public static <T1, T2, X extends Throwable> LBiObjShortConsumerX<T1, T2, X> biObjShortConsumerXFrom(Function<LBiObjShortConsumerXBuilder<T1, T2, X>, LBiObjShortConsumerX<T1, T2, X>> buildingFunction) {
		return buildingFunction.apply(new LBiObjShortConsumerXBuilder());
	}
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjShortConsumerXBuilder<T1, T2, X> casesOf(Class<V1> argC1, Class<V2> argC2, Consumer<LBiObjShortConsumerXBuilder<V1, V2, X>> pcpConsumer) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjShortConsumerXBuilder<T1, T2, X> aCase(Class<V1> argC1, Class<V2> argC2, LBiObjShortConsumerX<V1, V2, X> function) {
		PartialCase.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LBiObjShortConsumerX<T1, T2, X> build() {
		...
		retval = LBiObjShortConsumerX.<T1, T2, X> lX((a1, a2, a3) -> {
			try {
