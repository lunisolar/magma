...
public final class BiObjBooleanFunctionBuilder<T1, T2, R> extends PerCaseBuilderWithProduct<BiObjBooleanFunctionBuilder<T1, T2, R>, BiObjBooleanPredicate<T1, T2>, BiObjBooleanFunction<T1, T2, R>, R> {
