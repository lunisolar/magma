...
public final class LFloatToDoubleFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithDoubleProduct.Base<LFloatToDoubleFunctionXBuilder<X>, LFloatPredicateX<X>, LFloatToDoubleFunctionX<X>> {
	...
	@Nonnull
	public static <X extends Throwable> LFloatToDoubleFunctionX<X> floatToDoubleFunctionXFrom(Function<LFloatToDoubleFunctionXBuilder<X>, LFloatToDoubleFunctionX<X>> buildingFunction) {
		return buildingFunction.apply(new LFloatToDoubleFunctionXBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LFloatToDoubleFunctionXBuilder<X> withHandling(@Nonnull HandlingInstructions<X, X> handling) {
	...
	public final LFloatToDoubleFunctionX<X> build(@Nonnull HandlingInstructions<X, X> handling) {
