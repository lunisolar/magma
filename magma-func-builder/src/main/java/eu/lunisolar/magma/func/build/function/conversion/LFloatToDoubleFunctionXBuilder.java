...
public final class LFloatToDoubleFunctionXBuilder<X extends Exception> extends PerCaseBuilderWithDoubleProduct.Base<LFloatToDoubleFunctionXBuilder<X>, LFloatPredicateX<X>, LFloatToDoubleFunctionX<X>> {

	private Consumer<LFloatToDoubleFunctionX<X>> consumer;
	...
	public LFloatToDoubleFunctionXBuilder() {
		this(null);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Exception> LFloatToDoubleFunctionXBuilder<X> floatToDoubleFunctionX() {
		return new LFloatToDoubleFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Exception> LFloatToDoubleFunctionXBuilder<X> floatToDoubleFunctionX(Consumer<LFloatToDoubleFunctionX<X>> consumer) {
		return new LFloatToDoubleFunctionXBuilder(consumer);
	}

	/** Builds the functional interface implementation and if previously provided calls the consumer. */
	@Nonnull
	public final LFloatToDoubleFunctionX<X> build() {

		final LFloatToDoubleFunctionX<X> eventuallyFinal = this.eventually;
