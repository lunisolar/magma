...
public final class LToShortFunctionXBuilder<T, X extends Exception> extends PerCaseBuilderWithShortProduct.Base<LToShortFunctionXBuilder<T, X>, LPredicateX<T, X>, LToShortFunctionX<T, X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T, X extends Exception> LToShortFunctionXBuilder<T, X> toShortFunctionX() {
		return new LToShortFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T, X extends Exception> LToShortFunctionXBuilder<T, X> toShortFunctionX(Consumer<LToShortFunctionX<T, X>> consumer) {
