...
public final class LToShortFunctionXBuilder<T, X extends Throwable> extends PerCaseBuilderWithShortProduct.Base<LToShortFunctionXBuilder<T, X>, LPredicateX<T, X>, LToShortFunctionX<T, X>> {
	...
	public static final LToShortFunctionX EVENTUALLY_THROW = LToShortFunctionX.lX((Object a1) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", a1, LToShortFunctionX.DESCRIPTION);
	...
	@Nonnull
	public <E1 extends T> LToShortFunctionXBuilder<T, X> casesOf(Class<E1> argC1, Consumer<LToShortFunctionXBuilder<E1, X>> pcpConsumer) {
	...
	@Nonnull
	public <E1 extends T> LToShortFunctionXBuilder<T, X> aCase(Class<E1> argC1, LToShortFunctionX<E1, X> function) {
		PartialCaseWithShortProduct.The pc = partialCaseFactoryMethod(a1 -> (argC1 == null || argC1.isInstance(a1)));
