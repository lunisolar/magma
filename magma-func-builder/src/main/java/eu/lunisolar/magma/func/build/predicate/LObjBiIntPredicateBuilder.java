...
public final class LObjBiIntPredicateBuilder<T> extends PerCaseBuilderWithBoolProduct.Base<LObjBiIntPredicateBuilder<T>, LObjBiIntPredicate<T>, LObjBiIntPredicate<T>> {
	...
	public static final LObjBiIntPredicate EVENTUALLY_THROW = LObjBiIntPredicate.objBiIntPred((a1, a2, a3) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LObjBiIntPredicateBuilder(@Nullable Consumer<LObjBiIntPredicate<T>> consumer) {
		super(EVENTUALLY_THROW, LObjBiIntPredicate::constant, () -> new LObjBiIntPredicateBuilder(null));
	...
	@Nonnull
	public static <T> LObjBiIntPredicate<T> objBiIntPredicateFrom(Function<LObjBiIntPredicateBuilder<T>, LObjBiIntPredicate<T>> buildingFunction) {
		return buildingFunction.apply(new LObjBiIntPredicateBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LObjBiIntPredicateBuilder<T> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	@Nonnull
	public <V extends T> LObjBiIntPredicateBuilder<T> aCase(Class<V> argC1, LObjBiIntPredicate<V> function) {
		PartialCaseWithBoolProduct.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LObjBiIntPredicate<T> build() {
		...
		final LObjBiIntPredicate<T> eventuallyFinal = this.eventually;
	...
	public final LObjBiIntPredicate<T> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
