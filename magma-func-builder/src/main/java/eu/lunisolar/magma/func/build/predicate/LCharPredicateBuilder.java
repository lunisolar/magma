 ...
 */
public final class LCharPredicateBuilder extends PerCaseBuilderWithBoolProduct.Base<LCharPredicateBuilder, LCharPredicate, LCharPredicate> {
	...
	public static final LCharPredicate OTHERWISE_THROW = LCharPredicate.charPred(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LCharPredicateBuilder(@Nullable Consumer<LCharPredicate> consumer) {
		super(OTHERWISE_THROW, LCharPredicate::constant, () -> new LCharPredicateBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static LCharPredicateBuilder charPredicate() {
	...
	@Nonnull
	public static LCharPredicateBuilder charPredicate(Consumer<LCharPredicate> consumer) {
		return new LCharPredicateBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LCharPredicateBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public LCharPredicateBuilder forValue(char v, LCharPredicate function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithBoolProduct.The<LCharPredicateBuilder, LCharPredicate, LCharPredicate> forValue(char v) {
	...
	public final LCharPredicate build() {
		...
		final LCharPredicate otherwiseFinal = this.otherwise;
	...
	public final LCharPredicate build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
