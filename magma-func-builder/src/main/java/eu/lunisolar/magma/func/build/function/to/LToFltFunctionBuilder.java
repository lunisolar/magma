...
public final class LToFltFunctionBuilder<T> extends PerCaseBuilderWithFltProduct.Base<LToFltFunctionBuilder<T>, LPredicate<T>, LToFltFunction<T>> {
	...
	public static final LToFltFunction EVENTUALLY_THROW = LToFltFunction.toFltFunc(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LToFltFunctionBuilder(@Nullable Consumer<LToFltFunction<T>> consumer) {
		super(EVENTUALLY_THROW, LToFltFunction::constant, () -> new LToFltFunctionBuilder(null));
	...
	@Nonnull
	public static <T> LToFltFunction<T> toFltFunctionFrom(Function<LToFltFunctionBuilder<T>, LToFltFunction<T>> buildingFunction) {
		return buildingFunction.apply(new LToFltFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LToFltFunctionBuilder<T> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LToFltFunction<T> build() {
		...
		final LToFltFunction<T> eventuallyFinal = this.eventually;
	...
	public final LToFltFunction<T> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
