...
public final class BiObjByteFunctionBuilder<T1, T2, R> extends PerCaseBuilderWithProduct<BiObjByteFunctionBuilder<T1, T2, R>, BiObjBytePredicate<T1, T2>, BiObjByteFunction<T1, T2, R>, R> {
