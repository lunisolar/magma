...
public final class LBiCharPredicateXBuilder<X extends Throwable> extends PerCaseBuilderWithBooleanProduct.Base<LBiCharPredicateXBuilder<X>, LBiCharPredicateX<X>, LBiCharPredicateX<X>> {

	private Consumer<LBiCharPredicateX<X>> consumer;

	private @Nullable HandlingInstructions handling;

	public static final LBiCharPredicateX EVENTUALLY_THROW = LBiCharPredicateX.lX((char c1, char c2) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s  as function %s.", c1, c2, LBiCharPredicateX.DESCRIPTION);
	...
	public LBiCharPredicateXBuilder(@Nullable Consumer<LBiCharPredicateX<X>> consumer) {
		super(EVENTUALLY_THROW, LBiCharPredicateX::constant);
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Throwable> LBiCharPredicateXBuilder<X> biCharPredicateX() {
		return new LBiCharPredicateXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Throwable> LBiCharPredicateXBuilder<X> biCharPredicateX(Consumer<LBiCharPredicateX<X>> consumer) {
	...
	public final LBiCharPredicateX<X> build() {
		...
		retval = LBiCharPredicateX.<X> lX((char c1, char c2) -> {
			try {
