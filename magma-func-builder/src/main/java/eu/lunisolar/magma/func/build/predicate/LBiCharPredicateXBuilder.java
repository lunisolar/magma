...
public final class LBiCharPredicateXBuilder<X extends Exception> extends PerCaseBuilderWithBooleanProduct.Base<LBiCharPredicateXBuilder<X>, LBiCharPredicateX<X>, LBiCharPredicateX<X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Exception> LBiCharPredicateXBuilder<X> biCharPredicateX() {
		return new LBiCharPredicateXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Exception> LBiCharPredicateXBuilder<X> biCharPredicateX(Consumer<LBiCharPredicateX<X>> consumer) {
