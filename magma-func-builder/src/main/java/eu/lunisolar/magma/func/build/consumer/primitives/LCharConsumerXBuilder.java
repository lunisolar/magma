...
public final class LCharConsumerXBuilder<X extends Throwable> extends PerCaseBuilder.Base<LCharConsumerXBuilder<X>, LCharPredicateX<X>, LCharConsumerX<X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Throwable> LCharConsumerXBuilder<X> charConsumerX() {
		return new LCharConsumerXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Throwable> LCharConsumerXBuilder<X> charConsumerX(Consumer<LCharConsumerX<X>> consumer) {
