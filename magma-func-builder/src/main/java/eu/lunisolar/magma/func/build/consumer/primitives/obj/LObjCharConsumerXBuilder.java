...
public final class LObjCharConsumerXBuilder<T, X extends Throwable> extends PerCaseBuilder.Base<LObjCharConsumerXBuilder<T, X>, LObjCharPredicateX<T, X>, LObjCharConsumerX<T, X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T, X extends Throwable> LObjCharConsumerXBuilder<T, X> objCharConsumerX() {
		return new LObjCharConsumerXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T, X extends Throwable> LObjCharConsumerXBuilder<T, X> objCharConsumerX(Consumer<LObjCharConsumerX<T, X>> consumer) {
