...
public final class LBiFloatConsumerXBuilder<X extends Throwable> extends PerCaseBuilder.Base<LBiFloatConsumerXBuilder<X>, LBiFloatPredicateX<X>, LBiFloatConsumerX<X>> {
	...
	public static final LBiFloatConsumerX EVENTUALLY_THROW = LBiFloatConsumerX.lX((a1, a2) -> {
	...
	@Nonnull
	public static <X extends Throwable> LBiFloatConsumerX<X> biFloatConsumerXFrom(Function<LBiFloatConsumerXBuilder<X>, LBiFloatConsumerX<X>> buildingFunction) {
		return buildingFunction.apply(new LBiFloatConsumerXBuilder());
	}
	...
	public final LBiFloatConsumerX<X> build() {
		...
		retval = LBiFloatConsumerX.<X> lX((a1, a2) -> {
			try {
