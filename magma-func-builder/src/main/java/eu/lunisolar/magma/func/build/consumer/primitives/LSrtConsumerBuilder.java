...
public final class LSrtConsumerBuilder extends PerCaseBuilder.Base<LSrtConsumerBuilder, LSrtPredicate, LSrtConsumer> {
	...
	@Nonnull
	public static LSrtConsumer srtConsumerFrom(Function<LSrtConsumerBuilder, LSrtConsumer> buildingFunction) {
		return buildingFunction.apply(new LSrtConsumerBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LSrtConsumerBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LSrtConsumer build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
