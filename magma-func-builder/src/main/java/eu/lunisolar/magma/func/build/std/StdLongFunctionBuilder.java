...
public final class StdLongFunctionBuilder<R> extends PerCaseBuilder<StdLongFunctionBuilder<R>, LongPredicate, java.util.function.LongFunction<R>> {
	...
	public StdLongFunctionBuilder() {
		this(null);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <R> StdLongFunctionBuilder<R> stdLongFunction() {
		return new StdLongFunctionBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <R> StdLongFunctionBuilder<R> stdLongFunction(Consumer<java.util.function.LongFunction<R>> consumer) {
		return new StdLongFunctionBuilder(consumer);
	}
