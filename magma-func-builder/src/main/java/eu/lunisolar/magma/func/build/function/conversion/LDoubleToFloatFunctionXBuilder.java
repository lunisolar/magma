...
public final class LDoubleToFloatFunctionXBuilder<X extends Exception> extends PerCaseBuilderWithFloatProduct.Base<LDoubleToFloatFunctionXBuilder<X>, LDoublePredicateX<X>, LDoubleToFloatFunctionX<X>> {

	private Consumer<LDoubleToFloatFunctionX<X>> consumer;

	public static final LDoubleToFloatFunctionX EVENTUALLY_THROW = LDoubleToFloatFunctionX.lX((double d) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", d, LDoubleToFloatFunctionX.DESCRIPTION);
	...
	public LDoubleToFloatFunctionXBuilder(@Nullable Consumer<LDoubleToFloatFunctionX<X>> consumer) {
		super(EVENTUALLY_THROW, LDoubleToFloatFunctionX::constant);
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Exception> LDoubleToFloatFunctionXBuilder<X> doubleToFloatFunctionX() {
		return new LDoubleToFloatFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Exception> LDoubleToFloatFunctionXBuilder<X> doubleToFloatFunctionX(Consumer<LDoubleToFloatFunctionX<X>> consumer) {
