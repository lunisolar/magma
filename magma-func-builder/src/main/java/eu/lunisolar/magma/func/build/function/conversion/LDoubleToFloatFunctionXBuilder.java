...
public final class LDoubleToFloatFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithFloatProduct.Base<LDoubleToFloatFunctionXBuilder<X>, LDoublePredicateX<X>, LDoubleToFloatFunctionX<X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Throwable> LDoubleToFloatFunctionXBuilder<X> doubleToFloatFunctionX() {
		return new LDoubleToFloatFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Throwable> LDoubleToFloatFunctionXBuilder<X> doubleToFloatFunctionX(Consumer<LDoubleToFloatFunctionX<X>> consumer) {
