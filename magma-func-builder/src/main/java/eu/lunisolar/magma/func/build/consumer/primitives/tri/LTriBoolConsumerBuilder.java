...
public final class LTriBoolConsumerBuilder extends PerCaseBuilder.Base<LTriBoolConsumerBuilder, LLogicalTernaryOperator, LTriBoolConsumer> {
	...
	public static final LTriBoolConsumer OTHERWISE_THROW = LTriBoolConsumer.triBoolCons((a1, a2, a3) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LTriBoolConsumerBuilder(@Nullable Consumer<LTriBoolConsumer> consumer) {
		super(OTHERWISE_THROW, () -> new LTriBoolConsumerBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LTriBoolConsumerBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public LTriBoolConsumerBuilder forValue(boolean v1, boolean v2, boolean v3, LTriBoolConsumer function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCase.The<LTriBoolConsumerBuilder, LLogicalTernaryOperator, LTriBoolConsumer> forValue(boolean v1, boolean v2, boolean v3) {
	...
	public final LTriBoolConsumer build() {
		...
		final LTriBoolConsumer otherwiseFinal = this.otherwise;
	...
	public final LTriBoolConsumer build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
