...
public final class LTriBoolConsumerBuilder extends PerCaseBuilder.Base<LTriBoolConsumerBuilder, LLogicalTernaryOperator, LTriBoolConsumer> {
	...
	@Nonnull
	public static LTriBoolConsumer triBoolConsumerFrom(Function<LTriBoolConsumerBuilder, LTriBoolConsumer> buildingFunction) {
		return buildingFunction.apply(new LTriBoolConsumerBuilder());
	}
