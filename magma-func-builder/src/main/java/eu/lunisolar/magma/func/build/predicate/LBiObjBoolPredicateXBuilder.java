...
public final class LBiObjBoolPredicateXBuilder<T1, T2, X extends Throwable> extends PerCaseBuilderWithBooleanProduct.Base<LBiObjBoolPredicateXBuilder<T1, T2, X>, LBiObjBoolPredicateX<T1, T2, X>, LBiObjBoolPredicateX<T1, T2, X>> {
	...
	public static final LBiObjBoolPredicateX EVENTUALLY_THROW = LBiObjBoolPredicateX.lX((Object a1, Object a2, boolean a3) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s ,%s  as function %s.", a1, a2, a3, LBiObjBoolPredicateX.DESCRIPTION);
	...
	public <E1 extends T1, E2 extends T2> LBiObjBoolPredicateXBuilder<T1, T2, X> casesOf(Class<E1> argC1, Class<E2> argC2, Consumer<LBiObjBoolPredicateXBuilder<E1, E2, X>> pcpConsumer) {
		PartialCaseWithBooleanProduct.The pc = partialCaseFactoryMethod((T1 a1, T2 a2, boolean a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LBiObjBoolPredicateX<T1, T2, X> build() {
		...
		retval = LBiObjBoolPredicateX.<T1, T2, X> lX((T1 a1, T2 a2, boolean a3) -> {
			try {
