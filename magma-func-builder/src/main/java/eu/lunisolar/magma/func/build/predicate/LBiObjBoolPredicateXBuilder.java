...
public final class LBiObjBoolPredicateXBuilder<T1, T2, X extends Throwable> extends PerCaseBuilderWithBoolProduct.Base<LBiObjBoolPredicateXBuilder<T1, T2, X>, LBiObjBoolPredicateX<T1, T2, X>, LBiObjBoolPredicateX<T1, T2, X>> {
	...
	public static final LBiObjBoolPredicateX EVENTUALLY_THROW = LBiObjBoolPredicateX.lX((a1, a2, a3) -> {
	...
	@Nonnull
	public static <T1, T2, X extends Throwable> LBiObjBoolPredicateX<T1, T2, X> biObjBoolPredicateXFrom(Function<LBiObjBoolPredicateXBuilder<T1, T2, X>, LBiObjBoolPredicateX<T1, T2, X>> buildingFunction) {
		return buildingFunction.apply(new LBiObjBoolPredicateXBuilder());
	}
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjBoolPredicateXBuilder<T1, T2, X> casesOf(Class<V1> argC1, Class<V2> argC2, Consumer<LBiObjBoolPredicateXBuilder<V1, V2, X>> pcpConsumer) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjBoolPredicateXBuilder<T1, T2, X> aCase(Class<V1> argC1, Class<V2> argC2, LBiObjBoolPredicateX<V1, V2, X> function) {
		PartialCaseWithBoolProduct.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LBiObjBoolPredicateX<T1, T2, X> build() {
		...
		retval = LBiObjBoolPredicateX.<T1, T2, X> lX((a1, a2, a3) -> {
			try {
