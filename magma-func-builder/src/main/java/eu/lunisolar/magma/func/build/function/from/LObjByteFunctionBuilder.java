...
public final class LObjByteFunctionBuilder<T, R> extends PerCaseBuilderWithProduct.Base<LObjByteFunctionBuilder<T, R>, LObjBytePredicate<T>, LObjByteFunction<T, R>, R> {
	...
	@Nonnull
	public static <T, R> LObjByteFunction<T, R> objByteFunctionFrom(Function<LObjByteFunctionBuilder<T, R>, LObjByteFunction<T, R>> buildingFunction) {
		return buildingFunction.apply(new LObjByteFunctionBuilder());
	}
	...
	@Nonnull
	public <V extends T> LObjByteFunctionBuilder<T, R> aCase(Class<V> argC1, LObjByteFunction<V, R> function) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod((a1, a2) -> (argC1 == null || argC1.isInstance(a1)));
