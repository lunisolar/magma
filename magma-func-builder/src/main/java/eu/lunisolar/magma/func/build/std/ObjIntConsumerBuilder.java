...
public final class ObjIntConsumerBuilder<T> extends PerCaseBuilder.Base<ObjIntConsumerBuilder<T>, LObjIntPredicate<T>, ObjIntConsumer<T>> {
	...
	public static final ObjIntConsumer OTHERWISE_THROW = Function4U.objIntCons((a1, a2) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public ObjIntConsumerBuilder(@Nullable Consumer<ObjIntConsumer<T>> consumer) {
		super(OTHERWISE_THROW, () -> new ObjIntConsumerBuilder(null));
	...
	@Nonnull
	public static <T> ObjIntConsumer<T> objIntConsumerFrom(Consumer<ObjIntConsumerBuilder<T>> buildingFunction) {
		ObjIntConsumerBuilder builder = new ObjIntConsumerBuilder();
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final ObjIntConsumerBuilder<T> withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public final ObjIntConsumer<T> build() {
		...
		final ObjIntConsumer<T> otherwiseFinal = this.otherwise;
	...
	public final ObjIntConsumer<T> build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
