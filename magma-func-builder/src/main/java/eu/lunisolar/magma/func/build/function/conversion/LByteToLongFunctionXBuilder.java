...
public final class LByteToLongFunctionXBuilder<X extends Exception> extends PerCaseBuilderWithLongProduct.Base<LByteToLongFunctionXBuilder<X>, LBytePredicateX<X>, LByteToLongFunctionX<X>> {

	private Consumer<LByteToLongFunctionX<X>> consumer;

	public static final LByteToLongFunctionX EVENTUALLY_THROW = LByteToLongFunctionX.lX((byte b) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", b, LByteToLongFunctionX.DESCRIPTION);
	...
	public LByteToLongFunctionXBuilder(@Nullable Consumer<LByteToLongFunctionX<X>> consumer) {
		super(EVENTUALLY_THROW, LByteToLongFunctionX::constant);
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Exception> LByteToLongFunctionXBuilder<X> byteToLongFunctionX() {
		return new LByteToLongFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Exception> LByteToLongFunctionXBuilder<X> byteToLongFunctionX(Consumer<LByteToLongFunctionX<X>> consumer) {
