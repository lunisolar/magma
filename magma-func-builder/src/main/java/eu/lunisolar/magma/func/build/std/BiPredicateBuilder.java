...
public final class BiPredicateBuilder<T1, T2> extends PerCaseBuilderWithBoolProduct.Base<BiPredicateBuilder<T1, T2>, LBiPredicate<T1, T2>, BiPredicate<T1, T2>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final BiPredicateBuilder<T1, T2> withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public final BiPredicate<T1, T2> build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
