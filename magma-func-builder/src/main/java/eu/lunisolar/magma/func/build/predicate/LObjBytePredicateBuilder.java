...
public final class LObjBytePredicateBuilder<T> extends PerCaseBuilderWithBoolProduct.Base<LObjBytePredicateBuilder<T>, LObjBytePredicate<T>, LObjBytePredicate<T>> {
	...
	public static final LObjBytePredicate EVENTUALLY_THROW = LObjBytePredicate.l((a1, a2) -> {
	...
	@Nonnull
	public static <T> LObjBytePredicate<T> objBytePredicateFrom(Function<LObjBytePredicateBuilder<T>, LObjBytePredicate<T>> buildingFunction) {
		return buildingFunction.apply(new LObjBytePredicateBuilder());
	}
	...
	@Nonnull
	public <V extends T> LObjBytePredicateBuilder<T> aCase(Class<V> argC1, LObjBytePredicate<V> function) {
		PartialCaseWithBoolProduct.The pc = partialCaseFactoryMethod((a1, a2) -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LObjBytePredicate<T> build() {
		...
		retval = LObjBytePredicate.<T> l((a1, a2) -> {
			try {
