...
public final class StdDoubleBinaryOperatorBuilder extends PerCaseBuilder<StdDoubleBinaryOperatorBuilder, BiDoublePredicate, java.util.function.DoubleBinaryOperator> {
	...
	public StdDoubleBinaryOperatorBuilder() {
		this(null);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final StdDoubleBinaryOperatorBuilder stdDoubleBinaryOperator() {
		return new StdDoubleBinaryOperatorBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final StdDoubleBinaryOperatorBuilder stdDoubleBinaryOperator(Consumer<java.util.function.DoubleBinaryOperator> consumer) {
		return new StdDoubleBinaryOperatorBuilder(consumer);
	}
