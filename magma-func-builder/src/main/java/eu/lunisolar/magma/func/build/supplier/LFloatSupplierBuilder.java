...
public final class LFloatSupplierBuilder extends PerCaseBuilderWithFloatProduct.Base<LFloatSupplierBuilder, LBoolSupplier, LFloatSupplier> {
	...
	public LFloatSupplierBuilder(@Nullable Consumer<LFloatSupplier> consumer) {
		super(EVENTUALLY_THROW, LFloatSupplier::of, () -> new LFloatSupplierBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static LFloatSupplierBuilder floatSupplier() {
		return new LFloatSupplierBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static LFloatSupplier floatSupplierFrom(Function<LFloatSupplierBuilder, LFloatSupplier> buildingFunction) {
		return buildingFunction.apply(new LFloatSupplierBuilder());
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static LFloatSupplierBuilder floatSupplier(Consumer<LFloatSupplier> consumer) {
		return new LFloatSupplierBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LFloatSupplierBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LFloatSupplier build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
