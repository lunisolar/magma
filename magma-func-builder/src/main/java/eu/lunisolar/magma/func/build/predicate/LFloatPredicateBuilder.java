...
public final class LFloatPredicateBuilder extends PerCaseBuilderWithBoolProduct.Base<LFloatPredicateBuilder, LFloatPredicate, LFloatPredicate> {
	...
	public static final LFloatPredicate EVENTUALLY_THROW = LFloatPredicate.l(a -> {
	...
	@Nonnull
	public static LFloatPredicate floatPredicateFrom(Function<LFloatPredicateBuilder, LFloatPredicate> buildingFunction) {
		return buildingFunction.apply(new LFloatPredicateBuilder());
	}
