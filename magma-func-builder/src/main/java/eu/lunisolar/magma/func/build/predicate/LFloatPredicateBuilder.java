...
public final class LFloatPredicateBuilder extends PerCaseBuilderWithBooleanProduct.Base<LFloatPredicateBuilder, LFloatPredicate, LFloatPredicate> {
	...
	public static final LFloatPredicate EVENTUALLY_THROW = LFloatPredicate.l((float f) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", f, LFloatPredicate.DESCRIPTION);
	...
	public LFloatPredicateBuilder(@Nullable Consumer<LFloatPredicate> consumer) {
		super(EVENTUALLY_THROW, LFloatPredicate::constant);
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final LFloatPredicateBuilder floatPredicate() {
		return new LFloatPredicateBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final LFloatPredicateBuilder floatPredicate(Consumer<LFloatPredicate> consumer) {
