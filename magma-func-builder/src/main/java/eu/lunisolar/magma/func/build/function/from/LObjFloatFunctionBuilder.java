...
public final class LObjFloatFunctionBuilder<T, R> extends PerCaseBuilderWithProduct.Base<LObjFloatFunctionBuilder<T, R>, LObjFloatPredicate<T>, LObjFloatFunction<T, R>, R> {
	...
	public static final LObjFloatFunction EVENTUALLY_THROW = LObjFloatFunction.l((a1, a2) -> {
	...
	@Nonnull
	public static <T, R> LObjFloatFunction<T, R> objFloatFunctionFrom(Function<LObjFloatFunctionBuilder<T, R>, LObjFloatFunction<T, R>> buildingFunction) {
		return buildingFunction.apply(new LObjFloatFunctionBuilder());
	}
	...
	@Nonnull
	public <V extends T> LObjFloatFunctionBuilder<T, R> casesOf(Class<V> argC1, Consumer<LObjFloatFunctionBuilder<V, R>> pcpConsumer) {
	...
	@Nonnull
	public <V extends T> LObjFloatFunctionBuilder<T, R> aCase(Class<V> argC1, LObjFloatFunction<V, R> function) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod((a1, a2) -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LObjFloatFunction<T, R> build() {
		...
		retval = LObjFloatFunction.<T, R> l((a1, a2) -> {
			try {
