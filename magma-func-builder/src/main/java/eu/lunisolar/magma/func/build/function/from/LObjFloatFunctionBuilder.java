...
public final class LObjFloatFunctionBuilder<T, R> extends PerCaseBuilderWithProduct.Base<LObjFloatFunctionBuilder<T, R>, LObjFloatPredicate<T>, LObjFloatFunction<T, R>, R> {
	...
	public static final LObjFloatFunction EVENTUALLY_THROW = LObjFloatFunction.l((Object t, float f) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s  as function %s.", t, f, LObjFloatFunction.DESCRIPTION);
	...
	public LObjFloatFunctionBuilder(@Nullable Consumer<LObjFloatFunction<T, R>> consumer) {
		super(EVENTUALLY_THROW, LObjFloatFunction::constant);
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T, R> LObjFloatFunctionBuilder<T, R> objFloatFunction() {
		return new LObjFloatFunctionBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T, R> LObjFloatFunctionBuilder<T, R> objFloatFunction(Consumer<LObjFloatFunction<T, R>> consumer) {
	...
	public final LObjFloatFunction<T, R> build() {
		...
		retval = LObjFloatFunction.<T, R> l((T t, float f) -> {
			try {
