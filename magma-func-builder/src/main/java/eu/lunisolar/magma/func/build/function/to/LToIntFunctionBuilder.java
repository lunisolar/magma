...
public final class LToIntFunctionBuilder<T> extends PerCaseBuilderWithIntProduct.Base<LToIntFunctionBuilder<T>, LPredicate<T>, LToIntFunction<T>> {
	...
	public static final LToIntFunction EVENTUALLY_THROW = LToIntFunction.l(a1 -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LToIntFunctionBuilder(@Nullable Consumer<LToIntFunction<T>> consumer) {
		super(EVENTUALLY_THROW, LToIntFunction::constant, () -> new LToIntFunctionBuilder(null));
	...
	@Nonnull
	public static <T> LToIntFunction<T> toIntFunctionFrom(Function<LToIntFunctionBuilder<T>, LToIntFunction<T>> buildingFunction) {
		return buildingFunction.apply(new LToIntFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LToIntFunctionBuilder<T> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	@Nonnull
	public <V extends T> LToIntFunctionBuilder<T> casesOf(Class<V> argC1, Consumer<LToIntFunctionBuilder<V>> pcpConsumer) {
	...
	@Nonnull
	public <V extends T> LToIntFunctionBuilder<T> aCase(Class<V> argC1, LToIntFunction<V> function) {
		PartialCaseWithIntProduct.The pc = partialCaseFactoryMethod(a1 -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LToIntFunction<T> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
