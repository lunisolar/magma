...
public final class LToIntFunctionBuilder<T> extends PerCaseBuilderWithIntProduct.Base<LToIntFunctionBuilder<T>, LPredicate<T>, LToIntFunction<T>> {
	...
	public static final LToIntFunction EVENTUALLY_THROW = LToIntFunction.l((Object a1) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", a1, LToIntFunction.DESCRIPTION);
	...
	@Nonnull
	public <E1 extends T> LToIntFunctionBuilder<T> casesOf(Class<E1> argC1, Consumer<LToIntFunctionBuilder<E1>> pcpConsumer) {
	...
	@Nonnull
	public <E1 extends T> LToIntFunctionBuilder<T> aCase(Class<E1> argC1, LToIntFunction<E1> function) {
		PartialCaseWithIntProduct.The pc = partialCaseFactoryMethod(a1 -> (argC1 == null || argC1.isInstance(a1)));
