...
public final class LBiObjIntFunctionBuilder<T1, T2, R> extends PerCaseBuilderWithProduct.Base<LBiObjIntFunctionBuilder<T1, T2, R>, LBiObjIntPredicate<T1, T2>, LBiObjIntFunction<T1, T2, R>, R> {
	...
	public LBiObjIntFunctionBuilder(@Nullable Consumer<LBiObjIntFunction<T1, T2, R>> consumer) {
		super(EVENTUALLY_THROW, LBiObjIntFunction::constant);
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T1, T2, R> LBiObjIntFunctionBuilder<T1, T2, R> biObjIntFunction() {
		return new LBiObjIntFunctionBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T1, T2, R> LBiObjIntFunctionBuilder<T1, T2, R> biObjIntFunction(Consumer<LBiObjIntFunction<T1, T2, R>> consumer) {
