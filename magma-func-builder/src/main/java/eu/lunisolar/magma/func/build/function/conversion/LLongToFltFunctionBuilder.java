...
public final class LLongToFltFunctionBuilder extends PerCaseBuilderWithFltProduct.Base<LLongToFltFunctionBuilder, LLongPredicate, LLongToFltFunction> {
	...
	public static final LLongToFltFunction EVENTUALLY_THROW = LLongToFltFunction.longToFltFunc(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LLongToFltFunctionBuilder(@Nullable Consumer<LLongToFltFunction> consumer) {
		super(EVENTUALLY_THROW, LLongToFltFunction::constant, () -> new LLongToFltFunctionBuilder(null));
	...
	@Nonnull
	public static LLongToFltFunction longToFltFunctionFrom(Function<LLongToFltFunctionBuilder, LLongToFltFunction> buildingFunction) {
		return buildingFunction.apply(new LLongToFltFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LLongToFltFunctionBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LLongToFltFunction build() {
		...
		final LLongToFltFunction eventuallyFinal = this.eventually;
	...
	public final LLongToFltFunction build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
