...
public final class LByteSupplierBuilder extends PerCaseBuilderWithByteProduct.Base<LByteSupplierBuilder, LBooleanSupplier, LByteSupplier> {
	...
	public static final LByteSupplier EVENTUALLY_THROW = LByteSupplier.l(() -> {
		String message;
		try {
			message = String.format("No case specified for: no arg as function %s.", LByteSupplier.DESCRIPTION);
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LByteSupplierBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LByteSupplier build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
