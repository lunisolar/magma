...
public final class LQuintFunctionBuilder<T1, T2, T3, T4, T5, R> extends PerCaseBuilderWithProduct.Base<LQuintFunctionBuilder<T1, T2, T3, T4, T5, R>, LQuintPredicate<T1, T2, T3, T4, T5>, LQuintFunction<T1, T2, T3, T4, T5, R>, R> {
	...
	public <V1 extends T1, V2 extends T2, V3 extends T3, V4 extends T4, V5 extends T5> LQuintFunctionBuilder<T1, T2, T3, T4, T5, R> forValue(T1 v1, T2 v2, T3 v3, T4 v4, T5 v5, LQuintFunction<V1, V2, V3, V4, V5, R> function) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod((a1, a2, a3, a4, a5) -> Objects.equals(a1, v1) && Objects.equals(a2, v2) && Objects.equals(a3, v3) && Objects.equals(a4, v4) && Objects.equals(a5, v5));
		pc.evaluate(function);
		return fluentCtx();
	}

	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public <V1 extends T1, V2 extends T2, V3 extends T3, V4 extends T4, V5 extends T5> PartialCaseWithProduct.The<LQuintFunctionBuilder<T1, T2, T3, T4, T5, R>, LQuintPredicate<T1, T2, T3, T4, T5>, LQuintFunction<T1, T2, T3, T4, T5, R>, R> forValue(T1 v1,
