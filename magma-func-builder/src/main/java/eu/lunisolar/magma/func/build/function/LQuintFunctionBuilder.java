...
public final class LQuintFunctionBuilder<T1, T2, T3, T4, T5, R> extends PerCaseBuilderWithProduct.Base<LQuintFunctionBuilder<T1, T2, T3, T4, T5, R>, LQuintPredicate<T1, T2, T3, T4, T5>, LQuintFunction<T1, T2, T3, T4, T5, R>, R> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LQuintFunctionBuilder<T1, T2, T3, T4, T5, R> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LQuintFunction<T1, T2, T3, T4, T5, R> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
