...
public final class LObjIntFltPredicateBuilder<T> extends PerCaseBuilderWithBoolProduct.Base<LObjIntFltPredicateBuilder<T>, LObjIntFltPredicate<T>, LObjIntFltPredicate<T>> {
	...
	public static final LObjIntFltPredicate OTHERWISE_THROW = LObjIntFltPredicate.objIntFltPred((a1, a2, a3) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LObjIntFltPredicateBuilder(@Nullable Consumer<LObjIntFltPredicate<T>> consumer) {
		super(OTHERWISE_THROW, LObjIntFltPredicate::constant, () -> new LObjIntFltPredicateBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LObjIntFltPredicateBuilder<T> withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public <V extends T> LObjIntFltPredicateBuilder<T> forValue(T v1, int v2, float v3, LObjIntFltPredicate<V> function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public <V extends T> PartialCaseWithBoolProduct.The<LObjIntFltPredicateBuilder<T>, LObjIntFltPredicate<T>, LObjIntFltPredicate<T>> forValue(T v1, int v2, float v3) {
	...
	@Nonnull
	public <V extends T> LObjIntFltPredicateBuilder<T> forClass(Class<V> argC1, LObjIntFltPredicate<V> function) {
		PartialCaseWithBoolProduct.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)));
		pc.evaluate(function);
		return fluentCtx();
	}
	...
	/** Adds full new case for the argument that are of specific classes (matched by instanceOf, null is a wildcard). */
	@Nonnull
	public <V extends T> PartialCaseWithBoolProduct.The<LObjIntFltPredicateBuilder<T>, LObjIntFltPredicate<T>, LObjIntFltPredicate<T>> forClass(Class<V> argC1) {
	...
	public final LObjIntFltPredicate<T> build() {
		...
		final LObjIntFltPredicate<T> otherwiseFinal = this.otherwise;
	...
	public final LObjIntFltPredicate<T> build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
