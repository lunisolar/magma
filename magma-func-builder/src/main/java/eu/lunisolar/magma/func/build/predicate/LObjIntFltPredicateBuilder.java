...
public final class LObjIntFltPredicateBuilder<T> extends PerCaseBuilderWithBoolProduct.Base<LObjIntFltPredicateBuilder<T>, LObjIntFltPredicate<T>, LObjIntFltPredicate<T>> {
	...
	@Nonnull
	public static <T> LObjIntFltPredicate<T> objIntFltPredicateFrom(Function<LObjIntFltPredicateBuilder<T>, LObjIntFltPredicate<T>> buildingFunction) {
		return buildingFunction.apply(new LObjIntFltPredicateBuilder());
	}
