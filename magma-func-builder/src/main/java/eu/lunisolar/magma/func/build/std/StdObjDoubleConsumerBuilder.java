...
public final class StdObjDoubleConsumerBuilder<T> extends PerCaseBuilder.Base<StdObjDoubleConsumerBuilder<T>, ObjDoublePredicate<T>, java.util.function.ObjDoubleConsumer<T>> {
	...
	public StdObjDoubleConsumerBuilder(@Nullable Consumer<java.util.function.ObjDoubleConsumer<T>> consumer) {
	...
	public StdObjDoubleConsumerBuilder() {
		this(null);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T> StdObjDoubleConsumerBuilder<T> stdObjDoubleConsumer() {
		return new StdObjDoubleConsumerBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T> StdObjDoubleConsumerBuilder<T> stdObjDoubleConsumer(Consumer<java.util.function.ObjDoubleConsumer<T>> consumer) {
		return new StdObjDoubleConsumerBuilder(consumer);
	}
	...
	public final java.util.function.ObjDoubleConsumer<T> build() {
		...
		if (cases.isEmpty()) {
			...
			final Case<ObjDoublePredicate<T>, java.util.function.ObjDoubleConsumer<T>>[] casesArray = cases.toArray(new Case[cases.size()]);
