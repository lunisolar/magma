...
public final class StdObjDoubleConsumerBuilder<T> extends PerCaseBuilder.Base<StdObjDoubleConsumerBuilder<T>, LObjDoublePredicate<T>, java.util.function.ObjDoubleConsumer<T>> {
