...
public final class ObjShortPredicateXBuilder<T, X extends Exception> extends PerCaseBuilderWithBooleanProduct<ObjShortPredicateXBuilder<T, X>, ObjShortPredicateX<T, X>, ObjShortPredicateX<T, X>> {
