...
public final class LLongBinaryOperatorBuilder extends PerCaseBuilderWithLongProduct.Base<LLongBinaryOperatorBuilder, LBiLongPredicate, LLongBinaryOperator> {
	...
	public static final LLongBinaryOperator OTHERWISE_THROW = LLongBinaryOperator.longBinaryOp((a1, a2) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LLongBinaryOperatorBuilder(@Nullable Consumer<LLongBinaryOperator> consumer) {
		super(OTHERWISE_THROW, LLongBinaryOperator::constant, () -> new LLongBinaryOperatorBuilder(null));
	...
	@Nonnull
	public static LLongBinaryOperator longBinaryOperatorFrom(Consumer<LLongBinaryOperatorBuilder> buildingFunction) {
		LLongBinaryOperatorBuilder builder = new LLongBinaryOperatorBuilder();
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LLongBinaryOperatorBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public LLongBinaryOperatorBuilder forValue(long v1, long v2, LLongBinaryOperator function) {
		PartialCaseWithLongProduct.The pc = partialCaseFactoryMethod((a1, a2) -> a1 == v1 && a2 == v2);
		pc.evaluate(function);
		return fluentCtx();
	}

	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithLongProduct.The<LLongBinaryOperatorBuilder, LBiLongPredicate, LLongBinaryOperator> forValue(long v1, long v2) {
	...
	public final LLongBinaryOperator build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
