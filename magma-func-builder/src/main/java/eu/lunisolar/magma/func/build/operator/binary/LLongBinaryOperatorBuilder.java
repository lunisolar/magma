...
public final class LLongBinaryOperatorBuilder extends PerCaseBuilderWithLongProduct.Base<LLongBinaryOperatorBuilder, LBiLongPredicate, LLongBinaryOperator> {
	...
	@Nonnull
	public static LLongBinaryOperator longBinaryOperatorFrom(Function<LLongBinaryOperatorBuilder, LLongBinaryOperator> buildingFunction) {
		return buildingFunction.apply(new LLongBinaryOperatorBuilder());
	}
