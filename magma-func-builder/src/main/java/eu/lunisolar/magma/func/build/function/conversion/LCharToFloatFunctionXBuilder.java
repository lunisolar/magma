...
public final class LCharToFloatFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithFloatProduct.Base<LCharToFloatFunctionXBuilder<X>, LCharPredicateX<X>, LCharToFloatFunctionX<X>> {
	...
	public static final LCharToFloatFunctionX EVENTUALLY_THROW = LCharToFloatFunctionX.lX(a1 -> {
	...
	@Nonnull
	public static <X extends Throwable> LCharToFloatFunctionX<X> charToFloatFunctionXFrom(Function<LCharToFloatFunctionXBuilder<X>, LCharToFloatFunctionX<X>> buildingFunction) {
		return buildingFunction.apply(new LCharToFloatFunctionXBuilder());
	}
	...
	public final LCharToFloatFunctionX<X> build() {
		...
		retval = LCharToFloatFunctionX.<X> lX(a1 -> {
			try {
