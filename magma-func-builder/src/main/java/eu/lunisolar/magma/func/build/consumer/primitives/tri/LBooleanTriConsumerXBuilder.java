...
public final class LBooleanTriConsumerXBuilder<X extends Exception> extends PerCaseBuilder.Base<LBooleanTriConsumerXBuilder<X>, LBooleanTernaryOperatorX<X>, LBooleanTriConsumerX<X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Exception> LBooleanTriConsumerXBuilder<X> booleanTriConsumerX() {
		return new LBooleanTriConsumerXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Exception> LBooleanTriConsumerXBuilder<X> booleanTriConsumerX(Consumer<LBooleanTriConsumerX<X>> consumer) {
