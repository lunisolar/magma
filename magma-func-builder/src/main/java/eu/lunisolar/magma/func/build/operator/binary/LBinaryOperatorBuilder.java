...
public final class LBinaryOperatorBuilder<T> extends PerCaseBuilderWithProduct.Base<LBinaryOperatorBuilder<T>, LBiPredicate<T, T>, LBinaryOperator<T>, T> {
	...
	public static final LBinaryOperator EVENTUALLY_THROW = LBinaryOperator.binaryOp((a1, a2) -> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LBinaryOperatorBuilder<T> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LBinaryOperator<T> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
