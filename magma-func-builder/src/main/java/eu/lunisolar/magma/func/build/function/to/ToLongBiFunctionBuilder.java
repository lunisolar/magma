...
public final class ToLongBiFunctionBuilder<T1, T2> extends PerCaseBuilderWithLongProduct<ToLongBiFunctionBuilder<T1, T2>, BiPredicate<T1, T2>, ToLongBiFunction<T1, T2>> {
