...
public final class LToIntTriFunctionBuilder<T1, T2, T3> extends PerCaseBuilderWithIntProduct.Base<LToIntTriFunctionBuilder<T1, T2, T3>, LTriPredicate<T1, T2, T3>, LToIntTriFunction<T1, T2, T3>> {
	...
	@Nonnull
	public static <T1, T2, T3> LToIntTriFunction<T1, T2, T3> toIntTriFunctionFrom(Function<LToIntTriFunctionBuilder<T1, T2, T3>, LToIntTriFunction<T1, T2, T3>> buildingFunction) {
		return buildingFunction.apply(new LToIntTriFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LToIntTriFunctionBuilder<T1, T2, T3> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2, V3 extends T3> LToIntTriFunctionBuilder<T1, T2, T3> aCase(Class<V1> argC1, Class<V2> argC2, Class<V3> argC3, LToIntTriFunction<V1, V2, V3> function) {
		PartialCaseWithIntProduct.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)) && (argC3 == null || argC3.isInstance(a3)));
	...
	public final LToIntTriFunction<T1, T2, T3> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
