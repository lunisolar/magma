...
public final class LBooleanSupplierBuilder extends PerCaseBuilderWithBooleanProduct.Base<LBooleanSupplierBuilder, LBooleanSupplier, LBooleanSupplier> {
	...
	public LBooleanSupplierBuilder(@Nullable Consumer<LBooleanSupplier> consumer) {
		super(EVENTUALLY_THROW, LBooleanSupplier::of, () -> new LBooleanSupplierBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static LBooleanSupplierBuilder booleanSupplier() {
		return new LBooleanSupplierBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static LBooleanSupplierBuilder booleanSupplier(Consumer<LBooleanSupplier> consumer) {
		return new LBooleanSupplierBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LBooleanSupplierBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LBooleanSupplier build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
