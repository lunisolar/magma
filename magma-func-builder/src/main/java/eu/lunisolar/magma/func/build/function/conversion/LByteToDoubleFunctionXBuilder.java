...
public final class LByteToDoubleFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithDoubleProduct.Base<LByteToDoubleFunctionXBuilder<X>, LBytePredicateX<X>, LByteToDoubleFunctionX<X>> {
	...
	public static final LByteToDoubleFunctionX EVENTUALLY_THROW = LByteToDoubleFunctionX.lX(a1 -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LByteToDoubleFunctionXBuilder(@Nullable Consumer<LByteToDoubleFunctionX<X>> consumer) {
		super(EVENTUALLY_THROW, LByteToDoubleFunctionX::constant, () -> new LByteToDoubleFunctionXBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <X extends Throwable> LByteToDoubleFunctionXBuilder<X> byteToDoubleFunctionX() {
		return new LByteToDoubleFunctionXBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static <X extends Throwable> LByteToDoubleFunctionX<X> byteToDoubleFunctionXFrom(Function<LByteToDoubleFunctionXBuilder<X>, LByteToDoubleFunctionX<X>> buildingFunction) {
		return buildingFunction.apply(new LByteToDoubleFunctionXBuilder());
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <X extends Throwable> LByteToDoubleFunctionXBuilder<X> byteToDoubleFunctionX(Consumer<LByteToDoubleFunctionX<X>> consumer) {
	...
	public final LByteToDoubleFunctionX<X> build() {
		...
		retval = LByteToDoubleFunctionX.<X> lX(a1 -> {
			try {
