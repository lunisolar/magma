...
public final class LByteToDoubleFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithDoubleProduct.Base<LByteToDoubleFunctionXBuilder<X>, LBytePredicateX<X>, LByteToDoubleFunctionX<X>> {
	...
	public static final LByteToDoubleFunctionX EVENTUALLY_THROW = LByteToDoubleFunctionX.lX((byte a1) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", a1, LByteToDoubleFunctionX.DESCRIPTION);
