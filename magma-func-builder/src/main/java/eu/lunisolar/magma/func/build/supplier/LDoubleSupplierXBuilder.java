...
public final class LDoubleSupplierXBuilder<X extends Throwable> extends PerCaseBuilderWithDoubleProduct.Base<LDoubleSupplierXBuilder<X>, LBooleanSupplierX<X>, LDoubleSupplierX<X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Throwable> LDoubleSupplierXBuilder<X> doubleSupplierX() {
		return new LDoubleSupplierXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Throwable> LDoubleSupplierXBuilder<X> doubleSupplierX(Consumer<LDoubleSupplierX<X>> consumer) {
