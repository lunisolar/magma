...
public final class ToLongBiFunctionXBuilder<T1, T2, X extends Exception> extends PerCaseBuilderWithLongProduct.Base<ToLongBiFunctionXBuilder<T1, T2, X>, BiPredicateX<T1, T2, X>, ToLongBiFunctionX<T1, T2, X>> {
