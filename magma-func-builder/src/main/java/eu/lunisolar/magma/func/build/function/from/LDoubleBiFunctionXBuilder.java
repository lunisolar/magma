...
public final class LDoubleBiFunctionXBuilder<R, X extends Exception> extends PerCaseBuilderWithProduct.Base<LDoubleBiFunctionXBuilder<R, X>, LBiDoublePredicateX<X>, LDoubleBiFunctionX<R, X>, R> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <R, X extends Exception> LDoubleBiFunctionXBuilder<R, X> doubleBiFunctionX() {
		return new LDoubleBiFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <R, X extends Exception> LDoubleBiFunctionXBuilder<R, X> doubleBiFunctionX(Consumer<LDoubleBiFunctionX<R, X>> consumer) {
