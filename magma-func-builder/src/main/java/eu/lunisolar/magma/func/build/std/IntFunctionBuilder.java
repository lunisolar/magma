...
public final class IntFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<IntFunctionBuilder<R>, LIntPredicate, IntFunction<R>, R> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final IntFunctionBuilder<R> withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public final IntFunction<R> build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
