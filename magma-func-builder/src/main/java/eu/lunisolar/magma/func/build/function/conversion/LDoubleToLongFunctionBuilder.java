...
public final class LDoubleToLongFunctionBuilder extends PerCaseBuilderWithLongProduct.Base<LDoubleToLongFunctionBuilder, LDoublePredicate, LDoubleToLongFunction> {
	...
	private Consumer<LDoubleToLongFunction> consumer;

	private @Nullable HandlingInstructions handling;

	public static final LDoubleToLongFunction EVENTUALLY_THROW = LDoubleToLongFunction.l(a -> {
	...
	public LDoubleToLongFunctionBuilder() {
		this(null);
	}
	...
	@Nonnull
	public static LDoubleToLongFunction doubleToLongFunctionFrom(Function<LDoubleToLongFunctionBuilder, LDoubleToLongFunction> buildingFunction) {
		return buildingFunction.apply(new LDoubleToLongFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LDoubleToLongFunctionBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	@Nonnull
	public final LDoubleToLongFunction build() {

		final LDoubleToLongFunction eventuallyFinal = this.eventually;
		...
		retval = LDoubleToLongFunction.l(a -> {
			try {
	...
	public final LDoubleToLongFunction build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
