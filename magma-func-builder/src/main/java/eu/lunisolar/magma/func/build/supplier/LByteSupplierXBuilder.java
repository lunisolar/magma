...
public final class LByteSupplierXBuilder<X extends Throwable> extends PerCaseBuilderWithByteProduct.Base<LByteSupplierXBuilder<X>, LBoolSupplierX<X>, LByteSupplierX<X>> {
	...
	@Nonnull
	public static <X extends Throwable> LByteSupplierX<X> byteSupplierXFrom(Function<LByteSupplierXBuilder<X>, LByteSupplierX<X>> buildingFunction) {
		return buildingFunction.apply(new LByteSupplierXBuilder());
	}
