...
public final class IntToByteFunctionXBuilder<X extends Exception> extends PerCaseBuilder<IntToByteFunctionXBuilder<X>, IntPredicateX<X>, IntToByteFunctionX<X>> {
