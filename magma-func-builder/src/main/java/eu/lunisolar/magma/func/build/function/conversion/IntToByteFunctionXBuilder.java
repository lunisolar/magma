...
public final class IntToByteFunctionXBuilder<X extends Exception> extends PerCaseBuilderWithByteProduct<IntToByteFunctionXBuilder<X>, IntPredicateX<X>, IntToByteFunctionX<X>> {
