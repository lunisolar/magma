...
public final class LTriFunctionBuilder<T1, T2, T3, R> extends PerCaseBuilderWithProduct.Base<LTriFunctionBuilder<T1, T2, T3, R>, LTriPredicate<T1, T2, T3>, LTriFunction<T1, T2, T3, R>, R> {
	...
	public static final LTriFunction EVENTUALLY_THROW = LTriFunction.l((Object a1, Object a2, Object a3) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s ,%s  as function %s.", a1, a2, a3, LTriFunction.DESCRIPTION);
	...
	public final LTriFunction<T1, T2, T3, R> build() {
		...
		retval = LTriFunction.<T1, T2, T3, R> l((T1 a1, T2 a2, T3 a3) -> {
			try {
