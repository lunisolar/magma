...
public final class LTriFunctionBuilder<T1, T2, T3, R> extends PerCaseBuilderWithProduct.Base<LTriFunctionBuilder<T1, T2, T3, R>, LTriPredicate<T1, T2, T3>, LTriFunction<T1, T2, T3, R>, R> {
	...
	public static final LTriFunction EVENTUALLY_THROW = LTriFunction.l((Object t1, Object t2, Object t3) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s ,%s  as function %s.", t1, t2, t3, LTriFunction.DESCRIPTION);
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LTriFunctionBuilder<T1, T2, T3, R> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2, E3 extends T3> LTriFunctionBuilder<T1, T2, T3, R> casesOf(Class<E1> argC1, Class<E2> argC2, Class<E3> argC3, Consumer<LTriFunctionBuilder<E1, E2, E3, R>> pcpConsumer) {
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2, E3 extends T3> LTriFunctionBuilder<T1, T2, T3, R> aCase(Class<E1> argC1, Class<E2> argC2, Class<E3> argC3, LTriFunction<E1, E2, E3, R> function) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod((T1 t1, T2 t2, T3 t3) -> (argC1 == null || argC1.isInstance(t1)) && (argC2 == null || argC2.isInstance(t2)) && (argC3 == null || argC3.isInstance(t3)));
	...
	public final LTriFunction<T1, T2, T3, R> build() {
		...
		retval = LTriFunction.<T1, T2, T3, R> l((T1 t1, T2 t2, T3 t3) -> {
			try {
	...
	public final LTriFunction<T1, T2, T3, R> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
