...
public final class StdBiConsumerBuilder<T1, T2> extends PerCaseBuilder.Base<StdBiConsumerBuilder<T1, T2>, BiPredicate<T1, T2>, java.util.function.BiConsumer<T1, T2>> {
