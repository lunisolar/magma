...
public final class LTriIntConsumerBuilder extends PerCaseBuilder.Base<LTriIntConsumerBuilder, LTriIntPredicate, LTriIntConsumer> {
	...
	public static final LTriIntConsumer EVENTUALLY_THROW = LTriIntConsumer.triIntCons((a1, a2, a3) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LTriIntConsumerBuilder(@Nullable Consumer<LTriIntConsumer> consumer) {
		super(EVENTUALLY_THROW, () -> new LTriIntConsumerBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LTriIntConsumerBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LTriIntConsumer build() {
		...
		final LTriIntConsumer eventuallyFinal = this.eventually;
	...
	public final LTriIntConsumer build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
