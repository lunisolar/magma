...
public final class LLongUnaryOperatorBuilder extends PerCaseBuilderWithLongProduct.Base<LLongUnaryOperatorBuilder, LLongPredicate, LLongUnaryOperator> {
	...
	@Nonnull
	public static LLongUnaryOperator longUnaryOperatorFrom(Function<LLongUnaryOperatorBuilder, LLongUnaryOperator> buildingFunction) {
		return buildingFunction.apply(new LLongUnaryOperatorBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LLongUnaryOperatorBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LLongUnaryOperator build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
