...
public final class LLongUnaryOperatorBuilder extends PerCaseBuilderWithLongProduct.Base<LLongUnaryOperatorBuilder, LLongPredicate, LLongUnaryOperator> {
	...
	@Nonnull
	public static LLongUnaryOperator longUnaryOperatorFrom(Consumer<LLongUnaryOperatorBuilder> buildingFunction) {
		LLongUnaryOperatorBuilder builder = new LLongUnaryOperatorBuilder();
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LLongUnaryOperatorBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public LLongUnaryOperatorBuilder forValue(long v, LLongUnaryOperator function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithLongProduct.The<LLongUnaryOperatorBuilder, LLongPredicate, LLongUnaryOperator> forValue(long v) {
	...
	public final LLongUnaryOperator build() {
		...
		retval = LLongUnaryOperator.longUnaryOp(a -> {
			try {
	...
	public final LLongUnaryOperator build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
