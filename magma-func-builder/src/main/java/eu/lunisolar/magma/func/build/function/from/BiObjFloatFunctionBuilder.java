...
public final class BiObjFloatFunctionBuilder<T1, T2, R> extends PerCaseBuilder<BiObjFloatFunctionBuilder<T1, T2, R>, BiObjFloatPredicate<T1, T2>, BiObjFloatFunction<T1, T2, R>> {
