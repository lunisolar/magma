...
public final class LBiLongFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LBiLongFunctionBuilder<R>, LBiLongPredicate, LBiLongFunction<R>, R> {
	...
	public LBiLongFunctionBuilder<R> forValue(long v1, long v2, LBiLongFunction<R> function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithProduct.The<LBiLongFunctionBuilder<R>, LBiLongPredicate, LBiLongFunction<R>, R> forValue(long v1, long v2) {
