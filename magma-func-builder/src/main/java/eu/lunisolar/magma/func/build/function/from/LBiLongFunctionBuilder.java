...
public final class LBiLongFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LBiLongFunctionBuilder<R>, LBiLongPredicate, LBiLongFunction<R>, R> {
	...
	@Nonnull
	public static <R> LBiLongFunction<R> biLongFunctionFrom(Function<LBiLongFunctionBuilder<R>, LBiLongFunction<R>> buildingFunction) {
		return buildingFunction.apply(new LBiLongFunctionBuilder());
	}
