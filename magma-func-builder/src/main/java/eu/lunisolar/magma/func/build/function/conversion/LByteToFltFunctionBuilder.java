...
public final class LByteToFltFunctionBuilder extends PerCaseBuilderWithFltProduct.Base<LByteToFltFunctionBuilder, LBytePredicate, LByteToFltFunction> {
	...
	@Nonnull
	public static LByteToFltFunction byteToFltFunctionFrom(Function<LByteToFltFunctionBuilder, LByteToFltFunction> buildingFunction) {
		return buildingFunction.apply(new LByteToFltFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LByteToFltFunctionBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LByteToFltFunction build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
