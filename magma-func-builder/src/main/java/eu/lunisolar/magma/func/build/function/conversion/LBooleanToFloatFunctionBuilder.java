...
public final class LBooleanToFloatFunctionBuilder extends PerCaseBuilderWithFloatProduct.Base<LBooleanToFloatFunctionBuilder, LBooleanUnaryOperator, LBooleanToFloatFunction> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LBooleanToFloatFunctionBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LBooleanToFloatFunction build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
