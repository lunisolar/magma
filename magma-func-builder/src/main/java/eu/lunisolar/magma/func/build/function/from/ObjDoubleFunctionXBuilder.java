...
public final class ObjDoubleFunctionXBuilder<T, R, X extends Exception> extends PerCaseBuilderWithProduct.Base<ObjDoubleFunctionXBuilder<T, R, X>, ObjDoublePredicateX<T, X>, ObjDoubleFunctionX<T, R, X>, R> {
