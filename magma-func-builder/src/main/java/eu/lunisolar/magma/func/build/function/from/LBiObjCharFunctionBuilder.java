...
public final class LBiObjCharFunctionBuilder<T1, T2, R> extends PerCaseBuilderWithProduct.Base<LBiObjCharFunctionBuilder<T1, T2, R>, LBiObjCharPredicate<T1, T2>, LBiObjCharFunction<T1, T2, R>, R> {
	...
	public static final LBiObjCharFunction EVENTUALLY_THROW = LBiObjCharFunction.l((Object a1, Object a2, char a3) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s ,%s  as function %s.", a1, a2, a3, LBiObjCharFunction.DESCRIPTION);
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LBiObjCharFunctionBuilder<T1, T2, R> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2> LBiObjCharFunctionBuilder<T1, T2, R> casesOf(Class<E1> argC1, Class<E2> argC2, Consumer<LBiObjCharFunctionBuilder<E1, E2, R>> pcpConsumer) {
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2> LBiObjCharFunctionBuilder<T1, T2, R> aCase(Class<E1> argC1, Class<E2> argC2, LBiObjCharFunction<E1, E2, R> function) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod((T1 a1, T2 a2, char a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LBiObjCharFunction<T1, T2, R> build() {
		...
		retval = LBiObjCharFunction.<T1, T2, R> l((T1 a1, T2 a2, char a3) -> {
			try {
	...
	public final LBiObjCharFunction<T1, T2, R> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
