...
public final class LBiObjCharFunctionBuilder<T1, T2, R> extends PerCaseBuilderWithProduct.Base<LBiObjCharFunctionBuilder<T1, T2, R>, LBiObjCharPredicate<T1, T2>, LBiObjCharFunction<T1, T2, R>, R> {
	...
	public static final LBiObjCharFunction EVENTUALLY_THROW = LBiObjCharFunction.l((Object t1, Object t2, char c) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s ,%s  as function %s.", t1, t2, c, LBiObjCharFunction.DESCRIPTION);
	...
	public final LBiObjCharFunction<T1, T2, R> build() {
		...
		retval = LBiObjCharFunction.<T1, T2, R> l((T1 t1, T2 t2, char c) -> {
			try {
