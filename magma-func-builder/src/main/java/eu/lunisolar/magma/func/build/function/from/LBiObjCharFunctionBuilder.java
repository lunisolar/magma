...
public final class LBiObjCharFunctionBuilder<T1, T2, R> extends PerCaseBuilderWithProduct.Base<LBiObjCharFunctionBuilder<T1, T2, R>, LBiObjCharPredicate<T1, T2>, LBiObjCharFunction<T1, T2, R>, R> {
	...
	public <V1 extends T1, V2 extends T2> LBiObjCharFunctionBuilder<T1, T2, R> forValue(T1 v1, T2 v2, char v3, LBiObjCharFunction<V1, V2, R> function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public <V1 extends T1, V2 extends T2> PartialCaseWithProduct.The<LBiObjCharFunctionBuilder<T1, T2, R>, LBiObjCharPredicate<T1, T2>, LBiObjCharFunction<T1, T2, R>, R> forValue(T1 v1, T2 v2, char v3) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjCharFunctionBuilder<T1, T2, R> forClass(Class<V1> argC1, Class<V2> argC2, LBiObjCharFunction<V1, V2, R> function) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
		pc.evaluate(function);
		return fluentCtx();
	}
	...
	/** Adds full new case for the argument that are of specific classes (matched by instanceOf, null is a wildcard). */
	@Nonnull
	public <V1 extends T1, V2 extends T2> PartialCaseWithProduct.The<LBiObjCharFunctionBuilder<T1, T2, R>, LBiObjCharPredicate<T1, T2>, LBiObjCharFunction<T1, T2, R>, R> forClass(Class<V1> argC1, Class<V2> argC2) {
