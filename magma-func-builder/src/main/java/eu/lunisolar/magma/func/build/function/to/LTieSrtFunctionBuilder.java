...
public final class LTieSrtFunctionBuilder<T> extends PerCaseBuilderWithIntProduct.Base<LTieSrtFunctionBuilder<T>, LObjIntSrtPredicate<T>, LTieSrtFunction<T>> {
	...
	public static final LTieSrtFunction EVENTUALLY_THROW = LTieSrtFunction.tieSrtFunc((a1, a2, a3) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LTieSrtFunctionBuilder(@Nullable Consumer<LTieSrtFunction<T>> consumer) {
		super(EVENTUALLY_THROW, LTieSrtFunction::constant, () -> new LTieSrtFunctionBuilder(null));
	...
	@Nonnull
	public static <T> LTieSrtFunction<T> tieSrtFunctionFrom(Function<LTieSrtFunctionBuilder<T>, LTieSrtFunction<T>> buildingFunction) {
		return buildingFunction.apply(new LTieSrtFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LTieSrtFunctionBuilder<T> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LTieSrtFunction<T> build() {
		...
		final LTieSrtFunction<T> eventuallyFinal = this.eventually;
	...
	public final LTieSrtFunction<T> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
