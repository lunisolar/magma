...
public abstract class PerCaseBuilderWithByteProduct<PCB extends PerCaseBuilderWithByteProduct<PCB, P, F, PC>, P, F, PC extends PartialCaseWithByteProduct<PC, PCB, P, F>> extends PerCaseBuilder<PCB, P, F, PC> {
	...
	protected PerCaseBuilderWithByteProduct(@Nonnull F eventually, @Nonnull LByteFunction<F> directToFunction, @Nonnull Supplier<PCB> subCasesFactory) {
	...
	protected PC partialCaseFactoryMethod(P casePredicate) {
		return (PC) new PartialCaseWithByteProduct(self(), casePredicate, subCasesFactory);
	}
	...
	public static abstract class Base<SELF extends Base<SELF, P, F>, P, F> extends PerCaseBuilderWithByteProduct<SELF, P, F, PartialCaseWithByteProduct.The<SELF, P, F>> {
		protected Base(@Nonnull F eventually, @Nonnull LByteFunction<F> directToFunction, @Nonnull Supplier<SELF> subCasesFactory) {
		...
		protected PartialCaseWithByteProduct.The<SELF, P, F> partialCaseFactoryMethod(P casePredicate) {
			return new PartialCaseWithByteProduct.The(this, casePredicate, subCasesFactory);
		}
	}
