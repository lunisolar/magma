...
public final class LObjBoolConsumerBuilder<T> extends PerCaseBuilder.Base<LObjBoolConsumerBuilder<T>, LObjBoolPredicate<T>, LObjBoolConsumer<T>> {
	...
	public static final LObjBoolConsumer EVENTUALLY_THROW = LObjBoolConsumer.l((Object a1, boolean a2) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s  as function %s.", a1, a2, LObjBoolConsumer.DESCRIPTION);
	...
	public final LObjBoolConsumer<T> build() {
		...
		retval = LObjBoolConsumer.<T> l((T a1, boolean a2) -> {
			try {
