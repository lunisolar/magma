...
public final class LObjBoolConsumerBuilder<T> extends PerCaseBuilder.Base<LObjBoolConsumerBuilder<T>, LObjBoolPredicate<T>, LObjBoolConsumer<T>> {
	...
	public static final LObjBoolConsumer EVENTUALLY_THROW = LObjBoolConsumer.l((a1, a2) -> {
	...
	@Nonnull
	public static <T> LObjBoolConsumer<T> objBoolConsumerFrom(Function<LObjBoolConsumerBuilder<T>, LObjBoolConsumer<T>> buildingFunction) {
		return buildingFunction.apply(new LObjBoolConsumerBuilder());
	}
	...
	@Nonnull
	public <V extends T> LObjBoolConsumerBuilder<T> aCase(Class<V> argC1, LObjBoolConsumer<V> function) {
		PartialCase.The pc = partialCaseFactoryMethod((a1, a2) -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LObjBoolConsumer<T> build() {
		...
		retval = LObjBoolConsumer.<T> l((a1, a2) -> {
			try {
