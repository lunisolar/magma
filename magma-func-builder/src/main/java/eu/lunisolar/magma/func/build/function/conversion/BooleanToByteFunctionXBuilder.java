...
public final class BooleanToByteFunctionXBuilder<X extends Exception> extends PerCaseBuilder<BooleanToByteFunctionXBuilder<X>, BooleanUnaryOperatorX<X>, BooleanToByteFunctionX<X>> {
