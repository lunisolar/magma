...
public final class BooleanToByteFunctionXBuilder<X extends Exception> extends PerCaseBuilderWithByteProduct<BooleanToByteFunctionXBuilder<X>, BooleanUnaryOperatorX<X>, BooleanToByteFunctionX<X>> {
