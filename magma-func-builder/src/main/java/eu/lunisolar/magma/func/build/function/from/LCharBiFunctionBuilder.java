...
public final class LCharBiFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LCharBiFunctionBuilder<R>, LBiCharPredicate, LCharBiFunction<R>, R> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LCharBiFunctionBuilder<R> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LCharBiFunction<R> build() {
		...
		retval = LCharBiFunction.<R> l((char c1, char c2) -> {
			try {
	...
	public final LCharBiFunction<R> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
