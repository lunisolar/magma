...
public final class LObjDoublePredicateBuilder<T> extends PerCaseBuilderWithBooleanProduct.Base<LObjDoublePredicateBuilder<T>, LObjDoublePredicate<T>, LObjDoublePredicate<T>> {
	...
	public static final LObjDoublePredicate EVENTUALLY_THROW = LObjDoublePredicate.l((Object t, double d) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s  as function %s.", t, d, LObjDoublePredicate.DESCRIPTION);
	...
	public LObjDoublePredicateBuilder(@Nullable Consumer<LObjDoublePredicate<T>> consumer) {
		super(EVENTUALLY_THROW, LObjDoublePredicate::constant);
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T> LObjDoublePredicateBuilder<T> objDoublePredicate() {
		return new LObjDoublePredicateBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T> LObjDoublePredicateBuilder<T> objDoublePredicate(Consumer<LObjDoublePredicate<T>> consumer) {
	...
	public final LObjDoublePredicate<T> build() {
		...
		retval = LObjDoublePredicate.<T> l((T t, double d) -> {
			try {
