...
public final class LObjDoublePredicateBuilder<T> extends PerCaseBuilderWithBoolProduct.Base<LObjDoublePredicateBuilder<T>, LObjDoublePredicate<T>, LObjDoublePredicate<T>> {
	...
	public static final LObjDoublePredicate EVENTUALLY_THROW = LObjDoublePredicate.l((a1, a2) -> {
	...
	@Nonnull
	public static <T> LObjDoublePredicate<T> objDoublePredicateFrom(Function<LObjDoublePredicateBuilder<T>, LObjDoublePredicate<T>> buildingFunction) {
		return buildingFunction.apply(new LObjDoublePredicateBuilder());
	}
	...
	@Nonnull
	public <V extends T> LObjDoublePredicateBuilder<T> casesOf(Class<V> argC1, Consumer<LObjDoublePredicateBuilder<V>> pcpConsumer) {
	...
	@Nonnull
	public <V extends T> LObjDoublePredicateBuilder<T> aCase(Class<V> argC1, LObjDoublePredicate<V> function) {
		PartialCaseWithBoolProduct.The pc = partialCaseFactoryMethod((a1, a2) -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LObjDoublePredicate<T> build() {
		...
		retval = LObjDoublePredicate.<T> l((a1, a2) -> {
			try {
