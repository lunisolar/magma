...
public final class BiObjIntConsumerBuilder<T1, T2> extends PerCaseBuilder.Base<BiObjIntConsumerBuilder<T1, T2>, BiObjIntPredicate<T1, T2>, BiObjIntConsumer<T1, T2>> {
