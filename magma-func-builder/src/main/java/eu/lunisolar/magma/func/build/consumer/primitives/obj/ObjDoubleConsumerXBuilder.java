...
public final class ObjDoubleConsumerXBuilder<T, X extends Exception> extends PerCaseBuilder.Base<ObjDoubleConsumerXBuilder<T, X>, ObjDoublePredicateX<T, X>, ObjDoubleConsumerX<T, X>> {
