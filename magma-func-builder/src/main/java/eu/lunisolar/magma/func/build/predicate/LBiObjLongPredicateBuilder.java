...
public final class LBiObjLongPredicateBuilder<T1, T2> extends PerCaseBuilderWithBooleanProduct.Base<LBiObjLongPredicateBuilder<T1, T2>, LBiObjLongPredicate<T1, T2>, LBiObjLongPredicate<T1, T2>> {
	...
	public static final LBiObjLongPredicate EVENTUALLY_THROW = LBiObjLongPredicate.l((Object a1, Object a2, long a3) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s ,%s  as function %s.", a1, a2, a3, LBiObjLongPredicate.DESCRIPTION);
	...
	public final LBiObjLongPredicate<T1, T2> build() {
		...
		retval = LBiObjLongPredicate.<T1, T2> l((T1 a1, T2 a2, long a3) -> {
			try {
