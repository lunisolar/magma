...
public final class CharBiFunctionXBuilder<R, X extends Exception> extends PerCaseBuilder<CharBiFunctionXBuilder<R, X>, BiCharPredicateX<X>, CharBiFunctionX<R, X>> {
