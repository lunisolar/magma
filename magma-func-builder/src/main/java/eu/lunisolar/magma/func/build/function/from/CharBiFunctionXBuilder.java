...
public final class CharBiFunctionXBuilder<R, X extends Exception> extends PerCaseBuilderWithProduct.Base<CharBiFunctionXBuilder<R, X>, BiCharPredicateX<X>, CharBiFunctionX<R, X>, R> {
