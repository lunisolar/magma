...
public final class LDoubleConsumerBuilder extends PerCaseBuilder.Base<LDoubleConsumerBuilder, LDoublePredicate, LDoubleConsumer> {
	...
	public static final LDoubleConsumer EVENTUALLY_THROW = LDoubleConsumer.l((double a1) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", a1, LDoubleConsumer.DESCRIPTION);
	...
	public LDoubleConsumerBuilder(@Nullable Consumer<LDoubleConsumer> consumer) {
		super(EVENTUALLY_THROW, () -> new LDoubleConsumerBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static LDoubleConsumerBuilder doubleConsumer() {
		return new LDoubleConsumerBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static LDoubleConsumerBuilder doubleConsumer(Consumer<LDoubleConsumer> consumer) {
		return new LDoubleConsumerBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LDoubleConsumerBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LDoubleConsumer build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
