...
public final class LDoubleConsumerBuilder extends PerCaseBuilder.Base<LDoubleConsumerBuilder, LDoublePredicate, LDoubleConsumer> {
	...
	@Nonnull
	public static LDoubleConsumer doubleConsumerFrom(Function<LDoubleConsumerBuilder, LDoubleConsumer> buildingFunction) {
		return buildingFunction.apply(new LDoubleConsumerBuilder());
	}
