...
public final class LBiObjCharPredicateBuilder<T1, T2> extends PerCaseBuilderWithBoolProduct.Base<LBiObjCharPredicateBuilder<T1, T2>, LBiObjCharPredicate<T1, T2>, LBiObjCharPredicate<T1, T2>> {
	...
	@Nonnull
	public static <T1, T2> LBiObjCharPredicate<T1, T2> biObjCharPredicateFrom(Function<LBiObjCharPredicateBuilder<T1, T2>, LBiObjCharPredicate<T1, T2>> buildingFunction) {
		return buildingFunction.apply(new LBiObjCharPredicateBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LBiObjCharPredicateBuilder<T1, T2> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LBiObjCharPredicate<T1, T2> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
