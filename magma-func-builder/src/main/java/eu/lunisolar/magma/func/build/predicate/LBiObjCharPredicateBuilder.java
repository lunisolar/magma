...
public final class LBiObjCharPredicateBuilder<T1, T2> extends PerCaseBuilderWithBooleanProduct.Base<LBiObjCharPredicateBuilder<T1, T2>, LBiObjCharPredicate<T1, T2>, LBiObjCharPredicate<T1, T2>> {
	...
	public static final LBiObjCharPredicate EVENTUALLY_THROW = LBiObjCharPredicate.l((Object a1, Object a2, char a3) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s ,%s  as function %s.", a1, a2, a3, LBiObjCharPredicate.DESCRIPTION);
	...
	public final LBiObjCharPredicate<T1, T2> build() {
		...
		retval = LBiObjCharPredicate.<T1, T2> l((T1 a1, T2 a2, char a3) -> {
			try {
