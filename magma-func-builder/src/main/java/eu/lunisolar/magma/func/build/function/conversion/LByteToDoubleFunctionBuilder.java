...
public final class LByteToDoubleFunctionBuilder extends PerCaseBuilderWithDoubleProduct.Base<LByteToDoubleFunctionBuilder, LBytePredicate, LByteToDoubleFunction> {
	...
	public static final LByteToDoubleFunction EVENTUALLY_THROW = LByteToDoubleFunction.l((byte a1) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", a1, LByteToDoubleFunction.DESCRIPTION);
