...
public final class LByteUnaryOperatorBuilder extends PerCaseBuilderWithByteProduct.Base<LByteUnaryOperatorBuilder, LBytePredicate, LByteUnaryOperator> {
	...
	public static final LByteUnaryOperator EVENTUALLY_THROW = LByteUnaryOperator.l((byte a1) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", a1, LByteUnaryOperator.DESCRIPTION);
