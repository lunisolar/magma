...
public final class LByteUnaryOperatorBuilder extends PerCaseBuilderWithByteProduct.Base<LByteUnaryOperatorBuilder, LBytePredicate, LByteUnaryOperator> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LByteUnaryOperatorBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public LByteUnaryOperatorBuilder forValue(byte v, LByteUnaryOperator function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithByteProduct.The<LByteUnaryOperatorBuilder, LBytePredicate, LByteUnaryOperator> forValue(byte v) {
	...
	public final LByteUnaryOperator build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
