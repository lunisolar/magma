...
public final class LObjShortPredicateXBuilder<T, X extends Throwable> extends PerCaseBuilderWithBoolProduct.Base<LObjShortPredicateXBuilder<T, X>, LObjShortPredicateX<T, X>, LObjShortPredicateX<T, X>> {
	...
	public static final LObjShortPredicateX EVENTUALLY_THROW = LObjShortPredicateX.lX((a1, a2) -> {
	...
	@Nonnull
	public static <T, X extends Throwable> LObjShortPredicateX<T, X> objShortPredicateXFrom(Function<LObjShortPredicateXBuilder<T, X>, LObjShortPredicateX<T, X>> buildingFunction) {
		return buildingFunction.apply(new LObjShortPredicateXBuilder());
	}
	...
	@Nonnull
	public <V extends T> LObjShortPredicateXBuilder<T, X> casesOf(Class<V> argC1, Consumer<LObjShortPredicateXBuilder<V, X>> pcpConsumer) {
	...
	@Nonnull
	public <V extends T> LObjShortPredicateXBuilder<T, X> aCase(Class<V> argC1, LObjShortPredicateX<V, X> function) {
		PartialCaseWithBoolProduct.The pc = partialCaseFactoryMethod((a1, a2) -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LObjShortPredicateX<T, X> build() {
		...
		retval = LObjShortPredicateX.<T, X> lX((a1, a2) -> {
			try {
