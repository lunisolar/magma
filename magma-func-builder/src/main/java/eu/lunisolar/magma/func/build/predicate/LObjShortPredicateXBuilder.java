...
public final class LObjShortPredicateXBuilder<T, X extends Throwable> extends PerCaseBuilderWithBooleanProduct.Base<LObjShortPredicateXBuilder<T, X>, LObjShortPredicateX<T, X>, LObjShortPredicateX<T, X>> {
	...
	public static final LObjShortPredicateX EVENTUALLY_THROW = LObjShortPredicateX.lX((Object a1, short a2) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s  as function %s.", a1, a2, LObjShortPredicateX.DESCRIPTION);
	...
	public final LObjShortPredicateX<T, X> build() {
		...
		retval = LObjShortPredicateX.<T, X> lX((T a1, short a2) -> {
			try {
