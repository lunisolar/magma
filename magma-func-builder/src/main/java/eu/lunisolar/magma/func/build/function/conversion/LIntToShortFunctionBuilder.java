...
public final class LIntToShortFunctionBuilder extends PerCaseBuilderWithShortProduct.Base<LIntToShortFunctionBuilder, LIntPredicate, LIntToShortFunction> {
	...
	private Consumer<LIntToShortFunction> consumer;

	private @Nullable HandlingInstructions handling;

	public static final LIntToShortFunction EVENTUALLY_THROW = LIntToShortFunction.l(a -> {
	...
	public LIntToShortFunctionBuilder() {
		this(null);
	}
	...
	@Nonnull
	public static LIntToShortFunction intToShortFunctionFrom(Function<LIntToShortFunctionBuilder, LIntToShortFunction> buildingFunction) {
		return buildingFunction.apply(new LIntToShortFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LIntToShortFunctionBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	@Nonnull
	public final LIntToShortFunction build() {

		final LIntToShortFunction eventuallyFinal = this.eventually;

		LIntToShortFunction retval;

		final Case<LIntPredicate, LIntToShortFunction>[] casesArray = cases.toArray(new Case[cases.size()]);
		retval = LIntToShortFunction.l(a -> {
			try {
	...
	public final LIntToShortFunction build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
