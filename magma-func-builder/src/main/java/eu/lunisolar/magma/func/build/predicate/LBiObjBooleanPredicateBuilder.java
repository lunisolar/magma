...
public final class LBiObjBooleanPredicateBuilder<T1, T2> extends PerCaseBuilderWithBooleanProduct.Base<LBiObjBooleanPredicateBuilder<T1, T2>, LBiObjBooleanPredicate<T1, T2>, LBiObjBooleanPredicate<T1, T2>> {
	...
	public LBiObjBooleanPredicateBuilder(@Nullable Consumer<LBiObjBooleanPredicate<T1, T2>> consumer) {
		super(EVENTUALLY_THROW, LBiObjBooleanPredicate::constant, () -> new LBiObjBooleanPredicateBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <T1, T2> LBiObjBooleanPredicateBuilder<T1, T2> biObjBooleanPredicate() {
		return new LBiObjBooleanPredicateBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <T1, T2> LBiObjBooleanPredicateBuilder<T1, T2> biObjBooleanPredicate(Consumer<LBiObjBooleanPredicate<T1, T2>> consumer) {
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2> LBiObjBooleanPredicateBuilder<T1, T2> casesOf(Class<E1> argC1, Class<E2> argC2, Consumer<LBiObjBooleanPredicateBuilder<E1, E2>> pcpConsumer) {
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2> LBiObjBooleanPredicateBuilder<T1, T2> aCase(Class<E1> argC1, Class<E2> argC2, LBiObjBooleanPredicate<E1, E2> function) {
		PartialCaseWithBooleanProduct.The pc = partialCaseFactoryMethod((T1 t1, T2 t2, boolean b) -> (argC1 == null || argC1.isInstance(t1)) && (argC2 == null || argC2.isInstance(t2)));
	...
	public final LBiObjBooleanPredicate<T1, T2> build() {
		...
		retval = LBiObjBooleanPredicate.<T1, T2> l((T1 t1, T2 t2, boolean b) -> {
			try {
