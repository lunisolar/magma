...
public final class LBoolToLongFunctionBuilder extends PerCaseBuilderWithLongProduct.Base<LBoolToLongFunctionBuilder, LLogicalOperator, LBoolToLongFunction> {
	...
	private Consumer<LBoolToLongFunction> consumer;
	...
	public LBoolToLongFunctionBuilder() {
		this(null);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static LBoolToLongFunctionBuilder boolToLongFunction() {
		return new LBoolToLongFunctionBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static LBoolToLongFunction boolToLongFunctionFrom(Consumer<LBoolToLongFunctionBuilder> buildingFunction) {
		LBoolToLongFunctionBuilder builder = new LBoolToLongFunctionBuilder();
	...
	@Nonnull
	public static LBoolToLongFunctionBuilder boolToLongFunction(Consumer<LBoolToLongFunction> consumer) {
		return new LBoolToLongFunctionBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LBoolToLongFunctionBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public LBoolToLongFunctionBuilder forValue(boolean v, LBoolToLongFunction function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithLongProduct.The<LBoolToLongFunctionBuilder, LLogicalOperator, LBoolToLongFunction> forValue(boolean v) {
	...
	public final LBoolToLongFunction build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
