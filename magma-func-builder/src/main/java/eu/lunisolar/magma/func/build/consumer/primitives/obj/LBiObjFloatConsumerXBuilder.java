...
public final class LBiObjFloatConsumerXBuilder<T1, T2, X extends Throwable> extends PerCaseBuilder.Base<LBiObjFloatConsumerXBuilder<T1, T2, X>, LBiObjFloatPredicateX<T1, T2, X>, LBiObjFloatConsumerX<T1, T2, X>> {
	...
	public static final LBiObjFloatConsumerX EVENTUALLY_THROW = LBiObjFloatConsumerX.lX((Object a1, Object a2, float a3) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s ,%s  as function %s.", a1, a2, a3, LBiObjFloatConsumerX.DESCRIPTION);
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2> LBiObjFloatConsumerXBuilder<T1, T2, X> casesOf(Class<E1> argC1, Class<E2> argC2, Consumer<LBiObjFloatConsumerXBuilder<E1, E2, X>> pcpConsumer) {
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2> LBiObjFloatConsumerXBuilder<T1, T2, X> aCase(Class<E1> argC1, Class<E2> argC2, LBiObjFloatConsumerX<E1, E2, X> function) {
		PartialCase.The pc = partialCaseFactoryMethod((T1 a1, T2 a2, float a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LBiObjFloatConsumerX<T1, T2, X> build() {
		...
		retval = LBiObjFloatConsumerX.<T1, T2, X> lX((T1 a1, T2 a2, float a3) -> {
			try {
