...
public final class LBiObjFloatConsumerXBuilder<T1, T2, X extends Exception> extends PerCaseBuilder.Base<LBiObjFloatConsumerXBuilder<T1, T2, X>, LBiObjFloatPredicateX<T1, T2, X>, LBiObjFloatConsumerX<T1, T2, X>> {

	private Consumer<LBiObjFloatConsumerX<T1, T2, X>> consumer;

	public static final LBiObjFloatConsumerX EVENTUALLY_THROW = LBiObjFloatConsumerX.lX((Object t1, Object t2, float f) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s ,%s  as function %s.", t1, t2, f, LBiObjFloatConsumerX.DESCRIPTION);
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T1, T2, X extends Exception> LBiObjFloatConsumerXBuilder<T1, T2, X> biObjFloatConsumerX() {
		return new LBiObjFloatConsumerXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T1, T2, X extends Exception> LBiObjFloatConsumerXBuilder<T1, T2, X> biObjFloatConsumerX(Consumer<LBiObjFloatConsumerX<T1, T2, X>> consumer) {
	...
	public final LBiObjFloatConsumerX<T1, T2, X> build() {
		...
		if (cases.isEmpty()) {
			...
			retval = LBiObjFloatConsumerX.lX((T1 t1, T2 t2, float f) -> {
