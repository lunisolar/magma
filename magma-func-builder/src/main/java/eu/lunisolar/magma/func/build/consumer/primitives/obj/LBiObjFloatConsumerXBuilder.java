...
public final class LBiObjFloatConsumerXBuilder<T1, T2, X extends Throwable> extends PerCaseBuilder.Base<LBiObjFloatConsumerXBuilder<T1, T2, X>, LBiObjFloatPredicateX<T1, T2, X>, LBiObjFloatConsumerX<T1, T2, X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T1, T2, X extends Throwable> LBiObjFloatConsumerXBuilder<T1, T2, X> biObjFloatConsumerX() {
		return new LBiObjFloatConsumerXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T1, T2, X extends Throwable> LBiObjFloatConsumerXBuilder<T1, T2, X> biObjFloatConsumerX(Consumer<LBiObjFloatConsumerX<T1, T2, X>> consumer) {
