...
public final class LBiIntConsumerXBuilder<X extends Throwable> extends PerCaseBuilder.Base<LBiIntConsumerXBuilder<X>, LBiIntPredicateX<X>, LBiIntConsumerX<X>> {
	...
	public static final LBiIntConsumerX EVENTUALLY_THROW = LBiIntConsumerX.lX((a1, a2) -> {
	...
	@Nonnull
	public static <X extends Throwable> LBiIntConsumerX<X> biIntConsumerXFrom(Function<LBiIntConsumerXBuilder<X>, LBiIntConsumerX<X>> buildingFunction) {
		return buildingFunction.apply(new LBiIntConsumerXBuilder());
	}
	...
	public final LBiIntConsumerX<X> build() {
		...
		retval = LBiIntConsumerX.<X> lX((a1, a2) -> {
			try {
