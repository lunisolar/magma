...
public final class ObjCharFunctionXBuilder<T, R, X extends Exception> extends PerCaseBuilder<ObjCharFunctionXBuilder<T, R, X>, ObjCharPredicateX<T, X>, ObjCharFunctionX<T, R, X>> {
