...
public final class ObjCharFunctionXBuilder<T, R, X extends Exception> extends PerCaseBuilderWithProduct.Base<ObjCharFunctionXBuilder<T, R, X>, ObjCharPredicateX<T, X>, ObjCharFunctionX<T, R, X>, R> {
