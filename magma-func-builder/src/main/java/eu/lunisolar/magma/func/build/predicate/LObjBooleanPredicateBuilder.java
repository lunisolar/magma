...
public final class LObjBooleanPredicateBuilder<T> extends PerCaseBuilderWithBooleanProduct.Base<LObjBooleanPredicateBuilder<T>, LObjBooleanPredicate<T>, LObjBooleanPredicate<T>> {
	...
	public LObjBooleanPredicateBuilder(@Nullable Consumer<LObjBooleanPredicate<T>> consumer) {
		super(EVENTUALLY_THROW, LObjBooleanPredicate::constant, () -> new LObjBooleanPredicateBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <T> LObjBooleanPredicateBuilder<T> objBooleanPredicate() {
		return new LObjBooleanPredicateBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <T> LObjBooleanPredicateBuilder<T> objBooleanPredicate(Consumer<LObjBooleanPredicate<T>> consumer) {
	...
	@Nonnull
	public <E1 extends T> LObjBooleanPredicateBuilder<T> casesOf(Class<E1> argC1, Consumer<LObjBooleanPredicateBuilder<E1>> pcpConsumer) {
	...
	@Nonnull
	public <E1 extends T> LObjBooleanPredicateBuilder<T> aCase(Class<E1> argC1, LObjBooleanPredicate<E1> function) {
		PartialCaseWithBooleanProduct.The pc = partialCaseFactoryMethod((T t, boolean b) -> (argC1 == null || argC1.isInstance(t)));
