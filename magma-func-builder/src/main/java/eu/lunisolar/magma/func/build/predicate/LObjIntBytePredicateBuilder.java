...
public final class LObjIntBytePredicateBuilder<T> extends PerCaseBuilderWithBoolProduct.Base<LObjIntBytePredicateBuilder<T>, LObjIntBytePredicate<T>, LObjIntBytePredicate<T>> {
	...
	public static final LObjIntBytePredicate EVENTUALLY_THROW = LObjIntBytePredicate.objIntBytePred((a1, a2, a3) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LObjIntBytePredicateBuilder(@Nullable Consumer<LObjIntBytePredicate<T>> consumer) {
		super(EVENTUALLY_THROW, LObjIntBytePredicate::constant, () -> new LObjIntBytePredicateBuilder(null));
	...
	@Nonnull
	public static <T> LObjIntBytePredicate<T> objIntBytePredicateFrom(Function<LObjIntBytePredicateBuilder<T>, LObjIntBytePredicate<T>> buildingFunction) {
		return buildingFunction.apply(new LObjIntBytePredicateBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LObjIntBytePredicateBuilder<T> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LObjIntBytePredicate<T> build() {
		...
		final LObjIntBytePredicate<T> eventuallyFinal = this.eventually;
	...
	public final LObjIntBytePredicate<T> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
