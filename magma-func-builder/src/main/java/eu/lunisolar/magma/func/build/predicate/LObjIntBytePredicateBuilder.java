...
public final class LObjIntBytePredicateBuilder<T> extends PerCaseBuilderWithBoolProduct.Base<LObjIntBytePredicateBuilder<T>, LObjIntBytePredicate<T>, LObjIntBytePredicate<T>> {
	...
	public <V extends T> LObjIntBytePredicateBuilder<T> forValue(T v1, int v2, byte v3, LObjIntBytePredicate<V> function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public <V extends T> PartialCaseWithBoolProduct.The<LObjIntBytePredicateBuilder<T>, LObjIntBytePredicate<T>, LObjIntBytePredicate<T>> forValue(T v1, int v2, byte v3) {
	...
	@Nonnull
	public <V extends T> LObjIntBytePredicateBuilder<T> forClass(Class<V> argC1, LObjIntBytePredicate<V> function) {
		PartialCaseWithBoolProduct.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)));
		pc.evaluate(function);
		return fluentCtx();
	}
	...
	/** Adds full new case for the argument that are of specific classes (matched by instanceOf, null is a wildcard). */
	@Nonnull
	public <V extends T> PartialCaseWithBoolProduct.The<LObjIntBytePredicateBuilder<T>, LObjIntBytePredicate<T>, LObjIntBytePredicate<T>> forClass(Class<V> argC1) {
