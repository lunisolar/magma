...
public final class LBooleanTriFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LBooleanTriFunctionBuilder<R>, LBooleanTernaryOperator, LBooleanTriFunction<R>, R> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LBooleanTriFunctionBuilder<R> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LBooleanTriFunction<R> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
