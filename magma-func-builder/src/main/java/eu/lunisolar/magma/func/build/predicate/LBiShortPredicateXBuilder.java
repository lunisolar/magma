...
public final class LBiShortPredicateXBuilder<X extends Throwable> extends PerCaseBuilderWithBoolProduct.Base<LBiShortPredicateXBuilder<X>, LBiShortPredicateX<X>, LBiShortPredicateX<X>> {
	...
	public static final LBiShortPredicateX EVENTUALLY_THROW = LBiShortPredicateX.lX((a1, a2) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LBiShortPredicateXBuilder(@Nullable Consumer<LBiShortPredicateX<X>> consumer) {
		super(EVENTUALLY_THROW, LBiShortPredicateX::constant, () -> new LBiShortPredicateXBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <X extends Throwable> LBiShortPredicateXBuilder<X> biShortPredicateX() {
		return new LBiShortPredicateXBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static <X extends Throwable> LBiShortPredicateX<X> biShortPredicateXFrom(Function<LBiShortPredicateXBuilder<X>, LBiShortPredicateX<X>> buildingFunction) {
		return buildingFunction.apply(new LBiShortPredicateXBuilder());
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <X extends Throwable> LBiShortPredicateXBuilder<X> biShortPredicateX(Consumer<LBiShortPredicateX<X>> consumer) {
	...
	public final LBiShortPredicateX<X> build() {
		...
		retval = LBiShortPredicateX.<X> lX((a1, a2) -> {
			try {
