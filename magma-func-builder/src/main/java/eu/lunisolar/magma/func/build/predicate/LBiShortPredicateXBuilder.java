...
public final class LBiShortPredicateXBuilder<X extends Exception> extends PerCaseBuilderWithBooleanProduct.Base<LBiShortPredicateXBuilder<X>, LBiShortPredicateX<X>, LBiShortPredicateX<X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Exception> LBiShortPredicateXBuilder<X> biShortPredicateX() {
		return new LBiShortPredicateXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Exception> LBiShortPredicateXBuilder<X> biShortPredicateX(Consumer<LBiShortPredicateX<X>> consumer) {
