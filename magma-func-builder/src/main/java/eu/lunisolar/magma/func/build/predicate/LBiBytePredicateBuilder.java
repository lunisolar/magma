...
public final class LBiBytePredicateBuilder extends PerCaseBuilderWithBoolProduct.Base<LBiBytePredicateBuilder, LBiBytePredicate, LBiBytePredicate> {
	...
	public static final LBiBytePredicate OTHERWISE_THROW = LBiBytePredicate.biBytePred((a1, a2) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LBiBytePredicateBuilder(@Nullable Consumer<LBiBytePredicate> consumer) {
		super(OTHERWISE_THROW, LBiBytePredicate::constant, () -> new LBiBytePredicateBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LBiBytePredicateBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public LBiBytePredicateBuilder forValue(byte v1, byte v2, LBiBytePredicate function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithBoolProduct.The<LBiBytePredicateBuilder, LBiBytePredicate, LBiBytePredicate> forValue(byte v1, byte v2) {
	...
	public final LBiBytePredicate build() {
		...
		final LBiBytePredicate otherwiseFinal = this.otherwise;
	...
	public final LBiBytePredicate build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
