...
public final class LConsumerBuilder<T> extends PerCaseBuilder.Base<LConsumerBuilder<T>, LPredicate<T>, LConsumer<T>> {
	...
	public static final LConsumer EVENTUALLY_THROW = LConsumer.l((Object a1) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", a1, LConsumer.DESCRIPTION);
	...
	public LConsumerBuilder(@Nullable Consumer<LConsumer<T>> consumer) {
		super(EVENTUALLY_THROW, () -> new LConsumerBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LConsumerBuilder<T> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	@Nonnull
	public <E1 extends T> LConsumerBuilder<T> casesOf(Class<E1> argC1, Consumer<LConsumerBuilder<E1>> pcpConsumer) {
	...
	@Nonnull
	public <E1 extends T> LConsumerBuilder<T> aCase(Class<E1> argC1, LConsumer<E1> function) {
		PartialCase.The pc = partialCaseFactoryMethod(a1 -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LConsumer<T> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
