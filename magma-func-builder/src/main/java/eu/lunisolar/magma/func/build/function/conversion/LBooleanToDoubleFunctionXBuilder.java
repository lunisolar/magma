...
public final class LBooleanToDoubleFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithDoubleProduct.Base<LBooleanToDoubleFunctionXBuilder<X>, LLogicalOperatorX<X>, LBooleanToDoubleFunctionX<X>> {
	...
	public LBooleanToDoubleFunctionXBuilder(@Nullable Consumer<LBooleanToDoubleFunctionX<X>> consumer) {
		super(EVENTUALLY_THROW, LBooleanToDoubleFunctionX::constant, () -> new LBooleanToDoubleFunctionXBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <X extends Throwable> LBooleanToDoubleFunctionXBuilder<X> booleanToDoubleFunctionX() {
		return new LBooleanToDoubleFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <X extends Throwable> LBooleanToDoubleFunctionXBuilder<X> booleanToDoubleFunctionX(Consumer<LBooleanToDoubleFunctionX<X>> consumer) {
	...
	public final LBooleanToDoubleFunctionX<X> build() {
		...
		final Case<LLogicalOperatorX<X>, LBooleanToDoubleFunctionX<X>>[] casesArray = cases.toArray(new Case[cases.size()]);
		retval = LBooleanToDoubleFunctionX.<X> lX(b -> {
			try {
				for (Case<LLogicalOperatorX<X>, LBooleanToDoubleFunctionX<X>> aCase : casesArray) {
