...
public final class LObjIntPredicateBuilder<T> extends PerCaseBuilderWithBoolProduct.Base<LObjIntPredicateBuilder<T>, LObjIntPredicate<T>, LObjIntPredicate<T>> {
	...
	public static final LObjIntPredicate EVENTUALLY_THROW = LObjIntPredicate.l((a1, a2) -> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LObjIntPredicateBuilder<T> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LObjIntPredicate<T> build() {
		...
		retval = LObjIntPredicate.<T> l((a1, a2) -> {
			try {
	...
	public final LObjIntPredicate<T> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
