...
public final class LByteToShortFunctionXBuilder<X extends Exception> extends PerCaseBuilderWithShortProduct.Base<LByteToShortFunctionXBuilder<X>, LBytePredicateX<X>, LByteToShortFunctionX<X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Exception> LByteToShortFunctionXBuilder<X> byteToShortFunctionX() {
		return new LByteToShortFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Exception> LByteToShortFunctionXBuilder<X> byteToShortFunctionX(Consumer<LByteToShortFunctionX<X>> consumer) {
