...
public final class LByteToShortFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithShortProduct.Base<LByteToShortFunctionXBuilder<X>, LBytePredicateX<X>, LByteToShortFunctionX<X>> {
	...
	public static final LByteToShortFunctionX EVENTUALLY_THROW = LByteToShortFunctionX.lX(a1 -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LByteToShortFunctionXBuilder(@Nullable Consumer<LByteToShortFunctionX<X>> consumer) {
		super(EVENTUALLY_THROW, LByteToShortFunctionX::constant, () -> new LByteToShortFunctionXBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <X extends Throwable> LByteToShortFunctionXBuilder<X> byteToShortFunctionX() {
		return new LByteToShortFunctionXBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static <X extends Throwable> LByteToShortFunctionX<X> byteToShortFunctionXFrom(Function<LByteToShortFunctionXBuilder<X>, LByteToShortFunctionX<X>> buildingFunction) {
		return buildingFunction.apply(new LByteToShortFunctionXBuilder());
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <X extends Throwable> LByteToShortFunctionXBuilder<X> byteToShortFunctionX(Consumer<LByteToShortFunctionX<X>> consumer) {
	...
	public final LByteToShortFunctionX<X> build() {
		...
		retval = LByteToShortFunctionX.<X> lX(a1 -> {
			try {
