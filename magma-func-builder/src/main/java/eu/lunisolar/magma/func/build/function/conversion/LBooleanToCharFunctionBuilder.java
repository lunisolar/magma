...
public final class LBooleanToCharFunctionBuilder extends PerCaseBuilderWithCharProduct.Base<LBooleanToCharFunctionBuilder, LBooleanUnaryOperator, LBooleanToCharFunction> {
	...
	public static final LBooleanToCharFunction EVENTUALLY_THROW = LBooleanToCharFunction.l((boolean b) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", b, LBooleanToCharFunction.DESCRIPTION);
	...
	public LBooleanToCharFunctionBuilder() {
		this(null);
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LBooleanToCharFunctionBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	@Nonnull
	public final LBooleanToCharFunction build() {

		final LBooleanToCharFunction eventuallyFinal = this.eventually;
	...
	public final LBooleanToCharFunction build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
