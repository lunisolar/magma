...
public final class LLogicalBinaryOperatorBuilder extends PerCaseBuilderWithBooleanProduct.Base<LLogicalBinaryOperatorBuilder, LLogicalBinaryOperator, LLogicalBinaryOperator> {
	...
	public LLogicalBinaryOperatorBuilder(@Nullable Consumer<LLogicalBinaryOperator> consumer) {
		super(EVENTUALLY_THROW, LLogicalBinaryOperator::constant);
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final LLogicalBinaryOperatorBuilder logicalBinaryOperator() {
		return new LLogicalBinaryOperatorBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final LLogicalBinaryOperatorBuilder logicalBinaryOperator(Consumer<LLogicalBinaryOperator> consumer) {
