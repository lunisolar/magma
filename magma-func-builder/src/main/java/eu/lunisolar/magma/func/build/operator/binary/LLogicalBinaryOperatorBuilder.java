...
public final class LLogicalBinaryOperatorBuilder extends PerCaseBuilderWithBoolProduct.Base<LLogicalBinaryOperatorBuilder, LLogicalBinaryOperator, LLogicalBinaryOperator> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LLogicalBinaryOperatorBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public LLogicalBinaryOperatorBuilder forValue(boolean v1, boolean v2, LLogicalBinaryOperator function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithBoolProduct.The<LLogicalBinaryOperatorBuilder, LLogicalBinaryOperator, LLogicalBinaryOperator> forValue(boolean v1, boolean v2) {
	...
	public final LLogicalBinaryOperator build() {
		...
		retval = LLogicalBinaryOperator.logicalBinaryOp((a1, a2) -> {
			try {
	...
	public final LLogicalBinaryOperator build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
