...
public final class LBiObjShortConsumerBuilder<T1, T2> extends PerCaseBuilder.Base<LBiObjShortConsumerBuilder<T1, T2>, LBiObjShortPredicate<T1, T2>, LBiObjShortConsumer<T1, T2>> {
	...
	public static final LBiObjShortConsumer EVENTUALLY_THROW = LBiObjShortConsumer.l((Object a1, Object a2, short a3) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s ,%s  as function %s.", a1, a2, a3, LBiObjShortConsumer.DESCRIPTION);
	...
	public LBiObjShortConsumerBuilder(@Nullable Consumer<LBiObjShortConsumer<T1, T2>> consumer) {
		super(EVENTUALLY_THROW, () -> new LBiObjShortConsumerBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <T1, T2> LBiObjShortConsumerBuilder<T1, T2> biObjShortConsumer() {
		return new LBiObjShortConsumerBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <T1, T2> LBiObjShortConsumerBuilder<T1, T2> biObjShortConsumer(Consumer<LBiObjShortConsumer<T1, T2>> consumer) {
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2> LBiObjShortConsumerBuilder<T1, T2> casesOf(Class<E1> argC1, Class<E2> argC2, Consumer<LBiObjShortConsumerBuilder<E1, E2>> pcpConsumer) {
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2> LBiObjShortConsumerBuilder<T1, T2> aCase(Class<E1> argC1, Class<E2> argC2, LBiObjShortConsumer<E1, E2> function) {
		PartialCase.The pc = partialCaseFactoryMethod((T1 a1, T2 a2, short a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LBiObjShortConsumer<T1, T2> build() {
		...
		retval = LBiObjShortConsumer.<T1, T2> l((T1 a1, T2 a2, short a3) -> {
			try {
