...
public final class LBiObjShortConsumerBuilder<T1, T2> extends PerCaseBuilder.Base<LBiObjShortConsumerBuilder<T1, T2>, LBiObjShortPredicate<T1, T2>, LBiObjShortConsumer<T1, T2>> {
	...
	public static final LBiObjShortConsumer EVENTUALLY_THROW = LBiObjShortConsumer.l((a1, a2, a3) -> {
	...
	@Nonnull
	public static <T1, T2> LBiObjShortConsumer<T1, T2> biObjShortConsumerFrom(Function<LBiObjShortConsumerBuilder<T1, T2>, LBiObjShortConsumer<T1, T2>> buildingFunction) {
		return buildingFunction.apply(new LBiObjShortConsumerBuilder());
	}
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjShortConsumerBuilder<T1, T2> casesOf(Class<V1> argC1, Class<V2> argC2, Consumer<LBiObjShortConsumerBuilder<V1, V2>> pcpConsumer) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjShortConsumerBuilder<T1, T2> aCase(Class<V1> argC1, Class<V2> argC2, LBiObjShortConsumer<V1, V2> function) {
		PartialCase.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LBiObjShortConsumer<T1, T2> build() {
		...
		retval = LBiObjShortConsumer.<T1, T2> l((a1, a2, a3) -> {
			try {
