...
public final class LBiBytePredicateXBuilder<X extends Throwable> extends PerCaseBuilderWithBoolProduct.Base<LBiBytePredicateXBuilder<X>, LBiBytePredicateX<X>, LBiBytePredicateX<X>> {
	...
	public static final LBiBytePredicateX EVENTUALLY_THROW = LBiBytePredicateX.lX((a1, a2) -> {
	...
	@Nonnull
	public static <X extends Throwable> LBiBytePredicateX<X> biBytePredicateXFrom(Function<LBiBytePredicateXBuilder<X>, LBiBytePredicateX<X>> buildingFunction) {
		return buildingFunction.apply(new LBiBytePredicateXBuilder());
	}
	...
	public final LBiBytePredicateX<X> build() {
		...
		retval = LBiBytePredicateX.<X> lX((a1, a2) -> {
			try {
