...
public final class LBiObjShortFunctionXBuilder<T1, T2, R, X extends Exception> extends PerCaseBuilderWithProduct.Base<LBiObjShortFunctionXBuilder<T1, T2, R, X>, LBiObjShortPredicateX<T1, T2, X>, LBiObjShortFunctionX<T1, T2, R, X>, R> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T1, T2, R, X extends Exception> LBiObjShortFunctionXBuilder<T1, T2, R, X> biObjShortFunctionX() {
		return new LBiObjShortFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T1, T2, R, X extends Exception> LBiObjShortFunctionXBuilder<T1, T2, R, X> biObjShortFunctionX(Consumer<LBiObjShortFunctionX<T1, T2, R, X>> consumer) {
