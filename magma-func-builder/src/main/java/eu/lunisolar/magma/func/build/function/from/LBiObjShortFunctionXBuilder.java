...
public final class LBiObjShortFunctionXBuilder<T1, T2, R, X extends Throwable> extends PerCaseBuilderWithProduct.Base<LBiObjShortFunctionXBuilder<T1, T2, R, X>, LBiObjShortPredicateX<T1, T2, X>, LBiObjShortFunctionX<T1, T2, R, X>, R> {
	...
	public static final LBiObjShortFunctionX EVENTUALLY_THROW = LBiObjShortFunctionX.lX((a1, a2, a3) -> {
	...
	@Nonnull
	public static <T1, T2, R, X extends Throwable> LBiObjShortFunctionX<T1, T2, R, X> biObjShortFunctionXFrom(Function<LBiObjShortFunctionXBuilder<T1, T2, R, X>, LBiObjShortFunctionX<T1, T2, R, X>> buildingFunction) {
		return buildingFunction.apply(new LBiObjShortFunctionXBuilder());
	}
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjShortFunctionXBuilder<T1, T2, R, X> casesOf(Class<V1> argC1, Class<V2> argC2, Consumer<LBiObjShortFunctionXBuilder<V1, V2, R, X>> pcpConsumer) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjShortFunctionXBuilder<T1, T2, R, X> aCase(Class<V1> argC1, Class<V2> argC2, LBiObjShortFunctionX<V1, V2, R, X> function) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LBiObjShortFunctionX<T1, T2, R, X> build() {
		...
		retval = LBiObjShortFunctionX.<T1, T2, R, X> lX((a1, a2, a3) -> {
			try {
