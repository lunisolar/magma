...
public final class LBiObjShortFunctionXBuilder<T1, T2, R, X extends Throwable> extends PerCaseBuilderWithProduct.Base<LBiObjShortFunctionXBuilder<T1, T2, R, X>, LBiObjShortPredicateX<T1, T2, X>, LBiObjShortFunctionX<T1, T2, R, X>, R> {
	...
	public static final LBiObjShortFunctionX EVENTUALLY_THROW = LBiObjShortFunctionX.lX((Object a1, Object a2, short a3) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s ,%s  as function %s.", a1, a2, a3, LBiObjShortFunctionX.DESCRIPTION);
	...
	public LBiObjShortFunctionXBuilder(@Nullable Consumer<LBiObjShortFunctionX<T1, T2, R, X>> consumer) {
		super(EVENTUALLY_THROW, LBiObjShortFunctionX::constant, () -> new LBiObjShortFunctionXBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <T1, T2, R, X extends Throwable> LBiObjShortFunctionXBuilder<T1, T2, R, X> biObjShortFunctionX() {
		return new LBiObjShortFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <T1, T2, R, X extends Throwable> LBiObjShortFunctionXBuilder<T1, T2, R, X> biObjShortFunctionX(Consumer<LBiObjShortFunctionX<T1, T2, R, X>> consumer) {
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2> LBiObjShortFunctionXBuilder<T1, T2, R, X> casesOf(Class<E1> argC1, Class<E2> argC2, Consumer<LBiObjShortFunctionXBuilder<E1, E2, R, X>> pcpConsumer) {
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2> LBiObjShortFunctionXBuilder<T1, T2, R, X> aCase(Class<E1> argC1, Class<E2> argC2, LBiObjShortFunctionX<E1, E2, R, X> function) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod((T1 a1, T2 a2, short a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LBiObjShortFunctionX<T1, T2, R, X> build() {
		...
		retval = LBiObjShortFunctionX.<T1, T2, R, X> lX((T1 a1, T2 a2, short a3) -> {
			try {
