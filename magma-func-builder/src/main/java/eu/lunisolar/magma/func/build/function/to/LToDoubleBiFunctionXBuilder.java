...
public final class LToDoubleBiFunctionXBuilder<T1, T2, X extends Throwable> extends PerCaseBuilderWithDoubleProduct.Base<LToDoubleBiFunctionXBuilder<T1, T2, X>, LBiPredicateX<T1, T2, X>, LToDoubleBiFunctionX<T1, T2, X>> {
	...
	public static final LToDoubleBiFunctionX EVENTUALLY_THROW = LToDoubleBiFunctionX.lX((a1, a2) -> {
	...
	@Nonnull
	public static <T1, T2, X extends Throwable> LToDoubleBiFunctionX<T1, T2, X> toDoubleBiFunctionXFrom(Function<LToDoubleBiFunctionXBuilder<T1, T2, X>, LToDoubleBiFunctionX<T1, T2, X>> buildingFunction) {
		return buildingFunction.apply(new LToDoubleBiFunctionXBuilder());
	}
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LToDoubleBiFunctionXBuilder<T1, T2, X> casesOf(Class<V1> argC1, Class<V2> argC2, Consumer<LToDoubleBiFunctionXBuilder<V1, V2, X>> pcpConsumer) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LToDoubleBiFunctionXBuilder<T1, T2, X> aCase(Class<V1> argC1, Class<V2> argC2, LToDoubleBiFunctionX<V1, V2, X> function) {
		PartialCaseWithDoubleProduct.The pc = partialCaseFactoryMethod((a1, a2) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LToDoubleBiFunctionX<T1, T2, X> build() {
		...
		retval = LToDoubleBiFunctionX.<T1, T2, X> lX((a1, a2) -> {
			try {
