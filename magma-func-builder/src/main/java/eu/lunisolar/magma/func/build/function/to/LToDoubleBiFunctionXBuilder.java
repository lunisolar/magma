...
public final class LToDoubleBiFunctionXBuilder<T1, T2, X extends Throwable> extends PerCaseBuilderWithDoubleProduct.Base<LToDoubleBiFunctionXBuilder<T1, T2, X>, LBiPredicateX<T1, T2, X>, LToDoubleBiFunctionX<T1, T2, X>> {
	...
	public <E1 extends T1, E2 extends T2> LToDoubleBiFunctionXBuilder<T1, T2, X> casesOf(Class<E1> argC1, Class<E2> argC2, Consumer<LToDoubleBiFunctionXBuilder<E1, E2, X>> pcpConsumer) {
		PartialCaseWithDoubleProduct.The pc = partialCaseFactoryMethod((T1 t1, T2 t2) -> (argC1 == null || argC1.isInstance(t1)) && (argC2 == null || argC2.isInstance(t2)));
	...
	public final LToDoubleBiFunctionX<T1, T2, X> build() {
		...
		retval = LToDoubleBiFunctionX.<T1, T2, X> lX((T1 t1, T2 t2) -> {
			try {
