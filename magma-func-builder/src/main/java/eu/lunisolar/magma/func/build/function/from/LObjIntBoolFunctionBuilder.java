...
public final class LObjIntBoolFunctionBuilder<T, R> extends PerCaseBuilderWithProduct.Base<LObjIntBoolFunctionBuilder<T, R>, LObjIntBoolPredicate<T>, LObjIntBoolFunction<T, R>, R> {
	...
	public static final LObjIntBoolFunction EVENTUALLY_THROW = LObjIntBoolFunction.objIntBoolFunc((a1, a2, a3) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LObjIntBoolFunctionBuilder(@Nullable Consumer<LObjIntBoolFunction<T, R>> consumer) {
		super(EVENTUALLY_THROW, LObjIntBoolFunction::constant, () -> new LObjIntBoolFunctionBuilder(null));
	...
	@Nonnull
	public static <T, R> LObjIntBoolFunction<T, R> objIntBoolFunctionFrom(Function<LObjIntBoolFunctionBuilder<T, R>, LObjIntBoolFunction<T, R>> buildingFunction) {
		return buildingFunction.apply(new LObjIntBoolFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LObjIntBoolFunctionBuilder<T, R> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	@Nonnull
	public <V extends T> LObjIntBoolFunctionBuilder<T, R> aCase(Class<V> argC1, LObjIntBoolFunction<V, R> function) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LObjIntBoolFunction<T, R> build() {
		...
		final LObjIntBoolFunction<T, R> eventuallyFinal = this.eventually;
	...
	public final LObjIntBoolFunction<T, R> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
