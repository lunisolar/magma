...
public final class LByteToSrtFunctionBuilder extends PerCaseBuilderWithSrtProduct.Base<LByteToSrtFunctionBuilder, LBytePredicate, LByteToSrtFunction> {
	...
	public LByteToSrtFunctionBuilder forValue(byte v, LByteToSrtFunction function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithSrtProduct.The<LByteToSrtFunctionBuilder, LBytePredicate, LByteToSrtFunction> forValue(byte v) {
