...
public final class LByteToSrtFunctionBuilder extends PerCaseBuilderWithSrtProduct.Base<LByteToSrtFunctionBuilder, LBytePredicate, LByteToSrtFunction> {
	...
	@Nonnull
	public static LByteToSrtFunction byteToSrtFunctionFrom(Function<LByteToSrtFunctionBuilder, LByteToSrtFunction> buildingFunction) {
		return buildingFunction.apply(new LByteToSrtFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LByteToSrtFunctionBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LByteToSrtFunction build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
