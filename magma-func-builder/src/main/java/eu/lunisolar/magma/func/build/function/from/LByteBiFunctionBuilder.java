...
public final class LByteBiFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LByteBiFunctionBuilder<R>, LBiBytePredicate, LByteBiFunction<R>, R> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LByteBiFunctionBuilder<R> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LByteBiFunction<R> build() {
		...
		retval = LByteBiFunction.<R> l((byte b1, byte b2) -> {
			try {
	...
	public final LByteBiFunction<R> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
