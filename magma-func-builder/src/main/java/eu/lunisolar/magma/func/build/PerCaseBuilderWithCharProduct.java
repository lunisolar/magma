 ...
 */
public abstract class PerCaseBuilderWithCharProduct<PCB extends PerCaseBuilderWithCharProduct<PCB, P, F>, P, F> implements Fluent<PCB> {
	...
	/** Sets the function to evaluate _eventually_ when input data do not match any case. */
	public final PCB eventuallyProduce(@Nonnull char directValue) {
	...
	public final class PartialCase implements FluentSubcontext<PartialCase, PCB> {
		...
		public final PCB evaluate(@Nonnull F caseFunction) {
			PerCaseBuilderWithCharProduct.this.addCase(Case.of(casePredicate, caseFunction));
			return PerCaseBuilderWithCharProduct.this.self();
		}

		/** Finalize the case build by providing second required value for the Case. */
		public final PCB produce(@Nonnull char directValue) {
			PerCaseBuilderWithCharProduct.this.addCase(Case.of(casePredicate, directToFunction.apply(directValue)));
			return PerCaseBuilderWithCharProduct.this.self();
		}
