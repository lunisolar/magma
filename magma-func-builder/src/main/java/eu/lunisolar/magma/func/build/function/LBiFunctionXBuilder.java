...
public final class LBiFunctionXBuilder<T1, T2, R, X extends Throwable> extends PerCaseBuilderWithProduct.Base<LBiFunctionXBuilder<T1, T2, R, X>, LBiPredicateX<T1, T2, X>, LBiFunctionX<T1, T2, R, X>, R> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T1, T2, R, X extends Throwable> LBiFunctionXBuilder<T1, T2, R, X> biFunctionX() {
		return new LBiFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T1, T2, R, X extends Throwable> LBiFunctionXBuilder<T1, T2, R, X> biFunctionX(Consumer<LBiFunctionX<T1, T2, R, X>> consumer) {
