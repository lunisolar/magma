...
public final class LToByteFunctionXBuilder<T, X extends Throwable> extends PerCaseBuilderWithByteProduct.Base<LToByteFunctionXBuilder<T, X>, LPredicateX<T, X>, LToByteFunctionX<T, X>> {
	...
	@Nonnull
	public static <T, X extends Throwable> LToByteFunctionX<T, X> toByteFunctionXFrom(Function<LToByteFunctionXBuilder<T, X>, LToByteFunctionX<T, X>> buildingFunction) {
		return buildingFunction.apply(new LToByteFunctionXBuilder());
	}
