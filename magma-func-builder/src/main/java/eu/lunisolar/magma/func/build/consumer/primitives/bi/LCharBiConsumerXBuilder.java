...
public final class LCharBiConsumerXBuilder<X extends Throwable> extends PerCaseBuilder.Base<LCharBiConsumerXBuilder<X>, LBiCharPredicateX<X>, LCharBiConsumerX<X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Throwable> LCharBiConsumerXBuilder<X> charBiConsumerX() {
		return new LCharBiConsumerXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Throwable> LCharBiConsumerXBuilder<X> charBiConsumerX(Consumer<LCharBiConsumerX<X>> consumer) {
		return new LCharBiConsumerXBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LCharBiConsumerXBuilder<X> withHandling(@Nonnull HandlingInstructions<X, X> handling) {
	...
	public final LCharBiConsumerX<X> build(@Nonnull HandlingInstructions<X, X> handling) {
