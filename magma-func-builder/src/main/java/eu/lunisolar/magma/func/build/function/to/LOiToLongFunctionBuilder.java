...
public final class LOiToLongFunctionBuilder<T> extends PerCaseBuilderWithLongProduct.Base<LOiToLongFunctionBuilder<T>, LObjIntPredicate<T>, LOiToLongFunction<T>> {
	...
	@Nonnull
	public static <T> LOiToLongFunction<T> oiToLongFunctionFrom(Function<LOiToLongFunctionBuilder<T>, LOiToLongFunction<T>> buildingFunction) {
		return buildingFunction.apply(new LOiToLongFunctionBuilder());
	}
