 ...
 */
public abstract class PerCaseBuilderWithDoubleProduct<PCB extends PerCaseBuilderWithDoubleProduct<PCB, P, F>, P, F> implements Fluent<PCB> {
	...
	/** Sets the function to evaluate _eventually_ when input data do not match any case. */
	public final PCB eventuallyProduce(@Nonnull double directValue) {
	...
	public final class PartialCase implements FluentSubcontext<PartialCase, PCB> {
		...
		public final PCB evaluate(@Nonnull F caseFunction) {
			PerCaseBuilderWithDoubleProduct.this.addCase(Case.of(casePredicate, caseFunction));
			return PerCaseBuilderWithDoubleProduct.this.self();
		}

		/** Finalize the case build by providing second required value for the Case. */
		public final PCB produce(@Nonnull double directValue) {
			PerCaseBuilderWithDoubleProduct.this.addCase(Case.of(casePredicate, directToFunction.apply(directValue)));
			return PerCaseBuilderWithDoubleProduct.this.self();
		}
