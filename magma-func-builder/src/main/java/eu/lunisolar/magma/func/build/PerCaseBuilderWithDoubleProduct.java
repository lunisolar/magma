...
public abstract class PerCaseBuilderWithDoubleProduct<PCB extends PerCaseBuilderWithDoubleProduct<PCB, P, F, PC>, P, F, PC extends PartialCaseWithDoubleProduct<PC, PCB, P, F>> extends PerCaseBuilder<PCB, P, F, PC> {

	protected @Nonnull final LDoubleFunction<F> directToFunction;

	protected PerCaseBuilderWithDoubleProduct(@Nonnull F eventually, @Nonnull LDoubleFunction<F> directToFunction, @Nonnull Supplier<PCB> subCasesFactory) {
	...
	protected PC partialCaseFactoryMethod(P casePredicate) {
		return (PC) new PartialCaseWithDoubleProduct(self(), casePredicate, subCasesFactory);
	}

	public static abstract class Base<SELF extends Base<SELF, P, F>, P, F> extends PerCaseBuilderWithDoubleProduct<SELF, P, F, PartialCaseWithDoubleProduct.The<SELF, P, F>> {
		protected Base(@Nonnull F eventually, @Nonnull LDoubleFunction<F> directToFunction, @Nonnull Supplier<SELF> subCasesFactory) {
			super(eventually, directToFunction, subCasesFactory);
		}

		@Override
		protected PartialCaseWithDoubleProduct.The<SELF, P, F> partialCaseFactoryMethod(P casePredicate) {
			return new PartialCaseWithDoubleProduct.The(this, casePredicate, subCasesFactory);
		}
	}
