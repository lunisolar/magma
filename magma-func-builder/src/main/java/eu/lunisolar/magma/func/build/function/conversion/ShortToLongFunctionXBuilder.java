...
public final class ShortToLongFunctionXBuilder<X extends Exception> extends PerCaseBuilderWithLongProduct<ShortToLongFunctionXBuilder<X>, ShortPredicateX<X>, ShortToLongFunctionX<X>> {
