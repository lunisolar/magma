...
public final class LBiObjFloatFunctionXBuilder<T1, T2, R, X extends Throwable> extends PerCaseBuilderWithProduct.Base<LBiObjFloatFunctionXBuilder<T1, T2, R, X>, LBiObjFloatPredicateX<T1, T2, X>, LBiObjFloatFunctionX<T1, T2, R, X>, R> {
	...
	public static final LBiObjFloatFunctionX EVENTUALLY_THROW = LBiObjFloatFunctionX.lX((a1, a2, a3) -> {
	...
	@Nonnull
	public static <T1, T2, R, X extends Throwable> LBiObjFloatFunctionX<T1, T2, R, X> biObjFloatFunctionXFrom(Function<LBiObjFloatFunctionXBuilder<T1, T2, R, X>, LBiObjFloatFunctionX<T1, T2, R, X>> buildingFunction) {
		return buildingFunction.apply(new LBiObjFloatFunctionXBuilder());
	}
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjFloatFunctionXBuilder<T1, T2, R, X> casesOf(Class<V1> argC1, Class<V2> argC2, Consumer<LBiObjFloatFunctionXBuilder<V1, V2, R, X>> pcpConsumer) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjFloatFunctionXBuilder<T1, T2, R, X> aCase(Class<V1> argC1, Class<V2> argC2, LBiObjFloatFunctionX<V1, V2, R, X> function) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LBiObjFloatFunctionX<T1, T2, R, X> build() {
		...
		retval = LBiObjFloatFunctionX.<T1, T2, R, X> lX((a1, a2, a3) -> {
			try {
