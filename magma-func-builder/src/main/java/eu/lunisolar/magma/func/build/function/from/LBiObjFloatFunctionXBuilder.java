...
public final class LBiObjFloatFunctionXBuilder<T1, T2, R, X extends Exception> extends PerCaseBuilderWithProduct.Base<LBiObjFloatFunctionXBuilder<T1, T2, R, X>, LBiObjFloatPredicateX<T1, T2, X>, LBiObjFloatFunctionX<T1, T2, R, X>, R> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T1, T2, R, X extends Exception> LBiObjFloatFunctionXBuilder<T1, T2, R, X> biObjFloatFunctionX() {
		return new LBiObjFloatFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T1, T2, R, X extends Exception> LBiObjFloatFunctionXBuilder<T1, T2, R, X> biObjFloatFunctionX(Consumer<LBiObjFloatFunctionX<T1, T2, R, X>> consumer) {
