...
public final class LIntSupplierXBuilder<X extends Throwable> extends PerCaseBuilderWithIntProduct.Base<LIntSupplierXBuilder<X>, LBoolSupplierX<X>, LIntSupplierX<X>> {
	...
	public LIntSupplierXBuilder(@Nullable Consumer<LIntSupplierX<X>> consumer) {
		super(EVENTUALLY_THROW, LIntSupplierX::of, () -> new LIntSupplierXBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <X extends Throwable> LIntSupplierXBuilder<X> intSupplierX() {
		return new LIntSupplierXBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static <X extends Throwable> LIntSupplierX<X> intSupplierXFrom(Function<LIntSupplierXBuilder<X>, LIntSupplierX<X>> buildingFunction) {
		return buildingFunction.apply(new LIntSupplierXBuilder());
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <X extends Throwable> LIntSupplierXBuilder<X> intSupplierX(Consumer<LIntSupplierX<X>> consumer) {
	...
	public final LIntSupplierX<X> build() {
		...
		final Case<LBoolSupplierX<X>, LIntSupplierX<X>>[] casesArray = cases.toArray(new Case[cases.size()]);
		retval = LIntSupplierX.<X> lX(() -> {
			try {
				for (Case<LBoolSupplierX<X>, LIntSupplierX<X>> aCase : casesArray) {
