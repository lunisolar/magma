...
public final class LObjBooleanConsumerXBuilder<T, X extends Throwable> extends PerCaseBuilder.Base<LObjBooleanConsumerXBuilder<T, X>, LObjBooleanPredicateX<T, X>, LObjBooleanConsumerX<T, X>> {
	...
	public LObjBooleanConsumerXBuilder(@Nullable Consumer<LObjBooleanConsumerX<T, X>> consumer) {
		super(EVENTUALLY_THROW, () -> new LObjBooleanConsumerXBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <T, X extends Throwable> LObjBooleanConsumerXBuilder<T, X> objBooleanConsumerX() {
		return new LObjBooleanConsumerXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <T, X extends Throwable> LObjBooleanConsumerXBuilder<T, X> objBooleanConsumerX(Consumer<LObjBooleanConsumerX<T, X>> consumer) {
	...
	@Nonnull
	public <E1 extends T> LObjBooleanConsumerXBuilder<T, X> casesOf(Class<E1> argC1, Consumer<LObjBooleanConsumerXBuilder<E1, X>> pcpConsumer) {
	...
	@Nonnull
	public <E1 extends T> LObjBooleanConsumerXBuilder<T, X> aCase(Class<E1> argC1, LObjBooleanConsumerX<E1, X> function) {
		PartialCase.The pc = partialCaseFactoryMethod((T t, boolean b) -> (argC1 == null || argC1.isInstance(t)));
	...
	public final LObjBooleanConsumerX<T, X> build() {
		...
		retval = LObjBooleanConsumerX.<T, X> lX((T t, boolean b) -> {
			try {
