...
public final class LObjLongPredicateXBuilder<T, X extends Throwable> extends PerCaseBuilderWithBooleanProduct.Base<LObjLongPredicateXBuilder<T, X>, LObjLongPredicateX<T, X>, LObjLongPredicateX<T, X>> {
	...
	public static final LObjLongPredicateX EVENTUALLY_THROW = LObjLongPredicateX.lX((Object a1, long a2) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s  as function %s.", a1, a2, LObjLongPredicateX.DESCRIPTION);
	...
	@Nonnull
	public <E1 extends T> LObjLongPredicateXBuilder<T, X> casesOf(Class<E1> argC1, Consumer<LObjLongPredicateXBuilder<E1, X>> pcpConsumer) {
	...
	@Nonnull
	public <E1 extends T> LObjLongPredicateXBuilder<T, X> aCase(Class<E1> argC1, LObjLongPredicateX<E1, X> function) {
		PartialCaseWithBooleanProduct.The pc = partialCaseFactoryMethod((T a1, long a2) -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LObjLongPredicateX<T, X> build() {
		...
		retval = LObjLongPredicateX.<T, X> lX((T a1, long a2) -> {
			try {
