...
public final class LObjLongPredicateXBuilder<T, X extends Exception> extends PerCaseBuilderWithBooleanProduct.Base<LObjLongPredicateXBuilder<T, X>, LObjLongPredicateX<T, X>, LObjLongPredicateX<T, X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T, X extends Exception> LObjLongPredicateXBuilder<T, X> objLongPredicateX() {
		return new LObjLongPredicateXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T, X extends Exception> LObjLongPredicateXBuilder<T, X> objLongPredicateX(Consumer<LObjLongPredicateX<T, X>> consumer) {
