...
public final class ToIntFunctionBuilder<T> extends PerCaseBuilderWithIntProduct.Base<ToIntFunctionBuilder<T>, LPredicate<T>, ToIntFunction<T>> {
	...
	public static final ToIntFunction EVENTUALLY_THROW = Function4U.toIntFunction(a -> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <T> ToIntFunctionBuilder<T> toIntFunction() {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final ToIntFunctionBuilder<T> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	@Nonnull
	public <V extends T> ToIntFunctionBuilder<T> casesOf(Class<V> argC, Consumer<ToIntFunctionBuilder<V>> pcpConsumer) {
	...
	@Nonnull
	public <V extends T> ToIntFunctionBuilder<T> aCase(Class<V> argC, ToIntFunction<V> function) {
		PartialCaseWithIntProduct.The pc = partialCaseFactoryMethod(a -> (argC == null || argC.isInstance(a)));
	...
	public final ToIntFunction<T> build() {
		...
		retval = Function4U.<T> toIntFunction(a -> {
			try {
