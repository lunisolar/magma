...
public final class ShortBiFunctionXBuilder<R, X extends Exception> extends PerCaseBuilderWithProduct<ShortBiFunctionXBuilder<R, X>, BiShortPredicateX<X>, ShortBiFunctionX<R, X>, R> {
