...
public final class DoubleFunctionXBuilder<R, X extends Exception> extends PerCaseBuilder<DoubleFunctionXBuilder<R, X>, DoublePredicateX<X>, DoubleFunctionX<R, X>> {
