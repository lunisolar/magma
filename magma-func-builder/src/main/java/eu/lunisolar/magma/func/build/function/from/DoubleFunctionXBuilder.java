...
public final class DoubleFunctionXBuilder<R, X extends Exception> extends PerCaseBuilderWithProduct.Base<DoubleFunctionXBuilder<R, X>, DoublePredicateX<X>, DoubleFunctionX<R, X>, R> {
