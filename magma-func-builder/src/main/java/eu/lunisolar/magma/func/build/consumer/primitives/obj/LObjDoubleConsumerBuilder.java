...
public final class LObjDoubleConsumerBuilder<T> extends PerCaseBuilder.Base<LObjDoubleConsumerBuilder<T>, LObjDoublePredicate<T>, LObjDoubleConsumer<T>> {
	...
	public static final LObjDoubleConsumer EVENTUALLY_THROW = LObjDoubleConsumer.l((a1, a2) -> {
	...
	@Nonnull
	public static <T> LObjDoubleConsumer<T> objDoubleConsumerFrom(Function<LObjDoubleConsumerBuilder<T>, LObjDoubleConsumer<T>> buildingFunction) {
		return buildingFunction.apply(new LObjDoubleConsumerBuilder());
	}
	...
	@Nonnull
	public <V extends T> LObjDoubleConsumerBuilder<T> casesOf(Class<V> argC1, Consumer<LObjDoubleConsumerBuilder<V>> pcpConsumer) {
	...
	@Nonnull
	public <V extends T> LObjDoubleConsumerBuilder<T> aCase(Class<V> argC1, LObjDoubleConsumer<V> function) {
		PartialCase.The pc = partialCaseFactoryMethod((a1, a2) -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LObjDoubleConsumer<T> build() {
		...
		retval = LObjDoubleConsumer.<T> l((a1, a2) -> {
			try {
