...
public final class LObjDoubleConsumerBuilder<T> extends PerCaseBuilder.Base<LObjDoubleConsumerBuilder<T>, LObjDoublePredicate<T>, LObjDoubleConsumer<T>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T> LObjDoubleConsumerBuilder<T> objDoubleConsumer() {
		return new LObjDoubleConsumerBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T> LObjDoubleConsumerBuilder<T> objDoubleConsumer(Consumer<LObjDoubleConsumer<T>> consumer) {
	...
	public final LObjDoubleConsumer<T> build() {
		...
		if (cases.isEmpty()) {
			...
			retval = LObjDoubleConsumer.l((T t, double d) -> {
