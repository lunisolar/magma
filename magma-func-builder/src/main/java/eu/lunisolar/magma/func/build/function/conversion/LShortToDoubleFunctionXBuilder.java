...
public final class LShortToDoubleFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithDoubleProduct.Base<LShortToDoubleFunctionXBuilder<X>, LShortPredicateX<X>, LShortToDoubleFunctionX<X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Throwable> LShortToDoubleFunctionXBuilder<X> shortToDoubleFunctionX() {
		return new LShortToDoubleFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Throwable> LShortToDoubleFunctionXBuilder<X> shortToDoubleFunctionX(Consumer<LShortToDoubleFunctionX<X>> consumer) {
