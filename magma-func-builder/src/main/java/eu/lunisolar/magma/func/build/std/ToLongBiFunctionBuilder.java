...
public final class ToLongBiFunctionBuilder<T1, T2> extends PerCaseBuilderWithLongProduct.Base<ToLongBiFunctionBuilder<T1, T2>, LBiPredicate<T1, T2>, ToLongBiFunction<T1, T2>> {
	...
	public static final ToLongBiFunction EVENTUALLY_THROW = Function4U.toLongBiFunction((a1, a2) -> {
	...
	public final ToLongBiFunction<T1, T2> build() {
		...
		retval = Function4U.<T1, T2> toLongBiFunction((a1, a2) -> {
			try {
	...
	public final ToLongBiFunction<T1, T2> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
