...
public final class LByteToIntFunctionBuilder extends PerCaseBuilderWithIntProduct.Base<LByteToIntFunctionBuilder, LBytePredicate, LByteToIntFunction> {
	...
	private Consumer<LByteToIntFunction> consumer;
	...
	public LByteToIntFunctionBuilder() {
		this(null);
	}
	...
	@Nonnull
	public static LByteToIntFunction byteToIntFunctionFrom(Consumer<LByteToIntFunctionBuilder> buildingFunction) {
		LByteToIntFunctionBuilder builder = new LByteToIntFunctionBuilder();
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LByteToIntFunctionBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public LByteToIntFunctionBuilder forValue(byte v, LByteToIntFunction function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithIntProduct.The<LByteToIntFunctionBuilder, LBytePredicate, LByteToIntFunction> forValue(byte v) {
	...
	public final LByteToIntFunction build() {
		...
		retval = LByteToIntFunction.byteToIntFunc(a -> {
			try {
	...
	public final LByteToIntFunction build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
