...
public final class LByteToIntFunctionBuilder extends PerCaseBuilderWithIntProduct.Base<LByteToIntFunctionBuilder, LBytePredicate, LByteToIntFunction> {
	...
	@Nonnull
	public static LByteToIntFunction byteToIntFunctionFrom(Function<LByteToIntFunctionBuilder, LByteToIntFunction> buildingFunction) {
		return buildingFunction.apply(new LByteToIntFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LByteToIntFunctionBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LByteToIntFunction build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
