...
public final class BiObjIntFunctionBuilder<T1, T2, R> extends PerCaseBuilder<BiObjIntFunctionBuilder<T1, T2, R>, BiObjIntPredicate<T1, T2>, BiObjIntFunction<T1, T2, R>> {
