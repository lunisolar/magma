...
public final class LObjBoolConsumerXBuilder<T, X extends Throwable> extends PerCaseBuilder.Base<LObjBoolConsumerXBuilder<T, X>, LObjBoolPredicateX<T, X>, LObjBoolConsumerX<T, X>> {
	...
	public static final LObjBoolConsumerX EVENTUALLY_THROW = LObjBoolConsumerX.lX((a1, a2) -> {
	...
	@Nonnull
	public static <T, X extends Throwable> LObjBoolConsumerX<T, X> objBoolConsumerXFrom(Function<LObjBoolConsumerXBuilder<T, X>, LObjBoolConsumerX<T, X>> buildingFunction) {
		return buildingFunction.apply(new LObjBoolConsumerXBuilder());
	}
	...
	@Nonnull
	public <V extends T> LObjBoolConsumerXBuilder<T, X> casesOf(Class<V> argC1, Consumer<LObjBoolConsumerXBuilder<V, X>> pcpConsumer) {
	...
	@Nonnull
	public <V extends T> LObjBoolConsumerXBuilder<T, X> aCase(Class<V> argC1, LObjBoolConsumerX<V, X> function) {
		PartialCase.The pc = partialCaseFactoryMethod((a1, a2) -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LObjBoolConsumerX<T, X> build() {
		...
		retval = LObjBoolConsumerX.<T, X> lX((a1, a2) -> {
			try {
