...
public final class LObjBoolConsumerXBuilder<T, X extends Throwable> extends PerCaseBuilder.Base<LObjBoolConsumerXBuilder<T, X>, LObjBoolPredicateX<T, X>, LObjBoolConsumerX<T, X>> {
	...
	public static final LObjBoolConsumerX EVENTUALLY_THROW = LObjBoolConsumerX.lX((Object t, boolean b) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s  as function %s.", t, b, LObjBoolConsumerX.DESCRIPTION);
	...
	public final LObjBoolConsumerX<T, X> build() {
		...
		retval = LObjBoolConsumerX.<T, X> lX((T t, boolean b) -> {
			try {
