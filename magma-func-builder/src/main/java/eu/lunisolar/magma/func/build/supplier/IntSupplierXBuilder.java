...
public final class IntSupplierXBuilder<X extends Exception> extends PerCaseBuilderWithIntProduct.Base<IntSupplierXBuilder<X>, BooleanSupplierX<X>, IntSupplierX<X>> {
