...
public final class StdBiPredicateBuilder<T1, T2> extends PerCaseBuilderWithBooleanProduct.Base<StdBiPredicateBuilder<T1, T2>, LBiPredicate<T1, T2>, java.util.function.BiPredicate<T1, T2>> {
