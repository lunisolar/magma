...
public final class LCharUnaryOperatorBuilder extends PerCaseBuilderWithCharProduct.Base<LCharUnaryOperatorBuilder, LCharPredicate, LCharUnaryOperator> {
	...
	public static final LCharUnaryOperator EVENTUALLY_THROW = LCharUnaryOperator.l(a1 -> {
	...
	@Nonnull
	public static LCharUnaryOperator charUnaryOperatorFrom(Function<LCharUnaryOperatorBuilder, LCharUnaryOperator> buildingFunction) {
		return buildingFunction.apply(new LCharUnaryOperatorBuilder());
	}
	...
	public final LCharUnaryOperator build() {
		...
		retval = LCharUnaryOperator.l(a1 -> {
			try {
