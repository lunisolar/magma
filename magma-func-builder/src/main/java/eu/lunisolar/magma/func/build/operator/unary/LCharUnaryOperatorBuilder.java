...
public final class LCharUnaryOperatorBuilder extends PerCaseBuilderWithCharProduct.Base<LCharUnaryOperatorBuilder, LCharPredicate, LCharUnaryOperator> {
	...
	public static final LCharUnaryOperator EVENTUALLY_THROW = LCharUnaryOperator.l((char c) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", c, LCharUnaryOperator.DESCRIPTION);
	...
	public LCharUnaryOperatorBuilder(@Nullable Consumer<LCharUnaryOperator> consumer) {
		super(EVENTUALLY_THROW, LCharUnaryOperator::constant);
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final LCharUnaryOperatorBuilder charUnaryOperator() {
		return new LCharUnaryOperatorBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final LCharUnaryOperatorBuilder charUnaryOperator(Consumer<LCharUnaryOperator> consumer) {
		return new LCharUnaryOperatorBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LCharUnaryOperatorBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LCharUnaryOperator build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
