...
public final class LIntToFloatFunctionXBuilder<X extends Exception> extends PerCaseBuilderWithFloatProduct.Base<LIntToFloatFunctionXBuilder<X>, LIntPredicateX<X>, LIntToFloatFunctionX<X>> {

	private Consumer<LIntToFloatFunctionX<X>> consumer;

	public static final LIntToFloatFunctionX EVENTUALLY_THROW = LIntToFloatFunctionX.lX((int i) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", i, LIntToFloatFunctionX.DESCRIPTION);
	...
	public LIntToFloatFunctionXBuilder(@Nullable Consumer<LIntToFloatFunctionX<X>> consumer) {
		super(EVENTUALLY_THROW, LIntToFloatFunctionX::constant);
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Exception> LIntToFloatFunctionXBuilder<X> intToFloatFunctionX() {
		return new LIntToFloatFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Exception> LIntToFloatFunctionXBuilder<X> intToFloatFunctionX(Consumer<LIntToFloatFunctionX<X>> consumer) {
