...
public final class LIntToFloatFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithFloatProduct.Base<LIntToFloatFunctionXBuilder<X>, LIntPredicateX<X>, LIntToFloatFunctionX<X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Throwable> LIntToFloatFunctionXBuilder<X> intToFloatFunctionX() {
		return new LIntToFloatFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Throwable> LIntToFloatFunctionXBuilder<X> intToFloatFunctionX(Consumer<LIntToFloatFunctionX<X>> consumer) {
	...
	public final LIntToFloatFunctionX<X> build() {
		...
		retval = LIntToFloatFunctionX.<X> lX(i -> {
			try {
