...
public final class BiObjLongPredicateXBuilder<T1, T2, X extends Exception> extends PerCaseBuilder<BiObjLongPredicateXBuilder<T1, T2, X>, BiObjLongPredicateX<T1, T2, X>, BiObjLongPredicateX<T1, T2, X>> {
