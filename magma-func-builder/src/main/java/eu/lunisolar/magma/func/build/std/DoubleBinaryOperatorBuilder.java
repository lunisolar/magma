...
public final class DoubleBinaryOperatorBuilder extends PerCaseBuilderWithDoubleProduct.Base<DoubleBinaryOperatorBuilder, LBiDoublePredicate, java.util.function.DoubleBinaryOperator> {
	...
	@Nonnull
	public static DoubleBinaryOperatorBuilder doubleBinaryOperator(Consumer<java.util.function.DoubleBinaryOperator> consumer) {
	...
	public final java.util.function.DoubleBinaryOperator build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
