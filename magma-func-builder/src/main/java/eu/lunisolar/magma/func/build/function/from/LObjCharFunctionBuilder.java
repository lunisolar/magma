...
public final class LObjCharFunctionBuilder<T, R> extends PerCaseBuilderWithProduct.Base<LObjCharFunctionBuilder<T, R>, LObjCharPredicate<T>, LObjCharFunction<T, R>, R> {
	...
	@Nonnull
	public static <T, R> LObjCharFunction<T, R> objCharFunctionFrom(Function<LObjCharFunctionBuilder<T, R>, LObjCharFunction<T, R>> buildingFunction) {
		return buildingFunction.apply(new LObjCharFunctionBuilder());
	}
