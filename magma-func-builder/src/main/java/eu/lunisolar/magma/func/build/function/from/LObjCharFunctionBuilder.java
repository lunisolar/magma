...
public final class LObjCharFunctionBuilder<T, R> extends PerCaseBuilderWithProduct.Base<LObjCharFunctionBuilder<T, R>, LObjCharPredicate<T>, LObjCharFunction<T, R>, R> {
	...
	public static final LObjCharFunction EVENTUALLY_THROW = LObjCharFunction.l((Object a1, char a2) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s  as function %s.", a1, a2, LObjCharFunction.DESCRIPTION);
	...
	public final LObjCharFunction<T, R> build() {
		...
		retval = LObjCharFunction.<T, R> l((T a1, char a2) -> {
			try {
