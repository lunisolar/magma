...
public final class LToLongFunctionBuilder<T> extends PerCaseBuilderWithLongProduct.Base<LToLongFunctionBuilder<T>, LPredicate<T>, LToLongFunction<T>> {
	...
	public static final LToLongFunction OTHERWISE_THROW = LToLongFunction.toLongFunc(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LToLongFunctionBuilder(@Nullable Consumer<LToLongFunction<T>> consumer) {
		super(OTHERWISE_THROW, LToLongFunction::constant, () -> new LToLongFunctionBuilder(null));

		this.consumer = consumer;
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	public LToLongFunctionBuilder() {
		this(null);
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LToLongFunctionBuilder<T> withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public <V extends T> LToLongFunctionBuilder<T> forValue(T v, LToLongFunction<V> function) {
		PartialCaseWithLongProduct.The pc = partialCaseFactoryMethod(a -> Objects.equals(a, v));
		pc.evaluate(function);
		return fluentCtx();
	}

	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public <V extends T> PartialCaseWithLongProduct.The<LToLongFunctionBuilder<T>, LPredicate<T>, LToLongFunction<T>> forValue(T v) {
		return partialCaseFactoryMethod(a -> Objects.equals(a, v));
	}

	/** Allows to specify additional cases for a specific type of generic arguments (matched by instanceOf). Null classes can be provided in case of arguments that do not matter. */
	@Nonnull
	public <V extends T> LToLongFunctionBuilder<T> casesOf(Class<V> argC, Consumer<LToLongFunctionBuilder<V>> pcpConsumer) {
	...
	@Nonnull
	public <V extends T> LToLongFunctionBuilder<T> forClass(Class<V> argC, LToLongFunction<V> function) {
		PartialCaseWithLongProduct.The pc = partialCaseFactoryMethod(a -> (argC == null || argC.isInstance(a)));
		pc.evaluate(function);
		return fluentCtx();
	}
	...
	/** Adds full new case for the argument that are of specific classes (matched by instanceOf, null is a wildcard). */
	@Nonnull
	public <V extends T> PartialCaseWithLongProduct.The<LToLongFunctionBuilder<T>, LPredicate<T>, LToLongFunction<T>> forClass(Class<V> argC) {
		return partialCaseFactoryMethod(a -> (argC == null || argC.isInstance(a)));
	}

	/** Builds the functional interface implementation and if previously provided calls the consumer. */
	@Nonnull
	public final LToLongFunction<T> build() {

		final LToLongFunction<T> otherwiseFinal = this.otherwise;

		LToLongFunction<T> retval;

		final Case<LPredicate<T>, LToLongFunction<T>>[] casesArray = cases.toArray(new Case[cases.size()]);
		retval = LToLongFunction.<T> toLongFunc(a -> {
			try {
	...
	public final LToLongFunction<T> build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
