...
public final class LToLongFunctionBuilder<T> extends PerCaseBuilderWithLongProduct.Base<LToLongFunctionBuilder<T>, LPredicate<T>, LToLongFunction<T>> {
	...
	public static final LToLongFunction EVENTUALLY_THROW = LToLongFunction.toLongFunc(a -> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LToLongFunctionBuilder<T> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LToLongFunction<T> build() {
		...
		final LToLongFunction<T> eventuallyFinal = this.eventually;
	...
	public final LToLongFunction<T> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
