...
public final class BooleanToLongFunctionXBuilder<X extends Exception> extends PerCaseBuilderWithLongProduct.Base<BooleanToLongFunctionXBuilder<X>, BooleanUnaryOperatorX<X>, BooleanToLongFunctionX<X>> {
