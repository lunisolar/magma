...
public final class LBiObjFloatFunctionBuilder<T1, T2, R> extends PerCaseBuilderWithProduct.Base<LBiObjFloatFunctionBuilder<T1, T2, R>, LBiObjFloatPredicate<T1, T2>, LBiObjFloatFunction<T1, T2, R>, R> {
	...
	public static final LBiObjFloatFunction EVENTUALLY_THROW = LBiObjFloatFunction.l((a1, a2, a3) -> {
	...
	@Nonnull
	public static <T1, T2, R> LBiObjFloatFunction<T1, T2, R> biObjFloatFunctionFrom(Function<LBiObjFloatFunctionBuilder<T1, T2, R>, LBiObjFloatFunction<T1, T2, R>> buildingFunction) {
		return buildingFunction.apply(new LBiObjFloatFunctionBuilder());
	}
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjFloatFunctionBuilder<T1, T2, R> casesOf(Class<V1> argC1, Class<V2> argC2, Consumer<LBiObjFloatFunctionBuilder<V1, V2, R>> pcpConsumer) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjFloatFunctionBuilder<T1, T2, R> aCase(Class<V1> argC1, Class<V2> argC2, LBiObjFloatFunction<V1, V2, R> function) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LBiObjFloatFunction<T1, T2, R> build() {
		...
		retval = LBiObjFloatFunction.<T1, T2, R> l((a1, a2, a3) -> {
			try {
