...
public final class LBiObjFloatFunctionBuilder<T1, T2, R> extends PerCaseBuilderWithProduct.Base<LBiObjFloatFunctionBuilder<T1, T2, R>, LBiObjFloatPredicate<T1, T2>, LBiObjFloatFunction<T1, T2, R>, R> {
	...
	public static final LBiObjFloatFunction EVENTUALLY_THROW = LBiObjFloatFunction.l((Object a1, Object a2, float a3) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s ,%s  as function %s.", a1, a2, a3, LBiObjFloatFunction.DESCRIPTION);
	...
	public final LBiObjFloatFunction<T1, T2, R> build() {
		...
		retval = LBiObjFloatFunction.<T1, T2, R> l((T1 a1, T2 a2, float a3) -> {
			try {
