...
public final class LIntBiFunctionXBuilder<R, X extends Throwable> extends PerCaseBuilderWithProduct.Base<LIntBiFunctionXBuilder<R, X>, LBiIntPredicateX<X>, LIntBiFunctionX<R, X>, R> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <R, X extends Throwable> LIntBiFunctionXBuilder<R, X> intBiFunctionX() {
		return new LIntBiFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <R, X extends Throwable> LIntBiFunctionXBuilder<R, X> intBiFunctionX(Consumer<LIntBiFunctionX<R, X>> consumer) {
		return new LIntBiFunctionXBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LIntBiFunctionXBuilder<R, X> withHandling(@Nonnull HandlingInstructions<X, X> handling) {
	...
	public final LIntBiFunctionX<R, X> build(@Nonnull HandlingInstructions<X, X> handling) {
