...
public final class LBiObjLongFunctionXBuilder<T1, T2, R, X extends Throwable> extends PerCaseBuilderWithProduct.Base<LBiObjLongFunctionXBuilder<T1, T2, R, X>, LBiObjLongPredicateX<T1, T2, X>, LBiObjLongFunctionX<T1, T2, R, X>, R> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LBiObjLongFunctionXBuilder<T1, T2, R, X> withHandling(@Nonnull HandlingInstructions<X, X> handling) {
	...
	public final LBiObjLongFunctionX<T1, T2, R, X> build() {
		...
		retval = LBiObjLongFunctionX.<T1, T2, R, X> lX((T1 t1, T2 t2, long l) -> {
			try {
	...
	public final LBiObjLongFunctionX<T1, T2, R, X> build(@Nonnull HandlingInstructions<X, X> handling) {
