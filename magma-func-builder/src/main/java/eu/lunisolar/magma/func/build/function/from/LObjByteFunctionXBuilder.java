...
public final class LObjByteFunctionXBuilder<T, R, X extends Throwable> extends PerCaseBuilderWithProduct.Base<LObjByteFunctionXBuilder<T, R, X>, LObjBytePredicateX<T, X>, LObjByteFunctionX<T, R, X>, R> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T, R, X extends Throwable> LObjByteFunctionXBuilder<T, R, X> objByteFunctionX() {
		return new LObjByteFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T, R, X extends Throwable> LObjByteFunctionXBuilder<T, R, X> objByteFunctionX(Consumer<LObjByteFunctionX<T, R, X>> consumer) {
