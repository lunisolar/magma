...
public final class LongToDoubleFunctionBuilder extends PerCaseBuilderWithDoubleProduct.Base<LongToDoubleFunctionBuilder, LLongPredicate, java.util.function.LongToDoubleFunction> {
	...
	public LongToDoubleFunctionBuilder(@Nullable Consumer<java.util.function.LongToDoubleFunction> consumer) {
	...
	@Nonnull
	public static final LongToDoubleFunctionBuilder longToDoubleFunction(Consumer<java.util.function.LongToDoubleFunction> consumer) {
		return new LongToDoubleFunctionBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LongToDoubleFunctionBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final java.util.function.LongToDoubleFunction build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
