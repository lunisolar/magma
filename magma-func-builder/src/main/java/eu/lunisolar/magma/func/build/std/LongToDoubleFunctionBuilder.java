...
public final class LongToDoubleFunctionBuilder extends PerCaseBuilderWithDblProduct.Base<LongToDoubleFunctionBuilder, LLongPredicate, LongToDoubleFunction> {
	...
	public static final LongToDoubleFunction OTHERWISE_THROW = Function4U.longToDblFunc(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LongToDoubleFunctionBuilder(@Nullable Consumer<LongToDoubleFunction> consumer) {
		super(OTHERWISE_THROW, LLongToDblFunction::constant, () -> new LongToDoubleFunctionBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LongToDoubleFunctionBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public final LongToDoubleFunction build() {
		...
		final LongToDoubleFunction otherwiseFinal = this.otherwise;
	...
	public final LongToDoubleFunction build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
