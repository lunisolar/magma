...
public final class LBiDoublePredicateXBuilder<X extends Throwable> extends PerCaseBuilderWithBoolProduct.Base<LBiDoublePredicateXBuilder<X>, LBiDoublePredicateX<X>, LBiDoublePredicateX<X>> {
	...
	public static final LBiDoublePredicateX EVENTUALLY_THROW = LBiDoublePredicateX.lX((a1, a2) -> {
	...
	@Nonnull
	public static <X extends Throwable> LBiDoublePredicateX<X> biDoublePredicateXFrom(Function<LBiDoublePredicateXBuilder<X>, LBiDoublePredicateX<X>> buildingFunction) {
		return buildingFunction.apply(new LBiDoublePredicateXBuilder());
	}
	...
	public final LBiDoublePredicateX<X> build() {
		...
		retval = LBiDoublePredicateX.<X> lX((a1, a2) -> {
			try {
