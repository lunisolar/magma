...
public final class LTieByteFunctionBuilder<T> extends PerCaseBuilderWithIntProduct.Base<LTieByteFunctionBuilder<T>, LObjIntBytePredicate<T>, LTieByteFunction<T>> {
	...
	@Nonnull
	public static <T> LTieByteFunction<T> tieByteFunctionFrom(Function<LTieByteFunctionBuilder<T>, LTieByteFunction<T>> buildingFunction) {
		return buildingFunction.apply(new LTieByteFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LTieByteFunctionBuilder<T> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	@Nonnull
	public <V extends T> LTieByteFunctionBuilder<T> aCase(Class<V> argC1, LTieByteFunction<V> function) {
		PartialCaseWithIntProduct.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LTieByteFunction<T> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
