...
public final class LongUnaryOperatorBuilder extends PerCaseBuilderWithLongProduct.Base<LongUnaryOperatorBuilder, LLongPredicate, LongUnaryOperator> {
	...
	public static final LongUnaryOperator OTHERWISE_THROW = Function4U.longUnaryOp(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LongUnaryOperatorBuilder(@Nullable Consumer<LongUnaryOperator> consumer) {
		super(OTHERWISE_THROW, LLongUnaryOperator::constant, () -> new LongUnaryOperatorBuilder(null));

		this.consumer = consumer;
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	public LongUnaryOperatorBuilder() {
		this(null);
	}
	...
	@Nonnull
	public static LongUnaryOperator longUnaryOperatorFrom(Consumer<LongUnaryOperatorBuilder> buildingFunction) {
		LongUnaryOperatorBuilder builder = new LongUnaryOperatorBuilder();
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LongUnaryOperatorBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public final LongUnaryOperator build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
