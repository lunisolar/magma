...
public final class LBiConsumerXBuilder<T1, T2, X extends Throwable> extends PerCaseBuilder.Base<LBiConsumerXBuilder<T1, T2, X>, LBiPredicateX<T1, T2, X>, LBiConsumerX<T1, T2, X>> {
	...
	public static final LBiConsumerX EVENTUALLY_THROW = LBiConsumerX.lX((a1, a2) -> {
	...
	@Nonnull
	public static <T1, T2, X extends Throwable> LBiConsumerX<T1, T2, X> biConsumerXFrom(Function<LBiConsumerXBuilder<T1, T2, X>, LBiConsumerX<T1, T2, X>> buildingFunction) {
		return buildingFunction.apply(new LBiConsumerXBuilder());
	}
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiConsumerXBuilder<T1, T2, X> casesOf(Class<V1> argC1, Class<V2> argC2, Consumer<LBiConsumerXBuilder<V1, V2, X>> pcpConsumer) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiConsumerXBuilder<T1, T2, X> aCase(Class<V1> argC1, Class<V2> argC2, LBiConsumerX<V1, V2, X> function) {
		PartialCase.The pc = partialCaseFactoryMethod((a1, a2) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LBiConsumerX<T1, T2, X> build() {
		...
		retval = LBiConsumerX.<T1, T2, X> lX((a1, a2) -> {
			try {
