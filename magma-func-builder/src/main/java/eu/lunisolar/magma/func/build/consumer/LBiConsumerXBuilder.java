...
public final class LBiConsumerXBuilder<T1, T2, X extends Exception> extends PerCaseBuilder.Base<LBiConsumerXBuilder<T1, T2, X>, LBiPredicateX<T1, T2, X>, LBiConsumerX<T1, T2, X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T1, T2, X extends Exception> LBiConsumerXBuilder<T1, T2, X> biConsumerX() {
		return new LBiConsumerXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T1, T2, X extends Exception> LBiConsumerXBuilder<T1, T2, X> biConsumerX(Consumer<LBiConsumerX<T1, T2, X>> consumer) {
