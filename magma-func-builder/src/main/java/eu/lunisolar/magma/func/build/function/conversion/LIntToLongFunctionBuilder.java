...
public final class LIntToLongFunctionBuilder extends PerCaseBuilderWithLongProduct.Base<LIntToLongFunctionBuilder, LIntPredicate, LIntToLongFunction> {
	...
	public static final LIntToLongFunction EVENTUALLY_THROW = LIntToLongFunction.l((int a1) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", a1, LIntToLongFunction.DESCRIPTION);
	...
	public LIntToLongFunctionBuilder(@Nullable Consumer<LIntToLongFunction> consumer) {
		super(EVENTUALLY_THROW, LIntToLongFunction::constant, () -> new LIntToLongFunctionBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LIntToLongFunctionBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LIntToLongFunction build() {
		...
		retval = LIntToLongFunction.l(a1 -> {
			try {
	...
	public final LIntToLongFunction build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
