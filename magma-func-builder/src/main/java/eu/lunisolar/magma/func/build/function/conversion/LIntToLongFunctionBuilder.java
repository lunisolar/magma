...
public final class LIntToLongFunctionBuilder extends PerCaseBuilderWithLongProduct.Base<LIntToLongFunctionBuilder, LIntPredicate, LIntToLongFunction> {
	...
	public static final LIntToLongFunction OTHERWISE_THROW = LIntToLongFunction.intToLongFunc(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LIntToLongFunctionBuilder(@Nullable Consumer<LIntToLongFunction> consumer) {
		super(OTHERWISE_THROW, LIntToLongFunction::constant, () -> new LIntToLongFunctionBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static LIntToLongFunctionBuilder intToLongFunction() {
	...
	@Nonnull
	public static LIntToLongFunctionBuilder intToLongFunction(Consumer<LIntToLongFunction> consumer) {
		return new LIntToLongFunctionBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LIntToLongFunctionBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public LIntToLongFunctionBuilder forValue(int v, LIntToLongFunction function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithLongProduct.The<LIntToLongFunctionBuilder, LIntPredicate, LIntToLongFunction> forValue(int v) {
	...
	public final LIntToLongFunction build() {
		...
		final LIntToLongFunction otherwiseFinal = this.otherwise;
	...
	public final LIntToLongFunction build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
