...
public final class LToDblFunctionBuilder<T> extends PerCaseBuilderWithDblProduct.Base<LToDblFunctionBuilder<T>, LPredicate<T>, LToDblFunction<T>> {
	...
	public static final LToDblFunction EVENTUALLY_THROW = LToDblFunction.toDblFunc(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LToDblFunctionBuilder(@Nullable Consumer<LToDblFunction<T>> consumer) {
		super(EVENTUALLY_THROW, LToDblFunction::constant, () -> new LToDblFunctionBuilder(null));
	...
	@Nonnull
	public static <T> LToDblFunction<T> toDblFunctionFrom(Function<LToDblFunctionBuilder<T>, LToDblFunction<T>> buildingFunction) {
		return buildingFunction.apply(new LToDblFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LToDblFunctionBuilder<T> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	@Nonnull
	public <V extends T> LToDblFunctionBuilder<T> aCase(Class<V> argC, LToDblFunction<V> function) {
		PartialCaseWithDblProduct.The pc = partialCaseFactoryMethod(a -> (argC == null || argC.isInstance(a)));
	...
	public final LToDblFunction<T> build() {
		...
		final LToDblFunction<T> eventuallyFinal = this.eventually;
	...
	public final LToDblFunction<T> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
