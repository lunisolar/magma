...
public final class FloatToShortFunctionXBuilder<X extends Exception> extends PerCaseBuilderWithShortProduct.Base<FloatToShortFunctionXBuilder<X>, FloatPredicateX<X>, FloatToShortFunctionX<X>> {
