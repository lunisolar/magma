...
public final class LBiObjCharConsumerBuilder<T1, T2> extends PerCaseBuilder.Base<LBiObjCharConsumerBuilder<T1, T2>, LBiObjCharPredicate<T1, T2>, LBiObjCharConsumer<T1, T2>> {
	...
	public static final LBiObjCharConsumer EVENTUALLY_THROW = LBiObjCharConsumer.l((a1, a2, a3) -> {
	...
	@Nonnull
	public static <T1, T2> LBiObjCharConsumer<T1, T2> biObjCharConsumerFrom(Function<LBiObjCharConsumerBuilder<T1, T2>, LBiObjCharConsumer<T1, T2>> buildingFunction) {
		return buildingFunction.apply(new LBiObjCharConsumerBuilder());
	}
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjCharConsumerBuilder<T1, T2> aCase(Class<V1> argC1, Class<V2> argC2, LBiObjCharConsumer<V1, V2> function) {
		PartialCase.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LBiObjCharConsumer<T1, T2> build() {
		...
		retval = LBiObjCharConsumer.<T1, T2> l((a1, a2, a3) -> {
			try {
