...
public final class LBiObjCharConsumerBuilder<T1, T2> extends PerCaseBuilder.Base<LBiObjCharConsumerBuilder<T1, T2>, LBiObjCharPredicate<T1, T2>, LBiObjCharConsumer<T1, T2>> {
	...
	public static final LBiObjCharConsumer EVENTUALLY_THROW = LBiObjCharConsumer.l((Object t1, Object t2, char c) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s ,%s  as function %s.", t1, t2, c, LBiObjCharConsumer.DESCRIPTION);
	...
	public LBiObjCharConsumerBuilder(@Nullable Consumer<LBiObjCharConsumer<T1, T2>> consumer) {
		super(EVENTUALLY_THROW, () -> new LBiObjCharConsumerBuilder(null));
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2> LBiObjCharConsumerBuilder<T1, T2> casesOf(Class<E1> argC1, Class<E2> argC2, Consumer<LBiObjCharConsumerBuilder<E1, E2>> pcpConsumer) {
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2> LBiObjCharConsumerBuilder<T1, T2> aCase(Class<E1> argC1, Class<E2> argC2, LBiObjCharConsumer<E1, E2> function) {
		PartialCase.The pc = partialCaseFactoryMethod((T1 t1, T2 t2, char c) -> (argC1 == null || argC1.isInstance(t1)) && (argC2 == null || argC2.isInstance(t2)));
	...
	public final LBiObjCharConsumer<T1, T2> build() {
		...
		final LBiObjCharConsumer<T1, T2> eventuallyFinal = this.eventually;
		...
		retval = LBiObjCharConsumer.<T1, T2> l((T1 t1, T2 t2, char c) -> {
			try {
