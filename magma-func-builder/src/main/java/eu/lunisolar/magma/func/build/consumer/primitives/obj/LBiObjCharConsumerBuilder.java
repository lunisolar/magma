...
public final class LBiObjCharConsumerBuilder<T1, T2> extends PerCaseBuilder.Base<LBiObjCharConsumerBuilder<T1, T2>, LBiObjCharPredicate<T1, T2>, LBiObjCharConsumer<T1, T2>> {
	...
	public static final LBiObjCharConsumer EVENTUALLY_THROW = LBiObjCharConsumer.l((Object a1, Object a2, char a3) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s ,%s  as function %s.", a1, a2, a3, LBiObjCharConsumer.DESCRIPTION);
	...
	public final LBiObjCharConsumer<T1, T2> build() {
		...
		retval = LBiObjCharConsumer.<T1, T2> l((T1 a1, T2 a2, char a3) -> {
			try {
