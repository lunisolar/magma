...
public final class LBiObjCharConsumerBuilder<T1, T2> extends PerCaseBuilder.Base<LBiObjCharConsumerBuilder<T1, T2>, LBiObjCharPredicate<T1, T2>, LBiObjCharConsumer<T1, T2>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T1, T2> LBiObjCharConsumerBuilder<T1, T2> biObjCharConsumer() {
		return new LBiObjCharConsumerBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T1, T2> LBiObjCharConsumerBuilder<T1, T2> biObjCharConsumer(Consumer<LBiObjCharConsumer<T1, T2>> consumer) {
