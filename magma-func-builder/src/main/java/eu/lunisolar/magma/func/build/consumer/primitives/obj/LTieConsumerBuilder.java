...
public final class LTieConsumerBuilder<T1, T2> extends PerCaseBuilder.Base<LTieConsumerBuilder<T1, T2>, LObjIntObjPredicate<T1, T2>, LTieConsumer<T1, T2>> {
	...
	public static final LTieConsumer EVENTUALLY_THROW = LTieConsumer.tieCons((a1, a2, a3) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LTieConsumerBuilder(@Nullable Consumer<LTieConsumer<T1, T2>> consumer) {
		super(EVENTUALLY_THROW, () -> new LTieConsumerBuilder(null));
	...
	@Nonnull
	public static <T1, T2> LTieConsumer<T1, T2> tieConsumerFrom(Function<LTieConsumerBuilder<T1, T2>, LTieConsumer<T1, T2>> buildingFunction) {
		return buildingFunction.apply(new LTieConsumerBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LTieConsumerBuilder<T1, T2> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LTieConsumerBuilder<T1, T2> aCase(Class<V1> argC1, Class<V2> argC3, LTieConsumer<V1, V2> function) {
		PartialCase.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC3 == null || argC3.isInstance(a2)));
	...
	public final LTieConsumer<T1, T2> build() {
		...
		final LTieConsumer<T1, T2> eventuallyFinal = this.eventually;
	...
	public final LTieConsumer<T1, T2> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
