...
public abstract class PerCaseBuilderWithIntProduct<PCB extends PerCaseBuilderWithIntProduct<PCB, P, F, PC>, P, F, PC extends PartialCaseWithIntProduct<PC, PCB, P, F>> extends PerCaseBuilder<PCB, P, F, PC> {
	...
	protected PerCaseBuilderWithIntProduct(@Nonnull F eventually, @Nonnull LIntFunction<F> directToFunction, @Nonnull Supplier<PCB> subCasesFactory) {
	...
	protected PC partialCaseFactoryMethod(P casePredicate) {
		return (PC) new PartialCaseWithIntProduct(self(), casePredicate, subCasesFactory);
	}
	...
	public static abstract class Base<SELF extends Base<SELF, P, F>, P, F> extends PerCaseBuilderWithIntProduct<SELF, P, F, PartialCaseWithIntProduct.The<SELF, P, F>> {
		protected Base(@Nonnull F eventually, @Nonnull LIntFunction<F> directToFunction, @Nonnull Supplier<SELF> subCasesFactory) {
		...
		protected PartialCaseWithIntProduct.The<SELF, P, F> partialCaseFactoryMethod(P casePredicate) {
			return new PartialCaseWithIntProduct.The(this, casePredicate, subCasesFactory);
		}
	}
