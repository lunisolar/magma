...
public final class ObjIntConsumerXBuilder<T, X extends Exception> extends PerCaseBuilder.Base<ObjIntConsumerXBuilder<T, X>, ObjIntPredicateX<T, X>, ObjIntConsumerX<T, X>> {
