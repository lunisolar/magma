...
public final class LObjDoubleConsumerXBuilder<T, X extends Throwable> extends PerCaseBuilder.Base<LObjDoubleConsumerXBuilder<T, X>, LObjDoublePredicateX<T, X>, LObjDoubleConsumerX<T, X>> {
	...
	public static final LObjDoubleConsumerX EVENTUALLY_THROW = LObjDoubleConsumerX.lX((a1, a2) -> {
	...
	@Nonnull
	public static <T, X extends Throwable> LObjDoubleConsumerX<T, X> objDoubleConsumerXFrom(Function<LObjDoubleConsumerXBuilder<T, X>, LObjDoubleConsumerX<T, X>> buildingFunction) {
		return buildingFunction.apply(new LObjDoubleConsumerXBuilder());
	}
	...
	@Nonnull
	public <V extends T> LObjDoubleConsumerXBuilder<T, X> casesOf(Class<V> argC1, Consumer<LObjDoubleConsumerXBuilder<V, X>> pcpConsumer) {
	...
	@Nonnull
	public <V extends T> LObjDoubleConsumerXBuilder<T, X> aCase(Class<V> argC1, LObjDoubleConsumerX<V, X> function) {
		PartialCase.The pc = partialCaseFactoryMethod((a1, a2) -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LObjDoubleConsumerX<T, X> build() {
		...
		retval = LObjDoubleConsumerX.<T, X> lX((a1, a2) -> {
			try {
