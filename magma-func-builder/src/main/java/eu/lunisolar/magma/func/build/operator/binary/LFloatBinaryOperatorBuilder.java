...
public final class LFloatBinaryOperatorBuilder extends PerCaseBuilderWithFloatProduct.Base<LFloatBinaryOperatorBuilder, LBiFloatPredicate, LFloatBinaryOperator> {
	...
	public static final LFloatBinaryOperator EVENTUALLY_THROW = LFloatBinaryOperator.l((float f1, float f2) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s  as function %s.", f1, f2, LFloatBinaryOperator.DESCRIPTION);
	...
	public LFloatBinaryOperatorBuilder(@Nullable Consumer<LFloatBinaryOperator> consumer) {
		super(EVENTUALLY_THROW, LFloatBinaryOperator::constant);
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final LFloatBinaryOperatorBuilder floatBinaryOperator() {
		return new LFloatBinaryOperatorBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final LFloatBinaryOperatorBuilder floatBinaryOperator(Consumer<LFloatBinaryOperator> consumer) {
