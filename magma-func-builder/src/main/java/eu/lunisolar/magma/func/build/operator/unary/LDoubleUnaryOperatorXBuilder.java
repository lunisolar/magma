...
public final class LDoubleUnaryOperatorXBuilder<X extends Exception> extends PerCaseBuilderWithDoubleProduct.Base<LDoubleUnaryOperatorXBuilder<X>, LDoublePredicateX<X>, LDoubleUnaryOperatorX<X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Exception> LDoubleUnaryOperatorXBuilder<X> doubleUnaryOperatorX() {
		return new LDoubleUnaryOperatorXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Exception> LDoubleUnaryOperatorXBuilder<X> doubleUnaryOperatorX(Consumer<LDoubleUnaryOperatorX<X>> consumer) {
