...
public final class LDoubleUnaryOperatorXBuilder<X extends Throwable> extends PerCaseBuilderWithDoubleProduct.Base<LDoubleUnaryOperatorXBuilder<X>, LDoublePredicateX<X>, LDoubleUnaryOperatorX<X>> {
	...
	public static final LDoubleUnaryOperatorX EVENTUALLY_THROW = LDoubleUnaryOperatorX.lX(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LDoubleUnaryOperatorXBuilder(@Nullable Consumer<LDoubleUnaryOperatorX<X>> consumer) {
		super(EVENTUALLY_THROW, LDoubleUnaryOperatorX::constant, () -> new LDoubleUnaryOperatorXBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <X extends Throwable> LDoubleUnaryOperatorXBuilder<X> doubleUnaryOperatorX() {
		return new LDoubleUnaryOperatorXBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static <X extends Throwable> LDoubleUnaryOperatorX<X> doubleUnaryOperatorXFrom(Function<LDoubleUnaryOperatorXBuilder<X>, LDoubleUnaryOperatorX<X>> buildingFunction) {
		return buildingFunction.apply(new LDoubleUnaryOperatorXBuilder());
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <X extends Throwable> LDoubleUnaryOperatorXBuilder<X> doubleUnaryOperatorX(Consumer<LDoubleUnaryOperatorX<X>> consumer) {
	...
	public final LDoubleUnaryOperatorX<X> build() {
		...
		retval = LDoubleUnaryOperatorX.<X> lX(a -> {
			try {
