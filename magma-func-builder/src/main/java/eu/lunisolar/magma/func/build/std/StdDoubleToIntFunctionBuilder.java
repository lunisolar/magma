...
public final class StdDoubleToIntFunctionBuilder extends PerCaseBuilder<StdDoubleToIntFunctionBuilder, DoublePredicate, java.util.function.DoubleToIntFunction> {
	...
	public StdDoubleToIntFunctionBuilder() {
		this(null);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final StdDoubleToIntFunctionBuilder stdDoubleToIntFunction() {
		return new StdDoubleToIntFunctionBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final StdDoubleToIntFunctionBuilder stdDoubleToIntFunction(Consumer<java.util.function.DoubleToIntFunction> consumer) {
		return new StdDoubleToIntFunctionBuilder(consumer);
	}
