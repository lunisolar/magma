...
public final class LByteToShortFunctionBuilder extends PerCaseBuilderWithShortProduct.Base<LByteToShortFunctionBuilder, LBytePredicate, LByteToShortFunction> {
	...
	public static final LByteToShortFunction EVENTUALLY_THROW = LByteToShortFunction.l((byte a1) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", a1, LByteToShortFunction.DESCRIPTION);
