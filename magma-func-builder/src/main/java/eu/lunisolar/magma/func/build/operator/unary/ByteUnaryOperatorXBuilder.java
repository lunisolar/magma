...
public final class ByteUnaryOperatorXBuilder<X extends Exception> extends PerCaseBuilderWithByteProduct.Base<ByteUnaryOperatorXBuilder<X>, BytePredicateX<X>, ByteUnaryOperatorX<X>> {
