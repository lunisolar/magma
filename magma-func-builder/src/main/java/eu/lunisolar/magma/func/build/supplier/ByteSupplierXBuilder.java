...
public final class ByteSupplierXBuilder<X extends Exception> extends PerCaseBuilderWithByteProduct<ByteSupplierXBuilder<X>, BooleanSupplierX<X>, ByteSupplierX<X>> {
