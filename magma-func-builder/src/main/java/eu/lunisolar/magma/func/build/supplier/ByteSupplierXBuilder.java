...
/** Builder for ByteSupplierX. */
public final class ByteSupplierXBuilder<X extends Exception> extends PerCaseBuilderWithByteProduct.Base<ByteSupplierXBuilder<X>, BooleanSupplierX<X>, ByteSupplierX<X>> {
	...
	public ByteSupplierXBuilder(@Nullable Consumer<ByteSupplierX<X>> consumer) {
		super(EVENTUALLY_THROW, ByteSupplierX::of);
