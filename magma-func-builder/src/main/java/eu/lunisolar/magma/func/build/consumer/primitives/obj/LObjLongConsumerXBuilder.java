...
public final class LObjLongConsumerXBuilder<T, X extends Exception> extends PerCaseBuilder.Base<LObjLongConsumerXBuilder<T, X>, LObjLongPredicateX<T, X>, LObjLongConsumerX<T, X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T, X extends Exception> LObjLongConsumerXBuilder<T, X> objLongConsumerX() {
		return new LObjLongConsumerXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T, X extends Exception> LObjLongConsumerXBuilder<T, X> objLongConsumerX(Consumer<LObjLongConsumerX<T, X>> consumer) {
