...
public final class LToLongFunctionXBuilder<T, X extends Exception> extends PerCaseBuilderWithLongProduct.Base<LToLongFunctionXBuilder<T, X>, LPredicateX<T, X>, LToLongFunctionX<T, X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T, X extends Exception> LToLongFunctionXBuilder<T, X> toLongFunctionX() {
		return new LToLongFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T, X extends Exception> LToLongFunctionXBuilder<T, X> toLongFunctionX(Consumer<LToLongFunctionX<T, X>> consumer) {
	...
	public final LToLongFunctionX<T, X> build() {
		...
		if (cases.isEmpty()) {
			...
			retval = LToLongFunctionX.lX((T t) -> {
