...
public final class LToLongFunctionXBuilder<T, X extends Throwable> extends PerCaseBuilderWithLongProduct.Base<LToLongFunctionXBuilder<T, X>, LPredicateX<T, X>, LToLongFunctionX<T, X>> {
	...
	public static final LToLongFunctionX EVENTUALLY_THROW = LToLongFunctionX.lX(a -> {
	...
	@Nonnull
	public <V extends T> LToLongFunctionXBuilder<T, X> casesOf(Class<V> argC, Consumer<LToLongFunctionXBuilder<V, X>> pcpConsumer) {
	...
	@Nonnull
	public <V extends T> LToLongFunctionXBuilder<T, X> aCase(Class<V> argC, LToLongFunctionX<V, X> function) {
		PartialCaseWithLongProduct.The pc = partialCaseFactoryMethod(a -> (argC == null || argC.isInstance(a)));
	...
	public final LToLongFunctionX<T, X> build() {
		...
		retval = LToLongFunctionX.<T, X> lX(a -> {
			try {
