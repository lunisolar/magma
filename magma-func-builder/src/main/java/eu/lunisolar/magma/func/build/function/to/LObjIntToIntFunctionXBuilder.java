...
public final class LObjIntToIntFunctionXBuilder<T, X extends Throwable> extends PerCaseBuilderWithIntProduct.Base<LObjIntToIntFunctionXBuilder<T, X>, LObjIntPredicateX<T, X>, LObjIntToIntFunctionX<T, X>> {
	...
	public static final LObjIntToIntFunctionX EVENTUALLY_THROW = LObjIntToIntFunctionX.lX((Object a1, int a2) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s  as function %s.", a1, a2, LObjIntToIntFunctionX.DESCRIPTION);
	...
	@Nonnull
	public <E1 extends T> LObjIntToIntFunctionXBuilder<T, X> casesOf(Class<E1> argC1, Consumer<LObjIntToIntFunctionXBuilder<E1, X>> pcpConsumer) {
		PartialCaseWithIntProduct.The pc = partialCaseFactoryMethod((T a1, int a2) -> (argC1 == null || argC1.isInstance(a1)));
	...
	@Nonnull
	public <E1 extends T> LObjIntToIntFunctionXBuilder<T, X> aCase(Class<E1> argC1, LObjIntToIntFunctionX<E1, X> function) {
		PartialCaseWithIntProduct.The pc = partialCaseFactoryMethod((T a1, int a2) -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LObjIntToIntFunctionX<T, X> build() {
		...
		retval = LObjIntToIntFunctionX.<T, X> lX((T a1, int a2) -> {
			try {
