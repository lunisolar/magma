...
public final class LObjIntToIntFunctionXBuilder<T, X extends Throwable> extends PerCaseBuilderWithIntProduct.Base<LObjIntToIntFunctionXBuilder<T, X>, LObjIntPredicateX<T, X>, LObjIntToIntFunctionX<T, X>> {
	...
	public static final LObjIntToIntFunctionX EVENTUALLY_THROW = LObjIntToIntFunctionX.lX((a1, a2) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LObjIntToIntFunctionXBuilder(@Nullable Consumer<LObjIntToIntFunctionX<T, X>> consumer) {
		super(EVENTUALLY_THROW, LObjIntToIntFunctionX::constant, () -> new LObjIntToIntFunctionXBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <T, X extends Throwable> LObjIntToIntFunctionXBuilder<T, X> objIntToIntFunctionX() {
		return new LObjIntToIntFunctionXBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static <T, X extends Throwable> LObjIntToIntFunctionX<T, X> objIntToIntFunctionXFrom(Function<LObjIntToIntFunctionXBuilder<T, X>, LObjIntToIntFunctionX<T, X>> buildingFunction) {
		return buildingFunction.apply(new LObjIntToIntFunctionXBuilder());
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <T, X extends Throwable> LObjIntToIntFunctionXBuilder<T, X> objIntToIntFunctionX(Consumer<LObjIntToIntFunctionX<T, X>> consumer) {
	...
	@Nonnull
	public <V extends T> LObjIntToIntFunctionXBuilder<T, X> casesOf(Class<V> argC1, Consumer<LObjIntToIntFunctionXBuilder<V, X>> pcpConsumer) {
	...
	@Nonnull
	public <V extends T> LObjIntToIntFunctionXBuilder<T, X> aCase(Class<V> argC1, LObjIntToIntFunctionX<V, X> function) {
		PartialCaseWithIntProduct.The pc = partialCaseFactoryMethod((a1, a2) -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LObjIntToIntFunctionX<T, X> build() {
		...
		retval = LObjIntToIntFunctionX.<T, X> lX((a1, a2) -> {
			try {
