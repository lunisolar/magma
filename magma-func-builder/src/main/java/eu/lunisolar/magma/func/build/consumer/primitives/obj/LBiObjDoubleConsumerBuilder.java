...
public final class LBiObjDoubleConsumerBuilder<T1, T2> extends PerCaseBuilder.Base<LBiObjDoubleConsumerBuilder<T1, T2>, LBiObjDoublePredicate<T1, T2>, LBiObjDoubleConsumer<T1, T2>> {
	...
	public static final LBiObjDoubleConsumer EVENTUALLY_THROW = LBiObjDoubleConsumer.l((a1, a2, a3) -> {
	...
	@Nonnull
	public static <T1, T2> LBiObjDoubleConsumer<T1, T2> biObjDoubleConsumerFrom(Function<LBiObjDoubleConsumerBuilder<T1, T2>, LBiObjDoubleConsumer<T1, T2>> buildingFunction) {
		return buildingFunction.apply(new LBiObjDoubleConsumerBuilder());
	}
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjDoubleConsumerBuilder<T1, T2> casesOf(Class<V1> argC1, Class<V2> argC2, Consumer<LBiObjDoubleConsumerBuilder<V1, V2>> pcpConsumer) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjDoubleConsumerBuilder<T1, T2> aCase(Class<V1> argC1, Class<V2> argC2, LBiObjDoubleConsumer<V1, V2> function) {
		PartialCase.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LBiObjDoubleConsumer<T1, T2> build() {
		...
		retval = LBiObjDoubleConsumer.<T1, T2> l((a1, a2, a3) -> {
			try {
