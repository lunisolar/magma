...
public final class UnaryOperatorXBuilder<T, X extends Exception> extends PerCaseBuilderWithProduct.Base<UnaryOperatorXBuilder<T, X>, PredicateX<T, X>, UnaryOperatorX<T, X>, T> {
