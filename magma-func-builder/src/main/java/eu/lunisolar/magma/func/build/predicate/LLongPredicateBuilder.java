...
public final class LLongPredicateBuilder extends PerCaseBuilderWithBoolProduct.Base<LLongPredicateBuilder, LLongPredicate, LLongPredicate> {
	...
	public static final LLongPredicate OTHERWISE_THROW = LLongPredicate.longPred(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LLongPredicateBuilder(@Nullable Consumer<LLongPredicate> consumer) {
		super(OTHERWISE_THROW, LLongPredicate::constant, () -> new LLongPredicateBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static LLongPredicateBuilder longPredicate() {
		return new LLongPredicateBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static LLongPredicate longPredicateFrom(Consumer<LLongPredicateBuilder> buildingFunction) {
		LLongPredicateBuilder builder = new LLongPredicateBuilder();
	...
	@Nonnull
	public static LLongPredicateBuilder longPredicate(Consumer<LLongPredicate> consumer) {
		return new LLongPredicateBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LLongPredicateBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public LLongPredicateBuilder forValue(long v, LLongPredicate function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithBoolProduct.The<LLongPredicateBuilder, LLongPredicate, LLongPredicate> forValue(long v) {
	...
	public final LLongPredicate build() {
		...
		final LLongPredicate otherwiseFinal = this.otherwise;
	...
	public final LLongPredicate build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
