...
public final class LObjBooleanPredicateXBuilder<T, X extends Exception> extends PerCaseBuilderWithBooleanProduct.Base<LObjBooleanPredicateXBuilder<T, X>, LObjBooleanPredicateX<T, X>, LObjBooleanPredicateX<T, X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T, X extends Exception> LObjBooleanPredicateXBuilder<T, X> objBooleanPredicateX() {
		return new LObjBooleanPredicateXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T, X extends Exception> LObjBooleanPredicateXBuilder<T, X> objBooleanPredicateX(Consumer<LObjBooleanPredicateX<T, X>> consumer) {
