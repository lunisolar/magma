...
public final class LObjBooleanPredicateXBuilder<T, X extends Throwable> extends PerCaseBuilderWithBooleanProduct.Base<LObjBooleanPredicateXBuilder<T, X>, LObjBooleanPredicateX<T, X>, LObjBooleanPredicateX<T, X>> {
	...
	public LObjBooleanPredicateXBuilder(@Nullable Consumer<LObjBooleanPredicateX<T, X>> consumer) {
		super(EVENTUALLY_THROW, LObjBooleanPredicateX::constant, () -> new LObjBooleanPredicateXBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <T, X extends Throwable> LObjBooleanPredicateXBuilder<T, X> objBooleanPredicateX() {
		return new LObjBooleanPredicateXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <T, X extends Throwable> LObjBooleanPredicateXBuilder<T, X> objBooleanPredicateX(Consumer<LObjBooleanPredicateX<T, X>> consumer) {
	...
	@Nonnull
	public <E1 extends T> LObjBooleanPredicateXBuilder<T, X> casesOf(Class<E1> argC1, Consumer<LObjBooleanPredicateXBuilder<E1, X>> pcpConsumer) {
	...
	@Nonnull
	public <E1 extends T> LObjBooleanPredicateXBuilder<T, X> aCase(Class<E1> argC1, LObjBooleanPredicateX<E1, X> function) {
		PartialCaseWithBooleanProduct.The pc = partialCaseFactoryMethod((T t, boolean b) -> (argC1 == null || argC1.isInstance(t)));
	...
	public final LObjBooleanPredicateX<T, X> build() {
		...
		retval = LObjBooleanPredicateX.<T, X> lX((T t, boolean b) -> {
			try {
