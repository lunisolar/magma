...
public final class ObjDoublePredicateXBuilder<T, X extends Exception> extends PerCaseBuilder<ObjDoublePredicateXBuilder<T, X>, ObjDoublePredicateX<T, X>, ObjDoublePredicateX<T, X>> {
