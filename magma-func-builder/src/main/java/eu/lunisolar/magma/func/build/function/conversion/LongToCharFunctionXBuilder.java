...
public final class LongToCharFunctionXBuilder<X extends Exception> extends PerCaseBuilder<LongToCharFunctionXBuilder<X>, LongPredicateX<X>, LongToCharFunctionX<X>> {
