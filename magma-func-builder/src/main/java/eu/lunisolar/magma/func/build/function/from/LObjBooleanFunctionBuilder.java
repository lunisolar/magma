...
/** Builder for LObjBooleanFunction. */
public final class LObjBooleanFunctionBuilder<T, R> extends PerCaseBuilderWithProduct.Base<LObjBooleanFunctionBuilder<T, R>, LObjBooleanPredicate<T>, LObjBooleanFunction<T, R>, R> {
	...
	public static final LObjBooleanFunction EVENTUALLY_THROW = LObjBooleanFunction.l((Object t, boolean b) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s  as function %s.", t, b, LObjBooleanFunction.DESCRIPTION);
	...
	public LObjBooleanFunctionBuilder(@Nullable Consumer<LObjBooleanFunction<T, R>> consumer) {
		super(EVENTUALLY_THROW, LObjBooleanFunction::constant, () -> new LObjBooleanFunctionBuilder(null));

		this.consumer = consumer;
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	public LObjBooleanFunctionBuilder() {
		this(null);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <T, R> LObjBooleanFunctionBuilder<T, R> objBooleanFunction() {
		return new LObjBooleanFunctionBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <T, R> LObjBooleanFunctionBuilder<T, R> objBooleanFunction(Consumer<LObjBooleanFunction<T, R>> consumer) {
	...
	@Nonnull
	public <E1 extends T> LObjBooleanFunctionBuilder<T, R> casesOf(Class<E1> argC1, Consumer<LObjBooleanFunctionBuilder<E1, R>> pcpConsumer) {
	...
	@Nonnull
	public <E1 extends T> LObjBooleanFunctionBuilder<T, R> aCase(Class<E1> argC1, LObjBooleanFunction<E1, R> function) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod((T t, boolean b) -> (argC1 == null || argC1.isInstance(t)));
	...
	public final LObjBooleanFunction<T, R> build() {
		...
		final LObjBooleanFunction<T, R> eventuallyFinal = this.eventually;
