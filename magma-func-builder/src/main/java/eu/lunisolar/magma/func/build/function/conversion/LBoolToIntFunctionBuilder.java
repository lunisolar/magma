...
public final class LBoolToIntFunctionBuilder extends PerCaseBuilderWithIntProduct.Base<LBoolToIntFunctionBuilder, LLogicalOperator, LBoolToIntFunction> {
	...
	@Nonnull
	public static LBoolToIntFunction boolToIntFunctionFrom(Function<LBoolToIntFunctionBuilder, LBoolToIntFunction> buildingFunction) {
		return buildingFunction.apply(new LBoolToIntFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LBoolToIntFunctionBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LBoolToIntFunction build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
