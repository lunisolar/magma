...
public final class CharToDoubleFunctionXBuilder<X extends Exception> extends PerCaseBuilder<CharToDoubleFunctionXBuilder<X>, CharPredicateX<X>, CharToDoubleFunctionX<X>> {
