...
public final class CharToDoubleFunctionXBuilder<X extends Exception> extends PerCaseBuilderWithDoubleProduct<CharToDoubleFunctionXBuilder<X>, CharPredicateX<X>, CharToDoubleFunctionX<X>> {
