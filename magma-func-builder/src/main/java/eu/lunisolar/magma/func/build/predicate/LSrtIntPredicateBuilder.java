...
public final class LSrtIntPredicateBuilder extends PerCaseBuilderWithBoolProduct.Base<LSrtIntPredicateBuilder, LSrtIntPredicate, LSrtIntPredicate> {
	...
	@Nonnull
	public static LSrtIntPredicate srtIntPredicateFrom(Function<LSrtIntPredicateBuilder, LSrtIntPredicate> buildingFunction) {
		return buildingFunction.apply(new LSrtIntPredicateBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LSrtIntPredicateBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LSrtIntPredicate build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
