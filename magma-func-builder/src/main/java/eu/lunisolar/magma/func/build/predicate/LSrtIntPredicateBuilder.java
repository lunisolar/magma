...
public final class LSrtIntPredicateBuilder extends PerCaseBuilderWithBoolProduct.Base<LSrtIntPredicateBuilder, LSrtIntPredicate, LSrtIntPredicate> {
	...
	public static final LSrtIntPredicate OTHERWISE_THROW = LSrtIntPredicate.srtIntPred((a1, a2) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LSrtIntPredicateBuilder(@Nullable Consumer<LSrtIntPredicate> consumer) {
		super(OTHERWISE_THROW, LSrtIntPredicate::constant, () -> new LSrtIntPredicateBuilder(null));
	...
	public LSrtIntPredicateBuilder forValue(short v1, int v2, LSrtIntPredicate function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithBoolProduct.The<LSrtIntPredicateBuilder, LSrtIntPredicate, LSrtIntPredicate> forValue(short v1, int v2) {
	...
	public final LSrtIntPredicate build() {
		...
		final LSrtIntPredicate otherwiseFinal = this.otherwise;
