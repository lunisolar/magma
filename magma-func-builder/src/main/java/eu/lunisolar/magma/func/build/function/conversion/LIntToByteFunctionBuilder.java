...
public final class LIntToByteFunctionBuilder extends PerCaseBuilderWithByteProduct.Base<LIntToByteFunctionBuilder, LIntPredicate, LIntToByteFunction> {
	...
	public LIntToByteFunctionBuilder(@Nullable Consumer<LIntToByteFunction> consumer) {
		super(EVENTUALLY_THROW, LIntToByteFunction::constant, () -> new LIntToByteFunctionBuilder(null));
	...
	@Nonnull
	public static LIntToByteFunction intToByteFunctionFrom(Function<LIntToByteFunctionBuilder, LIntToByteFunction> buildingFunction) {
		return buildingFunction.apply(new LIntToByteFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LIntToByteFunctionBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LIntToByteFunction build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
