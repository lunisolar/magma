...
public final class LIntToByteFunctionBuilder extends PerCaseBuilderWithByteProduct.Base<LIntToByteFunctionBuilder, LIntPredicate, LIntToByteFunction> {
	...
	public static final LIntToByteFunction OTHERWISE_THROW = LIntToByteFunction.intToByteFunc(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LIntToByteFunctionBuilder(@Nullable Consumer<LIntToByteFunction> consumer) {
		super(OTHERWISE_THROW, LIntToByteFunction::constant, () -> new LIntToByteFunctionBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static LIntToByteFunctionBuilder intToByteFunction() {
	...
	@Nonnull
	public static LIntToByteFunctionBuilder intToByteFunction(Consumer<LIntToByteFunction> consumer) {
		return new LIntToByteFunctionBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LIntToByteFunctionBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public LIntToByteFunctionBuilder forValue(int v, LIntToByteFunction function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithByteProduct.The<LIntToByteFunctionBuilder, LIntPredicate, LIntToByteFunction> forValue(int v) {
	...
	public final LIntToByteFunction build() {
		...
		final LIntToByteFunction otherwiseFinal = this.otherwise;
	...
	public final LIntToByteFunction build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
