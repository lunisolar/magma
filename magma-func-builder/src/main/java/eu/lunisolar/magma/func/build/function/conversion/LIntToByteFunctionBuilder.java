...
public final class LIntToByteFunctionBuilder extends PerCaseBuilderWithByteProduct.Base<LIntToByteFunctionBuilder, LIntPredicate, LIntToByteFunction> {
	...
	public static final LIntToByteFunction EVENTUALLY_THROW = LIntToByteFunction.l((int a1) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", a1, LIntToByteFunction.DESCRIPTION);
