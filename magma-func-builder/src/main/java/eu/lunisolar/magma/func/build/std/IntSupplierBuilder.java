...
public final class IntSupplierBuilder extends PerCaseBuilderWithIntProduct.Base<IntSupplierBuilder, LBoolSupplier, IntSupplier> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final IntSupplierBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public final IntSupplier build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
