...
public final class LByteToCharFunctionBuilder extends PerCaseBuilderWithCharProduct.Base<LByteToCharFunctionBuilder, LBytePredicate, LByteToCharFunction> {
	...
	@Nonnull
	public static LByteToCharFunction byteToCharFunctionFrom(Consumer<LByteToCharFunctionBuilder> buildingFunction) {
		LByteToCharFunctionBuilder builder = new LByteToCharFunctionBuilder();
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LByteToCharFunctionBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public LByteToCharFunctionBuilder forValue(byte v, LByteToCharFunction function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithCharProduct.The<LByteToCharFunctionBuilder, LBytePredicate, LByteToCharFunction> forValue(byte v) {
	...
	public final LByteToCharFunction build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
