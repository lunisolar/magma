...
public final class LByteToCharFunctionBuilder extends PerCaseBuilderWithCharProduct.Base<LByteToCharFunctionBuilder, LBytePredicate, LByteToCharFunction> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LByteToCharFunctionBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LByteToCharFunction build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
