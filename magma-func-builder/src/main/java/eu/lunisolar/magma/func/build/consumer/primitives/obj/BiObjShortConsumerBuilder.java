...
public final class BiObjShortConsumerBuilder<T1, T2> extends PerCaseBuilder.Base<BiObjShortConsumerBuilder<T1, T2>, BiObjShortPredicate<T1, T2>, BiObjShortConsumer<T1, T2>> {
