...
public final class LObjIntObjFunctionBuilder<T1, T2, R> extends PerCaseBuilderWithProduct.Base<LObjIntObjFunctionBuilder<T1, T2, R>, LObjIntObjPredicate<T1, T2>, LObjIntObjFunction<T1, T2, R>, R> {
	...
	public static final LObjIntObjFunction EVENTUALLY_THROW = LObjIntObjFunction.objIntObjFunc((a1, a2, a3) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LObjIntObjFunctionBuilder(@Nullable Consumer<LObjIntObjFunction<T1, T2, R>> consumer) {
		super(EVENTUALLY_THROW, LObjIntObjFunction::constant, () -> new LObjIntObjFunctionBuilder(null));
	...
	@Nonnull
	public static <T1, T2, R> LObjIntObjFunction<T1, T2, R> objIntObjFunctionFrom(Function<LObjIntObjFunctionBuilder<T1, T2, R>, LObjIntObjFunction<T1, T2, R>> buildingFunction) {
		return buildingFunction.apply(new LObjIntObjFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LObjIntObjFunctionBuilder<T1, T2, R> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LObjIntObjFunctionBuilder<T1, T2, R> aCase(Class<V1> argC1, Class<V2> argC3, LObjIntObjFunction<V1, V2, R> function) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC3 == null || argC3.isInstance(a2)));
	...
	public final LObjIntObjFunction<T1, T2, R> build() {
		...
		final LObjIntObjFunction<T1, T2, R> eventuallyFinal = this.eventually;
	...
	public final LObjIntObjFunction<T1, T2, R> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
