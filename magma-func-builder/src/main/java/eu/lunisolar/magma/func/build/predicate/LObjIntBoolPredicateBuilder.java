...
public final class LObjIntBoolPredicateBuilder<T> extends PerCaseBuilderWithBoolProduct.Base<LObjIntBoolPredicateBuilder<T>, LObjIntBoolPredicate<T>, LObjIntBoolPredicate<T>> {
	...
	public static final LObjIntBoolPredicate EVENTUALLY_THROW = LObjIntBoolPredicate.objIntBoolPred((a1, a2, a3) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LObjIntBoolPredicateBuilder(@Nullable Consumer<LObjIntBoolPredicate<T>> consumer) {
		super(EVENTUALLY_THROW, LObjIntBoolPredicate::constant, () -> new LObjIntBoolPredicateBuilder(null));
	...
	@Nonnull
	public static <T> LObjIntBoolPredicate<T> objIntBoolPredicateFrom(Function<LObjIntBoolPredicateBuilder<T>, LObjIntBoolPredicate<T>> buildingFunction) {
		return buildingFunction.apply(new LObjIntBoolPredicateBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LObjIntBoolPredicateBuilder<T> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	@Nonnull
	public <V extends T> LObjIntBoolPredicateBuilder<T> aCase(Class<V> argC1, LObjIntBoolPredicate<V> function) {
		PartialCaseWithBoolProduct.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LObjIntBoolPredicate<T> build() {
		...
		final LObjIntBoolPredicate<T> eventuallyFinal = this.eventually;
	...
	public final LObjIntBoolPredicate<T> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
