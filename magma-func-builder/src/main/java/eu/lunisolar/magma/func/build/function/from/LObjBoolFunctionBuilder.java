...
public final class LObjBoolFunctionBuilder<T, R> extends PerCaseBuilderWithProduct.Base<LObjBoolFunctionBuilder<T, R>, LObjBoolPredicate<T>, LObjBoolFunction<T, R>, R> {
	...
	public static final LObjBoolFunction EVENTUALLY_THROW = LObjBoolFunction.l((a1, a2) -> {
	...
	@Nonnull
	public static <T, R> LObjBoolFunction<T, R> objBoolFunctionFrom(Function<LObjBoolFunctionBuilder<T, R>, LObjBoolFunction<T, R>> buildingFunction) {
		return buildingFunction.apply(new LObjBoolFunctionBuilder());
	}
	...
	public final LObjBoolFunction<T, R> build() {
		...
		retval = LObjBoolFunction.<T, R> l((a1, a2) -> {
			try {
