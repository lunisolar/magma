...
public final class LObjBoolFunctionBuilder<T, R> extends PerCaseBuilderWithProduct.Base<LObjBoolFunctionBuilder<T, R>, LObjBoolPredicate<T>, LObjBoolFunction<T, R>, R> {
	...
	public <V extends T> LObjBoolFunctionBuilder<T, R> forValue(T v1, boolean v2, LObjBoolFunction<V, R> function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public <V extends T> PartialCaseWithProduct.The<LObjBoolFunctionBuilder<T, R>, LObjBoolPredicate<T>, LObjBoolFunction<T, R>, R> forValue(T v1, boolean v2) {
	...
	@Nonnull
	public <V extends T> LObjBoolFunctionBuilder<T, R> forClass(Class<V> argC1, LObjBoolFunction<V, R> function) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod((a1, a2) -> (argC1 == null || argC1.isInstance(a1)));
		pc.evaluate(function);
		return fluentCtx();
	}
	...
	/** Adds full new case for the argument that are of specific classes (matched by instanceOf, null is a wildcard). */
	@Nonnull
	public <V extends T> PartialCaseWithProduct.The<LObjBoolFunctionBuilder<T, R>, LObjBoolPredicate<T>, LObjBoolFunction<T, R>, R> forClass(Class<V> argC1) {
