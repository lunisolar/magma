...
public final class LObjBoolFunctionBuilder<T, R> extends PerCaseBuilderWithProduct.Base<LObjBoolFunctionBuilder<T, R>, LObjBoolPredicate<T>, LObjBoolFunction<T, R>, R> {
	...
	public static final LObjBoolFunction EVENTUALLY_THROW = LObjBoolFunction.l((Object a1, boolean a2) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s  as function %s.", a1, a2, LObjBoolFunction.DESCRIPTION);
	...
	public final LObjBoolFunction<T, R> build() {
		...
		retval = LObjBoolFunction.<T, R> l((T a1, boolean a2) -> {
			try {
