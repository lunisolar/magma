...
public final class ObjBooleanPredicateXBuilder<T, X extends Exception> extends PerCaseBuilderWithBooleanProduct<ObjBooleanPredicateXBuilder<T, X>, ObjBooleanPredicateX<T, X>, ObjBooleanPredicateX<T, X>> {
