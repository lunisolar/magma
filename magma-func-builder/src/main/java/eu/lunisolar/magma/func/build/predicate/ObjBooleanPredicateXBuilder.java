...
public final class ObjBooleanPredicateXBuilder<T, X extends Exception> extends PerCaseBuilder<ObjBooleanPredicateXBuilder<T, X>, ObjBooleanPredicateX<T, X>, ObjBooleanPredicateX<T, X>> {
