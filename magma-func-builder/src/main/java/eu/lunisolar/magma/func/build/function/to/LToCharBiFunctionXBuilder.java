...
public final class LToCharBiFunctionXBuilder<T1, T2, X extends Exception> extends PerCaseBuilderWithCharProduct.Base<LToCharBiFunctionXBuilder<T1, T2, X>, LBiPredicateX<T1, T2, X>, LToCharBiFunctionX<T1, T2, X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T1, T2, X extends Exception> LToCharBiFunctionXBuilder<T1, T2, X> toCharBiFunctionX() {
		return new LToCharBiFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T1, T2, X extends Exception> LToCharBiFunctionXBuilder<T1, T2, X> toCharBiFunctionX(Consumer<LToCharBiFunctionX<T1, T2, X>> consumer) {
	...
	public final LToCharBiFunctionX<T1, T2, X> build() {
		...
		if (cases.isEmpty()) {
			...
			retval = LToCharBiFunctionX.lX((T1 t1, T2 t2) -> {
