...
public final class LShortToLongFunctionBuilder extends PerCaseBuilderWithLongProduct.Base<LShortToLongFunctionBuilder, LShortPredicate, LShortToLongFunction> {
	...
	public LShortToLongFunctionBuilder(@Nullable Consumer<LShortToLongFunction> consumer) {
		super(EVENTUALLY_THROW, LShortToLongFunction::constant, () -> new LShortToLongFunctionBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static LShortToLongFunctionBuilder shortToLongFunction() {
		return new LShortToLongFunctionBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static LShortToLongFunction shortToLongFunctionFrom(Function<LShortToLongFunctionBuilder, LShortToLongFunction> buildingFunction) {
		return buildingFunction.apply(new LShortToLongFunctionBuilder());
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static LShortToLongFunctionBuilder shortToLongFunction(Consumer<LShortToLongFunction> consumer) {
		return new LShortToLongFunctionBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LShortToLongFunctionBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LShortToLongFunction build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
