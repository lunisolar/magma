...
public final class StdToIntBiFunctionBuilder<T1, T2> extends PerCaseBuilderWithIntProduct<StdToIntBiFunctionBuilder<T1, T2>, BiPredicate<T1, T2>, java.util.function.ToIntBiFunction<T1, T2>> {
	...
	public StdToIntBiFunctionBuilder() {
		this(null);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T1, T2> StdToIntBiFunctionBuilder<T1, T2> stdToIntBiFunction() {
		return new StdToIntBiFunctionBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T1, T2> StdToIntBiFunctionBuilder<T1, T2> stdToIntBiFunction(Consumer<java.util.function.ToIntBiFunction<T1, T2>> consumer) {
		return new StdToIntBiFunctionBuilder(consumer);
	}
