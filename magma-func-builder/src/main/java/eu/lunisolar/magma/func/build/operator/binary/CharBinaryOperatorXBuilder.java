...
public final class CharBinaryOperatorXBuilder<X extends Exception> extends PerCaseBuilderWithCharProduct<CharBinaryOperatorXBuilder<X>, BiCharPredicateX<X>, CharBinaryOperatorX<X>> {
