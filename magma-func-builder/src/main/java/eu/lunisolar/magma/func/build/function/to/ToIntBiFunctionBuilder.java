...
public final class ToIntBiFunctionBuilder<T1, T2> extends PerCaseBuilderWithIntProduct.Base<ToIntBiFunctionBuilder<T1, T2>, BiPredicate<T1, T2>, ToIntBiFunction<T1, T2>> {
