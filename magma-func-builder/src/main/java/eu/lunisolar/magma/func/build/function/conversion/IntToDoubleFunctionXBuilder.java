...
public final class IntToDoubleFunctionXBuilder<X extends Exception> extends PerCaseBuilderWithDoubleProduct<IntToDoubleFunctionXBuilder<X>, IntPredicateX<X>, IntToDoubleFunctionX<X>> {
