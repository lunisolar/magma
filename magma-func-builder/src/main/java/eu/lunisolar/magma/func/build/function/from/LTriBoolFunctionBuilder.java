...
public final class LTriBoolFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LTriBoolFunctionBuilder<R>, LLogicalTernaryOperator, LTriBoolFunction<R>, R> {
	...
	public static final LTriBoolFunction EVENTUALLY_THROW = LTriBoolFunction.l((boolean b1, boolean b2, boolean b3) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s ,%s  as function %s.", b1, b2, b3, LTriBoolFunction.DESCRIPTION);
	...
	public final LTriBoolFunction<R> build() {
		...
		retval = LTriBoolFunction.<R> l((boolean b1, boolean b2, boolean b3) -> {
			try {
