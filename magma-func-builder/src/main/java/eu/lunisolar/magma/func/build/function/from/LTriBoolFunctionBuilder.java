...
public final class LTriBoolFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LTriBoolFunctionBuilder<R>, LLogicalTernaryOperator, LTriBoolFunction<R>, R> {
	...
	public static final LTriBoolFunction EVENTUALLY_THROW = LTriBoolFunction.l((boolean a1, boolean a2, boolean a3) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s ,%s  as function %s.", a1, a2, a3, LTriBoolFunction.DESCRIPTION);
	...
	public final LTriBoolFunction<R> build() {
		...
		retval = LTriBoolFunction.<R> l((boolean a1, boolean a2, boolean a3) -> {
			try {
