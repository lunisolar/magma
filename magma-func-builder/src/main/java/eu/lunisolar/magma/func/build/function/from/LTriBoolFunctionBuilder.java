...
public final class LTriBoolFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LTriBoolFunctionBuilder<R>, LLogicalTernaryOperator, LTriBoolFunction<R>, R> {
	...
	public static final LTriBoolFunction EVENTUALLY_THROW = LTriBoolFunction.l((a1, a2, a3) -> {
	...
	@Nonnull
	public static <R> LTriBoolFunction<R> triBoolFunctionFrom(Function<LTriBoolFunctionBuilder<R>, LTriBoolFunction<R>> buildingFunction) {
		return buildingFunction.apply(new LTriBoolFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LTriBoolFunctionBuilder<R> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LTriBoolFunction<R> build() {
		...
		retval = LTriBoolFunction.<R> l((a1, a2, a3) -> {
			try {
	...
	public final LTriBoolFunction<R> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
