...
public final class LObjIntFltFunctionBuilder<T, R> extends PerCaseBuilderWithProduct.Base<LObjIntFltFunctionBuilder<T, R>, LObjIntFltPredicate<T>, LObjIntFltFunction<T, R>, R> {
	...
	@Nonnull
	public static <T, R> LObjIntFltFunction<T, R> objIntFltFunctionFrom(Function<LObjIntFltFunctionBuilder<T, R>, LObjIntFltFunction<T, R>> buildingFunction) {
		return buildingFunction.apply(new LObjIntFltFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LObjIntFltFunctionBuilder<T, R> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LObjIntFltFunction<T, R> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
