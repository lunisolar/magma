...
public final class LObjIntFltFunctionBuilder<T, R> extends PerCaseBuilderWithProduct.Base<LObjIntFltFunctionBuilder<T, R>, LObjIntFltPredicate<T>, LObjIntFltFunction<T, R>, R> {
	...
	public static final LObjIntFltFunction OTHERWISE_THROW = LObjIntFltFunction.objIntFltFunc((a1, a2, a3) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LObjIntFltFunctionBuilder(@Nullable Consumer<LObjIntFltFunction<T, R>> consumer) {
		super(OTHERWISE_THROW, LObjIntFltFunction::constant, () -> new LObjIntFltFunctionBuilder(null));
	...
	public <V extends T> LObjIntFltFunctionBuilder<T, R> forValue(T v1, int v2, float v3, LObjIntFltFunction<V, R> function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public <V extends T> PartialCaseWithProduct.The<LObjIntFltFunctionBuilder<T, R>, LObjIntFltPredicate<T>, LObjIntFltFunction<T, R>, R> forValue(T v1, int v2, float v3) {
	...
	@Nonnull
	public <V extends T> LObjIntFltFunctionBuilder<T, R> forClass(Class<V> argC1, LObjIntFltFunction<V, R> function) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)));
		pc.evaluate(function);
		return fluentCtx();
	}
	...
	/** Adds full new case for the argument that are of specific classes (matched by instanceOf, null is a wildcard). */
	@Nonnull
	public <V extends T> PartialCaseWithProduct.The<LObjIntFltFunctionBuilder<T, R>, LObjIntFltPredicate<T>, LObjIntFltFunction<T, R>, R> forClass(Class<V> argC1) {
	...
	public final LObjIntFltFunction<T, R> build() {
		...
		final LObjIntFltFunction<T, R> otherwiseFinal = this.otherwise;
