...
public final class LBiObjFloatPredicateBuilder<T1, T2> extends PerCaseBuilderWithBoolProduct.Base<LBiObjFloatPredicateBuilder<T1, T2>, LBiObjFloatPredicate<T1, T2>, LBiObjFloatPredicate<T1, T2>> {
	...
	public static final LBiObjFloatPredicate EVENTUALLY_THROW = LBiObjFloatPredicate.l((a1, a2, a3) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LBiObjFloatPredicateBuilder(@Nullable Consumer<LBiObjFloatPredicate<T1, T2>> consumer) {
		super(EVENTUALLY_THROW, LBiObjFloatPredicate::constant, () -> new LBiObjFloatPredicateBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <T1, T2> LBiObjFloatPredicateBuilder<T1, T2> biObjFloatPredicate() {
		return new LBiObjFloatPredicateBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static <T1, T2> LBiObjFloatPredicate<T1, T2> biObjFloatPredicateFrom(Function<LBiObjFloatPredicateBuilder<T1, T2>, LBiObjFloatPredicate<T1, T2>> buildingFunction) {
		return buildingFunction.apply(new LBiObjFloatPredicateBuilder());
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <T1, T2> LBiObjFloatPredicateBuilder<T1, T2> biObjFloatPredicate(Consumer<LBiObjFloatPredicate<T1, T2>> consumer) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjFloatPredicateBuilder<T1, T2> casesOf(Class<V1> argC1, Class<V2> argC2, Consumer<LBiObjFloatPredicateBuilder<V1, V2>> pcpConsumer) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjFloatPredicateBuilder<T1, T2> aCase(Class<V1> argC1, Class<V2> argC2, LBiObjFloatPredicate<V1, V2> function) {
		PartialCaseWithBoolProduct.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LBiObjFloatPredicate<T1, T2> build() {
		...
		retval = LBiObjFloatPredicate.<T1, T2> l((a1, a2, a3) -> {
			try {
