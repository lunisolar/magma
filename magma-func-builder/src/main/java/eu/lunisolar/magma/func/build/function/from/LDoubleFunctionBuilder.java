...
public final class LDoubleFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LDoubleFunctionBuilder<R>, LDoublePredicate, LDoubleFunction<R>, R> {
	...
	public LDoubleFunctionBuilder(@Nullable Consumer<LDoubleFunction<R>> consumer) {
		super(EVENTUALLY_THROW, LDoubleFunction::constant, () -> new LDoubleFunctionBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <R> LDoubleFunctionBuilder<R> doubleFunction() {
		return new LDoubleFunctionBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static <R> LDoubleFunction<R> doubleFunctionFrom(Function<LDoubleFunctionBuilder<R>, LDoubleFunction<R>> buildingFunction) {
		return buildingFunction.apply(new LDoubleFunctionBuilder());
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <R> LDoubleFunctionBuilder<R> doubleFunction(Consumer<LDoubleFunction<R>> consumer) {
		return new LDoubleFunctionBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LDoubleFunctionBuilder<R> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LDoubleFunction<R> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
