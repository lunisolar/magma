...
public final class LDoubleFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LDoubleFunctionBuilder<R>, LDoublePredicate, LDoubleFunction<R>, R> {
	...
	public static final LDoubleFunction EVENTUALLY_THROW = LDoubleFunction.l((double a1) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", a1, LDoubleFunction.DESCRIPTION);
