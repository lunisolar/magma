...
public final class BooleanConsumerXBuilder<X extends Exception> extends PerCaseBuilder.Base<BooleanConsumerXBuilder<X>, BooleanUnaryOperatorX<X>, BooleanConsumerX<X>> {
