...
public final class LCharToByteFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithByteProduct.Base<LCharToByteFunctionXBuilder<X>, LCharPredicateX<X>, LCharToByteFunctionX<X>> {
	...
	public static final LCharToByteFunctionX EVENTUALLY_THROW = LCharToByteFunctionX.lX(a1 -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LCharToByteFunctionXBuilder(@Nullable Consumer<LCharToByteFunctionX<X>> consumer) {
		super(EVENTUALLY_THROW, LCharToByteFunctionX::constant, () -> new LCharToByteFunctionXBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <X extends Throwable> LCharToByteFunctionXBuilder<X> charToByteFunctionX() {
		return new LCharToByteFunctionXBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static <X extends Throwable> LCharToByteFunctionX<X> charToByteFunctionXFrom(Function<LCharToByteFunctionXBuilder<X>, LCharToByteFunctionX<X>> buildingFunction) {
		return buildingFunction.apply(new LCharToByteFunctionXBuilder());
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <X extends Throwable> LCharToByteFunctionXBuilder<X> charToByteFunctionX(Consumer<LCharToByteFunctionX<X>> consumer) {
	...
	public final LCharToByteFunctionX<X> build() {
		...
		retval = LCharToByteFunctionX.<X> lX(a1 -> {
			try {
