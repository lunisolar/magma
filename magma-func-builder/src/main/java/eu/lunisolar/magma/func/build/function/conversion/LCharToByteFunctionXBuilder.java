...
public final class LCharToByteFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithByteProduct.Base<LCharToByteFunctionXBuilder<X>, LCharPredicateX<X>, LCharToByteFunctionX<X>> {
	...
	public static final LCharToByteFunctionX EVENTUALLY_THROW = LCharToByteFunctionX.lX((char a1) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", a1, LCharToByteFunctionX.DESCRIPTION);
