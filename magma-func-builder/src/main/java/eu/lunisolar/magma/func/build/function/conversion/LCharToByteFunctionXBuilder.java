...
public final class LCharToByteFunctionXBuilder<X extends Exception> extends PerCaseBuilderWithByteProduct.Base<LCharToByteFunctionXBuilder<X>, LCharPredicateX<X>, LCharToByteFunctionX<X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Exception> LCharToByteFunctionXBuilder<X> charToByteFunctionX() {
		return new LCharToByteFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Exception> LCharToByteFunctionXBuilder<X> charToByteFunctionX(Consumer<LCharToByteFunctionX<X>> consumer) {
