...
public final class LDoubleToCharFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithCharProduct.Base<LDoubleToCharFunctionXBuilder<X>, LDoublePredicateX<X>, LDoubleToCharFunctionX<X>> {
	...
	public LDoubleToCharFunctionXBuilder(@Nullable Consumer<LDoubleToCharFunctionX<X>> consumer) {
		super(EVENTUALLY_THROW, LDoubleToCharFunctionX::constant, () -> new LDoubleToCharFunctionXBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <X extends Throwable> LDoubleToCharFunctionXBuilder<X> doubleToCharFunctionX() {
		return new LDoubleToCharFunctionXBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static <X extends Throwable> LDoubleToCharFunctionX<X> doubleToCharFunctionXFrom(Function<LDoubleToCharFunctionXBuilder<X>, LDoubleToCharFunctionX<X>> buildingFunction) {
		return buildingFunction.apply(new LDoubleToCharFunctionXBuilder());
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <X extends Throwable> LDoubleToCharFunctionXBuilder<X> doubleToCharFunctionX(Consumer<LDoubleToCharFunctionX<X>> consumer) {
		return new LDoubleToCharFunctionXBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LDoubleToCharFunctionXBuilder<X> withHandling(@Nonnull HandlingInstructions<X, X> handling) {
	...
	public final LDoubleToCharFunctionX<X> build(@Nonnull HandlingInstructions<X, X> handling) {
