...
public final class LDoubleToCharFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithCharProduct.Base<LDoubleToCharFunctionXBuilder<X>, LDoublePredicateX<X>, LDoubleToCharFunctionX<X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Throwable> LDoubleToCharFunctionXBuilder<X> doubleToCharFunctionX() {
		return new LDoubleToCharFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Throwable> LDoubleToCharFunctionXBuilder<X> doubleToCharFunctionX(Consumer<LDoubleToCharFunctionX<X>> consumer) {
