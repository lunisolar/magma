...
public final class BiObjFloatPredicateXBuilder<T1, T2, X extends Exception> extends PerCaseBuilderWithBooleanProduct<BiObjFloatPredicateXBuilder<T1, T2, X>, BiObjFloatPredicateX<T1, T2, X>, BiObjFloatPredicateX<T1, T2, X>> {
