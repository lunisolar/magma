...
public final class BiObjFloatPredicateXBuilder<T1, T2, X extends Exception> extends PerCaseBuilder<BiObjFloatPredicateXBuilder<T1, T2, X>, BiObjFloatPredicateX<T1, T2, X>, BiObjFloatPredicateX<T1, T2, X>> {
