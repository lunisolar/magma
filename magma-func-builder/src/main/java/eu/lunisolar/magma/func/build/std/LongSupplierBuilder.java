...
public final class LongSupplierBuilder extends PerCaseBuilderWithLongProduct.Base<LongSupplierBuilder, LBoolSupplier, LongSupplier> {
	...
	public static final LongSupplier OTHERWISE_THROW = Function4U.longSup(() -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LongSupplierBuilder(@Nullable Consumer<LongSupplier> consumer) {
		super(OTHERWISE_THROW, LLongSupplier::of, () -> new LongSupplierBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static LongSupplierBuilder longSupplier() {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LongSupplierBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public final LongSupplier build() {
		...
		final LongSupplier otherwiseFinal = this.otherwise;
	...
	public final LongSupplier build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
