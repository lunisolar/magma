...
public final class LongSupplierBuilder extends PerCaseBuilderWithLongProduct.Base<LongSupplierBuilder, LBooleanSupplier, java.util.function.LongSupplier> {
	...
	@Nonnull
	public static final LongSupplierBuilder longSupplier(Consumer<java.util.function.LongSupplier> consumer) {
		return new LongSupplierBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LongSupplierBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
