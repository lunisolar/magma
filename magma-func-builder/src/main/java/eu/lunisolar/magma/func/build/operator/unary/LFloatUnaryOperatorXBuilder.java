...
public final class LFloatUnaryOperatorXBuilder<X extends Throwable> extends PerCaseBuilderWithFloatProduct.Base<LFloatUnaryOperatorXBuilder<X>, LFloatPredicateX<X>, LFloatUnaryOperatorX<X>> {
	...
	public LFloatUnaryOperatorXBuilder(@Nullable Consumer<LFloatUnaryOperatorX<X>> consumer) {
		super(EVENTUALLY_THROW, LFloatUnaryOperatorX::constant, () -> new LFloatUnaryOperatorXBuilder(null));

		this.consumer = consumer;
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	public LFloatUnaryOperatorXBuilder() {
		this(null);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <X extends Throwable> LFloatUnaryOperatorXBuilder<X> floatUnaryOperatorX() {
		return new LFloatUnaryOperatorXBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static <X extends Throwable> LFloatUnaryOperatorX<X> floatUnaryOperatorXFrom(Function<LFloatUnaryOperatorXBuilder<X>, LFloatUnaryOperatorX<X>> buildingFunction) {
		return buildingFunction.apply(new LFloatUnaryOperatorXBuilder());
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <X extends Throwable> LFloatUnaryOperatorXBuilder<X> floatUnaryOperatorX(Consumer<LFloatUnaryOperatorX<X>> consumer) {
	...
	@Nonnull
	public final LFloatUnaryOperatorX<X> build() {

		final LFloatUnaryOperatorX<X> eventuallyFinal = this.eventually;
