...
public final class LFloatUnaryOperatorXBuilder<X extends Throwable> extends PerCaseBuilderWithFloatProduct.Base<LFloatUnaryOperatorXBuilder<X>, LFloatPredicateX<X>, LFloatUnaryOperatorX<X>> {
	...
	public static final LFloatUnaryOperatorX EVENTUALLY_THROW = LFloatUnaryOperatorX.lX((float a1) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", a1, LFloatUnaryOperatorX.DESCRIPTION);
