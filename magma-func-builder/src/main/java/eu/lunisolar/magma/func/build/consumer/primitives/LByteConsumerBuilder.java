...
public final class LByteConsumerBuilder extends PerCaseBuilder.Base<LByteConsumerBuilder, LBytePredicate, LByteConsumer> {
	...
	public static final LByteConsumer OTHERWISE_THROW = LByteConsumer.byteCons(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LByteConsumerBuilder(@Nullable Consumer<LByteConsumer> consumer) {
		super(OTHERWISE_THROW, () -> new LByteConsumerBuilder(null));
	...
	@Nonnull
	public static LByteConsumer byteConsumerFrom(Consumer<LByteConsumerBuilder> buildingFunction) {
		LByteConsumerBuilder builder = new LByteConsumerBuilder();
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LByteConsumerBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public LByteConsumerBuilder forValue(byte v, LByteConsumer function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCase.The<LByteConsumerBuilder, LBytePredicate, LByteConsumer> forValue(byte v) {
	...
	public final LByteConsumer build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
