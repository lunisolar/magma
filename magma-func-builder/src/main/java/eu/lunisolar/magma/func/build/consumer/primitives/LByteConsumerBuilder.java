...
public final class LByteConsumerBuilder extends PerCaseBuilder.Base<LByteConsumerBuilder, LBytePredicate, LByteConsumer> {
	...
	@Nonnull
	public static LByteConsumer byteConsumerFrom(Function<LByteConsumerBuilder, LByteConsumer> buildingFunction) {
		return buildingFunction.apply(new LByteConsumerBuilder());
	}
	...
	public final LByteConsumer build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
