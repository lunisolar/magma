...
public final class LToShortBiFunctionBuilder<T1, T2> extends PerCaseBuilderWithShortProduct.Base<LToShortBiFunctionBuilder<T1, T2>, LBiPredicate<T1, T2>, LToShortBiFunction<T1, T2>> {
	...
	public static final LToShortBiFunction EVENTUALLY_THROW = LToShortBiFunction.l((Object a1, Object a2) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s  as function %s.", a1, a2, LToShortBiFunction.DESCRIPTION);
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2> LToShortBiFunctionBuilder<T1, T2> casesOf(Class<E1> argC1, Class<E2> argC2, Consumer<LToShortBiFunctionBuilder<E1, E2>> pcpConsumer) {
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2> LToShortBiFunctionBuilder<T1, T2> aCase(Class<E1> argC1, Class<E2> argC2, LToShortBiFunction<E1, E2> function) {
		PartialCaseWithShortProduct.The pc = partialCaseFactoryMethod((T1 a1, T2 a2) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LToShortBiFunction<T1, T2> build() {
		...
		retval = LToShortBiFunction.<T1, T2> l((T1 a1, T2 a2) -> {
			try {
