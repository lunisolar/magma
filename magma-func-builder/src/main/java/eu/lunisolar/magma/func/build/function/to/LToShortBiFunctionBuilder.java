...
public final class LToShortBiFunctionBuilder<T1, T2> extends PerCaseBuilderWithShortProduct.Base<LToShortBiFunctionBuilder<T1, T2>, LBiPredicate<T1, T2>, LToShortBiFunction<T1, T2>> {
	...
	public static final LToShortBiFunction EVENTUALLY_THROW = LToShortBiFunction.l((a1, a2) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LToShortBiFunctionBuilder(@Nullable Consumer<LToShortBiFunction<T1, T2>> consumer) {
		super(EVENTUALLY_THROW, LToShortBiFunction::constant, () -> new LToShortBiFunctionBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <T1, T2> LToShortBiFunctionBuilder<T1, T2> toShortBiFunction() {
		return new LToShortBiFunctionBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static <T1, T2> LToShortBiFunction<T1, T2> toShortBiFunctionFrom(Function<LToShortBiFunctionBuilder<T1, T2>, LToShortBiFunction<T1, T2>> buildingFunction) {
		return buildingFunction.apply(new LToShortBiFunctionBuilder());
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <T1, T2> LToShortBiFunctionBuilder<T1, T2> toShortBiFunction(Consumer<LToShortBiFunction<T1, T2>> consumer) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LToShortBiFunctionBuilder<T1, T2> casesOf(Class<V1> argC1, Class<V2> argC2, Consumer<LToShortBiFunctionBuilder<V1, V2>> pcpConsumer) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LToShortBiFunctionBuilder<T1, T2> aCase(Class<V1> argC1, Class<V2> argC2, LToShortBiFunction<V1, V2> function) {
		PartialCaseWithShortProduct.The pc = partialCaseFactoryMethod((a1, a2) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LToShortBiFunction<T1, T2> build() {
		...
		retval = LToShortBiFunction.<T1, T2> l((a1, a2) -> {
			try {
