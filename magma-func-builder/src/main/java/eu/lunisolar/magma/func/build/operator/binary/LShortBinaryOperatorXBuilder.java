...
public final class LShortBinaryOperatorXBuilder<X extends Exception> extends PerCaseBuilderWithShortProduct.Base<LShortBinaryOperatorXBuilder<X>, LBiShortPredicateX<X>, LShortBinaryOperatorX<X>> {
	...
	public LShortBinaryOperatorXBuilder(@Nullable Consumer<LShortBinaryOperatorX<X>> consumer) {
		super(EVENTUALLY_THROW, LShortBinaryOperatorX::constant);
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Exception> LShortBinaryOperatorXBuilder<X> shortBinaryOperatorX() {
		return new LShortBinaryOperatorXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Exception> LShortBinaryOperatorXBuilder<X> shortBinaryOperatorX(Consumer<LShortBinaryOperatorX<X>> consumer) {
