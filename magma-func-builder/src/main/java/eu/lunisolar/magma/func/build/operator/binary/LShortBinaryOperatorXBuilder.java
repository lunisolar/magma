...
public final class LShortBinaryOperatorXBuilder<X extends Throwable> extends PerCaseBuilderWithShortProduct.Base<LShortBinaryOperatorXBuilder<X>, LBiShortPredicateX<X>, LShortBinaryOperatorX<X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Throwable> LShortBinaryOperatorXBuilder<X> shortBinaryOperatorX() {
		return new LShortBinaryOperatorXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Throwable> LShortBinaryOperatorXBuilder<X> shortBinaryOperatorX(Consumer<LShortBinaryOperatorX<X>> consumer) {
