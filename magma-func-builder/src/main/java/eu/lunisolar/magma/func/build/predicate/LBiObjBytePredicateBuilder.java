...
public final class LBiObjBytePredicateBuilder<T1, T2> extends PerCaseBuilderWithBooleanProduct.Base<LBiObjBytePredicateBuilder<T1, T2>, LBiObjBytePredicate<T1, T2>, LBiObjBytePredicate<T1, T2>> {
	...
	public static final LBiObjBytePredicate EVENTUALLY_THROW = LBiObjBytePredicate.l((Object a1, Object a2, byte a3) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s ,%s  as function %s.", a1, a2, a3, LBiObjBytePredicate.DESCRIPTION);
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2> LBiObjBytePredicateBuilder<T1, T2> casesOf(Class<E1> argC1, Class<E2> argC2, Consumer<LBiObjBytePredicateBuilder<E1, E2>> pcpConsumer) {
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2> LBiObjBytePredicateBuilder<T1, T2> aCase(Class<E1> argC1, Class<E2> argC2, LBiObjBytePredicate<E1, E2> function) {
		PartialCaseWithBooleanProduct.The pc = partialCaseFactoryMethod((T1 a1, T2 a2, byte a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LBiObjBytePredicate<T1, T2> build() {
		...
		retval = LBiObjBytePredicate.<T1, T2> l((T1 a1, T2 a2, byte a3) -> {
			try {
