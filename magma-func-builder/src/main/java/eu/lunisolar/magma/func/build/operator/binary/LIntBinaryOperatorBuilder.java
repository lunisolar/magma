...
public final class LIntBinaryOperatorBuilder extends PerCaseBuilderWithIntProduct.Base<LIntBinaryOperatorBuilder, LBiIntPredicate, LIntBinaryOperator> {
	...
	public static final LIntBinaryOperator OTHERWISE_THROW = LIntBinaryOperator.intBinaryOp((a1, a2) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LIntBinaryOperatorBuilder(@Nullable Consumer<LIntBinaryOperator> consumer) {
		super(OTHERWISE_THROW, LIntBinaryOperator::constant, () -> new LIntBinaryOperatorBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LIntBinaryOperatorBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public LIntBinaryOperatorBuilder forValue(int v1, int v2, LIntBinaryOperator function) {
		PartialCaseWithIntProduct.The pc = partialCaseFactoryMethod((a1, a2) -> a1 == v1 && a2 == v2);
		pc.evaluate(function);
		return fluentCtx();
	}

	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithIntProduct.The<LIntBinaryOperatorBuilder, LBiIntPredicate, LIntBinaryOperator> forValue(int v1, int v2) {
	...
	public final LIntBinaryOperator build() {
		...
		final LIntBinaryOperator otherwiseFinal = this.otherwise;
	...
	public final LIntBinaryOperator build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
