...
public final class BiObjCharConsumerXBuilder<T1, T2, X extends Exception> extends PerCaseBuilder.Base<BiObjCharConsumerXBuilder<T1, T2, X>, BiObjCharPredicateX<T1, T2, X>, BiObjCharConsumerX<T1, T2, X>> {
