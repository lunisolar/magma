...
public final class LTieDblFunctionBuilder<T> extends PerCaseBuilderWithIntProduct.Base<LTieDblFunctionBuilder<T>, LObjIntDblPredicate<T>, LTieDblFunction<T>> {
	...
	@Nonnull
	public static <T> LTieDblFunction<T> tieDblFunctionFrom(Function<LTieDblFunctionBuilder<T>, LTieDblFunction<T>> buildingFunction) {
		return buildingFunction.apply(new LTieDblFunctionBuilder());
	}
