...
public final class LTriLongPredicateBuilder extends PerCaseBuilderWithBoolProduct.Base<LTriLongPredicateBuilder, LTriLongPredicate, LTriLongPredicate> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LTriLongPredicateBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LTriLongPredicate build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
