...
public final class BooleanTriFunctionXBuilder<R, X extends Exception> extends PerCaseBuilderWithProduct.Base<BooleanTriFunctionXBuilder<R, X>, BooleanTernaryOperatorX<X>, BooleanTriFunctionX<R, X>, R> {
