...
public final class BooleanTriFunctionXBuilder<R, X extends Exception> extends PerCaseBuilder<BooleanTriFunctionXBuilder<R, X>, BooleanTernaryOperatorX<X>, BooleanTriFunctionX<R, X>> {
