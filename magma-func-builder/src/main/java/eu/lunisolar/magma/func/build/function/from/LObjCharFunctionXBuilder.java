...
public final class LObjCharFunctionXBuilder<T, R, X extends Throwable> extends PerCaseBuilderWithProduct.Base<LObjCharFunctionXBuilder<T, R, X>, LObjCharPredicateX<T, X>, LObjCharFunctionX<T, R, X>, R> {
	...
	public static final LObjCharFunctionX EVENTUALLY_THROW = LObjCharFunctionX.lX((Object a1, char a2) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s  as function %s.", a1, a2, LObjCharFunctionX.DESCRIPTION);
	...
	@Nonnull
	public <E1 extends T> LObjCharFunctionXBuilder<T, R, X> casesOf(Class<E1> argC1, Consumer<LObjCharFunctionXBuilder<E1, R, X>> pcpConsumer) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod((T a1, char a2) -> (argC1 == null || argC1.isInstance(a1)));
	...
	@Nonnull
	public <E1 extends T> LObjCharFunctionXBuilder<T, R, X> aCase(Class<E1> argC1, LObjCharFunctionX<E1, R, X> function) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod((T a1, char a2) -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LObjCharFunctionX<T, R, X> build() {
		...
		retval = LObjCharFunctionX.<T, R, X> lX((T a1, char a2) -> {
			try {
