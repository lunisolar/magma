...
public final class LObjCharFunctionXBuilder<T, R, X extends Exception> extends PerCaseBuilderWithProduct.Base<LObjCharFunctionXBuilder<T, R, X>, LObjCharPredicateX<T, X>, LObjCharFunctionX<T, R, X>, R> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T, R, X extends Exception> LObjCharFunctionXBuilder<T, R, X> objCharFunctionX() {
		return new LObjCharFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T, R, X extends Exception> LObjCharFunctionXBuilder<T, R, X> objCharFunctionX(Consumer<LObjCharFunctionX<T, R, X>> consumer) {
