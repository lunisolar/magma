...
public final class LObjCharFunctionXBuilder<T, R, X extends Throwable> extends PerCaseBuilderWithProduct.Base<LObjCharFunctionXBuilder<T, R, X>, LObjCharPredicateX<T, X>, LObjCharFunctionX<T, R, X>, R> {
	...
	public static final LObjCharFunctionX EVENTUALLY_THROW = LObjCharFunctionX.lX((a1, a2) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LObjCharFunctionXBuilder(@Nullable Consumer<LObjCharFunctionX<T, R, X>> consumer) {
		super(EVENTUALLY_THROW, LObjCharFunctionX::constant, () -> new LObjCharFunctionXBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <T, R, X extends Throwable> LObjCharFunctionXBuilder<T, R, X> objCharFunctionX() {
		return new LObjCharFunctionXBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static <T, R, X extends Throwable> LObjCharFunctionX<T, R, X> objCharFunctionXFrom(Function<LObjCharFunctionXBuilder<T, R, X>, LObjCharFunctionX<T, R, X>> buildingFunction) {
		return buildingFunction.apply(new LObjCharFunctionXBuilder());
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <T, R, X extends Throwable> LObjCharFunctionXBuilder<T, R, X> objCharFunctionX(Consumer<LObjCharFunctionX<T, R, X>> consumer) {
	...
	@Nonnull
	public <V extends T> LObjCharFunctionXBuilder<T, R, X> casesOf(Class<V> argC1, Consumer<LObjCharFunctionXBuilder<V, R, X>> pcpConsumer) {
	...
	@Nonnull
	public <V extends T> LObjCharFunctionXBuilder<T, R, X> aCase(Class<V> argC1, LObjCharFunctionX<V, R, X> function) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod((a1, a2) -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LObjCharFunctionX<T, R, X> build() {
		...
		retval = LObjCharFunctionX.<T, R, X> lX((a1, a2) -> {
			try {
