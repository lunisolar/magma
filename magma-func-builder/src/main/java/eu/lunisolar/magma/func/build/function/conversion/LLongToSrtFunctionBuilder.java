...
public final class LLongToSrtFunctionBuilder extends PerCaseBuilderWithSrtProduct.Base<LLongToSrtFunctionBuilder, LLongPredicate, LLongToSrtFunction> {
	...
	public static final LLongToSrtFunction EVENTUALLY_THROW = LLongToSrtFunction.longToSrtFunc(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LLongToSrtFunctionBuilder(@Nullable Consumer<LLongToSrtFunction> consumer) {
		super(EVENTUALLY_THROW, LLongToSrtFunction::constant, () -> new LLongToSrtFunctionBuilder(null));
	...
	@Nonnull
	public static LLongToSrtFunction longToSrtFunctionFrom(Function<LLongToSrtFunctionBuilder, LLongToSrtFunction> buildingFunction) {
		return buildingFunction.apply(new LLongToSrtFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LLongToSrtFunctionBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LLongToSrtFunction build() {
		...
		final LLongToSrtFunction eventuallyFinal = this.eventually;
	...
	public final LLongToSrtFunction build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
