...
public final class LBoolToDoubleFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithDoubleProduct.Base<LBoolToDoubleFunctionXBuilder<X>, LLogicalOperatorX<X>, LBoolToDoubleFunctionX<X>> {
	...
	public static final LBoolToDoubleFunctionX EVENTUALLY_THROW = LBoolToDoubleFunctionX.lX((boolean a1) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", a1, LBoolToDoubleFunctionX.DESCRIPTION);
