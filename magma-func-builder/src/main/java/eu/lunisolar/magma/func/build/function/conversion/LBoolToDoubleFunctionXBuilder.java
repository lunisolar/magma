...
public final class LBoolToDoubleFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithDoubleProduct.Base<LBoolToDoubleFunctionXBuilder<X>, LLogicalOperatorX<X>, LBoolToDoubleFunctionX<X>> {
	...
	@Nonnull
	public static <X extends Throwable> LBoolToDoubleFunctionX<X> boolToDoubleFunctionXFrom(Function<LBoolToDoubleFunctionXBuilder<X>, LBoolToDoubleFunctionX<X>> buildingFunction) {
		return buildingFunction.apply(new LBoolToDoubleFunctionXBuilder());
	}
