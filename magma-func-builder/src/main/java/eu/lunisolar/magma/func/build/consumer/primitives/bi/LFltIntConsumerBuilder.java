...
public final class LFltIntConsumerBuilder extends PerCaseBuilder.Base<LFltIntConsumerBuilder, LFltIntPredicate, LFltIntConsumer> {
	...
	@Nonnull
	public static LFltIntConsumer fltIntConsumerFrom(Function<LFltIntConsumerBuilder, LFltIntConsumer> buildingFunction) {
		return buildingFunction.apply(new LFltIntConsumerBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LFltIntConsumerBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LFltIntConsumer build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
