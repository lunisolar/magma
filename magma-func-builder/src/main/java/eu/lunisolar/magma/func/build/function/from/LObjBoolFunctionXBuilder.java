...
public final class LObjBoolFunctionXBuilder<T, R, X extends Throwable> extends PerCaseBuilderWithProduct.Base<LObjBoolFunctionXBuilder<T, R, X>, LObjBoolPredicateX<T, X>, LObjBoolFunctionX<T, R, X>, R> {
	...
	public static final LObjBoolFunctionX EVENTUALLY_THROW = LObjBoolFunctionX.lX((Object a1, boolean a2) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s  as function %s.", a1, a2, LObjBoolFunctionX.DESCRIPTION);
	...
	public <E1 extends T> LObjBoolFunctionXBuilder<T, R, X> casesOf(Class<E1> argC1, Consumer<LObjBoolFunctionXBuilder<E1, R, X>> pcpConsumer) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod((T a1, boolean a2) -> (argC1 == null || argC1.isInstance(a1)));
	...
	public final LObjBoolFunctionX<T, R, X> build() {
		...
		retval = LObjBoolFunctionX.<T, R, X> lX((T a1, boolean a2) -> {
			try {
