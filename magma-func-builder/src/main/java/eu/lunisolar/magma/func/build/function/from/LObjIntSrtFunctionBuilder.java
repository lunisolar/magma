...
public final class LObjIntSrtFunctionBuilder<T, R> extends PerCaseBuilderWithProduct.Base<LObjIntSrtFunctionBuilder<T, R>, LObjIntSrtPredicate<T>, LObjIntSrtFunction<T, R>, R> {
	...
	public static final LObjIntSrtFunction EVENTUALLY_THROW = LObjIntSrtFunction.objIntSrtFunc((a1, a2, a3) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LObjIntSrtFunctionBuilder(@Nullable Consumer<LObjIntSrtFunction<T, R>> consumer) {
		super(EVENTUALLY_THROW, LObjIntSrtFunction::constant, () -> new LObjIntSrtFunctionBuilder(null));
	...
	@Nonnull
	public static <T, R> LObjIntSrtFunction<T, R> objIntSrtFunctionFrom(Function<LObjIntSrtFunctionBuilder<T, R>, LObjIntSrtFunction<T, R>> buildingFunction) {
		return buildingFunction.apply(new LObjIntSrtFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LObjIntSrtFunctionBuilder<T, R> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LObjIntSrtFunction<T, R> build() {
		...
		final LObjIntSrtFunction<T, R> eventuallyFinal = this.eventually;
	...
	public final LObjIntSrtFunction<T, R> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
