...
public final class LObjIntSrtFunctionBuilder<T, R> extends PerCaseBuilderWithProduct.Base<LObjIntSrtFunctionBuilder<T, R>, LObjIntSrtPredicate<T>, LObjIntSrtFunction<T, R>, R> {
	...
	public <V extends T> LObjIntSrtFunctionBuilder<T, R> forValue(T v1, int v2, short v3, LObjIntSrtFunction<V, R> function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public <V extends T> PartialCaseWithProduct.The<LObjIntSrtFunctionBuilder<T, R>, LObjIntSrtPredicate<T>, LObjIntSrtFunction<T, R>, R> forValue(T v1, int v2, short v3) {
	...
	@Nonnull
	public <V extends T> LObjIntSrtFunctionBuilder<T, R> forClass(Class<V> argC1, LObjIntSrtFunction<V, R> function) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)));
		pc.evaluate(function);
		return fluentCtx();
	}
	...
	/** Adds full new case for the argument that are of specific classes (matched by instanceOf, null is a wildcard). */
	@Nonnull
	public <V extends T> PartialCaseWithProduct.The<LObjIntSrtFunctionBuilder<T, R>, LObjIntSrtPredicate<T>, LObjIntSrtFunction<T, R>, R> forClass(Class<V> argC1) {
