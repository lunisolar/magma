...
public final class LLongFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LLongFunctionBuilder<R>, LLongPredicate, LLongFunction<R>, R> {
	...
	public static final LLongFunction OTHERWISE_THROW = LLongFunction.longFunc(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LLongFunctionBuilder(@Nullable Consumer<LLongFunction<R>> consumer) {
		super(OTHERWISE_THROW, LLongFunction::constant, () -> new LLongFunctionBuilder(null));
	...
	@Nonnull
	public static <R> LLongFunction<R> longFunctionFrom(Consumer<LLongFunctionBuilder<R>> buildingFunction) {
		LLongFunctionBuilder builder = new LLongFunctionBuilder();
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LLongFunctionBuilder<R> withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public LLongFunctionBuilder<R> forValue(long v, LLongFunction<R> function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithProduct.The<LLongFunctionBuilder<R>, LLongPredicate, LLongFunction<R>, R> forValue(long v) {
	...
	public final LLongFunction<R> build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
