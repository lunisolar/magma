...
public final class LLongFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LLongFunctionBuilder<R>, LLongPredicate, LLongFunction<R>, R> {
	...
	public static final LLongFunction EVENTUALLY_THROW = LLongFunction.longFunc(a -> {
	...
	@Nonnull
	public static <R> LLongFunction<R> longFunctionFrom(Function<LLongFunctionBuilder<R>, LLongFunction<R>> buildingFunction) {
		return buildingFunction.apply(new LLongFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LLongFunctionBuilder<R> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LLongFunction<R> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
