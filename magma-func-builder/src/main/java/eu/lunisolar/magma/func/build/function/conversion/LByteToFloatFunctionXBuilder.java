...
public final class LByteToFloatFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithFloatProduct.Base<LByteToFloatFunctionXBuilder<X>, LBytePredicateX<X>, LByteToFloatFunctionX<X>> {
	...
	public static final LByteToFloatFunctionX EVENTUALLY_THROW = LByteToFloatFunctionX.lX(a1 -> {
	...
	@Nonnull
	public static <X extends Throwable> LByteToFloatFunctionX<X> byteToFloatFunctionXFrom(Function<LByteToFloatFunctionXBuilder<X>, LByteToFloatFunctionX<X>> buildingFunction) {
		return buildingFunction.apply(new LByteToFloatFunctionXBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LByteToFloatFunctionXBuilder<X> withHandling(@Nonnull HandlingInstructions<X, X> handling) {
	...
	public final LByteToFloatFunctionX<X> build() {
		...
		retval = LByteToFloatFunctionX.<X> lX(a1 -> {
			try {
	...
	public final LByteToFloatFunctionX<X> build(@Nonnull HandlingInstructions<X, X> handling) {
