...
public final class LByteToFloatFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithFloatProduct.Base<LByteToFloatFunctionXBuilder<X>, LBytePredicateX<X>, LByteToFloatFunctionX<X>> {
	...
	public static final LByteToFloatFunctionX EVENTUALLY_THROW = LByteToFloatFunctionX.lX((byte a1) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", a1, LByteToFloatFunctionX.DESCRIPTION);
