...
public final class ToShortBiFunctionBuilder<T1, T2> extends PerCaseBuilderWithShortProduct.Base<ToShortBiFunctionBuilder<T1, T2>, BiPredicate<T1, T2>, ToShortBiFunction<T1, T2>> {
