...
public final class LLongSupplierBuilder extends PerCaseBuilderWithLongProduct.Base<LLongSupplierBuilder, LBoolSupplier, LLongSupplier> {
	...
	@Nonnull
	public static LLongSupplier longSupplierFrom(Function<LLongSupplierBuilder, LLongSupplier> buildingFunction) {
		return buildingFunction.apply(new LLongSupplierBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LLongSupplierBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LLongSupplier build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
