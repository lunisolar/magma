...
public final class DoublePredicateBuilder extends PerCaseBuilderWithBoolProduct.Base<DoublePredicateBuilder, LDblPredicate, DoublePredicate> {
	...
	@Nonnull
	public static DoublePredicate dblPredicateFrom(Consumer<DoublePredicateBuilder> buildingFunction) {
		DoublePredicateBuilder builder = new DoublePredicateBuilder();
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final DoublePredicateBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public final DoublePredicate build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
