...
public final class LongFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LongFunctionBuilder<R>, LLongPredicate, java.util.function.LongFunction<R>, R> {
	...
	@Nonnull
	public static final <R> LongFunctionBuilder<R> longFunction(Consumer<java.util.function.LongFunction<R>> consumer) {
		return new LongFunctionBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LongFunctionBuilder<R> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
