...
public final class LongFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LongFunctionBuilder<R>, LLongPredicate, LongFunction<R>, R> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LongFunctionBuilder<R> withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public final LongFunction<R> build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
