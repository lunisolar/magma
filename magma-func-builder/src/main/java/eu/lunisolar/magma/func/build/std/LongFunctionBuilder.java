...
public final class LongFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LongFunctionBuilder<R>, LLongPredicate, LongFunction<R>, R> {
	...
	public static final LongFunction EVENTUALLY_THROW = Function4U.longFunction(a -> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <R> LongFunctionBuilder<R> longFunction() {
	...
	public final LongFunction<R> build() {
		...
		retval = Function4U.<R> longFunction(a -> {
			try {
