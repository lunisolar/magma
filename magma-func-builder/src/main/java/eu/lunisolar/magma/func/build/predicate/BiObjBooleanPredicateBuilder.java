...
public final class BiObjBooleanPredicateBuilder<T1, T2> extends PerCaseBuilderWithBooleanProduct<BiObjBooleanPredicateBuilder<T1, T2>, BiObjBooleanPredicate<T1, T2>, BiObjBooleanPredicate<T1, T2>> {
