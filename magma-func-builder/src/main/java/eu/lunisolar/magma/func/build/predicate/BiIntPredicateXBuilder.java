...
public final class BiIntPredicateXBuilder<X extends Exception> extends PerCaseBuilderWithBooleanProduct.Base<BiIntPredicateXBuilder<X>, BiIntPredicateX<X>, BiIntPredicateX<X>> {
