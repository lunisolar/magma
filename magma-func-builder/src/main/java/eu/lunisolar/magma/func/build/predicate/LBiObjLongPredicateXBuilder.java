...
public final class LBiObjLongPredicateXBuilder<T1, T2, X extends Throwable> extends PerCaseBuilderWithBoolProduct.Base<LBiObjLongPredicateXBuilder<T1, T2, X>, LBiObjLongPredicateX<T1, T2, X>, LBiObjLongPredicateX<T1, T2, X>> {
	...
	public static final LBiObjLongPredicateX EVENTUALLY_THROW = LBiObjLongPredicateX.lX((a1, a2, a3) -> {
	...
	@Nonnull
	public static <T1, T2, X extends Throwable> LBiObjLongPredicateX<T1, T2, X> biObjLongPredicateXFrom(Function<LBiObjLongPredicateXBuilder<T1, T2, X>, LBiObjLongPredicateX<T1, T2, X>> buildingFunction) {
		return buildingFunction.apply(new LBiObjLongPredicateXBuilder());
	}
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjLongPredicateXBuilder<T1, T2, X> casesOf(Class<V1> argC1, Class<V2> argC2, Consumer<LBiObjLongPredicateXBuilder<V1, V2, X>> pcpConsumer) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjLongPredicateXBuilder<T1, T2, X> aCase(Class<V1> argC1, Class<V2> argC2, LBiObjLongPredicateX<V1, V2, X> function) {
		PartialCaseWithBoolProduct.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LBiObjLongPredicateX<T1, T2, X> build() {
		...
		retval = LBiObjLongPredicateX.<T1, T2, X> lX((a1, a2, a3) -> {
			try {
