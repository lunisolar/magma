...
public final class LBiObjLongPredicateXBuilder<T1, T2, X extends Exception> extends PerCaseBuilderWithBooleanProduct.Base<LBiObjLongPredicateXBuilder<T1, T2, X>, LBiObjLongPredicateX<T1, T2, X>, LBiObjLongPredicateX<T1, T2, X>> {
	...
	public LBiObjLongPredicateXBuilder(@Nullable Consumer<LBiObjLongPredicateX<T1, T2, X>> consumer) {
		super(EVENTUALLY_THROW, LBiObjLongPredicateX::constant);
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T1, T2, X extends Exception> LBiObjLongPredicateXBuilder<T1, T2, X> biObjLongPredicateX() {
		return new LBiObjLongPredicateXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T1, T2, X extends Exception> LBiObjLongPredicateXBuilder<T1, T2, X> biObjLongPredicateX(Consumer<LBiObjLongPredicateX<T1, T2, X>> consumer) {
	...
	public final LBiObjLongPredicateX<T1, T2, X> build() {
		...
		if (cases.isEmpty()) {
			...
			retval = LBiObjLongPredicateX.lX((T1 t1, T2 t2, long l) -> {
