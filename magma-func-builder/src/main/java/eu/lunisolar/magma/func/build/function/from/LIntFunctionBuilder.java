...
public final class LIntFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LIntFunctionBuilder<R>, LIntPredicate, LIntFunction<R>, R> {
	...
	public static final LIntFunction OTHERWISE_THROW = LIntFunction.intFunc(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LIntFunctionBuilder(@Nullable Consumer<LIntFunction<R>> consumer) {
		super(OTHERWISE_THROW, LIntFunction::constant, () -> new LIntFunctionBuilder(null));

		this.consumer = consumer;
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	public LIntFunctionBuilder() {
		this(null);
	}
	...
	@Nonnull
	public static <R> LIntFunction<R> intFunctionFrom(Consumer<LIntFunctionBuilder<R>> buildingFunction) {
		LIntFunctionBuilder builder = new LIntFunctionBuilder();
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LIntFunctionBuilder<R> withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public LIntFunctionBuilder<R> forValue(int v, LIntFunction<R> function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithProduct.The<LIntFunctionBuilder<R>, LIntPredicate, LIntFunction<R>, R> forValue(int v) {
		return partialCaseFactoryMethod(a -> a == v);
	}

	/** Builds the functional interface implementation and if previously provided calls the consumer. */
	@Nonnull
	public final LIntFunction<R> build() {

		final LIntFunction<R> otherwiseFinal = this.otherwise;
	...
	public final LIntFunction<R> build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
