...
public final class LIntFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LIntFunctionBuilder<R>, LIntPredicate, LIntFunction<R>, R> {
	...
	public static final LIntFunction EVENTUALLY_THROW = LIntFunction.l((int i) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", i, LIntFunction.DESCRIPTION);
