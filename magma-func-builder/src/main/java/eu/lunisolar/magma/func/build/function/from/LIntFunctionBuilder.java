...
public final class LIntFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LIntFunctionBuilder<R>, LIntPredicate, LIntFunction<R>, R> {
	...
	public static final LIntFunction EVENTUALLY_THROW = LIntFunction.l(a1 -> {
	...
	@Nonnull
	public static <R> LIntFunction<R> intFunctionFrom(Function<LIntFunctionBuilder<R>, LIntFunction<R>> buildingFunction) {
		return buildingFunction.apply(new LIntFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LIntFunctionBuilder<R> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LIntFunction<R> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
