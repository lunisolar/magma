...
public final class ObjBytePredicateXBuilder<T, X extends Exception> extends PerCaseBuilderWithBooleanProduct.Base<ObjBytePredicateXBuilder<T, X>, ObjBytePredicateX<T, X>, ObjBytePredicateX<T, X>> {
	...
	public ObjBytePredicateXBuilder(@Nullable Consumer<ObjBytePredicateX<T, X>> consumer) {
		super(EVENTUALLY_THROW, ObjBytePredicateX::constant);
