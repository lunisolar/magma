...
public final class ObjBytePredicateXBuilder<T, X extends Exception> extends PerCaseBuilderWithBooleanProduct<ObjBytePredicateXBuilder<T, X>, ObjBytePredicateX<T, X>, ObjBytePredicateX<T, X>> {
