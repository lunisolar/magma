...
public final class LByteToCharFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithCharProduct.Base<LByteToCharFunctionXBuilder<X>, LBytePredicateX<X>, LByteToCharFunctionX<X>> {
	...
	public static final LByteToCharFunctionX EVENTUALLY_THROW = LByteToCharFunctionX.lX(a1 -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LByteToCharFunctionXBuilder(@Nullable Consumer<LByteToCharFunctionX<X>> consumer) {
		super(EVENTUALLY_THROW, LByteToCharFunctionX::constant, () -> new LByteToCharFunctionXBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <X extends Throwable> LByteToCharFunctionXBuilder<X> byteToCharFunctionX() {
		return new LByteToCharFunctionXBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static <X extends Throwable> LByteToCharFunctionX<X> byteToCharFunctionXFrom(Function<LByteToCharFunctionXBuilder<X>, LByteToCharFunctionX<X>> buildingFunction) {
		return buildingFunction.apply(new LByteToCharFunctionXBuilder());
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <X extends Throwable> LByteToCharFunctionXBuilder<X> byteToCharFunctionX(Consumer<LByteToCharFunctionX<X>> consumer) {
	...
	public final LByteToCharFunctionX<X> build() {
		...
		retval = LByteToCharFunctionX.<X> lX(a1 -> {
			try {
