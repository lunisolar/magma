...
public final class LBooleanTriFunctionXBuilder<R, X extends Throwable> extends PerCaseBuilderWithProduct.Base<LBooleanTriFunctionXBuilder<R, X>, LBooleanTernaryOperatorX<X>, LBooleanTriFunctionX<R, X>, R> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <R, X extends Throwable> LBooleanTriFunctionXBuilder<R, X> booleanTriFunctionX() {
		return new LBooleanTriFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <R, X extends Throwable> LBooleanTriFunctionXBuilder<R, X> booleanTriFunctionX(Consumer<LBooleanTriFunctionX<R, X>> consumer) {
		return new LBooleanTriFunctionXBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LBooleanTriFunctionXBuilder<R, X> withHandling(@Nonnull HandlingInstructions<X, X> handling) {
	...
	public final LBooleanTriFunctionX<R, X> build(@Nonnull HandlingInstructions<X, X> handling) {
