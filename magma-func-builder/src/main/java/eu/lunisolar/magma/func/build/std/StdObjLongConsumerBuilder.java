...
public final class StdObjLongConsumerBuilder<T> extends PerCaseBuilder.Base<StdObjLongConsumerBuilder<T>, ObjLongPredicate<T>, java.util.function.ObjLongConsumer<T>> {
