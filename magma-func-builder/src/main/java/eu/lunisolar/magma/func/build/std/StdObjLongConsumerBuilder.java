...
public final class StdObjLongConsumerBuilder<T> extends PerCaseBuilder.Base<StdObjLongConsumerBuilder<T>, LObjLongPredicate<T>, java.util.function.ObjLongConsumer<T>> {
