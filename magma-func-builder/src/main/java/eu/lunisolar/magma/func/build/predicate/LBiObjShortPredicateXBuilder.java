...
public final class LBiObjShortPredicateXBuilder<T1, T2, X extends Exception> extends PerCaseBuilderWithBooleanProduct.Base<LBiObjShortPredicateXBuilder<T1, T2, X>, LBiObjShortPredicateX<T1, T2, X>, LBiObjShortPredicateX<T1, T2, X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T1, T2, X extends Exception> LBiObjShortPredicateXBuilder<T1, T2, X> biObjShortPredicateX() {
		return new LBiObjShortPredicateXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T1, T2, X extends Exception> LBiObjShortPredicateXBuilder<T1, T2, X> biObjShortPredicateX(Consumer<LBiObjShortPredicateX<T1, T2, X>> consumer) {
	...
	public final LBiObjShortPredicateX<T1, T2, X> build() {
		...
		if (cases.isEmpty()) {
			...
			retval = LBiObjShortPredicateX.lX((T1 t1, T2 t2, short s) -> {
