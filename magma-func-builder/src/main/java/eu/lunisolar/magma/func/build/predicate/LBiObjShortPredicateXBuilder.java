...
public final class LBiObjShortPredicateXBuilder<T1, T2, X extends Throwable> extends PerCaseBuilderWithBooleanProduct.Base<LBiObjShortPredicateXBuilder<T1, T2, X>, LBiObjShortPredicateX<T1, T2, X>, LBiObjShortPredicateX<T1, T2, X>> {
	...
	public static final LBiObjShortPredicateX EVENTUALLY_THROW = LBiObjShortPredicateX.lX((Object a1, Object a2, short a3) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s ,%s  as function %s.", a1, a2, a3, LBiObjShortPredicateX.DESCRIPTION);
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2> LBiObjShortPredicateXBuilder<T1, T2, X> casesOf(Class<E1> argC1, Class<E2> argC2, Consumer<LBiObjShortPredicateXBuilder<E1, E2, X>> pcpConsumer) {
	...
	@Nonnull
	public <E1 extends T1, E2 extends T2> LBiObjShortPredicateXBuilder<T1, T2, X> aCase(Class<E1> argC1, Class<E2> argC2, LBiObjShortPredicateX<E1, E2, X> function) {
		PartialCaseWithBooleanProduct.The pc = partialCaseFactoryMethod((T1 a1, T2 a2, short a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LBiObjShortPredicateX<T1, T2, X> build() {
		...
		retval = LBiObjShortPredicateX.<T1, T2, X> lX((T1 a1, T2 a2, short a3) -> {
			try {
