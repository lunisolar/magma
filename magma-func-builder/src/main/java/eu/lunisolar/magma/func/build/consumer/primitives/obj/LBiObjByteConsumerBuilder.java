...
public final class LBiObjByteConsumerBuilder<T1, T2> extends PerCaseBuilder.Base<LBiObjByteConsumerBuilder<T1, T2>, LBiObjBytePredicate<T1, T2>, LBiObjByteConsumer<T1, T2>> {
	...
	public <V1 extends T1, V2 extends T2> LBiObjByteConsumerBuilder<T1, T2> forValue(T1 v1, T2 v2, byte v3, LBiObjByteConsumer<V1, V2> function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public <V1 extends T1, V2 extends T2> PartialCase.The<LBiObjByteConsumerBuilder<T1, T2>, LBiObjBytePredicate<T1, T2>, LBiObjByteConsumer<T1, T2>> forValue(T1 v1, T2 v2, byte v3) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjByteConsumerBuilder<T1, T2> forClass(Class<V1> argC1, Class<V2> argC2, LBiObjByteConsumer<V1, V2> function) {
		PartialCase.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
		pc.evaluate(function);
		return fluentCtx();
	}
	...
	/** Adds full new case for the argument that are of specific classes (matched by instanceOf, null is a wildcard). */
	@Nonnull
	public <V1 extends T1, V2 extends T2> PartialCase.The<LBiObjByteConsumerBuilder<T1, T2>, LBiObjBytePredicate<T1, T2>, LBiObjByteConsumer<T1, T2>> forClass(Class<V1> argC1, Class<V2> argC2) {
