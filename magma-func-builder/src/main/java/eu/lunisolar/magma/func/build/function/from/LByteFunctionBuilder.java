...
public final class LByteFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LByteFunctionBuilder<R>, LBytePredicate, LByteFunction<R>, R> {
	...
	public static final LByteFunction EVENTUALLY_THROW = LByteFunction.l(a1 -> {
	...
	@Nonnull
	public static <R> LByteFunction<R> byteFunctionFrom(Function<LByteFunctionBuilder<R>, LByteFunction<R>> buildingFunction) {
		return buildingFunction.apply(new LByteFunctionBuilder());
	}
