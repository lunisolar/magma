...
public final class LByteFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LByteFunctionBuilder<R>, LBytePredicate, LByteFunction<R>, R> {
	...
	public LByteFunctionBuilder<R> forValue(byte v, LByteFunction<R> function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithProduct.The<LByteFunctionBuilder<R>, LBytePredicate, LByteFunction<R>, R> forValue(byte v) {
