...
public final class LByteFunctionBuilder<R> extends PerCaseBuilderWithProduct.Base<LByteFunctionBuilder<R>, LBytePredicate, LByteFunction<R>, R> {
	...
	public static final LByteFunction EVENTUALLY_THROW = LByteFunction.l((byte b) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", b, LByteFunction.DESCRIPTION);
	...
	public LByteFunctionBuilder(@Nullable Consumer<LByteFunction<R>> consumer) {
		super(EVENTUALLY_THROW, LByteFunction::constant);
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <R> LByteFunctionBuilder<R> byteFunction() {
		return new LByteFunctionBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <R> LByteFunctionBuilder<R> byteFunction(Consumer<LByteFunction<R>> consumer) {
		return new LByteFunctionBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LByteFunctionBuilder<R> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LByteFunction<R> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
