...
public final class LByteUnaryOperatorXBuilder<X extends Throwable> extends PerCaseBuilderWithByteProduct.Base<LByteUnaryOperatorXBuilder<X>, LBytePredicateX<X>, LByteUnaryOperatorX<X>> {
	...
	public static final LByteUnaryOperatorX EVENTUALLY_THROW = LByteUnaryOperatorX.lX(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LByteUnaryOperatorXBuilder(@Nullable Consumer<LByteUnaryOperatorX<X>> consumer) {
		super(EVENTUALLY_THROW, LByteUnaryOperatorX::constant, () -> new LByteUnaryOperatorXBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <X extends Throwable> LByteUnaryOperatorXBuilder<X> byteUnaryOperatorX() {
		return new LByteUnaryOperatorXBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static <X extends Throwable> LByteUnaryOperatorX<X> byteUnaryOperatorXFrom(Function<LByteUnaryOperatorXBuilder<X>, LByteUnaryOperatorX<X>> buildingFunction) {
		return buildingFunction.apply(new LByteUnaryOperatorXBuilder());
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <X extends Throwable> LByteUnaryOperatorXBuilder<X> byteUnaryOperatorX(Consumer<LByteUnaryOperatorX<X>> consumer) {
	...
	public final LByteUnaryOperatorX<X> build() {
		...
		retval = LByteUnaryOperatorX.<X> lX(a -> {
			try {
