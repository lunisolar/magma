...
public final class LBiShortFunctionXBuilder<R, X extends Throwable> extends PerCaseBuilderWithProduct.Base<LBiShortFunctionXBuilder<R, X>, LBiShortPredicateX<X>, LBiShortFunctionX<R, X>, R> {
	...
	public static final LBiShortFunctionX EVENTUALLY_THROW = LBiShortFunctionX.lX((a1, a2) -> {
	...
	@Nonnull
	public static <R, X extends Throwable> LBiShortFunctionX<R, X> biShortFunctionXFrom(Function<LBiShortFunctionXBuilder<R, X>, LBiShortFunctionX<R, X>> buildingFunction) {
		return buildingFunction.apply(new LBiShortFunctionXBuilder());
	}
	...
	public final LBiShortFunctionX<R, X> build() {
		...
		retval = LBiShortFunctionX.<R, X> lX((a1, a2) -> {
			try {
