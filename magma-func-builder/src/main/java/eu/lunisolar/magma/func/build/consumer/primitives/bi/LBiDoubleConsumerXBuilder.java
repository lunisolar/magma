...
public final class LBiDoubleConsumerXBuilder<X extends Throwable> extends PerCaseBuilder.Base<LBiDoubleConsumerXBuilder<X>, LBiDoublePredicateX<X>, LBiDoubleConsumerX<X>> {
	...
	public static final LBiDoubleConsumerX EVENTUALLY_THROW = LBiDoubleConsumerX.lX((double a1, double a2) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s  as function %s.", a1, a2, LBiDoubleConsumerX.DESCRIPTION);
	...
	public final LBiDoubleConsumerX<X> build() {
		...
		retval = LBiDoubleConsumerX.<X> lX((double a1, double a2) -> {
			try {
