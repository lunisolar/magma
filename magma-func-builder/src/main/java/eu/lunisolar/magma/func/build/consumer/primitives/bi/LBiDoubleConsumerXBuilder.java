...
public final class LBiDoubleConsumerXBuilder<X extends Throwable> extends PerCaseBuilder.Base<LBiDoubleConsumerXBuilder<X>, LBiDoublePredicateX<X>, LBiDoubleConsumerX<X>> {
	...
	public static final LBiDoubleConsumerX EVENTUALLY_THROW = LBiDoubleConsumerX.lX((a1, a2) -> {
	...
	@Nonnull
	public static <X extends Throwable> LBiDoubleConsumerX<X> biDoubleConsumerXFrom(Function<LBiDoubleConsumerXBuilder<X>, LBiDoubleConsumerX<X>> buildingFunction) {
		return buildingFunction.apply(new LBiDoubleConsumerXBuilder());
	}
	...
	public final LBiDoubleConsumerX<X> build() {
		...
		retval = LBiDoubleConsumerX.<X> lX((a1, a2) -> {
			try {
