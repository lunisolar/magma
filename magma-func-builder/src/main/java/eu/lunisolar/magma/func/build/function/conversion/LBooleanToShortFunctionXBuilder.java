...
public final class LBooleanToShortFunctionXBuilder<X extends Exception> extends PerCaseBuilderWithShortProduct.Base<LBooleanToShortFunctionXBuilder<X>, LBooleanUnaryOperatorX<X>, LBooleanToShortFunctionX<X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Exception> LBooleanToShortFunctionXBuilder<X> booleanToShortFunctionX() {
		return new LBooleanToShortFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Exception> LBooleanToShortFunctionXBuilder<X> booleanToShortFunctionX(Consumer<LBooleanToShortFunctionX<X>> consumer) {
