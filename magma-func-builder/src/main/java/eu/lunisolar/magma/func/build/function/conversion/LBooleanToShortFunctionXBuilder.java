...
public final class LBooleanToShortFunctionXBuilder<X extends Throwable> extends PerCaseBuilderWithShortProduct.Base<LBooleanToShortFunctionXBuilder<X>, LLogicalOperatorX<X>, LBooleanToShortFunctionX<X>> {
	...
	public LBooleanToShortFunctionXBuilder(@Nullable Consumer<LBooleanToShortFunctionX<X>> consumer) {
		super(EVENTUALLY_THROW, LBooleanToShortFunctionX::constant, () -> new LBooleanToShortFunctionXBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <X extends Throwable> LBooleanToShortFunctionXBuilder<X> booleanToShortFunctionX() {
		return new LBooleanToShortFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <X extends Throwable> LBooleanToShortFunctionXBuilder<X> booleanToShortFunctionX(Consumer<LBooleanToShortFunctionX<X>> consumer) {
	...
	public final LBooleanToShortFunctionX<X> build() {
		...
		final Case<LLogicalOperatorX<X>, LBooleanToShortFunctionX<X>>[] casesArray = cases.toArray(new Case[cases.size()]);
		retval = LBooleanToShortFunctionX.<X> lX(b -> {
			try {
				for (Case<LLogicalOperatorX<X>, LBooleanToShortFunctionX<X>> aCase : casesArray) {
