...
public final class LBiObjDoubleConsumerXBuilder<T1, T2, X extends Throwable> extends PerCaseBuilder.Base<LBiObjDoubleConsumerXBuilder<T1, T2, X>, LBiObjDoublePredicateX<T1, T2, X>, LBiObjDoubleConsumerX<T1, T2, X>> {
	...
	public static final LBiObjDoubleConsumerX EVENTUALLY_THROW = LBiObjDoubleConsumerX.lX((Object a1, Object a2, double a3) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s ,%s  as function %s.", a1, a2, a3, LBiObjDoubleConsumerX.DESCRIPTION);
	...
	public final LBiObjDoubleConsumerX<T1, T2, X> build() {
		...
		retval = LBiObjDoubleConsumerX.<T1, T2, X> lX((T1 a1, T2 a2, double a3) -> {
			try {
