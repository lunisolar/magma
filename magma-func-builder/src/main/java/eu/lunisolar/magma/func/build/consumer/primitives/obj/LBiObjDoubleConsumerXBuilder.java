...
public final class LBiObjDoubleConsumerXBuilder<T1, T2, X extends Exception> extends PerCaseBuilder.Base<LBiObjDoubleConsumerXBuilder<T1, T2, X>, LBiObjDoublePredicateX<T1, T2, X>, LBiObjDoubleConsumerX<T1, T2, X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T1, T2, X extends Exception> LBiObjDoubleConsumerXBuilder<T1, T2, X> biObjDoubleConsumerX() {
		return new LBiObjDoubleConsumerXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T1, T2, X extends Exception> LBiObjDoubleConsumerXBuilder<T1, T2, X> biObjDoubleConsumerX(Consumer<LBiObjDoubleConsumerX<T1, T2, X>> consumer) {
