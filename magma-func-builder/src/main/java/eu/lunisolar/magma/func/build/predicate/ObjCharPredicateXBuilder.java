...
public final class ObjCharPredicateXBuilder<T, X extends Exception> extends PerCaseBuilderWithBooleanProduct<ObjCharPredicateXBuilder<T, X>, ObjCharPredicateX<T, X>, ObjCharPredicateX<T, X>> {
