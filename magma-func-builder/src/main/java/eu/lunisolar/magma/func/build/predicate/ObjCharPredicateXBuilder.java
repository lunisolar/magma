...
public final class ObjCharPredicateXBuilder<T, X extends Exception> extends PerCaseBuilder<ObjCharPredicateXBuilder<T, X>, ObjCharPredicateX<T, X>, ObjCharPredicateX<T, X>> {
