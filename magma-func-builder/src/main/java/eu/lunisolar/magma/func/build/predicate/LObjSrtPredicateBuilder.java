...
public final class LObjSrtPredicateBuilder<T> extends PerCaseBuilderWithBoolProduct.Base<LObjSrtPredicateBuilder<T>, LObjSrtPredicate<T>, LObjSrtPredicate<T>> {
	...
	@Nonnull
	public static <T> LObjSrtPredicate<T> objSrtPredicateFrom(Function<LObjSrtPredicateBuilder<T>, LObjSrtPredicate<T>> buildingFunction) {
		return buildingFunction.apply(new LObjSrtPredicateBuilder());
	}
