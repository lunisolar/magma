...
public final class LObjSrtPredicateBuilder<T> extends PerCaseBuilderWithBoolProduct.Base<LObjSrtPredicateBuilder<T>, LObjSrtPredicate<T>, LObjSrtPredicate<T>> {
	...
	public static final LObjSrtPredicate OTHERWISE_THROW = LObjSrtPredicate.objSrtPred((a1, a2) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LObjSrtPredicateBuilder(@Nullable Consumer<LObjSrtPredicate<T>> consumer) {
		super(OTHERWISE_THROW, LObjSrtPredicate::constant, () -> new LObjSrtPredicateBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LObjSrtPredicateBuilder<T> withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public <V extends T> LObjSrtPredicateBuilder<T> forValue(T v1, short v2, LObjSrtPredicate<V> function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public <V extends T> PartialCaseWithBoolProduct.The<LObjSrtPredicateBuilder<T>, LObjSrtPredicate<T>, LObjSrtPredicate<T>> forValue(T v1, short v2) {
	...
	@Nonnull
	public <V extends T> LObjSrtPredicateBuilder<T> forClass(Class<V> argC1, LObjSrtPredicate<V> function) {
		PartialCaseWithBoolProduct.The pc = partialCaseFactoryMethod((a1, a2) -> (argC1 == null || argC1.isInstance(a1)));
		pc.evaluate(function);
		return fluentCtx();
	}
	...
	/** Adds full new case for the argument that are of specific classes (matched by instanceOf, null is a wildcard). */
	@Nonnull
	public <V extends T> PartialCaseWithBoolProduct.The<LObjSrtPredicateBuilder<T>, LObjSrtPredicate<T>, LObjSrtPredicate<T>> forClass(Class<V> argC1) {
	...
	public final LObjSrtPredicate<T> build() {
		...
		final LObjSrtPredicate<T> otherwiseFinal = this.otherwise;
	...
	public final LObjSrtPredicate<T> build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
