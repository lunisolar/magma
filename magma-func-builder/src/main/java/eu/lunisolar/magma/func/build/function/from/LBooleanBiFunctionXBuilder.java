...
public final class LBooleanBiFunctionXBuilder<R, X extends Throwable> extends PerCaseBuilderWithProduct.Base<LBooleanBiFunctionXBuilder<R, X>, LLogicalBinaryOperatorX<X>, LBooleanBiFunctionX<R, X>, R> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <R, X extends Throwable> LBooleanBiFunctionXBuilder<R, X> booleanBiFunctionX() {
		return new LBooleanBiFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <R, X extends Throwable> LBooleanBiFunctionXBuilder<R, X> booleanBiFunctionX(Consumer<LBooleanBiFunctionX<R, X>> consumer) {
		return new LBooleanBiFunctionXBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LBooleanBiFunctionXBuilder<R, X> withHandling(@Nonnull HandlingInstructions<X, X> handling) {
	...
	public final LBooleanBiFunctionX<R, X> build() {
		...
		final Case<LLogicalBinaryOperatorX<X>, LBooleanBiFunctionX<R, X>>[] casesArray = cases.toArray(new Case[cases.size()]);
		retval = LBooleanBiFunctionX.<R, X> lX((boolean b1, boolean b2) -> {
			try {
				for (Case<LLogicalBinaryOperatorX<X>, LBooleanBiFunctionX<R, X>> aCase : casesArray) {
	...
	public final LBooleanBiFunctionX<R, X> build(@Nonnull HandlingInstructions<X, X> handling) {
