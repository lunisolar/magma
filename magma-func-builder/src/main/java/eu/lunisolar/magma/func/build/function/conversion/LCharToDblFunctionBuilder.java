...
public final class LCharToDblFunctionBuilder extends PerCaseBuilderWithDblProduct.Base<LCharToDblFunctionBuilder, LCharPredicate, LCharToDblFunction> {
	...
	public static final LCharToDblFunction EVENTUALLY_THROW = LCharToDblFunction.charToDblFunc(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LCharToDblFunctionBuilder(@Nullable Consumer<LCharToDblFunction> consumer) {
		super(EVENTUALLY_THROW, LCharToDblFunction::constant, () -> new LCharToDblFunctionBuilder(null));
	...
	@Nonnull
	public static LCharToDblFunction charToDblFunctionFrom(Function<LCharToDblFunctionBuilder, LCharToDblFunction> buildingFunction) {
		return buildingFunction.apply(new LCharToDblFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LCharToDblFunctionBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LCharToDblFunction build() {
		...
		final LCharToDblFunction eventuallyFinal = this.eventually;
	...
	public final LCharToDblFunction build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
