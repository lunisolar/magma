...
public final class LCharToDblFunctionBuilder extends PerCaseBuilderWithDblProduct.Base<LCharToDblFunctionBuilder, LCharPredicate, LCharToDblFunction> {
	...
	public LCharToDblFunctionBuilder forValue(char v, LCharToDblFunction function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithDblProduct.The<LCharToDblFunctionBuilder, LCharPredicate, LCharToDblFunction> forValue(char v) {
