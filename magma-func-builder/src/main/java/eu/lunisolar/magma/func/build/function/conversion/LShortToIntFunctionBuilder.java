...
public final class LShortToIntFunctionBuilder extends PerCaseBuilderWithIntProduct.Base<LShortToIntFunctionBuilder, LShortPredicate, LShortToIntFunction> {
	...
	public LShortToIntFunctionBuilder(@Nullable Consumer<LShortToIntFunction> consumer) {
		super(EVENTUALLY_THROW, LShortToIntFunction::constant, () -> new LShortToIntFunctionBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static LShortToIntFunctionBuilder shortToIntFunction() {
		return new LShortToIntFunctionBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static LShortToIntFunction shortToIntFunctionFrom(Function<LShortToIntFunctionBuilder, LShortToIntFunction> buildingFunction) {
		return buildingFunction.apply(new LShortToIntFunctionBuilder());
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static LShortToIntFunctionBuilder shortToIntFunction(Consumer<LShortToIntFunction> consumer) {
		return new LShortToIntFunctionBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LShortToIntFunctionBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LShortToIntFunction build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
