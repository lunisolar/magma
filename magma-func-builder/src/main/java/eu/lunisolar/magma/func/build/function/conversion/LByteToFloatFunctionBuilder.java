...
public final class LByteToFloatFunctionBuilder extends PerCaseBuilderWithFloatProduct.Base<LByteToFloatFunctionBuilder, LBytePredicate, LByteToFloatFunction> {
	...
	public static final LByteToFloatFunction EVENTUALLY_THROW = LByteToFloatFunction.l((byte a1) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", a1, LByteToFloatFunction.DESCRIPTION);
