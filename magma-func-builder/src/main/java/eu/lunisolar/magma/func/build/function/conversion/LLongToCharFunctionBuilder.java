...
/**
 * Builder for LLongToCharFunction.
 */
public final class LLongToCharFunctionBuilder extends PerCaseBuilderWithCharProduct.Base<LLongToCharFunctionBuilder, LLongPredicate, LLongToCharFunction> {
	//extends PER_CASE_BUILDER<BUILDER_NAME func.B(the_case.class_args_ref), CASE_PREDICATE func.B(the_case.domain_class_argsX_ref), the_case.name_ref RRR> {

	private Consumer<LLongToCharFunction> consumer;
	...
	public LLongToCharFunctionBuilder() {
		this(null);
	}
	...
	@Nonnull
	public static LLongToCharFunction longToCharFunctionFrom(Consumer<LLongToCharFunctionBuilder> buildingFunction) {
		LLongToCharFunctionBuilder builder = new LLongToCharFunctionBuilder();
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LLongToCharFunctionBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public LLongToCharFunctionBuilder forValue(long v, LLongToCharFunction function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithCharProduct.The<LLongToCharFunctionBuilder, LLongPredicate, LLongToCharFunction> forValue(long v) {
	...
	public final LLongToCharFunction build() {
		...
		retval = LLongToCharFunction.longToCharFunc(a -> {
			try {
	...
	public final LLongToCharFunction build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
