...
public final class ByteBinaryOperatorXBuilder<X extends Exception> extends PerCaseBuilderWithByteProduct<ByteBinaryOperatorXBuilder<X>, BiBytePredicateX<X>, ByteBinaryOperatorX<X>> {
