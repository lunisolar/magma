...
public final class IntUnaryOperatorBuilder extends PerCaseBuilderWithIntProduct.Base<IntUnaryOperatorBuilder, LIntPredicate, IntUnaryOperator> {
	...
	public static final IntUnaryOperator EVENTUALLY_THROW = Function4U.intUnaryOperator(a -> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final IntUnaryOperatorBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final IntUnaryOperator build() {
		...
		retval = Function4U.intUnaryOperator(a -> {
			try {
