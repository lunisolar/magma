...
public final class IntUnaryOperatorBuilder extends PerCaseBuilderWithIntProduct.Base<IntUnaryOperatorBuilder, LIntPredicate, IntUnaryOperator> {
	...
	public static final IntUnaryOperator OTHERWISE_THROW = Function4U.intUnaryOp(a -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public IntUnaryOperatorBuilder(@Nullable Consumer<IntUnaryOperator> consumer) {
		super(OTHERWISE_THROW, LIntUnaryOperator::constant, () -> new IntUnaryOperatorBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final IntUnaryOperatorBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public final IntUnaryOperator build() {
		...
		final IntUnaryOperator otherwiseFinal = this.otherwise;
	...
	public final IntUnaryOperator build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
