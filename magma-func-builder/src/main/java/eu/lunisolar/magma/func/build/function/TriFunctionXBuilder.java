...
public final class TriFunctionXBuilder<T1, T2, T3, R, X extends Exception> extends PerCaseBuilder<TriFunctionXBuilder<T1, T2, T3, R, X>, TriPredicateX<T1, T2, T3, X>, TriFunctionX<T1, T2, T3, R, X>> {
