...
public final class LBiFloatPredicateXBuilder<X extends Throwable> extends PerCaseBuilderWithBooleanProduct.Base<LBiFloatPredicateXBuilder<X>, LBiFloatPredicateX<X>, LBiFloatPredicateX<X>> {
	...
	public static final LBiFloatPredicateX EVENTUALLY_THROW = LBiFloatPredicateX.lX((float a1, float a2) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s  as function %s.", a1, a2, LBiFloatPredicateX.DESCRIPTION);
	...
	public final LBiFloatPredicateX<X> build() {
		...
		retval = LBiFloatPredicateX.<X> lX((float a1, float a2) -> {
			try {
