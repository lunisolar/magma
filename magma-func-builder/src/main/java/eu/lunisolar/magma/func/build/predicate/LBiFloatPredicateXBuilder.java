...
public final class LBiFloatPredicateXBuilder<X extends Throwable> extends PerCaseBuilderWithBoolProduct.Base<LBiFloatPredicateXBuilder<X>, LBiFloatPredicateX<X>, LBiFloatPredicateX<X>> {
	...
	public static final LBiFloatPredicateX EVENTUALLY_THROW = LBiFloatPredicateX.lX((a1, a2) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LBiFloatPredicateXBuilder(@Nullable Consumer<LBiFloatPredicateX<X>> consumer) {
		super(EVENTUALLY_THROW, LBiFloatPredicateX::constant, () -> new LBiFloatPredicateXBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static <X extends Throwable> LBiFloatPredicateXBuilder<X> biFloatPredicateX() {
		return new LBiFloatPredicateXBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static <X extends Throwable> LBiFloatPredicateX<X> biFloatPredicateXFrom(Function<LBiFloatPredicateXBuilder<X>, LBiFloatPredicateX<X>> buildingFunction) {
		return buildingFunction.apply(new LBiFloatPredicateXBuilder());
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static <X extends Throwable> LBiFloatPredicateXBuilder<X> biFloatPredicateX(Consumer<LBiFloatPredicateX<X>> consumer) {
	...
	public final LBiFloatPredicateX<X> build() {
		...
		retval = LBiFloatPredicateX.<X> lX((a1, a2) -> {
			try {
