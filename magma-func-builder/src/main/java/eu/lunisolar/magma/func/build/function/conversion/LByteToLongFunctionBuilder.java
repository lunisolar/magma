...
public final class LByteToLongFunctionBuilder extends PerCaseBuilderWithLongProduct.Base<LByteToLongFunctionBuilder, LBytePredicate, LByteToLongFunction> {
	...
	@Nonnull
	public static LByteToLongFunction byteToLongFunctionFrom(Function<LByteToLongFunctionBuilder, LByteToLongFunction> buildingFunction) {
		return buildingFunction.apply(new LByteToLongFunctionBuilder());
	}
