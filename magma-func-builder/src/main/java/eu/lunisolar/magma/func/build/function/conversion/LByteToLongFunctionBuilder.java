...
public final class LByteToLongFunctionBuilder extends PerCaseBuilderWithLongProduct.Base<LByteToLongFunctionBuilder, LBytePredicate, LByteToLongFunction> {
	...
	public static final LByteToLongFunction EVENTUALLY_THROW = LByteToLongFunction.l((byte b) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", b, LByteToLongFunction.DESCRIPTION);
	...
	public LByteToLongFunctionBuilder(@Nullable Consumer<LByteToLongFunction> consumer) {
		super(EVENTUALLY_THROW, LByteToLongFunction::constant);
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final LByteToLongFunctionBuilder byteToLongFunction() {
		return new LByteToLongFunctionBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final LByteToLongFunctionBuilder byteToLongFunction(Consumer<LByteToLongFunction> consumer) {
		return new LByteToLongFunctionBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LByteToLongFunctionBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LByteToLongFunction build() {
		...
		retval = LByteToLongFunction.l((byte b) -> {
			try {
	...
	public final LByteToLongFunction build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
