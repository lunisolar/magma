...
public final class LByteToLongFunctionBuilder extends PerCaseBuilderWithLongProduct.Base<LByteToLongFunctionBuilder, LBytePredicate, LByteToLongFunction> {
	...
	public LByteToLongFunctionBuilder forValue(byte v, LByteToLongFunction function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithLongProduct.The<LByteToLongFunctionBuilder, LBytePredicate, LByteToLongFunction> forValue(byte v) {
