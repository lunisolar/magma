...
public final class LCharBinaryOperatorBuilder extends PerCaseBuilderWithCharProduct.Base<LCharBinaryOperatorBuilder, LBiCharPredicate, LCharBinaryOperator> {
	...
	public LCharBinaryOperatorBuilder() {
		this(null);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static LCharBinaryOperatorBuilder charBinaryOperator() {
		return new LCharBinaryOperatorBuilder();
	}

	/** One of ways of creating builder. This is possibly the least verbose way where compiler should be able to guess the generic parameters. */
	@Nonnull
	public static LCharBinaryOperator charBinaryOperatorFrom(Consumer<LCharBinaryOperatorBuilder> buildingFunction) {
		LCharBinaryOperatorBuilder builder = new LCharBinaryOperatorBuilder();
	...
	@Nonnull
	public static LCharBinaryOperatorBuilder charBinaryOperator(Consumer<LCharBinaryOperator> consumer) {
		return new LCharBinaryOperatorBuilder(consumer);
	}

	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LCharBinaryOperatorBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public LCharBinaryOperatorBuilder forValue(char v1, char v2, LCharBinaryOperator function) {
		PartialCaseWithCharProduct.The pc = partialCaseFactoryMethod((a1, a2) -> a1 == v1 && a2 == v2);
		pc.evaluate(function);
		return fluentCtx();
	}

	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithCharProduct.The<LCharBinaryOperatorBuilder, LBiCharPredicate, LCharBinaryOperator> forValue(char v1, char v2) {
	...
	public final LCharBinaryOperator build() {
		...
		retval = LCharBinaryOperator.charBinaryOp((a1, a2) -> {
			try {
	...
	public final LCharBinaryOperator build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
