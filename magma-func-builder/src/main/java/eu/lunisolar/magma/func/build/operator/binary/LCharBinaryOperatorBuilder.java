...
public final class LCharBinaryOperatorBuilder extends PerCaseBuilderWithCharProduct.Base<LCharBinaryOperatorBuilder, LBiCharPredicate, LCharBinaryOperator> {
	...
	public LCharBinaryOperatorBuilder(@Nullable Consumer<LCharBinaryOperator> consumer) {
		super(EVENTUALLY_THROW, LCharBinaryOperator::constant);
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final LCharBinaryOperatorBuilder charBinaryOperator() {
		return new LCharBinaryOperatorBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final LCharBinaryOperatorBuilder charBinaryOperator(Consumer<LCharBinaryOperator> consumer) {
