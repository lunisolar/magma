...
public final class LCharBinaryOperatorBuilder extends PerCaseBuilderWithCharProduct.Base<LCharBinaryOperatorBuilder, LBiCharPredicate, LCharBinaryOperator> {
	...
	public static final LCharBinaryOperator EVENTUALLY_THROW = LCharBinaryOperator.l((a1, a2) -> {
	...
	@Nonnull
	public static LCharBinaryOperator charBinaryOperatorFrom(Function<LCharBinaryOperatorBuilder, LCharBinaryOperator> buildingFunction) {
		return buildingFunction.apply(new LCharBinaryOperatorBuilder());
	}
	...
	public final LCharBinaryOperator build() {
		...
		retval = LCharBinaryOperator.l((a1, a2) -> {
			try {
