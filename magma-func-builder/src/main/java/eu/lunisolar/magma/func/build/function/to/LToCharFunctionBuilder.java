...
public final class LToCharFunctionBuilder<T> extends PerCaseBuilderWithCharProduct.Base<LToCharFunctionBuilder<T>, LPredicate<T>, LToCharFunction<T>> {
	...
	public static final LToCharFunction EVENTUALLY_THROW = LToCharFunction.l((Object a1) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", a1, LToCharFunction.DESCRIPTION);
