...
public final class LToCharFunctionBuilder<T> extends PerCaseBuilderWithCharProduct.Base<LToCharFunctionBuilder<T>, LPredicate<T>, LToCharFunction<T>> {
	...
	public static final LToCharFunction EVENTUALLY_THROW = LToCharFunction.l((Object t) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", t, LToCharFunction.DESCRIPTION);
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LToCharFunctionBuilder<T> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	@Nonnull
	public <E1 extends T> LToCharFunctionBuilder<T> casesOf(Class<E1> argC1, Consumer<LToCharFunctionBuilder<E1>> pcpConsumer) {
	...
	@Nonnull
	public <E1 extends T> LToCharFunctionBuilder<T> aCase(Class<E1> argC1, LToCharFunction<E1> function) {
		PartialCaseWithCharProduct.The pc = partialCaseFactoryMethod(t -> (argC1 == null || argC1.isInstance(t)));
	...
	public final LToCharFunction<T> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
