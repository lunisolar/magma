...
public final class LBiObjIntFunctionXBuilder<T1, T2, R, X extends Throwable> extends PerCaseBuilderWithProduct.Base<LBiObjIntFunctionXBuilder<T1, T2, R, X>, LBiObjIntPredicateX<T1, T2, X>, LBiObjIntFunctionX<T1, T2, R, X>, R> {
	...
	public static final LBiObjIntFunctionX EVENTUALLY_THROW = LBiObjIntFunctionX.lX((Object a1, Object a2, int a3) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s ,%s  as function %s.", a1, a2, a3, LBiObjIntFunctionX.DESCRIPTION);
	...
	public final LBiObjIntFunctionX<T1, T2, R, X> build() {
		...
		retval = LBiObjIntFunctionX.<T1, T2, R, X> lX((T1 a1, T2 a2, int a3) -> {
			try {
