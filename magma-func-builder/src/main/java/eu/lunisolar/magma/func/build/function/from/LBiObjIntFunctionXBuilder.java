...
public final class LBiObjIntFunctionXBuilder<T1, T2, R, X extends Throwable> extends PerCaseBuilderWithProduct.Base<LBiObjIntFunctionXBuilder<T1, T2, R, X>, LBiObjIntPredicateX<T1, T2, X>, LBiObjIntFunctionX<T1, T2, R, X>, R> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T1, T2, R, X extends Throwable> LBiObjIntFunctionXBuilder<T1, T2, R, X> biObjIntFunctionX() {
		return new LBiObjIntFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T1, T2, R, X extends Throwable> LBiObjIntFunctionXBuilder<T1, T2, R, X> biObjIntFunctionX(Consumer<LBiObjIntFunctionX<T1, T2, R, X>> consumer) {
