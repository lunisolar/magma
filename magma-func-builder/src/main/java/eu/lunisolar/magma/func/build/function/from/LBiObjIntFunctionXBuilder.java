...
public final class LBiObjIntFunctionXBuilder<T1, T2, R, X extends Exception> extends PerCaseBuilderWithProduct.Base<LBiObjIntFunctionXBuilder<T1, T2, R, X>, LBiObjIntPredicateX<T1, T2, X>, LBiObjIntFunctionX<T1, T2, R, X>, R> {
	...
	public LBiObjIntFunctionXBuilder(@Nullable Consumer<LBiObjIntFunctionX<T1, T2, R, X>> consumer) {
		super(EVENTUALLY_THROW, LBiObjIntFunctionX::constant);
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <T1, T2, R, X extends Exception> LBiObjIntFunctionXBuilder<T1, T2, R, X> biObjIntFunctionX() {
		return new LBiObjIntFunctionXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <T1, T2, R, X extends Exception> LBiObjIntFunctionXBuilder<T1, T2, R, X> biObjIntFunctionX(Consumer<LBiObjIntFunctionX<T1, T2, R, X>> consumer) {
	...
	public final LBiObjIntFunctionX<T1, T2, R, X> build() {
		...
		if (cases.isEmpty()) {
			...
			retval = LBiObjIntFunctionX.lX((T1 t1, T2 t2, int i) -> {
