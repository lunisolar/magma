...
public final class LBiObjIntFunctionXBuilder<T1, T2, R, X extends Throwable> extends PerCaseBuilderWithProduct.Base<LBiObjIntFunctionXBuilder<T1, T2, R, X>, LBiObjIntPredicateX<T1, T2, X>, LBiObjIntFunctionX<T1, T2, R, X>, R> {
	...
	public static final LBiObjIntFunctionX EVENTUALLY_THROW = LBiObjIntFunctionX.lX((a1, a2, a3) -> {
	...
	@Nonnull
	public static <T1, T2, R, X extends Throwable> LBiObjIntFunctionX<T1, T2, R, X> biObjIntFunctionXFrom(Function<LBiObjIntFunctionXBuilder<T1, T2, R, X>, LBiObjIntFunctionX<T1, T2, R, X>> buildingFunction) {
		return buildingFunction.apply(new LBiObjIntFunctionXBuilder());
	}
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjIntFunctionXBuilder<T1, T2, R, X> casesOf(Class<V1> argC1, Class<V2> argC2, Consumer<LBiObjIntFunctionXBuilder<V1, V2, R, X>> pcpConsumer) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjIntFunctionXBuilder<T1, T2, R, X> aCase(Class<V1> argC1, Class<V2> argC2, LBiObjIntFunctionX<V1, V2, R, X> function) {
		PartialCaseWithProduct.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
	...
	public final LBiObjIntFunctionX<T1, T2, R, X> build() {
		...
		retval = LBiObjIntFunctionX.<T1, T2, R, X> lX((a1, a2, a3) -> {
			try {
