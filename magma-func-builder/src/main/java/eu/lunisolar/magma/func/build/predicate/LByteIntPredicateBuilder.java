...
public final class LByteIntPredicateBuilder extends PerCaseBuilderWithBoolProduct.Base<LByteIntPredicateBuilder, LByteIntPredicate, LByteIntPredicate> {
	...
	public static final LByteIntPredicate OTHERWISE_THROW = LByteIntPredicate.byteIntPred((a1, a2) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LByteIntPredicateBuilder(@Nullable Consumer<LByteIntPredicate> consumer) {
		super(OTHERWISE_THROW, LByteIntPredicate::constant, () -> new LByteIntPredicateBuilder(null));
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LByteIntPredicateBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public LByteIntPredicateBuilder forValue(byte v1, int v2, LByteIntPredicate function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithBoolProduct.The<LByteIntPredicateBuilder, LByteIntPredicate, LByteIntPredicate> forValue(byte v1, int v2) {
	...
	public final LByteIntPredicate build() {
		...
		final LByteIntPredicate otherwiseFinal = this.otherwise;
	...
	public final LByteIntPredicate build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
