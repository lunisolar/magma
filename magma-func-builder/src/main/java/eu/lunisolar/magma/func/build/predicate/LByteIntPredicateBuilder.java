...
public final class LByteIntPredicateBuilder extends PerCaseBuilderWithBoolProduct.Base<LByteIntPredicateBuilder, LByteIntPredicate, LByteIntPredicate> {
	...
	@Nonnull
	public static LByteIntPredicate byteIntPredicateFrom(Function<LByteIntPredicateBuilder, LByteIntPredicate> buildingFunction) {
		return buildingFunction.apply(new LByteIntPredicateBuilder());
	}
