...
public final class LTieFunctionBuilder<T1, T2> extends PerCaseBuilderWithIntProduct.Base<LTieFunctionBuilder<T1, T2>, LObjIntObjPredicate<T1, T2>, LTieFunction<T1, T2>> {
	...
	public <V1 extends T1, V2 extends T2> LTieFunctionBuilder<T1, T2> forValue(T1 v1, int v2, T2 v3, LTieFunction<V1, V2> function) {
		PartialCaseWithIntProduct.The pc = partialCaseFactoryMethod((a1, a2, a3) -> Objects.equals(a1, v1) && a2 == v2 && Objects.equals(a3, v3));
		pc.evaluate(function);
		return fluentCtx();
	}

	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public <V1 extends T1, V2 extends T2> PartialCaseWithIntProduct.The<LTieFunctionBuilder<T1, T2>, LObjIntObjPredicate<T1, T2>, LTieFunction<T1, T2>> forValue(T1 v1, int v2, T2 v3) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LTieFunctionBuilder<T1, T2> forClass(Class<V1> argC1, Class<V2> argC3, LTieFunction<V1, V2> function) {
		PartialCaseWithIntProduct.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC3 == null || argC3.isInstance(a2)));
		pc.evaluate(function);
		return fluentCtx();
	}
	...
	/** Adds full new case for the argument that are of specific classes (matched by instanceOf, null is a wildcard). */
	@Nonnull
	public <V1 extends T1, V2 extends T2> PartialCaseWithIntProduct.The<LTieFunctionBuilder<T1, T2>, LObjIntObjPredicate<T1, T2>, LTieFunction<T1, T2>> forClass(Class<V1> argC1, Class<V2> argC3) {
