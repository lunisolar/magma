...
public final class LTieFunctionBuilder<T1, T2> extends PerCaseBuilderWithIntProduct.Base<LTieFunctionBuilder<T1, T2>, LObjIntObjPredicate<T1, T2>, LTieFunction<T1, T2>> {
	...
	public static final LTieFunction EVENTUALLY_THROW = LTieFunction.tieFunc((a1, a2, a3) -> {
		throw new IllegalStateException("There is no case configured for the arguments (if any).");
	});

	public LTieFunctionBuilder(@Nullable Consumer<LTieFunction<T1, T2>> consumer) {
		super(EVENTUALLY_THROW, LTieFunction::constant, () -> new LTieFunctionBuilder(null));
	...
	@Nonnull
	public static <T1, T2> LTieFunction<T1, T2> tieFunctionFrom(Function<LTieFunctionBuilder<T1, T2>, LTieFunction<T1, T2>> buildingFunction) {
		return buildingFunction.apply(new LTieFunctionBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LTieFunctionBuilder<T1, T2> withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LTieFunction<T1, T2> build() {
		...
		final LTieFunction<T1, T2> eventuallyFinal = this.eventually;
	...
	public final LTieFunction<T1, T2> build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
