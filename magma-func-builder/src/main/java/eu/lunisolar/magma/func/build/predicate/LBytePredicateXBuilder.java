...
public final class LBytePredicateXBuilder<X extends Throwable> extends PerCaseBuilderWithBooleanProduct.Base<LBytePredicateXBuilder<X>, LBytePredicateX<X>, LBytePredicateX<X>> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public static final <X extends Throwable> LBytePredicateXBuilder<X> bytePredicateX() {
		return new LBytePredicateXBuilder();
	}

	/** One of ways of creating builder. This might be the only way (considering all _functional_ builders) that might be utilize to specify generic params only once. */
	@Nonnull
	public static final <X extends Throwable> LBytePredicateXBuilder<X> bytePredicateX(Consumer<LBytePredicateX<X>> consumer) {
