...
public final class LBiObjBoolPredicateBuilder<T1, T2> extends PerCaseBuilderWithBoolProduct.Base<LBiObjBoolPredicateBuilder<T1, T2>, LBiObjBoolPredicate<T1, T2>, LBiObjBoolPredicate<T1, T2>> {
	...
	@Nonnull
	public static <T1, T2> LBiObjBoolPredicate<T1, T2> biObjBoolPredicateFrom(Consumer<LBiObjBoolPredicateBuilder<T1, T2>> buildingFunction) {
		LBiObjBoolPredicateBuilder builder = new LBiObjBoolPredicateBuilder();
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LBiObjBoolPredicateBuilder<T1, T2> withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public <V1 extends T1, V2 extends T2> LBiObjBoolPredicateBuilder<T1, T2> forValue(T1 v1, T2 v2, boolean v3, LBiObjBoolPredicate<V1, V2> function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public <V1 extends T1, V2 extends T2> PartialCaseWithBoolProduct.The<LBiObjBoolPredicateBuilder<T1, T2>, LBiObjBoolPredicate<T1, T2>, LBiObjBoolPredicate<T1, T2>> forValue(T1 v1, T2 v2, boolean v3) {
	...
	@Nonnull
	public <V1 extends T1, V2 extends T2> LBiObjBoolPredicateBuilder<T1, T2> forClass(Class<V1> argC1, Class<V2> argC2, LBiObjBoolPredicate<V1, V2> function) {
		PartialCaseWithBoolProduct.The pc = partialCaseFactoryMethod((a1, a2, a3) -> (argC1 == null || argC1.isInstance(a1)) && (argC2 == null || argC2.isInstance(a2)));
		pc.evaluate(function);
		return fluentCtx();
	}
	...
	/** Adds full new case for the argument that are of specific classes (matched by instanceOf, null is a wildcard). */
	@Nonnull
	public <V1 extends T1, V2 extends T2> PartialCaseWithBoolProduct.The<LBiObjBoolPredicateBuilder<T1, T2>, LBiObjBoolPredicate<T1, T2>, LBiObjBoolPredicate<T1, T2>> forClass(Class<V1> argC1, Class<V2> argC2) {
	...
	public final LBiObjBoolPredicate<T1, T2> build() {
		...
		retval = LBiObjBoolPredicate.<T1, T2>biObjBoolPred((a1, a2, a3) -> {
			try {
	...
	public final LBiObjBoolPredicate<T1, T2> build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
