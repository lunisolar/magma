...
public final class LBiObjBoolPredicateBuilder<T1, T2> extends PerCaseBuilderWithBooleanProduct.Base<LBiObjBoolPredicateBuilder<T1, T2>, LBiObjBoolPredicate<T1, T2>, LBiObjBoolPredicate<T1, T2>> {
	...
	public static final LBiObjBoolPredicate EVENTUALLY_THROW = LBiObjBoolPredicate.l((Object a1, Object a2, boolean a3) -> {
		String message;
		try {
			message = String.format("No case specified for: %s ,%s ,%s  as function %s.", a1, a2, a3, LBiObjBoolPredicate.DESCRIPTION);
	...
	public final LBiObjBoolPredicate<T1, T2> build() {
		...
		retval = LBiObjBoolPredicate.<T1, T2> l((T1 a1, T2 a2, boolean a3) -> {
			try {
