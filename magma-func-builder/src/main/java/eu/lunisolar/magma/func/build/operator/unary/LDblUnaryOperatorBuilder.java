...
public final class LDblUnaryOperatorBuilder extends PerCaseBuilderWithDblProduct.Base<LDblUnaryOperatorBuilder, LDblPredicate, LDblUnaryOperator> {
	...
	@Nonnull
	public static LDblUnaryOperator dblUnaryOperatorFrom(Function<LDblUnaryOperatorBuilder, LDblUnaryOperator> buildingFunction) {
		return buildingFunction.apply(new LDblUnaryOperatorBuilder());
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LDblUnaryOperatorBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LDblUnaryOperator build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
