...
public final class IntBinaryOperatorBuilder extends PerCaseBuilderWithIntProduct.Base<IntBinaryOperatorBuilder, LBiIntPredicate, IntBinaryOperator> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final IntBinaryOperatorBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public final IntBinaryOperator build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
