...
public final class ObjLongPredicateXBuilder<T, X extends Exception> extends PerCaseBuilderWithBooleanProduct<ObjLongPredicateXBuilder<T, X>, ObjLongPredicateX<T, X>, ObjLongPredicateX<T, X>> {
