...
public final class ObjLongPredicateXBuilder<T, X extends Exception> extends PerCaseBuilder<ObjLongPredicateXBuilder<T, X>, ObjLongPredicateX<T, X>, ObjLongPredicateX<T, X>> {
