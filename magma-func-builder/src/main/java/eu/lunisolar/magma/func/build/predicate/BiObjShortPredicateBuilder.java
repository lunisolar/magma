...
public final class BiObjShortPredicateBuilder<T1, T2> extends PerCaseBuilderWithBooleanProduct.Base<BiObjShortPredicateBuilder<T1, T2>, BiObjShortPredicate<T1, T2>, BiObjShortPredicate<T1, T2>> {
	...
	public BiObjShortPredicateBuilder(@Nullable Consumer<BiObjShortPredicate<T1, T2>> consumer) {
		super(EVENTUALLY_THROW, BiObjShortPredicate::constant);
