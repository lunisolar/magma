...
public final class LCharToByteFunctionBuilder extends PerCaseBuilderWithByteProduct.Base<LCharToByteFunctionBuilder, LCharPredicate, LCharToByteFunction> {
	...
	private Consumer<LCharToByteFunction> consumer;
	...
	public LCharToByteFunctionBuilder() {
		this(null);
	}
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LCharToByteFunctionBuilder withHandling(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
	...
	public LCharToByteFunctionBuilder forValue(char v, LCharToByteFunction function) {
	...
	/** Allows to specify additional cases for a specific values of arguments (matched by equals).*/
	public PartialCaseWithByteProduct.The<LCharToByteFunctionBuilder, LCharPredicate, LCharToByteFunction> forValue(char v) {
	...
	public final LCharToByteFunction build(@Nonnull HandlingInstructions<Throwable, RuntimeException> handling) {
