...
public final class LCharToByteFunctionBuilder extends PerCaseBuilderWithByteProduct.Base<LCharToByteFunctionBuilder, LCharPredicate, LCharToByteFunction> {
	...
	/** One of ways of creating builder. In most cases (considering all _functional_ builders) it requires to provide generic parameters (in most cases redundantly) */
	@Nonnull
	public final LCharToByteFunctionBuilder withHandling(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
	...
	public final LCharToByteFunction build(@Nonnull HandlingInstructions<RuntimeException, RuntimeException> handling) {
