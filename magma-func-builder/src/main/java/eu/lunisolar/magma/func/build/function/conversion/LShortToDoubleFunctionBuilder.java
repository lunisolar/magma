...
public final class LShortToDoubleFunctionBuilder extends PerCaseBuilderWithDoubleProduct.Base<LShortToDoubleFunctionBuilder, LShortPredicate, LShortToDoubleFunction> {
	...
	public static final LShortToDoubleFunction EVENTUALLY_THROW = LShortToDoubleFunction.l((short a1) -> {
		String message;
		try {
			message = String.format("No case specified for: %s  as function %s.", a1, LShortToDoubleFunction.DESCRIPTION);
